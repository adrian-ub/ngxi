...
@Component({
  standalone: true,
  selector:
    'svg[siKarlsruherverkehrsverbund],svg[si-karlsruherverkehrsverbund]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.xmlns]': 'xmlns()',
  },
  template: `<svg:title>Karlsruher Verkehrsverbund</svg:title>
    <svg:path
...
export class SiKarlsruherverkehrsverbund {
