 ...
 * `icon-set.json`) and emits `apps/docs/public/icons/manifest.json` plus a
 * verbatim `<set>.json` and a naming `<set>.index.json` per set. Also emits
 * the site discovery files (`sitemap.xml`, `robots.txt`, `llms.txt`,
