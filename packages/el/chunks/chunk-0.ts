...
@Component({
  standalone: true,
  selector: 'svg[elAsteriskIcon],svg[el-asterisk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M489.838 29.354v443.603L68.032 335.894L0 545.285l421.829 137.086l-260.743 358.876l178.219 129.398L600.048 811.84l260.673 358.806l178.146-129.398l-260.766-358.783L1200 545.379l-68.032-209.403l-421.899 137.07V29.443H489.84z"></svg:path>`,
})
export class ElAsteriskIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elBellIcon],svg[el-bell-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M521.329 0v74.121c-163.599 35.891-286.205 181.326-286.954 355.52v319.63L-1.832 953.535v55.591h1203.665v-55.591L965.625 749.271v-319.63c-.753-174.194-123.364-319.629-286.97-355.52V0zm78.661 1024.585c-48.447 0-87.743 39.223-87.743 87.672c0 48.447 39.296 87.743 87.743 87.743c48.448 0 87.744-39.296 87.744-87.743c0-48.448-39.296-87.672-87.744-87.672"></svg:path>`,
})
export class ElBellIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elBlindIcon],svg[el-blind-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elBloggerIcon],svg[el-blogger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elBoldIcon],svg[el-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elBrailleIcon],svg[el-braille-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elBroomIcon],svg[el-broom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elBrushIcon],svg[el-brush-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1157.602.013c-46.711 2.677-736.479 591.498-793.123 798.838l130.736 136.944C868.899 624.199 988.915 294.221 1200 .649L1157.617 0zM323.267 840.562C87.09 927.418 235.147 1099.273 0 1183.352c266.294 59.953 384.296-49.748 454.003-205.421L323.267 840.548z"></svg:path>`,
})
export class ElBrushIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elBullhornIcon],svg[el-bullhorn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCalendarIcon],svg[el-calendar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCalendarSignIcon],svg[el-calendar-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCarIcon],svg[el-car-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m214.662 100.752l-75.97 316.401H0v91.456h47.573v590.639h136.569v-96.685h831.716v96.685h136.496V508.609H1200v-91.456h-138.692l-75.971-316.401zm40.474 61.52h689.713l61.187 254.887H193.934l61.186-254.887zm-168.048 423.7l190.44 70.329v91.384l-190.44-70.329zm1025.73 0v91.384l-190.362 70.329v-91.456zM415.833 825.036h368.193v91.384H415.833z"></svg:path>`,
})
export class ElCarIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elCcIcon],svg[el-cc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elChildIcon],svg[el-child-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M604.729 0C469.354 0 359.598 110.317 359.598 246.429c0 136.114 109.765 246.471 245.132 246.471c135.375 0 245.089-110.35 245.089-246.471C849.818 110.314 740.103 0 604.729 0M464.355 287.402h279.366c0 77.145-62.56 139.704-139.704 139.704s-139.662-62.559-139.662-139.704m-52.274 244.336c-127.661 2.621-211.637 85.551-206.878 235.714L204.952 1200h146.945V811.356c1.271-34.026 51.241-45.945 57.673 0V1200h386.133V811.356c1.271-34.026 51.241-45.945 57.673 0V1200h141.672V767.452c-.858-118.72-49.572-236.814-205.581-235.714z"></svg:path>`,
})
export class ElChildIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elCogIcon],svg[el-cog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCogAltIcon],svg[el-cog-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-57.129 234.375h114.258l11.06 110.303c22.729 6.054 44.277 14.988 64.16 26.514l85.84-70.166l80.786 80.786l-70.166 85.84c11.525 19.883 20.46 41.432 26.514 64.16l110.303 11.06V657.13l-110.303 11.133c-6.054 22.709-14.997 44.22-26.514 64.087l70.166 85.84l-80.786 80.786l-85.913-70.166c-19.874 11.516-41.371 20.464-64.087 26.514l-11.06 110.303H542.871l-11.133-110.303a262.3 262.3 0 0 1-64.014-26.514l-85.913 70.166l-80.786-80.786l70.166-85.913a262.3 262.3 0 0 1-26.514-64.014L234.374 657.13V542.871l110.303-11.06c6.05-22.716 14.998-44.213 26.514-64.087l-70.166-85.913l80.786-80.786l85.84 70.166c19.867-11.517 41.378-20.46 64.087-26.514zM600 494.312c-58.374 0-105.688 47.314-105.688 105.688S541.626 705.688 600 705.688S705.688 658.374 705.688 600S658.374 494.312 600 494.312"></svg:path>`,
})
export class ElCogAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elCogsIcon],svg[el-cogs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCompassIcon],svg[el-compass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M175.736 1024.264c234.315 234.314 614.213 234.314 848.527 0s234.314-614.212 0-848.527c-234.314-234.314-614.212-234.314-848.527 0c-234.314 234.314-234.314 614.212 0 848.527m58.575-58.575c-201.966-201.966-201.966-529.412 0-731.378s529.412-201.966 731.378 0c201.967 201.967 201.967 529.413 0 731.378c-201.965 201.967-529.411 201.967-731.378 0m58.522-31.281l398.11-243.465l243.465-398.109l-27.241-27.242l-398.11 243.465l-243.465 398.11z"></svg:path>`,
})
export class ElCompassIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elCompassAltIcon],svg[el-compass-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elCssIcon],svg[el-css-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elDashboardIcon],svg[el-dashboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 195.373c-331.371 0-600 268.629-600 600c0 73.594 13.256 144.104 37.5 209.253h164.062C168.665 942.111 150 870.923 150 795.373c0-248.528 201.471-450 450-450s450 201.472 450 450c0 75.55-18.665 146.738-51.562 209.253H1162.5c24.244-65.148 37.5-135.659 37.5-209.253c0-331.371-268.629-600-600-600m0 235.62c-41.421 0-75 33.579-75 75s33.579 75 75 75s75-33.578 75-75s-33.579-75-75-75m-224.927 73.462c-41.421 0-75 33.579-75 75s33.579 75 75 75s75-33.578 75-75s-33.579-75-75-75m449.854 0c-41.422 0-75 33.579-75 75s33.578 75 75 75s75-33.578 75-75s-33.579-75-75-75M600 651.672l-58.813 294.141v58.814h117.627v-58.814z"></svg:path>`,
})
export class ElDashboardIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elDeviantartIcon],svg[el-deviantart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elDribbbleIcon],svg[el-dribbble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elEditIcon],svg[el-edit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0v1200h1200V424.292l-196.875 196.875v381.958h-806.25v-806.25h381.958L775.708 0zm1050 0l-76.831 76.831l150 150L1200 150zM936.914 113.086L497.168 552.832l150 150l439.746-439.746zM441.943 622.339c-2.225.034-4.493.195-6.738.366v142.09h142.09c0-38.708-18.492-78.039-47.314-105.542c-23.842-22.751-54.675-37.428-88.038-36.914"></svg:path>`,
})
export class ElEditIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elErrorAltIcon],svg[el-error-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M197.314 439.453h805.371v321.094H197.314z"></svg:path>`,
})
export class ElErrorAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elEurIcon],svg[el-eur-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M754.722 199.33q-98.059 0-161.554 57.066q-63.496 56.264-81.982 163.965h323.912v141.46H499.129l-1.607 28.132v37.776l1.607 26.523h285.332v143.067H512.793q40.99 195.311 258.004 195.311q114.936 0 221.031-45.813v205.76Q898.593 1200.001 756.33 1200q-196.92 0-323.912-106.898q-126.993-106.9-159.946-295.78H162.357v-143.07H257.2q-3.216-18.484-3.215-49.831l1.607-42.6h-93.235v-141.46h106.899q29.738-194.505 159.946-307.031Q559.409.002 754.721 0q151.104.002 282.921 65.909l-78.768 186.47q-55.46-24.916-103.684-38.581q-48.225-14.466-100.468-14.468"></svg:path>`,
})
export class ElEurIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elEyeCloseIcon],svg[el-eye-close-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elEyeOpenIcon],svg[el-eye-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFacebookIcon],svg[el-facebook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFemaleIcon],svg[el-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C387.136 0 214.538 172.598 214.538 385.462c0 187.751 134.31 344.181 312.055 378.479V888.02H361.278v146.74h165.314V1200h146.74v-165.24h165.314V888.02H673.333V763.94c177.78-34.269 312.129-190.702 312.129-378.479C985.462 172.598 812.864 0 600 0m0 153.278c128.231 0 232.184 103.953 232.184 232.184S728.232 617.647 600 617.647S367.816 513.693 367.816 385.462S471.769 153.278 600 153.278"></svg:path>`,
})
export class ElFemaleIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elFileEditIcon],svg[el-file-edit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M284.506 0L58.436 218.249V1200h850.418V817.511L803.861 922.504v173.167H163.428V292.179h197.59v-187.85h442.844v272.996L490.433 690.753L397.32 977.619l286.793-93.188l457.452-457.452L947.885 233.3l-39.031 39.031V0zm254.402 739.154l96.803 96.876l-143.434 46.557z"></svg:path>`,
})
export class ElFileEditIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elFileEditAltIcon],svg[el-file-edit-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFireIcon],svg[el-fire-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFlagAltIcon],svg[el-flag-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M410.376 261.328c181.004.811 314.621 181.414 529.028 42.7v362.988c-173.222 173.222-335.647-107.109-588.721-38.232v309.888h-90.088V304.028c54.425-31.422 103.643-42.906 149.781-42.7"></svg:path>`,
})
export class ElFlagAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elFontsizeIcon],svg[el-fontsize-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elForkIcon],svg[el-fork-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFoursquareIcon],svg[el-foursquare-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFriendfeedIcon],svg[el-friendfeed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFriendfeedRectIcon],svg[el-friendfeed-rect-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elFullscreenIcon],svg[el-fullscreen-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0v413.818l144.141-145.386L475.708 600L143.555 932.153L0 789.844V1200h413.818l-145.386-144.141L600 724.292l332.153 332.153L789.844 1200H1200V786.182l-144.141 145.386L724.292 600l332.153-332.153L1200 410.156V0H786.182l145.386 144.141L600 475.708L267.847 143.555L410.156 0z"></svg:path>`,
})
export class ElFullscreenIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGbpIcon],svg[el-gbp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M676.062 0q157.787.001 315.576 66.352L916.385 252.46q-127.04-51.785-220.094-51.787q-63.115.001-97.101 36.413q-33.986 35.606-33.984 102.765v156.17h303.438V673.23H565.206v115.71q-.001 137.56-122.186 200.675h580.985V1200H175.994V999.326q83.345-35.603 114.093-81.727q31.558-46.122 31.559-127.04V673.23H177.612V496.02h144.033V338.235q0-162.642 92.246-250.034Q506.945 0 676.062 0"></svg:path>`,
})
export class ElGbpIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGiftIcon],svg[el-gift-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m750.588 371.765l230.588-145.882L755.293 0L609.412 324.706L524.706 70.588L298.824 221.176l188.234 150.588H58.824v301.178h75.294V1200h931.763V672.941h75.295V371.765zm23.756-272.854l118.195 118.195l-241.1 152.89zm-279.832 59.675l66.739 200.216l-166.848-133.477zm30.194 966.12H209.412v-475.35h315.294zm0-527.06H134.118V447.059h390.588zm465.882 527.06H675.293v-475.35h315.295zm75.293-527.06H675.293V447.059h390.588z"></svg:path>`,
})
export class ElGiftIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGithubIcon],svg[el-github-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGithubTextIcon],svg[el-github-text-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGlassesIcon],svg[el-glasses-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1118.948 592.892H732.471l49.909 227.792h312.254zm-652.661 0H79.809l24.315 227.792h312.253zm723.047-66.546q12.803 14.076 10.237 30.714l-33.272 307.135c-4.563 20.081-18.878 35.561-38.393 35.832h-376.24c-20.231-1.346-33.639-14.035-37.111-31.993l-60.146-267.463c-32.547-20.271-75.345-17.317-110.057-2.56l-60.147 270.022c-4.772 19.452-18.653 31.768-37.112 31.993H70.851c-21.166-1.673-35.301-16.94-37.112-35.832L.465 557.06q-2.559-17.915 8.958-30.714l432.548-222.673c20.748-9.255 41.297-.366 49.909 17.916c7.223 20.882 2.533 44.668-16.636 53.749L201.383 499.472h792.152L719.673 375.337c-20.314-11.516-25.569-34.709-17.916-53.749c10.862-19.479 32.864-25.945 51.189-17.916z"></svg:path>`,
})
export class ElGlassesIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGlobeIcon],svg[el-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGlobeAltIcon],svg[el-globe-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGoogleplusIcon],svg[el-googleplus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGraphIcon],svg[el-graph-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 145.532v908.936h1200V145.532zM147.51 291.87h904.98v616.26H147.51zm769.922 48.779L763.184 608.13L690.82 457.251l-45.41-94.775l-56.689 88.403L461.938 648.34l-52.075-54.712l-37.866-39.771l-42.114 35.229l-148.902 124.293l75.073 89.941l106.787-89.136l65.698 68.994l51.489 54.053l40.283-62.769l110.303-171.899l75 156.519l48.047 100.269l55.518-96.387l209.766-363.794z"></svg:path>`,
})
export class ElGraphIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGraphAltIcon],svg[el-graph-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M251.147 335.815h697.705v528.369H251.147zm85.767 85.035v358.3h526.172v-358.3zm447.656 28.344l58.96 34.058l-121.948 211.523l-32.227 56.03l-27.979-58.301l-43.579-91.04l-64.16 99.976l-23.364 36.475l-29.956-31.421l-38.159-40.137l-62.109 51.855l-43.652-52.295l86.572-72.29l24.463-20.435l22.046 23.071l30.249 31.86l73.682-114.844l32.959-51.343l26.44 55.078l42.041 87.744z"></svg:path>`,
})
export class ElGraphAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elGroupIcon],svg[el-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGroupAltIcon],svg[el-group-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elGuidedogIcon],svg[el-guidedog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHandDownIcon],svg[el-hand-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHandLeftIcon],svg[el-hand-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHandRightIcon],svg[el-hand-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHandUpIcon],svg[el-hand-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHddIcon],svg[el-hdd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M240.015 89.722L0 734.546l96.021 375.732H1103.98L1200 734.546L959.985 89.722zM93.75 793.945h1012.573l-65.625 256.934H159.375zm834.229 80.493c-26.508 0-47.974 21.466-47.974 47.974c0 26.509 21.466 48.047 47.974 48.047s48.047-21.538 48.047-48.047c-.001-26.508-21.54-47.974-48.047-47.974"></svg:path>`,
})
export class ElHddIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elHeadphonesIcon],svg[el-headphones-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1050 937.5v-300c0-248.513-201.487-450-450-450s-450 201.487-450 450v300c-11.048 106.906-147.598 78.946-150 0v-300c0-331.388 268.65-600 600-600s600 268.612 600 600v300c-11.048 106.906-147.598 78.946-150 0m-787.5-225h75c20.7 0 37.5 16.763 37.5 37.5v375c0 20.737-16.8 37.5-37.5 37.5h-75c-20.7 0-37.5-16.763-37.5-37.5V750c0-20.737 16.8-37.5 37.5-37.5m600 0h75c20.737 0 37.5 16.763 37.5 37.5v375c0 20.737-16.763 37.5-37.5 37.5h-75c-20.737 0-37.5-16.763-37.5-37.5V750c0-20.737 16.763-37.5 37.5-37.5"></svg:path>`,
})
export class ElHeadphonesIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elHearingImpairedIcon],svg[el-hearing-impaired-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elHeartIcon],svg[el-heart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1176.629 250.347c54.502 168.401 8.89 339.761-87.232 468.872c-63.446 87.553-139.273 163.012-216.796 228.983c-71.322 66.39-230.933 197.753-273.241 201.402c-37.394-7.148-79.353-49.433-109.039-71.196C323.503 951.599 143.93 797.388 52.878 628.779c-76.34-161.871-76.48-362.086 42.333-486.189C249.271 3.702 481.533 30.841 599.359 175.944q47.466-61.575 116.737-96.853c187.213-74.728 381.972 1.418 460.533 171.256"></svg:path>`,
})
export class ElHeartIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elHeartAltIcon],svg[el-heart-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m132.789 343.503c71.295-1.114 135.772 37.646 166.337 103.724c28.273 87.356 4.612 176.225-45.251 243.199c-32.912 45.417-72.247 84.584-112.462 118.807c-36.997 34.439-119.808 102.591-141.755 104.483c-19.397-3.708-41.173-25.678-56.573-36.968c-86.534-65.781-179.667-145.742-226.899-233.207c-39.601-83.97-39.673-187.864 21.96-252.241c79.917-72.048 200.39-57.946 261.512 17.325c16.415-21.295 36.605-38.066 60.562-50.267c24.279-9.69 48.803-14.483 72.569-14.855"></svg:path>`,
})
export class ElHeartAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elHeartEmptyIcon],svg[el-heart-empty-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M832.486 46.17c-48.316.497-97.873 9.932-146.357 29.285l-2.201.934l-2.201 1.134c-30.735 15.652-58.748 35.232-83.651 58.436c-134.023-115.917-347.394-124.33-493.37 7.271l-1.468 1.334l-1.334 1.401C-26.152 279.721-23.153 485.712 53.607 648.474l.667 1.268l.667 1.334c90.404 167.407 259.216 309.652 413.054 426.596l.4.333l.333.268c9.897 7.256 26.915 22.257 46.562 37.022c19.646 14.766 41.839 30.948 74.312 37.156l7.271 1.4l7.338-.601c34.082-2.939 47.452-15.523 69.843-29.617s47.177-31.986 72.645-51.565c50.202-38.595 102.147-83.079 136.351-114.804c.44-.409 1.166-.997 1.601-1.401c.071-.06.13-.14.2-.2c72.052-61.482 143.423-132.361 203.926-215.732c.019-.025.048-.041.065-.066c.114-.153.22-.313.334-.467c95.955-129.193 142.502-303.295 86.987-474.825l-1.001-3.069l-1.334-2.869C1111.497 123.881 977.435 44.681 832.486 46.17m1.735 105.532c104.434-2.402 195.973 53.518 241.415 149.158c41.99 133.897 5.693 270.32-72.512 375.364l-.2.267l-.199.268c-54.48 75.18-120.459 140.988-188.85 199.189l-.867.801l-.867.8c-30.797 28.667-82.925 73.323-130.547 109.935c-23.812 18.306-46.64 34.665-64.373 45.828c-6.668 4.197-13.008 7.059-18.212 9.272c-5.469-2.988-12.41-7.196-19.611-12.607c-14.5-10.897-29.94-24.809-46.763-37.224c-.262-.199-.538-.4-.8-.601c-149.294-113.553-306.55-251.435-382.169-390.44c-61.391-131.153-58.712-288.132 28.017-380.368c117.926-104.852 293.123-82.057 380.5 25.549l42.56 52.366l41.159-53.433c23.682-30.723 51.943-54.21 86.253-72.044c35.963-14.049 71.694-21.29 106.066-22.08"></svg:path>`,
})
export class ElHeartEmptyIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elHourglassIcon],svg[el-hourglass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M109.217 0v52.567C106.194 455.64 53.525 319.939 333.036 600c-284.6 280.454-223.819 149.32-223.819 547.434V1200h981.519v-52.566c2.99-402.972 55.98-268.045-223.408-547.434c284.422-279.638 223.408-149.581 223.408-547.433V0zM214.35 105.133h771.252c14.357 296.43-18.396 245.5-230.39 457.495L718.251 600l36.961 37.372c236.757 234.1 230.39 153.272 230.39 457.494H214.35c-14.399-296.413 18.597-245.734 230.39-457.905L481.701 600l-36.961-36.961C208.141 328.703 214.35 409.382 214.35 105.133M321.126 321.15c90.783 77.596 218.086 111.986 244.764 265.708h50.924C614.68 448.637 770.24 398.087 878.416 321.15c-214.421 23.11-301.874 35.51-557.29 0m276.797 439.013c-140.022-.882-279.086 70.906-276.386 218.07h557.289c.103-143.634-140.88-217.187-280.903-218.07"></svg:path>`,
})
export class ElHourglassIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elIdeaIcon],svg[el-idea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M567.663 0v190.423h64.679V0h-64.685zm-264.11 57.225l-52.992 37.103l109.203 155.946l52.963-37.104zm592.886 0L787.268 213.171l52.971 37.104L949.44 94.328l-52.992-37.103zm-296.45 185.299c-158.227 0-286.493 96.083-286.493 214.625l162.772 492.948h247.47l162.758-492.948c0-118.54-128.258-214.625-286.492-214.625zM85.465 299.673l-22.099 60.814l178.849 65.114l22.181-60.785l-178.935-65.143zm1029.062 0l-178.936 65.148l22.106 60.792l178.936-65.125zM255.756 577.681l-183.9 49.326l16.686 62.431l183.9-49.255l-16.683-62.502zm688.48 0l-16.674 62.501l183.9 49.247l16.674-62.432l-183.9-49.318zM472.66 986.032v85.686h254.687v-85.673H472.661zm0 128.282V1200h254.687v-85.672H472.661z"></svg:path>`,
})
export class ElIdeaIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elIdeaAltIcon],svg[el-idea-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-20.361 221.777h40.723v120.044h-40.723zm-166.553 36.035l68.848 98.291l-33.398 23.438l-68.848-98.291zm373.828 0l33.398 23.438l-68.848 98.291l-33.398-23.438zM600 374.634c99.754 0 180.615 60.549 180.615 135.278L678.003 820.679H521.997L419.385 509.912c0-74.73 80.867-135.278 180.615-135.278m-324.39 36.035l112.793 41.089l-13.989 38.306l-112.72-41.089zm648.78 0l13.916 38.306l-112.793 41.089l-13.916-38.306zM382.983 585.938l10.547 39.404l-115.942 31.055l-10.547-39.404zm434.034 0l115.942 31.055l-10.547 39.404l-115.942-31.055zm-297.29 257.446h160.547v53.979H519.727zm0 80.859h160.547v53.979H519.727z"></svg:path>`,
})
export class ElIdeaAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elInboxAltIcon],svg[el-inbox-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-73.242 216.064h146.484v168.237h85.474L600 622.412l-158.716-238.11h85.474zM239.502 589.6h236.865c0 68.266 55.367 123.706 123.633 123.706s123.633-55.44 123.633-123.706h236.865v347.461H239.502z"></svg:path>`,
})
export class ElInboxAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elInfoCircleIcon],svg[el-info-circle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-18.823 205.884c27.494.001 49.881 7.415 67.163 22.339c17.281 14.926 25.928 34.609 25.928 58.96c0 24.353-8.646 43.962-25.928 58.887c-17.282 14.926-39.669 22.413-67.163 22.412c-27.494.001-49.882-7.486-67.163-22.412c-16.496-14.925-24.756-34.534-24.756-58.887c0-24.351 8.26-44.034 24.756-58.96c17.281-14.925 39.669-22.338 67.163-22.339m85.986 262.72l23.584 27.1c-12.569 32.993-18.896 69.509-18.896 109.57v288.721c0 10.212.846 17.239 2.417 21.167c2.356 3.928 7.452 7.864 15.308 11.792c14.14 8.641 34.908 16.9 62.402 24.756l-8.203 42.407c-67.557-7.07-115.109-10.547-142.603-10.547s-74.587 3.477-141.357 10.547l-9.448-42.407c28.279-6.284 49.121-14.157 62.476-23.584c11.783-7.069 17.651-18.42 17.651-34.131v-294.58c0-27.493-10.65-41.235-31.86-41.235l-41.235 8.203l-9.375-47.095c28.279-11.782 65.567-23.206 111.914-34.204c46.345-10.998 82.087-16.48 107.225-16.48"></svg:path>`,
})
export class ElInfoCircleIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elInstagramIcon],svg[el-instagram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elIphoneHomeIcon],svg[el-iphone-home-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M392.212 342.847h415.503c27.966 1.894 49.067 22.242 49.438 48.047v416.895c-1.982 29.059-23.122 49.012-49.438 49.365H392.212c-29.04-1.98-49.012-23.074-49.365-49.365V390.894c1.602-27.831 24.771-47.717 49.365-48.047m69.946 94.629c-14.911.37-24.526 11.846-24.683 24.756V736.45c.387 14.886 11.808 24.6 24.683 24.756h275.61c14.918-.387 24.602-11.853 24.756-24.756V462.231c-.365-14.945-11.815-24.602-24.756-24.756z"></svg:path>`,
})
export class ElIphoneHomeIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elKeyIcon],svg[el-key-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLaptopIcon],svg[el-laptop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M120.264 172.705v628.052h959.473V172.705zm119.018 114.478h721.436v399.17H239.282zM0 857.886v106.201l60.938 63.208h1078.125L1200 964.087V857.886zm488.745 34.79h222.51v96.167h-222.51z"></svg:path>`,
})
export class ElLaptopIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elLaptopAltIcon],svg[el-laptop-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M289.966 323.877h620.068v405.835H289.966zm76.904 73.975v257.959h466.26V397.852zM212.256 766.626h775.488v68.628l-39.404 40.869H251.66l-39.404-40.869zm315.82 22.485v62.183h143.848v-62.183z"></svg:path>`,
})
export class ElLaptopAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elLastfmIcon],svg[el-lastfm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLeafIcon],svg[el-leaf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLinkIcon],svg[el-link-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLinkedinIcon],svg[el-linkedin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elListAltIcon],svg[el-list-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLivejournalIcon],svg[el-livejournal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLockIcon],svg[el-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elLockAltIcon],svg[el-lock-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-4.321 274.658c81.026.386 155.088 52.056 186.548 124.146c10.762 25.109 16.479 50.903 16.479 78.882v71.339h98.291v376.317H303.003V549.023h90.381c-.819-50.406-1.856-108.07 15.82-150.221c34.37-75.909 105.448-124.53 186.475-124.144m-4.395 119.824c-44.881.944-74.48 35.073-78.81 83.202v71.339h167.14v-72.07c-2.061-45.641-36.604-81.214-83.937-82.471a93 93 0 0 0-4.393 0"></svg:path>`,
})
export class ElLockAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elMagicIcon],svg[el-magic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elMagnetIcon],svg[el-magnet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elMaleIcon],svg[el-male-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M727.498 0v167.082h182.347L669.487 405.84c-67.443-43.645-147.834-68.973-234.15-68.973c-238.345 0-431.585 193.202-431.585 431.547C3.751 1006.76 196.992 1200 435.337 1200s431.548-193.24 431.548-431.586c0-90.596-27.903-174.67-75.601-244.09l236.321-236.321V468.75h167.082c0-146.475 1.587-322.656 1.561-468.75zM435.337 510.575c142.412 0 257.839 115.427 257.839 257.839s-115.427 257.878-257.839 257.878s-257.878-115.466-257.878-257.878s115.465-257.839 257.878-257.839"></svg:path>`,
})
export class ElMaleIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elMicIcon],svg[el-mic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elMicAltIcon],svg[el-mic-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elMusicIcon],svg[el-music-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m364.798 80.329l-30.419 790.778c-40.935-21.007-92.292-30.096-146.179-22.449C72.007 865.114-11.66 952.766 1.33 1044.407c12.992 91.647 117.714 152.585 233.902 136.124c103.119-14.613 180.524-85.303 187.557-165.075l.022.045c.016-.181.026-.452.042-.656c.173-2.026.271-4.08.346-6.119c4.327-82.368 30.815-708.026 30.815-708.026l652.416-67.219l-29.467 563.479c-41.867-23.303-95.68-33.684-152.264-25.665C808.507 787.768 724.845 875.4 737.836 967.054c12.986 91.639 117.709 152.587 233.901 136.107c105.313-14.906 183.777-88.319 187.895-170.171l.05-.05C1161.89 896.157 1198.7 46.799 1200 16.784z"></svg:path>`,
})
export class ElMusicIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elMyspaceIcon],svg[el-myspace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elNetworkIcon],svg[el-network-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elOffIcon],svg[el-off-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elOkCircleIcon],svg[el-ok-circle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elOpensourceIcon],svg[el-opensource-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPaperClipIcon],svg[el-paper-clip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPaperClipAltIcon],svg[el-paper-clip-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPathIcon],svg[el-path-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1156.8 460.801c-1.741 127.978-57.59 244.043-148 318.399c-117.563 89.48-265.186 119.294-397.601 121.6v72.001c-3.547 92.429-57.571 172.648-134.399 207.999c-28.249 13.41-59.446 19.088-88 19.2c-40.263-.487-79.431-12.662-112-28.8v-208c27.473 19.356 58.955 32.385 90.4 23.199c27.814-10.322 40.547-32.075 40.8-58.399V350.4h203.2v360c46.688-.646 92.747-5.771 135.2-15.2c55.65-13.509 108.654-34.821 148.8-70.4c49.263-46.933 70.78-102.815 71.2-164c-.765-90.595-46.353-165.932-116-209.6c-78.943-45.167-166.48-60.457-250.4-60.8c-90.493 1.983-179.56 19.778-252 64.8c-73.984 47.895-113.732 127.091-114.4 205.6c4.699 56.578 19.186 135.353 57.6 171.2L161.6 771.2c-42.053-42.06-69.765-93.552-88-145.602c-17.898-55.054-30.173-109.859-30.4-164.8c2.212-133.606 61.584-254.216 155.2-332.8C316.522 35.655 464.832.706 600 0c147.994 2.516 294.258 39.785 403.2 127.2c102.159 86.84 152.695 212.531 153.6 333.601"></svg:path>`,
})
export class ElPathIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPencilIcon],svg[el-pencil-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPencilAltIcon],svg[el-pencil-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m201.861 187.424c17.59.139 34.667 6.627 47.568 19.529l99.849 99.81c27.6 27.601 25.709 74.104-4.143 104.027c-29.925 29.925-76.502 31.704-104.026 4.18l-99.811-99.81c-27.601-27.525-25.671-74.177 4.18-104.027c15.859-15.899 36.45-23.866 56.383-23.709M637.348 319.301l199.658 199.62l-324.468 324.391L312.88 643.655zM261.056 681.459l210.6 210.601l-263.335 52.735z"></svg:path>`,
})
export class ElPencilAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPersonIcon],svg[el-person-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPhoneIcon],svg[el-phone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1183.326 997.842l-169.187 167.83c-24.974 25.612-58.077 34.289-90.316 34.328c-142.571-4.271-277.333-74.304-387.981-146.215C354.22 921.655 187.574 757.82 82.984 559.832C42.87 476.809-4.198 370.878.299 278.209c.401-34.86 9.795-69.073 34.346-91.543L203.831 17.565c35.132-29.883 69.107-19.551 91.589 15.257l136.111 258.102c14.326 30.577 6.108 63.339-15.266 85.188l-62.332 62.3c-3.848 5.271-6.298 11.271-6.36 17.801c23.902 92.522 96.313 177.799 160.281 236.486c63.967 58.688 132.725 138.198 221.977 157.021c11.032 3.077 24.545 4.158 32.438-3.179l72.51-73.743c24.996-18.945 61.086-28.205 87.771-12.714h1.272l245.51 144.943c36.041 22.592 39.799 66.252 13.994 92.815"></svg:path>`,
})
export class ElPhoneIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPhoneAltIcon],svg[el-phone-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M384.375 238.33c12.362-.729 23.536 6.66 32.007 19.775l82.031 155.566c8.637 18.434 3.729 38.172-9.155 51.343l-37.573 37.573c-2.319 3.178-3.845 6.757-3.882 10.693c14.409 55.775 58.117 107.223 96.681 142.603c38.562 35.38 80.009 83.281 133.812 94.629c6.65 1.855 14.797 2.52 19.556-1.903l43.652-44.458c15.068-11.421 36.866-16.956 52.954-7.617h.732l148.021 87.378c21.728 13.619 23.979 39.944 8.423 55.957L849.683 941.016c-15.056 15.44-35.058 20.631-54.491 20.654c-85.948-2.575-167.158-44.759-233.862-88.11c-109.49-79.653-209.923-178.446-272.975-297.803c-24.182-50.05-52.589-113.91-49.878-169.774c.242-21.016 5.928-41.605 20.728-55.151l101.953-101.953c7.942-6.758 15.799-10.111 23.217-10.549"></svg:path>`,
})
export class ElPhoneAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPicasaIcon],svg[el-picasa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M910.828 94.9C1088.896 205.959 1198.984 397.994 1200 600.633q0 101.91-34.395 194.904H910.828zm228.026 763.058c-94.882 190.637-281.383 312.875-484.075 333.758c-103.906 6.653-216.735-13.006-300.638-49.682V857.958zM0 600.633C2.652 373.328 132.909 172.7 326.115 73.246L554.14 277.067L21.656 754.773Q0 675.793 0 600.633m290.446 507.007C177.14 1036.634 90.612 933.589 43.313 819.741l247.133-222.929zm556.688-650.955L389.809 45.22C459.643 21.745 531.65 7.251 600 7.002q129.936 0 247.134 53.503z"></svg:path>`,
})
export class ElPicasaIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPictureIcon],svg[el-picture-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPinterestIcon],svg[el-pinterest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPlurkAltIcon],svg[el-plurk-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPodcastIcon],svg[el-podcast-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elPrintIcon],svg[el-print-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M367.456 73.572v181.2h-47.388L40.21 373.865h1119.58L879.932 254.772h-47.388v-181.2zM0 443.444v364.381h185.742l-65.259 318.603h959.033l-65.259-318.604H1200V443.443zm291.431 137.329h617.065l93.75 457.765H197.681z"></svg:path>`,
})
export class ElPrintIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elPuzzleIcon],svg[el-puzzle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elQrcodeIcon],svg[el-qrcode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0v545.312h545.312V0zm654.688 0v545.312H1200V0zM108.594 108.594h328.125v328.125H108.594zm654.687 0h328.125v328.125H763.281zM217.969 219.531v108.594h110.156V219.531zm653.906 0v108.594h108.594V219.531zM0 654.688V1200h545.312V654.688zm654.688 0V1200h108.595V873.438h108.594v108.595H1200V654.688h-108.594v108.595H980.469V654.688zM108.594 763.281h328.125v328.125H108.594zm109.375 108.594v110.156h110.156V871.875zm653.906 219.531V1200h108.594v-108.594zm219.531 0V1200H1200v-108.594z"></svg:path>`,
})
export class ElQrcodeIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elQuestionIcon],svg[el-question-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M585.558 0c-97.152-.233-273.994 93.271-279.6 176.4s11.325 88.252 19.2 92.8h91.2c20.839-47.054 46.22-74.561 112.8-74s139.612 83.846 108.8 157.6s-59.285 99.443-97.2 179.2c-37.914 79.757-50.579 200.231-.8 300.4l112.4 2c-27.82-142.988 119.439-270.381 178-358.4c58.559-88.019 64.125-121.567 64.8-194.4c-.517-69.114-25.544-138.181-80-194.4S682.71.234 585.558 0m5.599 927.601c-75.174 0-136 60.825-136 135.999c0 75.176 60.826 136.4 136 136.4s136-61.226 136-136.4s-60.825-135.999-136-135.999"></svg:path>`,
})
export class ElQuestionIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elQuestionSignIcon],svg[el-question-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-10.84 150.366c72.81.176 131.308 23.199 172.119 65.332s59.524 93.882 59.912 145.679c-.507 54.584-4.675 79.714-48.561 145.679S618.407 668.475 639.257 775.635l-84.229-1.465c-37.308-75.07-27.828-165.374.586-225.146s49.711-78.979 72.803-134.253s-31.621-117.72-81.519-118.141s-68.904 20.18-84.521 55.444h-68.335c-5.902-3.408-18.63-7.206-14.429-69.507c4.202-62.3 136.738-132.377 209.547-132.201m4.248 695.142c56.338 0 101.88 45.615 101.88 101.953s-45.542 102.173-101.88 102.173s-101.953-45.835-101.953-102.173s45.615-101.953 101.953-101.953"></svg:path>`,
})
export class ElQuestionSignIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elQuoteAltIcon],svg[el-quote-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m-45.923 282.422l25.781 118.727c-75.541 16.721-145.005 38.468-139.38 122.826h88.77v315.968H261.841V544.629c.095-234.691 172.401-253.786 292.236-262.207m358.228 0l25.854 118.727c-75.541 16.721-145.005 38.468-139.38 122.826h88.77v315.968H620.142V544.629c.094-234.691 172.328-253.786 292.163-262.207"></svg:path>`,
})
export class ElQuoteAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elQuotesIcon],svg[el-quotes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M518.474 105.344C305.831 120.286.168 154.236 0 570.687v523.97h474.504v-560.61H316.946C306.965 384.354 430.23 345.701 564.274 316.03zm635.724 0c-212.643 14.942-518.306 48.893-518.473 465.343v523.97h474.505v-560.61H952.672C942.689 384.354 1065.956 345.701 1200 316.03z"></svg:path>`,
})
export class ElQuotesIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRandomIcon],svg[el-random-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M935.926 42.203v186.061H763.958c-54.408 0-114.484 26.559-164.729 77.32c-50.242 50.761-104.842 126.065-191.527 249.904c-87.076 124.394-135.567 199.565-165.807 233.346c-30.24 33.78-25.376 30.882-69.388 30.882H0v147.863h172.507c66.078 0 132.54-27.619 179.515-80.093s91.312-125.164 176.742-247.208c85.82-122.601 140.381-195.159 175.512-230.651c35.129-35.491 36.641-33.5 59.685-33.5h171.967v194.147L1200 306.276zM0 228.263v147.863h172.507c44.012 0 39.148-2.975 69.388 30.805c19.456 21.734 51.507 67.826 91.49 125.915c5.419-7.773 7.973-11.521 13.708-19.716c21.78-31.114 41.563-59.187 59.838-84.79c6.36-8.91 11.688-15.939 17.714-24.259c-27.021-39.039-49.525-70.001-72.623-95.803c-46.975-52.474-113.437-80.015-179.515-80.015zm935.926 401.464v189.988H763.958c-23.043 0-24.554 1.915-59.684-33.577c-23.237-23.477-56.146-65.093-99.809-124.76c-5.281 7.49-9.555 13.418-15.095 21.333c-30.571 43.674-51.648 75.183-73.777 107.816c31.395 41.578 58.12 73.875 83.637 99.652c50.242 50.763 110.319 77.397 164.729 77.397h171.968v190.22L1200 893.801z"></svg:path>`,
})
export class ElRandomIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRedditIcon],svg[el-reddit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elRefreshIcon],svg[el-refresh-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C308.74 0 66.009 207.555 11.499 482.812h166.553C229.37 297.756 398.603 161.719 600 161.719c121.069 0 230.474 49.195 309.668 128.613l-192.48 192.48H1200V0l-175.781 175.781C915.653 67.181 765.698 0 600 0M0 717.188V1200l175.781-175.781C284.346 1132.819 434.302 1200 600 1200c291.26 0 533.991-207.555 588.501-482.812h-166.553C970.631 902.243 801.396 1038.281 600 1038.281c-121.069 0-230.474-49.195-309.668-128.613l192.48-192.48z"></svg:path>`,
})
export class ElRefreshIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRemoveSignIcon],svg[el-remove-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M411.475 262.5L600 451.025L788.525 262.5L937.5 411.475L748.975 600L937.5 788.525L788.525 937.5L600 748.975L411.475 937.5L262.5 788.525L451.025 600L262.5 411.475z"></svg:path>`,
})
export class ElRemoveSignIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRepeatIcon],svg[el-repeat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600c222.411 0 416.39-121.104 520.02-300.879L908.79 777.612C847.217 884.405 732.127 956.47 600 956.47c-196.873 0-356.47-159.597-356.47-356.47S403.127 243.53 600 243.53c84.387 0 161.732 29.521 222.729 78.589L665.186 434.18L1200 612.524V53.613l-174.17 123.926C917.124 67.952 766.553 0 600 0"></svg:path>`,
})
export class ElRepeatIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRepeatAltIcon],svg[el-repeat-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m0 252.466c96.469 0 183.717 39.359 246.68 102.832l100.854-71.777v323.73L637.72 503.979l91.261-64.966c-35.33-28.42-80.104-45.482-128.979-45.482c-114.03 0-206.47 92.438-206.47 206.47S485.97 806.47 600 806.47c76.528 0 143.194-41.709 178.857-103.563l122.313 70.312C841.148 877.346 728.821 947.534 600 947.534c-191.932 0-347.534-155.604-347.534-347.534S408.068 252.466 600 252.466"></svg:path>`,
})
export class ElRepeatAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elRssIcon],svg[el-rss-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1200 1200C1200 537.258 662.742 0 0 0v240.015c530.193 0 959.985 429.792 959.985 959.985zm-480.029 0c0-397.646-322.324-719.971-719.971-719.971v239.94c265.097 0 480.029 214.934 480.029 480.029zm-479.956 0c0-132.549-107.466-240.015-240.015-240.015V1200z"></svg:path>`,
})
export class ElRssIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elScissorsIcon],svg[el-scissors-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elScreenAltIcon],svg[el-screen-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M250.049 310.474h699.902v462.013h-254.15v66.576h61.963v50.465H442.236v-50.465h61.963v-66.576h-254.15zm86.133 87.231v287.622h527.637V397.705z"></svg:path>`,
})
export class ElScreenAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elScreenshotIcon],svg[el-screenshot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSearchIcon],svg[el-search-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSearchAltIcon],svg[el-search-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m41.162 260.01c160.533 0 290.625 130.166 290.625 290.698c0 160.533-130.092 290.625-290.625 290.625c-48.581 0-94.368-11.885-134.619-32.959c.041.186.106.401.146.586L375.586 939.99L268.213 832.544l126.416-126.489c.209-.094.45-.129.659-.22c-28.387-44.893-44.824-98.088-44.824-155.127c0-160.533 130.165-290.698 290.698-290.698m0 129.126c-89.213 0-161.572 72.359-161.572 161.572s72.359 161.499 161.572 161.499s161.499-72.286 161.499-161.499s-72.285-161.572-161.499-161.572"></svg:path>`,
})
export class ElSearchAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elShareAltIcon],svg[el-share-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M754.553 35.03v294.208C487.317 329.246 0 332.178 0 1164.97c55.25-556.9 309.061-560.402 754.553-560.408v321.292L1200 480.407z"></svg:path>`,
})
export class ElShareAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elShoppingCartIcon],svg[el-shopping-cart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elShoppingCartSignIcon],svg[el-shopping-cart-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSkypeIcon],svg[el-skype-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSlideshareIcon],svg[el-slideshare-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSmileyAltIcon],svg[el-smiley-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M286.157 286.157h627.686v627.686H286.157zm205.152 119.385c-37.424 0-67.749 30.325-67.749 67.749s30.325 67.749 67.749 67.749c37.425 0 67.822-30.325 67.822-67.749s-30.399-67.749-67.822-67.749m211.23 0c-37.424 0-67.749 30.325-67.749 67.749s30.325 67.749 67.749 67.749s67.749-30.325 67.749-67.749s-30.325-67.749-67.749-67.749M381.885 618.896c0 120.463 97.652 218.114 218.115 218.114s218.115-97.651 218.115-218.114z"></svg:path>`,
})
export class ElSmileyAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elSoundcloudIcon],svg[el-soundcloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elSpeakerIcon],svg[el-speaker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 350.411h282.787L708.197 3.688v1192.623L282.787 849.59H0zm868.033-56.558q125.409 125.41 127.868 304.918q0 172.131-127.868 295.082l-86.066-88.523c59.018-59.018 88.525-128.688 88.525-209.018q0-122.95-88.525-213.934zm147.541-145.082Q1199.999 333.198 1200 593.853q0 260.656-184.426 447.541l-90.984-90.982q147.541-145.083 147.541-355.327q0-210.246-147.541-357.788z"></svg:path>`,
})
export class ElSpeakerIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elSpotifyIcon],svg[el-spotify-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elStackoverflowIcon],svg[el-stackoverflow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elStarEmptyIcon],svg[el-star-empty-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m605.847 26.888l-37.454 107.02l-112.955 322.836l-342.008-1.483L0 454.727l90.281 68.734l272.087 207.211l-107.137 324.737l-35.495 107.73l93.249-64.58l281.11-194.747l275.827 202.228l91.468 67.072l-32.646-108.622l-98.412-327.586l277.607-199.792l92.061-66.3l-113.37-2.493l-341.949-7.717l-104.23-325.686zm-3.205 239.145l77.936 243.538l8.25 25.818l27.065.595l255.646 5.697l-207.509 149.4l-22.021 15.788l7.835 25.938l73.542 244.903l-206.202-151.18l-21.844-16.026l-22.259 15.433l-210.179 145.602l80.13-242.825l8.429-25.701l-21.546-16.44l-203.354-154.86l255.646 1.128l27.066.119l8.962-25.583z"></svg:path>`,
})
export class ElStarEmptyIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elStumbleuponIcon],svg[el-stumbleupon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elTagIcon],svg[el-tag-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elTagsIcon],svg[el-tags-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elTextHeightIcon],svg[el-text-height-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M991.699 0L783.398 209.399H922.85V990.6H783.398L991.699 1200L1200 990.601h-139.38V209.399H1200zM5.933 207.642L0 420.703h74.048c0-146.136.1-145.972 186.841-145.972V862.5c0 73.264-.037 73.141-102.539 71.338v58.521h379.468v-58.521c-102.335 0-102.539-.179-102.539-71.338V274.731c186.839 0 187.354.041 187.354 145.972h73.535l-5.347-213.062z"></svg:path>`,
})
export class ElTextHeightIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elTextWidthIcon],svg[el-text-width-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m257.813 0l-5.859 213.062h74.048c0-146.136.027-145.972 186.768-145.972v587.77c0 73.264-.036 73.142-102.538 71.338v58.521h379.54v-58.521c-102.335 0-102.538-.18-102.538-71.338V67.09c186.839 0 187.279.041 187.279 145.972h73.535L942.7 0zm-48.414 783.398L0 991.699L209.399 1200v-139.38H990.6V1200L1200 991.699L990.601 783.398V922.85H209.399z"></svg:path>`,
})
export class ElTextWidthIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elThumbsDownIcon],svg[el-thumbs-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1141.254 797.17H842.888c6.042 48.99 14.657 96.04 25.361 141.727c5.814 86.875-52.362 149.479-113.38 190.953q-23.869 14.92-50.723 7.459c-16.914-5.968-29.348-17.899-37.298-35.804L531.094 797.17H393.846c-36.075-2.562-59.249-27.021-59.675-59.673V134.795c2.563-36.075 27.023-59.249 59.675-59.673h551.979c30.137 2.299 59.875 13.033 84.289 26.853c42.318 25.706 72.122 61.157 85.779 104.429l83.543 519.159c4.976 39.367-23.686 71.109-58.182 71.607m-923.445 11.934H43.264C19.021 807.349.333 789.809 0 767.333V101.975c1.926-25.64 20.297-41.478 43.264-41.771h174.545c25.302 1.761 42.946 18.557 43.263 41.771v665.358c-2.085 24.651-21.115 41.471-43.263 41.771"></svg:path>`,
})
export class ElThumbsDownIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elThumbsUpIcon],svg[el-thumbs-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M717.534 60.514c42.51-.457 82.729 43.455 110.594 74.778c65.435 80.402 29.326 169.5 14.94 267.032h298.455c40.347.301 61.029 30.64 58.225 71.631l-83.567 517.806c-18.937 66.216-92.545 124.507-170.138 132.786H393.96c-32.659-.426-57.13-23.607-59.691-59.691v-602.84c.424-32.654 23.607-57.13 59.691-59.689h137.251L666.999 97.939c7.552-16.428 27.347-37.054 50.535-37.425M217.89 390.388c22.971.293 41.284 16.175 43.21 41.819v665.534c-.333 22.479-18.962 39.989-43.21 41.748H43.286c-22.155-.304-41.2-17.095-43.286-41.748V432.208c.316-23.22 17.976-40.06 43.286-41.819z"></svg:path>`,
})
export class ElThumbsUpIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elTintIcon],svg[el-tint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elTumblrIcon],svg[el-tumblr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elTwitterIcon],svg[el-twitter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1200 216.995q-12.04 25.42-44.816 64.214c-32.776 38.794-48.828 48.606-80.937 68.227q1.34 10.703 2.007 20.067c3.463 96.12-19.561 195.847-51.505 278.93c-61.918 154.473-156.795 278.795-292.308 363.21c-141.314 81.058-305.892 98.298-457.525 83.612C174.25 1083.694 75.033 1050.822 0 988.901c137.233 16.404 265.305-30.28 366.555-105.687c-112.472 2.847-194.191-78.514-232.775-172.575c17.393 4.559 35.588 4.009 52.174 2.677c20.416-1.918 39.796-3.833 58.863-8.026c-71.717-23.139-134.469-65.675-167.224-129.767c-19.213-40.61-27.888-79.282-28.093-123.077c33.605 17.693 74.028 34.937 111.037 33.444c-55.892-47.347-100.7-107.857-109.03-177.258c-5.259-57.866 9.221-110.688 30.101-159.866c83.607 91.885 177.415 167.502 285.618 214.047c73.998 30.302 147.786 46.507 224.081 46.822c-8.807-68.145-1.959-134.05 30.101-189.967c37.73-60.118 92.778-94.998 154.516-112.375c88.337-22.652 174.496 9.345 228.763 70.903c58.521-6.321 114.58-32.283 159.197-58.863c-18.958 57.41-55.874 114.492-109.699 141.806c51.247-9.488 100.149-24.659 145.815-44.144"></svg:path>`,
})
export class ElTwitterIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elUniversalAccessIcon],svg[el-universal-access-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elUnlockIcon],svg[el-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elUploadIcon],svg[el-upload-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 1200C268.63 1200 0 931.369 0 600S268.63 0 600 0s600 268.63 600 600s-268.631 600-600 600m0-1069.565c-259.369 0-469.565 210.261-469.565 469.565c0 259.305 210.196 469.564 469.565 469.564S1069.564 859.305 1069.564 600c0-259.304-210.195-469.565-469.564-469.565m117.392 720.652H482.608V584.348H335.87L600 335.87l264.131 248.478H717.392z"></svg:path>`,
})
export class ElUploadIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elUsdIcon],svg[el-usd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elUserIcon],svg[el-user-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elViadeoIcon],svg[el-viadeo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elVideoAltIcon],svg[el-video-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M242.285 329.297h715.356v541.406H242.285zm87.744 87.744v365.918H869.97V417.041zm189.698 63.721l210.719 121.51l-210.719 122.24z"></svg:path>`,
})
export class ElVideoAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elVimeoIcon],svg[el-vimeo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elVkontakteIcon],svg[el-vkontakte-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elVolumeOffIcon],svg[el-volume-off-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elVolumeUpIcon],svg[el-volume-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 384.805h243.816L610.6 85.866v1028.269l-366.784-298.94H0zm748.41-48.763q108.128 108.126 110.247 262.897q0 148.41-110.247 254.418l-74.205-76.326q76.325-76.324 76.325-180.211q0-106.008-76.325-184.453zm127.208-125.088q159.012 159.01 159.011 383.745c0 149.825-53.003 278.444-159.011 385.866l-78.445-78.445q127.209-125.089 127.209-306.36T797.174 287.28zM992.227 94.346q97.527 97.527 152.649 226.855Q1200 450.529 1200 594.699t-55.124 274.559c-55.124 130.39-87.632 162.896-152.649 227.916l-76.324-76.326q175.97-175.971 175.972-425.088q0-249.117-175.972-425.088z"></svg:path>`,
})
export class ElVolumeUpIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elW3cIcon],svg[el-w3c-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elWebsiteIcon],svg[el-website-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M698.598 922.244h-199.6V722.646h199.6zm252.506 0H751.503V722.646h199.601zm-505.012 0H246.493V722.646h199.599zm505.012-631.262v367.936h-704.61V290.982zm101-105.812H147.896v829.66h904.209zM0 1161.521V38.478h1200v1123.045z"></svg:path>`,
})
export class ElWebsiteIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elWebsiteAltIcon],svg[el-website-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M281.154 301.634h637.653v596.732H281.154zm78.611 77.963V820.44h480.471V379.597zm52.393 56.231H786.55v195.479H412.158zm0 229.369h106.041v106.041H412.158zm134.156 0h106.078v106.041H546.314zm134.157 0H786.55v106.041H680.471z"></svg:path>`,
})
export class ElWebsiteAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elWheelchairIcon],svg[el-wheelchair-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elWordpressIcon],svg[el-wordpress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elWrenchIcon],svg[el-wrench-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[elWrenchAltIcon],svg[el-wrench-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0m163.403 239.868c22.729-.064 45.519 3.784 67.163 11.572L711.108 370.898l32.959 85.033L829.1 488.89l119.46-119.456c24.923 69.264 9.648 149.801-45.85 205.299s-135.962 70.771-205.225 45.85L357.86 960.133L239.868 842.139l339.551-339.624c-24.922-69.263-9.647-149.726 45.85-205.225c38.155-38.155 88.127-57.281 138.134-57.422m-430.81 578.54c-13.543 13.542-13.543 35.457 0 48.999s35.457 13.542 48.999 0s13.542-35.457 0-48.999c-14.679-13.344-36.351-12.267-48.999 0"></svg:path>`,
})
export class ElWrenchAltIcon {
  readonly viewBox = input("0 0 1200 1200")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[elZoomOutIcon],svg[el-zoom-out-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
