...
@Component({
  standalone: true,
  selector: 'svg[emojioneV1ClockwiseLeftRightArrowsIcon],svg[emojione-v1-clockwise-left-right-arrows-icon]',
  host: {
    role: 'img',
