...
@Component({
  standalone: true,
  selector: 'svg[twemojiNoOneUnderEighteenIcon],svg[twemoji-no-one-under-eighteen-icon]',
  host: {
    role: 'img',
