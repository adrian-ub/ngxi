...
@Component({
  standalone: true,
  selector: 'svg[twemojiSmilingFaceWithSmilingEyesIcon],svg[twemoji-smiling-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
