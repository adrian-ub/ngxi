...
@Component({
  standalone: true,
  selector: 'svg[twemojiSmilingFaceWithHaloIcon],svg[twemoji-smiling-face-with-halo-icon]',
  host: {
    role: 'img',
