...
@Component({
  standalone: true,
  selector: 'svg[twemojiPinchingHandMediumLightSkinToneIcon],svg[twemoji-pinching-hand-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
