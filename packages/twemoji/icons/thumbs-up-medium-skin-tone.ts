...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsUpMediumSkinToneIcon],svg[twemoji-thumbs-up-medium-skin-tone-icon]',
  host: {
    role: 'img',
