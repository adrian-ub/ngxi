...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsDownMediumLightSkinToneIcon],svg[twemoji-thumbs-down-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
