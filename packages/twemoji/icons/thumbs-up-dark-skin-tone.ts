...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsUpDarkSkinToneIcon],svg[twemoji-thumbs-up-dark-skin-tone-icon]',
  host: {
    role: 'img',
