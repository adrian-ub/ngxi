...
@Component({
  standalone: true,
  selector: 'svg[twemojiHeartHandsMediumLightSkinToneIcon],svg[twemoji-heart-hands-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
