...
@Component({
  standalone: true,
  selector: 'svg[twemojiPinchingHandMediumSkinToneIcon],svg[twemoji-pinching-hand-medium-skin-tone-icon]',
  host: {
    role: 'img',
