...
@Component({
  standalone: true,
  selector: 'svg[twemojiFlagForFlagBosniaAndHerzegovinaIcon],svg[twemoji-flag-for-flag-bosnia-and-herzegovina-icon]',
  host: {
    role: 'img',
