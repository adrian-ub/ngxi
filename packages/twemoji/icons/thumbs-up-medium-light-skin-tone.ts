...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsUpMediumLightSkinToneIcon],svg[twemoji-thumbs-up-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
