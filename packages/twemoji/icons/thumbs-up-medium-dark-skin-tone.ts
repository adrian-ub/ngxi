...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsUpMediumDarkSkinToneIcon],svg[twemoji-thumbs-up-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
