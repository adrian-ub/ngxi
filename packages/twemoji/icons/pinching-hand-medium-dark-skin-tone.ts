...
@Component({
  standalone: true,
  selector: 'svg[twemojiPinchingHandMediumDarkSkinToneIcon],svg[twemoji-pinching-hand-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
