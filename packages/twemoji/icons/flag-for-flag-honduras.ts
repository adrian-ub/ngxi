...
@Component({
  standalone: true,
  selector: 'svg[twemojiFlagForFlagHondurasIcon],svg[twemoji-flag-for-flag-honduras-icon]',
  host: {
    role: 'img',
