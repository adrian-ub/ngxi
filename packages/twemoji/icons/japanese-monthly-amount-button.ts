...
@Component({
  standalone: true,
  selector: 'svg[twemojiJapaneseMonthlyAmountButtonIcon],svg[twemoji-japanese-monthly-amount-button-icon]',
  host: {
    role: 'img',
