...
@Component({
  standalone: true,
  selector: 'svg[twemojiPinchingHandDarkSkinToneIcon],svg[twemoji-pinching-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
