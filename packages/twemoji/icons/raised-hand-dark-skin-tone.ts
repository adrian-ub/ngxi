...
@Component({
  standalone: true,
  selector: 'svg[twemojiRaisedHandDarkSkinToneIcon],svg[twemoji-raised-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
