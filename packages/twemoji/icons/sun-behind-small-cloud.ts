...
@Component({
  standalone: true,
  selector: 'svg[twemojiSunBehindSmallCloudIcon],svg[twemoji-sun-behind-small-cloud-icon]',
  host: {
    role: 'img',
