...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsUpLightSkinToneIcon],svg[twemoji-thumbs-up-light-skin-tone-icon]',
  host: {
    role: 'img',
