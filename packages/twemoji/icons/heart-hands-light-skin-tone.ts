...
@Component({
  standalone: true,
  selector: 'svg[twemojiHeartHandsLightSkinToneIcon],svg[twemoji-heart-hands-light-skin-tone-icon]',
  host: {
    role: 'img',
