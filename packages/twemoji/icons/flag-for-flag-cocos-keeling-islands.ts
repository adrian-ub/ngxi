...
@Component({
  standalone: true,
  selector: 'svg[twemojiFlagForFlagCocosKeelingIslandsIcon],svg[twemoji-flag-for-flag-cocos-keeling-islands-icon]',
  host: {
    role: 'img',
