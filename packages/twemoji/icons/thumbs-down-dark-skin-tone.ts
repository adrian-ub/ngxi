...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsDownDarkSkinToneIcon],svg[twemoji-thumbs-down-dark-skin-tone-icon]',
  host: {
    role: 'img',
