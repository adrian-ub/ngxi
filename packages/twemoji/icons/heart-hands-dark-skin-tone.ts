...
@Component({
  standalone: true,
  selector: 'svg[twemojiHeartHandsDarkSkinToneIcon],svg[twemoji-heart-hands-dark-skin-tone-icon]',
  host: {
    role: 'img',
