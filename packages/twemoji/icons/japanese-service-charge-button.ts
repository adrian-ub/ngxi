...
@Component({
  standalone: true,
  selector: 'svg[twemojiJapaneseServiceChargeButtonIcon],svg[twemoji-japanese-service-charge-button-icon]',
  host: {
    role: 'img',
