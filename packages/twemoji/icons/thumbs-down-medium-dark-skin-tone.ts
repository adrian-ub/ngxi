...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsDownMediumDarkSkinToneIcon],svg[twemoji-thumbs-down-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
