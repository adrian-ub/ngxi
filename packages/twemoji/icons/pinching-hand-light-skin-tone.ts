...
@Component({
  standalone: true,
  selector: 'svg[twemojiPinchingHandLightSkinToneIcon],svg[twemoji-pinching-hand-light-skin-tone-icon]',
  host: {
    role: 'img',
