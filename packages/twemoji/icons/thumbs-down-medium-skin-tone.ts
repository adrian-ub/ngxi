...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsDownMediumSkinToneIcon],svg[twemoji-thumbs-down-medium-skin-tone-icon]',
  host: {
    role: 'img',
