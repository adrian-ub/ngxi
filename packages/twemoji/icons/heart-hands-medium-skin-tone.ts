...
@Component({
  standalone: true,
  selector: 'svg[twemojiHeartHandsMediumSkinToneIcon],svg[twemoji-heart-hands-medium-skin-tone-icon]',
  host: {
    role: 'img',
