...
@Component({
  standalone: true,
  selector: 'svg[twemojiHeartHandsMediumDarkSkinToneIcon],svg[twemoji-heart-hands-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
