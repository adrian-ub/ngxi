...
@Component({
  standalone: true,
  selector: 'svg[twemojiThumbsDownLightSkinToneIcon],svg[twemoji-thumbs-down-light-skin-tone-icon]',
  host: {
    role: 'img',
