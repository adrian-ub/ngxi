...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsAddColumnIcon],svg[flat-color-icons-add-column-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#90CAF9" d="M30 5H18c-2.2 0-4 1.8-4 4v30c0 2.2 1.8 4 4 4h12c2.2 0 4-1.8 4-4V9c0-2.2-1.8-4-4-4M18 39V9h12v30z"></svg:path><svg:circle cx="38" cy="38" r="10" fill="#43A047"></svg:circle><svg:g fill="#fff"><svg:path d="M36 32h4v12h-4z"></svg:path><svg:path d="M32 36h12v4H32z"></svg:path></svg:g>`,
})
export class FlatColorIconsAddColumnIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsAcceptDatabaseIcon],svg[flat-color-icons-accept-database-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#D1C4E9" d="M38 7H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2m0 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2v-6c0-1.1-.9-2-2-2m0 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2v-6c0-1.1-.9-2-2-2"></svg:path><svg:circle cx="38" cy="38" r="10" fill="#43A047"></svg:circle><svg:path fill="#DCEDC8" d="M42.5 33.3L36.8 39l-2.7-2.7l-2.1 2.2l4.8 4.8l7.8-7.8z"></svg:path>`,
})
export class FlatColorIconsAcceptDatabaseIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsBbcIcon],svg[flat-color-icons-bbc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsBiohazardIcon],svg[flat-color-icons-biohazard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#00A344" d="M24 13c-7.2 0-13 5.8-13 13s5.8 13 13 13s13-5.8 13-13s-5.8-13-13-13m0 22c-5 0-9-4-9-9s4-9 9-9s9 4 9 9s-4 9-9 9"></svg:path><svg:path fill="#00C853" d="M8.5 25.4c4-2.2 9-1.1 11.5 2.5c.1.1.2.1.3.1l1.2-.7c.1-.1.2-.2.1-.3c0-.2-.1-.4-.1-.6v-.6c0-.1 0-.1.1-.2c0-.1 0-.1.1-.2c0 0 0-.1.1-.1c0 0 0-.1.1-.1c0 0 0-.1.1-.1l.1-.1l.1-.1l.1-.1l.1-.1l.1-.1h.1c.2-.1.4-.2.5-.2s.2-.1.2-.3v-1.3c0-.1-.1-.2-.2-.2c-4.5-.4-8-4.1-8-8.6c0-4.1 3-7.6 6.9-8.4c.1 0 .2-.1.2-.3v-.5c0-.1-.1-.2-.2-.2c-5.6.9-10 5.8-10 11.7c0 1.3.2 2.6.6 3.8c-1.2.2-2.5.7-3.6 1.3c-5.2 3-7.3 9.2-5.2 14.5c.1.1.2.1.3.1l.3-.2c.1-.1.2-.2.1-.3c-1.2-3.8.3-8.1 4-10.1m30.5-4c-1.2-.7-2.4-1.1-3.6-1.3c.4-1.2.6-2.4.6-3.8c0-5.9-4.4-10.8-10.2-11.7c-.1 0-.2.1-.2.2v.4c0 .1.1.2.2.3c4 .8 6.9 4.3 6.9 8.4c0 4.5-3.5 8.2-8 8.6c-.1 0-.2.1-.2.2V24c0 .1.1.2.2.3c.2.1.4.1.6.2l.1.1c.1 0 .1.1.1.1l.3.3l.1.1l.1.1v.2s0 .1.1.1c0 .1 0 .1.1.2v.7c0 .2 0 .4-.1.6c0 .1 0 .2.1.3l1.2.7c.1.1.2 0 .3-.1c2.6-3.6 7.6-4.8 11.5-2.5c3.6 2.1 5.2 6.3 3.9 10.1c0 .1 0 .2.1.3l.3.2c.1.1.2 0 .3-.1c2.5-5.4.4-11.6-4.8-14.5m-8.2 18.9c-4-2.2-5.5-7.1-3.5-11.1c.1-.1 0-.2-.1-.3l-1.2-.7c-.1-.1-.2 0-.3 0c-.2.1-.3.3-.5.3c-.1 0-.1.1-.2.1s-.1 0-.2.1c-.1 0-.3.1-.4.1h-1.2c-.1 0-.1 0-.2-.1c0 0-.1 0-.1-.1h-.1c-.2-.1-.3-.2-.5-.3q-.15-.15-.3 0l-1.2.7c-.1.1-.1.2-.1.3c1.9 4 .4 8.8-3.5 11.1c-3.6 2.1-8.2 1.3-10.9-1.7c-.1-.1-.2-.1-.3-.1l-.3.2c-.1.1-.1.2-.1.3c3.6 4.5 10.2 5.8 15.4 2.8q1.8-1.05 3-2.4c.8.9 1.8 1.8 3 2.4c5.2 3 11.7 1.6 15.4-2.8c.1-.1 0-.2-.1-.3l-.3-.3c-.1-.1-.2 0-.3.1c-2.7 2.9-7.3 3.7-10.9 1.7"></svg:path>`,
})
export class FlatColorIconsBiohazardIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsBiomassIcon],svg[flat-color-icons-biomass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#9CCC65" d="M32 15V7H16v8L6.2 40c-.6 1.5.5 3 2.1 3h31.5c1.6 0 2.6-1.6 2.1-3z"></svg:path><svg:path fill="#8BC34A" d="M32 9H16c-1.1 0-2-.9-2-2s.9-2 2-2h16c1.1 0 2 .9 2 2s-.9 2-2 2"></svg:path><svg:path fill="#2E7D32" d="M28 30c0 4.4-4 8-4 8s-4-3.6-4-8s4-8 4-8s4 3.6 4 8"></svg:path><svg:path fill="#388E3C" d="M31.1 32.6c-2 4-7.1 5.4-7.1 5.4s-2-5 0-8.9s7.1-5.4 7.1-5.4s2 4.9 0 8.9"></svg:path><svg:path fill="#43A047" d="M16.9 32.6c2 4 7.1 5.4 7.1 5.4s2-5 0-8.9s-7.1-5.4-7.1-5.4s-2 4.9 0 8.9"></svg:path>`,
})
export class FlatColorIconsBiomassIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsBiotechIcon],svg[flat-color-icons-biotech-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#AD1457" d="M36 4c0 9.3-6 13.2-12.8 17.8C16.1 26.5 8 31.8 8 44h4c0-10.1 6.5-14.4 13.4-18.9C32.2 20.6 40 15.4 40 4z"></svg:path><svg:path fill="#AD1457" d="M38 41H11c-.6 0-1-.4-1-1s.4-1 1-1h27c.6 0 1 .4 1 1s-.4 1-1 1m-2-4H12c-.6 0-1-.4-1-1s.4-1 1-1h24c.6 0 1 .4 1 1s-.4 1-1 1m-2-4H14c-.6 0-1-.4-1-1s.4-1 1-1h20c.6 0 1 .4 1 1s-.4 1-1 1m-5-4H19c-.6 0-1-.4-1-1s.4-1 1-1h10c.6 0 1 .4 1 1s-.4 1-1 1"></svg:path><svg:path fill="#E91E63" d="M37 9H10c-.6 0-1-.4-1-1s.4-1 1-1h27c.6 0 1 .4 1 1s-.4 1-1 1m-1 4H12c-.6 0-1-.4-1-1s.4-1 1-1h24c.6 0 1 .4 1 1s-.4 1-1 1m-2 4H14c-.6 0-1-.4-1-1s.4-1 1-1h20c.6 0 1 .4 1 1s-.4 1-1 1m-5 4H19c-.6 0-1-.4-1-1s.4-1 1-1h10c.6 0 1 .4 1 1s-.4 1-1 1"></svg:path><svg:path fill="#E91E63" d="M40 44h-4c0-10.1-6.5-14.4-13.4-18.9C15.8 20.6 8 15.4 8 4h4c0 9.3 6 13.2 12.8 17.8C31.9 26.5 40 31.8 40 44"></svg:path>`,
})
export class FlatColorIconsBiotechIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsBusinessIcon],svg[flat-color-icons-business-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#263238" d="M11 44H9c-.6 0-1-.4-1-1v-2h4v2c0 .6-.4 1-1 1m28 0h-2c-.6 0-1-.4-1-1v-2h4v2c0 .6-.4 1-1 1"></svg:path><svg:path fill="#37474F" d="M27 7h-6c-1.7 0-3 1.3-3 3v3h2v-3c0-.6.4-1 1-1h6c.6 0 1 .4 1 1v3h2v-3c0-1.7-1.3-3-3-3"></svg:path><svg:path fill="#78909C" d="M40 43H8c-2.2 0-4-1.8-4-4V15c0-2.2 1.8-4 4-4h32c2.2 0 4 1.8 4 4v24c0 2.2-1.8 4-4 4"></svg:path>`,
})
export class FlatColorIconsBusinessIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsButtingInIcon],svg[flat-color-icons-butting-in-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M24 3C12.4 3 3 12.4 3 24s9.4 21 21 21c.3 0 .7 0 1-.1V3.1c-.3-.1-.7-.1-1-.1"></svg:path><svg:path fill="#37474F" d="M25 3.1V45c4.1-.2 7.9-1.5 11-3.7V6.8c-3.1-2.2-6.9-3.6-11-3.7"></svg:path><svg:path fill="#FFB74D" d="M20.5 13c-6.4.3-11.6 5.7-11.5 12.1c0 2.8 1 5.4 2.7 7.5c1.4 1.7 2.3 3.9 2.3 6.1v3.8c3 1.6 6.4 2.5 10 2.5c.3 0 .7 0 1-.1c.7 0 1.3-.1 2-.2v-9.4c3.6-2.1 6-5.9 6-10.4c0-6.7-5.6-12.2-12.5-11.9"></svg:path><svg:path fill="#FFB74D" d="m29 38.6l-4-.6v-9h8l-.7 7c-.2 1.6-1.6 2.8-3.3 2.6"></svg:path><svg:path fill="#FFB74D" d="m39 29l-7 2l-1-5l1-4z"></svg:path><svg:circle cx="29.5" cy="25.5" r="1.5" fill="#784719"></svg:circle><svg:path fill="#FF5722" d="M21 12c-7.2 0-13 5.8-13 13c0 7.6 5.1 9 6 13l4-3v-8l5-2l1-4c3.2 0 6-3.9 6-6.1c-2.1-1.9-5.6-2.9-9-2.9"></svg:path><svg:circle cx="19" cy="27" r="3" fill="#FFB74D"></svg:circle><svg:path fill="#CFD8DC" d="M45 24c0-7.1-3.6-13.4-9-17.2v34.4c5.4-3.8 9-10.1 9-17.2"></svg:path><svg:path fill="#FF9800" d="M20 44.6c1.3.2 2.6.4 4 .4c.3 0 .7 0 1-.1c.7 0 1.3-.1 2-.2v-6.5l-7-1z"></svg:path>`,
})
export class FlatColorIconsButtingInIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCableReleaseIcon],svg[flat-color-icons-cable-release-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#37474F" d="M34.9 29.1c-2.7-2.7-7.1-2.7-9.8 0l-4 4c-1.7 1.7-4.5 1.7-6.2 0s-1.7-4.5 0-6.2l4.5-4.5l-2.8-2.8l-4.5 4.5c-3.3 3.3-3.3 8.6 0 11.8c3.3 3.3 8.6 3.3 11.8 0l4-4c1.2-1.1 3-1.1 4.2 0c1.1 1.2 1.1 3 0 4.2L27 41.2l2.8 2.8l5.1-5.1c2.7-2.7 2.7-7.1 0-9.8"></svg:path><svg:path fill="#0277BD" d="M16.1 22.9c-2.8-2.8-2.8-7.3 0-10l6.8-6.8c2.8-2.8 7.3-2.8 10 0c2.8 2.8 2.8 7.3 0 10l-6.8 6.8c-2.8 2.8-7.2 2.8-10 0"></svg:path><svg:circle cx="28" cy="11" r="4" fill="#B3E5FC"></svg:circle>`,
})
export class FlatColorIconsCableReleaseIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCalculatorIcon],svg[flat-color-icons-calculator-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#616161" d="M40 16H8v24c0 2.2 1.8 4 4 4h24c2.2 0 4-1.8 4-4z"></svg:path><svg:path fill="#424242" d="M36 4H12C9.8 4 8 5.8 8 8v9h32V8c0-2.2-1.8-4-4-4"></svg:path><svg:path fill="#9CCC65" d="M36 14H12c-.6 0-1-.4-1-1V8c0-.6.4-1 1-1h24c.6 0 1 .4 1 1v5c0 .6-.4 1-1 1"></svg:path><svg:path fill="#33691E" d="M33 10h2v2h-2zm-4 0h2v2h-2z"></svg:path><svg:path fill="#FF5252" d="M36 23h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1"></svg:path><svg:path fill="#E0E0E0" d="M15 23h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m-14 6h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m-14 6h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m-14 6h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m7 0h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1"></svg:path><svg:path fill="#BDBDBD" d="M36 29h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m0 6h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1m0 6h-3c-.6 0-1-.4-1-1v-2c0-.6.4-1 1-1h3c.6 0 1 .4 1 1v2c0 .6-.4 1-1 1"></svg:path>`,
})
export class FlatColorIconsCalculatorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCallbackIcon],svg[flat-color-icons-callback-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#2196F3" d="M26.4 33.9s4-2.6 4.8-3s1.7-.6 2.2-.2c.8.5 7.5 4.9 8.1 5.3s.8 1.5.1 2.6c-.8 1.1-4.3 5.5-5.8 5.4c-1.5 0-8.4.4-20.3-11.4C3.6 20.7 4 13.8 4 12.3s4.3-5.1 5.4-5.8c1.1-.8 2.2-.5 2.6.1s4.8 7.3 5.3 8.1c.3.5.2 1.4-.2 2.2s-3 4.8-3 4.8s.7 2.8 5 7.2c4.4 4.3 7.3 5 7.3 5"></svg:path><svg:g fill="#3F51B5"><svg:path d="M35 9H25v4h10c1.1 0 2 .9 2 2v10h4V15c0-3.3-2.7-6-6-6"></svg:path><svg:path d="m28 16l-6.7-5L28 6z"></svg:path></svg:g>`,
})
export class FlatColorIconsCallbackIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCameraIcon],svg[flat-color-icons-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCameraAddonIcon],svg[flat-color-icons-camera-addon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#512DA8" d="M33.9 12.1H14.2L17.6 7c.4-.6 1-.9 1.7-.9h9.6c.7 0 1.3.3 1.7.9z"></svg:path><svg:path fill="#8667C4" d="M14 11H8V9.2C8 8.5 8.5 8 9.2 8h3.6c.7 0 1.2.5 1.2 1.2z"></svg:path><svg:path fill="#5E35B1" d="M40 42H8c-2.2 0-4-1.8-4-4V14c0-2.2 1.8-4 4-4h32c2.2 0 4 1.8 4 4v24c0 2.2-1.8 4-4 4"></svg:path><svg:circle cx="24" cy="26" r="12" fill="#512DA8"></svg:circle><svg:circle cx="24" cy="26" r="9" fill="#B388FF"></svg:circle><svg:path fill="#C7A7FF" d="M28.8 23c-1.2-1.4-3-2.2-4.8-2.2s-3.6.8-4.8 2.2c-.5.5-.4 1.3.1 1.8s1.3.4 1.8-.1c1.5-1.7 4.3-1.7 5.8 0c.3.3.6.4 1 .4q.45 0 .9-.3c.4-.4.5-1.3 0-1.8"></svg:path><svg:ellipse cx="11" cy="13.5" fill="#8667C4" rx="2" ry="1.5"></svg:ellipse><svg:path fill="#8BC34A" d="M48 33.8c0-1.3-1.1-2.4-2.4-2.4H42c-.4 0-.7-.5-.4-.8c.4-.6.5-1.3.4-2.1c-.2-1.2-1.1-2.1-2.3-2.4c-2-.4-3.7 1-3.7 2.9c0 .6.2 1.1.4 1.6c.2.4 0 .8-.5.8h-3.6c-1.3 0-2.4 1.1-2.4 2.4V37c0 .4.5.7.8.4c.6-.4 1.3-.5 2.1-.4c1.2.2 2.1 1.1 2.4 2.3c.4 1.9-1.1 3.6-2.9 3.6c-.6 0-1.1-.2-1.6-.4c-.4-.2-.8 0-.8.5v2.6c0 1.3 1.1 2.4 2.4 2.4h13.2c1.3 0 2.4-1.1 2.4-2.4V33.8z"></svg:path>`,
})
export class FlatColorIconsCameraAddonIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCancelIcon],svg[flat-color-icons-cancel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#D50000" d="M24 6C14.1 6 6 14.1 6 24s8.1 18 18 18s18-8.1 18-18S33.9 6 24 6m0 4c3.1 0 6 1.1 8.4 2.8L12.8 32.4C11.1 30 10 27.1 10 24c0-7.7 6.3-14 14-14m0 28c-3.1 0-6-1.1-8.4-2.8l19.6-19.6C36.9 18 38 20.9 38 24c0 7.7-6.3 14-14 14"></svg:path>`,
})
export class FlatColorIconsCancelIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCdLogoIcon],svg[flat-color-icons-cd-logo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCircuitIcon],svg[flat-color-icons-circuit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsClapperboardIcon],svg[flat-color-icons-clapperboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#3F51B5" d="M43.4 8.3L4 15l-.3-2C3.3 10.8 4.8 8.8 7 8.4l31.6-5.3c2.2-.4 4.2 1.1 4.6 3.3zM40 41H8c-2.2 0-4-1.8-4-4V15h40v22c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#9FA8DA" d="m18.8 6.4l4.9 5.3l4-.7l-5-5.3zm-7.9 1.3l4.9 5.3l4-.7l-5-5.2zm15.8-2.6l4.9 5.2l3.9-.6l-4.9-5.3zm7.8-1.3l5 5.2l3.9-.7l-4.9-5.2z"></svg:path><svg:circle cx="7.5" cy="11.5" r="1.5" fill="#9FA8DA"></svg:circle><svg:path fill="#9FA8DA" d="m40 15l-4 6h4l4-6zm-8 0l-4 6h4l4-6zm-8 0l-4 6h4l4-6zm-8 0l-4 6h4l4-6zm-8 0l-4 6h4l4-6z"></svg:path>`,
})
export class FlatColorIconsClapperboardIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsClothIcon],svg[flat-color-icons-cloth-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FF5722" d="M6 10v28c0 2.2 1.8 4 4 4h28c2.2 0 4-1.8 4-4V10c0-2.2-1.8-4-4-4H10c-2.2 0-4 1.8-4 4"></svg:path><svg:path fill="#BF360C" d="M6 35h36v2H6zm0-4h36v2H6zm.1 8c.2.8.6 1.5 1.2 2h33.2c.6-.5 1-1.2 1.2-2zm0-30h35.7c-.2-.8-.6-1.5-1.2-2H7.4c-.6.5-1.1 1.2-1.3 2M6 23h36v2H6zm0 4h36v2H6zm0-12h36v2H6zm0-4h36v2H6zm0 8h36v2H6z"></svg:path><svg:path fill="#FF8A65" d="M27 6h2v5h-2zm0 7h2v6h-2zm0 16h2v6h-2zm4-23h2v1h-2zM19 29h2v6h-2zM31 9h2v6h-2zm-8-3h2v1h-2zm0 19h2v6h-2zm0-16h2v6h-2zm-4 12h2v6h-2zm4-4h2v6h-2zm0 16h2v6h-2zm4-12h2v6h-2zm12 12h2v6h-2zm0-16h2v6h-2zm0 8h2v6h-2zm0-18.9V7h1.6c-.4-.4-1-.7-1.6-.9M31 17h2v6h-2zm9.6 24H39v.9c.6-.2 1.2-.5 1.6-.9M35 13h2v6h-2zm-4 20h2v6h-2zm4-4h2v6h-2zm4-20h2v6h-2zm-4 12h2v6h-2zm-4 4h2v6h-2zm4 12h2v5h-2zm0-31h2v5h-2zm-4 35h2v1h-2zm-8 0h2v1h-2zm4-4h2v5h-2zm-8 0h2v5h-2zM7 17h2v6H7zm2 24H7.4c.5.4 1 .7 1.6.9zM7.4 7H9v-.9c-.6.2-1.2.5-1.6.9M7 33h2v6H7zm0-8h2v6H7zM7 9h2v6H7zm4 20h2v6h-2zm4-12h2v6h-2zm0 16h2v6h-2zm0-24h2v6h-2zm0-3h2v1h-2zm4 0h2v5h-2zm-4 19h2v6h-2zm0 16h2v1h-2zm-4-20h2v6h-2zm0-15h2v5h-2zm0 31h2v5h-2zm8-24h2v6h-2zm-8 0h2v6h-2z"></svg:path>`,
})
export class FlatColorIconsClothIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCommandLineIcon],svg[flat-color-icons-command-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M41 6H7c-.6 0-1 .4-1 1v35h36V7c0-.6-.4-1-1-1"></svg:path><svg:path fill="#263238" d="M8 13h32v27H8z"></svg:path><svg:path fill="#76FF03" d="M22 27.6c-.1 1.1-.4 1.9-1 2.5s-1.4.9-2.5.9s-2-.4-2.6-1.1s-.9-1.8-.9-3.1v-1.6c0-1.3.3-2.4.9-3.1s1.5-1.1 2.6-1.1s1.9.3 2.5.9s.9 1.4 1 2.6h-2c0-.7-.1-1.2-.3-1.4c-.2-.3-.6-.4-1.1-.4q-.75 0-1.2.6c-.2.4-.3 1-.4 1.8v1.8c0 1 .1 1.6.3 2s.6.5 1.1.5s.9-.1 1.1-.4s.3-.7.3-1.4zm2-3.6c0-.3.1-.5.3-.7s.4-.3.7-.3s.5.1.7.3s.3.4.3.7s-.1.5-.3.7s-.4.3-.7.3s-.5-.1-.7-.3s-.3-.4-.3-.7m0 6c0-.3.1-.5.3-.7s.4-.3.7-.3s.5.1.7.3s.3.4.3.7s-.1.5-.3.7s-.4.3-.7.3s-.5-.1-.7-.3s-.3-.4-.3-.7m4-9h2l3 10h-2z"></svg:path><svg:g fill="#90A4AE"><svg:circle cx="13.5" cy="9.5" r="1.5"></svg:circle><svg:circle cx="9.5" cy="9.5" r="1.5"></svg:circle></svg:g>`,
})
export class FlatColorIconsCommandLineIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCompactCameraIcon],svg[flat-color-icons-compact-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#607D8B" d="M40 39H8c-2.2 0-4-1.8-4-4V13c0-2.2 1.8-4 4-4h32c2.2 0 4 1.8 4 4v22c0 2.2-1.8 4-4 4"></svg:path><svg:circle cx="29" cy="24" r="12" fill="#455A64"></svg:circle><svg:circle cx="29" cy="24" r="9" fill="#42A5F5"></svg:circle><svg:path fill="#90CAF9" d="M33.8 21c-1.2-1.4-3-2.2-4.8-2.2s-3.6.8-4.8 2.2c-.5.5-.4 1.3.1 1.8s1.3.4 1.8-.1c1.5-1.7 4.3-1.7 5.8 0c.3.3.6.4 1 .4q.45 0 .9-.3c.4-.4.5-1.3 0-1.8"></svg:path><svg:path fill="#ADD8FB" d="M8 13h6v3H8z"></svg:path>`,
})
export class FlatColorIconsCompactCameraIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCopyleftIcon],svg[flat-color-icons-copyleft-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21" fill="#9C27B0"></svg:circle><svg:path fill="#E1BEE7" d="M19.3 28.1c.3 1.3.2 4.1 4.6 4.1c.9 0 4.8.2 4.7-7.2v-1.6c0-6.7-3.2-7.2-4.8-7.2c-2.3 0-4.2.6-4.5 4.3h-4.8c.1-1.2.8-8.2 9.3-8.2c4.2 0 9.7 2.5 9.7 11.2V25c0 9.6-6.5 11.2-9.6 11.2c-3.7 0-8.7-1.6-9.3-8.1z"></svg:path>`,
})
export class FlatColorIconsCopyleftIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCopyrightIcon],svg[flat-color-icons-copyright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21" fill="#9C27B0"></svg:circle><svg:path fill="#E1BEE7" d="M33.5 28.1c-.6 6.4-5.6 8.1-9.3 8.1c-3.1 0-9.6-1.6-9.6-11.2v-1.5c0-8.7 5.5-11.2 9.7-11.2c8.5 0 9.2 7 9.3 8.2h-4.8c-.3-3.6-2.2-4.3-4.5-4.3c-1.6 0-4.8.5-4.8 7.2V25c-.1 7.5 3.8 7.2 4.7 7.2c4.3 0 4.3-2.9 4.6-4.1z"></svg:path>`,
})
export class FlatColorIconsCopyrightIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCurrencyExchangeIcon],svg[flat-color-icons-currency-exchange-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsCursorIcon],svg[flat-color-icons-cursor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#E0E0E0" d="M27.8 39.7c-.1 0-.2 0-.4-.1s-.4-.3-.6-.5l-3.7-8.6l-4.5 4.2q-.15.3-.6.3c-.1 0-.3 0-.4-.1c-.3-.1-.6-.5-.6-.9V12c0-.4.2-.8.6-.9c.1-.1.3-.1.4-.1c.2 0 .5.1.7.3l16 15c.3.3.4.7.3 1.1s-.5.6-.9.7l-6.3.6l3.9 8.5c.1.2.1.5 0 .8c-.1.2-.3.5-.5.6l-2.9 1.3c-.2-.2-.4-.2-.5-.2"></svg:path><svg:path fill="#212121" d="m18 12l16 15l-7.7.7l4.5 9.8l-2.9 1.3l-4.3-9.9L18 34zm0-2c-.3 0-.5.1-.8.2c-.7.3-1.2 1-1.2 1.8v22c0 .8.5 1.5 1.2 1.8c.3.2.6.2.8.2c.5 0 1-.2 1.4-.5l3.4-3.2l3.1 7.3c.2.5.6.9 1.1 1.1c.2.1.5.1.7.1c.3 0 .5-.1.8-.2l2.9-1.3c.5-.2.9-.6 1.1-1.1s.2-1.1 0-1.5l-3.3-7.2l4.9-.4c.8-.1 1.5-.6 1.7-1.3c.3-.7.1-1.6-.5-2.1l-16-15c-.3-.5-.8-.7-1.3-.7"></svg:path>`,
})
export class FlatColorIconsCursorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDamIcon],svg[flat-color-icons-dam-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDataConfigurationIcon],svg[flat-color-icons-data-configuration-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#D1C4E9" d="M38 7H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2m0 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2v-6c0-1.1-.9-2-2-2m0 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2v-6c0-1.1-.9-2-2-2"></svg:path><svg:path fill="#607D8B" d="M45.2 38.1c.1-.4.1-.8.1-1.1s0-.8-.1-1.1l2.3-1.7c.2-.2.3-.5.2-.7l-2.3-3.9c-.1-.2-.4-.3-.7-.2l-2.6 1.2c-.6-.5-1.3-.9-2-1.2l-.3-2.9c0-.3-.3-.5-.5-.5h-4.5c-.3 0-.5.2-.5.5l-.3 2.9c-.7.3-1.4.7-2 1.2l-2.6-1.2c-.3-.1-.6 0-.7.2l-2.3 3.9c-.1.2-.1.6.2.7l2.3 1.7c-.1.4-.1.8-.1 1.1s0 .8.1 1.1l-2.3 1.7c-.2.2-.3.5-.2.7l2.3 3.9c.1.2.4.3.7.2l2.6-1.2c.6.5 1.3.9 2 1.2l.3 2.9c0 .3.3.5.5.5h4.5c.3 0 .5-.2.5-.5l.3-2.9c.7-.3 1.4-.7 2-1.2l2.6 1.2c.3.1.6 0 .7-.2l2.3-3.9c.1-.2.1-.6-.2-.7zM37 42.2c-2.9 0-5.2-2.3-5.2-5.2s2.3-5.2 5.2-5.2s5.2 2.3 5.2 5.2s-2.3 5.2-5.2 5.2"></svg:path><svg:path fill="#455A64" d="M37 31c-3.3 0-6 2.7-6 6s2.7 6 6 6s6-2.7 6-6s-2.7-6-6-6m0 9c-1.7 0-3-1.3-3-3s1.3-3 3-3s3 1.3 3 3s-1.3 3-3 3"></svg:path>`,
})
export class FlatColorIconsDataConfigurationIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDataEncryptionIcon],svg[flat-color-icons-data-encryption-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#D1C4E9" d="M38 7H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2m0 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h25.1c1.3-1.3 4.9-.9 4.9-2v-6c0-1.1-.9-2-2-2m-3.6 12H10c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h28c1.1 0 2-.9 2-2v-2.4c0-3.1-2.5-5.6-5.6-5.6"></svg:path><svg:g fill="#FFA000"><svg:path d="m43 46l-2 2h-2l-2-2V35.4h6V40l-1 1l1 1v1l-1 1l1 1z"></svg:path><svg:path d="M47.5 28.5c-.3-.9-1-1.6-2-1.8c-1.3-.3-3.3-.7-5.5-.7s-4.2.4-5.5.6c-1 .2-1.7.9-2 1.8c-.2 1-.5 2.2-.5 3.6s.3 2.6.5 3.5c.3.9 1 1.6 2 1.8c1.3.3 3.2.6 5.5.6s4.2-.4 5.5-.6c1-.2 1.7-.9 2-1.8s.5-2.1.5-3.5s-.3-2.6-.5-3.5M42.9 31h-5.7c-.6 0-1.1-.5-1.1-1.1v-1.4c0-.3 1.8-.6 4-.6s4 .3 4 .6v1.4c-.1.6-.6 1.1-1.2 1.1"></svg:path></svg:g><svg:path fill="#D68600" d="M39 37.1h1V48h-1z"></svg:path>`,
})
export class FlatColorIconsDataEncryptionIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDataSheetIcon],svg[flat-color-icons-data-sheet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#90CAF9" d="M39 16v7h-6v-7h-2v7h-6v-7h-2v7h-7v2h7v6h-7v2h7v6h-7v2h25V16zm0 9v6h-6v-6zm-14 0h6v6h-6zm0 8h6v6h-6zm8 6v-6h6v6z"></svg:path><svg:path fill="#00BCD4" d="M40 8H8v32h8V16h24z"></svg:path><svg:path fill="#0097A7" d="M7 7v34h10V17h24V7zm2 16v-6h6v6zm6 2v6H9v-6zm2-16h6v6h-6zm8 0h6v6h-6zM15 9v6H9V9zM9 39v-6h6v6zm30-24h-6V9h6z"></svg:path>`,
})
export class FlatColorIconsDataSheetIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDebianIcon],svg[flat-color-icons-debian-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDebtIcon],svg[flat-color-icons-debt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FFB74D" d="M10 12c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5"></svg:path><svg:path fill="#607D8B" d="M2 22v8l3 2l1 14h8l1-14l3-2v-8c0-4.4-3.6-8-8-8s-8 3.6-8 8"></svg:path><svg:g fill="#263238"><svg:path d="M22.4 40.4c-.6 2.5-1 3.6-2.4 3.6c-.6 0-1.2-.5-1.9-1.1c-1-.8-2.2-1.9-4.1-1.9v2c1.1 0 1.9.7 2.8 1.4S18.7 46 20 46c3.1 0 3.8-2.9 4.4-5.2c.6-2.6 1-3.8 2.6-3.8v-2c-3.3 0-4.1 3.1-4.6 5.4"></svg:path><svg:path d="M14.4 40H10v4h4.1z"></svg:path></svg:g><svg:circle cx="36" cy="36" r="10" fill="#4CAF50"></svg:circle><svg:path fill="#fff" d="M35 34c.1.2.1.3.3.4c.1.1.3.2.5.4c.2.1.5.2.8.3c.5.2.9.4 1.3.6s.7.4 1 .7s.5.6.7.9c.2.4.2.8.2 1.3c0 .4-.1.8-.2 1.2q-.15.6-.6.9q-.45.45-.9.6q-.6.3-1.2.3v1.5h-1.2v-1.5q-.6 0-1.2-.3c-.4-.2-.7-.4-1-.6c-.3-.3-.5-.6-.7-1.1q-.3-.6-.3-1.5h2.2c0 .4 0 .7.1.9s.2.4.4.6c.2.1.3.2.5.3s.4.1.6.1s.4 0 .6-.1s.3-.2.4-.3s.2-.3.3-.4c.1-.2.1-.3.1-.5s0-.4-.1-.6s-.1-.3-.3-.4c-.1-.1-.3-.3-.5-.4s-.4-.2-.7-.3c-.5-.2-.9-.4-1.3-.6s-.7-.4-1-.7s-.5-.6-.7-.9c-.2-.4-.2-.8-.2-1.3c0-.4.1-.8.2-1.2c.1-.3.3-.7.6-.9q.45-.45.9-.6q.6-.3 1.2-.3v-1.6H37v1.6c.4.1.8.2 1.2.4s.6.4.9.7c.2.3.4.6.6 1c.1.4.2.9.2 1.4h-2.2c0-.6-.1-1-.4-1.3c-.2-.3-.6-.4-1-.4c-.2 0-.4 0-.6.1s-.3.2-.4.3q-.3 0-.3.3c0 .3-.1.3-.1.5s0 .4.1.5"></svg:path>`,
})
export class FlatColorIconsDebtIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDecisionIcon],svg[flat-color-icons-decision-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#FFCC80"><svg:circle cx="38" cy="26" r="4"></svg:circle><svg:circle cx="10" cy="26" r="4"></svg:circle><svg:path d="M39 19c0-12.7-30-8.3-30 0v10c0 8.3 6.7 15 15 15s15-6.7 15-15z"></svg:path><svg:path d="M24 4C15.2 4 8 11.2 8 20v3.5l2.1.6V19l19.5-6.3l8.2 6.3v5.1l2.1-.6V20C40 12.5 34.6 4 24 4"></svg:path></svg:g><svg:path fill="#0277BD" d="M21.8 29.6c0-6.6 5.1-6.2 5.1-10.2c0-1-.3-3-2.9-3c-2.8 0-3 2.3-3 2.8h-3.8c0-1 .4-6 6.8-6c6.5 0 6.7 5.1 6.7 6c0 4.9-5.4 5.6-5.4 10.3h-3.5zm-.3 4.9c0-.3.1-2.1 2.1-2.1s2.2 1.8 2.2 2.1c0 .6-.3 2-2.2 2c-1.8 0-2.1-1.4-2.1-2"></svg:path>`,
})
export class FlatColorIconsDecisionIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDeleteColumnIcon],svg[flat-color-icons-delete-column-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#90CAF9" d="M30 5H18c-2.2 0-4 1.8-4 4v30c0 2.2 1.8 4 4 4h12c2.2 0 4-1.8 4-4V9c0-2.2-1.8-4-4-4M18 39V9h12v30z"></svg:path><svg:circle cx="38" cy="38" r="10" fill="#F44336"></svg:circle><svg:g fill="#fff"><svg:path d="m43.31 41.181l-2.12 2.122l-8.485-8.484l2.121-2.122z"></svg:path><svg:path d="m34.819 43.31l-2.122-2.12l8.484-8.485l2.122 2.121z"></svg:path></svg:g>`,
})
export class FlatColorIconsDeleteColumnIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDisapproveIcon],svg[flat-color-icons-disapprove-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#FFCC80"><svg:circle cx="38" cy="26" r="4"></svg:circle><svg:circle cx="10" cy="26" r="4"></svg:circle><svg:path d="M39 19c0-12.7-30-8.3-30 0v10c0 8.3 6.7 15 15 15s15-6.7 15-15z"></svg:path><svg:path d="M24 4C15.2 4 8 11.2 8 20v3.5l2.1.6V19l19.5-6.3l8.2 6.3v5.1l2.1-.6V20C40 12.5 34.6 4 24 4"></svg:path></svg:g><svg:g fill="#F44336"><svg:path d="m16.077 20.91l2.828-2.828l13.08 13.08l-2.829 2.827z"></svg:path><svg:path d="m29.09 18.077l2.828 2.828l-13.08 13.08l-2.827-2.829z"></svg:path></svg:g>`,
})
export class FlatColorIconsDisapproveIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDisclaimerIcon],svg[flat-color-icons-disclaimer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#FFCC80"><svg:path d="M13 22H8v-8.5c0-1.4 1.1-2.5 2.5-2.5s2.5 1.1 2.5 2.5zm7 0h-5V7.5C15 6.1 16.1 5 17.5 5S20 6.1 20 7.5zm7 0h-5V5.5C22 4.1 23.1 3 24.5 3S27 4.1 27 5.5zm7 0h-5V8.5C29 7.1 30.1 6 31.5 6S34 7.1 34 8.5zm-1.9 21l-5-5l10-10c1.4-1.4 3.6-1.4 4.9 0c1.4 1.4 1.4 3.6 0 4.9z"></svg:path><svg:path d="M29 21c0 .6-.4 1-1 1s-1-.4-1-1h-5c0 .6-.4 1-1 1s-1-.4-1-1h-5c0 .6-.4 1-1 1s-1-.4-1-1H8v16c0 4.4 3.6 8 8 8h11.2c3.7 0 6.8-3 6.8-6.8V21z"></svg:path></svg:g><svg:g fill="#F44336"><svg:path d="m15.413 28.971l2.474-2.474l10.605 10.605l-2.474 2.474z"></svg:path><svg:path d="m25.993 26.504l2.475 2.474l-10.605 10.605l-2.475-2.474z"></svg:path></svg:g>`,
})
export class FlatColorIconsDisclaimerIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDislikeIcon],svg[flat-color-icons-dislike-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#F44336" d="M34 9c-4.2 0-7.9 2.1-10 5.4C21.9 11.1 18.2 9 14 9C7.4 9 2 14.4 2 21c0 11.9 22 24 22 24s22-12 22-24c0-6.6-5.4-12-12-12"></svg:path><svg:path fill="#37474F" d="M3.563 6.396L6.39 3.568l37.966 37.966l-2.828 2.828z"></svg:path>`,
})
export class FlatColorIconsDislikeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDonateIcon],svg[flat-color-icons-donate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#E69329" d="m11.7 21.6l5.1 9.9l9.5-3.9l4.4-12.7l-14.8.8z"></svg:path><svg:circle cx="15" cy="36" r="7.8" fill="#546E7A"></svg:circle><svg:g fill="#90A4AE"><svg:path d="M15 27c-5 0-9 4-9 9s4 9 9 9s9-4 9-9s-4-9-9-9m0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7s7 3.1 7 7s-3.1 7-7 7"></svg:path><svg:path d="M14 33h2v8h-2z"></svg:path></svg:g><svg:g fill="#FFB74D"><svg:path d="M12.9 36c1 1.9 3.2 2.7 5.1 1.7l16.5-8.5c1-.5 1.7-1.2 2.2-1.9c1.7-3.2 5.6-10.7 8.2-17.2l-18.2 8.7l-4.8 7.2l-6.8 3.6c-2.6 1.3-3.4 4.2-2.2 6.4"></svg:path><svg:path d="M30.2 3L13.7 9.3c-.7.2-1.5 1-2.2 1.7l-5.6 7.5c-1 1.5-1.2 3.4-.5 5.1c.4 1 1.7 3.4 3.1 6.1C10.1 28 12.4 27 15 27c.4 0 .9 0 1.3.1l-2.1-4.2l4.6-4.1h8s15.5-2.2 18.2-8.7z"></svg:path></svg:g><svg:path fill="#FFCDD2" d="M18.2 36c-1.3.6-2.8 0-3.3-1.3c-.6-1.3 0-2.8 1.3-3.3c1.2-.6 3.2 4 2 4.6"></svg:path>`,
})
export class FlatColorIconsDonateIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDribbbleIcon],svg[flat-color-icons-dribbble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsDvdLogoIcon],svg[flat-color-icons-dvd-logo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsElectronicsIcon],svg[flat-color-icons-electronics-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FF9800" d="M44 18v-4H34V4h-4v10h-4V4h-4v10h-4V4h-4v10H4v4h10v4H4v4h10v4H4v4h10v10h4V34h4v10h4V34h4v10h4V34h10v-4H34v-4h10v-4H34v-4z"></svg:path><svg:path fill="#4CAF50" d="M8 12v24c0 2.2 1.8 4 4 4h24c2.2 0 4-1.8 4-4V12c0-2.2-1.8-4-4-4H12c-2.2 0-4 1.8-4 4"></svg:path><svg:path fill="#37474F" d="M31 31H17c-1.1 0-2-.9-2-2V19c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2v10c0 1.1-.9 2-2 2"></svg:path>`,
})
export class FlatColorIconsElectronicsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsEngineeringIcon],svg[flat-color-icons-engineering-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#EF6C00" d="m37.4 24.6l-11.6-2.2l-3.9-11.2l-3.8 1.3L22 23.6l-7.8 9l3 2.6l7.8-9l11.6 2.2z"></svg:path><svg:g fill="#FF9800"><svg:path d="M24 19c-2.8 0-5 2.2-5 5s2.2 5 5 5s5-2.2 5-5s-2.2-5-5-5m0 7c-1.1 0-2-.9-2-2s.9-2 2-2s2 .9 2 2s-.9 2-2 2"></svg:path><svg:path d="M40.7 27q.3-1.5.3-3c0-1.5-.1-2-.3-3l3.3-2.4c.4-.3.6-.9.3-1.4L40 9.8c-.3-.5-.8-.7-1.3-.4L35 11c-1.5-1.3-3.3-2.3-5.2-3l-.4-4.1c-.1-.5-.5-.9-1-.9h-8.6c-.5 0-1 .4-1 .9L18.2 8c-1.9.7-3.7 1.7-5.2 3L9.3 9.3c-.5-.2-1.1 0-1.3.5l-4.3 7.4c-.3.5-.1 1.1.3 1.4L7.3 21Q7 22.5 7 24c0 1.5.1 2 .3 3L4 29.4c-.4.3-.6.9-.3 1.4L8 38.2c.3.5.8.7 1.3.4L13 37c1.5 1.3 3.3 2.3 5.2 3l.4 4.1c.1.5.5.9 1 .9h8.6c.5 0 1-.4 1-.9l.4-4.1c1.9-.7 3.7-1.7 5.2-3l3.7 1.7c.5.2 1.1 0 1.3-.4l4.3-7.4c.3-.5.1-1.1-.3-1.4zM24 35c-6.1 0-11-4.9-11-11s4.9-11 11-11s11 4.9 11 11s-4.9 11-11 11"></svg:path></svg:g>`,
})
export class FlatColorIconsEngineeringIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsEnteringHeavenAliveIcon],svg[flat-color-icons-entering-heaven-alive-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#039BE5" d="M17 29h14v2H17zm-4 4h22v2H13zm-4 4h30v2H9zm-4 4h38v2H5z"></svg:path><svg:path fill="#81D4FA" d="M35 13c-.4 0-.8 0-1.2.1C32.9 8.5 28.9 5 24 5c-4.1 0-7.6 2.5-9.2 6H14c-4.4 0-8 3.6-8 8s3.6 8 8 8h21c3.9 0 7-3.1 7-7s-3.1-7-7-7"></svg:path><svg:path fill="#039BE5" d="M28 21c0-2.2-1.8-4-4-4s-4 1.8-4 4v6h8z"></svg:path>`,
})
export class FlatColorIconsEnteringHeavenAliveIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsExpiredIcon],svg[flat-color-icons-expired-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="17" cy="17" r="14" fill="#00ACC1"></svg:circle><svg:circle cx="17" cy="17" r="11" fill="#eee"></svg:circle><svg:path d="M16 8h2v9h-2z"></svg:path><svg:path d="m22.655 20.954l-1.697 1.697l-4.808-4.807l1.697-1.697z"></svg:path><svg:circle cx="17" cy="17" r="2"></svg:circle><svg:circle cx="17" cy="17" r="1" fill="#00ACC1"></svg:circle><svg:path fill="#FFC107" d="m11.9 42l14.4-24.1c.8-1.3 2.7-1.3 3.4 0L44.1 42c.8 1.3-.2 3-1.7 3H13.6c-1.5 0-2.5-1.7-1.7-3"></svg:path><svg:path fill="#263238" d="M26.4 39.9c0-.2 0-.4.1-.6s.2-.3.3-.5s.3-.2.5-.3s.4-.1.6-.1s.5 0 .7.1s.4.2.5.3s.2.3.3.5s.1.4.1.6s0 .4-.1.6s-.2.3-.3.5s-.3.2-.5.3s-.4.1-.7.1s-.5 0-.6-.1s-.4-.2-.5-.3s-.2-.3-.3-.5s-.1-.4-.1-.6m2.8-3.1h-2.3l-.4-9.8h3z"></svg:path>`,
})
export class FlatColorIconsExpiredIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsFaqIcon],svg[flat-color-icons-faq-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#558B2F" d="M15 40h23l6 6V25c0-2.2-1.8-4-4-4H15c-2.2 0-4 1.8-4 4v11c0 2.2 1.8 4 4 4"></svg:path><svg:path fill="#1B5E20" d="M28.8 32.8h-3.6l-.7 2.1h-2.2l3.7-10h1.9l3.7 10h-2.2zm-3.1-1.6h2.5L27 27.4z"></svg:path><svg:path fill="#8BC34A" d="M33 25H10l-6 6V8c0-2.2 1.8-4 4-4h25c2.2 0 4 1.8 4 4v13c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#fff" d="M25.4 14.2c0 1-.2 1.8-.5 2.5s-.7 1.3-1.3 1.7l1.7 1.3l-1.3 1.2l-2.2-1.7c-.2 0-.5.1-.8.1q-.9 0-1.8-.3c-.5-.2-1-.6-1.4-1s-.7-1-.9-1.6q-.3-.9-.3-2.1v-.4q0-1.2.3-2.1c.2-.6.5-1.2.9-1.6s.8-.8 1.4-1q.75-.3 1.8-.3q.9 0 1.8.3c.5.2 1 .6 1.4 1s.7 1 .9 1.6q.3.9.3 2.1zm-2.2-.5q0-1.65-.6-2.4c-.4-.6-.9-.8-1.6-.8s-1.3.3-1.6.8q-.6.9-.6 2.4v.5c0 .5.1 1 .2 1.4s.2.8.4 1c.2.3.4.5.7.6s.6.2.9.2c.7 0 1.3-.3 1.6-.8c.4-.6.6-1.4.6-2.5z"></svg:path>`,
})
export class FlatColorIconsFaqIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsFinePrintIcon],svg[flat-color-icons-fine-print-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#90CAF9" d="M33 42H5V4h19l9 9z"></svg:path><svg:path fill="#E1F5FE" d="M31.5 14H23V5.5z"></svg:path><svg:path fill="#616161" d="m34.505 37.58l1.98-1.98l8.483 8.485l-1.98 1.98z"></svg:path><svg:circle cx="28" cy="29" r="11" fill="#616161"></svg:circle><svg:circle cx="28" cy="29" r="9" fill="#90CAF9"></svg:circle><svg:path fill="#37474F" d="m36.849 39.88l1.98-1.98l6.15 6.151l-1.98 1.98z"></svg:path><svg:path fill="#1976D2" d="M30 31h-9.7c.4 1.6 1.3 3 2.5 4H30zm-9.7-4H30v-4h-7.3c-1.2 1-2 2.4-2.4 4m-.2-7H11v2h7.3c.5-.7 1.1-1.4 1.8-2m-3 4H11v2h5.4c.2-.7.4-1.4.7-2M16 29c0-.3 0-.7.1-1H11v2h5.1c-.1-.3-.1-.7-.1-1m.4 3H11v2h6.1c-.3-.6-.5-1.3-.7-2"></svg:path>`,
})
export class FlatColorIconsFinePrintIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsFrameIcon],svg[flat-color-icons-frame-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#3949AB" d="M40.6 40.1h-1.9l-3.1-.4c-2.4-.3-4.9-.2-7.3.4l-3.6.9c-.5.1-1.1.1-1.6 0l-3.5-1c-2.4-.6-4.8-.7-7.3-.4l-3.1.4H7.4C5.5 40 4 38.5 4 36.6c0-.4.1-.9.2-1.3l.2-.6c1-2.5 1.1-5.3.4-7.9l-.6-2c-.2-.7-.2-1.3 0-2l.3-.8c.9-2.7.8-5.7-.2-8.4l-.1-.3c-.1-.2-.2-.6-.2-1v-1c0-1.9 1.5-3.4 3.4-3.4h1.9l3.1.4c2.4.3 4.9.2 7.3-.4l3.6-.9c.5-.1 1.1-.1 1.6 0l3.5 1c2.4.6 4.8.7 7.3.4l3.1-.4h1.9c1.9 0 3.4 1.5 3.4 3.4v1c0 .4-.1.9-.2 1.3l-.1.3c-1.1 2.7-1.2 5.6-.2 8.4l.3.8c.2.6.2 1.3 0 2l-.6 2c-.7 2.6-.6 5.4.4 7.9l.2.6c.2.4.2.8.2 1.3c-.1 1.6-1.6 3.1-3.5 3.1"></svg:path><svg:path fill="#BBDEFB" d="M38 36H10c-.6 0-1-.4-1-1V13c0-.6.4-1 1-1h28c.6 0 1 .4 1 1v22c0 .6-.4 1-1 1"></svg:path>`,
})
export class FlatColorIconsFrameIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsFullBatteryIcon],svg[flat-color-icons-full-battery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#8BC34A"><svg:path d="M34 44H14c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2h20c1.1 0 2 .9 2 2v34c0 1.1-.9 2-2 2"></svg:path><svg:path d="M28 13h-8c-.6 0-1-.4-1-1V5c0-.6.4-1 1-1h8c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1"></svg:path></svg:g>`,
})
export class FlatColorIconsFullBatteryIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsGenealogyIcon],svg[flat-color-icons-genealogy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M40 9V7h-9v5H15v11H8v2h7v11h16v5h9v-2h-7v-8h7v-2h-9v5H17V14h14v5h9v-2h-7V9z"></svg:path><svg:path fill="#00BCD4" d="M4 20h8v8H4z"></svg:path><svg:path fill="#3F51B5" d="M36 14h8v8h-8zm0-10h8v8h-8zM20 9h8v8h-8zm0 22h8v8h-8zm16 5h8v8h-8zm0-10h8v8h-8z"></svg:path>`,
})
export class FlatColorIconsGenealogyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsGlobeIcon],svg[flat-color-icons-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsGoogleIcon],svg[flat-color-icons-google-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C12.955 4 4 12.955 4 24s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917"></svg:path><svg:path fill="#FF3D00" d="m6.306 14.691l6.571 4.819C14.655 15.108 18.961 12 24 12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C16.318 4 9.656 8.337 6.306 14.691"></svg:path><svg:path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.9 11.9 0 0 1 24 36c-5.202 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44"></svg:path><svg:path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002l6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917"></svg:path>`,
})
export class FlatColorIconsGoogleIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsGraduationCapIcon],svg[flat-color-icons-graduation-cap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#37474F"><svg:path d="M9 20h30v13H9z"></svg:path><svg:ellipse cx="24" cy="33" rx="15" ry="6"></svg:ellipse></svg:g><svg:path fill="#78909C" d="M23.1 8.2L.6 18.1c-.8.4-.8 1.5 0 1.9l22.5 9.9q.9.3 1.8 0L47.4 20c.8-.4.8-1.5 0-1.9L24.9 8.2q-.9-.45-1.8 0"></svg:path><svg:g fill="#37474F"><svg:path d="m43.2 20.4l-20-3.4c-.5-.1-1.1.3-1.2.8s.3 1.1.8 1.2L42 22.2V37c0 .6.4 1 1 1s1-.4 1-1V21.4c0-.5-.4-.9-.8-1"></svg:path><svg:circle cx="43" cy="37" r="2"></svg:circle><svg:path d="M46 40c0 1.7-3 6-3 6s-3-4.3-3-6s1.3-3 3-3s3 1.3 3 3"></svg:path></svg:g>`,
})
export class FlatColorIconsGraduationCapIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsHighBatteryIcon],svg[flat-color-icons-high-battery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#CFD8DC"><svg:path d="M34 44H14c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2h20c1.1 0 2 .9 2 2v34c0 1.1-.9 2-2 2"></svg:path><svg:path d="M28 13h-8c-.6 0-1-.4-1-1V5c0-.6.4-1 1-1h8c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1"></svg:path></svg:g><svg:path fill="#8BC34A" d="M34 44H14c-1.1 0-2-.9-2-2V13h24v29c0 1.1-.9 2-2 2"></svg:path>`,
})
export class FlatColorIconsHighBatteryIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsIcons8CupIcon],svg[flat-color-icons-icons8-cup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#4CAF50" d="M40 14H8l3.8 28.3c.1 1 1 1.7 2 1.7h20.5c1 0 1.8-.7 2-1.7z"></svg:path><svg:g fill="#81C784"><svg:path d="M42 14H6v-3c0-2.2 1.8-4 4-4h28c2.2 0 4 1.8 4 4z"></svg:path><svg:path d="M37.2 10H10.8l1.7-4.7c.3-.8 1-1.3 1.9-1.3h19.2c.8 0 1.6.5 1.9 1.3z"></svg:path></svg:g><svg:path fill="#E8F5E9" d="M28 28.5c1.2-1.1 2-2.7 2-4.5c0-3.3-2.7-6-6-6s-6 2.7-6 6c0 1.8.8 3.4 2 4.5c-1.2 1.1-2 2.7-2 4.5c0 3.3 2.7 6 6 6s6-2.7 6-6c0-1.8-.8-3.4-2-4.5M24 36c-1.7 0-3-1.3-3-3s1.3-3 3-3s3 1.3 3 3s-1.3 3-3 3m0-9c-1.7 0-3-1.3-3-3s1.3-3 3-3s3 1.3 3 3s-1.3 3-3 3"></svg:path>`,
})
export class FlatColorIconsIcons8CupIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsIdeaIcon],svg[flat-color-icons-idea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="22" r="20" fill="#FFF59D"></svg:circle><svg:path fill="#FBC02D" d="M37 22c0-7.7-6.6-13.8-14.5-12.9c-6 .7-10.8 5.5-11.4 11.5c-.5 4.6 1.4 8.7 4.6 11.3c1.4 1.2 2.3 2.9 2.3 4.8v.3h12v-.1c0-1.8.8-3.6 2.2-4.8c2.9-2.4 4.8-6 4.8-10.1"></svg:path><svg:path fill="#FFF59D" d="m30.6 20.2l-3-2c-.3-.2-.8-.2-1.1 0L24 19.8l-2.4-1.6c-.3-.2-.8-.2-1.1 0l-3 2c-.2.2-.4.4-.4.7s0 .6.2.8l3.8 4.7V37h2V26c0-.2-.1-.4-.2-.6l-3.3-4.1l1.5-1l2.4 1.6c.3.2.8.2 1.1 0l2.4-1.6l1.5 1l-3.3 4.1c-.1.2-.2.4-.2.6v11h2V26.4l3.8-4.7c.2-.2.3-.5.2-.8s-.2-.6-.4-.7"></svg:path><svg:circle cx="24" cy="44" r="3" fill="#5C6BC0"></svg:circle><svg:path fill="#9FA8DA" d="M26 45h-4c-2.2 0-4-1.8-4-4v-5h12v5c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#5C6BC0" d="m30 41l-11.6 1.6c.3.7.9 1.4 1.6 1.8l9.4-1.3q.6-.9.6-2.1m-12-2.3v2L30 39v-2z"></svg:path>`,
})
export class FlatColorIconsIdeaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsInspectionIcon],svg[flat-color-icons-inspection-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLibraryIcon],svg[flat-color-icons-library-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FF9800" d="M1 38h46v2H1zm24-20h4v16h-4zm6 0h4v16h-4zm6 0h4v16h-4zm-18 0h4v16h-4zm-6 0h4v16h-4zm-6 0h4v16H7zm36-2H5v-3l19-9l19 9zM5 34h38v2H5z"></svg:path><svg:g fill="#EF6C00"><svg:path d="M25 16h4v2h-4zm6 0h4v2h-4zm6 0h4v2h-4zm-18 0h4v2h-4zm-6 0h4v2h-4zm-6 0h4v2H7zM3 36h42v2H3z"></svg:path><svg:circle cx="24" cy="11" r="2"></svg:circle></svg:g>`,
})
export class FlatColorIconsLibraryIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLightAtTheEndOfTunnelIcon],svg[flat-color-icons-light-at-the-end-of-tunnel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#3F51B5" d="M6 10v28c0 2.2 1.8 4 4 4h28c2.2 0 4-1.8 4-4V10c0-2.2-1.8-4-4-4H10c-2.2 0-4 1.8-4 4"></svg:path><svg:path fill="#CCF2F6" d="M27.9 28.9h-5.8l-8.4 7.2l6-7.2v-2.4l-3 .8l3-1.9v-1.5c0-.8.1-1.7.6-2.4l-7.5-8.3l8.7 7.2c.7-.7 1.5-1.1 2.5-1.2l.6-7.3l1.1 7.3c.3 0 .6.1.8.1l1.2-1.2l-.3 1.7c.3.1.4.3.7.6l4.4-2.8l-3.6 3.9c.3.4.6 1 .7 1.7l2.2.1l-2.2.8v1.5l2.6 1.4l-2.6-.3v2.2l6.2 7.1z"></svg:path>`,
})
export class FlatColorIconsLightAtTheEndOfTunnelIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLikeIcon],svg[flat-color-icons-like-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#F44336" d="M34 9c-4.2 0-7.9 2.1-10 5.4C21.9 11.1 18.2 9 14 9C7.4 9 2 14.4 2 21c0 11.9 22 24 22 24s22-12 22-24c0-6.6-5.4-12-12-12"></svg:path>`,
})
export class FlatColorIconsLikeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLineChartIcon],svg[flat-color-icons-line-chart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#3F51B5"><svg:circle cx="8" cy="38" r="3"></svg:circle><svg:circle cx="16" cy="40" r="3"></svg:circle><svg:circle cx="24" cy="33" r="3"></svg:circle><svg:circle cx="32" cy="35" r="3"></svg:circle><svg:circle cx="40" cy="31" r="3"></svg:circle><svg:path d="m39.1 29.2l-7.3 3.7l-8.3-2.1l-8 7l-7-1.7l-1 3.8l9 2.3l8-7l7.7 1.9l8.7-4.3z"></svg:path></svg:g><svg:g fill="#00BCD4"><svg:circle cx="8" cy="20" r="3"></svg:circle><svg:circle cx="16" cy="22" r="3"></svg:circle><svg:circle cx="24" cy="15" r="3"></svg:circle><svg:circle cx="32" cy="20" r="3"></svg:circle><svg:circle cx="40" cy="8" r="3"></svg:circle><svg:path d="M38.3 6.9c-2.1 3.2-5.3 8-6.9 10.4c-1.2-.7-3.1-2-6.4-4l-1.3-.8l-8.3 7.3l-7-1.7l-1 3.9l9 2.3l7.7-6.7c2.6 1.6 5.8 3.6 6.5 4.1l.5.5l.9-.1c1.1-.1 1.1-.1 9.5-12.9z"></svg:path></svg:g>`,
})
export class FlatColorIconsLineChartIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLinuxIcon],svg[flat-color-icons-linux-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#ECEFF1" d="m20.1 16.2l.1 2.3l-1.6 3l-2.5 4.9l-.5 4.1l1.8 5.8l4.1 2.3h6.2l5.8-4.4l2.6-6.9l-6-7.3l-1.7-4.1z"></svg:path><svg:path fill="#263238" d="M34.3 21.9c-1.6-2.3-2.9-3.7-3.6-6.6s.2-2.1-.4-4.6c-.3-1.3-.8-2.2-1.3-2.9c-.6-.7-1.3-1.1-1.7-1.2c-.9-.5-3-1.3-5.6.1c-2.7 1.4-2.4 4.4-1.9 10.5c0 .4-.1.9-.3 1.3c-.4.9-1.1 1.7-1.7 2.4c-.7 1-1.4 2-1.9 3.1c-1.2 2.3-2.3 5.2-2 6.3c.5-.1 6.8 9.5 6.8 9.7c.4-.1 2.1-.1 3.6-.1c2.1-.1 3.3-.2 5 .2c0-.3-.1-.6-.1-.9c0-.6.1-1.1.2-1.8c.1-.5.2-1 .3-1.6c-1 .9-2.8 1.9-4.5 2.2c-1.5.3-4-.2-5.2-1.7c.1 0 .3 0 .4-.1c.3-.1.6-.2.7-.4c.3-.5.1-1-.1-1.3s-1.7-1.4-2.4-2s-1.1-.9-1.5-1.3l-.8-.8c-.2-.2-.3-.4-.4-.5c-.2-.5-.3-1.1-.2-1.9c.1-1.1.5-2 1-3c.2-.4.7-1.2.7-1.2s-1.7 4.2-.8 5.5c0 0 .1-1.3.5-2.6c.3-.9.8-2.2 1.4-2.9s2.1-3.3 2.2-4.9c0-.7.1-1.4.1-1.9c-.4-.4 6.6-1.4 7-.3c.1.4 1.5 4 2.3 5.9c.4.9.9 1.7 1.2 2.7c.3 1.1.5 2.6.5 4.1c0 .3 0 .8-.1 1.3c.2 0 4.1-4.2-.5-7.7c0 0 2.8 1.3 2.9 3.9c.1 2.1-.8 3.8-1 4.1c.1 0 2.1.9 2.2.9c.4 0 1.2-.3 1.2-.3c.1-.3.4-1.1.4-1.4c.7-2.3-1-6-2.6-8.3"></svg:path><svg:g fill="#ECEFF1" transform="translate(0 -2)"><svg:ellipse cx="21.6" cy="15.3" rx="1.3" ry="2"></svg:ellipse><svg:ellipse cx="26.1" cy="15.2" rx="1.7" ry="2.3"></svg:ellipse></svg:g><svg:g fill="#212121" transform="translate(0 -2)"><svg:ellipse cx="21.7" cy="15.5" rx="1.2" ry=".7" transform="rotate(-97.204 21.677 15.542)"></svg:ellipse><svg:ellipse cx="26" cy="15.6" rx="1" ry="1.3"></svg:ellipse></svg:g><svg:path fill="#FFC107" d="M39.3 35.6c-.4-.2-1.1-.5-1.7-1.4c-.3-.5-.2-1.9-.7-2.5c-.3-.4-.7-.2-.8-.2c-.9.2-3 1.6-4.4 0c-.2-.2-.5-.5-1-.5s-.7.2-.9.6s-.2.7-.2 1.7c0 .8 0 1.7-.1 2.4c-.2 1.7-.5 2.7-.5 3.7c0 1.1.3 1.8.7 2.1c.3.3.8.5 1.9.5s1.8-.4 2.5-1.1c.5-.5.9-.7 2.3-1.7c1.1-.7 2.8-1.6 3.1-1.9c.2-.2.5-.3.5-.9c0-.5-.4-.7-.7-.8m-20.1.3c-1-1.6-1.1-1.9-1.8-2.9c-.6-1-1.9-2.9-2.7-2.9c-.6 0-.9.3-1.3.7s-.8 1.3-1.5 1.8c-.6.5-2.3.4-2.7 1s.4 1.5.4 3c0 .6-.5 1-.6 1.4c-.1.5-.2.8 0 1.2c.4.6.9.8 4.3 1.5c1.8.4 3.5 1.4 4.6 1.5s3 0 3-2.7c.1-1.6-.8-2-1.7-3.6m1.9-18.1c-.6-.4-1.1-.8-1.1-1.4s.4-.8 1-1.3c.1-.1 1.2-1.1 2.3-1.1s2.4.7 2.9.9c.9.2 1.8.4 1.7 1.1c-.1 1-.2 1.2-1.2 1.7c-.7.2-2 1.3-2.9 1.3c-.4 0-1 0-1.4-.1c-.3-.1-.8-.6-1.3-1.1"></svg:path><svg:path fill="#634703" d="M20.9 17c.2.2.5.4.8.5c.2.1.5.2.5.2h.9c.5 0 1.2-.2 1.9-.6c.7-.3.8-.5 1.3-.7c.5-.3 1-.6.8-.7s-.4 0-1.1.4c-.6.4-1.1.6-1.7.9c-.3.1-.7.3-1 .3h-.9c-.3 0-.5-.1-.8-.2c-.2-.1-.3-.2-.4-.2c-.2-.1-.6-.5-.8-.6c0 0-.2 0-.1.1zm3-2.2c.1.2.3.2.4.3s.2.1.2.1c.1-.1 0-.3-.1-.3c0-.2-.5-.2-.5-.1m-1.6.2c0 .1.2.2.2.1c.1-.1.2-.2.3-.2c.2-.1.1-.2-.2-.2c-.2.1-.2.2-.3.3"></svg:path><svg:path fill="#455A64" d="M32 32.7v.3c.2.4.7.5 1.1.5c.6 0 1.2-.4 1.5-.8c0-.1.1-.2.2-.3c.2-.3.3-.5.4-.6c0 0-.1-.1-.1-.2c-.1-.2-.4-.4-.8-.5c-.3-.1-.8-.2-1-.2c-.9-.1-1.4.2-1.7.5c0 0 .1 0 .1.1c.2.2.3.4.3.7c.1.2 0 .3 0 .5"></svg:path>`,
})
export class FlatColorIconsLinuxIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLockIcon],svg[flat-color-icons-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#424242" d="M24 4c-5.5 0-10 4.5-10 10v4h4v-4c0-3.3 2.7-6 6-6s6 2.7 6 6v4h4v-4c0-5.5-4.5-10-10-10"></svg:path><svg:path fill="#FB8C00" d="M36 44H12c-2.2 0-4-1.8-4-4V22c0-2.2 1.8-4 4-4h24c2.2 0 4 1.8 4 4v18c0 2.2-1.8 4-4 4"></svg:path><svg:circle cx="24" cy="31" r="3" fill="#C76E00"></svg:circle>`,
})
export class FlatColorIconsLockIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsLowBatteryIcon],svg[flat-color-icons-low-battery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#CFD8DC"><svg:path d="M34 44H14c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2h20c1.1 0 2 .9 2 2v34c0 1.1-.9 2-2 2"></svg:path><svg:path d="M28 13h-8c-.6 0-1-.4-1-1V5c0-.6.4-1 1-1h8c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1"></svg:path></svg:g><svg:path fill="#8BC34A" d="M34 44H14c-1.1 0-2-.9-2-2v-9h24v9c0 1.1-.9 2-2 2"></svg:path>`,
})
export class FlatColorIconsLowBatteryIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsMiddleBatteryIcon],svg[flat-color-icons-middle-battery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#CFD8DC"><svg:path d="M34 44H14c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2h20c1.1 0 2 .9 2 2v34c0 1.1-.9 2-2 2"></svg:path><svg:path d="M28 13h-8c-.6 0-1-.4-1-1V5c0-.6.4-1 1-1h8c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1"></svg:path></svg:g><svg:path fill="#8BC34A" d="M34 44H14c-1.1 0-2-.9-2-2V23h24v19c0 1.1-.9 2-2 2"></svg:path>`,
})
export class FlatColorIconsMiddleBatteryIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsMissedCallIcon],svg[flat-color-icons-missed-call-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#F44336"><svg:path d="M30.3 12.9L24 19.2l-8.3-8.3l-2.8 2.8L24 24.8l9.1-9.1z"></svg:path><svg:path d="m36 19l-9-9h9z"></svg:path></svg:g><svg:path fill="#009688" d="m44.5 30.8l-2.4-2.4c-8.5-8.3-28.9-7.1-36.2 0l-2.4 2.4c-.7.7-.7 1.7 0 2.4l4.8 4.7c.7.7 1.7.7 2.4 0l5.3-5.1l-.4-5.6c1.7-1.7 15.1-1.7 16.8 0l-.3 5.8l5.1 4.9c.7.7 1.7.7 2.4 0l4.8-4.7c.8-.7.8-1.8.1-2.4"></svg:path>`,
})
export class FlatColorIconsMissedCallIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsNfcSignIcon],svg[flat-color-icons-nfc-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#2196F3" d="M37 42c-.3 0-.7-.1-1-.3c-1-.5-1.3-1.8-.8-2.7c0-.1 3.7-6.8 3.7-15S35.3 9 35.3 9c-.5-1-.2-2.2.8-2.7s2.2-.2 2.7.8c.2.3 4.3 7.6 4.3 17s-4.1 16.7-4.3 17c-.4.5-1.1.9-1.8.9m-4.2-6.2c.1-.2 2.2-5 2.2-11.8s-2.1-11.6-2.2-11.8c-.4-1-1.6-1.5-2.6-1c-1 .4-1.5 1.6-1 2.6c0 0 1.8 4.3 1.8 10.2s-1.8 10.2-1.8 10.2c-.4 1 0 2.2 1 2.6c.3.1.5.2.8.2c.8 0 1.5-.4 1.8-1.2M23.3 33c.6-.1 1.1-.5 1.4-1c.1-.2 2.3-3.9 2.3-8s-2.2-7.9-2.3-8c-.6-1-1.8-1.3-2.7-.7c-1 .6-1.3 1.8-.7 2.7c0 0 1.7 3 1.7 6c0 1.3-.3 2.7-.7 3.7l-13-11.2c-.5-.4-1.2-.6-1.8-.4s-1.2.6-1.4 1.3c0 .1-1.1 3.1-1.1 6.6s1.1 6.5 1.1 6.7c.4 1 1.5 1.6 2.6 1.2c1-.4 1.6-1.5 1.2-2.6c0 0-.9-2.6-.9-5.3c0-.8.1-1.6.2-2.3l12.5 10.8c.4.3.8.5 1.3.5z"></svg:path>`,
})
export class FlatColorIconsNfcSignIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsNoIdeaIcon],svg[flat-color-icons-no-idea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FBC02D" d="M37 22c0-7.7-6.6-13.8-14.5-12.9c-6 .7-10.8 5.5-11.4 11.5c-.5 4.6 1.4 8.7 4.6 11.3c1.4 1.2 2.3 2.9 2.3 4.8v.3h12v-.1c0-1.8.8-3.6 2.2-4.8c2.9-2.4 4.8-6 4.8-10.1"></svg:path><svg:path fill="#FFF59D" d="m30.6 20.2l-3-2c-.3-.2-.8-.2-1.1 0L24 19.8l-2.4-1.6c-.3-.2-.8-.2-1.1 0l-3 2c-.2.2-.4.4-.4.7s0 .6.2.8l3.8 4.7V37h2V26c0-.2-.1-.4-.2-.6l-3.3-4.1l1.5-1l2.4 1.6c.3.2.8.2 1.1 0l2.4-1.6l1.5 1l-3.3 4.1c-.1.2-.2.4-.2.6v11h2V26.4l3.8-4.7c.2-.2.3-.5.2-.8s-.2-.6-.4-.7"></svg:path><svg:circle cx="24" cy="44" r="3" fill="#5C6BC0"></svg:circle><svg:path fill="#9FA8DA" d="M26 45h-4c-2.2 0-4-1.8-4-4v-5h12v5c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#5C6BC0" d="m30 41l-11.6 1.6c.3.7.9 1.4 1.6 1.8l9.4-1.3q.6-.9.6-2.1m-12-2.3v2L30 39v-2z"></svg:path><svg:path fill="#37474F" d="M3.563 6.396L6.39 3.568l37.966 37.966l-2.828 2.828z"></svg:path>`,
})
export class FlatColorIconsNoIdeaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsNumericalSorting12Icon],svg[flat-color-icons-numerical-sorting-12-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#546E7A" d="M38 33V5h-4v28h-6l8 10l8-10z"></svg:path><svg:path fill="#2196F3" d="M16.4 20h-3V8.6L9.9 9.7V7.3L16 5.1h.3V20zm3 23H9.2v-2l4.8-5.1c.4-.4.7-.8.9-1.1s.5-.6.6-.9c.2-.3.3-.5.3-.8c.1-.2.1-.5.1-.7c0-.7-.2-1.2-.5-1.6s-.8-.6-1.4-.6c-.3 0-.7.1-.9.2c-.3.1-.5.3-.7.5s-.3.5-.4.8s-.1.6-.1 1h-3c0-.7.1-1.3.4-1.9c.2-.6.6-1.1 1-1.6c.5-.4 1-.8 1.6-1.1s1.4-.4 2.2-.4q1.2 0 2.1.3c.6.2 1.1.5 1.5.8s.7.8.9 1.3s.3 1.1.3 1.8c0 .5-.1 1-.2 1.4s-.4 1.2-.7 1.7s-.6.9-1 1.4s-.9 1-1.4 1.5L13 40.6h6.4z"></svg:path>`,
})
export class FlatColorIconsNumericalSorting12Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsNumericalSorting21Icon],svg[flat-color-icons-numerical-sorting-21-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#546E7A" d="M38 33V5h-4v28h-6l8 10l8-10z"></svg:path><svg:path fill="#2196F3" d="M19.2 20H9v-2l4.8-5.1c.4-.4.7-.8.9-1.1s.5-.6.6-.9c.2-.3.3-.5.3-.8c.1-.2.1-.5.1-.7c0-.7-.2-1.2-.5-1.6s-.8-.6-1.4-.6c-.3 0-.7.1-.9.2c-.3.1-.5.3-.7.5s-.3.5-.4.8s-.1.6-.1 1h-3c0-.7.1-1.3.4-1.9c.2-.6.6-1.1 1-1.6c.5-.4 1-.8 1.6-1.1s1.4-.4 2.2-.4q1.2 0 2.1.3c.6.2 1.1.5 1.5.8s.7.8.9 1.3q.3.75.3 1.8c0 .5-.1 1-.2 1.4s-.4.9-.7 1.4s-.6.9-1 1.4s-.9 1-1.4 1.5l-2.6 2.8h6.4zm-3 23h-3V31.6l-3.5 1.1v-2.4l6.2-2.2h.3z"></svg:path>`,
})
export class FlatColorIconsNumericalSorting21Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsOnlineSupportIcon],svg[flat-color-icons-online-support-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#BF360C" d="M13 30h22v12H13z"></svg:path><svg:g fill="#FFA726"><svg:circle cx="10" cy="26" r="4"></svg:circle><svg:circle cx="38" cy="26" r="4"></svg:circle></svg:g><svg:path fill="#FFB74D" d="M39 19c0-12.7-30-8.3-30 0v10c0 8.3 6.7 15 15 15s15-6.7 15-15z"></svg:path><svg:g fill="#784719"><svg:circle cx="30" cy="26" r="2"></svg:circle><svg:circle cx="18" cy="26" r="2"></svg:circle></svg:g><svg:path fill="#FF5722" d="M24 2C15.5 2 3 7.8 3 35.6L13 42V24l16.8-9.8L35 21v21l10-8.2c0-5.6-.9-29-15.4-29L28.2 2z"></svg:path><svg:path fill="#757575" d="M45 24c-.6 0-1 .4-1 1v-7c0-8.8-7.2-16-16-16h-9c-.6 0-1 .4-1 1s.4 1 1 1h9c7.7 0 14 6.3 14 14v10c0 .6.4 1 1 1s1-.4 1-1v2c0 3.9-3.1 7-7 7H24c-.6 0-1 .4-1 1s.4 1 1 1h13c5 0 9-4 9-9v-5c0-.6-.4-1-1-1"></svg:path><svg:g fill="#37474F"><svg:path d="M45 22h-1c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h1c1.1 0 2-.9 2-2v-4c0-1.1-.9-2-2-2"></svg:path><svg:circle cx="24" cy="38" r="2"></svg:circle></svg:g>`,
})
export class FlatColorIconsOnlineSupportIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsPlannerIcon],svg[flat-color-icons-planner-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M5 38V14h38v24c0 2.2-1.8 4-4 4H9c-2.2 0-4-1.8-4-4"></svg:path><svg:path fill="#F44336" d="M43 10v6H5v-6c0-2.2 1.8-4 4-4h30c2.2 0 4 1.8 4 4"></svg:path><svg:g fill="#B71C1C"><svg:circle cx="33" cy="10" r="3"></svg:circle><svg:circle cx="15" cy="10" r="3"></svg:circle></svg:g><svg:path fill="#B0BEC5" d="M33 3c-1.1 0-2 .9-2 2v5c0 1.1.9 2 2 2s2-.9 2-2V5c0-1.1-.9-2-2-2M15 3c-1.1 0-2 .9-2 2v5c0 1.1.9 2 2 2s2-.9 2-2V5c0-1.1-.9-2-2-2m-2 18h6v6h-6zm8 0h6v6h-6zm8 0h6v6h-6zm-16 8h6v6h-6zm8 0h6v6h-6z"></svg:path><svg:path fill="#F44336" d="M29 29h6v6h-6z"></svg:path>`,
})
export class FlatColorIconsPlannerIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsPrivacyIcon],svg[flat-color-icons-privacy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#424242" d="M24 4c-5.5 0-10 4.5-10 10v4h4v-4c0-3.3 2.7-6 6-6s6 2.7 6 6v4h4v-4c0-5.5-4.5-10-10-10"></svg:path><svg:path fill="#FB8C00" d="M36 44H12c-2.2 0-4-1.8-4-4V22c0-2.2 1.8-4 4-4h24c2.2 0 4 1.8 4 4v18c0 2.2-1.8 4-4 4"></svg:path><svg:circle cx="24" cy="31" r="6" fill="#EFEBE9"></svg:circle><svg:circle cx="24" cy="31" r="3" fill="#1E88E5"></svg:circle><svg:circle cx="26" cy="29" r="1" fill="#fff"></svg:circle>`,
})
export class FlatColorIconsPrivacyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsProcessIcon],svg[flat-color-icons-process-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#9C27B0"><svg:path d="m31 8l11.9 1.6l-9.8 9.8zM17 40L5.1 38.4l9.8-9.8zM8 17L9.6 5.1l9.8 9.8z"></svg:path><svg:path d="m9.3 21.2l-4.2.8c-.1.7-.1 1.3-.1 2c0 4.6 1.6 9 4.6 12.4l3-2.6C10.3 31.1 9 27.6 9 24c0-.9.1-1.9.3-2.8M24 5c-5.4 0-10.2 2.3-13.7 5.9l2.8 2.8C15.9 10.8 19.7 9 24 9c.9 0 1.9.1 2.8.3l.7-3.9C26.4 5.1 25.2 5 24 5m14.7 21.8l4.2-.8c.1-.7.1-1.3.1-2c0-4.4-1.5-8.7-4.3-12.1l-3.1 2.5c2.2 2.7 3.4 6.1 3.4 9.5c0 1-.1 2-.3 2.9m-3.8 7.5C32.1 37.2 28.3 39 24 39c-.9 0-1.9-.1-2.8-.3l-.7 3.9c1.2.2 2.4.3 3.5.3c5.4 0 10.2-2.3 13.7-5.9z"></svg:path><svg:path d="m40 31l-1.6 11.9l-9.8-9.8z"></svg:path></svg:g>`,
})
export class FlatColorIconsProcessIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsPuzzleIcon],svg[flat-color-icons-puzzle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsQuestionsIcon],svg[flat-color-icons-questions-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#42A5F5" d="M36 44H8V8h20l8 8z"></svg:path><svg:path fill="#90CAF9" d="M40 40H12V4h20l8 8z"></svg:path><svg:path fill="#E1F5FE" d="M38.5 13H31V5.5z"></svg:path><svg:path fill="#1976D2" d="M24.5 28.3c0-4.7 3.6-4.4 3.6-7.2c0-.7-.2-2.1-2-2.1c-2 0-2.1 1.6-2.1 2h-2.7c0-.7.3-4.2 4.8-4.2c4.6 0 4.7 3.6 4.7 4.3c0 3.5-3.8 4-3.8 7.3h-2.5zm-.2 3.5c0-.2 0-1.5 1.5-1.5c1.4 0 1.5 1.3 1.5 1.5c0 .4-.2 1.4-1.5 1.4s-1.5-1-1.5-1.4"></svg:path>`,
})
export class FlatColorIconsQuestionsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsRadarPlotIcon],svg[flat-color-icons-radar-plot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M38.4 13L24.1 6.4L4.6 12.1l8.8 13.2l-2.2 15.1h22.7l6.6-13.3zm-6.3 24.5H14.7l1.8-12.9l-7.1-10.7l14.5-4.3L35.6 15l1.8 11.7z"></svg:path><svg:g fill="#00BCD4"><svg:circle cx="24" cy="8" r="4"></svg:circle><svg:circle cx="37" cy="14" r="4"></svg:circle><svg:circle cx="39" cy="27" r="4"></svg:circle><svg:circle cx="7" cy="13" r="4"></svg:circle><svg:circle cx="13" cy="39" r="4"></svg:circle><svg:circle cx="15" cy="25" r="4"></svg:circle><svg:circle cx="33" cy="39" r="4"></svg:circle></svg:g>`,
})
export class FlatColorIconsRadarPlotIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsReadingEbookIcon],svg[flat-color-icons-reading-ebook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#2196F3" d="M33.5 27c-2.2-3-5.2-5-9.5-5s-7.3 2-9.5 5z"></svg:path><svg:path fill="#546E7A" d="M34.1 43H13.9c-1.1 0-1.9-.8-2-1.9l-.8-13c0-1.1.9-2.1 2-2.1h21.8c1.2 0 2.1 1 2 2.1l-.8 13c-.1 1.1-.9 1.9-2 1.9"></svg:path><svg:circle cx="34" cy="29" r="1" fill="#B0BEC5"></svg:circle><svg:g fill="#FFB74D"><svg:circle cx="24" cy="12" r="8"></svg:circle><svg:path d="M16.1 42.4L15 43.5c-.6.6-1.6.6-2.2 0l-3.3-3.3c-.6-.6-.6-1.6 0-2.2l1.1-1.1c1.3-1.3 3.1-1.3 4.4 0l1.1 1.1c1.2 1.3 1.2 3.2 0 4.4M31.9 38l1.1-1.1c1.3-1.3 3.1-1.3 4.4 0l1.1 1.1c.6.6.6 1.6 0 2.2l-3.3 3.3c-.6.6-1.6.6-2.2 0l-1.1-1.1c-1.2-1.2-1.2-3.1 0-4.4"></svg:path></svg:g>`,
})
export class FlatColorIconsReadingEbookIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsRedditIcon],svg[flat-color-icons-reddit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FFF" d="M12.193 19.555c-1.94-1.741-4.79-1.727-6.365.029s-1.301 5.023.926 6.632zm23.614 0c1.939-1.741 4.789-1.727 6.365.029c1.575 1.756 1.302 5.023-.927 6.632z"></svg:path><svg:circle cx="38.32" cy="10.475" r="3.5" fill="#FFF"></svg:circle><svg:ellipse cx="24.085" cy="28.611" fill="#FFF" rx="18.085" ry="12.946"></svg:ellipse><svg:g fill="#D84315"><svg:circle cx="30.365" cy="26.39" r="2.884"></svg:circle><svg:circle cx="17.635" cy="26.39" r="2.884"></svg:circle></svg:g><svg:g fill="#37474F"><svg:path d="M24.002 34.902c-3.252 0-6.14-.745-8.002-1.902c1.024 2.044 4.196 4 8.002 4c3.802 0 6.976-1.956 7.998-4c-1.857 1.157-4.746 1.902-7.998 1.902m17.828-7.876l-1.17-1.621c.831-.6 1.373-1.556 1.488-2.623c.105-.98-.157-1.903-.721-2.531c-.571-.637-1.391-.99-2.307-.994a4.08 4.08 0 0 0-2.646 1.041l-1.336-1.488a6.14 6.14 0 0 1 3.991-1.553c1.488.007 2.833.596 3.786 1.658c.942 1.05 1.387 2.537 1.221 4.081c-.175 1.63-1.015 3.1-2.306 4.03m-35.661 0c-1.29-.932-2.131-2.401-2.306-4.031c-.166-1.543.279-3.03 1.221-4.079c.953-1.062 2.297-1.651 3.785-1.658h.027c1.441 0 2.849.551 3.965 1.553l-1.336 1.488c-.753-.676-1.689-1.005-2.646-1.041c-.916.004-1.735.357-2.306.994c-.563.628-.826 1.55-.721 2.53c.115 1.067.657 2.023 1.488 2.624zM25 16.84h-2c0-2.885 0-10.548 4.979-10.548c2.154 0 3.193 1.211 3.952 2.096c.629.734.961 1.086 1.616 1.086h1.37v2h-1.37c-1.604 0-2.453-.99-3.135-1.785c-.67-.781-1.198-1.398-2.434-1.398C25.975 8.292 25 11.088 25 16.84"></svg:path><svg:path d="M24.085 16.95c9.421 0 17.085 5.231 17.085 11.661c0 6.431-7.664 11.662-17.085 11.662S7 35.042 7 28.611c0-6.43 7.664-11.661 17.085-11.661m0-2C13.544 14.95 5 21.066 5 28.611c0 7.546 8.545 13.662 19.085 13.662S43.17 36.157 43.17 28.611c0-7.545-8.545-13.661-19.085-13.661M38.32 7.975c1.379 0 2.5 1.122 2.5 2.5s-1.121 2.5-2.5 2.5s-2.5-1.122-2.5-2.5s1.121-2.5 2.5-2.5m0-2a4.501 4.501 0 1 0 .002 9.002a4.501 4.501 0 0 0-.002-9.002"></svg:path></svg:g>`,
})
export class FlatColorIconsRedditIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsRegisteredTrademarkIcon],svg[flat-color-icons-registered-trademark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21" fill="#9C27B0"></svg:circle><svg:path fill="#E1BEE7" d="M25 26.8h-4.5v9h-4V12.5h8.2c1.3 0 2.5.2 3.6.5c1 .3 1.9.8 2.6 1.3c.7.6 1.3 1.3 1.6 2.2s.6 1.9.6 3c0 1.6-.4 2.9-1.1 3.9c-.8 1-1.8 1.9-3.1 2.4l5.2 9.7v.2h-4.3zm-4.5-3.2h4.2c.7 0 1.4-.1 1.9-.3s1-.5 1.4-.8s.6-.7.8-1.2s.3-1 .3-1.6s-.1-1.1-.3-1.6s-.4-.9-.8-1.2s-.8-.6-1.4-.8c-.5-.2-1.2-.3-2-.3h-4.1z"></svg:path>`,
})
export class FlatColorIconsRegisteredTrademarkIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsRotateToPortraitIcon],svg[flat-color-icons-rotate-to-portrait-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#37474F" d="M41 38H7c-2.2 0-4-1.8-4-4V14c0-2.2 1.8-4 4-4h34c2.2 0 4 1.8 4 4v20c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#F3E5F5" d="M6 14v20c0 .6.4 1 1 1h34c.6 0 1-.4 1-1V14c0-.6-.4-1-1-1H7c-.6 0-1 .4-1 1"></svg:path><svg:path fill="#9C27B0" d="m26 15l-5.9 7h11.8z"></svg:path><svg:path fill="#9C27B0" d="M24 21v6c0 1.1-.9 2-2 2s-2-.9-2-2v-2h-4v2c0 3.3 2.7 6 6 6s6-2.7 6-6v-6z"></svg:path>`,
})
export class FlatColorIconsRotateToPortraitIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsRulerIcon],svg[flat-color-icons-ruler-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSafeIcon],svg[flat-color-icons-safe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#455A64" d="M8 39h6v3H8zm26 0h6v3h-6z"></svg:path><svg:path fill="#78909C" d="M40 41H8c-2.2 0-4-1.8-4-4V11c0-2.2 1.8-4 4-4h32c2.2 0 4 1.8 4 4v26c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#90A4AE" d="M40 38H8c-.6 0-1-.4-1-1V11c0-.6.4-1 1-1h32c.6 0 1 .4 1 1v26c0 .6-.4 1-1 1"></svg:path><svg:path fill="#37474F" d="M29 14c-5.5 0-10 4.5-10 10s4.5 10 10 10s10-4.5 10-10s-4.5-10-10-10m0 17c-3.9 0-7-3.1-7-7s3.1-7 7-7s7 3.1 7 7s-3.1 7-7 7"></svg:path><svg:path fill="#B0BEC5" d="m35.3 19.1l.4-.4c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-.4.4c.5.4 1 .9 1.4 1.4m-12.6 0c.4-.5.9-1 1.4-1.4l-.4-.4c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4zM21 24c0-.3 0-.7.1-1h-.6c-.6 0-1 .4-1 1s.4 1 1 1h.6c-.1-.3-.1-.7-.1-1m8-8c.3 0 .7 0 1 .1v-.6c0-.6-.4-1-1-1s-1 .4-1 1v.6c.3-.1.7-.1 1-.1m6.3 12.9c-.4.5-.9 1-1.4 1.4l.4.4c.2.2.5.3.7.3s.5-.1.7-.3c.4-.4.4-1 0-1.4zm-12.6 0l-.4.4c-.4.4-.4 1 0 1.4c.2.2.5.3.7.3s.5-.1.7-.3l.4-.4c-.5-.4-1-.9-1.4-1.4M37.5 23h-.6c0 .3.1.7.1 1s0 .7-.1 1h.6c.6 0 1-.4 1-1s-.4-1-1-1M29 32c-.3 0-.7 0-1-.1v.6c0 .6.4 1 1 1s1-.4 1-1v-.6c-.3.1-.7.1-1 .1"></svg:path><svg:path fill="#455A64" d="M12 20c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2s2-.9 2-2v-8c0-1.1-.9-2-2-2"></svg:path><svg:path fill="#CFD8DC" d="M12 18c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2s2-.9 2-2v-8c0-1.1-.9-2-2-2"></svg:path>`,
})
export class FlatColorIconsSafeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSalesPerformanceIcon],svg[flat-color-icons-sales-performance-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#FFA000"><svg:path d="M38 13c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 10c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2V8c0 1.1-2.7 2-6 2m0 6c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 19c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 22c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 25c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 28c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 31c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 34c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 37c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M38 40c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path></svg:g><svg:g fill="#FFC107"><svg:ellipse cx="38" cy="8" rx="6" ry="2"></svg:ellipse><svg:path d="M38 12c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5"></svg:path></svg:g><svg:g fill="#FFA000"><svg:path d="M10 19c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 16c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2m0 6c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 25c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 28c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 31c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 34c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 37c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M10 40c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path></svg:g><svg:g fill="#FFC107"><svg:ellipse cx="10" cy="14" rx="6" ry="2"></svg:ellipse><svg:path d="M10 18c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5"></svg:path></svg:g><svg:g fill="#FFA000"><svg:path d="M24 28c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M24 25c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2m0 6c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M24 34c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M24 37c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path><svg:path d="M24 40c-3.3 0-6-.9-6-2v2c0 1.1 2.7 2 6 2s6-.9 6-2v-2c0 1.1-2.7 2-6 2"></svg:path></svg:g><svg:g fill="#FFC107"><svg:ellipse cx="24" cy="23" rx="6" ry="2"></svg:ellipse><svg:path d="M24 27c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5m0 3c-2.8 0-5.1-.6-5.8-1.5c-.1.2-.2.3-.2.5c0 1.1 2.7 2 6 2s6-.9 6-2c0-.2-.1-.3-.2-.5c-.7.9-3 1.5-5.8 1.5"></svg:path></svg:g>`,
})
export class FlatColorIconsSalesPerformanceIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSearchIcon],svg[flat-color-icons-search-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#616161"><svg:path d="m29.175 31.99l2.828-2.827l12.019 12.019l-2.828 2.827z"></svg:path><svg:circle cx="20" cy="20" r="16"></svg:circle></svg:g><svg:path fill="#37474F" d="m32.45 35.34l2.827-2.828l8.696 8.696l-2.828 2.828z"></svg:path><svg:circle cx="20" cy="20" r="13" fill="#64B5F6"></svg:circle><svg:path fill="#BBDEFB" d="M26.9 14.2c-1.7-2-4.2-3.2-6.9-3.2s-5.2 1.2-6.9 3.2c-.4.4-.3 1.1.1 1.4c.4.4 1.1.3 1.4-.1C16 13.9 17.9 13 20 13s4 .9 5.4 2.5c.2.2.5.4.8.4c.2 0 .5-.1.6-.2c.4-.4.4-1.1.1-1.5"></svg:path>`,
})
export class FlatColorIconsSearchIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsServiceMarkIcon],svg[flat-color-icons-service-mark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21" fill="#9C27B0"></svg:circle><svg:path fill="#E1BEE7" d="M16.7 28.2c0-3.8-7.3-2.2-7.3-8.1c0-.7.4-4.8 5.5-4.8s5.4 4.5 5.4 5.3h-3.5c0-.4 0-2.5-2-2.5c-1.8 0-1.9 1.7-1.9 2c0 3 7.4 2 7.4 8.1c0 2-1.1 4.8-5.3 4.8c-4.7 0-6-3.4-6-5.7h3.5c0 .5-.2 2.8 2.5 2.8c1.8.1 1.7-1.6 1.7-1.9m10.4-12.6L30.3 28l3.2-12.4H38v17.2h-3.5v-4.6l.3-7.2l-3.4 11.8H29L25.6 21l.3 7.2v4.6h-3.5V15.6z"></svg:path>`,
})
export class FlatColorIconsServiceMarkIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsServicesIcon],svg[flat-color-icons-services-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#E65100" d="M25.6 34.4c.1-.4.1-.9.1-1.4s0-.9-.1-1.4l2.8-2c.3-.2.4-.6.2-.9l-2.7-4.6c-.2-.3-.5-.4-.8-.3L22 25.3c-.7-.6-1.5-1-2.4-1.4l-.3-3.4c0-.3-.3-.6-.6-.6h-5.3c-.3 0-.6.3-.6.6l-.4 3.5c-.9.3-1.6.8-2.4 1.4L6.9 24c-.3-.1-.7 0-.8.3l-2.7 4.6c-.2.3-.1.7.2.9l2.8 2c-.1.4-.1.9-.1 1.4s0 .9.1 1.4l-2.8 2c-.3.2-.4.6-.2.9l2.7 4.6c.2.3.5.4.8.3L10 41c.7.6 1.5 1 2.4 1.4l.3 3.4c0 .3.3.6.6.6h5.3c.3 0 .6-.3.6-.6l.3-3.4c.9-.3 1.6-.8 2.4-1.4l3.1 1.4c.3.1.7 0 .8-.3l2.7-4.6c.2-.3.1-.7-.2-.9zM16 38c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5"></svg:path><svg:path fill="#FFA000" d="M41.9 15.3c.1-.5.1-.9.1-1.3s0-.8-.1-1.3l2.5-1.8c.3-.2.3-.5.2-.8l-2.5-4.3c-.2-.3-.5-.4-.8-.2l-2.9 1.3c-.7-.5-1.4-.9-2.2-1.3l-.3-3.1c.1-.3-.1-.5-.4-.5h-4.9c-.3 0-.6.2-.6.5l-.3 3.1c-.8.3-1.5.7-2.2 1.3l-2.9-1.3c-.3-.1-.6 0-.8.2l-2.5 4.3c-.2.3-.1.6.2.8l2.5 1.8V14c0 .4 0 .8.1 1.3l-2.5 1.8c-.3.2-.3.5-.2.8l2.5 4.3c.2.3.5.4.8.2l2.9-1.3c.7.5 1.4.9 2.2 1.3l.3 3.1c0 .3.3.5.6.5h4.9c.3 0 .6-.2.6-.5l.3-3.1c.8-.3 1.5-.7 2.2-1.3l2.9 1.3c.3.1.6 0 .8-.2l2.5-4.3c.2-.3.1-.6-.2-.8zM33 19c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5"></svg:path>`,
})
export class FlatColorIconsServicesIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSettingsIcon],svg[flat-color-icons-settings-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#607D8B" d="M39.6 27.2c.1-.7.2-1.4.2-2.2s-.1-1.5-.2-2.2l4.5-3.2c.4-.3.6-.9.3-1.4L40 10.8c-.3-.5-.8-.7-1.3-.4l-5 2.3c-1.2-.9-2.4-1.6-3.8-2.2L29.4 5c-.1-.5-.5-.9-1-.9h-8.6c-.5 0-1 .4-1 .9l-.5 5.5c-1.4.6-2.7 1.3-3.8 2.2l-5-2.3c-.5-.2-1.1 0-1.3.4l-4.3 7.4c-.3.5-.1 1.1.3 1.4l4.5 3.2c-.1.7-.2 1.4-.2 2.2s.1 1.5.2 2.2L4 30.4c-.4.3-.6.9-.3 1.4L8 39.2c.3.5.8.7 1.3.4l5-2.3c1.2.9 2.4 1.6 3.8 2.2l.5 5.5c.1.5.5.9 1 .9h8.6c.5 0 1-.4 1-.9l.5-5.5c1.4-.6 2.7-1.3 3.8-2.2l5 2.3c.5.2 1.1 0 1.3-.4l4.3-7.4c.3-.5.1-1.1-.3-1.4zM24 35c-5.5 0-10-4.5-10-10s4.5-10 10-10s10 4.5 10 10s-4.5 10-10 10"></svg:path><svg:path fill="#455A64" d="M24 13c-6.6 0-12 5.4-12 12s5.4 12 12 12s12-5.4 12-12s-5.4-12-12-12m0 17c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5"></svg:path>`,
})
export class FlatColorIconsSettingsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsShopIcon],svg[flat-color-icons-shop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M5 19h38v19H5z"></svg:path><svg:path fill="#B0BEC5" d="M5 38h38v4H5z"></svg:path><svg:path fill="#455A64" d="M27 24h12v18H27z"></svg:path><svg:path fill="#E3F2FD" d="M9 24h14v11H9z"></svg:path><svg:path fill="#1E88E5" d="M10 25h12v9H10z"></svg:path><svg:path fill="#90A4AE" d="M36.5 33.5c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5s.5-.2.5-.5v-2c0-.3-.2-.5-.5-.5"></svg:path><svg:g fill="#558B2F"><svg:circle cx="24" cy="19" r="3"></svg:circle><svg:circle cx="36" cy="19" r="3"></svg:circle><svg:circle cx="12" cy="19" r="3"></svg:circle></svg:g><svg:path fill="#7CB342" d="M40 6H8c-1.1 0-2 .9-2 2v3h36V8c0-1.1-.9-2-2-2m-19 5h6v8h-6zm16 0h-5l1 8h6zm-26 0h5l-1 8H9z"></svg:path><svg:g fill="#FFA000"><svg:circle cx="30" cy="19" r="3"></svg:circle><svg:path d="M45 19c0 1.7-1.3 3-3 3s-3-1.3-3-3s1.3-3 3-3z"></svg:path><svg:circle cx="18" cy="19" r="3"></svg:circle><svg:path d="M3 19c0 1.7 1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3z"></svg:path></svg:g><svg:path fill="#FFC107" d="M32 11h-5v8h6zm10 0h-5l2 8h6zm-26 0h5v8h-6zM6 11h5l-2 8H3z"></svg:path>`,
})
export class FlatColorIconsShopIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSignatureIcon],svg[flat-color-icons-signature-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#1565C0" d="M38.8 28.2C41.5 24.8 45 20.1 45 12c0-.6-.4-1-1-1s-1 .4-1 1c0 6.7-2.5 10.7-5 13.9c-.6-1.9-1-4.2-1-6.9c0-.5-.4-1-1-1c-.5 0-1 .4-1 1c-.1 1.7-.6 3.6-1 3.8c-.4 0-.9-1.4-1-2.8c0-.5-.5-.9-1-.9s-1 .3-1 .9c-.3 1.7-1.1 4.1-2 4.1c-.4 0-.6-.1-.7-.3c-.3-.3-.4-1-.4-1.6c0-.4.1-.8.1-1.2c0-.5-.4-1-.9-1s-1 .3-1.1.8c0 .1-.1.5-.1 1.1c-.2 1.7-.8 5.1-2.9 5.1c-.7 0-1.1-.2-1.4-.7c-.5-.8-.5-2.1 0-3.3v-.1c.1-.1.1-.3.2-.4c.8-1.6 1.7-2.5 3.2-2.5c.6 0 1-.4 1-1s-.4-1-1-1c-4.2 0-5.4 4.1-6.6 8c-1.4 4.8-2.7 8-6.4 8c-5.1 0-7-6.6-7-11c0-8.6 4.7-14 9-14c2.9 0 4 2.3 4.1 2.4c.2.5.8.7 1.3.5s.7-.8.5-1.3C19.8 10.4 18.2 7 14 7C8.6 7 3 13 3 23c0 10.3 5.9 13 9 13c5.1 0 6.8-4.5 8.1-8.5c.7.9 1.7 1.5 2.9 1.5c2.2 0 3.5-1.6 4.2-3.6q.75.6 1.8.6c1.4 0 2.4-1.2 3-2.4c.4.7 1.1 1.2 2 1.2c.6 0 1.1-.3 1.5-.7c.3 1.4.7 2.7 1 3.8c-1.4 1.8-2.5 3.3-2.5 5.1c0 1.7 1.3 3 3 3c1.8 0 3-1.6 3-3c0-1.3-.5-2.7-1.1-4.3c0-.2-.1-.3-.1-.5M37 34c-.7 0-1-.5-1-1c0-.9.5-1.8 1.3-2.9c.4 1.2.7 2.1.7 2.9c0 .3-.3 1-1 1"></svg:path><svg:path fill="#90A4AE" d="M3 40h42v2H3z"></svg:path>`,
})
export class FlatColorIconsSignatureIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSimCardIcon],svg[flat-color-icons-sim-card-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#009688" d="M36 45H12c-2.2 0-4-1.8-4-4V7c0-2.2 1.8-4 4-4h16.3c1.1 0 2.1.4 2.8 1.2l7.7 7.7c.8.8 1.2 1.8 1.2 2.8V41c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#FF9800" d="M32 38H16c-1.1 0-2-.9-2-2V24c0-1.1.9-2 2-2h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2"></svg:path><svg:path fill="#FFD54F" d="M29 30v3h5v2h-5v3h-2V22h2v6h5v2zm-15-1v2h5v2h-5v2h5v3h2v-9z"></svg:path>`,
})
export class FlatColorIconsSimCardIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSimCardChipIcon],svg[flat-color-icons-sim-card-chip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FF9800" d="M5 35V13c0-2.2 1.8-4 4-4h30c2.2 0 4 1.8 4 4v22c0 2.2-1.8 4-4 4H9c-2.2 0-4-1.8-4-4"></svg:path><svg:path fill="#FFD54F" d="M43 21v-2H31c-1.1 0-2-.9-2-2s.9-2 2-2h1v-2h-1c-2.2 0-4 1.8-4 4s1.8 4 4 4h3v6h-3c-2.8 0-5 2.2-5 5s2.2 5 5 5h2v-2h-2c-1.7 0-3-1.3-3-3s1.3-3 3-3h12v-2h-7v-6zm-26 6h-3v-6h3c2.2 0 4-1.8 4-4s-1.8-4-4-4h-3v2h3c1.1 0 2 .9 2 2s-.9 2-2 2H5v2h7v6H5v2h12c1.7 0 3 1.3 3 3s-1.3 3-3 3h-2v2h2c2.8 0 5-2.2 5-5s-2.2-5-5-5"></svg:path>`,
})
export class FlatColorIconsSimCardChipIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSoundRecordingCopyrightIcon],svg[flat-color-icons-sound-recording-copyright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21" fill="#9C27B0"></svg:circle><svg:path fill="#E1BEE7" d="M20.7 27.2v8.4h-3.9V12.9h8.7c1.3 0 2.5.2 3.5.5c1 .4 1.9.9 2.6 1.5s1.2 1.4 1.6 2.3s.6 1.8.6 2.9q0 1.65-.6 3c-.4.9-.9 1.6-1.6 2.2S30 26.4 29 26.7s-2.2.5-3.5.5zm0-3.2h4.7c.8 0 1.4-.1 2-.3c.5-.2 1-.5 1.4-.8s.6-.8.8-1.2c.2-.5.2-1 .2-1.6c0-.5-.1-1-.2-1.5c-.2-.5-.4-.9-.8-1.3s-.8-.7-1.4-.9c-.5-.2-1.2-.3-2-.3h-4.7z"></svg:path>`,
})
export class FlatColorIconsSoundRecordingCopyrightIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSpeakerIcon],svg[flat-color-icons-speaker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#81D4FA" d="M28 7.1v2c7.3 1 13 7.3 13 14.9s-5.7 13.9-13 14.9v2c8.4-1 15-8.2 15-16.9S36.4 8.1 28 7.1"></svg:path><svg:path fill="#546E7A" d="M14 32H7c-1.1 0-2-.9-2-2V18c0-1.1.9-2 2-2h7z"></svg:path><svg:path fill="#78909C" d="M26 42L14 32V16L26 6z"></svg:path><svg:path fill="#03A9F4" d="M28 17.3v2.1c1.8.8 3 2.5 3 4.6s-1.2 3.8-3 4.6v2.1c2.9-.9 5-3.5 5-6.7s-2.1-5.8-5-6.7"></svg:path><svg:path fill="#4FC3F7" d="M28 12.2v2c4.6.9 8 5 8 9.8s-3.4 8.9-8 9.8v2c5.7-1 10-5.9 10-11.8s-4.3-10.9-10-11.8"></svg:path>`,
})
export class FlatColorIconsSpeakerIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSportsModeIcon],svg[flat-color-icons-sports-mode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="28" cy="9" r="5" fill="#FF9800"></svg:circle><svg:path fill="#00796B" d="m29 27.3l-9.2-4.1c-1-.5-1.5 1-2 2s-4.1 7.2-3.8 8.3c.3.9 1.1 1.4 1.9 1.4c.2 0 .4 0 .6-.1L28.8 31c.8-.2 1.4-1 1.4-1.8s-.5-1.6-1.2-1.9"></svg:path><svg:path fill="#009688" d="m26.8 15.2l-2.2-1c-1.3-.6-2.9 0-3.5 1.3L9.2 41.1c-.5 1 0 2.2 1 2.7c.3.1.6.2.9.2c.8 0 1.5-.4 1.8-1.1c0 0 9.6-13.3 10.4-14.9s4.9-9.3 4.9-9.3c.5-1.3 0-2.9-1.4-3.5"></svg:path><svg:path fill="#FF9800" d="M40.5 15.7c-.7-.8-2-1-2.8-.3l-5 4.2l-6.4-3.5c-1.1-.6-2.6-.4-3.3.9c-.8 1.3-.4 2.9.8 3.4l8.3 3.4c.3.1.6.2.9.2c.5 0 .9-.2 1.3-.5l6-5c.8-.7.9-1.9.2-2.8m-28.8 7.4l3.4-5.1l4.6.6l1.5-3.1c.4-.9 1.2-1.4 2.1-1.5h-9.2c-.7 0-1.3.3-1.7.9l-4 6c-.6.9-.4 2.2.6 2.8c.2.2.6.3 1 .3c.6 0 1.3-.3 1.7-.9"></svg:path>`,
})
export class FlatColorIconsSportsModeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsStackOfPhotosIcon],svg[flat-color-icons-stack-of-photos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#64B5F6" d="m17.474 8.578l26.544 8.904l-8.904 26.544L8.57 35.122z"></svg:path><svg:path fill="#1E88E5" d="m19.238 12.504l20.922 6.82l-6.2 19.02l-20.922-6.82z"></svg:path><svg:path fill="#90CAF9" d="m10.881 5.778l27.524 5.068l-5.068 27.524l-27.524-5.068z"></svg:path><svg:path fill="#42A5F5" d="m13.219 9.444l21.67 3.85l-3.5 19.7l-21.67-3.85z"></svg:path><svg:path fill="#BBDEFB" d="M4 4h28v28H4z"></svg:path><svg:path fill="#4CAF50" d="M7 7h22v20H7z"></svg:path><svg:path fill="#fff" d="M16 13c0-1.1.9-2 2-2s2 .9 2 2s-2 4-2 4s-2-2.9-2-4m4 8c0 1.1-.9 2-2 2s-2-.9-2-2s2-4 2-4s2 2.9 2 4"></svg:path><svg:path fill="#fff" d="M13.5 16.7c-1-.6-1.3-1.8-.7-2.7c.6-1 1.8-1.3 2.7-.7c1 .6 2.5 3.7 2.5 3.7s-3.5.3-4.5-.3m9 .6c1 .6 1.3 1.8.7 2.7c-.6 1-1.8 1.3-2.7.7c-1-.5-2.5-3.7-2.5-3.7s3.5-.3 4.5.3"></svg:path><svg:path fill="#fff" d="M22.5 16.7c1-.6 1.3-1.8.7-2.7c-.6-1-1.8-1.3-2.7-.7c-1 .5-2.5 3.7-2.5 3.7s3.5.3 4.5-.3m-9 .6c-1 .6-1.3 1.8-.7 2.7c.6 1 1.8 1.3 2.7.7c1-.6 2.5-3.7 2.5-3.7s-3.5-.3-4.5.3"></svg:path><svg:circle cx="18" cy="17" r="2" fill="#FFC107"></svg:circle>`,
})
export class FlatColorIconsStackOfPhotosIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSteamIcon],svg[flat-color-icons-steam-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#FFF" d="M42 38a4 4 0 0 1-4 4H10a4 4 0 0 1-4-4V10a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4z"></svg:path><svg:g fill="#455A64"><svg:path d="M18.459 33.645c-.288 0-.56-.057-.822-.141l-.005.02l-3.67-1.062c.644 1.878 2.406 3.237 4.5 3.237c2.641 0 4.776-2.136 4.776-4.776s-2.135-4.777-4.776-4.777c-1.141 0-2.175.418-2.998 1.087L19 28.255c.029.007.055.018.084.024l.049.016v.002a2.715 2.715 0 0 1-.674 5.348m12.464-9.346a5.84 5.84 0 0 0 5.837-5.838a5.84 5.84 0 0 0-5.837-5.837a5.84 5.84 0 0 0-5.837 5.837a5.84 5.84 0 0 0 5.837 5.838m-.003-9.89a4.053 4.053 0 1 1 .005 8.107a4.053 4.053 0 0 1-.005-8.107"></svg:path><svg:path d="M38 6H10a4 4 0 0 0-4 4v14.495l7.027 2.033c1.287-1.59 3.229-2.626 5.434-2.626c.07 0 .135.02.204.021l3.876-5.355c0-.035-.005-.072-.005-.105a8.387 8.387 0 1 1 8.387 8.385c-.044 0-.087-.006-.132-.007l-5.33 3.871c.002.07.021.14.021.211a7.02 7.02 0 0 1-7.021 7.021c-3.593 0-6.52-2.707-6.937-6.188L6 30.158V38a4 4 0 0 0 4 4h28a4 4 0 0 0 4-4V10a4 4 0 0 0-4-4"></svg:path></svg:g>`,
})
export class FlatColorIconsSteamIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsStumbleuponIcon],svg[flat-color-icons-stumbleupon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#E64A19" d="M24.001 5c-10.494 0-19 8.506-19 19s8.506 19 19 19s19-8.507 19-19s-8.507-19-19-19"></svg:path><svg:path fill="#FFF" d="M24.001 19c-.003 0 .003 0 0 0c-.062-.004-1 0-1 1v7.876C22.916 29.888 21.504 33 17.959 33c-3.607 0-4.958-3.065-4.958-4.958V24h4v4c.038.709.629 1 1 1c.665 0 .972-.361 1-1v-8.124c0-2.01 1.332-5 5-5c.045 0 .086.006.131.007c0 0 4.869-.009 4.869 5.117c0 1.104-.896 1.876-2 1.876s-2-.771-2-1.876c0-.876-.96-.997-1-1m11 8.876c0 2.01-1.331 5.124-5 5.124s-5-3.114-5-5.124v-3.439a4.9 4.9 0 0 0 2 .439a4.95 4.95 0 0 0 2-.424V28c.038 1 .663 1 1 1c.247 0 1 0 1-1v-4h4z"></svg:path>`,
})
export class FlatColorIconsStumbleuponIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSupportIcon],svg[flat-color-icons-support-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#607D8B" d="M44.7 11L36 19.6s-2.6 0-5.2-2.6s-2.6-5.2-2.6-5.2l8.7-8.7c-4.9-1.2-10.8.4-14.4 4c-5.4 5.4-.6 12.3-2 13.7C12.9 28.7 5.1 34.7 4.9 35c-2.3 2.3-2.4 6-.2 8.2s5.9 2.1 8.2-.2c.3-.3 6.7-8.4 14.2-15.9c1.4-1.4 8 3.7 13.6-1.8c3.5-3.6 5.2-9.4 4-14.3M9.4 41.1c-1.4 0-2.5-1.1-2.5-2.5C6.9 37.1 8 36 9.4 36s2.5 1.1 2.5 2.5s-1.1 2.6-2.5 2.6"></svg:path>`,
})
export class FlatColorIconsSupportIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsSwitchCameraIcon],svg[flat-color-icons-switch-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#5E35B1"><svg:path d="M33.9 12.1H14.2L17.6 7c.4-.6 1-.9 1.7-.9h9.6c.7 0 1.3.3 1.7.9zM14 11H8V9.2C8 8.5 8.5 8 9.2 8h3.6c.7 0 1.2.5 1.2 1.2z"></svg:path><svg:path d="M40 42H8c-2.2 0-4-1.8-4-4V14c0-2.2 1.8-4 4-4h32c2.2 0 4 1.8 4 4v24c0 2.2-1.8 4-4 4"></svg:path></svg:g><svg:path fill="#E8EAF6" d="M34 25c0-5.5-4.5-10-10-10c-2.4 0-4.6.8-6.3 2.2l1.2 1.6C20.3 17.7 22 17 24 17c4.4 0 8 3.6 8 8h-3.5l4.5 5.6l4.5-5.6zm-4.9 6.2C27.7 32.3 25.9 33 24 33c-4.4 0-8-3.6-8-8h3.5L15 19.4L10.5 25H14c0 5.5 4.5 10 10 10c2.4 0 4.6-.8 6.3-2.2z"></svg:path>`,
})
export class FlatColorIconsSwitchCameraIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsUnlockIcon],svg[flat-color-icons-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#424242" d="M24 4c-5.5 0-10 4.5-10 10v4h4v-4c0-3.3 2.7-6 6-6s6 2.7 6 6h4c0-5.5-4.5-10-10-10"></svg:path><svg:path fill="#FB8C00" d="M36 44H12c-2.2 0-4-1.8-4-4V22c0-2.2 1.8-4 4-4h24c2.2 0 4 1.8 4 4v18c0 2.2-1.8 4-4 4"></svg:path><svg:circle cx="24" cy="31" r="3" fill="#C76E00"></svg:circle>`,
})
export class FlatColorIconsUnlockIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsUsbIcon],svg[flat-color-icons-usb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#1565C0" d="M38.701 24.355h-2.189l-.467 2.265h2.51c.233 0 1.545-.167 1.545-1.267c0-1.087-1.399-.998-1.399-.998m.82-4.016h-2.15l-.374 1.796h2.337c.188 0 1.113-.146 1.113-1.006c0-.858-.926-.79-.926-.79m4.543 2.77s1.436-.743 1.436-3.093c0-3.715-4.377-3.516-4.377-3.516h-2.865l.674-3H17.961c-9.344 0-12.158 6.774-12.158 6.774l-.067.226H2.547l-1.047 6h3.37l.001.143S4.586 33.5 15.334 33.5h19.042l.679-3h4.389c4.729 0 5.591-3.354 5.591-4.9c-.003-1.762-.971-2.491-.971-2.491"></svg:path><svg:path fill="#FFF" d="M38.701 24.355h-2.189l-.467 2.265h2.51c.233 0 1.545-.167 1.545-1.267c0-1.087-1.399-.998-1.399-.998m.82-4.016h-2.15l-.374 1.796h2.337c.188 0 1.113-.146 1.113-1.006c0-.858-.926-.79-.926-.79M14.022 29.5c-5.306 0-5.306-3.624-5.238-3.986a1911 1911 0 0 1 1.789-8.014h3.84l-1.358 6.354s-.971 2.728 1.251 2.728c2.081 0 2.336-2.535 2.336-2.535l1.465-6.543h3.839l-1.582 6.979c.001-.003-.106 5.017-6.342 5.017m12.076.021c-2.674 0-4.958-1.262-4.856-4.14h3.438c0 .576.086 1.627 1.633 1.627c.627 0 1.688-.266 1.688-1.133c0-1.631-5.597-.785-5.597-4.57c0-2.063 1.899-3.785 4.989-3.785c4.976 0 4.613 3.749 4.613 3.749h-3.369c0-1.044-.664-1.204-1.463-1.204c-.8 0-1.372.343-1.372.944c0 1.471 5.634.456 5.634 4.531c0 1.765-1.424 3.981-5.338 3.981m13.268-.021h-7.515l2.601-12h6.556c1.113 0 3.43.234 3.43 2.542c0 2.602-2.227 3.013-2.227 3.013s1.764.407 1.764 2.473c0 3.929-4.2 3.972-4.609 3.972"></svg:path>`,
})
export class FlatColorIconsUsbIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsVipIcon],svg[flat-color-icons-vip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#880E4F" d="M38 43H10c-2.2 0-4-1.8-4-4V11c0-2.2 1.8-4 4-4h28c2.2 0 4 1.8 4 4v28c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="#FFD54F" d="m15.9 28l2.1-9.1h2.8l-3.6 12.6h-2.6L11 18.9h2.8zm9.7 3.5h-2.5V18.9h2.5zm5.6-4.4v4.4h-2.5V18.9H33c3.7 0 4.1 3.4 4.1 4.2c0 1.2-.5 4-4.1 4zm0-2.2h1.7c1.3 0 1.5-1.1 1.5-1.9c0-1.6-.9-2.1-1.5-2.1h-1.7z"></svg:path>`,
})
export class FlatColorIconsVipIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsVlcIcon],svg[flat-color-icons-vlc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#F57C00" d="M36.258 28.837S36.148 28 35.001 28h-3.719c.798 2.671 1.497 5.135 1.497 5.279c0 2.387-3.401 3.393-8.917 3.393c-5.515 0-8.651-.94-8.651-3.326c0-.167.998-2.692 1.791-5.346h-4.063c-.806 0-.937.749-.937.749L8.159 40.986L8.815 42h30.652l.376-1.014z"></svg:path><svg:path fill="#E0E0E0" d="M24.001 6c-1.029 0-1.864.179-1.864.398c-.492 1.483-8.122 26.143-8.122 26.774c0 2.388 4.471 3.827 9.985 3.827s9.986-1.439 9.986-3.827c0-.549-7.614-25.268-8.122-26.774c.001-.219-.833-.398-1.863-.398"></svg:path><svg:path fill="#FF9800" d="M33.196 30.447C32.032 32.232 28.341 34 24.046 34c-4.34 0-8.156-1.696-9.281-3.51c-.499 1.483-.892 2.647-.892 3.28c0 2.386 4.533 4.229 10.128 4.229s10.131-1.844 10.131-4.229c0-.548-.419-1.815-.936-3.323m-1.809-6.133l-2.074-6.794s-1.857 1.479-5.311 1.479s-5.316-1.479-5.316-1.479l-2.081 6.806S18.673 27 24.002 27c5.373 0 7.385-2.686 7.385-2.686m-4.146-13.505l-1.376-4.41s-.083-.398-1.864-.398c-1.844 0-1.864.398-1.864.398l-1.376 4.407S21.646 12 24 12s3.241-1.191 3.241-1.191"></svg:path>`,
})
export class FlatColorIconsVlcIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsWiFiLogoIcon],svg[flat-color-icons-wi-fi-logo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="#3F51B5"><svg:path d="M46 26.48c0 4.527-3.268 7.52-7.3 7.52H9.299C5.269 34 2 30.634 2 26.48v-4.96C2 17.366 5.269 14 9.299 14H38.7c4.032 0 7.3 3.366 7.3 7.52z"></svg:path><svg:ellipse cx="24" cy="24" rx="14.902" ry="15"></svg:ellipse></svg:g><svg:path fill="#FFF" d="M17 19h-2.736l-.837 5.859l-1.039-5.831H9.93l-1.066 5.831l-.81-5.831H5.266L7.597 29h2.459l1.064-6.146L12.209 29h2.484zm2 3h2.508v7H19zm2.5-2.253a1.251 1.251 0 1 1-2.5 0c0-.696.56-1.258 1.25-1.258s1.25.562 1.25 1.258M38.561 16h-7.979S25 16.193 25 21.914v4.336s.101 2.941-3 5.75h16.785S44 32 44 26.447v-4.879S43.772 16 38.561 16m-1.222 5.369h-5.651v2.236h5.094v2.344h-5.094V29H29V19h8.339zm2.911-2.88c.689 0 1.25.562 1.25 1.258c0 .693-.561 1.253-1.25 1.253S39 20.44 39 19.747c0-.696.561-1.258 1.25-1.258M41.508 29H39v-7h2.508z"></svg:path>`,
})
export class FlatColorIconsWiFiLogoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[flatColorIconsWikipediaIcon],svg[flat-color-icons-wikipedia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="#CFD8DC" d="M6 10a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4v28a4 4 0 0 1-4 4H10a4 4 0 0 1-4-4z"></svg:path><svg:path fill="#37474F" d="M39 17.271a.34.34 0 0 1-.334.349h-1.799l-8.164 18.179c-.052.12-.17.2-.297.202h-.004a.33.33 0 0 1-.298-.193l-3.874-8.039l-4.18 8.049a.33.33 0 0 1-.303.184a.34.34 0 0 1-.292-.199l-8.252-18.182h-1.87a.345.345 0 0 1-.333-.35v-.921a.34.34 0 0 1 .333-.35h6.657a.34.34 0 0 1 .333.35v.921a.34.34 0 0 1-.333.349h-1.433l5.696 13.748l2.964-5.793l-3.757-7.953h-.904a.34.34 0 0 1-.333-.35v-.922c0-.191.149-.348.333-.348h4.924a.34.34 0 0 1 .333.348v.922c0 .192-.149.35-.333.35h-.867l2.162 4.948l2.572-4.948H25.77a.34.34 0 0 1-.334-.35v-.922a.34.34 0 0 1 .334-.348h4.784c.187 0 .333.156.333.348v.922a.34.34 0 0 1-.333.35h-1.05l-3.757 7.141l3.063 6.584l5.905-13.725h-1.872a.343.343 0 0 1-.334-.35v-.922c0-.191.15-.348.334-.348h5.822a.34.34 0 0 1 .334.348z"></svg:path>`,
})
export class FlatColorIconsWikipediaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
