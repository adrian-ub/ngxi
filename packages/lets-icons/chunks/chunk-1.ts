...
@Component({
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round"><svg:path d="m9 10l3.258 2.444a1 1 0 0 0 1.353-.142L20 5"></svg:path><svg:path d="M21 12a9 9 0 1 1-6.67-8.693"></svg:path></svg:g>`,
})
export class LetsIconsDoneRingRoundLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDoneRoundIcon],svg[lets-icons-done-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m5 14l3.233 2.425a1 1 0 0 0 1.374-.167L18 6"></svg:path>`,
})
export class LetsIconsDoneRoundIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDoughnutChartIcon],svg[lets-icons-doughnut-chart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:circle cx="12" cy="12" r="9"></svg:circle><svg:circle cx="12" cy="12" r="4"></svg:circle><svg:path stroke-linecap="round" d="M12 3v4.5M18 18l-3-3m3-9l-3 3M3 12h4.5"></svg:path></svg:g>`,
})
export class LetsIconsDoughnutChartIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDownIcon],svg[lets-icons-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m14 20l-.707.707l.707.707l.707-.707zM6 3a1 1 0 1 0 0 2zm2.293 12.707l5 5l1.414-1.414l-5-5zm6.414 5l5-5l-1.414-1.414l-5 5zM15 20V10h-2v10zM8 3H6v2h2zm7 7a7 7 0 0 0-7-7v2a5 5 0 0 1 5 5z"></svg:path>`,
})
export class LetsIconsDownIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDownloadIcon],svg[lets-icons-download-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M9.5 11.878c-.492.394-.89.903-1.152 1.487l-.004.01q-.117.261-.196.429a2.4 2.4 0 0 1-.201.36a2 2 0 0 1-.533.527a2 2 0 0 1-.7.27c-.2.04-.442.04-.65.04H6a2 2 0 0 0 0 4h12a2 2 0 1 0 0-4h-.064c-.208 0-.45 0-.65-.04a2 2 0 0 1-.7-.27a2 2 0 0 1-.533-.528a2.4 2.4 0 0 1-.201-.36a23 23 0 0 1-.196-.428l-.004-.01a4 4 0 0 0-1.152-1.488V9.545a6.02 6.02 0 0 1 2.976 3.002a24 24 0 0 0 .207.452h.02c.064.002.151.002.297.002a4 4 0 0 1 0 8H6a4 4 0 1 1 0-8c.146 0 .233 0 .297-.002h.02l.025-.053c.042-.089.098-.213.182-.4a6.02 6.02 0 0 1 2.976-3zm8.202 1.156" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m12 3l-.707-.707l.707-.707l.707.707zm1 10a1 1 0 1 1-2 0zM7.293 6.293l4-4l1.414 1.414l-4 4zm5.414-4l4 4l-1.414 1.414l-4-4zM13 3v10h-2V3z"></svg:path>`,
})
export class LetsIconsDownloadIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDownloadCircleFillIcon],svg[lets-icons-download-circle-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="m7.086 13.07l-1.702-1.363a7 7 0 1 0 13.232 0l-1.702 1.362q.085.454.086.93a5 5 0 1 1-9.914-.93" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m12 4l-.625-.78l.625-.5l.625.5zm1 9a1 1 0 1 1-2 0zM6.375 7.22l5-4l1.25 1.56l-5 4zm6.25-4l5 4l-1.25 1.56l-5-4zM13 4v9h-2V4z"></svg:path>`,
})
export class LetsIconsDownloadCircleFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDownloadDuotoneLineIcon],svg[lets-icons-download-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsDownloadDuotoneLine0" width="20" height="12" x="2" y="9" fill="#000" maskUnits="userSpaceOnUse"><svg:path fill="#fff" d="M2 9h20v12H2z"></svg:path><svg:path fill-rule="evenodd" d="M6 20h12a3 3 0 1 0 0-6c-.28 0-.42 0-.517-.02c-.298-.06-.44-.151-.616-.399c-.058-.08-.14-.262-.303-.626a5.001 5.001 0 0 0-9.128 0c-.163.364-.245.545-.303.626c-.176.248-.318.34-.616.4C6.419 14 6.28 14 6 14a3 3 0 1 0 0 6" clip-rule="evenodd"></svg:path></svg:mask><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M6 20h12a3 3 0 1 0 0-6c-.28 0-.42 0-.517-.02c-.298-.06-.44-.151-.616-.399c-.058-.08-.14-.262-.303-.626a5.001 5.001 0 0 0-9.128 0c-.163.364-.245.545-.303.626c-.176.248-.318.34-.616.4C6.419 14 6.28 14 6 14a3 3 0 1 0 0 6" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-opacity=".25" d="m7.436 12.955l-.547-.246zm-.303.626l-.488-.348zm-.616.4l-.118-.589zm10.966 0l-.118.588zm-.92-1.026l.548-.246zm.304.626l.488-.348zM12 19.4H6v1.2h6zm6 0h-6v1.2h6zm2.4-2.4a2.4 2.4 0 0 1-2.4 2.4v1.2a3.6 3.6 0 0 0 3.6-3.6zM18 14.6a2.4 2.4 0 0 1 2.4 2.4h1.2a3.6 3.6 0 0 0-3.6-3.6zm-.889-1.89A5.6 5.6 0 0 0 12 9.4v1.2a4.4 4.4 0 0 1 4.017 2.6zM12 9.4a5.6 5.6 0 0 0-5.111 3.31l1.094.49A4.4 4.4 0 0 1 12 10.6zm-6 4A3.6 3.6 0 0 0 2.4 17h1.2A2.4 2.4 0 0 1 6 14.6zM2.4 17A3.6 3.6 0 0 0 6 20.6v-1.2A2.4 2.4 0 0 1 3.6 17zm4.489-4.29c-.083.184-.141.313-.186.406c-.049.104-.064.125-.058.117l.976.697c.064-.089.12-.2.166-.298q.077-.163.196-.431zM6 14.6c.244 0 .463.003.635-.031L6.4 13.392a1 1 0 0 1-.09.006c-.071.002-.165.002-.309.002zm.645-1.367a.4.4 0 0 1-.1.114a.4.4 0 0 1-.146.045l.236 1.177c.188-.038.379-.096.562-.214a1.6 1.6 0 0 0 .424-.425zM18 13.4c-.143 0-.238 0-.309-.002s-.091-.006-.09-.006l-.236 1.177c.172.034.39.031.635.031zm-1.983-.2q.119.27.196.432c.047.098.102.21.166.298l.976-.697c.006.008-.01-.013-.058-.117a24 24 0 0 1-.186-.407zm1.584.192a.4.4 0 0 1-.146-.044a.4.4 0 0 1-.1-.115l-.976.697c.11.156.242.306.424.425c.183.118.374.176.562.213z" mask="url(#letsIconsDownloadDuotoneLine0)"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.5 11.379a4.4 4.4 0 0 0-1.517 1.822l-.003.007q-.117.264-.193.424c-.047.099-.102.21-.166.299a1.6 1.6 0 0 1-.424.424a1.6 1.6 0 0 1-.562.214a3 3 0 0 1-.578.031H6a2.4 2.4 0 1 0 0 4.8h12a2.4 2.4 0 0 0 0-4.8h-.057c-.221 0-.42 0-.578-.031a1.6 1.6 0 0 1-.562-.214a1.6 1.6 0 0 1-.424-.424c-.064-.09-.12-.2-.166-.299q-.075-.16-.193-.424l-.003-.007a4.4 4.4 0 0 0-1.517-1.822V9.988a5.62 5.62 0 0 1 2.611 2.722c.083.184.141.313.186.407c.035.074.053.106.058.115q.003.004 0 0a.5.5 0 0 0 .1.116a.4.4 0 0 0 .146.044c.002 0 .023.004.09.006c.071.002.166.002.309.002a3.6 3.6 0 1 1 0 7.2H6a3.6 3.6 0 0 1 0-7.2c.144 0 .238 0 .309-.002a1 1 0 0 0 .09-.005a.4.4 0 0 0 .146-.045a.4.4 0 0 0 .1-.115v-.001c.005-.01.023-.04.058-.115c.045-.094.103-.223.186-.408A5.62 5.62 0 0 1 9.5 9.989z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m12 3l-.424-.424L12 2.15l.424.425zm.6 10a.6.6 0 1 1-1.2 0zM7.576 6.576l4-4l.848.848l-4 4zm4.848-4l4 4l-.848.848l-4-4zM12.6 3v10h-1.2V3z"></svg:path>`,
})
export class LetsIconsDownloadDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDownloadFillIcon],svg[lets-icons-download-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M14.5 10.67V13a2.5 2.5 0 0 1-5 0v-2.33a5.02 5.02 0 0 0-2.064 2.285c-.163.364-.245.546-.303.627c-.176.247-.318.339-.616.399C6.419 14 6.28 14 6 14a3 3 0 0 0 0 6h12a3 3 0 1 0 0-6c-.28 0-.42 0-.517-.02c-.298-.06-.44-.152-.616-.4c-.058-.08-.14-.262-.303-.626A5.02 5.02 0 0 0 14.5 10.67" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m12 3l-.707-.707l.707-.707l.707.707zm1 10a1 1 0 1 1-2 0zM7.293 6.293l4-4l1.414 1.414l-4 4zm5.414-4l4 4l-1.414 1.414l-4-4zM13 3v10h-2V3z"></svg:path>`,
})
export class LetsIconsDownloadFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDrinkIcon],svg[lets-icons-drink-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsDrink0" fill="#fff"><svg:path d="M5 9.286c0-.266 0-.399.025-.509a1 1 0 0 1 .752-.752C5.887 8 6.02 8 6.286 8h11.428c.266 0 .399 0 .509.025a1 1 0 0 1 .752.752c.025.11.025.243.025.509V10c0 .929 0 1.393-.051 1.783a6 6 0 0 1-5.166 5.166C13.393 17 12.93 17 12 17s-1.393 0-1.783-.051a6 6 0 0 1-5.166-5.166C5 11.393 5 10.93 5 10z"></svg:path></svg:mask><svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 21h6m-3 0v-5"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="4" d="M5 9.286c0-.266 0-.399.025-.509a1 1 0 0 1 .752-.752C5.887 8 6.02 8 6.286 8h11.428c.266 0 .399 0 .509.025a1 1 0 0 1 .752.752c.025.11.025.243.025.509V10c0 .929 0 1.393-.051 1.783a6 6 0 0 1-5.166 5.166C13.393 17 12.93 17 12 17s-1.393 0-1.783-.051a6 6 0 0 1-5.166-5.166C5 11.393 5 10.93 5 10z" mask="url(#letsIconsDrink0)"></svg:path><svg:path fill="currentColor" d="M11.039 11.725a1 1 0 1 0 1.922.55zm2.691-5.782l.962.275zm1.18-1.307l-.37-.929zm-.825.44l.742.67zm-1.124 7.199l1.731-6.057l-1.923-.55l-1.73 6.057zm2.321-6.71l4.09-1.637l-.743-1.856l-4.09 1.635zm-.59.653c.07-.248.107-.373.14-.46c.027-.07.028-.048-.005-.012l-1.485-1.34c-.347.385-.468.894-.573 1.262zm-.153-2.51c-.356.142-.85.313-1.197.698l1.485 1.34c-.033.037-.054.039.012.005c.083-.042.204-.091.443-.187z"></svg:path></svg:g>`,
})
export class LetsIconsDrinkIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsDrinkLightIcon],svg[lets-icons-drink-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" d="M9 21h6m-3 0v-4M5.5 9.286c0-.293.003-.356.013-.397a.5.5 0 0 1 .376-.376c.04-.01.104-.013.397-.013h11.428c.293 0 .356.003.397.013a.5.5 0 0 1 .377.376c.009.04.012.104.012.397V10c0 .945-.001 1.369-.047 1.718a5.5 5.5 0 0 1-4.735 4.735c-.35.046-.773.047-1.718.047s-1.369-.001-1.718-.047a5.5 5.5 0 0 1-4.735-4.735c-.046-.35-.047-.773-.047-1.718z"></svg:path><svg:path fill="currentColor" d="M11.52 11.863a.5.5 0 0 0 .96.274zm2.21-5.92l.481.138zm1.18-1.307l-.185-.465zm-.825.44l.37.335zm-1.604 7.061l1.73-6.056l-.961-.275l-1.73 6.057zM15.097 5.1l4.089-1.636l-.372-.928l-4.089 1.635zm-.886.98c.146-.51.185-.603.245-.669l-.743-.67c-.251.279-.344.649-.463 1.065zm.514-1.909c-.402.161-.76.292-1.012.57l.743.67c.06-.066.148-.114.64-.311z"></svg:path></svg:g>`,
})
export class LetsIconsDrinkLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsEMailIcon],svg[lets-icons-e-mail-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path stroke-linecap="round" d="M21 12a9 9 0 1 0-6.67 8.693"></svg:path><svg:circle cx="12" cy="12" r="4"></svg:circle><svg:path stroke-linecap="round" d="M16 9v4.5a2.5 2.5 0 0 0 2.5 2.5v0a2.5 2.5 0 0 0 2.5-2.5V12"></svg:path></svg:g>`,
})
export class LetsIconsEMailIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsEditIcon],svg[lets-icons-edit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsEditDuotoneLineIcon],svg[lets-icons-edit-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="m12.5 7.5l-6.572 6.572c-.212.212-.319.319-.388.45c-.07.13-.1.277-.159.572l-.734 3.67c-.066.333-.1.5-.005.594c.095.095.26.061.593-.005l3.671-.734c.295-.06.442-.089.573-.159s.237-.176.45-.388L16.5 11.5z"></svg:path><svg:path stroke="currentColor" stroke-width="1.2" d="m5.954 19.38l.026-.007l2.628-.657l.049-.012c.218-.054.429-.106.62-.215c.192-.108.345-.262.504-.421l.035-.036l7.194-7.193l.027-.027c.31-.31.585-.585.776-.836c.207-.271.373-.585.373-.976s-.166-.705-.373-.976c-.191-.251-.466-.525-.776-.836l-.027-.026l-.172-.172l-.026-.027c-.31-.31-.585-.584-.836-.776c-.271-.207-.585-.373-.976-.373s-.705.166-.976.373c-.251.192-.525.466-.836.776l-.027.027l-7.194 7.194l-.035.035c-.16.16-.313.313-.421.504c-.109.191-.161.402-.215.62l-.012.049l-.664 2.654l-.007.03a3.4 3.4 0 0 0-.097.476c-.016.165-.015.464.227.705c.24.242.54.243.705.227c.148-.014.323-.058.477-.097zM12.5 7.5l4 4"></svg:path></svg:g>`,
})
export class LetsIconsEditDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsEditFillIcon],svg[lets-icons-edit-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M17.204 10.796L19 9c.545-.545.818-.818.964-1.112a2 2 0 0 0 0-1.776C19.818 5.818 19.545 5.545 19 5s-.818-.818-1.112-.964a2 2 0 0 0-1.776 0c-.294.146-.567.419-1.112.964l-1.819 1.819a10.9 10.9 0 0 0 4.023 3.977m-5.477-2.523l-6.87 6.87c-.426.426-.638.638-.778.9c-.14.26-.199.555-.316 1.145l-.616 3.077c-.066.332-.1.498-.005.593s.26.061.593-.005l3.077-.616c.59-.117.885-.176 1.146-.316s.473-.352.898-.777l6.89-6.89a12.9 12.9 0 0 1-4.02-3.98" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsEditFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandDownIcon],svg[lets-icons-expand-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsExpandDownIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandDownDoubleLightIcon],svg[lets-icons-expand-down-double-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18 12l-6 6l-6-6m12-6l-6 6l-6-6"></svg:path>`,
})
export class LetsIconsExpandDownDoubleLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandDownLightIcon],svg[lets-icons-expand-down-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18 9l-6 6l-6-6"></svg:path>`,
})
export class LetsIconsExpandDownLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandDownStopIcon],svg[lets-icons-expand-down-stop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="m6 7l6 6l6-6m-1 11H7"></svg:path>`,
})
export class LetsIconsExpandDownStopIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandLeftIcon],svg[lets-icons-expand-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="m15 6l-6 6l6 6"></svg:path>`,
})
export class LetsIconsExpandLeftIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandLeftDoubleLightIcon],svg[lets-icons-expand-left-double-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m12 18l-6-6l6-6m6 12l-6-6l6-6"></svg:path>`,
})
export class LetsIconsExpandLeftDoubleLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandLeftLightIcon],svg[lets-icons-expand-left-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m15 6l-6 6l6 6"></svg:path>`,
})
export class LetsIconsExpandLeftLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandRightDoubleIcon],svg[lets-icons-expand-right-double-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="m12 18l6-6l-6-6M6 18l6-6l-6-6"></svg:path>`,
})
export class LetsIconsExpandRightDoubleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandRightDoubleLightIcon],svg[lets-icons-expand-right-double-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m12 18l6-6l-6-6M6 18l6-6l-6-6"></svg:path>`,
})
export class LetsIconsExpandRightDoubleLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandTopStopLightIcon],svg[lets-icons-expand-top-stop-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18 17l-6-6l-6 6M7 6h10"></svg:path>`,
})
export class LetsIconsExpandTopStopLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandUpDoubleLightIcon],svg[lets-icons-expand-up-double-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18 18l-6-6l-6 6m12-6l-6-6l-6 6"></svg:path>`,
})
export class LetsIconsExpandUpDoubleLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExpandUpLightIcon],svg[lets-icons-expand-up-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18 15l-6-6l-6 6"></svg:path>`,
})
export class LetsIconsExpandUpLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsExportLightIcon],svg[lets-icons-export-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="m12 5l-.354-.354l.354-.353l.354.353zm.5 9a.5.5 0 0 1-1 0zM6.646 9.646l5-5l.708.708l-5 5zm5.708-5l5 5l-.708.708l-5-5zM12.5 5v9h-1V5z"></svg:path><svg:path stroke="currentColor" d="M5 16v1a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-1"></svg:path></svg:g>`,
})
export class LetsIconsExportLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsEyeFillIcon],svg[lets-icons-eye-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M2.98 10.27C4.364 8.199 7.268 5 12 5s7.635 3.198 9.02 5.27c.465.697.698 1.044.677 1.687s-.288.99-.822 1.685C19.286 15.71 16.113 19 12 19s-7.286-3.29-8.875-5.358c-.534-.695-.8-1.042-.822-1.685s.211-.99.676-1.686M12 16a4 4 0 1 0 0-8a4 4 0 0 0 0 8" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsEyeFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoriteIcon],svg[lets-icons-favorite-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFavoriteIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoriteFillIcon],svg[lets-icons-favorite-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFavoriteFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoriteLightIcon],svg[lets-icons-favorite-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFavoriteLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoritesDuotoneIcon],svg[lets-icons-favorites-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" d="M20 11.5c0 5.068-5.972 8.47-7.596 9.302a.88.88 0 0 1-.808 0C9.972 19.97 4 16.568 4 11.5C4 7 7.876 4 12 4c4.267 0 8 3 8 7.5"></svg:path><svg:path fill="currentColor" d="m8.286 11.786l3.457 3.457c.121.121.182.182.257.182s.136-.06.257-.182l3.457-3.457c.748-.748.864-1.92.277-2.8c-.915-1.371-2.954-1.301-3.772.13l-.141.248a.09.09 0 0 1-.156 0l-.141-.247c-.818-1.432-2.857-1.502-3.772-.13c-.587.88-.47 2.051.277 2.799"></svg:path>`,
})
export class LetsIconsFavoritesDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoritesFillIcon],svg[lets-icons-favorites-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M12.404 20.802C14.028 19.97 20 16.568 20 11.5C20 7 16.267 4 12 4c-4.124 0-8 3-8 7.5c0 5.068 5.972 8.47 7.596 9.302a.88.88 0 0 0 .808 0m-.635-6.045L8.97 11.81a1.806 1.806 0 1 1 2.898-2.107l.07.128a.07.07 0 0 0 .124 0l.07-.128c.658-1.212 2.377-1.27 3.114-.104c.443.7.354 1.61-.216 2.21l-2.799 2.947c-.092.097-.139.146-.195.157a.2.2 0 0 1-.072 0c-.056-.011-.103-.06-.195-.157" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFavoritesFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFavoritesLightIcon],svg[lets-icons-favorites-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M19.5 11c0 5.018-5.488 8.403-7.075 9.276a.87.87 0 0 1-.85 0C9.988 19.403 4.5 16.018 4.5 11c0-4.5 3.634-7.5 7.5-7.5c4 0 7.5 3 7.5 7.5Z"></svg:path><svg:path d="m8.286 11.786l3.457 3.457c.121.121.182.182.257.182s.136-.06.257-.182l3.457-3.457c.748-.748.864-1.92.277-2.8c-.915-1.371-2.954-1.301-3.772.13l-.141.248a.09.09 0 0 1-.156 0l-.141-.247c-.818-1.432-2.857-1.502-3.772-.13c-.587.88-.47 2.051.277 2.799Z"></svg:path></svg:g>`,
})
export class LetsIconsFavoritesLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileIcon],svg[lets-icons-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M13.172 3H9c-1.886 0-2.828 0-3.414.586S5 5.114 5 7v10c0 1.886 0 2.828.586 3.414S7.114 21 9 21h6c1.886 0 2.828 0 3.414-.586S19 18.886 19 17V8.828c0-.408 0-.613-.076-.796s-.22-.329-.51-.618l-3.828-3.828c-.29-.29-.434-.434-.617-.51C13.785 3 13.58 3 13.172 3Z"></svg:path><svg:path d="M13 3v4c0 .943 0 1.414.293 1.707S14.057 9 15 9h4"></svg:path></svg:g>`,
})
export class LetsIconsFileIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDockIcon],svg[lets-icons-file-dock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M13.172 3H9c-1.886 0-2.828 0-3.414.586S5 5.114 5 7v10c0 1.886 0 2.828.586 3.414S7.114 21 9 21h6c1.886 0 2.828 0 3.414-.586S19 18.886 19 17V8.828c0-.408 0-.613-.076-.796s-.22-.329-.51-.618l-3.828-3.828c-.29-.29-.434-.434-.617-.51C13.785 3 13.58 3 13.172 3Z"></svg:path><svg:path stroke-linecap="round" d="M9 13h6m-6 4h4"></svg:path><svg:path d="M13 3v4c0 .943 0 1.414.293 1.707S14.057 9 15 9h4"></svg:path></svg:g>`,
})
export class LetsIconsFileDockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDockDuotoneIcon],svg[lets-icons-file-dock-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M5 5a2 2 0 0 1 2-2h4.75a.25.25 0 0 1 .25.25V8a2 2 0 0 0 2 2h4.75a.25.25 0 0 1 .25.25V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z"></svg:path><svg:path fill="currentColor" d="M13 8V3.604a.25.25 0 0 1 .427-.177l5.146 5.146a.25.25 0 0 1-.177.427H14a1 1 0 0 1-1-1"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" d="M8.5 13.5h6m-6 3h5"></svg:path></svg:g>`,
})
export class LetsIconsFileDockDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDockDuotoneLineIcon],svg[lets-icons-file-dock-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M13 7V3H9c-1.886 0-2.828 0-3.414.586S5 5.114 5 7v10c0 1.886 0 2.828.586 3.414S7.114 21 9 21h6c1.886 0 2.828 0 3.414-.586S19 18.886 19 17V9h-4c-.943 0-1.414 0-1.707-.293S13 7.943 13 7"></svg:path><svg:path stroke="currentColor" stroke-width="1.2" d="M13.172 3H9c-1.886 0-2.828 0-3.414.586S5 5.114 5 7v10c0 1.886 0 2.828.586 3.414S7.114 21 9 21h6c1.886 0 2.828 0 3.414-.586S19 18.886 19 17V8.828c0-.408 0-.613-.076-.796s-.22-.329-.51-.618l-3.828-3.828c-.29-.29-.434-.434-.617-.51C13.785 3 13.58 3 13.172 3Z"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="1.2" d="M9 13h6m-6 4h4"></svg:path><svg:path stroke="currentColor" stroke-width="1.2" d="M13 3v4c0 .943 0 1.414.293 1.707S14.057 9 15 9h4"></svg:path></svg:g>`,
})
export class LetsIconsFileDockDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDockFillIcon],svg[lets-icons-file-dock-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M12 2v5.054c0 .424 0 .837.046 1.177c.051.383.177.82.54 1.183s.8.489 1.184.54c.34.046.752.046 1.176.046H20v6c0 2.828 0 4.243-.879 5.121C18.243 22 16.828 22 14 22h-4c-2.828 0-4.243 0-5.121-.879C4 20.243 4 18.828 4 16V8c0-2.828 0-4.243.879-5.121C5.757 2 7.172 2 10 2zm2 .005V7c0 .5.002.774.028.964v.007l.008.001c.19.026.464.028.964.028h4.995c-.01-.412-.043-.684-.147-.937c-.152-.367-.441-.657-1.02-1.235l-2.656-2.656c-.578-.578-.867-.868-1.235-1.02c-.253-.105-.525-.137-.937-.147M8 13a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1m1 3a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFileDockFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDockLightIcon],svg[lets-icons-file-dock-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileDuotoneLineIcon],svg[lets-icons-file-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFileDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFileFillIcon],svg[lets-icons-file-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFileFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFilterAltIcon],svg[lets-icons-filter-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFilterAltDuotoneIcon],svg[lets-icons-filter-alt-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M20 5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v1.586a1 1 0 0 0 .293.707l4.414 4.414a1 1 0 0 1 .293.707v6.892a.5.5 0 0 0 .658.475l5-1.667A.5.5 0 0 0 15 17.64v-5.226a1 1 0 0 1 .293-.707l4.414-4.414A1 1 0 0 0 20 6.586z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m9.658 19.78l.19.57zm5-1.666l.19.57zm5.05-10.821l.423.424zm-4.415 4.414l-.424-.424zM5 4.6h14V3.4H5zm-.4 1.986V5H3.4v1.586zm4.531 4.697L4.717 6.869l-.848.848l4.414 4.414zM8.4 12.414v6.892h1.2v-6.892zm0 6.892a1.1 1.1 0 0 0 1.448 1.044l-.38-1.139a.1.1 0 0 1 .132.095zm1.448 1.044l5-1.667l-.38-1.138l-5 1.666zm5-1.667a1.1 1.1 0 0 0 .752-1.043h-1.2a.1.1 0 0 1 .068-.095zm.752-1.043v-5.226h-1.2v5.226zm3.683-10.771l-4.414 4.414l.848.848l4.414-4.414zM19.4 5v1.586h1.2V5zm.731 2.717c.3-.3.469-.707.469-1.131h-1.2a.4.4 0 0 1-.117.283zM15.6 12.414a.4.4 0 0 1 .117-.283l-.848-.848a1.6 1.6 0 0 0-.469 1.131zm-7.317-.283a.4.4 0 0 1 .117.283h1.2a1.6 1.6 0 0 0-.469-1.131zM3.4 6.586c0 .424.169.831.469 1.131l.848-.848a.4.4 0 0 1-.117-.283zM19 4.6c.22 0 .4.18.4.4h1.2A1.6 1.6 0 0 0 19 3.4zM5 3.4A1.6 1.6 0 0 0 3.4 5h1.2c0-.22.18-.4.4-.4z"></svg:path>`,
})
export class LetsIconsFilterAltDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFilterAltDuotoneLineIcon],svg[lets-icons-filter-alt-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFilterAltDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFilterAltLightIcon],svg[lets-icons-filter-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireIcon],svg[lets-icons-fire-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireAltLightIcon],svg[lets-icons-fire-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M9.5 10c0-.79-1.053-1-1.332-.26C7.492 11.53 7 13.134 7 14a5 5 0 0 0 10 0c0-.93-.568-2.711-1.322-4.663c-.975-2.528-1.463-3.792-2.066-3.86a1.03 1.03 0 0 0-.575.107C12.5 5.864 12.5 7.243 12.5 10a1.5 1.5 0 0 1-3 0Z"></svg:path>`,
})
export class LetsIconsFireAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireDuotoneFillIcon],svg[lets-icons-fire-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><svg:path d="M10.367 4.061C9.667 4.567 5 8.158 5 14a7 7 0 0 0 6.92 7a4 4 0 0 1-3.874-4.616c.336-2.254 2.41-4.167 3.412-4.974a.856.856 0 0 1 1.084 0c1.003.807 3.076 2.72 3.412 4.974l.004.034Q16 16.703 16 17a4 4 0 0 1-3.92 4A7 7 0 0 0 19 14.057V14c-.027-4.241-2.896-6.555-3.419-6.942a.14.14 0 0 0-.163 0c-.21.155-.794.618-1.421 1.39a.156.156 0 0 1-.26-.032c-1.18-2.495-2.813-4.009-3.198-4.345a.135.135 0 0 0-.172-.01"></svg:path><svg:path fill-opacity=".25" d="M8.046 16.384c.336-2.253 2.41-4.167 3.412-4.974a.856.856 0 0 1 1.084 0c1.003.807 3.076 2.72 3.412 4.974l.004.034Q16 16.703 16 17a4 4 0 1 1-7.954-.616"></svg:path></svg:g>`,
})
export class LetsIconsFireDuotoneFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireDuotoneLineIcon],svg[lets-icons-fire-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireFillIcon],svg[lets-icons-fire-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.367 4.061C9.667 4.567 5 8.158 5 14a7 7 0 0 0 6.92 7a4 4 0 0 1-3.874-4.616c.336-2.254 2.41-4.167 3.412-4.974a.856.856 0 0 1 1.084 0c1.003.807 3.076 2.72 3.412 4.974l.004.034Q16 16.703 16 17a4 4 0 0 1-3.92 4A7 7 0 0 0 19 14.057V14c-.026-4.241-2.896-6.555-3.419-6.942a.14.14 0 0 0-.163 0c-.21.155-.794.618-1.421 1.39a.156.156 0 0 1-.26-.032c-1.18-2.495-2.813-4.009-3.198-4.345a.135.135 0 0 0-.172-.01"></svg:path>`,
})
export class LetsIconsFireFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFireLightIcon],svg[lets-icons-fire-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m18.005 16.488l-.462-.191zm-1.409 2.11l.354.353zm-2.109 1.408l-.19-.462zm-4.974 0l.19-.462zm-2.11-1.409l.354-.353zm-1.408-2.109l-.462.192zm9.412-9.905l-.34-.366zm.184-.001l.341-.366zm-1.237.9l.409-.288zm.249.004L15 7.79zM11.42 4.548l.264.425zm.157.008l-.3.4zm-.42-.433c-.378.235-1.904 1.23-3.341 2.893S5 11.043 5 14.001h1c0-2.633 1.226-4.774 2.572-6.33a14.5 14.5 0 0 1 3.112-2.698zm3.606 3.071c-1.215-1.732-2.54-2.779-2.887-3.038l-.598.8c.297.223 1.533 1.198 2.666 2.813zM15 7.79c.337-.441.62-.722.748-.841l-.682-.732a8 8 0 0 0-.86.965zm.25-.842C15.7 7.366 18 9.716 18 14h1c0-4.67-2.512-7.266-3.068-7.784zM18 14h1zm0 0a6 6 0 0 1-.457 2.297l.924.383c.352-.85.533-1.76.533-2.68zm-.457 2.297a6 6 0 0 1-1.3 1.947l.707.707a7 7 0 0 0 1.517-2.271zm-1.3 1.947a6 6 0 0 1-1.947 1.3l.383.924a7 7 0 0 0 2.27-1.517zm-1.947 1.3a6 6 0 0 1-2.296.457v1a7 7 0 0 0 2.679-.533zM12 20.001a6 6 0 0 1-2.296-.457l-.383.924a7 7 0 0 0 2.679.533zm-2.296-.457a6 6 0 0 1-1.947-1.3l-.707.707a7 7 0 0 0 2.271 1.517zm-1.947-1.3a6 6 0 0 1-1.3-1.947l-.924.383a7 7 0 0 0 1.517 2.27zm-1.3-1.947A6 6 0 0 1 6 14.001H5a7 7 0 0 0 .533 2.679zm9.291-9.348a.367.367 0 0 1-.497-.001l.681-.732a.633.633 0 0 0-.866.001zm-1.804.82c.256.364.79.37 1.056.02l-.794-.607a.345.345 0 0 1 .557.012zm-2.26-2.796a.36.36 0 0 1-.406-.016l.598-.801a.64.64 0 0 0-.72-.033z"></svg:path><svg:path fill="currentColor" d="m15.5 16.922l-.5.01zM8.5 17H9zm3.586-5.436l.302-.398zm-.474-.398A12.3 12.3 0 0 0 9.617 13.1C8.804 14.102 8 15.47 8 17h1c0-1.19.635-2.335 1.394-3.27c.75-.924 1.57-1.575 1.822-1.767zm4.387 5.746c-.03-1.509-.833-2.855-1.64-3.841a12.3 12.3 0 0 0-1.971-1.905l-.604.797c.25.19 1.056.83 1.8 1.74c.754.921 1.391 2.052 1.415 3.229zm-1 .02L15 17h1l-.001-.09zM15 17a3 3 0 0 1-3 3v1a4 4 0 0 0 4-4zm-3 3a3 3 0 0 1-3-3H8a4 4 0 0 0 4 4zm-4-3a.5.5 0 0 0 .5.5v-1a.5.5 0 0 1 .5.5zm1 0a.5.5 0 0 0-.5-.5v1A.5.5 0 0 1 8 17zm3.216-5.037a.36.36 0 0 1-.432 0l.604-.797a.64.64 0 0 0-.776 0z"></svg:path>`,
})
export class LetsIconsFireLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagAltFillIcon],svg[lets-icons-flag-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M6 5.5V15h10.793c.514 0 .77 0 .834-.154c.064-.155-.117-.336-.48-.7l-3.864-3.863c-.133-.133-.2-.2-.2-.283s.066-.15.2-.283l3.863-3.863c.364-.364.545-.545.481-.7C17.564 5 17.307 5 16.793 5H6.5c-.236 0-.354 0-.427.073S6 5.264 6 5.5"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 15V5.5c0-.236 0-.354.073-.427S6.264 5 6.5 5h10.293c.514 0 .77 0 .834.154c.064.155-.117.336-.48.7l-3.864 3.863c-.133.133-.2.2-.2.283s.066.15.2.283l3.863 3.863c.364.364.545.545.481.7c-.063.154-.32.154-.834.154zm0 0v4"></svg:path></svg:g>`,
})
export class LetsIconsFlagAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagAltLightIcon],svg[lets-icons-flag-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" d="M6 15V5.5c0-.236 0-.354.073-.427S6.264 5 6.5 5h10.293c.514 0 .77 0 .834.154c.064.155-.117.336-.48.7l-3.864 3.863c-.133.133-.2.2-.2.283s.066.15.2.283l3.863 3.863c.364.364.545.545.481.7c-.063.154-.32.154-.834.154zm0 0v4"></svg:path>`,
})
export class LetsIconsFlagAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagFillIcon],svg[lets-icons-flag-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M16.577 8.526L6.658 5.219c-.3-.1-.45-.15-.554-.075S6 5.377 6 5.694V13l10.577-3.526c.588-.196.882-.294.882-.474s-.294-.278-.882-.474"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 13V5.694c0-.317 0-.475.104-.55s.254-.025.554.075l9.919 3.307c.588.196.882.294.882.474s-.294.278-.882.474zm0 0v6"></svg:path></svg:g>`,
})
export class LetsIconsFlagFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagFinishAltIcon],svg[lets-icons-flag-finish-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 13V3.5c0-.236 0-.354.073-.427S5.264 3 5.5 3h4.096c.2 0 .3 0 .39.036c.09.037.161.106.305.245l1.488 1.438c.144.139.216.208.306.245c.09.036.19.036.39.036h6.195c.243 0 .364 0 .407.078s-.023.18-.155.384L16.174 9.73c-.084.132-.127.197-.127.271c0 .073.043.14.127.27l2.748 4.268c.132.204.197.306.155.384s-.164.078-.407.078h-6.196c-.2 0-.3 0-.39-.036c-.09-.037-.161-.106-.305-.245l-1.488-1.438c-.144-.139-.216-.208-.306-.245c-.09-.036-.19-.036-.39-.036zm0 0v6"></svg:path>`,
})
export class LetsIconsFlagFinishAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagFinishDuotoneIcon],svg[lets-icons-flag-finish-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagFinishLightIcon],svg[lets-icons-flag-finish-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" d="M6 13V5.5c0-.236 0-.354.073-.427S6.264 5 6.5 5h3.882c.3 0 .451 0 .572.075c.12.074.188.209.322.478l.448.894c.134.27.201.404.322.478c.121.075.271.075.572.075H17.5c.236 0 .354 0 .427.073S18 7.264 18 7.5v7c0 .236 0 .354-.073.427S17.736 15 17.5 15h-4.882c-.3 0-.451 0-.572-.075c-.12-.074-.188-.209-.322-.478l-.448-.894c-.134-.27-.201-.404-.322-.478c-.121-.075-.271-.075-.572-.075zm0 0v6"></svg:path>`,
})
export class LetsIconsFlagFinishLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFlagLightIcon],svg[lets-icons-flag-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" d="M6 13V5.694c0-.317 0-.475.104-.55s.254-.025.554.075l9.919 3.307c.588.196.882.294.882.474s-.294.278-.882.474zm0 0v6"></svg:path>`,
})
export class LetsIconsFlagLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderIcon],svg[lets-icons-folder-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="M4 9c0-1.886 0-2.828.586-3.414S6.114 5 8 5h.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02l.656.656c.579.578.867.868 1.235 1.02S13.84 8 14.657 8H16c1.886 0 2.828 0 3.414.586S20 10.114 20 12v3c0 1.886 0 2.828-.586 3.414S17.886 19 16 19H8c-1.886 0-2.828 0-3.414-.586S4 16.886 4 15z"></svg:path>`,
})
export class LetsIconsFolderIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAddDuotoneFillIcon],svg[lets-icons-folder-add-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAddFillIcon],svg[lets-icons-folder-add-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M9 14h3m0 0h3m-3 0v3m0-3v-3"></svg:path></svg:g>`,
})
export class LetsIconsFolderAddFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAddLightIcon],svg[lets-icons-folder-add-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsFolderAddLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAltIcon],svg[lets-icons-folder-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M3 7c0-1.886 0-2.828.586-3.414S5.114 3 7 3h10c1.886 0 2.828 0 3.414.586S21 5.114 21 7v10c0 1.886 0 2.828-.586 3.414S18.886 21 17 21H7c-1.886 0-2.828 0-3.414-.586S3 18.886 3 17z"></svg:path><svg:path d="M3 7h3c.981 0 1.472 0 1.894.211c.423.211.717.604 1.306 1.389l.6.8c.589.785.883 1.178 1.306 1.389c.422.211.913.211 1.894.211h5c.932 0 1.398 0 1.765-.152a2 2 0 0 0 1.083-1.083C21 9.398 21 8.932 21 8"></svg:path><svg:path stroke-linecap="round" d="M7 16h8"></svg:path></svg:g>`,
})
export class LetsIconsFolderAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAltDuotoneFillIcon],svg[lets-icons-folder-alt-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="20" height="9" x="2" y="2" fill="currentColor" fill-opacity=".25" rx="2"></svg:rect><svg:path fill="currentColor" fill-rule="evenodd" d="M19 10h-7.343c-.818 0-1.226 0-1.594-.152c-.367-.152-.657-.442-1.235-1.02l-.792-.792c-.444-.444-.665-.665-.934-.806a2 2 0 0 0-.337-.14C6.475 7 6.162 7 5.535 7c-1.438 0-2.157 0-2.67.353a2 2 0 0 0-.512.513C2 8.378 2 9.097 2 10.536V18c0 1.886 0 2.828.586 3.414S4.114 22 6 22h12c1.886 0 2.828 0 3.414-.586S22 19.886 22 18V7c0 .932 0 1.398-.152 1.765a2 2 0 0 1-1.083 1.083C20.398 10 19.932 10 19 10M6 14a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFolderAltDuotoneFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderAltFillIcon],svg[lets-icons-folder-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M3 7c0-1.886 0-2.828.586-3.414S5.114 3 7 3h10c1.886 0 2.828 0 3.414.586S21 5.114 21 7v10c0 1.886 0 2.828-.586 3.414S18.886 21 17 21H7c-1.886 0-2.828 0-3.414-.586S3 18.886 3 17z"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M18 10h-5.343c-.818 0-1.226 0-1.594-.152s-.657-.442-1.235-1.02l-.656-.656c-.578-.578-.868-.868-1.235-1.02S7.16 7 6.343 7H3v10c0 1.886 0 2.828.586 3.414S5.114 21 7 21h10c1.886 0 2.828 0 3.414-.586S21 18.886 21 17V7c0 .932 0 1.398-.152 1.765a2 2 0 0 1-1.083 1.083C19.398 10 18.932 10 18 10M7 15a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2z" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class LetsIconsFolderAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCheckDuotoneIcon],svg[lets-icons-folder-check-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:path stroke="currentColor" d="m9 13.5l1.894 1.894a.15.15 0 0 0 .212 0L15 11.5"></svg:path></svg:g>`,
})
export class LetsIconsFolderCheckDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCheckLightIcon],svg[lets-icons-folder-check-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M5 13V9c0-1.886 0-2.828.586-3.414S7.114 5 9 5h.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02l.656.656c.579.578.867.868 1.235 1.02S14.84 8 15.657 8H17c1.886 0 2.828 0 3.414.586S21 10.114 21 12v3c0 1.886 0 2.828-.586 3.414S18.886 19 17 19h-6"></svg:path><svg:path d="M4 16.5L6.5 19l5-5"></svg:path></svg:g>`,
})
export class LetsIconsFolderCheckLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCopyDuotoneIcon],svg[lets-icons-folder-copy-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderCopyDuotone0"><svg:g fill="none"><svg:path stroke="silver" stroke-miterlimit="1.414" stroke-opacity=".25" d="M13 19.5h.5a2 2 0 0 0 2-2V17M6 19.5h-.5a2 2 0 0 1-2-2V17M6 7.5h-.5a2 2 0 0 0-2 2v.5m7.5 9.5H8M3.5 12v3"></svg:path><svg:path fill="#fff" d="M8 6.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C9.52 3 10.08 3 11.2 3h1.301c.551 0 .827 0 1.082.069a2 2 0 0 1 .631.295c.216.153.393.364.745.787L16.5 6h2.3c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C22 7.52 22 8.08 22 9.2v2.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C20.48 15 19.92 15 18.8 15h-7.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C8 13.48 8 12.92 8 11.8z"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderCopyDuotone0)"></svg:path>`,
})
export class LetsIconsFolderCopyDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCopyDuotoneLineIcon],svg[lets-icons-folder-copy-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderCopyDuotoneLine0"><svg:g fill="none" stroke-width="1.2"><svg:path stroke="#fff" stroke-linejoin="round" d="M16.04 6.384a.6.6 0 0 0 .46.216h2.3c.57 0 .961 0 1.265.025c.296.024.455.069.57.128a1.4 1.4 0 0 1 .612.611c.06.116.104.275.128.571c.024.304.025.695.025 1.265v2.6c0 .57 0 .961-.025 1.265c-.024.296-.069.455-.128.57a1.4 1.4 0 0 1-.611.612c-.116.06-.275.104-.571.128c-.304.024-.695.025-1.265.025h-7.6c-.57 0-.961 0-1.265-.025c-.296-.024-.455-.069-.57-.128a1.4 1.4 0 0 1-.612-.611c-.06-.116-.104-.275-.128-.571C8.6 12.76 8.6 12.37 8.6 11.8V6.2c0-.57 0-.961.025-1.265c.024-.296.069-.455.128-.57a1.4 1.4 0 0 1 .611-.612c.116-.06.275-.104.571-.128c.304-.025.695-.025 1.265-.025h1.301c.584 0 .765.005.926.048a1.4 1.4 0 0 1 .442.207c.136.096.256.232.63.68z"></svg:path><svg:path stroke="silver" stroke-miterlimit="1.414" stroke-opacity=".25" d="M6 7H5a2 2 0 0 0-2 2v1m3 10H5a2 2 0 0 1-2-2v-1m10 3h1a2 2 0 0 0 2-2v-1m-5 3H8m-5-8v3"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderCopyDuotoneLine0)"></svg:path>`,
})
export class LetsIconsFolderCopyDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCopyFillIcon],svg[lets-icons-folder-copy-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-miterlimit="1.414" stroke-width="2" d="M6 7H5a2 2 0 0 0-2 2v1m3 10H5a2 2 0 0 1-2-2v-1m10 3h1a2 2 0 0 0 2-2v-1m-5 3H8m-5-8v3"></svg:path><svg:path fill="currentColor" d="M8 6.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C9.52 3 10.08 3 11.2 3h1.301c.551 0 .827 0 1.082.069a2 2 0 0 1 .631.295c.216.153.393.364.745.787L16.5 6h2.3c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C22 7.52 22 8.08 22 9.2v2.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C20.48 15 19.92 15 18.8 15h-7.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C8 13.48 8 12.92 8 11.8z"></svg:path></svg:g>`,
})
export class LetsIconsFolderCopyFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderCopyLightIcon],svg[lets-icons-folder-copy-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDelIcon],svg[lets-icons-folder-del-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="m16 21l5-5m0 5l-5-5m4-2.5V12c0-1.886 0-2.828-.586-3.414S17.886 8 16 8h-1.343c-.818 0-1.226 0-1.594-.152s-.657-.442-1.235-1.02l-.656-.656c-.578-.578-.867-.868-1.235-1.02S9.16 5 8.343 5H8c-1.886 0-2.828 0-3.414.586S4 7.114 4 9v6c0 1.886 0 2.828.586 3.414S6.114 19 8 19h5"></svg:path>`,
})
export class LetsIconsFolderDelIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDelDuotoneFillIcon],svg[lets-icons-folder-del-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:path stroke="currentColor" d="m9.5 16.5l5-5m0 5l-5-5"></svg:path></svg:g>`,
})
export class LetsIconsFolderDelDuotoneFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDelDuotoneLineIcon],svg[lets-icons-folder-del-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderDelDuotoneLine0"><svg:g fill="none" stroke-width="1.2"><svg:path stroke="#fff" d="m17 21l5-5m0 5l-5-5"></svg:path><svg:path stroke="silver" stroke-opacity=".25" d="M19.5 14v-1.5c0-1.886 0-2.828-.586-3.414S17.386 8.5 15.5 8.5h-1.343c-.818 0-1.226 0-1.594-.152s-.657-.442-1.235-1.02l-.656-.656c-.578-.578-.868-.868-1.235-1.02S8.66 5.5 7.843 5.5H7.5c-1.886 0-2.828 0-3.414.586S3.5 7.614 3.5 9.5v5c0 1.886 0 2.828.586 3.414s1.528.586 3.414.586H15"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderDelDuotoneLine0)"></svg:path>`,
})
export class LetsIconsFolderDelDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDelFillIcon],svg[lets-icons-folder-del-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="m9.5 16.5l5-5m0 5l-5-5"></svg:path></svg:g>`,
})
export class LetsIconsFolderDelFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDublicateIcon],svg[lets-icons-folder-dublicate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><svg:path d="M8 7c0-.943 0-1.414.293-1.707S9.057 5 10 5h1.764c.601 0 .902 0 1.144.15c.241.149.376.418.645.956L14.5 8H18c.943 0 1.414 0 1.707.293S20 9.057 20 10v3c0 .943 0 1.414-.293 1.707S18.943 15 18 15h-8c-.943 0-1.414 0-1.707-.293S8 13.943 8 13z"></svg:path><svg:path d="M17 15v2.4c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C16.24 19 15.96 19 15.4 19H5.6c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C4 18.24 4 17.96 4 17.4V9.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C4.76 8 5.04 8 5.6 8H8"></svg:path></svg:g>`,
})
export class LetsIconsFolderDublicateIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDublicateDuotoneIcon],svg[lets-icons-folder-dublicate-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" d="M4 11.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C5.52 8 6.08 8 7.2 8h1.301c.551 0 .827 0 1.082.069a2 2 0 0 1 .631.295c.216.153.393.364.745.787L12.5 11h2.3c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C18 12.52 18 13.08 18 14.2v2.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C16.48 20 15.92 20 14.8 20H7.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C4 18.48 4 17.92 4 16.8z"></svg:path><svg:path fill="currentColor" d="M7 8.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C8.52 5 9.08 5 10.2 5h1.301c.551 0 .827 0 1.082.069a2 2 0 0 1 .631.295c.216.153.393.364.745.787L15.5 8h2.3c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v2.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 17 18.92 17 17.8 17h-7.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C7 15.48 7 14.92 7 13.8z"></svg:path>`,
})
export class LetsIconsFolderDublicateDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDublicateDuotoneLineIcon],svg[lets-icons-folder-dublicate-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderDublicateDuotoneLine0"><svg:g fill="none" stroke-linejoin="round" stroke-width="1.2"><svg:path stroke="#fff" d="M15.04 7.384a.6.6 0 0 0 .46.216h2.3c.57 0 .961 0 1.265.025c.296.024.455.069.57.128a1.4 1.4 0 0 1 .612.611c.06.116.104.275.128.571c.024.304.025.695.025 1.265v2.6c0 .57 0 .961-.025 1.265c-.024.296-.069.455-.128.57a1.4 1.4 0 0 1-.611.612c-.116.06-.275.104-.571.128c-.304.024-.695.025-1.265.025h-7.6c-.57 0-.961 0-1.265-.025c-.296-.024-.455-.069-.57-.128a1.4 1.4 0 0 1-.612-.611c-.06-.116-.104-.275-.128-.571C7.6 13.76 7.6 13.37 7.6 12.8V7.2c0-.57 0-.961.025-1.265c.024-.296.069-.455.128-.57a1.4 1.4 0 0 1 .611-.612c.116-.06.275-.104.571-.128C9.24 4.6 9.63 4.6 10.2 4.6h1.301c.584 0 .765.005.926.048a1.4 1.4 0 0 1 .442.207c.136.096.256.232.63.68z"></svg:path><svg:path stroke="silver" stroke-opacity=".25" d="M17 15v1.8c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C15.48 20 14.92 20 13.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8v-5.6c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.52 8 5.08 8 6.2 8H8"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderDublicateDuotoneLine0)"></svg:path>`,
})
export class LetsIconsFolderDublicateDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDublicateFillIcon],svg[lets-icons-folder-dublicate-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDublicateLightIcon],svg[lets-icons-folder-dublicate-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round"><svg:path d="M14.116 8.32a.5.5 0 0 0 .384.18h2.3c.568 0 .965 0 1.273.026c.302.024.476.07.608.137a1.5 1.5 0 0 1 .656.656c.067.132.113.306.137.608c.026.309.026.705.026 1.273v2.6c0 .568 0 .964-.026 1.273c-.024.303-.07.476-.137.608a1.5 1.5 0 0 1-.656.656c-.132.067-.306.113-.608.137c-.308.026-.705.026-1.273.026H9.2c-.568 0-.964 0-1.273-.026c-.302-.024-.476-.07-.608-.137a1.5 1.5 0 0 1-.656-.656c-.067-.132-.113-.305-.137-.608c-.026-.309-.026-.705-.026-1.273V8.2c0-.568 0-.964.026-1.273c.024-.302.07-.476.137-.608a1.5 1.5 0 0 1 .656-.656c.132-.067.306-.113.608-.137C8.236 5.5 8.632 5.5 9.2 5.5h1.301c.578 0 .775.004.952.052q.256.068.474.221c.149.106.278.254.648.699z"></svg:path><svg:path d="M17 16v1.6c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H5.4c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656C3 18.861 3 18.441 3 17.6v-7.2c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656C4.139 8 4.559 8 5.4 8H7"></svg:path></svg:g>`,
})
export class LetsIconsFolderDublicateLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDuotoneFillIcon],svg[lets-icons-folder-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" d="M3 8c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8v3H3z"></svg:path><svg:path fill="currentColor" d="M3 11.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.52 8 5.08 8 6.2 8h11.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v4.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 19 18.92 19 17.8 19H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 17.48 3 16.92 3 15.8z"></svg:path>`,
})
export class LetsIconsFolderDuotoneFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderDuotoneLineIcon],svg[lets-icons-folder-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileAltDuotoneFillIcon],svg[lets-icons-folder-file-alt-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M14 4.92V3H8.4c-.84 0-1.26 0-1.581.163a1.5 1.5 0 0 0-.656.656C6 4.139 6 4.559 6 5.4V8h2.264c.232 0 .495-.001.753.06a2.2 2.2 0 0 1 .635.264c.226.139.412.325.576.49l.042.041l1.875 1.875a8 8 0 0 0 .25.243q.025.014.052.02q.007.002.046.004c.063.003.147.003.302.003H18l.001-.4V7h-1.92c-.263 0-.49 0-.677-.015a1.5 1.5 0 0 1-.584-.148a1.5 1.5 0 0 1-.655-.656a1.5 1.5 0 0 1-.149-.583C14 5.41 14 5.183 14 4.919M12.611 13a2.8 2.8 0 0 1-.628-.06a2.2 2.2 0 0 1-.635-.264c-.227-.139-.412-.325-.576-.49l-.042-.041l-1.875-1.875a7 7 0 0 0-.25-.243a.2.2 0 0 0-.052-.02l-.047-.004A8 8 0 0 0 8.205 10H6v.6c0 .84 0 1.26.163 1.581a1.5 1.5 0 0 0 .656.656c.32.163.74.163 1.581.163zM15 4.9V3.09q.056.026.108.057c.101.062.188.149.36.322l2.063 2.062c.173.173.26.26.322.36q.032.054.057.109H16.1c-.288 0-.474 0-.616-.012a.6.6 0 0 1-.211-.043a.5.5 0 0 1-.218-.218a.6.6 0 0 1-.043-.21A9 9 0 0 1 15 4.9" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M3 11.4c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656C4.139 9 4.559 9 5.4 9h2.805c.293 0 .44 0 .578.033q.185.045.347.144c.121.074.225.178.432.385l1.876 1.876c.207.207.311.311.432.385a1.2 1.2 0 0 0 .347.144c.138.033.285.033.578.033H18.6c.84 0 1.26 0 1.581.164a1.5 1.5 0 0 1 .656.655c.163.32.163.74.163 1.581v5.2c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H5.4c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656C3 20.861 3 20.441 3 19.6z"></svg:path>`,
})
export class LetsIconsFolderFileAltDuotoneFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileAltDuotoneLineIcon],svg[lets-icons-folder-file-alt-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileAltFillIcon],svg[lets-icons-folder-file-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M14 4.92V3H8.4c-.84 0-1.26 0-1.581.163a1.5 1.5 0 0 0-.656.656C6 4.139 6 4.559 6 5.4V8h2.264c.232 0 .495-.001.753.06a2.2 2.2 0 0 1 .635.264c.226.139.412.325.576.49l.042.041l1.875 1.875a8 8 0 0 0 .25.243q.025.014.052.02q.007.002.046.004c.063.003.147.003.302.003H18l.001-.4V7h-1.92c-.263 0-.49 0-.677-.015a1.5 1.5 0 0 1-.584-.148a1.5 1.5 0 0 1-.655-.656a1.5 1.5 0 0 1-.149-.583C14 5.41 14 5.183 14 4.919M12.611 13a2.8 2.8 0 0 1-.628-.06a2.2 2.2 0 0 1-.635-.264c-.227-.139-.412-.325-.576-.49l-.042-.041l-1.875-1.875a7 7 0 0 0-.25-.243a.2.2 0 0 0-.052-.02l-.047-.004A8 8 0 0 0 8.205 10H6v.6c0 .84 0 1.26.163 1.581a1.5 1.5 0 0 0 .656.656c.32.163.74.163 1.581.163zM15 4.9V3.09q.056.026.108.057c.101.062.188.149.36.322l2.063 2.062c.173.173.26.26.322.36q.032.054.057.109H16.1c-.288 0-.474 0-.616-.012a.6.6 0 0 1-.211-.043a.5.5 0 0 1-.218-.218a.6.6 0 0 1-.043-.21A9 9 0 0 1 15 4.9" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M3 11.4c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656C4.139 9 4.559 9 5.4 9h2.805c.293 0 .44 0 .578.033q.185.045.347.144c.121.074.225.178.432.385l1.876 1.876c.207.207.311.311.432.385a1.2 1.2 0 0 0 .347.144c.138.033.285.033.578.033H18.6c.84 0 1.26 0 1.581.164a1.5 1.5 0 0 1 .656.655c.163.32.163.74.163 1.581v5.2c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H5.4c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656C3 20.861 3 20.441 3 19.6z"></svg:path>`,
})
export class LetsIconsFolderFileAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileAltLightIcon],svg[lets-icons-folder-file-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M3.5 9.9c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656c.32-.163.74-.163 1.581-.163h2.413c.431 0 .646 0 .837.066a1.2 1.2 0 0 1 .448.277c.144.14.24.333.433.718l.938 1.878c.193.385.29.578.433.719c.127.124.28.219.448.277c.19.065.406.065.837.065H18.1c.84 0 1.26 0 1.581.164a1.5 1.5 0 0 1 .656.655c.163.321.163.741.163 1.581v4.2c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H5.9c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656c-.163-.32-.163-.74-.163-1.58z"></svg:path><svg:path d="M17.5 11V7.163c0-.245 0-.367-.028-.482a1 1 0 0 0-.12-.29c-.061-.1-.148-.187-.32-.36L14.968 3.97c-.173-.173-.26-.26-.36-.322a1 1 0 0 0-.29-.12c-.115-.027-.237-.027-.482-.027H8.9c-.84 0-1.26 0-1.581.163a1.5 1.5 0 0 0-.656.656c-.163.32-.163.74-.163 1.581V8"></svg:path><svg:path d="M13.5 3.5v2.4c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437c.214.109.494.109 1.054.109h2.4"></svg:path></svg:g>`,
})
export class LetsIconsFolderFileAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileDuotoneFillIcon],svg[lets-icons-folder-file-duotone-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileDuotoneLineIcon],svg[lets-icons-folder-file-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderFileDuotoneLine0"><svg:g fill="none" stroke-width="1.2"><svg:path stroke="silver" stroke-opacity=".25" d="M18.5 11V7.5c0-1.886 0-2.828-.586-3.414S16.386 3.5 14.5 3.5h-5c-1.886 0-2.828 0-3.414.586S5.5 5.614 5.5 7.5V8"></svg:path><svg:path stroke="#fff" stroke-linejoin="round" d="M12.576 10.424A.6.6 0 0 0 13 10.6h4.8c.57 0 .961 0 1.265.025c.296.024.455.069.57.128a1.4 1.4 0 0 1 .612.611l.504-.256l-.504.256c.06.116.104.275.128.571c.024.304.025.695.025 1.265v4.6c0 .57 0 .961-.025 1.265c-.024.296-.069.455-.128.57a1.4 1.4 0 0 1-.611.612c-.116.06-.275.104-.571.128c-.304.024-.695.025-1.265.025H6.2c-.57 0-.961 0-1.265-.025c-.296-.024-.455-.069-.57-.128a1.4 1.4 0 0 1-.612-.611c-.06-.116-.104-.275-.128-.571C3.6 18.76 3.6 18.37 3.6 17.8v-7.6c0-.57 0-.961.025-1.265c.024-.296.069-.455.128-.57a1.4 1.4 0 0 1 .611-.612c.116-.06.275-.104.571-.128C5.24 7.6 5.63 7.6 6.2 7.6h2.475c.517 0 .678.004.823.039q.216.051.405.167c.127.078.244.19.61.556z"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderFileDuotoneLine0)"></svg:path>`,
})
export class LetsIconsFolderFileDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileFillIcon],svg[lets-icons-folder-file-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M6 7c0-1.886 0-2.828.586-3.414S8.114 3 10 3h4c1.886 0 2.828 0 3.414.586S18 5.114 18 7v3h-3.172a1 1 0 0 1-.707-.293L12.293 7.88A3 3 0 0 0 10.172 7zm0 2c-.932 0-1.398 0-1.765.152a2 2 0 0 0-1.083 1.083C3 10.602 3 11.068 3 12v5.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C4.52 21 5.08 21 6.2 21h11.6c1.12 0 1.68 0 2.108-.218a2 2 0 0 0 .874-.874C21 19.48 21 18.92 21 17.8v-2.6c0-1.12 0-1.68-.218-2.108a2 2 0 0 0-.874-.874c-.402-.205-.92-.217-1.908-.218h-3.172a3 3 0 0 1-2.12-.879l-1.83-1.828A1 1 0 0 0 10.173 9z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFolderFileFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderFileLightIcon],svg[lets-icons-folder-file-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M3.5 9.9c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656c.32-.163.74-.163 1.581-.163h2.413c.431 0 .646 0 .837.066a1.2 1.2 0 0 1 .448.277c.144.14.24.333.433.718l.938 1.878c.193.385.29.578.433.719c.127.124.28.219.448.277c.19.065.406.065.837.065H18.1c.84 0 1.26 0 1.581.164a1.5 1.5 0 0 1 .656.655c.163.321.163.741.163 1.581v4.2c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H5.9c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656c-.163-.32-.163-.74-.163-1.58z"></svg:path><svg:path d="M17.5 11V5.9c0-.84 0-1.26-.163-1.581a1.5 1.5 0 0 0-.656-.656c-.32-.163-.74-.163-1.581-.163H8.9c-.84 0-1.26 0-1.581.163a1.5 1.5 0 0 0-.656.656c-.163.32-.163.74-.163 1.581V8"></svg:path></svg:g>`,
})
export class LetsIconsFolderFileLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderLightIcon],svg[lets-icons-folder-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderLineDuotoneLineIcon],svg[lets-icons-folder-line-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderOpenIcon],svg[lets-icons-folder-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path stroke-linecap="round" d="M15 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8V7.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.52 4 5.08 4 6.2 4h1.475c.489 0 .733 0 .963.055a2 2 0 0 1 .579.24c.201.123.374.296.72.642l.126.126c.346.346.519.519.72.642q.271.165.579.24c.23.055.474.055.963.055H13.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C17 7.52 17 8.08 17 9.2v.3"></svg:path><svg:path d="M5.316 12.28c.245-.818.368-1.227.611-1.53a2 2 0 0 1 .812-.604C7.1 10 7.527 10 8.381 10h8.318c1.458 0 2.187 0 2.673.304a2 2 0 0 1 .869 1.168c.151.553-.058 1.251-.477 2.648l-1.08 3.6c-.245.817-.368 1.227-.611 1.53a2 2 0 0 1-.812.604c-.36.146-.788.146-1.642.146H5.15c-.728 0-1.093 0-1.336-.152a1 1 0 0 1-.434-.584c-.076-.277.029-.626.238-1.324z"></svg:path><svg:path stroke-linecap="round" d="M9 15h6"></svg:path></svg:g>`,
})
export class LetsIconsFolderOpenIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderOpenAltIcon],svg[lets-icons-folder-open-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><svg:path d="M3 12V7.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.52 4 5.08 4 6.2 4h1.475c.489 0 .733 0 .963.055a2 2 0 0 1 .579.24c.201.123.374.296.72.642l.126.126c.346.346.519.519.72.642q.271.165.579.24c.23.055.474.055.963.055h.475c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C16 7.52 16 8.08 16 9.2v.3"></svg:path><svg:path d="M4.7 20h10.92c.854 0 1.28 0 1.64-.146a2 2 0 0 0 .813-.604c.243-.303.366-.713.611-1.53l1.08-3.6c.419-1.397.628-2.095.477-2.648a2 2 0 0 0-.869-1.168C18.886 10 18.157 10 16.699 10h-5.318c-.854 0-1.281 0-1.642.146a2 2 0 0 0-.812.604c-.243.303-.366.712-.611 1.53l-1.948 6.494A1.72 1.72 0 0 1 4.72 20v0C3.77 20 3 19.23 3 18.28V11m8 4h5"></svg:path></svg:g>`,
})
export class LetsIconsFolderOpenAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderOpenLightIcon],svg[lets-icons-folder-open-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path stroke-linecap="round" d="M14.5 18.5H5.9c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656c-.163-.32-.163-.74-.163-1.58V6.9c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656c.32-.163.74-.163 1.581-.163h2.572c.376 0 .564 0 .734.052a1.2 1.2 0 0 1 .414.221c.137.113.242.27.45.582l.86 1.29c.208.313.313.47.45.582c.122.1.263.176.413.222c.171.051.359.051.735.051H16.5c.465 0 .697 0 .888.051a1.5 1.5 0 0 1 1.061 1.061c.051.191.051.423.051.888v0m-9 4h7"></svg:path><svg:path d="M5.953 11.141c.197-.59.295-.885.477-1.103a1.5 1.5 0 0 1 .602-.434C7.297 9.5 7.608 9.5 8.23 9.5h9.94c1.124 0 1.687 0 2.055.236a1.5 1.5 0 0 1 .649.899c.106.425-.072.958-.427 2.024l-1.4 4.2c-.197.59-.295.885-.477 1.104a1.5 1.5 0 0 1-.602.433c-.265.104-.576.104-1.198.104H6.83c-1.124 0-1.687 0-2.056-.235a1.5 1.5 0 0 1-.648-.9c-.106-.424.071-.957.427-2.023z"></svg:path></svg:g>`,
})
export class LetsIconsFolderOpenLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderSearchDuotoneIcon],svg[lets-icons-folder-search-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:circle cx="11.5" cy="13.5" r="2" stroke="currentColor"></svg:circle><svg:path stroke="currentColor" stroke-linecap="round" d="m14 16l1.5 1.5"></svg:path></svg:g>`,
})
export class LetsIconsFolderSearchDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderSendFillIcon],svg[lets-icons-folder-send-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M2 7c0-1.886 0-2.828.586-3.414S4.114 3 6 3h1c.981 0 1.472 0 1.894.211c.423.211.717.604 1.306 1.389L12 7h6.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C22 8.52 22 9.08 22 10.2v7.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C20.48 21 19.92 21 18.8 21H5.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C2 19.48 2 18.92 2 17.8zm14.707 6.293l-3-3l-1.414 1.414L13.586 13H9v2h4.586l-1.293 1.293l1.414 1.414l3-3l.707-.707z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFolderSendFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderSendLightIcon],svg[lets-icons-folder-send-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M5 13V9c0-1.886 0-2.828.586-3.414S7.114 5 9 5h.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02l.656.656c.579.578.867.868 1.235 1.02S14.84 8 15.657 8H17c1.886 0 2.828 0 3.414.586S21 10.114 21 12v3c0 1.886 0 2.828-.586 3.414S18.886 19 17 19h-5m-7-2h5m0 0l-2.5-2.5M10 17l-2.5 2.5"></svg:path>`,
})
export class LetsIconsFolderSendLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderUpIcon],svg[lets-icons-folder-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path stroke-linejoin="round" d="M16 20h2.4c.56 0 .84 0 1.054-.109a1 1 0 0 0 .437-.437C20 19.24 20 18.96 20 18.4V9.6c0-.56 0-.84-.109-1.054a1 1 0 0 0-.437-.437C19.24 8 18.96 8 18.4 8h-4.737c-.245 0-.367 0-.482-.028a1 1 0 0 1-.29-.12c-.1-.061-.187-.148-.36-.32L10.47 5.468c-.173-.173-.26-.26-.36-.322a1 1 0 0 0-.29-.12C9.704 5 9.582 5 9.337 5H5.6c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C4 5.76 4 6.04 4 6.6v11.8c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C4.76 20 5.04 20 5.6 20H8"></svg:path><svg:path d="m12 12l-3 3m3-3l3 3m-3-3v7"></svg:path></svg:g>`,
})
export class LetsIconsFolderUpIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderUpDuotoneIcon],svg[lets-icons-folder-up-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M3 8h14.8c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C21 9.52 21 10.08 21 11.2v5.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 20 18.92 20 17.8 20H6.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 18.48 3 17.92 3 16.8zm0 0c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C4.602 5 5.068 5 6 5h2.343c.818 0 1.226 0 1.594.152s.657.442 1.235 1.02L13 8z"></svg:path><svg:path stroke="currentColor" d="m10 13.5l1.894-1.894a.15.15 0 0 1 .212 0L14 13.5M12 16v-4.5"></svg:path></svg:g>`,
})
export class LetsIconsFolderUpDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFolderUpDuotoneLineIcon],svg[lets-icons-folder-up-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFolderUpDuotoneLine0"><svg:g fill="none"><svg:path stroke="#fff" d="m10 12.5l1.894-1.894a.15.15 0 0 1 .212 0L14 12.5M12 15v-4.5"></svg:path><svg:path stroke="silver" stroke-opacity=".25" d="M4.5 6.9c0-.84 0-1.26.163-1.581a1.5 1.5 0 0 1 .656-.656c.32-.163.74-.163 1.581-.163h2.572c.376 0 .564 0 .735.052a1.2 1.2 0 0 1 .413.221c.137.113.242.27.45.582l.86 1.29c.208.313.313.47.45.582c.122.1.263.176.413.222c.171.051.359.051.735.051H17.1c.84 0 1.26 0 1.581.164a1.5 1.5 0 0 1 .656.655c.163.321.163.741.163 1.581v6.2c0 .84 0 1.26-.163 1.581a1.5 1.5 0 0 1-.656.656c-.32.163-.74.163-1.581.163H6.9c-.84 0-1.26 0-1.581-.163a1.5 1.5 0 0 1-.656-.656c-.163-.32-.163-.74-.163-1.58z"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFolderUpDuotoneLine0)"></svg:path>`,
})
export class LetsIconsFolderUpDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersGroupIcon],svg[lets-icons-folders-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersGroupLightIcon],svg[lets-icons-folders-group-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersLightIcon],svg[lets-icons-folders-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M14.5 5.5c0-.943 0-1.414.293-1.707S15.557 3.5 16.5 3.5h3c.943 0 1.414 0 1.707.293s.293.764.293 1.707v13c0 .943 0 1.414-.293 1.707s-.764.293-1.707.293h-3c-.943 0-1.414 0-1.707-.293s-.293-.764-.293-1.707z"></svg:path><svg:path stroke="currentColor" d="M16.5 17c0-.236 0-.354.073-.427s.191-.073.427-.073h2c.236 0 .354 0 .427.073s.073.191.073.427v1c0 .236 0 .354-.073.427s-.191.073-.427.073h-2c-.236 0-.354 0-.427-.073S16.5 18.236 16.5 18z"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" d="M16.5 6.5h3m-3 3h3m-5 5h7m-3-11h-8c-.943 0-1.414 0-1.707.293S8.5 4.557 8.5 5.5v13c0 .943 0 1.414.293 1.707s.764.293 1.707.293h8"></svg:path><svg:path stroke="currentColor" d="M13 16.5h-2c-.236 0-.354 0-.427.073s-.073.191-.073.427v1c0 .236 0 .354.073.427s.191.073.427.073h2"></svg:path><svg:path fill="currentColor" d="M10.5 6a.5.5 0 0 0 0 1zm0 1H13V6h-2.5zm0 2a.5.5 0 0 0 0 1zm0 1H13V9h-2.5z"></svg:path><svg:path stroke="currentColor" d="M8.5 14.5H13"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" d="M12.5 3.5h-8c-.943 0-1.414 0-1.707.293S2.5 4.557 2.5 5.5v13c0 .943 0 1.414.293 1.707s.764.293 1.707.293h8"></svg:path><svg:path stroke="currentColor" d="M7 16.5H5c-.236 0-.354 0-.427.073S4.5 16.764 4.5 17v1c0 .236 0 .354.073.427s.191.073.427.073h2"></svg:path><svg:path fill="currentColor" d="M4.5 6a.5.5 0 0 0 0 1zm0 1H7V6H4.5zm0 2a.5.5 0 0 0 0 1zm0 1H7V9H4.5z"></svg:path><svg:path stroke="currentColor" d="M2.5 14.5H7"></svg:path></svg:g>`,
})
export class LetsIconsFoldersLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersLineIcon],svg[lets-icons-folders-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M7 2v2.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C8.52 8 9.08 8 10.2 8H15"></svg:path><svg:path d="M7 5v9.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C8.52 18 9.08 18 10.2 18H15"></svg:path><svg:path stroke-linejoin="round" d="M15 16.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C15.76 15 16.04 15 16.6 15h.4l1 1h1.4c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C21 16.76 21 17.04 21 17.6v1.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C20.24 21 19.96 21 19.4 21h-2.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C15 20.24 15 19.96 15 19.4zm0-10c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C15.76 5 16.04 5 16.6 5h.4l1 1h1.4c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C21 6.76 21 7.04 21 7.6v1.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C20.24 11 19.96 11 19.4 11h-2.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C15 10.24 15 9.96 15 9.4z"></svg:path></svg:g>`,
})
export class LetsIconsFoldersLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersLineDuotoneIcon],svg[lets-icons-folders-line-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsFoldersLineDuotone0"><svg:g fill="none"><svg:path stroke="silver" stroke-opacity=".24" d="M5.5 3v3.9c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C6.26 8.5 6.54 8.5 7.1 8.5h4.4M5.5 5v11.9c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437c.214.109.494.109 1.054.109h4.4"></svg:path><svg:path fill="#fff" d="M11 6.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C11.76 5 12.04 5 12.6 5h.737c.245 0 .367 0 .482.028a1 1 0 0 1 .29.12c.1.061.187.148.36.32l.062.063c.173.173.26.26.36.322a1 1 0 0 0 .29.12c.115.027.237.027.482.027H17.4c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C19 6.76 19 7.04 19 7.6v2.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C18.24 12 17.96 12 17.4 12h-4.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C11 11.24 11 10.96 11 10.4zm0 10c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C11.76 15 12.04 15 12.6 15h.737c.245 0 .367 0 .482.028q.154.036.29.12c.1.061.187.148.36.32l.062.063c.173.173.26.26.36.322q.136.082.29.12c.115.027.237.027.482.027H17.4c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C19 16.76 19 17.04 19 17.6v2.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C18.24 22 17.96 22 17.4 22h-4.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C11 21.24 11 20.96 11 20.4z"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsFoldersLineDuotone0)"></svg:path>`,
})
export class LetsIconsFoldersLineDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersLineDuotoneLineIcon],svg[lets-icons-folders-line-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFoldersLineLightIcon],svg[lets-icons-folders-line-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M11.5 7.1c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C12.26 5.5 12.54 5.5 13.1 5.5h.237c.245 0 .367 0 .482.028a1 1 0 0 1 .29.12c.1.061.187.148.36.32l.062.063c.173.174.26.26.36.322a1 1 0 0 0 .29.12c.115.027.237.027.482.027H16.9c.56 0 .84 0 1.054.11a1 1 0 0 1 .437.436c.109.214.109.494.109 1.054v1.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437c-.214.109-.494.109-1.054.109h-3.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C11.5 10.74 11.5 10.46 11.5 9.9zm0 10c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437c.214-.109.494-.109 1.054-.109h.237c.245 0 .367 0 .482.028q.154.037.29.12c.1.061.187.148.36.32l.062.064c.173.172.26.26.36.32q.136.084.29.12c.115.028.237.028.482.028H16.9c.56 0 .84 0 1.054.11a1 1 0 0 1 .437.436c.109.214.109.494.109 1.054v1.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437c-.214.109-.494.109-1.054.109h-3.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437c-.109-.214-.109-.494-.109-1.054z"></svg:path><svg:path d="M5.5 3v3.9c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C6.26 8.5 6.54 8.5 7.1 8.5h4.4M5.5 5v11.9c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437c.214.109.494.109 1.054.109h4.4"></svg:path></svg:g>`,
})
export class LetsIconsFoldersLineLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFormIcon],svg[lets-icons-form-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M4 7c0-1.886 0-2.828.586-3.414S6.114 3 8 3h8c1.886 0 2.828 0 3.414.586S20 5.114 20 7v8c0 2.828 0 4.243-.879 5.121C18.243 21 16.828 21 14 21h-4c-2.828 0-4.243 0-5.121-.879C4 19.243 4 17.828 4 15z"></svg:path><svg:path stroke-linecap="round" d="M15 18v3m-6-3v3M9 8h6m-6 4h6"></svg:path></svg:g>`,
})
export class LetsIconsFormIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFormDuotoneLineIcon],svg[lets-icons-form-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.2"><svg:path fill="currentColor" fill-opacity=".25" d="M4 7c0-1.886 0-2.828.586-3.414S6.114 3 8 3h8c1.886 0 2.828 0 3.414.586S20 5.114 20 7v8c0 2.828 0 4.243-.879 5.121C18.243 21 16.828 21 14 21h-4c-2.828 0-4.243 0-5.121-.879C4 19.243 4 17.828 4 15z"></svg:path><svg:path stroke-linecap="round" d="M15 18v3m-6-3v3M9 8h6m-6 4h6"></svg:path></svg:g>`,
})
export class LetsIconsFormDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFormFillIcon],svg[lets-icons-form-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M3.586 2.586C3 3.172 3 4.114 3 6v10c0 2.828 0 4.243.879 5.121c.641.642 1.568.815 3.121.862V19a1 1 0 1 1 2 0v3h6v-3a1 1 0 1 1 2 0v2.983c1.553-.047 2.48-.22 3.121-.862C21 20.243 21 18.828 21 16V6c0-1.886 0-2.828-.586-3.414S18.886 2 17 2H7c-1.886 0-2.828 0-3.414.586M8 8a1 1 0 0 0 0 2h8a1 1 0 1 0 0-2zm0 6h8a1 1 0 1 0 0-2H8a1 1 0 1 0 0 2" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsFormFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFrameIcon],svg[lets-icons-frame-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M8 3v1c0 1.886 0 2.828-.586 3.414S5.886 8 4 8H3m13-5v1c0 1.886 0 2.828.586 3.414S18.114 8 20 8h1M8 21v-1c0-1.886 0-2.828-.586-3.414S5.886 16 4 16H3m13 5v-1c0-1.886 0-2.828.586-3.414S18.114 16 20 16h1"></svg:path>`,
})
export class LetsIconsFrameIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFullIcon],svg[lets-icons-full-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 4V3H3v1zm7.293 8.707a1 1 0 0 0 1.414-1.414zM5 10V4H3v6zM4 5h6V3H4zm-.707-.293l8 8l1.414-1.414l-8-8z"></svg:path><svg:path fill="currentColor" d="M4 20v1H3v-1zm7.293-8.707a1 1 0 0 1 1.414 1.414zM5 14v6H3v-6zm-1 5h6v2H4zm-.707.293l8-8l1.414 1.414l-8 8z"></svg:path><svg:path fill="currentColor" d="M20 4V3h1v1zm-7.293 8.707a1 1 0 0 1-1.414-1.414zM19 10V4h2v6zm1-5h-6V3h6zm.707-.293l-8 8l-1.414-1.414l8-8z"></svg:path><svg:path fill="currentColor" d="M20 20v1h1v-1zm-7.293-8.707a1 1 0 0 0-1.414 1.414zM19 14v6h2v-6zm1 5h-6v2h6zm.707.293l-8-8l-1.414 1.414l8 8z"></svg:path>`,
})
export class LetsIconsFullIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFullAltIcon],svg[lets-icons-full-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFullAltLightIcon],svg[lets-icons-full-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsFullScreenCornerLightIcon],svg[lets-icons-full-screen-corner-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 20h-.5v.5H4zm5.354-4.646a.5.5 0 0 0-.708-.708zM3.5 14v6h1v-6zm.5 6.5h6v-1H4zm.354-.146l5-5l-.708-.708l-5 5zM20 4h.5v-.5H20zm-5.354 4.646a.5.5 0 0 0 .708.708zM20.5 10V4h-1v6zM20 3.5h-6v1h6zm-.354.146l-5 5l.708.708l5-5z"></svg:path>`,
})
export class LetsIconsFullScreenCornerLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGamepadIcon],svg[lets-icons-gamepad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:rect width="2" height="2" x="13" y="14" fill="currentColor" rx="1"></svg:rect><svg:rect width="2" height="6" x="7" y="11" fill="currentColor" rx="1"></svg:rect><svg:rect width="2" height="6" x="11" y="13" fill="currentColor" rx="1" transform="rotate(90 11 13)"></svg:rect><svg:rect width="2" height="2" x="16" y="12" fill="currentColor" rx="1"></svg:rect><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14 8v0c0-.417 0-.625-.034-.809a2 2 0 0 0-1.13-1.446c-.17-.078-.372-.129-.776-.23L12 5.5c-.461-.115-.692-.173-.883-.267a2 2 0 0 1-1.072-1.373C10 3.652 10 3.414 10 2.938V2"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M3 14c0-2.559 0-3.838.62-4.72q.241-.341.554-.604C4.982 8 6.154 8 8.5 8h7c2.346 0 3.518 0 4.326.676c.208.174.395.378.554.604c.62.882.62 2.161.62 4.72s0 3.838-.62 4.72a3.2 3.2 0 0 1-.554.604C19.018 20 17.846 20 15.5 20h-7c-2.346 0-3.518 0-4.326-.676a3.2 3.2 0 0 1-.554-.604C3 17.838 3 16.559 3 14Z"></svg:path></svg:g>`,
})
export class LetsIconsGamepadIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGiftAltIcon],svg[lets-icons-gift-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><svg:rect width="18" height="3" x="2" y="10" rx="1.5"></svg:rect><svg:path d="M5 13v6.4c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C5.76 21 6.04 21 6.6 21h8.8c.56 0 .84 0 1.054-.109a1 1 0 0 0 .437-.437C17 20.24 17 19.96 17 19.4V13m-5-6.5V10H8.5A3.5 3.5 0 1 1 12 6.5Zm0 1V10h2.5A2.5 2.5 0 1 0 12 7.5Zm0 5.5v8"></svg:path></svg:g>`,
})
export class LetsIconsGiftAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGiftFillIcon],svg[lets-icons-gift-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M11 8H5c-.943 0-1.414 0-1.707.293S3 9.057 3 10v1c0 .943 0 1.414.293 1.707S4.057 13 5 13h6zm-5 7v4c0 .943 0 1.414.293 1.707S7.057 21 8 21h3v-6zm7 6h3c.943 0 1.414 0 1.707-.293S18 19.943 18 19v-4h-5zm5-8h1c.943 0 1.414 0 1.707-.293S21 11.943 21 11v-1c0-.943 0-1.414-.293-1.707S19.943 8 19 8h-6v5z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M19 4.632V4.45a1.766 1.766 0 0 0-2.325-1.675A9.7 9.7 0 0 0 12.88 5.12L12 6v1h3.675a2 2 0 0 0 .633-.103l1.395-.465A1.9 1.9 0 0 0 19 4.632m-14 0V4.45a1.766 1.766 0 0 1 2.325-1.675A9.7 9.7 0 0 1 11.12 5.12L12 6v1H8.325a2 2 0 0 1-.633-.103l-1.395-.465A1.9 1.9 0 0 1 5 4.632"></svg:path>`,
})
export class LetsIconsGiftFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGiftLightIcon],svg[lets-icons-gift-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M3 10c0-.943 0-1.414.293-1.707S4.057 8 5 8h14c.943 0 1.414 0 1.707.293S21 9.057 21 10v1.5c0 .466 0 .699-.076.883a1 1 0 0 1-.541.54c-.184.077-.417.077-.883.077s-.699 0-.883.076a1 1 0 0 0-.54.541c-.077.184-.077.417-.077.883V18c0 .943 0 1.414-.293 1.707S16.943 20 16 20H8c-.943 0-1.414 0-1.707-.293S6 18.943 6 18v-3.5c0-.466 0-.699-.076-.883a1 1 0 0 0-.541-.54C5.199 13 4.966 13 4.5 13s-.699 0-.883-.076a1 1 0 0 1-.54-.541C3 12.199 3 11.966 3 11.5z"></svg:path><svg:path stroke-linecap="round" d="M5 13h14m-7-6v13m0-13l-.879-.879a9.7 9.7 0 0 0-3.796-2.346v0A1.766 1.766 0 0 0 5 5.45v.182c0 .817.523 1.542 1.297 1.8L8 8m4-1l.879-.879a9.7 9.7 0 0 1 3.796-2.346v0A1.766 1.766 0 0 1 19 5.45v.182c0 .817-.523 1.542-1.297 1.8L16 8"></svg:path></svg:g>`,
})
export class LetsIconsGiftLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGiftLightDuotoneLineIcon],svg[lets-icons-gift-light-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M3 10c0-.943 0-1.414.293-1.707S4.057 8 5 8h14c.943 0 1.414 0 1.707.293S21 9.057 21 10v1.5c0 .466 0 .699-.076.883a1 1 0 0 1-.541.54c-.184.077-.417.077-.883.077s-.699 0-.883.076a1 1 0 0 0-.54.541c-.077.184-.077.417-.077.883V18c0 .943 0 1.414-.293 1.707S16.943 20 16 20H8c-.943 0-1.414 0-1.707-.293S6 18.943 6 18v-3.5c0-.466 0-.699-.076-.883a1 1 0 0 0-.541-.54C5.199 13 4.966 13 4.5 13s-.699 0-.883-.076a1 1 0 0 1-.54-.541C3 12.199 3 11.966 3 11.5z"></svg:path><svg:path stroke="currentColor" stroke-width="1.2" d="M3 10c0-.943 0-1.414.293-1.707S4.057 8 5 8h14c.943 0 1.414 0 1.707.293S21 9.057 21 10v1.5c0 .466 0 .699-.076.883a1 1 0 0 1-.541.54c-.184.077-.417.077-.883.077s-.699 0-.883.076a1 1 0 0 0-.54.541c-.077.184-.077.417-.077.883V18c0 .943 0 1.414-.293 1.707S16.943 20 16 20H8c-.943 0-1.414 0-1.707-.293S6 18.943 6 18v-3.5c0-.466 0-.699-.076-.883a1 1 0 0 0-.541-.54C5.199 13 4.966 13 4.5 13s-.699 0-.883-.076a1 1 0 0 1-.54-.541C3 12.199 3 11.966 3 11.5z"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="1.2" d="M5 13h14m-7-6v13m0-13l-.879-.879a9.7 9.7 0 0 0-3.796-2.346v0A1.766 1.766 0 0 0 5 5.45v.182c0 .817.523 1.542 1.297 1.8L8 8m4-1l.879-.879a9.7 9.7 0 0 1 3.796-2.346v0A1.766 1.766 0 0 1 19 5.45v.182c0 .817-.523 1.542-1.297 1.8L16 8"></svg:path></svg:g>`,
})
export class LetsIconsGiftLightDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGlobeIcon],svg[lets-icons-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:circle cx="12" cy="12" r="8"></svg:circle><svg:ellipse cx="12" cy="12" rx="3" ry="8"></svg:ellipse><svg:path stroke-linecap="round" d="M4 12h16"></svg:path></svg:g>`,
})
export class LetsIconsGlobeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGpsFixedIcon],svg[lets-icons-gps-fixed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:circle cx="12" cy="12" r="7"></svg:circle><svg:circle cx="12" cy="12" r="2" fill="currentColor"></svg:circle><svg:path stroke-linecap="round" d="M12 5V3m7 9h2m-9 9v-2m-9-7h2"></svg:path></svg:g>`,
})
export class LetsIconsGpsFixedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGpsFixedDuotoneIcon],svg[lets-icons-gps-fixed-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="12" cy="12" r="3" fill="currentColor"></svg:circle><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M12 2.4a.6.6 0 0 1 .6.6v2.025a7 7 0 0 1 6.375 6.375H21a.6.6 0 1 1 0 1.2h-2.025a7 7 0 0 1-6.376 6.375L12.6 19v2a.6.6 0 1 1-1.2 0v-2.025a7 7 0 0 1-6.375-6.376L5 12.6H3a.6.6 0 1 1 0-1.2h2.025A7 7 0 0 1 11.4 5.025V3a.6.6 0 0 1 .6-.6M12 18a6 6 0 1 0 0-12a6 6 0 0 0 0 12" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsGpsFixedDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGpsFixedDuotoneLineIcon],svg[lets-icons-gps-fixed-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupIcon],svg[lets-icons-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupAddIcon],svg[lets-icons-group-add-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:circle cx="9" cy="9" r="3" stroke="currentColor" stroke-linecap="round" stroke-width="2"></svg:circle><svg:path stroke="currentColor" stroke-width="2" d="M12.268 9a2 2 0 1 1 3.464 2a2 2 0 0 1-3.464-2Z"></svg:path><svg:path fill="currentColor" d="m13.882 19l-.98.197l.16.803h.82zm3.838-1.096l.943-.334zm-5.94-2.193l-.604-.797l-1.157.879l1.234.767zM16.868 18h-2.985v2h2.985zm-.09.238a.2.2 0 0 1-.005-.103a.2.2 0 0 1 .043-.097c.032-.04.059-.038.052-.038v2c1.146 0 2.274-1.08 1.796-2.43zM14 16c1.642 0 2.403 1.181 2.778 2.238l1.885-.668C18.198 16.259 16.948 14 14 14zm-1.614.507C12.77 16.215 13.282 16 14 16v-2c-1.162 0-2.097.362-2.824.914zm-1.133.053c1.039.646 1.474 1.772 1.648 2.637l1.96-.394c-.217-1.083-.824-2.867-2.552-3.942z"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 15c3.572 0 4.592 2.551 4.883 4.009c.109.541-.33.991-.883.991H5c-.552 0-.992-.45-.883-.991C4.408 17.55 5.428 15 9 15ZM19 3v4m2-2h-4"></svg:path></svg:g>`,
})
export class LetsIconsGroupAddIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupAddFillIcon],svg[lets-icons-group-add-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:circle cx="9" cy="9" r="4" fill="currentColor"></svg:circle><svg:path fill="currentColor" fill-rule="evenodd" d="M14.864 18.813c.021.105.11.187.218.187h1.785c.602 0 1.054-.529.853-1.096C17.3 16.72 16.295 15 14 15q-.188 0-.365.015c-.376.032-.472.494-.22.774c.905 1.005 1.285 2.203 1.449 3.024m-1.336-.98c.243.583-.236 1.167-.868 1.167h-1.527c-.602 0-1.054-.529-.853-1.096c.19-.536.5-1.181.995-1.728a.75.75 0 0 1 1.058-.055c.572.506.948 1.122 1.195 1.712" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M9 15c3.572 0 4.592 2.551 4.883 4.009c.109.541-.33.991-.883.991H5c-.552 0-.992-.45-.883-.991C4.408 17.55 5.428 15 9 15"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M12.482 12.588A5 5 0 0 0 14 9c0-.7-.144-1.368-.404-1.973Q13.794 7 14 7a3 3 0 1 1-1.518 5.588m-.77-.648A4 4 0 0 0 13 9c0-.597-.13-1.163-.365-1.672a3 3 0 0 0-.923 4.612" clip-rule="evenodd"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M19 3v4m2-2h-4"></svg:path></svg:g>`,
})
export class LetsIconsGroupAddFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupAddLightIcon],svg[lets-icons-group-add-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:circle cx="8" cy="8" r="2.5" stroke="currentColor" stroke-linecap="round"></svg:circle><svg:path stroke="currentColor" d="M11.768 8.5a2 2 0 1 1 3.464 2a2 2 0 0 1-3.464-2Z"></svg:path><svg:path fill="currentColor" d="m13.405 17.507l.494-.079zM12.5 18h-9v1h9zm-9.412-.414c.13-.814.442-1.971 1.176-2.915C4.979 13.751 6.119 13 8 13v-1c-2.199 0-3.626.9-4.526 2.057c-.88 1.134-1.231 2.48-1.373 3.371zM8 13c1.881 0 3.02.75 3.736 1.671c.734.944 1.046 2.1 1.176 2.915l.987-.158c-.142-.89-.492-2.237-1.373-3.37C11.626 12.9 10.199 12 8 12zm-4.5 5c-.292 0-.443-.217-.412-.414l-.987-.158C1.958 18.322 2.687 19 3.5 19zm9 1c.813 0 1.542-.678 1.4-1.572l-.988.158c.031.197-.12.414-.412.414z"></svg:path><svg:path fill="currentColor" d="m17.297 17.416l-.485.122zM11.8 13.981l-.268-.422l-.515.327l.422.44zm1.605 3.526l.494-.079zm2.99.493H12.5v1h3.895zm.417-.462c.053.215-.104.462-.417.462v1c.87 0 1.62-.772 1.387-1.705zM13.5 14c1.028 0 1.75.503 2.278 1.207c.54.718.856 1.624 1.034 2.33l.97-.242c-.192-.764-.55-1.816-1.204-2.689C15.913 13.72 14.92 13 13.5 13zm-1.432.403c.39-.247.858-.403 1.432-.403v-1c-.768 0-1.421.212-1.968.559zm-.629-.077c.947.99 1.326 2.339 1.473 3.26l.987-.158c-.16-1-.583-2.586-1.737-3.793zm1.473 3.26c.031.197-.12.414-.412.414v1c.813 0 1.542-.678 1.4-1.572z"></svg:path><svg:rect width="4.5" height=".5" x="16.25" y="5.25" stroke="currentColor" stroke-linecap="round" stroke-width=".5" rx=".25"></svg:rect><svg:rect width="4.5" height=".5" x="18.75" y="3.25" stroke="currentColor" stroke-linecap="round" stroke-width=".5" rx=".25" transform="rotate(90 18.75 3.25)"></svg:rect></svg:g>`,
})
export class LetsIconsGroupAddLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupFillIcon],svg[lets-icons-group-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="12" cy="9" r="4" fill="currentColor"></svg:circle><svg:circle cx="17" cy="9" r="3" fill="currentColor"></svg:circle><svg:circle cx="7" cy="9" r="3" fill="currentColor"></svg:circle><svg:path fill="currentColor" fill-rule="evenodd" d="M17.569 18h2.326c.592 0 1.045-.51.902-1.084C20.428 15.446 19.448 13 17 13c-.886 0-1.58.32-2.122.8c1.508.977 2.287 2.69 2.69 4.2m-8.446-4.2A3.1 3.1 0 0 0 7 13c-2.448 0-3.428 2.446-3.797 3.916c-.143.574.31 1.084.902 1.084h2.327c.403-1.51 1.182-3.223 2.69-4.2" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M12 14c3.709 0 4.666 3.301 4.914 5.006c.08.547-.362.994-.914.994H8c-.552 0-.993-.447-.914-.994C7.334 17.301 8.291 14 12 14"></svg:path>`,
})
export class LetsIconsGroupFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupLightIcon],svg[lets-icons-group-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupScanIcon],svg[lets-icons-group-scan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupShareIcon],svg[lets-icons-group-share-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M9 6a3 3 0 1 0 6 0a3 3 0 0 0-6 0Zm-4.562 7.902a3 3 0 1 0 3 5.195a3 3 0 0 0-3-5.196Zm15.124 0a2.999 2.999 0 1 1-2.998 5.194a2.999 2.999 0 0 1 2.998-5.194Z"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.07 6.643a3 3 0 0 1 .42-2.286a9 9 0 0 0-6.23 10.79a3 3 0 0 1 1.77-1.506a7 7 0 0 1 4.04-6.998m5.86 0a7 7 0 0 1 4.04 6.998a3 3 0 0 1 1.77 1.507a9 9 0 0 0-6.23-10.79a3 3 0 0 1 .42 2.285m3.3 12.852a3 3 0 0 1-2.19-.779a7 7 0 0 1-8.08 0a3 3 0 0 1-2.19.78a9 9 0 0 0 12.46 0" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class LetsIconsGroupShareIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsGroupShareLightIcon],svg[lets-icons-group-share-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M9 6a3 3 0 1 0 6 0a3 3 0 0 0-6 0Zm-4.562 7.902a3 3 0 1 0 3 5.195a3 3 0 0 0-3-5.196Zm15.124 0a2.999 2.999 0 1 1-2.998 5.194a2.999 2.999 0 0 1 2.998-5.194Z"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.003 6.125a3 3 0 0 1 .175-1.143a8.5 8.5 0 0 0-5.031 4.766a8.5 8.5 0 0 0-.502 4.817a3 3 0 0 1 .902-.723a7.5 7.5 0 0 1 4.456-7.717m5.994 0a7.5 7.5 0 0 1 4.456 7.717q.055.028.11.06c.3.174.568.398.792.663a8.5 8.5 0 0 0-5.533-9.583a3 3 0 0 1 .175 1.143m2.536 13.328a3 3 0 0 1-1.078-.42a7.5 7.5 0 0 1-8.91 0l-.107.065a3 3 0 0 1-.971.355a8.5 8.5 0 0 0 11.066 0" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class LetsIconsGroupShareLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHeadphonesFillDuotoneIcon],svg[lets-icons-headphones-fill-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.2"><svg:rect width="4" height="7" x="16" y="12" fill="currentColor" fill-opacity=".25" rx="2"></svg:rect><svg:rect width="4" height="7" x="4" y="12" fill="currentColor" fill-opacity=".25" rx="2"></svg:rect><svg:path stroke-linecap="round" d="M4 13v3m16-3v3m0-3c0-2.387-.843-4.676-2.343-6.364S14.122 4 12 4s-4.157.948-5.657 2.636S4 10.613 4 13"></svg:path></svg:g>`,
})
export class LetsIconsHeadphonesFillDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHeadphonesFillLightIcon],svg[lets-icons-headphones-fill-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round"><svg:rect width="4" height="7" x="16" y="12" rx="2"></svg:rect><svg:rect width="4" height="7" x="4" y="12" rx="2"></svg:rect><svg:path stroke-linecap="round" d="M4 13v3m16-3v3m0-3c0-2.387-.843-4.676-2.343-6.364S14.122 4 12 4s-4.157.948-5.657 2.636S4 10.613 4 13"></svg:path></svg:g>`,
})
export class LetsIconsHeadphonesFillLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHideEyeIcon],svg[lets-icons-hide-eye-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M6.887 5.172c.578-.578.867-.868 1.235-1.02S8.898 4 9.716 4h4.61c.826 0 1.239 0 1.61.155c.37.155.66.45 1.239 1.037l1.674 1.699c.568.576.852.865 1.002 1.23c.149.364.149.768.149 1.578v4.644c0 .818 0 1.226-.152 1.594s-.441.656-1.02 1.235l-1.656 1.656c-.579.579-.867.867-1.235 1.02c-.368.152-.776.152-1.594.152H9.7c-.81 0-1.214 0-1.579-.15c-.364-.149-.653-.433-1.229-1.001l-1.699-1.674c-.588-.58-.882-.87-1.037-1.24S4 15.152 4 14.326v-4.61c0-.818 0-1.226.152-1.594s.442-.657 1.02-1.235z"></svg:path><svg:path stroke-linecap="round" d="m8 11l.422.211a8 8 0 0 0 7.156 0L16 11m-4 1.5V14m-3-2l-.5 1m6.5-1l.5 1"></svg:path></svg:g>`,
})
export class LetsIconsHideEyeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHideEyeDuotoneIcon],svg[lets-icons-hide-eye-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.2"><svg:path fill="currentColor" fill-opacity=".25" d="M6.887 5.172c.578-.578.867-.868 1.235-1.02S8.898 4 9.716 4h4.61c.826 0 1.239 0 1.61.155c.37.155.66.45 1.239 1.037l1.674 1.699c.568.576.852.865 1.002 1.23c.149.364.149.768.149 1.578v4.644c0 .818 0 1.226-.152 1.594s-.441.656-1.02 1.235l-1.656 1.656c-.579.579-.867.867-1.235 1.02c-.368.152-.776.152-1.594.152H9.7c-.81 0-1.214 0-1.579-.15c-.364-.149-.653-.433-1.229-1.001l-1.699-1.674c-.588-.58-.882-.87-1.037-1.24S4 15.152 4 14.326v-4.61c0-.818 0-1.226.152-1.594s.442-.657 1.02-1.235z"></svg:path><svg:path stroke-linecap="round" d="m8 11l.422.211a8 8 0 0 0 7.156 0L16 11m-4 1.5V14m-3-2l-.5 1m6.5-1l.5 1"></svg:path></svg:g>`,
})
export class LetsIconsHideEyeDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHideEyeDuotoneLineIcon],svg[lets-icons-hide-eye-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsHideEyeDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHideEyeFillIcon],svg[lets-icons-hide-eye-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHideEyeLightIcon],svg[lets-icons-hide-eye-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M6.887 5.172c.578-.578.867-.868 1.235-1.02S8.898 4 9.716 4h4.61c.826 0 1.239 0 1.61.155c.37.155.66.45 1.239 1.037l1.674 1.699c.568.576.852.865 1.002 1.23c.149.364.149.768.149 1.578v4.644c0 .818 0 1.226-.152 1.594s-.441.656-1.02 1.235l-1.656 1.656c-.579.579-.867.867-1.235 1.02c-.368.152-.776.152-1.594.152H9.7c-.81 0-1.214 0-1.579-.15c-.364-.149-.653-.433-1.229-1.001l-1.699-1.674c-.588-.58-.882-.87-1.037-1.24S4 15.152 4 14.326v-4.61c0-.818 0-1.226.152-1.594s.442-.657 1.02-1.235z"></svg:path><svg:path stroke-linecap="round" d="m8 11l.422.211a8 8 0 0 0 7.156 0L16 11m-4 1.5V14m-3-2l-.5 1m6.5-1l.5 1"></svg:path></svg:g>`,
})
export class LetsIconsHideEyeLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHomeIcon],svg[lets-icons-home-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M5 12.76c0-1.358 0-2.037.274-2.634c.275-.597.79-1.038 1.821-1.922l1-.857C9.96 5.75 10.89 4.95 12 4.95s2.041.799 3.905 2.396l1 .857c1.03.884 1.546 1.325 1.82 1.922c.275.597.275 1.276.275 2.634V17c0 1.886 0 2.828-.586 3.414S16.886 21 15 21H9c-1.886 0-2.828 0-3.414-.586S5 18.886 5 17z"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M14.5 21v-5a1 1 0 0 0-1-1h-3a1 1 0 0 0-1 1v5"></svg:path></svg:g>`,
})
export class LetsIconsHomeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHomeDuotoneIcon],svg[lets-icons-home-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" d="M5 14.059c0-1.01 0-1.514.222-1.945c.221-.43.632-.724 1.453-1.31l4.163-2.974c.56-.4.842-.601 1.162-.601s.601.2 1.162.601l4.163 2.973c.821.587 1.232.88 1.453 1.311s.222.935.222 1.944V19c0 .943 0 1.414-.293 1.707S17.943 21 17 21H7c-.943 0-1.414 0-1.707-.293S5 19.943 5 19z"></svg:path><svg:path fill="currentColor" d="M3 12.387c0 .266 0 .4.084.441s.19-.04.4-.205l7.288-5.668c.59-.459.885-.688 1.228-.688s.638.23 1.228.688l7.288 5.668c.21.164.316.246.4.205s.084-.175.084-.441v-.409c0-.48 0-.72-.102-.928s-.291-.356-.67-.65l-7-5.445c-.59-.459-.885-.688-1.228-.688s-.638.23-1.228.688l-7 5.445c-.379.294-.569.442-.67.65S3 11.498 3 11.978zM12.5 15h-1a2 2 0 0 0-2 2v3.85c0 .083.067.15.15.15h4.7a.15.15 0 0 0 .15-.15V17a2 2 0 0 0-2-2"></svg:path><svg:rect width="2" height="4" x="16" y="5" fill="currentColor" rx=".5"></svg:rect>`,
})
export class LetsIconsHomeDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHomeFillIcon],svg[lets-icons-home-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M5.274 10.126C5 10.723 5 11.402 5 12.76V17c0 1.887 0 2.83.586 3.415c.531.532 1.357.58 2.914.585v-5a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v5c1.557-.005 2.383-.054 2.914-.586C19 19.828 19 18.886 19 17v-4.24c0-1.358 0-2.037-.274-2.634c-.275-.597-.79-1.038-1.821-1.922l-1-.857C14.04 5.75 13.11 4.95 12 4.95s-2.041.799-3.905 2.396l-1 .857c-1.03.884-1.546 1.325-1.82 1.922M13.5 21v-5h-3v5z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsHomeFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHomeLightIcon],svg[lets-icons-home-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M5 12.76c0-1.358 0-2.037.274-2.634c.275-.597.79-1.038 1.821-1.922l1-.857C9.96 5.75 10.89 4.95 12 4.95s2.041.799 3.905 2.396l1 .857c1.03.884 1.546 1.325 1.82 1.922c.275.597.275 1.276.275 2.634V17c0 1.886 0 2.828-.586 3.414S16.886 21 15 21H9c-1.886 0-2.828 0-3.414-.586S5 18.886 5 17z"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M14.5 21v-5a1 1 0 0 0-1-1h-3a1 1 0 0 0-1 1v5"></svg:path></svg:g>`,
})
export class LetsIconsHomeLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHorizontalDownLeftMainIcon],svg[lets-icons-horizontal-down-left-main-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHorizontalSwitchIcon],svg[lets-icons-horizontal-switch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHorizontalSwitchLightIcon],svg[lets-icons-horizontal-switch-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHorizontalTopLeftMainLightIcon],svg[lets-icons-horizontal-top-left-main-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m2 8l-.354-.354L1.293 8l.353.354L2 8Zm19 .5a.5.5 0 0 0 0-1v1ZM5.646 3.646l-4 4l.708.708l4-4l-.708-.708Zm-4 4.708l4 4l.708-.708l-4-4l-.708.708ZM2 8.5h19v-1H2v1ZM22 16l.354-.354l.353.354l-.353.354L22 16Zm-9 .5a.5.5 0 0 1 0-1v1Zm5.354-4.854l4 4l-.708.708l-4-4l.708-.708Zm4 4.708l-4 4l-.708-.708l4-4l.708.708ZM22 16.5h-9v-1h9v1Z"></svg:path>`,
})
export class LetsIconsHorizontalTopLeftMainLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHorizontalTopRightMainIcon],svg[lets-icons-horizontal-top-right-main-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsHumidityIcon],svg[lets-icons-humidity-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M20 14.571C20 18.753 16.336 22 12 22s-8-3.247-8-7.429C4 12 5.305 9.452 6.716 7.423c1.43-2.055 3.076-3.726 3.962-4.568M20 14.571L10.678 2.855M20 14.571c0-2.571-1.305-5.119-2.716-7.148c-1.43-2.055-3.076-3.726-3.962-4.568a1.913 1.913 0 0 0-2.644 0M20 14.571L10.678 2.855"></svg:path><svg:path stroke-linecap="round" d="M12 18a4 4 0 0 1-4-4"></svg:path></svg:g>`,
})
export class LetsIconsHumidityIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsIceCream1Icon],svg[lets-icons-ice-cream-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgIcon],svg[lets-icons-img-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgBoxIcon],svg[lets-icons-img-box-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m19 13.585l-.02-.02c-.39-.39-.726-.726-1.026-.979c-.317-.267-.662-.502-1.088-.63a3 3 0 0 0-1.732 0c-.426.129-.77.363-1.088.63c-.3.253-.636.59-1.025.98l-.029.028c-.307.306-.487.486-.628.601l-.02.017l-.012-.023c-.087-.16-.189-.393-.36-.792l-.053-.124l-.022-.052c-.356-.83-.655-1.528-.95-2.054c-.305-.541-.685-1.05-1.277-1.346a3 3 0 0 0-1.597-.307c-.66.055-1.201.386-1.685.775c-.406.327-.86.77-1.388 1.297V13q0 .774.003 1.411l1.114-1.114c.69-.69 1.15-1.147 1.525-1.45c.37-.298.53-.335.6-.34a1 1 0 0 1 .532.102c.061.031.196.124.43.54c.236.42.493 1.016.877 1.912l.053.124l.017.038c.149.348.287.67.425.924c.145.265.355.583.709.802a2 2 0 0 0 1.398.27c.41-.073.723-.29.956-.482c.222-.184.47-.432.738-.7l.03-.03c.425-.425.701-.7.928-.891c.218-.184.32-.228.376-.245a1 1 0 0 1 .578 0c.056.017.158.061.376.245c.227.191.503.466.929.892l1.35 1.35c.046-.718.054-1.61.056-2.773" clip-rule="evenodd"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsImgBoxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgBoxDuotoneIcon],svg[lets-icons-img-box-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgBoxDuotoneLineIcon],svg[lets-icons-img-box-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsImgBoxDuotoneLine0" width="18" height="18" x="3" y="3" maskUnits="userSpaceOnUse" style="mask-type:alpha"><svg:path fill="#273B4A" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path></svg:mask><svg:g fill="none"><svg:g mask="url(#letsIconsImgBoxDuotoneLine0)"><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" d="m5.41 12.59l-.153.153c-.98.98-1.47 1.47-1.764 2.073q-.153.314-.25.65c-.185.644-.148 1.337-.075 2.722L3.5 24.5H21v-4.743c0-1.451 0-2.177-.239-2.836a4 4 0 0 0-.233-.525c-.33-.619-.87-1.104-1.95-2.075l-.214-.193c-.896-.807-1.344-1.21-1.856-1.324a2 2 0 0 0-.973.025c-.505.141-.932.568-1.784 1.42c-.633.633-.949.949-1.288.992a1 1 0 0 1-.61-.118c-.3-.166-.479-.583-.836-1.418c-.761-1.775-1.141-2.662-1.795-2.99a2 2 0 0 0-1.065-.205c-.729.062-1.401.735-2.747 2.08Z"></svg:path></svg:g><svg:path stroke="currentColor" stroke-width="1.2" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsImgBoxDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgBoxFillIcon],svg[lets-icons-img-box-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-rule="evenodd" d="M3.172 3.172C2 4.343 2 6.229 2 10v4c0 3.771 0 5.657 1.172 6.828S6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14v-4c0-2.84 0-4.61-.5-5.811V17a3.62 3.62 0 0 1-2.56-1.06l-.752-.752c-.722-.722-1.082-1.082-1.491-1.234a2 2 0 0 0-1.394 0c-.409.152-.77.512-1.49 1.234l-.114.113c-.585.585-.878.878-1.189.932a1 1 0 0 1-.699-.134c-.268-.166-.431-.547-.758-1.308L11 14.667c-.75-1.75-1.124-2.624-1.778-2.952a2 2 0 0 0-1.065-.205c-.729.062-1.401.735-2.747 2.08L3.5 15.5V2.887q-.174.129-.328.285" clip-rule="evenodd"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M3 10c0-1.914.002-3.249.138-4.256c.131-.978.372-1.496.74-1.865c.37-.37.888-.61 1.866-.741C6.751 3.002 8.086 3 10 3h4c1.914 0 3.249.002 4.256.138c.978.131 1.496.372 1.865.74c.37.37.61.888.742 1.866C20.998 6.751 21 8.086 21 10v4c0 1.914-.002 3.249-.137 4.256c-.132.978-.373 1.496-.742 1.865c-.369.37-.887.61-1.865.742c-1.007.135-2.342.137-4.256.137h-4c-1.914 0-3.249-.002-4.256-.137c-.978-.132-1.496-.373-1.865-.742c-.37-.369-.61-.887-.741-1.865C3.002 17.249 3 15.914 3 14z"></svg:path><svg:circle cx="15" cy="9" r="2" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsImgBoxFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgBoxLightIcon],svg[lets-icons-img-box-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgDuotoneLineIcon],svg[lets-icons-img-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="17" cy="6" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-width="1.2" d="m11.053 12.791l-.668-1.56c-.295-.687-.442-1.031-.628-1.255a2 2 0 0 0-2.329-.559c-.266.115-.554.355-1.129.834c-.764.636-1.146.955-1.467 1.306a7 7 0 0 0-1.768 3.774C3 15.803 3 16.311 3 17.328c0 .62 0 .93.065 1.179a2 2 0 0 0 1.428 1.428c.25.065.553.065 1.16.065h11.612c.684 0 1.026 0 1.304-.083a2 2 0 0 0 1.348-1.348c.083-.278.083-.62.083-1.304c0-.598 0-.897-.041-1.183a4 4 0 0 0-.753-1.818c-.173-.231-.385-.443-.808-.866l-.21-.21c-.722-.722-1.082-1.082-1.491-1.234a2 2 0 0 0-1.394 0c-.409.152-.77.512-1.49 1.234l-.114.113c-.585.585-.878.878-1.189.932a1 1 0 0 1-.699-.134c-.268-.166-.431-.547-.758-1.308Z"></svg:path>`,
})
export class LetsIconsImgDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgFillIcon],svg[lets-icons-img-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="17" cy="6" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" stroke="currentColor" stroke-width="2" d="M5.226 11.145L3.72 12.4c-.354.295-.531.443-.626.644c-.094.202-.094.432-.094.893V16c0 1.886 0 2.828.586 3.414S5.114 20 7 20h9c1.886 0 2.828 0 3.414-.586S20 17.886 20 16v-.172c0-.408 0-.613-.076-.796s-.22-.329-.51-.618l-1.113-1.113c-.828-.828-1.242-1.242-1.723-1.387a2 2 0 0 0-1.156 0c-.48.145-.895.559-1.723 1.387c-.585.585-.878.878-1.189.932a1 1 0 0 1-.699-.134c-.268-.166-.431-.547-.758-1.308l-.118-.276c-.799-1.864-1.198-2.796-1.95-3.108a2 2 0 0 0-.61-.147c-.812-.063-1.59.586-3.149 1.885Z"></svg:path>`,
})
export class LetsIconsImgFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLightIcon],svg[lets-icons-img-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsImgLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLoadBoxIcon],svg[lets-icons-img-load-box-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-1"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m19 13.585l-.243-.243l-.015-.014a3 3 0 0 0-4.924.799l-.009.018l-.028.057l-.002.003l-.003-.003l-.04-.047l-4.977-5.806a1 1 0 0 0-1.518 1.302l4.976 5.805l.009.01a2 2 0 0 0 3.366-.414l.006-.012l.075-.148a1 1 0 0 1 1.551-.252c.012.01.032.03.119.117l1.601 1.601c.046-.718.054-1.61.056-2.773" clip-rule="evenodd"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M8 16v-1h1v1zm-4.375 4.78a1 1 0 1 1-1.25-1.56zM7 21v-5h2v5zm1-4H3v-2h5zm.625-.22l-5 4l-1.25-1.56l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgLoadBoxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLoadBoxDuotoneIcon],svg[lets-icons-img-load-box-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsImgLoadBoxDuotone0" width="18" height="18" x="3" y="3" maskUnits="userSpaceOnUse" style="mask-type:alpha"><svg:path d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path></svg:mask><svg:g fill="none"><svg:g mask="url(#letsIconsImgLoadBoxDuotone0)"><svg:path fill="currentColor" fill-opacity=".25" d="m13.017 14.927l-2.164-2.36c-.943-1.03-1.415-1.543-2-1.689a2 2 0 0 0-.784-.035c-.596.091-1.113.56-2.145 1.499c-1.062.965-1.592 1.447-2.05 1.39a1 1 0 0 1-.524-.232C3 13.2 3 12.483 3 11.048v-3.48c0-3.584 0-5.376 1.094-6.533S6.978-.22 10.556-.42l2-.11c3.961-.221 5.942-.331 7.193.853S21 3.49 21 7.457v6.45c0 .564 0 .846-.055 1.004a1 1 0 0 1-1.383.574c-.15-.074-.35-.273-.75-.673c-.37-.37-.555-.555-.742-.673a2 2 0 0 0-2.14 0c-.187.118-.372.303-.742.673l-.159.159c-.27.27-.404.404-.547.476a1 1 0 0 1-.94-.02c-.14-.079-.268-.22-.525-.5"></svg:path></svg:g><svg:path fill="currentColor" d="M8 16v-.6h.6v.6zm-5.576 6.424a.6.6 0 1 1-.848-.848zM7.4 21v-5h1.2v5zm.6-4.4H3v-1.2h5zm.424-.176l-6 6l-.848-.848l6-6z"></svg:path><svg:circle cx="16" cy="8" r="2" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsImgLoadBoxDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLoadBoxDuotoneLineIcon],svg[lets-icons-img-load-box-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsImgLoadBoxDuotoneLine0" width="18" height="18" x="3" y="3" maskUnits="userSpaceOnUse" style="mask-type:alpha"><svg:path d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path></svg:mask><svg:g fill="none"><svg:g mask="url(#letsIconsImgLoadBoxDuotoneLine0)"><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-linecap="round" stroke-width="1.2" d="M12.898 14.788L4.31 5.341A1.04 1.04 0 0 0 3.54 5a2.082 2.082 0 0 1-2.042-2.49l.4-1.995A3.75 3.75 0 0 1 5.573-2.5h8.718c3.86 0 5.791 0 6.969 1.208s1.128 3.138 1.029 6.997L22 17l-3.823-3.186a6 6 0 0 0-.414-.329a2 2 0 0 0-2.783.582c-.06.093-.123.218-.248.468c-.07.142-.106.213-.139.262a1 1 0 0 1-1.49.206a3 3 0 0 1-.205-.215z"></svg:path></svg:g><svg:path stroke="currentColor" stroke-width="1.2" d="M3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-1"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M8 16v-.6h.6v.6zm-4.625 4.468a.6.6 0 1 1-.75-.936zM7.4 21v-5h1.2v5zm.6-4.4H3v-1.2h5zm.375-.132l-5 4l-.75-.936l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgLoadBoxDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLoadBoxFillIcon],svg[lets-icons-img-load-box-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-rule="evenodd" d="M2.019 7.495C2 8.224 2 9.052 2 10v2h8.097a3.3 3.3 0 0 0-1.082-.299L7 11.5c-1.313-.131-1.97-.197-2.503-.413a4 4 0 0 1-2.335-2.58c-.083-.284-.124-.596-.143-1.012m19.855-1.72L21.5 17a3.62 3.62 0 0 1-2.56-1.06l-1.128-1.128c-.37-.37-.555-.555-.742-.673a2 2 0 0 0-2.14 0c-.187.118-.372.303-.742.673l-.774.774A.829.829 0 0 1 12 15v7h2c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14v-4c0-1.793 0-3.16-.126-4.225" clip-rule="evenodd"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M3 10c0-1.914.002-3.249.138-4.256c.131-.978.372-1.496.74-1.865c.37-.37.888-.61 1.866-.741C6.751 3.002 8.086 3 10 3h4c1.914 0 3.249.002 4.256.138c.978.131 1.496.372 1.865.74l.69-.69l-.69.69c.37.37.61.888.742 1.866C20.998 6.751 21 8.086 21 10v4c0 1.914-.002 3.249-.137 4.256c-.132.978-.373 1.496-.742 1.865c-.369.37-.887.61-1.865.742c-1.007.135-2.342.137-4.256.137h-1v-7.054c0-.425 0-.837-.046-1.176c-.051-.384-.177-.821-.54-1.184s-.8-.489-1.184-.54C10.89 11 10.48 11 10.055 11H3z"></svg:path><svg:circle cx="16" cy="8" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M8 16v-1h1v1zm-4.375 4.78a1 1 0 1 1-1.25-1.56zM7 21v-5h2v5zm1-4H3v-2h5zm.625-.22l-5 4l-1.25-1.56l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgLoadBoxFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgLoadBoxLightIcon],svg[lets-icons-img-load-box-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-1"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m18.998 14.29l-.595-.594l-.01-.01c-.069-.069-.114-.115-.154-.15a2.5 2.5 0 0 0-3.976.82l-.007.013l-.04.08a.5.5 0 0 1-.802.098l-.058-.067L8.38 8.674a.5.5 0 0 0-.76.651l4.977 5.806l.007.008q.046.056.08.092a1.5 1.5 0 0 0 2.406-.296l.056-.109l.005-.01c.052-.104.07-.141.085-.167a1.5 1.5 0 0 1 2.327-.377l.133.131l1.28 1.28c.013-.41.019-.871.022-1.393" clip-rule="evenodd"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M8 16v-.5h.5v.5zm-4.688 4.39a.5.5 0 1 1-.624-.78zM7.5 21v-5h1v5zm.5-4.5H3v-1h5zm.312-.11l-5 4l-.624-.78l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgLoadBoxLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgOutBoxIcon],svg[lets-icons-img-out-box-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h1"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m19 13.585l-.243-.243l-.015-.014q-.095-.096-.164-.16a3 3 0 0 0-4.76.959l-.009.018l-.028.057l-.002.003l-.003-.003l-.04-.047l-4.977-5.806a1 1 0 0 0-1.518 1.302l4.976 5.805l.009.01a2 2 0 0 0 3.366-.414l.006-.012l.075-.148a1 1 0 0 1 1.551-.252c.012.01.032.03.119.117l1.601 1.601c.046-.718.054-1.61.056-2.773" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M21 3V2h1v1zm-4.375 4.78a1 1 0 0 1-1.25-1.56zM20 8V3h2v5zm1-4h-5V2h5zm.625-.22l-5 4l-1.25-1.56l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgOutBoxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgOutBoxDuotoneIcon],svg[lets-icons-img-out-box-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsImgOutBoxDuotone0" width="18" height="18" x="3" y="3" maskUnits="userSpaceOnUse" style="mask-type:alpha"><svg:path d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path></svg:mask><svg:g fill="none"><svg:g mask="url(#letsIconsImgOutBoxDuotone0)"><svg:path fill="currentColor" fill-opacity=".25" d="m12.689 14.57l-1.497-1.633c-1.27-1.385-1.904-2.078-2.73-2.115c-.825-.038-1.52.594-2.91 1.858l-1.921 1.747c-.299.271-.448.407-.533.583l-.024.056c-.074.18-.074.383-.074.786c0 3.669 0 5.503 1.083 6.657q.163.174.346.327c1.212 1.017 3.044.916 6.706.712l3.312-.184c2.61-.145 3.916-.218 4.85-.874c.441-.31.815-.704 1.1-1.161c.603-.97.603-2.278.603-4.892v-.194c0-.408 0-.612-.038-.805a2 2 0 0 0-.3-.72c-.108-.165-.253-.309-.54-.597c-.66-.659-.99-.988-1.357-1.14a2 2 0 0 0-1.53 0c-.368.152-.697.481-1.356 1.14l-.507.507c-.592.592-.889.889-1.248.922a1 1 0 0 1-.228-.005c-.358-.049-.641-.358-1.207-.976"></svg:path></svg:g><svg:circle cx="6" cy="6" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M20 4v-.6h.6V4zm-5.576 6.424a.6.6 0 0 1-.848-.848zM19.4 9V4h1.2v5zm.6-4.4h-5V3.4h5zm.424-.176l-6 6l-.848-.848l6-6z"></svg:path></svg:g>`,
})
export class LetsIconsImgOutBoxDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgOutBoxDuotoneLineIcon],svg[lets-icons-img-out-box-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:mask id="letsIconsImgOutBoxDuotoneLine0" width="18" height="18" x="3" y="3" maskUnits="userSpaceOnUse" style="mask-type:alpha"><svg:path d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path></svg:mask><svg:g fill="none"><svg:g mask="url(#letsIconsImgOutBoxDuotoneLine0)"><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-linecap="round" stroke-width="1.2" d="M12.898 14.788L4.366 5.402A1.23 1.23 0 0 0 3.456 5A2.457 2.457 0 0 0 1 7.457V15.5c0 3.771 0 5.657 1.172 6.828S5.229 23.501 9 23.501h8.034c.504 0 .755 0 .975-.024a4 4 0 0 0 3.422-2.936c.057-.214.095-.462.172-.96h0c.052-.337.078-.505.09-.665a4 4 0 0 0-1.192-3.149a9 9 0 0 0-.507-.439h0l-1.817-1.514a6 6 0 0 0-.414-.329a2 2 0 0 0-2.783.582c-.06.093-.123.218-.248.468h0c-.07.142-.106.213-.139.262a1 1 0 0 1-1.49.206a3 3 0 0 1-.205-.215z"></svg:path></svg:g><svg:path stroke="currentColor" stroke-width="1.2" d="M21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h1"></svg:path><svg:path fill="currentColor" d="M21 3v-.6h.6V3zm-4.625 4.469a.6.6 0 1 1-.75-.938zM20.4 8V3h1.2v5zm.6-4.4h-5V2.4h5zm.375-.131l-5 4l-.75-.938l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgOutBoxDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgOutBoxFillIcon],svg[lets-icons-img-out-box-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-rule="evenodd" d="m3.5 15.5l1.91-1.91c1.346-1.345 2.018-2.018 2.747-2.08c.367-.03.735.04 1.065.205c.654.328 1.028 1.203 1.778 2.952l.053.124c.326.761.49 1.142.758 1.308a1 1 0 0 0 .7.134c.31-.054.603-.347 1.188-.932l.113-.113c.722-.722 1.082-1.082 1.491-1.234a2 2 0 0 1 1.394 0c.409.152.77.512 1.49 1.234l.752.751a3.62 3.62 0 0 0 1.964 1.012c-.125 1.327-.413 2.216-1.075 2.877C18.657 21 16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13v-2c0-2.84 0-4.61.5-5.812z" clip-rule="evenodd"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M12 3h-1C7.229 3 5.343 3 4.172 4.172S3 7.229 3 11v2c0 3.771 0 5.657 1.172 6.828S7.229 21 11 21h2c3.771 0 5.657 0 6.828-1.172S21 16.771 21 13v-1"></svg:path><svg:path fill="currentColor" d="M21 3V2h1v1zm-4.375 4.78a1 1 0 0 1-1.25-1.56zM20 8V3h2v5zm1-4h-5V2h5zm.625-.22l-5 4l-1.25-1.56l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgOutBoxFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgOutBoxLightIcon],svg[lets-icons-img-out-box-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h1"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m18.998 14.29l-.595-.594l-.01-.01c-.069-.069-.114-.115-.154-.15a2.5 2.5 0 0 0-3.976.82l-.007.013l-.04.08a.5.5 0 0 1-.802.098l-.058-.067L8.38 8.674a.5.5 0 0 0-.76.651l4.977 5.806l.007.008q.046.056.08.092a1.5 1.5 0 0 0 2.406-.296l.056-.109l.005-.01c.052-.104.07-.141.085-.167a1.5 1.5 0 0 1 2.327-.377l.133.131l1.28 1.28c.013-.41.019-.871.022-1.393" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M21 3v-.5h.5V3zm-4.688 4.39a.5.5 0 1 1-.624-.78zM20.5 8V3h1v5zm.5-4.5h-5v-1h5zm.312-.11l-5 4l-.624-.78l5-4z"></svg:path></svg:g>`,
})
export class LetsIconsImgOutBoxLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgRolIcon],svg[lets-icons-img-rol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="m3.5 18l2.46-2.684c1.276-1.391 1.913-2.087 2.69-2.154a2 2 0 0 1 .567.032c.764.154 1.319.918 2.429 2.444l.375.515c.22.303.33.455.449.544a1 1 0 0 0 1.13.051c.127-.079.25-.22.497-.501c.534-.61.801-.916 1.07-1.078a2 2 0 0 1 2.35.21c.235.207.443.555.86 1.25L19.5 18.5"></svg:path><svg:path stroke-linecap="round" d="M7 9.5v-5m10 5v-5M3 17V7m18 0v10M17.02 4.51c1.602.359 2.815.88 3.461 1.486s.69 1.266.126 1.881c-.565.615-1.707 1.154-3.26 1.536s-3.433.588-5.363.587s-3.808-.21-5.356-.593c-1.549-.384-2.686-.924-3.244-1.54s-.507-1.275.145-1.88c.653-.606 1.872-1.126 3.478-1.483"></svg:path><svg:path d="M21 17c0 .796-.948 1.559-2.636 2.121S14.387 20 12 20s-4.676-.316-6.364-.879S3 17.796 3 17"></svg:path></svg:g>`,
})
export class LetsIconsImgRolIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgRolDuotoneIcon],svg[lets-icons-img-rol-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgRolDuotoneLineIcon],svg[lets-icons-img-rol-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M7 7c0-.89 0-1.335-.268-1.623a1.1 1.1 0 0 0-.285-.213c-.351-.176-.742-.061-1.522.168C3.417 5.774 2.5 6.359 2.5 7s.917 1.226 2.425 1.668c.78.23 1.17.344 1.522.168c.1-.05.21-.131.285-.213C7 8.335 7 7.89 7 7m10 0c0 .89 0 1.335.268 1.623c.076.082.185.163.285.213c.351.176.742.061 1.522-.168C20.583 8.226 21.5 7.641 21.5 7s-.917-1.226-2.425-1.668c-.78-.23-1.17-.344-1.522-.168c-.1.05-.21.131-.285.213C17 5.665 17 6.11 17 7" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-opacity=".25" d="M5.96 15.316L3.5 18l4.466 1.218c.516.14.774.211 1.039.247c.264.035.531.035 1.066.035h4.05c.44 0 .659 0 .876-.024c.218-.024.432-.071.86-.166l3.643-.81l-1.122-1.87c-.418-.696-.626-1.044-.861-1.25a2 2 0 0 0-2.35-.21c-.269.16-.536.466-1.07 1.077c-.247.282-.37.422-.497.501a1 1 0 0 1-1.13-.05c-.119-.09-.23-.242-.45-.545l-.374-.515c-1.11-1.526-1.665-2.29-2.429-2.444a2 2 0 0 0-.568-.032c-.776.067-1.413.763-2.688 2.154"></svg:path><svg:path stroke="currentColor" d="m3.5 18l2.46-2.684c1.276-1.391 1.913-2.087 2.69-2.154a2 2 0 0 1 .567.032c.764.154 1.319.918 2.429 2.444l.375.515c.22.303.33.455.449.544a1 1 0 0 0 1.13.051c.127-.079.25-.22.497-.501c.534-.61.801-.916 1.07-1.078a2 2 0 0 1 2.35.21c.235.207.443.555.86 1.25L19.5 18.5"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" d="M6.5 9V5m11 4V5m-15 12V7m19 0v10M17.507 4.963c1.64.307 2.868.743 3.505 1.246c.637.502.65 1.045.04 1.55c-.611.505-1.816.945-3.44 1.258s-3.584.482-5.597.483c-2.013 0-3.975-.167-5.602-.478c-1.628-.312-2.838-.751-3.455-1.255c-.618-.505-.61-1.047.02-1.55c.631-.504 1.853-.94 3.49-1.25"></svg:path><svg:path stroke="currentColor" d="M21.5 17c0 .663-1 1.299-2.782 1.768S14.52 19.5 12 19.5s-4.936-.263-6.718-.732C3.501 18.298 2.5 17.663 2.5 17"></svg:path></svg:g>`,
})
export class LetsIconsImgRolDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgRolFillIcon],svg[lets-icons-img-rol-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M21 18V7l-3 2l-6 1l-7-1l-2-2v11l6-6.5l4 3.5l3.5-2l3 4.5z"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="m3 17l3.04-3.546c1.201-1.402 1.802-2.103 2.547-2.21c.241-.035.488-.025.726.029c.733.166 1.277.913 2.363 2.406l.31.428c.252.345.377.518.517.614a1 1 0 0 0 1.062.048c.148-.084.288-.244.57-.565c.582-.667.874-1 1.178-1.169a2 2 0 0 1 2.164.142c.28.207.525.576 1.016 1.312L20.5 17.5"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 9.5v-5m10 5v-5M3 17V7m18 0v10M17.02 4.51c1.602.359 2.815.88 3.461 1.486s.69 1.266.126 1.881c-.565.615-1.707 1.154-3.26 1.536s-3.433.588-5.363.587s-3.808-.21-5.356-.593c-1.549-.384-2.686-.924-3.244-1.54s-.507-1.275.145-1.88c.653-.606 1.872-1.126 3.478-1.483"></svg:path><svg:path stroke="currentColor" stroke-width="2" d="M21 17c0 .796-.948 1.559-2.636 2.121S14.387 20 12 20s-4.676-.316-6.364-.879S3 17.796 3 17"></svg:path></svg:g>`,
})
export class LetsIconsImgRolFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsImgRolLightIcon],svg[lets-icons-img-rol-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="m3.5 18l2.46-2.684c1.276-1.391 1.913-2.087 2.69-2.154a2 2 0 0 1 .567.032c.764.154 1.319.918 2.429 2.444l.375.515c.22.303.33.455.449.544a1 1 0 0 0 1.13.051c.127-.079.25-.22.497-.501c.534-.61.801-.916 1.07-1.078a2 2 0 0 1 2.35.21c.235.207.443.555.86 1.25L19.5 18.5"></svg:path><svg:path stroke-linecap="round" d="M6.5 8.5V5m11 3.5V5m-15 12V7m19 0v10M17.507 4.963c1.64.307 2.868.743 3.505 1.246c.637.502.65 1.045.04 1.55c-.611.505-1.816.945-3.44 1.258s-3.584.482-5.597.483c-2.013 0-3.975-.167-5.602-.478c-1.628-.312-2.838-.751-3.455-1.255c-.618-.505-.61-1.047.02-1.55c.631-.504 1.853-.94 3.49-1.25"></svg:path><svg:path d="M21.5 17c0 .663-1 1.299-2.782 1.768S14.52 19.5 12 19.5s-4.936-.263-6.718-.732C3.501 18.298 2.5 17.663 2.5 17"></svg:path></svg:g>`,
})
export class LetsIconsImgRolLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsInIcon],svg[lets-icons-in-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 9v6c0 2.828 0 4.243.879 5.121C4.757 21 6.172 21 9 21h6c2.828 0 4.243 0 5.121-.879C21 19.243 21 17.828 21 15V9c0-2.828 0-4.243-.879-5.121C19.243 3 17.828 3 15 3H9"></svg:path><svg:path fill="currentColor" d="M15 15v1h1v-1zM7.707 6.293a1 1 0 0 0-1.414 1.414zM14 8v7h2V8zm1 6H8v2h7zm.707.293l-8-8l-1.414 1.414l8 8z"></svg:path></svg:g>`,
})
export class LetsIconsInIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsInfoLightIcon],svg[lets-icons-info-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M13.737 21.848a10.002 10.002 0 0 0 6.697-15.221a10 10 0 1 0-6.698 15.221Z"></svg:path><svg:path stroke-linecap="square" d="M12 12v6m0-11V6"></svg:path></svg:g>`,
})
export class LetsIconsInfoLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsInstaIcon],svg[lets-icons-insta-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-width="2" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle><svg:circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="2"></svg:circle></svg:g>`,
})
export class LetsIconsInstaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsInstaFillIcon],svg[lets-icons-insta-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13zm15-3.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0M14 13a2 2 0 1 1-4 0a2 2 0 0 1 4 0m2 0a4 4 0 1 1-8 0a4 4 0 0 1 8 0" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsInstaFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsInstaLightIcon],svg[lets-icons-insta-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M3 11c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3h2c3.771 0 5.657 0 6.828 1.172S21 7.229 21 11v2c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13z"></svg:path><svg:circle cx="16.5" cy="7.5" r="1.5" fill="currentColor"></svg:circle><svg:circle cx="12" cy="12" r="3.5" stroke="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsInstaLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsItoDuotoneIcon],svg[lets-icons-ito-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.2"><svg:path fill="currentColor" fill-opacity=".25" d="M5.6 7A1.4 1.4 0 0 1 7 5.6h8A3.4 3.4 0 0 1 18.4 9v8a1.4 1.4 0 0 1-1.4 1.4H7A1.4 1.4 0 0 1 5.6 17z"></svg:path><svg:path d="M9 6V2m0 20v-4m6 4v-4m7-3h-4M6 15H2m4-6H2m13-6.4A6.4 6.4 0 0 1 21.4 9"></svg:path></svg:g>`,
})
export class LetsIconsItoDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsItoLightIcon],svg[lets-icons-ito-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M5.5 7A1.5 1.5 0 0 1 7 5.5h8A3.5 3.5 0 0 1 18.5 9v8a1.5 1.5 0 0 1-1.5 1.5H7A1.5 1.5 0 0 1 5.5 17zM9 6V2m0 20v-4m6 4v-4m7-3h-4M6 15H2m4-6H2m13-6c1.864 0 2.796 0 3.53.304a4 4 0 0 1 2.165 2.165C21 6.204 21 7.136 21 9"></svg:path>`,
})
export class LetsIconsItoLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsJsonIcon],svg[lets-icons-json-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="M14 19h2a2 2 0 0 0 2-2v-2.438a2 2 0 0 1 1.515-1.94l1.515-.38c.252-.063.252-.421 0-.485l-1.515-.378A2 2 0 0 1 18 9.439V5h-4m-4 0H8a2 2 0 0 0-2 2v2.438a2 2 0 0 1-1.515 1.94l-1.515.38c-.252.063-.252.421 0 .485l1.515.378A2 2 0 0 1 6 14.561V19h4"></svg:path>`,
})
export class LetsIconsJsonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsKeyAltFillIcon],svg[lets-icons-key-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M3 7c0-1.4 0-2.1.272-2.635a2.5 2.5 0 0 1 1.093-1.093C4.9 3 5.6 3 7 3h10c1.4 0 2.1 0 2.635.272a2.5 2.5 0 0 1 1.092 1.093C21 4.9 21 5.6 21 7v10c0 1.4 0 2.1-.273 2.635a2.5 2.5 0 0 1-1.092 1.092C19.1 21 18.4 21 17 21H7c-1.4 0-2.1 0-2.635-.273a2.5 2.5 0 0 1-1.093-1.092C3 19.1 3 18.4 3 17zm7.83 4a3.001 3.001 0 1 0 0 2H13v1a1 1 0 1 0 2 0v-1h1v1a1 1 0 1 0 2 0v-1.85A1.15 1.15 0 0 0 16.85 11zM9 12a1 1 0 1 0-2 0a1 1 0 0 0 2 0" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsKeyAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsKeyFillIcon],svg[lets-icons-key-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLableIcon],svg[lets-icons-lable-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLableLightIcon],svg[lets-icons-lable-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M3 8c0-.943 0-1.414.293-1.707S4.057 6 5 6h10.93c.524 0 .786 0 1.007.118c.22.119.366.337.657.773l2.666 4c.359.537.538.806.538 1.109s-.18.572-.538 1.11l-2.666 4c-.29.435-.436.653-.657.772c-.221.118-.483.118-1.007.118H5c-.943 0-1.414 0-1.707-.293S3 16.943 3 16z"></svg:path><svg:circle cx="15" cy="12" r="1" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsLableLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLampIcon],svg[lets-icons-lamp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLampDuotoneLineIcon],svg[lets-icons-lamp-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsLampDuotoneLine0"><svg:mask id="letsIconsLampDuotoneLine1" fill="#fff"><svg:path fill-rule="evenodd" d="M15 15.5c0-.103.056-.2.148-.246a7 7 0 1 0-6.296 0A.27.27 0 0 1 9 15.5v3a2.5 2.5 0 0 0 2.5 2.5h1a2.5 2.5 0 0 0 2.5-2.5z" clip-rule="evenodd"></svg:path></svg:mask><svg:g fill="none"><svg:path stroke="silver" stroke-linecap="round" stroke-opacity=".25" d="M11 13V9.75c0-.69-.56-1.25-1.25-1.25v0c-.69 0-1.25.56-1.25 1.25v0c0 .69.56 1.25 1.25 1.25h4.5c.69 0 1.25-.56 1.25-1.25v0c0-.69-.56-1.25-1.25-1.25v0c-.69 0-1.25.56-1.25 1.25V13"></svg:path><svg:circle cx="12" cy="9" r="6.5" stroke="silver" stroke-opacity=".25"></svg:circle><svg:path fill="#fff" d="m8.852 15.254l-.45.893zm6.296 0l-.45-.893zM18 9a6 6 0 0 1-3.302 5.361l.9 1.786A8 8 0 0 0 20 9zm-6-6a6 6 0 0 1 6 6h2a8 8 0 0 0-8-8zM6 9a6 6 0 0 1 6-6V1a8 8 0 0 0-8 8zm3.302 5.361A6 6 0 0 1 6 9H4a8 8 0 0 0 4.402 7.147zM10 18.5v-3H8v3zm1.5 1.5a1.5 1.5 0 0 1-1.5-1.5H8a3.5 3.5 0 0 0 3.5 3.5zm1 0h-1v2h1zm1.5-1.5a1.5 1.5 0 0 1-1.5 1.5v2a3.5 3.5 0 0 0 3.5-3.5zm0-3v3h2v-3zm-5.598.647A.73.73 0 0 1 8 15.5h2c0-.457-.248-.912-.698-1.139zm6.296-1.786c-.45.227-.698.682-.698 1.139h2c0 .25-.136.513-.402.647z" mask="url(#letsIconsLampDuotoneLine1)"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsLampDuotoneLine0)"></svg:path>`,
})
export class LetsIconsLampDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLampLightIcon],svg[lets-icons-lamp-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="m10.211 20.106l-.223.447zm-1.067-4.42l-.462.19zm-.226-.452l-.395.306zm6.164 0l.395.306zM17.5 10c0 1.8-.865 3.4-2.204 4.403l.6.8A6.49 6.49 0 0 0 18.5 10zM12 4.5a5.5 5.5 0 0 1 5.5 5.5h1A6.5 6.5 0 0 0 12 3.5zM6.5 10A5.5 5.5 0 0 1 12 4.5v-1A6.5 6.5 0 0 0 5.5 10zm2.204 4.403A5.49 5.49 0 0 1 6.5 10h-1a6.49 6.49 0 0 0 2.604 5.203zm1.793 5.35a11.8 11.8 0 0 0-.891-4.258l-.924.382c.51 1.234.788 2.556.816 3.897zm3.068-.095a3.5 3.5 0 0 1-3.13 0l-.447.895a4.5 4.5 0 0 0 4.024 0zm.83-4.163a11.8 11.8 0 0 0-.892 4.259l1 .02c.027-1.341.305-2.663.815-3.897zm-.383 5.058a.89.89 0 0 0 .49-.779l-1-.02a.11.11 0 0 1 .063-.096zm-4.514-.779a.89.89 0 0 0 .49.779l.447-.895a.11.11 0 0 1 .062.095zm-1.394-4.57c.318.238.39.297.42.336l.79-.613c-.135-.174-.353-.33-.61-.524zm1.502.29c-.087-.21-.16-.396-.292-.567l-.79.613c.032.042.054.086.158.337zm5.69-1.09c-.257.192-.475.35-.61.523l.79.613c.03-.039.101-.098.42-.337zm.022 1.473c.104-.251.126-.295.159-.337l-.79-.613c-.133.171-.206.358-.293.568z"></svg:path><svg:path stroke="currentColor" d="M14.5 16.5a6.73 6.73 0 0 1-5 0"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" d="M11 14V9.75c0-.69-.56-1.25-1.25-1.25v0c-.69 0-1.25.56-1.25 1.25v0c0 .69.56 1.25 1.25 1.25h4.5c.69 0 1.25-.56 1.25-1.25v0c0-.69-.56-1.25-1.25-1.25v0c-.69 0-1.25.56-1.25 1.25V14"></svg:path></svg:g>`,
})
export class LetsIconsLampLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLayersDuotoneIcon],svg[lets-icons-layers-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-linejoin="round" stroke-width="1.2" d="M12 4L5 7l7 3l7-3z"></svg:path><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M10.834 9.5L12 10l1.166-.5L19 12l-7 3l-7-3z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m10.834 9.5l.236-.552a.6.6 0 0 0-.473 0zM12 10l-.236.551a.6.6 0 0 0 .472 0zm1.166-.5l.237-.552a.6.6 0 0 0-.473 0zM19 12l.236.552a.6.6 0 0 0 0-1.104zm-7 3l-.236.552a.6.6 0 0 0 .472 0zm-7-3l-.236-.552a.6.6 0 0 0 0 1.104zm5.597-1.949l1.167.5l.472-1.103l-1.166-.5zm1.64.5l1.166-.5l-.473-1.103l-1.166.5zm7 .897l-5.834-2.5l-.473 1.103l5.834 2.5zm-7 4.104l7-3l-.473-1.104l-7 3zm-7.473-3l7 3l.472-1.104l-7-3zm5.833-3.604l-5.833 2.5l.472 1.104l5.834-2.5z"></svg:path><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M10.833 14.5L12 15l1.167-.5L19 17l-7 3l-7-3z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m10.833 14.5l.237-.552a.6.6 0 0 0-.473 0zM12 15l-.236.552a.6.6 0 0 0 .472 0zm1.167-.5l.236-.552a.6.6 0 0 0-.473 0zM19 17l.236.552a.6.6 0 0 0 0-1.104zm-7 3l-.236.552a.6.6 0 0 0 .472 0zm-7-3l-.236-.552a.6.6 0 0 0 0 1.104zm5.597-1.948l1.167.5l.472-1.104l-1.166-.5zm1.64.5l1.166-.5l-.473-1.104l-1.166.5zm7 .896l-5.834-2.5l-.473 1.104l5.834 2.5zm-7 4.104l7-3l-.473-1.104l-7 3zm-7.473-3l7 3l.472-1.104l-7-3zm5.833-3.604l-5.833 2.5l.472 1.104l5.834-2.5z"></svg:path>`,
})
export class LetsIconsLayersDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLayersFillIcon],svg[lets-icons-layers-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.106 3.447L5.789 6.106c-.78.39-1.171.585-1.171.894s.39.504 1.17.894l5.318 2.659c.438.22.658.329.894.329s.456-.11.894-.33l5.317-2.658c.78-.39 1.171-.585 1.171-.894s-.39-.504-1.17-.894l-5.318-2.659c-.438-.22-.658-.329-.894-.329s-.456.11-.894.33"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M7.022 10.49c.604.323 1.315.679 2.134 1.088l1.055.528c.878.439 1.317.658 1.79.658c.471 0 .91-.219 1.788-.658l1.056-.528c.818-.409 1.53-.764 2.133-1.089l1.233.617c.78.39 1.171.585 1.171.894s-.39.504-1.17.895l-5.317 2.658c-.44.22-.659.33-.895.33s-.455-.11-.894-.33l-5.317-2.658c-.78-.39-1.17-.586-1.17-.895s.39-.504 1.17-.894z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M7.022 15.49c.604.323 1.315.68 2.134 1.088l1.055.528c.878.44 1.317.659 1.79.659c.471 0 .91-.22 1.788-.659l1.056-.528c.818-.409 1.53-.764 2.134-1.089l1.232.617c.78.39 1.171.585 1.171.894s-.39.504-1.17.895l-5.317 2.658c-.44.22-.659.329-.895.329s-.455-.11-.894-.33l-5.317-2.657c-.78-.39-1.17-.586-1.17-.895s.39-.504 1.17-.894z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsLayersFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningIcon],svg[lets-icons-lightning-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningAltIcon],svg[lets-icons-lightning-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningAltDuotoneIcon],svg[lets-icons-lightning-alt-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsLightningAltDuotone0"><svg:g fill="none"><svg:path fill="#fff" d="m10.415 18.923l.465-2.325c.056-.277.083-.415.008-.506S10.672 16 10.39 16H8.883c-.391 0-.587 0-.659-.127s.029-.294.23-.63l2.092-3.486c.201-.335.302-.503.23-.63s-.268-.127-.66-.127H7.723c-.328 0-.492 0-.567-.108c-.074-.107-.017-.26.098-.568l2.625-7c.06-.156.089-.235.153-.28C10.096 3 10.18 3 10.348 3h4.77c.391 0 .587 0 .659.127s-.029.295-.23.63l-2.092 3.486c-.201.335-.302.503-.23.63s.268.127.66.127H15c.436 0 .655 0 .724.138s-.062.313-.324.662l-1.8 2.4c-.262.35-.393.524-.324.662c.07.138.288.138.724.138h1.978c.444 0 .667 0 .735.14c.069.14-.068.316-.34.667L11.3 19.328c-.514.662-.771.992-.951.91s-.098-.493.066-1.315"></svg:path><svg:path stroke="silver" stroke-linecap="round" stroke-linejoin="round" stroke-opacity=".25" d="M18.5 4L17 6h2l-1.5 2m-11 8L5 18h2l-1.5 2"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsLightningAltDuotone0)"></svg:path>`,
})
export class LetsIconsLightningAltDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningAltDuotoneLineIcon],svg[lets-icons-lightning-alt-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsLightningAltDuotoneLine0"><svg:g fill="none"><svg:path stroke="#fff" d="m10.646 18.633l.682-2.501c.079-.29.118-.436.043-.534s-.225-.098-.526-.098H8.902c-.399 0-.598 0-.67-.129c-.071-.129.035-.298.246-.636l1.544-2.47c.211-.338.317-.507.246-.636s-.271-.129-.67-.129H7.194c-.317 0-.475 0-.55-.104s-.025-.254.075-.554l2.667-8c.055-.165.083-.248.148-.295s.152-.047.326-.047h5.757c.391 0 .587 0 .659.127s-.029.295-.23.63l-2.092 3.486c-.201.335-.302.503-.23.63s.268.127.66.127H15.5c.436 0 .654 0 .724.138s-.062.313-.324.662l-1.8 2.4c-.262.35-.393.524-.324.662c.07.138.288.138.724.138h1.968c.449 0 .673 0 .741.141s-.07.317-.348.669l-5.34 6.764c-.592.749-.887 1.123-1.07 1.031c-.182-.092-.056-.552.195-1.472Z"></svg:path><svg:path stroke="silver" stroke-linecap="round" stroke-linejoin="round" stroke-opacity=".25" d="M19.5 4L18 6h2l-1.5 2m-12 8L5 18h2l-1.5 2"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsLightningAltDuotoneLine0)"></svg:path>`,
})
export class LetsIconsLightningAltDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningAltFillIcon],svg[lets-icons-lightning-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m10.415 18.923l.465-2.325c.056-.277.083-.415.008-.506S10.672 16 10.39 16H8.883c-.391 0-.587 0-.659-.127s.029-.294.23-.63l2.092-3.486c.201-.335.302-.503.23-.63s-.268-.127-.66-.127H7.723c-.328 0-.492 0-.567-.108c-.074-.107-.017-.26.098-.568l2.625-7c.06-.156.089-.235.153-.28C10.096 3 10.18 3 10.348 3h4.77c.391 0 .587 0 .659.127s-.029.295-.23.63l-2.092 3.486c-.201.335-.302.503-.23.63s.268.127.66.127H15c.436 0 .655 0 .724.138s-.062.313-.324.662l-1.8 2.4c-.262.35-.393.524-.324.662c.07.138.288.138.724.138h1.978c.444 0 .667 0 .735.14c.069.14-.068.316-.34.667L11.3 19.328c-.514.662-.771.992-.951.91s-.098-.493.066-1.315"></svg:path>`,
})
export class LetsIconsLightningAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningAltLightIcon],svg[lets-icons-lightning-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningDuotoneIcon],svg[lets-icons-lightning-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:mask id="letsIconsLightningDuotone0"><svg:g fill="none"><svg:path fill="#fff" d="m9.556 13.323l-.12-.01c-1.528-.14-2.292-.209-2.535-.732c-.242-.522.198-1.15 1.077-2.407l3.583-5.119c.581-.83.872-1.245 1.123-1.157c.25.089.216.594.15 1.605l-.204 3.049c-.062.92-.092 1.38.172 1.69c.265.31.724.351 1.642.435l.12.01c1.528.14 2.292.209 2.535.732c.242.522-.198 1.15-1.078 2.407l-3.582 5.119c-.581.83-.872 1.245-1.123 1.157c-.25-.089-.216-.594-.15-1.605l.204-3.049c.062-.92.092-1.38-.172-1.69c-.265-.31-.724-.351-1.642-.435"></svg:path><svg:path stroke="silver" stroke-linecap="round" stroke-linejoin="round" stroke-opacity=".25" d="M18.5 4L17 6h2l-1.5 2m-11 8L5 18h2l-1.5 2"></svg:path></svg:g></svg:mask></svg:defs><svg:path fill="currentColor" d="M0 0h24v24H0z" mask="url(#letsIconsLightningDuotone0)"></svg:path>`,
})
export class LetsIconsLightningDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningFillIcon],svg[lets-icons-lightning-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10m-1.87-8.2h1.37c.236 0 .354 0 .427.073s.073.191.073.427v4.43c0 .89 0 1.336.196 1.38c.197.042.383-.362.758-1.17l2.731-5.9c.592-1.278.888-1.917.593-2.378s-1-.462-2.408-.462H12.5c-.236 0-.354 0-.427-.073S12 9.936 12 9.7V5.27c0-.89 0-1.336-.196-1.38c-.197-.042-.383.362-.758 1.17l-2.731 5.9c-.592 1.278-.888 1.917-.593 2.378s1 .462 2.408.462" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsLightningFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningLightIcon],svg[lets-icons-lightning-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningRingIcon],svg[lets-icons-lightning-ring-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" d="M11.5 13.8h-1.063c-1.53 0-2.294 0-2.583-.497s.088-1.162.844-2.491l2.367-4.167c.375-.66.563-.99.749-.94c.186.049.186.428.186 1.187V9.7c0 .236 0 .354.073.427s.191.073.427.073h1.063c1.53 0 2.294 0 2.583.497s-.088 1.162-.844 2.491l-2.367 4.167c-.375.66-.563.99-.749.94C12 18.247 12 17.868 12 17.109V14.3c0-.236 0-.354-.073-.427s-.191-.073-.427-.073"></svg:path><svg:circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2"></svg:circle></svg:g>`,
})
export class LetsIconsLightningRingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningRingDuotoneIcon],svg[lets-icons-lightning-ring-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M12 21a9 9 0 1 0 0-18a9 9 0 0 0 0 18m-1.563-7.2H11.5c.236 0 .354 0 .427.073s.073.191.073.427v2.808c0 .759 0 1.139.186 1.188s.374-.281.749-.941l2.367-4.167c.756-1.33 1.133-1.994.844-2.491s-1.054-.497-2.583-.497H12.5c-.236 0-.354 0-.427-.073S12 9.936 12 9.7V6.892c0-.759 0-1.138-.186-1.188c-.186-.049-.374.281-.749.941l-2.367 4.167c-.756 1.33-1.133 1.994-.844 2.491s1.054.497 2.583.497" clip-rule="evenodd"></svg:path><svg:path stroke="currentColor" stroke-width="1.2" d="M11.5 13.8h-1.063c-1.53 0-2.294 0-2.583-.497s.088-1.162.844-2.491l2.367-4.167c.375-.66.563-.99.749-.94c.186.049.186.428.186 1.187V9.7c0 .236 0 .354.073.427s.191.073.427.073h1.063c1.53 0 2.294 0 2.583.497s-.088 1.162-.844 2.491l-2.367 4.167c-.375.66-.563.99-.749.94C12 18.247 12 17.868 12 17.109V14.3c0-.236 0-.354-.073-.427s-.191-.073-.427-.073Z"></svg:path><svg:circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.2"></svg:circle></svg:g>`,
})
export class LetsIconsLightningRingDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLightningRingDuotoneLineIcon],svg[lets-icons-lightning-ring-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsLightningRingDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineIcon],svg[lets-icons-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineDuotoneIcon],svg[lets-icons-line-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.2"><svg:path fill="currentColor" fill-opacity=".25" d="M9 15v3c0 .943 0 1.414-.293 1.707S7.943 20 7 20H6c-.943 0-1.414 0-1.707-.293S4 18.943 4 18v-1c0-.943 0-1.414.293-1.707S5.057 15 6 15zm6-6V6c0-.943 0-1.414.293-1.707S16.057 4 17 4h1c.943 0 1.414 0 1.707.293S20 5.057 20 6v1c0 .943 0 1.414-.293 1.707S18.943 9 18 9z"></svg:path><svg:path d="m15 9l-6 6"></svg:path></svg:g>`,
})
export class LetsIconsLineDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineFillIcon],svg[lets-icons-line-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path fill="currentColor" d="M9 15v3c0 .943 0 1.414-.293 1.707S7.943 20 7 20H6c-.943 0-1.414 0-1.707-.293S4 18.943 4 18v-1c0-.943 0-1.414.293-1.707S5.057 15 6 15zm6-6V6c0-.943 0-1.414.293-1.707S16.057 4 17 4h1c.943 0 1.414 0 1.707.293S20 5.057 20 6v1c0 .943 0 1.414-.293 1.707S18.943 9 18 9z"></svg:path><svg:path d="m15 9l-6 6"></svg:path></svg:g>`,
})
export class LetsIconsLineFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineInIcon],svg[lets-icons-line-in-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-width="2" d="M15 9V6c0-.943 0-1.414.293-1.707S16.057 4 17 4h1c.943 0 1.414 0 1.707.293S20 5.057 20 6v1c0 .943 0 1.414-.293 1.707S18.943 9 18 9zM9 20H4v-5m0 5L15 9"></svg:path>`,
})
export class LetsIconsLineInIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineInAltLightIcon],svg[lets-icons-line-in-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:rect width="6" height="6" x="15" y="9" rx="2" transform="rotate(-90 15 9)"></svg:rect><svg:path d="m6 21l-3-4l3-4"></svg:path><svg:path d="M3 17h7c3.771 0 5.657 0 6.828-1.172S18 12.771 18 9"></svg:path></svg:g>`,
})
export class LetsIconsLineInAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineOutAltLightIcon],svg[lets-icons-line-out-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:rect width="6" height="6" x="9" y="15" rx="2" transform="rotate(90 9 15)"></svg:rect><svg:path d="m18 3l3 4l-3 4"></svg:path><svg:path d="M21 7h-7c-3.771 0-5.657 0-6.828 1.172S6 11.229 6 15"></svg:path></svg:g>`,
})
export class LetsIconsLineOutAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineOutLightIcon],svg[lets-icons-line-out-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M9 15v3c0 .943 0 1.414-.293 1.707S7.943 20 7 20H6c-.943 0-1.414 0-1.707-.293S4 18.943 4 18v-1c0-.943 0-1.414.293-1.707S5.057 15 6 15zm6-11h5v5m0-5L9 15"></svg:path>`,
})
export class LetsIconsLineOutLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLineUpIcon],svg[lets-icons-line-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><svg:path stroke-linejoin="round" d="m21 6l-5.293 5.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 0-1.414 0L7 14"></svg:path><svg:path d="M3 3v14.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C4.52 21 5.08 21 6.2 21H21"></svg:path></svg:g>`,
})
export class LetsIconsLineUpIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLinkAltIcon],svg[lets-icons-link-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><svg:path d="m5.251 9.663l-1.587-1.41a1 1 0 1 0-1.328 1.494l1.405 1.25l.068-.062c.503-.446.982-.873 1.442-1.272m2.295 4.642q.544.436 1.04.777c1.117.763 2.185 1.228 3.414 1.228s2.297-.465 3.413-1.228c1.081-.739 2.306-1.828 3.843-3.194l.052-.046l2.356-2.095a1 1 0 0 0-1.328-1.494l-2.357 2.094c-1.6 1.423-2.731 2.426-3.694 3.084c-.94.642-1.613.88-2.285.88s-1.345-.238-2.285-.88q-.304-.21-.636-.465c-.446.378-.949.82-1.533 1.339"></svg:path><svg:path d="M16.455 9.695q-.545-.436-1.042-.777C14.297 8.155 13.23 7.689 12 7.689s-2.297.466-3.413 1.229c-1.081.738-2.306 1.828-3.843 3.193l-.052.047l-2.356 2.094a1 1 0 1 0 1.328 1.495l2.357-2.094c1.6-1.423 2.731-2.426 3.694-3.084c.94-.642 1.613-.88 2.285-.88s1.345.238 2.285.88q.304.21.636.464c.446-.377.949-.82 1.534-1.338m3.804 3.308l-.068.061q-.753.672-1.442 1.273l1.587 1.41a1 1 0 0 0 1.328-1.495z"></svg:path></svg:g>`,
})
export class LetsIconsLinkAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLinkLightIcon],svg[lets-icons-link-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10 16H7a4 4 0 0 1-4-4v0a4 4 0 0 1 4-4h3m6 4H8m6 4h3a4 4 0 0 0 4-4v0a4 4 0 0 0-4-4h-3"></svg:path>`,
})
export class LetsIconsLinkLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLoadCircleFillIcon],svg[lets-icons-load-circle-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="m7.086 13.07l-1.702-1.363a7 7 0 1 0 13.232 0l-1.702 1.362q.085.454.086.93a5 5 0 1 1-9.914-.93" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m12 13l-.625.78l.625.5l.625-.5zm1-9a1 1 0 1 0-2 0zM6.375 9.78l5 4l1.25-1.56l-5-4zm6.25 4l5-4l-1.25-1.56l-5 4zM13 13V4h-2v9z"></svg:path>`,
})
export class LetsIconsLoadCircleFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLoadCircleLightIcon],svg[lets-icons-load-circle-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M5.239 14.812a7 7 0 0 0 13.523 0"></svg:path><svg:path fill="currentColor" d="m12 13l-.312.39l.312.25l.312-.25zm.5-9a.5.5 0 0 0-1 0zM6.688 9.39l5 4l.624-.78l-5-4zm5.624 4l5-4l-.624-.78l-5 4zM12.5 13V4h-1v9z"></svg:path></svg:g>`,
})
export class LetsIconsLoadCircleLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLoadListFillIcon],svg[lets-icons-load-list-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M3 4h18"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M19 4H5v11.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C6.52 19 7.08 19 8.2 19h7.6c1.12 0 1.68 0 2.108-.218a2 2 0 0 0 .874-.874C19 17.48 19 16.92 19 15.8zm-8 11v-3.586l-1.293 1.293a1 1 0 0 1-1.414-1.414l2.894-2.894q.027-.027.057-.053a.998.998 0 0 1 1.512 0q.03.026.057.053l2.894 2.894a1 1 0 0 1-1.414 1.414L13 11.414V15a1 1 0 1 1-2 0" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class LetsIconsLoadListFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockIcon],svg[lets-icons-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockAltIcon],svg[lets-icons-lock-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:path d="M4 13c0-1.886 0-2.828.586-3.414S6.114 9 8 9h8c1.886 0 2.828 0 3.414.586S20 11.114 20 13v2c0 2.828 0 4.243-.879 5.121C18.243 21 16.828 21 14 21h-4c-2.828 0-4.243 0-5.121-.879C4 19.243 4 17.828 4 15z"></svg:path><svg:path stroke-linecap="round" d="M16 8V7a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v1"></svg:path></svg:g>`,
})
export class LetsIconsLockAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockAltDuotoneIcon],svg[lets-icons-lock-alt-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" d="M4.5 13.5c0-1.886 0-2.828.586-3.414S6.614 9.5 8.5 9.5h7c1.886 0 2.828 0 3.414.586s.586 1.528.586 3.414v1c0 2.828 0 4.243-.879 5.121c-.878.879-2.293.879-5.121.879h-3c-2.828 0-4.243 0-5.121-.879C4.5 18.743 4.5 17.328 4.5 14.5z"></svg:path><svg:path stroke="currentColor" d="M16.5 9.5V8a4.5 4.5 0 0 0-9 0v1.5"></svg:path></svg:g>`,
})
export class LetsIconsLockAltDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockAltDuotoneLineIcon],svg[lets-icons-lock-alt-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path fill="currentColor" fill-opacity=".25" d="M4.5 13.5c0-1.886 0-2.828.586-3.414S6.614 9.5 8.5 9.5h7c1.886 0 2.828 0 3.414.586s.586 1.528.586 3.414v1c0 2.828 0 4.243-.879 5.121c-.878.879-2.293.879-5.121.879h-3c-2.828 0-4.243 0-5.121-.879C4.5 18.743 4.5 17.328 4.5 14.5z"></svg:path><svg:path stroke-linecap="round" d="M16.5 9.5V8A4.5 4.5 0 0 0 12 3.5v0A4.5 4.5 0 0 0 7.5 8v1.5"></svg:path></svg:g>`,
})
export class LetsIconsLockAltDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockAltFillIcon],svg[lets-icons-lock-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 8V7a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v1"></svg:path><svg:path fill="currentColor" d="M3 13c0-2.828 0-4.243.879-5.121C4.757 7 6.172 7 9 7h6c2.828 0 4.243 0 5.121.879C21 8.757 21 10.172 21 13v1c0 3.771 0 5.657-1.172 6.828S16.771 22 13 22h-2c-3.771 0-5.657 0-6.828-1.172S3 17.771 3 14z"></svg:path></svg:g>`,
})
export class LetsIconsLockAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockAltLightIcon],svg[lets-icons-lock-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M4.5 13.5c0-1.886 0-2.828.586-3.414S6.614 9.5 8.5 9.5h7c1.886 0 2.828 0 3.414.586s.586 1.528.586 3.414v1c0 2.828 0 4.243-.879 5.121c-.878.879-2.293.879-5.121.879h-3c-2.828 0-4.243 0-5.121-.879C4.5 18.743 4.5 17.328 4.5 14.5z"></svg:path><svg:path stroke-linecap="round" d="M16.5 9.5V8A4.5 4.5 0 0 0 12 3.5v0A4.5 4.5 0 0 0 7.5 8v1.5"></svg:path></svg:g>`,
})
export class LetsIconsLockAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockDuotoneLineIcon],svg[lets-icons-lock-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-width="1.2" d="M4 13c0-1.886 0-2.828.586-3.414S6.114 9 8 9h8c1.886 0 2.828 0 3.414.586S20 11.114 20 13v2c0 2.828 0 4.243-.879 5.121C18.243 21 16.828 21 14 21h-4c-2.828 0-4.243 0-5.121-.879C4 19.243 4 17.828 4 15z"></svg:path><svg:path stroke="currentColor" stroke-linecap="round" stroke-width="1.2" d="M16 8V7a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v1"></svg:path><svg:circle cx="12" cy="15" r="2" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsLockDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLockLightIcon],svg[lets-icons-lock-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsLolLightIcon],svg[lets-icons-lol-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:circle cx="12" cy="12" r="9.5" stroke="currentColor" stroke-linecap="round"></svg:circle><svg:circle cx="9" cy="10" r="1" fill="currentColor" stroke="currentColor" stroke-linecap="round"></svg:circle><svg:circle cx="15" cy="10" r="1" fill="currentColor" stroke="currentColor" stroke-linecap="round"></svg:circle><svg:path fill="currentColor" fill-rule="evenodd" d="M8.629 15c-.28 0-.42 0-.494.107s-.032.225.055.461C8.706 16.978 10.217 18 12 18s3.294-1.021 3.81-2.432c.087-.236.13-.354.055-.461c-.074-.107-.214-.107-.494-.107z" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class LetsIconsLolLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMapDuotoneIcon],svg[lets-icons-map-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M17.608 21L15.134 7.81L4 8.822V17.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C5.52 21 6.08 21 7.2 21zM13.5 15.03c0 2.158-2.14 3.674-3.073 4.233a.83.83 0 0 1-.854 0C8.64 18.704 6.5 17.188 6.5 15.029c0-2.117 1.696-3.529 3.5-3.529c1.867 0 3.5 1.412 3.5 3.53" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-opacity=".25" d="M4.218 4.092C4 4.52 4 5.08 4 6.2v.614l17.99-1.636c-.019-.488-.07-.814-.208-1.086a2 2 0 0 0-.874-.874C20.48 3 19.92 3 18.8 3H7.2c-1.12 0-1.68 0-2.108.218a2 2 0 0 0-.874.874M22 7.186l-4.865.442l2.506 13.367c.592-.013.963-.058 1.267-.213a2 2 0 0 0 .874-.874C22 19.48 22 18.92 22 17.8z"></svg:path><svg:circle cx="10" cy="15" r="1" fill="currentColor"></svg:circle>`,
})
export class LetsIconsMapDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMapFillIcon],svg[lets-icons-map-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMapLightIcon],svg[lets-icons-map-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" stroke-linecap="round" d="M2.5 5.7c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.02 2.5 4.58 2.5 5.7 2.5h12.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874c.218.428.218.988.218 2.108v12.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874c-.428.218-.988.218-2.108.218H5.7c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C2.5 19.98 2.5 19.42 2.5 18.3z"></svg:path><svg:path stroke="currentColor" d="M12.5 15.03c0 2.158-2.14 3.674-3.073 4.233a.83.83 0 0 1-.854 0C7.64 18.704 5.5 17.188 5.5 15.029C5.5 12.912 7.196 11.5 9 11.5c1.867 0 3.5 1.412 3.5 3.53Zm6 6.47l-6-15m9-2l-19 4"></svg:path><svg:circle cx="9" cy="15" r="1" fill="currentColor"></svg:circle></svg:g>`,
})
export class LetsIconsMapLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMaterialsIcon],svg[lets-icons-materials-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><svg:path d="m3 7l7-4l11 4M3 7v5l11 4l7-4V7M3 7l11 4l7-4"></svg:path><svg:path d="M3 12v5l11 4l7-4v-5"></svg:path></svg:g>`,
})
export class LetsIconsMaterialsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageIcon],svg[lets-icons-message-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:rect width="16" height="12" x="4" y="6" rx="2"></svg:rect><svg:path d="m4 9l7.106 3.553a2 2 0 0 0 1.788 0L20 9"></svg:path></svg:g>`,
})
export class LetsIconsMessageIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageAltDuotoneLineIcon],svg[lets-icons-message-alt-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="16" height="12" x="4" y="6" fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-width="1.2" rx="2"></svg:rect><svg:path fill="currentColor" d="M11.106 12.553L4 9v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-7.106 3.553a2 2 0 0 1-1.788 0"></svg:path>`,
})
export class LetsIconsMessageAltDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageAltFillIcon],svg[lets-icons-message-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M3.013 9.151C3 9.691 3 10.302 3 11v2c0 2.828 0 4.243.879 5.121C4.757 19 6.172 19 9 19h6c2.828 0 4.243 0 5.121-.879C21 17.243 21 15.828 21 13v-2c0-.698 0-1.31-.013-1.849l-8.016 4.453a2 2 0 0 1-1.942 0zm.23-2.121q.125.03.243.096L12 11.856l8.514-4.73q.119-.065.243-.096c-.13-.474-.33-.845-.636-1.151C19.243 5 17.828 5 15 5H9c-2.828 0-4.243 0-5.121.879c-.307.306-.506.677-.636 1.15" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsMessageAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageAltLightIcon],svg[lets-icons-message-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:rect width="16" height="12" x="4" y="6" stroke="currentColor" rx="2"></svg:rect><svg:path fill="currentColor" d="M11.106 12.553L4 9v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-7.106 3.553a2 2 0 0 1-1.788 0"></svg:path></svg:g>`,
})
export class LetsIconsMessageAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageOpenDuotoneIcon],svg[lets-icons-message-open-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" d="M4 11.472c0-1.203 0-1.804.299-2.287c.298-.484.836-.753 1.912-1.29l4-2c.878-.44 1.317-.659 1.789-.659s.911.22 1.789.658l4 2c1.076.538 1.614.807 1.912 1.29c.299.484.299 1.085.299 2.288V15c0 1.886 0 2.828-.586 3.414S17.886 19 16 19H8c-1.886 0-2.828 0-3.414-.586S4 16.886 4 15z"></svg:path><svg:path fill="currentColor" d="M4 17v-6.757a.15.15 0 0 1 .217-.135l6.441 3.221a3 3 0 0 0 2.684 0l6.44-3.22a.15.15 0 0 1 .218.134V17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2"></svg:path>`,
})
export class LetsIconsMessageOpenDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageOpenDuotoneLineIcon],svg[lets-icons-message-open-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.2"><svg:path d="M4 10.472c0-1.203 0-1.804.299-2.287c.298-.484.836-.753 1.912-1.29l4-2c.878-.44 1.317-.659 1.789-.659s.911.22 1.789.658l4 2c1.076.538 1.614.807 1.912 1.29C20 8.669 20 9.27 20 10.473V16c0 1.886 0 2.828-.586 3.414S17.886 20 16 20H8c-1.886 0-2.828 0-3.414-.586S4 17.886 4 16z"></svg:path><svg:path fill="currentColor" fill-opacity=".25" stroke-linecap="round" d="M6.414 13.414L4 11v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7l-2.414 2.414a2 2 0 0 1-1.414.586H7.828a2 2 0 0 1-1.414-.586Z"></svg:path></svg:g>`,
})
export class LetsIconsMessageOpenDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageOpenFillIcon],svg[lets-icons-message-open-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M3 10.415V15c0 2.828 0 4.243.879 5.121C4.757 21 6.172 21 9 21h6c2.828 0 4.243 0 5.121-.879C21 19.243 21 17.828 21 15v-4.585l-1.707 1.706a3 3 0 0 1-2.121.88H6.828a3 3 0 0 1-2.12-.88zm.237-2.592l2.884 2.884a1 1 0 0 0 .707.293h10.344a1 1 0 0 0 .707-.293l2.884-2.884a2.3 2.3 0 0 0-.248-.508c-.484-.746-1.349-1.13-3.078-1.899l-3.812-1.694c-.8-.356-1.2-.533-1.625-.533c-.424 0-.825.177-1.625.533L6.563 5.416c-1.73.769-2.594 1.153-3.078 1.899a2.3 2.3 0 0 0-.248.508" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsMessageOpenFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMessageOpenLightIcon],svg[lets-icons-message-open-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M4 10.472c0-1.203 0-1.804.299-2.287c.298-.484.836-.753 1.912-1.29l4-2c.878-.44 1.317-.659 1.789-.659s.911.22 1.789.658l4 2c1.076.538 1.614.807 1.912 1.29C20 8.669 20 9.27 20 10.473V16c0 1.886 0 2.828-.586 3.414S17.886 20 16 20H8c-1.886 0-2.828 0-3.414-.586S4 17.886 4 16z"></svg:path><svg:path stroke-linecap="round" d="m4 10l2.414 2.414A2 2 0 0 0 7.828 13h8.344a2 2 0 0 0 1.414-.586L20 10"></svg:path></svg:g>`,
})
export class LetsIconsMessageOpenLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMicAltIcon],svg[lets-icons-mic-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><svg:rect width="12" height="16" x="6" y="3" rx="6"></svg:rect><svg:path stroke-linecap="round" d="M12 22v-3m-2-6H7m11 0h-2m-6-4H7m11 0h-2"></svg:path></svg:g>`,
})
export class LetsIconsMicAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMicAltLightIcon],svg[lets-icons-mic-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round"><svg:rect width="12" height="16" x="6" y="3" rx="6"></svg:rect><svg:path stroke-linecap="round" d="M12 22v-3m-2-6H7m11 0h-2m-6-4H7m11 0h-2"></svg:path></svg:g>`,
})
export class LetsIconsMicAltLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonIcon],svg[lets-icons-moon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonAltIcon],svg[lets-icons-moon-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonAltDuotoneIcon],svg[lets-icons-moon-alt-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M11.94 5.213C11.846 5.149 11.886 5 12 5a7 7 0 1 1-.565 13.978c-1.093-.088-1.64-.131-1.72-.492c-.08-.36.529-.707 1.746-1.4A7 7 0 0 0 15 11a7 7 0 0 0-3.06-5.787" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m11.435 18.978l.048-.599zm-1.72-.492l.586-.13zM11.94 5.213l.339-.496zM18.4 12A6.4 6.4 0 0 0 12 5.6V4.4a7.6 7.6 0 0 1 7.6 7.6zM12 18.4a6.4 6.4 0 0 0 6.4-6.4h1.2a7.6 7.6 0 0 1-7.6 7.6zm-.517-.02q.256.02.517.02v1.2q-.309 0-.613-.024zm-.319-1.816a6.4 6.4 0 0 0 3.236-5.565h1.2c0 2.832-1.548 5.3-3.842 6.608zm3.236-5.565a6.4 6.4 0 0 0-2.798-5.29l.677-.992A7.6 7.6 0 0 1 15.6 11zm-3.013 8.577c-.524-.042-.99-.078-1.33-.158c-.321-.076-.806-.257-.927-.801l1.171-.261c-.04-.184-.212-.163.032-.106c.228.054.581.084 1.15.13zm.371-1.97c-.624.356-1.04.595-1.299.787a1 1 0 0 0-.182.16c-.001.002.013-.017.023-.056a.3.3 0 0 0 .001-.141l-1.171.26a.94.94 0 0 1 .16-.744c.12-.175.289-.32.454-.443c.33-.245.827-.527 1.42-.865zM12 5.6a.49.49 0 0 0 .47-.359a.48.48 0 0 0-.191-.524l-.677.992a.72.72 0 0 1-.288-.785A.71.71 0 0 1 12 4.4z"></svg:path><svg:path fill="currentColor" fill-opacity=".25" stroke="currentColor" stroke-width="1.2" d="M5.4 10.2c.101.304.152.456.203.523a.5.5 0 0 0 .794 0c.05-.067.102-.219.203-.523c.082-.245.123-.368.176-.479a2 2 0 0 1 .945-.945c.111-.053.234-.094.479-.176c.304-.101.456-.152.523-.203a.5.5 0 0 0 0-.794c-.067-.05-.219-.102-.523-.203c-.245-.082-.368-.123-.479-.176a2 2 0 0 1-.945-.945A4 4 0 0 1 6.6 5.8c-.101-.304-.152-.456-.203-.522a.5.5 0 0 0-.794 0c-.05.066-.102.218-.203.522a4 4 0 0 1-.176.479a2 2 0 0 1-.945.945A4 4 0 0 1 3.8 7.4c-.304.101-.456.152-.522.203a.5.5 0 0 0 0 .794c.066.05.218.102.522.203c.245.082.368.123.479.176a2 2 0 0 1 .945.945c.053.111.094.234.176.479Z"></svg:path>`,
})
export class LetsIconsMoonAltDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonAltFillIcon],svg[lets-icons-moon-alt-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.625 5.01Q11.812 5 12 5a7 7 0 1 1-3.625 12.99a7 7 0 0 0 3.25-12.98M5.4 10.2c.101.304.152.456.203.523a.5.5 0 0 0 .794 0c.05-.067.102-.219.203-.523c.082-.245.123-.368.176-.479a2 2 0 0 1 .945-.945c.111-.053.234-.094.479-.176c.304-.101.456-.152.523-.203a.5.5 0 0 0 0-.794c-.067-.05-.219-.102-.523-.203c-.245-.082-.368-.123-.479-.176a2 2 0 0 1-.945-.945A4 4 0 0 1 6.6 5.8c-.101-.304-.152-.456-.203-.522a.5.5 0 0 0-.794 0c-.05.066-.102.218-.203.522a4 4 0 0 1-.176.479a2 2 0 0 1-.945.945A4 4 0 0 1 3.8 7.4c-.304.101-.456.152-.522.203a.5.5 0 0 0 0 .794c.066.05.218.102.522.203c.245.082.368.123.479.176a2 2 0 0 1 .945.945c.053.111.094.234.176.479"></svg:path>`,
})
export class LetsIconsMoonAltFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonAltLightIcon],svg[lets-icons-moon-alt-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonDuotoneIcon],svg[lets-icons-moon-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-opacity=".25" fill-rule="evenodd" d="M15 4c.292 0 .438 0 .578.042a1 1 0 0 1 .586 1.448c-.072.127-.29.338-.725.759A7.98 7.98 0 0 0 13 12c0 2.257.935 4.297 2.439 5.751c.435.421.653.632.725.76a1 1 0 0 1-.586 1.447C15.438 20 15.292 20 15 20a8 8 0 1 1 0-16" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="m16.164 18.51l.523-.294zm-.586 1.448l-.172-.575zm-.14-13.709l.418.431zm.726-.76l.523.295zm-.586-1.447l-.172.575zM13.6 12c0-2.088.864-3.974 2.256-5.32l-.834-.862A8.58 8.58 0 0 0 12.4 12zm2.256 5.32A7.38 7.38 0 0 1 13.6 12h-1.2a8.58 8.58 0 0 0 2.622 6.182zM15 19.4A7.4 7.4 0 0 1 7.6 12H6.4a8.6 8.6 0 0 0 8.6 8.6zM7.6 12A7.4 7.4 0 0 1 15 4.6V3.4A8.6 8.6 0 0 0 6.4 12zm7.422 6.182c.22.214.376.364.486.477c.122.126.14.159.133.145l1.046-.588a2 2 0 0 0-.319-.393q-.19-.194-.512-.503zM15 20.6c.258 0 .507.006.75-.067l-.344-1.15c-.037.011-.08.017-.406.017zm.64-1.796a.4.4 0 0 1-.234.58l.344 1.15a1.6 1.6 0 0 0 .937-2.318zm.216-12.124q.323-.31.512-.503c.114-.116.24-.252.319-.393l-1.046-.588c.007-.014-.011.02-.133.145c-.11.113-.265.263-.486.477zM15 4.6c.326 0 .37.006.406.017l.344-1.15c-.243-.073-.492-.067-.75-.067zm1.687 1.184a1.6 1.6 0 0 0-.937-2.317l-.344 1.15a.4.4 0 0 1 .235.579z"></svg:path>`,
})
export class LetsIconsMoonDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoonLightIcon],svg[lets-icons-moon-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m16.164 18.51l.436-.245zm-.586 1.448l-.143-.479zm-.14-13.709l.348.36zm.726-.76l.436.246zm-.586-1.447l-.143.479zM13.5 12c0-2.116.876-4.027 2.287-5.392l-.696-.718A8.48 8.48 0 0 0 12.5 12zm2.287 5.392A7.48 7.48 0 0 1 13.5 12h-1c0 2.398.994 4.566 2.591 6.11zM15 19.5A7.5 7.5 0 0 1 7.5 12h-1a8.5 8.5 0 0 0 8.5 8.5zM7.5 12A7.5 7.5 0 0 1 15 4.5v-1A8.5 8.5 0 0 0 6.5 12zm7.591 6.11c.22.213.377.365.488.48c.122.124.15.166.149.165l.872-.49a2 2 0 0 0-.304-.373q-.186-.19-.51-.5zM15 20.5c.264 0 .495.005.721-.063l-.286-.958c-.054.016-.115.021-.435.021zm.728-1.745a.5.5 0 0 1-.293.724l.286.958a1.5 1.5 0 0 0 .879-2.172zm.059-12.147q.323-.31.51-.5c.114-.118.23-.245.303-.373l-.872-.49s-.027.04-.149.166c-.11.114-.268.266-.488.479zM15 4.5c.32 0 .38.005.435.02l.286-.957c-.226-.068-.457-.063-.721-.063zm1.6 1.235a1.5 1.5 0 0 0-.879-2.172l-.286.958a.5.5 0 0 1 .293.724z"></svg:path>`,
})
export class LetsIconsMoonLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMouseIcon],svg[lets-icons-mouse-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"><svg:path d="M5 10.8c0-2.619 0-3.928.59-4.89a4 4 0 0 1 1.32-1.32C7.872 4 9.181 4 11.8 4h.4c2.619 0 3.928 0 4.89.59a4 4 0 0 1 1.32 1.32c.59.962.59 2.271.59 4.89V14c0 .929 0 1.393-.051 1.783a6 6 0 0 1-5.166 5.166C13.393 21 12.93 21 12 21s-1.393 0-1.783-.051a6 6 0 0 1-5.166-5.166C5 15.393 5 14.93 5 14z"></svg:path><svg:path stroke-linecap="round" d="M12 4v5"></svg:path></svg:g>`,
})
export class LetsIconsMouseIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMouseLightIcon],svg[lets-icons-mouse-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round"><svg:path d="M5 10.8c0-2.619 0-3.928.59-4.89a4 4 0 0 1 1.32-1.32C7.872 4 9.181 4 11.8 4h.4c2.619 0 3.928 0 4.89.59a4 4 0 0 1 1.32 1.32c.59.962.59 2.271.59 4.89V14c0 .929 0 1.393-.051 1.783a6 6 0 0 1-5.166 5.166C13.393 21 12.93 21 12 21s-1.393 0-1.783-.051a6 6 0 0 1-5.166-5.166C5 15.393 5 14.93 5 14z"></svg:path><svg:path stroke-linecap="round" d="M12 4v5"></svg:path></svg:g>`,
})
export class LetsIconsMouseLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoveIcon],svg[lets-icons-move-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m12 3l.625-.78l-.625-.5l-.625.5zm-1 6a1 1 0 1 0 2 0zm5.625-3.58l-4-3.2l-1.25 1.56l4 3.2zm-5.25-3.2l-4 3.2l1.25 1.56l4-3.2zM11 3v6h2V3zm10 9l.78.625l.5-.625l-.5-.625zm-6-1a1 1 0 1 0 0 2zm3.58 5.625l3.2-4l-1.56-1.25l-3.2 4zm3.2-5.25l-3.2-4l-1.56 1.25l3.2 4zM21 11h-6v2h6zm-9 10l.625.78l-.625.5l-.625-.5zm-1-6a1 1 0 1 1 2 0zm5.625 3.58l-4 3.2l-1.25-1.56l4-3.2zm-5.25 3.2l-4-3.2l1.25-1.56l4 3.2zM11 21v-6h2v6zm-8-9l-.78.625l-.5-.625l.5-.625zm6-1a1 1 0 1 1 0 2zm-3.58 5.625l-3.2-4l1.56-1.25l3.2 4zm-3.2-5.25l3.2-4l1.56 1.25l-3.2 4zM3 11h6v2H3z"></svg:path>`,
})
export class LetsIconsMoveIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoveAltIcon],svg[lets-icons-move-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMoveAltAltIcon],svg[lets-icons-move-alt-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m12 3l.365-.342l-.365-.39l-.365.39zm-.5 6a.5.5 0 0 0 1 0zm3.865-3.142l-3-3.2l-.73.684l3 3.2zm-3.73-3.2l-3 3.2l.73.684l3-3.2zM11.5 3v6h1V3zm9.5 9l.342.365l.39-.365l-.39-.365zm-6-.5a.5.5 0 0 0 0 1zm3.142 3.865l3.2-3l-.684-.73l-3.2 3zm3.2-3.73l-3.2-3l-.684.73l3.2 3zM21 11.5h-6v1h6zM12 21l.365.342l-.365.39l-.365-.39zm-.5-6a.5.5 0 0 1 1 0zm3.865 3.142l-3 3.2l-.73-.684l3-3.2zm-3.73 3.2l-3-3.2l.73-.684l3 3.2zM11.5 21v-6h1v6zM3 12l-.342.365l-.39-.365l.39-.365zm6-.5a.5.5 0 0 1 0 1zm-3.142 3.865l-3.2-3l.684-.73l3.2 3zm-3.2-3.73l3.2-3l.684.73l-3.2 3zM3 11.5h6v1H3z"></svg:path>`,
})
export class LetsIconsMoveAltAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMusicIcon],svg[lets-icons-music-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMusicDuotoneIcon],svg[lets-icons-music-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMusicFillIcon],svg[lets-icons-music-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsMusicLightIcon],svg[lets-icons-music-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsMusicLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNavigateDuotoneIcon],svg[lets-icons-navigate-duotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.01 12.093c-.274-.195-.41-.293-.546-.305a.5.5 0 0 0-.335.091c-.11.08-.179.233-.315.54l-3.039 6.837c-.243.548-.365.822-.313.998a.5.5 0 0 0 .31.33c.173.062.454-.044 1.015-.254l5.932-2.225c.104-.039.156-.058.21-.066a.5.5 0 0 1 .143 0c.053.008.105.027.209.066l5.932 2.225c.561.21.842.316 1.015.253a.5.5 0 0 0 .31-.329c.052-.176-.07-.45-.313-.998l-3.039-6.837c-.136-.307-.204-.46-.315-.54a.5.5 0 0 0-.335-.09c-.136.011-.272.109-.546.304l-2.409 1.72a1 1 0 0 1-1.162 0z"></svg:path><svg:path fill="currentColor" fill-opacity=".25" d="M9.061 9.613a.06.06 0 0 0 .02.074l2.454 1.752c.167.12.251.18.342.203a.5.5 0 0 0 .246 0c.091-.023.175-.083.342-.203l2.454-1.752a.06.06 0 0 0 .02-.074L12.73 4.645c-.231-.52-.347-.781-.508-.861a.5.5 0 0 0-.445 0c-.162.08-.277.34-.509.861z"></svg:path>`,
})
export class LetsIconsNavigateDuotoneIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNavigateFillIcon],svg[lets-icons-navigate-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M9.01 12.093c-.274-.195-.41-.293-.546-.305a.5.5 0 0 0-.335.091c-.11.08-.179.233-.315.54l-3.039 6.837c-.243.548-.365.822-.313.998a.5.5 0 0 0 .31.33c.173.062.454-.044 1.015-.254l5.932-2.225c.104-.039.156-.058.21-.066a.5.5 0 0 1 .143 0c.053.008.105.027.209.066l5.932 2.225c.561.21.842.316 1.015.253a.5.5 0 0 0 .31-.329c.052-.176-.07-.45-.313-.998l-3.039-6.837c-.136-.307-.204-.46-.315-.54a.5.5 0 0 0-.335-.09c-.136.011-.272.109-.546.304l-2.409 1.72a1 1 0 0 1-1.162 0zm.051-2.48a.06.06 0 0 0 .02.073l2.454 1.753c.167.12.251.18.342.202a.5.5 0 0 0 .246 0c.091-.023.175-.082.342-.202l2.454-1.753a.06.06 0 0 0 .02-.074L12.73 4.645c-.232-.521-.347-.782-.509-.862a.5.5 0 0 0-.444 0c-.162.08-.277.34-.51.862z" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsNavigateFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNestingIcon],svg[lets-icons-nesting-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:rect width="4" height="4" x="18" y="15" rx="2" transform="rotate(90 18 15)"></svg:rect><svg:rect width="4" height="4" x="6" y="8" rx="2" transform="rotate(-90 6 8)"></svg:rect><svg:path d="M8 8v5c0 1.886 0 2.828.586 3.414S10.114 17 12 17h2"></svg:path></svg:g>`,
})
export class LetsIconsNestingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNestingFillIcon],svg[lets-icons-nesting-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="2"><svg:rect width="4" height="4" x="18" y="15" fill="currentColor" rx="2" transform="rotate(90 18 15)"></svg:rect><svg:rect width="4" height="4" x="6" y="8" fill="currentColor" rx="2" transform="rotate(-90 6 8)"></svg:rect><svg:path d="M8 8v5c0 1.886 0 2.828.586 3.414S10.114 17 12 17h2"></svg:path></svg:g>`,
})
export class LetsIconsNestingFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNestingLightIcon],svg[lets-icons-nesting-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:rect width="4" height="4" x="18" y="15" rx="2" transform="rotate(90 18 15)"></svg:rect><svg:rect width="4" height="4" x="6" y="8" rx="2" transform="rotate(-90 6 8)"></svg:rect><svg:path d="M8 8v5c0 1.886 0 2.828.586 3.414S10.114 17 12 17h2"></svg:path></svg:g>`,
})
export class LetsIconsNestingLightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNewsDuotoneLineIcon],svg[lets-icons-news-duotone-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LetsIconsNewsDuotoneLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[letsIconsNfcFillIcon],svg[lets-icons-nfc-fill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10M8.669 7.938a.6.6 0 0 0-.633-.537a.597.597 0 0 0-.635.573a8.6 8.6 0 0 0 .151 8.326a.6.6 0 1 0 1.04-.6a7.4 7.4 0 0 1-.484-6.395l4.223 6.757a.6.6 0 0 0 .633.537a.597.597 0 0 0 .636-.573a8.6 8.6 0 0 0-.152-8.326a.6.6 0 1 0-1.04.6a7.4 7.4 0 0 1 .484 6.395zM16.007 6.8a.6.6 0 1 1 1.039-.6a11.6 11.6 0 0 1 0 11.6a.6.6 0 1 1-1.04-.6a10.4 10.4 0 0 0 0-10.4" clip-rule="evenodd"></svg:path>`,
})
export class LetsIconsNfcFillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
