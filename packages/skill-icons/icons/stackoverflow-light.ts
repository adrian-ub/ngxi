...
@Component({
  standalone: true,
  selector: 'svg[skillIconsStackoverflowLightIcon],svg[skill-icons-stackoverflow-light-icon]',
  host: {
    role: 'img',
