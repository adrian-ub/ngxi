...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForNauruIcon],svg[emojione-monotone-flag-for-nauru-icon]',
  host: {
    role: 'img',
