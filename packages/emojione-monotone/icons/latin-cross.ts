...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneLatinCrossIcon],svg[emojione-monotone-latin-cross-icon]',
  host: {
    role: 'img',
