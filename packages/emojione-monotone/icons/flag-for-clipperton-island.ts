...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForClippertonIslandIcon],svg[emojione-monotone-flag-for-clipperton-island-icon]',
  host: {
    role: 'img',
...
export class EmojioneMonotoneFlagForClippertonIslandIcon {
