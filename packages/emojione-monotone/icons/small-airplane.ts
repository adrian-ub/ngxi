...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneSmallAirplaneIcon],svg[emojione-monotone-small-airplane-icon]',
  host: {
    role: 'img',
