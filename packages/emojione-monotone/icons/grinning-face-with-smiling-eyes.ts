...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneGrinningFaceWithSmilingEyesIcon],svg[emojione-monotone-grinning-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
