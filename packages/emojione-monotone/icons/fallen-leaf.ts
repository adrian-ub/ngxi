...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFallenLeafIcon],svg[emojione-monotone-fallen-leaf-icon]',
  host: {
    role: 'img',
