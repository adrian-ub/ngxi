...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneHighHeeledShoeIcon],svg[emojione-monotone-high-heeled-shoe-icon]',
  host: {
    role: 'img',
