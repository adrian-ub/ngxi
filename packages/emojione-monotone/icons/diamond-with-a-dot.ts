...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneDiamondWithADotIcon],svg[emojione-monotone-diamond-with-a-dot-icon]',
  host: {
    role: 'img',
