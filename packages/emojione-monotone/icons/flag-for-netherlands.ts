...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForNetherlandsIcon],svg[emojione-monotone-flag-for-netherlands-icon]',
  host: {
    role: 'img',
...
export class EmojioneMonotoneFlagForNetherlandsIcon {
