...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneBeamingFaceWithSmilingEyesIcon],svg[emojione-monotone-beaming-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
