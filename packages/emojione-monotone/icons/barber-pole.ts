...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneBarberPoleIcon],svg[emojione-monotone-barber-pole-icon]',
  host: {
    role: 'img',
