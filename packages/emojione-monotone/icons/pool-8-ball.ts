...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotonePool8BallIcon],svg[emojione-monotone-pool-8-ball-icon]',
  host: {
    role: 'img',
