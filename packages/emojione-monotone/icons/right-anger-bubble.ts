...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneRightAngerBubbleIcon],svg[emojione-monotone-right-anger-bubble-icon]',
  host: {
    role: 'img',
