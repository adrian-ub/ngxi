...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneSportsMedalIcon],svg[emojione-monotone-sports-medal-icon]',
  host: {
    role: 'img',
