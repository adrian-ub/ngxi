...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneDoubleCurlyLoopIcon],svg[emojione-monotone-double-curly-loop-icon]',
  host: {
    role: 'img',
