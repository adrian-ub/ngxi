...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneConstructionIcon],svg[emojione-monotone-construction-icon]',
  host: {
    role: 'img',
