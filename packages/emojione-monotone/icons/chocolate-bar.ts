...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneChocolateBarIcon],svg[emojione-monotone-chocolate-bar-icon]',
  host: {
    role: 'img',
