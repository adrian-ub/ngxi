...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneLevelSliderIcon],svg[emojione-monotone-level-slider-icon]',
  host: {
    role: 'img',
