...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneTelevisionIcon],svg[emojione-monotone-television-icon]',
  host: {
    role: 'img',
