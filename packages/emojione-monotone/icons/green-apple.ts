...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneGreenAppleIcon],svg[emojione-monotone-green-apple-icon]',
  host: {
    role: 'img',
