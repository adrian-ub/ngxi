...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneGrinningSquintingFaceIcon],svg[emojione-monotone-grinning-squinting-face-icon]',
  host: {
    role: 'img',
