...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneOncomingFistIcon],svg[emojione-monotone-oncoming-fist-icon]',
  host: {
    role: 'img',
