...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneDerelictHouseIcon],svg[emojione-monotone-derelict-house-icon]',
  host: {
    role: 'img',
