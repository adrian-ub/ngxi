...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForUnitedKingdomIcon],svg[emojione-monotone-flag-for-united-kingdom-icon]',
  host: {
    role: 'img',
...
export class EmojioneMonotoneFlagForUnitedKingdomIcon {
