...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForEuropeanUnionIcon],svg[emojione-monotone-flag-for-european-union-icon]',
  host: {
    role: 'img',
