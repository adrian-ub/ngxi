...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotonePeaceSymbolIcon],svg[emojione-monotone-peace-symbol-icon]',
  host: {
    role: 'img',
