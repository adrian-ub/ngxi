...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneYellowHeartIcon],svg[emojione-monotone-yellow-heart-icon]',
  host: {
    role: 'img',
