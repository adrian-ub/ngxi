...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneFlagForSierraLeoneIcon],svg[emojione-monotone-flag-for-sierra-leone-icon]',
  host: {
    role: 'img',
...
export class EmojioneMonotoneFlagForSierraLeoneIcon {
