...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneDigitThreeIcon],svg[emojione-monotone-digit-three-icon]',
  host: {
    role: 'img',
