...
@Component({
  standalone: true,
  selector: 'svg[emojioneMonotoneStraightRulerIcon],svg[emojione-monotone-straight-ruler-icon]',
  host: {
    role: 'img',
