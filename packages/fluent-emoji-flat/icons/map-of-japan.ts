...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatMapOfJapanIcon],svg[fluent-emoji-flat-map-of-japan-icon]',
  host: {
    role: 'img',
