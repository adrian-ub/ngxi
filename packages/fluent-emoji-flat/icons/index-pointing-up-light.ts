...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatIndexPointingUpLightIcon],svg[fluent-emoji-flat-index-pointing-up-light-icon]',
  host: {
    role: 'img',
