...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsIcon],svg[fluent-emoji-flat-flexed-biceps-icon]',
  host: {
    role: 'img',
