...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatEarMediumDarkIcon],svg[fluent-emoji-flat-ear-medium-dark-icon]',
  host: {
    role: 'img',
