...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFirecrackerIcon],svg[fluent-emoji-flat-firecracker-icon]',
  host: {
    role: 'img',
