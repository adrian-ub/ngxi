...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatThumbsUpMediumIcon],svg[fluent-emoji-flat-thumbs-up-medium-icon]',
  host: {
    role: 'img',
