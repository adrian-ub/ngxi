...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFallenLeafIcon],svg[fluent-emoji-flat-fallen-leaf-icon]',
  host: {
    role: 'img',
