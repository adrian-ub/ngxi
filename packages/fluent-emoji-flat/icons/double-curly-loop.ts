...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatDoubleCurlyLoopIcon],svg[fluent-emoji-flat-double-curly-loop-icon]',
  host: {
    role: 'img',
