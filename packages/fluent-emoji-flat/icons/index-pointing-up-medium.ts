...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatIndexPointingUpMediumIcon],svg[fluent-emoji-flat-index-pointing-up-medium-icon]',
  host: {
    role: 'img',
