...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsMediumIcon],svg[fluent-emoji-flat-flexed-biceps-medium-icon]',
  host: {
    role: 'img',
