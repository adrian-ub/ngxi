...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatJapanesePassingGradeButtonIcon],svg[fluent-emoji-flat-japanese-passing-grade-button-icon]',
  host: {
    role: 'img',
