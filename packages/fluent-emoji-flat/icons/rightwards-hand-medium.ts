...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatRightwardsHandMediumIcon],svg[fluent-emoji-flat-rightwards-hand-medium-icon]',
  host: {
    role: 'img',
