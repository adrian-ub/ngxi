...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatIndexPointingUpDarkIcon],svg[fluent-emoji-flat-index-pointing-up-dark-icon]',
  host: {
    role: 'img',
