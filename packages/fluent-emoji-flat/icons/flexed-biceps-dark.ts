...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsDarkIcon],svg[fluent-emoji-flat-flexed-biceps-dark-icon]',
  host: {
    role: 'img',
