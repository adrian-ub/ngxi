...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatSpeakingHeadIcon],svg[fluent-emoji-flat-speaking-head-icon]',
  host: {
    role: 'img',
