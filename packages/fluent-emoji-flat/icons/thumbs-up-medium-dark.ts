...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatThumbsUpMediumDarkIcon],svg[fluent-emoji-flat-thumbs-up-medium-dark-icon]',
  host: {
    role: 'img',
