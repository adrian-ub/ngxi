...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatGlobeShowingEuropeAfricaIcon],svg[fluent-emoji-flat-globe-showing-europe-africa-icon]',
  host: {
    role: 'img',
