...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFreeButtonIcon],svg[fluent-emoji-flat-free-button-icon]',
  host: {
    role: 'img',
