...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatGlobeWithMeridiansIcon],svg[fluent-emoji-flat-globe-with-meridians-icon]',
  host: {
    role: 'img',
