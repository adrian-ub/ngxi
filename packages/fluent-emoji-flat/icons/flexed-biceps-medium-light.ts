...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsMediumLightIcon],svg[fluent-emoji-flat-flexed-biceps-medium-light-icon]',
  host: {
    role: 'img',
