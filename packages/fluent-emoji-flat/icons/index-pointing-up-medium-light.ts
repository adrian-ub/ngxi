...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatIndexPointingUpMediumLightIcon],svg[fluent-emoji-flat-index-pointing-up-medium-light-icon]',
  host: {
    role: 'img',
