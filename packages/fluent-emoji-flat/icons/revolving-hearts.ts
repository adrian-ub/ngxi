...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatRevolvingHeartsIcon],svg[fluent-emoji-flat-revolving-hearts-icon]',
  host: {
    role: 'img',
