...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatExclamationQuestionMarkIcon],svg[fluent-emoji-flat-exclamation-question-mark-icon]',
  host: {
    role: 'img',
