...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatWheelOfDharmaIcon],svg[fluent-emoji-flat-wheel-of-dharma-icon]',
  host: {
    role: 'img',
