...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatRightFacingFistIcon],svg[fluent-emoji-flat-right-facing-fist-icon]',
  host: {
    role: 'img',
