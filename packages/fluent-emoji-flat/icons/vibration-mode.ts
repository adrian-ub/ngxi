...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatVibrationModeIcon],svg[fluent-emoji-flat-vibration-mode-icon]',
  host: {
    role: 'img',
