...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatBrightButtonIcon],svg[fluent-emoji-flat-bright-button-icon]',
  host: {
    role: 'img',
