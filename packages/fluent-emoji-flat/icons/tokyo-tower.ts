...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatTokyoTowerIcon],svg[fluent-emoji-flat-tokyo-tower-icon]',
  host: {
    role: 'img',
