...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatKeycapHashtagIcon],svg[fluent-emoji-flat-keycap-hashtag-icon]',
  host: {
    role: 'img',
