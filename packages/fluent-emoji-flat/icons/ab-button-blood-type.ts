...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatAbButtonBloodTypeIcon],svg[fluent-emoji-flat-ab-button-blood-type-icon]',
  host: {
    role: 'img',
