...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatThumbsUpMediumLightIcon],svg[fluent-emoji-flat-thumbs-up-medium-light-icon]',
  host: {
    role: 'img',
