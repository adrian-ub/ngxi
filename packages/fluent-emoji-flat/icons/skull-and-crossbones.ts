...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatSkullAndCrossbonesIcon],svg[fluent-emoji-flat-skull-and-crossbones-icon]',
  host: {
    role: 'img',
