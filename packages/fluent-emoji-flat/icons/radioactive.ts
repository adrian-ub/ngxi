...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatRadioactiveIcon],svg[fluent-emoji-flat-radioactive-icon]',
  host: {
    role: 'img',
