...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatIndexPointingUpMediumDarkIcon],svg[fluent-emoji-flat-index-pointing-up-medium-dark-icon]',
  host: {
    role: 'img',
