...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatOfficeBuildingIcon],svg[fluent-emoji-flat-office-building-icon]',
  host: {
    role: 'img',
