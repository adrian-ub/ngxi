...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatThumbsUpDarkIcon],svg[fluent-emoji-flat-thumbs-up-dark-icon]',
  host: {
    role: 'img',
