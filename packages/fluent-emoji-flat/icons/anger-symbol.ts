...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatAngerSymbolIcon],svg[fluent-emoji-flat-anger-symbol-icon]',
  host: {
    role: 'img',
