...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsLightIcon],svg[fluent-emoji-flat-flexed-biceps-light-icon]',
  host: {
    role: 'img',
