...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatLadyBeetleIcon],svg[fluent-emoji-flat-lady-beetle-icon]',
  host: {
    role: 'img',
