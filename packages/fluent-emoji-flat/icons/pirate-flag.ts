...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatPirateFlagIcon],svg[fluent-emoji-flat-pirate-flag-icon]',
  host: {
    role: 'img',
