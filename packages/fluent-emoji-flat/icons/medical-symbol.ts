...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatMedicalSymbolIcon],svg[fluent-emoji-flat-medical-symbol-icon]',
  host: {
    role: 'img',
