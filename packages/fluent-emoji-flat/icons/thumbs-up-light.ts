...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatThumbsUpLightIcon],svg[fluent-emoji-flat-thumbs-up-light-icon]',
  host: {
    role: 'img',
