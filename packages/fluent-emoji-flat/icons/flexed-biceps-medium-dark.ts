...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatFlexedBicepsMediumDarkIcon],svg[fluent-emoji-flat-flexed-biceps-medium-dark-icon]',
  host: {
    role: 'img',
