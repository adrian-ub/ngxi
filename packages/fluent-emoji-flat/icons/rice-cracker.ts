...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiFlatRiceCrackerIcon],svg[fluent-emoji-flat-rice-cracker-icon]',
  host: {
    role: 'img',
