...
@Component({
  standalone: true,
  selector: 'svg[fxemojiClockwiseleftrightarrowsIcon],svg[fxemoji-clockwiseleftrightarrows-icon]',
  host: {
    role: 'img',
