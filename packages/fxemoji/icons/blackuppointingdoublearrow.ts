...
@Component({
  standalone: true,
  selector: 'svg[fxemojiBlackuppointingdoublearrowIcon],svg[fxemoji-blackuppointingdoublearrow-icon]',
  host: {
    role: 'img',
