...
@Component({
  standalone: true,
  selector: 'svg[fxemojiExclaimationquestionmarkIcon],svg[fxemoji-exclaimationquestionmark-icon]',
  host: {
    role: 'img',
