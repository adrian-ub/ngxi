...
@Component({
  standalone: true,
  selector: 'svg[fxemojiBlackleftpointingdoublearrowIcon],svg[fxemoji-blackleftpointingdoublearrow-icon]',
  host: {
    role: 'img',
