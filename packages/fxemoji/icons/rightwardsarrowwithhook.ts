...
@Component({
  standalone: true,
  selector: 'svg[fxemojiRightwardsarrowwithhookIcon],svg[fxemoji-rightwardsarrowwithhook-icon]',
  host: {
    role: 'img',
