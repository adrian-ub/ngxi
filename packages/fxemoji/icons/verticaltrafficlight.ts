...
@Component({
  standalone: true,
  selector: 'svg[fxemojiVerticaltrafficlightIcon],svg[fxemoji-verticaltrafficlight-icon]',
  host: {
    role: 'img',
