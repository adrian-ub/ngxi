...
@Component({
  standalone: true,
  selector: 'svg[fxemojiBlackdownpointingdoublearrowIcon],svg[fxemoji-blackdownpointingdoublearrow-icon]',
  host: {
    role: 'img',
