...
@Component({
  standalone: true,
  selector: 'svg[fxemojiDownpointingsmallredtrisngleIcon],svg[fxemoji-downpointingsmallredtrisngle-icon]',
  host: {
    role: 'img',
