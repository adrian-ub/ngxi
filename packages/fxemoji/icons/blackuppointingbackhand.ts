...
@Component({
  standalone: true,
  selector: 'svg[fxemojiBlackuppointingbackhandIcon],svg[fxemoji-blackuppointingbackhand-icon]',
  host: {
    role: 'img',
