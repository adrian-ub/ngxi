...
@Component({
  standalone: true,
  selector: 'svg[eosIconsAbstractIncompleteIcon],svg[eos-icons-abstract-incomplete-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsAiIcon],svg[eos-icons-ai-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 11V9h-2V7a2.006 2.006 0 0 0-2-2h-2V3h-2v2h-2V3H9v2H7a2.006 2.006 0 0 0-2 2v2H3v2h2v2H3v2h2v2a2.006 2.006 0 0 0 2 2h2v2h2v-2h2v2h2v-2h2a2.006 2.006 0 0 0 2-2v-2h2v-2h-2v-2Zm-4 6H7V7h10Z"></svg:path><svg:path fill="currentColor" d="M11.361 8h-1.345l-2.01 8h1.027l.464-1.875h2.316L12.265 16h1.062Zm-1.729 5.324L10.65 8.95h.046l.983 4.374ZM14.244 8h1v8h-1z"></svg:path>`,
})
export class EosIconsAiIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsAiHealingIcon],svg[eos-icons-ai-healing-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 4h2v1h-2z"></svg:path><svg:circle cx="9" cy="4" r="1" fill="currentColor"></svg:circle><svg:circle cx="15" cy="4" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M18 10h-5V8l3-.01A3 3 0 0 0 19 5V3a3.01 3.01 0 0 0-3-3H8a3.01 3.01 0 0 0-3 3v2a3.01 3.01 0 0 0 3 3h3v2H6a3.01 3.01 0 0 0-3 3v8a3.01 3.01 0 0 0 3 3h12a3.01 3.01 0 0 0 3-3v-8a3.01 3.01 0 0 0-3-3M8 6a1.003 1.003 0 0 1-1-1V3a1.003 1.003 0 0 1 1-1h7.99A1.01 1.01 0 0 1 17 3v2a1.01 1.01 0 0 1-1.01 1Zm4.435 14.072L12 20.5l-.435-.432C10.02 18.541 9 17.534 9 16.298a1.71 1.71 0 0 1 1.65-1.798a1.74 1.74 0 0 1 1.35.683a1.74 1.74 0 0 1 1.35-.683A1.71 1.71 0 0 1 15 16.298c0 1.236-1.02 2.243-2.565 3.774"></svg:path>`,
})
export class EosIconsAiHealingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsAiHealingOutlinedIcon],svg[eos-icons-ai-healing-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsApiOutlinedIcon],svg[eos-icons-api-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.312 9H5.688L3.5 15h1.607l.446-1.226h1.894L7.893 15H9.5Zm-1.394 3.774L6.5 11.18l.582 1.595ZM14.744 9h-3.5v6h1.5v-2h2a1.473 1.473 0 0 0 1.5-1.5v-1a1.473 1.473 0 0 0-1.5-1.5m0 2.5h-2v-1h2ZM18 9h1.5v6H18z"></svg:path><svg:path fill="currentColor" d="M22 6v12H2V6zm0-2H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2"></svg:path>`,
})
export class EosIconsApiOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsApplicationInstanceOutlinedIcon],svg[eos-icons-application-instance-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1 3v2h22V3a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2m3 1a.987.987 0 0 1-.993-.992A1 1 0 0 1 4 2a1.013 1.013 0 0 1 1.006 1.008A1 1 0 0 1 4 4m3 0a1 1 0 1 1 1-1a1.004 1.004 0 0 1-1 1M1 6v14a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6Zm20 14H3V8h18Z"></svg:path><svg:path fill="currentColor" d="M9 10v8l7-4z"></svg:path>`,
})
export class EosIconsApplicationInstanceOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsApplicationOutlinedIcon],svg[eos-icons-application-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:defs><svg:path id="eosIconsApplicationOutlined0" fill="currentColor" d="m9 18l.7-.7l.7-.7l-1.3-1.3L7.8 14l1.3-1.3l1.3-1.3l-.7-.7L9 10l-2 2l-2 2l2 2zm4.6-1.4l.7.7l.7.7l2-2l2-2l-2-2l-2-2l-.7.7l-.7.7l1.3 1.3l1.3 1.3l-1.3 1.3z"></svg:path></svg:defs><svg:path fill="currentColor" d="M1 3v2h22V3a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2m3.007 1.008a1 1 0 1 1 .999-1a1 1 0 0 1-1 1m2.997-.001a1 1 0 1 1 1-1a1 1 0 0 1-1 1M1 6v14a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6Zm20 14H3V8h18Z"></svg:path><svg:use href="#eosIconsApplicationOutlined0"></svg:use><svg:use href="#eosIconsApplicationOutlined0"></svg:use>`,
})
export class EosIconsApplicationOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsApplicationWindowOutlinedIcon],svg[eos-icons-application-window-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1 3v2h22V3a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2m3 1a.987.987 0 0 1-.993-.992A1 1 0 0 1 4 2a1.013 1.013 0 0 1 1.006 1.008A1 1 0 0 1 4 4m3 0a1 1 0 1 1 1-1a1.004 1.004 0 0 1-1 1M1 6v14a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6Zm20 14H3V8h18Z"></svg:path>`,
})
export class EosIconsApplicationWindowOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsAtomElectronIcon],svg[eos-icons-atom-electron-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsBigDataIcon],svg[eos-icons-big-data-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.965 8a5.35 5.35 0 0 0-3.615-1.96a7.492 7.492 0 0 0-14-2A6 6 0 0 0 4 4.365A5.98 5.98 0 0 0 4 15.65V8h16v7.9a5 5 0 0 0 4-4.9a4.9 4.9 0 0 0-1.035-3M18.02 22.003c0 1.103-2.687 1.997-6 1.997s-6-.894-6-1.997v-1.996c0 1.102 2.686 1.996 6 1.996s6-.894 6-1.996"></svg:path><svg:path fill="currentColor" d="M12.02 16.684c-3.311 0-6-.898-6-1.996v3.964c0 1.099 2.689 1.997 6 1.997s6-.898 6-1.997v-3.964c0 1.098-2.69 1.996-6 1.996"></svg:path><svg:path fill="currentColor" d="M18.02 11.997c0-1.103-2.687-1.997-6-1.997s-6 .894-6 1.997v1.33c0 1.104 2.686 1.998 6 1.998s6-.894 6-1.997"></svg:path>`,
})
export class EosIconsBigDataIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsBigDataOutlinedIcon],svg[eos-icons-big-data-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsBlockchainIcon],svg[eos-icons-blockchain-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsBootstrappingOutlinedIcon],svg[eos-icons-bootstrapping-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.667 12c-12 0-9 9-9 9v3h18v-3s3-9-9-9m7 10h-14v-1h14Zm0-2h-14c-.243-1.937-.117-6 7-6s7.243 4.064 7 6M8 6h8v2H8zm1-3h6v2H9z"></svg:path><svg:path fill="currentColor" d="M12 0H3l1 13c1-1 2.033-2.5 8-2.5c5.97 0 7 1.5 8 2.5l1-13Zm6.308 9H5.692l-.538-7h13.692Z"></svg:path>`,
})
export class EosIconsBootstrappingOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsCloudControllerManagerIcon],svg[eos-icons-cloud-controller-manager-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9 10h8v2H9Zm15 0h-3V8h-2v6h2v-2h3ZM9 20h8v2H9Zm15 0h-3v-2h-2v6h2v-2h3Zm0-3h-8v-2h8ZM9 17h3v2h2v-6h-2v2H9Z"></svg:path><svg:path fill="currentColor" d="M19 6H7v10s-7 .17-7-6a6.07 6.07 0 0 1 1.235-4a6 6 0 0 1 4.459-1.99a5 5 0 0 1 .572-.99l.272-.36l.23-.26a4 4 0 0 1 .262-.29A6.9 6.9 0 0 1 12 0c.16 0 .362.01.513.02a7 7 0 0 1 3.756 1.39a9 9 0 0 1 .913.81A7.04 7.04 0 0 1 19 6"></svg:path>`,
})
export class EosIconsCloudControllerManagerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsClusterManagementIcon],svg[eos-icons-cluster-management-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1 1v10h22V1Zm12 6H4V5h9Zm3 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1m3 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1m3.69 11.37l1.14-1l-1-1.73l-1.45.49a3.7 3.7 0 0 0-1.08-.63L20 14h-2l-.3 1.49a3.7 3.7 0 0 0-1.08.63l-1.45-.49l-1 1.73l1.14 1a3.3 3.3 0 0 0 0 1.26l-1.14 1l1 1.73l1.45-.49a3.7 3.7 0 0 0 1.08.63L18 24h2l.3-1.49a3.7 3.7 0 0 0 1.08-.63l1.45.49l1-1.73l-1.14-1a3.4 3.4 0 0 0 0-1.27M19 21a2 2 0 1 1 2-2a2.006 2.006 0 0 1-2 2"></svg:path><svg:path fill="currentColor" d="M12 19H4v-2h8.294a7 7 0 0 1 3.114-4H1v10h12.26A6.96 6.96 0 0 1 12 19"></svg:path>`,
})
export class EosIconsClusterManagementIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsCodeDeployIcon],svg[eos-icons-code-deploy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21.95 9h-.27l-4.16 6.02l-.82-.57L20.47 9h-2.34a1.25 1.25 0 1 0-2.5 0h-.43l-1.25 4l-.95-.3L14.15 9h-.9a1.25 1.25 0 0 0-2.5 0h-.9L11 12.7l-.95.3L8.8 9h-.42a1.25 1.25 0 0 0-2.5 0H3.51l3.77 5.45l-.82.57L2.3 9h-.25a10 10 0 0 1 19.9 0"></svg:path><svg:path fill="currentColor" d="M11 15.405L9.586 14l-3.618 3.595L4.554 19l5.032 5L11 22.595L7.382 19zm2.021 7.19L14.435 24l3.618-3.595L19.467 19l-5.032-5l-1.414 1.405L16.639 19z"></svg:path>`,
})
export class EosIconsCodeDeployIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsCodeDeployOutlinedIcon],svg[eos-icons-code-deploy-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21.95 9a10 10 0 0 0-19.9 0h.248l4.162 6.016l.823-.57L3.514 9h2.362a1.25 1.25 0 0 1 2.5 0h.422l1.247 4l.955-.298L9.845 9h.906a1.25 1.25 0 1 1 2.5 0h.904L13 12.702l.955.298l1.247-4h.424a1.25 1.25 0 1 1 2.5 0h2.343L16.7 14.447l.822.569L21.685 9Zm-5.074-3.25a3.23 3.23 0 0 0-2.437 1.123a3.206 3.206 0 0 0-4.875 0a3.207 3.207 0 0 0-4.959.101a7.984 7.984 0 0 1 14.788-.004a3.23 3.23 0 0 0-2.517-1.22"></svg:path><svg:path fill="currentColor" d="M11 15.405L9.586 14l-3.618 3.595L4.554 19l5.032 5L11 22.595L7.382 19zm2.021 7.19L14.435 24l3.618-3.595L19.467 19l-5.032-5l-1.414 1.405L16.639 19z"></svg:path>`,
})
export class EosIconsCodeDeployOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsCollocationIcon],svg[eos-icons-collocation-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2m0 18H4V4h16Z"></svg:path><svg:path fill="currentColor" d="M7.51 18A2.5 2.5 0 0 0 10 16h4.1a2.5 2.5 0 1 0 2.45-3h-.05l-2.42-4.1a2.5 2.5 0 1 0-4.14 0L7.56 13a2.5 2.5 0 0 0 0 5Zm3.17-8.39a2.46 2.46 0 0 0 2.66 0l2.1 3.64A2.49 2.49 0 0 0 14.06 15H10a2.49 2.49 0 0 0-1.38-1.75Z"></svg:path>`,
})
export class EosIconsCollocationIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsConfigMapIcon],svg[eos-icons-config-map-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m10.822 13.34l-1.07-.83a4 4 0 0 0 .04-.49a2.6 2.6 0 0 0-.04-.49l1.06-.83a.26.26 0 0 0 .06-.32l-1-1.73a.254.254 0 0 0-.31-.11l-1.24.5a3.4 3.4 0 0 0-.85-.49l-.19-1.32a.24.24 0 0 0-.24-.21h-2a.26.26 0 0 0-.25.21l-.19 1.32a4 4 0 0 0-.85.49l-1.24-.5a.26.26 0 0 0-.31.11l-1 1.73a.25.25 0 0 0 .06.32l1.06.83a4 4 0 0 0 0 .98l-1.06.83a.26.26 0 0 0-.06.32l1 1.73a.254.254 0 0 0 .31.11l1.24-.5a3.4 3.4 0 0 0 .85.49l.19 1.32a.25.25 0 0 0 .25.21h2a.26.26 0 0 0 .25-.21l.19-1.32a3.7 3.7 0 0 0 .84-.49l1.25.5a.26.26 0 0 0 .31-.11l1-1.73a.26.26 0 0 0-.06-.32m-4.78.18a1.5 1.5 0 1 1 1.5-1.5a1.5 1.5 0 0 1-1.5 1.5M19.997.015h-4a1 1 0 0 0-.995 1L15 3H4.997v3.01l2.012.012v-1.01L14.999 5l-.002 4.015a1 1 0 0 0 .995 1h6.005a1.003 1.003 0 0 0 1-1v-6Zm-.5 3.5V.765l2.75 2.75Zm.501 10.494h-4a1 1 0 0 0-.995 1l-.002 4.01l-7.99.004v-1.01H5v3.01l10-.004l-.002 1.99a1 1 0 0 0 .995 1h6.005a1.003 1.003 0 0 0 1-1v-6Zm-.5 3.5v-2.75l2.75 2.75Z"></svg:path>`,
})
export class EosIconsConfigMapIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsConfigurationFileIcon],svg[eos-icons-configuration-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsConfigurationFileOutlinedIcon],svg[eos-icons-configuration-file-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m13.691 15.778l-.63-.49a2 2 0 0 0 .023-.288a1.6 1.6 0 0 0-.024-.289l.625-.49a.15.15 0 0 0 .036-.188l-.59-1.02a.15.15 0 0 0-.183-.065l-.73.295a2 2 0 0 0-.502-.289l-.112-.778a.14.14 0 0 0-.141-.124h-1.18a.15.15 0 0 0-.147.124l-.112.778a2.4 2.4 0 0 0-.5.29l-.732-.296a.154.154 0 0 0-.183.065l-.59 1.02a.146.146 0 0 0 .036.189l.625.49a2.4 2.4 0 0 0 0 .577l-.625.49a.15.15 0 0 0-.035.188l.59 1.02a.15.15 0 0 0 .182.065l.731-.295a2 2 0 0 0 .501.289l.112.778a.15.15 0 0 0 .148.124h1.179a.15.15 0 0 0 .147-.124l.112-.778a2.2 2.2 0 0 0 .495-.29l.737.296a.154.154 0 0 0 .183-.065l.59-1.02a.15.15 0 0 0-.036-.189m-2.818.106a.884.884 0 1 1 .885-.884a.883.883 0 0 1-.885.884"></svg:path><svg:path fill="currentColor" d="M14 2H6a2.006 2.006 0 0 0-2 2v16a2.006 2.006 0 0 0 2 2h12a2.006 2.006 0 0 0 2-2V8Zm4 18H6V4h7v5h5Z"></svg:path>`,
})
export class EosIconsConfigurationFileOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsContentLifecycleManagementIcon],svg[eos-icons-content-lifecycle-management-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 7h8v2H6zm0 4h12v2H6zm0 4h2.99v2H6z"></svg:path><svg:path fill="currentColor" d="m14 3l-3-3v2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h4v-2H4V4h7v2Zm-4 18l3 3v-2h7a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-4v2h4v16h-7v-2Z"></svg:path>`,
})
export class EosIconsContentLifecycleManagementIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsCriticalBugOutlinedIcon],svg[eos-icons-critical-bug-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 15h2v2h-2zm0-6h2v5h-2z"></svg:path><svg:path fill="currentColor" d="M20 8h-2.81a6 6 0 0 0-1.82-1.96L17 4.41L15.59 3l-2.17 2.17A6 6 0 0 0 12 5a6 6 0 0 0-1.41.17L8.41 3L7 4.41l1.62 1.63A6.1 6.1 0 0 0 6.81 8H4v2h2.09A6.6 6.6 0 0 0 6 11v1H4v2h2v1a6.6 6.6 0 0 0 .09 1H4v2h2.81a5.99 5.99 0 0 0 10.38 0H20v-2h-2.09a6.6 6.6 0 0 0 .09-1v-1h2v-2h-2v-1a6.6 6.6 0 0 0-.09-1H20Zm-4 4v3a4 4 0 0 1-.07.7l-.1.65l-.37.65a3.993 3.993 0 0 1-6.92 0l-.37-.64l-.1-.65A4.3 4.3 0 0 1 8 15v-4a4 4 0 0 1 .07-.7l.1-.65l.37-.65a4.1 4.1 0 0 1 1.21-1.31l.57-.39l.74-.18A3.8 3.8 0 0 1 12 7a4 4 0 0 1 .95.12l.68.16l.61.42a3.9 3.9 0 0 1 1.21 1.31l.38.65l.1.65A4 4 0 0 1 16 11Z"></svg:path>`,
})
export class EosIconsCriticalBugOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDaemonIcon],svg[eos-icons-daemon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.231 9.366q.129-.206.24-.426a5 5 0 0 0 .2-.455a5.05 5.05 0 0 0-.104-3.84a4.94 4.94 0 0 0-2.772-2.637l-.016-.004L17.764 2a5.03 5.03 0 0 1 .446 4.476l-.002.003l-.001.004A9 9 0 0 0 15.4 4.655a8.98 8.98 0 0 0-6.804 0A9 9 0 0 0 5.79 6.483l-.002-.004l-.001-.003a4.9 4.9 0 0 1-.276-2.331A5.2 5.2 0 0 1 6.282 2l-.015.004l-.015.004a5.044 5.044 0 0 0-2.926 6.477a5 5 0 0 0 .2.455q.11.22.24.426a9 9 0 1 0 16.465 0m-4.734-.378a1.498 1.498 0 1 1-1.061.439a1.5 1.5 0 0 1 1.06-.44m-6.997 0a1.498 1.498 0 1 1-1.06.439a1.5 1.5 0 0 1 1.06-.44m3.498 9.532a5.43 5.43 0 0 1-3.127-.986a5.55 5.55 0 0 1-1.98-2.516h10.215a5.55 5.55 0 0 1-1.98 2.516a5.43 5.43 0 0 1-3.128.986"></svg:path>`,
})
export class EosIconsDaemonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDaemonOutlinedIcon],svg[eos-icons-daemon-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDaemonSetIcon],svg[eos-icons-daemon-set-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDaemonSetOutlinedIcon],svg[eos-icons-daemon-set-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 20V6H1v14a2 2 0 0 0 2 2h16v-2l-8-.001Z"></svg:path><svg:path fill="currentColor" d="M17.293 8.946q.05-.082.095-.17a2 2 0 0 0 .08-.182a2.02 2.02 0 0 0-.041-1.536a1.98 1.98 0 0 0-1.11-1.055l-.005-.001L16.306 6a2.01 2.01 0 0 1 .178 1.79v.002l-.001.001a3.6 3.6 0 0 0-1.123-.73a3.6 3.6 0 0 0-2.721 0a3.6 3.6 0 0 0-1.123.73v-.001l-.001-.002a1.95 1.95 0 0 1-.11-.932A2.1 2.1 0 0 1 11.712 6l-.006.002l-.006.001a2.02 2.02 0 0 0-1.17 2.59a2 2 0 0 0 .08.183q.044.088.095.17a3.6 3.6 0 1 0 6.587 0m-1.894-.15a.6.6 0 1 1-.425.175a.6.6 0 0 1 .425-.176m-2.799 0a.6.6 0 1 1-.424.175a.6.6 0 0 1 .424-.176m1.4 3.812a2.17 2.17 0 0 1-1.252-.394a2.2 2.2 0 0 1-.792-1.007h4.086a2.2 2.2 0 0 1-.792 1.007a2.17 2.17 0 0 1-1.25.394"></svg:path><svg:path fill="currentColor" d="M22.396 2.604A1.9 1.9 0 0 0 21 2H7a1.9 1.9 0 0 0-1.396.604A1.9 1.9 0 0 0 5 4v12a1.9 1.9 0 0 0 .604 1.396A1.9 1.9 0 0 0 7 18h14a2.067 2.067 0 0 0 2-2V4a1.9 1.9 0 0 0-.604-1.396M21 16H7V4h14Z"></svg:path>`,
})
export class EosIconsDaemonSetOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDataScientistIcon],svg[eos-icons-data-scientist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDataScientistOutlinedIcon],svg[eos-icons-data-scientist-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDatabaseMigrationIcon],svg[eos-icons-database-migration-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 11.021c0 1.013-2.462 1.833-5.5 1.833s-5.5-.82-5.5-1.833V9.188c0 1.012 2.462 1.833 5.5 1.833s5.5-.82 5.5-1.833"></svg:path><svg:path fill="currentColor" d="M18.5 6.137c-3.035 0-5.5-.825-5.5-1.833v3.64c0 1.009 2.465 1.834 5.5 1.834S24 8.953 24 7.944v-3.64c0 1.008-2.465 1.833-5.5 1.833"></svg:path><svg:path fill="currentColor" d="M24 1.833C24 .821 21.538 0 18.5 0S13 .82 13 1.833v1.223c0 1.012 2.462 1.833 5.5 1.833s5.5-.82 5.5-1.833M11 22.021c0 1.013-2.462 1.833-5.5 1.833S0 23.034 0 22.021v-1.833C0 21.2 2.462 22.02 5.5 22.02s5.5-.82 5.5-1.833Z"></svg:path><svg:path fill="currentColor" d="M5.5 17.137c-3.035 0-5.5-.825-5.5-1.833v3.64c0 1.009 2.465 1.834 5.5 1.834s5.5-.825 5.5-1.834v-3.64c0 1.008-2.465 1.833-5.5 1.833"></svg:path><svg:path fill="currentColor" d="M11 12.833C11 11.821 8.538 11 5.5 11S0 11.82 0 12.833v1.223c0 1.012 2.462 1.833 5.5 1.833s5.5-.82 5.5-1.833ZM20 21h-2v-2.59L15.41 21L14 19.59L16.59 17H14v-2h6z"></svg:path>`,
})
export class EosIconsDatabaseMigrationIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDatabaseMigrationOutlinedIcon],svg[eos-icons-database-migration-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDatabaseOutlinedIcon],svg[eos-icons-database-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 1.5C7.395 1.5 2.5 2.727 2.5 5v14c0 2.273 4.895 3.5 9.5 3.5s9.5-1.227 9.5-3.5V5c0-2.273-4.895-3.5-9.5-3.5m0 16c-5.267 0-8.5-1.456-8.5-2.5v-1.367C5.166 14.854 8.66 15.5 12 15.5s6.834-.646 8.5-1.867V15c0 1.044-3.233 2.5-8.5 2.5m0-4c-5.267 0-8.5-1.456-8.5-2.5V9.632C5.166 10.854 8.66 11.5 12 11.5s6.834-.646 8.5-1.868V11c0 1.044-3.233 2.5-8.5 2.5m8.5 5.5c0 1.044-3.233 2.5-8.5 2.5S3.5 20.044 3.5 19v-1.367C5.166 18.854 8.66 19.5 12 19.5s6.834-.646 8.5-1.867ZM12 9.5C6.733 9.5 3.5 8.044 3.5 7V5c0-1.044 3.233-2.5 8.5-2.5s8.5 1.456 8.5 2.5v2c0 1.044-3.233 2.5-8.5 2.5"></svg:path>`,
})
export class EosIconsDatabaseOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDeployIcon],svg[eos-icons-deploy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24.01 20.027v2h-24v-2h4v-1a2.006 2.006 0 0 1-2-2v-10a2.006 2.006 0 0 1 2-2h1.996v2H4.01v10h16v-10h-2.004v-2h2.004a2.006 2.006 0 0 1 2 2l-.01 10a1.997 1.997 0 0 1-1.99 2v1Zm-9-6.012l-3-3l-3 3h2v2.01h2v-2.01Zm.995-7.991a4 4 0 1 1-4-4a4 4 0 0 1 4 4m-4.4 2.96v-.56a.8.8 0 0 1-.8-.8v-.4L9.06 5.479a2.96 2.96 0 0 0 2.545 3.505m2.658-1.007a2.977 2.977 0 0 0-1.068-4.704a.797.797 0 0 1-.79.75h-.8v.8a.4.4 0 0 1-.4.4h-.8v.8h2.4a.4.4 0 0 1 .4.4v1.2h.4a.79.79 0 0 1 .658.354"></svg:path>`,
})
export class EosIconsDeployIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsDnsIcon],svg[eos-icons-dns-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.5 17.5h2v3h-2z"></svg:path><svg:path fill="currentColor" d="M20.998 14H3.002A2 2 0 0 0 1 16.002v5.996A2 2 0 0 0 3.002 24h17.996A2 2 0 0 0 23 21.998v-5.996A2 2 0 0 0 20.998 14M8 20.5A1.473 1.473 0 0 1 6.5 22H3v-6h3.5A1.473 1.473 0 0 1 8 17.5Zm6.5 1.5h-1.2l-2.55-3.5V22H9.5v-6h1.25l2.5 3.5V16h1.25Zm6.5-4.48h-3.5v.74H20a1 1 0 0 1 1 1V21a1 1 0 0 1-1 1h-4v-1.5h3.51v-.74H17a1 1 0 0 1-1-1V17a1 1 0 0 1 1-1h4ZM4.26 12A8.2 8.2 0 0 1 4 10a8.2 8.2 0 0 1 .26-2h3.38a17 17 0 0 0-.14 2a17 17 0 0 0 .14 2h2.02a15 15 0 0 1-.16-2a15 15 0 0 1 .16-2h4.68a15 15 0 0 1 .16 2a15 15 0 0 1-.16 2h2.02a17 17 0 0 0 .14-2a17 17 0 0 0-.14-2h3.38a8.2 8.2 0 0 1 .26 2a8.2 8.2 0 0 1-.26 2h2.059A10 10 0 1 0 2.2 12Zm14.66-6h-2.95a15.7 15.7 0 0 0-1.38-3.56A8.03 8.03 0 0 1 18.92 6M12 2.04A14.1 14.1 0 0 1 13.91 6h-3.82A14.1 14.1 0 0 1 12 2.04m-2.59.4A15.7 15.7 0 0 0 8.03 6H5.08a8 8 0 0 1 4.33-3.56"></svg:path>`,
})
export class EosIconsDnsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsEdgeComputingIcon],svg[eos-icons-edge-computing-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.82 10.99L7 9.17V6H6V2h3v4H8v2.76l1.72 1.72A5.6 5.6 0 0 1 12 10a5.6 5.6 0 0 1 1 .09V5.91a1.5 1.5 0 1 1 1 0v4.46A5.45 5.45 0 0 1 16.29 12h2.8a1.5 1.5 0 1 1 0 1h-2.12a5.4 5.4 0 0 1 .54 1.53a3.74 3.74 0 0 1-.26 7.47H7.5a4.499 4.499 0 0 1-2.47-8.26l-1.89-1.89a1.518 1.518 0 1 1 .71-.71l2.13 2.13a4.4 4.4 0 0 1 1.03-.24a5.56 5.56 0 0 1 1.81-2.04"></svg:path>`,
})
export class EosIconsEdgeComputingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsEdgeComputingOutlinedIcon],svg[eos-icons-edge-computing-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsEndpointsIcon],svg[eos-icons-endpoints-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.02 10.98h2v2h-2zm3.97 4.03h2v2h-2zm0-4.03h2v2h-2zm4.01 0h2v2h-2zm4.01 0h2v2h-2zm4.01 0h2v2h-2zm-4.01-3.97h2v2h-2zM5.99 17.99h4v4h-4zm8.02-15.98h4v4h-4z"></svg:path>`,
})
export class EosIconsEndpointsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsEndpointsDisconnectedIcon],svg[eos-icons-endpoints-disconnected-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m2.39 4.93l6.08 6.08H3.01v2H7V18H6v4h3.99v-4h-1v-4.99h1.48l8.65 8.65l1.28-1.28L3.67 3.66zm14.62 6.08v-5h1v-4h-4v4h1v5h-1.44l2 2h5.44v-2z"></svg:path>`,
})
export class EosIconsEndpointsDisconnectedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsFileSystemIcon],svg[eos-icons-file-system-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 13h6a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1h-3l-1-1h-2a1 1 0 0 0-1 1v1H8V7h2a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H7L6 1H4a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2v13h7v1a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-3l-1-1h-2a1 1 0 0 0-1 1v1H8v-7h5v1a1 1 0 0 0 1 1"></svg:path>`,
})
export class EosIconsFileSystemIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsGenomicIcon],svg[eos-icons-genomic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsHardwareCircuitIcon],svg[eos-icons-hardware-circuit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22 0H2a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M6 16a1 1 0 1 1 1-1a1 1 0 0 1-1 1M22 6h-2.184a3 3 0 1 0 0 2H22v4h-4v2h4v2h-2v2h2v4h-8v-1.184a3 3 0 1 0-2 0V22H7v-4.184a3 3 0 1 0-2 0V22H2V2h4v6h2V2h2v10h2V2h10Zm-4 1a1 1 0 1 1-1-1a1 1 0 0 1 1 1"></svg:path>`,
})
export class EosIconsHardwareCircuitIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsHourglassIcon],svg[eos-icons-hourglass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g><svg:path fill="currentColor" d="M7 3H17V7.2L12 12L7 7.2V3Z"><svg:animate id="eosIconsHourglass0" fill="freeze" attributeName="opacity" begin="0;eosIconsHourglass1.end" dur="2s" from="1" to="0"></svg:animate></svg:path><svg:path fill="currentColor" d="M17 21H7V16.8L12 12L17 16.8V21Z"><svg:animate fill="freeze" attributeName="opacity" begin="0;eosIconsHourglass1.end" dur="2s" from="0" to="1"></svg:animate></svg:path><svg:path fill="currentColor" d="M6 2V8H6.01L6 8.01L10 12L6 16L6.01 16.01H6V22H18V16.01H17.99L18 16L14 12L18 8.01L17.99 8H18V2H6ZM16 16.5V20H8V16.5L12 12.5L16 16.5ZM12 11.5L8 7.5V4H16V7.5L12 11.5Z"></svg:path><svg:animatetransform id="eosIconsHourglass1" attributeName="transform" attributeType="XML" begin="eosIconsHourglass0.end" dur="0.5s" from="0 12 12" to="180 12 12" type="rotate"></svg:animatetransform></svg:g>`,
})
export class EosIconsHourglassIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsInfinityIcon],svg[eos-icons-infinity-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.385 8.609A5.47 5.47 0 0 0 18.5 7a5.57 5.57 0 0 0-3.928 1.609L12 11.092L9.428 8.61a5.5 5.5 0 1 0 0 7.782L12 13.83l2.572 2.562a5.514 5.514 0 1 0 7.813-7.782m-14.37 6.374a3.54 3.54 0 0 1-4.986 0a3.518 3.518 0 0 1 4.985-4.965l2.486 2.474Zm12.956 0a3.54 3.54 0 0 1-4.985 0l-2.486-2.49l2.486-2.476a3.54 3.54 0 0 1 4.985 0a3.506 3.506 0 0 1 0 4.965"></svg:path>`,
})
export class EosIconsInfinityIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsIngressIcon],svg[eos-icons-ingress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 24h-4v-4h4zm2-13.982h-3v7.996h-2v-7.996H8l1-1.001l1-1.001l1-1.001l1-1.001l1 1l1 1.002l1 1ZM1 15.999V3.001a2 2 0 0 1 .158-.777a2.02 2.02 0 0 1 1.065-1.066A2 2 0 0 1 3 1h18a2 2 0 0 1 .777.158a2.02 2.02 0 0 1 1.065 1.066A2 2 0 0 1 23 3v12.998a2 2 0 0 1-.158.777a2.02 2.02 0 0 1-1.065 1.066A2 2 0 0 1 21 18h-6v-1.99h6v-13H3v13h6V18H3a2 2 0 0 1-.777-.158a2.02 2.02 0 0 1-1.065-1.066A2 2 0 0 1 1 16"></svg:path>`,
})
export class EosIconsIngressIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsInitContainerIcon],svg[eos-icons-init-container-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsInitContainerOutlinedIcon],svg[eos-icons-init-container-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 18H4v-8h16v2.078a7 7 0 0 1 2 .603V10a2 2 0 0 0-2-2l-1.488-.015l-5.302-3.43A1.96 1.96 0 0 0 14 3a2.03 2.03 0 0 0-1-1.721V0h-1v2a1 1 0 1 1-1 1h-1a1.96 1.96 0 0 0 .796 1.56L5.5 7.984L4 8a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8.08a7 7 0 0 1-.08-1.003A7 7 0 0 1 12 18m-.005-13.026L12 5c.006 0 .01-.027.017-.027L17 8H7Z"></svg:path><svg:path fill="currentColor" d="M15 13.26V12a1 1 0 0 0-2 0v3.408a7 7 0 0 1 2-2.148M18 11a1 1 0 0 0-1 1v.294A7 7 0 0 1 19 12a1 1 0 0 0-1-1M6 11a1 1 0 0 0-1 1v4a1 1 0 0 0 2 0v-4a1 1 0 0 0-1-1m4 0a1 1 0 0 0-1 1v4a1 1 0 0 0 2 0v-4a1 1 0 0 0-1-1m13.879 9.319l-1.07-.83a4 4 0 0 0 .04-.49a2.6 2.6 0 0 0-.04-.49l1.06-.83a.26.26 0 0 0 .06-.32l-1-1.73a.25.25 0 0 0-.31-.11l-1.239.5a3.4 3.4 0 0 0-.85-.49l-.19-1.319a.24.24 0 0 0-.24-.21h-1.998a.26.26 0 0 0-.25.21l-.19 1.32a4 4 0 0 0-.85.49l-1.239-.5a.26.26 0 0 0-.31.11l-1 1.73a.25.25 0 0 0 .06.32l1.06.829a4 4 0 0 0 0 .98l-1.06.83a.26.26 0 0 0-.06.32l1 1.73a.25.25 0 0 0 .31.11l1.24-.5a3.4 3.4 0 0 0 .849.49l.19 1.319a.25.25 0 0 0 .25.21H20.1a.26.26 0 0 0 .25-.21l.19-1.32a3.7 3.7 0 0 0 .839-.49l1.25.5a.26.26 0 0 0 .31-.11l.999-1.73a.26.26 0 0 0-.06-.32m-4.758.18a1.5 1.5 0 1 1 1.5-1.5a1.497 1.497 0 0 1-1.5 1.5"></svg:path>`,
})
export class EosIconsInitContainerOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsIotIcon],svg[eos-icons-iot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 13v9H3v-9Zm18 0v2h-2v7h-2v-7h-2v-2Zm-11-2a7.54 7.54 0 0 1 3.96 1.149l1.447-1.45A9.5 9.5 0 0 0 12 9a9.36 9.36 0 0 0-5.333 1.68l1.449 1.453A7.36 7.36 0 0 1 12 11"></svg:path><svg:path fill="currentColor" d="M12 7a11.5 11.5 0 0 1 6.834 2.27l1.427-1.43A13.48 13.48 0 0 0 12 5a13.33 13.33 0 0 0-8.186 2.822l1.426 1.43A11.34 11.34 0 0 1 12 7"></svg:path><svg:path fill="currentColor" d="M12 3a15.47 15.47 0 0 1 9.687 3.41l1.427-1.429A17.43 17.43 0 0 0 .96 4.964l1.427 1.429A15.33 15.33 0 0 1 12 3m0 10a4.5 4.5 0 1 0 4.5 4.5A4.5 4.5 0 0 0 12 13m0 7a2.5 2.5 0 1 1 2.5-2.5A2.5 2.5 0 0 1 12 20"></svg:path>`,
})
export class EosIconsIotIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsIpIcon],svg[eos-icons-ip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.26 12A8.2 8.2 0 0 1 4 10a8.2 8.2 0 0 1 .26-2h3.38a17 17 0 0 0-.14 2a17 17 0 0 0 .14 2h2.02a15 15 0 0 1-.16-2a15 15 0 0 1 .16-2h4.68a15 15 0 0 1 .16 2a15 15 0 0 1-.16 2h2.02a17 17 0 0 0 .14-2a17 17 0 0 0-.14-2h3.38a8.2 8.2 0 0 1 .26 2a8.2 8.2 0 0 1-.26 2h2.059A10 10 0 1 0 2.2 12Zm14.66-6h-2.95a15.7 15.7 0 0 0-1.38-3.56A8.03 8.03 0 0 1 18.92 6M12 2.04A14.1 14.1 0 0 1 13.91 6h-3.82A14.1 14.1 0 0 1 12 2.04m-2.59.4A15.7 15.7 0 0 0 8.03 6H5.08a8 8 0 0 1 4.33-3.56m3.339 15.055h2v1h-2z"></svg:path><svg:path fill="currentColor" d="M20.998 14H3.002A2 2 0 0 0 1 16.002v5.996A2 2 0 0 0 3.002 24h17.996A2 2 0 0 0 23 21.998v-5.996A2 2 0 0 0 20.998 14M9.251 22.005h-1.5v-6h1.5Zm6.998-3.51a1.473 1.473 0 0 1-1.5 1.5h-2v2h-1.5v-6h3.5a1.473 1.473 0 0 1 1.5 1.5Z"></svg:path>`,
})
export class EosIconsIpIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsIpOutlinedIcon],svg[eos-icons-ip-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.26 12A8.2 8.2 0 0 1 4 10a8.2 8.2 0 0 1 .26-2h3.38a17 17 0 0 0-.14 2a17 17 0 0 0 .14 2h2.02a15 15 0 0 1-.16-2a15 15 0 0 1 .16-2h4.68a15 15 0 0 1 .16 2a15 15 0 0 1-.16 2h2.02a17 17 0 0 0 .14-2a17 17 0 0 0-.14-2h3.38a8.2 8.2 0 0 1 .26 2a8.2 8.2 0 0 1-.26 2L22 13v-3a10 10 0 1 0-20 0v3Zm14.66-6h-2.95a15.7 15.7 0 0 0-1.38-3.56A8.03 8.03 0 0 1 18.92 6M12 2.04A14.1 14.1 0 0 1 13.91 6h-3.82A14.1 14.1 0 0 1 12 2.04m-2.59.4A15.7 15.7 0 0 0 8.03 6H5.08a8 8 0 0 1 4.33-3.56"></svg:path><svg:path fill="currentColor" d="M21 14v8H3v-8zm0-2H3a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2"></svg:path><svg:path fill="currentColor" d="M7 15h2v6H7zm9 0h-4v6h2v-2h2a1.473 1.473 0 0 0 1.5-1.5v-1A1.473 1.473 0 0 0 16 15m0 3h-2v-2h2Z"></svg:path>`,
})
export class EosIconsIpOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsKubeletIcon],svg[eos-icons-kubelet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsKubeletOutlinedIcon],svg[eos-icons-kubelet-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsLockedEnvIcon],svg[eos-icons-locked-env-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 8h-1V6A5 5 0 0 0 6 6v2H5a2.006 2.006 0 0 0-2 2v10a2.006 2.006 0 0 0 2 2h12a2.006 2.006 0 0 0 2-2V10a2.006 2.006 0 0 0-2-2m-9.72 6.59v.752H5.975v.877H7.45V17H5v-4h2.45v.78H5.975v.81ZM7.9 6a3.1 3.1 0 1 1 6.2 0v2H7.9Zm4.268 11h-.974l-1.63-2.467V17H8.59v-4h.974l1.63 2.479V13h.974Zm3.433 0H14.4L13 13h1l1 3l1-3h1Z"></svg:path>`,
})
export class EosIconsLockedEnvIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMachineLearningIcon],svg[eos-icons-machine-learning-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 8h2v1h-2zm0-4h2v1h-2zm0 6h2v1h-2z"></svg:path><svg:path fill="currentColor" d="M21 12V9a13.12 13.12 0 0 0-8.354 3h-1.292A13.12 13.12 0 0 0 3 9v3a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v4a13.15 13.15 0 0 1 9 3.55A13.2 13.2 0 0 1 21 20v-4a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"></svg:path><svg:circle cx="9" cy="4" r="1" fill="currentColor"></svg:circle><svg:circle cx="15" cy="4" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M16 8H8a3.003 3.003 0 0 1-3-3V3a3.003 3.003 0 0 1 3-3h8a3.003 3.003 0 0 1 3 3v2a3.003 3.003 0 0 1-3 3M8 2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z"></svg:path>`,
})
export class EosIconsMachineLearningIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMachineLearningOutlinedIcon],svg[eos-icons-machine-learning-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 10a16.84 16.84 0 0 0-9 3.244A16.84 16.84 0 0 0 3 10v2.96a2.004 2.004 0 0 0-2 2.007v1.004c0 1.109 2 2.208 2 2.208v2.007a14.87 14.87 0 0 1 7.417 2.55A15 15 0 0 1 12 24a15 15 0 0 1 1.583-1.264A14.87 14.87 0 0 1 21 20.186v-2.208a2.004 2.004 0 0 0 2-2.007v-1.004a2.004 2.004 0 0 0-2-2.007Zm-9 11.422a16.84 16.84 0 0 0-7-2.996v-6.15a14.8 14.8 0 0 1 5.417 2.282A15 15 0 0 1 12 15.822a15 15 0 0 1 1.583-1.264A14.8 14.8 0 0 1 19 12.275v6.151a16.84 16.84 0 0 0-7 2.996M11 8h2v1h-2zm0-4h2v1h-2z"></svg:path><svg:path fill="currentColor" d="M11 10h2v1h-2zM9 5a1 1 0 0 0 1-1a.983.983 0 0 0-.99-.99A.995.995 0 1 0 9 5"></svg:path><svg:circle cx="15" cy="4" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M16 8H8a3.003 3.003 0 0 1-3-3V3a3.003 3.003 0 0 1 3-3h8a3.003 3.003 0 0 1 3 3v2a3.003 3.003 0 0 1-3 3M8 2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z"></svg:path>`,
})
export class EosIconsMachineLearningOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMasterIcon],svg[eos-icons-master-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 20h16v2H4zM21 5a1 1 0 0 0-1 1a.9.9 0 0 0 .064.332a1.1 1.1 0 0 0 .167.283l-2.12 1.692L15.994 10L14.24 6.927l-1.752-3.072a1.05 1.05 0 0 0 .369-.353A.95.95 0 0 0 13 3a1 1 0 1 0-2 0a.95.95 0 0 0 .143.502a1.05 1.05 0 0 0 .369.353L9.757 6.927L8.002 10L5.886 8.308L3.769 6.615a1.1 1.1 0 0 0 .167-.283A.9.9 0 0 0 4 6a1 1 0 1 0-1 1a.2.2 0 0 0 .041-.007a.2.2 0 0 1 .041-.01l.459 5.509L4 18h16l.459-5.508l.459-5.509a.2.2 0 0 1 .04.01A.2.2 0 0 0 21 7a1 1 0 1 0 0-2"></svg:path>`,
})
export class EosIconsMasterIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMergeIcon],svg[eos-icons-merge-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 11a2.99 2.99 0 0 0-2.815 1.997c-2.995-.014-5.26-.129-6.726-.886a6.2 6.2 0 0 1-3.358-4.326A3.008 3.008 0 1 0 4 7.816v9.368a3 3 0 1 0 2 0v-5.257a8.6 8.6 0 0 0 2.541 1.962c1.847.952 4.36 1.092 7.642 1.108A2.995 2.995 0 1 0 19 11"></svg:path>`,
})
export class EosIconsMergeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMiscellaneousIcon],svg[eos-icons-miscellaneous-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m18 13l.989 7.875A1 1 0 0 1 17.997 22H6.003a1 1 0 0 1-.992-1.125L6 13Zm3-3H3v2h18Zm-6.286-4.196A6.3 6.3 0 0 0 15 3.835C15 2.27 14.552 1 14 1s-1 1.27-1 2.835a7 7 0 0 0 .115 1.301a4.6 4.6 0 0 0-2.234.001A7 7 0 0 0 11 3.835C11 2.27 10.552 1 10 1S9 2.27 9 3.835a6.3 6.3 0 0 0 .283 1.971A5.1 5.1 0 0 0 7 9h2a1 1 0 0 1 2 0h2a1 1 0 0 1 2 0h2a5.1 5.1 0 0 0-2.286-3.196"></svg:path>`,
})
export class EosIconsMiscellaneousIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMiscellaneousOutlinedIcon],svg[eos-icons-miscellaneous-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsModifiedDateOutlinedIcon],svg[eos-icons-modified-date-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m13.372 11.013l.614.614l-6.04 6.04h-.613v-.614zM15.771 7a.67.67 0 0 0-.467.193l-1.22 1.22l2.5 2.5l1.22-1.22a.664.664 0 0 0 0-.94l-1.56-1.56A.66.66 0 0 0 15.772 7m-2.4 2.127L6 16.5V19h2.5l7.372-7.373Z"></svg:path><svg:path fill="currentColor" d="M19 1h-2v2H7V1H5v2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-1zM4 21V5h16v16Z"></svg:path>`,
})
export class EosIconsModifiedDateOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMoleculesIcon],svg[eos-icons-molecules-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMoleculesOutlinedIcon],svg[eos-icons-molecules-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMonitoringIcon],svg[eos-icons-monitoring-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 18h2v3h-2zm5 3v2H8v-2zm4-3H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v11a3.003 3.003 0 0 1-3 3M4 3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1Z"></svg:path><svg:path fill="currentColor" d="m16 15l-1.914-6.38L13 13l-1.309-3h-.331L10 14L8.843 9.933L8.309 11H5v-1h2.691L9 7l1.068 3.713L10.64 9h1.669l.487.973L14 4l2 8l.64-2H19v1h-1.64z"></svg:path>`,
})
export class EosIconsMonitoringIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsMoveIcon],svg[eos-icons-move-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.017 12.008L18.019 8.01l-.002 2.993h-5.001v-4.99l2.993.002l-4.002-4.002l-3.998 3.998l2.994.001v4.991h-5L6.002 8.01l-3.998 3.998l4.002 4.002l-.002-2.993h4.999v4.993l-2.994.001l3.998 3.999l4.002-4.002l-2.993.001v-4.992h5l-.001 2.993z"></svg:path>`,
})
export class EosIconsMoveIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNamespaceIcon],svg[eos-icons-namespace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23 11v2c-.852 0-1 .35-1 1.314v4.498c0 2.514-1.46 3.156-4 3.188v-2c1.404-.032 2 .154 2-1.36v-4.297a3.1 3.1 0 0 1 .294-1.56a1.7 1.7 0 0 1 .997-.783a1.7 1.7 0 0 1-.997-.783A3.1 3.1 0 0 1 20 9.657V5.359c0-1.513-.596-1.327-2-1.359V2c2.54.032 4 .674 4 3.188v4.498c0 .963.148 1.314 1 1.314M1 11v2c.852 0 1 .35 1 1.314v4.498C2 21.326 3.46 21.968 6 22v-2c-1.404-.032-2 .154-2-1.36v-4.297a3.1 3.1 0 0 0-.294-1.56A1.7 1.7 0 0 0 2.709 12a1.7 1.7 0 0 0 .997-.783A3.1 3.1 0 0 0 4 9.657V5.359C4 3.846 4.596 4.032 6 4V2c-2.54.032-4 .674-4 3.188v4.498C2 10.649 1.852 11 1 11m17-2H6v6h12ZM8 11h8v2H8Z"></svg:path>`,
})
export class EosIconsNamespaceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNetworkIcon],svg[eos-icons-network-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 4a8 8 0 1 0 8 8a8.003 8.003 0 0 0-8-8m-6 8a6 6 0 0 1 .105-1.095L9.6 14.4v.8a1.605 1.605 0 0 0 1.6 1.6v1.14A6.004 6.004 0 0 1 6 12m9.2 3.2h-.8v-2.4a.8.8 0 0 0-.8-.8H8.8v-1.6h1.6a.8.8 0 0 0 .8-.8V8h1.6a1.6 1.6 0 0 0 1.59-1.5a5.985 5.985 0 0 1 2.137 9.426A1.57 1.57 0 0 0 15.2 15.2M13 1a1 1 0 1 1-1-1a1 1 0 0 1 1 1m5 1a1 1 0 1 1-1-1a1 1 0 0 1 1 1m4 4a1 1 0 1 1-1-1a1 1 0 0 1 1 1m2 6a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-2 6a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-4 4a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-5 1a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-5-1a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-4-4a1 1 0 1 1-1-1a1 1 0 0 1 1 1m-2-6a1 1 0 1 1-1-1a1 1 0 0 1 1 1m2-6a1 1 0 1 1-1-1a1 1 0 0 1 1 1m4-4a1 1 0 1 1-1-1a1 1 0 0 1 1 1"></svg:path>`,
})
export class EosIconsNetworkIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNetworkFileSystemOutlinedIcon],svg[eos-icons-network-file-system-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 17h-3v-4h-2v4H8v1H2v2h6v1h8v-1h6v-2h-6z"></svg:path><svg:path fill="currentColor" d="M18 4h-5.793l-.853-.854L11.207 3H6a1.5 1.5 0 0 0-1.5 1.5v8A1.5 1.5 0 0 0 6 14h12a1.5 1.5 0 0 0 1.5-1.5v-7A1.5 1.5 0 0 0 18 4m-.5 2v6h-11V5h3.793l.853.854l.147.146z"></svg:path>`,
})
export class EosIconsNetworkFileSystemOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNetworkPolicyIcon],svg[eos-icons-network-policy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 1a1 1 0 1 1 1 1a1 1 0 0 1-1-1M3 7a1 1 0 1 0-1-1a1 1 0 0 0 1 1m4-4a1 1 0 1 0-1-1a1 1 0 0 0 1 1m10 0a1 1 0 1 0-1-1a1 1 0 0 0 1 1m4 4a1 1 0 1 0-1-1a1 1 0 0 0 1 1M10.69 19.883a9.6 9.6 0 0 1-.59-2.201a5.96 5.96 0 0 1-3.995-6.777L9.6 14.4v.8a1.6 1.6 0 0 0 .4 1.045V12H8.8v-1.6h1.6a.8.8 0 0 0 .8-.8V8h1.6a1.6 1.6 0 0 0 1.59-1.5a6 6 0 0 1 2.353 1.857L18 7.833l1.08.45a7.997 7.997 0 1 0-8.39 11.6M7 21a1 1 0 1 0 1 1a1 1 0 0 0-1-1m5 1a1 1 0 1 0 1 1a1 1 0 0 0-1-1m-9-5a1 1 0 1 0 1 1a1 1 0 0 0-1-1m-2-6a1 1 0 1 0 1 1a1 1 0 0 0-1-1m23 1.5v3.863A8.17 8.17 0 0 1 18 24a8.12 8.12 0 0 1-6-7.596V12.5l6-2.5Z"></svg:path>`,
})
export class EosIconsNetworkPolicyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNetworkPolicyOutlinedIcon],svg[eos-icons-network-policy-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="7" cy="2" r="1" fill="currentColor"></svg:circle><svg:circle cx="3" cy="6" r="1" fill="currentColor"></svg:circle><svg:circle cx="12" cy="1" r="1" fill="currentColor"></svg:circle><svg:circle cx="17" cy="2" r="1" fill="currentColor"></svg:circle><svg:circle cx="21" cy="6" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="m17.5 24l-.119-.029A8.62 8.62 0 0 1 11 15.916v-4.218L17.5 9l6.5 2.698v4.218a8.62 8.62 0 0 1-6.381 8.055ZM13 12.865v3.15a6.4 6.4 0 0 0 4.5 5.96a6.4 6.4 0 0 0 4.5-5.96v-3.15l-4.5-1.793Zm10-.503"></svg:path><svg:circle cx="12" cy="23" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M10.4 10.4a.8.8 0 0 0 .8-.8V8h1.6a1.6 1.6 0 0 0 1.59-1.5a6 6 0 0 1 2.353 1.857L18 7.833l1.08.45a7.997 7.997 0 1 0-8.39 11.6a9.6 9.6 0 0 1-.59-2.201a5.96 5.96 0 0 1-3.995-6.777L9.6 14.4v.8a1.6 1.6 0 0 0 .4 1.045V12H8.8v-1.6Z"></svg:path><svg:circle cx="3" cy="18" r="1" fill="currentColor"></svg:circle><svg:circle cx="7" cy="22" r="1" fill="currentColor"></svg:circle><svg:circle cx="1" cy="12" r="1" fill="currentColor"></svg:circle>`,
})
export class EosIconsNetworkPolicyOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNeuralNetworkIcon],svg[eos-icons-neural-network-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsNodeOutlinedIcon],svg[eos-icons-node-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="12" cy="2" r="1" fill="currentColor"></svg:circle><svg:circle cx="21" cy="6" r="1" fill="currentColor"></svg:circle><svg:circle cx="21" cy="17" r="1" fill="currentColor"></svg:circle><svg:circle cx="12" cy="22" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M21 8a2.006 2.006 0 0 1-2-2a1.94 1.94 0 0 1 .26-.96L14 2a2 2 0 0 1-1.01 1.73a1.95 1.95 0 0 1-1.98 0A2 2 0 0 1 10 2L4.74 5.04A1.94 1.94 0 0 1 5 6a2.006 2.006 0 0 1-2 2a2 2 0 0 1-.5-.07v7.14A2 2 0 0 1 3 15a2 2 0 0 1 1.5.69a2.2 2.2 0 0 1 .39.68A1.9 1.9 0 0 1 5 17a2 2 0 0 1-.58 1.41l3.84 2.21l1.78 1.03a1.3 1.3 0 0 1 .07-.28a.3.3 0 0 0 .02-.07a2 2 0 0 1 .12-.24c.01-.03.03-.06.04-.09c.05-.07.09-.14.14-.2c.03-.03.05-.06.08-.09a1.2 1.2 0 0 1 .16-.16a.5.5 0 0 1 .11-.1a2 2 0 0 1 .17-.11a1 1 0 0 1 .15-.09c.06-.03.11-.05.17-.08l.21-.06a1 1 0 0 1 .14-.04a1.8 1.8 0 0 1 .76 0a1 1 0 0 1 .14.04l.21.06c.06.03.11.05.17.08a1 1 0 0 1 .15.09a2 2 0 0 1 .17.11a.5.5 0 0 1 .11.1a1.2 1.2 0 0 1 .16.16c.03.03.05.06.08.09c.05.06.09.13.14.2c.01.03.03.06.04.09a2 2 0 0 1 .12.24a.3.3 0 0 0 .02.07a1.3 1.3 0 0 1 .07.28l1.78-1.03l3.84-2.21A2 2 0 0 1 19 17a1.9 1.9 0 0 1 .11-.63a2.2 2.2 0 0 1 .39-.68A2 2 0 0 1 21 15a2 2 0 0 1 .5.07V7.93A2 2 0 0 1 21 8m-9 5a1 1 0 1 1 1-1a1.003 1.003 0 0 1-1 1m7.5.3A4 4 0 0 0 17 17a3.6 3.6 0 0 0 .06.56l-2.47 1.42a4 4 0 0 0-1.59-.84v-3.32a3 3 0 1 0-2 0v3.32a4 4 0 0 0-1.59.84l-2.47-1.42A3.6 3.6 0 0 0 7 17a4 4 0 0 0-2.5-3.7V9.7A4 4 0 0 0 7 6.04L9.15 4.8a3.984 3.984 0 0 0 5.7 0L17 6.04a4 4 0 0 0 2.5 3.66Z"></svg:path><svg:circle cx="3" cy="17" r="1" fill="currentColor"></svg:circle><svg:circle cx="3" cy="6" r="1" fill="currentColor"></svg:circle>`,
})
export class EosIconsNodeOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsOrganismsIcon],svg[eos-icons-organisms-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsOrganismsOutlinedIcon],svg[eos-icons-organisms-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsOrganizationOutlinedIcon],svg[eos-icons-organization-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 11V9h-2l.025 2H3.5v4h2v-2H11v2h2v-2h5.505l-.005 2h2v-4zm-1-9a2.5 2.5 0 1 0 2.5 2.5A2.5 2.5 0 0 0 12 2m0 3.5a1 1 0 1 1 1-1a1 1 0 0 1-1 1M4.5 17A2.5 2.5 0 1 0 7 19.5A2.5 2.5 0 0 0 4.5 17m0 3.5a1 1 0 1 1 1-1a1 1 0 0 1-1 1M12 17a2.5 2.5 0 1 0 2.5 2.5A2.5 2.5 0 0 0 12 17m0 3.5a1 1 0 1 1 1-1a1 1 0 0 1-1 1m7.5-3.5a2.5 2.5 0 1 0 2.5 2.5a2.5 2.5 0 0 0-2.5-2.5m0 3.5a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path>`,
})
export class EosIconsOrganizationOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPatchFixesOutlinedIcon],svg[eos-icons-patch-fixes-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPatternsOutlinedIcon],svg[eos-icons-patterns-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.98 9.193V6.822a2.992 2.992 0 1 0-3.796-3.81h-2.368a2.992 2.992 0 1 0-3.806 3.813v2.37a2.972 2.972 0 0 0 0 5.624v2.37a2.99 2.99 0 0 0-1.828 1.822H6.818A2.99 2.99 0 0 0 5 17.193v-2.37a3.009 3.009 0 1 0-2-.007v2.377a2.99 2.99 0 1 0 3.815 3.814h2.37a2.992 2.992 0 1 0 3.825-3.81v-2.378a2.982 2.982 0 0 0 0-5.623V6.819a2.99 2.99 0 0 0 1.806-1.81h2.368a2.96 2.96 0 0 0 1.796 1.813v2.377A2.97 2.97 0 0 0 17 12a3 3 0 1 0 3.98-2.807M4 21a1 1 0 1 1 1-1a1 1 0 0 1-1 1m0-8a1 1 0 1 1 1-1a1 1 0 0 1-1 1m8 8a1 1 0 1 1 1-1a1 1 0 0 1-1 1m0-8a1.033 1.033 0 0 1-1.02-1.017A1.003 1.003 0 0 1 12 11a.97.97 0 0 1 .98.983A1 1 0 0 1 12 13m-.02-8.006a.999.999 0 0 1 0-1.997a.999.999 0 1 1 0 1.997M20 12.98a.984.984 0 0 1-1-.98a1.02 1.02 0 0 1 1.02-1a.99.99 0 0 1-.02 1.981M20 5a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path><svg:path fill="currentColor" d="M20 17a3 3 0 1 0 3 3a3 3 0 0 0-3-3m0 4a1 1 0 1 1 1-1a1 1 0 0 1-1 1M4 1a3 3 0 1 0 3 3a3 3 0 0 0-3-3m0 4a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path>`,
})
export class EosIconsPatternsOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPerformanceIcon],svg[eos-icons-performance-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPersistentVolumeIcon],svg[eos-icons-persistent-volume-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 1H10a2 2 0 0 0-2 2v10.369a6 6 0 0 1 .989.454A5.983 5.983 0 0 1 17.65 21H20a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2M9 3a1 1 0 1 1 1 1a1 1 0 0 1-1-1m6 10a5 5 0 0 1-2-.422V10h-2.578A4.997 4.997 0 1 1 15 13m5 7a1 1 0 1 1 1-1a1 1 0 0 1-1 1m0-16a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path><svg:path fill="currentColor" d="M12 23a3.97 3.97 0 0 1-3-1.38a3.97 3.97 0 0 1-1-2.617V19a2 2 0 1 0-2 2a1.9 1.9 0 0 0 .79-.175a6 6 0 0 0 .927 1.765A3.8 3.8 0 0 1 6 23a4 4 0 1 1 3-6.62a3.97 3.97 0 0 1 1 2.617V19a2 2 0 1 0 2-2a1.9 1.9 0 0 0-.79.176a6 6 0 0 0-.928-1.766A3.8 3.8 0 0 1 12 15a4 4 0 0 1 0 8"></svg:path><svg:circle cx="15" cy="8" r="2" fill="currentColor"></svg:circle>`,
})
export class EosIconsPersistentVolumeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPinOutlinedIcon],svg[eos-icons-pin-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m9.675 6.83l3.546 3.537a5 5 0 0 0 2.836 1.415l-4.255 4.244a4.94 4.94 0 0 0-1.418-2.83L6.838 9.66zm.709-3.537l-7.091 7.075a1.002 1.002 0 0 0 1.418 1.415l.709-.708l3.546 3.537a2.993 2.993 0 0 1 0 4.245l1.418 1.415l4.234-4.223L19.582 21H21v-1.415l-4.964-4.952l4.276-4.266l-1.418-1.415a3.01 3.01 0 0 1-4.255 0l-3.546-3.538l.71-.707a1.002 1.002 0 1 0-1.419-1.415"></svg:path>`,
})
export class EosIconsPinOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPodAutoscalerIcon],svg[eos-icons-pod-autoscaler-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPodSecurityIcon],svg[eos-icons-pod-security-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPodSecurityOutlinedIcon],svg[eos-icons-pod-security-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m19.75 12l-2.25-1l-2.25 1L13 13v3a6.4 6.4 0 0 0 1.282 3.804A5.78 5.78 0 0 0 17.5 22a5.78 5.78 0 0 0 3.218-2.196A6.4 6.4 0 0 0 22 16v-3Zm.098 7.287a4.8 4.8 0 0 1-2.348 1.678V16.5H14v-2.85l1.75-.777l1.75-.778v4.4H21a5.8 5.8 0 0 1-1.152 2.792M13 4a1.004 1.004 0 0 0-1-1H8a1.004 1.004 0 0 0-1 1v1h6Z"></svg:path><svg:circle cx="10" cy="11" r="1.5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M12 17v-2H5.1l3.18-7h3.42l1.704 3.726l1.825-.811L12.99 6H7L2 17zm2 4a6 6 0 0 1-.519-.597A7.5 7.5 0 0 1 12.68 19H6v-1H4v1.003A2 2 0 0 0 6 21"></svg:path>`,
})
export class EosIconsPodSecurityOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPrimitiveIcon],svg[eos-icons-primitive-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsProductClassesIcon],svg[eos-icons-product-classes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 2H3a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1M5 21a2 2 0 1 1 2-2a2 2 0 0 1-2 2m2-9H3V3h4Z"></svg:path><svg:circle cx="5.01" cy="19.01" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M10.01 2v9.01h5V2zM17 2v9.01h5V2zm-6.99 11v9h5v-9zM17 13v9h5v-9z"></svg:path>`,
})
export class EosIconsProductClassesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsProductSubscriptionsIcon],svg[eos-icons-product-subscriptions-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 8H4V6h16Zm-2-6H6v2h12Zm4 10v8a2 2 0 0 1-2 2H4a2.006 2.006 0 0 1-2-2v-8a2.006 2.006 0 0 1 2-2h16a2.006 2.006 0 0 1 2 2m-8.073 5.042l2.323-1.986l-3.059-.256L12 12l-1.191 2.8l-3.059.256l2.323 1.986l-.7 2.958L12 18.428L14.627 20Z"></svg:path>`,
})
export class EosIconsProductSubscriptionsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsProxyIcon],svg[eos-icons-proxy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m15.013 9.395l4.57-4.57L21 6.243V2h-4.243l1.411 1.41l-4.834 4.835a3.938 3.938 0 0 0-5.191 2.75H5.72a2 2 0 1 0 .005 2H8.14a3.94 3.94 0 0 0 5.204 2.757l4.83 4.83L16.758 22H21v-4.243l-1.41 1.411l-4.571-4.57a4 4 0 0 0 .841-1.603L18 13v2l3-3l-3-3v2l-2.143-.005a4 4 0 0 0-.844-1.6"></svg:path>`,
})
export class EosIconsProxyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsProxyOutlinedIcon],svg[eos-icons-proxy-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 6.243V2h-4.243l1.411 1.41l-4.834 4.835a3.938 3.938 0 0 0-5.191 2.75H5.72a2 2 0 1 0 .005 2H8.14a3.94 3.94 0 0 0 5.204 2.757l4.83 4.83L16.758 22H21v-4.243l-1.41 1.411l-4.571-4.57a4 4 0 0 0 .841-1.603L18 13v2l3-3l-3-3v2l-2.143-.005a4 4 0 0 0-.844-1.6l4.57-4.57ZM12 14a2 2 0 1 1 2-2a2 2 0 0 1-2 2"></svg:path>`,
})
export class EosIconsProxyOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPullRequestIcon],svg[eos-icons-pull-request-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 17.184V8.816a3 3 0 1 0-2 0v8.368a3 3 0 1 0 2 0m14 0V7a2 2 0 0 0-2-2h-5.172l1.586-1.586L13 2l-2.586 2.586L9 6l1.414 1.414L13 10l1.414-1.414L12.828 7H18v10.184a3 3 0 1 0 2 0"></svg:path>`,
})
export class EosIconsPullRequestIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPullRequestOutlinedIcon],svg[eos-icons-pull-request-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 17.184V8.816a3 3 0 1 0-2 0v8.368a3 3 0 1 0 2 0M5 5a1 1 0 1 1-1 1a1 1 0 0 1 1-1m0 16a1 1 0 1 1 1-1a1 1 0 0 1-1 1m15-3.816V7a2 2 0 0 0-2-2h-5.172l1.586-1.586L13 2l-2.586 2.586L9 6l1.414 1.414L13 10l1.414-1.414L12.828 7H18v10.184a3 3 0 1 0 2 0M19 21a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path>`,
})
export class EosIconsPullRequestOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsPushPinOutlinedIcon],svg[eos-icons-push-pin-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.996 12.011A3.005 3.005 0 0 1 16 9V4h1l-.013.011A1.023 1.023 0 0 0 18 3a1.007 1.007 0 0 0-1.015-.988L17 2H7a1 1 0 0 0-.003 2H8l-.004 5A2.99 2.99 0 0 1 5 12v2h6v7l1 1l1-1v-7h6v-2ZM9 12a4.94 4.94 0 0 0 1-3V4h4v5a5 5 0 0 0 1 3Z"></svg:path>`,
})
export class EosIconsPushPinOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsRepositoriesIcon],svg[eos-icons-repositories-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m8 23.01l2.5-1.5l2.5 1.5V19H8zM8 5h2v2H8zm0 5h2v2H8zm0 5.01h2v2H8z"></svg:path><svg:path fill="currentColor" d="M18.36 1.05A1.5 1.5 0 0 0 18 1H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2V3h12v16h-3v2h3a2 2 0 0 0 2-2V3a2 2 0 0 0-1.64-1.95"></svg:path>`,
})
export class EosIconsRepositoriesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsRoleBindingIcon],svg[eos-icons-role-binding-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 21h-2a2 2 0 0 1 0-4h2v-2h-2a4 4 0 0 0 0 8h2Zm8-2a4 4 0 0 1-4 4h-2v-2h2a2 2 0 0 0 0-4h-2v-2h2a4 4 0 0 1 4 4"></svg:path><svg:path fill="currentColor" d="M14 18h4v2h-4zm-7 1a6 6 0 0 1 .09-1H3v-1.4c0-2 4-3.1 6-3.1a8.6 8.6 0 0 1 1.35.125A5.95 5.95 0 0 1 13 13h5V4a2.006 2.006 0 0 0-2-2h-4.18a2.988 2.988 0 0 0-5.64 0H2a2.006 2.006 0 0 0-2 2v14a2.006 2.006 0 0 0 2 2h5.09A6 6 0 0 1 7 19M9 2a1 1 0 1 1-1 1a1.003 1.003 0 0 1 1-1m0 4a3 3 0 1 1-3 3a2.996 2.996 0 0 1 3-3"></svg:path>`,
})
export class EosIconsRoleBindingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsRoleBindingOutlinedIcon],svg[eos-icons-role-binding-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23 19a4 4 0 0 1-4 4h-2v-2h2a2 2 0 0 0 0-4h-2v-2h2a4 4 0 0 1 4 4M9 19a4 4 0 0 1 4-4h2v2h-2a2 2 0 0 0 0 4h2v2h-2a4 4 0 0 1-4-4"></svg:path><svg:path fill="currentColor" d="M14 18h4v2h-4zM9 5a3 3 0 1 0 3 3a3.01 3.01 0 0 0-3-3m0 4a1 1 0 1 1 1-1a1.003 1.003 0 0 1-1 1m-3.69 6A7 7 0 0 1 9 13.88a6 6 0 0 1 .778.064A5.97 5.97 0 0 1 13 13h.254A9.4 9.4 0 0 0 9 11.89c-2.03 0-6 1.07-6 3.58V17h4.349a6 6 0 0 1 1.188-2Z"></svg:path><svg:path fill="currentColor" d="M16 2h-4.18a2.988 2.988 0 0 0-5.64 0H2a2.006 2.006 0 0 0-2 2v14a2.006 2.006 0 0 0 2 2h5.141a3.6 3.6 0 0 1 0-2H2V4h14v9h2V4a2.006 2.006 0 0 0-2-2M9 3.25a.756.756 0 0 1-.75-.75a.75.75 0 0 1 1.5 0a.756.756 0 0 1-.75.75"></svg:path>`,
})
export class EosIconsRoleBindingOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsRotatingGearIcon],svg[eos-icons-rotating-gear-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.43 12.98c.04-.32.07-.64.07-.98s-.03-.66-.07-.98l2.11-1.65c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.3-.61-.22l-2.49 1c-.52-.4-1.08-.73-1.69-.98l-.38-2.65C14.46 2.18 14.25 2 14 2h-4c-.25 0-.46.18-.49.42l-.38 2.65c-.61.25-1.17.59-1.69.98l-2.49-1c-.23-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49.12.64l2.11 1.65c-.04.32-.07.65-.07.98s.03.66.07.98l-2.11 1.65c-.19.15-.24.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1c.52.4 1.08.73 1.69.98l.38 2.65c.03.24.24.42.49.42h4c.25 0 .46-.18.49-.42l.38-2.65c.61-.25 1.17-.59 1.69-.98l2.49 1c.23.09.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.65zM12 15.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5s3.5 1.57 3.5 3.5s-1.57 3.5-3.5 3.5z"><svg:animatetransform attributeName="transform" attributeType="XML" dur="10s" from="0 12 12" repeatCount="indefinite" to="360 12 12" type="rotate"></svg:animatetransform></svg:path>`,
})
export class EosIconsRotatingGearIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsRouteIcon],svg[eos-icons-route-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.016 4.502A2.976 2.976 0 0 0 3.038 7.48c0 2.233 2.978 5.53 2.978 5.53s2.978-3.297 2.978-5.53a2.976 2.976 0 0 0-2.978-2.978m0 4.041A1.063 1.063 0 1 1 7.079 7.48a1.064 1.064 0 0 1-1.063 1.063m15.008 2.753v-4.3a5 5 0 0 0-.204-1.333a4.996 4.996 0 0 0-9.796 1.216v.248l-.01.87v9.952h-.004v.041a2 2 0 0 1-4 0l.004-.037H7.01V16.01h-2v2h.002a3.998 3.998 0 0 0 7.996-.005h.002v-.982h.005V8.997l.01-1.87V6.88a3.001 3.001 0 0 1 6 .123v4.275a1.999 1.999 0 1 0 2 .018"></svg:path>`,
})
export class EosIconsRouteIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSandboxIcon],svg[eos-icons-sandbox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="9.54" cy="8.99" r="1" fill="currentColor"></svg:circle><svg:circle cx="11.04" cy="11.99" r="1" fill="currentColor"></svg:circle><svg:circle cx="8.04" cy="11.99" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M19 9.24V15h-4a3 3 0 0 1-6 0H5V5h9.77l2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7.24Z"></svg:path><svg:path fill="currentColor" d="m17 10.1l-.84-.84l-.26.26l-1.44-1.41l.26-.26l-.78-.78c-.37-.38-.88-.17-1.15.31l-1.17 1.91a2 2 0 0 1 1.49 1.16a1.5 1.5 0 0 1 .6-.13A1.67 1.67 0 0 1 15.39 12l1.25-.74c.5-.26.71-.78.36-1.16"></svg:path><svg:path fill="currentColor" d="m15.87 9.53l.26-.27l5.28-5.27l-1.42-1.42l-5.27 5.28l-.26.26z"></svg:path>`,
})
export class EosIconsSandboxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSatelliteAltIcon],svg[eos-icons-satellite-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m9.74 23.53l-3.78-3.77a.976.976 0 0 1-.95.75a1.003 1.003 0 0 1-1-1a.99.99 0 0 1 .75-.95l-3.51-3.51a6 6 0 0 1 8.49 8.48"></svg:path><svg:path fill="currentColor" d="m22.46 12.45l-2.94-2.94l.86-.86a1.956 1.956 0 0 0 0-2.76L18.9 4.41a1.97 1.97 0 0 0-2.77 0l-.85.85l-2.95-2.94a1.67 1.67 0 0 0-2.36 0L6.2 6.09a1.67 1.67 0 0 0 0 2.36l2.95 2.95l-.15.14a1.95 1.95 0 0 0 0 2.77l.74.74l.74.74a1.955 1.955 0 0 0 2.76 0l.15-.15l2.94 2.94a1.68 1.68 0 0 0 2.37 0l3.76-3.76a1.666 1.666 0 0 0 0-2.37M7.38 7.27l3.77-3.77l2.94 2.95l-3.76 3.76ZM17.52 17.4l-2.95-2.94l3.77-3.77l2.94 2.94Z"></svg:path>`,
})
export class EosIconsSatelliteAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSatelliteAltOutlinedIcon],svg[eos-icons-satellite-alt-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.465 12.45L19.52 9.506l.855-.855a1.954 1.954 0 0 0 0-2.764l-1.48-1.479a1.954 1.954 0 0 0-2.763 0l-.855.855l-2.943-2.944a1.676 1.676 0 0 0-2.367 0L6.2 6.086a1.676 1.676 0 0 0 0 2.367l2.944 2.943l-.148.148a1.954 1.954 0 0 0 0 2.764l.74.739a6 6 0 0 0-8.485 0l3.511 3.512a.986.986 0 0 0-.75.95a1 1 0 0 0 1 1a.986.986 0 0 0 .95-.75l3.774 3.774a6 6 0 0 0 0-8.485l.74.739a1.954 1.954 0 0 0 2.763 0l.148-.148l2.944 2.944a1.676 1.676 0 0 0 2.366 0l3.767-3.767a1.676 1.676 0 0 0 0-2.366M9.359 20.327l-4.901-4.902a4.006 4.006 0 0 1 4.901 4.902M7.385 7.269l3.766-3.766l2.944 2.944l-3.766 3.766Zm4.447 7.045L10.418 12.9l.115-.115l1.184-1.184l3.766-3.766l1.184-1.184l.822-.822l1.414 1.414l-.822.823l-1.184 1.183l-3.766 3.766l-1.183 1.184Zm5.684 3.086l-2.945-2.944l3.767-3.767l2.943 2.944Z"></svg:path>`,
})
export class EosIconsSatelliteAltOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsScientistOutlinedIcon],svg[eos-icons-scientist-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="20" cy="5" r="1" fill="currentColor"></svg:circle><svg:circle cx="21.5" cy="3.5" r=".5" fill="currentColor"></svg:circle><svg:circle cx="20.5" cy="1.5" r=".5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M16 7v1h1l.003 10.031C17 19.712 18 21 19.5 21s2.5-1.207 2.5-3V8h1V7Zm5 8l-.565.424a1.77 1.77 0 0 1-1.05.326H19V15h-1v-2h1v-1h-1v-2h1V9h-1V8h3ZM8 10a2 2 0 1 1-2 2a2.006 2.006 0 0 1 2-2m0 10c2.7 0 5.8 1.29 6 2H2c.23-.72 3.31-2 6-2M8 8a4 4 0 1 0 4 4a4 4 0 0 0-4-4m0 10c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4"></svg:path>`,
})
export class EosIconsScientistOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSecretIcon],svg[eos-icons-secret-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18 9.5A2.492 2.492 0 0 0 13.511 8H10.49a2.436 2.436 0 1 0 .46 1h2.101a2.5 2.5 0 1 0 4.95.5M20 5h-3V2a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v3H4v1h16ZM5 17H4a4 4 0 0 0-4 4v3h8l-1-1l2-2Zm15 0h-1l-4 4l2 2l-1 1h8v-3a4 4 0 0 0-4-4m-9 3h2v4h-2zm1-2l-1 2h2z"></svg:path>`,
})
export class EosIconsSecretIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSecretOutlinedIcon],svg[eos-icons-secret-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m4.172 19l2 2l-1 1H2v-1a2 2 0 0 1 2-2zM5 17H4a4 4 0 0 0-4 4v3h8l-1-1l2-2zm14.828 2H20a2 2 0 0 1 2 2v1h-3.172l-1-1zM19 17l-4 4l2 2l-1 1h8v-3a4 4 0 0 0-4-4Zm-7 1l-1 2v4h2v-4zm5-13V2a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v3H4v1h16V5Zm-2-1H9V2h6Zm.5 3a2.49 2.49 0 0 0-1.989 1H10.49a2.436 2.436 0 1 0 .46 1h2.101a2.5 2.5 0 1 0 2.45-2m-7 3.5a1 1 0 1 1 1-1a1 1 0 0 1-1 1m7 0a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path>`,
})
export class EosIconsSecretOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSecureDataIcon],svg[eos-icons-secure-data-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.269 15.01a4.3 4.3 0 0 1 .78-2h-4.027v-2h7.994v.001a4.9 4.9 0 0 1 1.998.44V3.012a2 2 0 0 0-2.001-2.001H3.016a2 2 0 0 0-2.002 2.001V17.01a2 2 0 0 0 2.002 2.002h9.997v-.801a3 3 0 0 1 .268-1.2H7.013v-2Zm4.744-6h-7.994v-2h7.994Zm-12-6h12v2h-12Zm-2.011 14h-2v-2h2Zm0-12h-2v-2h2Zm2.005 2h2v2h-2Zm.003 6v-2h2v2Zm14.803 4.001v-1.5a2.818 2.818 0 0 0-5.6 0v1.5a1.29 1.29 0 0 0-1.2 1.2v3.5a1.31 1.31 0 0 0 1.2 1.3h5.5a1.31 1.31 0 0 0 1.3-1.2v-3.5a1.31 1.31 0 0 0-1.2-1.3m-1.3 0h-3v-1.5a1.375 1.375 0 0 1 1.5-1.3a1.375 1.375 0 0 1 1.5 1.3Z"></svg:path>`,
})
export class EosIconsSecureDataIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSecureDataOutlinedIcon],svg[eos-icons-secure-data-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21.8 17v-1.5a2.818 2.818 0 0 0-5.6 0V17a1.29 1.29 0 0 0-1.2 1.2v3.5a1.31 1.31 0 0 0 1.2 1.3h5.5a1.31 1.31 0 0 0 1.3-1.2v-3.5a1.31 1.31 0 0 0-1.2-1.3m-4.3-1.5a1.375 1.375 0 0 1 1.5-1.3a1.375 1.375 0 0 1 1.5 1.3V17h-3Z"></svg:path><svg:path fill="currentColor" d="M24 11V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h11v-2H2V2h20v9"></svg:path><svg:path fill="currentColor" d="M6 4H4v2h2zm14 0H8v2h12zm-7 12H8v2h5zm-7 0H4v2h2zm4-8H8v2h2zm10 0h-8v2h8zm-5.192 4H12v2h2.2v-.5a2.26 2.26 0 0 1 .608-1.5M10 12H8v2h2z"></svg:path>`,
})
export class EosIconsSecureDataOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSelfHealingIcon],svg[eos-icons-self-healing-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.048 11.769A8.2 8.2 0 0 1 5.73 5.722L8.167 8.17V2H2l2.276 2.262A10.271 10.271 0 0 0 10.214 22v-2.077a8.22 8.22 0 0 1-7.166-8.154M23 12.283A10.315 10.315 0 0 0 13.786 2v2.077a8.27 8.27 0 0 1 7.166 8.206a8.07 8.07 0 0 1-2.682 5.995l-2.484-2.448V22h6.19l-2.252-2.262A10.12 10.12 0 0 0 23 12.283"></svg:path><svg:path fill="currentColor" d="m12.29 16l-.537-.49c-1.91-1.732-3.172-2.875-3.172-4.277a2.02 2.02 0 0 1 2.04-2.04a2.22 2.22 0 0 1 1.67.775a2.22 2.22 0 0 1 1.669-.775a2.02 2.02 0 0 1 2.04 2.04c0 1.402-1.261 2.545-3.172 4.281Z"></svg:path>`,
})
export class EosIconsSelfHealingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsServiceIcon],svg[eos-icons-service-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 21h2v-6H3zm9.46 1l-2.93-.64l-2.93-.69a.73.73 0 0 1-.43-.26a.7.7 0 0 1-.17-.47v-4a.77.77 0 0 1 .17-.47a.8.8 0 0 1 .43-.26l4.78-.59l4.79-.6l.15.56l.15.55a.93.93 0 0 1-.15.52a.9.9 0 0 1-.4.37l-2 .5l-2 .5l1.62.66l1.63.65l2.27-.64l2.21-.69a.78.78 0 0 1 .58.08a.73.73 0 0 1 .36.46l.19.77l.2.76a.77.77 0 0 1-.08.56a.78.78 0 0 1-.46.35l-3.63 1l-3.63 1a1.4 1.4 0 0 1-.36 0a1.1 1.1 0 0 1-.36.02M9 4L7 6L5 8l2 2l2 2l.7-.7l.7-.7l-1.3-1.3L7.8 8l1.3-1.3l1.3-1.3l-.7-.7zm6 0l-.7.7l-.7.7l1.3 1.3L16.2 8l-1.3 1.3l-1.3 1.3l.7.7l.7.7l2-2l2-2l-2-2z"></svg:path>`,
})
export class EosIconsServiceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsServiceInstanceIcon],svg[eos-icons-service-instance-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 21h2.03v-6H3zm9.45 1l-2.93-.64l-2.93-.64A.76.76 0 0 1 6 20v-4a.7.7 0 0 1 .17-.47a.75.75 0 0 1 .43-.27l4.78-.59l4.79-.67l.15.55l.15.55a1 1 0 0 1-.56.9l-2 .5l-2 .5l1.62.65l1.62.65l2.28-.64l2.22-.66a.73.73 0 0 1 .58.07a.75.75 0 0 1 .36.47l.19.76l.2.77a.74.74 0 0 1-.54.9l-3.63 1l-3.63 1a1.5 1.5 0 0 1-.36.05a1.6 1.6 0 0 1-.37-.02m5.57-13.5l-3.5-2.25L11.02 4v9l3.5-2.25z"></svg:path>`,
})
export class EosIconsServiceInstanceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsServiceInstanceOutlinedIcon],svg[eos-icons-service-instance-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m20.977 19.09l-.388-1.532a.75.75 0 0 0-.356-.466a.76.76 0 0 0-.587-.072l-4.552 1.284L12 17l3.915-1.003a1.9 1.9 0 0 0 .558-.893L16.166 14L8 15H3v6h5l4.455.964a3.2 3.2 0 0 0 .727-.017l7.26-1.954a.76.76 0 0 0 .454-.344a.74.74 0 0 0 .081-.56M6 20H4v-4h2zm6.922.982a.6.6 0 0 1-.138.018a.5.5 0 0 1-.115-.012L8 19.963V16.02l7.329-.908L10 17l4.721 2.232l.317.127l.328-.093l4.316-1.217l.264 1.042ZM9 2v11l8.18-5.5Zm2 3.76l2.6 1.74L11 9.25Z"></svg:path>`,
})
export class EosIconsServiceInstanceOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsServiceOutlinedIcon],svg[eos-icons-service-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9 4L7 6L5 8l2 2l2 2l.7-.7l.7-.7l-1.3-1.3L7.8 8l1.3-1.3l1.3-1.3l-.7-.7zm6 0l-.7.7l-.7.7l1.3 1.3L16.2 8l-1.3 1.3l-1.3 1.3l.7.7l.7.7l2-2l2-2l-2-2zm5.977 15.09l-.388-1.532a.75.75 0 0 0-.356-.466a.76.76 0 0 0-.587-.072l-4.552 1.284L12 17l3.915-1.003a1.9 1.9 0 0 0 .558-.893L16.166 14L8 15H3v6h5l4.455.964a3.2 3.2 0 0 0 .727-.017l7.26-1.954a.76.76 0 0 0 .454-.344a.74.74 0 0 0 .081-.56M6 20H4v-4h2zm6.922.982a.6.6 0 0 1-.138.018a.5.5 0 0 1-.115-.012L8 19.963V16.02l7.329-.908L10 17l4.721 2.232l.317.127l.328-.093l4.316-1.217l.264 1.042Z"></svg:path>`,
})
export class EosIconsServiceOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsStatefulSetIcon],svg[eos-icons-stateful-set-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsStatefulSetOutlinedIcon],svg[eos-icons-stateful-set-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsStorageClassIcon],svg[eos-icons-storage-class-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22 4H2v4h20ZM6 7H4V5h2Zm14.6 7.8A2.09 2.09 0 0 0 19 14h-7.002a1 1 0 0 0-.998.998v6.004a1 1 0 0 0 .998.998H19a1.82 1.82 0 0 0 1.6-.8L23 18ZM11.998 12H19a4.08 4.08 0 0 1 3 1.39V10H2v4h7.184a2.99 2.99 0 0 1 2.814-2M4 13v-2h2v2Zm5 3H2v4h7Zm-5 3v-2h2v2Z"></svg:path>`,
})
export class EosIconsStorageClassIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsSystemImageOutlinedIcon],svg[eos-icons-system-image-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 6v2H7V6Zm-2 4v2h6v-2Zm-3 4v2h5v-2Zm3 4v2h6v-2Zm-4 0v2h2v-2Zm8-4v2h2v-2Zm0-8v2h2V6Zm4 16H5V4h14Zm0-20H5a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V0Z"></svg:path>`,
})
export class EosIconsSystemImageOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsTemplatesOutlinedIcon],svg[eos-icons-templates-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 0H4a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2m0 22H4V2h16Z"></svg:path><svg:path fill="currentColor" d="M6 4h12v2H6zm0 4h7v2H6zm2 12h8l-4-3zm11-1v-6l-5 3zM6 13v6l4-3zm10-1H8l4 3z"></svg:path>`,
})
export class EosIconsTemplatesOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsTroubleshootingIcon],svg[eos-icons-troubleshooting-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsVirtualHostManagerIcon],svg[eos-icons-virtual-host-manager-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.312 18.034L17.297 7.559a1.994 1.994 0 1 0-3.005-2.466L5.984 3.614A1.998 1.998 0 1 0 3 5.7v12.578a1.992 1.992 0 0 0 .694 3.692A2 2 0 0 0 4 22a1.99 1.99 0 0 0 1.717-.99h12.546a1.99 1.99 0 0 0 3.699-.834c.005-.059.018-.116.018-.176a1.996 1.996 0 0 0-1.668-1.966m-14.538 1.06a2 2 0 0 0-.172-.28l3.845-4.917a3.5 3.5 0 0 0 .688.07a3.5 3.5 0 0 0 .949-.147l1.242 1.478A2.5 2.5 0 0 0 12 16.51c0 .038.01.073.011.11a2.494 2.494 0 0 0 2.489 2.39a2.47 2.47 0 0 0 1.664-.647l1.903 1.099c-.006.018-.017.035-.022.054H5.935a2 2 0 0 0-.161-.422m9.225-11.422a1.83 1.83 0 0 0 1.35.288l2.93 10.173a2 2 0 0 0-.279.141l-2.078-1.2a2.5 2.5 0 0 0 .065-.435c.002-.043.013-.084.013-.129a2.49 2.49 0 0 0-3.995-1.992l-.95-1.13a3.485 3.485 0 0 0 1.285-4.322ZM5.904 4.638l8.178 1.455a2 2 0 0 0 .228.824L12.782 8.2a3.446 3.446 0 0 0-4.477-.705zm-1.882 1.35a1.98 1.98 0 0 0 1.282-.476l2.221 2.643a3.46 3.46 0 0 0 .923 5.36l-3.642 4.657a2 2 0 0 0-.784-.17Z"></svg:path>`,
})
export class EosIconsVirtualHostManagerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsVirtualRealityOutlinedIcon],svg[eos-icons-virtual-reality-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.826 10a3.01 3.01 0 0 0-1.955-1.871A3.005 3.005 0 0 0 16 6H8a3.005 3.005 0 0 0-2.871 2.129A3.01 3.01 0 0 0 3.174 10H2v4h1.174a3.01 3.01 0 0 0 1.955 1.871A3.01 3.01 0 0 0 8 18h1.605l1.891-3.275a.582.582 0 0 1 1.008 0L14.396 18H16a3.01 3.01 0 0 0 2.871-2.129A3.01 3.01 0 0 0 20.826 14H22v-4ZM19 13a1 1 0 0 1-1 1h-1v1a1 1 0 0 1-1 1h-.45l-1.314-2.275a2.582 2.582 0 0 0-4.472 0L8.45 16H8a1 1 0 0 1-1-1v-1H6a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h1V9a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v1h1a1 1 0 0 1 1 1Z"></svg:path><svg:path fill="currentColor" d="M15 11H9v-1h6Z"></svg:path>`,
})
export class EosIconsVirtualRealityOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsVolumeBindingIcon],svg[eos-icons-volume-binding-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 19a6 6 0 0 1 6-6h4V3a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v16.001A2 2 0 0 0 4 21h2.349A6 6 0 0 1 6 19m8-17a1 1 0 1 1-1 1a1 1 0 0 1 1-1M9 3a5 5 0 1 1-2 9.578V10H4.422A4.99 4.99 0 0 1 9 3M4 2a1 1 0 1 1-1 1a1 1 0 0 1 1-1m0 18a1 1 0 1 1 1-1a1 1 0 0 1-1 1"></svg:path><svg:circle cx="9" cy="8" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M13 18h4v2h-4z"></svg:path><svg:path fill="currentColor" d="M18 15h-2v2h2a2 2 0 0 1 0 4h-2v2h2a4 4 0 0 0 0-8m-4 6h-2a2 2 0 0 1 0-4h2v-2h-2a4 4 0 0 0 0 8h2Z"></svg:path>`,
})
export class EosIconsVolumeBindingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsVolumeBindingOutlinedIcon],svg[eos-icons-volume-binding-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 18h4v2h-4z"></svg:path><svg:path fill="currentColor" d="M19 15h-2v2h2a2 2 0 0 1 0 4h-2v2h2a4 4 0 0 0 0-8m-6 2h2v-2h-2a4 4 0 0 0 0 8h2v-2h-2a2 2 0 0 1 0-4M6 4a1 1 0 1 1-1-1a1 1 0 0 1 1 1m10 0a1 1 0 1 1-1-1a1 1 0 0 1 1 1M6 20a1 1 0 1 1-1-1a1 1 0 0 1 1 1"></svg:path><svg:path fill="currentColor" d="M9.69 24H3a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v11h-2V2H3v20h4.812a6.04 6.04 0 0 0 1.879 2"></svg:path><svg:path fill="currentColor" d="M14.578 13A4.998 4.998 0 1 0 6 14h3v.54A5.97 5.97 0 0 1 13 13ZM10 13a2 2 0 1 1 2-2a2 2 0 0 1-2 2"></svg:path>`,
})
export class EosIconsVolumeBindingOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[eosIconsVolumeOutlinedIcon],svg[eos-icons-volume-outlined-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 22H5V2h14Zm0-22H5a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2"></svg:path><svg:path fill="currentColor" d="M8 4a1 1 0 1 1-1-1a1 1 0 0 1 1 1m10 0a1 1 0 1 1-1-1a1 1 0 0 1 1 1M8 20a1 1 0 1 1-1-1a1 1 0 0 1 1 1m10 0a1 1 0 1 1-1-1a1 1 0 0 1 1 1M12 6a5 5 0 0 0-5 5a4.94 4.94 0 0 0 1 3h3v1.9a5 5 0 0 0 6-4.9c0-5-5-5-5-5m0 7a2 2 0 1 1 2-2a2 2 0 0 1-2 2"></svg:path>`,
})
export class EosIconsVolumeOutlinedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
