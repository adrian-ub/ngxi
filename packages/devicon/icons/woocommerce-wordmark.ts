...
@Component({
  standalone: true,
  selector: 'svg[deviconWoocommerceWordmarkIcon],svg[devicon-woocommerce-wordmark-icon]',
  host: {
    role: 'img',
