...
@Component({
  standalone: true,
  selector: 'svg[deviconUnifiedmodelinglanguageIcon],svg[devicon-unifiedmodelinglanguage-icon]',
  host: {
    role: 'img',
