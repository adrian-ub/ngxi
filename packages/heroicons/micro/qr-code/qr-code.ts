...
@Component({
  standalone: true,
  selector: 'svg[heroQrCodeMicro],svg[hero-qr-code-micro]',
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns()',
  ...
  template: `<svg:path d="M4.75 4.25a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1Z"></svg:path>
    <svg:path
      fill-rule="evenodd"
      d="M2 3.5A1.5 1.5 0 0 1 3.5 2H6a1.5 1.5 0 0 1 1.5 1.5V6A1.5 1.5 0 0 1 6 7.5H3.5A1.5 1.5 0 0 1 2 6V3.5Zm1.5 0H6V6H3.5V3.5Z"
      clip-rule="evenodd"
    ></svg:path>
    <svg:path d="M4.25 11.25a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0Z"></svg:path>
    <svg:path
      fill-rule="evenodd"
      ...
      clip-rule="evenodd"
    ></svg:path>
    <svg:path d="M11.25 4.25a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1Z"></svg:path>
    <svg:path
      fill-rule="evenodd"
