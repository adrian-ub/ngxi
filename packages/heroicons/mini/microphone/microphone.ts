...
@Component({
  standalone: true,
  selector: 'svg[heroMicrophoneMini],svg[hero-microphone-mini]',
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns()',
  ...
  template: `<svg:path d="M7 4a3 3 0 0 1 6 0v6a3 3 0 1 1-6 0V4Z"></svg:path>
    <svg:path
...
export class HeroMicrophoneMini {
