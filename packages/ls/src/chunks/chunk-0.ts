...
@Component({
  standalone: true,
  selector: 'svg[ls2Icon],svg[ls-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M423 368L156 682h325v72H0l255-299s117-135 128-152s19-47 19-75c0-87-70-158-158-158c-87 0-158 71-158 158c0 26 6 49 17 71H29c-8-23-13-45-13-71C16 103 119 0 244 0c117 0 213 88 226 202c1 8 1 18 1 26c0 53-18 102-48 140"></svg:path>`,
})
export class Ls2Icon {
  readonly viewBox = input("0 0 481 754")
...
@Component({
  standalone: true,
  selector: 'svg[ls3Icon],svg[ls-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M105 192H33C35 87 122 0 228 0s193 87 193 195c0 63-31 119-78 154c67 40 112 113 112 196c0 126-102 227-227 227C105 772 5 676 0 555h72c5 81 73 147 156 147c86 0 155-71 155-157s-69-156-155-156v-71c68 0 122-55 122-123S296 72 228 72s-122 53-123 120"></svg:path>`,
})
export class Ls3Icon {
  readonly viewBox = input("0 0 455 772")
...
@Component({
  standalone: true,
  selector: 'svg[ls5Icon],svg[ls-5-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m203 72l-36 192c20-6 42-9 65-9c137 0 248 112 248 249S369 752 232 752C115 752 27 672 0 562h73c25 71 81 122 160 122c99 0 179-80 179-179c0-98-80-180-179-180c-26 0-53 6-81 14c-30 8-51 14-78 27L144 0h317v72z"></svg:path>`,
})
export class Ls5Icon {
  readonly viewBox = input("0 0 480 752")
  readonly width = input("0.64em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[ls8Icon],svg[ls-8-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M343 349c67 40 112 113 112 196c0 126-102 227-227 227C102 772 0 671 0 545c0-83 44-156 111-196c-47-35-78-91-78-154C33 87 120 0 228 0s193 87 193 195c0 63-30 119-78 154M105 195c0 68 55 123 123 123s122-55 122-123S296 72 228 72s-123 55-123 123m123 507c86 0 155-71 155-157s-69-156-155-156S71 459 71 545s71 157 157 157"></svg:path>`,
})
export class Ls8Icon {
  readonly viewBox = input("0 0 455 772")
  readonly width = input("0.59em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsAimIcon],svg[ls-aim-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAligncenterIcon],svg[ls-aligncenter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M500 147H167c-16 0-29-14-29-28V77c0-14 13-27 29-27h333c14 0 27 13 27 27v42c0 15-13 28-27 28m110 162H55c-15 0-27-12-27-28v-41c0-16 12-27 27-27h555c15 0 28 11 28 27v41c0 16-13 28-28 28m-83 163H139c-16 0-28-13-28-28v-42c0-15 12-28 28-28h388c14 0 28 13 28 28v42c0 15-14 28-28 28M29 546h609c15 0 28 14 28 28v41c0 16-13 29-28 29H29c-16 0-29-13-29-29v-41c0-15 13-28 29-28"></svg:path>`,
})
export class LsAligncenterIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsAlignrightIcon],svg[ls-alignright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M638 147H305c-15 0-27-14-27-28V77c0-14 12-27 27-27h333c15 0 28 13 28 27v42c0 15-13 28-28 28m0 162H83c-15 0-28-12-28-28v-41c0-16 13-27 28-27h555c15 0 28 11 28 27v41c0 16-13 28-28 28m0 163H250c-15 0-28-13-28-28v-42c0-15 13-28 28-28h388c15 0 28 13 28 28v42c0 15-13 28-28 28M29 546h609c15 0 28 14 28 28v41c0 16-13 29-28 29H29c-16 0-29-13-29-29v-41c0-15 13-28 29-28"></svg:path>`,
})
export class LsAlignrightIcon {
  readonly viewBox = input("0 0 666 644")
  readonly width = input("1.04em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsAmazonIcon],svg[ls-amazon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAmpersandIcon],svg[ls-ampersand-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAndroidIcon],svg[ls-android-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAppIcon],svg[ls-app-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAppleIcon],svg[ls-apple-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsAsciitildeIcon],svg[ls-asciitilde-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M508 325v-82c-42 27-70 43-84 49c-14 5-29 8-43 8c-11 0-25-3-39-7s-42-17-81-35c-57-27-101-40-134-40c-15 0-31 2-47 8c-16 5-43 19-80 39v81c37-23 65-37 83-43c17-7 34-10 48-10c10 0 22 2 34 6s41 16 85 36c56 26 100 37 132 37c14 0 30-2 46-8c15-5 43-19 80-39"></svg:path>`,
})
export class LsAsciitildeIcon {
  readonly viewBox = input("0 0 508 614")
...
@Component({
  standalone: true,
  selector: 'svg[lsAtIcon],svg[ls-at-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBUpperCaseIcon],svg[ls-b-upper-case-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0h175c58 0 109 27 141 71c23 30 35 66 35 105s-12 75-35 104c-3 5-7 10-10 15c34 12 63 31 88 58c38 40 61 96 61 155c0 60-23 114-61 155c-41 44-100 72-166 72H0zm72 280h108c55-2 99-48 99-104S235 74 180 71H72zm0 73v310h158c85-1 153-70 153-155s-68-155-153-155z"></svg:path>`,
})
export class LsBUpperCaseIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsBadIcon],svg[ls-bad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M505 122V85h109V15H243l-59 45v319s82 61 118 136c36 76 34 164 34 164h94s4-72 0-129c-5-58-24-129-24-129h260v-82H505v-37h161v-73H505v-37h130v-70zM0 64h142v308H0z"></svg:path>`,
})
export class LsBadIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsBagIcon],svg[ls-bag-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBanIcon],svg[ls-ban-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M651.22 154c98 139 85 334-40 459s-318 137-458 40c-16-12-34-26-49-40c-15-15-28-32-39-49c-98-139-86-334 39-459s319-137 459-40c16 12 33 26 48 40c15 15 29 32 40 49m-522 345l370-370c-104-63-242-50-331 39c-90 90-102 228-39 331m458-280l-370 369c104 63 242 50 331-39c90-90 102-227 39-330"></svg:path>`,
})
export class LsBanIcon {
  readonly viewBox = input("0 0 717 718")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsBellIcon],svg[ls-bell-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBicycleIcon],svg[ls-bicycle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBloggerIcon],svg[ls-blogger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M326 306h-73c-12 0-23-11-23-24c0-12 11-23 23-23h73c13 0 23 11 23 23c0 13-10 24-23 24m-73 98h145c13 0 23 10 23 23s-10 23-23 23H253c-12 0-23-10-23-23s11-23 23-23M98 29h454c54 0 98 44 98 98v454c0 54-44 98-98 98H98c-54 0-98-44-98-98V127c0-54 44-98 98-98m428 403v-96c0-18-5-30-27-30h-17c-18 0-28-11-28-24v-11c0-57-62-117-116-117h-85c-71 0-127 56-127 127v152c0 67 58 121 117 121h161c65 0 122-55 122-122"></svg:path>`,
})
export class LsBloggerIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsBoldIcon],svg[ls-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBookmarkIcon],svg[ls-bookmark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M39 14h495c40 0 71 34 71 75v506c0 50-31 85-77 85H43c-31 0-43-24-43-38V51c0-18 14-37 39-37m95 624h394c22 0 35-16 35-43V89c0-15-12-33-29-33h-47v383l-138-44l-134 44V56h-81zm144-422v37h55v56h37v-56h55v-37h-55v-56h-37v56z"></svg:path>`,
})
export class LsBookmarkIcon {
  readonly viewBox = input("0 0 605 680")
...
@Component({
  standalone: true,
  selector: 'svg[lsBraceleftIcon],svg[ls-braceleft-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M289 0h-28c-29 0-51 2-63 5c-22 6-40 17-54 31c-13 14-24 32-31 56c-6 24-10 64-10 118c-1 55-1 91-2 105c-2 32-7 56-15 73c-8 16-21 30-37 40c-12 7-29 11-49 12v81c25 1 44 8 59 19c16 12 28 28 34 51c6 22 10 63 10 124c0 60 2 100 5 122c4 32 13 57 26 75c14 18 31 32 54 40c15 6 39 8 73 8h28v-77c-33 0-55-3-65-7s-17-9-21-15c-7-10-12-24-14-42c-1-11-2-49-2-114c0-72-8-122-24-154s-43-56-80-71c33-15 57-33 71-56c15-22 26-53 30-94c2-22 3-71 3-149c0-43 7-71 18-84c11-12 33-18 68-18h16z"></svg:path>`,
})
export class LsBraceleftIcon {
  readonly viewBox = input("0 0 289 960")
  readonly width = input("0.31em")
  readonly height = input("1em")
}

@Component({
  standalone: true,
  selector: 'svg[lsBracerightIcon],svg[ls-braceright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBrushIcon],svg[ls-brush-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m680 28l11 12s54 54 5 104c-42 41-89 43-145 79c-67 41-103 100-95 135c15 65 92 118 25 186c-5 4-15 16-19 20c0 0 3 21-20 21c0 0 5 22-20 22L270 455l-5-5l-151-151c0-24 21-21 21-21c0-16 14-19 20-19c0 0 14-15 20-21c67-68 122 11 185 25c36 9 96-27 137-94c35-57 36-104 78-146c50-50 105 5 105 5m-86 29c-19 19-19 51 0 70s52 20 71 1s19-53 0-72s-52-18-71 1M3 453l-3-40l82-82l305 307l-81 83l-41-5l-4-48l-48-4l-3-51l-49-2l-4-49l-48-3l-5-49l-49-4l-3-49z"></svg:path>`,
})
export class LsBrushIcon {
  readonly viewBox = input("0 0 717 721")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsBuffaloIcon],svg[ls-buffalo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsBusIcon],svg[ls-bus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCIcon],svg[ls-c-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m507 242l-56 39c-38-51-98-84-167-84c-70 0-134 34-174 85c-26 34-41 75-41 119s15 85 41 119c40 51 104 85 174 85c69 0 129-33 167-84l56 39c-50 68-131 111-222 111c-92 0-178-44-230-112C20 514 0 459 0 401s20-113 55-158c52-68 138-112 230-112c91 0 172 43 222 111"></svg:path>`,
})
export class LsCIcon {
  readonly viewBox = input("0 0 507 671")
...
@Component({
  standalone: true,
  selector: 'svg[lsCalendarIcon],svg[ls-calendar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 155v476c0 26 22 48 49 48h552c27 0 49-22 49-48V155c0-26-22-48-49-48h-56v-5c0-17-5-36-17-50c-13-13-33-23-62-23c-30 0-50 10-62 23c-13 14-18 33-18 50v5H264v-5c0-17-5-36-17-50c-13-13-33-23-63-23c-29 0-49 10-61 23c-13 14-18 33-18 50v5H49c-27 0-49 22-49 48m66 459V510h117v104zm0-120V390h117v104zm0-120V269h117v105zm87-188v-84c0-16 10-24 31-24c22 0 32 8 32 24v84c0 16-10 24-32 24c-21 0-31-8-31-24m46 428V510h118v104zm0-120V390h118v104zm0-120V269h118v105zm134 240V510h118v104zm0-120V390h118v104zm0-120V269h118v105zm134 240V510h117v104zm0-120V390h117v104zm0-120V269h117v105zm-33-188v-84c0-16 10-24 32-24c20 0 31 8 31 24v84c0 16-10 24-31 24c-22 0-32-8-32-24"></svg:path>`,
})
export class LsCalendarIcon {
  readonly viewBox = input("0 0 650 679")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsCameraIcon],svg[ls-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M585 114h68c46 0 84 37 84 84v364c0 46-38 84-84 84H84c-46 0-84-38-84-84V198c0-47 38-84 84-84h69c17-27 48-66 76-66h279c28 0 60 39 77 66M366 540c103 0 187-84 187-187c0-104-84-188-187-188c-104 0-189 84-189 188c0 103 85 187 189 187m3-300c62 0 112 51 112 113c0 61-50 112-112 112s-113-51-113-112c0-62 51-113 113-113"></svg:path>`,
})
export class LsCameraIcon {
  readonly viewBox = input("0 0 737 646")
...
@Component({
  standalone: true,
  selector: 'svg[lsCarIcon],svg[ls-car-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsChromeIcon],svg[ls-chrome-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCinnamonIcon],svg[ls-cinnamon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCircleIcon],svg[ls-circle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsClearIcon],svg[ls-clear-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M438 167V40c0-23-17-40-39-40h-30c-22 0-39 17-39 40v127c0 22 17 40 39 40h30c22 0 39-18 39-40m-169 24l-90-89c-15-15-41-15-56 0l-21 21c-15 15-15 41 0 56l89 90c15 15 42 15 57 0l21-21c15-15 15-42 0-57m308 78l89-90c15-15 15-41 0-56l-21-21c-15-15-41-15-56 0l-90 89c-15 15-15 42 0 57l21 21c15 15 42 15 57 0M40 438h127c22 0 40-17 40-39v-31c0-22-18-38-40-38H40c-23 0-40 16-40 38v31c0 22 17 39 40 39m561 0h127c23 0 40-17 40-39v-31c0-22-17-38-40-38H601c-22 0-40 16-40 38v31c0 22 18 39 40 39M179 665l90-89c15-15 15-41 0-56l-21-22c-15-15-42-15-57 0l-89 91c-15 15-15 41 0 56l21 20c15 15 41 15 56 0m487-76l-89-91c-15-15-42-15-57 0l-21 22c-15 15-15 41 0 56l90 89c15 15 41 15 56 0l21-20c15-15 15-41 0-56M438 728V601c0-22-17-40-39-40h-30c-22 0-39 18-39 40v127c0 23 17 40 39 40h30c22 0 39-17 39-40"></svg:path>`,
})
export class LsClearIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsClipIcon],svg[ls-clip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCloudIcon],svg[ls-cloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M343 620H171C77 620 0 543 0 449c0-71 43-130 103-156c0-5-1-10-1-15c0-56 47-102 103-102c34 0 64 17 83 42c31-84 112-145 207-145c122 0 220 99 222 220c60 27 102 86 102 156c0 94-77 171-171 171H481V520h81c12 0 16-8 7-17L428 352c-4-4-10-7-16-7s-13 3-17 7L254 503c-8 9-6 17 7 17h82z"></svg:path>`,
})
export class LsCloudIcon {
  readonly viewBox = input("0 0 819 620")
...
@Component({
  standalone: true,
  selector: 'svg[lsCoffeeIcon],svg[ls-coffee-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M397 344c-3-67-7-103-47-147c-51-57-70-112-28-197c11 57 15 108 55 139s73 115 20 205m-75 0c-2-36-4-54-26-79c-27-30-38-59-15-105c6 31 7 58 29 74s41 62 12 110m181 316h182c11 0 15 8 8 17c0 0-71 91-169 91H173L4 677c-7-9-4-17 7-17h180c-25-13-62-70-62-141V369h438v12c14-12 31-18 49-18c25 0 72 26 72 71c0 65-43 89-68 106c0 0-47 37-80 80c-11 19-24 34-37 40m113-270c-16 0-36 7-49 39v83c0 11-1 24-3 35c22-22 48-37 48-37c16-11 48-32 48-73c1-29-26-47-44-47m-411 12h-28v41h28zm0 65h-28v67s8 90 65 117c-35-41-37-88-37-117z"></svg:path>`,
})
export class LsCoffeeIcon {
  readonly viewBox = input("0 0 697 768")
  readonly width = input("0.91em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsCollegeIcon],svg[ls-college-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m390 86l390 156l-390 155L99 281c-18 15-31 39-33 66h7c8 0 14 6 14 14v37c0 8-6 14-14 14h-5l19 194c1 8-5 15-13 15H39c-8 0-14-7-14-15l20-194h-5c-8 0-15-6-15-14v-37c0-8 7-14 15-14h11c2-29 15-54 33-72L0 242zm-11 339l11 4l11-4l214-86l16 177c1 12-7 17-18 12l-84-43c-11-6-29-5-39 1l-81 46c-10 6-28 6-38 0l-81-46c-10-6-28-7-38-1l-85 43c-11 6-19 0-18-12l16-177z"></svg:path>`,
})
export class LsCollegeIcon {
  readonly viewBox = input("0 0 780 621")
  readonly width = input("1.26em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsCommentsIcon],svg[ls-comments-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCookpadIcon],svg[ls-cookpad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCopyIcon],svg[ls-copy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCrownIcon],svg[ls-crown-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsCutIcon],svg[ls-cut-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsDailycalendarIcon],svg[ls-dailycalendar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsDarkIcon],svg[ls-dark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsDashboardIcon],svg[ls-dashboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsDiggIcon],svg[ls-digg-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M132 410H90V297h42zm0-191H0v270h222V104h-90zm131-37h90v-78h-90zm0 307h90V219h-90zm264-79h-42V297h42zM395 525v79h222V219H395v270h132v36zm395-115h-42V297h42zM658 525v79h222V219H658v270h132v36z"></svg:path>`,
})
export class LsDiggIcon {
  readonly viewBox = input("0 0 880 614")
...
@Component({
  standalone: true,
  selector: 'svg[lsDollarIcon],svg[ls-dollar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M263 148v256c65 47 107 89 131 125c24 37 35 73 36 110c2 60-44 175-167 195v119h-71V836C82 822 28 733 0 682l63-37c38 71 81 109 129 119V445c-56-43-93-75-107-94c-26-35-39-73-39-113c0-65 41-155 146-170V0h71v69c79 15 125 77 155 117l-60 45c-22-29-51-68-95-83m-71 202V145c-54 14-70 63-70 90c0 46 29 78 47 95c3 4 12 11 23 20m71 152v257c65-22 88-83 87-118c0-25-8-48-24-72c-14-19-35-42-63-67"></svg:path>`,
})
export class LsDollarIcon {
  readonly viewBox = input("0 0 431 953")
...
@Component({
  standalone: true,
  selector: 'svg[lsDribbbleIcon],svg[ls-dribbble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 161 359 359S556 717 358 717S0 557 0 359S160 0 358 0m0 53c-25 0-48 3-71 9c4 5 61 82 113 178c116-43 160-110 160-111c-53-48-124-76-202-76M227 82C142 122 78 201 59 295c7 1 136 2 282-37c-52-94-110-171-114-176m368 82c-1 1-50 72-171 121c7 15 14 30 20 45c2 5 6 10 8 15c104-13 208 10 213 11c-1-73-27-140-70-192M52 359c0 79 30 151 79 205c0 0 83-150 249-203c4-1 8-2 11-3c-7-17-15-35-24-52c-158 47-309 44-315 44zm477 254l1-1c69-46 117-120 130-205c-6-2-92-28-190-13c40 111 56 201 59 219m-52 27h1c-5-27-22-120-65-232c-1 0-1 1-2 1c-174 60-236 181-240 190l6 7c51 37 113 59 181 59c42 0 83-9 119-25"></svg:path>`,
})
export class LsDribbbleIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsEditIcon],svg[ls-edit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M558 554V425l80-80v235c0 47-39 86-85 86H85c-47 0-85-39-85-86V113c0-47 38-86 85-86h475v1l-80 79H112c-17 0-32 15-32 33v414c0 18 15 32 32 32h414c17 0 32-14 32-32m76-488l85 85l39-39l-85-85zM335 366l84 85l271-271l-84-85zm-60 144l116-31l-85-85z"></svg:path>`,
})
export class LsEditIcon {
  readonly viewBox = input("0 0 758 666")
...
@Component({
  standalone: true,
  selector: 'svg[lsEmphasisIcon],svg[ls-emphasis-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M525 594s34 4 35 4c-4 43-27 110-40 132c-51-1-143-2-222-2H173c-46 0-101 1-173 2v-29l53-5c44-6 49-11 49-87V301c0-75-5-80-49-88l-30-4v-29c45 2 101 3 147 3h203c62 0 116-1 129-3c1 13 7 72 12 127l-36 4c-10-29-23-53-36-65c-18-15-47-25-94-25h-77c-31 0-31 1-31 32v144c0 24 1 25 27 25h66c50 0 61-6 71-45l5-21s35 0 35 1c-2 26-3 56-3 87c0 32 1 62 3 88c0 1-36 1-35 1l-5-21c-10-39-21-46-71-46h-66c-26 0-27 1-27 26v98c0 38 4 64 15 78c13 15 31 22 101 22c83 0 116-3 169-96M340 70c0-39-31-70-70-70c-38 0-70 31-70 70c0 38 32 70 70 70c39 0 70-32 70-70"></svg:path>`,
})
export class LsEmphasisIcon {
  readonly viewBox = input("0 0 560 730")
  readonly width = input("0.77em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsEraserIcon],svg[ls-eraser-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M68 276L322 22c23-23 58-23 81 0l246 246c23 23 23 59 0 82L395 604c-90 90-236 90-327 0c-90-90-90-238 0-328m286 287L109 317c-68 68-68 178 0 246s177 68 245 0"></svg:path>`,
})
export class LsEraserIcon {
  readonly viewBox = input("0 0 667 672")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsEvernoteIcon],svg[ls-evernote-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsExchangeIcon],svg[ls-exchange-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M696.033 490h81c24 0 28 14 11 30l-118 119c-10 11-29 11-40 0l-119-119c-16-16-12-30 12-30h81V196c-4-41-38-72-80-72c-43 0-78 33-80 75v296c-3 62-40 117-92 145c-24 12-50 18-79 18s-54-6-78-18c-53-28-91-83-93-146V204h-80c-24 0-29-13-12-29l118-119c11-11 30-11 40 0l119 119c17 16 12 29-12 29h-80v291c2 42 35 76 78 76s79-36 79-79V199c3-63 39-116 92-144c24-12 51-19 80-19s55 7 80 19c51 27 87 79 92 140z"></svg:path>`,
})
export class LsExchangeIcon {
  readonly viewBox = input("0 0 799 658")
  readonly width = input("1.22em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsExternalIcon],svg[ls-external-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M501 107L167 443l70 71l335-335l62 61c17 17 32 12 32-14V45c0-16-14-31-31-31H454c-26 0-32 15-15 32zm37 465V345h76v253c0 45-37 82-82 82H82c-45 0-82-37-82-82V147c0-45 37-82 82-81h277v76H108c-16 0-31 15-31 31v399c0 16 15 31 31 31h399c16 0 31-15 31-31"></svg:path>`,
})
export class LsExternalIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsFacebookIcon],svg[ls-facebook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M38 14h590c20 0 38 18 38 38v590c0 20-18 38-38 38H38c-20 0-38-18-38-38V52c0-20 18-38 38-38m435 374h92l4-88h-96v-65c0-25 5-39 37-39h56l2-82s-25-4-61-4c-88 0-127 55-127 114v76h-65v88h65v244h93z"></svg:path>`,
})
export class LsFacebookIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsFemaleIcon],svg[ls-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M245.116 76c0-42-34-76-76-76c-41 0-75 34-75 76s34 76 75 76c42 0 76-34 76-76m42 124l50 157c5 13-3 27-16 31c-13 5-27-3-32-16l-27-83c-4-13-16-24-27-24c-10 0-15 11-11 24l58 179c4 13-4 24-18 24h-25v203c0 14-12 25-25 25c-14 0-26-11-26-25V492h-38v203c0 14-11 25-25 25s-25-11-25-25V492h-25c-14 0-22-11-18-24l58-179c4-13-1-24-12-24c-10 0-22 11-27 24l-27 83c-4 13-18 21-31 16c-14-4-21-18-17-31l51-157c4-13 19-24 33-24h169c14 0 28 11 33 24"></svg:path>`,
})
export class LsFemaleIcon {
  readonly viewBox = input("0 0 339 720")
...
@Component({
  standalone: true,
  selector: 'svg[lsFileIcon],svg[ls-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m430 28l141 148c14 15 26 43 26 65v438c0 20-16 38-38 38H38c-20 0-38-18-38-38V38C0 18 18 0 38 0h328c22 0 50 13 64 28M79 651h439c7 0 13-6 13-13V272c0-7-6-13-13-13H361c-7 0-13-6-13-13V79c0-7-5-12-12-12H79c-7 0-12 5-12 12v559c0 7 5 13 12 13m408-467l-63-68c-5-5-9-3-9 4v61c0 6 6 12 12 12h56c7 0 9-4 4-9m-331-58h124c13 0 25 12 25 26v15c0 13-12 25-25 25H156c-14 0-26-12-26-25v-15c0-14 12-26 26-26m0 134h124c13 0 25 12 25 26v15c0 13-12 25-25 25H156c-14 0-26-12-26-25v-15c0-14 12-26 26-26m283 200H156c-14 0-26-11-26-25v-15c0-14 12-25 26-25h283c13 0 26 11 26 25v15c0 14-13 25-26 25m0 137H156c-14 0-26-11-26-24v-16c0-14 12-25 26-25h283c13 0 26 11 26 25v16c0 13-13 24-26 24"></svg:path>`,
})
export class LsFileIcon {
  readonly viewBox = input("0 0 597 717")
  readonly width = input("0.84em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsFirefoxIcon],svg[ls-firefox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsFlagIcon],svg[ls-flag-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M108 699V134c23-14 35-36 35-62c0-39-32-72-71-72C32 0 0 33 0 72c0 26 14 48 37 62v565c0 10 7 18 16 18h37c10 0 18-8 18-18m35-533v324c0 19 10 27 22 18c23-17 43-30 61-39c37-17 63-25 87-26c30 0 53 6 76 17c22 10 42 26 65 41c13 8 29 13 47 14c30 2 72-5 121-45c11-9 20-32 20-49V97c0-19-8-26-20-17c-25 19-48 32-68 38c-41 11-73 9-100-7c-23-15-43-31-65-41c-23-11-46-17-76-17c-11 0-25 3-40 7c-27 8-62 25-108 57c-12 9-22 31-22 49"></svg:path>`,
})
export class LsFlagIcon {
  readonly viewBox = input("0 0 642 717")
  readonly width = input("0.9em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsFlickrIcon],svg[ls-flickr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsFoursquareIcon],svg[ls-foursquare-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m356 538l156-155c11-11 12-29 3-42l151-127v466H0V14h554L400 226l-44-44c-12-12-33-12-45 0l-9 9c-25-40-70-66-120-66c-78 0-140 62-140 140c0 76 60 137 135 140l134 133c12 13 33 13 45 0m-30-88l-86-68c24-12 44-32 57-56c15 20 26 34 27 35c1 2 4 4 7 4s6-1 9-5L592 14h74v160L337 451c-2 1-4 2-5 2c-4 0-6-3-6-3M182 155c60 0 110 49 110 110c0 60-50 109-110 109S73 325 73 265c0-61 49-110 109-110"></svg:path>`,
})
export class LsFoursquareIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsFriendIcon],svg[ls-friend-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M552.664 491c41 23 64 61 60 100c-2 24-1 24-32 28c-19 2-140 3-263 3c-140 0-286-1-297-4c-41-11-17-87 37-123c43-27 130-69 154-74c33-7 37-28 0-91c-8-15-17-58-18-104c-1-74 12-124 77-149c12-4 26-6 39-6c43 0 83 24 100 59c23 47 12 170-12 215c-29 51-26 67 6 75c20 5 86 36 149 71m219-63c32 17 50 48 47 78c-1 18-1 19-25 22c-12 2-75 3-149 3c-13-31-38-59-72-77c-39-22-85-45-120-60c23-11 43-20 52-22c25-6 28-20 0-70c-7-12-15-46-16-82c-1-58 12-98 62-117c10-3 21-5 31-5c33 0 64 18 77 46c17 37 9 133-9 169c-22 40-20 52 5 58c16 4 67 29 117 57"></svg:path>`,
})
export class LsFriendIcon {
  readonly viewBox = input("0 0 819 622")
...
@Component({
  standalone: true,
  selector: 'svg[lsFrustrateIcon],svg[ls-frustrate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGearIcon],svg[ls-gear-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGithubIcon],svg[ls-github-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGlobeIcon],svg[ls-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGoogleIcon],svg[ls-google-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGrabIcon],svg[ls-grab-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M298 14h85v42h-85zM128 56h85v43h-85zm85 43h42V56h43v213h-43v-85h-42zm212-43h85v43h-85v170h-42V56zM85 184V99h43v85zm468-85v85h42v42h-42v85h-43V99zm42 85v-43h43v43zm43 42v-42h42v170h-42zm-468 43h-42v-85h42zm-127 0h85v42H43zM0 396v-85h43v85zm128-42v-43h42v-42h43v127h-43v-42zm467 85v-85h43v127h-43zM85 396v43H43v-43zm43 128H85v-85h43zm425 42v-85h42v85zm-383-42v42h-42v-42zm43 42v43h-43v-43zm297 86v-86h43v128h-43zm-255 42h-42v-85h42z"></svg:path>`,
})
export class LsGrabIcon {
  readonly viewBox = input("0 0 680 694")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsGroupIcon],svg[ls-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsGuillemotleftIcon],svg[ls-guillemotleft-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LsGuillemotleftIcon {
...
@Component({
  standalone: true,
  selector: 'svg[lsGuillemotrightIcon],svg[ls-guillemotright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LsGuillemotrightIcon {
  readonly viewBox = input("0 0 516 614")
  readonly width = input("0.85em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsGumroadIcon],svg[ls-gumroad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M85 566V184c0-20 23-43 42-43h310c14 25 41 43 73 43c47 0 85-39 85-85c0-48-38-85-85-85c-32 0-59 17-73 42H127c-31 0-63 15-88 39c-25 25-39 57-39 89v382c0 32 14 64 39 89c25 24 57 39 88 39h341c31 0 63-15 88-39c25-25 39-57 39-89V354c0-35-14-68-40-92c-24-23-56-36-87-36H298c-34 0-66 14-91 40c-23 24-37 56-37 88v42c0 32 14 64 39 88c25 25 57 40 89 40h11c15 25 42 42 74 42c47 0 85-38 85-85s-38-85-85-85c-32 0-59 17-74 43h-11c-20 0-43-24-43-43v-42c0-20 19-43 43-43h170c19 0 42 19 42 43v212c0 19-23 43-42 43H127c-19 0-42-24-42-43"></svg:path>`,
})
export class LsGumroadIcon {
  readonly viewBox = input("0 0 595 694")
  readonly width = input("0.86em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHatenaIcon],svg[ls-hatena-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsHatenabookmarkIcon],svg[ls-hatenabookmark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M293 390c8 6 12 16 12 31c0 13-4 22-14 28q-13.5 9-48 9h-33v-77h35q34.5 0 48 9m-16-79c-8 5-24 7-48 7h-19v-70h21c23 0 39 3 47 8s13 15 13 28s-5 22-14 27M80 29h490c44 0 80 36 80 80v490c0 44-36 80-80 80H80c-44 0-80-36-80-80V109c0-44 36-80 80-80m453 154h-85v230h85zM384 478c8-14 12-30 12-49q0-39-21-63c-14-15-34-24-58-26c22-6 38-15 48-26q15-18 15-48c0-15-3-29-10-41s-17-22-30-29c-11-6-24-11-40-13c-16-3-43-4-83-4h-96v350h99c40 0 69-1 86-4c18-3 32-7 44-14c15-8 26-19 34-33m139 38c9-9 13-19 13-32c0-12-4-23-13-32q-13.5-12-33-12c-19.5 0-24 4-32 13c-9 8-13 19-13 31c0 13 4 23 13 32s19 13 32 13s24-4 33-13"></svg:path>`,
})
export class LsHatenabookmarkIcon {
  readonly viewBox = input("0 0 650 679")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHeartemptyIcon],svg[ls-heartempty-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M384.022 668c5 0 11-1 15-4c11-7 259-165 344-320c36-66 32-155-9-224c-36-61-96-95-168-95c-99 0-153 53-182 98c-29-45-84-98-182-98c-73 0-132 34-169 95c-41 69-44 158-8 224c84 155 333 313 343 320c5 3 10 4 16 4m-182-583c118 0 148 98 152 117c4 13 16 24 30 24c13 0 26-11 29-24c5-19 35-117 153-117c65 0 100 35 117 66c30 49 33 118 8 164c-67 120-252 250-307 288c-56-38-241-168-307-288c-25-46-22-115 8-164c17-31 52-66 117-66"></svg:path>`,
})
export class LsHeartemptyIcon {
  readonly viewBox = input("0 0 768 668")
  readonly width = input("1.15em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHelpIcon],svg[ls-help-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 161 359 359S556 717 358 717S0 557 0 359S160 0 358 0m-27 470h24c3-61 17-81 74-115c35-22 46-29 59-43c18-19 27-43 27-71c0-71-57-114-150-114c-32 0-57 6-82 15c-50 19-81 59-81 103c0 22 15 33 46 33c26 0 40-11 39-29v-24c0-15 6-41 14-54c10-16 31-27 55-27c45 0 74 36 74 89c0 20-3 39-11 57c-7 14-15 25-39 51c-38 40-49 69-49 114zm13 145c29 0 52-23 52-52s-22-52-52-52c-29 0-51 23-51 52s22 52 51 52"></svg:path>`,
})
export class LsHelpIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHetemlIcon],svg[ls-heteml-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsHomeIcon],svg[ls-home-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m623.352 238l116 106c14 13 10 23-9 23h-87v277c0 19-16 36-35 36h-151V486c0-19-17-36-36-36h-95c-19 0-36 17-36 36v194h-151c-19 0-36-17-36-36V367h-86c-19 0-23-10-9-23l339-308c14-13 38-13 53 0l77 69V50c0-19 17-36 36-36h75c19 0 35 17 35 36z"></svg:path>`,
})
export class LsHomeIcon {
  readonly viewBox = input("0 0 748 680")
  readonly width = input("1.11em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHorizontalIcon],svg[ls-horizontal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M330 129H43v179c-15 4-31 11-43 21V68C0 31 31 0 68 0h237c37 0 68 31 68 68v238h-43zm141 84h69c-3-28-15-54-35-74c-27-27-62-38-96-35V53c47-3 96 13 132 50c31 31 47 69 50 110h67l-92 100zM68 344h552c37 0 67 31 67 68v238c0 37-30 67-67 67H68c-37 0-68-30-68-67V412c0-37 31-68 68-68m66 329h424V387H134zM78 568c20 0 38-17 38-37s-18-37-38-37s-37 17-37 37s17 37 37 37"></svg:path>`,
})
export class LsHorizontalIcon {
  readonly viewBox = input("0 0 687 717")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsHotIcon],svg[ls-hot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M630 379c0-125-65-190-190-190c125 0 190-64 190-189c0 125 64 189 189 189c-125 0-189 65-189 190M345 58c0 227 119 346 346 346c-227 0-346 119-346 346c0-227-118-346-345-346c227 0 345-119 345-346m250 478c0 59 31 91 90 91h1c-60 0-91 31-91 90c0-59-31-90-90-90c59 0 90-32 90-91"></svg:path>`,
})
export class LsHotIcon {
  readonly viewBox = input("0 0 819 750")
  readonly width = input("1.1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsInfoIcon],svg[ls-info-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 161 359 359S556 717 358 717S0 557 0 359S160 0 358 0m-4 132c-10 12-15 26-15 41c0 12 4 22 10 29c7 7 17 11 27 11c14 0 27-6 37-18c9-11 14-27 14-44c0-10-3-19-10-26s-17-11-27-11c-13 0-26 6-36 18m-91 207l12 13c9-10 18-18 24-23q9-6 15-6c3 0 6 1 8 3c1 3 2 6 2 11c0 25-3 41-16 101s-20 104-20 133q0 16.5 6 24c3 5 9 9 17 9c13 0 32-10 54-27c22-18 44-43 68-75l-13-11c-8 10-16 17-22 22c-6 4-11 8-15 8c-3 0-6-3-8-5c-1-3-2-7-2-13c0-4 1-17 5-40c3-23 2-23 8-57c1-10 4-24 7-41c8-51 13-82 13-92c0-9-3-17-6-22c-4-5-10-7-17-7c-12 0-28 9-50 25c-22 17-44 40-70 70"></svg:path>`,
})
export class LsInfoIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsInkIcon],svg[ls-ink-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsInstagramIcon],svg[ls-instagram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsInstapaperIcon],svg[ls-instapaper-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M129 14h408c72 0 129 57 129 129v307c-3 30-18 58-34 67c-18 10-54-3-81 13c-28 16-31 52-49 66c-22 16-40 21-72 24H114C52 620 0 570 0 508V143C0 71 57 14 129 14m256 140h29v-38H254v38h27c10 0 19 9 19 20v285c0 11-9 20-19 20h-27v38h160v-38h-29c-10 0-19-9-19-20V174c0-11 9-20 19-20m167 466H431c114 0 235-72 235-170v58c0 62-52 112-114 112m-438 15h438c62 0 114-52 114-114v13c0 62-52 114-114 114H114C52 648 0 596 0 534v-13c0 62 52 114 114 114m0 26h438c62 0 114-51 114-113v3c0 72-57 129-129 129H129C57 680 0 623 0 551v-3c0 62 52 113 114 113"></svg:path>`,
})
export class LsInstapaperIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsInternetexplorerIcon],svg[ls-internetexplorer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsItalicIcon],svg[ls-italic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsJpaIcon],svg[ls-jpa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsKudakurageIcon],svg[ls-kudakurage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsLaughIcon],svg[ls-laugh-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 155 359 349S556 698 358 698S0 543 0 349S160 0 358 0M138 290l3 1c5 0 10-3 12-8c0-1 11-49 55-49c45 0 55 47 56 49c2 5 6 8 11 8l32-10c3-1 5-3 6-6c2-3 2-6 1-8c-1-4-20-85-106-85c-91 0-105 81-106 84s-1 6 1 9c1 3 4 5 7 6zm437 1l32-10c3-1 5-3 6-6c2-3 2-6 1-8c-1-4-20-85-105-85c-91 0-106 81-107 84s-1 6 1 9c1 3 4 5 7 6l28 9l3 1c5 0 10-3 12-8c0-1 11-49 56-49c44 0 55 47 55 49c2 5 6 8 11 8m-21 157c7-20-4-43-24-51s-325-8-344 0c-20 8-30 31-23 51c32 81 108 134 195 134s164-53 196-134"></svg:path>`,
})
export class LsLaughIcon {
  readonly viewBox = input("0 0 717 698")
  readonly width = input("1.03em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsLightIcon],svg[ls-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M380.297 39v79c0 27-12 40-37 40s-37-13-37-40V39c0-26 12-39 37-39s37 13 37 39m75 104l46-65c15-20 34-24 53-10s21 32 6 54l-46 64c-15 22-33 24-53 10c-19-14-21-31-6-53m-270-64l47 64c15 22 13 39-7 53c-19 15-37 12-52-10l-47-64c-15-22-13-39 7-53c19-15 37-12 52 10m158 124c86 0 156 70 156 156c0 85-70 154-156 154s-156-69-156-154c0-86 70-156 156-156m-292 22l76 24c25 8 34 23 26 47c-7 24-24 31-50 23l-74-24q-37.5-12-27-48c8-23 24-30 49-22m509 24l75-24c26-8 42-1 49 22c8 24-1 40-27 47l-74 25c-25 8-41 1-49-23c-7-24 1-39 26-47m-217 196c48 0 87-39 87-86c0-48-39-87-87-87s-86 39-86 87c0 47 38 86 86 86m-314-23l75-24c25-8 42-2 49 22c8 24-1 39-26 47l-76 25c-25 8-41 1-49-23c-7-24 2-39 27-47m554-24l75 24c25 8 34 23 26 47c-7 24-23 31-49 23l-75-25c-26-8-33-23-26-47c8-24 24-30 49-22m-457 196l47-63c15-22 33-25 52-10c20 14 22 31 7 53l-47 63c-15 22-33 26-53 12c-19-14-21-33-6-55m388-63l46 63c15 22 13 41-6 55s-38 9-53-11l-46-64c-15-22-13-39 6-53c20-14 38-12 53 10m-134 67v79c0 27-12 40-37 40s-37-13-37-40v-79c0-27 12-40 37-40s37 13 37 40"></svg:path>`,
})
export class LsLightIcon {
  readonly viewBox = input("0 0 688 717")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsLineIcon],svg[ls-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsLinkIcon],svg[ls-link-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m333 276l80-81c7-7 15-16 23-26c8-9 17-17 26-24c17-15 37-28 62-28c22 0 41 10 55 23s22 32 22 54c0 9-1 19-4 26c-7 14-13 24-19 32c-3 4-6 8-6 12c0 3 0 6 2 7c11 27 19 50 24 78c3 11 9 16 19 16c4 0 8-1 12-4c8-5 15-13 22-21c4-4 7-8 9-10c36-35 57-85 57-136c0-54-22-102-57-137c-35-34-84-57-136-57S422 21 387 58L250 194c-36 37-56 85-56 136c0 15 6 46 16 75c10 28 23 53 40 53c9 0 28-15 44-32s32-36 32-43c0-5-4-11-8-20c-5-9-7-20-7-33c0-20 8-40 22-54m-3 384l137-136c36-35 56-86 56-137c0-15-6-45-16-74c-9-28-23-54-40-54c-7 0-28 16-43 33c-17 17-33 35-33 42c0 5 3 13 8 21c5 9 9 19 9 32c-1 20-9 40-23 56l-81 80c-7 8-15 16-23 25l-25 25c-17 16-38 27-63 27c-42 0-76-33-76-76c0-10 2-19 5-26c6-14 12-24 19-32c3-4 4-8 4-11c0-2-1-4-2-8c-12-27-19-50-24-78c-2-5-3-9-6-11c-3-4-8-5-13-5c-4 0-7 1-11 4c-8 5-16 13-23 21c-3 4-7 7-9 9c-36 36-57 86-57 137c0 53 21 102 57 137c35 35 83 56 136 56c52 0 102-20 137-57"></svg:path>`,
})
export class LsLinkIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsLinkedinIcon],svg[ls-linkedin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsLockIcon],svg[ls-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M468 332h67c9 0 16 8 16 17v352c0 9-7 16-16 16H16c-9 0-16-7-16-16V349c0-9 7-17 16-17h65V168C81 76 140 0 231 0h86c92 0 151 76 151 168zm-302 0h218V176c0-51-42-94-94-94h-31c-51 0-93 43-93 94zm63 283h93l-23-101c16-8 27-25 27-44c0-29-23-51-51-51s-50 22-50 51c0 19 11 36 27 44z"></svg:path>`,
})
export class LsLockIcon {
  readonly viewBox = input("0 0 551 717")
  readonly width = input("0.77em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsLogoutIcon],svg[ls-logout-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 151v391c0 36 15 68 39 93c24 24 55 37 91 37h196v-81H130c-27 0-48-22-48-49V151c0-27 21-48 48-48h196V21H130c-36 0-67 14-91 38c-24 25-39 56-39 92m215 118v156c0 18 16 33 34 33h181v123c0 11 6 20 16 25c4 1 8 1 10 1c7 0 13-2 18-7l235-235c11-9 10-27 0-37L474 94c-14-15-44-6-44 18v124H249c-18 0-34 15-34 33"></svg:path>`,
})
export class LsLogoutIcon {
  readonly viewBox = input("0 0 717 672")
  readonly width = input("1.07em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsLtthonIcon],svg[ls-ltthon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMagicIcon],svg[ls-magic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m304.188 151l-29 93l-28-93l-93-29l93-28l28-94l29 94l93 28zm162-51l-14 47l-16-47l-46-15l46-14l16-46l14 46l46 14zm-457 511l573-556c4-5 10-8 17-8c9-1 18 2 25 9c3 2 7 6 13 11c11 10 23 22 32 34c4 6 6 11 6 16c1 10-2 19-8 25l-573 558c-5 5-11 7-18 8c-9 1-18-2-25-9c-3-3-7-6-13-12c-11-9-23-21-31-34c-4-6-6-12-7-17c-1-10 2-18 9-25m460-404l42 43l133-129l-42-44zm-279 57l-13 46l-14-46l-46-15l46-14l14-47l13 47l48 14zm466-35l15 47l46 14l-46 15l-15 46l-15-46l-46-15l46-14z"></svg:path>`,
})
export class LsMagicIcon {
  readonly viewBox = input("0 0 718 709")
  readonly width = input("1.02em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsMaleIcon],svg[ls-male-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMealIcon],svg[ls-meal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M201 248V14h67v268c0 37-30 68-67 68v296c0 18-15 34-34 34h-67c-18 0-33-16-33-34V350c-37 0-67-31-67-68V14h67v234h33V14h67v234zm168 102V114c0-55 45-100 100-100s100 45 100 100v532c0 18-14 34-32 34h-68c-18 0-34-16-34-34V350z"></svg:path>`,
})
export class LsMealIcon {
  readonly viewBox = input("0 0 569 680")
  readonly width = input("0.84em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsMemoIcon],svg[ls-memo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMixiIcon],svg[ls-mixi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMoveIcon],svg[ls-move-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMusicIcon],svg[ls-music-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsMyspaceIcon],svg[ls-myspace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsOUpperCaseIcon],svg[ls-o-upper-case-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M788.018 318c37 211-107 412-324 450c-216 38-421-101-458-312c-38-210 108-411 324-449s421 101 458 311m-391 383c178 0 323-140 323-313s-145-315-323-315s-322 142-322 315s144 313 322 313"></svg:path>`,
})
export class LsOUpperCaseIcon {
  readonly viewBox = input("0 0 794 775")
  readonly width = input("1.03em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsOffIcon],svg[ls-off-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M459 83c118 50 201 167 201 304c0 181-148 330-330 330C149 717 0 568 0 387C0 250 83 133 202 83v111C140 236 98 306 98 387c0 128 104 232 232 232s232-104 232-232c0-81-41-151-103-193zm-74 302V0H275v385z"></svg:path>`,
})
export class LsOffIcon {
  readonly viewBox = input("0 0 660 717")
  readonly width = input("0.93em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsOrdbleIcon],svg[ls-ordble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPaintIcon],svg[ls-paint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M326 337h82V28h-82zm131-87l85 85c14 14 14 36 0 50L275 651c-13 14-36 14-49 0L10 435c-13-13-13-36 0-49l266-267v259h181zm74 24s67 27 67 159c0 82-9 95-9 95s128 14 128-111c0-126-186-143-186-143"></svg:path>`,
})
export class LsPaintIcon {
  readonly viewBox = input("0 0 717 662")
...
@Component({
  standalone: true,
  selector: 'svg[lsPaletteIcon],svg[ls-palette-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M767.074 148c15-50-112-130-227-135c-223-9-515 108-539 365c-18 206 194 312 350 312c157 0 306-121 322-187c16-68-143-49-132-157c16-153 204-125 226-198m-236-35c0 26-20 46-45 46c-26 0-46-20-46-46c0-25 20-45 46-45c25 0 45 20 45 45m-124 24c0 28-22 50-49 50s-49-22-49-50c0-26 22-48 49-48s49 22 49 48m-119 65c0 29-22 52-51 52c-28 0-51-23-51-52c0-27 23-49 51-49c29 0 51 22 51 49m-100 114c0 29-24 53-53 53c-31 0-55-24-55-53c0-31 24-55 55-55c29 0 53 24 53 55m275 192c0 38-32 69-71 69c-38 0-69-31-69-69c0-39 31-72 69-72c39 0 71 33 71 72"></svg:path>`,
})
export class LsPaletteIcon {
  readonly viewBox = input("0 0 769 690")
...
@Component({
  standalone: true,
  selector: 'svg[lsPaperboyIcon],svg[ls-paperboy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M576 288C576 129 447 0 288 0S0 129 0 288c0 118 73 223 181 266c13 34 52 129 52 129c9 22 31 37 55 37s46-15 55-37c0 0 39-95 53-129c107-43 180-148 180-266M288 601c-18-45-42-101-42-101c-2-7-7-12-14-13c-88-25-150-107-150-199c0-114 92-206 206-206s206 92 206 206c0 92-61 174-150 199c-6 1-12 6-14 13c0 0-23 56-42 101"></svg:path>`,
})
export class LsPaperboyIcon {
  readonly viewBox = input("0 0 576 720")
...
@Component({
  standalone: true,
  selector: 'svg[lsParamaterIcon],svg[ls-paramater-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPauseIcon],svg[ls-pause-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 45v604c0 17 14 31 31 31h212c16 0 29-14 29-31V45c0-17-13-31-29-31H31C14 14 0 28 0 45m393 0v604c0 17 14 31 30 31h212c17 0 31-14 31-31V45c0-17-14-31-31-31H423c-16 0-30 14-30 31"></svg:path>`,
})
export class LsPauseIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsPercentIcon],svg[ls-percent-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M62 819L596 0h77L137 819zM174 15c95 0 173 78 173 173c0 96-78 174-173 174C78 362 0 284 0 188C0 93 78 15 174 15m0 285c61 0 111-51 111-112S235 78 174 78S63 127 63 188s50 112 111 112m402 142c96 0 174 78 174 174c0 95-78 174-174 174c-95 0-173-79-173-174c0-96 78-174 173-174m0 285c61 0 111-50 111-111s-50-111-111-111s-111 50-111 111s50 111 111 111"></svg:path>`,
})
export class LsPercentIcon {
  readonly viewBox = input("0 0 750 819")
...
@Component({
  standalone: true,
  selector: 'svg[lsPhoneIcon],svg[ls-phone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPicasaIcon],svg[ls-picasa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M503 271L231 24C271 9 313 0 358 0c51 0 101 12 145 31zM329 163L12 453c-8-30-12-61-12-94C0 221 78 100 193 41zm213 314V51c104 62 175 177 175 308c0 41-8 81-20 118zM171 360v304C105 624 55 564 26 492zm38 155h472c-58 119-181 202-323 202c-53 0-104-13-149-33z"></svg:path>`,
})
export class LsPicasaIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsPinIcon],svg[ls-pin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M217 0c116 0 209 95 209 209c0 115-213 559-213 559S0 324 0 209C0 95 93 0 209 0zm-4 287c52 0 95-44 95-97c0-52-43-95-95-95c-53 0-96 43-96 95c0 53 43 97 96 97"></svg:path>`,
})
export class LsPinIcon {
  readonly viewBox = input("0 0 426 768")
...
@Component({
  standalone: true,
  selector: 'svg[lsPinterestIcon],svg[ls-pinterest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPlaneIcon],svg[ls-plane-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPlaymediaIcon],svg[ls-playmedia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 359c0 99 39 189 105 254c65 65 154 104 253 104s188-39 254-104c65-65 105-155 105-254s-40-189-105-254C546 40 457 0 358 0S170 40 105 105C39 170 0 260 0 359m108 0c0-70 28-132 73-177s107-74 177-74s133 29 178 74c46 45 73 107 73 177s-27 132-73 177c-45 45-107 74-178 74c-70 0-132-29-177-74s-73-107-73-177m153-140v281c0 5 2 9 7 12c2 1 5 2 7 2s6-1 8-2l244-141c4-2 8-6 8-12s-4-10-8-12L283 205c-3-2-9-2-15 0c-5 3-7 9-7 14"></svg:path>`,
})
export class LsPlaymediaIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsPointerIcon],svg[ls-pointer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M298 14v42h-85V14zm0 170V56h42v128h170v42h-42v85h-43v-85h-85v85h-42zm-170 85v42H43v-42zm425 42h-43v-85h85v43h-42zm42 0v-42h43v212h-43zM0 311h43v85H0zm170 85v-42h-42v-43h42V56h43v340zM43 439v-43h42v43zm255 42v-85h42v170h-42zm85 0v-85h42v170h-42zM85 439h43v85H85zm425 0v127h-42V396h42zm43 127v-85h42v85zm-425 0v-42h42v42zm42 43v-43h43v43zm340 43v-86h43v128h-85v-42zm-85 0v-43h43v43zm-127 0h127v42H213v-85h42v43z"></svg:path>`,
})
export class LsPointerIcon {
  readonly viewBox = input("0 0 638 694")
  readonly width = input("0.92em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsPresentIcon],svg[ls-present-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsPrintIcon],svg[ls-print-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsQIcon],svg[ls-q-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M490 210v-97h72v754h-72V558c-53 58-132 96-216 96C122 654 0 534 0 384s122-271 274-271c84 0 163 39 216 97M275 587c115 0 215-90 215-203S390 180 275 180c-114 0-207 91-207 204s93 203 207 203"></svg:path>`,
})
export class LsQIcon {
  readonly viewBox = input("0 0 562 867")
  readonly width = input("0.65em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsQuoteIcon],svg[ls-quote-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m306 106l-26-40C100 187 0 334 0 455c0 117 86 172 159 172c92 0 157-78 157-160c0-69-44-128-103-150c-17-6-33-11-33-40c0-37 27-92 126-171m397 0l-26-40C499 187 397 334 397 455c0 117 88 172 161 172c93 0 159-78 159-160c0-69-45-128-106-150c-17-6-32-11-32-40c0-37 28-92 124-171"></svg:path>`,
})
export class LsQuoteIcon {
  readonly viewBox = input("0 0 717 627")
  readonly width = input("1.15em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsReadabilityIcon],svg[ls-readability-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M210 353v-1c-2-16-7-33-15-47c-7-12-17-23-28-31C181 152 285 58 410 58s228 94 242 216c-10 8-20 19-27 31c-8 14-14 31-16 47v1l-8 77c-57-36-123-55-191-55s-135 19-192 55zm-60 243L91 458c-50-1-91-43-91-93c0-52 42-94 94-94c34 0 64 18 80 46c7 11 11 24 13 38v1l29 269c0 5-4 11-9 11h-48c-5 0-9-6-9-11zm482-240v-1c2-14 6-27 13-38c16-28 46-46 80-46c52 0 94 42 94 94c0 50-41 92-91 93l-58 138v29c0 5-5 11-10 11h-48c-5 0-9-6-9-11zM232 566l-11-111c54-36 119-56 189-56s134 20 188 56l-11 111z"></svg:path>`,
})
export class LsReadabilityIcon {
  readonly viewBox = input("0 0 819 636")
  readonly width = input("1.29em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsRecordIcon],svg[ls-record-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M85 207v-95C85 51 140 0 210 0c69 0 125 51 125 112v95zm337 6v191c-41 112-162 129-162 129v127h133v57H27v-57h134V533S41 516 0 404V213l49-23v174s15 117 161 117s163-117 163-117V190zm-87 27v86c0 61-56 112-125 112c-70 0-125-51-125-112v-86z"></svg:path>`,
})
export class LsRecordIcon {
  readonly viewBox = input("0 0 422 717")
  readonly width = input("0.59em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsRemoveIcon],svg[ls-remove-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 161 359 359S556 717 358 717S0 557 0 359S160 0 358 0m2 411l114 115c14 14 37 14 51 0c13-13 13-36 0-50L411 361l114-115c13-14 13-37 0-50c-14-14-37-14-51 0L360 311L246 196c-14-14-37-14-51 0c-13 13-13 36 0 50l114 115l-114 115c-13 14-13 37 0 50c14 14 37 14 51 0z"></svg:path>`,
})
export class LsRemoveIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsRepeatIcon],svg[ls-repeat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M453 28v95H45c-16 0-30 14-30 31v264l107-95c5-6 10-8 15-11v-67h316v95c0 28 17 36 40 16l161-148c7-6 12-14 12-24c0-9-5-18-12-24L493 12c-23-20-40-12-40 16m197 288l-106 96c-5 4-12 7-16 10v67H213v-96c0-28-17-35-40-15L11 526c-7 6-11 14-11 24c0 9 4 18 11 24l162 147c23 20 40 13 40-15v-95h407c17 0 30-14 30-31z"></svg:path>`,
})
export class LsRepeatIcon {
  readonly viewBox = input("0 0 666 733")
  readonly width = input("0.91em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsRssIcon],svg[ls-rss-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 126V27c39-8 80-13 122-13c300 0 544 244 544 544c0 42-6 83-14 122h-98c11-39 16-80 16-122c0-248-200-449-448-449c-42 0-83 6-122 17m0 228V248c38-15 79-23 122-23c183 0 333 150 333 333c0 43-9 84-24 122H326c22-36 33-78 33-122c0-131-106-238-237-238c-45 0-86 12-122 34m122 82c68 0 122 54 122 122s-54 122-122 122S0 626 0 558s54-122 122-122"></svg:path>`,
})
export class LsRssIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSIcon],svg[ls-s-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m280 220l45-47c-50-49-101-74-151-74c-43 0-78 14-107 41c-28 28-42 62-42 103c0 32 9 59 26 85c17 25 52 49 101 75c45 24 75 42 88 57c13 16 19 35 19 55c0 24-11 45-30 63c-19 17-43 27-71 27c-40 0-78-21-114-61L0 595c18 24 42 43 71 56s58 20 90 20c47 0 85-15 117-46c32-32 48-69 48-113c0-32-10-60-28-86c-18-25-55-51-107-78c-43-22-71-42-84-58s-20-33-20-50c0-20 9-38 25-53c16-14 35-22 58-22c36 0 73 18 110 55"></svg:path>`,
})
export class LsSIcon {
  readonly viewBox = input("0 0 326 671")
  readonly width = input("0.49em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSUpperCaseIcon],svg[ls-s-upper-case-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M63 580L0 617c31 56 93 155 222 155c154 0 211-130 208-197c-1-37-11-74-35-111s-68-79-131-126c-54-40-86-63-95-73c-17-17-46-50-46-96c0-31 21-93 100-93c69 0 108 53 136 90l59-46C384 74 328 0 225 0C95 0 46 102 46 172c0 40 13 78 39 113c15 20 54 54 115 100s103 85 126 118c17 24 24 48 25 73c1 43-36 125-136 125c-57 0-108-40-152-121"></svg:path>`,
})
export class LsSUpperCaseIcon {
  readonly viewBox = input("0 0 431 772")
  readonly width = input("0.56em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSafariIcon],svg[ls-safari-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSepiaIcon],svg[ls-sepia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M49.064 397c-60 42-24 95 26 98c50 4 92 38 80 79c-22 70-8 128 106 70c58-29 97-101 172 30c44 77 156 26 141-62c-7-43 17-69 101-94c153-45 88-172 12-204s-87-87-60-143c26-54-48-141-113-83c-52 46-117 4-118-12s-57-133-90-34c-22 63 13 172-181 59c-123-72-183 113-49 178c63 31 33 77-27 118"></svg:path>`,
})
export class LsSepiaIcon {
  readonly viewBox = input("0 0 769 712")
  readonly width = input("1.09em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsServerIcon],svg[ls-server-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsShoppingIcon],svg[ls-shopping-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M644 480v46H203L126 73H0V28h165l77 452zm73-453l-69 400H287L217 27zM334 150V73h-62l14 77zm46 0h63V73h-63zm109-77v77h64V73zm110 77h50l14-77h-64zm-265 46h-41l11 64h30zm109 64v-64h-63v64zm46 0h64v-64h-64zm152-64h-42v64h31zM334 306h-22l13 75h9zm46 75h63v-75h-63zm173-75h-64v75h64zm46 0v75h10l14-75zM254 553c32 0 56 25 56 56c0 32-24 57-56 57c-31 0-56-25-56-57c0-31 25-56 56-56m343 0c32 0 56 25 56 56c0 32-24 57-56 57s-56-25-56-57c0-31 24-56 56-56"></svg:path>`,
})
export class LsShoppingIcon {
  readonly viewBox = input("0 0 717 666")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsShuffleIcon],svg[ls-shuffle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSkypeIcon],svg[ls-skype-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSleipnirIcon],svg[ls-sleipnir-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSlideshareIcon],svg[ls-slideshare-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M634 66v264c3-2 5-4 8-6c20-14 34 5 21 24c-24 29-70 66-141 95c26 88 12 151-17 190c-17 24-40 38-63 43v1c-50 13-100-11-98-69c0-1-1-71-1-124c-5-1-11-3-18-5v129c4 130-253 90-179-165c-70-29-116-66-141-95c-12-19 1-38 22-24c2 2 5 4 8 6V66C35 30 62 0 96 0h477c34 0 61 30 61 66m-33 283V96c0-43-14-61-54-61H125c-42 0-54 15-54 61v256c90 47 167 38 209 37c18-1 30 3 36 10c2 1 3 2 4 4c8 7 16 13 23 19c2-21 14-35 45-33c43 1 122 10 213-40M244 204c45 0 81 35 81 77s-36 77-81 77c-46 0-82-35-82-77s36-77 82-77m190 0c45 0 82 35 82 77s-37 77-82 77s-82-35-82-77s37-77 82-77"></svg:path>`,
})
export class LsSlideshareIcon {
  readonly viewBox = input("0 0 669 681")
  readonly width = input("0.99em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSmallIcon],svg[ls-small-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M333 83v226c0 10 4 19 11 27c6 7 16 11 27 11h225c32 0 40-17 17-40l-71-73l118-118c3-4 6-9 6-14s-3-9-6-13l-69-69c-4-4-8-6-14-6c-5 0-10 2-14 6L444 139l-71-72c-23-23-40-15-40 16M5 605l70 69c4 3 8 6 14 6c5 0 9-3 13-6l119-119l72 71c23 23 40 16 40-15V385c0-19-16-38-38-38H70c-32 0-41 17-18 40l72 72L5 577c-3 4-5 10-5 15s2 9 5 13"></svg:path>`,
})
export class LsSmallIcon {
  readonly viewBox = input("0 0 666 680")
  readonly width = input("0.98em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSmileIcon],svg[ls-smile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSnsIcon],svg[ls-sns-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m271 392l173 97c25-29 62-47 104-47c76 0 137 62 137 138s-61 137-137 137c-77 0-138-61-138-137c0-8 1-17 2-25l-178-99c-25 25-59 40-97 40C61 496 0 435 0 359s61-137 137-137c39 0 75 16 100 42l177-96c-2-10-4-20-4-30C410 62 471 0 548 0c76 0 137 62 137 138s-61 137-137 137c-39 0-74-15-99-42l-178 95c2 10 3 21 3 31c0 11-1 23-3 33"></svg:path>`,
})
export class LsSnsIcon {
  readonly viewBox = input("0 0 685 717")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSoundcloudIcon],svg[ls-soundcloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsSqaleIcon],svg[ls-sqale-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsStrikeIcon],svg[ls-strike-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 323h700v62H0zm370-64l64 34H179c-18-27-29-60-29-97C149 80 239 1 387 1c33 0 75 4 116 16c13 4 23 6 35 8c8 23 18 78 18 146c0 0-39 3-40 3c-17-52-61-126-134-126c-68 0-104 44-104 95c0 47 41 89 92 116m73 298c0-66-50-111-102-142h223c11 24 18 52 18 85c0 126-103 207-258 207c-93 0-152-26-173-38c-20-23-33-96-33-166l39-3c20 66 89 160 176 160c75 0 110-52 110-103"></svg:path>`,
})
export class LsStrikeIcon {
  readonly viewBox = input("0 0 700 707")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSurpriseIcon],svg[ls-surprise-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 0c198 0 359 155 359 349S556 698 358 698S0 543 0 349S160 0 358 0M119 236c0 58 47 106 105 106s106-48 106-106s-48-105-106-105s-105 47-105 105m374 106c58 0 105-48 105-106s-47-105-105-105s-106 47-106 105s48 106 106 106M271 236c0 26-21 47-47 47s-47-21-47-47s21-47 47-47s47 21 47 47m222-47c26 0 47 21 47 47s-21 47-47 47s-48-21-48-47s22-47 48-47M316 579h84c51 0 94-42 94-94s-43-94-94-94h-84c-51 0-93 42-93 94s42 94 93 94"></svg:path>`,
})
export class LsSurpriseIcon {
  readonly viewBox = input("0 0 717 698")
  readonly width = input("1.03em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsSyncIcon],svg[ls-sync-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsTabezouIcon],svg[ls-tabezou-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1087 158l15-15c7-25-7-19 26-51c4-4-10 10 32-33c28-27 79-7 67 4c-14 15-68 69-117 118l69 69c6 6 6 16 0 22s-17 6-23 0l-19-18c-4 5-8 6-8 13c0 9-4 68-6 85c-4 28-42 84-61 108c-19 23-67 44-105 44c-38-1-82-33-110-53c-28-22-63-62-63-62v284H656V521h-28v152H493V521h-75v156H290V521h-26v152H135V295L0 416s95-193 128-230c30-32 52-44 81-44h461s38-11 54-10c16 2 59 14 75 23c15 9 52 52 63 78c12 26 27 114 38 129c10 15 39 43 57 47s57-11 57-11s23-20 35-49c7-18 8-47 3-71c-3-10-13-17-18-22l-16 16c-6 6-17 6-23 0s-6-16 0-22l69-69l-32-33c-17 13-36 15-58-7l-46-45c-4-5-4-12 0-17c5-5 12-5 17 0l44 44c3 3 8 3 11 0s3-9 0-12l-44-44c-5-5-5-12 0-17c5-4 13-4 18 0v1l44 43c3 3 8 3 11 0s3-8 0-11l-44-44c-5-4-5-13 0-17c4-5 12-5 16 0l47 45c22 22 19 42 7 59zM601 455h81v-29h-81c-22 0-46-1-63-18c-18-18-34-51-34-65l-2-142h-30l2 142c0 25 19 63 43 87c26 26 59 25 84 25m526-211l-40-41c-17 16-33 32-45 44c12-1 32 3 45 3c14 0 30-5 40-6m-410 51c14 0 26-13 26-27s-12-27-26-27s-27 13-27 27s13 27 27 27"></svg:path>`,
})
export class LsTabezouIcon {
  readonly viewBox = input("0 0 1229 677")
  readonly width = input("1.82em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsTimeIcon],svg[ls-time-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M358 717C160 717 0 557 0 359S160 0 358 0s359 161 359 359s-161 358-359 358m0-628C210 89 90 211 90 359s120 268 268 268s270-120 270-268S506 89 358 89m97 407l-127-93c-9-7-18-22-18-34V166c0-11 10-20 22-20h42c11 0 20 9 20 20v160c0 12 9 27 18 34l93 67c9 7 11 21 4 30l-25 34c-7 9-20 11-29 5"></svg:path>`,
})
export class LsTimeIcon {
  readonly viewBox = input("0 0 717 717")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsTrashIcon],svg[ls-trash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M441 99h99c18 0 32 14 32 32v23c0 15-11 29-25 32v475c0 31-26 56-58 56H83c-32 0-57-25-57-56V186c-14-3-26-17-26-32v-23c0-18 15-32 33-32h98V57c0-31 25-57 57-57h196c32 0 57 26 57 57zm-57-49H188c-5 0-8 3-8 7v42h212V57c0-4-3-7-8-7M99 653h375c4 0 7-5 7-9V187H91v457c0 4 3 9 8 9m77-37h-6c-18 0-33-15-33-33V256c0-17 15-31 33-31h6c17 0 32 14 32 31v327c0 18-15 33-32 33m113 0h-5c-18 0-33-15-33-33V256c0-17 15-31 33-31h5c18 0 33 14 33 31v327c0 18-15 33-33 33m113 0h-5c-18 0-32-15-32-33V256c0-17 14-31 32-31h5c18 0 33 14 33 31v327c0 18-15 33-33 33"></svg:path>`,
})
export class LsTrashIcon {
  readonly viewBox = input("0 0 572 717")
  readonly width = input("0.8em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsTroubleIcon],svg[ls-trouble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsTumblrIcon],svg[ls-tumblr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsTwitterIcon],svg[ls-twitter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsUbuntuIcon],svg[ls-ubuntu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsUmbrellaIcon],svg[ls-umbrella-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M288 589V347c10-3 20-4 26-4s16 1 26 4v242c0 42-28 105-105 105c-76 0-104-63-104-105c0-14 11-26 26-26c14 0 26 12 26 26c0 13 5 53 52 53c50 0 53-44 53-53m52-549v28c161 13 288 148 288 312h-4c-12-45-52-69-101-69s-89 24-101 69h-7c-10-36-38-55-75-65c-8-2-17-3-26-3s-18 1-26 3c-37 10-66 29-75 65h-8c-11-45-52-69-100-69c-49 0-90 24-101 69H0C0 216 127 81 288 68V40c0-14 11-26 26-26c14 0 26 12 26 26"></svg:path>`,
})
export class LsUmbrellaIcon {
  readonly viewBox = input("0 0 628 694")
  readonly width = input("0.91em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsUnderlineIcon],svg[ls-underline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsUnlockIcon],svg[ls-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M468 332h67c9 0 16 8 16 17v352c0 9-7 16-16 16H16c-9 0-16-7-16-16V349c0-9 7-17 16-17h368V176c0-51-42-94-94-94h-31c-51 0-93 43-93 94v59H81v-67C81 76 140 0 231 0h86c92 0 151 76 151 168zM228 615h94l-23-101c16-8 27-25 27-44c0-29-23-51-51-51s-50 22-50 51c0 19 11 36 27 44z"></svg:path>`,
})
export class LsUnlockIcon {
  readonly viewBox = input("0 0 551 717")
  readonly width = input("0.77em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsUploadIcon],svg[ls-upload-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M132 273h129v211c0 18 15 33 33 33h129c18 0 34-15 34-33V273h129c17 0 22-9 10-22L382 38c-6-7-15-11-24-11s-17 4-23 11L122 251c-12 13-8 22 10 22M0 422v228c0 10 5 16 16 16h684c11 0 17-6 17-16V422c0-10-8-18-17-18h-65c-9 0-17 9-17 18v145H98V422c0-10-7-18-16-18H16c-9 0-16 9-16 18"></svg:path>`,
})
export class LsUploadIcon {
  readonly viewBox = input("0 0 717 666")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsUserIcon],svg[ls-user-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M646 516c47 26 74 70 71 115c-3 28-3 29-39 33c-23 3-163 5-307 5c-163 0-333-2-346-5c-48-13-22-102 43-143c50-33 152-82 179-88c38-8 43-31 1-106c-10-17-22-68-23-122c-2-86 16-145 91-173c14-5 30-8 45-8c50 0 97 28 116 69c27 55 16 199-13 251c-32 60-29 78 8 88c24 6 99 43 174 84"></svg:path>`,
})
export class LsUserIcon {
  readonly viewBox = input("0 0 718 669")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsVerticalIcon],svg[ls-vertical-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LsVerticalIcon {
  readonly viewBox = input("0 0 717 691")
  readonly width = input("1.04em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsVideoIcon],svg[ls-video-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m496 258l219-126c29-17 53-5 53 30v372c0 34-24 48-53 31L496 438v94c0 35-28 63-63 63H61c-34 0-61-28-61-63V161c0-35 27-62 61-62h372c35 0 63 27 63 62z"></svg:path>`,
})
export class LsVideoIcon {
  readonly viewBox = input("0 0 768 614")
  readonly width = input("1.26em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsVimeoIcon],svg[ls-vimeo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M130 29h390c72 0 130 58 130 130v390c0 72-58 130-130 130H130C58 679 0 621 0 549V159C0 87 58 29 130 29m408 216c4-20 4-41-9-57c-17-21-54-22-79-18c-20 3-89 33-113 106c42-3 64 3 60 49c-2 20-12 41-23 61c-12 23-36 69-66 36c-28-30-26-86-32-124c-4-21-8-48-14-70c-6-18-20-41-37-46c-18-5-40 3-53 11c-42 24-74 59-110 88v3c7 6 9 18 20 19c25 4 48-23 65 5c10 17 13 35 19 54c9 24 16 51 23 79c11 47 26 119 67 136c21 9 53-3 69-13c43-25 77-62 105-100c66-89 103-190 108-219"></svg:path>`,
})
export class LsVimeoIcon {
  readonly viewBox = input("0 0 650 679")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsVkIcon],svg[ls-vk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsVolumeupIcon],svg[ls-volumeup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsWalkingIcon],svg[ls-walking-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M304 73c0-40-33-73-74-73c-40 0-72 33-72 73c0 41 32 73 72 73c41 0 74-32 74-73m-79 644h-65s-3-185 2-207c4-22 47-68 49-86c2-19-17-97-17-97s-43 39-57 46s-124 25-124 25L0 342s105-23 120-35c15-11 55-108 85-120c20-9 74-5 101-5c28 0 120 53 129 65c10 11 65 119 65 119l-50 28l-40-86s-31-26-43-30c-13-4-30-9-33 2c-4 10 23 92 30 115c6 24 39 133 51 156s83 125 83 125l-61 40s-87-118-98-135c-12-17-46-108-46-108s-58 71-63 93c-4 20-5 151-5 151"></svg:path>`,
})
export class LsWalkingIcon {
  readonly viewBox = input("0 0 500 717")
  readonly width = input("0.7em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsWebIcon],svg[ls-web-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsWifiIcon],svg[ls-wifi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M486 476c-43-42-110-42-153 0c-42 42-42 110 0 153c43 42 110 42 153 0c42-43 42-111 0-153m-226-73c-28 28-46 61-55 97l-67-65c14-34 35-64 63-91c115-116 302-116 417 0c27 27 49 57 63 91l-67 65c-9-36-27-69-55-97c-83-83-217-83-299 0M127 270c-26 27-49 56-66 87L0 296c19-30 42-58 68-85c188-188 496-188 684 0c26 27 48 55 67 85l-61 61c-17-31-40-60-66-87c-156-156-409-156-565 0"></svg:path>`,
})
export class LsWifiIcon {
  readonly viewBox = input("0 0 819 661")
  readonly width = input("1.24em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsWindowsIcon],svg[ls-windows-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class LsWindowsIcon {
  readonly viewBox = input("0 0 768 709")
  readonly width = input("1.09em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsWinkIcon],svg[ls-wink-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsWordpressIcon],svg[ls-wordpress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsWrenchIcon],svg[ls-wrench-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m247 245l10-85L122 23c29-14 62-23 97-23c121 0 219 97 219 219c0 18-3 38-7 56l249 248c45 46 49 116 8 157s-112 38-158-8L287 427c-22 7-44 12-68 12C98 439 0 340 0 219c0-34 7-64 20-93l139 141z"></svg:path>`,
})
export class LsWrenchIcon {
  readonly viewBox = input("0 0 717 709")
  readonly width = input("1.02em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[lsYahooIcon],svg[ls-yahoo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsYapcasiaIcon],svg[ls-yapcasia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsYapcasialogoIcon],svg[ls-yapcasialogo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsYelpIcon],svg[ls-yelp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsYoutubeIcon],svg[ls-youtube-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[lsZoominIcon],svg[ls-zoomin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m541 517l176 176l-72 73l-184-185c-45 25-97 39-151 39C139 620 0 481 0 310S139 0 310 0s311 139 311 310c0 80-31 153-80 207M86 310c0 124 100 223 224 223c123 0 224-99 224-223S433 87 310 87C186 87 86 186 86 310m260-35h124v71H346v123h-71V346H152v-71h123V151h71z"></svg:path>`,
})
export class LsZoominIcon {
  readonly viewBox = input("0 0 717 766")
  readonly width = input("0.94em")
  readonly height = input("1em")
}
