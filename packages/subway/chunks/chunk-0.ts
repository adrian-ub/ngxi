...
@Component({
  standalone: true,
  selector: 'svg[subwayAddIcon],svg[subway-add-icon]',
  host: {
    role: 'img',
...
@Component({
  ...
  template: `<svg:path fill="currentColor" d="M490.7 0c-21.3 0-42.7 0-53.3 10.7l-85.3 96H21.3L0 138.7l234.7 74.7l-64 85.3h-96l-32 32l64 21.3v32c.7 11.5 10.7 21.3 21.3 21.3h32l21.3 64l32-32v-96l85.3-64L373.3 512l32-21.3V160l96-85.3C512 64 512 42.7 512 21.3C512 10.7 501.3 0 490.7 0"></svg:path>`,
})
export class SubwayAirplaneModeIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayAdmin2Icon],svg[subway-admin-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M384 256c-70.7 0-128 57.3-128 128s57.3 128 128 128s128-57.3 128-128s-57.3-128-128-128m85.3 149.3H298.7v-42.7h170.7v42.7zm-256-21.3c0-87 65.2-158.7 149.3-169.2v-1.5c5.5-8 21.3-21.3 21.3-42.7s-21.3-42.7-21.3-53.3C362.7 32 319.2 0 256 0c-60.5 0-106.7 32-106.7 117.3c0 10.7-21.3 32-21.3 53.3s15.2 35.4 21.3 42.7c0 0 0 21.3 10.7 53.3c0 10.7 21.3 21.3 32 32c0 10.7 0 21.3-10.7 42.7L64 362.7C21.3 373.3 0 448 0 512h271.4c-35.5-31.3-58.1-77-58.1-128"></svg:path>`,
})
export class SubwayAdmin2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayAlamIcon],svg[subway-alam-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M251 85.3c-117.8 0-213.3 95.5-213.3 213.3C37.7 416.5 133.2 512 251 512s213.3-95.5 213.3-213.3S368.8 85.3 251 85.3M357.7 320h-128V149.3h42.7v128h85.3zm100-171.9c17.1-15.6 27.9-37.8 27.9-62.8c0-47.1-38.2-85.3-85.3-85.3c-35.6 0-66 21.8-78.8 52.7c55.5 15.9 103.1 50 136.2 95.4M180.5 52.7C167.6 21.8 137.2 0 101.7 0C54.5 0 16.3 38.2 16.3 85.3c0 24.9 10.9 47.2 27.9 62.8c33.2-45.4 80.8-79.5 136.3-95.4"></svg:path>`,
})
export class SubwayAlamIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayAdmin1Icon],svg[subway-admin-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayBagIcon],svg[subway-bag-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M421.2 128h-42.7v21.3c0 23.5-19.1 42.7-42.7 42.7c-23.5 0-42.7-19.1-42.7-42.7V128h-85.3v21.3c0 23.5-19.1 42.7-42.7 42.7c-23.5 0-42.7-19.1-42.7-42.7V128H79.9c0 213.3-21.3 384-21.3 384h384c-.1 0-21.4-170.7-21.4-384m-256 42.7c11.8 0 21.3-9.5 21.3-21.3v-42.7c0-35.4 28.6-64 64-64s64 28.6 64 64v42.7c0 11.8 9.5 21.3 21.3 21.3s21.3-9.5 21.3-21.3v-42.7C357.2 47.8 309.4 0 250.5 0S143.8 47.8 143.8 106.7v42.7c.1 11.7 9.6 21.3 21.4 21.3"></svg:path>`,
})
export class SubwayBagIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayBox1Icon],svg[subway-box-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayBrightestIcon],svg[subway-brightest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 192c-35.4 0-64 28.6-64 64s28.6 64 64 64s64-28.6 64-64s-28.6-64-64-64m0-42.7c23.5 0 42.7-19.1 42.7-42.7v-64C298.7 19.1 279.5 0 256 0s-42.7 19.1-42.7 42.7v64c0 23.5 19.2 42.6 42.7 42.6m0 213.4c-23.5 0-42.7 19.1-42.7 42.7v64c0 23.5 19.1 42.7 42.7 42.7c23.5 0 42.7-19.1 42.7-42.7v-64c0-23.6-19.2-42.7-42.7-42.7m213.3-149.4h-64c-23.5 0-42.7 19.1-42.7 42.7c0 23.5 19.1 42.7 42.7 42.7h64c23.5 0 42.7-19.1 42.7-42.7c0-23.5-19.1-42.7-42.7-42.7m-320 42.7c0-23.5-19.1-42.7-42.7-42.7h-64C19.1 213.3 0 232.5 0 256s19.1 42.7 42.7 42.7h64c23.5 0 42.6-19.2 42.6-42.7m242.5 75.4c-16.7-16.6-43.7-16.6-60.4 0c-16.6 16.7-16.6 43.7 0 60.4l45.3 45.3c16.6 16.6 43.7 16.6 60.3 0c16.6-16.7 16.6-43.7 0-60.3zM120.2 180.6c16.7 16.6 43.7 16.6 60.4 0c16.6-16.7 16.6-43.7 0-60.4L135.3 75C118.7 58.3 91.6 58.3 75 75s-16.6 43.7 0 60.3zm271.6 0l45.3-45.3c16.6-16.6 16.6-43.7 0-60.3c-16.7-16.6-43.7-16.6-60.3 0l-45.3 45.3c-16.6 16.7-16.6 43.7 0 60.4c16.6 16.5 43.6 16.5 60.3-.1M120.2 331.4L75 376.7c-16.6 16.6-16.6 43.7 0 60.3c16.7 16.6 43.7 16.6 60.3 0l45.3-45.3c16.6-16.7 16.6-43.7 0-60.4c-16.7-16.5-43.7-16.5-60.4.1"></svg:path>`,
})
export class SubwayBrightestIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayBrushIcon],svg[subway-brush-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M79.1 372.5C59.4 431.9 49.5 451.7 0 451.7c168.2 69.3 197.9-49.5 197.9-49.5l-49.5-49.5s-49.5-9.8-69.3 19.8M504.6 46.1c-14-14-38-3.9-38-3.9c-35 7-229.1 201.8-229.1 201.8l69.3 69.3S501.6 119.2 508.6 84.2c-.1-.1 10-24.2-4-38.1M168.2 333l49.5 49.5L287 333l-69.3-69.3z"></svg:path>`,
})
export class SubwayBrushIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCIcon],svg[subway-c-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M69.8 0C31.3 0 0 31.2 0 69.8s31.3 69.8 69.8 69.8c38.6 0 69.8-31.3 69.8-69.8C139.6 31.2 108.4 0 69.8 0m0 104.7c-19.3 0-34.9-15.6-34.9-34.9s15.6-34.9 34.9-34.9s34.9 15.6 34.9 34.9s-15.6 34.9-34.9 34.9m325.8-11.6c40.9 0 84.4 15.1 116.4 34.9V23.3C480 11.1 442.3 0 395.6 0c-75.3 0-137.8 24.7-185 73.9s-71 114.7-71 193.8c0 74.3 21.2 132.5 63.2 177.1s96.3 67.3 169.5 67.3c56.2 0 104.8-5.8 139.6-23.3V384c-34.9 21.2-74.4 34.9-116.4 34.9c-44 0-78.7-18.1-104.7-46.5s-34.9-56.9-34.9-104.7c0-49.9 7.4-98.8 34.9-128c27.7-29.3 60-46.6 104.8-46.6"></svg:path>`,
})
export class SubwayCIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCainIcon],svg[subway-cain-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCalendarIcon],svg[subway-calendar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M362.7 320H320v42.7h42.7zm0-85.3H320v42.7h42.7zm0-85.4H320V192h42.7zm-85.4 85.4h-42.7v42.7h42.7zm0-85.4h-42.7V192h42.7zm0 170.7h-42.7v42.7h42.7zM448 149.3h-42.7V192H448zm0 85.4h-42.7v42.7H448zm0 85.3h-42.7v42.7H448zm-341.3 85.3H64V448h42.7zm0-85.3H64v42.7h42.7zm170.6 85.3h-42.7V448h42.7zm-85.3 0h-42.7V448H192zM0 0v512h512V0zm469.3 469.3H42.7V128h426.7v341.3zM106.7 234.7H64v42.7h42.7zM192 320h-42.7v42.7H192zm0-170.7h-42.7V192H192zm0 85.4h-42.7v42.7H192zm170.7 170.6H320V448h42.7z"></svg:path>`,
})
export class SubwayCalendarIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCalendar1Icon],svg[subway-calendar-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCalendar3Icon],svg[subway-calendar-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M405.3 0h-42.7v64h42.7zm-256 0h-42.7v64h42.7zm277.4 0v85.3h-85.3V0H170.7v85.3H85.3V0H0v512h512V0zm42.6 469.3H42.7V128h426.7v341.3zm-64-245.3l-42.7-42.7l-149.3 149.4l-64-64l-42.7 42.7L213.3 416z"></svg:path>`,
})
export class SubwayCalendar3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCalendar6Icon],svg[subway-calendar-6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M149.3 0h-42.7v64h42.7zm256 0h-42.7v64h42.7zM148.9 426.7h214.3c33 0 52.3-22.2 35.9-49.4L286 190.9c-16.5-27.2-43.4-27.2-59.9 0L113 377.3c-16.5 27.1 2.9 49.4 35.9 49.4m85.8-192h42.7v106.7h-42.7zm0 128h42.7v42.7h-42.7zM426.7 0v85.3h-85.3V0H170.7v85.3H85.3V0H0v512h512V0zm42.6 469.3H42.7V128h426.7v341.3z"></svg:path>`,
})
export class SubwayCalendar6Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCallIcon],svg[subway-call-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCall1Icon],svg[subway-call-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCall2Icon],svg[subway-call-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCall3Icon],svg[subway-call-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCall4Icon],svg[subway-call-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M331 374.8c-8.2-16.9-18.8-29.2-37.1-21.7l-36.1 13.4c-28.9 13.4-43.3 0-57.8-20.2l-65-147.8c-8.2-16.9-3.9-32.8 14.4-40.3l50.5-20.2c18.3-7.6 15.4-23.4 7.2-40.3L164 17.1c-8.2-16.9-25-21-43.3-13.5c-36.7 15.1-67 38.8-86.6 73.9c-24 42.9-12 102.6-7.2 127.7s21.6 69.1 43.3 114.2c21.7 45.2 40.7 80.7 57.8 100.8c17 20.1 57.8 75.1 108.3 87.4c41.4 10 86.1 1.6 122.7-13.5c18.3-7.5 18.4-23.4 10.2-40.4zM305.3 256c16.3 0 29.6-13.2 29.6-29.6c0-16.3-13.2-29.6-29.6-29.6c-16.3 0-29.6 13.2-29.6 29.6c0 16.3 13.3 29.6 29.6 29.6m78.8-59.2c-16.3 0-29.6 13.2-29.6 29.6c0 16.3 13.2 29.6 29.6 29.6c16.3 0 29.6-13.2 29.6-29.6c-.1-16.3-13.3-29.6-29.6-29.6m78.8 0c-16.3 0-29.6 13.2-29.6 29.6c0 16.3 13.2 29.6 29.6 29.6c16.3 0 29.6-13.2 29.6-29.6c-.1-16.3-13.3-29.6-29.6-29.6"></svg:path>`,
})
export class SubwayCall4Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCameraIcon],svg[subway-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M475.4 121.8H359.6l-12.2-36.6c0-20.2-16.4-36.6-36.6-36.6H201.1c-20.2 0-36.6 16.4-36.6 36.6l-12.2 36.6H36.6C16.4 121.8 0 138.2 0 158.4v219.4c0 20.2 16.4 36.6 36.6 36.6h438.9c20.2 0 36.6-16.4 36.6-36.6V158.4c-.1-20.2-16.5-36.6-36.7-36.6M256 377.8c-60.6 0-109.7-49.1-109.7-109.7S195.4 158.4 256 158.4s109.7 49.1 109.7 109.7c0 60.5-49.1 109.7-109.7 109.7m219.4-182.9c0 10.1-8.2 18.3-18.3 18.3h-18.3c-10.1 0-18.3-8.2-18.3-18.3v-18.3c0-10.1 8.2-18.3 18.3-18.3h18.3c10.1 0 18.3 8.2 18.3 18.3zm-219.4 0c-40.4 0-73.1 32.7-73.1 73.1s32.7 73.1 73.1 73.1s73.1-32.7 73.1-73.1s-32.7-73.1-73.1-73.1"></svg:path>`,
})
export class SubwayCameraIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle1Icon],svg[subway-cercle-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 426.7c-94.3 0-170.7-76.4-170.7-170.7S161.7 85.3 256 85.3S426.7 161.7 426.7 256S350.3 426.7 256 426.7m0-256c-47.1 0-85.3 38.2-85.3 85.3s38.2 85.3 85.3 85.3s85.3-38.2 85.3-85.3s-38.2-85.3-85.3-85.3"></svg:path>`,
})
export class SubwayCercle1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle2Icon],svg[subway-cercle-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle3Icon],svg[subway-cercle-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle5Icon],svg[subway-cercle-5-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle6Icon],svg[subway-cercle-6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCercle8Icon],svg[subway-cercle-8-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCircleIcon],svg[subway-circle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="256" cy="256" r="256" fill="currentColor"></svg:circle>`,
})
export class SubwayCircleIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCloth1Icon],svg[subway-cloth-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCloudIcon],svg[subway-cloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M470.7 306.2c3-11.2 4.7-22.9 4.7-35c0-75.8-61.4-137.1-137.1-137.1c-19.5 0-38 4.1-54.7 11.4c-16.8-39-55.6-66.3-100.7-66.3c-60.6 0-109.7 49.1-109.7 109.7c0 4.1.8 7.9 1.2 11.9C30.5 221.1 0 265.3 0 316.9c0 70.7 57.3 128 128 128h310.9c40.4 0 73.1-32.7 73.1-73.1c0-29-16.9-53.7-41.3-65.6"></svg:path>`,
})
export class SubwayCloudIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCloudDownloadIcon],svg[subway-cloud-download-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M470.7 280.2c3-11.2 4.7-22.9 4.7-35c0-75.8-61.4-137.1-137.1-137.1c-19.5 0-38 4.1-54.7 11.4c-16.8-39-55.6-66.3-100.7-66.3c-60.6 0-109.7 49.1-109.7 109.7c0 4.1.8 7.9 1.2 11.9C30.5 195.1 0 239.3 0 290.9c0 70.7 57.3 128 128 128h310.9c40.4 0 73.1-32.7 73.1-73.1c0-29-16.9-53.7-41.3-65.6M256 364l-91.4-91.4h54.9v-91.4h73.1v91.4h54.9z"></svg:path>`,
})
export class SubwayCloudDownloadIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCloudReloadIcon],svg[subway-cloud-reload-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCloudUploadIcon],svg[subway-cloud-upload-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCoinIcon],svg[subway-coin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 243.2c141.4 0 256-47.8 256-106.7S397.4 29.8 256 29.8S0 77.6 0 136.5s114.6 106.7 256 106.7m0 170.6c-97.7 0-184.1-23.5-238.6-59.8C6.3 366 0 378.9 0 392.5c0 58.9 114.6 106.7 256 106.7s256-47.8 256-106.7c0-13.6-6.3-26.5-17.4-38.4c-54.5 36.2-140.9 59.7-238.6 59.7m0-128c-97.7 0-184.1-23.5-238.6-59.8C6.3 238 0 250.9 0 264.5c0 58.9 114.6 106.7 256 106.7s256-47.8 256-106.7c0-13.6-6.3-26.5-17.4-38.4c-54.5 36.2-140.9 59.7-238.6 59.7"></svg:path>`,
})
export class SubwayCoinIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCoin1Icon],svg[subway-coin-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayCompassIcon],svg[subway-compass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 472.6c-119.6 0-216.6-97-216.6-216.6S136.4 39.4 256 39.4s216.6 97 216.6 216.6s-97 216.6-216.6 216.6m-137.8-78.8l187.1-88.6l88.6-187.1l-187.1 88.6zm167.3-108.3l-118.2 59.1l59.1-118.2z"></svg:path>`,
})
export class SubwayCompassIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayCompass2Icon],svg[subway-compass-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayDeleteIcon],svg[subway-delete-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M42.7 469.3c0 23.5 19.1 42.7 42.7 42.7h341.3c23.5 0 42.7-19.1 42.7-42.7V192H42.7zm320-213.3h42.7v192h-42.7zm-128 0h42.7v192h-42.7zm-128 0h42.7v192h-42.7zm384-170.7h-128V42.7C362.7 19.1 343.5 0 320 0H192c-23.5 0-42.7 19.1-42.7 42.7v42.7h-128C9.5 85.3 0 94.9 0 106.7V128c0 11.8 9.5 21.3 21.3 21.3h469.3c11.8 0 21.3-9.5 21.3-21.3v-21.3c.1-11.8-9.4-21.4-21.2-21.4m-170.7 0H192V42.7h128z"></svg:path>`,
})
export class SubwayDeleteIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayDownIcon],svg[subway-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 512h139.6V372.4H0zm46.5-93.1H93v46.5H46.5zM0 139.6h139.6V0H0zm0 186.2h139.6V186.2H0zm46.5-93.1H93v46.5H46.5zM209.5 0c162.9 93.1 244.4 221.1 58.2 337.5L186.2 256v256h256l-81.5-81.5C605.1 186.2 372.4 0 209.5 0"></svg:path>`,
})
export class SubwayDownIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayDubleCornerArrow4Icon],svg[subway-duble-corner-arrow-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M325.8.1L256 69.9h139.6L256 209.5l46.5 46.5l139.6-139.6V256l69.8-69.8L512 0zM209.5 256L69.9 395.6V256L.1 325.8L0 512l186.2-.1l69.8-69.8H116.4L256 302.5z"></svg:path>`,
})
export class SubwayDubleCornerArrow4Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayEqualIcon],svg[subway-equal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayEqualizer2Icon],svg[subway-equalizer-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M42.7 486.7h42.7v-256H42.7zM469.3 17.3h-42.7v256h42.7zm-384 0H42.7V60h42.7V17.3zm192 0h-42.7v149.3h42.7zM0 188h128v-85.3H0zm21.3-64h85.3v42.7H21.3zm213.4 362.7h42.7V337.3h-42.7zm192 0h42.7V444h-42.7zM384 316v85.3h128V316zm106.7 64h-85.3v-42.7h85.3zM192 294.7h128v-85.3H192zm21.3-64h85.3v42.7h-85.3z"></svg:path>`,
})
export class SubwayEqualizer2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayEuroIcon],svg[subway-euro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M307.5 64.4c31.9 0 69.2 14 95.8 31.9V21.8C376.3 8.9 339.5.5 307.5.5C254.3.5 216.6 14.7 181 45.3s-63.1 71.4-75.8 125.5H62.7v63.9h42.6v42.6H62.7v63.9h42.6c21.3 117.1 95.8 170.3 202.3 170.3c42.6 0 62.8-4.2 95.8-21.3v-74.5c-32.6 20-65.9 31.9-95.8 31.9c-64.2 0-103-34-119.5-106.3l172.7-.1v-63.9H190.4v-42.6h170.3v-63.9H190.4c8.9-33.8 23.8-59.3 46.1-79.4c22.4-20.1 39.1-27 71-27"></svg:path>`,
})
export class SubwayEuroIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayExitIcon],svg[subway-exit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M469.3 469.3H42.7V42.7H256L298.7 0h-256C19.1 0 0 19.1 0 42.7v426.7C0 492.9 19.1 512 42.7 512h426.7c23.6 0 42.7-19.1 42.7-42.7V320l-42.7 42.7v106.6zm-384-42.6C149.1 255.7 234.7 256 362.7 256v85.3L512 192L362.7 42.7V128C85.3 128 85.1 341.1 85.3 426.7"></svg:path>`,
})
export class SubwayExitIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayEyeIcon],svg[subway-eye-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 226v32c128 192 384 192 512 0v-32C384 34 128 34 0 226m256 144c-70.7 0-128-57.3-128-128s57.3-128 128-128s128 57.3 128 128s-57.3 128-128 128m0-200c0-8.3 1.7-16.1 4.3-23.6c-1.5-.1-2.8-.4-4.3-.4c-53 0-96 43-96 96s43 96 96 96s96-43 96-96c0-1.5-.4-2.8-.4-4.3c-7.4 2.6-15.3 4.3-23.6 4.3c-39.8 0-72-32.2-72-72"></svg:path>`,
})
export class SubwayEyeIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayFeedIcon],svg[subway-feed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M58.2 395.6C26 395.6 0 421.7 0 453.8S26 512 58.2 512c32.1 0 58.2-26 58.2-58.2s-26.1-58.2-58.2-58.2M0 0v93.1c231.4 0 418.9 187.5 418.9 418.9H512C512 229.2 282.8 0 0 0m0 186.2v93.1c128.5 0 232.7 104.2 232.7 232.7h93.1c0-180-145.9-325.8-325.8-325.8"></svg:path>`,
})
export class SubwayFeedIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayFolder1Icon],svg[subway-folder-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m0 192l36.6 237.7c0 8 10.3 18.3 18.3 18.3h402.3c8 0 18.3-10.3 18.3-18.3L512 192zm475.4-54.9c0-8-10.3-18.3-18.3-18.3H274.3l-9.1-36.6c-1.3-7.8-10.3-18.3-18.3-18.3h-128c-7.9 0-17 10.4-18.3 18.3l-9.1 36.6H54.9c-7.9 0-18.3 10.3-18.3 18.3v18.3h438.9v-18.3z"></svg:path>`,
})
export class SubwayFolder1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayFolder2Icon],svg[subway-folder-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M475.4 137.1c0-8-10.3-18.3-18.3-18.3H274.3l-9.1-36.6c-1.3-7.8-10.3-18.3-18.3-18.3h-128c-7.9 0-17 10.4-18.3 18.3l-9.1 36.6H54.9c-7.9 0-18.3 10.3-18.3 18.3v18.3h438.9v-18.3zM0 192l36.6 237.7c0 8 10.3 18.3 18.3 18.3h402.3c8 0 18.3-10.3 18.3-18.3L512 192zm256 219.4L164.6 320h54.9v-73.1h73.1V320h54.9z"></svg:path>`,
})
export class SubwayFolder2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayFolder3Icon],svg[subway-folder-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class SubwayFolder3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayGlassIcon],svg[subway-glass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayHurt1Icon],svg[subway-hurt-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M384 29.8c-64 0-96.2 27.6-128 64c-31.8-36.4-64-64-128-64S0 72.5 0 200.5c0 64 64 192 256 298.7c192-106.7 256-234.7 256-298.7c0-128-64-170.7-128-170.7M256 450C81.7 346.6 42.7 235.7 42.7 200.5c0-58.4 14.8-128 85.3-128c44.8 0 66.6 15.9 95.9 49.4l32.1 35.9l32.1-35.9c29.3-33.5 51.1-49.4 95.9-49.4c70.5 0 85.3 69.6 85.3 128c0 35.2-39 146.1-213.3 249.5"></svg:path>`,
})
export class SubwayHurt1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayIdCard1Icon],svg[subway-id-card-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M426.7 64H384v85.3h42.7zM128 64H85.3v85.3H128zm341.3 42.7H448v64h-85.3v-64H149.3v64H64v-64H42.7C19.1 106.7 0 125.8 0 149.3v256C0 428.9 19.1 448 42.7 448h426.7c23.5 0 42.7-19.1 42.7-42.7v-256c-.1-23.5-19.2-42.6-42.8-42.6M192 384H42.7V234.7H192zm149.3-21.3H234.7V320h106.7v42.7zm128-64H234.7V256h234.7v42.7z"></svg:path>`,
})
export class SubwayIdCard1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayImageIcon],svg[subway-image-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m349.1 140.6l-69.8 139.6l-46.5-46.5l-46.5 46.5l-46.5-46.5l-46.7 139.7h325.8zM0 1v512h512V1zm465.5 418.9h-419V47.5h418.9v372.4zM139.6 187.2c25.7 0 46.5-20.9 46.5-46.5c0-25.7-20.9-46.5-46.5-46.5S93.1 115 93.1 140.6c0 25.7 20.8 46.6 46.5 46.6"></svg:path>`,
})
export class SubwayImageIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayJoinCornerArrow3Icon],svg[subway-join-corner-arrow-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M325.8.1L256 69.9h139.6L69.9 395.6V256L.1 325.8L0 512l186.2-.1l69.8-69.8H116.4l325.7-325.7V256l69.8-69.8L512 0z"></svg:path>`,
})
export class SubwayJoinCornerArrow3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayKeyIcon],svg[subway-key-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M373.3 0c-76.6 0-138.7 62.1-138.7 138.7c0 16 2.8 31.2 7.8 45.5L21.3 405.3L0 512h128v-42.7l21.3-21.3l21.3 21.3l42.7-42.7l-21.3-21.3l42.7-42.7L256 384l42.7-42.7l-21.4-21.3l50.5-50.5c14.3 5 29.6 7.8 45.5 7.8c76.6 0 138.7-62.1 138.7-138.7S449.9 0 373.3 0m32 149.3c-23.5 0-42.7-19.1-42.7-42.7S381.8 64 405.3 64S448 83.1 448 106.7s-19.1 42.6-42.7 42.6"></svg:path>`,
})
export class SubwayKeyIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLikeIcon],svg[subway-like-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayLocationIcon],svg[subway-location-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C149.3 0 64 85.3 64 192c0 36.9 11 65.4 30.1 94.3l141.7 215c4.3 6.5 11.7 10.7 20.2 10.7s16-4.3 20.2-10.7l141.7-215C437 257.4 448 228.9 448 192C448 85.3 362.7 0 256 0m0 298.6c-58.9 0-106.7-47.8-106.7-106.8S197.1 85 256 85s106.7 47.8 106.7 106.8S314.9 298.6 256 298.6"></svg:path>`,
})
export class SubwayLocationIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLocation1Icon],svg[subway-location-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C149.3 0 64 85.3 64 192c0 36.9 11 65.4 30.1 94.3l141.7 215c4.3 6.5 11.7 10.7 20.2 10.7s16-4.3 20.2-10.7l141.7-215C437 257.4 448 228.9 448 192C448 85.3 362.7 0 256 0m0 298.6c-58.9 0-106.7-47.8-106.7-106.8S197.1 85 256 85s106.7 47.8 106.7 106.8S314.9 298.6 256 298.6m0-170.6c-35.4 0-64 28.6-64 64s28.6 64 64 64s64-28.6 64-64s-28.6-64-64-64"></svg:path>`,
})
export class SubwayLocation1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLocation2Icon],svg[subway-location-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayLocation3Icon],svg[subway-location-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M240.3 396.8c3.3 5.1 9.1 8.5 15.7 8.5s12.4-3.4 15.8-8.5L382 226.6c14.8-22.9 23.4-48.1 23.4-77.3C405.3 64.9 339 0 256 0S106.7 64.9 106.7 149.3c0 29.2 8.6 54.4 23.4 77.3zM256 64c47.1 0 85.3 38.2 85.3 85.3s-38.2 85.3-85.3 85.3s-85.3-38.2-85.3-85.3S208.9 64 256 64m109.4 259.5L256 469.3L146.6 323.5c-37.4 19.6-61.3 48.9-61.3 81.8C85.3 464.2 161.7 512 256 512s170.7-47.8 170.7-106.7c0-32.9-23.9-62.2-61.3-81.8"></svg:path>`,
})
export class SubwayLocation3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLockIcon],svg[subway-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M418.9 232.7h-23.3V69.8c0-38.6-31.3-69.8-69.8-69.8H186.2c-38.6 0-69.8 31.3-69.8 69.8v162.9H93.1c-12.8 0-23.3 10.4-23.3 23.3v232.7c0 12.9 10.4 23.3 23.3 23.3h325.8c12.8 0 23.3-10.4 23.3-23.3V256c0-12.9-10.4-23.3-23.3-23.3m-69.8 0H162.9V69.8c0-12.9 10.4-23.3 23.3-23.3h139.6c12.8 0 23.3 10.4 23.3 23.3z"></svg:path>`,
})
export class SubwayLockIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLock1Icon],svg[subway-lock-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M418.4 232.7h-23.3v-93.1C395.1 62.5 332.6 0 255.5 0S115.9 62.5 115.9 139.6v93.1H92.6c-12.8 0-23.3 10.4-23.3 23.3v232.7c0 12.9 10.4 23.3 23.3 23.3h325.8c12.8 0 23.3-10.4 23.3-23.3V256c0-12.9-10.5-23.3-23.3-23.3m-69.8 0H162.4v-93.1c0-51.4 41.7-93.1 93.1-93.1s93.1 41.7 93.1 93.1z"></svg:path>`,
})
export class SubwayLock1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayLock2Icon],svg[subway-lock-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M280.9 326V196.9h-78.8V326c-23.4 13.7-39.4 38.8-39.4 67.8c0 43.5 35.3 78.8 78.8 78.8s78.8-35.3 78.8-78.8c0-29-16-54.1-39.4-67.8m39.4-20V78.8C320.3 35.3 285 0 241.5 0s-78.8 35.3-78.8 78.8V306c-24.1 21.6-39.4 52.9-39.4 87.9c0 65.2 52.9 118.2 118.2 118.2c65.2 0 118.2-52.9 118.2-118.2c0-35-15.3-66.3-39.4-87.9m-78.8 186.3c-54.4 0-98.5-44.1-98.5-98.5c0-32.2 15.5-60.7 39.4-78.6V78.8c0-32.6 26.4-59.1 59.1-59.1c32.6 0 59.1 26.4 59.1 59.1v236.4c23.9 18 39.4 46.5 39.4 78.6c0 54.4-44.1 98.5-98.5 98.5"></svg:path>`,
})
export class SubwayLock2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMarkIcon],svg[subway-mark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M213.3 0h-128C38.2 0 0 38.2 0 85.3v128L298.7 512L512 298.7zm-128 128c-23.6 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7S128 61.8 128 85.3S108.9 128 85.3 128"></svg:path>`,
})
export class SubwayMarkIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMark1Icon],svg[subway-mark-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M213.3 0h-128C38.2 0 0 38.2 0 85.3v128L298.7 512L512 298.7zm-128 128c-23.6 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7S128 61.8 128 85.3S108.9 128 85.3 128m85.4 192L320 170.7l42.7 42.7l-149.4 149.3zm85.3 85.3L405.3 256l42.7 42.7L298.7 448z"></svg:path>`,
})
export class SubwayMark1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMark3Icon],svg[subway-mark-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M432.9 0H107.1C94.3 0 83.8 10.4 83.8 23.3V512L270 325.8L456.2 512V23.3c0-12.9-10.4-23.3-23.3-23.3m-46.5 186.2h-93.1v93.1h-46.5v-93.1h-93.1v-46.5h93.1V46.5h46.5v93.1h93.1z"></svg:path>`,
})
export class SubwayMark3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMenuIcon],svg[subway-menu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M186.2 139.6h139.6V0H186.2zM372.4 0v139.6H512V0zM0 139.6h139.6V0H0zm186.2 186.2h139.6V186.2H186.2zm186.2 0H512V186.2H372.4zM0 325.8h139.6V186.2H0zM186.2 512h139.6V372.4H186.2zm186.2 0H512V372.4H372.4zM0 512h139.6V372.4H0z"></svg:path>`,
})
export class SubwayMenuIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMicIcon],svg[subway-mic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M155.7 320.3c2.8 23.3 24.9 42.4 49 42.4h87.8c24.1 0 46.2-19.1 49-42.4l11.7-96.6c2.8-23.3 2.8-61.4 0-84.8l-11.7-96.6C338.6 19 316.5 0 292.4 0h-87.8c-24.1 0-46.2 19.1-49 42.4L144 138.9c-2.8 23.3-2.8 61.5 0 84.8zm263.4-149.6h-42.6c.4 19.5-.3 40.2-2.2 55.6l-11.7 96.6c-4.1 34.3-34.9 61.1-70.2 61.1h-87.8c-35.2 0-66-26.9-70.2-61.1l-11.7-96.6c-1.9-15.4-2.6-36.1-2.2-55.6H77.9c-.4 21.3.4 43.6 2.5 60.7L92.1 328c6.7 55.3 56.1 98.6 112.5 98.6h22.6v42.7h-64V512h170.7v-42.7h-64v-42.7h22.6c56.5 0 105.9-43.4 112.5-98.7l11.7-96.7c2-17 2.8-39.3 2.4-60.5"></svg:path>`,
})
export class SubwayMicIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMoveIcon],svg[subway-move-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 256L405.3 149.3v85.4h-128v-128h85.4L256 0L149.3 106.7h85.4v128h-128v-85.4L0 256l106.7 106.7v-85.4h128v128h-85.4L256 512l106.7-106.7h-85.4v-128h128v85.4z"></svg:path>`,
})
export class SubwayMoveIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMovieIcon],svg[subway-movie-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0v512h512V0zm63.9 490.7H21.3V448H64v42.7zm0-85.3H21.3v-42.7H64v42.7zm0-85.4H21.3v-42.7H64V320zm0-85.3H21.3V192H64v42.7zm0-85.4H21.3v-42.7H64v42.7zm0-85.4H21.3V21.3H64v42.6zm362.8 405.5H85.3V277.3h341.4zm0-234.7H85.3V42.6h341.4zm64 256H448V448h42.7zm0-85.3H448v-42.7h42.7zm0-85.4H448v-42.7h42.7zm0-85.3H448V192h42.7zm0-85.4H448v-42.7h42.7zm0-85.4H448V21.3h42.7z"></svg:path>`,
})
export class SubwayMovieIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMusicIcon],svg[subway-music-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M165 85.3v325.3c-9.7-3.3-20.5-5.3-32-5.3c-41.2 0-74.7 23.9-74.7 53.3c0 29.5 33.4 53.3 74.7 53.3c41.2 0 74.7-23.9 74.7-53.3c0-3.6-.5-7.2-1.5-10.7h1.5V179.8L421 118.9v227.8c-9.7-3.3-20.5-5.3-32-5.3c-41.2 0-74.7 23.9-74.7 53.3c0 29.5 33.4 53.3 74.7 53.3c41.2 0 74.7-23.9 74.7-53.3c0-3.4-.5-6.7-1.4-10l1.4-.7V0z"></svg:path>`,
})
export class SubwayMusicIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayMuskIcon],svg[subway-musk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayNetwarkIcon],svg[subway-netwark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 247.2c-57.1 0-106.1 34-128.2 82.9l41.9 41.9c7.5-40.9 43.2-72 86.3-72s78.8 31.1 86.3 72l41.9-41.9c-22.1-48.9-71.1-82.9-128.2-82.9m0-175.9C150.6 71.3 57.5 123 0 202.2l37.6 37.6C85.1 170 165.2 124.1 256 124.1S426.9 170 474.4 239.9l37.6-37.6c-57.5-79.3-150.6-131-256-131m0 88c-81.1 0-152.3 42.4-192.8 106.1l38.4 38.4C131.4 249.1 189.3 212 256 212s124.6 37.1 154.5 91.7l38.4-38.4c-40.6-63.6-111.8-106-192.9-106m0 175.8c-29.1 0-52.8 23.6-52.8 52.8c0 29.1 23.6 52.8 52.8 52.8c29.1 0 52.8-23.6 52.8-52.8c0-29.1-23.7-52.8-52.8-52.8"></svg:path>`,
})
export class SubwayNetwarkIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayParagraph2Icon],svg[subway-paragraph-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 462h256v-64H0zm0-106.7h512v-64H0zm256-170.6H0v64h256zM0 78v64h512V78z"></svg:path>`,
})
export class SubwayParagraph2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayParagraph8Icon],svg[subway-paragraph-8-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 351.3h85.3v-64H0zM0 138h85.3V74H0zm0 320h85.3v-64H0zm0-213.3h85.3v-64H0zM170.7 458H512v-64H170.7zm0-384v64H512V74zm0 170.7H512v-64H170.7zm0 106.6H512v-64H170.7z"></svg:path>`,
})
export class SubwayParagraph8Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayPencilIcon],svg[subway-pencil-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m70.2 337.4l104.4 104.4L441.5 175L337 70.5zM.6 499.8c-2.3 9.3 2.3 13.9 11.6 11.6L151.4 465L47 360.6zM487.9 24.1c-46.3-46.4-92.8-11.6-92.8-11.6c-7.6 5.8-34.8 34.8-34.8 34.8l104.4 104.4s28.9-27.2 34.8-34.8c0 0 34.8-46.3-11.6-92.8"></svg:path>`,
})
export class SubwayPencilIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayPinIcon],svg[subway-pin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayPoundIcon],svg[subway-pound-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayPowerBattonIcon],svg[subway-power-batton-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M334.5 53.1v64c58.3 29 98.5 89 98.5 158.6c0 97.9-79.3 177.2-177.2 177.2S78.5 373.6 78.5 275.7c0-69.6 40.2-129.6 98.5-158.6v-64C85.2 85.6 19.4 172.8 19.4 275.7C19.4 406.2 125.2 512 255.7 512S492 406.2 492 275.7c0-102.9-65.8-190.1-157.5-222.6m-78.8 143.8c21.7 0 39.4-17.7 39.4-39.4V39.4c0-21.7-17.6-39.4-39.4-39.4s-39.4 17.7-39.4 39.4v118.2c0 21.7 17.7 39.3 39.4 39.3"></svg:path>`,
})
export class SubwayPowerBattonIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayPrevious1Icon],svg[subway-previous-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M472.8 90.1L298.6 192.5v-73.9c0-28.4-17.6-41.2-39.2-28.5l-152.8 89.8v-52c0-23.6-19.1-42.7-42.7-42.7H42.7C19.1 85.3 0 104.4 0 128v256c0 23.5 19.1 42.7 42.7 42.7H64c23.5 0 42.7-19.1 42.7-42.7v-51.9l152.8 89.8c21.5 12.7 39.2-.2 39.2-28.5v-74l174.2 102.5c21.5 12.7 39.2-.2 39.2-28.5V118.6c-.1-28.4-17.7-41.2-39.3-28.5"></svg:path>`,
})
export class SubwayPrevious1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayPrintIcon],svg[subway-print-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M384 362.7H128V384h256zM106.7 21.3h192V128h106.7v42.7h21.3v-64L320 0H85.3v170.7h21.3V21.3zM448 192H64c-42.7 0-64 21.3-64 64v128h85.3v128h341.3V384H512V256c0-42.7-21.3-64-64-64M85.3 277.3H42.7v-42.7h42.7v42.7zm320 213.4H106.7V341.3h298.7v149.4zM384 405.3H128v21.3h256zm0 42.7H128v21.3h256z"></svg:path>`,
})
export class SubwayPrintIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRandomIcon],svg[subway-random-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M341.3 28.3v85.3H128c-70.7 0-128 57.3-128 128c0 21.5 5.8 41.4 15.2 59.2L68 263.2c-2.4-6.8-4-13.9-4-21.5c0-35.4 28.7-64 64-64h213.3V263L512 156.3V135zM444 262.8c2.4 6.8 4 13.9 4 21.5c0 35.4-28.6 64-64 64H170.7V263L0 369.7V391l170.7 106.7v-85.3H384c70.7 0 128-57.3 128-128c0-21.5-5.8-41.4-15.2-59.2z"></svg:path>`,
})
export class SubwayRandomIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRectangle1Icon],svg[subway-rectangle-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M46.5 279.3H0v93.1h46.5zM279.3 46.5h93.1V0h-93.1zm0 465.5h93.1v-46.5h-93.1zM46.5 418.9H0V512h93.1v-46.5H46.5zm93.1 93.1h93.1v-46.5h-93.1zM418.9 0v46.5h46.5V93H512V0zm46.6 232.7H512v-93.1h-46.5zm0 232.8H419V512h93v-93.1h-46.5zm0-93.1H512v-93.1h-46.5zM0 232.7h232.7V0H0z"></svg:path>`,
})
export class SubwayRectangle1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRectangle2Icon],svg[subway-rectangle-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M46.5 279.3H0v93.1h46.5zm0 139.6H0V512h93.1v-46.5H46.5zm93.1 93.1h93.1v-46.5h-93.1zM46.5 139.6H0v93.1h46.5zM0 93.1h46.5V46.5H93V0H0zm465.5 372.4H419V512h93v-93.1h-46.5zm0-93.1H512v-93.1h-46.5zM139.6 46.5h93.1V0h-93.1zM279.3 512h93.1v-46.5h-93.1zm0-512v232.7H512V0z"></svg:path>`,
})
export class SubwayRectangle2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRectangle4Icon],svg[subway-rectangle-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayRectangularIcon],svg[subway-rectangular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayRedoIconIcon],svg[subway-redo-icon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 192V21.3l-64.9 64.9C400.3 33.4 332.2 0 256 0C114.6 0 0 114.6 0 256s114.6 256 256 256c70.7 0 134.7-28.6 181-75l-45.3-45.2C357 426.5 309 448 256 448c-106 0-192-85.9-192-192S150 64 256 64c58.5 0 110.4 26.5 145.5 67.8L341.3 192z"></svg:path>`,
})
export class SubwayRedoIconIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRefreshTimeIcon],svg[subway-refresh-time-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class SubwayRefreshTimeIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRemovePlaylistIcon],svg[subway-remove-playlist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M465.5 0H186.2c-25.7 0-46.5 20.9-46.5 46.5v279.3c0 25.7 20.9 46.5 46.5 46.5h279.3c25.7 0 46.5-20.9 46.5-46.5V46.5C512 20.9 491.1 0 465.5 0m-23.3 209.5H209.5V163h232.7zM93.1 325.8V139.6H46.5C20.9 139.6 0 160.5 0 186.2v279.3C0 491.1 20.9 512 46.5 512h279.3c25.7 0 46.5-20.9 46.5-46.5V419H186.2c-51.4-.1-93.1-41.8-93.1-93.2"></svg:path>`,
})
export class SubwayRemovePlaylistIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRoundArrow1Icon],svg[subway-round-arrow-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayRoundArrow2Icon],svg[subway-round-arrow-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayRoundArrow3Icon],svg[subway-round-arrow-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M247.6 393.8c-37.4 0-71.1-15.2-95.9-39.4h95.9l-59.1-59.1H31v157.5L90.1 512V403.6c39.5 42.2 95.2 69 157.5 69c113 0 205.7-86.5 215.6-196.9h-79.8c-9.6 66.7-66.4 118.1-135.8 118.1M405.2 0v108.4c-39.5-42.2-95.2-69-157.5-69C134.6 39.4 42 125.9 32 236.3h79.8c9.6-66.7 66.5-118.2 135.9-118.2c37.4 0 71.1 15.2 95.9 39.4h-95.9l59.1 59.1h157.5V59.1z"></svg:path>`,
})
export class SubwayRoundArrow3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayRoundArrow4Icon],svg[subway-round-arrow-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayRoundArrow6Icon],svg[subway-round-arrow-6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M110.5 131.8C145.6 90.5 197.5 64 256 64c106.1 0 192 85.9 192 192h64C512 114.6 397.4 0 256 0C179.8 0 111.7 33.4 64.9 86.2L0 21.3V192h170.7zm291 248.4c-35.2 41.3-87 67.8-145.5 67.8c-106.1 0-192-85.9-192-192H0c0 141.4 114.6 256 256 256c76.2 0 144.3-33.4 191.1-86.2l64.9 64.9V320H341.3zM213.3 256c0 23.6 19.1 42.7 42.7 42.7s42.7-19.1 42.7-42.7s-19.1-42.7-42.7-42.7s-42.7 19.1-42.7 42.7"></svg:path>`,
})
export class SubwayRoundArrow6Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySettongIcon],svg[subway-settong-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayShareIcon],svg[subway-share-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayShare1Icon],svg[subway-share-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M426.7 341.3c-29.1 0-54.8 14.6-70.2 36.9L167.4 278.1c1.9-7.1 3.3-14.4 3.3-22.1s-1.3-15-3.3-22.1l189.1-100.1c15.4 22.3 41 36.9 70.2 36.9c47.1 0 85.3-38.2 85.3-85.3S473.8 0 426.7 0s-85.3 38.2-85.3 85.3c0 .8.2 1.6.2 2.4l-199 105.4c-15.1-13.8-35.1-22.4-57.2-22.4C38.2 170.6 0 208.9 0 256s38.2 85.3 85.3 85.3c22.1 0 42-8.6 57.2-22.4l199 105.4c0 .9-.2 1.6-.2 2.4c0 47.1 38.2 85.3 85.3 85.3s85.3-38.2 85.3-85.3s-38.1-85.4-85.2-85.4m0-298.6c23.5 0 42.7 19.1 42.7 42.7c0 23.5-19.1 42.7-42.7 42.7c-23.5 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7m-341.4 256c-23.5 0-42.7-19.1-42.7-42.7c0-23.5 19.1-42.7 42.7-42.7c23.5 0 42.7 19.1 42.7 42.7c0 23.5-19.1 42.7-42.7 42.7m341.4 170.6c-23.5 0-42.7-19.1-42.7-42.7c0-23.5 19.1-42.7 42.7-42.7c23.5 0 42.7 19.1 42.7 42.7c-.1 23.6-19.2 42.7-42.7 42.7"></svg:path>`,
})
export class SubwayShare1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayShuffileIcon],svg[subway-shuffile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms1Icon],svg[subway-sms-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M448 0H64C28.6 0 0 28.6 0 64v256c0 35.4 28.6 64 64 64h128l-42.7 128l192-128H448c35.4 0 64-28.6 64-64V64c0-35.4-28.6-64-64-64m-64 213.3H277.3V320h-42.7V213.3H128v-42.7h106.7V64h42.7v106.7H384z"></svg:path>`,
})
export class SubwaySms1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms2Icon],svg[subway-sms-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M448 0H64C28.6 0 0 28.6 0 64v256c0 35.4 28.6 64 64 64h128l-42.7 128l192-128H448c35.4 0 64-28.6 64-64V64c0-35.4-28.6-64-64-64m-64 213.3H128v-42.7h256z"></svg:path>`,
})
export class SubwaySms2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms3Icon],svg[subway-sms-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M448 0H64C28.6 0 0 28.6 0 64v256c0 35.4 28.6 64 64 64h128l-42.7 128l192-128H448c35.4 0 64-28.6 64-64V64c0-35.4-28.6-64-64-64M128 234.7c-23.6 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7s42.7 19.1 42.7 42.7s-19.1 42.7-42.7 42.7m128 0c-23.6 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7s42.7 19.1 42.7 42.7s-19.1 42.7-42.7 42.7m128 0c-23.6 0-42.7-19.1-42.7-42.7s19.1-42.7 42.7-42.7s42.7 19.1 42.7 42.7s-19.1 42.7-42.7 42.7"></svg:path>`,
})
export class SubwaySms3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms5Icon],svg[subway-sms-5-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 85.9 0 192c0 75 57.5 139.8 141.1 171.4L85.3 512l160.5-128.4c3.4.1 6.7.4 10.2.4c141.4 0 256-85.9 256-192S397.4 0 256 0"></svg:path>`,
})
export class SubwaySms5Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms6Icon],svg[subway-sms-6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M257 0C115.6 0 1 85.9 1 192c0 75 57.5 139.8 141.1 171.4L86.3 512l160.5-128.4c3.4.1 6.7.4 10.2.4c141.4 0 256-85.9 256-192S398.4 0 257 0m128 213.3H278.3V320h-42.7V213.3H129v-42.7h106.7V64h42.7v106.7H385z"></svg:path>`,
})
export class SubwaySms6Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySms9Icon],svg[subway-sms-9-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 85.9 0 192c0 75 57.5 139.8 141.1 171.4L85.3 512l160.5-128.4c3.4.1 6.7.4 10.2.4c141.4 0 256-85.9 256-192S397.4 0 256 0m117.3 256L320 309.3l-64-64l-64 64l-53.3-53.3l64-64l-64-64L192 74.7l64 64l64-64l53.3 53.3l-64 64z"></svg:path>`,
})
export class SubwaySms9Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySoundIcon],svg[subway-sound-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwaySound1Icon],svg[subway-sound-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwaySound2Icon],svg[subway-sound-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m376.1 177.3l-16.4 39.4c15.4 6.4 26.2 21.6 26.2 39.4c0 17.7-10.8 32.9-26.2 39.4l16.4 39.4c30.8-12.9 52.5-43.3 52.5-78.8c.1-35.6-21.6-66-52.5-78.8m-288.8-28v213.3h85.3L322 512V0L172.7 149.3z"></svg:path>`,
})
export class SubwaySound2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayStar1Icon],svg[subway-star-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 206.8H315.1L256 9.8l-59.1 196.9H0L157.5 315l-59 187.2L256 403.7l157.5 98.5l-59.1-187.1zM256 354.5l-88.6 59.1l39.4-108.3l-78.8-59.1h98.5l29.5-98.5l29.5 98.5H384l-78.8 59.1l39.4 108.3z"></svg:path>`,
})
export class SubwayStar1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayStepIcon],svg[subway-step-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M217 39.5C95.5 49.5 0 151.1 0 275.2C0 406 106 512 236.8 512c124.1 0 225.7-95.5 235.8-217H217zM256.5 0v255.5H512C502.3 118.7 393.3 9.7 256.5 0"></svg:path>`,
})
export class SubwayStepIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayStopIcon],svg[subway-stop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwaySwitchIcon],svg[subway-switch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M469.3 362.7H42.7C19.1 362.7 0 381.8 0 405.3V448c0 23.5 19.1 42.7 42.7 42.7h426.7c23.5 0 42.7-19.1 42.7-42.7v-42.7c-.1-23.5-19.2-42.6-42.8-42.6M85.3 448H42.7v-42.7h42.7V448zm298.7 0h-21.3v-42.7H384zm42.7 0h-21.3v-42.7h21.3zm42.6 0H448v-42.7h21.3zm0-256H42.7C19.1 192 0 211.1 0 234.7v42.7C0 300.9 19.1 320 42.7 320h426.7c23.5 0 42.7-19.1 42.7-42.7v-42.7c-.1-23.5-19.2-42.6-42.8-42.6m-384 85.3H42.7v-42.7h42.7v42.7zm298.7 0h-21.3v-42.7H384zm42.7 0h-21.3v-42.7h21.3zm42.6 0H448v-42.7h21.3zm0-256H42.7C19.1 21.3 0 40.5 0 64v42.7c0 23.5 19.1 42.7 42.7 42.7h426.7c23.5 0 42.7-19.1 42.7-42.7V64c-.1-23.5-19.2-42.7-42.8-42.7m-384 85.4H42.7V64h42.7v42.7zm298.7 0h-21.3V64H384zm42.7 0h-21.3V64h21.3zm42.6 0H448V64h21.3z"></svg:path>`,
})
export class SubwaySwitchIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwaySymbolIcon],svg[subway-symbol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayTepIcon],svg[subway-tep-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M469.3 77H42.7C19.1 77 0 96.1 0 119.7v298.7C0 441.9 19.1 461 42.7 461h426.7c23.6 0 42.7-19.1 42.7-42.7V119.7C512 96.1 492.9 77 469.3 77M384 354.3H128c-47.1 0-85.3-38.2-85.3-85.3s38.2-85.3 85.3-85.3s85.3 38.2 85.3 85.3c0 15.6-4.5 30.1-11.8 42.7h109c-7.3-12.6-11.8-27-11.8-42.7c0-47.1 38.2-85.3 85.3-85.3s85.3 38.2 85.3 85.3s-38.2 85.3-85.3 85.3"></svg:path>`,
})
export class SubwayTepIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayTimeIcon],svg[subway-time-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m21.3-256v-128h-42.7V320l128-128l-32-32z"></svg:path>`,
})
export class SubwayTimeIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayTime1Icon],svg[subway-time-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m21.3-384h-42.7v192H384v-42.7H277.3z"></svg:path>`,
})
export class SubwayTime1Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayTime2Icon],svg[subway-time-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m21.3-384h-42.7V256l96 96l32-32l-85.3-85.3z"></svg:path>`,
})
export class SubwayTime2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayTime3Icon],svg[subway-time-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m-21.3-234.6L149.3 320l32 32l96-96V85.3h-42.7v149.4z"></svg:path>`,
})
export class SubwayTime3Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayTime4Icon],svg[subway-time-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m-21.3-234.6H128v42.7h149.3v-192h-42.7v149.3z"></svg:path>`,
})
export class SubwayTime4Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayUndoIconIcon],svg[subway-undo-icon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M256 1C179.8 1 111.7 34.4 64.9 87.2L0 22.3V193h170.7l-60.2-60.2C145.6 91.5 197.5 65 256 65c106.1 0 192 85.9 192 192s-85.9 192-192 192c-53 0-101-21.5-135.8-56.2L75 438c46.4 46.3 110.4 75 181 75c141.4 0 256-114.6 256-256S397.4 1 256 1"></svg:path>`,
})
export class SubwayUndoIconIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayUnlikeIcon],svg[subway-unlike-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayUnlockIcon],svg[subway-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M412.4 232.7h-256V69.8c0-12.9 10.4-23.3 23.3-23.3h139.6c12.8 0 23.3 10.4 23.3 23.3v93.1h46.5V69.8c0-38.6-31.3-69.8-69.8-69.8H179.7c-38.6 0-69.8 31.3-69.8 69.8v162.9H86.6c-12.8 0-23.3 10.4-23.3 23.3v232.7c0 12.9 10.4 23.3 23.3 23.3h325.8c12.8 0 23.3-10.4 23.3-23.3V256c0-12.9-10.5-23.3-23.3-23.3"></svg:path>`,
})
export class SubwayUnlockIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayUpIcon],svg[subway-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 512h139.6V372.4H0zm0-186.2h139.6V186.2H0zm46.5-93.1H93v46.5H46.5zM0 139.6h139.6V0H0zm46.5-93.1H93V93H46.5zm314.2 35L442.2 0h-256v256l81.5-81.5C453.8 290.9 372.4 418.9 209.5 512c162.9 0 395.6-186.2 151.2-430.5"></svg:path>`,
})
export class SubwayUpIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayUsdIcon],svg[subway-usd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayVideoIcon],svg[subway-video-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M302.5 162.9h-256C20.9 162.9 0 183.8 0 209.5v256C0 491.1 20.9 512 46.5 512h256c25.7 0 46.5-20.9 46.5-46.5v-256c.1-25.7-20.8-46.6-46.5-46.6m69.9 116.4v116.4L512 465.5v-256zM69.8 139.6c38.6 0 69.8-31.3 69.8-69.8S108.4 0 69.8 0C31.3 0 0 31.3 0 69.8s31.3 69.8 69.8 69.8M279.3 0c-38.6 0-69.8 31.3-69.8 69.8s31.3 69.8 69.8 69.8c38.6 0 69.8-31.3 69.8-69.8S317.8 0 279.3 0"></svg:path>`,
})
export class SubwayVideoIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayWebcamIcon],svg[subway-webcam-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayWorldIcon],svg[subway-world-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayWorld1Icon],svg[subway-world-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayZipIcon],svg[subway-zip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[subwayZoomMinusIcon],svg[subway-zoom-minus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M325.8 0C223 0 139.6 83.4 139.6 186.2c0 33.5 9 64.8 24.4 92L0 442.2l23.3 46.5L69.8 512l164-164c27.1 15.5 58.5 24.4 92 24.4C428.6 372.4 512 289 512 186.2S428.6 0 325.8 0m0 314.2c-70.7 0-128-57.3-128-128s57.3-128 128-128s128 57.3 128 128s-57.3 128-128 128M256 209.5h139.6V163H256z"></svg:path>`,
})
export class SubwayZoomMinusIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[subwayZoomPlusIcon],svg[subway-zoom-plus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M325.8 0C223 0 139.6 83.4 139.6 186.2c0 33.5 9 64.8 24.4 92L0 442.2l23.3 46.5L69.8 512l164-164c27.2 15.5 58.5 24.4 92 24.4C428.6 372.4 512 289 512 186.2S428.6 0 325.8 0m0 314.2c-70.7 0-128-57.3-128-128s57.3-128 128-128s128 57.3 128 128s-57.3 128-128 128m23.3-197.8h-46.5v46.5H256v46.5h46.5V256H349v-46.5h46.5V163H349v-46.6z"></svg:path>`,
})
export class SubwayZoomPlusIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
