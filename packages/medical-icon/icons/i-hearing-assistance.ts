...
@Component({
  standalone: true,
  selector: 'svg[medicalIconIHearingAssistanceIcon],svg[medical-icon-i-hearing-assistance-icon]',
  host: {
    role: 'img',
