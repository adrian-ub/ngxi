...
@Component({
  standalone: true,
  selector: 'svg[medicalIconIPhysicalTherapyIcon],svg[medical-icon-i-physical-therapy-icon]',
  host: {
    role: 'img',
