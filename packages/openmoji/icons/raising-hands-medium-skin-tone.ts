...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisingHandsMediumSkinToneIcon],svg[openmoji-raising-hands-medium-skin-tone-icon]',
  host: {
    role: 'img',
