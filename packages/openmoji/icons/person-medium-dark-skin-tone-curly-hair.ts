...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonMediumDarkSkinToneCurlyHairIcon],svg[openmoji-person-medium-dark-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
...
export class OpenmojiPersonMediumDarkSkinToneCurlyHairIcon {
