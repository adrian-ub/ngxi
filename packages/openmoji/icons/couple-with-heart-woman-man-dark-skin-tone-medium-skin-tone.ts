...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManDarkSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-dark-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManDarkSkinToneMediumSkinToneIcon {
