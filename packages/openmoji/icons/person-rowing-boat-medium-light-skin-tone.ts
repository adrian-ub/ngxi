...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonRowingBoatMediumLightSkinToneIcon],svg[openmoji-person-rowing-boat-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
