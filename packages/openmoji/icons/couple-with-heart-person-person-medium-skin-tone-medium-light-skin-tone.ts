...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
