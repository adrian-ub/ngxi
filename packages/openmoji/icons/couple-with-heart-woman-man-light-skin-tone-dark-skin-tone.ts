...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManLightSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-light-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManLightSkinToneDarkSkinToneIcon {
