...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonLightSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-person-person-light-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonLightSkinToneMediumSkinToneIcon {
