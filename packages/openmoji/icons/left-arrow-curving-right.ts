...
@Component({
  standalone: true,
  selector: 'svg[openmojiLeftArrowCurvingRightIcon],svg[openmoji-left-arrow-curving-right-icon]',
  host: {
    role: 'img',
