...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonDarkSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-dark-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
