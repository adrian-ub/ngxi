...
@Component({
  standalone: true,
  selector: 'svg[openmojiPrincessMediumDarkSkinToneIcon],svg[openmoji-princess-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
