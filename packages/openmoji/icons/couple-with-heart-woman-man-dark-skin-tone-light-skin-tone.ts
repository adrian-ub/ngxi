...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManDarkSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-dark-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManDarkSkinToneLightSkinToneIcon {
