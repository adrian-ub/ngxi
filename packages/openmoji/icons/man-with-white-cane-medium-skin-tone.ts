...
@Component({
  standalone: true,
  selector: 'svg[openmojiManWithWhiteCaneMediumSkinToneIcon],svg[openmoji-man-with-white-cane-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManWithWhiteCaneMediumSkinToneIcon {
