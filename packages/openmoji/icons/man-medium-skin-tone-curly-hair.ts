...
@Component({
  standalone: true,
  selector: 'svg[openmojiManMediumSkinToneCurlyHairIcon],svg[openmoji-man-medium-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManMediumSkinToneCurlyHairIcon {
