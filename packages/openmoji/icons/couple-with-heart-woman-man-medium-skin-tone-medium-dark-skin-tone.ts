...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumSkinToneMediumDarkSkinToneIcon {
