...
@Component({
  standalone: true,
  selector: 'svg[openmojiOpenHandsMediumSkinToneIcon],svg[openmoji-open-hands-medium-skin-tone-icon]',
  host: {
    role: 'img',
