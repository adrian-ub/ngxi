...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonLightSkinToneBaldIcon],svg[openmoji-person-light-skin-tone-bald-icon]',
  host: {
    role: 'img',
