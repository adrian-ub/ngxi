...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanJugglingLightSkinToneIcon],svg[openmoji-woman-juggling-light-skin-tone-icon]',
  host: {
    role: 'img',
