...
@Component({
  standalone: true,
  selector: 'svg[openmojiThumbsUpDarkSkinToneIcon],svg[openmoji-thumbs-up-dark-skin-tone-icon]',
  host: {
    role: 'img',
