...
@Component({
  standalone: true,
  selector: 'svg[openmojiLoveYouGestureDarkSkinToneIcon],svg[openmoji-love-you-gesture-dark-skin-tone-icon]',
  host: {
    role: 'img',
