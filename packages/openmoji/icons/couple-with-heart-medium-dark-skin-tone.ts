...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
