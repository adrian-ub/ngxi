...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonMediumSkinToneCurlyHairIcon],svg[openmoji-person-medium-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
