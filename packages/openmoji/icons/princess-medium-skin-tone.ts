...
@Component({
  standalone: true,
  selector: 'svg[openmojiPrincessMediumSkinToneIcon],svg[openmoji-princess-medium-skin-tone-icon]',
  host: {
    role: 'img',
