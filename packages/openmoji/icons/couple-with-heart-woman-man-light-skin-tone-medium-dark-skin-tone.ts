...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManLightSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-light-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManLightSkinToneMediumDarkSkinToneIcon {
