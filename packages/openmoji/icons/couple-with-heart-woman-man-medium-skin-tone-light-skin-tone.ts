...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumSkinToneLightSkinToneIcon {
