...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonDarkSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-person-person-dark-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonDarkSkinToneMediumSkinToneIcon {
