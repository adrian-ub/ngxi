...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedBackOfHandDarkSkinToneIcon],svg[openmoji-raised-back-of-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
