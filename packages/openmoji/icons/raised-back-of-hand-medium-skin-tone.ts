...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedBackOfHandMediumSkinToneIcon],svg[openmoji-raised-back-of-hand-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiRaisedBackOfHandMediumSkinToneIcon {
