...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumLightSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-light-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
