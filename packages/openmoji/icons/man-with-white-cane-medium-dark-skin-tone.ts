...
@Component({
  standalone: true,
  selector: 'svg[openmojiManWithWhiteCaneMediumDarkSkinToneIcon],svg[openmoji-man-with-white-cane-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManWithWhiteCaneMediumDarkSkinToneIcon {
