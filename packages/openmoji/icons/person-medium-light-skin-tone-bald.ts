...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonMediumLightSkinToneBaldIcon],svg[openmoji-person-medium-light-skin-tone-bald-icon]',
  host: {
    role: 'img',
