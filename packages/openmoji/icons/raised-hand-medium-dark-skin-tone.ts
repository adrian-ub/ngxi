...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedHandMediumDarkSkinToneIcon],svg[openmoji-raised-hand-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
