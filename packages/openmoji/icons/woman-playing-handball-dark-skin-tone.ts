...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanPlayingHandballDarkSkinToneIcon],svg[openmoji-woman-playing-handball-dark-skin-tone-icon]',
  host: {
    role: 'img',
