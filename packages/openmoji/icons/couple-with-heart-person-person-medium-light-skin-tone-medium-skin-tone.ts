...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumLightSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-light-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
