...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumSkinToneMediumLightSkinToneIcon {
