...
@Component({
  standalone: true,
  selector: 'svg[openmojiOlderPersonLightSkinToneIcon],svg[openmoji-older-person-light-skin-tone-icon]',
  host: {
    role: 'img',
