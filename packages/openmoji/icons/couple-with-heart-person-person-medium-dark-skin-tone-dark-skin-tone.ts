...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumDarkSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-dark-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumDarkSkinToneDarkSkinToneIcon {
