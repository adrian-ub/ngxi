...
@Component({
  standalone: true,
  selector: 'svg[openmojiLoveYouGestureMediumLightSkinToneIcon],svg[openmoji-love-you-gesture-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
