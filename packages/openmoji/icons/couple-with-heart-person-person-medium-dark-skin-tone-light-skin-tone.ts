...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumDarkSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-dark-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumDarkSkinToneLightSkinToneIcon {
