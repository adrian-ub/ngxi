...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonCartwheelingLightSkinToneIcon],svg[openmoji-person-cartwheeling-light-skin-tone-icon]',
  host: {
    role: 'img',
