...
@Component({
  standalone: true,
  selector: 'svg[openmojiOlderPersonMediumSkinToneIcon],svg[openmoji-older-person-medium-skin-tone-icon]',
  host: {
    role: 'img',
