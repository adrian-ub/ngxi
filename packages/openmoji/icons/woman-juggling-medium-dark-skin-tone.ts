...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanJugglingMediumDarkSkinToneIcon],svg[openmoji-woman-juggling-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
