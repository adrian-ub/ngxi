...
@Component({
  standalone: true,
  selector: 'svg[openmojiLoveYouGestureMediumSkinToneIcon],svg[openmoji-love-you-gesture-medium-skin-tone-icon]',
  host: {
    role: 'img',
