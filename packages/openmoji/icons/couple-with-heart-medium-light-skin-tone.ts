...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
