...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanPlayingHandballMediumDarkSkinToneIcon],svg[openmoji-woman-playing-handball-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
