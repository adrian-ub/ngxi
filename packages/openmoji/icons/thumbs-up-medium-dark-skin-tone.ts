...
@Component({
  standalone: true,
  selector: 'svg[openmojiThumbsUpMediumDarkSkinToneIcon],svg[openmoji-thumbs-up-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
