...
@Component({
  standalone: true,
  selector: 'svg[openmojiThumbsUpMediumLightSkinToneIcon],svg[openmoji-thumbs-up-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
