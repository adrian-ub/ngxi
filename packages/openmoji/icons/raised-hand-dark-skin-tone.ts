...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedHandDarkSkinToneIcon],svg[openmoji-raised-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
