...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisingHandsLightSkinToneIcon],svg[openmoji-raising-hands-light-skin-tone-icon]',
  host: {
    role: 'img',
