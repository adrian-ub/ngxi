...
@Component({
  standalone: true,
  selector: 'svg[openmojiLoveYouGestureMediumDarkSkinToneIcon],svg[openmoji-love-you-gesture-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
