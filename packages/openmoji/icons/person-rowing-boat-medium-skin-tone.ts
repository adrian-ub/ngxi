...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonRowingBoatMediumSkinToneIcon],svg[openmoji-person-rowing-boat-medium-skin-tone-icon]',
  host: {
    role: 'img',
