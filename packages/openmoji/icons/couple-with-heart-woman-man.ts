...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManIcon],svg[openmoji-couple-with-heart-woman-man-icon]',
  host: {
    role: 'img',
