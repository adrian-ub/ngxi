...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonCartwheelingDarkSkinToneIcon],svg[openmoji-person-cartwheeling-dark-skin-tone-icon]',
  host: {
    role: 'img',
