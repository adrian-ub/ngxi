...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumDarkSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-dark-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumDarkSkinToneMediumLightSkinToneIcon {
