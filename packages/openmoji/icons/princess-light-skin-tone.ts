...
@Component({
  standalone: true,
  selector: 'svg[openmojiPrincessLightSkinToneIcon],svg[openmoji-princess-light-skin-tone-icon]',
  host: {
    role: 'img',
