...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumDarkSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-dark-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumDarkSkinToneMediumSkinToneIcon {
