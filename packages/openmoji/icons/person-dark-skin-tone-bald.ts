...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonDarkSkinToneBaldIcon],svg[openmoji-person-dark-skin-tone-bald-icon]',
  host: {
    role: 'img',
