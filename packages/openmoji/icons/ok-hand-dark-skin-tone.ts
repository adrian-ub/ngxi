...
@Component({
  standalone: true,
  selector: 'svg[openmojiOkHandDarkSkinToneIcon],svg[openmoji-ok-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
