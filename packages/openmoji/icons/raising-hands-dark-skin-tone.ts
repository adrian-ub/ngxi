...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisingHandsDarkSkinToneIcon],svg[openmoji-raising-hands-dark-skin-tone-icon]',
  host: {
    role: 'img',
