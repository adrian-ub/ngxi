...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumLightSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-light-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
