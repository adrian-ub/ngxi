...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManLightSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-light-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManLightSkinToneMediumLightSkinToneIcon {
