...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
