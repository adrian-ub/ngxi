...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonLightSkinToneCurlyHairIcon],svg[openmoji-person-light-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
