...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumDarkSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-dark-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumDarkSkinToneDarkSkinToneIcon {
