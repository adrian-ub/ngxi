...
@Component({
  standalone: true,
  selector: 'svg[openmojiOkHandMediumSkinToneIcon],svg[openmoji-ok-hand-medium-skin-tone-icon]',
  host: {
    role: 'img',
