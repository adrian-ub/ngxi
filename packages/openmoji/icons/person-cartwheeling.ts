...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonCartwheelingIcon],svg[openmoji-person-cartwheeling-icon]',
  host: {
    role: 'img',
