...
@Component({
  standalone: true,
  selector: 'svg[openmojiLoveYouGestureLightSkinToneIcon],svg[openmoji-love-you-gesture-light-skin-tone-icon]',
  host: {
    role: 'img',
