...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonWithWhiteCaneMediumDarkSkinToneIcon],svg[openmoji-person-with-white-cane-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
