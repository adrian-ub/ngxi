...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedBackOfHandMediumDarkSkinToneIcon],svg[openmoji-raised-back-of-hand-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
