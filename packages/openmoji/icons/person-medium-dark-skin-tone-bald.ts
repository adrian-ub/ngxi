...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonMediumDarkSkinToneBaldIcon],svg[openmoji-person-medium-dark-skin-tone-bald-icon]',
  host: {
    role: 'img',
