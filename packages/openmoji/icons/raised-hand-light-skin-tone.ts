...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedHandLightSkinToneIcon],svg[openmoji-raised-hand-light-skin-tone-icon]',
  host: {
    role: 'img',
