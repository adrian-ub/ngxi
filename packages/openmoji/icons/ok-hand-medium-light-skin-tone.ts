...
@Component({
  standalone: true,
  selector: 'svg[openmojiOkHandMediumLightSkinToneIcon],svg[openmoji-ok-hand-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
