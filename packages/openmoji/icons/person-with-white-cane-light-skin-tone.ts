...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonWithWhiteCaneLightSkinToneIcon],svg[openmoji-person-with-white-cane-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiPersonWithWhiteCaneLightSkinToneIcon {
