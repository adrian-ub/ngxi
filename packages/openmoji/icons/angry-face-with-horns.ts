...
@Component({
  standalone: true,
  selector: 'svg[openmojiAngryFaceWithHornsIcon],svg[openmoji-angry-face-with-horns-icon]',
  host: {
    role: 'img',
