...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisedBackOfHandMediumLightSkinToneIcon],svg[openmoji-raised-back-of-hand-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
