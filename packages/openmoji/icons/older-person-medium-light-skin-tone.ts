...
@Component({
  standalone: true,
  selector: 'svg[openmojiOlderPersonMediumLightSkinToneIcon],svg[openmoji-older-person-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
