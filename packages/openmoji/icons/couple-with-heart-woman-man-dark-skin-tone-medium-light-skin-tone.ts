...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManDarkSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-dark-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManDarkSkinToneMediumLightSkinToneIcon {
