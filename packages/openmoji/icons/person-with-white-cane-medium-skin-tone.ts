...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonWithWhiteCaneMediumSkinToneIcon],svg[openmoji-person-with-white-cane-medium-skin-tone-icon]',
  host: {
    role: 'img',
