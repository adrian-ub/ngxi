...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartLightSkinToneIcon],svg[openmoji-couple-with-heart-light-skin-tone-icon]',
  host: {
    role: 'img',
