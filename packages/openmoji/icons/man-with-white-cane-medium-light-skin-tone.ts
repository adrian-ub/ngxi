...
@Component({
  standalone: true,
  selector: 'svg[openmojiManWithWhiteCaneMediumLightSkinToneIcon],svg[openmoji-man-with-white-cane-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManWithWhiteCaneMediumLightSkinToneIcon {
