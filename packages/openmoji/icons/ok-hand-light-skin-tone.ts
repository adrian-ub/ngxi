...
@Component({
  standalone: true,
  selector: 'svg[openmojiOkHandLightSkinToneIcon],svg[openmoji-ok-hand-light-skin-tone-icon]',
  host: {
    role: 'img',
