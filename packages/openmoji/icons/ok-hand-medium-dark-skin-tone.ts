...
@Component({
  standalone: true,
  selector: 'svg[openmojiOkHandMediumDarkSkinToneIcon],svg[openmoji-ok-hand-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
