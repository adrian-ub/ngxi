...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumLightSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-light-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
