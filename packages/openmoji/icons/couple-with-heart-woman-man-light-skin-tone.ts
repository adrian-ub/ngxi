...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-light-skin-tone-icon]',
  host: {
    role: 'img',
