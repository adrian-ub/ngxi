...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumSkinToneMediumDarkSkinToneIcon {
