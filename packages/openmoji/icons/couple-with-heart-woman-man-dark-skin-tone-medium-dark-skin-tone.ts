...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManDarkSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-dark-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManDarkSkinToneMediumDarkSkinToneIcon {
