...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanJugglingMediumLightSkinToneIcon],svg[openmoji-woman-juggling-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
