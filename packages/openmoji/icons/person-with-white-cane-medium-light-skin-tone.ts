...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonWithWhiteCaneMediumLightSkinToneIcon],svg[openmoji-person-with-white-cane-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
