...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanJugglingMediumSkinToneIcon],svg[openmoji-woman-juggling-medium-skin-tone-icon]',
  host: {
    role: 'img',
