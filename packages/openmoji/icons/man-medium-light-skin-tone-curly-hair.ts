...
@Component({
  standalone: true,
  selector: 'svg[openmojiManMediumLightSkinToneCurlyHairIcon],svg[openmoji-man-medium-light-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManMediumLightSkinToneCurlyHairIcon {
