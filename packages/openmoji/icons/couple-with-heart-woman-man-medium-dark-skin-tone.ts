...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
