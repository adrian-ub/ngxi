...
@Component({
  standalone: true,
  selector: 'svg[openmojiOpenHandsMediumDarkSkinToneIcon],svg[openmoji-open-hands-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
