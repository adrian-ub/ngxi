...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonDarkSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-dark-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonDarkSkinToneMediumDarkSkinToneIcon {
