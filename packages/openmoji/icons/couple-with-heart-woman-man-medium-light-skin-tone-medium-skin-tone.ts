...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumLightSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-light-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumLightSkinToneMediumSkinToneIcon {
