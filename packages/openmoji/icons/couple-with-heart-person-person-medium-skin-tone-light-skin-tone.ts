...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumSkinToneLightSkinToneIcon {
