...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonRowingBoatLightSkinToneIcon],svg[openmoji-person-rowing-boat-light-skin-tone-icon]',
  host: {
    role: 'img',
