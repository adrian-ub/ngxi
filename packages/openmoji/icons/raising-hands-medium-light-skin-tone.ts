...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisingHandsMediumLightSkinToneIcon],svg[openmoji-raising-hands-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
