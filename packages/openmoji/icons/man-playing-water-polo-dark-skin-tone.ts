...
@Component({
  standalone: true,
  selector: 'svg[openmojiManPlayingWaterPoloDarkSkinToneIcon],svg[openmoji-man-playing-water-polo-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManPlayingWaterPoloDarkSkinToneIcon {
