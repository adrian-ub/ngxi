...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonWithWhiteCaneDarkSkinToneIcon],svg[openmoji-person-with-white-cane-dark-skin-tone-icon]',
  host: {
    role: 'img',
