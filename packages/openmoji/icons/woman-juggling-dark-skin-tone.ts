...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanJugglingDarkSkinToneIcon],svg[openmoji-woman-juggling-dark-skin-tone-icon]',
  host: {
    role: 'img',
