...
@Component({
  standalone: true,
  selector: 'svg[openmojiOlderPersonDarkSkinToneIcon],svg[openmoji-older-person-dark-skin-tone-icon]',
  host: {
    role: 'img',
