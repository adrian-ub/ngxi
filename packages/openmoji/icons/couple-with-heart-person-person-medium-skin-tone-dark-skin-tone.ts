...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonMediumSkinToneDarkSkinToneIcon {
