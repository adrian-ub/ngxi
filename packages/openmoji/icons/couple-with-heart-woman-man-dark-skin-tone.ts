...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-dark-skin-tone-icon]',
  host: {
    role: 'img',
