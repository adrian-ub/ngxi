...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumLightSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-light-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
