...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManLightSkinToneMediumSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-light-skin-tone-medium-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManLightSkinToneMediumSkinToneIcon {
