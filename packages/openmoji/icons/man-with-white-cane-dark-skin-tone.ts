...
@Component({
  standalone: true,
  selector: 'svg[openmojiManWithWhiteCaneDarkSkinToneIcon],svg[openmoji-man-with-white-cane-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManWithWhiteCaneDarkSkinToneIcon {
