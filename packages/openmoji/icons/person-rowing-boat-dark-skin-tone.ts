...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonRowingBoatDarkSkinToneIcon],svg[openmoji-person-rowing-boat-dark-skin-tone-icon]',
  host: {
    role: 'img',
