...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-skin-tone-icon]',
  host: {
    role: 'img',
