...
@Component({
  standalone: true,
  selector: 'svg[openmojiWomanPlayingHandballLightSkinToneIcon],svg[openmoji-woman-playing-handball-light-skin-tone-icon]',
  host: {
    role: 'img',
