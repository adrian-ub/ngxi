...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonLightSkinToneMediumLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-light-skin-tone-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
