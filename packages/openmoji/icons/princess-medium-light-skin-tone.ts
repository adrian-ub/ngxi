...
@Component({
  standalone: true,
  selector: 'svg[openmojiPrincessMediumLightSkinToneIcon],svg[openmoji-princess-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
