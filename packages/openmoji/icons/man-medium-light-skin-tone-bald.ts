...
@Component({
  standalone: true,
  selector: 'svg[openmojiManMediumLightSkinToneBaldIcon],svg[openmoji-man-medium-light-skin-tone-bald-icon]',
  host: {
    role: 'img',
...
export class OpenmojiManMediumLightSkinToneBaldIcon {
