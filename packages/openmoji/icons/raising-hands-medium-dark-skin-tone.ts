...
@Component({
  standalone: true,
  selector: 'svg[openmojiRaisingHandsMediumDarkSkinToneIcon],svg[openmoji-raising-hands-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
