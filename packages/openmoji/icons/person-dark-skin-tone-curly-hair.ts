...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonDarkSkinToneCurlyHairIcon],svg[openmoji-person-dark-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
