...
@Component({
  standalone: true,
  selector: 'svg[openmojiOlderPersonMediumDarkSkinToneIcon],svg[openmoji-older-person-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
