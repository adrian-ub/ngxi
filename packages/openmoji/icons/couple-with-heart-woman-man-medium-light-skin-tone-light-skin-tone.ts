...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumLightSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-light-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumLightSkinToneLightSkinToneIcon {
