...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartMediumSkinToneIcon],svg[openmoji-couple-with-heart-medium-skin-tone-icon]',
  host: {
    role: 'img',
