...
@Component({
  standalone: true,
  selector: 'svg[openmojiPersonMediumLightSkinToneCurlyHairIcon],svg[openmoji-person-medium-light-skin-tone-curly-hair-icon]',
  host: {
    role: 'img',
