...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonLightSkinToneMediumDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-light-skin-tone-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonLightSkinToneMediumDarkSkinToneIcon {
