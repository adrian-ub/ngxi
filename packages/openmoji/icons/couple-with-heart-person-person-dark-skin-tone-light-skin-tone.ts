...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonDarkSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-dark-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonDarkSkinToneLightSkinToneIcon {
