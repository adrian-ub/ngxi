...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonLightSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-person-person-light-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartPersonPersonLightSkinToneDarkSkinToneIcon {
