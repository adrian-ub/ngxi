...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartDarkSkinToneIcon],svg[openmoji-couple-with-heart-dark-skin-tone-icon]',
  host: {
    role: 'img',
