...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartPersonPersonMediumLightSkinToneLightSkinToneIcon],svg[openmoji-couple-with-heart-person-person-medium-light-skin-tone-light-skin-tone-icon]',
  host: {
    role: 'img',
