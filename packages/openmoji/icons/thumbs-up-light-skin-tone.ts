...
@Component({
  standalone: true,
  selector: 'svg[openmojiThumbsUpLightSkinToneIcon],svg[openmoji-thumbs-up-light-skin-tone-icon]',
  host: {
    role: 'img',
