...
@Component({
  standalone: true,
  selector: 'svg[openmojiCoupleWithHeartWomanManMediumSkinToneDarkSkinToneIcon],svg[openmoji-couple-with-heart-woman-man-medium-skin-tone-dark-skin-tone-icon]',
  host: {
    role: 'img',
...
export class OpenmojiCoupleWithHeartWomanManMediumSkinToneDarkSkinToneIcon {
