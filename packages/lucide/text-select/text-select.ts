...
@Component({
  ...
  template: `<svg:path d="M5 3a2 2 0 0 0-2 2"></svg:path>
    ...
    <svg:line x1="7" x2="15" y1="8" y2="8"></svg:line>
    <svg:line x1="7" x2="17" y1="12" y2="12"></svg:line>
    <svg:line x1="7" x2="13" y1="16" y2="16"></svg:line>`,
})
