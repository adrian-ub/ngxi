...
@Component({
  ...
  template: `<svg:polyline
    ...
    <svg:polyline points="14.5 6.5 18 3 21 3 21 6 17.5 9.5"></svg:polyline>
    <svg:line x1="5" x2="9" y1="14" y2="18"></svg:line>
    <svg:line x1="7" x2="4" y1="17" y2="20"></svg:line>
    <svg:line x1="3" x2="5" y1="19" y2="21"></svg:line>`,
})
