...
@Component({
  standalone: true,
  selector: 'svg[lucideBug],svg[lucide-bug]',
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns()',
  ...
  template: `<svg:path d="m8 2 1.88 1.88"></svg:path>
    ...
    <svg:path d="M22 13h-4"></svg:path>
    <svg:path d="M17.2 17c2.1.1 3.8 1.9 3.8 4"></svg:path>`,
})
export class LucideBug {
