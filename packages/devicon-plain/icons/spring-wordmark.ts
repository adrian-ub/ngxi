...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainSpringWordmarkIcon],svg[devicon-plain-spring-wordmark-icon]',
  host: {
    role: 'img',
