...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainRedhatWordmarkIcon],svg[devicon-plain-redhat-wordmark-icon]',
  host: {
    role: 'img',
