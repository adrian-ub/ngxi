...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainWebpackWordmarkIcon],svg[devicon-plain-webpack-wordmark-icon]',
  host: {
    role: 'img',
