...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainPyscriptWordmarkIcon],svg[devicon-plain-pyscript-wordmark-icon]',
  host: {
    role: 'img',
