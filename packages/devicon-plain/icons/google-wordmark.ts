...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainGoogleWordmarkIcon],svg[devicon-plain-google-wordmark-icon]',
  host: {
    role: 'img',
