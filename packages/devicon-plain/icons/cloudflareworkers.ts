...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainCloudflareworkersIcon],svg[devicon-plain-cloudflareworkers-icon]',
  host: {
    role: 'img',
