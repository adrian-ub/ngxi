...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainDockerWordmarkIcon],svg[devicon-plain-docker-wordmark-icon]',
  host: {
    role: 'img',
