...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainHerokuWordmarkIcon],svg[devicon-plain-heroku-wordmark-icon]',
  host: {
    role: 'img',
