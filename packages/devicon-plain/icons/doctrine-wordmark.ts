...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainDoctrineWordmarkIcon],svg[devicon-plain-doctrine-wordmark-icon]',
  host: {
    role: 'img',
