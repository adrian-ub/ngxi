...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainPytorchWordmarkIcon],svg[devicon-plain-pytorch-wordmark-icon]',
  host: {
    role: 'img',
