...
@Component({
  standalone: true,
  selector: 'svg[deviconPlainWeblateWordmarkIcon],svg[devicon-plain-weblate-wordmark-icon]',
  host: {
    role: 'img',
