...
@Component({
  standalone: true,
  selector: 'svg[tokenBrandedBinanceSmartChainIcon],svg[token-branded-binance-smart-chain-icon]',
  host: {
    role: 'img',
