...
@Component({
  standalone: true,
  selector: 'svg[awsServiceManagementConnectorIcon],svg[aws-service-management-connector-icon]',
  host: {
    role: 'img',
