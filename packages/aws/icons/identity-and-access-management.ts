...
@Component({
  standalone: true,
  selector: 'svg[awsIdentityAndAccessManagementIcon],svg[aws-identity-and-access-management-icon]',
  host: {
    role: 'img',
