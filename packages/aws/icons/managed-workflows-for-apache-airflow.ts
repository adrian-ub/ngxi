...
@Component({
  standalone: true,
  selector: 'svg[awsManagedWorkflowsForApacheAirflowIcon],svg[aws-managed-workflows-for-apache-airflow-icon]',
  host: {
    role: 'img',
