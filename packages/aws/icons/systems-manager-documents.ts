...
@Component({
  standalone: true,
  selector: 'svg[awsSystemsManagerDocumentsIcon],svg[aws-systems-manager-documents-icon]',
  host: {
    role: 'img',
