...
@Component({
  standalone: true,
  selector: 'svg[awsFileCacheOnPremisesNfsLinkedDatasetsIcon],svg[aws-file-cache-on-premises-nfs-linked-datasets-icon]',
  host: {
    role: 'img',
