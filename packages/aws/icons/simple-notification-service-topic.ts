...
@Component({
  standalone: true,
  selector: 'svg[awsSimpleNotificationServiceTopicIcon],svg[aws-simple-notification-service-topic-icon]',
  host: {
    role: 'img',
