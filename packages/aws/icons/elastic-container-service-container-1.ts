...
@Component({
  standalone: true,
  selector: 'svg[awsElasticContainerServiceContainer1Icon],svg[aws-elastic-container-service-container-1-icon]',
  host: {
    role: 'img',
