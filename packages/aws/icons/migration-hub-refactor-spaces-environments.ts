...
@Component({
  standalone: true,
  selector: 'svg[awsMigrationHubRefactorSpacesEnvironmentsIcon],svg[aws-migration-hub-refactor-spaces-environments-icon]',
  host: {
    role: 'img',
