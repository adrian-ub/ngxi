...
@Component({
  standalone: true,
  selector: 'svg[awsOpensearchServiceTracesIcon],svg[aws-opensearch-service-traces-icon]',
  host: {
    role: 'img',
