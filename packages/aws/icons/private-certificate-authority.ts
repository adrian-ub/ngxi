...
@Component({
  standalone: true,
  selector: 'svg[awsPrivateCertificateAuthorityIcon],svg[aws-private-certificate-authority-icon]',
  host: {
    role: 'img',
