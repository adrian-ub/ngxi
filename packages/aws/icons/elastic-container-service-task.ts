...
@Component({
  standalone: true,
  selector: 'svg[awsElasticContainerServiceTaskIcon],svg[aws-elastic-container-service-task-icon]',
  host: {
    role: 'img',
