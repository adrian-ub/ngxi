...
@Component({
  standalone: true,
  selector: 'svg[awsVpcReachabilityAnalyzerIcon],svg[aws-vpc-reachability-analyzer-icon]',
  host: {
    role: 'img',
