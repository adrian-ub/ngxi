...
@Component({
  standalone: true,
  selector: 'svg[awsElasticBlockStoreMultipleVolumesIcon],svg[aws-elastic-block-store-multiple-volumes-icon]',
  host: {
    role: 'img',
