...
@Component({
  standalone: true,
  selector: 'svg[awsStorageGatewayFileGatewayIcon],svg[aws-storage-gateway-file-gateway-icon]',
  host: {
    role: 'img',
