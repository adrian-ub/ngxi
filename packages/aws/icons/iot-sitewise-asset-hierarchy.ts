...
@Component({
  standalone: true,
  selector: 'svg[awsIotSitewiseAssetHierarchyIcon],svg[aws-iot-sitewise-asset-hierarchy-icon]',
  host: {
    role: 'img',
