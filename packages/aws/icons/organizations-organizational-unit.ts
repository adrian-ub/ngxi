...
@Component({
  standalone: true,
  selector: 'svg[awsOrganizationsOrganizationalUnitIcon],svg[aws-organizations-organizational-unit-icon]',
  host: {
    role: 'img',
