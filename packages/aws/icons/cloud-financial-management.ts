...
@Component({
  standalone: true,
  selector: 'svg[awsCloudFinancialManagementIcon],svg[aws-cloud-financial-management-icon]',
  host: {
    role: 'img',
