...
@Component({
  standalone: true,
  selector: 'svg[awsEventbridgeDefaultEventBusIcon],svg[aws-eventbridge-default-event-bus-icon]',
  host: {
    role: 'img',
