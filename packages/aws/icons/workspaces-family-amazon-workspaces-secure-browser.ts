...
@Component({
  standalone: true,
  selector: 'svg[awsWorkspacesFamilyAmazonWorkspacesSecureBrowserIcon],svg[aws-workspaces-family-amazon-workspaces-secure-browser-icon]',
  host: {
    role: 'img',
