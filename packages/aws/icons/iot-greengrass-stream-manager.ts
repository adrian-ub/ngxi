...
@Component({
  standalone: true,
  selector: 'svg[awsIotGreengrassStreamManagerIcon],svg[aws-iot-greengrass-stream-manager-icon]',
  host: {
    role: 'img',
