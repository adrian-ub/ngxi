...
@Component({
  standalone: true,
  selector: 'svg[awsSimpleStorageServiceS3BatchOperationsIcon],svg[aws-simple-storage-service-s3-batch-operations-icon]',
  host: {
    role: 'img',
