...
@Component({
  standalone: true,
  selector: 'svg[awsOpensearchServiceOpensearchDashboardsIcon],svg[aws-opensearch-service-opensearch-dashboards-icon]',
  host: {
    role: 'img',
