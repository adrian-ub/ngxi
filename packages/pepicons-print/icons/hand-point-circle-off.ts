...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandPointCircleOffIcon],svg[pepicons-print-hand-point-circle-off-icon]',
  host: {
    role: 'img',
