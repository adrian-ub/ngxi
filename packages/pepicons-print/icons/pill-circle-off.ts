...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPillCircleOffIcon],svg[pepicons-print-pill-circle-off-icon]',
  host: {
    role: 'img',
