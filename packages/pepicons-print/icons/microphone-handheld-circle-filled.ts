...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMicrophoneHandheldCircleFilledIcon],svg[pepicons-print-microphone-handheld-circle-filled-icon]',
  host: {
    role: 'img',
