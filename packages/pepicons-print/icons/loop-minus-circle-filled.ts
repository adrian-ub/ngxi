...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLoopMinusCircleFilledIcon],svg[pepicons-print-loop-minus-circle-filled-icon]',
  host: {
    role: 'img',
