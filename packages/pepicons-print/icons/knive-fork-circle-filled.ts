...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintKniveForkCircleFilledIcon],svg[pepicons-print-knive-fork-circle-filled-icon]',
  host: {
    role: 'img',
