...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandsClappingOffIcon],svg[pepicons-print-hands-clapping-off-icon]',
  host: {
    role: 'img',
