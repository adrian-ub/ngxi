...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteSingleCircleOffIcon],svg[pepicons-print-music-note-single-circle-off-icon]',
  host: {
    role: 'img',
