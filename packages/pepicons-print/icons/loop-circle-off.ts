...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLoopCircleOffIcon],svg[pepicons-print-loop-circle-off-icon]',
  host: {
    role: 'img',
