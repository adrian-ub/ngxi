...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMapCircleOffIcon],svg[pepicons-print-map-circle-off-icon]',
  host: {
    role: 'img',
