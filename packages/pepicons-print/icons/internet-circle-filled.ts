...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintInternetCircleFilledIcon],svg[pepicons-print-internet-circle-filled-icon]',
  host: {
    role: 'img',
