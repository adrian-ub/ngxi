...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintQuestionCircleOffIcon],svg[pepicons-print-question-circle-off-icon]',
  host: {
    role: 'img',
