...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPowerCircleOffIcon],svg[pepicons-print-power-circle-off-icon]',
  host: {
    role: 'img',
