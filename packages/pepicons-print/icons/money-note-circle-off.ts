...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMoneyNoteCircleOffIcon],svg[pepicons-print-money-note-circle-off-icon]',
  host: {
    role: 'img',
