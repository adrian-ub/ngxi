...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintRadioCircleOffIcon],svg[pepicons-print-radio-circle-off-icon]',
  host: {
    role: 'img',
