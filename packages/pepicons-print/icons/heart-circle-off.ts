...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHeartCircleOffIcon],svg[pepicons-print-heart-circle-off-icon]',
  host: {
    role: 'img',
