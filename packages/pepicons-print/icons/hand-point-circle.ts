...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandPointCircleIcon],svg[pepicons-print-hand-point-circle-icon]',
  host: {
    role: 'img',
