...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLetterOpenCircleIcon],svg[pepicons-print-letter-open-circle-icon]',
  host: {
    role: 'img',
