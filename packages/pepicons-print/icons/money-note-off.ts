...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMoneyNoteOffIcon],svg[pepicons-print-money-note-off-icon]',
  host: {
    role: 'img',
