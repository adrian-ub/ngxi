...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintRadioCircleFilledIcon],svg[pepicons-print-radio-circle-filled-icon]',
  host: {
    role: 'img',
