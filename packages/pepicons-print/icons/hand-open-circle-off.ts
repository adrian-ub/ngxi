...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandOpenCircleOffIcon],svg[pepicons-print-hand-open-circle-off-icon]',
  host: {
    role: 'img',
