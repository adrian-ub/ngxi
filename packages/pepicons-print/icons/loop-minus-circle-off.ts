...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLoopMinusCircleOffIcon],svg[pepicons-print-loop-minus-circle-off-icon]',
  host: {
    role: 'img',
