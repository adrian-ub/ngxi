...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMonitorCircleFilledIcon],svg[pepicons-print-monitor-circle-filled-icon]',
  host: {
    role: 'img',
