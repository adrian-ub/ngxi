...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLetterOpenCircleOffIcon],svg[pepicons-print-letter-open-circle-off-icon]',
  host: {
    role: 'img',
