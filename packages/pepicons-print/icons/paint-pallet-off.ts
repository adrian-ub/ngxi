...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPaintPalletOffIcon],svg[pepicons-print-paint-pallet-off-icon]',
  host: {
    role: 'img',
