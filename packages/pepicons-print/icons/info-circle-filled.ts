...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintInfoCircleFilledIcon],svg[pepicons-print-info-circle-filled-icon]',
  host: {
    role: 'img',
