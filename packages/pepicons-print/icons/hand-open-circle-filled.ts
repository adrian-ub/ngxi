...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandOpenCircleFilledIcon],svg[pepicons-print-hand-open-circle-filled-icon]',
  host: {
    role: 'img',
