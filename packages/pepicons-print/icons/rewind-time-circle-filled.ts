...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintRewindTimeCircleFilledIcon],svg[pepicons-print-rewind-time-circle-filled-icon]',
  host: {
    role: 'img',
