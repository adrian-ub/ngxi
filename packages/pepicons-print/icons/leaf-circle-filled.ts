...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLeafCircleFilledIcon],svg[pepicons-print-leaf-circle-filled-icon]',
  host: {
    role: 'img',
