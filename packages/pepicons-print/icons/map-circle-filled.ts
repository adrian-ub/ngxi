...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMapCircleFilledIcon],svg[pepicons-print-map-circle-filled-icon]',
  host: {
    role: 'img',
