...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintOpenCircleFilledIcon],svg[pepicons-print-open-circle-filled-icon]',
  host: {
    role: 'img',
