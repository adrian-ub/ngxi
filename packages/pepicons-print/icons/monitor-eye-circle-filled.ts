...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMonitorEyeCircleFilledIcon],svg[pepicons-print-monitor-eye-circle-filled-icon]',
  host: {
    role: 'img',
