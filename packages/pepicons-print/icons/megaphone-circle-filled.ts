...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMegaphoneCircleFilledIcon],svg[pepicons-print-megaphone-circle-filled-icon]',
  host: {
    role: 'img',
