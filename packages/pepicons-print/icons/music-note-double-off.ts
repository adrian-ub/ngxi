...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteDoubleOffIcon],svg[pepicons-print-music-note-double-off-icon]',
  host: {
    role: 'img',
