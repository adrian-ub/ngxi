...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteDoubleCircleIcon],svg[pepicons-print-music-note-double-circle-icon]',
  host: {
    role: 'img',
...
export class PepiconsPrintMusicNoteDoubleCircleIcon {
