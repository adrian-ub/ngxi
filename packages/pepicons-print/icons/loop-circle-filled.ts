...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintLoopCircleFilledIcon],svg[pepicons-print-loop-circle-filled-icon]',
  host: {
    role: 'img',
