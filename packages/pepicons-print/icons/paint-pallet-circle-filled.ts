...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPaintPalletCircleFilledIcon],svg[pepicons-print-paint-pallet-circle-filled-icon]',
  host: {
    role: 'img',
