...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMoonCircleFilledIcon],svg[pepicons-print-moon-circle-filled-icon]',
  host: {
    role: 'img',
