...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandsClappingCircleFilledIcon],svg[pepicons-print-hands-clapping-circle-filled-icon]',
  host: {
    role: 'img',
