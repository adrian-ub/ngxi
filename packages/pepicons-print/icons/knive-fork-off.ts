...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintKniveForkOffIcon],svg[pepicons-print-knive-fork-off-icon]',
  host: {
    role: 'img',
