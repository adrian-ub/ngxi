...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPowerCircleFilledIcon],svg[pepicons-print-power-circle-filled-icon]',
  host: {
    role: 'img',
