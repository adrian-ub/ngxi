...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPlanetCircleFilledIcon],svg[pepicons-print-planet-circle-filled-icon]',
  host: {
    role: 'img',
