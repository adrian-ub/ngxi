...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintNutCircleFilledIcon],svg[pepicons-print-nut-circle-filled-icon]',
  host: {
    role: 'img',
