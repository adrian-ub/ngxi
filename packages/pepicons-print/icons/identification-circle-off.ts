...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintIdentificationCircleOffIcon],svg[pepicons-print-identification-circle-off-icon]',
  host: {
    role: 'img',
