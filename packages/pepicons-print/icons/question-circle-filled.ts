...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintQuestionCircleFilledIcon],svg[pepicons-print-question-circle-filled-icon]',
  host: {
    role: 'img',
