...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteSingleCircleFilledIcon],svg[pepicons-print-music-note-single-circle-filled-icon]',
  host: {
    role: 'img',
