...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintListCircleFilledIcon],svg[pepicons-print-list-circle-filled-icon]',
  host: {
    role: 'img',
