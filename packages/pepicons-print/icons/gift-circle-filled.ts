...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintGiftCircleFilledIcon],svg[pepicons-print-gift-circle-filled-icon]',
  host: {
    role: 'img',
