...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPrinterCircleFilledIcon],svg[pepicons-print-printer-circle-filled-icon]',
  host: {
    role: 'img',
