...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHammerSledgeCircleFilledIcon],svg[pepicons-print-hammer-sledge-circle-filled-icon]',
  host: {
    role: 'img',
