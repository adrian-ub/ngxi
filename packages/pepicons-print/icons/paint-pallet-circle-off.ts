...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPaintPalletCircleOffIcon],svg[pepicons-print-paint-pallet-circle-off-icon]',
  host: {
    role: 'img',
