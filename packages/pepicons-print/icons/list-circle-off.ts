...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintListCircleOffIcon],svg[pepicons-print-list-circle-off-icon]',
  host: {
    role: 'img',
