...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPinCircleFilledIcon],svg[pepicons-print-pin-circle-filled-icon]',
  host: {
    role: 'img',
