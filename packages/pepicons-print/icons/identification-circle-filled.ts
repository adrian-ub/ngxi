...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintIdentificationCircleFilledIcon],svg[pepicons-print-identification-circle-filled-icon]',
  host: {
    role: 'img',
