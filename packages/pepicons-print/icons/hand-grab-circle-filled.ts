...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandGrabCircleFilledIcon],svg[pepicons-print-hand-grab-circle-filled-icon]',
  host: {
    role: 'img',
