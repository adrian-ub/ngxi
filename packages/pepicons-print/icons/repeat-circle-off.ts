...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintRepeatCircleOffIcon],svg[pepicons-print-repeat-circle-off-icon]',
  host: {
    role: 'img',
