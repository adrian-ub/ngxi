...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHeadphoneCircleFilledIcon],svg[pepicons-print-headphone-circle-filled-icon]',
  host: {
    role: 'img',
