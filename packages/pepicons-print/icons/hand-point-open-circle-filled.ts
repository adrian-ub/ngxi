...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandPointOpenCircleFilledIcon],svg[pepicons-print-hand-point-open-circle-filled-icon]',
  host: {
    role: 'img',
