...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPillCircleFilledIcon],svg[pepicons-print-pill-circle-filled-icon]',
  host: {
    role: 'img',
