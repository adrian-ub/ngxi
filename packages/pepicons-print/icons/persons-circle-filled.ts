...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPersonsCircleFilledIcon],svg[pepicons-print-persons-circle-filled-icon]',
  host: {
    role: 'img',
