...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHammerClawCircleFilledIcon],svg[pepicons-print-hammer-claw-circle-filled-icon]',
  host: {
    role: 'img',
