...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHourglassCircleFilledIcon],svg[pepicons-print-hourglass-circle-filled-icon]',
  host: {
    role: 'img',
