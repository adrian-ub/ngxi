...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintHandPointCircleFilledIcon],svg[pepicons-print-hand-point-circle-filled-icon]',
  host: {
    role: 'img',
