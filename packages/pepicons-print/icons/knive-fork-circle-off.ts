...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintKniveForkCircleOffIcon],svg[pepicons-print-knive-fork-circle-off-icon]',
  host: {
    role: 'img',
