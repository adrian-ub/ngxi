...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteDoubleCircleOffIcon],svg[pepicons-print-music-note-double-circle-off-icon]',
  host: {
    role: 'img',
