...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintPhotoCircleFilledIcon],svg[pepicons-print-photo-circle-filled-icon]',
  host: {
    role: 'img',
