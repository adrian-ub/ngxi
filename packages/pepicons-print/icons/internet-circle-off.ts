...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintInternetCircleOffIcon],svg[pepicons-print-internet-circle-off-icon]',
  host: {
    role: 'img',
