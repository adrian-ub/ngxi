...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMusicNoteDoubleCircleFilledIcon],svg[pepicons-print-music-note-double-circle-filled-icon]',
  host: {
    role: 'img',
