...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintMoneyNoteCircleFilledIcon],svg[pepicons-print-money-note-circle-filled-icon]',
  host: {
    role: 'img',
