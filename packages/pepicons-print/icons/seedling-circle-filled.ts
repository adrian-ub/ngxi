...
@Component({
  standalone: true,
  selector: 'svg[pepiconsPrintSeedlingCircleFilledIcon],svg[pepicons-print-seedling-circle-filled-icon]',
  host: {
    role: 'img',
