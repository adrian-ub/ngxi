...
@Component({
  standalone: true,
  selector: 'svg[gameIconsSacrificialDaggerIcon],svg[game-icons-sacrificial-dagger-icon]',
  host: {
    role: 'img',
