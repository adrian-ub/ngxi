...
@Component({
  standalone: true,
  selector: 'svg[gameIconsCardJackDiamondsIcon],svg[game-icons-card-jack-diamonds-icon]',
  host: {
    role: 'img',
