...
@Component({
  standalone: true,
  selector: 'svg[gameIconsClaymoreExplosiveIcon],svg[game-icons-claymore-explosive-icon]',
  host: {
    role: 'img',
