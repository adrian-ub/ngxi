...
@Component({
  standalone: true,
  selector: 'svg[gameIconsAcousticMegaphoneIcon],svg[game-icons-acoustic-megaphone-icon]',
  host: {
    role: 'img',
