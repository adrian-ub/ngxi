...
@Component({
  standalone: true,
  selector: 'svg[gameIconsFastForwardButtonIcon],svg[game-icons-fast-forward-button-icon]',
  host: {
    role: 'img',
