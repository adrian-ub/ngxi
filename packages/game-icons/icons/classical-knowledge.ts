...
@Component({
  standalone: true,
  selector: 'svg[gameIconsClassicalKnowledgeIcon],svg[game-icons-classical-knowledge-icon]',
  host: {
    role: 'img',
