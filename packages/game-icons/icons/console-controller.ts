...
@Component({
  standalone: true,
  selector: 'svg[gameIconsConsoleControllerIcon],svg[game-icons-console-controller-icon]',
  host: {
    role: 'img',
