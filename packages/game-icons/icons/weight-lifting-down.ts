...
@Component({
  standalone: true,
  selector: 'svg[gameIconsWeightLiftingDownIcon],svg[game-icons-weight-lifting-down-icon]',
  host: {
    role: 'img',
