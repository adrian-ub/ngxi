...
@Component({
  standalone: true,
  selector: 'svg[gameIconsNorthStarShurikenIcon],svg[game-icons-north-star-shuriken-icon]',
  host: {
    role: 'img',
