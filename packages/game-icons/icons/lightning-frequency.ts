...
@Component({
  standalone: true,
  selector: 'svg[gameIconsLightningFrequencyIcon],svg[game-icons-lightning-frequency-icon]',
  host: {
    role: 'img',
