...
@Component({
  standalone: true,
  selector: 'svg[gameIconsElectricalResistanceIcon],svg[game-icons-electrical-resistance-icon]',
  host: {
    role: 'img',
