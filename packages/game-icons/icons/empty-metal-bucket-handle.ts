...
@Component({
  standalone: true,
  selector: 'svg[gameIconsEmptyMetalBucketHandleIcon],svg[game-icons-empty-metal-bucket-handle-icon]',
  host: {
    role: 'img',
