...
@Component({
  standalone: true,
  selector: 'svg[gameIconsMedievalVillage01Icon],svg[game-icons-medieval-village-01-icon]',
  host: {
    role: 'img',
