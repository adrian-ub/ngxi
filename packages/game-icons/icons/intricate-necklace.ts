...
@Component({
  standalone: true,
  selector: 'svg[gameIconsIntricateNecklaceIcon],svg[game-icons-intricate-necklace-icon]',
  host: {
    role: 'img',
