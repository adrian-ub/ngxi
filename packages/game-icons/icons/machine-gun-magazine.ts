...
@Component({
  standalone: true,
  selector: 'svg[gameIconsMachineGunMagazineIcon],svg[game-icons-machine-gun-magazine-icon]',
  host: {
    role: 'img',
