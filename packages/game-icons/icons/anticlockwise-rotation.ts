...
@Component({
  standalone: true,
  selector: 'svg[gameIconsAnticlockwiseRotationIcon],svg[game-icons-anticlockwise-rotation-icon]',
  host: {
    role: 'img',
