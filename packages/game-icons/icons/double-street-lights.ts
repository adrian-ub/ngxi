...
@Component({
  standalone: true,
  selector: 'svg[gameIconsDoubleStreetLightsIcon],svg[game-icons-double-street-lights-icon]',
  host: {
    role: 'img',
