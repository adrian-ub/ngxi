...
@Component({
  standalone: true,
  selector: 'svg[gameIconsBoxingGloveSurpriseIcon],svg[game-icons-boxing-glove-surprise-icon]',
  host: {
    role: 'img',
