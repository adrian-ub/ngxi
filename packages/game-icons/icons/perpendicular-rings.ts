...
@Component({
  standalone: true,
  selector: 'svg[gameIconsPerpendicularRingsIcon],svg[game-icons-perpendicular-rings-icon]',
  host: {
    role: 'img',
