...
@Component({
  standalone: true,
  selector: 'svg[gameIconsVibratingSmartphoneIcon],svg[game-icons-vibrating-smartphone-icon]',
  host: {
    role: 'img',
