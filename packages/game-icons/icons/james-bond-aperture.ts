...
@Component({
  standalone: true,
  selector: 'svg[gameIconsJamesBondApertureIcon],svg[game-icons-james-bond-aperture-icon]',
  host: {
    role: 'img',
