...
@Component({
  standalone: true,
  selector: 'svg[gameIconsWhirlpoolShurikenIcon],svg[game-icons-whirlpool-shuriken-icon]',
  host: {
    role: 'img',
