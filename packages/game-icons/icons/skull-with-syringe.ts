...
@Component({
  standalone: true,
  selector: 'svg[gameIconsSkullWithSyringeIcon],svg[game-icons-skull-with-syringe-icon]',
  host: {
    role: 'img',
