...
@Component({
  standalone: true,
  selector: 'svg[gameIconsBowlingPropulsionIcon],svg[game-icons-bowling-propulsion-icon]',
  host: {
    role: 'img',
