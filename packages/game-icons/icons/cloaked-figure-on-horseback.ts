...
@Component({
  standalone: true,
  selector: 'svg[gameIconsCloakedFigureOnHorsebackIcon],svg[game-icons-cloaked-figure-on-horseback-icon]',
  host: {
    role: 'img',
