...
@Component({
  standalone: true,
  selector: 'svg[gameIconsImperialCrownIcon],svg[game-icons-imperial-crown-icon]',
  host: {
    role: 'img',
...
export class GameIconsImperialCrownIcon {
