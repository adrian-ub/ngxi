...
@Component({
  standalone: true,
  selector: 'svg[gameIconsSatelliteCommunicationIcon],svg[game-icons-satellite-communication-icon]',
  host: {
    role: 'img',
