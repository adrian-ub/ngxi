...
@Component({
  standalone: true,
  selector: 'svg[gameIconsCommercialAirplaneIcon],svg[game-icons-commercial-airplane-icon]',
  host: {
    role: 'img',
