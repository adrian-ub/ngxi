...
@Component({
  standalone: true,
  selector: 'svg[gameIconsCaptainHatProfileIcon],svg[game-icons-captain-hat-profile-icon]',
  host: {
    role: 'img',
