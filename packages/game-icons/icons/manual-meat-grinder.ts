...
@Component({
  standalone: true,
  selector: 'svg[gameIconsManualMeatGrinderIcon],svg[game-icons-manual-meat-grinder-icon]',
  host: {
    role: 'img',
