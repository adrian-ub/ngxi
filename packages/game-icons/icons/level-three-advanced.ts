...
@Component({
  standalone: true,
  selector: 'svg[gameIconsLevelThreeAdvancedIcon],svg[game-icons-level-three-advanced-icon]',
  host: {
    role: 'img',
