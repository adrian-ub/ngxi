...
@Component({
  standalone: true,
  selector: 'svg[gameIconsRadarCrossSectionIcon],svg[game-icons-radar-cross-section-icon]',
  host: {
    role: 'img',
