...
@Component({
  standalone: true,
  selector: 'svg[vs1SquareIcon],svg[vs-1-square-icon]',
  host: {
    role: 'img',
...
@Component({
  standalone: true,
  selector: 'svg[vs6SquareIcon],svg[vs-6-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vs7SquareIcon],svg[vs-7-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vs8SquareIcon],svg[vs-8-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsBabyIcon],svg[vs-baby-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsCSquareIcon],svg[vs-c-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m-37 896q0 162 80 299.5T596.5 1413t299.5 80q192 0 340.5-98.5T1449 1127q30-81-23-81h-186q-20 0-32 4t-16 7.5t-15 19.5t-18 25q-47 60-116 95t-149 35q-140 0-238.5-98.5T557 896t98.5-237.5T894 560q80 0 149 35t116 95q6 8 13 18l10.5 15l8.5 10.5l11 7.5l15.5 3.5l22.5 1.5h186q53 0 23-81q-64-169-212.5-267.5T896 299q-162 0-299.5 80T379 596.5T299 896"></svg:path>`,
})
export class VsCSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsCalendarAlt2Icon],svg[vs-calendar-alt-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsCamelIcon],svg[vs-camel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsCatFaceIcon],svg[vs-cat-face-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsCcCardIcon],svg[vs-cc-card-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsChairIcon],svg[vs-chair-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M384 896h768q53 0 90.5 37t37.5 91t-38 91t-90 37h-48l20 608q1 13-8.5 22.5t-22.5 9.5h-69q-12 0-21-9.5t-10-22.5l-18-608H448l-102 609q-5 31-31 31h-74q-13 0-22.5-9.5T210 1761l95-609q-4-2-44-5.5t-66.5-26.5t-42.5-80q-16-59-26.5-150t-20-221.5T92 497q-5-56-48.5-176.5T0 128q0-46 31.5-87T128 0q59 0 88 37.5T269 154q91 298 115 742"></svg:path>`,
})
export class VsChairIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsChairAltIcon],svg[vs-chair-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsChickenIcon],svg[vs-chicken-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsClipNoteIcon],svg[vs-clip-note-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsClipNoteOIcon],svg[vs-clip-note-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1664 256v637q0 110-.5 153t-1.5 130t-3 122.5t-6.5 102t-11 97.5t-16 80.5t-22 80t-29.5 66t-38 67.5H0q79-242 103.5-447.5T128 768V256h256v-54q0-88 68-147Q517 0 617 0q91 0 151.5 39t80.5 88q13 33 13 89H734q-5-58-35-82.5T609 109q-52 0-82 50q-6 11-9.5 25t-4.5 21t-1 27v24zM512 384v448q-1 32 15 46.5t49 17.5q40 0 52-12.5t12-51.5V512h128v320q0 71-12 99q-41 93-180 93q-86 0-139-53t-53-139V384H256v384q0 326-17.5 515T167 1664h1275q28-57 46-122.5t27.5-118.5t14-155t5.5-163.5t1-211.5V384z"></svg:path>`,
})
export class VsClipNoteOIcon {
  readonly viewBox = input("0 0 1664 1792")
  readonly width = input("0.93em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsClipboardIcon],svg[vs-clipboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsClockIcon],svg[vs-clock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1088 768H904q-29-32-72-32h-5L475 384q-19-19-45.5-19T384 384t-19 45.5t19 45.5l352 352v5q0 40 28 68t68 28q43 0 72-32h184q26 0 45-19t19-45t-19-45t-45-19M832 256q26 0 45 19t19 45t-19 45t-45 19t-45-19t-19-45t19-45t45-19m0 1024q26 0 45 19t19 45t-19 45t-45 19t-45-19t-19-45t19-45t45-19M320 768q26 0 45 19t19 45t-19 45t-45 19t-45-19t-19-45t19-45t45-19m1024 0q26 0 45 19t19 45t-19 45t-45 19t-45-19t-19-45t19-45t45-19M832 0Q663 0 508.5 66T243 243T66 508.5T0 832t66 323.5T243 1421t265.5 177t323.5 66t323.5-66t265.5-177t177-265.5t66-323.5t-66-323.5T1421 243T1155.5 66T832 0m0 128q143 0 273.5 55.5t225 150t150 225T1536 832t-55.5 273.5t-150 225t-225 150T832 1536t-273.5-55.5t-225-150t-150-225T128 832t55.5-273.5t150-225t225-150T832 128"></svg:path>`,
})
export class VsClockIcon {
  readonly viewBox = input("0 0 1664 1664")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsClockAltIcon],svg[vs-clock-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M768 416q26 0 45 19t19 45v192l266 207q22 20 22 49q0 26-19 45t-45 19t-44-18L733 758q-29-19-29-54V480q0-26 19-45t45-19m0-416Q559 0 382.5 103T103 382.5T0 768t103 385.5T382.5 1433T768 1536t385.5-103t279.5-279.5T1536 768t-103-385.5T1153.5 103T768 0m0 224q148 0 273 73t198 198t73 273t-73 273t-198 198t-273 73t-273.5-73t-198-198T224 768t72.5-273t198-198T768 224"></svg:path>`,
})
export class VsClockAltIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsCommentBubbleIcon],svg[vs-comment-bubble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1792 704q0 174-120 321.5t-326 233t-450 85.5q-70 0-145-8q-198 175-460 242q-49 14-114 22q-17 2-30.5-9t-17.5-29v-1q-3-4-.5-12t2-10t4.5-9.5l6-9l7-8.5l8-9q7-8 31-34.5t34.5-38t31-39.5t32.5-51t27-59t26-76q-157-89-247.5-220T0 704q0-130 71-248.5T262 251t286-136.5T896 64q244 0 450 85.5t326 233T1792 704"></svg:path>`,
})
export class VsCommentBubbleIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsCommentsIcon],svg[vs-comments-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1664 64q49 0 88.5 39.5T1792 192v512q0 52-38 90t-90 38h-128v384l-388-384H768q-50 0-89-39t-39-89V192q0-50 39-89t89-39zM512 704q1 97 80 176q76 76 176 80h384v128q0 49-37.5 88.5T1028 1216H644l-388 384v-384H128q-50 0-89-39t-39-89V576q0-50 39-89t89-39h384z"></svg:path>`,
})
export class VsCommentsIcon {
  readonly viewBox = input("0 0 1792 1600")
  readonly width = input("1.13em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsCowIcon],svg[vs-cow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M768 1152q59-25 145.5-44.5T1088 1088q166 0 320 64q-12-81 11-155.5t77-172.5h-157q-34 0-58.5-25.5T1256 738t24.5-60.5T1339 652h209q7-102 1.5-138.5T1522 455q-32-31-109-51t-133-20H896q-56 0-132 20t-108 51q-22 22-27.5 58.5T630 652h208q34 0 59 25.5t25 60.5t-25 60.5t-59 25.5H682q53 96 75.5 171.5T768 1152m0-960h640q61 0 128 64q50 0 90-6.5t71.5-20.5t53.5-28t46-41t38.5-45.5t41-55.5T1920 0q22 60 24.5 113t-11.5 91.5t-40 71t-57 53.5t-67.5 36.5t-68.5 23t-61 10.5q7 27 15.5 88t9.5 89q8-8 131.5-67t132.5-59q11 0 64 41t113 91t71 58q-41 28-69 59.5t-40 53t-27.5 40.5t-43.5 29t-76 10q-38 0-74-12.5t-72.5-39t-56-43.5t-54.5-51q-7 77-28.5 141T1592 927.5t-38 95t-18 129.5q-1 44 31.5 135t32.5 121q0 60-37.5 107.5t-93 74.5t-128 44.5t-134 23.5t-119.5 6t-119.5-6t-134-23.5t-128-44.5t-93-74.5T576 1408q0-30 32.5-121t31.5-135q-1-71-18-129.5t-38-95T541.5 827T513 686q-35 34-54.5 51t-56 43.5t-72.5 39t-74 12.5q-48 0-76-10t-43.5-29t-27.5-40.5t-40-53T0 640q10-7 71-57.5T185 491t64-41q9 0 132 59t131 67q1-28 10-89t16-88q-29-3-61-10.5t-68.5-23t-68-36.5t-57.5-53.5t-39.5-71T232 113T256 0q17 22 43.5 59t41 55.5T379 160t46 41t53.5 28t71.5 20.5t90 6.5q67-64 128-64m552 1063q-38 0-62.5 21.5T1233 1334v79q0 36 24.5 57.5t62.5 21.5q37 0 62-21.5t25-57.5v-79q0-36-25-57.5t-62-21.5m-464 0q-37 0-62 21.5t-25 57.5v79q0 36 25 57.5t62 21.5q38 0 62.5-21.5T943 1413v-79q0-36-24.5-57.5T856 1255"></svg:path>`,
})
export class VsCowIcon {
  readonly viewBox = input("0 0 2176 1664")
...
@Component({
  standalone: true,
  selector: 'svg[vsCrownIcon],svg[vs-crown-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1472 1216H192q-24 0-44 38.5t-20 89.5t20 89.5t44 38.5h1280q24 0 44-38.5t20-89.5t-20-89.5t-44-38.5M128 128q-53 0-90.5 37.5T0 256t37.5 90.5T128 384l80 703h1248l80-703q53 0 90.5-37.5T1664 256t-37.5-90.5T1536 128t-90.5 37.5T1408 256q0 56 41 94q-153 183-207 236.5t-90 53.5q-34 0-83-66.5T899 301q28-17 44.5-46t16.5-63q0-53-37.5-90.5T832 64t-90.5 37.5T704 192q0 34 16.5 63t44.5 46Q644 507 595 573.5T512 640q-36 0-90-53.5T215 350q41-38 41-94q0-53-37.5-90.5T128 128"></svg:path>`,
})
export class VsCrownIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsCutleryIcon],svg[vs-cutlery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1280 64v1600q0 36-18 64q-16 30-46 46q-28 18-64 18t-64-18q-29-17-46-46q-18-28-18-64v-512H800q-13 0-22-10q-19-19 4-145q4-25 15.5-101.5t21.5-143T847 591t37-171.5t47.5-158t59.5-136t73-90T1152 0h64q26 0 45 19t19 45m-640 0v640q0 38-8 65t-19 42.5t-32 27.5t-37 17t-46.5 13.5T448 885v779q0 36-18 64q-17 29-46 46q-29 18-64 18q-36 0-64-18q-29-17-46-46q-18-28-18-64V885q-19-7-49.5-15.5T96 856t-37-17t-32-27.5T8 769t-8-65V64q2-28 19-45T64 0q28 2 45 19q19 19 19 45v416q0 26 19 45t45 19t45-19t19-45V64q2-28 19-45t45-19q28 2 45 19t19 45v416q0 26 19 45t45 19t45-19t19-45V64q2-28 19-45t45-19q28 2 45 19t19 45"></svg:path>`,
})
export class VsCutleryIcon {
  readonly viewBox = input("0 0 1280 1792")
  readonly width = input("0.72em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsDSquareIcon],svg[vs-d-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsDrumstickIcon],svg[vs-drumstick-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsESquareIcon],svg[vs-e-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m339 546h584q31 0 53-21.5t22-52.5v-98q0-31-22-53t-53-22H502q-30 0-52 22t-22 53v1044q0 31 22 53t52 22h757q31 0 53-22t22-53v-98q0-31-22-52.5t-53-21.5H677l-2-226h423q31 0 53-22t22-53v-98q0-31-22-53t-53-22H675z"></svg:path>`,
})
export class VsESquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsEditPageIcon],svg[vs-edit-page-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFaceAllergyIcon],svg[vs-face-allergy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFaceDislikeIcon],svg[vs-face-dislike-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M832 0q169 0 323 66t265.5 177.5T1598 509t66 323t-66 323.5t-177.5 265.5t-265.5 177t-323 66t-323-66t-265.5-177T66 1155.5T0 832t66-323t177.5-265.5T509 66T832 0M607 1265q122-111 225-113q102 0 225 113q20 19 44.5 14.5t38.5-29.5q30-50-12-89q-148-137-296-137t-296 137q-42 40-12 89q15 25 39 29.5t44-14.5M384 704q0 53 37.5 90.5T512 832t90.5-37.5T640 704t-37.5-90.5T512 576t-90.5 37.5T384 704m768 128q53 0 90.5-37.5T1280 704t-37.5-90.5T1152 576t-90.5 37.5T1024 704t37.5 90.5T1152 832"></svg:path>`,
})
export class VsFaceDislikeIcon {
  readonly viewBox = input("0 0 1664 1664")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsFaceLikeIcon],svg[vs-face-like-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M832 0q169 0 323 66t265.5 177.5T1598 509t66 323t-66 323.5t-177.5 265.5t-265.5 177t-323 66t-323-66t-265.5-177T66 1155.5T0 832t66-323t177.5-265.5T509 66T832 0M384 640q0 53 37.5 90.5T512 768t90.5-37.5T640 640t-37.5-90.5T512 512t-90.5 37.5T384 640m448 704q137 0 243.5-89.5T1216 1025H448q34 141 140 230t244 89m320-576q53 0 90.5-37.5T1280 640t-37.5-90.5T1152 512t-90.5 37.5T1024 640t37.5 90.5T1152 768"></svg:path>`,
})
export class VsFaceLikeIcon {
  readonly viewBox = input("0 0 1664 1664")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsFileDownloadIcon],svg[vs-file-download-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFileDownloadOIcon],svg[vs-file-download-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class VsFileDownloadOIcon {
  readonly viewBox = input("0 0 1280 1536")
  readonly width = input("0.84em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsFileMoveOIcon],svg[vs-file-move-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFishIcon],svg[vs-fish-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFloorsIcon],svg[vs-floors-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsFlowerIcon],svg[vs-flower-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M896 1792q277 0 516-113.5t380-334.5q-80-50-240-45t-298 65q-90 39-159 98t-96 113v-449q201-28 332-153t131-326V81q0-34-23.5-57.5T1381 0q-21 10-67.5 56.5t-103 109T1139 243q-13-13-71-80.5t-105.5-115T896 0q-20 0-67.5 47.5t-105 115T653 243q-15-15-71.5-77.5t-103-109T410 0q-33 0-57 23.5T329 81v566q0 102 36.5 187.5T466 979t147 96.5t179 50.5v449q-26-53-95-112.5T538 1364q-138-60-298-65T0 1344q142 221 380.5 334.5T896 1792"></svg:path>`,
})
export class VsFlowerIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsGSquareIcon],svg[vs-g-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsGanttIcon],svg[vs-gantt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsGanttOIcon],svg[vs-gantt-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1408 106v250q0 18-9 30t-23 12H32q-14 0-23-12t-9-30V106q0-18 9-30t23-12h1344q14 0 23 12t9 30m512 400v250q0 18-9 30t-23 12H544q-14 0-23-12t-9-30V506q0-16 9-28t23-14h1344q14 2 23 14t9 28m-768 402v250q0 17-9.5 29.5T1120 1200H288q-12 0-22-13t-10-29V908q0-18 10-30t22-12h832q14 0 23 12t9 30m512 400v250q0 17-9.5 29.5T1632 1600H800q-12 0-22-13t-10-29v-250q0-16 10-29t22-13h832q13 0 22.5 12.5t9.5 29.5"></svg:path>`,
})
export class VsGanttOIcon {
  readonly viewBox = input("0 0 1920 1600")
...
@Component({
  standalone: true,
  selector: 'svg[vsGlobeIcon],svg[vs-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsGrapesIcon],svg[vs-grapes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsHSquareIcon],svg[vs-h-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsHourglassIcon],svg[vs-hourglass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsISquareIcon],svg[vs-i-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m864 299H591q-30 0-52 22t-22 53v149q0 31 22 52.5t52 21.5h156v598H591q-30 0-52 21.5t-22 52.5v149q0 31 22 53t52 22h609q31 0 53-22t22-53v-149q0-31-22-52.5t-53-21.5h-155V597h155q31 0 53-21.5t22-52.5V374q0-31-22-53t-53-22"></svg:path>`,
})
export class VsISquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsIdBadgeAltIcon],svg[vs-id-badge-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsIdCardAltIcon],svg[vs-id-card-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2368 192v1280q0 78-57 135t-135 57H192q-77 0-134.5-57T0 1472V192q0-77 57.5-134.5T192 0h1984q78 0 135 57.5t57 134.5m-1333 940q0-65-8.5-120t-29-106.5t-60-81T842 795q-79 76-185 76q-110 0-186-76q-56 0-96 29.5t-60 81t-28.5 106.5t-8.5 120q0 64 37 109.5t89 45.5h506q52 0 88.5-45.5T1035 1132M884 607q0-95-66.5-162.5T657 377t-161 67.5T429 607q0 93 67 159.5T657 833t160.5-66.5T884 607m1213 567v-76q0-16-11.5-27t-26.5-11h-836q-15 0-26.5 11t-11.5 27v76q0 16 11.5 27t26.5 11h836q15 0 26.5-11t11.5-27m-454-303v-76q0-16-11.5-27t-26.5-11h-382q-15 0-26.5 11t-11.5 27v76q0 17 11.5 28t26.5 11h382q15 0 26.5-11t11.5-28m454 0v-76q0-16-11.5-27t-26.5-11h-229q-16 0-26.5 10.5T1793 795v76q0 17 10.5 28t26.5 11h229q15 0 26.5-11t11.5-28m0-303v-76q0-16-11.5-27t-26.5-11h-836q-15 0-26.5 11t-11.5 27v76q0 16 11.5 27.5T1223 607h836q15 0 26.5-11.5T2097 568"></svg:path>`,
})
export class VsIdCardAltIcon {
  readonly viewBox = input("0 0 2368 1664")
  readonly width = input("1.43em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsKSquareIcon],svg[vs-k-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsKakaoSquareIcon],svg[vs-kakao-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1792 1652V140q0-58-41-99t-99-41H140Q82 0 41 41T0 140v1512q0 58 41 99t99 41h1512q58 0 99-41t41-99M896 252q198 0 365.5 77t265 209t97.5 288t-97.5 288t-265 209t-365.5 77q-66 0-129-9q-68 49-180.5 125T459 1594q-9 4-17-1q-4-2-5.5-6.5t-1.5-7.5v-3q1-5 74-264q-156-77-248.5-206T168 826q0-156 97.5-288t265-209T896 252"></svg:path>`,
})
export class VsKakaoSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsKakaotalkIcon],svg[vs-kakaotalk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsKakaotalkSquareIcon],svg[vs-kakaotalk-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsKanjiChuIcon],svg[vs-kanji-chu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m530 1079l-226-75q-32 112-115 313q-87 212-178 344l225 131q87-140 174-351q90-218 120-362m-67-330Q347 633 133 471L0 664q185 148 322 290zm83-435q-96-96-333-282L71 219q186 156 330 300zm1246 1442v-233h-503v-387h422V908h-422V596h471V371h-432l56-45Q1231 163 1049 0L850 151q148 140 222 220H553v225h469v312H585v228h437v387H480v233z"></svg:path>`,
})
export class VsKanjiChuIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsKanjiUtageIcon],svg[vs-kanji-utage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsKanjiYubiIcon],svg[vs-kanji-yubi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1482 1741v64h260V892H738v913h251v-64zm0-516H989v-130h493zm-493 315v-132h493v132zm-292-520l-21-207q-38 15-151 47V575h159V370H525V31H274v339H53v205h221v351Q93 969 14 979l49 232l211-56v373q0 59-63 59H57l29 232h219q94 0 157-52q63-53 63-148v-536q114-37 172-63m1097-433V359l-218-26q0 188-25 213q-27 25-263 25q-93 0-171-5q-61-3-87-7q-18-4-27-17q-10-15-10-34v-75q578-100 774-185L1634 43q-168 83-641 178V27H740v552q0 94 54 145q55 52 199 61q139 10 266 10q369 0 453-52q82-52 82-156"></svg:path>`,
})
export class VsKanjiYubiIcon {
  readonly viewBox = input("0 0 1824 1824")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsKeyboardIcon],svg[vs-keyboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1600 192q132 0 226 94t94 226v512q0 132-94 226t-226 94H320q-132 0-226-94T0 1024V512q0-132 94-226t226-94zM320 1216h1280q80 0 136-56t56-136V512q0-80-56-136t-136-56H320q-80 0-136 56t-56 136v512q0 80 56 136t136 56m-64-768v128h128V448zm256 0v128h128V448zm256 0v128h128V448zm256 0v128h128V448zm512 0v128h128V448zm-256 0v128h128V448zM256 704v128h128V704zm256 0v128h128V704zm256 0v128h128V704zm256 0v128h128V704zm512 0v128h128V704zm-256 0v128h128V704zM256 960v128h128V960zm1280 0v128h128V960zm-1024 0h896v128H512z"></svg:path>`,
})
export class VsKeyboardIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsLSquareIcon],svg[vs-l-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m43 1419q0 31 22 52.5t53 21.5h884q31 0 53-21.5t22-52.5v-150q0-31-22-52.5t-53-21.5H678V373q0-31-22-52.5T603 299H454q-31 0-53 21.5T379 373z"></svg:path>`,
})
export class VsLSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsLanguageIcon],svg[vs-language-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsLineIcon],svg[vs-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsLineSquareIcon],svg[vs-line-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1546 816q0-143-87.5-265T1221 358t-327-71t-327 71t-237.5 193T242 816q0 196 155 343t391 178q47 11 57 33q7 18 2 59q-7 46-9 56q-4 35 9 42q14 7 47-7q73-31 247.5-152.5T1407 1142q139-154 139-326m-217-69h-125v47h125q13 0 13 13v46q0 13-13 13h-125v47h125q13 0 13 13v46q0 13-13 13h-183q-12 0-12-13V688q0-13 12-13h183q13 0 13 13v46q0 13-13 13M651 913q13 0 13 13v46q0 13-13 13H469q-12 0-12-13V688q0-13 12-13h46q12 0 12 13v225zm426-238q13 0 13 13v284q0 13-13 13h-46q-7 0-11-6L891 803v169q0 13-13 13h-46q-13 0-13-13V688q0-13 13-13h46q4 0 10 6l130 176V688q0-13 13-13zm-315 0q13 0 13 13v284q0 13-13 13h-46q-13 0-13-13V688q0-13 13-13zM336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0"></svg:path>`,
})
export class VsLineSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsMSquareIcon],svg[vs-m-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsMagnetNoteIcon],svg[vs-magnet-note-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsMaleFemaleIcon],svg[vs-male-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsMicIcon],svg[vs-mic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsMobileIcon],svg[vs-mobile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsMultiArrowIcon],svg[vs-multi-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1100 1653l382-382h-260V442q39 70 89 143t91 126t110 131t106 117t122 127.5t116 121.5l-200 200h544V808l-200 200q-70-60-157.5-128T1694 766.5t-130.5-103T1447 559t-93-108.5t-72.5-124.5t-43-143.5T1222 8H978q0 94-16.5 177T919 333.5t-73.5 133t-92 117.5t-117 114t-130 110t-149 120T200 1058L0 858v550h550l-200-200q21-22 99-104t104.5-110.5t91-99t97-111.5t81-103.5t85-119.5T978 442v829H718z"></svg:path>`,
})
export class VsMultiArrowIcon {
  readonly viewBox = input("0 0 2208 1664")
  readonly width = input("1.33em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsNSquareIcon],svg[vs-n-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsNekoIcon],svg[vs-neko-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M464 720q-49 0-80.5 31.5T352 832t31.5 80.5T464 944t80.5-31.5T576 832t-31.5-80.5T464 720m866-2q-50 0-82 32t-32 82t32 82t82 32t82-32t32-82t-32-82t-82-32M566 366q29-12 344-12t344 12q3 1 9.5-8t18-25.5T1308 294t37-48.5t46.5-53T1449 138t68-51q69-46 119.5-66T1744 1q30 59 15.5 303.5T1714 615q32 58 55 156.5t23 188.5q0 323-235 513.5T896 1664q-167 0-300.5-21.5t-247-72t-189-130T42 1240T0 960q0-136 13-207.5T61 616q-19-40-31.5-175.5t-9-270.5T44 1q26 0 44 3t36.5 11.5t28.5 15T189.5 56T234 87q75 49 156 121t126 116t50 42m733 887q0-29-10.5-47t-21.5-24.5t-32-13.5q-24 48-70 79.5t-84 32.5q-44 1-99-42.5t-86-85.5q-20 39-66.5 82t-86.5 44q-48 1-81-6t-54-26t-31-33.5t-25-43.5q-26-2-46 15.5t-19 41.5q-2 55 75 118.5t142 63.5q51 0 88-12t51-25t29.5-33.5T894 1312q2 1 25 25.5t39 36.5t52 24t78 10q50 0 130.5-59.5t80.5-95.5"></svg:path>`,
})
export class VsNekoIcon {
  readonly viewBox = input("0 0 1792 1664")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsNekoSleepIcon],svg[vs-neko-sleep-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsNinjaIcon],svg[vs-ninja-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsNoCommentBubbleIcon],svg[vs-no-comment-bubble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1792 768q0 150-91.5 282T1450 1271L793 132q68-4 103-4q244 0 450 85.5t326 233T1792 768M539 21q256 444 457.5 793t362.5 629q9 14 4.5 31t-18.5 25l-108 62q-15 8-31.5 4t-24.5-19l-89-153q-95 15-196 15q-70 0-145-8q-198 175-460 242q-49 14-114 22q-17 2-30.5-9t-17.5-29v-1q-3-4-.5-12t2-10t4.5-9.5l6-9l7-8.5l8-9q7-8 31-34.5t34.5-38t31-39.5t32.5-51t27-59t26-76q-157-89-247.5-220T0 768q0-168 113-311.5T419 226l-59-102q-8-14-4-31t19-25L482 6q15-8 31.5-3.5T539 21"></svg:path>`,
})
export class VsNoCommentBubbleIcon {
  readonly viewBox = input("0 0 1792 1664")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsNoSmokingAltIcon],svg[vs-no-smoking-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1504 640q0-23-5-40t-17-27.5t-22.5-17t-33-9.5t-36.5-4.5t-43-2.5q-47-2-72-4t-72-13t-75.5-29.5t-66-56t-61-89.5T957 214.5T928 32q0-14 9-23t23-9t23 9t9 23q7 86 23 154t35.5 114t47.5 79.5t54.5 52t62 29.5t62.5 14t64 4q10 0 35.5.5t35 1t31.5 2.5t31 5t25.5 9t24 14t18 20t15 27t8 36t3.5 46v96q0 14-9 23t-23 9t-23-9t-9-23zm0-320q-2-160-160-160h-96q-14 0-23-9t-9-23t9-23t23-9h96q101 0 158.5 49.5T1560 292q53 0 85 9.5t61 40.5q56 60 54 170v224q0 14-9 23t-23 9t-23-9t-9-23V512q0-72-31-116t-97-44h-64zm-362 832l221 383q8 13 4 28.5t-18 23.5l-100 58q-13 8-29 3.5t-23-17.5L435 312q-8-14-4-29.5t18-23.5l100-57q13-8 29-4t24 18l355 616h451v320zM0 832h578l185 320H0zm1503 0q-12 0-21.5 9t-9.5 22v258q0 13 9.5 22t21.5 9h66q12 0 21.5-9t9.5-22V863q0-13-9.5-22t-21.5-9zm192 0q-12 0-21.5 9t-9.5 22v258q0 13 9.5 22t21.5 9h66q12 0 21.5-9t9.5-22V863q0-13-9.5-22t-21.5-9z"></svg:path>`,
})
export class VsNoSmokingAltIcon {
  readonly viewBox = input("0 0 1792 1664")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsOSquareIcon],svg[vs-o-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsPantherIcon],svg[vs-panther-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsPartyIcon],svg[vs-party-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsPeopleGroupIcon],svg[vs-people-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsPersonIcon],svg[vs-person-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M832 0Q673 0 560.5 112.5T448 384t112.5 271.5T832 768t271.5-112.5T1216 384t-112.5-271.5T832 0m0 896q112 0 227 22t224 69.5t193.5 114t136 162.5t51.5 208q0 75-57 133.5t-135 58.5H192q-78 0-135-58.5T0 1472q0-112 51.5-208t136-162.5t193.5-114T605 918t227-22"></svg:path>`,
})
export class VsPersonIcon {
  readonly viewBox = input("0 0 1664 1664")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsPigIcon],svg[vs-pig-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsPregnantIcon],svg[vs-pregnant-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsProfileIcon],svg[vs-profile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsQSquareIcon],svg[vs-q-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsQuestionSquareIcon],svg[vs-question-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class VsQuestionSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsRSquareIcon],svg[vs-r-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsRoseIcon],svg[vs-rose-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsSSquareIcon],svg[vs-s-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m94 656q0 100 38.5 167t100 98.5t136 48.5t149 24.5t136 19t100 41t38.5 81.5q0 61-68 103.5T896 1282q-71 0-129-24.5t-85-64.5q-25-38-40-47.5t-42-9.5H477q-57 0-39 68q33 124 161.5 206.5T896 1493q126 0 233.5-48t170-130t62.5-179q0-100-38.5-167t-100-98.5t-136-48.5t-149-24.5t-136-19t-100-41T664 656q0-61 68-103.5T896 510q71 0 129 24.5t85 64.5q25 38 40 47.5t42 9.5h123q57 0 39-68q-33-124-161.5-206.5T896 299q-126 0-233.5 48t-170 130T430 656"></svg:path>`,
})
export class VsSSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSeniorIcon],svg[vs-senior-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M642 0q-78 0-132.5 55T455 188t54.5 132.5T642 375q79 0 133.5-54.5T830 188T775.5 55T642 0m-92 428q-24-52-88-56q-24-2-94-2q-159 5-286 205q-61 97-74.5 201T38 980l62 269l-75 406q-9 52 21.5 94t80.5 43q119 0 141-89l89-389q8-38 8-53t-9-56l-42-248l110-292q9 13 32.5 50t39.5 60t40 52.5t48.5 49.5t49.5 31q23 10 328 74q41 8 68.5-24t27.5-66q0-43-57-74l-288-82zm241 767q0-71 50.5-121t122.5-50q70 0 120.5 50t50.5 121l-2 554q0 18-12.5 30.5T1090 1792q-17 0-30-12.5t-13-30.5v-554q0-36-24-61t-59-25q-36 0-60.5 25t-24.5 61q0 18-13 30t-30 12q-18 0-31.5-12t-13.5-30"></svg:path>`,
})
export class VsSeniorIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsSheepIcon],svg[vs-sheep-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsShieldCheckIcon],svg[vs-shield-check-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1000 20l1000 300q0 136-2.5 228t-13 217.5t-30 216t-55 205T1813 1391t-126.5 195t-172.5 196t-226.5 188.5T1000 2160q-158-92-287.5-189.5T486 1782t-172.5-196T187 1391t-86.5-204.5t-55-205t-30-216T2.5 548T0 320zm673 732q0-36-24-60l-118-118q-25-25-59-25q-33 0-58 25l-533 531l-294-295q-24-24-59-24t-59 24L351 928q-25 25-25 61q0 32 25 57l472 472q25 25 58 25q35 0 60-25l708-708q24-24 24-58"></svg:path>`,
})
export class VsShieldCheckIcon {
  readonly viewBox = input("0 0 2016 2176")
  readonly width = input("0.93em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsShieldTimesIcon],svg[vs-shield-times-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1000 20l1000 300q0 136-2.5 228t-13 217.5t-30 216t-55 205T1813 1391t-126.5 195t-172.5 196t-226.5 188.5T1000 2160q-158-92-287.5-189.5T486 1782t-172.5-196T187 1391t-86.5-204.5t-55-205t-30-216T2.5 548T0 320zm497 1237q0-34-25-59l-236-236l236-235q25-25 25-60q0-36-25-59l-117-118q-23-24-59-24t-60 24l-236 237l-236-237q-24-24-59-24q-37 0-59 24L528 608q-26 24-26 59q0 34 26 60l236 235l-236 236q-26 26-26 59q0 36 26 60l118 118q23 25 59 25q34 0 59-25l236-237l236 237q25 25 60 25q36 0 59-25l117-118q25-23 25-60"></svg:path>`,
})
export class VsShieldTimesIcon {
  readonly viewBox = input("0 0 2016 2176")
  readonly width = input("0.93em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsShopIcon],svg[vs-shop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1664 675V331q0-40-50-89.5T1503.5 160t-95.5-32q0-24-20-44t-44-20H320q-24 0-44 20t-20 44q-35 0-95.5 32T50 241.5T0 331v337q0 39 34.5 72t93.5 42v562q-26 0-45 19t-19 45t19 45t45 19h1408q26 0 45-19t19-45t-19-45t-45-19V785q60-10 94-40.5t34-69.5M896 896v448H256V782q79-24 96-39q57 50 160 50t160-50q57 50 160 50t160-50q57 50 160 50t160-50q17 15 96 39v562h-128V896zm64 64h256v384H960zM384 677l-1-377q0-58 33.5-82t94.5-26h129q0 54 1 223.5t0 261.5q-37 50-129 50q-90 0-128-50m639 0V192h128q24 1 31 1.5t26 3t25 6t18 11.5t16 19t8 28t4 39l1 377q-6 27-41.5 41t-86.5 14t-87-14t-42-41M384 896v320h384V896zm64 64h256v192H448z"></svg:path>`,
})
export class VsShopIcon {
  readonly viewBox = input("0 0 1664 1472")
  readonly width = input("1.14em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSleepSquareIcon],svg[vs-sleep-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M288 0Q170 0 85 85T0 288v960q0 118 85 203t203 85h960q118 0 203-85t85-203V288q0-118-85-203T1248 0zm663 928v46q0 10-6.5 16.5T928 997H608q-10 0-16.5-6.5T585 974v-46q0-23 14-40q36-43 107.5-128.5T814 631H608q-10 0-16.5-6.5T585 608v-46q0-10 6.5-16.5T608 539h320q10 0 16.5 6.5T951 562v46q0 23-14 40q-36 43-107.5 128.5T722 905h206q10 0 16.5 6.5T951 928m457 274v46q0 10-6.5 16.5t-16.5 6.5h-320q-10 0-16.5-6.5t-6.5-16.5v-46q0-22 14-40q43-50 124-147.5t91-109.5h-206q-10 0-16.5-6.5T1042 882v-45q0-10 6.5-16.5t16.5-6.5h320q10 0 16.5 6.5t6.5 16.5v45q0 23-14 40q-10 12-91 109.5T1179 1179h206q10 0 16.5 6.5t6.5 16.5M494 654v45q0 10-6.5 16.5T471 722H151q-10 0-16.5-6.5T128 699v-45q0-23 14-40q10-12 91-109.5T357 357H151q-10 0-16.5-6.5T128 334v-46q0-10 6.5-16.5T151 265h320q10 0 16.5 6.5T494 288v46q0 22-14 40q-43 50-124 147.5T265 631h206q10 0 16.5 6.5T494 654"></svg:path>`,
})
export class VsSleepSquareIcon {
  readonly viewBox = input("0 0 1536 1536")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSmokingIcon],svg[vs-smoking-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2 786q1 95 41.5 193.5T154 1152q-16-79-13.5-157T159 868q13-41 38.5-78t50-64.5t48.5-58t39.5-73T353 499q2-55-9.5-114t-39-120t-68-112.5T135 60T0 0q47 49 77.5 104.5t43.5 113t17 97.5t4 93q1 54-21 109.5t-48.5 94t-48.5 86T2 786m557 668l-147-292l1234-619l146 291zm-408 205L4 1368l290-146l146 291z"></svg:path>`,
})
export class VsSmokingIcon {
  readonly viewBox = input("0 0 1792 1664")
  readonly width = input("1.08em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSmokingAltIcon],svg[vs-smoking-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1504 640q0-23-5-40t-17-27.5t-22.5-17t-33-9.5t-36.5-4.5t-43-2.5q-47-2-72-4t-72-13t-75.5-29.5t-66-56t-61-89.5T957 214.5T928 32q0-14 9-23t23-9t23 9t9 23q7 86 23 154t35.5 114t47.5 79.5t54.5 52t62 29.5t62.5 14t64 4q10 0 35.5.5t35 1t31.5 2.5t31 5t25.5 9t24 14t18 20t15 27t8 36t3.5 46v96q0 14-9 23t-23 9t-23-9t-9-23zm0-320q-2-160-160-160h-96q-14 0-23-9t-9-23t9-23t23-9h96q101 0 158.5 49.5T1560 292q53 0 85 9.5t61 40.5q56 60 54 170v224q0 14-9 23t-23 9t-23-9t-9-23V512q0-72-31-116t-97-44h-64zM0 832h1408v320H0zm1503 0q-12 0-21.5 9t-9.5 22v258q0 13 9.5 22t21.5 9h66q12 0 21.5-9t9.5-22V863q0-13-9.5-22t-21.5-9zm192 0q-12 0-21.5 9t-9.5 22v258q0 13 9.5 22t21.5 9h66q12 0 21.5-9t9.5-22V863q0-13-9.5-22t-21.5-9z"></svg:path>`,
})
export class VsSmokingAltIcon {
  readonly viewBox = input("0 0 1792 1344")
...
@Component({
  standalone: true,
  selector: 'svg[vsSmsIcon],svg[vs-sms-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsSofaIcon],svg[vs-sofa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 1428h-54.5l-30.5-.5l-34.5-1.5l-32-2.5l-33-4.5l-28-7l-26-9l-17.5-12v145q0 29 18.5 46.5T320 1600h128q27 0 45.5-17.5T512 1536zm1024 0h54.5l30.5-.5l34.5-1.5l32-2.5l33-4.5l28-7l26-9l17.5-12v145q0 29-18.5 46.5T1728 1600h-128q-27 0-45.5-17.5T1536 1536zM193 575q-98 0-146 43T0 736q1 86 36.5 131t91.5 45q0 48 1 79t4 72.5t9.5 68.5t17.5 59.5t27.5 52.5t40.5 41t55 32.5t72.5 19t92.5 7.5h1152q51 0 92.5-7.5t72.5-19t55-32.5t40.5-41t27.5-52.5t17.5-59.5t9.5-68.5t4-72.5t1-79q56 0 91.5-45t36.5-131q1-75-46-118t-145-43q-49 0-92 35t-74.5 93.5t-53.5 123t-36 134.5q-266-133-576.5-133T448 961q-14-71-36-135t-53-122.5t-74-93.5t-92-35m319-383q-64 0-111 7.5T320.5 225t-55 40t-36 58t-21.5 72t-13 90q38 5 70 16t55 23.5t44.5 36.5t34 40.5t28.5 51t23.5 54t23 62.5t23.5 64q244-92 527.5-92t527.5 92q8-20 19.5-52t18.5-50.5t18-45.5t20-43.5t23-38.5t27.5-35.5t32-29t39.5-25t47.5-17T1855 485q-7-64-17-106t-31-81t-54.5-60t-87-33.5T1536 192z"></svg:path>`,
})
export class VsSofaIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsSpeechIcon],svg[vs-speech-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsStrollerIcon],svg[vs-stroller-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1216 0L960 565h768q-24-207-167-360.5T1216 0M590 651q0-74-19-154t-58-157.5t-92.5-139t-130-99T128 64q-55 0-91.5 34.5T0 192q0 55 39 91.5t89 36.5q43 0 66.5-25t42.5-71q99 69 145 175.5T428 628q7 170 96 312t237 224.5t322 82.5t319.5-76.5t232-213.5t93.5-306zm-14 472q-85 0-145.5 60.5T370 1330t60 146t146 60t146-60t60-146t-60.5-146.5T576 1123m0 91q47 0 81 34t34 82t-34 81.5t-81 33.5t-81-33.5t-34-81.5t34-82t81-34m1010-90q-86 0-146.5 60.5T1379 1330t60.5 145.5T1586 1536t146-60t60-146t-60-146t-146-60m0 90q48 0 81.5 34t33.5 82t-33.5 81.5t-81.5 33.5t-82-33.5t-34-81.5t34-82t82-34"></svg:path>`,
})
export class VsStrollerIcon {
  readonly viewBox = input("0 0 1792 1536")
  readonly width = input("1.17em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSunIcon],svg[vs-sun-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsSunriseIcon],svg[vs-sunrise-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1565 1216h-93q0-157-77-289.5T1185.5 717T896 640t-289.5 77T397 926.5T320 1216h-93L47 968q-9-13-4-29q4-15 20-20l292-97V516q2-18 14-26q14-9 29-4l292 94l180-248q9-12 26-12t26 12l180 248l292-94q15-5 29 4q13 10 13 26v306l293 97q6 2 13 8t7 12q4 15-4 29l-181 248zM55 1312q-21 0-38 16.5T0 1367v50q0 22 17 38.5t38 16.5h1682q21 0 38-16.5t17-38.5v-50q0-22-17-38.5t-38-16.5zm841-576q-130 0-240.5 64.5t-175 175T416 1216h960q0-130-64.5-240.5t-175-175T896 736"></svg:path>`,
})
export class VsSunriseIcon {
  readonly viewBox = input("0 0 1792 1472")
  readonly width = input("1.22em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsSunriseOIcon],svg[vs-sunrise-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1565 1216h-93q0-157-77-289.5T1185.5 717T896 640t-289.5 77T397 926.5T320 1216h-93L47 968q-9-13-4-29q4-15 20-20l292-97V516q2-18 14-26q14-9 29-4l292 94l180-248q9-12 26-12t26 12l180 248l292-94q15-5 29 4q13 10 13 26v306l293 97q6 2 13 8t7 12q4 15-4 29l-181 248zM55 1312q-21 0-38 16.5T0 1367v50q0 22 17 38.5t38 16.5h1682q21 0 38-16.5t17-38.5v-50q0-22-17-38.5t-38-16.5z"></svg:path>`,
})
export class VsSunriseOIcon {
  readonly viewBox = input("0 0 1792 1472")
  readonly width = input("1.22em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsTSquareIcon],svg[vs-t-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m1082 299H374q-31 0-53 22t-22 53v149q0 31 22 52.5t53 21.5h373v821q0 31 22 53t53 22h149q31 0 52.5-22t21.5-53V597h373q31 0 53-21.5t22-52.5V374q0-31-22-53t-53-22"></svg:path>`,
})
export class VsTSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsTableIcon],svg[vs-table-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M64 606L0 576V448L832 64l832 384v128l-64 30v534q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57V694L928 916v480q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57V916L256 694v446q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57z"></svg:path>`,
})
export class VsTableIcon {
  readonly viewBox = input("0 0 1664 1472")
  readonly width = input("1.14em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsTableAltIcon],svg[vs-table-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M289 192h1086q202 185 267 245q22 11 22 34v141q0 22-11.5 50t-27.5 28h-32v678q0 27-8 65.5t-23 38.5h-133q-16 0-35-42t-19-62V690H289v678q0 20-19 62t-35 42H102q-15 0-23-38.5t-8-65.5V690H39q-16 0-27.5-28T0 612V471q0-23 22-34zm1034 866V746h-170v312q0 24 9 51.5t25 27.5h71q17 0 41-30.5t24-48.5m-982 0V746h170v312q0 24-9 51.5t-25 27.5h-71q-17 0-41-30.5t-24-48.5"></svg:path>`,
})
export class VsTableAltIcon {
  readonly viewBox = input("0 0 1664 1472")
  readonly width = input("1.14em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsTableQuestionIcon],svg[vs-table-question-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M64 606L0 576V448L832 64l832 384v128l-64 30v534q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57V694L928 916v480q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57V916L256 694v446q0 38-26.5 57t-69.5 19t-69.5-19t-26.5-57zm2176 458v240q0 16-12 28t-28 12h-240q-16 0-28-12t-12-28v-240q0-16 12-28t28-12h240q16 0 28 12t12 28m316-600q0 54-15.5 101t-35 76.5t-55 59.5t-57.5 43.5t-61 35.5q-41 23-68.5 65t-27.5 67q0 17-12 32.5t-28 15.5h-240q-15 0-25.5-18.5T1920 904v-45q0-83 65-156.5T2128 594q59-27 84-56t25-76q0-42-46.5-74T2083 356q-65 0-108 29q-35 25-107 115q-13 16-31 16q-12 0-25-8l-164-125q-13-10-15.5-25t5.5-28q160-266 464-266q80 0 161 31t146 83t106 127.5t41 158.5"></svg:path>`,
})
export class VsTableQuestionIcon {
  readonly viewBox = input("0 0 2560 1472")
  readonly width = input("1.74em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsTimeslotQuestionIcon],svg[vs-timeslot-question-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M320 320q-120 0-220 103.5T0 667v324q0 140 100 246.5T320 1344h1024q119 0 219.5-103.5T1664 998V667q0-139-100.5-243T1344 320zm-64 320h1152v384H256zm1984 424v240q0 16-12 28t-28 12h-240q-16 0-28-12t-12-28v-240q0-16 12-28t28-12h240q16 0 28 12t12 28m316-600q0 54-15.5 101t-35 76.5t-55 59.5t-57.5 43.5t-61 35.5q-41 23-68.5 65t-27.5 67q0 17-12 32.5t-28 15.5h-240q-15 0-25.5-18.5T1920 904v-45q0-83 65-156.5T2128 594q59-27 84-56t25-76q0-42-46.5-74T2083 356q-65 0-108 29q-35 25-107 115q-13 16-31 16q-12 0-25-8l-164-125q-13-10-15.5-25t5.5-28q160-266 464-266q80 0 161 31t146 83t106 127.5t41 158.5"></svg:path>`,
})
export class VsTimeslotQuestionIcon {
  readonly viewBox = input("0 0 2560 1344")
  readonly width = input("1.91em")
  readonly height = input("1em")
}

@Component({
  standalone: true,
  selector: 'svg[vsTimeslotsIcon],svg[vs-timeslots-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsUSquareIcon],svg[vs-u-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m562 1221q-103 0-155.5-40T690 1051V374q0-31-22-53t-53-22H466q-31 0-53 22t-22 53v641q0 58 16.5 120t55.5 127t95 115.5t144.5 83T898 1493t195.5-32.5t144.5-83t94.5-115.5t55-127t16.5-120V374q0-31-21.5-53t-52.5-22h-149q-31 0-53 22t-22 53v677q0 90-52.5 130T898 1221"></svg:path>`,
})
export class VsUSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsUserBossIcon],svg[vs-user-boss-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsUserGroupIcon],svg[vs-user-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsUserSuitIcon],svg[vs-user-suit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsUserSuitFemaleIcon],svg[vs-user-suit-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsUserWaiterIcon],svg[vs-user-waiter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M704 64q133 0 226.5 93.5T1024 384t-93.5 226.5T704 704t-226.5-93.5T384 384t93.5-226.5T704 64m272 322q-39 8-111.5-7.5T742 342q-34-15-65-34.5t-71-49t-62-43.5q16 119-112 170q1 113 80.5 192T704 656t191.5-79T976 386m-142 893H580q-10 0-26-4t-38-20t-29-40q-16-54-27-162t-17-192.5t-13-93.5q-7 3-31.5 16T348 806q-30 11-82 30t-82 30.5t-66.5 27.5t-59 32.5T24 960q-24 64-24 512h1408q0-112-5.5-292T1384 960q-12-17-34.5-33.5t-59-32.5t-66.5-27.5t-82-30.5t-82-30q-26-10-50.5-23T978 767q-7 9-11.5 93.5t-14 192.5t-25.5 162q-7 24-29 40t-38 20t-26 4M704 800l192-64v192l-192-64l-192 64V736zm0 224q-12 0-22-9.5T672 992t10-22.5t22-9.5t22 9.5t10 22.5t-10 22.5t-22 9.5m0 128q-12 0-22-9.5t-10-22.5t10-22.5t22-9.5t22 9.5t10 22.5t-10 22.5t-22 9.5"></svg:path>`,
})
export class VsUserWaiterIcon {
  readonly viewBox = input("0 0 1408 1472")
  readonly width = input("0.96em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsUserWaiterFemaleIcon],svg[vs-user-waiter-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M64 1472h1152q0-24 32-250t32-298q0-13-7-24.5t-23-20.5t-32-16t-45-15t-51-13t-61.5-14t-64.5-15q-26-10-50.5-23T914 767q-7 9-13 93.5T884 1053t-27 162q-7 24-29 40t-38 20t-26 4H516q-10 0-26-4t-38-20t-29-40q-16-54-27-162t-17-192.5t-13-93.5q-7 3-31.5 16T284 806q-25 6-64.5 15T158 835t-51 13t-45 15t-32 16t-23 20.5T0 924q0 72 32 298t32 250m576-672l192-64v192l-192-64l-192 64V736zm0 224q-12 0-22-9.5T608 992t10-22.5t22-9.5t22 9.5t10 22.5t-10 22.5t-22 9.5m0 128q-12 0-22-9.5t-10-22.5t10-22.5t22-9.5t22 9.5t10 22.5t-10 22.5t-22 9.5m174-500q104 79 194 63q-48-28-57-85q16 21 46.5 27t59.5-4q-49-43-65-89t-24-126q-4-44-5.5-124.5T953 188t-32-79q-30-43-124-76T640 0q-87 0-183 43T336 160q-7 21-11.5 88T318 381.5t-2 69.5q-18 177-74 220q14 9 44 .5t52-25.5q-1 30-45 80q27 5 89.5-19t96.5-46q75 43 161 43q95 0 174-52m-375-85q-9-60 12-204t62-164q7-3 26 12.5t21 26.5q6 32-12 62q19 17 73.5 21t99 .5T788 313q12 13 22.5 28t17.5 33.5t12 32t9.5 37t6 33t4.5 34t4 28.5q-38 54-97 85.5T640 656q-120 0-201-89"></svg:path>`,
})
export class VsUserWaiterFemaleIcon {
  readonly viewBox = input("0 0 1280 1472")
  readonly width = input("0.87em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsVSquareIcon],svg[vs-v-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336 0h1120q139 0 237.5 98.5T1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0m486 1493h147q28 0 44-19.5t31-55.5l447-1044q11-27-15-51t-59-24h-149q-28 0-44 19.5t-31 55.5l-298 695l-298-695q-10-24-17.5-37.5T557 311t-34-12H374q-33 0-59.5 24T299 374l448 1044q15 36 31 55.5t44 19.5"></svg:path>`,
})
export class VsVSquareIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsVolumeOnIcon],svg[vs-volume-on-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsVolumeTimesIcon],svg[vs-volume-times-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsWSquareIcon],svg[vs-w-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsWalkIcon],svg[vs-walk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M640 0q-66 0-113 47t-47 113t47 113t113 47t113-47t47-113t-47-113T640 0M275 1616l169-277q28-46 42-92l58-192l175 183l153 367q11 27 34.5 43t53.5 16q40 0 68-28t28-68q0-17-7-36l-140-345q-13-33-20.5-44.5T855 1103L658 891l60-282l56 109q16 34 44 49q6 3 207 105q48 24 63 24q28 0 46-18t18-46q0-41-38-61L885 649l-90-206q-25-55-66-60l-229-26q-32-3-86 19l-242 96q-20 8-39 27t-25 39Q29 742 4 810q-4 9-4 22q0 26 19 45t45 19q20 0 40.5-9.5T131 862l102-268l210-79l-147 687l-188 320q-12 23-12 46q0 40 28 68t68 28q54 0 83-48"></svg:path>`,
})
export class VsWalkIcon {
...
@Component({
  standalone: true,
  selector: 'svg[vsWeddingCakeIcon],svg[vs-wedding-cake-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsWhiteboardIcon],svg[vs-whiteboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M128 64q0-26 19-45t45-19h1408q26 0 45 19t19 45v1024h98q12 0 21 9t9 21v68q0 12-9 21t-21 9h-579l131 487q7 25-6.5 48.5T1268 1782t-48.5-6.5t-29.5-38.5l-140-521h-90v384q0 26-19 45t-45 19t-45-19t-19-45v-384h-90l-140 521q-7 25-29.5 38.5T524 1782t-39.5-30.5t-6.5-48.5l131-487H30q-12 0-21-9t-9-21v-68q0-12 9-21t21-9h98zm128 1024h1280V128H256zm128-64V915q0-14 9.5-24t23.5-10h318q14 0 23.5 10t9.5 24v109z"></svg:path>`,
})
export class VsWhiteboardIcon {
  readonly viewBox = input("0 0 1792 1792")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsWindowIcon],svg[vs-window-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M64 0Q38 0 19 19T0 64v1536q0 26 19 45t45 19h1536q26 0 45-19t19-45V64q0-26-19-45t-45-19zm1408 896v576H896V896zm-704 576H192V896h576zM896 192h576v576H896zm-704 0h576v576H192zm960 384q33 55 124 91.5t132 36.5V256h-384q27 116 51 175t77 145m-640 0q53-86 77-145t51-175H256v448q41 0 132-36.5T512 576m832 448q-26 66-44.5 171t-19.5 213h128V960q-24 0-37 13.5t-27 50.5m-1024 0q-14-37-27-50.5T256 960v448h128q-1-108-19.5-213T320 1024"></svg:path>`,
})
export class VsWindowIcon {
  readonly viewBox = input("0 0 1664 1664")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsWineIcon],svg[vs-wine-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M500 2000q-253 2-394-26q-48-10-77-64T0 1784v-399q0-151 42-291t99-193q60-56 124.5-159T343 592v-20h318v20q13 47 77.5 150T863 901q56 53 96.5 192.5T1000 1385v399q0 73-27.5 127t-74.5 63q-141 28-398 26M394 0h217q17 0 26 3t16.5 18.5T661 66v386H343V66q0-29 7.5-44.5t17-18.5T394 0"></svg:path>`,
})
export class VsWineIcon {
  readonly viewBox = input("0 0 1024 2016")
...
@Component({
  standalone: true,
  selector: 'svg[vsWineOIcon],svg[vs-wine-o-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M547 2190q227 2 394-35q41-9 72.5-40.5t48-74t24.5-85.5t8-84v-589q0-156-70-349q-17-46-64-112.5T868 700t-80.5-107.5T752 514V139q0-71-12.5-105T692 0H402q-36 0-48 33.5T342 139v375q0 25-35.5 78.5T226 700t-92 120.5T70 933Q0 1114 0 1282v589q0 41 8 83.5t24.5 85.5t47.5 74.5t72 40.5q164 37 395 35M465 138h162v393q0 47 29 107.5T721.5 751T801 872.5T864 997q62 164 62 280v581q0 75-20 112t-83 48q-132 23-276 23t-276-23q-64-11-84-48t-20-112v-581q0-116 62-280q20-55 62.5-124.5T371 751t65.5-112.5T465 531z"></svg:path>`,
})
export class VsWineOIcon {
  readonly viewBox = input("0 0 1120 2208")
  readonly width = input("0.51em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[vsXSquareIcon],svg[vs-x-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsYSquareIcon],svg[vs-y-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[vsYahooJapanIcon],svg[vs-yahoo-japan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1733 481l46-73h-715l12 78q19 0 103 11t118 18q-3 30-85.5 103.5t-174 146.5T934 855q-22-32-160-211T568 366q26-7 135.5-15T829 340l12-71H9l-9 75q18 4 128.5 18.5T253 382q66 50 262.5 293.5T726 959v256q0 29-20 45.5t-56 26.5q-86 24-163 17l-21 85q59 2 114 2t145.5-1.5T837 1388q400 0 421 3l10-96l-247-17q-5-298 0-324q13-37 131-142.5t237-196t143-96.5q185-35 201-38m464 6l-390 663l-135-38l217-718zm-674 896l174 49l67-149l-179-50z"></svg:path>`,
})
export class VsYahooJapanIcon {
  readonly viewBox = input("0 0 2208 1440")
...
@Component({
  standalone: true,
  selector: 'svg[vsZSquareIcon],svg[vs-z-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1792 336v1120q0 139-98.5 237.5T1456 1792H336q-139 0-237.5-98.5T0 1456V336Q0 197 98.5 98.5T336 0h1120q139 0 237.5 98.5T1792 336m-990 859l607-594q30-32 30-78V373q0-31-22-52.5t-53-21.5H428q-31 0-53 21.5T353 373v150q0 31 22 52.5t53 21.5h562l-608 594q-29 32-29 78v150q0 31 22 52.5t52 21.5h937q30 0 52.5-22t22.5-52v-150q0-30-22.5-52t-52.5-22z"></svg:path>`,
})
