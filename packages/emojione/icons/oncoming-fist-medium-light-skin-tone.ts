...
@Component({
  standalone: true,
  selector: 'svg[emojioneOncomingFistMediumLightSkinToneIcon],svg[emojione-oncoming-fist-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
