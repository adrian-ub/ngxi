...
@Component({
  standalone: true,
  selector: 'svg[emojioneOncomingFistDarkSkinToneIcon],svg[emojione-oncoming-fist-dark-skin-tone-icon]',
  host: {
    role: 'img',
