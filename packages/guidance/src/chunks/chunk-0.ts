...
@Component({
  standalone: true,
  selector: 'svg[guidance24HoursIcon],svg[guidance-24-hours-icon]',
  host: {
    role: 'img',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M4.5 10.5v-.25a1.75 1.75 0 1 1 3.5 0v.09c0 .427-.148.84-.42 1.17L4.5 15.25v.25h4m5-2h-4v-.25A8.93 8.93 0 0 0 11 8.296V8m2.5 5.5V10m0 3.5V16M16 8v4.75m0 0a1.75 1.75 0 1 1 3.5 0V16M16 12.75V16m-4 7.5C5.649 23.5.5 18.351.5 12S5.649.5 12 .5S23.5 5.649 23.5 12S18.351 23.5 12 23.5Z"></svg:path>`,
})
export class Guidance24HoursIcon {
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAccessToLowVisionIcon],svg[guidance-access-to-low-vision-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m16 13.5l6 10m-12-15c0 2.4 3.546 4 5 4m-5-4v5.25m0-5.25a2 2 0 0 0-2-2H6.5A3.5 3.5 0 0 0 3 10v3m2.76-6.421V14L10 16.5v.5c0 1.5 0 3.5.75 5c0 0 .75 1.5 1.75 1.5m-5.75-6.627C6.56 20.03 5.415 22.853 3 23.5m4.359-19s-1.6-1-1.6-2.25a1.746 1.746 0 1 1 3.495 0C9.254 3.5 7.66 4.5 7.66 4.5z"></svg:path>`,
})
export class GuidanceAccessToLowVisionIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAirplaneModeIcon],svg[guidance-airplane-mode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M.5 15.5v-2.25S6 10.5 9.75 9.5V4.211c0-.79.23-1.565.707-2.194c.364-.48.828-1.052 1.293-1.517h.5c.465.465.93 1.037 1.293 1.517c.478.629.707 1.404.707 2.194V9.5c3.75 1 9.25 3.75 9.25 3.75v2.25s-5.5-1-9.25-1c0 0-.5 2.28-.5 6.5c0 0 1.25.75 2.25 1.75v.5S13.75 23 12 23s-4 .25-4 .25v-.5c1-1 2.25-1.75 2.25-1.75c0-4.22-.5-6.5-.5-6.5c-3.75 0-9.25 1-9.25 1Z"></svg:path>`,
})
export class GuidanceAirplaneModeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAlertOctagonIcon],svg[guidance-alert-octagon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAmbulanceEntranceIcon],svg[guidance-ambulance-entrance-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M14.5 6.5v-3H.5V20h3m11-13.5h4a7.14 7.14 0 0 0 4.184 5.637l.816.363V17a3 3 0 0 1-3 3m-6-13.5V13h9m-3 7a2.5 2.5 0 0 1-5 0m5 0a2.5 2.5 0 0 0-5 0m0 0h-7m-5 0a2.5 2.5 0 0 0 5 0m-5 0a2.5 2.5 0 0 1 5 0M6 6.5V9H3.5v3H6v2.5h3V12h2.5V9H9V6.5z"></svg:path>`,
})
export class GuidanceAmbulanceEntranceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAquariumIcon],svg[guidance-aquarium-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAssistiveListeningDeviceIcon],svg[guidance-assistive-listening-device-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceAssistiveListeningDeviceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAtmIcon],svg[guidance-atm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M17.5 6.5c0 4.038.444 8.062 1.322 12M6.5 6.5c0 4.038-.444 8.062-1.322 12M4 6.5h16m-16 4H.5v-8h23v8H20m-12 11V21a2.5 2.5 0 0 0-2.5-2.5h-.322M16 21.5V21a2.5 2.5 0 0 1 2.5-2.5h.322m-13.644 0a55 55 0 0 1-.427 1.778l-.251.972v.25h15v-.25l-.25-.972a55 55 0 0 1-.428-1.778M12 14.5a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"></svg:path>`,
})
export class GuidanceAtmIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAudioDescriptionIcon],svg[guidance-audio-description-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m2.75 16.25l1.605-2.841m0 0L7.408 8H8.75v5.409m-4.395 0H4.25m.105 0H8.75m0 0V16.5m9.25-9s.5 1.5.5 4.5s-.5 4.5-.5 4.5m2.5-9S21 9 21 12s-.5 4.5-.5 4.5m-19 4S.5 17 .5 12s1-8.5 1-8.5h21s1 3.5 1 8.5s-1 8.5-1 8.5zM11 16V8h3.75c.644 0 1.25.522 1.25 1.167v5.666c0 .645-.606 1.167-1.25 1.167z"></svg:path>`,
})
export class GuidanceAudioDescriptionIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceAuditoriumIcon],svg[guidance-auditorium-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M11 19.5h7m-.5-5.5V6.5h-1.172a3 3 0 0 0-2.906 2.255L11.5 16.25v.25h9V18c0 1.5 0 2.5.75 4c0 0 .75 1.5 1.75 1.5m-21-4h7M8.5 14V6.5H7.328a3 3 0 0 0-2.906 2.255L2.5 16.25v.25H9m8.35-12s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25zm-9 0s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceAuditoriumIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceBankIcon],svg[guidance-bank-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceBarIcon],svg[guidance-bar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10 19v4.5m0-4.5c0-4 3.167-9.806 7.063-13.053L18.5 4.75V4.5h-4.972M10 19c0-4-3.167-9.806-7.063-13.053L1.5 4.75V4.5h12.028M10 23.5H5m5 0h5m-9.5-15h9m3.5 1a4.5 4.5 0 1 0-4.472-5"></svg:path>`,
})
export class GuidanceBarIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceBicycleIcon],svg[guidance-bicycle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M4 6h4M7 8.5h9.5m3.5-5h-3.5v4c0 2.808.322 4.329 1.224 6.111c.469.927 1.237 1.889 2.276 1.889m-12.5-7c-.098 2.45-.41 3.617-1.208 5.12c-.487.918-1.253 1.88-2.292 1.88m1.5 5a5 5 0 1 1 0-10a5 5 0 0 1 0 10Zm13 0a5 5 0 1 1 0-10a5 5 0 0 1 0 10Z"></svg:path>`,
})
export class GuidanceBicycleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceBillingDepartmentIcon],svg[guidance-billing-department-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M0 12.5h14.464m7.072 0H24m-20 4H3a1 1 0 0 0-1 1v.375a1 1 0 0 0 .72.96l2.56.747a1 1 0 0 1 .72.96v.958a1 1 0 0 1-1 1H4m0-6h1a1 1 0 0 1 1 1v.5m-2-1.5V15m0 7.5H3a1 1 0 0 1-1-1V21m2 1.5V24m6-14V7.5s-1.5-1-4-1s-4 1-4 1V10m14 14v-5.5h-3.5v-.25l.072-.15A25 25 0 0 0 15 7.35v-.328a8.6 8.6 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H20V24M5.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5zm12 0s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceBillingDepartmentIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceBoxingIcon],svg[guidance-boxing-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceBoxingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCampfiresIcon],svg[guidance-campfires-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCampgroundIcon],svg[guidance-campground-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18 4.5h1.5c0 4.92 1.247 9.76 3.623 14.067l.377.683v.25H14m5 0V14m-.5-9.5h-14c0 4.92-1.246 9.76-3.623 14.067L.5 19.25v.25h13.85l.15-.25l.377-.683A29.1 29.1 0 0 0 18.5 4.5Z"></svg:path>`,
})
export class GuidanceCampgroundIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCarIcon],svg[guidance-car-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M4 15.5h2m2 0h8m2 0h2M3.127 10.64c1.326.275 4.643.86 8.873.86s7.547-.585 8.873-.86m-17.746 0A16 16 0 0 0 4.5 4.155V3.5h15v.656a16 16 0 0 0 1.373 6.484m-17.746 0a16 16 0 0 1-1.314 2.39l-.313.47v7h2.25l.075-.12a4 4 0 0 1 3.392-1.88h9.566a4 4 0 0 1 3.392 1.88l.075.12h2.25v-7l-.313-.47a16 16 0 0 1-1.314-2.39"></svg:path>`,
})
export class GuidanceCarIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCarRentalIcon],svg[guidance-car-rental-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M5 18.5h2m2 0h6m2 0h2M4.25 14.894c1.691.28 4.591.606 7.75.606c3.16 0 6.059-.326 7.75-.606m-15.5 0A12 12 0 0 0 5.5 9.561V9.5h13v.06c0 1.865.434 3.688 1.25 5.334m-15.5 0a12 12 0 0 1-1.64 2.476l-.111.13v6h2.25l.075-.12a4 4 0 0 1 3.392-1.88h7.566a4 4 0 0 1 3.392 1.88l.075.12h2.25v-6l-.111-.13a12 12 0 0 1-1.639-2.476M8.5 3.5h1M15 5V3.5M13 5V3.5M11.6 5a3 3 0 1 1 0-3h4.813c.347.492.815.885 1.36 1.142L18 3.25v.5l-.229.108A3.5 3.5 0 0 0 16.411 5z"></svg:path>`,
})
export class GuidanceCarRentalIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCardIcon],svg[guidance-card-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChanginRoomDisabledIcon],svg[guidance-changin-room-disabled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChanginRoomFamilyIcon],svg[guidance-changin-room-family-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChanginRoomManIcon],svg[guidance-changin-room-man-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.5 3.29c.136-.1.522-.423.83-.683A1.198 1.198 0 0 0 18.552.5H18.5c-.69 0-1.25.56-1.25 1.25V2m1.25 1.29c-1.318.961-2.877 1.542-4.56 1.905l-.44.095V7l.179.072a12.98 12.98 0 0 0 9.642 0L23.5 7V5.29l-.44-.095c-1.683-.363-3.242-.944-4.56-1.905ZM8 24v-6.5a2 2 0 0 1 2-2v-8s-1.5-1-4-1s-4 1-4 1v8a2 2 0 0 1 2 2V24M5.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5z"></svg:path>`,
})
export class GuidanceChanginRoomManIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChanginRoomWomanIcon],svg[guidance-changin-room-woman-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.5 3.29c.136-.1.522-.423.83-.683A1.198 1.198 0 0 0 18.552.5H18.5c-.69 0-1.25.56-1.25 1.25V2m1.25 1.29c-1.318.961-2.877 1.542-4.56 1.905l-.44.095V7l.179.072a12.98 12.98 0 0 0 9.642 0L23.5 7V5.29l-.44-.095c-1.683-.363-3.242-.944-4.56-1.905ZM4 24v-5.5H.5v-.25l.072-.15A25 25 0 0 0 3 7.35v-.328A8.6 8.6 0 0 1 6 6.5a8.6 8.6 0 0 1 3 .523v.328A25 25 0 0 0 11.428 18.1l.072.15v.25H8V24M5.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5z"></svg:path>`,
})
export class GuidanceChanginRoomWomanIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChangingRoomHangerIcon],svg[guidance-changing-room-hanger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M9.5 6V5a2.5 2.5 0 0 1 5 0v.216a3.1 3.1 0 0 1-.908 2.192q-.768.767-1.592 1.465a26 26 0 0 1-10.487 5.374L.5 14.5v3l.782.26a33.9 33.9 0 0 0 21.436 0l.782-.26v-3l-1.013-.253A26 26 0 0 1 14 10.405"></svg:path>`,
})
export class GuidanceChangingRoomHangerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChargingStationIcon],svg[guidance-charging-station-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceChildrenMustBeSupervisedIcon],svg[guidance-children-must-be-supervised-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceClimbingWallIcon],svg[guidance-climbing-wall-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCoffeeShopIcon],svg[guidance-coffee-shop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.608 8.5h.892V9c-.577 2.831-1 5.714-1 8.604v.896h-.911m1.019-10q.36-2.262.84-4.506q.052-.244.052-.494h-15q0 .25.052.494q.48 2.244.84 4.506m13.216 0H5.392m12.197 10a89 89 0 0 0-.089 3.964V23.5h-11v-1.036q0-1.984-.089-3.964m11.178 0H6.41m-1.019-10H4.5V9c.577 2.831 1 5.714 1 8.604v.896h.911M2.5 3.5V3l.586-.293A3.82 3.82 0 0 0 5 .5h14a3.82 3.82 0 0 0 1.914 2.207L21.5 3v.5z"></svg:path>`,
})
export class GuidanceCoffeeShopIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCoworkingSpaceIcon],svg[guidance-coworking-space-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M6.5 21a7.5 7.5 0 0 0-.847-3.469A3.2 3.2 0 0 0 5.3 17H.5v.25c.655 1.147 1 2.43 1 3.75H10m5 2.5H0m15.5-14a7.5 7.5 0 0 0-.847-3.469A3.2 3.2 0 0 0 14.3 5.5H9.5v.25c.655 1.147 1 2.43 1 3.75H19m5 2.5h-9m-.5 9.5V19s-1.5-1-4-1c-1.006 0-1.85.162-2.5.355M23.5 10V7.5s-1.5-1-4-1c-1.006 0-1.85.162-2.5.356M10.35 16s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C12.246 15 10.65 16 10.65 16zm9-11.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceCoworkingSpaceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceCustomsIcon],svg[guidance-customs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m18.5 18.5l5 5M8 7.5v8m6-8v8m-5.5-8a2.5 2.5 0 1 1 5 0m-2.5 14C5.201 21.5.5 16.799.5 11S5.201.5 11 .5S21.5 5.201 21.5 11S16.799 21.5 11 21.5Zm6-6H5v-.25l.128-.77a18.1 18.1 0 0 0 0-5.96L5 7.75V7.5h12v.25l-.128.77a18.1 18.1 0 0 0 0 5.96l.128.77z"></svg:path>`,
})
export class GuidanceCustomsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDangerPoisonIcon],svg[guidance-danger-poison-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M14 18.501c-.185 0-.712-.229-.945-.46a4 4 0 0 1-.762-1.064C12.143 16.67 12 16.299 12 16c0 .299-.144.67-.293.977c-.2.409-.462.765-.762 1.063c-.233.232-.76.461-.945.461M2.5 18.5V10a9.5 9.5 0 1 1 19 0v8.5a5 5 0 0 0-5 5h-9a5 5 0 0 0-5-5Zm8-8V14c-1 1-4 1.5-5 1.5v-1.015c0-1.591.69-3.117 2.225-3.538c1.087-.298 2.23-.447 2.775-.447Zm3 0V14c1 1 4 1.5 5 1.5v-1.015c0-1.591-.69-3.117-2.225-3.538c-1.087-.298-2.23-.447-2.775-.447Z"></svg:path>`,
})
export class GuidanceDangerPoisonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDepartureIcon],svg[guidance-departure-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDiscothequeIcon],svg[guidance-discotheque-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M14 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-3.5-.75-5v-.5l-5-2.5V6.5h5V14m-3 3.5c-.21 0-.466.133-.737.344C5.958 19.24 5.5 21.718 5.5 24m-5-14l2.328-2.328A4 4 0 0 1 5.657 6.5h7.186a4 4 0 0 0 2.829-1.172L18 3m1.5 14.5a2 2 0 1 0-4 0a2 2 0 0 0 4 0Zm0 0v-8h.75s.75 4 3.75 4m-14.805-9s-1.81-.557-2.135-1.776A1.77 1.77 0 0 1 8.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61z"></svg:path>`,
})
export class GuidanceDiscothequeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDoNotSitIcon],svg[guidance-do-not-sit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M6 19.5h7m-.5-7v-6h-1.172a3 3 0 0 0-2.829 2m5.501 8H6.5v-.25L8 10.4m10 13.1c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4M.5.5l23 23m-11.15-19s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceDoNotSitIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDoNotSkateboardRollerboardIcon],svg[guidance-do-not-skateboard-rollerboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M13.5 13.5H7v-.25l1-2.7M13.5 20c0-1.851.538-3.464 1.54-4.96M14.5 6.5l-2.162 5.838M10.764 15.5C9.94 16.94 9.5 18.326 9.5 20m9.5 1.5l-1.09.272a24.4 24.4 0 0 1-11.82 0L5 21.5m2 .482V24m10-2.018V24M.5.5l11.838 11.838M23.5 23.5l-8.46-8.46M2.5 5.5s4 1 9.5 1s9.5-1 9.5-1m-9.162 6.838l2.701 2.701M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceDoNotSkateboardRollerboardIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDoNotStandHereIcon],svg[guidance-do-not-stand-here-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDownAngleArrowIcon],svg[guidance-down-angle-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M24 16c-.741 0-1.85.733-2.78 1.475c-1.2.954-2.247 2.094-3.046 3.401C17.575 21.856 17 23.044 17 24m0 0c0-.956-.575-2.145-1.174-3.124c-.8-1.307-1.847-2.447-3.045-3.401C11.85 16.733 10.74 16 10 16m7 8V12.5c0-6.627-5.373-12-12-12H0"></svg:path>`,
})
export class GuidanceDownAngleArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDownLeft2ShortArrowIcon],svg[guidance-down-left-2-short-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M3.01 20.991L21 3.001M4.07 5.08c.785.786 1.182 2.737 1.381 4.51c.258 2.282.159 4.6-.381 6.834c-.404 1.673-1.056 3.543-2.07 4.557m15.92-1.051c-.785-.785-2.737-1.181-4.51-1.381c-2.282-.258-4.6-.159-6.834.381c-1.673.404-3.543 1.056-4.557 2.07"></svg:path>`,
})
export class GuidanceDownLeft2ShortArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDownLeftArrowIcon],svg[guidance-down-left-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M3 21L21 3M3 21c.676-.676 1.923-1.11 3.039-1.379c1.49-.359 3.036-.424 4.559-.252c1.182.134 2.484.4 3.009.924M3 21c.676-.676 1.11-1.923 1.379-3.039c.359-1.49.424-3.036.252-4.559c-.134-1.182-.4-2.484-.924-3.009"></svg:path>`,
})
export class GuidanceDownLeftArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDownRight2ShortArrowIcon],svg[guidance-down-right-2-short-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M20.991 20.991L3.001 3.001m16.93 2.08c-.786.786-1.183 2.737-1.382 4.51c-.258 2.282-.159 4.6.381 6.834c.404 1.673 1.056 3.543 2.07 4.557M5.081 19.93c.786-.785 2.737-1.181 4.51-1.381c2.282-.258 4.6-.159 6.834.381c1.673.404 3.543 1.056 4.557 2.07"></svg:path>`,
})
export class GuidanceDownRight2ShortArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDownRightArrowIcon],svg[guidance-down-right-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M21 21L3 3m18 18c-.676-.676-1.923-1.11-3.039-1.379c-1.49-.359-3.036-.424-4.559-.252c-1.182.134-2.484.4-3.009.924M21 21c-.676-.676-1.11-1.923-1.379-3.039c-.359-1.49-.424-3.036-.252-4.559c.134-1.182.4-2.484.924-3.009"></svg:path>`,
})
export class GuidanceDownRightArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDrinkingFountainIcon],svg[guidance-drinking-fountain-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="currentColor" d="M6.5 15v9m11 0v-.179c0-4.527-1.799-8.87-5-12.071v-.25H22M2.5 24v-9.5l2.22-5.182A3 3 0 0 1 7.479 7.5H8.5v3.757a3 3 0 0 0 .879 2.122L12 16M9.805 5.902s1.812.414 2.686-.46A1.726 1.726 0 0 0 12.498 3a1.72 1.72 0 0 0-2.438.01c-.874.873-.464 2.683-.464 2.683z"></svg:path><svg:path fill="currentColor" d="m15.275 7.421l.137.481zm4.278 2.303l.223.447l.895-.447l-.224-.448zm-4.376-1.755l.48-.137l-.274-.961l-.481.137zm-.079-1.017l-.48.137l.274.962l.481-.138zm.656.87l.492-.09l-.18-.983l-.491.09zm2.04-.832l-.475-.155l-.31.95l.475.156zm.33 1.232l.436.246l.491-.871l-.435-.246zm2.103.663l-.267-.423l-.846.533l.267.423zm-5.09-.904l.04-.012l-.275-.961l-.04.011zm.236-.068l.04-.01l-.275-.962l-.04.01zm.04-.01a4 4 0 0 1 .34-.08l-.178-.984q-.22.039-.437.102zm2.07.038q.335.109.642.281l.49-.87a4.6 4.6 0 0 0-.82-.362zm1.898 1.477q.092.147.172.306l.894-.448a5 5 0 0 0-.22-.391z"></svg:path></svg:g>`,
})
export class GuidanceDrinkingFountainIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDrinkingWaterIcon],svg[guidance-drinking-water-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M7 6.5H3.5v.25l.24 1.05C4.91 12.917 5.5 18 5.5 23.5h13c0-5.5.59-10.583 1.76-15.7l.24-1.05V6.5H17M4.723 13H6a3 3 0 0 0 3-3a3 3 0 1 0 6 0a3 3 0 0 0 3 3h1.277M9.5 5c0 1.5 1 2.5 2.5 2.5s2.5-1 2.5-2.5a2.32 2.32 0 0 0-.635-1.604l-1.04-1.089C12.297 1.754 12 .782 12 0c0 .782-.297 1.754-.825 2.307l-1.04 1.089A2.32 2.32 0 0 0 9.5 5Z"></svg:path>`,
})
export class GuidanceDrinkingWaterIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceDroneZoneIcon],svg[guidance-drone-zone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceEBike2Icon],svg[guidance-e-bike-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M16.5 5.5h-9V6c0 5-3.5 6.5-3.5 6.5m6 9.5h-.5a9 9 0 0 1-9-9a6 6 0 0 1 4-5.659M10 22c0 1 .5 1.5.5 1.5H13M10 22c0-1 .5-1.5.5-1.5H13m0 0v3m0-3h2m-2 3h2M6.498 17a4.98 4.98 0 0 1-3-1m3 1a5 5 0 0 1-2.098-.46m2.098.46a5 5 0 0 0 4.584-3M5 3h4M20 .5h-3.5V6c0 5 3.5 6.5 3.5 6.5M.5.5l13.356 13.356M23.5 23.5l-6.856-6.856m0 0a5 5 0 1 0-2.789-2.789m2.79 2.79l-2.79-2.79"></svg:path>`,
})
export class GuidanceEBike2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceElderlyPeoplePrioritySeatingIcon],svg[guidance-elderly-people-priority-seating-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12.004 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-3.5-.75-5v-.5l-5-2.5v-.25l1.803-5.228A3 3 0 0 1 9.143 6.5h1.36l.519 2.588a3 3 0 0 0 2.941 2.412H15m-7.496 6c-.21 0-.466.133-.737.344C4.962 19.24 4.504 21.718 4.504 24M16 14.5V13a1.5 1.5 0 0 1 3 0v10.5m-8.646-19s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceElderlyPeoplePrioritySeatingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceElectricWheelchairIcon],svg[guidance-electric-wheelchair-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M7 18.5a2.5 2.5 0 1 1 0 5a2.5 2.5 0 0 1 0-5Zm0 0L5 6m2 12.5h5.5a2 2 0 0 1 2 2m0 0a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3Zm5.5 3c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-2H9l-.24-1.5M17.5 10h-3.05a2.5 2.5 0 0 1-2.17-1.26L11 6.5h-.588a2.5 2.5 0 0 0-2.469 2.895L8.52 13m-2.4 0H16.5a3 3 0 0 0 3-3v-.5m-8.9-5S9 3.5 9 2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceElectricWheelchairIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceElevatorAccesibleIcon],svg[guidance-elevator-accesible-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceElevatorPersonIcon],svg[guidance-elevator-person-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceEntryIcon],svg[guidance-entry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M17 12H1m10.5-5c0 .577.665 1.562 1.228 2.294a7.5 7.5 0 0 0 1.745 1.662C15.2 11.445 16.2 12 16.99 12c-.79 0-1.79.556-2.517 1.044a7.5 7.5 0 0 0-1.745 1.662c-.563.732-1.228 1.717-1.228 2.294m-3-10V2.5h.329A46 46 0 0 0 21.897.605L22.25.5h.25v23h-.25l-.353-.105A46 46 0 0 0 8.829 21.5H8.5V17"></svg:path>`,
})
export class GuidanceEntryIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceExitIcon],svg[guidance-exit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M24 12H8m10.5-5c0 .577.665 1.562 1.228 2.294a7.5 7.5 0 0 0 1.745 1.662C22.2 11.445 23.2 12 23.99 12c-.79 0-1.79.556-2.517 1.044a7.5 7.5 0 0 0-1.745 1.662c-.563.732-1.228 1.717-1.228 2.294m-4-10V2.5h-.329A46 46 0 0 1 1.103.605L.75.5H.5v23h.25l.353-.105A46 46 0 0 1 14.171 21.5h.329V17"></svg:path>`,
})
export class GuidanceExitIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFallingRocksIcon],svg[guidance-falling-rocks-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M1 1c3 1.5 5 4 5 4s-.5 3 1 6c5.5 2 8.5 5.5 8.5 5.5s.5 4 3.5 6v.5H1M20.252 8.129s-.559-.46-2.002-1.294c-1.443-.833-2.122-1.087-2.122-1.087s-.46.559-1.293 2.002s-1.088 2.122-1.088 2.122s.56.46 2.003 1.293s2.122 1.088 2.122 1.088s.46-.56 1.293-2.003s1.087-2.121 1.087-2.121Zm2.32 8.45s-.153-.407-.655-1.276c-.501-.869-.778-1.205-.778-1.205s-.408.153-1.277.654c-.868.502-1.205.779-1.205.779s.153.408.654 1.276c.502.869.779 1.205.779 1.205s.408-.152 1.276-.654c.87-.501 1.206-.778 1.206-.778Zm-9.56-12s-.152-.407-.654-1.276c-.501-.869-.778-1.205-.778-1.205s-.408.153-1.277.654c-.869.502-1.205.779-1.205.779s.153.408.654 1.276c.502.869.779 1.205.779 1.205s.408-.152 1.276-.654c.869-.501 1.205-.778 1.205-.778Z"></svg:path>`,
})
export class GuidanceFallingRocksIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFemaleSignIcon],svg[guidance-female-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 15.5a7.5 7.5 0 1 1 0-15a7.5 7.5 0 0 1 0 15Zm0 0V24m-4-4h8"></svg:path>`,
})
export class GuidanceFemaleSignIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFingerprintScanIcon],svg[guidance-fingerprint-scan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFireAlarmIcon],svg[guidance-fire-alarm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M.5 21.5H1A2.5 2.5 0 0 1 3.5 24m-3-2.5v.5m0-.5v-8H1A2.5 2.5 0 0 1 3.5 16v2m9 6v-8a2.5 2.5 0 0 0-2.5-2.5h-.5V15m0 1v-2A2.5 2.5 0 0 0 7 11.5h-.5V16m0-5V9A2.5 2.5 0 0 0 4 6.5h-.5V17M24 2.5h-3.719A6 6 0 0 1 16.295.984L15.75.5h-.25v1a4 4 0 0 0 4 4H24m0 13h-1.719a6 6 0 0 1-3.986-1.515l-.545-.485h-.25v1a4 4 0 0 0 4 4H24M5 3.5a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3Zm13.281 6a6 6 0 0 1-3.986-1.516L13.75 7.5h-.25v1a4 4 0 0 0 4 4h1.219a6 6 0 0 1 3.986 1.515l.545.485h.25v-1a4 4 0 0 0-4-4z"></svg:path>`,
})
export class GuidanceFireAlarmIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFireHazardIcon],svg[guidance-fire-hazard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 23.5c-1.933 0-3.5-1.24-3.5-3.07c0-.762.32-1.588.89-2.127l1.455-1.378c.74-.7 1.155-1.93 1.155-2.92c0 .99.416 2.22 1.156 2.92l1.456 1.378c.569.54.889 1.365.889 2.127c0 1.83-1.567 3.07-3.5 3.07Zm0 0c-4.556 0-8.25-2.972-8.25-7.5c0-1.885.754-4.027 2.096-5.36l3.432-3.41C11.02 5.496 12 2.45 12 0c0 2.45.98 5.497 2.723 7.23l3.431 3.41c1.342 1.333 2.096 3.475 2.096 5.36c0 4.528-3.693 7.5-8.25 7.5Z"></svg:path>`,
})
export class GuidanceFireHazardIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFireHoseIcon],svg[guidance-fire-hose-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFirstAidIcon],svg[guidance-first-aid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M7.527 4.5H.5v.25l.055.31a45.7 45.7 0 0 1 0 15.88l-.055.31v.25h23v-.25l-.055-.31a45.7 45.7 0 0 1 0-15.88l.055-.31V4.5h-7.027m-8.946 0a4.5 4.5 0 0 1 8.946 0m-8.946 0h8.946m-5.973 4v3h-3v3h3v3h3v-3h3v-3h-3v-3z"></svg:path>`,
})
export class GuidanceFirstAidIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFishingAreaIcon],svg[guidance-fishing-area-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M2.093 2.093C2.324 1.351 2.5 1 2.5 1H3s1.825 1.5 4 1.5h.035m-2.88 1.656A9 9 0 0 1 7.036 2.5m1.027 9.062C6.832 12.33 6 13.806 6 15.5c0 2.485 1.79 4.5 4 4.5m0 0A9 9 0 0 1 2.51 6.01M10 20c1.078 1.931 3.093 3.5 5.4 3.5v-.25S13.5 22 13.5 20c0-.672.215-1.26.5-1.744M10 20c.68-1.22 1.735-2.294 3-2.921M21.25 0v6.25l.25.25A1.5 1.5 0 1 1 20 8m-8-2V4M.5.5l10.499 10.499M23.5 23.5L10.999 10.999m0 0c2.41-.027 4.054-.552 6.001-2.499v-.25c-2-.25-3-.75-3-.75v-.25S15.5 6 17.25 5.5v-.25C15.724 3.223 13.401 2 10.8 2H10a9 9 0 0 0-2.965.5"></svg:path>`,
})
export class GuidanceFishingAreaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFishingArea1Icon],svg[guidance-fishing-area-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceFishingArea1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFlashNotAllowedIcon],svg[guidance-flash-not-allowed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceFlashNotAllowedIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceForbidden2Icon],svg[guidance-forbidden-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFountainIcon],svg[guidance-fountain-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFragileIcon],svg[guidance-fragile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceFunicularRailwayIcon],svg[guidance-funicular-railway-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceGasStationIcon],svg[guidance-gas-station-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M8.5 21V3.5l.088-.059a11.56 11.56 0 0 1 12.824 0l.088.059V21M6 22.5h18M0 4.5h4.5v8a4 4 0 0 0 4 4m-7-12a3 3 0 0 0 3 3m14 2h-7V5.043a11.56 11.56 0 0 1 7 0z"></svg:path>`,
})
export class GuidanceGasStationIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceGlobeIcon],svg[guidance-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M23 12c0-6.075-4.925-11-11-11m11 11c0 6.075-4.925 11-11 11m11-11c0 2.21-4.925 4-11 4S1 14.21 1 12M12 1C5.925 1 1 5.925 1 12M12 1c2.761 0 5 4.925 5 11s-2.239 11-5 11m0-22C9.239 1 7 5.925 7 12s2.239 11 5 11M1 12c0 6.075 4.925 11 11 11"></svg:path>`,
})
export class GuidanceGlobeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceGolfCourseIcon],svg[guidance-golf-course-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceGuestHeightLimitIcon],svg[guidance-guest-height-limit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceGuestWithinHeightLimitMustBeSupervisedIcon],svg[guidance-guest-within-height-limit-must-be-supervised-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHairdresserIcon],svg[guidance-hairdresser-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHeartIcon],svg[guidance-heart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 8.5V7.486m0 .264c0-2.9 2.35-5.25 5.25-5.25s5.25 2.382 5.25 5.282c0 1.56-.687 3.055-1.88 4.062l-5.657 4.776A8.35 8.35 0 0 0 12 23a8.35 8.35 0 0 0-2.963-6.38L3.38 11.844A5.33 5.33 0 0 1 1.5 7.782c0-2.9 2.35-5.282 5.25-5.282S12 4.85 12 7.75Z"></svg:path>`,
})
export class GuidanceHeartIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHighVoltageIcon],svg[guidance-high-voltage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M3.5 14.25v.25h7.974A30.9 30.9 0 0 1 7.5 23v.5c1.32 0 3.184-.544 5.089-1.273c5.044-1.931 7.912-7.076 7.915-12.477L20.5 9.5h-5.586A25.2 25.2 0 0 0 16.5.699V.5h-9v.08a25.36 25.36 0 0 1-4 13.67Z"></svg:path>`,
})
export class GuidanceHighVoltageIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHikingIcon],svg[guidance-hiking-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHomeIcon],svg[guidance-home-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M22.5 21V10.25l-.247-.113a20 20 0 0 1-8.942-8.104L13 1.5h-2l-.311.533a20 20 0 0 1-8.942 8.104l-.247.113V21M23 22.5H1M15 21v-4a3 3 0 1 0-6 0v4"></svg:path>`,
})
export class GuidanceHomeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHotelRoomIcon],svg[guidance-hotel-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M1.5 18.5V14l.676-.184a37.34 37.34 0 0 1 19.648 0L22.5 14v4.5m-21 0s0 3-1.5 3m1.5-3h21m0 0s0 3 1.5 3M3.5 11c0-1.989-.297-3.966-.882-5.867L2.5 4.75V4.5h19v.25l-.118.383A20 20 0 0 0 20.5 11M12 7.5H6.5V11M12 7.5V11m0-3.5h5.5V11"></svg:path>`,
})
export class GuidanceHotelRoomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceHydrantIcon],svg[guidance-hydrant-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceImageIcon],svg[guidance-image-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M22.5 18.5h-.304c-.94 0-1.877-.274-2.564-.917a11 11 0 0 1-2.061-2.624l-.82-1.459h-.5l-.822 1.459a11 11 0 0 1-1.75 2.32a4.6 4.6 0 0 1-1.919-1.062a15.3 15.3 0 0 1-2.868-3.674L7.75 10.5h-.498l-1.141 2.043a15.3 15.3 0 0 1-3.286 4.053a3.5 3.5 0 0 1-1.325.722m0 5.182v-21h21v21zm15-13a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"></svg:path>`,
})
export class GuidanceImageIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceInPatientIcon],svg[guidance-in-patient-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceInPatientIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceInformationDeskPeopleIcon],svg[guidance-information-desk-people-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M0 12.5h14.464m7.072 0H24M10 10V7.5s-1.5-1-4-1s-4 1-4 1V10m14 14v-5.5h-3.5v-.25l.072-.15A25 25 0 0 0 15 7.35v-.328a8.6 8.6 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H20V24M5.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5zm12 0s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceInformationDeskPeopleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceIntensiveCareIcon],svg[guidance-intensive-care-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M1.5 20.5V6m0 14.5s0 3-1.5 3m1.5-3h21m0 0s0 3 1.5 3m-1.5-3V15a3.5 3.5 0 0 0-3.5-3.5h-8.5v4m-9 2h21M10.5 4h1.573a1.5 1.5 0 0 0 1.342-.83L14.75.5H15l3.5 7h.25l1.335-2.67A1.5 1.5 0 0 1 21.427 4H23M8.5 13.4S7.5 15 6.25 15a1.75 1.75 0 0 1-1.75-1.75c0-.966.784-1.746 1.75-1.746c1.25 0 2.25 1.596 2.25 1.596z"></svg:path>`,
})
export class GuidanceIntensiveCareIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceIrisScanIcon],svg[guidance-iris-scan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLaboratoryIcon],svg[guidance-laboratory-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M6.5 12.5h.146c2.206 0 4.381.514 6.354 1.5s4.148 1.5 6.354 1.5H20.5m-13-14h9v.25l-.707.972a6.76 6.76 0 0 0 .688 8.759L22.5 17.5c0 2-1 3.5-3 5h-15c-2-1.5-3-3-3-5l6.02-6.02a6.76 6.76 0 0 0 .687-8.758L7.5 1.75z"></svg:path>`,
})
export class GuidanceLaboratoryIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLaundryIcon],svg[guidance-laundry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M16.9 13H16a2 2 0 0 1-2-2a2 2 0 1 1-4 0a2 2 0 0 1-2 2h-.9M5.5 4h3m.217 17h6.566a4 4 0 0 1 3.392 1.88l.075.12H21V1H3v22h2.25l.075-.12A4 4 0 0 1 8.717 21ZM12 17a5 5 0 1 1 0-10a5 5 0 0 1 0 10Z"></svg:path>`,
})
export class GuidanceLaundryIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLaundry2Icon],svg[guidance-laundry-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M9 14.5h6M17 4H7m10 0a3 3 0 0 0 3-3V.5H7.5a3.5 3.5 0 1 0 0 7H20V7a3 3 0 0 0-3-3ZM3.5 23.5h17c0-4 .934-7.79 2.722-11.217l.278-.533v-.25H.5v.25l.278.533C2.566 15.71 3.5 19.5 3.5 23.5Z"></svg:path>`,
})
export class GuidanceLaundry2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLeftAngleArrowIcon],svg[guidance-left-angle-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M16 0c0 .742.733 1.85 1.475 2.78c.954 1.2 2.094 2.247 3.401 3.046C21.856 6.425 23.044 7 24 7m0 0c-.956 0-2.145.575-3.124 1.174c-1.307.8-2.447 1.847-3.401 3.045C16.733 12.15 16 13.26 16 14m8-7H12.5C5.873 7 .5 12.373.5 19v5"></svg:path>`,
})
export class GuidanceLeftAngleArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLeftArrowIcon],svg[guidance-left-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M16 5c0 .742.733 1.85 1.475 2.78c.954 1.2 2.094 2.247 3.401 3.046C21.856 11.425 23.044 12 24 12m0 0c-.956 0-2.145.575-3.124 1.174c-1.307.8-2.447 1.847-3.401 3.045C16.733 17.15 16 18.26 16 19m8-7H0"></svg:path>`,
})
export class GuidanceLeftArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLgbtFriendlyIcon],svg[guidance-lgbt-friendly-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLocationOffIcon],svg[guidance-location-off-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m16.19 16.19l1.337-1.215A8.37 8.37 0 0 0 20.25 8.8c0-4.558-3.694-8.3-8.25-8.3c-3.104 0-5.807 1.737-7.216 4.284M12 23.92a9.04 9.04 0 0 1 2.383-6.037M12 23.92a9.04 9.04 0 0 0-2.96-6.61l-2.567-2.334a8.37 8.37 0 0 1-2.6-7.603M12 23.92V24v-.057M.5.5l23 23M9.564 9.564a2.5 2.5 0 1 1 1.872 1.872"></svg:path>`,
})
export class GuidanceLocationOffIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLocationPinIcon],svg[guidance-location-pin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 23.92a9.04 9.04 0 0 0-2.96-6.61l-2.567-2.334A8.37 8.37 0 0 1 3.75 8.799C3.75 4.242 7.444.5 12 .5s8.25 3.741 8.25 8.298c0 2.343-.989 4.6-2.723 6.177l-2.568 2.334a9.04 9.04 0 0 0-2.96 6.61Zm0 0V24v-.057M12 11.5a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5Z"></svg:path>`,
})
export class GuidanceLocationPinIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLockIcon],svg[guidance-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M6.5 10.5V6a5.5 5.5 0 1 1 11 0v4.5M12 15v4m8.5 4.5h-17v-.25l.075-.327a26.34 26.34 0 0 0 0-11.846L3.5 10.75v-.25h17v.25l-.075.327a26.34 26.34 0 0 0 0 11.846l.075.327z"></svg:path>`,
})
export class GuidanceLockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLostAndFoundIcon],svg[guidance-lost-and-found-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceLuggageTrolleyIcon],svg[guidance-luggage-trolley-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMailboxIcon],svg[guidance-mailbox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M11 21.5v-7.174C11 11.27 9.058 8.5 6 8.5s-5 2.769-5 5.826V21.5zm0 0h.5l11.5-2v-7.541c0-2.845-2.35-4.816-5.163-4.934a4 4 0 0 0-.534.023L16 7.192m-2 .227c-2.382.275-6.484.8-8.6 1.118M14 16.5V4.75m0 0v-3L19 1s.5 1.5 0 3zM3 14s1.5.5 3 .5s3-.5 3-.5"></svg:path>`,
})
export class GuidanceMailboxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMassageIcon],svg[guidance-massage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M17.5 24v-5.5a3 3 0 0 0-3-3C13.5 15.5.1 17 .1 17M15 21.5H0m24 0h-4m-10.5-8l2.918-2.085a1.39 1.39 0 0 0 .47-1.677l-.985-2.297C11.534 7.226 10.13 6.5 8 6.5s-3.534.726-3.903.94l-.985 2.298a1.39 1.39 0 0 0 .47 1.678L6.5 13.5m13 3.9s1 1.6 2.25 1.6a1.75 1.75 0 0 0 1.75-1.75c0-.966-.784-1.746-1.75-1.746c-1.25 0-2.25 1.596-2.25 1.596zM7.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C9.746 3.5 8.15 4.5 8.15 4.5z"></svg:path>`,
})
export class GuidanceMassageIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMedicalLaboratoryIcon],svg[guidance-medical-laboratory-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMeetingPointIcon],svg[guidance-meeting-point-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMeetingPoint2Icon],svg[guidance-meeting-point-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMeetingRoomIcon],svg[guidance-meeting-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMenRestroomIcon],svg[guidance-men-restroom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M14 24v-6.5a2 2 0 0 1 2-2v-8s-1.5-1-4-1s-4 1-4 1v8a2 2 0 0 1 2 2V24m1.85-19.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceMenRestroomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMoneyIcon],svg[guidance-money-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M4 12h2m12 0h2M.5 16.5V20H1a43 43 0 0 1 3-.37M.5 16.5H1a3 3 0 0 1 3 3v.13M.5 16.5v-9M4 19.63a95 95 0 0 1 8-.38c2.134 0 5.281.127 8 .38m0 0a43 43 0 0 1 3 .37h.5v-3.5M20 19.63v-.13a3 3 0 0 1 3-3h.5m0 0v-9m0 0V4H23a43 43 0 0 1-3 .37m3.5 3.13H23a3 3 0 0 1-3-3v-.13m0 0a95 95 0 0 1-8 .38a95 95 0 0 1-8-.38m0 0A43 43 0 0 1 1 4H.5v3.5M4 4.37v.13a3 3 0 0 1-3 3H.5m11.5 7a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5Z"></svg:path>`,
})
export class GuidanceMoneyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMotorcycleIcon],svg[guidance-motorcycle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceMriPetIcon],svg[guidance-mri-pet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNewspapersIcon],svg[guidance-newspapers-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.91 20c.276-1.823.59-4.637.59-8c0-6-1-10.25-1-10.25l-.05-.25H1.5v.25S2.5 6 2.5 12s-1 10.25-1 10.25v.25h19.95l.05-.25s1-4.25 1-10.25c0-3.07-.262-5.681-.517-7.5H19m-2.685 12h-11m-.332-12a54.5 54.5 0 0 1 .496 9h11a54.5 54.5 0 0 0-.496-9z"></svg:path>`,
})
export class GuidanceNewspapersIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoAccessForServiceAnimal2Icon],svg[guidance-no-access-for-service-animal-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceNoAccessForServiceAnimal2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoAccessForServiceAnimal3Icon],svg[guidance-no-access-for-service-animal-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoAccessForServiceAnimal4Icon],svg[guidance-no-access-for-service-animal-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m.5.5l15.848 15.848M23.5 23.5l-7.152-7.152M11.5 18a5.5 5.5 0 1 0-2 4.243m2-10.743v-5h-1.172a3 3 0 0 0-2.906 2.255l-.966 3.764M21 21v-6.357a2.5 2.5 0 0 0 2.5-2.5v-.357h-3.786c-.986 0-1.785-.8-1.785-1.786v2.782a4.82 4.82 0 0 1-1.581 3.566M11.5 20v1.75c0 .966.784 1.75 1.75 1.75h.393v-2.71c0-1.264.496-2.462 1.357-3.35M16 20h1.5v.292c0 .875 0 1.458.45 2.333c.001.002.45.875 1.05.875m-7.65-19s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceNoAccessForServiceAnimal4Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoDrinkingWaterIcon],svg[guidance-no-drinking-water-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoElectricScooterIcon],svg[guidance-no-electric-scooter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m.5.5l16.169 16.169M23.5 23.5l-2.05-2.05M3 14a5 5 0 0 1 5 5v.5h.25S10 19 12 19s3.75.5 3.75.5M19 14.416a5.02 5.02 0 0 0-2.331 2.084v.169M13 2.5h3.5v.825c0 4.705 1.205 9.331 3.5 13.438m1.45 4.687h.05a2.5 2.5 0 1 0-2.95-2.95v.05m2.9 2.9l-2.9-2.9m0 0l-1.881-1.881M5.5 19a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Z"></svg:path>`,
})
export class GuidanceNoElectricScooterIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoEntryForPedestriansIcon],svg[guidance-no-entry-for-pedestrians-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoFishing1Icon],svg[guidance-no-fishing-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceNoFishing1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoLitter2Icon],svg[guidance-no-litter-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m5.18 13.86l.416.416a2.5 2.5 0 0 0 3.536 0l7.313-7.314l.245.245l-.048 3.256a2.5 2.5 0 0 0 2.5 2.537h.462V0M4.876 10.046a2.5 2.5 0 0 1-3.522-.012L1 9.68l2.895-2.895m.981 3.261l.013-.012l1.127-1.127zm0 0l-3.169 3.17l.326.325a2.5 2.5 0 0 0 3.535 0L8.11 11m1.446-1.445l1.67-1.67M7.461 7.46l1.67-1.67M5.34 5.34L10.18.5M.5.5l23 23m-7.25-2.75a2.75 2.75 0 1 1-5.5 0a2.75 2.75 0 0 1 5.5 0Z"></svg:path>`,
})
export class GuidanceNoLitter2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoRunningIcon],svg[guidance-no-running-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoSelfieStickAllowedIcon],svg[guidance-no-selfie-stick-allowed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoVideoIcon],svg[guidance-no-video-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M17.5 17.5v-3h.054c.94 0 1.877.274 2.564.917c.814.761 1.51 1.644 2.061 2.624L23 19.5h.5v-15H23l-.82 1.459a11 11 0 0 1-2.062 2.624c-.687.643-1.624.917-2.564.917H17.5v-5h-13m11.5 15H.5V4M.5.5l23 23"></svg:path>`,
})
export class GuidanceNoVideoIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNoWheelchairAccessIcon],svg[guidance-no-wheelchair-access-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceNurseryIcon],svg[guidance-nursery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceOfficeIcon],svg[guidance-office-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceOfficeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceParentAndInfantPrioritySeatingIcon],svg[guidance-parent-and-infant-priority-seating-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidancePassportsIcon],svg[guidance-passports-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.5 5.5h2v18h-17v-20c8.5-1 14.75-3 14.75-3h.25zm0 0H6m10.5 9A4.5 4.5 0 0 0 12 10m4.5 4.5A4.5 4.5 0 0 1 12 19m4.5-4.5c-.5.5-2 1-4.5 1s-4-.5-4.5-1M12 10a4.5 4.5 0 0 0-4.5 4.5M12 10c.966 0 1.75 2.015 1.75 4.5S12.966 19 12 19m0-9c-.966 0-1.75 2.015-1.75 4.5S11.034 19 12 19m-4.5-4.5A4.5 4.5 0 0 0 12 19"></svg:path>`,
})
export class GuidancePassportsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePatioIcon],svg[guidance-patio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M0 19.5h10m.5-5l-2-8H7.067a3 3 0 0 0-2.803 1.932L1 17m14 6.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-1.5h-7v-6M15.069 0c0 .33-.05.664-.206.955L14.838 1A3.81 3.81 0 0 1 11.5 2.97a3.81 3.81 0 0 1 3.569 2.469a3.81 3.81 0 0 1-.778 4.27a3.81 3.81 0 0 1 4.27-.778a3.81 3.81 0 0 1 2.47 3.569c0-1.455.815-2.72 2.014-3.363c.291-.156.624-.206.955-.206M19 .526A3.177 3.177 0 1 0 23.474 5m-16.28-.5s-1.81-.557-2.134-1.776A1.77 1.77 0 0 1 6.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61z"></svg:path>`,
})
export class GuidancePatioIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePedestriansIcon],svg[guidance-pedestrians-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10 6.525L8.5 13.75V14l5 2.5v.5c0 1.5 0 3.5.75 5c0 0 .75 1.5 1.75 1.5m-3-9.75l1.002-4.845A2 2 0 0 0 12.044 6.5H10.5a4.91 4.91 0 0 0-4.81 3.917L5.154 13M15.5 10.188C17 11.5 19 12 21 12m-10.5 5.5c-1 3-3 5-5.5 5m8.35-18s-1.6-1-1.6-2.25a1.746 1.746 0 1 1 3.495 0c0 1.25-1.595 2.25-1.595 2.25z"></svg:path>`,
})
export class GuidancePedestriansIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePersonalTrainingIcon],svg[guidance-personal-training-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidancePhysicalTherapyIcon],svg[guidance-physical-therapy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidancePhysicalTherapyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePlaneIcon],svg[guidance-plane-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidancePlayRoomIcon],svg[guidance-play-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M7.5 8v5m2.5-2.5H5m-.909 10H5.5s1.5-5 6.5-5s6.5 5 6.5 5h1.409a3.59 3.59 0 0 0 3.499-4.398L20.5 3.5h-.25S17 4.5 12 4.5s-8.25-1-8.25-1H3.5L.592 16.102A3.59 3.59 0 0 0 4.091 20.5ZM16.5 8.5a2 2 0 1 1 0 4a2 2 0 0 1 0-4Z"></svg:path>`,
})
export class GuidancePlayRoomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePortIcon],svg[guidance-port-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 4.5a2 2 0 1 0 0-4a2 2 0 0 0 0 4Zm0 0v19M7 15c-2 0-3.5-1-5-3h-.5c0 4.68 3.06 8.643 7.29 10c1.21.4 2.21.5 3.085 1.5h.25C13 22.5 14 22.4 15.211 22c4.228-1.357 7.289-5.32 7.289-10H22c-1.5 2-3 3-5 3M7 7.5s2.5 1 5 1s5-1 5-1"></svg:path>`,
})
export class GuidancePortIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidancePregnantWomanPrioritySeatingIcon],svg[guidance-pregnant-woman-priority-seating-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M15 23.5c-2.5-2-2-5.5-2-5.5l-6.5-1v-.25l1.343-2.552A10.05 10.05 0 0 0 9 9.516A3.016 3.016 0 0 1 12.016 6.5H13.5v3l.546.137a3.24 3.24 0 0 1 2.454 3.142c0 1.13.283 2.24.824 3.232L18 17.25v.25l-3 .5m-5 6c0-1.613.229-3.323 1-4.68m.85-14.82s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidancePregnantWomanPrioritySeatingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceProjectionRoomIcon],svg[guidance-projection-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M0 20.5h5.5M5 15v-5h-.557a3 3 0 0 0-2.938 2.392L.5 17.25v.25h5m1.5 3h5.5M12 15v-5h-.557a3 3 0 0 0-2.938 2.392L7.5 17.25v.25H14v.5c0 1.5 0 2.5.75 4c0 0 .75 1.5 1.75 1.5m-2-9h9v-.25S23 12 23 7.5s.5-6.75.5-6.75V.5h-19V3m.382 5.249S3.623 7.436 3.623 6.42C3.623 5.636 4.239 5 5 5c.76 0 1.374.636 1.374 1.421c0 1.015-1.256 1.828-1.256 1.828zm7 0s-1.26-.813-1.26-1.828C10.623 5.636 11.24 5 12 5s1.374.636 1.374 1.421c0 1.015-1.256 1.828-1.256 1.828z"></svg:path>`,
})
export class GuidanceProjectionRoomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceProstheticLegIcon],svg[guidance-prosthetic-leg-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10 24v-6.5a2 2 0 0 0-2-2v-8s1.5-1 4-1s4 1 4 1v8a2 2 0 0 0-2 2V19m-1.5 4.5H14m0 0h1.5m-1.5 0V20M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceProstheticLegIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRadiationIcon],svg[guidance-radiation-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRadiologyIcon],svg[guidance-radiology-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M7.5 16s2-1 4.5-1m0 0c2.5 0 4.5 1 4.5 1M12 15v7m-4.5-1s2-1 4.5-1s4.5 1 4.5 1m-10-2.5s2.5-1 5.5-1s5.5 1 5.5 1m1-7.5v-1S16 8.5 12 8.5S5.5 10 5.5 10v1m6.286-4.498s-2.29-1.5-2.29-3.374c0-1.45 1.121-2.625 2.505-2.625S14.5 1.678 14.5 3.128c0 1.875-2.284 3.374-2.284 3.374zM21.5 12.5h-19v.25S3 15 3 18s-.5 5.25-.5 5.25v.25h19v-.25S21 21 21 18s.5-5.25.5-5.25z"></svg:path>`,
})
export class GuidanceRadiologyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRampDownIcon],svg[guidance-ramp-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRampUpIcon],svg[guidance-ramp-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M23 23.5v-7h-.5S15 21 1 23m3.28-11.366a4.424 4.424 0 1 0 5.145 2.382M4.28 11.634l.069-2.036a3 3 0 0 1 2.222-2.796l1.042-.28l1.027 3.833m-4.36 1.28a4.425 4.425 0 0 1 5.145 2.381m6.543 3.647c-1.73-.527-2.816-1.4-3.28-3.13l-.334-1.249l-2.733.732h-.196m-2.436-9.28s-1.701-.52-2.006-1.658A1.65 1.65 0 0 1 6.15 1.057a1.647 1.647 0 0 1 2.017 1.168c.305 1.138-.904 2.439-.904 2.439z"></svg:path>`,
})
export class GuidanceRampUpIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRampUpArrowIcon],svg[guidance-ramp-up-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M23 23H1v-1c14-3.228 21.5-9 21.5-9h.5zM13 8.247L.5 15.5M13 8.246c-.498.29-.944.95-1.274 1.559a8 8 0 0 0-.856 2.622c-.106.712-.155 1.514.068 1.902M13 8.246c-.498.29-1.29.348-1.98.33a7.9 7.9 0 0 1-2.687-.566C7.666 7.747 6.95 7.388 6.728 7"></svg:path>`,
})
export class GuidanceRampUpArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRecyclingIcon],svg[guidance-recycling-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRefillForWaterBottleIcon],svg[guidance-refill-for-water-bottle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRefrigerationIcon],svg[guidance-refrigeration-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceRefrigerationIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRight2ShortArrowIcon],svg[guidance-right-2-short-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 1.5c0 1.11-1.1 2.771-2.212 4.166c-1.432 1.796-3.141 3.365-5.102 4.563c-1.469.897-3.253 1.758-4.686 1.758M12 22.5c0-1.11-1.1-2.771-2.212-4.166c-1.432-1.796-3.141-3.365-5.102-4.563c-1.469-.897-3.253-1.758-4.686-1.758M0 12h24"></svg:path>`,
})
export class GuidanceRight2ShortArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRightAngleArrowIcon],svg[guidance-right-angle-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M8 24c0-.741-.733-1.85-1.475-2.78c-.954-1.2-2.094-2.247-3.401-3.046C2.144 17.575.956 17 0 17m0 0c.956 0 2.145-.575 3.124-1.174c1.307-.8 2.447-1.847 3.401-3.045C7.267 11.85 8 10.74 8 10m-8 7h11.5c6.627 0 12-5.373 12-12V0"></svg:path>`,
})
export class GuidanceRightAngleArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceRvTrailerIcon],svg[guidance-rv-trailer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M19.5 7.5v.429c0 3.335 1.288 4.215 4 5.571v5H21m-1.5-11h2V7s-1.5-1-2-2.5H.5v14h2m17-11h-5v4h6.019M16 18.5a2.5 2.5 0 0 0 5 0m-5 0a2.5 2.5 0 0 1 5 0m-5 0H7.5m-5 0a2.5 2.5 0 0 0 5 0m-5 0a2.5 2.5 0 0 1 5 0m4-7v-4h-8v4z"></svg:path>`,
})
export class GuidanceRvTrailerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSafeSocialDistancingIcon],svg[guidance-safe-social-distancing-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M24 12h-6m2.571-3c0 .317.315.792.632 1.19c.41.513.898.962 1.458 1.304c.42.256.93.502 1.339.502M20.571 15c0-.317.315-.792.632-1.19a5.6 5.6 0 0 1 1.458-1.304c.42-.256.93-.502 1.339-.502M0 12h6M3.428 9c0 .317-.314.792-.632 1.19a5.6 5.6 0 0 1-1.457 1.304c-.42.256-.93.502-1.34.502M3.43 15c0-.317-.315-.792-.633-1.19a5.6 5.6 0 0 0-1.457-1.304c-.42-.256-.93-.502-1.34-.502M14 24v-6.5a2 2 0 0 1 2-2v-8s-1.5-1-4-1s-4 1-4 1v8a2 2 0 0 1 2 2V24m1.85-19.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceSafeSocialDistancingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSanitizeHandsIcon],svg[guidance-sanitize-hands-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSaunaIcon],svg[guidance-sauna-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M15.5 1s-2.25 2.571 0 6s0 6 0 6m3-12s-2.25 2.571 0 6s0 6 0 6m3-12s-2.25 2.571 0 6s0 6 0 6M0 19.5h10m.5-5l-2-8H7.067a3 3 0 0 0-2.803 1.932L1 17m14 6.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-1.5h-7v-6m1.695-6s-1.81-.557-2.135-1.776A1.77 1.77 0 0 1 6.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61z"></svg:path>`,
})
export class GuidanceSaunaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSchoolZoneIcon],svg[guidance-school-zone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceServiceAnimal1Icon],svg[guidance-service-animal-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M11.5 18a5.5 5.5 0 1 0-2 4.243m2-9.243V6.5h-1.172a3 3 0 0 0-2.906 2.255l-.966 3.764M21 24v-9.357a2.5 2.5 0 0 0 2.5-2.5v-.357h-3.786c-.986 0-1.785-.8-1.785-1.786v2.782a4.81 4.81 0 0 1-2.143 4.004a4.81 4.81 0 0 0-2.143 4.004v2.71h-.393a1.75 1.75 0 0 1-1.75-1.75V20m4.5 0h1.5v.292c0 .875 0 1.458.45 2.333c.001.002.45.875 1.05.875m-7.65-19s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceServiceAnimal1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceServiceAnimal2Icon],svg[guidance-service-animal-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceServiceAnimal2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceServiceAnimal3Icon],svg[guidance-service-animal-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceShelterIcon],svg[guidance-shelter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceShowersIcon],svg[guidance-showers-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m13.228 4.772l3.03-3.03a4.242 4.242 0 0 1 7.242 3V24M5.803 7.954L4.39 9.368m-.353 2.475L2.62 13.257m-.707-3.535L.5 11.136m5.657 2.829l-1.414 1.414m3.535.707L6.864 17.5m3.182-5.303L8.632 13.61m-.707-3.536L6.51 11.49m4.243-9.193l-.155.155a6 6 0 0 1-3.89 1.747l-.728.043l-.177.177l7.779 7.778l.176-.177l.043-.728a6 6 0 0 1 1.747-3.89l.155-.155z"></svg:path>`,
})
export class GuidanceShowersIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSignLanguageIcon],svg[guidance-sign-language-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M.5 24V6H1a3 3 0 0 1 3 3v4V3h.5a3 3 0 0 1 3 3v6.5h2a3 3 0 0 1 3 3v6h-2A2.5 2.5 0 0 0 8 24m1-8.5V19m0-1.75h3.5M23.5 0v18H23a3 3 0 0 1-3-3v-4v10h-.5a3 3 0 0 1-3-3v-6.5h-2a3 3 0 0 1-3-3v-6h2A2.5 2.5 0 0 0 16 0m-1 8.5V5m0 1.75h-3.5"></svg:path>`,
})
export class GuidanceSignLanguageIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSkateParkIcon],svg[guidance-skate-park-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M9.5 6.5L7 13.25v.25h9v.25l-.518.674C14.197 16.094 13.5 17.893 13.5 20m1-13.5l-1.852 5m-1.884 4C9.94 16.94 9.5 18.326 9.5 20m-7-14.5s4 1 9.5 1s9.5-1 9.5-1m-2.5 16l-1.09.272a24.4 24.4 0 0 1-11.82 0L5 21.5m2 .482V24m10-2.018V24M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceSkateParkIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSpinningIcon],svg[guidance-spinning-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStadiumIcon],svg[guidance-stadium-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M12 3.5c-2.663 0-5.323-.189-7.96-.566L1 2.5H.5v19H1l3.04-.434A56 56 0 0 1 12 20.5m0-17c2.663 0 5.323-.189 7.96-.566L23 2.5h.5v19H23l-3.04-.434A56 56 0 0 0 12 20.5m0-17V9m0 11.5V15M.5 7.5H1a4.5 4.5 0 0 1 0 9H.5m23 0H23a4.5 4.5 0 1 1 0-9h.5M12 9a3 3 0 1 1 0 6m0-6a3 3 0 1 0 0 6"></svg:path>`,
})
export class GuidanceStadiumIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStairsDownArrowIcon],svg[guidance-stairs-down-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStairsDownPersonIcon],svg[guidance-stairs-down-person-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStairsUpPersonIcon],svg[guidance-stairs-up-person-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceStairsUpPersonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStrollerParkingIcon],svg[guidance-stroller-parking-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceStudyRoomIcon],svg[guidance-study-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSunIcon],svg[guidance-sun-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceSurgeryIcon],svg[guidance-surgery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTaxiIcon],svg[guidance-taxi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M4 16.5h2m2 0h8m2 0h2m.873-4.86c-1.326.275-4.643.86-8.873.86s-7.547-.585-8.873-.86m17.746 0A16 16 0 0 1 19.5 5.156V4.5h-15v.655a16 16 0 0 1-1.373 6.485m17.746 0c.367.83.807 1.63 1.314 2.39l.313.47v7h-2.25l-.075-.12a4 4 0 0 0-3.392-1.88H7.217a4 4 0 0 0-3.392 1.88l-.075.12H1.5v-7l.313-.47c.507-.76.947-1.56 1.314-2.39M9.5 2v2.5h5V2z"></svg:path>`,
})
export class GuidanceTaxiIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTerraceIcon],svg[guidance-terrace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M1.5 14v3.5a2 2 0 0 0 2 2h2V23m17-9v3.5a2 2 0 0 1-2 2h-2V23M12 8.5V15m-7 1.5h14m-7 0V23M1.5 8.5h21v-2h-.086a5 5 0 0 1-.822-.068l-.396-.066a16 16 0 0 1-8.861-4.65l-.21-.216h-.25l-.21.216a16 16 0 0 1-8.861 4.65l-.396.066a5 5 0 0 1-.822.068H1.5z"></svg:path>`,
})
export class GuidanceTerraceIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceToolsIcon],svg[guidance-tools-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m6.75 6.75l3.75 3.75M6.75 6.75L8.5 5v-.25l-1.44-.6a12 12 0 0 1-2.88-1.706L3 1.5h-.25L1.5 2.75V3l.944 1.18A12 12 0 0 1 4.15 7.06l.6 1.44H5zM13.734 17a102 102 0 0 1 4.516 5.5h.25l4-4v-.25s-2.47-1.852-5.5-4.516m.5-2.234a5 5 0 0 0 4.584-7H21.5l-3 3h-2v-2l3-3v-.584a5 5 0 0 0-6.703 6.287L11 10c-4.5 4.5-9.5 8.25-9.5 8.25v.25l4 4h.25S9.5 17.5 14 13l1.797-1.797a5 5 0 0 0 1.703.297Z"></svg:path>`,
})
export class GuidanceToolsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTrackIcon],svg[guidance-track-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceTrackIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTrailerSitesIcon],svg[guidance-trailer-sites-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.5 18.5H24m-5.5 0v-14h-15S.5 9 .5 16.616V18.5H7m11.5 0H12m9 2h3m-17-2a2.5 2.5 0 0 0 5 0m-5 0a2.5 2.5 0 0 1 5 0m-2-11v4m-6 0a24 24 0 0 1 1.172-4H15.5v4z"></svg:path>`,
})
export class GuidanceTrailerSitesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTransgenderSignIcon],svg[guidance-transgender-sign-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceTunnelIcon],svg[guidance-tunnel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceTunnelIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceUnisexRestroomIcon],svg[guidance-unisex-restroom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M16 24v-5.5h-3.5v-.25l.072-.15A25 25 0 0 0 15 7.35v-.328a8.6 8.6 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H20V24M8 24v-6.5a2 2 0 0 1 2-2v-8s-1.5-1-4-1s-4 1-4 1v8a2 2 0 0 1 2 2V24M17.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25zm-12 0s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C7.746 3.5 6.15 4.5 6.15 4.5z"></svg:path>`,
})
export class GuidanceUnisexRestroomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceUp2ShortArrowIcon],svg[guidance-up-2-short-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M1.5 12c1.11 0 2.771-1.1 4.166-2.212c1.796-1.432 3.365-3.141 4.563-5.102c.897-1.469 1.758-3.253 1.758-4.686M22.5 12c-1.11 0-2.771-1.1-4.166-2.212c-1.796-1.432-3.365-3.141-4.563-5.102c-.897-1.469-1.758-3.253-1.758-4.686M12 0v24"></svg:path>`,
})
export class GuidanceUp2ShortArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceUpAngleArrowIcon],svg[guidance-up-angle-arrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M0 8c.742 0 1.85-.733 2.78-1.475c1.2-.954 2.247-2.094 3.046-3.401C6.425 2.144 7 .956 7 0m0 0c0 .956.575 2.145 1.174 3.124c.8 1.307 1.847 2.447 3.045 3.401C12.15 7.267 13.26 8 14 8M7 0v11.5c0 6.627 5.373 12 12 12h5"></svg:path>`,
})
export class GuidanceUpAngleArrowIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceUser1Icon],svg[guidance-user-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18.5 20.247V16S16 14.5 12 14.5S5.5 16 5.5 16v4.247M1.5 12C1.5 6.201 6.201 1.5 12 1.5S22.5 6.201 22.5 12S17.799 22.5 12 22.5S1.5 17.799 1.5 12Zm10.426.5S8.5 10.68 8.5 8c0-1.933 1.569-3.5 3.504-3.5A3.495 3.495 0 0 1 15.5 8c0 2.68-3.426 4.5-3.426 4.5z"></svg:path>`,
})
export class GuidanceUser1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceVendingMachineIcon],svg[guidance-vending-machine-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10.5 2V.5h-8v23h8V22M14 9h-1a1 1 0 0 0-1 1v.375a1 1 0 0 0 .72.96l2.56.747a1 1 0 0 1 .72.96V14a1 1 0 0 1-1 1h-1m0-6h1a1 1 0 0 1 1 1v.5M14 9V7.5m0 7.5h-1a1 1 0 0 1-1-1v-.5m2 1.5v1.5M6.5 3v4.996M6.5 21v-4.996m0-8.008a8.5 8.5 0 1 1 0 8.007m0-8.007v8.008"></svg:path>`,
})
export class GuidanceVendingMachineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWaitingRoomIcon],svg[guidance-waiting-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M18 3v2h2M1 19.5h7M7.5 14V6.5H6.328a3 3 0 0 0-2.906 2.255L1.5 16.25v.25h9V18c0 1.5 0 2.5.75 4c0 0 .75 1.5 1.75 1.5m5-14a4.5 4.5 0 1 1 0-9a4.5 4.5 0 0 1 0 9Zm-10.65-5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0C9.246 3.5 7.65 4.5 7.65 4.5z"></svg:path>`,
})
export class GuidanceWaitingRoomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWalkerIcon],svg[guidance-walker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10.004 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-3.5-.75-5v-.5l-5-2.5v-.25l1.803-5.228A3 3 0 0 1 7.143 6.5h1.36l.519 4.588a3 3 0 0 0 2.941 2.412H12m-6.496 4c-.21 0-.466.133-.737.344C2.962 19.24 2.504 21.718 2.504 24m8.996-.2a26 26 0 0 0 2-10v-.3h6v.3a26 26 0 0 0 2 10m-8.878-3.3h7.756M8.354 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceWalkerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWashHandsIcon],svg[guidance-wash-hands-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWasteIcon],svg[guidance-waste-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWcIcon],svg[guidance-wc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M5.5 8v7.5h.25s1.016-1.152 1.5-2c.62-1.087 1.125-2.5 1.125-2.5h.25s.505 1.413 1.125 2.5c.484.848 1.5 2 1.5 2h.25V8m7 2.5v-1a1 1 0 0 0-1-1H15a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h2.5a1 1 0 0 0 1-1v-1m-6.5 10C5.649 23.5.5 18.351.5 12S5.649.5 12 .5S23.5 5.649 23.5 12S18.351 23.5 12 23.5Z"></svg:path>`,
})
export class GuidanceWcIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWearGasMaskIcon],svg[guidance-wear-gas-mask-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWearGogglesIcon],svg[guidance-wear-goggles-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class GuidanceWearGogglesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWearHardHatIcon],svg[guidance-wear-hard-hat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWearHeadsetIcon],svg[guidance-wear-headset-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWearMaskIcon],svg[guidance-wear-mask-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWeightliftingIcon],svg[guidance-weightlifting-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M.5 11v5m2-6v7m21-6v5m-2-6v7m-19-3.5h19m-7.5 2l2 8.35m-6-8.35l-2 8.35m9.5-10.35l-1.5-6s-1.5-1-4-1s-4 1-4 1l-1.5 6m5.35-9s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceWeightliftingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWetFloorIcon],svg[guidance-wet-floor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m17.5 1l-4.621 4.621a3 3 0 0 1-2.122.879H7.243a3 3 0 0 0-1.132.222M.5 12l4.621-4.621a3 3 0 0 1 .99-.657m5.346-.305L14 11.5h5c.936 1.123 1.591 1.965 2.596 2.528c.723.405 1.575.472 2.404.472M15.5 24c0-1.5-1-2.5-2.5-2.5m6.5 2.5c0-1.5 1-2.5 2.5-2.5m-4-1c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-.5h-3.646a3 3 0 0 1-2.683-1.658l-3.06-6.12M8.195 4.5s-1.81-.557-2.135-1.776A1.77 1.77 0 0 1 7.302.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61z"></svg:path>`,
})
export class GuidanceWetFloorIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWheelchair1Icon],svg[guidance-wheelchair-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWheelchairBasketballIcon],svg[guidance-wheelchair-basketball-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M17 23.5c-1 0-1.75-1.5-1.75-1.5c-.75-1.5-.75-2.5-.75-4v-1.5h-3.207M6.5 12.522l2.136-4.35a3 3 0 0 1 2.69-1.672H12.5l2.47 2.47a1.81 1.81 0 0 0 2.56 0L20.5 6m-4.75 1.25L18.5 4.5M6 23.5a5.5 5.5 0 1 1 0-11a5.5 5.5 0 0 1 0 11Zm15.5-19a2 2 0 1 1 0-4a2 2 0 0 1 0 4Zm-9.805 0s-1.81-.557-2.135-1.776A1.77 1.77 0 0 1 10.802.561a1.75 1.75 0 0 1 2.146 1.25c.324 1.219-.962 2.61-.962 2.61z"></svg:path>`,
})
export class GuidanceWheelchairBasketballIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWheelchairTennisIcon],svg[guidance-wheelchair-tennis-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWiFiIcon],svg[guidance-wi-fi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor"><svg:path d="M8.646 17A4.5 4.5 0 0 1 12 15.5c1.333 0 2.53.58 3.354 1.5h.265l2.841-3.966A9.47 9.47 0 0 0 12 10.5a9.47 9.47 0 0 0-6.46 2.534L8.381 17z"></svg:path><svg:path d="M20.218 10.58L23 6.5v-.25C20.09 4.051 16.5 2.5 12 2.5S3.91 4.05 1 6.25v.25l2.782 4.08A12.45 12.45 0 0 1 12 7.5c3.146 0 6.02 1.162 8.218 3.08ZM10.5 20a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z"></svg:path></svg:g>`,
})
export class GuidanceWiFiIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWifiOffIcon],svg[guidance-wifi-off-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m.5.5l23 23m-7.305-7.305l2.265-3.16A9.47 9.47 0 0 0 12 10.5a9.6 9.6 0 0 0-1.398.102m-2.683.817a9.5 9.5 0 0 0-2.379 1.615L8.381 17h.265A4.5 4.5 0 0 1 12 15.5M8.115 8.115A12.5 12.5 0 0 1 12 7.5c3.146 0 6.02 1.162 8.218 3.08L23 6.5v-.25C20.09 4.051 16.5 2.5 12 2.5c-2.954 0-5.516.668-7.75 1.75M2.022 5.522Q1.5 5.873 1 6.25v.25l2.782 4.08A12.6 12.6 0 0 1 5.701 9.2M10.5 20a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z"></svg:path>`,
})
export class GuidanceWifiOffIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceWomenRestroomIcon],svg[guidance-women-restroom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="M10 24v-5.5H6.5v-.25l.072-.15A25 25 0 0 0 9 7.35v-.328a8.6 8.6 0 0 1 3-.523c1.288 0 2.311.266 3 .523v.328c0 3.72.83 7.391 2.428 10.749l.072.15v.25H14V24M11.85 4.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceWomenRestroomIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[guidanceYogaIcon],svg[guidance-yoga-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" d="m2 14.5l1.654-.551a6 6 0 0 0 3.795-3.795L8 8.5s1.5-1 4-1s4 1 4 1l.551 1.654a6 6 0 0 0 3.795 3.795L22 14.5m-12.5-4v5l-4.25.85a.937.937 0 0 0-.042 1.825c1.305.332 4.198 1.095 6.792 1.99c2.657.916 5 1.97 5 2.835m-2.5-12.5v5l4.25.85a.937.937 0 0 1 .042 1.825c-.974.248-2.833.736-4.792 1.34m-4 1.397c-1.73.712-3 1.45-3 2.088m4.85-17.5s-1.6-1-1.6-2.25a1.747 1.747 0 1 1 3.496 0c0 1.25-1.596 2.25-1.596 2.25z"></svg:path>`,
})
export class GuidanceYogaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
