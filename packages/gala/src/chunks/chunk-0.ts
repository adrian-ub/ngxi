...
@Component({
  standalone: true,
  selector: 'svg[galaChatIcon],svg[gala-chat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="16"><svg:path d="M 48.004588,16.00078 H 207.99487"></svg:path><svg:path stroke-linejoin="round" d="M 240.00422,-48.000717 A 31.999937,31.999937 0 0 1 208.00429,-16.00078" transform="scale(1 -1)"></svg:path><svg:path stroke-linejoin="round" d="M -16.004652,-48.000717 A 31.999937,31.999937 0 0 1 -48.004588,-16.00078" transform="scale(-1)"></svg:path><svg:path stroke-linejoin="round" d="m -16.004652,160.0005 a 31.999937,31.999937 0 0 1 -31.999936,31.99994" transform="scale(-1 1)"></svg:path><svg:path stroke-linejoin="round" d="m 240.00422,160.0005 a 31.999937,31.999937 0 0 1 -31.99993,31.99994"></svg:path><svg:path stroke-linejoin="round" d="M 16.004649,48.00072 V 160.00051"></svg:path><svg:path stroke-linejoin="round" d="M 240.00422,48.00072 V 160.00051"></svg:path><svg:path stroke-linejoin="round" d="m 48.004588,192.00044 h 31.999937 l 47.999905,47.99991 47.99991,-47.99991 h 31.99994"></svg:path></svg:g>`,
})
export class GalaChatIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaFileCode1Icon],svg[gala-file-code1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[galaFileErrorIcon],svg[gala-file-error-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round"><svg:path stroke-width="15.992" d="M 32,48 V 207.9236"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 224,96 V 208"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 64,16 h 80"></svg:path><svg:path stroke-width="15.992" d="M 64,240 H 192"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 224,208 c 0.0874,15.98169 -16,32 -32,32"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m -32,208 c -10e-7,16 -16,32 -32,32" transform="scale(-1 1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M -32,-47.976784 C -32,-32 -48,-16.356322 -63.999997,-16.000002" transform="scale(-1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 223.91257,96.071779 144,16"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m -144,64 c -0.0492,15.912926 -16.06452,31.999995 -32,32" transform="scale(-1 1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 144,64 V 16"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 176,96 h 48"></svg:path><svg:path stroke-linejoin="round" stroke-width="16" d="m 64,208 48,-64"></svg:path><svg:path stroke-linejoin="round" stroke-width="16" d="m 64,144 48,64"></svg:path></svg:g>`,
})
export class GalaFileErrorIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaFileScriptIcon],svg[gala-file-script-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round"><svg:path stroke-width="15.992" d="M 32,48 V 207.9236"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 224,96 V 208"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 64,16 h 80"></svg:path><svg:path stroke-width="15.992" d="M 64,240 H 192"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 224,208 c 0.0874,15.98169 -16,32 -32,32"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m -32,208 c -10e-7,16 -16,32 -32,32" transform="scale(-1 1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M -32,-47.976784 C -32,-32 -48,-16.356322 -63.999997,-16.000002" transform="scale(-1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 223.91257,96.071779 144,16"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m -144,64 c -0.0492,15.912926 -16.06452,31.999995 -32,32" transform="scale(-1 1)"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="M 144,64 V 16"></svg:path><svg:path stroke-linejoin="round" stroke-width="15.992" d="m 176,96 h 48"></svg:path><svg:path stroke-linejoin="round" stroke-width="16" d="M 64,208 96.000003,176 64,144"></svg:path><svg:path stroke-linejoin="round" stroke-width="16" d="m 112,208 h 32"></svg:path></svg:g>`,
})
export class GalaFileScriptIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaGlobeIcon],svg[gala-globe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:circle cx="127.999" cy="128" r="112"></svg:circle><svg:path d="m 192.0027,219.91074 c -40.13552,-10.60764 2.8991,-36.95009 -12.98135,-56.80128 -7.0348,-8.7939 -24.94292,-22.44625 -16.06406,-37.68626 14.14662,-24.2819 74.44445,-16.70043 77.04541,2.65434"></svg:path><svg:path d="m 52.26403,210.5115 c 11.735422,-10.73393 23.101176,-21.25355 28.928591,-35.30877 4.896866,-11.81082 11.221497,-27.74331 3.816787,-38.16679 -6.795901,-9.56626 -28.036264,1.74355 -34.229477,-8.2235 -5.19823,-8.36579 -1.703207,-26.91578 6.536171,-28.815794 C 71.025394,96.835252 95.999454,115.70076 91.525264,97.954854 71.651098,54.251844 101.47196,64.000005 79.998805,26.807419"></svg:path><svg:path d="M 229.90244,81.526574 C 222.59641,76.902443 210.40368,72.548 197.29726,73.264682 184.1909,73.981363 156.7628,89.642259 150.64024,75.329052 143.20598,57.949662 165.8904,33.900895 191.58021,36.089261"></svg:path></svg:g>`,
})
export class GalaGlobeIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaLockIcon],svg[gala-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:path d="M 48.003124,207.99947 V 144.00668"></svg:path><svg:path d="M 208.00205,207.99948 V 143.99989"></svg:path><svg:path d="M 80.002888,239.99926 H 176.00225"></svg:path><svg:path d="m 208.00205,207.99948 a 31.999787,31.999787 0 0 1 -31.9998,31.99978"></svg:path><svg:path d="m 48.003124,207.99948 a 31.999787,31.999787 0 0 0 31.999764,31.99978"></svg:path><svg:path d="m 128.00258,207.99949 v -31.9998"></svg:path><svg:path d="M 47.996095,144.00668 A 15.999894,15.999894 0 0 1 63.995976,128.0068"></svg:path><svg:path d="M 208.00205,143.99989 A 15.999894,15.999894 0 0 0 192.00218,128"></svg:path><svg:path d="M 176.00225,64.00042 A 47.999683,47.999683 0 0 0 128.00258,16.00074"></svg:path><svg:path d="M 80.002812,64.00042 A 47.999683,47.999683 0 0 1 128.00249,16.00074"></svg:path><svg:path d="M 80.002888,128 V 63.907475"></svg:path><svg:path d="M 176.00225,64.000424 V 128"></svg:path><svg:path d="M 64.003006,128 H 192.00218"></svg:path></svg:g>`,
})
export class GalaLockIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaRemoveIcon],svg[gala-remove-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:circle cx="128" cy="128" r="112"></svg:circle><svg:path d="M 80.000004,128 H 176.00001"></svg:path></svg:g>`,
})
export class GalaRemoveIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaSidebarLeftIcon],svg[gala-sidebar-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:path d="m 16,64 224.93778,0.09256"></svg:path><svg:path d="M 48,16 H 207.91114 C 225.62929,16 240,30.281849 240,48 v 160 c 0,17.71816 -14.28185,32 -32,32 H 48 C 30.281848,240 16.069099,225.73073 16.06221,208.01257 L 16,48 C 15.993112,30.281851 30.281848,16 48,16 Z"></svg:path><svg:path d="M 96,64 V 240"></svg:path></svg:g>`,
})
export class GalaSidebarLeftIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaTerminalIcon],svg[gala-terminal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:path d="m 16,64 224.93778,0.09256"></svg:path><svg:path d="M 48,16 H 207.91114 C 225.62929,16 240,30.281849 240,48 v 160 c 0,17.71816 -14.28185,32 -32,32 H 48 C 30.281848,240 16.069099,225.73073 16.06221,208.01257 L 16,48 C 15.993112,30.281851 30.281848,16 48,16 Z"></svg:path><svg:path d="M 191.96444,64.092555 192,16"></svg:path><svg:path d="M 48,208 80,176 48,144"></svg:path><svg:path d="m 96,208 h 32"></svg:path></svg:g>`,
})
export class GalaTerminalIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaUnlockIcon],svg[gala-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"><svg:path d="M 48.003124,207.99947 V 144.00668"></svg:path><svg:path d="M 208.00205,207.99948 V 143.99989"></svg:path><svg:path d="M 80.002888,239.99926 H 176.00225"></svg:path><svg:path d="m 208.00205,207.99948 a 31.999787,31.999787 0 0 1 -31.9998,31.99978"></svg:path><svg:path d="m 48.003124,207.99948 a 31.999787,31.999787 0 0 0 31.999764,31.99978"></svg:path><svg:path d="m 128.00258,207.99949 v -31.9998"></svg:path><svg:path d="M 47.996095,144.00668 A 15.999894,15.999894 0 0 1 63.995976,128.0068"></svg:path><svg:path d="M 208.00205,143.99989 A 15.999894,15.999894 0 0 0 192.00218,128"></svg:path><svg:path d="M 176.00225,64.00042 A 47.999683,47.999683 0 0 0 128.00258,16.00074"></svg:path><svg:path d="M 80.002812,64.00042 A 47.999683,47.999683 0 0 1 128.00249,16.00074"></svg:path><svg:path d="M 80.002888,128 V 63.907475"></svg:path><svg:path d="m 176.00225,64.000424 0,15.999576"></svg:path><svg:path d="M 64.003006,128 H 192.00218"></svg:path></svg:g>`,
})
export class GalaUnlockIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[galaWindowIcon],svg[gala-window-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
