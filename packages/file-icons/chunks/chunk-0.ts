...
@Component({
  standalone: true,
  selector: 'svg[fileIcons3dsMaxIcon],svg[file-icons-3ds-max-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsAdobeBridgeIcon],svg[file-icons-adobe-bridge-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsAdobeCharacteranimatorIcon],svg[file-icons-adobe-characteranimator-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M0 0h512v512H0zm422.344 240.566v123.662h-41.858V244.79c1.322-42.628-37.786-42.766-58.76-24.197v143.634h-41.862V108.07h41.862v78.73c30.756-23.923 102.116-28.254 100.618 53.767M246.836 110.475v40.266c-59.386-24.703-116.64 2.886-116.75 84.446c1.644 69.545 38.569 109.902 114.446 88.16l.002 37.578C154.1 387.402 84.891 335.774 86.304 236.342c.633-98.056 69.098-152.01 160.532-125.867" clip-rule="evenodd"></svg:path>`,
})
export class FileIconsAdobeCharacteranimatorIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
