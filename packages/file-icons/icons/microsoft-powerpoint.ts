...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftPowerpointIcon],svg[file-icons-microsoft-powerpoint-icon]',
  host: {
    role: 'img',
