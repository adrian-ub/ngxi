...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftAccessIcon],svg[file-icons-microsoft-access-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftExcelIcon],svg[file-icons-microsoft-excel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftInfopathIcon],svg[file-icons-microsoft-infopath-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftLyncIcon],svg[file-icons-microsoft-lync-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftOnenoteIcon],svg[file-icons-microsoft-onenote-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMicrosoftWordIcon],svg[file-icons-microsoft-word-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M488.877 52.447H302.306V5.92h-34.779L0 52.563v406.99l265.957 46.527h36.349v-46.353h174.59c9.887-.465 20.879.291 29.37-5.757c6.804-10.41 5.06-23.438 5.641-35.186V75.012c1.221-13.26-9.77-23.903-23.03-22.565m-294.862 282.59c-9.712 5.06-24.252-.233-35.767.581c-7.735-38.5-16.75-76.768-23.67-115.443c-6.805 37.57-15.645 74.79-23.438 112.128c-11.166-.581-22.39-1.28-33.615-2.035c-9.655-51.18-20.995-102.01-30.01-153.305c9.945-.465 19.948-.872 29.893-1.221c5.99 37.047 12.795 73.919 18.03 111.024c8.2-38.036 16.574-76.071 24.717-114.106c11.05-.64 22.1-1.105 33.15-1.687c7.735 39.257 15.644 78.455 24.019 117.537c6.572-40.361 13.841-80.607 20.879-120.91c11.631-.407 23.263-1.047 34.836-1.745c-13.143 56.355-24.659 113.176-39.024 169.182m290.212 97.069H302.306v-36.527h151.21v-23.263h-151.21v-29.079h151.21v-23.263h-151.21v-29.08h151.21v-23.262h-151.21v-29.08h151.21V215.29h-151.21v-29.08h151.21v-23.263h-151.21v-29.079h151.21v-23.263h-151.21v-30.71h181.921z"></svg:path>`,
})
export class FileIconsMicrosoftWordIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMinizincIcon],svg[file-icons-minizinc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMirandaIcon],svg[file-icons-miranda-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMircIcon],svg[file-icons-mirc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMixinIcon],svg[file-icons-mixin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMochaIcon],svg[file-icons-mocha-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsModelicaIcon],svg[file-icons-modelica-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M399.537 165.003c-6.143-44.655-48.907-51.034-114.827 4.726c-3.544-49.144-42.01-48.621-81.009-25.082c-21.336 12.878-42.257 33.176-67.378 58.297C111.513 227.754 58.492 286.725 0 352.958c11.962 7.225 21.801 17.575 28.326 29.984l142.62-174.397s48.277-55.947 74.84-45.511s5.868 49.449.106 61.639c-18.489 39.112-73.405 133.765-73.405 133.765s84.67-123.804 134.833-169.341c6.701-6.084 29.885-26.659 47.671-27.394c15.37-.634 28.047 12.638 18.144 38.778c-11.078 29.242-31.796 70.257-59.901 113.304c0 0-.997 7.7 8.786-6.083c29.77-41.94 102.345-143.864 144.68-147.303c16.982-1.38 25.344 14.455 22.057 32.73c-5.882 32.703-37 77.792-37 77.792c-1.469 2.049.425 4.088 1.899 3.558c29.409-42.691 56.946-68.486 58.344-102.933c0 0-2.372-91.074-112.463-6.543m9.617 175.919c-18.257-10.526-18.257-36.982 0-47.508s41.203 2.703 41.203 23.754c0 21.05-22.946 34.279-41.203 23.754"></svg:path>`,
})
export class FileIconsModelicaIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsModernwebIcon],svg[file-icons-modernweb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M128.224 477.382C97.468 457.656 353.8 18.668 383.71 34.684c30.063 17.357-225.423 460.055-255.486 442.698m41.597-270.908C229.36 102.967 347.62 13.847 383.71 34.684C306.133-7.59 192.58 75.147 132.737 175.107c-67.115 112.103-73.49 266.164-4.513 302.275c-35.191-26.449-11.749-178.167 41.597-270.908M383.71 34.684c40.605 44.376 4.837 193.602-47.05 277.568c-50.211 83.688-161.014 181.835-208.436 165.13c60.253 40.663 192.727-38.17 253.35-144.487c55.512-97.356 84.585-244.908 2.136-298.211m-4.767-3.12c-300.093-146.21-534.837 258.55-250.72 445.818c-234.64-144.57 4.847-568.985 250.72-445.818m10.247 5.918c102.385 63.26 117.705 202.633 48.243 322.945c-60.27 103.141-181.423 185.587-309.21 116.955c122.275 70.595 278.869 28.56 349.463-93.715c68.193-117.443 32.735-272.799-88.496-346.185"></svg:path>`,
})
export class FileIconsModernwebIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsModoIcon],svg[file-icons-modo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M255.232 205.618c-1.555-25.559 58.826-44.09 75.7-23.528c14.206 52.643 35.236 120.344 32.225 162.654c-3.597 37.268-39.98 58.735-77.235 25.575c-32.367-31.658-79.364-85.885-114.573-100.254q1.532-14.315 9.718-16.367c-10.572 1.738-15.437 9.504-15.345 22.507q0 9.723 6.138 46.289c7.711 43.366 5.277 47.104-6.905 57.542c-45.17 27.119-57.105 1.845-67.772-38.617c-27.498-134.403 55.243-188.714 161.63-87.209c11.13 30.221 24 69.471 28.644 94.625c-1.915-30.084-30.101-114.642-32.225-143.217m23.018-31.712q-17.395 7.674-24.552 19.437q-6.137-58.311 19.947-78.258c-4.435 12.62-2.9 32.223 4.605 58.821m53.45-31.2c.168 7.16-.52 11.342-2.097 12.39c-1.366 3.069-1.57 9.603-.205 18.81c-11.619-6.597-32.495-6.174-46.545-1.535c-6.161-22.807-9.517-44.454-4.092-57.286q2.04-4.604 5.627-6.138c26.923-8.153 48.02 11.148 47.313 33.758m2.302 14.832c6.534-14.655 2.456-45.274-25.063-53.194q21.986 1.536 50.637 24.04c3.014 7.346-1.847 28.881-16.368 42.453q-5.634-2.038-9.206-3.069c-.654-3.76-.73-7.212 0-10.23m1.023 18.925q-.513-1.531-.512-3.58q2.042.515 4.092 1.535c-1.023.687-2.222 1.366-3.58 2.045m21.994 45.523q-2.05-2.038-13.81-12.276c-3.203-10.272-5.8-19.88-7.161-28.131c3.404-2.047 5.962-3.749 7.672-5.116c10.23 4.436 23.353 12.62 39.385 24.552c-11.702 10.559-21.812 19.227-26.086 20.97m8.183-88.999c9.35 6.646 26.013 24.209 42.966 41.43c-5.803 7.505-12.963 15.345-21.482 23.53c-15.69-11.59-28.644-19.95-38.874-25.064c11.849-12.129 18.16-28.167 17.39-39.896m21.994 71.097q12.274 9.722 20.46 16.88c-2.389 5.457-8.528 12.45-18.413 20.97c-6.138-1.023-15.521-6.65-28.132-16.88c6.651-3.594 17.605-13.71 26.085-20.97m42.454 1.534c-2.709 3.373-9.281 7.556-18.413 12.276a1456 1456 0 0 0-20.46-16.879c7.84-7.84 14.657-15.513 20.46-23.017c9.058 10.17 19.141 21.73 18.413 27.62m-32.223 35.293c8.184-7.496 13.122-13.634 14.832-18.413c4.093-1.36 9.031-4.092 14.834-8.184c-4.334 11.348-18.937 22.775-29.666 26.597M127.71 477.547c-170.281-98.17-170.281-344.925 0-443.094S512 59.662 512 256S297.993 575.716 127.711 477.547M485.914 256c0-176.332-192.2-287.137-345.13-198.972s-152.93 309.778 0 397.944s345.13-22.64 345.13-198.972"></svg:path>`,
})
export class FileIconsModoIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsModula3Icon],svg[file-icons-modula-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMomentTimezoneIcon],svg[file-icons-moment-timezone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMonkeyIcon],svg[file-icons-monkey-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M511.974 261.913c-.94-31.383-29.239-53.52-58.884-48.351c-1.96.342-3.773.72-5.454 1.138c-7.985-15.886-16.736-31.648-28.37-45.038c-14.084-16.206-31.841-33.135-50.457-43.83c-16.45-9.451-34.62-15.601-53.134-19.748c-16.929-3.795-34.804-1.919-51.347-3.187c-9.391-.72-19.336.476-27.648-3.948c-6.985-3.717-8.063-6.171-1.705-20.643c-11.629 8.023-16.764 14.056-19.318 23.19c-.873 3.12-5.409-9.824-.954-18.853c-9.397 4.656-13.56 17.047-15.102 17.197c-3.385.335-5.095-11.29-5.604-18.857c-7.117 7.32-8.665 22.68-8.665 22.68c-1.756.67-8.123-15.695-4.587-23.7c-10.37 6.725-6.963 24.404-10.322 26.12c-3.972 2.03-2.412-16.567-27.081-24.593v.002c9.67 12.463 11.46 17.529 5.041 26.13a304 304 0 0 1-4.08 5.346c-11.466 14.67-27.516 26.649-39.5 40.9c-11.68 13.894-23.064 28.323-31.6 44.34a206 206 0 0 0-7.967 16.707a83 83 0 0 0-6.326-1.353C29.265 208.394.966 230.53.026 261.912c-.903 30.158 21.62 53.392 51.799 51.41c1.854 15.755 6.165 34.035 13.223 47.467c8.005 15.237 18.685 26.435 32.108 37.205c8.776 7.041 19.013 12.381 29.56 16.309c21.484 8.002 45.096 10.495 67.787 13.76c24.118 3.47 48.516 5.885 72.882 5.605c22.193-.253 44.378-2.888 66.256-6.626c19.13-3.267 36.355-6.243 54.025-14.27c14.764-6.707 27.87-15.965 39.243-27.521c12.695-12.896 24.784-25.757 32.109-42.303c4.131-9.334 6.723-19.434 8-29.612c26.672-1.665 45.79-23.594 44.956-51.423M55.9 243.372c-3.163 14.46-5.286 30.64-5.393 44.901c-3.36 1.559-6.733 1.99-9.496.746c-9.747-4.388-16.767-12.49-14.743-25.158c2.027-12.67 8.845-18.414 19.197-21.085c4.122-1.063 7.585-.71 10.435.596m365.504 73.572c-1.06 10.083-2.702 20.468-7.208 29.551c-6.183 12.47-16.134 22.742-26.816 31.67c-10.52 8.79-23.242 14.901-36.04 19.82c-15.666 6.02-31.102 9.065-47.739 11.276c-21.564 2.867-43.51 3.442-65.229 2.162c-20.742-1.223-41.725-3.394-61.627-9.37c-14.827-4.45-29.136-9.848-41.656-18.95c-10.45-7.595-20.48-16.953-26.816-28.214c-7.906-14.05-12.792-30.376-13.334-46.49c-.713-21.124 5.232-40.279 13.59-59.693c6.044-14.047 15.155-27 25.946-37.84c9.382-9.42 20.501-19.17 32.795-24.233c12.074-4.972 25.516-7.318 38.563-6.848c11.267.403 22.082 3.307 32.54 7.523c7.184 2.9 15.72 9.038 20.917 12.064c6.454-2.976 13.242-10.308 21.033-13.356c12.749-4.984 26.678-7.804 40.364-7.569c11.568.202 22.715 2.542 33.367 7.06c11.255 4.774 20.411 12.09 29.103 20.69c9.168 9.072 15.857 20.544 21.625 32.076c6.713 13.42 12.824 27.513 15.54 42.27c2.2 11.94 2.35 24.33 1.082 36.4m52.66-27.925c-1.806.813-3.878.886-6.031.427c-.28-11.1-1.527-22.44-3.92-32.632a140 140 0 0 0-3.998-13.795c2.667-.982 5.809-1.194 9.495-.243c10.352 2.671 17.17 8.415 19.197 21.085c2.024 12.668-4.996 20.77-14.743 25.158M193.12 278.7c0 11.147-9.035 20.182-20.182 20.182s-20.182-9.035-20.182-20.182s9.036-20.182 20.182-20.182c11.147 0 20.182 9.036 20.182 20.182m173.47 0c0 11.147-9.036 20.182-20.183 20.182s-20.181-9.035-20.181-20.182s9.035-20.182 20.181-20.182s20.182 9.036 20.182 20.182m-115.553 36.593c-1.124 2.277-5.413 2.588-9.58.693s-6.639-5.276-5.515-7.556c1.123-2.277 5.412-2.588 9.58-.693s6.638 5.277 5.515 7.556m18.203 0c1.123 2.277 5.412 2.588 9.58.693s6.638-5.276 5.515-7.556c-1.124-2.277-5.412-2.588-9.58-.693s-6.639 5.277-5.515 7.556m-59.58 30.615c.717.256.735 2.01.922 2.65c.499 1.704 1.38 2.949 2.8 4.029c3.132 2.382 7.342 3.318 11.129 4.069c8.718 1.729 17.743 2.013 26.608 1.982a251 251 0 0 0 23.559-1.2c8.974-.88 18.239-1.986 26.789-4.967c2.542-.886 7.24-2.343 7.6-5.542c.178-1.577-2.333-6.25 1.281-4.068c4.012 2.423 3.492 7.475 1.007 10.732c-2.57 3.368-6.648 5.492-10.448 7.162c-15.106 6.64-32.938 8.181-49.296 7.845c-10.264-.21-20.904-1.232-30.588-4.843c-4.396-1.64-9.19-3.994-11.897-7.99c-1.293-1.909-3.531-9.432.535-9.859"></svg:path>`,
})
export class FileIconsMonkeyIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMonoIcon],svg[file-icons-mono-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M168.782 201.379c-15.291-4.629-40.83-15.266-67.362-26.484L0 202.157V32C0 14.327 14.327 0 32 0h448c17.673 0 32 14.327 32 32v448c0 17.673-14.327 32-32 32H40.3l112.22-132.726l211.841 89.923c12.913-26.142 24.1-50.581 31.936-71.709c-44.667-24.694-77.255-62.703-97.081-103.574c35.59 39.068 89.643 89.642 102.697 88.186c12.711-46.998 6.62-104.272-15.742-167.251l-75.327-23.26c5.023-4.094 50.697 9.58 82.8 13.667c12.741 1.603 15.544-.896 16.908-15.075c1.737-18.077-9.93-68.003-21.7-92.86c-4.697-9.92-6.816-12.06-16.221-16.366c-42.176-16.708-164.95-36.808-213.13-13.423c-.525 3.516 56.219 11.78 58.987 14.407c-53.597-3.002-119.262-18.642-125.77-10.735c-8.28 7.493-20.193 27.974-22.645 38.933c-7.322 25.544 17.609 50.103 98.71 91.242"></svg:path>`,
})
export class FileIconsMonoIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMonotoneIcon],svg[file-icons-monotone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMrubyIcon],svg[file-icons-mruby-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMsDosIcon],svg[file-icons-ms-dos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsMupadIcon],svg[file-icons-mupad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m455.224 326.596l-4.18-169.968c28.622-8.507 46.014-41.301 32.589-71.169c-15.444-34.36-60.798-40.663-85.356-13.864L332.73 45.051C334.699 24.67 321.002 4.036 298.336.504c-24.204-3.771-44.552 14.149-46.869 36.117L86.7 77.812c-14.843-30.91-57.844-34.898-78.082-6.825c-20.331 28.201-2.653 67.901 31.716 71.848L64.29 308.749c-22.348 17.487-20.342 53.248 5.451 67.675c9.133 5.109 18.98 6.257 28.035 4.38l44.76 57.772c-15.436 27.02-1.805 63.577 30.44 71.845c31.984 8.202 61.451-16.772 61.526-47.51l171.151-62.668c17.034 25.527 56.698 26.921 77.284.096c21.901-28.537 6.358-68.356-27.715-73.746zm-56.802 42.428l-174.081 63.74c-7.612-9.913-18.657-16.255-30.516-18.344l-9.861-86.091l102.334-27.957c11.053 10.377 27.354 12.685 40.686 6.729l72.982 54.737a47 47 0 0 0-1.545 7.187zM260.805 67.069c5.33 6.389 12.359 10.778 19.988 12.969l2.821 48.965l-86.18 23.532c-15.426-31.766-55.507-39.749-81.98-20.115l-25.822-22.557zm124.031 33.394c-.038.308-.068.618-.101.926l-69.757 19.048l-2.541-44.094a40 40 0 0 0 4.819-3.246l67.579 27.367zm34.377 55.406l4.34 176.481a50 50 0 0 0-5.286 3.457l-70.731-53.049c5.101-19.277-6.491-39.726-25.807-45.159l-4.88-84.704l74.507-20.345c5.987 10.559 15.618 19.095 27.858 23.319zM180.304 296.36l-8.049-70.274c16.254-8.08 27.731-23.994 30.278-41.974l82.951-22.651l4.698 81.546c-8.925 6.39-14.711 16.583-15.55 27.582l-94.329 25.77zM96.365 157.975c-11.596 31.777 8.805 68.6 44.466 73.251l8.431 73.614l-29.82 8.147c-6.397-6.759-14.992-11.245-24.225-12.589L71.519 136.272zm34.077 184.976l22.482-6.142l8.501 74.221l-37.34-48.194c3.682-5.697 6-12.437 6.356-19.885z"></svg:path>`,
})
export class FileIconsMupadIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNantIcon],svg[file-icons-nant-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 354.548c0 15.192-12.32 27.522-27.526 27.522a27.433 27.433 0 0 1-27.517-27.522c0-15.335-.53-21.334-5.074-27.521c-4.483-6.111-14.658-8.929-22.42-8.929c-15.614 0-27.522-12.316-27.522-27.517c0-15.205 12.32-27.521 27.521-27.521s27.522 12.289 27.522 27.521c0 15.228-1.732 22.954 3.774 28.594c5.45 5.595 8.322 7.856 23.716 7.856c15.403 0 27.526 12.32 27.526 27.517m-429.462-30.24c-15.39 0-18.27-2.262-23.717-7.852c-5.506-5.635-3.778-13.357-3.778-28.59c0-15.232-12.32-27.52-27.521-27.52S0 272.66 0 287.865c0 15.197 11.917 27.522 27.522 27.522c7.766 0 17.942 2.813 22.424 8.92c4.54 6.196 5.07 12.186 5.07 27.521c0 15.34 12.32 27.526 27.522 27.526s27.52-12.325 27.52-27.526c0-15.2-12.122-27.521-27.52-27.521m68.224 0c-15.407 0-18.278-2.262-23.726-7.852c-5.51-5.635-3.777-13.357-3.777-28.59c0-15.232-12.32-27.52-27.522-27.52s-27.521 12.315-27.521 27.52c0 15.197 11.908 27.522 27.521 27.522c7.762 0 17.938 2.813 22.425 8.92c4.54 6.196 5.07 12.186 5.07 27.521c0 15.34 12.32 27.526 27.53 27.526c15.192 0 27.517-12.325 27.517-27.526c0-15.2-12.127-27.521-27.517-27.521m66.812 0c-15.394 0-18.266-2.262-23.717-7.852c-5.505-5.635-3.773-13.357-3.773-28.59c0-15.232-12.321-27.52-27.522-27.52s-27.521 12.315-27.521 27.52c0 15.197 11.908 27.522 27.521 27.522c7.762 0 17.938 2.813 22.42 8.92c4.545 6.196 5.075 12.186 5.075 27.521a27.434 27.434 0 0 0 27.517 27.526c15.205 0 27.526-12.325 27.526-27.526c0-15.2-12.124-27.521-27.526-27.521m0-192.273c-15.394 0-18.266-2.262-23.717-7.857c-5.505-5.64-3.773-13.365-3.773-28.593c0-15.233-12.321-27.522-27.522-27.522s-27.521 12.316-27.521 27.522c0 15.2 11.908 27.517 27.521 27.517c7.762 0 17.938 2.818 22.42 8.928c4.545 6.187 5.075 12.186 5.075 27.522s12.32 27.521 27.517 27.521c15.205 0 27.526-12.33 27.526-27.521c0-15.197-12.124-27.517-27.526-27.517m66.057 0c-15.398 0-18.274-2.262-23.721-7.857c-5.505-5.64-3.773-13.365-3.773-28.593c0-15.233-12.33-27.522-27.522-27.522c-15.2 0-27.525 12.316-27.525 27.522c0 15.2 11.912 27.517 27.525 27.517c7.763 0 17.938 2.818 22.416 8.928c4.545 6.187 5.074 12.186 5.074 27.522s12.325 27.521 27.526 27.521c15.197 0 27.522-12.33 27.522-27.521c0-15.197-12.128-27.517-27.522-27.517m51.723 156.675c0 15.201 12.32 27.522 27.522 27.522s27.52-12.182 27.52-27.522c0-15.335.535-21.334 5.07-27.517c4.488-6.12 14.663-8.924 22.425-8.924c15.61 0 27.526-12.316 27.526-27.517c0-15.21-12.33-27.525-27.526-27.525c-15.2 0-27.525 12.293-27.525 27.525c0 15.228 1.736 22.95-3.774 28.594c-5.442 5.581-8.318 7.847-23.716 7.847s-27.522 12.321-27.522 27.517m-68.216 0c0 15.201 12.32 27.522 27.517 27.522c15.206 0 27.526-12.182 27.526-27.522c0-15.335.534-21.334 5.074-27.517c4.474-6.12 14.654-8.924 22.42-8.924c15.61 0 27.522-12.316 27.522-27.517c0-15.21-12.32-27.525-27.521-27.525s-27.522 12.293-27.522 27.525c0 15.228 1.728 22.95-3.769 28.594c-5.455 5.581-8.327 7.847-23.73 7.847c-15.39 0-27.517 12.321-27.517 27.517m-66.824 0c0 15.201 12.32 27.522 27.52 27.522c15.202 0 27.522-12.182 27.522-27.522c0-15.335.53-21.334 5.075-27.517c4.477-6.12 14.658-8.924 22.42-8.924c15.613 0 27.52-12.316 27.52-27.517c0-15.21-12.32-27.525-27.52-27.525s-27.522 12.293-27.522 27.525c0 15.228 1.732 22.95-3.769 28.594c-5.456 5.581-8.327 7.847-23.725 7.847s-27.521 12.321-27.521 27.517M69.683 222.657c0 15.206 12.316 27.522 27.522 27.522a27.427 27.427 0 0 0 27.516-27.522c0-15.336.534-21.325 5.08-27.521c4.477-6.107 14.653-8.92 22.42-8.92c15.608 0 27.516-12.311 27.516-27.522c0-15.2-12.32-27.525-27.516-27.525c-15.197 0-27.526 12.298-27.526 27.525c0 15.237 1.731 22.95-3.774 28.595c-5.45 5.59-8.322 7.847-23.716 7.847c-15.399 0-27.522 12.325-27.522 27.521m197.455 193.758c0 15.201 12.32 27.522 27.517 27.522c15.206 0 27.526-12.177 27.526-27.522s.534-21.343 5.074-27.535c4.474-6.102 14.654-8.915 22.42-8.915c15.61 0 27.522-12.32 27.522-27.521c0-15.192-12.32-27.517-27.521-27.517s-27.522 12.289-27.522 27.517c0 15.232 1.728 22.958-3.769 28.598c-5.455 5.586-8.327 7.852-23.73 7.852c-15.39 0-27.517 12.316-27.517 27.521m-66.824 0c0 15.201 12.32 27.522 27.52 27.522c15.202 0 27.522-12.177 27.522-27.522s.53-21.343 5.075-27.535c4.477-6.102 14.658-8.915 22.42-8.915c15.613 0 27.52-12.32 27.52-27.521c0-15.192-12.32-27.517-27.52-27.517s-27.522 12.289-27.522 27.517c0 15.232 1.732 22.958-3.769 28.598c-5.456 5.586-8.327 7.852-23.725 7.852s-27.521 12.316-27.521 27.521"></svg:path>`,
})
export class FileIconsNantIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNasmIcon],svg[file-icons-nasm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M511.31 58.832c-5.611 36.685-47.118 54.658-77.515 35.635l-32.494 32.49c114.438 126.46 55.254 332.993-111.943 377.216C118.557 549.35-38.015 391.566 8.205 220.845C53.37 54.019 259.375-4.001 384.999 110.584l32.4-32.4c-16.235-25.855-6.165-62.6 24.787-74.649c36.553-14.228 75.047 16.567 69.123 55.297M338.461 321.24h16.83c2.396-.02 3.01-.738 3.213-3.212v-47.436c6.26-3.155 11.528-4.936 15.687-4.271c4.682.748 6.697 4.099 6.502 11.461v40.246c.027 1.337.164 3.247 3.37 3.212h16.83c2.018-.012 2.959-.659 3.054-3.212v-43.615c.223-13.208-1.702-25.37-13.419-28.819c-10.221-3.041-23.205-.487-34.936 9.234c-3.132-6.933-9.908-10.027-18.285-10.414c-7.58-.35-16.312 2.193-24.26 8.629l.01-3.881c-.165-1.812-.506-3.376-3.346-3.366h-16.718c-1.858-.03-3.177.723-3.191 3.366v68.863c.023 2.21.891 3.21 3.191 3.212h16.718c2.76.034 3.238-1.323 3.346-3.212v-47.436c16.266-8.035 22.55-4.677 22.188 6.732v40.707c.057 2.202.795 3.168 3.216 3.212m-60.606-67.244c.513-1.958.28-3.317-.689-4.09c-9.161-5.606-31.288-7.598-43.69-3.083c-11.559 4.209-15.362 13.493-15.606 21.993c-.107 16.758 12.263 21.088 30.144 23.322c6.055.792 8.814 1.686 8.568 6.288c.33 8.978-20.141 5.354-32.591 3.687c-4.424-.827-4.285.595-4.901 2.597l-1.681 7.285c-.776 3.905-.483 5.166 5.2 7.284c22.641 5.993 46.638 4.552 55.011-9.864c4.991-9.07 3.862-24.67-6.148-30.448c-6.433-3.987-14.035-4.562-20.157-5.553c-6.314-1.25-10.4-1.526-10.183-5.433c.338-5.15 2.92-5.552 13.164-5.037c10.898.436 19.062 2.497 20.577 1.531c1.372-.902 1.953-6.042 2.982-10.48m-80.997-3.03c-8.518-7.535-30.323-8.841-52.604-3.028c-3.536 1.64-5.307 2.213-4.898 5.967c1.281 5.342 1.553 10.119 3.29 10.56c5.042.673 20.084-2.583 31.14-.846c4.973 1.167 6.902 2.859 6.578 10.94h-17.599c-21.352-.177-29.616 9.182-29.382 25.401c-.028 12.38 3.908 21.939 20.777 22.505c9.55.32 20.455-3.621 28.235-10.614c.825 3.173 1.687 5.421 4.38 7.52c2.874 2.239 10.326 3.509 17.545 2.406c4.962-.758 7.967-1.892 7.877-4.668v-9.798c-.059-2.04-.724-2.385-3.216-2.6c-5.006-.414-5.658-1.428-5.655-7.348v-24.174c-.631-9.093-.64-17.068-6.468-22.223m-36.395 53.708c-2.385-.617-3.57-2.206-3.514-5.927c-.061-6.81 2.996-9.109 9.186-9.336h13.772v10.256c-6.519 3.779-14.267 6.347-19.444 5.007m-59.996 13.354c0 2.14.971 3.212 3.219 3.212h16.83c1.333-.079 3.149.033 3.21-3.209v-43.46c.272-13.501-2.013-20.495-7.094-25.186c-8.684-8.017-26.833-6.062-40.493 3.942v-4.157c-.167-2.768-.999-3.308-3.216-3.366H56.247c-2.545-.007-3.292 1.134-3.366 3.366v68.862c.188 1.268-.014 3.222 3.366 3.213h16.677c1.99-.045 3.057-.37 3.216-3.213v-47.436c12.464-5.463 24.515-8.646 24.328 7.34z"></svg:path>`,
})
export class FileIconsNasmIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNdependIcon],svg[file-icons-ndepend-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M62.132 127.995c-12.784-11.937-9.956-24.391-5.666-28.683L96.511 59.25c12.157-12.161 23.599-6.438 26.459-3.577c2.86 2.862 39.33 40.777 39.33 40.777v164.538c5.71 126.604 190.215 115.654 190.215-14.308V96.45l38.377-37.438s12.517-13.166 23.481-2.196s41.476 41.492 41.476 41.492s11.32 14.119-3.936 29.38l-34.064 35.029c-1.903 32.757 1.523 47.993 24.749 48.374l53.684.761c7.829 1.982 14.127 5.457 15.094 14.136c0 0 1.678 58.25-.468 64.689s-7.352 10.95-18.963 11.54h-54.297l-23.225 26.19c-3.412 5.774-3.73 12.187-.62 19.676c0 0 32.332 32.238 42.501 43.553c6.644 7.393 5.144 17.437 2.045 22.206c0 0-35.99 36.48-42.906 43.4c-8.104 8.108-21.69.715-21.69.715l-41.476-41.015c-36.03-.793-44.336 3.815-49.103 18.838c0 0-.7 40.896-.7 56.512s-11.958 19.125-19.077 19.125s-34.979.583-53.635.583s-18.12-18.512-18.12-18.512V441.98c0-5.647-21.649-24.083-21.649-24.083c-6.488-3.643-17.08-5.598-26.1-1.502c0 0-30.435 30.832-40.446 40.37c-10.012 9.538-23.36.477-23.36.477s-33.371-30.523-42.429-40.062s-2.384-22.892-2.384-22.892l41-42.923c.953-21.461 2.861-39.784-17.64-48.169H18.09c-25.266 0-16.686-70.823-16.686-70.823c0-19.315 17.162-21.462 17.162-21.462h53.632c6.05 0 16.384-11.052 24.149-20.613C107 177.25 99 159.75 62.132 127.995M301.6 174.999l-.333-158.91c.923-22.291-90.288-20.9-89.625.953v157.385c38.975-17.698 53.94-15.668 89.958.572"></svg:path>`,
})
export class FileIconsNdependIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNekoIcon],svg[file-icons-neko-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNemerleIcon],svg[file-icons-nemerle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNeo4jIcon],svg[file-icons-neo4j-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNestjsIcon],svg[file-icons-nestjs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNetlifyIcon],svg[file-icons-netlify-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNgrxIcon],svg[file-icons-ngrx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNickleIcon],svg[file-icons-nickle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M470.77 116.25C364.03-48.63 117.59-35.665 28.243 139.53s44.802 382.416 240.888 372.1S577.51 281.13 470.77 116.25M267.49 479.138C96.299 488.145-20.82 307.233 57.185 154.278C131.787 7.996 331.83-8.73 430.657 116.01l-31.861 70.838c-31.422-8.19-76.092-8.587-105.509 39.154c-22.056 35.795-25.735 99.336 26.518 136.467l-30.515 67.845l27.668 12.494l29.875-66.421c24.55 6.656 61.495.347 88.722-6.911v-32.273c-13.646 7.524-50.32 13.399-74.31 7.143l51.752-115.064c13.393 5.278 22.558 10.837 22.558 10.837V201.68l-8.203-4.315l23.263-51.72c80.78 142.444-16.526 324.728-183.124 333.492M334.275 330.3c-48.436-30.947-15.818-125.922 49.146-109.266zM163.302 96.544h92.908v31.03h-65.935l-15.984 35.034s81.919 21.02 81.919 82.08v45.044c0 14.957-6.635 94.09-83.917 94.09H96.37v-33.031h71.928c36.15 0 50.95-38.99 50.95-61.06v-45.043c0-38.037-90.91-53.052-90.91-53.052v-29.028z"></svg:path>`,
})
export class FileIconsNickleIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNightwatchIcon],svg[file-icons-nightwatch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNimrodIcon],svg[file-icons-nimrod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNitIcon],svg[file-icons-nit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNmapIcon],svg[file-icons-nmap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNokogiriIcon],svg[file-icons-nokogiri-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNsisOldIcon],svg[file-icons-nsis-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M103.853 86.647h24.7l32.23 48.964V86.647h24.933v88.5h-24.932l-32.057-48.592v48.592h-24.874zm130.328 52.218c-30.779-6.736-32.353-20.907-32.29-27.83c.211-23.4 25.825-26.168 36.377-25.897c30.468.78 34.178 17.205 35.268 26.38l-24.933 1.51c-.662-3.984-3.055-11.737-12.963-11.41c-8.437.278-9.26 5.01-9.284 6.943c-.05 4.06 6.131 6.057 10.802 7.063c11.562 2.575 17.12 4.138 24.846 7.817c17.267 8.224 21.934 36.884-2.95 49.502c-11.558 4.605-31.905 5.7-45.773-1.31c-9.148-4.622-13.93-16.205-14.602-25.765l25.166-1.63q.818 6.339 3.329 9.66c7.408 9.504 23.84 5.751 23.503-4.379c-.203-6.096-8.796-8.968-16.496-10.654m132.896 0c-30.778-6.736-32.352-20.907-32.29-27.83c.212-23.4 25.825-26.168 36.378-25.897c30.468.78 34.178 17.205 35.268 26.38l-24.933 1.51c-.662-3.984-3.055-11.737-12.963-11.41c-8.437.278-9.26 5.01-9.284 6.943c-.05 4.06 6.131 6.057 10.802 7.063c11.562 2.575 17.12 4.138 24.846 7.817c17.267 8.224 21.934 36.884-2.95 49.502c-11.558 4.605-31.905 5.7-45.773-1.31c-9.148-4.622-13.93-16.205-14.602-25.765l25.166-1.63q.818 6.339 3.329 9.66c7.408 9.504 23.84 5.751 23.503-4.379c-.203-6.096-8.796-8.968-16.497-10.654m-76.374-52.218h26.509v88.5h-26.51zM256 0C114.615 0 0 114.615 0 256s114.615 256 256 256s256-114.615 256-256S397.385 0 256 0m-.45 496.022c-91.485 0-165.649-52.76-165.649-117.842s74.164-117.843 165.65-117.843c91.485 0 165.648 52.76 165.648 117.843S347.036 496.022 255.55 496.022M22.626 205.774C45.762 98.177 141.59 17.264 256 17.264s210.238 80.913 233.374 188.51zM148.792 381.15l104.386 109.271l109.13-109.271H310.86v-95.64H197.125v95.64z"></svg:path>`,
})
export class FileIconsNsisOldIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNsriAltIcon],svg[file-icons-nsri-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNunjucksIcon],svg[file-icons-nunjucks-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNvidiaIcon],svg[file-icons-nvidia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNwscriptIcon],svg[file-icons-nwscript-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsNxIcon],svg[file-icons-nx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOberonIcon],svg[file-icons-oberon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsObjectiveJIcon],svg[file-icons-objective-j-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m278.005 143.727l-14.042-8.75c-3.182 3.291-8.301 4.118-12.41 1.678c-4.238-2.517-5.953-7.644-4.336-12.115l-38.675-24.101l41.262 20.21c3.199-3.02 8.102-3.733 12.072-1.375c3.48 2.067 5.237 5.895 4.87 9.673l15.79 7.733zm191.006 316.678c5.63 16.144-.916 51.595-35.39 51.595H66.307c-28.606 0-36.41-34.393-33.048-44.375c9.153-27.17 26.615-78.119 31.179-87.932s10.918-26.973 39.253-26.973h46.632l-3.604-22.741l19.055-25.009c9.935-12.915 15.407-28.002 15.407-42.479V221.96l-.007-.001a437 437 0 0 1-10.843-1.616h-.001v42.148c0 11.924-4.796 24.993-13.172 35.884l-12.789 16.783l-16.52-104.22c-60.086-17.445-99.602-49.413-99.602-95.768C28.247 46.077 129.244 0 253.83 0s229.923 46.077 229.923 115.17c0 51.452-42.804 82.588-106.105 98.407l-8.458 55.654c18.54 4.11 53.94 12.853 61.04 14.847c15.182 4.265 10.064 50.492-11.77 44.692c-8.17-2.17-40.504-10.974-55.958-15.524l-5.999 39.474h43.77c15.508 0 30.947 3.978 39.768 29.233c7.218 20.664 23.339 62.308 28.97 78.452M420.125 321.24c4.453 1.093 9.682-4.616 11.68-12.752s.006-15.618-4.447-16.71c-4.453-1.094-9.682 4.615-11.68 12.75c-1.997 8.137-.006 15.618 4.447 16.712M118.228 124.895c0-5.952-4.824-10.776-10.775-10.776s-10.775 4.824-10.775 10.776c0 5.95 4.824 10.775 10.775 10.775s10.775-4.824 10.775-10.775m41.847 0c0-9.886-8.014-17.9-17.9-17.9s-17.899 8.014-17.899 17.9s8.014 17.899 17.9 17.899s17.899-8.014 17.899-17.9m225.844 0c0 5.95 4.825 10.775 10.776 10.775s10.775-4.824 10.775-10.775s-4.824-10.776-10.775-10.776s-10.776 4.824-10.776 10.776m-41.846 0c0 9.885 8.014 17.899 17.9 17.899s17.899-8.014 17.899-17.9s-8.014-17.899-17.9-17.899s-17.899 8.014-17.899 17.9m-153.932.683c0 35.065 28.425 63.49 63.489 63.49s63.49-28.425 63.49-63.49s-28.426-63.489-63.49-63.489s-63.49 28.425-63.49 63.49m106.603 159.163l-.003-.03zm19.113-60.937c-42.849 3.571-84.779 3.424-125.723-.72l-.001 21.39s4.455 7.799 15.589 11.67V267s2.441 10.308 18.175 10.308h12.37v8.594a4.44 4.44 0 0 0 4.426 4.427h5.171v5.783a2.906 2.906 0 0 0 2.898 2.898h8.592a2.906 2.906 0 0 0 2.898-2.898v-5.783h5.17a4.44 4.44 0 0 0 4.427-4.427v-8.594h6.131c3.528 0 6.848-.467 9.857-1.262c-.014.27-.025.534-.025.78c0 3.403 7.07 5.312 10.766 6.08c-.352-6.744 1.94-14.904 6.422-20.098a32 32 0 0 0-2.606-.633v-5.407c7.53-2.822 13.55-8.971 14.864-12.912c.816-2.448.823-11.299.599-20.05"></svg:path>`,
})
export class FileIconsObjectiveJIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOcamlIcon],svg[file-icons-ocaml-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOgoneIcon],svg[file-icons-ogone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m136.445 387.686l-121.982 42.59c-11.366 3.346-16.457-11.5-13.75-17.96l197.041-205.251c4.97-5.157 9.764-10.182 8.402-17.214l-16.35-88.15c-4.342-18.092 18.014-23.463 24.449-9.65l49.938 103.395a21.36 21.36 0 0 1-1.773 21.888L144.689 381.52a17.06 17.06 0 0 1-8.244 6.167m219.138-142.755l-72.196 184.77a25.76 25.76 0 0 1-9.952 12.221l-105.046 68.285c-13.573 7.553-23.243-10.697-17.158-18.746l141.451-245.438c3.08-5.371 3.74-10.139 1.184-15.778l-36.598-79.27c-8.244-15.159 10.764-26.12 17.606-19.114l77.481 92.42a20.76 20.76 0 0 1 3.228 20.65m49.786 98.85c-8.295 17.804-28.121 4.25-23.67-12.745l19.482-86.168a10.11 10.11 0 0 0-2.32-9.234L205.097 21.93c-9.644-10.583 1.412-26.136 15.111-20.874L341.26 48.08l116.254 173.475a19.81 19.81 0 0 1 1.123 20.164z"></svg:path>`,
})
export class FileIconsOgoneIcon {
  readonly viewBox = input("0 0 461 512")
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOmnigraffleIcon],svg[file-icons-omnigraffle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenapiIcon],svg[file-icons-openapi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m.204 294.376l135.073-.002a91.7 91.7 0 0 0 8.452 30.17L27.94 394.298C12.75 368.103 3.166 334.783.204 294.376m131.802 196.803l51.407-124.841a91.5 91.5 0 0 1-14.938-9.955l-95.47 95.472c19.49 17.557 39.562 30.71 59.001 39.324m-65.604-45.647l95.284-95.286c-4.933-4.963-9.482-10.85-13.667-17.616L32.512 402.213c10.491 17.069 22.148 31.847 33.89 43.319m313.997 6.327l-95.53-95.525a92 92 0 0 1-3.184 2.466l69.71 115.72c9.73-6.055 19.39-13.823 29.004-22.66m-36.74 27.532l-69.565-115.479c-25.964 14.5-53.318 17.553-82.406 6.337l-51.301 124.583c70.2 28.467 142.961 20.313 203.272-15.441M171.713 211.67L102.005 95.95c-10.164 6.523-19.819 14.106-29.006 22.66l95.527 95.527a135 135 0 0 1 3.187-2.467M0 285.236l134.762-.002c.291-23.838 8.71-45.682 26.928-65.006l-95.287-95.287C22.416 171.553.512 225.056 0 285.236m226.694-91.938L226.7 58.54c-44.728.274-84.005 12.326-116.96 32.539l69.563 115.48c13.077-7.677 28.664-12.98 47.39-13.26m186.404-37.118l-99.449 99.452a93.7 93.7 0 0 1 4.453 20.46h135.09c-.883-40.98-14.404-80.939-40.094-119.912m40.28 129.052H318.631c-.468 25.24-9.9 48.244-26.924 65.014l95.29 95.286c43.82-43.123 65.122-96.948 66.381-160.3M235.84 58.74l-.006 135.087c7.082.802 13.883 2.342 20.466 4.455l99.415-99.415c-35.132-24.575-76.54-38.362-119.875-40.127M430.95 2.597c-39.165 11.457-55.533 55.183-38.782 88.672L254.808 228.63c-32.407-16.157-74.902-1.57-87.795 36.034c-15.716 45.84 24.243 91.802 71.754 82.533c42.01-8.196 62.31-54.188 44.466-90.01L420.722 119.7c34.66 17.226 79.533-1.065 89.396-41.654c11.43-47.037-32.658-89.054-79.168-75.449"></svg:path>`,
})
export class FileIconsOpenapiIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenbsdIcon],svg[file-icons-openbsd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenbsdAltIcon],svg[file-icons-openbsd-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenclIcon],svg[file-icons-opencl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M47.075 330.25a183.5 183.5 0 0 1 10.894-26.404L14.74 278.03a223 223 0 0 0-11.374 41.226zm-1.968-107.426c-9.917 13.37-18.421 27.71-25.264 42.868l44.536 26.596a177.6 177.6 0 0 1 19.867-26.901zm212.511-103.036l-19.868 94.198c19.014 4.09 36.856 11.608 52.926 21.969l56.526-100.604c-27.86-9.878-58.036-15.38-89.584-15.563m-108.001 21.487c-17.878 7.603-34.644 17.05-50.025 28.101l30.001 60.091c11.182-6.032 23.079-10.772 35.53-14.006zm195.269 150.84l116.514-76.47c-24.312-30.318-56.222-55.052-93.099-71.81l-69.331 97.853a171.8 171.8 0 0 1 30.308 28.497l-131.634 84.198c-12.206 8.39-10.672 22.314-2.814 30.936s21.217 9.24 29.839 1.381l114.117-104.017a180 180 0 0 1 6.1 9.432M1.449 332.393C.506 340.693 0 349.113 0 357.645c0 5.152.238 10.25.585 15.322h37.95c.834-10.283 2.528-20.298 4.928-30.006zm474.978-95.699l-124.586 68.069c10.334 20.647 16.993 43.706 18.982 68.204h140.592c.347-5.071.585-10.17.585-15.322c0-44.172-13.001-85.505-35.573-120.95M93.445 255.877a168.6 168.6 0 0 1 23.97-19.115l-31.36-56.97a247.3 247.3 0 0 0-32.666 32.524zm132.775-43.921l11.69-91.55c-24.894 1.618-48.816 6.497-71.242 14.26l12.666 77.827a157.5 157.5 0 0 1 25.345-2.071c7.306 0 14.484.56 21.541 1.534"></svg:path>`,
})
export class FileIconsOpenclIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpencvIcon],svg[file-icons-opencv-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M148.646 81.064c43.211-81.41 158.967-85.682 207.86-7.67c37.888 60.45 13.796 135.484-41.823 167.787l-36.122-62.565c22.127-12.85 31.712-42.7 16.639-66.75c-19.451-31.035-65.502-29.336-82.693 3.052c-12.72 23.965-2.639 51.55 18.309 63.73l-36.148 62.61c-52.656-30.615-77.998-99.952-46.022-160.194m19.32 293.407c-.043 24.278-18.934 46.898-46.092 47.9c-36.642 1.352-61.088-37.652-43.897-70.04c13.292-25.041 43.83-31.719 65.993-19.122l36.216-62.728c-55.724-31.8-132.625-15.015-166.07 47.997c-43.212 81.41 18.237 179.453 110.341 176.054c68.138-2.514 115.575-59.165 115.862-120.061zm283.748-103.714l-36.121 62.564c22.203 12.817 31.842 42.725 16.745 66.813c-19.452 31.035-65.503 29.336-82.693-3.052c-12.742-24.006-2.605-51.643 18.415-63.79l-36.148-62.611c-52.728 30.583-78.125 99.973-46.128 160.255c43.21 81.41 158.967 85.682 207.86 7.67c37.912-60.49 13.766-135.58-41.93-167.849"></svg:path>`,
})
export class FileIconsOpencvIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenglIcon],svg[file-icons-opengl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenscadIcon],svg[file-icons-openscad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpensolarisIcon],svg[file-icons-opensolaris-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenvmsIcon],svg[file-icons-openvms-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M222.902.002c-7.575.138-14.478 6.24-14.473 14.707c.007 11.289 12.29 18.39 22.055 12.752s9.757-19.824-.016-25.475c-2.443-1.412-5.042-2.03-7.566-1.984m3.132 47.643c-5.791.105-11.069 4.771-11.066 11.246h.002c.005 8.632 9.398 14.063 16.865 9.752c7.467-4.312 7.46-15.162-.013-19.483a11.1 11.1 0 0 0-5.788-1.515M349.32 61.32c-2.525-.046-5.126.57-7.569 1.983c-9.772 5.65-9.78 19.838-.015 25.476s22.047-1.463 22.054-12.752c.005-8.466-6.896-14.568-14.47-14.707M107.005 78.443c-2.527-.047-5.13.567-7.574 1.977c-9.78 5.638-9.78 19.81 0 25.447s22.07-1.448 22.07-12.724c0-8.458-6.913-14.557-14.496-14.7m121.854 8.903c-4.797.087-9.17 3.95-9.166 9.312h.002c.005 7.149 7.782 11.647 13.966 8.076s6.178-12.554-.011-16.132a9.2 9.2 0 0 0-4.791-1.256m83.687 2.193a11.1 11.1 0 0 0-5.787 1.518h-.002c-7.472 4.32-7.477 15.169-.01 19.48c7.468 4.312 16.861-1.117 16.865-9.75c.004-6.474-5.274-11.142-11.066-11.248m-165.79 11.785a11.1 11.1 0 0 0-5.794 1.51c-7.478 4.312-7.478 15.15 0 19.46c7.479 4.312 16.88-1.106 16.88-9.73c0-6.467-5.288-11.13-11.087-11.24m134.45 11.451a9.2 9.2 0 0 0-4.793 1.256c-6.188 3.58-6.193 12.565-.01 16.135c6.185 3.57 13.963-.927 13.967-8.076c.003-5.362-4.367-9.227-9.164-9.315m-100.377 6.946a9.2 9.2 0 0 0-4.796 1.25c-6.194 3.57-6.194 12.546 0 16.117c6.193 3.57 13.978-.918 13.978-8.059c0-5.355-4.38-9.218-9.182-9.308m50.698.6c-3.777.153-7.285 3.192-7.38 7.3c-.124 5.478 5.915 8.785 10.846 5.938c4.932-2.847 5.09-9.731.284-12.362a7.16 7.16 0 0 0-3.75-.877m24.048 12.173a7.16 7.16 0 0 0-3.75.877c-4.806 2.63-4.647 9.514.284 12.361c4.93 2.847 10.97-.458 10.845-5.935c-.093-4.108-3.602-7.15-7.379-7.303m-46.876 2.37c-7.596.64-8.22 8.409-5.56 12.099l-158.55 23.813v14.82l35.063 11.827C5.484 271.377-39.38 375.844 47.993 448.362c30.818 25.577 110.718 69.452 139.592 62.997c88.054-1.769 172.311-130.694 95.174-171.593l-65.217-23.934c-38.404 6.158-53.07 27.033-59.271 46.063l56.693 29.31c8.51-15.892 17.539-32.931 48.64-39.62c4.698 46.288-32.31 130.639-148.82 111.136c-33.505-77.978 59.093-175.316 130.46-218.405l51.86 15.141v-15.463l-39.478-69.748c6.978-1.415 9.401-10.572 2.926-13.814c-3.416-2.078-7.461-.722-9.404 2.369l-12.022-21.24l-24.039 3.61c2.795-5.831-2.38-10.103-6.388-10.308m76.1 35.943c-4.803.09-9.18 3.952-9.18 9.308c0 7.14 7.783 11.627 13.976 8.057s6.193-12.545 0-16.115v.002a9.2 9.2 0 0 0-4.797-1.252m34.073 14.53c-5.798.11-11.086 4.776-11.086 11.243c.001 8.622 9.4 14.04 16.88 9.729c7.478-4.312 7.477-15.147 0-19.46a11.1 11.1 0 0 0-5.794-1.511m39.75 15.964c-7.582.143-14.496 6.242-14.496 14.699c0 11.277 12.29 18.363 22.07 12.725s9.78-19.809.003-25.448h-.002c-2.445-1.409-5.048-2.024-7.575-1.976"></svg:path>`,
})
export class FileIconsOpenvmsIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOpenzfsIcon],svg[file-icons-openzfs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 38.987C512 17.463 494.546 0 473 0H38.99C17.462 0 0 17.463 0 38.987v148.951h58.145L0 324.049V473.01C0 494.537 17.462 512 38.99 512h434.014C494.55 512 512 494.537 512 473.01V324.05h-58.141L512 187.937zM244.06 320.01c-15.843-9.134-15.843-32.094 0-41.228s35.758 2.346 35.758 20.614s-19.913 29.749-35.757 20.614m-45.908 45.898c-15.844-9.135-15.844-32.094 0-41.229s35.757 2.346 35.757 20.614s-19.913 29.749-35.757 20.615m91.801 0c-15.844-9.135-15.844-32.094 0-41.229s35.757 2.346 35.757 20.614s-19.913 29.749-35.757 20.615m-137.698 45.896c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.346 35.757 20.614s-19.913 29.749-35.757 20.614m91.81 0c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.346 35.757 20.614s-19.912 29.749-35.757 20.614m91.79 0c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.346 35.757 20.614s-19.913 29.749-35.757 20.614M106.36 457.705c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.345 35.757 20.614s-19.913 29.748-35.757 20.614m91.795 0c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.345 35.757 20.614s-19.913 29.748-35.757 20.614m91.795 0c-15.844-9.134-15.844-32.094 0-41.228s35.757 2.345 35.757 20.614s-19.913 29.748-35.757 20.614m91.796 0c-15.844-9.134-15.844-32.094 0-41.228c15.845-9.135 35.757 2.345 35.757 20.614s-19.912 29.748-35.757 20.614M249.162 223.808c-9.075-5.232-9.075-18.384 0-23.616c9.076-5.232 20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m-29.58-29.633c-9.075-5.232-9.075-18.384 0-23.616c9.076-5.232 20.482 1.343 20.482 11.808s-11.406 17.04-20.481 11.808m59.153 0c-9.075-5.232-9.075-18.384 0-23.616c9.076-5.232 20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m29.576-29.616c-9.076-5.232-9.076-18.384 0-23.616c9.075-5.232 20.482 1.344 20.482 11.808s-11.407 17.04-20.482 11.808m-59.149 0c-9.075-5.232-9.075-18.384 0-23.616s20.482 1.344 20.482 11.808s-11.406 17.04-20.482 11.808m-59.153 0c-9.076-5.232-9.076-18.384 0-23.616c9.075-5.232 20.482 1.344 20.482 11.808s-11.407 17.04-20.482 11.808m88.725-29.617c-9.075-5.232-9.075-18.384 0-23.616c9.076-5.232 20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m59.15 0c-9.077-5.232-9.077-18.384 0-23.616c9.075-5.232 20.481 1.343 20.481 11.808s-11.406 17.04-20.482 11.808m-118.302 0c-9.076-5.232-9.076-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m-59.15 0c-9.075-5.232-9.075-18.384 0-23.616s20.483 1.343 20.483 11.808s-11.406 17.04-20.482 11.808m88.731-29.613c-9.076-5.232-9.076-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m59.148 0c-9.076-5.232-9.076-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.407 17.04-20.482 11.808m59.159 0c-9.076-5.232-9.076-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m-177.46 0c-9.075-5.232-9.075-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m-59.153 0c-9.076-5.232-9.076-18.384 0-23.616s20.482 1.343 20.482 11.808s-11.406 17.04-20.482 11.808m147.877-29.61c-9.076-5.233-9.076-18.385 0-23.617s20.482 1.344 20.482 11.808s-11.406 17.04-20.482 11.808m59.151 0c-9.076-5.233-9.076-18.385 0-23.617s20.482 1.344 20.482 11.808s-11.406 17.04-20.482 11.808m59.163 0c-9.076-5.233-9.076-18.385 0-23.617c9.075-5.232 20.482 1.344 20.482 11.808s-11.407 17.04-20.482 11.808m-177.467 0c-9.076-5.233-9.076-18.385 0-23.617c9.075-5.232 20.482 1.344 20.482 11.808s-11.407 17.04-20.482 11.808m-59.146 0c-9.076-5.233-9.076-18.385 0-23.617s20.482 1.344 20.482 11.808s-11.406 17.04-20.482 11.808m-59.156 0c-9.075-5.233-9.075-18.385 0-23.617s20.482 1.344 20.482 11.808s-11.406 17.04-20.482 11.808"></svg:path>`,
})
export class FileIconsOpenzfsIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOrgModeIcon],svg[file-icons-org-mode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M388.634 512c-1.275-13.87-40.212-103.377-114.3-146.28c-50.053-27.292-18.61-74.308-15.04-90.902c0 0 40.087 28.015 69.135-14.84c26.25 6.759 43.827-4.77 66.397 3.402c13.687 5.989 71.35 2.374 49.924-29.84l21.627-19.382c3.637-16.253-4.598-19.682-7.1-24.174c-.685-10.308-9.305-14.329-19.633-6.952c-41.365-7.925-57.37 6.536-104.409-20.023c-5.838-17.437-18.138-13.476-33.94-20.004c13.044-29.308 14.398-42.935 30.31-85.649C337.188 34.836 353.871-.07 345.4 0c-12.103.085-46.207 70.826-72.237 127.046a46.85 46.85 0 0 1-8.727-27.082c-.642-12.453-23.292 5.027-20.023 27.233c0 0-26.952 4.877-26.952 4.92c-4.92-19.893-17.156-34.592-24.596-12.022c-14.97 35.575-18.82 63.81 2.46 98.052C175.901 304.949 46.726 347.592 60.161 417.68c3.743.085 34.974 74.479 135.562 44.037c118.818-33.73 185.39 44.748 192.91 50.283M48.989 409.752c-18.87-67.782 113.28-114.005 133.936-191.512c-17.647-25.669-16.176-39.39-15.504-62.983c-21.387 22.079-45.031 22.294-80.857 28.28c-27.804 5.006-78.219 52.34-86.09 101.471c-3.969 62.898 17.403 108.032 48.515 124.744"></svg:path>`,
})
export class FileIconsOrgModeIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOs2Icon],svg[file-icons-os2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M71.212 316.895c-1.563-39.321-.765-78.627 2.836-116.932c3.05-29.275 21.785-40.74 44.85-42.45c22.787-.714 43.257 13.19 46.778 42.291c1.173 36.742.793 73.919-1.947 111.176c-3.985 40.382-19.889 42.844-43.147 45.56c-25.468 2.89-45.853-9.776-49.37-39.645m44.426 16.078c18 1.605 16.36-38.733 15.508-75.157c.138-49.19 2.492-76.704-11.499-76.832c-16.939-.076-16.213 28.064-15.845 75.839c.26 43.792-2.194 74.9 11.836 76.15m119.283-111.815h28.214l-.208-36.502c-1.936-17.363-18.017-30.829-43.333-31.494c-29.158.542-43.948 16.753-44.931 49.49c-.769 29.3 10.893 44.681 35.187 62.725c37.032 28.96 31.626 60.573 11.19 61.943c-16.119-1.195-15.998-20.489-16.976-42.906l-29.97-.65l.52 44.395c1.446 13.407 25.894 29.78 52.792 29.868c23.783-1.155 43.187-24.988 42.41-50.758c-2.096-18.641.202-43.845-36.586-70.9c-40.51-22.821-30.896-53.013-15.447-54.034c18.471 1.194 17.575 14.56 17.138 38.823m117.094-113.746L270.3 406.116l-12.627-.326l83.213-299.906zm26.468 114.708l-32.885 2.411l-.885-31.803c.805-26.346 25.803-45.889 51.871-44.719c29.524 2.087 40.76 14.207 44.509 37.607c3.02 22.841-9.011 47.673-34.589 75c-21.124 23.737-29.587 42.426-32.878 60.43l59.615-1.238l-1.317 35.411l-90.694 2.03l-.128-41.169c.598-15.352 12.361-39.822 32.25-62.701c33.286-34.295 44.853-69.991 19.447-71.29c-11.47 1.138-17.374 9.578-14.312 40.03M127.711 477.548c-170.281-98.17-170.281-344.925 0-443.094S512 59.662 512 256S297.993 575.716 127.711 477.547m6.463-11.161c-161.703-93.224-161.703-327.548 0-420.772S499.104 69.553 499.104 256s-203.227 303.61-364.93 210.386" clip-rule="evenodd"></svg:path>`,
})
export class FileIconsOs2Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOwlIcon],svg[file-icons-owl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOxIcon],svg[file-icons-ox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsOxygeneIcon],svg[file-icons-oxygene-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPapyrusIcon],svg[file-icons-papyrus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsParrotIcon],svg[file-icons-parrot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M39.755 140.93C33.007 72.327 59.163 31.293 96 12.874c18.067-9.033 47.043-16.543 94.747-10.953c84.912 9.95 165.708 124.871 183.6 291.841c-45.32 10.125-55.001 54.48-85.857 116.191c-31.352 62.706-80.593 97.942-116.634 101.75c-40.087 4.663-100.954-46.217-120.926-108.986c-9.093-28.58-.047-64.214 9.033-82.463c30.91 9.034 69.428 7.806 93.68-12.165c8.559-80.839-11.413-159.3-113.888-167.16m134.056-69.588c-14.273 0-25.844 11.722-25.844 26.183s11.57 26.184 25.844 26.184s25.845-11.723 25.845-26.184s-11.571-26.183-25.845-26.183m0 8.473c-9.874 0-17.879 7.93-17.879 17.71s8.005 17.71 17.88 17.71s17.879-7.929 17.879-17.71s-8.005-17.71-17.88-17.71"></svg:path><svg:path fill="currentColor" d="M36.114 149.04C6.004 160.415-10.724 256.1 7.677 317.658c.332.813.954 1.48 1.672 1.004c30.11-19.07 26.682-98.779 98.361-88.993c-16.477 33.373-33.913 56.515-65.156 65.992c-3.307.94-2.056 4.406-1.37 5.313c16.115 21.307 82.899 23.625 106.004 1.964c3.648-74.407-10.354-149.951-111.074-153.898"></svg:path>`,
})
export class FileIconsParrotIcon {
  readonly viewBox = input("0 0 375 512")
  readonly width = input("0.74em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPascalIcon],svg[file-icons-pascal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPatchIcon],svg[file-icons-patch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPegjsIcon],svg[file-icons-pegjs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPerl6Icon],svg[file-icons-perl6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M244.397 223.134c-.495-6.572.018-13.464.514-20.13c.933-12.522 1.814-24.35-3.262-34.635a3 3 0 0 1-.074-.161l-4.784-11.392l-4.051 6.817l2.961.58l-1.122 5.729l-7.024-1.376a2.92 2.92 0 0 1-1.948-4.356l9.125-15.353a2.918 2.918 0 0 1 5.2.361l6.99 16.65c5.737 11.692 4.758 24.847 3.81 37.57c-.502 6.748-.977 13.121-.515 19.257zm25.705-20.189c-.953-12.501-1.852-24.31 3.215-34.576q.038-.08.074-.161l4.783-11.392l4.051 6.817l-2.962.58l1.123 5.729l7.025-1.376a2.92 2.92 0 0 0 1.947-4.356l-9.125-15.353a2.918 2.918 0 0 0-5.2.361l-6.99 16.65c-5.73 11.678-4.73 24.815-3.761 37.52c.515 6.766 1.002 13.156.538 19.307l5.82.44c.498-6.593-.03-13.505-.538-20.19m-69.092 37.052c-9.27 0-16.802 7.532-16.802 16.802S191.74 273.6 201.01 273.6s16.73-7.532 16.73-16.802s-7.46-16.802-16.73-16.802m111.24-1.738c-9.343 0-16.802 7.46-16.802 16.73c0 9.197 7.46 16.729 16.802 16.729c9.27 0 16.73-7.532 16.73-16.73c0-9.27-7.46-16.73-16.73-16.73m-57.877 160.146L242.855 379.3v-20.958h-5v21.654c0 .455.124.901.359 1.291l11.877 19.699zm26.435.073l-11.519-19.103v-21.031h-5v21.726c0 .455.123.902.358 1.291l11.877 19.7zm182.534-138.121c-16.752 12.27-35.425 19.663-54.051 22.381a101.4 101.4 0 0 1 14.726 8.978c40.049 29.33 51.42 82.126 25.275 117.758c-26.144 35.703-79.809 40.773-119.93 11.442c-23.756-17.44-37.42-43.085-39.151-68.5c-9.987 3.35-20.958 5.203-32.475 5.203c-10.545 0-20.63-1.556-29.924-4.39c-2.18 24.909-15.782 49.848-39.094 66.89c-40.122 29.404-93.786 24.334-119.93-11.37c-26.072-35.631-14.702-88.354 25.42-117.685a100.6 100.6 0 0 1 19.469-11.207c-22.077-1.207-44.725-8.952-64.66-23.556c-49.9-36.5-64.022-102.114-31.577-146.437c32.518-44.322 99.218-50.622 149.117-14.05c43.342 31.705 59.684 85.317 41.923 127.905a33.5 33.5 0 0 1 12.847 6.414c11.009-4.251 23.357-6.639 36.41-6.639c11.997 0 23.396 2.025 33.712 5.653a33.5 33.5 0 0 1 11.778-5.479c-14.854-41.564 1.716-92.339 43.298-122.856c49.537-36.284 115.875-29.983 148.103 14.05c32.3 44.104 18.25 109.212-31.286 145.495m-291.188 14.177a33.5 33.5 0 0 1-3.38-6.696a95 95 0 0 1-9.35 4.492a84 84 0 0 1 12.73 2.204m53.854-17.735c0-13.842-11.138-25.088-24.98-25.088s-25.089 11.246-25.089 25.088s11.247 25.088 25.089 25.088s24.98-11.246 24.98-25.088m61.961 55.793v-1.55h-7.493s-.31.831.092 2.78c1.407 6.239.32 10.546-3.324 13.166c-7.028 5.055-23.385 3.298-35.005-3.757c-3.209-1.949-10.572-7.175-9.639-13.606l-7.415-1.076c-1.11 7.647 3.689 15.333 13.165 21.087c6.398 3.885 14.488 6.608 22.198 7.471c1.756.197 3.465.294 5.115.294c6.453 0 12.004-1.488 15.955-4.33c4.256-3.06 8.78-9.09 6.351-20.48m49.279-57.604a24.92 24.92 0 0 0-24.98-24.98c-13.95 0-25.089 11.139-25.089 24.98c0 13.734 11.139 24.98 25.089 24.98c13.841 0 24.98-11.246 24.98-24.98m12.243 19.454a92 92 0 0 1-7.802-4.152a33.5 33.5 0 0 1-2.454 4.401q.36 1.184.669 2.382a81 81 0 0 1 9.587-2.63"></svg:path>`,
})
export class FileIconsPerl6Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPhalconIcon],svg[file-icons-phalcon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPhoenixIcon],svg[file-icons-phoenix-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPhotorecIcon],svg[file-icons-photorec-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M127.711 477.547c-170.281-98.17-170.281-344.925 0-443.094S512 59.662 512 256S297.993 575.716 127.711 477.547M462.954 256c0-158.723-173.007-258.463-310.664-179.102s-137.658 278.842 0 358.203S462.954 414.722 462.954 256m-72.926 125.707l-49.843-45.427l3.882-4.253l49.843 45.426zm-271.379-3.63l-3.752-4.365l51.16-43.93l3.752 4.366zm282.812-9.795l-53.968-40.436l3.455-4.613l53.967 40.436zm-294.821-5.226l-3.274-4.738l55.472-38.349l3.275 4.738zm304.914-9.233l-57.59-35.08l2.993-4.918l57.59 35.08zm-315.283-6.971l-2.763-5.053l59.175-32.334l2.762 5.053zm323.942-8.389l-60.69-29.397l2.509-5.188l60.69 29.398zm-332.567-8.8l-2.217-5.322l62.232-25.97l2.217 5.322zm339.713-7.32L364.13 298.9l2.003-5.401l63.229 23.444zm-346.49-10.678l-1.649-5.525l64.604-19.326l1.649 5.525zm352.06-6.048l-65.181-17.279l1.474-5.57l65.18 17.279zM76.01 293.047l-1.063-5.66l66.272-12.467l1.064 5.66zm360.863-4.619L370.33 277.48l.934-5.683l66.543 10.949zM73.124 274.031l-.467-5.74l67.212-5.468l.467 5.739zm366.022-3.084l-67.28-4.523l.383-5.75l67.28 4.523zm-299.49-14.543L72.24 254.82l.135-5.762l67.414 1.584zm232.677-1.134l-.168-5.762l67.403-1.946l.168 5.761zm-232.081-11.03l-66.88-8.623l.737-5.716l66.88 8.622zm231.361-1.126l-.765-5.71l66.835-8.983l.765 5.71zm-229.496-10.912l-65.611-15.565l1.327-5.604l65.611 15.565zm227.521-1.103l-1.361-5.598l65.524-15.92l1.361 5.599zm-224.41-10.67L81.6 198.089l1.908-5.434l63.627 22.339zm221.18-1.072l-1.935-5.424l63.504-22.682l1.936 5.424zm-216.856-10.313L88.61 180.178l2.464-5.204l60.941 28.866zm212.423-1.027l-2.498-5.193l60.787-29.195l2.498 5.194zm-206.932-9.84L97.453 163.1l2.998-4.923l57.59 35.077zm201.34-.973l-3.027-4.906l57.4-35.39l3.026 4.906zM161.64 187.94l-53.607-40.906l3.493-4.58l53.608 40.906zm188.042-.906l-3.522-4.563l53.388-41.196l3.522 4.563zm-180.41-8.583l-49.039-46.287l3.955-4.192l49.04 46.288zm156.155-15.796l-4.704-3.33l39.013-55.006l4.704 3.33zm-10.139-6.746l-5.018-2.824l33.043-58.778l5.019 2.825zm-111.827 9.36c-69.736 40.204-69.736 141.258 0 181.462s157.38-10.324 157.38-90.731s-87.644-130.935-157.38-90.731m41.806 109.267c-14.247-8.213-14.247-28.859 0-37.072s32.151 2.11 32.151 18.536s-17.905 26.75-32.151 18.536m38.414-32.828c-24.434-14.087-24.434-49.496 0-63.583s55.145 3.618 55.145 31.792s-30.71 45.878-55.145 31.791"></svg:path>`,
})
export class FileIconsPhotorecIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPhpIcon],svg[file-icons-php-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPhraseappIcon],svg[file-icons-phraseapp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPickleIcon],svg[file-icons-pickle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPikeIcon],svg[file-icons-pike-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPipenvIcon],svg[file-icons-pipenv-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M306.631 25.031L256 0l-50.062 25.031c-75.805-56.557-161.85-9.15-137.671 68.836L0 128v256l256 128l256-128V128l-68.267-34.133c24.711-75.911-59.652-125.805-137.102-68.836m77.938 155.307l-83.058-41.53h77.369c17.067 0 34.133-6.257 46.649-18.204l39.253 19.912zM209.35 59.164c11.947 15.36 21.618 32.996 31.858 49.494l-65.422-32.996zm93.298 0l33.564 17.067l-65.422 32.427c10.24-16.498 19.911-34.134 31.858-49.494m101.831 50.632c-7.396 5.12-16.498 7.395-25.6 7.395h-77.938l59.165-29.582zM151.893 87.609l58.596 29.582H133.12c-9.102 0-17.636-2.844-25.6-7.395zm-18.773 51.2h77.369l-83.058 41.529l-80.213-39.822l39.253-19.912c13.085 11.947 29.582 18.205 46.649 18.205m112.071 124.018V471.04L138.24 417.564V209.351zm21.618 0L373.76 209.35v208.213L266.809 471.04zM256 244.053l-104.676-52.337l76.232-37.547l-13.654 34.133l19.911 7.965L256 141.084l22.187 55.183l19.91-7.965l-13.653-34.133l76.232 38.115zM327.68 35.84c59.382-34.726 109.362-1.298 96.711 48.356zm-44.373 13.653C273.636 63.147 265.102 77.938 256 92.16c-9.102-14.222-17.636-29.013-27.307-42.667L256 35.84zM87.04 84.764C75.061 26.26 132.839 4.171 183.751 36.41zm-55.182 71.68l85.333 42.667v207.645l-85.333-42.667zm362.95 250.312V199.11l85.334-42.667V364.09z"></svg:path>`,
})
export class FileIconsPipenvIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPlatformioIcon],svg[file-icons-platformio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPodIcon],svg[file-icons-pod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPointwiseIcon],svg[file-icons-pointwise-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M146.704 143.907a43 43 0 0 1-3.392-2.688c7.597-6.288 14.088-10.968 18.875-14.18c-3.98 4.016-9.305 9.654-15.483 16.868m54.686 97.377a176 176 0 0 1-15.953.746c-4.359 0-8.678-.183-12.953-.518c-2.152 21.542-3.637 43.992-4.027 66.582c13.128 1.272 26.826 1.224 40.958-.122a1298 1298 0 0 1-5.397-41.534c-.98-8.624-1.852-17.027-2.628-25.154M169.475 65.707a103 103 0 0 0-4.103 2.376a1483 1483 0 0 1 9.92 3.928c-1.66-2.12-3.634-4.227-5.817-6.304m36.29 64.219c.024 3.021.131 11.347.574 23.785a115 115 0 0 0 12.642-3.002l-7.445-22.16a71 71 0 0 1-5.771 1.377m-41.65 22.21c6.699-12.24 11.744-20.375 13.545-23.216a43 43 0 0 1-1.569-.522c-2.18 2.01-9.719 9.159-19.872 20.878a65 65 0 0 0 6.924 2.584c.32.099.65.182.973.276m-27.72-19.067a266 266 0 0 1 7.994-6.382a140 140 0 0 0-8.846 4.94c.269.488.558.966.852 1.442m85.149-8.145l7.485 22.278c3.149-1.263 6.2-2.651 9.145-4.156c-7.036-10.1-11.972-16.833-13.895-19.427q-1.341.676-2.735 1.305m28.84-59.974a340 340 0 0 1 10.324-3.557a51 51 0 0 0-1.76-1.034a492 492 0 0 0-8.565 4.59m8.525 8.33c3.942-.36 8.541-.738 13.694-1.096a36 36 0 0 0-2.114-2.652a353 353 0 0 0-11.58 3.747m-4.683 11.136a612 612 0 0 1 24.22 2.117a32 32 0 0 0-.867-4.019a626 626 0 0 0-23.353 1.902M149.4 80.346c5.544 1.017 16.383.698 16.383.698s-6.413-3.885-10.863-5.606a84 84 0 0 0-5.52 4.908m71.388-20.503a453 453 0 0 1 8.96-7.655a93 93 0 0 0-3.913-.209a989 989 0 0 0-5.047 7.864m-9.703 169.523c10.46-1.6 21.09-4.182 31.709-7.78l-20.42-60.779a125 125 0 0 1-15.61 3.622a1473 1473 0 0 0 4.32 64.937m-43.907-32.19a1154 1154 0 0 1 5.12-32.34a92 92 0 0 1-2.692-.454c-8.245 15.596-18.293 36.347-27.695 60.436c6.689 2.175 13.758 3.817 21.115 4.913a1051 1051 0 0 1 4.152-32.556M403.9 302.91c-10.89-18.717-23.049-36.441-35.423-52.724c-10.7 10.272-22.814 19.6-36.205 27.889c9.818 19.034 19.67 39.514 28.849 60.828a253.6 253.6 0 0 0 42.78-35.993m24.577-30.073a246 246 0 0 0 10.665-16.77c-12.433-15.167-26.206-29.365-40.929-42.646q-1.915 3.137-3.97 6.205c-5.379 8.027-11.464 15.664-18.2 22.888c13.43 17.537 25.271 34.94 35.432 52.082a253 253 0 0 0 17.002-21.76m-66.548-31.112a669 669 0 0 0-23.169-27.803a764 764 0 0 0-21.884-23.823c-7.176 6.688-15.048 12.891-23.52 18.517a1267 1267 0 0 1 14.718 25.014a1166 1166 0 0 1 19.26 34.99c12.833-8.003 24.412-16.999 34.595-26.895m-1.457-129.382a101 101 0 0 1-2.828 13.84q2.1.903 4.211 1.838c17.173 7.617 33.256 16.107 48.188 25.403a154 154 0 0 0 2.493-23.117c-15.416-6.646-32.198-12.49-50.347-17.504c-.57-.157-1.147-.305-1.717-.46m-11.96-57.074a84.3 84.3 0 0 1 6.542 12.842c.486 1.2.933 2.41 1.363 3.624c17.349 1.147 33.359 3.109 48.02 5.869c-2.568-7.177-5.707-14.004-9.37-20.355c-15.724-2.351-31.46-2.78-46.555-1.98m59.525 34.014c-16.232-3.39-32.872-5.451-48.575-6.641a86.7 86.7 0 0 1 1.79 18.975c17.01 4.533 34.321 10.181 51.21 17.201a142.4 142.4 0 0 0-4.425-29.535M318.173 274.04a1169 1169 0 0 0-19.26-34.993a1265 1265 0 0 0-14.58-24.787a204 204 0 0 1-26.79 13.205c-.455.184-.912.355-1.368.536l21.61 64.318c14.448-5.162 27.941-11.286 40.388-18.279M133.1 105.715a146 146 0 0 1 9.54-3.158a142 142 0 0 0-8.884 1.07a43 43 0 0 0-.656 2.088m-1.103 15.627c8.227-4.822 16.144-8.479 23.742-10.97c-7.493 1.304-15.628 3.847-24.122 7.295c.059 1.236.183 2.462.38 3.675m27.005 40.352c-3.502-1.133-6.8-2.46-9.875-3.976a384 384 0 0 0-36.048 52.686c5.712 4.147 12.04 7.71 18.875 10.659c9.127-23.392 18.862-43.716 27.048-59.37M139.5 92.177q5.902-.602 11.36-.674c-3.16-.643-6.41-1.2-9.731-1.678a63 63 0 0 0-1.63 2.352m106.682 139.498c-11.312 3.836-22.75 6.626-34.116 8.331c1.984 20.683 4.592 43.224 8.02 66.711c15.46-2.154 31.386-5.821 47.613-11zm-22.93 152.648c-4.949-22.546-8.978-44.779-12.249-65.822c-7.813.763-15.511 1.158-23.064 1.158a213 213 0 0 1-19.584-.89c-.032 21.377.981 42.768 3.396 63.53c17.334 2.526 34.634 3.058 51.501 2.024m55.008-287.162a611 611 0 0 0-24.448-2.11a441 441 0 0 1 23.87 4.903a39 39 0 0 0 .578-2.793M88.866 182.368a335 335 0 0 1 11.11-13.508c9.975-11.483 19.595-21.002 28.269-28.763a44 44 0 0 1-1.644-2.65c-14.03 9.724-28.1 22.195-41.565 35.825c.435 1.27.897 2.533 1.404 3.782a73 73 0 0 0 2.426 5.314M336.773 81.447c-17.628-.54-34.233-.197-48.362.47c.431 1.943.73 3.906.889 5.884c18.615 2.338 39.558 5.845 61.276 11.102c-.094-5.736-.807-11.413-2.189-16.969a520 520 0 0 0-11.614-.487M403.6 203.942c14.69 13.116 28.499 27.125 41.06 42.083c6.628-12.788 11.91-25.89 15.771-39.102c-2.64-2.693-5.324-5.359-8.107-7.967c-10.741-10.07-22.566-19.513-35.382-28.307a171.8 171.8 0 0 1-13.342 33.293m16.061-44.308c14.486 9.692 27.793 20.183 39.812 31.437c1.379 1.29 2.714 2.606 4.06 3.917c1.854-8.2 3.177-16.414 3.906-24.597c.248-2.794.416-5.569.53-8.33c-13.185-10.035-28.193-19.052-44.991-27.03a165 165 0 0 1-3.317 24.603M81.131 144.88a77.5 77.5 0 0 0 .878 16.305c14.144-13.894 27.635-25.173 40.432-33.806a43 43 0 0 1-1.09-5.203c-13.19 6.21-26.928 14.168-40.22 22.704m48.422 166.2a166 166 0 0 1-11.813-4.236c-3.854 19.859-6.045 39.109-6.517 57.588a206 206 0 0 0 12.035 5.154c12.368 4.822 24.915 8.377 37.49 10.837a478 478 0 0 1-1.24-12.86c-1.31-15.866-1.92-32.58-1.852-50.067c-9.696-1.43-19.08-3.566-28.103-6.416m18.094-73.556a137 137 0 0 1-9.513-2.741a517 517 0 0 0-5.97 17.132c-4.945 15.047-9.023 29.844-12.234 44.337a155 155 0 0 0 12.829 4.68c8.038 2.54 16.396 4.469 25.025 5.812c.41-21.083 1.787-43.251 4.118-66.412a147 147 0 0 1-14.255-2.808m-141.991-36.4A248.6 248.6 0 0 0 0 241.417c1.7 4.148 3.46 8.23 5.301 12.217c7.379-10.449 16.394-22.741 26.543-35.65a140.2 140.2 0 0 1-6.74-32.73a812 812 0 0 0-19.448 15.868m100.633 227.672a264.5 264.5 0 0 1-37.053-19.98a341 341 0 0 0 3.056 23.198a256 256 0 0 0 24.723 21.958a239 239 0 0 0 18.783 7.522a235 235 0 0 1-9.509-32.698m220.6 43.098c-20.26 6.55-41.343 11.25-62.781 14.02a470 470 0 0 0 9.069 21.736c21.427-1.415 42.129-5.423 61.792-11.709zM24.618 172.015c.09-8.154.893-16.325 2.428-24.413c.327-1.725.694-3.44 1.084-5.148c-.567.297-1.112.585-1.645.867a248.3 248.3 0 0 0-16.13 40.047c4.176-3.4 8.964-7.23 14.263-11.353m16.088 154.182a227 227 0 0 1-7.858-8.86c-3.48 11.986-6.579 24.65-9.213 37.988c9.62 11.38 20.954 22.16 33.567 31.959a333 333 0 0 1 1.582-43.886a219 219 0 0 1-18.078-17.201m457.84-151.122c-5.707-16.608-13.137-32.431-22.055-47.285a169 169 0 0 1 2.242 29.243c6.984 5.58 13.613 11.587 19.813 18.042m-451.333 74.76a140 140 0 0 1-4.797-7.922a139 139 0 0 1-6.092-12.283a885 885 0 0 0-25.685 34.976c5.519 10.714 11.598 20.76 18.202 30.13c5.577-16.277 11.794-31.23 18.372-44.9m413.366-142.723c-12.34-6.508-26.344-11.434-40.966-15.152a153 153 0 0 1 2.97 18.935c.39 4.198.6 8.41.655 12.622c15.636 7.149 30.755 15.562 44.758 25.46c-.543-14.523-3.018-28.522-7.417-41.865m-151.133 75.33a856 856 0 0 0-45.976-43.41a103 103 0 0 1-10.015 7.435a1338 1338 0 0 1 34.35 53.037c7.854-5.25 15.088-10.977 21.64-17.063m-38.211-50.75A868 868 0 0 1 317 174.95a147 147 0 0 0 11.757-14.117c-18.048-11.627-36.527-22.278-54.937-32.02a85 85 0 0 1-2.587 2.88m9.032-11.52c18.23 9.693 36.53 20.272 54.427 31.81c3.966-6.46 7.241-13.08 9.766-19.77c-21.934-8.863-42.681-15.167-60.015-19.579c-1.182 2.533-2.585 5.048-4.178 7.54M232.42 157.3l20.36 60.602c.254-.101.508-.195.762-.298a193 193 0 0 0 25.249-12.441a1325 1325 0 0 0-34.531-53.29a121 121 0 0 1-11.84 5.427m55.62-54.803c17.269 4.44 37.793 10.732 59.662 19.543a90 90 0 0 0 2.34-12.404c-19.529-4.836-39.975-8.596-61.185-11.251c-.214 1.37-.48 2.74-.817 4.112m-14.78 12.722a56 56 0 0 0 3.032-5.158a442 442 0 0 0-22.477-4.585a926 926 0 0 1 19.446 9.743m134.335 49.247c-15.317-9.77-31.935-18.662-49.781-26.594a417 417 0 0 0-3.522-1.543c-2.76 7.206-6.329 14.397-10.708 21.495c17.903 11.961 35.314 24.91 51.752 38.919a160.7 160.7 0 0 0 12.26-32.277m-302.843 39.062c11.964-20.86 24.385-38.1 35.132-51.41a53 53 0 0 1-4.7-3.9c-8.462 7.566-17.852 16.852-27.534 28.035a326 326 0 0 0-12.893 15.902c2.93 4.096 6.285 7.884 9.995 11.373m142.669-65.82a93 93 0 0 0 7.893-5.722c-11.657-9.935-18.896-15.491-19.086-15.636c0 0-1.366.576-2.85 1.676c2.328 3.157 7.265 9.936 14.043 19.683M99.428 213.144a89 89 0 0 1-11.268-12.015c-9.616 13.53-19.44 29.418-28.663 47.828a133 133 0 0 0 16.091 18.538c6.357-18.466 14.329-36.629 23.84-54.351M243.87 54.455a512 512 0 0 0-7.6 6.197a451 451 0 0 1 9.876-5.579a72 72 0 0 0-2.276-.618M43.89 220.005a129 129 0 0 0 7.81 16.71c.363.647.737 1.285 1.11 1.925c9.403-18.046 19.333-33.635 29.003-46.921a84 84 0 0 1-4.943-9.975c-11.73 12.48-22.873 25.607-32.98 38.261m280.541-37.4a774 774 0 0 1 22.189 24.142a695 695 0 0 1 22.792 27.256c5.89-6.438 11.237-13.21 15.988-20.3a164 164 0 0 0 4.687-7.434c-16.59-14.271-34.24-27.445-52.426-39.595a157 157 0 0 1-13.23 15.931m179.47 15.026c-7.406-9.753-16.01-18.868-25.787-27.335c-.029.347-.046.692-.077 1.04c-.973 10.922-2.922 21.818-5.72 32.59c9.387 10.018 17.861 20.566 25.382 31.628c3.215-12.576 5.291-25.303 6.202-37.923M281.495 66.366a44 44 0 0 1 3.096 5.088c15.073-.785 33.2-1.235 52.508-.645c2.583.08 5.132.18 7.663.291a73.5 73.5 0 0 0-8.486-14.911c-20.455 1.982-39.306 5.986-54.781 10.177M145.582 35.933a203 203 0 0 1 23.196-11.982l-1.754-4.703a257 257 0 0 0-28.989 12.616a263 263 0 0 1 7.547 4.069M257.61 7.526c9.035.622 17.864 1.99 26.375 4.116c.794.199 1.579.41 2.363.62a194 194 0 0 1 10.337-5.357a261.5 261.5 0 0 0-35.462-3.145c-1.08 1.003-2.29 2.268-3.613 3.766m-37.126 1.5c7.962-1.154 15.884-1.784 23.698-1.876c.907-1.15 1.79-2.235 2.662-3.289c-8.572.29-17.037.99-25.375 2.09c-.322.996-.648 2.014-.985 3.075M3.84 274.491a798 798 0 0 0-3.18 4.733c2.07 22.291 7.071 43.747 14.645 63.98c2.777-12.606 5.946-24.623 9.461-36.002c-7.618-10.105-14.602-21.02-20.926-32.71m85.3-209.127a170 170 0 0 0-14.355 13.4a301 301 0 0 1 23.307-1.709a163 163 0 0 1 15.63-17.027c-2.465-.9-4.868-1.775-7.2-2.624l-5.934-2.163a257 257 0 0 0-11.946 9.524zm33.66-13.348a185 185 0 0 1 12.604-9.523a252 252 0 0 0-8.743-4.453a257 257 0 0 0-15.554 9.707q5.602 2.039 11.693 4.27M57.908 401.085a250 250 0 0 1-25.052-20.701a253 253 0 0 0 26.694 37.771a348 348 0 0 1-1.642-17.07M469.72 300.418c-6.969-12.305-14.828-24.076-23.435-35.33c-8.346 13.837-18.131 27.032-29.168 39.308a421 421 0 0 1 2.613 4.727c6.194 11.436 11.59 22.744 16.235 33.912c12.974-13.23 24.238-27.444 33.755-42.617m8.334-14.33a225.7 225.7 0 0 0 15.735-37.027c-7.28-11.619-15.6-22.692-24.95-33.177c-4.32 13.394-9.969 26.527-16.828 39.2c8.717 11.099 16.746 22.696 23.938 34.82c.71-1.267 1.42-2.535 2.105-3.816M300.45 16.896c5.469 2.154 10.634 4.632 15.463 7.424c8.219-2.619 16.547-4.831 24.761-6.432a257 257 0 0 0-25.016-7.253c-4.9 1.588-10.012 3.726-15.208 6.261m108.938 295.736c-13.22 13.503-27.995 25.73-44.053 36.256c5.257 12.659 10.245 25.565 14.815 38.601c17.628-11.06 33.487-23.193 47.547-36.37c-5.28-13.14-11.482-26.01-18.31-38.487M327.38 32.023c5.079 3.942 9.654 8.3 13.682 13.045c14.613-1.101 30.285-1.184 46.257.497c-.351-.462-.691-.937-1.05-1.392a99.5 99.5 0 0 0-9.855-10.81a257 257 0 0 0-15.265-7.42c-10.758.577-22.253 2.832-33.77 6.08m89.111 48.094c11.722 2.709 22.451 6.001 32.213 9.848a256 256 0 0 0-27.944-27.002a179 179 0 0 0-12.33-3.226a141 141 0 0 1 8.061 20.38m-237.855-60.19c9.939-3.763 20.008-6.708 30.07-8.816c.357-1.149.705-2.26 1.05-3.352a258 258 0 0 0-32.649 8.069zm308.803 271.184a245 245 0 0 1-5.406 9.559a285 285 0 0 1 10.59 21.804c6.649-12.475 12.713-25.975 18.039-40.58c.019-.184.034-.37.053-.553a237 237 0 0 0-9.838-20.217a236 236 0 0 1-13.438 29.987M190.277 487.754c-19.153-1.523-37.596-4.597-55-9.118a257 257 0 0 0 63.06 23.234a196 196 0 0 1-8.06-14.116m320.117-260.021a233 233 0 0 1-5.013 19.88a250 250 0 0 1 6.576 11.703c.015-1.117.043-2.23.043-3.35c0-9.546-.557-18.963-1.606-28.233M253.197 487.157a358 358 0 0 1-34.889 1.728q-6.644 0-13.285-.25c-.751-.028-1.493-.078-2.242-.11a174 174 0 0 0 10.256 16.2a262 262 0 0 0 42.746 3.516c2.009 0 4.01-.03 6.007-.075a494 494 0 0 1-8.593-21.009m189.927-82.66c-15.388 14.34-31.4 26.125-47.194 35.802a440 440 0 0 1 5.045 23.534a256.5 256.5 0 0 0 44.594-38.387a204 204 0 0 0-2.445-20.948m47.557-57.468c-11.728 18.566-24.733 34.634-38.39 48.542a230 230 0 0 1 2.963 18.711c15.213-18.559 27.81-39.28 37.237-61.627a259 259 0 0 0-1.81-5.626m-194.22 34.298c-19.26 6.15-39.215 10.405-59.279 12.541c-.278.03-.555.05-.833.078c3.455 14.853 7.3 29.646 11.58 44.175c19.619-2.683 40.43-7.757 62.247-15.974zm189.53-47.058a270 270 0 0 0-10.512-23.162c-10.01 15.087-21.812 29.332-35.283 42.61c3.716 9.923 6.801 19.722 9.26 29.383c13.093-14.017 25.476-30.183 36.534-48.831M323.5 461.807l-9.939-29.58c-21.856 8.203-42.754 13.385-62.505 16.213a602 602 0 0 0 9.193 27.232c21.608-2.631 42.86-7.28 63.25-13.865m-74.122 15.035a625 625 0 0 1-9.036-27.088a269 269 0 0 1-27.638 1.45c-9.239 0-18.13-.506-26.69-1.377c3.183 9.657 6.866 18.938 11.095 27.755q4.145.262 8.313.42c14.666.548 29.37.152 43.956-1.16m182.358-115.107a299 299 0 0 1-4.35 3.886c-13.2 11.548-27.826 22.272-43.744 32.137c3.494 10.535 6.696 21.127 9.528 31.716c15.967-10.039 32.109-22.336 47.494-37.38c-2.321-10.217-5.338-20.355-8.928-30.36m-45.41 84.216c-14.05 7.926-27.782 14.233-40.586 19.243a329 329 0 0 1-8.775 3.276l8.073 24.028a257 257 0 0 0 46.268-22.419c-1.283-7.35-2.915-15.39-4.98-24.128m-44.465 9.333c13.152-5.147 27.32-11.713 41.792-20.072c-2.566-9.825-5.658-20.43-9.378-31.822c-15.542 9.016-32.235 17.244-50.005 24.627c-.265.11-.526.208-.79.317l10.098 30.055c2.78-1 5.542-2.032 8.283-3.105m-168.259-224.37c3.854.291 7.767.448 11.735.448c4.952 0 9.988-.24 15.077-.701a1473 1473 0 0 1-4.282-64.938a112 112 0 0 1-8.235.312c-1.671 0-3.327-.053-4.975-.13a1125 1125 0 0 0-5.21 32.782a1023 1023 0 0 0-4.11 32.228M103.415 87.638c-2.172 2.945-4.236 5.942-6.138 9.008a127 127 0 0 0-3.44 5.9c11.57-3.789 22.367-6.61 32.365-8.456a65 65 0 0 1 3.042-5.612c-8.419-.715-17.117-.98-25.829-.84m88.808-31.256l2.144 5.752q.89-3.464 1.77-6.815q-1.954.495-3.914 1.063m-2.722 74.64a1272 1272 0 0 0-4.694 24.315a99 99 0 0 0 10.906-.257c-.416-11.8-.543-20.114-.581-23.972c-1.913.057-3.794.03-5.631-.086M156.05 42.18c5.698 3.614 10.74 7.208 15.085 10.774q3.566-1.665 7.29-3.119l-5.923-15.89a193 193 0 0 0-16.452 8.235m-43.928 34.736c8.274.122 16.5.61 24.465 1.528a88 88 0 0 1 7.074-7.314a2223 2223 0 0 0-18.675-6.973c-4.578 4.062-8.885 8.315-12.864 12.759M134.5 56.329c5.982 2.22 12.233 4.568 18.718 7.049a109 109 0 0 1 7.586-4.963c-4.73-3.574-9.886-6.961-15.019-10.044a178 178 0 0 0-11.285 7.958m45.14 4.485q2.955 3.12 5.189 6.2l-2.687-7.209c-.84.33-1.676.662-2.503 1.009M320.186 418.19c18.16-7.544 35.04-15.903 50.643-25.044c-4.162-12.04-9.005-24.89-14.632-38.556c-3.345 2-6.723 3.95-10.165 5.801c-12.598 6.773-25.836 12.638-39.487 17.535l13.541 40.305zM188.494 46.376c3.58-1.061 7.17-1.952 10.756-2.68c2.053-7.515 4.04-14.5 5.918-20.87a193 193 0 0 0-22.818 7.067zm44.043-4.585c2.9.284 5.75.701 8.543 1.235c9.18-7.203 20.295-15.396 32.02-22.853c-7.703-1.417-15.651-2.192-23.748-2.355c-5.183 6.9-11.029 15.306-16.815 23.973m37.366 13.007a54 54 0 0 1 3.455 2.714a368 368 0 0 1 26.051-6.472a330 330 0 0 1 28.277-4.67c-3.921-3.792-8.293-7.257-13.087-10.362c-16.064 5.461-31.628 12.364-44.696 18.79m-59.11-12.872c3.12-.325 6.221-.533 9.289-.6c4.93-7.51 10.463-15.7 15.877-23.218a174 174 0 0 0-18.962 2.244a1043 1043 0 0 0-6.205 21.574m-5.886 22.083c.26-.036.522-.076.782-.11a1039 1039 0 0 1 7.228-11.495c-1.7.161-3.41.357-5.133.604c-.948 3.56-1.909 7.23-2.877 11.001m49.123-17.464c1.6.582 3.14 1.22 4.645 1.888c12.242-6.262 27.307-13.306 43.351-19.298a114.5 114.5 0 0 0-14.285-5.406c-11.876 6.931-23.625 15.18-33.71 22.816m-69.123 430.02c-3.94-8.831-7.456-18.229-10.549-28.18a265.3 265.3 0 0 1-56.005-14.644a220 220 0 0 0 10.567 32.01c17.595 5.2 36.496 8.857 55.987 10.813m-62.772-228.22a527 527 0 0 1 6.038-17.307c-7.367-3.13-14.149-6.872-20.27-11.184c-9.55 18.015-17.448 36.49-23.643 55.262c7.866 6.359 16.502 11.927 25.789 16.6c3.226-14.204 7.249-28.675 12.086-43.37m48.962 188.757c-3.806-14.198-6.81-29.429-9.002-45.663c-14.838-2.667-29.153-6.655-42.703-11.938a218 218 0 0 1-8.213-3.419c.22 15.63 1.703 30.695 4.45 45.137a255 255 0 0 0 55.468 15.883m66.118 2.263c-4.307-14.75-8.15-29.676-11.59-44.53c-5.978.388-11.934.606-17.844.606c-11.733 0-23.308-.762-34.624-2.272c2.238 15.73 5.339 31.022 9.469 45.584c16.791 2.008 35.055 2.475 54.59.612M271.09 305.81c-16.814 5.375-33.344 9.18-49.422 11.427c3.348 21.634 7.399 43.936 12.304 66.216c20.753-2.095 40.698-6.477 59.068-12.31zm69.904 45.207a246 246 0 0 0 11.05-6.341c-8.086-18.915-17.658-39.32-28.943-61.198c-12.944 7.25-26.952 13.59-41.928 18.929l21.951 65.335c13.78-4.924 26.525-10.626 37.87-16.725M37.5 149.584c-.88 4.64-1.469 9.309-1.832 13.984c10.677-8.016 22.69-16.611 35.27-24.84c.653-5.894 1.87-11.839 3.644-17.792c-12.598 5.049-24.215 10.398-33.743 15.072a132 132 0 0 0-3.339 13.576m2.415 58.31a739 739 0 0 1 2.398-2.935c10.537-12.8 20.778-24.357 30.717-34.692a85.6 85.6 0 0 1-2.608-18.328c-12.707 8.58-24.721 17.4-35.112 25.367a129.5 129.5 0 0 0 4.605 30.587m43.052-76.798c12.708-7.811 25.717-14.97 38.277-20.554a48 48 0 0 1 .843-4.745c-11.498 2.517-23.25 6.129-34.555 10.206c-1.965 5.042-3.489 10.083-4.565 15.093m-2.094 154.898a331 331 0 0 0-7.219 29.506a322 322 0 0 0-3.672 23.342a201.3 201.3 0 0 0 30.78 20.354c.75-18.28 3.09-37.242 6.995-56.75c-9.617-4.631-18.618-10.144-26.884-16.452M46.085 121.669a502 502 0 0 1 18.164-8.03a438 438 0 0 1 15.243-6.049c2.435-5.55 5.346-11.082 8.743-16.557q.898-1.444 1.832-2.873c-8.822.548-17.5 1.485-25.74 2.76c-7.473 9.65-13.58 19.95-18.242 30.75m17.174 191.537a342 342 0 0 1 8.71-34.573a145 145 0 0 1-17.674-18.86c-6.386 13.808-12.384 28.902-17.698 45.346a219 219 0 0 0 11.872 13.799a210 210 0 0 0 11.86 11.676a333 333 0 0 1 2.93-17.388m40.658 102.808c-2.318-14.444-3.463-29.443-3.415-44.958a212 212 0 0 1-31.76-19.714a323 323 0 0 0-.544 44.017a255 255 0 0 0 35.72 20.655M261.55 128.017l5.287-4.549v-2.336l-22.53-9.726z"></svg:path>`,
})
export class FileIconsPointwiseIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPonyIcon],svg[file-icons-pony-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPostcssIcon],svg[file-icons-postcss-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPostscriptIcon],svg[file-icons-postscript-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M295.354 26.55c14.07 3.831 21.733 7.023 30.034 13.432l-169.37 197.49c46.017 30.033 94.604 105.47 68.402 166.815c12.76-83.1-72.873-145.107-123.56-153.383zM159.848 483.533c31.971 1.3 63.285 1.917 95.871 1.917c70.97 0 139.339-3.194 203.26-9.58c22.987-1.916 42.187-20.455 45.359-44.104c5.13-42.804 7.662-87.548 7.662-133.568s-2.532-90.785-7.662-133.59c-3.172-24.285-22.372-42.188-45.359-44.743c-28.141-2.552-56.899-4.49-86.272-6.405c0 0-121.456 263.986-134.24 290.827c-17.901 40.273-42.817 69.667-78.619 79.246m52.418-93.956c0-81.163-137.355-116.325-184.213-93.953L244.874 43.812c-13.44-3.193-28.777-.638-28.14-.638l-61.983 69.668c-34.978 1.278-68.908 3.831-101.76 7.023c-23.384 2.555-42.431 20.458-45.383 44.744C2.446 207.413 0 252.179 0 298.199s2.446 90.763 7.608 133.567c3.336 26.864 21.8 40.274 45.382 44.105c64.737 10.877 159.276 1.277 159.276-86.294" clip-rule="evenodd"></svg:path>`,
})
export class FileIconsPostscriptIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPowerbuilderIcon],svg[file-icons-powerbuilder-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M336.055 115.425c-41.158-23.728-41.158-83.37 0-107.098s92.884 6.093 92.884 53.549s-51.727 77.276-92.884 53.549m-60.31-80.283H0v17.15h275.745zM124.42 102.733H0v15.133h124.421zm10.089 175.535H0v16.141h134.51zm-42.371 61.538H0v16.141h92.139zM75.762 504.323c13.421-18.86 122.237-176.288 137.697-180.066c15.675 4.334 47.684 13.76 45.142 18.376c-3.233 5.87-35.027 47.671-37.25 58.79c-2.225 11.12 14.455 41.699 40.53 22.703s83-89.976 76.884-106.655s-42.388-40.807-82.944-57.266c-1.112-2.78 29.467-32.802 45.59-60.601c3.017-5.202 58.378 66.161 76.169 62.825c26.976-5.058 111.855-76.725 116.858-90.624s-.659-30.023-19.203-42.745s-65.408 66.096-94.32 62.76c-19.33-2.23-32.009-48.357-77.836-76.725c-40.204-24.887-102.674-33.942-117.96-32.034c-17.245 2.153-58.84 40.93-115.55 100.975c-18.428 19.511 21.213 54.882 37.806 42.81c50.215-36.532 81.443-81.936 92.948-81.525c11.505.41 38.86 15.515 38.86 15.515S52.778 423.566 32.873 463.137c-21.8 43.345 29.468 60.046 42.889 41.186"></svg:path>`,
})
export class FileIconsPowerbuilderIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPrettierIcon],svg[file-icons-prettier-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsProgressOldIcon],svg[file-icons-progress-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPropellerIcon],svg[file-icons-propeller-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M267.78 87.938c52.32-4.454 93.544-1.05 139.224 8.869C465.335 109.473 512 113.473 512 81.974c0-66.344-192.518-11.35-244.817-.691a11.79 11.79 0 0 0-10.96-7.358c-5.796 0-10.606 4.133-11.6 9.577c-50.947 2.3-84.239 3.864-152.033-10.774C32.322 59.716-.956 65.28.02 90.474c2.382 61.428 164.405 17.637 245.475-.06a11.75 11.75 0 0 0 5.516 5.616v11.855c-3.899 1.903-6.587 5.86-6.587 10.447c0 4.767 2.9 8.86 7.05 10.667c-6.867 2.216-11.843 8.72-11.843 16.404c0 5.617 2.67 10.59 6.781 13.733C50.995 180.444 24.672 370.564 28.285 413.904c8.054 63.705 446.671 65.17 455.458 0c1.425-116.824-73.79-240.798-217.033-254.639a17.24 17.24 0 0 0 6.95-13.862c0-7.88-5.234-14.508-12.372-16.554c3.978-1.875 6.734-5.873 6.734-10.517c0-4.753-2.883-8.835-7.012-10.65v-11.45c3.428-1.507 5.998-4.574 6.77-8.294m-20.377 71.91q1.113.73 2.336 1.283c-38.214 18.491-50.328 146.46-53.452 203.076c-39.863 2.708-75.867 6.919-106.44 13.246c12.969-105.2 62.277-207.251 157.556-217.605M469.409 412.25c0 17.433-95.903 35.286-216.902 35.286c-93.494 0-195.252-12.03-210.774-35.83c0 0 30.066-34.148 206.958-34.148c196.312 0 220.718 34.692 220.718 34.692m-46.739-33.79c-34.953-8.335-70.771-12.815-107.329-13.999c-2.532-60.463-14.2-183.859-52.012-203.222a17 17 0 0 0 3.166-1.812C354.08 166.8 417.68 283.817 422.67 378.462"></svg:path>`,
})
export class FileIconsPropellerIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsProselintIcon],svg[file-icons-proselint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPugIcon],svg[file-icons-pug-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPugOldIcon],svg[file-icons-pug-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M348.012 250.498c18.588 22.588 11.882 32.47 12 54.118c0 26.955-3.259 41.908-8.28 50.31l12.28-4.663c.547 15.08.702 22.54-10.353 28.589a286.6 286.6 0 0 1-85.324 17.311c10.253 6.726 14.564 20.901 7.556 32.678c-9.495 15.956-32.853 15.633-41.944-.58c-6.577-11.73-2.205-25.464 7.784-32.068a286.5 286.5 0 0 1-85.838-17.341c-7.361-2.97-12.247-8.698-10.706-28.589l15.954 5.746c-5.438-8.15-9.013-23.217-9.013-51.51c0-21.53-6.706-31.413 11.882-54.001c17.883-22.118 52.236-43.883 92.001-43.883c39.647 0 74 21.765 92 43.883m-327.65-51.53c20.706 10.588 47.412 45.295 46.824 38.706c-11.294-130 119.648-148.118 119.648-148.118s-19.22-28.06-103.177-12.706c-84.763 15.5-103.65 92.994-63.295 122.118m470.945 0c-20.706 10.588-47.412 45.295-46.824 38.706c11.294-130-119.648-148.118-119.648-148.118S344.482 59.32 428.012 76.85C530.39 100.053 522.474 185 491.307 198.968m-266.238 37.53c-3.744 8.283 8.602 21.596 28.589 22.532v67.049c-7.114 1.099-15.927 5.023-24.47 7.596c-9.295 3.177-18.236 4.47-14.707 5.059c12.118.47 25.53-4.118 42.118-3.882c16.47-.236 29.883 4.352 42.118 3.882c3.53-.47-5.412-1.765-14.706-5.059c-8.917-2.686-18.219-6.832-25.412-7.713V259c19.708-1.121 31.833-14.285 28.118-22.502c-8.784-16.55-56.04-15.569-61.648 0m-81.53-40.706c0-6.497-7.08-10.58-12.715-7.331s-5.634 11.413 0 14.661c5.634 3.249 12.716-.834 12.716-7.33m-33.272 43.112c-21.833-12.587-21.833-44.226 0-56.813s49.273 3.233 49.273 28.407s-27.44 40.993-49.273 28.406m291.98-43.112c0-6.497-7.08-10.58-12.715-7.331s-5.635 11.413 0 14.661c5.634 3.249 12.715-.834 12.715-7.33m-33.272 43.112c-21.833-12.587-21.833-44.226 0-56.813s49.272 3.233 49.272 28.407s-27.44 40.993-49.272 28.406"></svg:path>`,
})
export class FileIconsPugOldIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsPyretIcon],svg[file-icons-pyret-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsQIcon],svg[file-icons-q-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsQiskitIcon],svg[file-icons-qiskit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsQtIcon],svg[file-icons-qt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsQuasarIcon],svg[file-icons-quasar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRIcon],svg[file-icons-r-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M488.787 304.652C571.52 172.84 414.497 86.744 309.514 66.865C99.116 27.027-118.752 215.015 75.462 356.94c28.8 21.046 70.324 35.303 116.423 41.915v51.704h86.02v-48.242c24.86-1.461 49.641-5.05 73.254-10.889c15.203 29.586 28.23 59.13 28.23 59.13h97.618s-31.703-53.725-51.938-87.644c26.532-14.97 48.674-34.293 63.718-58.262m-210.883 58.685v-31.288H309.8c5.613 0 14.887 12.428 24.861 29.229c-18.816 2.185-38.007 2.837-56.756 2.059m64.165-88.104h-64.165v-57.417h64.165s21.388 9.523 21.388 29.15s-21.388 28.267-21.388 28.267m70.22 66.4a287 287 0 0 0-2.938-4.752c-7.348-11.475-41.146-19.33-41.146-19.33s79.806-3.866 78.84-84.087c-.722-59.95-60.174-76.355-90.011-76.355h-165.15v190.756c-12.92-4.614-24.504-10.193-34.194-16.702C8.867 231.194 175.816 98.78 337.041 126.84c80.448 14.002 200.773 74.647 137.376 167.493c-13.96 20.445-35.899 36.089-62.128 47.3"></svg:path>`,
})
export class FileIconsRIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRacketIcon],svg[file-icons-racket-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M87.783 447.726C33.993 401.098 0 332.496 0 256C0 159.76 53.801 76.012 133.145 32.806a2508 2508 0 0 1 39.962-10.404c24.097-6.06 33.028 8.893 38.432 17c12.44 18.658 27.713 51.223 29.27 92.197c1.773 46.698-108.121 212.477-153.026 316.127M512 256C512 115.524 397.385 1.646 256 1.646a259 259 0 0 0-47.175 4.327c30.418-2.453 53.72 2.637 71.657 40.654c5.583 11.833 16.064 40.522 33.655 81.53c6.147 14.33 35.453 77.66 67.995 151.247c22.143 50.072 49.457 92.917 66.253 144.382C487.98 379.004 512 320.293 512 256M390.366 472.525l-11.74-6.826c-32.793-101.507-66.375-193.91-102.146-268.794c-9.57-23.135-19.778-24.775-29.597-2.99c-34.246 75.98-80.078 184.04-110.56 263.193l-30.675 4.756c42.218 30.491 94.166 48.49 150.352 48.49c49.285 0 95.307-13.85 134.366-37.829"></svg:path>`,
})
export class FileIconsRacketIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRascalIcon],svg[file-icons-rascal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M471.96 224.44c-16.845 17.266-79.243 64.09-79.243 64.09c22.631-23.653 38.257-54.688 49.087-88.6c7.515 3.165 17.567 3.372 28.237 2.858c-9.635-2.703-17.868-7.736-24.437-15.54l.042-.148c19.051 2.842 36.531-1.738 48.99-12.834c-15.03 5.465-35.235 5.378-44.748-2.22c-.855-4.1 21.349-3.758 36.55-18.96c-13.454 6.242-25.453 8.669-33.778 4.958q.336-1.631.662-3.267c21.744-13.553 41.242-45.447 44.57-81.18c12.638-1.822 3.303-35.913-20.246-24.382c-14.91 7.3-2.191 26.766 8.157 26.25c0 0 3.197 37.302-42.485 66.408c-10.673-9.508-26.968-18.7-46.27-26.801c7.855-6.19 19.275-7.083 36.37.455c-15.328-12.194-29.252-9.66-42.79-3.066q-1.224-.483-2.462-.96c3.822-15.402 13.702-24.475 33.828-20.98c-12.085-4.664-30.036.002-48.645 15.648q-1.054-.354-2.114-.703c3.727-7.415 20.11-22.261 12.932-39.444c2.323 20.053-10.434 26.326-31.57 33.794q-.94-.26-1.882-.517c7.094-17.707 2.85-31.732-18.719-40.131c20.561 12.057 16.57 22.774 1.015 33.045c1.419-7.916-6.273-14.633-22.656-20.206c11.898 7.18 15.023 13.961 11.19 20.424c-10.243-2.032-20.476-3.662-30.458-4.814c-31.085-22.209-66.361-41.993-65.156-60.938c10.825-1.575 23.363-23.128-3.093-22.122c-32.541 1.238-8.963 21.088-8.963 21.088c4.447 22.492 24.285 51.497 42.904 63.084a440 440 0 0 0-10.322 19.935c-6.862-1.175-21.847-12.723-36.355-26.436c16.163 19.085 27.625 34.952 27.896 43.162c-18.628-6.657-35.49-11.695-54.505-32.789c8.584 18.017 29.346 37.026 44.176 48.149c-9.269 2.913-17.68 1.22-35.156-5.755c19.242 19.407 26.65 22.983 35.65 19.658c-7.434 24.569-10.46 47.964-8.984 70.942C154.162 105.534 96.192 36.905 46.336 27.504c-31.737 4.443-74.264 180.264 8.251 238.025c-7.754 25.372-7.196 45.386 5.713 55.221c13.33 10.156 72.037 4.274 75.755-8.882c6.489 1.617 11.567 3.47 14.3 5.72C32.583 429.29 52.048 510.535 0 502.918c82.938 10.58 212.847 5.925 284.163-48.51c19.028 3.233 30.665-3.537 41.667-14.751c22.427 15.868 71.936 19.254 87.17-.635c3.173-1.904 5.914-32.845 5.924-50.144c42.21-22.427 85.689-117.637 93.076-195.953c-10.591-15.5-29.707 20.924-40.04 31.515"></svg:path>`,
})
export class FileIconsRascalIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRdataIcon],svg[file-icons-rdata-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M338.23 83.722C338.23 8.173 0 8.173 0 83.722v56.371c3.966 38.402 97.904 59.156 191.663 55.807v-35.911H338.23zM6.166 182.372c31.565 32.912 108.476 44.095 185.497 41.399v84.872C106.571 313.133 2.18 291.855 0 252.837v-56.372c.244-5.03 2.728-9.648 6.166-14.093M0 365.58v-56.372q.44-7.486 6.166-14.092c30.024 35.291 120.146 44.303 185.497 41.399v84.872C119.191 424.787 5.336 410.122 0 365.58m370.28-64.778h-67.39v-60.303h67.39s22.463 10.001 22.463 30.614c0 20.614-22.463 29.689-22.463 29.689m-7.781 90.37C378.466 422.245 409.475 485 409.475 485H512l-71.057-119.452c-7.717-12.051-43.213-20.301-43.213-20.301s83.817-4.06 82.802-88.314c-.759-62.964-63.198-80.193-94.535-80.193h-173.45V485h90.343V360.473h33.498c5.895 0 15.635 13.053 26.11 30.699M112.616 107.704c-74.992-10.724-74.992-37.68 0-48.404s169.242 2.754 169.242 24.202s-94.25 34.926-169.242 24.202"></svg:path>`,
})
export class FileIconsRdataIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsReactosIcon],svg[file-icons-reactos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsReadthedocsIcon],svg[file-icons-readthedocs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsReduxIcon],svg[file-icons-redux-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsReekIcon],svg[file-icons-reek-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRenovateIcon],svg[file-icons-renovate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRestqlIcon],svg[file-icons-restql-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRestructuredtextIcon],svg[file-icons-restructuredtext-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M142.186 244.055q-4.86-4.228-14.58-4.23h-30.96v36.18h30.96q9.72 0 14.58-4.32t4.86-14.04q0-9.358-4.86-13.59"></svg:path><svg:path fill="currentColor" d="M0 96v320h512V96zm150.827 250.385q-2.342-6.116-2.88-14.58q-.54-8.46-1.62-16.2q-1.442-10.079-6.12-14.76q-4.682-4.678-15.3-4.679h-28.26v50.219h-28.26v-128.52h69.3q8.638 0 15.57 2.79q6.927 2.792 11.88 7.65a33.3 33.3 0 0 1 7.56 11.25c1.737 4.26 2.61 8.85 2.61 13.77q-.002 11.341-4.77 19.62q-4.772 8.28-15.57 12.6v.36q5.219 1.442 8.64 4.41a24.5 24.5 0 0 1 5.58 7.021q2.16 4.05 3.15 8.908a78 78 0 0 1 1.35 9.721q.177 3.061.36 7.2q.178 4.14.63 8.46a56 56 0 0 0 1.44 8.19q.986 3.872 2.97 6.57zm184.619-29.855c-3.127 6.908-7.771 12.873-13.941 17.888q-9.252 7.53-22.946 11.72q-13.696 4.194-31.706 4.194q-14.56-.002-28.25-3.578c-9.13-2.38-17.191-6.125-24.181-11.226q-10.49-7.646-16.655-19.493q-6.171-11.841-5.922-28.127h37.504c0 5.922 1.069 10.942 3.208 15.051q3.204 6.172 8.512 9.992c3.536 2.553 7.688 4.442 12.461 5.676q7.153 1.851 14.804 1.85c3.455 0 7.155-.285 11.102-.863q5.922-.862 11.104-3.33c3.455-1.643 6.33-3.907 8.635-6.786q3.454-4.317 3.455-10.98q-.002-7.153-4.565-11.596c-3.045-2.96-7.031-5.43-11.967-7.403s-10.529-3.701-16.777-5.182a458 458 0 0 1-18.999-4.934a168 168 0 0 1-19.245-6.045c-6.254-2.383-11.844-5.467-16.778-9.253q-7.403-5.674-11.967-14.188c-3.046-5.675-4.565-12.54-4.565-20.602c0-9.044 1.932-16.902 5.798-23.564q5.794-9.994 15.175-16.654q9.374-6.66 21.22-9.87q11.842-3.205 23.686-3.207q13.814.002 26.523 3.084q12.705 3.088 22.578 9.993q9.865 6.908 15.668 17.642c3.861 7.155 5.797 15.833 5.797 26.03h-37.504q-.498-7.894-3.33-13.077c-1.893-3.454-4.405-6.168-7.526-8.142c-3.127-1.975-6.705-3.37-10.734-4.195c-4.031-.82-8.43-1.234-13.2-1.234q-4.689.002-9.375.988q-4.69.989-8.513 3.454q-3.829 2.467-6.291 6.168q-2.469 3.702-2.468 9.377c0 3.454.656 6.253 1.974 8.388q1.971 3.21 7.772 5.922q5.796 2.717 16.038 5.428q10.237 2.717 26.77 6.91q4.933.987 13.695 3.576q8.754 2.593 17.395 8.267q8.634 5.678 14.928 15.174q6.29 9.5 6.29 24.303q-.001 12.093-4.687 22.454m118.248-74.905h-38.521v104.76h-28.26v-104.76h-38.52v-23.76h105.301z"></svg:path>`,
})
export class FileIconsRestructuredtextIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRhino3dIcon],svg[file-icons-rhino3d-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M191.618 353.588c.312 8.898-5.463 11.084-9.938 2.342c-49.747-90.96-114.894-109.275-171.508-91.166c-20.399-.625-4.58-47.04 0-59.53c4.58-12.488 50.37-3.746 71.184 3.33c22.895-79.093-5.204-107.4-11.031-114.893s1.56-10.303 1.56-10.303s47.456-14.986 67.438-19.045s24.873 2.29 29.035 20.19c15.82 63.691-45.27 143.409-45.27 143.409s5.724 11.448 21.897 16.027c45.31-42.46 58.03-104.695 60.216-147.052c0 0-1.563-15.09 10.614-7.597c12.176 7.493 55.886 44.646 63.691 99.44c2.601 22.218-16.651 32.105-16.651 32.105c-46.831 33.511-90.72 44.397-96.392 48.624c24.146 34.221 26.248 74.909 25.155 84.119m13.894-58.227c-.624 3.278 2.81 22.479 0 38.402c-4.683 11.863-6.264 19.045 2.957 26.225c9.22 7.182 78.114 39.65 118.493 82.944c15.455 15.715 23.26-3.798 11.864-12.852c-3.122-3.435-17.796-16.547-17.483-21.074s8.741 4.215 11.863 7.493c-8.43-17.016 9.991-38.714 29.66-14.206c8.014 7.753 2.394 26.07-4.474 31.065c7.525-7.524-5.568-26.278-16.028-15.819c-5.411 5.204 9.47 16.963 12.801 19.878c3.331 2.913 15.194-6.974 19.357-13.842c3.064-4.264 7.468-7.857 13.843-35.384c2.029-7.129 4.659-9.711 11.03-16.083c6.373-6.373 99.284-84.24 109.587-117.024c6.036-17.067 3.122-23.103-9.678-10.927S415.63 309.41 388.78 316.903s-31.533-6.088-27.63-9.366c2.373-2.376 62.075-66.918-4.27-32.158c-24.297 8.95-48.025-10.824-53.02-28.516c-10.538-33.693-10.2-40.38-34.136-19.774c-12.906 10.616-35.8 22.064-44.542 25.185c-26.226 6.245-36.633 35.593-15.403 38.507s32.73-.416 26.954 5.672c-5.776 6.089-14.362 11.552-4.683 16.86s28.16 18.42 29.222 19.669s9.648 2.342 12.146-3.902c2.497-6.245.312-7.962-1.405-8.899s.156-3.747 4.215-3.278s13.737-3.278 16.079-4.996c2.341-1.717 29.816-6.244 36.529 3.279c-7.62 2.38-9.834-2.55-20.606 1.248c-5.906 2.284-20.249 4.1-27.007 19.358c-5.048 11.396-6.921 34.915-27.526 28.255c-20.607-6.661-41.785-12.957-38.506-33.719s1.873-34.187-9.68-34.967"></svg:path>`,
})
export class FileIconsRhino3dIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRiotOldIcon],svg[file-icons-riot-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M505.978 271.244c8.031-8.034 8.029-21.055-.004-29.088l-82.45-82.45c-3.673-3.164-4.542-4.912-8.487-5.841c-1.471-.347-2.987-.467-4.499-.467c-132.444-.029-264.889-.027-397.334-.027c-.62 0-1.243.025-1.857.121c-5.178.812-9.274 3.788-10.476 8.85c-.518 2.18-.82 4.466-.822 6.704c-.043 57.897-.091 176.142.015 177.355c.346 3.961 1.967 7.313 5.193 9.697c2.78 2.055 6.012 2.533 9.438 2.53c65.994-.037 397.794-.032 397.794-.032c2.437-.07 5.878.202 7.124-.994c.947-.908 58.66-58.64 86.366-86.359zm-461.538-60.2c.007-3.543.076-3.615 3.639-3.619c16.55-.016 33.108-.283 49.648.147c8.121.21 16.133 1.784 23.61 5.597c10.826 5.522 16.167 14.56 17.382 26.207c.947 9.077-1.431 17.35-7.007 24.77c-2.756 3.666-6.432 5.97-10.16 8.228c-1.784 1.08-2.344 1.538-.97 3.495c6.085 8.667 21.508 32.041 21.508 32.041s-24.676-.183-33.956 0c-3.17.062-5.162-.911-6.843-3.66c-4.373-7.147-8.983-14.15-13.616-21.134c-1.538-2.318-3.121-4.608-6.675-4.262c-2.083.202-2.776.734-2.751 2.808c.09 7.265.022 14.532.037 21.798c.01 4.618.284 4.412-4.092 4.394a4068 4068 0 0 0-25.432-.004c-4.345.01-4.353.401-4.345-4.164c.03-15.34.011-30.679.011-46.02c0-15.54-.016-31.082.012-46.623m236.726 97.049c-17.081 4.175-32.815 1.62-47.164-8.444c-12.616-8.85-19.761-20.917-21.38-36.484c-.933-8.978.382-17.306 3.78-25.502c5.503-13.28 15.298-22.148 28.254-27.887c6.467-2.864 13.366-4.141 20.252-4.506c7.75-.411 15.529.931 22.795 3.843c16.397 6.572 27.572 18.091 32.152 35.417c1.11 4.205 1.646 8.563 2.058 10.772c-.622 27.242-17.395 47.083-40.747 52.79zm139.074-100.67c3.267.009 3.325.093 3.341 3.312l.028 21.792c.03 3.773.111 3.835-4.113 3.806l-19.977-.004c-7.04.043-5.88-.794-5.9 6.205l-.014 61.139c.097 4.72-.23 4.195-4.33 4.183l-24.82-.002c-5.562.01-4.685.11-4.69-5.011l-.012-62.955c-.077-3.476-.085-3.535-3.714-3.554c-7.466-.04-14.932-.083-22.397.03c-2.282.034-3.204-.519-3.155-3.015l-.002-23c-.054-2.553.966-2.987 3.19-2.975l86.564.051zm-226.897 96.81c-.006 3.527-.077 3.586-3.648 3.601c-9.072.036-18.147-.086-27.217.075c-2.526.045-3.04-.878-3.013-3.132l.05-93.75c.003-3.536.079-3.59 3.626-3.603l27.217-.063c2.446-.036 3.054.798 3.041 3.121l-.056 93.75m-97.514-49.58c-2.804.214-17.323-.242-17.323-.242s.018-15.083.139-18.07c3.134-.205 14.649-.185 17.255.017c5.336.413 8.994 3.916 9.091 8.51c.117 5.502-3.378 9.34-9.162 9.784m155.108 17.192c-3.244-4.435-4.735-9.191-4.321-14.158c-.786-9.593 6.045-19.486 15.563-21.9c6.381-1.62 16.7 1.595 20.424 7.035c5.943 8.682 7.015 18.917.747 28.395c-7.7 11.64-24.187 11.876-32.413.628m241.5-15.749c0 7.815-6.336 14.15-14.15 14.15s-14.151-6.335-14.151-14.15s6.335-14.15 14.15-14.15s14.15 6.335 14.15 14.15"></svg:path>`,
})
export class FileIconsRiotOldIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRmarkdownIcon],svg[file-icons-rmarkdown-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRobotframeworkIcon],svg[file-icons-robotframework-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRobotframeworkOldIcon],svg[file-icons-robotframework-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m177.169 344.177l46.56-48.5a10.31 10.31 0 0 1 8.718-3.1a10.33 10.33 0 0 1 7.706 5.12l56.72 99.003c4.47 6.954 8.12 9.462 9.897 9.492c1.865-.002 5.832-2.52 10.846-9.787l26.741-43.199a10.34 10.34 0 0 1 8.789-4.895H499c10.837-72.394.912-156.068.912-156.068s-5.602-94.637-91.765-151.111c-52.689 47.487-105.186 51.909-154.63 51.91l-1.226-.002c-43.412-.061-97.16-.147-147.624-55.348c-55.628 34.823-91.279 92.682-96.732 169.02V339.01s.043 1.856.336 5.168zm154.514-154.001h73.892v50.644h-73.892zm-226.593 0h204.46v50.644H105.09zm28.07-167.543C166.81 7.8 205.884 0 248.756 0c54.348 0 96.962 9.876 130.369 25.15c-42 33.94-82.557 36.922-126.79 36.884c-46.415-.066-82.908-3.14-119.175-39.4m362.071 346.35c1.763 16.278-9.791 48.354-24.194 63.558c-55.813 58.913-97.06 83.966-270.698 78.798C65.404 507.324 20.966 411.063 11.39 364.85h170.185c2.815 0 5.507-1.148 7.456-3.178l40.05-41.72l49.983 87.243q.121.212.251.416c8.033 12.609 17.155 19.085 27.113 19.25l.387.003c9.953 0 19.368-6.379 27.987-18.967q.135-.197.26-.4l23.842-38.514z"></svg:path>`,
})
export class FileIconsRobotframeworkOldIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRobotsIcon],svg[file-icons-robots-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRollupOldIcon],svg[file-icons-rollup-old-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRsyncIcon],svg[file-icons-rsync-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsRubocopIcon],svg[file-icons-rubocop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSageIcon],svg[file-icons-sage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSaltstackIcon],svg[file-icons-saltstack-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m492.621 62.195l-101.92-60.5a12.05 12.05 0 0 0-12.255-.042L304.88 44.606L231.705 1.829a12.08 12.08 0 0 0-12.19 0L5.984 126.634A12.07 12.07 0 0 0 0 137.061v233.825c0 4.22 2.202 8.13 5.805 10.322L218.2 510.244a12.09 12.09 0 0 0 12.426.073l212.717-125.943a12.09 12.09 0 0 0 5.923-10.395V252.59a12.08 12.08 0 0 0-6.06-10.471a12.06 12.06 0 0 0-12.093.034l-88.772 51.672V245.74l32.919 18.809a12.04 12.04 0 0 0 5.992 1.593c2.075 0 4.156-.534 6.017-1.609l105.207-60.492a12.08 12.08 0 0 0 6.06-10.47V72.58a12.08 12.08 0 0 0-5.914-10.385M384.485 26.096l77.893 46.235l-80.365 45.489l-77.125-45.248zM253.41 133.12l13.183-7.791v16.03zM225.609 26.246l55.323 32.34l-8.353 4.878a12.08 12.08 0 0 0-5.986 10.428v23.379l-42.578 25.162a12.078 12.078 0 0 0-.257 20.64l83.284 52.05l-80.327 47.667L41.404 133.909zM24.155 151.789L214.669 263.73v216.103L24.155 364.093zM425.11 273.596v93.5L238.824 477.388V263.692l79.36-47.091v98.228c0 4.324 2.312 8.314 6.06 10.468a12.07 12.07 0 0 0 12.093-.031zm-88.448-88.446l-45.914-28.695V92.28l79.08 46.395v94.953L342.34 217.92v-22.527c0-4.164-2.144-8.036-5.678-10.243m57.321 47.66V138.8l80.396-45.507v93.289z"></svg:path>`,
})
export class FileIconsSaltstackIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsScilabIcon],svg[file-icons-scilab-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.416 297.89c-9.888-5.7-9.888-20.03 0-25.73s22.316 1.463 22.316 12.865S17.304 303.59 7.416 297.89m84.676-60.372c0-10.767-11.736-17.532-21.073-12.149s-9.338 18.915 0 24.298s21.073-1.382 21.073-12.149m60.98-35.38c0-10.133-11.043-16.5-19.83-11.433c-8.788 5.065-8.788 17.799 0 22.865s19.83-1.301 19.83-11.433m11.794 37.487c0-10.45-11.39-17.016-20.452-11.791s-9.062 18.357 0 23.581s20.452-1.341 20.452-11.79m10.997 38.296c0-10.555-11.505-17.188-20.659-11.91s-9.154 18.543 0 23.82s20.66-1.355 20.66-11.91m10.484 39.218c0-10.45-11.39-17.015-20.452-11.79c-9.063 5.224-9.063 18.356 0 23.58c9.062 5.225 20.452-1.34 20.452-11.79m43.142-24.459c0-10.132-11.043-16.498-19.83-11.432c-8.788 5.065-8.788 17.799 0 22.865s19.83-1.3 19.83-11.433m-5.022-39.8c0-10.133-11.043-16.5-19.83-11.433c-8.788 5.065-8.788 17.799 0 22.865s19.83-1.301 19.83-11.433m-5.191-39.05c0-9.92-10.813-16.154-19.417-11.193c-8.604 4.96-8.604 17.427 0 22.387s19.417-1.273 19.417-11.194m-5.634-38.465c0-9.495-10.349-15.461-18.583-10.714c-8.235 4.747-8.235 16.68 0 21.428c8.234 4.747 18.583-1.22 18.583-10.714m59.79-19.844c0-8.86-9.657-14.428-17.342-9.998s-7.684 15.565 0 19.995s17.342-1.137 17.342-9.997m55.858 24.201c0-8.86-9.657-14.427-17.341-9.997s-7.684 15.565 0 19.995s17.341-1.138 17.341-9.998m-3.865 38.585c0-9.285-10.122-15.12-18.175-10.478c-8.053 4.643-8.053 16.313 0 20.956s18.175-1.192 18.175-10.478m-4.117 39.224c0-9.494-10.349-15.46-18.583-10.713c-8.235 4.747-8.235 16.68 0 21.427s18.583-1.219 18.583-10.714m-4.244 39.996c0-9.495-10.35-15.461-18.584-10.714s-8.235 16.68 0 21.428c8.235 4.747 18.584-1.22 18.584-10.714m44.284-12.245c0-9.283-10.119-15.117-18.17-10.475c-8.05 4.641-8.05 16.308 0 20.95s18.17-1.192 18.17-10.475m-8.42 39.976c0-9.177-10.004-14.944-17.963-10.355c-7.96 4.588-7.96 16.122 0 20.711s17.962-1.178 17.962-10.356m16.492-78.93c0-9.18-10.006-14.949-17.967-10.36s-7.961 16.128 0 20.717c7.961 4.59 17.967-1.178 17.967-10.358M377.173 208c0-8.86-9.657-14.428-17.341-9.998s-7.685 15.565 0 19.995s17.34-1.138 17.34-9.997m30.14 69.2c0-9.072-9.889-14.772-17.756-10.236s-7.868 15.936 0 20.472c7.867 4.536 17.755-1.165 17.755-10.236m-11.782 38.61c0-9.072-9.888-14.772-17.755-10.236c-7.868 4.535-7.868 15.936 0 20.472c7.867 4.536 17.755-1.165 17.755-10.236m23.086-76.417c0-8.86-9.658-14.428-17.342-9.998s-7.684 15.565 0 19.995s17.342-1.137 17.342-9.997m35.838 33.732c0-8.86-9.657-14.428-17.341-9.998s-7.684 15.565 0 19.995s17.341-1.138 17.341-9.997m-14.759 37.086c0-8.966-9.773-14.6-17.548-10.117c-7.776 4.483-7.776 15.75 0 20.234c7.775 4.483 17.548-1.151 17.548-10.117m27.681 34.816c0-8.86-9.657-14.427-17.341-9.997s-7.684 15.565 0 19.995s17.341-1.138 17.341-9.998m18.045-36.202c0-8.86-9.657-14.427-17.341-9.997s-7.684 15.565 0 19.995s17.341-1.138 17.341-9.998M512 346.357c0-8.86-9.657-14.428-17.341-9.998s-7.684 15.565 0 19.995S512 355.216 512 346.357M274.125 194.105c0-9.39-10.237-15.292-18.382-10.597s-8.145 16.499 0 21.195c8.145 4.695 18.382-1.206 18.382-10.598m.329 39.08c0-9.706-10.58-15.805-18.998-10.952s-8.418 17.052 0 21.905s18.998-1.246 18.998-10.952m.229 39.764c0-9.814-10.698-15.982-19.21-11.075s-8.512 17.242 0 22.15s19.21-1.26 19.21-11.075m-.15 40.666c0-9.704-10.578-15.801-18.994-10.95s-8.416 17.048 0 21.9s18.993-1.246 18.993-10.95m-.465 42.171c0-9.39-10.236-15.292-18.381-10.597s-8.145 16.499 0 21.194s18.381-1.205 18.381-10.597m38.243-17.072c0-9.284-10.118-15.117-18.17-10.475c-8.05 4.641-8.05 16.308 0 20.95c8.052 4.641 18.17-1.192 18.17-10.475m-78.075-5.085c0-9.92-10.813-16.154-19.417-11.194s-8.604 17.428 0 22.388s19.417-1.274 19.417-11.194m-123.473-60.85c0-10.977-11.966-17.876-21.487-12.387s-9.521 19.286 0 24.775s21.487-1.41 21.487-12.387m17.763 36.19c0-10.978-11.966-17.876-21.487-12.387s-9.522 19.286 0 24.775s21.487-1.41 21.487-12.388m-71.194 6.408c0-11.507-12.543-18.738-22.523-12.984s-9.98 20.215 0 25.969c9.98 5.753 22.523-1.478 22.523-12.985"></svg:path>`,
})
export class FileIconsScilabIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSelfIcon],svg[file-icons-self-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M141.086 343.907v-21.49l8.061.071c2.059 13.622 11.41 17.965 20.92 18.04c9.71 0 18.877-4.988 18.877-19.748s-17.172-19.77-26.713-25.28s-20.539-12.837-20.539-29.104s16.438-25.512 28.858-26.424s15.216-.036 30.494 3.294v20.84h-8.172c-2.49-12.26-10.308-16.993-19.336-16.993s-17.157 5.858-17.45 16.676s6.404 14.846 20.097 22.752s26.748 12.89 26.71 32.532c-.694 20.65-15.371 28.899-31.918 28.899c-11.837 0-19.775-1.355-29.889-4.065m89.06-33.167c1.756 12.345 7.988 27.637 24.036 27.607s24.386-13.407 26.446-16.975l6.57 4.956c-3.94 7.96-16.462 23.752-37.749 23.752s-35.965-19.711-35.965-48.434c0-14.227 10.55-37.04 36.502-37.04s30.44 26.268 32.795 34.492zm34.931-15.564c-2.911-8.686-7.692-24.444-22.008-22.301s-15.95 19.214-14.463 30.303zm50.956 36.83c0 9.854 5.801 9.87 8.752 10.66v4.159h-30.853v-4.16c2.334-.892 8.855-.608 8.855-10.659v-81.698c-.181-4.044-.79-8.776-10.374-8.776v-5.817h23.62m72.157 14.897h-8.296c-.448-.775-.973-7.941-9.114-7.833s-11.013 7.574-11.013 18.849v10.853h18.008v8.208h-18.008v51.317c0 9.503 5.374 10.054 8.871 10.66v4.159H337.12v-4.16c3.559-.953 8.645-1.138 8.645-10.659V280.69h-9.015v-4.035c12.421-1.977 5.975-4.978 11.142-21.504s19.475-19.435 29.737-19.435s10.56.549 10.56.549zM81.97 317.8l-9.42-14.282l60.472 20.968l-53.483 36.161l6.077-17.017c-206.353-9.908-1.516-142.25 211.731-180.035s300.686 15.664 107.395 108.786l6.938-17.484L395 248.23c183.2-97.177.608-105.704-155.23-65.556S-49.784 305.677 81.97 317.799"></svg:path>`,
})
export class FileIconsSelfIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSemanticreleaseIcon],svg[file-icons-semanticrelease-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsServiceFabricIcon],svg[file-icons-service-fabric-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShadowcljsIcon],svg[file-icons-shadowcljs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M178.472 12.205C69.646 46.726 6.219 142.692.712 243.017C-9.085 367.123 83.275 487.048 215.52 508.984c126.26 19.65 259.68-57.909 290.367-197.82c42.079-191.842-140.257-358.33-327.415-298.96m307.033 290.492c-27.439-26.746-59.085-43.936-92.62-50.407c5.199-50.82 34.639-75.964 80.143-84.092c16.67 40.497 22.199 86.58 12.477 134.499M185.06 32.902C304.612-5.022 422.007 57.756 468.924 158.833c-53.186 10.827-80.786 42.288-85.916 91.869c-19.268-2.83-41.885-1.324-64.093 4.737c-39.271-29.336-111.421-25.33-118.008-68.164c-4.661-37.344 26.813-57.655 52.44-57.655c33.443 0 52.212 16.115 52.212 62.657h20.626c5.103-59.545-34.089-84.509-72.03-83.393c-62.913 1.849-76.805 54.308-74.365 80.067c5.089 50.616 68.565 55.565 112.656 76.173c-20.092 9.287-38.099 22.171-53.433 38.262c-64.971-46.897-137.768-66.306-216.154-66.08c7.475-89.31 65.079-173.595 162.201-204.404m70.5 350.085c-20.72-.363-35.555-5.072-46.162-11.911c14.54-43.868 48.359-81.49 94.375-100.017c46.833 28.268 29.616 113.291-48.213 111.928M22.224 247.328c85.437.063 153.23 22.907 210.046 63.524c-13.586 15.935-24.226 34.145-31.19 53.68c-22.083-21.141-17.363-52.872-17.363-52.872h-21.245c-1.376 33.718 11.217 58.911 32.564 74.322c-6.807 32.381-3.624 66.067 9.41 98.706C79.9 455.534 18.128 346.24 22.224 247.328m194.072 239.773c-13.885-31.466-17.997-64.08-12.198-95.442c14.622 7.903 32.33 11.992 51.9 11.954c89.64 0 118.67-87.12 71.873-140.216c58.461-13.699 115.102 8.605 154.999 50.804c-31.451 124.144-152.577 192.016-266.574 172.9"></svg:path>`,
})
export class FileIconsShadowcljsIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShellcheckIcon],svg[file-icons-shellcheck-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShenIcon],svg[file-icons-shen-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShipitIcon],svg[file-icons-shipit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M511.693 300.4c3.161 46.526-17.436 122.97-93.51 155.251c-116.19 6.992-243.72 11.044-339.361-1.12C47.924 445.335.23 373.294 0 302.974c49.93 58.426 155.92 81.101 241.316 80.036s173.611-18.003 270.377-82.61"></svg:path><svg:path fill="currentColor" d="M243.077 49.684c19.907 61.393 14.967 198.874 5.629 316.995c35.804 4.045 120.443-13.523 174.434-36.693c-74.046-131.792-157.166-272.22-180.063-280.302m151.718 278.189c-16.406 5.34-33.072 9.255-50.77 9.812c-11.94-75.453-63.302-202.859-52.78-196.301c18.636 22 72.859 110.842 106.384 178.903c1.338 3.295 1.252 6.254-2.834 7.586M235.493 114.106C228.527 66.788 123.467 253.894 76.85 331.839c19.974 17.832 108.152 37.62 156.633 35.112c5.453-100.069 12.928-206.81 2.01-252.845M162.873 336.9c-.776 4.629-3.241 6.033-7.024 5.147c-13.716-3.192-27.495-5.972-40.413-12.175c-6.78-3.257-8.41-7.692-4.834-14.578c22.117-41.266 44.613-79.752 67.813-113.09c5.248 1.998-4.944 71.415-15.542 134.696"></svg:path>`,
})
export class FileIconsShipitIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShippableIcon],svg[file-icons-shippable-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsShopifyIcon],svg[file-icons-shopify-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSigilsIcon],svg[file-icons-sigils-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSilicongraphicsIcon],svg[file-icons-silicongraphics-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSinatraIcon],svg[file-icons-sinatra-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSketchupLayoutIcon],svg[file-icons-sketchup-layout-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSketchupStylebuilderIcon],svg[file-icons-sketchup-stylebuilder-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSlashIcon],svg[file-icons-slash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSmartosAltIcon],svg[file-icons-smartos-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSnortIcon],svg[file-icons-snort-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSnykIcon],svg[file-icons-snyk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSophiaIcon],svg[file-icons-sophia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSorbetIcon],svg[file-icons-sorbet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSpacemacsIcon],svg[file-icons-spacemacs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSqfIcon],svg[file-icons-sqf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSqliteIcon],svg[file-icons-sqlite-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSquarespaceIcon],svg[file-icons-squarespace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStanIcon],svg[file-icons-stan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 256.024C512 397.409 397.361 512 255.976 512c-69.048 0-131.698-27.372-177.738-71.806c25.832-5.475 51.308-10.44 73.63-14.735c69.968-13.467 176.242-38.77 199.625-61.582c0 0 11.99-26.71 18.913-43.786c4.004-5.445 5.433-9.519 5.567-9.922c7.245-28.58-55.958-63.575-97.498-78.92c-29.46-10.883-42.01-17.481-57.898-25.835c-6.202-3.26-12.625-6.635-20.726-10.633c20.305-5.4 40.193-9.66 54.829-12.963c37.352-8.426 183.093-34.88 229.289-42.334C501.874 174.44 512 214.05 512 256.024M111.616 237.5c.092-.29.988-2.84 4.663-6.652c11.894-29.212 38.996-89.252 38.996-89.252c22.243-36.501 120.713-62.614 189.402-81.598c16.021-4.428 35.158-9.863 55.294-15.695C358.946 16.344 309.367 0 255.976 0C114.591 0 0 114.638 0 256.024c0 66.772 25.57 127.559 67.438 173.13c31.029-9.403 62.366-18.15 87.885-24.815c55.436-14.477 140.438-36.458 187.1-63.898c-14.469-9.869-50.654-23.12-108.182-41.321c-68.626-21.674-127.244-40.066-122.625-61.62"></svg:path>`,
})
export class FileIconsStanIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStoryistIcon],svg[file-icons-storyist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStringsIcon],svg[file-icons-strings-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStyledcomponentsIcon],svg[file-icons-styledcomponents-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStylelintIcon],svg[file-icons-stylelint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M266.135 500.973c57.436-205.351 55.769-206.284 97.28-352.702l9.978 5.776c5.435 3.112 9.873.552 9.873-5.697V78.508c11.027-38.571 19.64-68.398 22.187-77.325h44.964l74.713 69.186l-49.073 42.404l37.114 40.133l-244.565 348.068c-1.182 1.969-2.849 1.523-2.468 0z"></svg:path><svg:path fill="currentColor" d="M292.851 58.342c2.232 0 4.017 1.221 4.017 2.757v35.775c0 1.496-1.798 2.718-4.017 2.718h-60.389c-2.232 0-4.03-1.221-4.03-2.731V61.073c0-1.51 1.798-2.757 4.017-2.757zm74.568-39.621l-66.455 38.361c.762 1.181 1.234 2.534 1.234 4.004v35.8c0 1.838-.735 3.519-1.916 4.858l67.125 38.754c4.569 2.652 8.324.486 8.324-4.792V23.526c0-5.291-3.728-7.444-8.31-4.805zM223.088 96.886V61.073c0-1.471.472-2.822 1.234-3.991l-66.455-38.387c-4.569-2.625-8.323-.473-8.323 4.805v112.181c0 5.278 3.755 7.444 8.337 4.792l67.112-38.755c-1.181-1.352-1.891-3.019-1.891-4.858l-.013.026z"></svg:path><svg:path fill="currentColor" d="M256.525 500.973h2.468c-57.423-205.351-55.769-206.284-97.28-352.702l-9.977 5.776c-5.422 3.112-9.873.552-9.873-5.697V78.508c-11.028-38.557-19.64-68.398-22.186-77.325H74.726L.001 70.369l49.06 42.404l-37.114 40.146zm22.357-344.787c0 10.02-8.123 18.143-18.143 18.143s-18.143-8.123-18.143-18.143s8.123-18.143 18.143-18.143s18.143 8.123 18.143 18.143m0 107.848c0 10.02-8.123 18.143-18.143 18.143s-18.143-8.123-18.143-18.143s8.123-18.143 18.143-18.143s18.143 8.123 18.143 18.143m0 107.875c0 10.02-8.123 18.143-18.143 18.143s-18.143-8.123-18.143-18.143s8.123-18.143 18.143-18.143s18.143 8.123 18.143 18.143"></svg:path>`,
})
export class FileIconsStylelintIcon {
  readonly viewBox = input("0 0 525 512")
  readonly width = input("1.03em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsStylusIcon],svg[file-icons-stylus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M78.909 343.327c13.28-15.884 14.842-32.289 4.557-62.755c-6.51-19.27-17.317-34.112-9.375-46.09c8.463-12.759 26.43-.39 11.458 16.666l2.994 2.083c17.968 2.083 26.821-22.524 13.41-29.555c-35.413-18.488-66.4 17.056-52.73 58.198c5.86 17.446 14.062 35.934 7.422 50.647c-5.729 12.629-16.795 20.05-24.217 20.31c-15.493.782-5.207-34.762 12.63-43.616c1.562-.78 3.775-1.822 1.692-4.426c-22.003-2.474-34.893 7.681-42.314 21.873c-21.613 41.272 41.012 56.505 74.473 16.665m386.685-121.344c5.078 12.5 12.76 24.868 8.203 35.805c-3.776 9.374-8.724 13.28-14.192 14.191c-7.681 1.302-5.598-22.784 7.552-29.945c1.171-.651 2.864-3.776 1.302-5.599c-16.666-.911-26.04 7.03-31.118 17.577c-14.712 30.857 33.33 39.32 56.897 8.983c9.374-12.108 9.764-24.086.78-45.829c-5.728-13.8-14.451-24.086-8.983-33.2c5.86-9.635 19.92-1.302 9.374 11.587l2.344 1.302c13.67.781 19.27-17.446 8.853-22.003c-27.471-11.718-53.12 17.837-41.012 47.131M161.844 351.01c-32.289 12.629-51.818 40.491-44.918 54.682c5.86 12.24 37.497 7.812 52.47-.26c36.715-19.92 63.406-58.98 81.633-112.88c15.884-47.783 35.935-101.945 40.622-103.508c-9.504-7.55-36.195 5.078-43.746 23.827c-9.505 23.826-23.566 58.588-37.367 73.821c-14.582 16.015-16.014 3.646-14.582-5.598c3.385-21.743 24.607-72.13 36.195-86.32c-4.297-6.38-32.42-5.47-51.949 24.867c-7.29 11.457-23.956 49.605-42.444 79.68c-4.036 6.51-9.114 1.953-5.208-13.28c4.427-17.576 17.446-65.88 34.242-103.897c44.006-8.723 90.747-14.842 126.551-14.973c4.818-1.302 8.073-5.598 0-5.859c-30.856-1.041-77.206 2.604-120.562 8.073c8.333-16.666 17.316-29.946 26.43-35.544c-9.895-6.25-29.945-3.776-41.403 13.15c-5.077 7.551-10.155 16.665-14.972 26.56c-31.769 4.948-58.98 10.546-72.78 15.754c-14.322 5.468-12.76 22.784-4.037 19.53c18.098-6.77 42.575-13.801 69.786-20.05c-17.316 39.058-30.857 85.148-34.112 103.896c-8.072 45.57 20.18 45.309 33.982 27.342c14.972-19.66 46.22-88.795 51.037-96.086c1.432-2.473 3.385-1.171 2.344 1.042c-34.893 69.655-31.899 96.606-3.646 90.617c12.76-2.734 34.763-24.607 40.491-35.934c1.172-2.734 3.646-2.474 3.125-1.302c-22.133 57.417-50.256 103.897-69.135 118.48c-17.186 13.149-29.945-15.364 30.857-56.246c8.984-6.12 4.817-14.452-5.338-11.588c-31.377 4.948-121.213 33.461-160.663 60.802c-2.995 2.084-5.729 3.776-5.599 8.073c.13 2.473 4.427 1.562 6.51.26c51.037-30.596 92.83-42.574 140.743-52.6c8.017-.987 1.69 2.827-4.557 5.469m324.191-27.602c7.942 1.432 31.768-22.394 19.009-24.087c-59.76-7.811-188.656 2.604-245.552 17.707c-16.925 4.427-12.238 13.41-3.645 11.718c62.903-12.745 170.32-16.912 230.188-5.338M308.316 292.29c16.665-8.333 41.403-59.89 57.677-88.144c1.172-2.083 3.255-.39 2.084 1.042c-41.143 70.827-23.696 79.03-7.422 77.988c21.743-1.302 41.794-32.55 46.22-39.58c1.823-2.734 2.865-.52 1.823 1.432c-1.041 3.255-4.817 8.984-8.332 16.796c-4.948 11.066.26 15.363 4.556 17.316c6.77 3.255 25.259 1.172 28.123-10.155c-18.488-.391 25.779-87.623 30.336-92.961c-12.369-7.161-31.508.65-40.231 17.837c-18.618 36.846-34.242 66.53-44.007 67.051c-19.008 1.042 21.873-82.154 28.514-84.758c-4.037-5.859-29.946-3.385-44.398 19.009c-5.208 8.072-36.976 64.317-44.788 73.561c-13.8 16.405-14.842 2.344-10.936-14.061c1.302-5.599 3.515-12.76 6.38-20.702c9.113-20.57 18.878-27.08 24.867-33.72c40.231-44.658 63.276-80.853 54.162-95.044c-8.072-12.63-35.023-7.031-52.339 19.008c-31.898 47.783-61.323 113.272-65.099 143.217c-3.645 29.945 18.098 32.159 32.81 24.868m16.926-87.623c1.432-3.255 2.343-4.166 4.817-9.634c14.322-31.508 32.289-64.708 44.658-80.202c7.681-8.072 18.488 2.864-1.042 32.81c-11.457 17.707-24.477 34.046-38.668 48.368c-3.646 4.036-6.9 7.486-8.333 9.44c-1.042 1.301-2.213 1.04-1.432-.782"></svg:path>`,
})
export class FileIconsStylusIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSublimeIcon],svg[file-icons-sublime-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M510.19 413.166c-2.674-32.106-29.75-309.246-29.75-309.246c-1.59-24.952-14.565-35.395-25.393-39.774c-2.36-23.781-20.668-29.085-26.732-29.085c-6.203 0-322.62-.098-344.746-.098c-24.734 0-28.463 18.842-28.463 18.842l-1.087 11.088C33.79 73.268 33.784 92.2 33.784 92.2S0 408.4 0 443.322s29.77 33.709 29.77 33.709h438.787c50.835 0 44.31-31.759 41.634-63.865M165.555 266.779c3.957-10.35 22.028-14.18 32.552-10.702c.171.056 13.655 5.733 36.12 8.918c26.234 3.718 47.532-6.179 48.16-16.499c.16-2.635 4.235-16.722-7.804-23.188c-9.142-4.91-19.226-7.291-32.999-10.925c-15.887-4.192-31.855-5.305-45.038-12.709c-24.132-13.552-26.309-24.971-26.309-36.788c0-15.342 14.593-32.624 28.985-41.47c27.675-17.01 72.425-17.077 98.548-5.798c10.175 4.394 23.236 11.3 18.843 21.475c-4.394 10.174-22.146 14.164-32.24 9.588c-18.621-8.442-41.37-6.813-50.433-1.669c-5.86 3.326-27.04 24.423 22.874 33.448c16.55 2.993 36.733 6.35 50.544 13.634c27.317 14.407 33.803 35.994 32.998 49.943c-1.338 23.188-15.95 37.066-31.66 47.713c-15.249 10.334-36.781 14.564-56.739 14.564c-36.185.001-66.113-8.767-74.14-12.557c-10.021-4.732-18.06-11.817-12.262-26.978m310.23 145.702s-8.4 19.067-27.095 19.067H58.7c-18.694 0-27.095-19.067-27.095-19.067l-5.728-52.894c1.234 8.63 7.275 21.125 31.988 21.125H447.6c26.082 0 32.593-14.651 34.22-23.061z"></svg:path>`,
})
export class FileIconsSublimeIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSvelteIcon],svg[file-icons-svelte-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M403.508 229.23C491.235 87.7 315.378-58.105 190.392 23.555L71.528 99.337c-57.559 37.487-82.55 109.513-47.45 183.53c-87.761 133.132 83.005 289.03 213.116 205.762l118.864-75.782c64.673-42.583 79.512-116.018 47.45-183.616m-297.592-80.886l118.69-75.739c77.973-46.679 167.756 34.942 135.388 110.992c-19.225-15.274-40.65-24.665-56.923-28.894c6.186-24.57-22.335-42.796-42.174-30.106l-118.95 75.48c-29.411 20.328 1.946 62.138 31.014 44.596l45.33-28.895c101.725-57.403 198 80.425 103.38 147.975l-118.692 75.739C131.455 485.225 34.11 411.96 67.592 328.5c17.786 13.463 36.677 23.363 56.923 28.894c-4.47 28.222 24.006 41.943 42.476 30.365L285.64 312.02c29.28-21.955-2.149-61.692-30.97-44.595l-45.504 28.894c-100.56 58.77-199.076-80.42-103.25-147.975"></svg:path>`,
})
export class FileIconsSvelteIcon {
  readonly viewBox = input("0 0 426 512")
  readonly width = input("0.84em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSwaggerIcon],svg[file-icons-swagger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsSystemverilogIcon],svg[file-icons-systemverilog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M19.316 366.603v-216.77c0-12.03 9.752-21.781 21.781-21.781h429.805c12.029 0 21.781 9.752 21.781 21.781v216.77c0 12.029-9.752 21.781-21.781 21.781H41.097c-12.029 0-21.782-9.752-21.782-21.781zm436.648-246.901V70.791h-68.957v48.911zM387.007 398.11v43.844h68.957V398.11zm53.455-336.993L436.118 0h-28.52l-5.089 61.117h37.954zm-37.953 389.767L407.598 512h28.52l4.344-61.116h-37.954zm-55.816-331.182V70.791h-68.957v48.911zM277.736 398.11v43.844h68.957V398.11zm53.456-336.993L326.848 0h-28.52l-5.089 61.117h37.954zm-37.954 389.767L298.327 512h28.52l4.344-61.116h-37.954zm-55.816-331.182V70.791h-68.957v48.911zM168.465 398.11v43.844h68.957V398.11zm53.456-336.993L217.576 0h-28.52l-5.089 61.117zm-37.954 389.767L189.056 512h28.52l4.345-61.116zm-55.816-331.182V70.791H59.194v48.911zM59.194 398.11v43.844h68.957V398.11zM112.65 61.117L108.306 0h-28.52l-5.089 61.117h37.954zM74.696 450.884L79.785 512h28.52l4.344-61.116zm315.695-149.732c-61.562 69.633-250.387 63.673-286.051-16.529H64.43c28.446 104.449 268.202 108.749 325.961 16.53m57.179-70.65c-28.446-104.449-268.202-108.75-325.961-16.53c61.562-69.632 250.387-63.672 286.051 16.53zm-276.66 51.322c.64 0 1.12.16 1.12 1.28c.32 4.96 2.56 11.84 6.4 18.08c4.64 7.36 12.48 10.88 20.16 10.88s20-5.12 20-17.76c0-13.28-2.56-17.12-23.36-24.961c-4.8-1.76-15.04-6.88-23.2-13.92c-5.6-4.96-8-13.44-8-22.72c0-9.76 2.4-16.32 12-23.52c7.2-5.44 13.28-7.681 23.04-7.681c11.68 0 17.92 1.92 21.281 3.2c1.6.64 2.72.32 3.68-.8l2.08-2.08q.96-.96 2.4-.96c1.12 0 1.44 1.76 1.6 2.72l2.56 27.36c0 .64-.32.8-.8.96l-3.52 1.12c-.8.32-1.6 0-2.08-1.12c-1.76-4.64-4.48-10.88-9.92-16.64c-4-4.48-8.8-6.72-16-6.72c-12 0-16.96 10.4-16.96 14.56c0 5.92.16 10.72 4.16 14.72c4.16 4.321 13.28 8.16 21.12 10.401c7.68 2.24 13.92 6.24 20.48 12.16c6.24 5.6 8.8 12.64 8.8 23.84c0 19.521-13.92 35.362-35.04 35.362c-14.4 0-21.921-2.4-28.641-6.88c-1.92-1.28-2.88-1.76-3.68-1.76c-.96 0-1.6 1.12-2.56 2.72c-.96 1.76-1.76 1.92-2.88 1.92c-1.76 0-2.4-.8-2.24-2.56l2.56-30.401c.16-1.12.64-1.12 1.28-1.12zm152.848-77.282c0-.8.16-1.12.96-1.12c1.44 0 8.8.48 19.52.48c14.881 0 18.881-.48 20.32-.48c.96 0 1.12.32 1.12 1.44v4c0 .64-.16 1.12-1.12 1.12h-3.68c-2.72 0-7.68 1.12-11.84 8.32c-6.4 10.88-13.28 29.761-19.36 43.2c-4 8.642-22.08 51.522-24.801 56.163c-1.12 1.92-1.92 2.72-3.68 2.72c-2.08 0-2.72-1.92-3.68-4c-5.92-12.64-20.48-51.362-24.96-62.402s-12.48-34.24-14.4-38.72c-1.601-3.681-3.521-5.281-6.881-5.281h-4.16c-.64 0-.8-.8-.8-1.6v-3.84c0-.8.16-1.12 1.12-1.12c1.6 0 6.88.48 26.08.48c16.641 0 23.841-.48 25.28-.48c1.441 0 1.601.48 1.601 1.44v3.68c0 .8-.16 1.44-1.28 1.44h-6.88c-3.84 0-6.88 1.76-6.88 3.84c0 1.28 0 3.2.48 5.44c1.28 5.76 7.36 24.801 10.72 34.081l12.16 35.681h.64c4.64-10.72 12.48-30.721 14.561-36.481c3.04-7.84 8-21.28 10.56-28.48c1.6-4.16 1.6-6.88 1.6-8.8s-1.92-5.281-6.56-5.281h-4.96c-.64 0-.8-.48-.8-1.44z" clip-rule="evenodd"></svg:path>`,
})
export class FileIconsSystemverilogIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTclIcon],svg[file-icons-tcl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTernIcon],svg[file-icons-tern-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestGoIcon],svg[file-icons-test-go-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestJsIcon],svg[file-icons-test-js-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestPerlIcon],svg[file-icons-test-perl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M202.512 385.907H84.692l84.823-141.482h76.918l16.737 27.915c-46.462 38.219-61.507 78.236-60.658 113.567m3.922 27.705H33.914l131.959-218.809V61.975h81.854v132.828l36.916 61.213c5.677-5.533 13.904-9.824 21.857-17.17l-30.81-51.093V61.975h26.075c19.504 0 19.504-27.595 0-27.595h-189.93c-19.504 0-19.504 27.595 0 27.595h26.075v125.778L5.765 406.897c-12.407 21.116-4.619 34.31 21.73 34.31h189.4c-4.28-8.472-7.91-17.734-10.461-27.595m137.871-188.97c-10.294 27.452-30.782 32.25-41.128 42.065c-111.83 67.99-86.088 145.775-52.014 185.2c26.36 30.5 77.66 48.992 82.445 40.577c2.676-7.253-20.315-12.873-29.015-19.584c-49.955-38.535-66.879-92.919-33.972-141.934c33.034-46.623 77.976-76.838 80.916-103.8c1.33-10.437 3.074-25.493 3.218-45.865c0-4.65-7.081-10.146-7.503-7.716c.488 22.093-.708 45.088-2.947 51.057m12.975 9.073c-9.803 62.37-69.121 83.634-68.928 144.196c-1.465 50.712 55.957 112.94 68.501 104c3.393-14.838-36.237-37.532-40.39-99.905c-3.466-52.08 42.765-88.16 45.886-118.278c3.602-14.793 4.434-94.953 2.228-103.721c-1.387-3.005-4.307-8.475-6.656-9.224c-2.077 12.473 1.513 60.735-.64 82.932m66.875 258.67c65.664-26.918 94.867-76.128 86.423-133.023c-6.459-43.523-52.468-71.617-86.423-92.837c-39.064-24.937-43.778-25.142-43.93-74.977c-.363-4.124-10.673-3.588-10.673-3.588c8.523 51.221 1.09 79.747-5.223 103.273c-19.406 72.323-22.916 131.078 4.507 186.454c42.808 5.678 33.109 26.943 55.319 14.697"></svg:path>`,
})
export class FileIconsTestPerlIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestPythonIcon],svg[file-icons-test-python-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestReactIcon],svg[file-icons-test-react-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTestRustIcon],svg[file-icons-test-rust-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTextileIcon],svg[file-icons-textile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M512 96.05c0-13.342-10.77-24.113-24.113-24.113H24.113C10.77 71.937 0 82.707 0 96.05v319.9c0 13.342 10.77 24.113 24.113 24.113h463.774c13.342 0 24.113-10.77 24.113-24.113zM195.557 352.211q-6.029 3.496-13.745 6.51c-5.144 2.09-10.77 3.778-16.879 5.145s-12.458 2.09-19.13 2.09c-14.95 0-26.122-3.859-33.436-11.655c-7.315-7.797-11.092-20.336-11.092-37.697V211.793H73.947V198.37c8.841-5.627 17.683-9.645 27.328-12.057v-27.89c1.607-1.367 6.43-3.457 13.664-6.109s15.432-4.823 24.354-6.43h11.815v44.207h45.011v21.702h-45.01v88.977c0 14.146 1.687 23.952 5.304 29.418c3.537 5.465 9.404 8.198 17.683 8.198c4.1 0 8.761-.321 13.905-.884s9.887-1.688 14.307-3.295l2.412 11.333c-2.09 2.17-5.144 4.34-9.163 6.671m84.797 4.983c-5.546 4.903-12.619 7.395-21.3 7.395c-8.76 0-15.754-2.492-20.978-7.395c-5.305-4.903-7.877-11.494-7.877-19.772s2.652-14.87 7.877-19.934c5.305-5.064 12.298-7.555 20.978-7.555s15.835 2.491 21.3 7.555s8.279 11.735 8.279 19.934c0 8.198-2.733 14.789-8.279 19.772"></svg:path>`,
})
export class FileIconsTextileIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTextmateIcon],svg[file-icons-textmate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTfsIcon],svg[file-icons-tfs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M44.53 42.126c-77.21 74.216-49.38 203.31 47.762 241.273l-21.229 82.217c-42.473-.14-74.826 37.235-69.54 83.027c6.406 55.492 71.834 82.49 117.163 48.066c43.197-32.805 37.457-98.066-7.944-122.373l23.406-84.26c50.353 5.631 73.213-5.189 103.117-29.715L340.209 365.92c-26.791 45.493 2.629 106.356 56.296 112.035c55.55 5.879 96.204-52.064 72.52-103.822c-19.192-41.942-69.073-54.544-104.26-33.41L261.668 234.996c21.753-28.706 33.289-65.47 28.503-104.632l84.072-23.527c18.784 38.102 61.396 60.914 103.364 30.256c46.831-30.448 41.868-104.381-9.141-129.636c-48.61-24.067-100.065 13.45-101.61 64.925l-85.101 23.83C243.247-7.35 119.525-27.929 44.53 42.126m67.323 169.604c-48.066-28.459-48.066-99.994 0-128.453s109.141 7.308 109.141 64.227s-61.074 92.686-109.14 64.226"></svg:path>`,
})
export class FileIconsTfsIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTipeIcon],svg[file-icons-tipe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTortoisesvnIcon],svg[file-icons-tortoisesvn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTsxIcon],svg[file-icons-tsx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m321.957 275.591l47.673 88.816l-50.938 93.387h35.918l35.265-62.694l35.265 62.693h35.918l-50.938-93.387l47.02-88.816h-35.918l-31.346 58.122l-31.346-58.122h-36.571zm-99.266 3.92c38.667-14.191 68.354 3.917 77.06 24.815l-28.081 18.286c-4.152-7.493-13-15.154-23.216-15.702c-9.264-.497-17.876 4.346-18.15 16.874c.55 18.255 24.554 18.253 53.339 36.487c21.087 13.358 25.036 23.568 26.986 42.022c1.445 13.678-1.128 37.311-28.04 49.253c-29.282 12.993-81.244 8.257-99.082-30.977l29.387-16.979c14.694 27.918 52.804 27.851 60.285 9.464c7.307-17.954-14.735-24.974-42.088-37.104c-11.897-6.135-30.306-15.798-35.83-39.408c-4.17-17.817-.45-44.739 27.427-57.034zM512 454.528V57.471C511.32 30.224 493.805.56 454.528 0H57.469C27.102-.228.403 23.534 0 57.471v397.058c.404 33.937 27.102 57.698 57.47 57.47h397.058c39.276-.56 56.791-30.223 57.472-57.47m-30.044 0c-.257 10.97-5.691 25.19-27.428 26.776H57.469c-14.287-.112-26.453-9.789-26.776-26.776V57.471c.322-16.986 12.488-26.663 26.776-26.776h397.059c21.738 1.586 27.17 15.805 27.428 26.776zM176.183 312.305H130.61v145.49H94.039v-145.49H48.466v-36.572h127.717z"></svg:path>`,
})
export class FileIconsTsxIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTsxAltIcon],svg[file-icons-tsx-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M454.528.001H57.469C27.102-.228.403 23.534 0 57.471v397.058c.404 33.937 27.102 57.698 57.47 57.47h397.058c39.276-.56 56.791-30.223 57.472-57.47V57.471C511.32 30.224 493.805.56 454.528 0M170.433 308.45h-48.83v155.887H82.417V308.45h-48.83v-39.185h136.845zm114.01 149.193c-31.375 13.921-87.05 8.847-106.163-33.191l31.487-18.193c15.744 29.913 56.577 29.842 64.593 10.14c7.829-19.236-15.787-26.758-45.095-39.755c-12.747-6.574-32.472-16.927-38.392-42.224c-4.467-19.09-.481-47.937 29.388-61.11l.004.002c41.429-15.204 73.237 4.198 82.567 26.59l-30.09 19.592c-4.448-8.028-13.928-16.237-24.873-16.824c-9.926-.533-19.154 4.657-19.448 18.08c.589 19.56 26.308 19.557 57.15 39.094c22.594 14.313 26.826 25.253 28.915 45.026c1.548 14.655-1.209 39.977-30.044 52.773m152.738 6.693l-37.786-67.173l-37.785 67.174h-38.485l54.579-100.06l-51.08-95.164l.002-.001h39.184l33.586 62.275l33.587-62.275h38.485l-50.38 95.163l54.578 100.06z"></svg:path>`,
})
export class FileIconsTsxAltIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTwigIcon],svg[file-icons-twig-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsTxlIcon],svg[file-icons-txl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M481.4 510.44a14.1 14.1 0 0 1-6.447 1.56c-5.156 0-10.128-2.821-12.637-7.727l-137.99-269.75l-37.039 53.202a14.17 14.17 0 0 1-11.652 6.08c-2.797 0-5.621-.825-8.09-2.544c-6.43-4.476-8.012-13.314-3.537-19.743l45.68-65.612l-81.474-159.27l-91.336 198.379c-3.276 7.114-11.698 10.226-18.814 6.951s-10.227-11.699-6.952-18.814L214.66 8.25a14.183 14.183 0 0 1 25.509-.527l247.399 483.632c3.568 6.974.806 15.518-6.168 19.085M152.158 348.335c-4.242-7.767-15.185-5.622-22.74-6.04c-20.173-1.116-39.992-.77-60.169-1.082c-10.294-.16-50.147-10.318-46.087 13.418c2.502 14.626 34.395 11.432 44.906 11.393c-3.467 25.441-5.498 51.16-8.593 76.659c-.994 8.182-7.702 25.688-1.522 32.167c9.555 10.015 21.297-3.01 24.266-11.777c2.99-8.83 2.606-19.235 3.981-28.447c2.126-14.239 3.399-28.566 4.86-42.882c.633-6.209.65-12.909 2.066-18.983c1.554-6.674-.466-5.858 6.199-7.048c12.13-2.167 26.438 1.866 38.854 1.866c9.124 0 18.994-10.062 13.98-19.244m126.873 10.457c6.842-6.473 6.536-19.301-4.49-20.48c-4.748-.507-8.335 2.62-11.97 5.332c-17.369 12.955-31.416 31.075-46.141 46.817c-5.77-9.325-42.597-78.003-56.107-42.85c-4.06 10.567 11.52 24.826 16.828 33.39c3.079 4.968 6.382 9.75 9.614 14.622c1.494 2.251 7.095 8.692 7.523 11.716c.682 4.826-3.065 6.58-7.028 10.277c-11.989 11.184-24.025 22.314-36.238 33.252c-7.057 6.32-29.818 23.605-12.045 31.738c12.538 5.738 26.826-13.668 34.793-20.936c11.395-10.396 22.847-20.724 34.073-31.304c8.357 14.856 15.905 39.893 29.573 50.567c5.872 4.587 12.085 5.415 18.161.324c8.698-7.289 4.695-14.47-.202-22.616c-5.836-9.708-11.571-19.389-16.953-29.362c-2.076-3.845-6.334-9.04-7.25-13.401q-5.569-5.197 1.635-8.655q3.697-3.84 7.36-7.71c12.92-13.67 25.226-27.735 38.864-40.721c2.709-2.562-9.677 9.215 0 0m83.246 115.05c7.257-3.014 13.773-12.2 8.26-19.86c-5.075-7.05-14.086-3.134-20.78-1.35c-16.078 4.282-32.757 8.117-49.474 8.397c8.341-35.238 18.16-70.633 22.984-106.592c1.144-8.528 1.427-17.915-9.59-18.252c-6.113-.186-11.312 4.028-13.948 9.234c-4.297 8.488-4.323 21.89-6.1 31.173a1625 1625 0 0 1-5.255 26.315c-3.646 17.476-7.708 34.853-11.846 52.218c-1.69 7.089-5.546 16.773-1.316 23.624c6.861 11.114 26.714 6.964 37.313 5.725c16.556-1.936 34.208-4.273 49.752-10.631c5.729-2.38-7.76 3.174 0 0"></svg:path>`,
})
export class FileIconsTxlIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsUnibeautifyIcon],svg[file-icons-unibeautify-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsUrwebIcon],svg[file-icons-urweb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsV8Icon],svg[file-icons-v8-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsV8TurbofanIcon],svg[file-icons-v8-turbofan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsVelocityIcon],svg[file-icons-velocity-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsVerilogIcon],svg[file-icons-verilog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.316 346.604V169.833c0-12.03 9.752-21.781 21.781-21.781h429.806c12.03 0 21.78 9.752 21.78 21.781v176.77c0 12.03-9.751 21.782-21.78 21.782H41.097c-12.03 0-21.78-9.752-21.78-21.781M468.06 192c0-10.686-8.662-19.349-19.349-19.349s-19.348 8.663-19.348 19.35c0 10.685 8.662 19.348 19.348 19.348s19.35-8.663 19.35-19.349m-12.096-52.298V90.791h-68.957v48.911zM387.007 378.11v43.843h68.957V378.11zm53.455-296.994L436.118 0h-28.52l-5.09 81.116zM402.51 430.884L407.597 512h28.52l4.345-81.116zm-55.816-291.182V90.791h-68.957v48.911zM277.736 378.11v43.843h68.957V378.11zm53.455-296.994L326.847 0h-28.52l-5.09 81.116zm-37.953 349.768L298.326 512h28.52l4.345-81.116zm-55.816-291.182V90.791h-68.957v48.91zM168.465 378.11v43.843h68.957V378.11zM221.92 81.116L217.576 0h-28.52l-5.089 81.116zm-37.953 349.768L189.056 512h28.52l4.344-81.116zM128.15 139.702V90.791H59.194v48.91zM59.195 378.11v43.843h68.956V378.11zM112.65 81.116L108.305 0h-28.52l-5.089 81.116zM74.696 430.884L79.785 512h28.52l4.344-81.116z"></svg:path>`,
})
export class FileIconsVerilogIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsVideoIcon],svg[file-icons-video-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M292.571 384H219.43v-73.143h73.142zm73.143-62.407l-41.927-41.951a18.23 18.23 0 0 0-12.93-5.356H201.143c-10.1 0-18.286 8.186-18.286 18.285v109.715c0 4.76 1.819 9.094 4.798 12.347l42.52 42.51H164.57c-10.099 0-18.285-8.186-18.285-18.286V256c0-10.1 8.186-18.286 18.285-18.286h182.86c10.099 0 18.285 8.187 18.285 18.286zM475.43 384l-36.572-36.571l.047-73.191l36.525-36.525zM274.244 96.35c-24.325 14.025-24.325 49.275 0 63.3c24.326 14.024 54.899-3.602 54.899-31.65s-30.573-45.674-54.899-31.65M475.43 201.143l-73.143 73.143v-36.572c0-17.5-12.295-32.12-28.715-35.716c17.834-19.51 28.715-45.482 28.715-73.997c0-60.594-49.12-109.715-109.715-109.715c-57.784 0-105.134 44.673-109.4 101.367c-19.448-17.542-45.204-28.224-73.457-28.224C49.121 91.429 0 140.549 0 201.144c0 60.593 49.121 109.713 109.714 109.713H73.143V384h36.571v73.143c0 20.198 16.373 36.571 36.572 36.571h219.428c20.199 0 36.572-16.373 36.572-36.571V420.57l73.143 73.143H512v-292.57zm-329.144 0c0-28.048-30.135-44.886-54.899-31.65c-27.322 14.605-25.533 65.4 18.328 68.221v36.57C29.015 271.71 12.667 172 73.06 137.845c48.882-27.646 109.797 7.202 109.797 63.299zm109.633-9.844c-48.652-28.048-48.652-98.55 0-126.598S365.715 71.903 365.715 128s-61.145 91.348-109.797 63.3"></svg:path>`,
})
export class FileIconsVideoIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsVmwareIcon],svg[file-icons-vmware-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWaltIcon],svg[file-icons-walt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWarcraftIiiIcon],svg[file-icons-warcraft-iii-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m212.144 306.74l48.385-192.837l47.846 189.475l28.221-163.118c3.351-23.288-.605-26.502-11.636-35.909l109.15.184c-12.344 10.647-22.078 25.962-30.618 48.625c-15.722 71.424-30.253 147.804-42.043 227.618c-2.347 12.998.92 26.223 13.031 39.805H273.124c4.47-13.13 4.738-27.626 2.414-42.964l-14.55-81.296s-18.956 80.243-20.22 94.354c-1.49 16.636 6.47 29.906 6.47 29.906H144.221c21.119-17.16 20.727-22.956 14.54-51.81c-14.697-70.744-33.114-145.62-55.522-224.932c-2.317-24.852-24.089-40.438-24.089-40.438h103.357s-7.766 24.642-.816 58.129c6.785 43.321 17.693 92.867 30.452 145.209M115.07 81.466V45.17c3.118-8.53 13.648-18.639 25.942-28.564V11.28H0v5.09c13.57 11.328 25.858 23.179 25.887 30.696V465.02c0 6.297-14.284 21.926-25.887 29.638v6.062h140.372v-5.394c-5.054-3.803-27.776-21.084-26.036-32.536V264.23L81.804 138.049c-1.946-8.672-7.328-17.399-18.639-26.221c-12.637-11.69.366-31.859 11.55-30.363zm319.952-1.131c15.858 0 26.575 19.7 13.689 32.587c-13.907 12.887-20.893 27.181-22.839 35.853c-9.108 38.374-18.112 86.4-27.076 138.098l.978 174.36c1.74 11.452-21.96 30.292-27.014 34.095v5.394H512v-6.063c-11.603-7.71-25.887-23.34-25.887-29.637V47.065c.029-7.517 12.317-19.368 25.887-30.697V11.28H372.12v5.326c12.294 9.925 22.824 20.035 25.942 28.565v35.164zM300.57 46.749c1.264-8.214 14.48-21.35 26.775-31.276V11.28H186.333v5.09c13.57 11.328 27.044 22.798 27.044 33.54l-.947 172.805l29.16-117.586c5.802-18.539 29.312-18.79 35.435-.38l29.232 117.966c.212-43.025-2.406-107.214-5.687-175.965M214.7 434.095v30.927c-4.107 11.69-16.27 22.43-26.537 30.012v5.055h141.03v-5.055c-11.028-6.985-20.348-15.133-28.248-28.432v-32.507z"></svg:path>`,
})
export class FileIconsWarcraftIiiIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWatchmanIcon],svg[file-icons-watchman-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M492.784 351.932c-30.597 75.382-96.33 136.816-187.153 154.837c-127.539 25.304-241.804-47.441-286.108-153.433c17.22-16.146 48.53-49.366 81.291-80.98c48.267 45.898 102.808 90.765 155.494 90.765c52.078 0 107.647-43.654 156.404-91.131c28.291 27.003 57.194 58.094 80.072 79.942m-65.348-93.516c26.656 26.925 51.685 54.184 72.469 73.73c15.015-47.609 16.463-99.514 2.021-148.91c-21.037 19.988-47.184 47.598-74.49 75.18m-214.11-31.403v59.445l37.49 20.073c3.653 1.915 9.009 1.937 12.682.06l35.459-19.3v-59.279l-37.458-18.662c-3.673-1.878-9.03-1.856-12.683.06zm-113.03 17.928c48.155-46.202 103.502-93.23 156.012-93.23c51.962 0 107.4 45.12 156.079 92.77c28.285-28.57 58.943-60.279 82.401-82.169c-10.36-26.451-25.533-51.87-45.904-75.15C322.43-57.356 87.828-14.452 18.324 161.647c16.779 16.098 48.348 50.878 81.973 83.294m155.013-73.237c46.409 0 92.806 39.269 143.107 86.712c-45.56 44.92-92.387 84.712-142.108 84.712c-48.28 0-97.938-42.848-141.994-84.75c43.895-42.203 92.723-86.674 140.995-86.674m9.979 17.65c-6.737-2.079-17.143-1.657-20.12 0c0 0-35.46 17.94-43.974 22.124s-7.24 15.114-7.24 15.114l.138 62.457c0 6.298 1.644 9.558 6.569 13.004l45.272 22.798c6.044 2.619 17.642 2.333 21.537.453l42.978-21.779c5.476-4.144 8.24-7.873 8.375-11.198v-65.553c.066-5.899-3.017-11.342-10.833-15.569zm-179.39 69.573c-32.322-31.601-59.393-61.628-74.785-76.586c-15.81 52.17-14.068 104.035.9 150.651c15.535-14.65 42.188-43.075 73.884-74.065"></svg:path>`,
})
export class FileIconsWatchmanIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWebglIcon],svg[file-icons-webgl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWebhintIcon],svg[file-icons-webhint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWixIcon],svg[file-icons-wix-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M507.522 65.853c5.526-9.86 7.72-17.573-4.068-16.272h-74.24c-20.53-1.15-49.286 26.22-77.29 58.985c-11.51-31.249-26.467-57.09-57.968-56.951H208.84s-26.848-.405-48.217 56.03c-7.647-16.704-52.62-52.708-67.475-58.056C78.292 44.24 16.975 45.62 6.15 48.564c-10.825 2.942-4.068 12.204-4.068 12.204c19.053 21.696 77.883 164.908 150.38 199.372l-99.53 185.045c-7.272 9.95-5.462 16.918 5.593 20.848l88.986-1.525c20.259-2.739 34.608-12.946 44.747-28.476l64.466-97.164l73.844 106.826c10.762 11.672 30.48 16.656 39.153 16.78h80.85c11.961-.67 14.82-2.606 12.204-13.22L360.845 260.18C440.91 218.4 478.504 102.013 507.522 65.853M294.758 98.315l28.763-.277c-7.049 9.271-16.897 13.633-29.593 12.999zm13.305 21.085c11.607 2.177 14.879 7.432 12.22 30.842s-29.56 15.072-30.82 1.856c-1.258-13.215 6.992-34.876 18.6-32.698m-30.819 45.197c-.92 9.755-1.746 20.173-21.531 21.92c-22.242 1.962-23.472-20.174-23.472-20.174c20.368 14.16 32.214 11.364 45.003-1.746m-61.57-66.282l.83 12.722c-12.697.634-22.544-3.728-29.593-12.999zm5.294 53.783c-1.259 13.216-28.161 21.554-30.82-1.856s.613-28.665 12.22-30.842c11.608-2.178 19.859 19.483 18.6 32.698m112.907 103.759s94.59 164.705 99.408 179.16c-30.51 11.525-78.774 9.214-97.08-9.092c-18.305-18.305-75.807-124.133-75.807-124.133l-84.114 124.133c-9.62 14.734-18.818 15.283-35.92 17.689l-66.416-.03l59.048-106.99c65.765-93.562 123.377-116.585 191.591-140.341c48.039-16.73 85.923-30.016 130.535-71.979c-19.322 38.137-73.772 106.81-121.245 131.583"></svg:path>`,
})
export class FileIconsWixIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWolframIcon],svg[file-icons-wolfram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsWurstIcon],svg[file-icons-wurst-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M134.843 132.458c1.367 5.072 18.942-1.333 24.487 8.5c2.032 9.271-17.977 2.916-24.401 16.328c30.723 28.768 11.7 44.511 9.372 75.503c-2.713 21.479-4.34 48.502 23.599 55.876c21.958 5.801 29.736-29.005 43.136-41.88c29.7-30.897 48.975-28.65 72.972-12.716c21.695 15.329 31.804 33.183 47.384 50.649c23.277 14 37.288-14.428 38.038-32.67c2.448-42.71-10.514-42.424-8.281-64.577c1.32-19.456 16.243-26.358 16.242-30.664c-.09-10.493-33.468-8.941-29.913-16.712s17.141-3.658 23.971-6.028c5.225-1.812 8.244-5.471 12.405-8.079c9-12.013 17.028-24.866 21.702-21.39c15.588 11.758-12.78 28.774-3.382 40.811c3.784 6.96 18.876-8.224 37.379 16.19c29.076 46.088 27.425 75.774 25.567 106.516c-4.092 62.454-50.9 133.596-121.584 137.477c-60.052 1.123-50.182-32.841-75.122-50.08c-24.842-20.427-43.118 27.546-60.625 41.5c-26.44 20.985-70.057 8.454-94.849-9.188c-63.047-48.933-81.463-130.478-55.654-199.351c6.79-18.257 15.559-36.828 36.528-39.72c11.826-1.635 21.14.518 20.649-6.884c-4.748-13.57-18.8-32.865-6.59-35.66c8.37 3.93 21.81 19.878 26.97 26.249m-7.132 345.089c-170.281-98.17-170.281-344.925 0-443.094S512 59.662 512 256S297.993 575.716 127.711 477.547"></svg:path>`,
})
export class FileIconsWurstIcon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsX10Icon],svg[file-icons-x10-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M440.123 332.944c2.76 8.147 4.147 20.704 4.147 37.671c0 16.179-1.388 28.56-4.147 37.132c-2.775 8.585-8.6 12.878-17.493 12.878c-8.877 0-14.762-4.293-17.638-12.878c-2.862-8.571-4.293-20.953-4.293-37.132q0-25.45 4.293-37.671c2.876-8.163 8.76-12.236 17.638-12.236c8.892 0 14.718 4.073 17.493 12.236M512 0v512H0V0zM281.657 380.5l-88.936-150.708l88.75-146.51h-40.959l-68.737 116.774L103.98 83.281H60.938l87.413 148.511L58.275 380.5h40.752l70.27-118.965L238.419 380.5zm75.553-81.636h-24.998l-26.516 24.852v18.835h20.85v97.1h30.664zm117.927 71.751c0-23.245-3.913-41.176-11.71-53.791c-7.812-12.63-21.406-18.938-40.797-18.938c-19.376 0-32.984 6.307-40.782 18.938c-7.811 12.615-11.71 30.546-11.71 53.791c0 23.246 3.899 41.132 11.71 53.69c7.798 12.557 21.406 18.835 40.782 18.835c19.39 0 32.985-6.278 40.797-18.835c7.797-12.558 11.71-30.444 11.71-53.69"></svg:path>`,
})
export class FileIconsX10Icon {
  readonly viewBox = input("0 0 512 512")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsYamlAlt3Icon],svg[file-icons-yaml-alt3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsYaraIcon],svg[file-icons-yara-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsYarnIcon],svg[file-icons-yarn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsYorickIcon],svg[file-icons-yorick-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsZbrushIcon],svg[file-icons-zbrush-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fileIconsZimplIcon],svg[file-icons-zimpl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
