...
@Component({
  standalone: true,
  selector: 'svg[meteoconsTimeLateAfternoonFillIcon],svg[meteocons-time-late-afternoon-fill-icon]',
  host: {
    role: 'img',
