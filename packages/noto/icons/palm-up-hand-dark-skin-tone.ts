...
@Component({
  standalone: true,
  selector: 'svg[notoPalmUpHandDarkSkinToneIcon],svg[noto-palm-up-hand-dark-skin-tone-icon]',
  host: {
    role: 'img',
