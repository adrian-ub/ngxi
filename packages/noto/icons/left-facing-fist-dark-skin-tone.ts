...
@Component({
  standalone: true,
  selector: 'svg[notoLeftFacingFistDarkSkinToneIcon],svg[noto-left-facing-fist-dark-skin-tone-icon]',
  host: {
    role: 'img',
