...
@Component({
  ...
  template: `<svg:path fill="currentColor" d="M4 7a1 1 0 0 0 0 2h2.22l2.624 10.5c.223.89 1.02 1.5 1.937 1.5h12.47c.903 0 1.67-.6 1.907-1.47L27.75 10h-2.094l-2.406 9H10.78L8.157 8.5A1.984 1.984 0 0 0 6.22 7zm18 14c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m-9 0c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m3-14v3h-3v2h3v3h2v-3h3v-2h-3V7zm-3 16c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1m9 0c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1"></svg:path>`,
})
export class Icons8AddShoppingCartIcon {
...
@Component({
  standalone: true,
  selector: 'svg[icons8AlignCenterIcon],svg[icons8-align-center-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8AlignCenterIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
export class Icons8AlignJustifyIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8AlignRightIcon],svg[icons8-align-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8AlphabeticalSortingIcon],svg[icons8-alphabetical-sorting-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8AlphabeticalSorting2Icon],svg[icons8-alphabetical-sorting-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 5v2h5.563L5.28 12.28l-.28.314V15h8v-2H7.437l5.282-5.28l.28-.314V5zm17 0v18.688l-2.594-2.594L18 22.5l4.28 4.313l.72.687l.72-.688L28 22.5l-1.406-1.406L24 23.687V5zM8.187 17l-.218.656L6.03 23H6v.063l-.938 2.593l-.062.157V27h2v-.844L7.406 25h3.188L11 26.156V27h2v-1.188l-.063-.156L12 23.063V23h-.03l-1.94-5.344L9.814 17H8.185zM9 20.656L9.844 23H8.156z"></svg:path>`,
})
export class Icons8AlphabeticalSorting2Icon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BabysRoomIcon],svg[icons8-babys-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3v2c1.496 0 2.298.52 2.688 1.094c-4.284.58-7.665 3.948-8.407 8.218C5.025 14.67 4 15.636 4 17s1.024 2.33 2.28 2.688C7.098 24.387 11.1 28 16 28s8.903-3.61 9.72-8.313C26.975 19.33 28 18.366 28 17c0-1.32-.963-2.26-2.156-2.656c-.75-3.958-3.718-7.142-7.563-8.063c.132-.17.267-.28.72-.28V4c-1.092 0-1.954.546-2.406 1.188c-.03.04-.036.084-.063.125C15.79 4.006 14.203 3 12 3m4 5c4.093 0 7.464 3.106 8 7.125l.125.875H25c.555 0 1 .445 1 1s-.445 1-1 1h-1l-.094.875C23.46 22.88 20.093 26 16 26s-7.46-3.12-7.906-7.125L8 18H7c-.555 0-1-.445-1-1s.445-1 1-1h1l.094-.875C8.54 11.12 11.907 8 16 8m-3.5 8a1.5 1.5 0 1 0 .001 3.001A1.5 1.5 0 0 0 12.5 16m7 0a1.5 1.5 0 1 0 .001 3.001A1.5 1.5 0 0 0 19.5 16"></svg:path>`,
})
export class Icons8BabysRoomIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BanknotesIcon],svg[icons8-banknotes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8BarChartIcon],svg[icons8-bar-chart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8BarChartIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BarcodeIcon],svg[icons8-barcode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8BarcodeIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BedIcon],svg[icons8-bed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 6C4.355 6 3 7.355 3 9v6.78c-.61.552-1 1.342-1 2.22v9h5v-2h18v2h5v-9c0-.878-.39-1.668-1-2.22V9c0-1.645-1.355-3-3-3zm0 2h20c.555 0 1 .445 1 1v6h-2v-1c0-1.645-1.355-3-3-3h-4c-.767 0-1.467.3-2 .78a3 3 0 0 0-2-.78h-4c-1.645 0-3 1.355-3 3v1H5V9c0-.555.445-1 1-1m4 5h4c.555 0 1 .445 1 1v1H9v-1c0-.555.445-1 1-1m8 0h4c.555 0 1 .445 1 1v1h-6v-1c0-.555.445-1 1-1M5 17h22c.555 0 1 .445 1 1v7h-1v-2H5v2H4v-7c0-.555.445-1 1-1"></svg:path>`,
})
export class Icons8BedIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BinocularsIcon],svg[icons8-binoculars-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8BitcoinIcon],svg[icons8-bitcoin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3v3H8v20h4v3h2v-3h2v3h2v-3h1.5c3.026 0 5.5-2.474 5.5-5.5a5.52 5.52 0 0 0-2.875-4.844A5.52 5.52 0 0 0 24 11.5C24 8.474 21.526 6 18.5 6H18V3h-2v3h-2V3zm-2 5h8.5c1.944 0 3.5 1.556 3.5 3.5S20.444 15 18.5 15H10zm0 9h9.5c1.944 0 3.5 1.556 3.5 3.5S21.444 24 19.5 24H10z"></svg:path>`,
})
export class Icons8BitcoinIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BoldIcon],svg[icons8-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 7c2.8 0 5 2.2 5 5c0 1.3-.5 2.4-1.3 3.3c1.9.7 3.3 2.5 3.3 4.7c0 2.8-2.2 5-5 5H7V7zm-7 8h7c1.7 0 3-1.3 3-3s-1.3-3-3-3H9zm0 8h9c1.7 0 3-1.3 3-3s-1.3-3-3-3H9zm7-18H5v22h13c3.9 0 7-3.1 7-7c0-2.1-1-4.1-2.5-5.4c.3-.8.5-1.7.5-2.6c0-3.9-3.1-7-7-7m-5 6h5c.6 0 1 .4 1 1s-.4 1-1 1h-5zm0 8h7c.6 0 1 .4 1 1s-.4 1-1 1h-7z"></svg:path>`,
})
export class Icons8BoldIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8BritishPoundIcon],svg[icons8-british-pound-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8BrushIcon],svg[icons8-brush-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8BuyIcon],svg[icons8-buy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 7a1 1 0 0 0 0 2h2.22l2.624 10.5c.223.89 1.02 1.5 1.937 1.5h12.47c.903 0 1.67-.6 1.907-1.47L27.75 10h-2.094l-2.406 9H10.78L8.157 8.5A1.984 1.984 0 0 0 6.22 7zm18 14c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m-9 0c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m3-14v5h-3l4 4l4-4h-3V7zm-3 16c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1m9 0c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1"></svg:path>`,
})
export class Icons8BuyIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8CancelIcon],svg[icons8-cancel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8CatFootprintIcon],svg[icons8-cat-footprint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8CheckedIcon],svg[icons8-checked-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.8 3 3 8.8 3 16s5.8 13 13 13s13-5.8 13-13c0-1.4-.188-2.794-.688-4.094L26.688 13.5c.2.8.313 1.6.313 2.5c0 6.1-4.9 11-11 11S5 22.1 5 16S9.9 5 16 5c3 0 5.694 1.194 7.594 3.094L25 6.688C22.7 4.388 19.5 3 16 3m11.28 4.28L16 18.563l-4.28-4.28l-1.44 1.437l5 5l.72.686l.72-.687l12-12l-1.44-1.44z"></svg:path>`,
})
export class Icons8CheckedIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronDownRoundIcon],svg[icons8-chevron-down-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m-5.28 7.78l-1.44 1.44l6 6l.72.686l.72-.687l6-6l-1.44-1.44L16 18.064l-5.28-5.282z"></svg:path>`,
})
export class Icons8ChevronDownRoundIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronLeftIcon],svg[icons8-chevron-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m19.75 2.594l-.72.687l-12 12l-.686.72l.687.72l12 12l.72.686l.72-.687l3.593-3.626l.687-.688l-.688-.718L16.375 16l7.688-7.688l.687-.718l-.688-.688L20.47 3.28zm0 2.844l2.188 2.187l-7.688 7.656l-.72.72l.72.72l7.688 7.655l-2.188 2.188L9.187 16z"></svg:path>`,
})
export class Icons8ChevronLeftIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronLeftRoundIcon],svg[icons8-chevron-left-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m1.78 4.28l-6 6l-.686.72l.687.72l6 6l1.44-1.44L13.937 16l5.28-5.28z"></svg:path>`,
})
export class Icons8ChevronLeftRoundIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronRightRoundIcon],svg[icons8-chevron-right-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m-1.78 4.28l-1.44 1.44L18.064 16l-5.282 5.28l1.44 1.44l6-6l.686-.72l-.687-.72z"></svg:path>`,
})
export class Icons8ChevronRightRoundIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronUpIcon],svg[icons8-chevron-up-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ChevronUpRoundIcon],svg[icons8-chevron-up-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m0 6.094l-.72.687l-6 6l1.44 1.44L16 13.937l5.28 5.28l1.44-1.437l-6-6z"></svg:path>`,
})
export class Icons8ChevronUpRoundIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ClipboardIcon],svg[icons8-clipboard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3c-1.26 0-2.152.89-2.594 2H6v23h20V5h-7.406C18.152 3.89 17.26 3 16 3m0 2c.555 0 1 .445 1 1v1h3v2h-8V7h3V6c0-.555.445-1 1-1M8 7h2v4h12V7h2v19H8z"></svg:path>`,
})
export class Icons8ClipboardIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8CodeFileIcon],svg[icons8-code-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 3v26h20V9.594l-.28-.313l-6-6l-.314-.28H6zm2 2h10v6h6v16H8zm12 1.438L22.563 9H20zM16 13l-2 12h2l2-12zm-3.78 2.375l-2.5 3l-.533.625l.532.625l2.5 3l1.56-1.25L11.813 19l1.968-2.375zm7.56 0l-1.56 1.25L20.187 19l-1.97 2.375l1.563 1.25l2.5-3l.532-.625l-.53-.625l-2.5-3z"></svg:path>`,
})
export class Icons8CodeFileIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ColorDropperIcon],svg[icons8-color-dropper-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ControllerIcon],svg[icons8-controller-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 7C9.617 7 4.03 9.063 4.03 9.063l-.593.218l-.062.596l-1.344 10.25c-.363 2.835 1.667 5.48 4.5 5.844c2.64.34 5.01-1.44 5.627-3.97h7.688c.62 2.528 2.986 4.31 5.625 3.97c2.834-.366 4.864-3.01 4.5-5.845l-1.345-10.25l-.063-.594l-.593-.216S22.38 7 16 7m0 2c5.486 0 10.007 1.524 10.75 1.78l1.22 9.626a3.16 3.16 0 0 1-2.75 3.563c-1.763.225-3.368-.99-3.595-2.75l-.03-.346L21.47 20H10.53l-.124.874l-.03.344c-.227 1.762-1.832 2.976-3.595 2.75a3.16 3.16 0 0 1-2.75-3.564l1.22-9.625C5.994 10.524 10.515 9 16 9m-7 3v2H7v2h2v2h2v-2h2v-2h-2v-2zm13 0a1 1 0 1 0 0 2a1 1 0 0 0 0-2m-2 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2m4 0a1 1 0 1 0 0 2a1 1 0 0 0 0-2m-2 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class Icons8ControllerIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8CutIcon],svg[icons8-cut-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 6c-2.197 0-4 1.803-4 4s1.803 4 4 4c.957 0 1.81-.37 2.5-.938l5.22 2.97l-5.158 2.937C7.864 18.374 6.982 18 6 18c-2.197 0-4 1.803-4 4s1.803 4 4 4s4-1.803 4-4c0-.494-.115-.97-.28-1.406L30 9h-4l-10.22 5.844l-6.06-3.438c.072-.194.144-.387.186-.594c.054-.26.094-.537.094-.812c0-2.197-1.803-4-4-4m0 2c1.116 0 2 .884 2 2s-.884 2-2 2s-2-.884-2-2c0-.14.005-.275.03-.406A2 2 0 0 1 6 8m13.094 8.813l-2 1.093L26 23h4zM6 20c1.116 0 2 .884 2 2s-.884 2-2 2s-2-.884-2-2c0-.14.005-.275.03-.406A2 2 0 0 1 6 20"></svg:path>`,
})
export class Icons8CutIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8DiningRoomIcon],svg[icons8-dining-room-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.406 4L17.78 8.594c-1.152 1.153-1.152 3.065 0 4.22L16 14.56l-1.28-1.28l-7.5-7.5l-.72-.688l-.72.687a4.57 4.57 0 0 0 0 6.44l6.282 6.28l-7.78 7.78l1.437 1.44l7.78-7.782l1.188 1.156l.718.718l.688-.718l1.78-1.782l8.407 8.407l1.44-1.44l-9.126-9.093L17.437 16l1.75-1.78h.032l.03.03c1.158 1.1 3.02 1.105 4.156-.03l.094-.126l4.5-4.5l-1.406-1.406L22 12.78c-.435.436-.937.445-1.375.033l5.28-5.313L24.5 6.094l-5.313 5.28c-.412-.437-.403-.94.032-1.374l4.593-4.594zM6.78 8.22l9.69 9.686l-1.064 1.063l-8.187-8.19c-.742-.74-.764-1.676-.44-2.56z"></svg:path>`,
})
export class Icons8DiningRoomIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8Diploma1Icon],svg[icons8-diploma-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8DoctorIcon],svg[icons8-doctor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m8.438 6l-.282.47S5 11.652 5 20v1h6.094A5 5 0 0 0 11 22c0 2.75 2.25 5 5 5s5-2.25 5-5c0-.344-.027-.675-.094-1H27v-1c0-4.61-.776-7.99-1.563-10.22c-.786-2.228-1.625-3.374-1.625-3.374L23.5 6H8.437zm1.218 2h12.72c.145.208.573.732 1.186 2.47c.65 1.84 1.232 4.73 1.344 8.53H20c-.915-1.21-2.376-2-4-2s-3.085.79-4 2H7.094c.228-6.65 2.232-10.43 2.562-11M15 10v2h-2v2h2v2h2v-2h2v-2h-2v-2zm1 9c1.67 0 3 1.33 3 3s-1.33 3-3 3s-3-1.33-3-3s1.33-3 3-3m0 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class Icons8DoctorIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8Download2Icon],svg[icons8-download-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ElectricalIcon],svg[icons8-electrical-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m22 3.594l-4 3.969l-2.28-2.282l-1.44 1.44l.75.75l-5.124 5.124a3.124 3.124 0 0 0 0 4.406l1.844 1.844l-7.47 7.437l1.44 1.44l7.436-7.47L15 22.094a3.124 3.124 0 0 0 4.406 0l5.125-5.125l.75.75l1.44-1.44L24.437 14l3.968-4L27 8.594l-4 3.97L19.437 9l3.97-4zm-5.563 5.28l6.688 6.688L18 20.689c-.388.387-1.206.387-1.594 0l-5.093-5.094c-.388-.388-.388-1.206 0-1.594l5.124-5.125z"></svg:path>`,
})
export class Icons8ElectricalIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8EraserIcon],svg[icons8-eraser-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.906 4.094c-.805-.002-1.64.272-2.28.843v.032l-.032.03L4.906 16.594c-1.212 1.212-1.204 3.184-.062 4.468l.03.032h.032l6 6c1.213 1.212 3.184 1.204 4.47.062v-.03l.03-.032L27 15.5c1.267-1.267 1.306-3.288.094-4.5l-6-6a3.06 3.06 0 0 0-2.188-.906m-.03 2.03c.318 0 .618.088.81.282l6.002 6c.387.388.44 1.154-.094 1.688l-5.032 5.03l-7.656-7.655l5.063-5.033l.03-.03c.253-.21.57-.28.875-.282zm-7.407 6.782l7.655 7.656l-5.094 5.094l-.03.032c-.517.428-1.308.38-1.688 0L6.345 19.75c-.016-.018-.017-.044-.032-.063c-.41-.517-.374-1.313 0-1.687z"></svg:path>`,
})
export class Icons8EraserIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8EuroIcon],svg[icons8-euro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18 4c-4.738 0-8.587 3.887-9.688 9H6v2h2.063c-.023.328-.063.666-.063 1s.04.672.063 1H6v2h2.313c1.1 5.113 4.95 9 9.687 9c2.71 0 5.17-1.303 6.938-3.344l-1.532-1.312C21.954 25.02 20.07 26 18 26c-3.502 0-6.59-2.898-7.625-7H19v-2h-8.97c-.025-.33-.03-.66-.03-1s.005-.67.03-1H19v-2h-8.625C11.41 8.898 14.498 6 18 6c2.07 0 3.954.98 5.406 2.656l1.532-1.312C23.168 5.304 20.708 4 18 4"></svg:path>`,
})
export class Icons8EuroIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8FantasyIcon],svg[icons8-fantasy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8FilmIcon],svg[icons8-film-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8FinishFlagIcon],svg[icons8-finish-flag-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8FinishFlagIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8FireExtinguisherIcon],svg[icons8-fire-extinguisher-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8FolderIcon],svg[icons8-folder-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 3v26h20V15.437l1.72-1.718l.28-.314V3zm2 2h14v8.406l.28.313L24 15.436V27H8zm16 0h2v7.563l-1 1l-1-1z"></svg:path>`,
})
export class Icons8FolderIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8Football2Icon],svg[icons8-football2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8GenderIcon],svg[icons8-gender-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8GenderNeutralUserIcon],svg[icons8-gender-neutral-user-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 5c-3.854 0-7 3.146-7 7c0 2.41 1.23 4.552 3.094 5.813C8.527 19.343 6 22.88 6 27h2c0-4.43 3.57-8 8-8s8 3.57 8 8h2c0-4.12-2.527-7.658-6.094-9.188A7.02 7.02 0 0 0 23 12c0-3.854-3.146-7-7-7m0 2c2.773 0 5 2.227 5 5s-2.227 5-5 5s-5-2.227-5-5s2.227-5 5-5"></svg:path>`,
})
export class Icons8GenderNeutralUserIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8GenderqueerIcon],svg[icons8-genderqueer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M26.594 3.97L23.5 7.06l-2.28-2.28l-1.44 1.437l2.282 2.28l-3.312 3.313c-.79-.524-1.734-.81-2.75-.81s-1.96.286-2.75.813L11.937 10.5l1.782-1.78l-1.44-1.44l-1.78 1.782L7.437 6H11V4H4v7h2V7.437L9.063 10.5L7.28 12.28l1.44 1.44l1.78-1.783l1.313 1.313A4.9 4.9 0 0 0 11 16c0 2.406 1.727 4.438 4 4.906v4.657l-2.28-2.282l-1.44 1.44l4 4l.72.686l.72-.687l4-4l-1.44-1.44L17 25.563v-4.656c2.273-.468 4-2.5 4-4.906c0-1.016-.286-1.96-.813-2.75L23.5 9.937l2.28 2.282l1.44-1.44l-2.282-2.28l3.093-3.094l-1.436-1.437zM16 13c1.67 0 3 1.33 3 3s-1.33 3-3 3s-3-1.33-3-3s1.33-3 3-3"></svg:path>`,
})
export class Icons8GenderqueerIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8GenericSorting2Icon],svg[icons8-generic-sorting-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5v2h2V5zm17 0v18.688l-2.594-2.594L17 22.5l4.28 4.313l.72.687l.72-.688L27 22.5l-1.406-1.406L23 23.687V5zM4 9v2h4V9zm0 4v2h6v-2zm0 4v2h8v-2zm0 4v2h10v-2zm0 4v2h12v-2z"></svg:path>`,
})
export class Icons8GenericSorting2Icon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8GiftIcon],svg[icons8-gift-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 5c-1.645 0-3 1.355-3 3c0 .353.073.684.188 1H4v6h1v13h22V15h1V9h-5.188c.115-.316.188-.647.188-1c0-1.645-1.355-3-3-3c-1.75 0-2.94 1.33-3.72 2.438c-.103.148-.188.292-.28.437c-.092-.145-.177-.29-.28-.438C14.94 6.33 13.75 5 12 5m0 2c.626 0 1.436.67 2.063 1.563c.152.217.13.23.25.437H12c-.565 0-1-.435-1-1s.435-1 1-1m8 0c.565 0 1 .435 1 1s-.435 1-1 1h-2.313c.12-.206.098-.22.25-.438C18.564 7.672 19.375 7 20 7M6 11h20v2h-9v-1h-2v1H6zm1 4h18v11h-8V16h-2v10H7z"></svg:path>`,
})
export class Icons8GiftIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8GoogleWalletIcon],svg[icons8-google-wallet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8GridIcon],svg[icons8-grid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8GroupIcon],svg[icons8-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8HeaderIcon],svg[icons8-header-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8Hospital2Icon],svg[icons8-hospital-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8Hospital2Icon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8IdeaIcon],svg[icons8-idea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ImageFileIcon],svg[icons8-image-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 3v26h20V9.594l-.28-.313l-6-6l-.314-.28H6zm2 2h10v6h6v16H8zm12 1.438L22.563 9H20zM21.094 14a1 1 0 1 0 0 2a1 1 0 0 0 0-2M14 15.594l-.72.687l-4 4l1.44 1.44L14 18.437l2.28 2.28l.72.688l.72-.687L19 19.437l2.28 2.28l1.44-1.437l-3-3l-.72-.686l-.72.687L17 18.563l-2.28-2.28z"></svg:path>`,
})
export class Icons8ImageFileIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8IndentIcon],svg[icons8-indent-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8KeyIcon],svg[icons8-key-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8Lock2Icon],svg[icons8-lock-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8MastercardIcon],svg[icons8-mastercard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8MinusIcon],svg[icons8-minus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m-6 10v2h12v-2z"></svg:path>`,
})
export class Icons8MinusIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8MoonIcon],svg[icons8-moon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8NewsIcon],svg[icons8-news-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5v18c0 2.21 1.79 4 4 4h18c2.21 0 4-1.79 4-4V12h-6V5zm2 2h16v16c0 .73.22 1.41.563 2H7c-1.19 0-2-.81-2-2zm2 2v5h12V9zm2 2h8v1H9zm14 3h4v9c0 1.19-.81 2-2 2s-2-.81-2-2zM7 15v2h5v-2zm7 0v2h5v-2zm-7 3v2h5v-2zm7 0v2h5v-2zm-7 3v2h5v-2zm7 0v2h5v-2z"></svg:path>`,
})
export class Icons8NewsIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8NumberedListIcon],svg[icons8-numbered-list-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m5.97 3l-.314.344S4.9 4 4.406 4v2c.68 0 1.15-.276 1.594-.53V10h2V3zM11 6v2h17V6zm-4.5 6A2.497 2.497 0 0 0 4 14.5v.5h2v-.5c0-.217.283-.5.5-.5s.5.283.5.5l-.03.03l-.064.064l-2.593 2.5l-.313.28V19h5v-2H7.28l.876-.875l.125-.094l-.03-.03c.502-.41.75-1.02.75-1.5A2.5 2.5 0 0 0 6.5 12m4.5 3v2h17v-2zm-7 6v2h1.375l-.25.406l-.125.22V25h1.5c.217 0 .5.283.5.5s-.283.5-.5.5H4v2h2.5C7.883 28 9 26.883 9 25.5c0-1.005-.678-1.696-1.53-2.094l.405-.687l.125-.25V21zm7 3v2h17v-2z"></svg:path>`,
})
export class Icons8NumberedListIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8NumericalSorting12Icon],svg[icons8-numerical-sorting-12-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8NumericalSorting21Icon],svg[icons8-numerical-sorting-21-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.5 5A3.51 3.51 0 0 0 5 8.5V9h2v-.5C7 7.624 7.624 7 8.5 7h1c.876 0 1.5.624 1.5 1.5c0 .456-.353.98-.938 1.344c-1.234.76-2.316 1.244-3.218 1.75c-.452.253-.867.496-1.22.875c-.35.377-.624.95-.624 1.53v1h8v-2H8.437c.736-.378 1.58-.756 2.688-1.438C12.14 10.928 13 9.845 13 8.5C13 6.576 11.424 5 9.5 5zM22 5v18.688l-2.594-2.594L18 22.5l4.28 4.313l.72.687l.72-.688L28 22.5l-1.406-1.406L24 23.687V5zM8.594 17l-.156.78s-.166.576-.563 1.157C7.478 19.52 6.98 20 6 20v2c1.376 0 2.32-.675 3-1.406V27h2V17z"></svg:path>`,
})
export class Icons8NumericalSorting21Icon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8OldTimeCameraIcon],svg[icons8-old-time-camera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8PaypalIcon],svg[icons8-paypal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8PdfIcon],svg[icons8-pdf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8PencilIcon],svg[icons8-pencil-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8PhoneIcon],svg[icons8-phone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8PieChartIcon],svg[icons8-pie-chart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m-1.125 2.063c.04-.005.084.003.125 0v11.343l.28.313l7.783 7.75C21.154 26.06 18.686 27 16 27C9.913 27 5 22.087 5 16c0-5.707 4.32-10.375 9.875-10.938zm2.125 0A10.956 10.956 0 0 1 26.938 15H17zM18.438 17h8.5c-.207 2.294-1.077 4.395-2.47 6.063L18.44 17z"></svg:path>`,
})
export class Icons8PieChartIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8Pin3Icon],svg[icons8-pin-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m20.47 2.563l-.72.75c-1.045 1.15-1.542 2.605-1.656 4.062l-4.063 4.063c-2.47-.44-5.127.253-7.03 2.156l-.72.72l.72.686l4.313 4.313L3 27.593V29h1.406l8.282-8.313l4.218 4.22l.688.718l.718-.72c2.096-2.094 2.69-4.973 2.063-7.56l3.563-3.564c1.737.208 3.513-.293 4.78-1.56l.688-.72l-.687-.72l-7.5-7.5l-.75-.717zm.218 3.062l5.687 5.688c-.825.466-1.716.758-2.625.53l-.563-.155l-.406.406l-4.186 4.187l-.438.44l.188.593c.587 1.762.315 3.75-.844 5.375L9.312 14.5c1.455-1 3.206-1.46 4.844-1.03l.53.155l.408-.406l4.625-4.626l.28-.28v-.408c0-.803.293-1.563.688-2.28z"></svg:path>`,
})
export class Icons8Pin3Icon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8PlusIcon],svg[icons8-plus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m-1 5v5h-5v2h5v5h2v-5h5v-2h-5v-5z"></svg:path>`,
})
export class Icons8PlusIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8PuzzleIcon],svg[icons8-puzzle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 3c-2.21 0-4 1.79-4 4H7v5c-2.21 0-4 1.79-4 4s1.79 4 4 4v5h6c0 2.21 1.79 4 4 4s4-1.79 4-4h6v-7h-2c-1.19 0-2-.81-2-2s.81-2 2-2h2V7h-6c0-2.21-1.79-4-4-4m0 2c1.19 0 2 .81 2 2v2h6v3c-2.21 0-4 1.79-4 4s1.79 4 4 4v3h-6v2c0 1.19-.81 2-2 2s-2-.81-2-2v-2H9v-5H7c-1.19 0-2-.81-2-2s.81-2 2-2h2V9h6V7c0-1.19.81-2 2-2"></svg:path>`,
})
export class Icons8PuzzleIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8QrCodeIcon],svg[icons8-qr-code-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8QuestionMarkIcon],svg[icons8-question-mark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8RecyclingIcon],svg[icons8-recycling-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3.97a3.26 3.26 0 0 0-2.75 1.5l-2.813 4.624l1.72 1.03l2.812-4.593c.54-.805 1.563-.823 2.092 0l3.125 5l-1.5.876L23.313 15V9.687l-1.437.844l-3.125-5.06a3.26 3.26 0 0 0-2.75-1.5zm-5.594 8.124l-4.5 2.594l1.25.75l-2.562 4.218l-.032-.03c-.012.017.012.044 0 .06C3.092 21.916 4.788 25 7.5 25H13v-2H7.5c-1.267 0-1.946-1.25-1.28-2.22l.03-.03v-.03l2.625-4.25l1.53.936v-5.312zm14.656 3.562l-1.718 1.063l2.5 4c.64 1.087-.087 2.28-1.25 2.28H19v-2l-4.906 3L19 27v-2h5.594c2.637 0 4.328-3 2.968-5.313v-.03z"></svg:path>`,
})
export class Icons8RecyclingIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8RefreshIcon],svg[icons8-refresh-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8RemoveUserIcon],svg[icons8-remove-user-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 4c-3.854 0-7 3.146-7 7c0 2.41 1.23 4.552 3.094 5.813C6.527 18.343 4 21.88 4 26h2c0-4.43 3.57-8 8-8c1.376 0 2.654.358 3.78.97A8 8 0 0 0 16 24c0 4.406 3.594 8 8 8s8-3.594 8-8s-3.594-8-8-8a7.98 7.98 0 0 0-4.688 1.53c-.442-.277-.92-.51-1.406-.718A7.02 7.02 0 0 0 21 11c0-3.854-3.146-7-7-7m0 2c2.773 0 5 2.227 5 5s-2.227 5-5 5s-5-2.227-5-5s2.227-5 5-5m10 12c3.326 0 6 2.674 6 6s-2.674 6-6 6s-6-2.674-6-6s2.674-6 6-6m-2.28 2.28l-1.44 1.44L22.563 24l-2.28 2.28l1.437 1.44L24 25.437l2.28 2.28l1.44-1.437L25.437 24l2.28-2.28l-1.437-1.44L24 22.563l-2.28-2.28z"></svg:path>`,
})
export class Icons8RemoveUserIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ResizeFourDirectionsIcon],svg[icons8-resize-four-directions-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8ResizeFourDirectionsIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8RightRoundIcon],svg[icons8-right-round-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 3C8.832 3 3 8.832 3 16s5.832 13 13 13s13-5.832 13-13S23.168 3 16 3m0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 22.087 5 16S9.913 5 16 5m.72 4.594L15.28 11l4 4H9v2h10.28l-4 4l1.44 1.406l5.686-5.687l.72-.72l-.72-.72l-5.687-5.686z"></svg:path>`,
})
export class Icons8RightRoundIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8RotateLeftIcon],svg[icons8-rotate-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8RotateRightIcon],svg[icons8-rotate-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8RupeeIcon],svg[icons8-rupee-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 5v2h4c1.704 0 3.94 1.038 4.72 3H8v2h8.97c-.31 2.61-2.996 4-4.97 4H8v2.47L18.25 27h3.125l-10.813-9H12c3.234 0 6.674-2.39 6.97-6H24v-2h-5.188C18.51 8.816 17.86 7.804 17 7h7V5z"></svg:path>`,
})
export class Icons8RupeeIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8SearchIcon],svg[icons8-search-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.5 3C14.265 3 10 7.265 10 12.5c0 2.25.81 4.307 2.125 5.938L3.28 27.28l1.44 1.44l8.843-8.845C15.192 21.19 17.25 22 19.5 22c5.235 0 9.5-4.265 9.5-9.5S24.735 3 19.5 3m0 2c4.154 0 7.5 3.346 7.5 7.5S23.654 20 19.5 20S12 16.654 12 12.5S15.346 5 19.5 5"></svg:path>`,
})
export class Icons8SearchIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8SensorIcon],svg[icons8-sensor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ServicesIcon],svg[icons8-services-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8SettingsIcon],svg[icons8-settings-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ShareIcon],svg[icons8-share-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8ShekelIcon],svg[icons8-shekel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 5v22h2V7h1c3.877 0 7 3.123 7 7v7h2v-7c0-4.96-4.04-9-9-9zm15 0v20h-1c-3.877 0-7-3.123-7-7v-7h-2v7c0 4.96 4.04 9 9 9h3V5z"></svg:path>`,
})
export class Icons8ShekelIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8ShoppingCartIcon],svg[icons8-shopping-cart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 7a1 1 0 0 0 0 2h2.22l2.624 10.5c.223.89 1.02 1.5 1.937 1.5h11.47c.903 0 1.67-.6 1.907-1.47L27.75 10H11l.5 2h13.656l-1.906 7H11.78L9.157 8.5A1.984 1.984 0 0 0 7.22 7zm17 14c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m-9 0c-1.645 0-3 1.355-3 3s1.355 3 3 3s3-1.355 3-3s-1.355-3-3-3m0 2c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1m9 0c.564 0 1 .436 1 1s-.436 1-1 1s-1-.436-1-1s.436-1 1-1"></svg:path>`,
})
export class Icons8ShoppingCartIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8SpyIcon],svg[icons8-spy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8StripeIcon],svg[icons8-stripe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8StudentIcon],svg[icons8-student-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8SubscriptIcon],svg[icons8-subscript-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8SuperscriptIcon],svg[icons8-superscript-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8SupportIcon],svg[icons8-support-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8TagsIcon],svg[icons8-tags-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m14.594 4l-.313.28l-11 11l-.685.72l.687.72l9 9l.72.686l.72-.687l11-11l.28-.315V4zm.844 2H23v7.563l-10 10L5.437 16zM26 7v2h1v8.156l-9.5 9.438l-1.25-1.25l-1.406 1.406l1.937 1.97l.72.686l.69-.687L28.72 18.31L29 18V7zm-6 1a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class Icons8TagsIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8TextHeightIcon],svg[icons8-text-height-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8TextHeightIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8TextWidthIcon],svg[icons8-text-width-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class Icons8TextWidthIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8TranslationIcon],svg[icons8-translation-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8TrashIcon],svg[icons8-trash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 4c-.522 0-1.06.185-1.438.563S13 5.478 13 6v1H7v2h1v16c0 1.645 1.355 3 3 3h12c1.645 0 3-1.355 3-3V9h1V7h-6V6c0-.522-.185-1.06-.563-1.438C20.06 4.186 19.523 4 19 4zm0 2h4v1h-4zm-5 3h14v16c0 .555-.445 1-1 1H11c-.555 0-1-.445-1-1zm2 3v11h2V12zm4 0v11h2V12zm4 0v11h2V12z"></svg:path>`,
})
export class Icons8TrashIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8TrophyIcon],svg[icons8-trophy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8TurkishLiraIcon],svg[icons8-turkish-lira-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 4v5.906L8 11v2l3-1.094v2L8 15v2l3-1.094V28h1c5.76 0 10.828-3.85 12.344-9.406l.625-2.344l-1.94-.5l-.625 2.313c-1.19 4.36-4.977 7.36-9.406 7.78V15.19L19 13v-2l-6 2.188v-2L19 9V7l-6 2.188V4z"></svg:path>`,
})
export class Icons8TurkishLiraIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8UmbrellaIcon],svg[icons8-umbrella-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 4v2.063C8.988 6.565 4.255 11.47 4.03 16.625c-.004.127-.03.248-.03.375h2c0-.08.088-.278.53-.53c.444-.254 1.158-.47 1.97-.47s1.526.216 1.97.47c.442.252.53.45.53.53h2c0-.012.083-.26.625-.53c.542-.272 1.406-.47 2.375-.47s1.833.198 2.375.47c.542.27.625.518.625.53h2c0-.08.088-.278.53-.53c.444-.254 1.158-.47 1.97-.47s1.526.216 1.97.47c.442.252.53.45.53.53h2q0-.193-.03-.375C27.744 11.47 23.01 6.565 17 6.062V4zm1 4c4.346 0 8.06 2.954 9.438 6.28A6.6 6.6 0 0 0 23.5 14c-1.12 0-2.145.248-2.97.72a4 4 0 0 0-.56.405a4.5 4.5 0 0 0-.69-.438C18.376 14.237 17.24 14 16 14s-2.375.235-3.28.688c-.234.116-.45.28-.658.437c-.006-.006-.024.006-.03 0a4 4 0 0 0-.563-.406c-.826-.473-1.85-.72-2.97-.72c-.694 0-1.344.096-1.94.28C7.94 10.954 11.655 8 16 8m-1 9v8c0 .565-.435 1-1 1s-1-.435-1-1v-1h-2v1c0 1.645 1.355 3 3 3s3-1.355 3-3v-8z"></svg:path>`,
})
export class Icons8UmbrellaIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8UnderlineIcon],svg[icons8-underline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 4v12c0 4.43 3.57 8 8 8s8-3.57 8-8V4h-2v12c0 3.37-2.63 6-6 6s-6-2.63-6-6V4zM6 26v2h20v-2z"></svg:path>`,
})
export class Icons8UnderlineIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8Unlock2Icon],svg[icons8-unlock-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8Upload2Icon],svg[icons8-upload-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8UsDollarIcon],svg[icons8-us-dollar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8UserFemaleIcon],svg[icons8-user-female-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8UserMaleIcon],svg[icons8-user-male-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8VisaIcon],svg[icons8-visa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 6C3.355 6 2 7.355 2 9v14c0 1.645 1.355 3 3 3h22c1.645 0 3-1.355 3-3V9c0-1.645-1.355-3-3-3zm0 2h22c.565 0 1 .435 1 1v14c0 .565-.435 1-1 1H5c-.565 0-1-.435-1-1V9c0-.565.435-1 1-1m14.406 4.375c-1.926 0-2.937.95-2.937 2.156c0 2.183 2.56 1.88 2.56 3c0 .193-.16.627-1.22.627s-1.75-.375-1.75-.375l-.31 1.44s.655.405 1.97.405c1.31 0 3.154-1.008 3.154-2.47c0-1.756-2.563-1.872-2.563-2.655c0-.4.34-.72 1.25-.72c.594 0 1.25.47 1.25.47l.314-1.53s-.87-.345-1.72-.345zm-8.218.125L9.5 17.438s-.084-.428-.125-.688c-.955-2.14-2.5-2.938-2.5-2.938l1.47 5.594h2l2.81-6.906H11.19zm2.687 0l-1.094 6.906h1.846L15.72 12.5zm9.938 0l-3 6.906h1.812l.375-.968h2.313l.187.968h1.656L25.75 12.5zm-18.97.03s3.597 1.105 4.438 3.814l-.623-3.125s-.275-.69-1-.69H4.844zM24.5 14.5l.53 2.594h-1.5z"></svg:path>`,
})
export class Icons8VisaIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[icons8WonIcon],svg[icons8-won-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[icons8XlsIcon],svg[icons8-xls-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
