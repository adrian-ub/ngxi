...
@Component({
  standalone: true,
  selector: 'svg[cuidaBullseyeOutlineIcon],svg[cuida-bullseye-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="bullseye-outline"><svg:g fill="currentColor" class="Vector"><svg:path fill-rule="evenodd" d="M12.26 2.948a1 1 0 0 1-.916 1.079a8 8 0 1 0 8.504 9.527a1 1 0 1 1 1.962.389a10 10 0 1 1-10.63-11.91a1 1 0 0 1 1.08.915" clip-rule="evenodd"></svg:path><svg:path fill-rule="evenodd" d="M11.129 6.976a1 1 0 0 1-.572 1.293a4 4 0 1 0 4.88 5.779a1 1 0 1 1 1.717 1.024a6 6 0 1 1-7.319-8.668a1 1 0 0 1 1.294.572" clip-rule="evenodd"></svg:path><svg:path fill-rule="evenodd" d="M16.26 8.35a1 1 0 0 1-.11 1.41l-3.5 3a1 1 0 1 1-1.3-1.52l3.5-3a1 1 0 0 1 1.41.11" clip-rule="evenodd"></svg:path><svg:path d="M11.5 11a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3"></svg:path><svg:path fill-rule="evenodd" d="m16.627 8.017l1.055.476l.506-.361a2.6 2.6 0 0 1-1.161-1.629l-.506.361zm1.077-4.453a.6.6 0 0 1 .941.395l.324 2.058a.6.6 0 0 0 .311.437l1.84.976a.6.6 0 0 1 .068 1.018l-3 2.14a.6.6 0 0 1-.595.059l-2.532-1.142a.6.6 0 0 1-.351-.492l-.255-2.766a.6.6 0 0 1 .25-.544z" clip-rule="evenodd"></svg:path></svg:g></svg:g>`,
})
export class CuidaBullseyeOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaChatbubbleOutlineIcon],svg[cuida-chatbubble-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaChatbubblesOutlineIcon],svg[cuida-chatbubbles-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="chatbubbles-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M16.094 15.581a.8.8 0 0 0-.529-.022a6.4 6.4 0 0 1-2.039.248c-3.289-.131-5.857-2.71-5.736-5.76s2.886-5.417 6.175-5.287c3.29.13 5.857 2.71 5.736 5.76c-.022.566-.375 1.441-.685 2.115a1.97 1.97 0 0 0-.149 1.225l.439 2.093a.562.562 0 0 1-.763.634zM5.792 9.967c-.17 4.294 3.407 7.67 7.655 7.838a8.4 8.4 0 0 0 2.268-.218l2.068.85c1.901.782 3.902-.883 3.48-2.895l-.433-2.066l.002-.004c.17-.368.364-.82.524-1.28c.146-.42.32-1.006.344-1.593c.17-4.293-3.407-7.668-7.656-7.837S5.962 5.674 5.792 9.967"></svg:path><svg:path d="M5.395 13.053a1 1 0 0 1-.448 1.341c-.177.089-.398.334-.573.802a3.6 3.6 0 0 0-.22 1.318c.002.047.027.184.107.42c.074.216.172.452.27.668c.196.435.268.936.167 1.435l-.062.302l.543-.228a1.55 1.55 0 0 1 1.044-.052c.322.096.67.142 1.033.128a3.08 3.08 0 0 0 2.192-1.02a1 1 0 1 1 1.498 1.325a5.08 5.08 0 0 1-3.611 1.693a5.2 5.2 0 0 1-1.532-.167l-1.465.616c-1.026.43-2.117-.464-1.894-1.555l.294-1.442a.35.35 0 0 0-.03-.212a10 10 0 0 1-.34-.846c-.096-.28-.199-.641-.212-.985a5.6 5.6 0 0 1 .345-2.1c.258-.687.729-1.477 1.552-1.889a1 1 0 0 1 1.342.448"></svg:path></svg:g></svg:g>`,
})
export class CuidaChatbubblesOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaClipboardOutlineIcon],svg[cuida-clipboard-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="clipboard-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M4 7.462C4 5.518 5.62 4 7.545 4H8.5v2h-.955C6.66 6 6 6.686 6 7.462v11.076C6 19.314 6.66 20 7.545 20h8.91C17.34 20 18 19.314 18 18.538V7.462C18 6.686 17.34 6 16.454 6h-1.272V4h1.272C18.381 4 20 5.518 20 7.462v11.076C20 20.482 18.38 22 16.454 22H7.545C5.62 22 4 20.482 4 18.538z"></svg:path><svg:path d="M9.523 2h4.954A2.523 2.523 0 0 1 17 4.523v.954A2.523 2.523 0 0 1 14.477 8H9.523A2.523 2.523 0 0 1 7 5.477v-.954A2.523 2.523 0 0 1 9.523 2m0 2A.523.523 0 0 0 9 4.523v.954c0 .289.234.523.523.523h4.954A.523.523 0 0 0 15 5.477v-.954A.523.523 0 0 0 14.477 4z"></svg:path></svg:g></svg:g>`,
})
export class CuidaClipboardOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaClipboardTextOutlineIcon],svg[cuida-clipboard-text-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="clipboard-text-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M4 7.462C4 5.518 5.62 4 7.545 4H8.5v2h-.955C6.66 6 6 6.686 6 7.462v11.076C6 19.314 6.66 20 7.545 20h8.91C17.34 20 18 19.314 18 18.538V7.462C18 6.686 17.34 6 16.454 6h-1.272V4h1.272C18.381 4 20 5.518 20 7.462v11.076C20 20.482 18.38 22 16.454 22H7.545C5.62 22 4 20.482 4 18.538z"></svg:path><svg:path d="M9.523 2h4.954A2.523 2.523 0 0 1 17 4.523v.954A2.523 2.523 0 0 1 14.477 8H9.523A2.523 2.523 0 0 1 7 5.477v-.954A2.523 2.523 0 0 1 9.523 2m0 2A.523.523 0 0 0 9 4.523v.954c0 .289.234.523.523.523h4.954A.523.523 0 0 0 15 5.477v-.954A.523.523 0 0 0 14.477 4zM8 12a1 1 0 0 1 1-1h5a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1m0 4a1 1 0 0 1 1-1h3.125a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaClipboardTextOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaDashboardOutlineIcon],svg[cuida-dashboard-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaDocumentOutlineIcon],svg[cuida-document-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="document-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M15.143 22H8.286A4.286 4.286 0 0 1 4 17.714V6.286A4.286 4.286 0 0 1 8.286 2h4.008a3.5 3.5 0 0 1 2.304.866l3.635 3.18a3.5 3.5 0 0 1 1.196 2.635v9.033A4.286 4.286 0 0 1 15.143 22m0-2H8.286A2.286 2.286 0 0 1 6 17.714V6.286A2.286 2.286 0 0 1 8.286 4h4.008a1.5 1.5 0 0 1 .987.371l3.635 3.18a1.5 1.5 0 0 1 .513 1.13v9.033A2.286 2.286 0 0 1 15.143 20"></svg:path><svg:path d="M13 3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h2.5a1 1 0 1 1 0 2H15a3 3 0 0 1-3-3V4a1 1 0 0 1 1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaDocumentOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaDocumentTextsOutlineIcon],svg[cuida-document-texts-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="document-texts-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M3 9.612c0-1.563 1.333-2.72 2.837-2.72H9v2H5.837c-.525 0-.837.383-.837.72v9.56c0 .337.312.72.837.72h6.326c.525 0 .837-.383.837-.72v-.288h2v.287c0 1.563-1.333 2.72-2.837 2.72H5.837C4.333 21.892 3 20.735 3 19.172z"></svg:path><svg:path d="M17.2 19h-5.4C9.643 19 8 17.214 8 15.143V5.857C8 3.787 9.643 2 11.8 2h3.022c.867 0 1.703.322 2.347.903l2.675 2.415A3.5 3.5 0 0 1 21 7.918v7.225C21 17.213 19.357 19 17.2 19m0-2h-5.4c-.994 0-1.8-.831-1.8-1.857V5.857C10 4.831 10.806 4 11.8 4h3.022c.372 0 .73.138 1.007.387l2.675 2.416A1.5 1.5 0 0 1 19 7.918v7.225C19 16.169 18.194 17 17.2 17"></svg:path><svg:path d="M11 11a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2h-4a1 1 0 0 1-1-1m0 4a1 1 0 0 1 1-1h2.5a1 1 0 1 1 0 2H12a1 1 0 0 1-1-1m4-12a1 1 0 0 1 1 1v1.997C16 6.551 16.449 7 17.003 7H19a1 1 0 1 1 0 2h-1.997A3.003 3.003 0 0 1 14 5.997V4a1 1 0 0 1 1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaDocumentTextsOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaDownloadOutlineIcon],svg[cuida-download-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="download-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M7 22a5 5 0 0 1-5-5v-3a1 1 0 1 1 2 0v3a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-3a1 1 0 1 1 2 0v3a5 5 0 0 1-5 5z"></svg:path><svg:path d="M17.715 10.9a1 1 0 0 1-.016 1.415l-4.5 4.4a1 1 0 0 1-1.398 0l-4.5-4.4a1 1 0 1 1 1.398-1.43l2.801 2.739V5a1 1 0 1 1 2 0v8.624l2.8-2.739a1 1 0 0 1 1.415.016Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaDownloadOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaEditOutlineIcon],svg[cuida-edit-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="edit-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M2 6.857A4.857 4.857 0 0 1 6.857 2H12a1 1 0 1 1 0 2H6.857A2.857 2.857 0 0 0 4 6.857v10.286A2.857 2.857 0 0 0 6.857 20h10.286A2.857 2.857 0 0 0 20 17.143V12a1 1 0 1 1 2 0v5.143A4.857 4.857 0 0 1 17.143 22H6.857A4.857 4.857 0 0 1 2 17.143z"></svg:path><svg:path d="m15.137 13.219l-2.205 1.33l-1.033-1.713l2.205-1.33l.003-.002a1.2 1.2 0 0 0 .232-.182l5.01-5.036a3 3 0 0 0 .145-.157c.331-.386.821-1.15.228-1.746c-.501-.504-1.219-.028-1.684.381a6 6 0 0 0-.36.345l-.034.034l-4.94 4.965a1.2 1.2 0 0 0-.27.41l-.824 2.073a.2.2 0 0 0 .29.245l1.032 1.713c-1.805 1.088-3.96-.74-3.18-2.698l.825-2.072a3.2 3.2 0 0 1 .71-1.081l4.939-4.966l.029-.029c.147-.15.641-.656 1.24-1.02c.327-.197.849-.458 1.494-.508c.74-.059 1.53.174 2.15.797a2.9 2.9 0 0 1 .845 1.75a3.15 3.15 0 0 1-.23 1.517c-.29.717-.774 1.244-.987 1.457l-5.01 5.036q-.28.281-.62.487m4.453-7.126s-.004.003-.013.006z"></svg:path></svg:g></svg:g>`,
})
export class CuidaEditOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaExpandOutlineIcon],svg[cuida-expand-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M21.392 21.392a1 1 0 0 0 0-1.414l-7.985-7.986a1 1 0 1 0-1.414 1.414l7.985 7.986a1 1 0 0 0 1.414 0" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M21.685 20.685a1 1 0 0 1-1 1h-4.242a1 1 0 1 1 0-2h3.242v-3.242a1 1 0 1 1 2 0zM2.614 2.614a1 1 0 0 1 1.415 0l8.379 8.378a1 1 0 0 1-1.415 1.415L2.614 4.028a1 1 0 0 1 0-1.414" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M3.322 2.322a1 1 0 0 0-1 1v4.242a1 1 0 1 0 2 0V4.322h3.242a1 1 0 0 0 0-2zm-.708 19.07a1 1 0 0 1 0-1.414l8.879-8.878a1 1 0 0 1 1.414 1.414L4.03 21.392a1 1 0 0 1-1.415 0Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M2.321 20.685a1 1 0 0 0 1 1h4.243a1 1 0 1 0 0-2H4.32v-3.242a1 1 0 1 0-2 0zM21.392 2.614a1 1 0 0 0-1.414 0L11.493 11.1a1 1 0 1 0 1.414 1.414l8.485-8.486a1 1 0 0 0 0-1.414" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M20.685 2.322a1 1 0 0 1 1 1v4.242a1 1 0 1 1-2 0V4.322h-3.243a1 1 0 0 1 0-2z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaExpandOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFireOutlineIcon],svg[cuida-fire-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFlagOutlineIcon],svg[cuida-flag-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFolderOpenOutlineIcon],svg[cuida-folder-open-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="folder-open-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M5.323 5C4.593 5 4 5.592 4 6.323v11.354C4 18.407 4.592 19 5.323 19h3.446a1 1 0 0 1 0 2H5.323A3.323 3.323 0 0 1 2 17.677V6.323A3.323 3.323 0 0 1 5.323 3h2.38c.582 0 1.14.236 1.548.654l1.859 1.909c.249.256.59.4.947.4h3.62A3.323 3.323 0 0 1 19 9.285v1.233a1 1 0 0 1-2 0V9.285c0-.73-.592-1.322-1.323-1.322h-3.62a3.32 3.32 0 0 1-2.38-1.005l-1.86-1.91A.16.16 0 0 0 7.703 5z"></svg:path><svg:path d="M10.175 12.3c-.627 0-1.168.44-1.295 1.055L7.712 19.01h10.08c.627 0 1.168-.441 1.295-1.055l.84-4.065c.17-.82-.457-1.59-1.295-1.59zm-3.253.65a3.32 3.32 0 0 1 3.253-2.65h8.457a3.323 3.323 0 0 1 3.254 3.995l-.84 4.065a3.32 3.32 0 0 1-3.254 2.65H5.256z"></svg:path></svg:g></svg:g>`,
})
export class CuidaFolderOpenOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFolderOutlineIcon],svg[cuida-folder-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="folder-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="M2 17V8a4 4 0 0 1 4-4h3.327a3 3 0 0 1 2.02.781L10 6.261A1 1 0 0 0 9.327 6H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-6.4a2 2 0 0 0-2-2h-4.655A2 2 0 0 1 12 8.08l-2-1.82l1.347-1.479L13.345 6.6H18a4 4 0 0 1 4 4V17a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4" class="Vector (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaFolderOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFramerLogoOutlineIcon],svg[cuida-framer-logo-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="framer-logo-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="M5.076 2.617A1 1 0 0 1 6 2h12a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-3.586l4.293 4.293A1 1 0 0 1 18 16h-5v5a1 1 0 0 1-1.707.707l-6-6a1 1 0 0 1-.292-.661M5 14.992V9a1 1 0 0 1 1-1h3.586L5.293 3.707a1 1 0 0 1-.217-1.09M12.414 8H17V4H8.414zm-.828 2H7v4h8.586zM11 16H8.414L11 18.586z" class="Vector (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaFramerLogoOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaFunnelOutlineIcon],svg[cuida-funnel-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="funnel-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M10.42 13.154a.6.6 0 0 0-.197-.443l-4.83-4.356A1.2 1.2 0 0 1 5 7.47V5.192C5 4.534 5.534 4 6.192 4h11.616C18.466 4 19 4.534 19 5.192v2.309c0 .32-.128.625-.356.85l-4.434 4.363a.6.6 0 0 0-.178.425v3.893c0 .19-.09.368-.242.48l-2.42 1.787a.596.596 0 0 1-.95-.48zm5.612.573l4.015-3.951c.61-.6.953-1.42.953-2.275V5.192A3.19 3.19 0 0 0 17.808 2H6.192A3.19 3.19 0 0 0 3 5.192V7.47a3.2 3.2 0 0 0 1.054 2.37l4.365 3.938v5.041c0 2.13 2.424 3.354 4.138 2.089l2.42-1.787a2.6 2.6 0 0 0 1.055-2.089z"></svg:path><svg:path d="M3 7a1 1 0 0 1 1-1h15a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaFunnelOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaGithubLogoOutlineIcon],svg[cuida-github-logo-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaGitlabLogoOutlineIcon],svg[cuida-gitlab-logo-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="gitlab-logo-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="m5.726 4.242l-.003-.013zm.625 1.916l1.372 4.212a1 1 0 0 0 .95.69h6.62a1 1 0 0 0 .951-.691l1.367-4.208l1.373 4.224l.95 2.813l-7.952 5.807l-7.927-5.76L6.35 6.157Zm10.637-1.916l-.004-.013zM5.44 3.053a1.35 1.35 0 0 1 1.844.02c.16.156.28.349.347.563L9.4 9.06h5.167l1.77-5.446a1.34 1.34 0 0 1 .369-.562a1.35 1.35 0 0 1 1.84.02c.162.157.282.35.349.564l1.99 6.126l1.036 3.067a1.686 1.686 0 0 1-.69 1.928a1 1 0 0 1-.149.079l-8.508 6.214a1 1 0 0 1-1.178.002l-8.703-6.326l-.005-.003a1.69 1.69 0 0 1-.603-1.884l2.99-9.225a1.34 1.34 0 0 1 .37-.563l.672.74l-.675-.738Z" class="Vector (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaGitlabLogoOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHeadphoneOutlineIcon],svg[cuida-headphone-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M21.497 9.843c.56 1.691.544 3.517.505 5.088l-.002.094a1 1 0 1 1-2-.05l.003-.093c.039-1.597.031-3.092-.405-4.41a8 8 0 0 0-1.536-2.705a8.027 8.027 0 0 0-11.285-.836a7.94 7.94 0 0 0-2.755 5.442c-.052.692-.04 1.1-.022 1.678c.011.372.025.815.025 1.449a1 1 0 1 1-2 0c0-.491-.011-.894-.022-1.265c-.018-.668-.034-1.229.025-2.01a9.94 9.94 0 0 1 3.446-6.81a10 10 0 0 1 7.267-2.388a10.03 10.03 0 0 1 6.834 3.432a10 10 0 0 1 1.922 3.384" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m9.055 15.699l.274 3.13a2.857 2.857 0 0 1-2.597 3.096a4.143 4.143 0 0 1-4.488-3.766l-.25-2.846a3 3 0 0 1 2.728-3.25a4 4 0 0 1 4.333 3.636m-4.159-1.644a1 1 0 0 0-.909 1.083l.25 2.847a2.143 2.143 0 0 0 2.32 1.948a.857.857 0 0 0 .78-.929l-.274-3.13a2 2 0 0 0-2.167-1.819m16.859 4.246l.274-3.13a2.857 2.857 0 0 0-2.597-3.096a4.143 4.143 0 0 0-4.488 3.766l-.25 2.846a3 3 0 0 0 2.728 3.25a4 4 0 0 0 4.333-3.636m-4.159 1.644a1 1 0 0 1-.909-1.083l.25-2.847a2.143 2.143 0 0 1 2.32-1.948a.86.86 0 0 1 .78.929l-.274 3.13a2 2 0 0 1-2.167 1.819" clip-rule="evenodd"></svg:path>`,
})
export class CuidaHeadphoneOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHeadsetOutlineIcon],svg[cuida-headset-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHeartRateOutlineIcon],svg[cuida-heart-rate-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="m14.426 7.792l1.298 4.413A2.5 2.5 0 0 0 18.122 14H21a1 1 0 1 0 0-2h-2.878a.5.5 0 0 1-.48-.359l-1.74-5.918c-.412-1.403-2.382-1.447-2.858-.065L8.93 17.63l-1.623-4.058A2.5 2.5 0 0 0 4.984 12H3a1 1 0 0 0 0 2h1.984a.5.5 0 0 1 .465.314l2.123 5.308c.516 1.291 2.36 1.245 2.811-.07z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaHeartRateOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHelpOutlineIcon],svg[cuida-help-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="help-outline"><svg:g fill="currentColor" class="Vector"><svg:path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-10 8a8 8 0 1 0 0-16a8 8 0 0 0 0 16" clip-rule="evenodd"></svg:path><svg:path d="M11 17a1 1 0 1 1 2 0a1 1 0 0 1-2 0"></svg:path><svg:path fill-rule="evenodd" d="M13.23 7.931c-.424-.225-.948-.301-1.326-.287c-1.44.056-1.933.935-1.918 1.305a1 1 0 0 1-1.999.078c-.072-1.858 1.722-3.3 3.84-3.381c.64-.025 1.534.09 2.342.52c.846.45 1.603 1.259 1.789 2.535c.173 1.19-.601 2.09-1.255 2.566c-.5.363-.955.746-1.275 1.161c-.313.405-.458.787-.443 1.179a1 1 0 0 1-1.998.077c-.039-.996.355-1.827.858-2.478c.495-.64 1.131-1.157 1.682-1.557c.18-.131.31-.274.384-.4c.069-.12.076-.2.068-.26c-.08-.542-.365-.853-.75-1.058Z" clip-rule="evenodd"></svg:path></svg:g></svg:g>`,
})
export class CuidaHelpOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHistoryOutlineIcon],svg[cuida-history-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaHomeOutlineIcon],svg[cuida-home-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="home-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="M10.033 2.883a3 3 0 0 1 3.934 0l7 6.076A3 3 0 0 1 22 11.225V19a3 3 0 0 1-3 3h-3.5a1.5 1.5 0 0 1-1.5-1.5v-6.813h-4V20.5A1.5 1.5 0 0 1 8.5 22H5a3 3 0 0 1-3-3v-7.775a3 3 0 0 1 1.033-2.266zm2.623 1.51a1 1 0 0 0-1.312 0l-7 6.077a1 1 0 0 0-.344.755V19a1 1 0 0 0 1 1h3v-6.313a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2V20h3a1 1 0 0 0 1-1v-7.775a1 1 0 0 0-.345-.755z" class="Vector (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaHomeOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaKeyOutlineIcon],svg[cuida-key-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="key-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M13.272 7.199a3.94 3.94 0 0 0-1.122 2.726q-.005.376.06.745a1.01 1.01 0 0 1-.796 1.175a.99.99 0 0 1-1.15-.815a6 6 0 0 1-.092-1.128a6 6 0 0 1 1.701-4.133a5.723 5.723 0 0 1 8.217 0c2.27 2.32 2.27 6.079 0 8.398a5.72 5.72 0 0 1-6.475 1.226a1.02 1.02 0 0 1-.5-1.335a.98.98 0 0 1 1.305-.512a3.77 3.77 0 0 0 4.271-.809a3.977 3.977 0 0 0 0-5.538a3.774 3.774 0 0 0-5.42 0Z"></svg:path><svg:path d="M18.466 9.297a1.81 1.81 0 0 1-1.805 1.818a1.81 1.81 0 0 1-1.804-1.818a1.81 1.81 0 0 1 1.805-1.817a1.81 1.81 0 0 1 1.804 1.817m-1.805.616a.61.61 0 0 0 .603-.616a.61.61 0 0 0-.602-.615a.61.61 0 0 0-.603.615c0 .34.27.616.602.616m-4.671.573a1 1 0 0 1-.094 1.412l-7.482 6.554a.2.2 0 0 0-.027.274l1.162 1.002a.2.2 0 0 0 .168-.06l.244-.249a.2.2 0 0 0 .058-.141v-.73c0-1.275 1.193-2.194 2.411-1.914a1.957 1.957 0 0 1 2.44-1.841l.546.14a.2.2 0 0 0 .194-.055l1.323-1.353a1 1 0 0 1 1.43 1.4l-1.323 1.351a2.2 2.2 0 0 1-2.12.594l-.491-.126a1.96 1.96 0 0 1-2.41 1.848v.686c0 .576-.226 1.128-.628 1.54l-.244.25a2.2 2.2 0 0 1-2.334.526a1.8 1.8 0 0 1-.55-.334l-1.26-1.086l-.03-.03a2.2 2.2 0 0 1 .123-3.197l7.483-6.554a1 1 0 0 1 1.41.093Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaKeyOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLampOnOutlineIcon],svg[cuida-lamp-on-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="lamp-on-outline"><svg:g fill="currentColor" class="Vector"><svg:path fill-rule="evenodd" d="M9 21a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2h-4a1 1 0 0 1-1-1m0-5.575a1 1 0 0 1 1 1v.398c0 .374.303.677.677.677h2.646a.677.677 0 0 0 .677-.677V16.5a1 1 0 1 1 2 0v.323a2.676 2.676 0 0 1-2.677 2.677h-2.646A2.676 2.676 0 0 1 8 16.823v-.398a1 1 0 0 1 1-1" clip-rule="evenodd"></svg:path><svg:path d="M14.228 16.846c.137.42.59.654.995.476a8 8 0 1 0-6.367.034c.406.174.857-.064.99-.486l.087-.278c.132-.421-.106-.866-.506-1.052a6.109 6.109 0 1 1 5.206-.028c-.399.19-.632.637-.495 1.058z"></svg:path><svg:path fill-rule="evenodd" d="M10.056 9.076a1 1 0 0 1 1.274-.614l.906.317l.044.015c.22.076.478.166.682.273c.234.123.618.38.747.895c.128.515-.09.922-.238 1.14c-.13.19-.316.391-.473.562l-.032.034l-.103.112l.445.145a1 1 0 0 1-.616 1.902l-.743-.24l-.045-.015a5 5 0 0 1-.7-.262c-.238-.118-.635-.37-.772-.893c-.137-.522.086-.936.235-1.156c.132-.193.32-.397.482-.572l.032-.035l.109-.118l-.62-.216a1 1 0 0 1-.614-1.274" clip-rule="evenodd"></svg:path></svg:g></svg:g>`,
})
export class CuidaLampOnOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLoadingLeftOutlineIcon],svg[cuida-loading-left-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLoadingRightOutlineIcon],svg[cuida-loading-right-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLockOutlineIcon],svg[cuida-lock-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="lock-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M6.143 7.429h11.714A4.143 4.143 0 0 1 22 11.57v5.715a4.143 4.143 0 0 1-4.143 4.143H6.143A4.143 4.143 0 0 1 2 17.286V11.57a4.143 4.143 0 0 1 4.143-4.14Zm0 2A2.14 2.14 0 0 0 4 11.57v5.715c0 1.183.96 2.143 2.143 2.143h11.714c1.184 0 2.143-.96 2.143-2.143V11.57c0-1.183-.96-2.142-2.143-2.142z"></svg:path><svg:path d="M8.13 2.543C9.139 2.088 10.22 2 11.163 2h1c.737 0 1.53.067 2.311.31c.778.241 1.529.584 2.001 1.345c.438.706.525 1.603.525 2.618V9h-2V6.273c0-.993-.109-1.378-.224-1.563c-.08-.13-.241-.287-.895-.49c-.52-.162-1.094-.22-1.718-.22h-1c-.846 0-1.588.086-2.21.366c-.375.17-.565.33-.689.531C8.131 5.115 8 5.506 8 6.273V9H6V6.273c0-.97.161-1.771.559-2.42c.408-.666.988-1.047 1.571-1.31m3.834 10.1a1 1 0 0 1 1 1v1.214a1 1 0 1 1-2 0v-1.214a1 1 0 0 1 1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaLockOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLoginOutlineIcon],svg[cuida-login-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="login-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M21 17a5 5 0 0 1-5 5h-5a1 1 0 1 1 0-2h5a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3h-5a1 1 0 1 1 0-2h5a5 5 0 0 1 5 5z"></svg:path><svg:path d="M10.47 7.316a1 1 0 0 1 1.414-.046l4.8 4.5a1 1 0 0 1 0 1.46l-4.8 4.5a1 1 0 1 1-1.368-1.46l2.955-2.77H4a1 1 0 1 1 0-2h9.471l-2.955-2.77a1 1 0 0 1-.046-1.414"></svg:path></svg:g></svg:g>`,
})
export class CuidaLoginOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaLoopOutlineIcon],svg[cuida-loop-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMapOutlineIcon],svg[cuida-map-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="map-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M8 4.744a2 2 0 0 1 1.626-.059l5.335 2.149l4.162-2.03A2 2 0 0 1 22 6.6v10.036a2 2 0 0 1-1.36 1.894l-4.847 1.639a2 2 0 0 1-1.367-.032l-5.522-2.152l-3.963 2.113C3.609 20.809 2 19.843 2 18.334V8.93a2 2 0 0 1 1.12-1.796zm6.214 3.945L8.879 6.54L4 8.93v9.403l3.964-2.113a2 2 0 0 1 1.667-.099l5.522 2.153L20 16.637V6.6l-4.162 2.03a2 2 0 0 1-1.624.058Z"></svg:path><svg:path d="M9 4.943a1 1 0 0 1 1 1v10.915a1 1 0 1 1-2 0V5.943a1 1 0 0 1 1-1m6 1.984a1 1 0 0 1 1 1v10.916a1 1 0 1 1-2 0V7.927a1 1 0 0 1 1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaMapOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMapPinOutlineIcon],svg[cuida-map-pin-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="map-pin-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M15.525 10.313c0 1.948-1.588 3.5-3.512 3.5c-1.925 0-3.513-1.552-3.513-3.5c0-1.95 1.588-3.5 3.513-3.5a3.506 3.506 0 0 1 3.512 3.5m-3.512 1.5c.835 0 1.512-.672 1.512-1.5c0-.829-.677-1.5-1.512-1.5c-.836 0-1.513.671-1.513 1.5c0 .828.677 1.5 1.513 1.5"></svg:path><svg:path d="M12 4.5c-3.557 0-6.5 2.793-6.5 6.969a1 1 0 0 1-2 0C3.5 6.255 7.273 2.5 12 2.5s8.5 3.755 8.5 8.969a1 1 0 0 1-2 0C18.5 7.293 15.557 4.5 12 4.5"></svg:path><svg:path d="M4.5 10.469a1 1 0 0 1 1 1c0 1.769 1.02 3.422 2.415 4.836c1.378 1.398 2.993 2.43 3.887 2.948a.32.32 0 0 0 .338-.01c.894-.572 2.526-1.704 3.924-3.144c1.43-1.474 2.436-3.088 2.436-4.63a1 1 0 1 1 2 0c0 2.353-1.482 4.456-3.001 6.022c-1.552 1.6-3.33 2.829-4.282 3.437a2.32 2.32 0 0 1-2.415.056c-.967-.559-2.754-1.695-4.311-3.275C4.95 16.146 3.5 14.012 3.5 11.47a1 1 0 0 1 1-1Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaMapPinOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMenuOutlineIcon],svg[cuida-menu-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="menu-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="M3 7a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1m0 5a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1m0 5a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1" class="Vector 38 (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaMenuOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMinusCircleOutlineIcon],svg[cuida-minus-circle-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="minus-circle-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-10 8a8 8 0 1 0 0-16a8 8 0 0 0 0 16"></svg:path><svg:path d="M17 12a1 1 0 0 1-1 1H8a1 1 0 1 1 0-2h8a1 1 0 0 1 1 1"></svg:path></svg:g></svg:g>`,
})
export class CuidaMinusCircleOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMonitorOutlineIcon],svg[cuida-monitor-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M5.62 3h12.808c.246 0 .54 0 .799.022c.3.025.73.09 1.177.327a3 3 0 0 1 1.247 1.247c.237.447.302.877.327 1.177c.022.259.022.553.022.8v6.854c0 .246 0 .54-.022.799c-.025.3-.09.73-.327 1.177a3 3 0 0 1-1.247 1.247c-.366.188-.767.3-1.177.327c-.259.022-.553.022-.8.022H5.573c-.246 0-.54 0-.799-.022c-.3-.025-.73-.09-1.177-.327a3 3 0 0 1-1.247-1.247a3 3 0 0 1-.327-1.177C2 13.968 2 13.674 2 13.427V6.573c0-.246 0-.54.022-.799c.025-.3.09-.73.327-1.177A3 3 0 0 1 3.596 3.35c.366-.188.766-.3 1.177-.327C5.032 3 5.326 3 5.573 3zM4.116 5.532C4 5.752 4 6.042 4 6.62v6.76c0 .579 0 .868.116 1.088a1 1 0 0 0 .416.416c.22.116.51.116 1.088.116h12.76c.579 0 .868 0 1.088-.116a1 1 0 0 0 .416-.416c.116-.22.116-.509.116-1.088V6.62c0-.579 0-.868-.116-1.088a1 1 0 0 0-.416-.416C19.248 5 18.959 5 18.38 5H5.62c-.579 0-.868 0-1.088.116a1 1 0 0 0-.416.416" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M12 16a1 1 0 0 1 1 1v3a1 1 0 0 1-2 0v-3a1 1 0 0 1 1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M6 20a1 1 0 0 1 1-1h10a1 1 0 0 1 0 2H7a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path>`,
})
export class CuidaMonitorOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMoonOutlineIcon],svg[cuida-moon-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M19.008 13.562c.588-.15 1.656-.177 2.41.74c.588.716.552 1.535.519 1.86c-.078.761-.44 1.53-.862 2.07c-2.283 2.92-6.196 4.21-9.845 3.75c-5.744-.723-9.815-5.967-9.091-11.711c.223-1.769.74-3.355 1.694-4.701c.961-1.357 2.272-2.337 3.864-3.035a7.1 7.1 0 0 1 1.939-.52c.18-.018.4-.03.638-.014c.209.014.587.06.983.262a2.17 2.17 0 0 1 1.157 1.538c.129.7-.116 1.256-.261 1.522c-.175.32-.424.838-.64 1.376c-.232.576-.356 1.006-.38 1.207a5.326 5.326 0 0 0 4.618 5.95c.233.03.826.02 1.591-.05c.738-.07 1.384-.173 1.666-.244m.76 2.995c.264-.567.301-1.201-.268-1.057c-.351.09-.923.182-1.542.252l-.025.003c-.895.1-1.882.155-2.432.085a7.326 7.326 0 0 1-6.353-8.184c.054-.432.234-1 .453-1.563l.068-.17c.241-.597.518-1.173.727-1.557c.193-.352-.164-.415-.642-.35a5.3 5.3 0 0 0-1.68.55C5.71 5.742 4.488 7.618 4.123 10.52a8.483 8.483 0 0 0 7.356 9.477c2.769.348 5.614-.518 7.452-2.357A7 7 0 0 0 19.5 17c.102-.13.194-.284.268-.444ZM10.066 5.992h-.003Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M14.883 7.585a.238.238 0 0 1 .38.047q.016.032.043.056a.24.24 0 0 1-.048.38a.2.2 0 0 0-.056.043a.237.237 0 0 1-.379-.048a.2.2 0 0 0-.043-.056a.237.237 0 0 1 .047-.379a.2.2 0 0 0 .056-.043"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M15.678 7.354a.737.737 0 0 1-.142 1.13a.737.737 0 0 1-1.129-.143a.737.737 0 0 1 .142-1.129a.737.737 0 0 1 1.13.142Zm-.523.638a.26.26 0 0 0 .032-.256a.26.26 0 0 0-.256-.032a.26.26 0 0 0-.049.195q.005.03.017.06a.26.26 0 0 0 .256.033" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M18.235 4.983c.11-.116.3-.092.378.048q.018.031.044.056c.116.11.092.3-.048.379a.2.2 0 0 0-.056.043a.237.237 0 0 1-.378-.048a.2.2 0 0 0-.044-.056a.237.237 0 0 1 .048-.378a.2.2 0 0 0 .056-.044"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M19.03 4.753a.737.737 0 0 1-.143 1.129a.737.737 0 0 1-1.128-.143a.737.737 0 0 1 .142-1.129a.737.737 0 0 1 1.129.143m-.524.637a.26.26 0 0 0 .049-.195a.3.3 0 0 0-.017-.06a.26.26 0 0 0-.256-.033a.26.26 0 0 0-.032.256a.26.26 0 0 0 .256.032" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M18.602 10.069a.237.237 0 0 1 .379.047q.017.032.043.057c.116.11.092.3-.047.378a.2.2 0 0 0-.056.044a.237.237 0 0 1-.379-.048a.2.2 0 0 0-.044-.056a.237.237 0 0 1 .048-.379a.2.2 0 0 0 .056-.043"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M19.397 9.838a.737.737 0 0 1-.142 1.13a.737.737 0 0 1-1.13-.143a.737.737 0 0 1 .143-1.129a.737.737 0 0 1 1.13.142Zm-.524.638a.26.26 0 0 0 .051-.143a.3.3 0 0 0-.018-.113a.26.26 0 0 0-.143-.051a.3.3 0 0 0-.113.019a.26.26 0 0 0-.051.142a.3.3 0 0 0 .018.114a.26.26 0 0 0 .143.05a.3.3 0 0 0 .113-.018" clip-rule="evenodd"></svg:path>`,
})
export class CuidaMoonOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMouseOutlineIcon],svg[cuida-mouse-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="mouse-outline"><svg:g fill="currentColor" class="Vector"><svg:path fill-rule="evenodd" d="M5 9a7 7 0 0 1 14 0v6a7 7 0 1 1-14 0zm7-5a5 5 0 0 0-5 5v6a5 5 0 0 0 10 0V9a5 5 0 0 0-5-5" clip-rule="evenodd"></svg:path><svg:path d="M12 11.778c-1.102 0-2-.898-2-2V8c0-1.102.898-2 2-2s2 .898 2 2v1.778c0 1.102-.898 2-2 2m0-4.445a.67.67 0 0 0-.667.667v1.778c0 .364.303.666.667.666a.67.67 0 0 0 .667-.666V8A.67.67 0 0 0 12 7.333"></svg:path><svg:path fill-rule="evenodd" d="M10 9.778c0 1.102.898 2 2 2s2-.898 2-2V8c0-1.102-.898-2-2-2s-2 .898-2 2zM11.333 8c0-.364.303-.667.667-.667s.667.303.667.667v1.778a.67.67 0 0 1-.667.666a.67.67 0 0 1-.667-.666z" clip-rule="evenodd"></svg:path><svg:path fill-rule="evenodd" d="M10.2 9.778c0 .992.808 1.8 1.8 1.8s1.8-.808 1.8-1.8V8c0-.992-.808-1.8-1.8-1.8s-1.8.808-1.8 1.8zM11.133 8c0-.475.392-.867.867-.867s.867.392.867.867v1.778a.87.87 0 0 1-.867.866a.87.87 0 0 1-.867-.866zM12 11.778c-1.102 0-2-.898-2-2V8c0-1.102.898-2 2-2s2 .898 2 2v1.778c0 1.102-.898 2-2 2m0-4.445a.67.67 0 0 0-.667.667v1.778c0 .364.303.666.667.666a.67.67 0 0 0 .667-.666V8A.67.67 0 0 0 12 7.333" clip-rule="evenodd"></svg:path><svg:path fill-rule="evenodd" d="M12.9 2.6v4.3h-1.8V2.6z" clip-rule="evenodd"></svg:path></svg:g></svg:g>`,
})
export class CuidaMouseOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaMoveOutlineIcon],svg[cuida-move-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M12 2a1 1 0 0 1 1 1v9a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M12.707 2.293a1 1 0 0 0-1.414 0l-3 3a1 1 0 0 0 1.414 1.414L12 4.414l2.293 2.293a1 1 0 1 0 1.414-1.414zM12 22a1 1 0 0 1-1-1v-9a1 1 0 1 1 2 0v9a1 1 0 0 1-1 1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M11.293 21.707a1 1 0 0 0 1.414 0l3-3a1 1 0 0 0-1.414-1.414L12 19.586l-2.293-2.293a1 1 0 0 0-1.414 1.414zM2 12a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M2.293 11.293a1 1 0 0 0 0 1.414l3 3a1 1 0 0 0 1.414-1.414L4.414 12l2.293-2.293a1 1 0 0 0-1.414-1.414zM22 12a1 1 0 0 1-1 1h-9a1 1 0 1 1 0-2h9a1 1 0 0 1 1 1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M21.707 12.707a1 1 0 0 0 0-1.414l-3-3a1 1 0 1 0-1.414 1.414L19.586 12l-2.293 2.293a1 1 0 0 0 1.414 1.414z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaMoveOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaNotificationBellTimerOutlineIcon],svg[cuida-notification-bell-timer-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M22 16a6 6 0 1 1-12 0a6 6 0 0 1 12 0m-6 4a4 4 0 1 0 0-8a4 4 0 0 0 0 8" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M15.7 13.6a.9.9 0 0 1 .9.9v2a.9.9 0 1 1-1.8 0v-2a.9.9 0 0 1 .9-.9" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M14.951 16a.9.9 0 0 1 1.248-.249l1.5 1a.9.9 0 1 1-.998 1.498l-1.5-1A.9.9 0 0 1 14.95 16ZM8.5 18a2 2 0 0 0 3.333 1.491l1.334 1.49A4 4 0 0 1 6.5 18z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.01 5.22c-.621.168-1.201.431-1.605.795c-1.103.995-1.552 2.343-1.552 4.773c0 1.732-.986 3.372-1.696 4.434c-.154.232-.202.453-.193.586c.004.06.018.088.024.098c.004.007.016.026.064.052c.692.37 1.736.64 2.943.811A26 26 0 0 0 10.5 17a1 1 0 1 1 0 2c-1.128 0-2.484-.065-3.786-.25c-1.282-.183-2.603-.493-3.605-1.028c-.737-.394-1.093-1.08-1.14-1.779c-.046-.659.177-1.31.525-1.831c.717-1.074 1.359-2.259 1.359-3.324c0-2.661.492-4.707 2.213-6.258c.725-.654 1.636-1.027 2.419-1.24A8 8 0 0 1 10.5 3a1 1 0 1 1 0 2c-.306 0-.876.052-1.49.22" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M11.99 5.22c.621.168 1.201.431 1.605.795c1.103.995 1.552 2.343 1.552 4.773a1 1 0 1 0 2 0c0-2.661-.492-4.707-2.213-6.258c-.725-.654-1.636-1.027-2.419-1.24A8 8 0 0 0 10.5 3a1 1 0 0 0 0 2c.306 0 .876.052 1.49.22" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" d="M13.147 3.68c0 .695-1.395.042-2.5.042s-2.5.653-2.5-.043c0-.695 1-1.679 2.5-1.679s2.5.984 2.5 1.68"></svg:path>`,
})
export class CuidaNotificationBellTimerOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaOpenBookOutlineIcon],svg[cuida-open-book-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaPackageOutlineIcon],svg[cuida-package-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="package-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="m14.071 2.887l4.786 2.762a4.14 4.14 0 0 1 2.071 3.588v5.526c0 1.48-.79 2.848-2.071 3.588l-4.786 2.762a4.14 4.14 0 0 1-4.142 0l-4.786-2.762a4.14 4.14 0 0 1-2.071-3.588V9.237c0-1.48.79-2.848 2.071-3.588L9.93 2.887a4.14 4.14 0 0 1 4.142 0Zm-1 1.732a2.14 2.14 0 0 0-2.142 0L6.143 7.38a2.14 2.14 0 0 0-1.071 1.856v5.526c0 .765.408 1.473 1.071 1.856l4.786 2.762a2.14 2.14 0 0 0 2.142 0l4.786-2.762a2.14 2.14 0 0 0 1.071-1.856V9.237c0-.765-.408-1.473-1.071-1.856L13.07 4.62Z"></svg:path><svg:path d="m10.595 11.844l-5.9-2.95l.895-1.788l5.899 2.949c.322.16.7.16 1.022 0l5.899-2.95l.895 1.79l-5.9 2.949a3.14 3.14 0 0 1-2.81 0"></svg:path><svg:path d="M13 11.428v9.143h-2v-9.143zM7.677 5.267a1 1 0 0 1 1.342-.447l6.857 3.428a1 1 0 1 1-.895 1.79l-6.857-3.43a1 1 0 0 1-.447-1.34Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaPackageOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaPhoneOutlineIcon],svg[cuida-phone-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaPieChartOutlineIcon],svg[cuida-pie-chart-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="pie-chart-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M9.665 3.661a1 1 0 0 1-.602 1.28C6.12 6 4 8.867 4 12.25C4 16.55 7.414 20 11.586 20c3.655 0 6.726-2.647 7.433-6.194a1 1 0 1 1 1.962.39C20.096 18.636 16.239 22 11.586 22C6.274 22 2 17.617 2 12.251c0-4.234 2.657-7.85 6.385-9.192a1 1 0 0 1 1.28.602"></svg:path><svg:path d="M20.42 7.128c.38.917.593 1.893.628 2.883c.046 1.303-1.01 2.296-2.22 2.296h-5.857a2.224 2.224 0 0 1-2.225-2.225V4.224c0-1.209.993-2.265 2.296-2.219a8.31 8.31 0 0 1 7.379 5.123Zm-1.693 1.179l.002.003a6.3 6.3 0 0 1 .32 1.772a.22.22 0 0 1-.22.225H12.97a.224.224 0 0 1-.225-.225V4.224c0-.124.1-.224.224-.22a6.3 6.3 0 0 1 1.773.32l.003.002a6.3 6.3 0 0 1 2.46 1.521a6.3 6.3 0 0 1 1.521 2.46Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaPieChartOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaPinOutlineIcon],svg[cuida-pin-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="pin-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M12 16.143a1 1 0 0 1 1 1V21a1 1 0 0 1-2 0v-3.857a1 1 0 0 1 1-1"></svg:path><svg:path d="M8.447 4.223q0 .01.007.033c.05.17.12.344.198.51c.262.549.53 1.246.53 2.027v3.85c0 1.03-.442 1.97-1.109 2.666c-.49.512-.873.979-1.169 1.391c-.114.16-.133.269-.135.321a.25.25 0 0 0 .052.16c.089.126.352.319.83.319h4.985a1 1 0 1 1 0 2H7.652c-.987 0-1.93-.403-2.468-1.17c-.58-.827-.556-1.887.095-2.795c.355-.495.8-1.035 1.35-1.61c.358-.373.553-.833.553-1.282v-3.85c0-.335-.118-.71-.336-1.168a5.5 5.5 0 0 1-.31-.805c-.265-.898.081-1.68.664-2.168C7.736 2.204 8.455 2 9.124 2h3.512a1 1 0 1 1 0 2H9.124c-.303 0-.536.099-.64.186a.2.2 0 0 0-.037.037m-.005.007"></svg:path><svg:path d="M15.553 4.223a3.5 3.5 0 0 1-.206.543c-.26.549-.529 1.246-.529 2.027v3.85c0 1.03.442 1.97 1.109 2.666c.49.512.873.979 1.169 1.391c.114.16.133.269.135.321a.25.25 0 0 1-.052.16c-.089.126-.352.319-.83.319h-4.985a1 1 0 1 0 0 2h4.985c.986 0 1.928-.403 2.467-1.17c.58-.827.556-1.887-.095-2.795c-.355-.495-.8-1.035-1.35-1.61c-.358-.373-.553-.833-.553-1.282v-3.85c0-.335.118-.71.335-1.168c.116-.243.226-.515.311-.805c.265-.898-.081-1.68-.664-2.168C16.264 2.204 15.545 2 14.876 2h-3.512a1 1 0 1 0 0 2h3.512c.303 0 .536.099.64.186q.029.026.037.037m.005.007"></svg:path></svg:g></svg:g>`,
})
export class CuidaPinOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaPlusCircleOutlineIcon],svg[cuida-plus-circle-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="plus-circle-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M12 17a1 1 0 0 1-1-1V8a1 1 0 1 1 2 0v8a1 1 0 0 1-1 1"></svg:path><svg:path d="M17 12a1 1 0 0 1-1 1H8a1 1 0 1 1 0-2h8a1 1 0 0 1 1 1"></svg:path><svg:path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-10 8a8 8 0 1 0 0-16a8 8 0 0 0 0 16"></svg:path></svg:g></svg:g>`,
})
export class CuidaPlusCircleOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaRendoOutlineIcon],svg[cuida-rendo-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M21.479 8a1 1 0 0 0-1-1H8c-2.814 0-6 2.366-6 6s3.186 6 6 6h7.778a1 1 0 1 0 0-2H8c-1.88 0-4-1.634-4-4s2.12-4 4-4h12.479a1 1 0 0 0 1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M17.053 4.293a1 1 0 0 0 0 1.414l2.345 2.345l-2.397 2.797a1 1 0 0 0 1.518 1.302l3-3.5a1 1 0 0 0-.052-1.358l-3-3a1 1 0 0 0-1.414 0" clip-rule="evenodd"></svg:path>`,
})
export class CuidaRendoOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaRotateLeftOutlineIcon],svg[cuida-rotate-left-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="rotate-left-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M12 6.05c3.869 0 7 3.126 7 6.975C19 16.875 15.869 20 12 20s-7-3.126-7-6.975c0-1.07.242-2.083.673-2.987a1 1 0 0 0-1.806-.86A8.9 8.9 0 0 0 3 13.024C3 17.985 7.032 22 12 22s9-4.015 9-8.975s-4.032-8.974-9-8.974c-1.24 0-2.425.25-3.502.705l.777 1.843A7 7 0 0 1 12 6.05"></svg:path><svg:path d="M10.194 2.233a.857.857 0 0 0-1.15.385L7.713 5.301a1.086 1.086 0 0 0 .493 1.456l2.691 1.329a.857.857 0 1 0 .758-1.536L9.53 5.5l1.053-2.118a.857.857 0 0 0-.388-1.149Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaRotateLeftOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaRotateRightOutlineIcon],svg[cuida-rotate-right-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="rotate-right-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M12 6.05c-3.869 0-7 3.126-7 6.975C5 16.875 8.131 20 12 20s7-3.126 7-6.975a6.9 6.9 0 0 0-.673-2.987a1 1 0 0 1 1.806-.86A8.9 8.9 0 0 1 21 13.024C21 17.985 16.968 22 12 22s-9-4.015-9-8.975s4.032-8.974 9-8.974c1.24 0 2.425.25 3.502.705l-.777 1.843A7 7 0 0 0 12 6.05"></svg:path><svg:path d="M13.806 2.233a.857.857 0 0 1 1.15.385l1.332 2.683c.267.537.046 1.19-.493 1.456l-2.691 1.329a.857.857 0 1 1-.758-1.536L14.47 5.5l-1.053-2.118a.857.857 0 0 1 .388-1.149Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaRotateRightOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSampleContainerOutlineIcon],svg[cuida-sample-container-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M4.955 8.001a1 1 0 0 1 1.044.954l.413 9.09a1 1 0 0 0 1 .955h9.177a1 1 0 0 0 .999-.954L18 8.955a1 1 0 1 1 1.998.09l-.413 9.091A3 3 0 0 1 16.589 21H7.41a3 3 0 0 1-2.997-2.864L4 9.046A1 1 0 0 1 4.955 8Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M4.795 3h14.437c.11 0 .29 0 .456.013c.204.016.552.062.93.25a2.5 2.5 0 0 1 1.118 1.12c.189.377.235.725.251.929c.013.166.013.346.013.456v1.464c0 .11 0 .29-.013.456a2.5 2.5 0 0 1-.25.93a2.5 2.5 0 0 1-1.12 1.118a2.5 2.5 0 0 1-.929.251c-.166.013-.346.013-.456.013H4.768c-.11 0-.29 0-.456-.013a2.5 2.5 0 0 1-.93-.25a2.5 2.5 0 0 1-1.118-1.12a2.5 2.5 0 0 1-.25-.929C2 7.522 2 7.342 2 7.232V5.768c0-.11 0-.29.013-.456a2.5 2.5 0 0 1 .25-.93a2.5 2.5 0 0 1 1.12-1.118c.377-.189.725-.235.929-.25C4.478 3 4.658 3 4.768 3zm-.742 2.277C4 5.382 4 5.52 4 5.795v1.41c0 .275 0 .413.053.519a.5.5 0 0 0 .224.223C4.382 8 4.52 8 4.795 8h14.41c.275 0 .413 0 .519-.053a.5.5 0 0 0 .223-.223C20 7.618 20 7.48 20 7.205v-1.41c0-.275 0-.413-.053-.518a.5.5 0 0 0-.223-.224C19.617 5 19.48 5 19.205 5H4.795c-.275 0-.413 0-.518.053a.5.5 0 0 0-.224.224M12 12.5a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2h-5a1 1 0 0 1-1-1m0 4a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2h-5a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path>`,
})
export class CuidaSampleContainerOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSettingsOutlineIcon],svg[cuida-settings-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaShareOutlineIcon],svg[cuida-share-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M22 18.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0M18.5 20a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M9 11.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0M5.5 13a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M22 5.5a3.5 3.5 0 1 0-7 0a3.5 3.5 0 0 0 7 0M18.5 4a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9 11.5a3.5 3.5 0 1 0-7 0a3.5 3.5 0 0 0 7 0M5.5 10a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M16.617 18.065a1 1 0 0 0-.388-1.36l-8.243-4.58a1 1 0 0 0-.972 1.75l8.244 4.579a1 1 0 0 0 1.36-.389Zm.115-12.168a1 1 0 0 1-.508 1.32l-8.318 3.697a1 1 0 0 1-.812-1.828l8.318-3.697a1 1 0 0 1 1.32.508" clip-rule="evenodd"></svg:path>`,
})
export class CuidaShareOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaShieldAlertOutlineIcon],svg[cuida-shield-alert-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="shield-alert-outline"><svg:g fill="currentColor" class="Vector"><svg:path fill-rule="evenodd" d="M11.061 2.36a2.9 2.9 0 0 1 1.878 0l6 2.045a2.91 2.91 0 0 1 1.97 2.753v7.894a2.91 2.91 0 0 1-1.408 2.492l-6 3.613a2.91 2.91 0 0 1-3.002 0l-6-3.613a2.91 2.91 0 0 1-1.408-2.492V7.158a2.91 2.91 0 0 1 1.97-2.753zm1.291 1.72a1.1 1.1 0 0 0-.704 0l-6 2.046a1.09 1.09 0 0 0-.739 1.032v7.894c0 .382.2.737.528.934l6 3.614c.346.208.78.208 1.126 0l6-3.614a1.09 1.09 0 0 0 .528-.934V7.158a1.09 1.09 0 0 0-.739-1.032z" clip-rule="evenodd"></svg:path><svg:path fill-rule="evenodd" d="M12 13a1 1 0 0 1-1-1V8a1 1 0 1 1 2 0v4a1 1 0 0 1-1 1" clip-rule="evenodd"></svg:path><svg:path d="M11 15a1 1 0 1 1 2 0a1 1 0 0 1-2 0"></svg:path></svg:g></svg:g>`,
})
export class CuidaShieldAlertOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaShieldOutlineIcon],svg[cuida-shield-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="shield-outline"><svg:path fill="currentColor" fill-rule="evenodd" d="M11.061 2.36a2.9 2.9 0 0 1 1.878 0l5.856 1.996A2.91 2.91 0 0 1 20.75 7.39l-.758 7.792a2.9 2.9 0 0 1-1.205 2.085l-5.118 3.657a2.91 2.91 0 0 1-3.34.029l-5.077-3.495a2.91 2.91 0 0 1-1.247-2.119l-.76-7.953a2.91 2.91 0 0 1 1.957-3.03zm1.291 1.72a1.1 1.1 0 0 0-.704 0L5.789 6.078a1.09 1.09 0 0 0-.734 1.136l.761 7.953c.03.32.202.612.468.795l5.076 3.494c.378.26.88.256 1.253-.01l5.119-3.657a1.1 1.1 0 0 0 .451-.782l.759-7.792a1.09 1.09 0 0 0-.734-1.138z" class="Vector 69 (Stroke)" clip-rule="evenodd"></svg:path></svg:g>`,
})
export class CuidaShieldOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaShieldTickOutlineIcon],svg[cuida-shield-tick-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="shield-tick-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M15.696 9.282a1 1 0 0 1 .022 1.414l-4.03 4.159a1.17 1.17 0 0 1-1.683 0l-1.723-1.778a1 1 0 1 1 1.436-1.392l1.128 1.164l3.436-3.545a1 1 0 0 1 1.414-.022"></svg:path><svg:path d="M11.061 2.36a2.9 2.9 0 0 1 1.878 0l5.856 1.996A2.91 2.91 0 0 1 20.75 7.39l-.758 7.792a2.9 2.9 0 0 1-1.205 2.085l-5.118 3.657a2.91 2.91 0 0 1-3.34.029l-5.077-3.495a2.91 2.91 0 0 1-1.247-2.119l-.76-7.953a2.91 2.91 0 0 1 1.957-3.03zm1.291 1.72a1.1 1.1 0 0 0-.704 0L5.789 6.078a1.09 1.09 0 0 0-.734 1.136l.761 7.953c.03.32.202.612.468.795l5.076 3.494c.378.26.88.256 1.253-.01l5.119-3.657a1.1 1.1 0 0 0 .451-.782l.759-7.792a1.09 1.09 0 0 0-.734-1.138z"></svg:path></svg:g></svg:g>`,
})
export class CuidaShieldTickOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaShuffleOutlineIcon],svg[cuida-shuffle-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSidebarCollapseOutlineIcon],svg[cuida-sidebar-collapse-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M6.416 4.767a2.65 2.65 0 0 0-2.65 2.65v8.832a2.65 2.65 0 0 0 2.65 2.65h1.461V4.767h-1.46Zm0-1.767A4.416 4.416 0 0 0 2 7.416v8.833a4.416 4.416 0 0 0 4.416 4.417h11.168A4.416 4.416 0 0 0 22 16.248V7.416A4.416 4.416 0 0 0 17.584 3zm3.228 1.767v14.132h7.94a2.65 2.65 0 0 0 2.65-2.65V7.416a2.65 2.65 0 0 0-2.65-2.65h-7.94Z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaSidebarCollapseOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSparksOutlineIcon],svg[cuida-sparks-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaStarOutlineIcon],svg[cuida-star-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaStethoscopeOutlineIcon],svg[cuida-stethoscope-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M19 12a1 1 0 0 1 1 1v3.429C20 19.713 16.903 22 13.5 22C10.076 22 7 19.628 7 16.36V14a1 1 0 1 1 2 0v2.36C9 18.219 10.848 20 13.5 20c2.672 0 4.5-1.732 4.5-3.571V13a1 1 0 0 1 1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M4.828 4A.83.83 0 0 0 4 4.828v5.12C4 11.537 5.466 13 7.5 13S11 11.537 11 9.947v-5.26A.687.687 0 0 0 10.312 4h-.609a1 1 0 0 1 0-2h.61A2.687 2.687 0 0 1 13 4.688v5.26C13 12.833 10.437 15 7.5 15S2 12.834 2 9.947V4.828A2.83 2.83 0 0 1 4.828 2h.61a1 1 0 0 1 0 2zm14.049 4.846c-.742 0-1.23.605-1.23 1.23c0 .627.307 1.232 1.23 1.232c.774 0 1.23-.533 1.23-1.231c0-.62-.37-1.23-1.23-1.23Zm3.077 1.23a3.077 3.077 0 1 1-6.154.001a3.077 3.077 0 0 1 6.154 0Z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaStethoscopeOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaStopCircleOutlineIcon],svg[cuida-stop-circle-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="stop-circle-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-10 8a8 8 0 1 0 0-16a8 8 0 0 0 0 16"></svg:path><svg:path d="M10 7.5h4a2.5 2.5 0 0 1 2.5 2.5v4a2.5 2.5 0 0 1-2.5 2.5h-4A2.5 2.5 0 0 1 7.5 14v-4A2.5 2.5 0 0 1 10 7.5m0 2a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5z"></svg:path></svg:g></svg:g>`,
})
export class CuidaStopCircleOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSubtaskOutlineIcon],svg[cuida-subtask-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="subtask-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M8.308 5.148a3.15 3.15 0 0 1-3.154 3.148A3.15 3.15 0 0 1 2 5.148A3.15 3.15 0 0 1 5.154 2a3.15 3.15 0 0 1 3.154 3.148M5.154 6.296a1.15 1.15 0 0 0 1.154-1.148A1.15 1.15 0 0 0 5.154 4A1.15 1.15 0 0 0 4 5.148a1.15 1.15 0 0 0 1.154 1.148M21 18.924a3.15 3.15 0 0 1-3.154 3.147a3.15 3.15 0 0 1-3.154-3.148a3.15 3.15 0 0 1 3.154-3.147c1.732 0 3.154 1.4 3.154 3.148m-3.154 1.147A1.15 1.15 0 0 0 19 18.923c0-.633-.517-1.147-1.154-1.147a1.15 1.15 0 0 0-1.154 1.148a1.15 1.15 0 0 0 1.154 1.147M21 11.462a3.15 3.15 0 0 1-3.154 3.148a3.15 3.15 0 0 1-3.154-3.148a3.15 3.15 0 0 1 3.154-3.148A3.15 3.15 0 0 1 21 11.462m-3.154 1.148A1.15 1.15 0 0 0 19 11.462c0-.634-.517-1.148-1.154-1.148a1.15 1.15 0 0 0-1.154 1.148a1.15 1.15 0 0 0 1.154 1.148"></svg:path><svg:path d="M5.154 7.018a1 1 0 0 1 1 1v6.784a3.154 3.154 0 0 0 3.13 3.154l5.724.044a1 1 0 0 1-.016 2l-5.724-.044a5.154 5.154 0 0 1-5.114-5.154V8.018a1 1 0 0 1 1-1"></svg:path><svg:path d="M9.172 12.462a5.02 5.02 0 0 1-5.018-5.018h2a3.02 3.02 0 0 0 3.018 3.018H15a1 1 0 1 1 0 2z"></svg:path></svg:g></svg:g>`,
})
export class CuidaSubtaskOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaSyringeOutlineIcon],svg[cuida-syringe-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="m14.373 4.475l5.656 5.656l-8.484 8.485a3 3 0 0 1-4.242 0L5.888 17.2a3 3 0 0 1 0-4.242l8.485-8.484Zm0 2.828l-7.07 7.07a1 1 0 0 0 0 1.414l1.414 1.414a1 1 0 0 0 1.414 0l7.07-7.07z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M12.605 4.121a1 1 0 0 1 1.414 0l6.364 6.364a1 1 0 1 1-1.415 1.415l-6.363-6.365a1 1 0 0 1 0-1.414m.889 6.182a1 1 0 0 1 1.414 0l1.768 1.768a1 1 0 0 1-1.414 1.414l-1.768-1.768a1 1 0 0 1 0-1.414m-3.364 3.364a1 1 0 0 1 1.414 0l1.768 1.768a1 1 0 0 1-1.415 1.414l-1.767-1.768a1 1 0 0 1 0-1.414M17.2 3.06a1 1 0 0 1 1.415 0l2.828 2.83a1 1 0 1 1-1.414 1.413l-2.828-2.828a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M19.322 6.596L17.908 8.01l-1.414-1.414l1.414-1.414zM6.111 17.1l-3.28 3.171a.2.2 0 0 0 .138.344h2.373a.2.2 0 0 0 .142-.058l2.041-2.042z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaSyringeOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTestTubeOutlineIcon],svg[cuida-test-tube-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTotemOutlineIcon],svg[cuida-totem-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTranslateOutlineIcon],svg[cuida-translate-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M15.958 8.95a1.5 1.5 0 0 1 1.085.02c.472.193.693.613.791.81c.112.227.223.523.337.828l.015.04l3.75 10a1 1 0 0 1-1.872.703l-3.613-9.633l-4.028 9.667a1 1 0 0 1-1.846-.77l4.179-10.028l.016-.04a10 10 0 0 1 .367-.815c.104-.194.34-.605.82-.781Zm-3.174-4.909a1 1 0 0 1 .675 1.243C12.476 8.6 11.432 11.04 9.87 13.02c-1.568 1.988-3.598 3.434-6.417 4.872a1 1 0 1 1-.909-1.782c2.683-1.369 4.434-2.654 5.756-4.329c1.329-1.685 2.285-3.842 3.24-7.064a1 1 0 0 1 1.243-.675Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M5.961 7.342a1 1 0 0 1 1.235.689c.702 2.47 2.066 4.29 3.904 5.669a1 1 0 0 1-1.2 1.6c-2.162-1.622-3.798-3.802-4.627-6.723a1 1 0 0 1 .688-1.235M2 5a1 1 0 0 1 1-1h12.5a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9 2a1 1 0 0 1 1 1v2a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1m4 15a1 1 0 0 1 1-1h5.5a1 1 0 1 1 0 2H14a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path>`,
})
export class CuidaTranslateOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTrashOutlineIcon],svg[cuida-trash-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="trash-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M4.917 6.003a1 1 0 0 1 1.08.914l.849 10.248A2 2 0 0 0 8.839 19h6.322a2 2 0 0 0 1.993-1.835l.85-10.248a1 1 0 0 1 1.993.166l-.85 10.247A4 4 0 0 1 15.162 21H8.84a4 4 0 0 1-3.987-3.67l-.85-10.247a1 1 0 0 1 .914-1.08"></svg:path><svg:path d="M3 7a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1m7 2a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1m4 0a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-4a1 1 0 0 1 1-1"></svg:path><svg:path d="M10.441 5a1 1 0 0 0-.948.684l-.544 1.632a1 1 0 1 1-1.898-.632l.544-1.633A3 3 0 0 1 10.441 3h3.117a3 3 0 0 1 2.846 2.051l.545 1.633a1 1 0 0 1-1.898.632l-.544-1.632A1 1 0 0 0 13.56 5h-3.117Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaTrashOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTrendingDownOutlineIcon],svg[cuida-trending-down-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="trending-down-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M19.438 18.093a1.05 1.05 0 0 0 .111-1.437l-5.29-6.463c-.904-1.104-2.595-.902-3.235.387l-1.442 2.905l-5.29-6.462a.954.954 0 0 0-1.382-.116a1.05 1.05 0 0 0-.111 1.437l5.29 6.463c.904 1.104 2.596.902 3.235-.387l1.442-2.905l5.29 6.462c.351.43.97.48 1.382.116"></svg:path><svg:path d="M19.749 18.795a1.04 1.04 0 0 0 .287-.721V14.03c0-.563-.439-1.02-.98-1.02s-.98.457-.98 1.02v3.025H15.26c-.541 0-.98.456-.98 1.019s.439 1.02.98 1.02h3.795c.26 0 .51-.108.693-.3Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaTrendingDownOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTrendingUpOutlineIcon],svg[cuida-trending-up-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="trending-up-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M19.438 6.907c.413.365.462 1.008.111 1.437l-5.29 6.463c-.904 1.104-2.595.902-3.235-.387l-1.442-2.905l-5.29 6.462a.954.954 0 0 1-1.382.116a1.05 1.05 0 0 1-.111-1.437l5.29-6.463c.904-1.104 2.596-.902 3.235.387l1.442 2.905l5.29-6.462a.954.954 0 0 1 1.382-.116"></svg:path><svg:path d="M19.749 6.205c.184.192.287.45.287.721v4.044c0 .563-.439 1.02-.98 1.02s-.98-.457-.98-1.02V7.946H15.26c-.541 0-.98-.457-.98-1.02s.439-1.02.98-1.02h3.795c.26 0 .51.108.693.3Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaTrendingUpOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTrophyOutlineIcon],svg[cuida-trophy-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M14.8 20a.2.2 0 0 0 .2-.2a.797.797 0 0 0-.8-.8H9.8a.8.8 0 0 0-.8.8c0 .11.09.2.2.2zm-5-3h4.4a2.8 2.8 0 0 1 2.8 2.8a2.2 2.2 0 0 1-2.2 2.2H9.2A2.2 2.2 0 0 1 7 19.8A2.8 2.8 0 0 1 9.8 17m3.2-3v3h-2v-3z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.656 4.003a4.8 4.8 0 0 0-1.886.304c-.436.169-.77.722-.77 1.68V9.43c0 1.295.755 2.426 1.86 3.279C9.986 13.575 11.277 14 12 14v2c-1.276 0-2.985-.646-4.36-1.708C6.244 13.217 5 11.563 5 9.43V5.986c0-1.238.436-2.92 2.048-3.544a6.8 6.8 0 0 1 2.68-.437z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M14.457 4c.718 0 1.339.138 1.821.326c.403.157.722.673.722 1.602v3.5c0 1.298-.757 2.432-1.84 3.287c-1.107.876-2.334 1.285-2.918 1.285v2c1.174 0 2.826-.662 4.158-1.716C17.757 13.212 19 11.56 19 9.43v-3.5c0-1.201-.414-2.85-1.995-3.466A7 7 0 0 0 14.457 2H9.5v2zM2.082 7.036c.381-1.716 2.003-2.8 3.922-2.48a1 1 0 1 1-.328 1.973c-.947-.158-1.507.335-1.642.94c-.14.629.114 1.79 1.79 2.896c.167.11.398.178.676.178a1 1 0 1 1 0 2c-.588 0-1.222-.142-1.778-.509c-2.12-1.399-3.016-3.305-2.64-4.998" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M21.918 7.036c-.381-1.716-2.003-2.8-3.922-2.48a1 1 0 0 0 .328 1.973c.947-.158 1.507.335 1.642.94c.14.629-.114 1.79-1.79 2.896c-.167.11-.398.178-.676.178a1 1 0 1 0 0 2c.588 0 1.222-.142 1.777-.509c2.12-1.399 3.017-3.305 2.64-4.998ZM6 21a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path>`,
})
export class CuidaTrophyOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTubeOutlineIcon],svg[cuida-tube-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M11.01 6h1.98C14.1 6 15 6.9 15 8.01V19a3 3 0 1 1-6 0V8.01C9 6.9 9.9 6 11.01 6M13 8.01V19a1 1 0 1 1-2 0V8.01a.01.01 0 0 1 .01-.01h1.98a.01.01 0 0 1 .01.01" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M9.6 2h4.8c1.16 0 2.1.94 2.1 2.1v1.8A2.1 2.1 0 0 1 14.4 8H9.6a2.1 2.1 0 0 1-2.1-2.1V4.1c0-1.16.94-2.1 2.1-2.1m0 2a.1.1 0 0 0-.1.1v1.8a.1.1 0 0 0 .1.1h4.8a.1.1 0 0 0 .1-.1V4.1a.1.1 0 0 0-.1-.1z" clip-rule="evenodd"></svg:path>`,
})
export class CuidaTubeOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaTvOutlineIcon],svg[cuida-tv-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M5.62 3.5h12.808c.246 0 .54 0 .799.022c.3.025.73.09 1.177.327a3 3 0 0 1 1.247 1.247c.237.447.302.877.327 1.177c.022.259.022.553.022.8v6.854c0 .246 0 .54-.022.799c-.025.3-.09.73-.327 1.177a3 3 0 0 1-1.247 1.247c-.366.188-.767.3-1.177.327c-.259.022-.553.022-.8.022H5.573c-.246 0-.54 0-.799-.022c-.3-.025-.73-.09-1.177-.327a3 3 0 0 1-1.247-1.247a3 3 0 0 1-.327-1.177C2 14.468 2 14.174 2 13.927V7.073c0-.246 0-.54.022-.799c.025-.3.09-.73.327-1.177A3 3 0 0 1 3.596 3.85c.366-.188.766-.3 1.177-.327c.259-.022.553-.022.8-.022zM4.116 6.032C4 6.252 4 6.542 4 7.12v6.76c0 .579 0 .868.116 1.088a1 1 0 0 0 .416.416c.22.116.51.116 1.088.116h12.76c.579 0 .868 0 1.088-.116a1 1 0 0 0 .416-.416c.116-.22.116-.509.116-1.088V7.12c0-.579 0-.868-.116-1.088a1 1 0 0 0-.416-.416c-.22-.116-.509-.116-1.088-.116H5.62c-.579 0-.868 0-1.088.116a1 1 0 0 0-.416.416M7 19a1 1 0 0 1 1-1h8a1 1 0 0 1 0 2H8a1 1 0 0 1-1-1" clip-rule="evenodd"></svg:path>`,
})
export class CuidaTvOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUndoOutlineIcon],svg[cuida-undo-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M2.281 8a1 1 0 0 1 1-1H15.76c2.814 0 6 2.366 6 6s-3.186 6-6 6H7.982a1 1 0 1 1 0-2h7.778c1.88 0 4-1.634 4-4s-2.12-4-4-4H3.28a1 1 0 0 1-1-1Z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M6.707 4.293a1 1 0 0 1 0 1.414L4.362 8.052l2.397 2.797a1 1 0 0 1-1.518 1.302l-3-3.5a1 1 0 0 1 .052-1.358l3-3a1 1 0 0 1 1.414 0" clip-rule="evenodd"></svg:path>`,
})
export class CuidaUndoOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUnlockOutlineIcon],svg[cuida-unlock-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="unlock-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M6.143 7.429h11.714A4.143 4.143 0 0 1 22 11.57v5.715a4.143 4.143 0 0 1-4.143 4.143H6.143A4.143 4.143 0 0 1 2 17.286V11.57a4.143 4.143 0 0 1 4.143-4.14Zm0 2A2.14 2.14 0 0 0 4 11.57v5.715c0 1.183.96 2.143 2.143 2.143h11.714c1.184 0 2.143-.96 2.143-2.143V11.57c0-1.183-.96-2.142-2.143-2.142z"></svg:path><svg:path d="M11.964 12.643a1 1 0 0 1 1 1v1.214a1 1 0 0 1-2 0v-1.214a1 1 0 0 1 1-1M11.69 2h.042c1.011 0 2.098.077 3.158.4c.604.183 1.257.462 1.67 1.133c.374.608.44 1.374.44 2.194a1 1 0 1 1-2 0c0-.804-.09-1.058-.144-1.147l-.001-.001c-.017-.028-.074-.122-.547-.266c-.79-.24-1.653-.313-2.576-.313c-1.332 0-2.371.046-3.132.557a1.07 1.07 0 0 0-.41.483c-.104.235-.19.61-.19 1.233V9H6V6.273c0-.788.106-1.465.36-2.04a3.07 3.07 0 0 1 1.124-1.336C8.82 2 10.481 2 11.69 2"></svg:path></svg:g></svg:g>`,
})
export class CuidaUnlockOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUploadOutlineIcon],svg[cuida-upload-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="upload-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M7 22a5 5 0 0 1-5-5v-3a1 1 0 1 1 2 0v3a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-3a1 1 0 1 1 2 0v3a5 5 0 0 1-5 5z"></svg:path><svg:path d="M7.285 10.1a1 1 0 0 1 .016-1.415l4.5-4.4a1 1 0 0 1 1.398 0l4.5 4.4a1 1 0 1 1-1.398 1.43L13.5 7.376V16a1 1 0 1 1-2 0V7.376l-2.8 2.739a1 1 0 0 1-1.415-.016Z"></svg:path></svg:g></svg:g>`,
})
export class CuidaUploadOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUserAddOutlineIcon],svg[cuida-user-add-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="user-add-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M9.5 10a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0 2a4 4 0 1 0 0-8a4 4 0 0 0 0 8m8.975-4a1 1 0 0 1 1 1v1.475h1.475a1 1 0 1 1 0 2h-1.475v1.475a1 1 0 1 1-2 0v-1.475H16a1 1 0 1 1 0-2h1.475V9a1 1 0 0 1 1-1M3.354 15.176C4.311 13.836 5.77 13 7.643 13h3.714c1.873 0 3.332.837 4.289 2.176C16.577 16.479 17 18.202 17 20a1 1 0 1 1-2 0c0-1.516-.36-2.793-.981-3.661c-.595-.832-1.457-1.339-2.662-1.339H7.643c-1.205 0-2.067.507-2.662 1.339c-.62.868-.981 2.145-.981 3.66a1 1 0 1 1-2 0c0-1.797.422-3.52 1.354-4.823"></svg:path><svg:path d="M2 20a1 1 0 0 1 1-1h12.969a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaUserAddOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUserOutlineIcon],svg[cuida-user-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="user-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M12 10a3 3 0 1 0 0-6a3 3 0 0 0 0 6m0 2a5 5 0 1 0 0-10a5 5 0 0 0 0 10m-7.361 3.448C5.784 13.93 7.509 13 9.714 13h4.572c2.205 0 3.93.93 5.075 2.448C20.482 16.935 21 18.916 21 21a1 1 0 1 1-2 0c0-1.782-.446-3.3-1.235-4.348C17 15.638 15.867 15 14.285 15h-4.57c-1.582 0-2.715.638-3.48 1.652C5.445 17.7 5 19.218 5 21a1 1 0 1 1-2 0c0-2.084.518-4.065 1.639-5.552"></svg:path><svg:path d="M3 21a1 1 0 0 1 1-1h15.962a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaUserOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUserRemoveOutlineIcon],svg[cuida-user-remove-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="user-remove-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M9.5 10a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0 2a4 4 0 1 0 0-8a4 4 0 0 0 0 8m6.793-2.707a1 1 0 0 1 1.414 0L19 10.586l1.293-1.293a1 1 0 1 1 1.414 1.414L20.414 12l1.293 1.293a1 1 0 0 1-1.414 1.414L19 13.414l-1.293 1.293a1 1 0 0 1-1.414-1.414L17.586 12l-1.293-1.293a1 1 0 0 1 0-1.414M3.354 15.176C4.311 13.836 5.77 13 7.643 13h3.714c1.873 0 3.332.837 4.289 2.176C16.577 16.479 17 18.202 17 20a1 1 0 1 1-2 0c0-1.516-.36-2.793-.981-3.661c-.595-.832-1.457-1.339-2.662-1.339H7.643c-1.205 0-2.067.507-2.662 1.339c-.62.868-.981 2.145-.981 3.66a1 1 0 1 1-2 0c0-1.797.422-3.52 1.354-4.823"></svg:path><svg:path d="M2 20a1 1 0 0 1 1-1h12.969a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaUserRemoveOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaUsersOutlineIcon],svg[cuida-users-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g class="users-outline"><svg:g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><svg:path d="M8.75 9.5a1.75 1.75 0 1 0 0-3.5a1.75 1.75 0 0 0 0 3.5m0 2a3.75 3.75 0 1 0 0-7.5a3.75 3.75 0 0 0 0 7.5m-5.484 3.027c.899-1.249 2.269-2.027 4.02-2.027h3.428c1.752 0 3.121.778 4.02 2.027C15.607 15.74 16 17.339 16 19a1 1 0 1 1-2 0c0-1.377-.33-2.527-.89-3.305c-.533-.742-1.307-1.195-2.396-1.195H7.286c-1.09 0-1.863.453-2.397 1.195C4.33 16.472 4 17.623 4 19a1 1 0 1 1-2 0c0-1.661.393-3.26 1.266-4.473"></svg:path><svg:path d="M2 19a1 1 0 0 1 1-1h11.971a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1M14.892 5.867l-.028-.002a2.3 2.3 0 0 1-.445-.07c-.345-.092-.655-.276-.796-.595l-.013-.028c-.208-.47.006-1.033.513-1.12a3.75 3.75 0 1 1 .596 7.448c-.514-.004-.815-.526-.684-1.023l.008-.03c.088-.338.366-.569.69-.714a2.3 2.3 0 0 1 .456-.147a1.887 1.887 0 0 0-.297-3.719M15.5 13.5a1 1 0 0 1 1-1h.214c1.752 0 3.121.778 4.02 2.027C21.607 15.74 22 17.339 22 19a1 1 0 1 1-2 0c0-1.377-.33-2.527-.89-3.305c-.533-.742-1.307-1.195-2.396-1.195H16.5a1 1 0 0 1-1-1"></svg:path><svg:path d="M17 19a1 1 0 0 1 1-1h2.971a1 1 0 0 1 0 2H18a1 1 0 0 1-1-1"></svg:path></svg:g></svg:g>`,
})
export class CuidaUsersOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaVisibilityOffOutlineIcon],svg[cuida-visibility-off-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaVisibilityOnOutlineIcon],svg[cuida-visibility-on-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M12.153 3.802c3.734.067 7.309 2.237 9.228 6.14a4.79 4.79 0 0 1 0 4.217c-1.92 3.902-5.494 6.072-9.228 6.14c-3.75.067-7.427-1.99-9.532-6.003a4.84 4.84 0 0 1 0-4.492c2.105-4.013 5.781-6.07 9.532-6.002m-7.761 6.932c3.545-6.759 11.99-6.425 15.195.09c.379.77.379 1.681 0 2.452c-3.205 6.515-11.65 6.849-15.195.09a2.84 2.84 0 0 1 0-2.632" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M15.7 12.05a3.75 3.75 0 1 1-7.5 0a3.75 3.75 0 0 1 7.5 0m-3.75 1.75a1.75 1.75 0 1 0 0-3.5a1.75 1.75 0 0 0 0 3.5" clip-rule="evenodd"></svg:path>`,
})
export class CuidaVisibilityOnOutlineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[cuidaVolume1OutlineIcon],svg[cuida-volume-1-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaVolume2OutlineIcon],svg[cuida-volume-2-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[cuidaWeightOutlineIcon],svg[cuida-weight-outline-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
