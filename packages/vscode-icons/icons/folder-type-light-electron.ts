...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightElectronIcon],svg[vscode-icons-folder-type-light-electron-icon]',
  host: {
    role: 'img',
