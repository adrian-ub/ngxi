...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeFaviconOpenedIcon],svg[vscode-icons-folder-type-favicon-opened-icon]',
  host: {
    role: 'img',
