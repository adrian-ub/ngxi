...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeGradleIcon],svg[vscode-icons-file-type-gradle-icon]',
  host: {
    role: 'img',
