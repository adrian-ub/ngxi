...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeTypings2OpenedIcon],svg[vscode-icons-folder-type-typings2-opened-icon]',
  host: {
    role: 'img',
