...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightMlangIcon],svg[vscode-icons-file-type-light-mlang-icon]',
  host: {
    role: 'img',
