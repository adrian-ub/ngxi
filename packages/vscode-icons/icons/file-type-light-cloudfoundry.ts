...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightCloudfoundryIcon],svg[vscode-icons-file-type-light-cloudfoundry-icon]',
  host: {
    role: 'img',
