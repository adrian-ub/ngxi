...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeDockertest2Icon],svg[vscode-icons-file-type-dockertest2-icon]',
  host: {
    role: 'img',
