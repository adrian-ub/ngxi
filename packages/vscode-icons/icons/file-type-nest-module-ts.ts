...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestModuleTsIcon],svg[vscode-icons-file-type-nest-module-ts-icon]',
  host: {
    role: 'img',
