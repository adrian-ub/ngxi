...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeApiOpenedIcon],svg[vscode-icons-folder-type-api-opened-icon]',
  host: {
    role: 'img',
