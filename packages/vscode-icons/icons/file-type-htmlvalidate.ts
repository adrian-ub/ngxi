...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeHtmlvalidateIcon],svg[vscode-icons-file-type-htmlvalidate-icon]',
  host: {
    role: 'img',
