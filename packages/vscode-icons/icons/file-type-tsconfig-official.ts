...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeTsconfigOfficialIcon],svg[vscode-icons-file-type-tsconfig-official-icon]',
  host: {
    role: 'img',
