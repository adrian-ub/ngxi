...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeHookOpenedIcon],svg[vscode-icons-folder-type-hook-opened-icon]',
  host: {
    role: 'img',
