...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeJsOfficialIcon],svg[vscode-icons-file-type-js-official-icon]',
  host: {
    role: 'img',
