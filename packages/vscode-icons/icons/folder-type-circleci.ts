...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeCircleciIcon],svg[vscode-icons-folder-type-circleci-icon]',
  host: {
    role: 'img',
