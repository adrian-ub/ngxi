...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeApplescriptIcon],svg[vscode-icons-file-type-applescript-icon]',
  host: {
    role: 'img',
