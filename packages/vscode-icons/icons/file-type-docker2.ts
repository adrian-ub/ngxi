...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeDocker2Icon],svg[vscode-icons-file-type-docker2-icon]',
  host: {
    role: 'img',
