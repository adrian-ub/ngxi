...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLiquidIcon],svg[vscode-icons-file-type-liquid-icon]',
  host: {
    role: 'img',
