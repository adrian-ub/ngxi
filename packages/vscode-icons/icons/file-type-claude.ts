...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeClaudeIcon],svg[vscode-icons-file-type-claude-icon]',
  host: {
    role: 'img',
