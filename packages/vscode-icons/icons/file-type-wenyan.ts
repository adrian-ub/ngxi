...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeWenyanIcon],svg[vscode-icons-file-type-wenyan-icon]',
  host: {
    role: 'img',
