...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeCopilotIcon],svg[vscode-icons-file-type-copilot-icon]',
  host: {
    role: 'img',
