...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeInfopathIcon],svg[vscode-icons-file-type-infopath-icon]',
  host: {
    role: 'img',
