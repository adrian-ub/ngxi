...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeObjidconfigIcon],svg[vscode-icons-file-type-objidconfig-icon]',
  host: {
    role: 'img',
