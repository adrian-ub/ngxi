...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightConfigIcon],svg[vscode-icons-file-type-light-config-icon]',
  host: {
    role: 'img',
