...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeTestjsIcon],svg[vscode-icons-file-type-testjs-icon]',
  host: {
    role: 'img',
