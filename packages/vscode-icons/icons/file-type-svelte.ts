...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeSvelteIcon],svg[vscode-icons-file-type-svelte-icon]',
  host: {
    role: 'img',
