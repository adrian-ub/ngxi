...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeHuskyOpenedIcon],svg[vscode-icons-folder-type-husky-opened-icon]',
  host: {
    role: 'img',
