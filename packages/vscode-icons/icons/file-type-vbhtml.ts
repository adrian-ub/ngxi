...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeVbhtmlIcon],svg[vscode-icons-file-type-vbhtml-icon]',
  host: {
    role: 'img',
