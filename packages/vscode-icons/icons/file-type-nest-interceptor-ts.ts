...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestInterceptorTsIcon],svg[vscode-icons-file-type-nest-interceptor-ts-icon]',
  host: {
    role: 'img',
