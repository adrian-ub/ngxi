...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeVscodeTest3OpenedIcon],svg[vscode-icons-folder-type-vscode-test3-opened-icon]',
  host: {
    role: 'img',
...
export class VscodeIconsFolderTypeVscodeTest3OpenedIcon {
