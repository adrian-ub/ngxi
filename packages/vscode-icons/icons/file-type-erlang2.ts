...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeErlang2Icon],svg[vscode-icons-file-type-erlang2-icon]',
  host: {
    role: 'img',
