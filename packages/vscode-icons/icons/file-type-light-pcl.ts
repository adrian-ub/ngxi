...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightPclIcon],svg[vscode-icons-file-type-light-pcl-icon]',
  host: {
    role: 'img',
