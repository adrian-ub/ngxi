...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeQsharpIcon],svg[vscode-icons-file-type-qsharp-icon]',
  host: {
    role: 'img',
