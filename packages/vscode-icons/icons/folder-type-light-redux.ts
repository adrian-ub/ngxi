...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightReduxIcon],svg[vscode-icons-folder-type-light-redux-icon]',
  host: {
    role: 'img',
