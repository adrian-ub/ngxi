...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightNodeOpenedIcon],svg[vscode-icons-folder-type-light-node-opened-icon]',
  host: {
    role: 'img',
