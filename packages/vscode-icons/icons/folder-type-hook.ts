...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeHookIcon],svg[vscode-icons-folder-type-hook-icon]',
  host: {
    role: 'img',
