...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypePytestOpenedIcon],svg[vscode-icons-folder-type-pytest-opened-icon]',
  host: {
    role: 'img',
