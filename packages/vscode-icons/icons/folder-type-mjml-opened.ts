...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeMjmlOpenedIcon],svg[vscode-icons-folder-type-mjml-opened-icon]',
  host: {
    role: 'img',
