...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightSymfonyIcon],svg[vscode-icons-file-type-light-symfony-icon]',
  host: {
    role: 'img',
