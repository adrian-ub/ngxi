...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeCoderabbitIcon],svg[vscode-icons-file-type-coderabbit-icon]',
  host: {
    role: 'img',
