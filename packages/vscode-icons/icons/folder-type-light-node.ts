...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightNodeIcon],svg[vscode-icons-folder-type-light-node-icon]',
  host: {
    role: 'img',
