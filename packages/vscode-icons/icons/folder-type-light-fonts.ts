...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightFontsIcon],svg[vscode-icons-folder-type-light-fonts-icon]',
  host: {
    role: 'img',
