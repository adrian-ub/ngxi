...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestAdapterTsIcon],svg[vscode-icons-file-type-nest-adapter-ts-icon]',
  host: {
    role: 'img',
