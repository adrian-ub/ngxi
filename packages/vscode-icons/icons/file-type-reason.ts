...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeReasonIcon],svg[vscode-icons-file-type-reason-icon]',
  host: {
    role: 'img',
