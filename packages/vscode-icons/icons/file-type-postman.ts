...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypePostmanIcon],svg[vscode-icons-file-type-postman-icon]',
  host: {
    role: 'img',
