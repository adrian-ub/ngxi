...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeSafetensorsIcon],svg[vscode-icons-file-type-safetensors-icon]',
  host: {
    role: 'img',
