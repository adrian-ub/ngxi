...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightCopilotIcon],svg[vscode-icons-file-type-light-copilot-icon]',
  host: {
    role: 'img',
