...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeConfigIcon],svg[vscode-icons-file-type-config-icon]',
  host: {
    role: 'img',
