...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeElectronOpenedIcon],svg[vscode-icons-folder-type-electron-opened-icon]',
  host: {
    role: 'img',
