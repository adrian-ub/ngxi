...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestFilterTsIcon],svg[vscode-icons-file-type-nest-filter-ts-icon]',
  host: {
    role: 'img',
