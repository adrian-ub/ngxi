...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeFundingIcon],svg[vscode-icons-file-type-funding-icon]',
  host: {
    role: 'img',
