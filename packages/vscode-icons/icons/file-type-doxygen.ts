...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeDoxygenIcon],svg[vscode-icons-file-type-doxygen-icon]',
  host: {
    role: 'img',
