...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeQmldirIcon],svg[vscode-icons-file-type-qmldir-icon]',
  host: {
    role: 'img',
