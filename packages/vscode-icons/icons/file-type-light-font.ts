...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightFontIcon],svg[vscode-icons-file-type-light-font-icon]',
  host: {
    role: 'img',
