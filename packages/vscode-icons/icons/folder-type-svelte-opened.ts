...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeSvelteOpenedIcon],svg[vscode-icons-folder-type-svelte-opened-icon]',
  host: {
    role: 'img',
