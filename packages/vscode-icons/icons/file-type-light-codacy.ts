...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightCodacyIcon],svg[vscode-icons-file-type-light-codacy-icon]',
  host: {
    role: 'img',
