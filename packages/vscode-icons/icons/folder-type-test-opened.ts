...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeTestOpenedIcon],svg[vscode-icons-folder-type-test-opened-icon]',
  host: {
    role: 'img',
