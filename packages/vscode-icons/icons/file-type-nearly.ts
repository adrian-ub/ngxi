...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNearlyIcon],svg[vscode-icons-file-type-nearly-icon]',
  host: {
    role: 'img',
