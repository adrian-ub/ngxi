...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeHandlebarsIcon],svg[vscode-icons-file-type-handlebars-icon]',
  host: {
    role: 'img',
