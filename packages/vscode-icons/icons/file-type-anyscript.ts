...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeAnyscriptIcon],svg[vscode-icons-file-type-anyscript-icon]',
  host: {
    role: 'img',
