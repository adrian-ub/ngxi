...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNextflowIcon],svg[vscode-icons-file-type-nextflow-icon]',
  host: {
    role: 'img',
