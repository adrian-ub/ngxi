...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeMjmlIcon],svg[vscode-icons-folder-type-mjml-icon]',
  host: {
    role: 'img',
