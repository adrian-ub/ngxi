...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightDbIcon],svg[vscode-icons-file-type-light-db-icon]',
  host: {
    role: 'img',
