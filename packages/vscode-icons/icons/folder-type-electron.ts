...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeElectronIcon],svg[vscode-icons-folder-type-electron-icon]',
  host: {
    role: 'img',
