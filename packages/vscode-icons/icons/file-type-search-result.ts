...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeSearchResultIcon],svg[vscode-icons-file-type-search-result-icon]',
  host: {
    role: 'img',
