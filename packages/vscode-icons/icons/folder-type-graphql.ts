...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeGraphqlIcon],svg[vscode-icons-folder-type-graphql-icon]',
  host: {
    role: 'img',
