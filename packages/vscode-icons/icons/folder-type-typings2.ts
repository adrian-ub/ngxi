...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeTypings2Icon],svg[vscode-icons-folder-type-typings2-icon]',
  host: {
    role: 'img',
