...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeManifestSkipIcon],svg[vscode-icons-file-type-manifest-skip-icon]',
  host: {
    role: 'img',
