...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeDenoifyIcon],svg[vscode-icons-file-type-denoify-icon]',
  host: {
    role: 'img',
