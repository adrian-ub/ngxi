...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeJbuilderIcon],svg[vscode-icons-file-type-jbuilder-icon]',
  host: {
    role: 'img',
