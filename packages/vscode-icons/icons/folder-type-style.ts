...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeStyleIcon],svg[vscode-icons-folder-type-style-icon]',
  host: {
    role: 'img',
