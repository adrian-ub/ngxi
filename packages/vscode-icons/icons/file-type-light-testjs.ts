...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightTestjsIcon],svg[vscode-icons-file-type-light-testjs-icon]',
  host: {
    role: 'img',
