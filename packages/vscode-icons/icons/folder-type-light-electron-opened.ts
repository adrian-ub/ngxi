...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightElectronOpenedIcon],svg[vscode-icons-folder-type-light-electron-opened-icon]',
  host: {
    role: 'img',
