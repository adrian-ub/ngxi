...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestjsIcon],svg[vscode-icons-file-type-nestjs-icon]',
  host: {
    role: 'img',
