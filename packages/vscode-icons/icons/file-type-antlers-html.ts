...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeAntlersHtmlIcon],svg[vscode-icons-file-type-antlers-html-icon]',
  host: {
    role: 'img',
