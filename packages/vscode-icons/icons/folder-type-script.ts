...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeScriptIcon],svg[vscode-icons-folder-type-script-icon]',
  host: {
    role: 'img',
