...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypePhotoshopIcon],svg[vscode-icons-file-type-photoshop-icon]',
  host: {
    role: 'img',
