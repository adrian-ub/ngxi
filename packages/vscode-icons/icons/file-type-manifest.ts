...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeManifestIcon],svg[vscode-icons-file-type-manifest-icon]',
  host: {
    role: 'img',
