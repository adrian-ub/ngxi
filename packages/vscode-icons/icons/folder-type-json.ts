...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeJsonIcon],svg[vscode-icons-folder-type-json-icon]',
  host: {
    role: 'img',
