...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightIoIcon],svg[vscode-icons-file-type-light-io-icon]',
  host: {
    role: 'img',
