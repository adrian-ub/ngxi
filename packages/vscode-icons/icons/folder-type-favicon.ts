...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeFaviconIcon],svg[vscode-icons-folder-type-favicon-icon]',
  host: {
    role: 'img',
