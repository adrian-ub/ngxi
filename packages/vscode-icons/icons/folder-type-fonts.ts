...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeFontsIcon],svg[vscode-icons-folder-type-fonts-icon]',
  host: {
    role: 'img',
