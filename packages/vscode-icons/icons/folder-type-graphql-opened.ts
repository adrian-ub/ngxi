...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeGraphqlOpenedIcon],svg[vscode-icons-folder-type-graphql-opened-icon]',
  host: {
    role: 'img',
