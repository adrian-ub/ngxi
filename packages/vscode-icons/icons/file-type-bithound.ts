...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeBithoundIcon],svg[vscode-icons-file-type-bithound-icon]',
  host: {
    role: 'img',
