...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeReduxOpenedIcon],svg[vscode-icons-folder-type-redux-opened-icon]',
  host: {
    role: 'img',
