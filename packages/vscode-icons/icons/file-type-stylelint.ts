...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeStylelintIcon],svg[vscode-icons-file-type-stylelint-icon]',
  host: {
    role: 'img',
