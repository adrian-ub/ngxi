...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeMustacheIcon],svg[vscode-icons-file-type-mustache-icon]',
  host: {
    role: 'img',
