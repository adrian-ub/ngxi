...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightFontsOpenedIcon],svg[vscode-icons-folder-type-light-fonts-opened-icon]',
  host: {
    role: 'img',
