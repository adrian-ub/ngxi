...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeYarnIcon],svg[vscode-icons-folder-type-yarn-icon]',
  host: {
    role: 'img',
