...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeFontsOpenedIcon],svg[vscode-icons-folder-type-fonts-opened-icon]',
  host: {
    role: 'img',
