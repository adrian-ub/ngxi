...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightToitIcon],svg[vscode-icons-file-type-light-toit-icon]',
  host: {
    role: 'img',
