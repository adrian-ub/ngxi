...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeLightReduxOpenedIcon],svg[vscode-icons-folder-type-light-redux-opened-icon]',
  host: {
    role: 'img',
