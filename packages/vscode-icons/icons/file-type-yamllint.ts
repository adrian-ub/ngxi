...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeYamllintIcon],svg[vscode-icons-file-type-yamllint-icon]',
  host: {
    role: 'img',
