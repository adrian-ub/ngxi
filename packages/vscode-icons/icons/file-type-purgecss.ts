...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypePurgecssIcon],svg[vscode-icons-file-type-purgecss-icon]',
  host: {
    role: 'img',
