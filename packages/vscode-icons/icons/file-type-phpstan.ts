...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypePhpstanIcon],svg[vscode-icons-file-type-phpstan-icon]',
  host: {
    role: 'img',
