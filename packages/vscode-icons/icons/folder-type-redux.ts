...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeReduxIcon],svg[vscode-icons-folder-type-redux-icon]',
  host: {
    role: 'img',
