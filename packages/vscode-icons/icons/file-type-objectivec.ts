...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeObjectivecIcon],svg[vscode-icons-file-type-objectivec-icon]',
  host: {
    role: 'img',
