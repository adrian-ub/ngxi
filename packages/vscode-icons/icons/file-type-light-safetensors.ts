...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightSafetensorsIcon],svg[vscode-icons-file-type-light-safetensors-icon]',
  host: {
    role: 'img',
