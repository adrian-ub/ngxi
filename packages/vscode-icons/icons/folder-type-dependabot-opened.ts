...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeDependabotOpenedIcon],svg[vscode-icons-folder-type-dependabot-opened-icon]',
  host: {
    role: 'img',
