...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeCodacyIcon],svg[vscode-icons-file-type-codacy-icon]',
  host: {
    role: 'img',
