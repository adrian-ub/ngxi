...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeVscodeTestIcon],svg[vscode-icons-file-type-vscode-test-icon]',
  host: {
    role: 'img',
