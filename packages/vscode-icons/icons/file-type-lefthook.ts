...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLefthookIcon],svg[vscode-icons-file-type-lefthook-icon]',
  host: {
    role: 'img',
