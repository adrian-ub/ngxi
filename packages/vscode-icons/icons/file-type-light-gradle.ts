...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightGradleIcon],svg[vscode-icons-file-type-light-gradle-icon]',
  host: {
    role: 'img',
