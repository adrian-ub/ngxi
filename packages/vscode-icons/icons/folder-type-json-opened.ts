...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeJsonOpenedIcon],svg[vscode-icons-folder-type-json-opened-icon]',
  host: {
    role: 'img',
