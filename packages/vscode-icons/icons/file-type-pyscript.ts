...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypePyscriptIcon],svg[vscode-icons-file-type-pyscript-icon]',
  host: {
    role: 'img',
