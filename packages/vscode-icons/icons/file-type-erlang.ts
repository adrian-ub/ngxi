...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeErlangIcon],svg[vscode-icons-file-type-erlang-icon]',
  host: {
    role: 'img',
