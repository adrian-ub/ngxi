...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestPipeJsIcon],svg[vscode-icons-file-type-nest-pipe-js-icon]',
  host: {
    role: 'img',
