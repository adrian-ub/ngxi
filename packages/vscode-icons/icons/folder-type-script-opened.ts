...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeScriptOpenedIcon],svg[vscode-icons-folder-type-script-opened-icon]',
  host: {
    role: 'img',
