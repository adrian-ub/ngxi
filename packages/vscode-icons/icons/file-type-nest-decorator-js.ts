...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeNestDecoratorJsIcon],svg[vscode-icons-file-type-nest-decorator-js-icon]',
  host: {
    role: 'img',
