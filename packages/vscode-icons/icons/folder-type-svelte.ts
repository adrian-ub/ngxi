...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeSvelteIcon],svg[vscode-icons-folder-type-svelte-icon]',
  host: {
    role: 'img',
