...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightNeo4jIcon],svg[vscode-icons-file-type-light-neo4j-icon]',
  host: {
    role: 'img',
