...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeScriptIcon],svg[vscode-icons-file-type-script-icon]',
  host: {
    role: 'img',
