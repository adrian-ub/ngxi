...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeSourceIcon],svg[vscode-icons-file-type-source-icon]',
  host: {
    role: 'img',
