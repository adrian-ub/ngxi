...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeRouteOpenedIcon],svg[vscode-icons-folder-type-route-opened-icon]',
  host: {
    role: 'img',
