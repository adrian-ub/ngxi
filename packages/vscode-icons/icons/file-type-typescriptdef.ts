...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeTypescriptdefIcon],svg[vscode-icons-file-type-typescriptdef-icon]',
  host: {
    role: 'img',
