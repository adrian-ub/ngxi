...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightVashIcon],svg[vscode-icons-file-type-light-vash-icon]',
  host: {
    role: 'img',
