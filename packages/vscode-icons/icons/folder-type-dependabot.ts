...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeDependabotIcon],svg[vscode-icons-folder-type-dependabot-icon]',
  host: {
    role: 'img',
