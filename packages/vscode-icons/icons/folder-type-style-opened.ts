...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFolderTypeStyleOpenedIcon],svg[vscode-icons-folder-type-style-opened-icon]',
  host: {
    role: 'img',
