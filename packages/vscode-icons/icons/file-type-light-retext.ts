...
@Component({
  standalone: true,
  selector: 'svg[vscodeIconsFileTypeLightRetextIcon],svg[vscode-icons-file-type-light-retext-icon]',
  host: {
    role: 'img',
