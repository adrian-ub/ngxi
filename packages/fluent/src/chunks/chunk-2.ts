...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMaximize20RegularIcon],svg[fluent-arrow-maximize-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMaximize24FilledIcon],svg[fluent-arrow-maximize-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMaximize24RegularIcon],svg[fluent-arrow-maximize-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimize16FilledIcon],svg[fluent-arrow-minimize-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimize16RegularIcon],svg[fluent-arrow-minimize-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.854 2.854a.5.5 0 0 0-.708-.708L10 5.293V3.5a.5.5 0 0 0-1 0v2.9a.6.6 0 0 0 .6.6h2.9a.5.5 0 0 0 0-1h-1.793zM6.5 13a.5.5 0 0 1-.5-.5v-1.793l-3.146 3.147a.5.5 0 0 1-.708-.708L5.293 10H3.5a.5.5 0 0 1 0-1h2.9a.6.6 0 0 1 .6.6v2.9a.5.5 0 0 1-.5.5"></svg:path>`,
})
export class FluentArrowMinimize16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimize20FilledIcon],svg[fluent-arrow-minimize-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimize24RegularIcon],svg[fluent-arrow-minimize-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimize28RegularIcon],svg[fluent-arrow-minimize-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMinimizeVertical24RegularIcon],svg[fluent-arrow-minimize-vertical-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMove24FilledIcon],svg[fluent-arrow-move-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowMoveInward20FilledIcon],svg[fluent-arrow-move-inward-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft20RegularIcon],svg[fluent-arrow-outline-down-left-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.003 16.444a.5.5 0 0 0 .552.552l9.704-1.078a.5.5 0 0 0 .298-.85l-1.42-1.421a.5.5 0 0 1 0-.707l4.716-4.717a.5.5 0 0 0 0-.707l-4.37-4.37a.5.5 0 0 0-.706 0L7.06 7.863a.5.5 0 0 1-.707 0l-1.421-1.42a.5.5 0 0 0-.85.297zm.663 1.546a1.5 1.5 0 0 1-1.657-1.657L3.088 6.63c.138-1.25 1.662-1.784 2.551-.895l1.067 1.067L11.07 2.44a1.5 1.5 0 0 1 2.122 0l4.37 4.37a1.5 1.5 0 0 1 0 2.121l-4.364 4.363l1.068 1.067c.889.89.354 2.413-.896 2.552z"></svg:path>`,
})
export class FluentArrowOutlineDownLeft20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft24FilledIcon],svg[fluent-arrow-outline-down-left-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.166 21.986a1.95 1.95 0 0 1-2.154-2.153L3.352 7.77c.181-1.625 2.161-2.32 3.317-1.163l1.268 1.267L13.24 2.57a1.95 1.95 0 0 1 2.758 0L21.427 8a1.95 1.95 0 0 1 0 2.757l-5.304 5.304l1.268 1.267c1.156 1.156.461 3.136-1.164 3.317z"></svg:path>`,
})
export class FluentArrowOutlineDownLeft24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft24RegularIcon],svg[fluent-arrow-outline-down-left-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.503 19.998a.45.45 0 0 0 .497.497l12.062-1.34a.45.45 0 0 0 .268-.765l-1.798-1.798a.75.75 0 0 1 0-1.06l5.834-5.835a.45.45 0 0 0 0-.636l-5.429-5.43a.45.45 0 0 0-.636 0L8.467 9.467a.75.75 0 0 1-1.06 0L5.608 7.668a.45.45 0 0 0-.766.269zm.663 1.988a1.95 1.95 0 0 1-2.154-2.153L3.352 7.77c.181-1.625 2.161-2.32 3.317-1.163l1.268 1.267L13.24 2.57a1.95 1.95 0 0 1 2.758 0L21.427 8a1.95 1.95 0 0 1 0 2.757l-5.304 5.304l1.268 1.267c1.156 1.156.461 3.136-1.164 3.317z"></svg:path>`,
})
export class FluentArrowOutlineDownLeft24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft28RegularIcon],svg[fluent-arrow-outline-down-left-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft32RegularIcon],svg[fluent-arrow-outline-down-left-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.793 2.878a3 3 0 0 1 4.243 0l7.09 7.09a3 3 0 0 1 0 4.243l-6.902 6.902l1.749 1.748c2.122 2.122.765 5.755-2.228 5.967L5.212 29.996a3 3 0 0 1-3.204-3.204l1.167-16.53c.21-2.993 3.844-4.35 5.965-2.23l1.75 1.75zm2.829 1.415a1 1 0 0 0-1.415 0l-7.61 7.61a1 1 0 0 1-1.414 0L7.726 9.447c-.909-.909-2.466-.327-2.556.956l-1.167 16.53A1 1 0 0 0 5.07 28l16.533-1.167c1.283-.09 1.864-1.648.955-2.557l-2.456-2.456a1 1 0 0 1 0-1.414l7.608-7.61a1 1 0 0 0 0-1.413z"></svg:path>`,
})
export class FluentArrowOutlineDownLeft32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineDownLeft48RegularIcon],svg[fluent-arrow-outline-down-left-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineUpRight20RegularIcon],svg[fluent-arrow-outline-up-right-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineUpRight24FilledIcon],svg[fluent-arrow-outline-up-right-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.833 2.012a1.95 1.95 0 0 1 2.153 2.154l-1.34 12.061c-.18 1.625-2.161 2.32-3.317 1.164l-1.267-1.267l-5.304 5.303a1.95 1.95 0 0 1-2.758 0l-5.429-5.429a1.95 1.95 0 0 1 0-2.758l5.304-5.303l-1.268-1.268c-1.156-1.156-.461-3.136 1.164-3.317z"></svg:path>`,
})
export class FluentArrowOutlineUpRight24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineUpRight24RegularIcon],svg[fluent-arrow-outline-up-right-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineUpRight32RegularIcon],svg[fluent-arrow-outline-up-right-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowOutlineUpRight48RegularIcon],svg[fluent-arrow-outline-up-right-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M38.146 4.042c3.359-.39 6.206 2.45 5.823 5.81l-2.665 23.387c-.4 3.516-4.672 5.03-7.198 2.553l-2.843-2.787l-9.465 9.46a5.25 5.25 0 0 1-7.427-.004l-8.833-8.849a5.25 5.25 0 0 1 .004-7.42l9.452-9.453l-2.75-2.751c-2.51-2.514-1.012-6.815 2.516-7.226zm3.339 5.526a2.75 2.75 0 0 0-3.05-3.043l-23.386 2.72c-1.453.17-2.07 1.94-1.036 2.976l3.632 3.635a1.25 1.25 0 0 1 0 1.768L7.309 27.959a2.75 2.75 0 0 0-.001 3.887l8.833 8.849a2.75 2.75 0 0 0 3.89.002l10.34-10.335a1.25 1.25 0 0 1 1.759-.009l3.726 3.654c1.04 1.02 2.799.396 2.964-1.051z"></svg:path>`,
})
export class FluentArrowOutlineUpRight48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowParagraph16RegularIcon],svg[fluent-arrow-paragraph-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowParagraph16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowParagraph20RegularIcon],svg[fluent-arrow-paragraph-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowParagraph20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowParagraph24FilledIcon],svg[fluent-arrow-paragraph-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowParagraph24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowParagraph24RegularIcon],svg[fluent-arrow-paragraph-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowParagraph24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo16RegularIcon],svg[fluent-arrow-redo-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 2.5a.5.5 0 0 0-1 0v3.843L8.827 3.172a4 4 0 0 0-5.656 5.656l5.025 5.026a.5.5 0 0 0 .707-.708L3.879 8.121A3 3 0 0 1 8.12 3.88L11.243 7H7.499a.5.5 0 0 0 0 1h4.9a.6.6 0 0 0 .6-.6z"></svg:path>`,
})
export class FluentArrowRedo16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo20FilledIcon],svg[fluent-arrow-redo-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.14 6.5h-2.387a.75.75 0 1 0 0 1.5h4.4c.47 0 .85-.38.85-.85v-4.4a.75.75 0 0 0-1.5 0v2.947l-3.059-2.66a5.25 5.25 0 0 0-6.888 7.925l8.172 7.104a.75.75 0 1 0 .984-1.132L5.54 9.83a3.75 3.75 0 1 1 4.92-5.66z"></svg:path>`,
})
export class FluentArrowRedo20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo28FilledIcon],svg[fluent-arrow-redo-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.011 5.436a5.76 5.76 0 0 1 7.833.115L20.552 11h-6.551a1 1 0 0 0 0 2h9a1 1 0 0 0 1-1V3a1 1 0 1 0-2 0v6.618l-5.776-5.514A7.76 7.76 0 0 0 5.673 3.95c-3.324 2.991-3.439 8.166-.25 11.302l10.632 10.46a1 1 0 0 0 1.403-1.425L6.825 13.827a5.76 5.76 0 0 1 .186-8.39"></svg:path>`,
})
export class FluentArrowRedo28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo28RegularIcon],svg[fluent-arrow-redo-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.134 4.655a6.26 6.26 0 0 1 8.028.648l6.27 6.196h-7.679a.75.75 0 0 0 0 1.5h9.5a.75.75 0 0 0 .75-.75V2.75a.75.75 0 0 0-1.5 0v7.7l-6.287-6.214a7.76 7.76 0 0 0-9.951-.804c-3.991 2.838-4.388 8.62-.82 11.975l11.04 10.39a.75.75 0 0 0 1.029-1.093L6.472 14.314c-2.877-2.707-2.558-7.37.662-9.66"></svg:path>`,
})
export class FluentArrowRedo28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo32FilledIcon],svg[fluent-arrow-redo-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M27.002 4.256a1.25 1.25 0 1 0-2.5 0v6.181L19.905 5.64c-1.221-1.294-3.252-2.326-5.481-2.543c-2.28-.22-4.817.408-6.929 2.52c-2.149 2.15-2.712 4.66-2.5 6.83c.205 2.105 1.143 3.959 2.118 4.936l.002.002L18.322 28.68a1.25 1.25 0 1 0 1.775-1.76l-11.21-11.3l-.004-.004c-.523-.523-1.245-1.818-1.4-3.412c-.15-1.528.228-3.268 1.78-4.82c1.525-1.525 3.298-1.957 4.92-1.8c1.669.163 3.128.947 3.907 1.773l.007.008l4.939 5.155h-6.437a1.25 1.25 0 0 0 0 2.5h9.153c.69 0 1.25-.56 1.25-1.25z"></svg:path>`,
})
export class FluentArrowRedo32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRedo32RegularIcon],svg[fluent-arrow-redo-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat116FilledIcon],svg[fluent-arrow-repeat-1-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat116RegularIcon],svg[fluent-arrow-repeat-1-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat120FilledIcon],svg[fluent-arrow-repeat-1-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat120RegularIcon],svg[fluent-arrow-repeat-1-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat124FilledIcon],svg[fluent-arrow-repeat-1-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeat124RegularIcon],svg[fluent-arrow-repeat-1-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll16FilledIcon],svg[fluent-arrow-repeat-all-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll16RegularIcon],svg[fluent-arrow-repeat-all-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll20FilledIcon],svg[fluent-arrow-repeat-all-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll20RegularIcon],svg[fluent-arrow-repeat-all-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.5 6.671c.116 0 .223.04.308.107l.067.063l.017.02a5 5 0 0 1-3.675 8.135L13 15H7a5 5 0 0 1-.303-.009l1.657 1.655a.5.5 0 0 1 .057.638l-.057.07a.5.5 0 0 1-.638.057l-.07-.057l-2.5-2.5a.5.5 0 0 1-.057-.638l.057-.07l2.5-2.5a.5.5 0 0 1 .765.638l-.057.07l-1.637 1.636l.14.008L7 14h6a4 4 0 0 0 3.11-6.516a.5.5 0 0 1 .39-.812m-4.854-4.025a.5.5 0 0 1 .638-.057l.07.057l2.5 2.5l.057.07a.5.5 0 0 1 0 .568l-.057.07l-2.5 2.5l-.07.057a.5.5 0 0 1-.568 0l-.07-.057l-.057-.07a.5.5 0 0 1 0-.568l.057-.07l1.637-1.636l-.14-.008L13 6H7a4 4 0 0 0-3.105 6.522a.5.5 0 1 1-.801.601a5 5 0 0 1 3.689-8.119L7 5h6q.153 0 .303.009l-1.657-1.655l-.057-.07a.5.5 0 0 1 .057-.638"></svg:path>`,
})
export class FluentArrowRepeatAll20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll24FilledIcon],svg[fluent-arrow-repeat-all-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll24RegularIcon],svg[fluent-arrow-repeat-all-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRepeatAll24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll28FilledIcon],svg[fluent-arrow-repeat-all-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.293 2.293a1 1 0 0 1 1.415 0l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.415-1.414L17.586 8h-7.335a6.25 6.25 0 0 0-6.246 6h-.004a6.22 6.22 0 0 0 1.297 3.568h-.003a1 1 0 1 1-1.633 1.154A8.2 8.2 0 0 1 2.001 14h.004a8.25 8.25 0 0 1 8.247-8h7.335l-2.293-2.293a1 1 0 0 1 0-1.414M25.997 14h-.004a8.25 8.25 0 0 1-8.247 8h-7.34l2.294 2.293a1 1 0 0 1-1.414 1.414l-4-4a1 1 0 0 1 0-1.414l4-4a1 1 0 0 1 1.414 1.414L10.407 20h7.34a6.25 6.25 0 0 0 6.244-6h.005a6.22 6.22 0 0 0-1.297-3.568h.002a1 1 0 1 1 1.633-1.154A8.2 8.2 0 0 1 25.997 14"></svg:path>`,
})
export class FluentArrowRepeatAll28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll28RegularIcon],svg[fluent-arrow-repeat-all-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll48FilledIcon],svg[fluent-arrow-repeat-all-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M29.56 5.44a1.5 1.5 0 0 0-2.12 2.12L30.878 11H17C9.82 11 4 16.82 4 24c0 3.34 1.26 6.386 3.33 8.689a1.5 1.5 0 1 0 2.276-1.952l.002-.002A9.96 9.96 0 0 1 7 24c0-5.523 4.477-10 10-10h13.879l-3.44 3.44a1.5 1.5 0 0 0 2.122 2.12l6-6a1.5 1.5 0 0 0 0-2.12zM18.44 42.56a1.5 1.5 0 0 0 2.12-2.12L17.122 37H31c7.18 0 13-5.82 13-13c0-3.34-1.26-6.386-3.33-8.689a1.5 1.5 0 1 0-2.276 1.952l-.002.002A9.96 9.96 0 0 1 41 24c0 5.523-4.477 10-10 10H17.121l3.44-3.44a1.5 1.5 0 0 0-2.122-2.12l-6 6a1.5 1.5 0 0 0 0 2.12z"></svg:path>`,
})
export class FluentArrowRepeatAll48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAll48RegularIcon],svg[fluent-arrow-repeat-all-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M29.116 5.349a1.25 1.25 0 1 0-1.732 1.802l4.009 3.855Q31.197 11 31 11H17C9.82 11 4 16.82 4 24a12.95 12.95 0 0 0 3.23 8.576v-.004A1.25 1.25 0 0 0 9.172 31h.002l-.012-.012a1 1 0 0 0-.106-.121A10.46 10.46 0 0 1 6.5 24c0-5.799 4.701-10.5 10.5-10.5h14q.44 0 .87.036l-4.486 4.313a1.25 1.25 0 0 0 1.732 1.802l6.5-6.25a1.25 1.25 0 0 0 0-1.802zM18.884 42.65a1.25 1.25 0 0 0 1.732-1.802l-4.009-3.855Q16.803 37 17 37h14c7.18 0 13-5.82 13-13l-.001-.177a12.95 12.95 0 0 0-3.229-8.4v.005A1.25 1.25 0 0 0 38.828 17h-.002l.012.012q.048.065.106.121A10.46 10.46 0 0 1 41.5 24c0 5.799-4.701 10.5-10.5 10.5H17q-.44 0-.87-.035l4.486-4.314a1.25 1.25 0 0 0-1.732-1.802l-6.5 6.25a1.25 1.25 0 0 0 0 1.802z"></svg:path>`,
})
export class FluentArrowRepeatAll48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff16FilledIcon],svg[fluent-arrow-repeat-all-off-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff16RegularIcon],svg[fluent-arrow-repeat-all-off-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m2.784 2.088l.07.058l11 11a.5.5 0 0 1-.638.765l-.07-.058l-2.016-2.015a4 4 0 0 1-.896.155L10 12l-3.293-.001l1.148 1.149a.5.5 0 0 1 .058.638l-.058.069a.5.5 0 0 1-.638.058l-.069-.058l-2.002-2.002a.5.5 0 0 1-.057-.638l.057-.069l2.002-2.002a.5.5 0 0 1 .765.638l-.058.07l-1.148 1.147H10q.141 0 .279-.012L4.626 5.332a3 3 0 0 0-.765 4.772a.5.5 0 0 1-.714.698a3.997 3.997 0 0 1 .746-6.203L2.146 2.853a.5.5 0 0 1 .638-.765m9.716 2.96a.5.5 0 0 1 .322.118l.072.072A4 4 0 0 1 14 8a4 4 0 0 1-1.12 2.775l-.706-.708A3 3 0 0 0 13 8a3 3 0 0 0-.866-2.109a.5.5 0 0 1 .366-.843M8.146 2.145a.5.5 0 0 1 .638-.057l.07.057l2.001 2.002l.058.07a.5.5 0 0 1 0 .568l-.058.07L8.907 6.8L8.2 6.093l1.094-1.094H7.105l-1-1h3.189L8.146 2.852l-.057-.07a.5.5 0 0 1 .057-.638"></svg:path>`,
})
export class FluentArrowRepeatAllOff16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff20FilledIcon],svg[fluent-arrow-repeat-all-off-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff20RegularIcon],svg[fluent-arrow-repeat-all-off-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.146 2.146a.5.5 0 0 1 .638-.057l.07.057l15 15l.057.07a.5.5 0 0 1-.695.695l-.07-.057l-2.988-2.989a5 5 0 0 1-.861.126L13 15H7q-.153 0-.304-.01l1.658 1.656a.5.5 0 0 1 .057.638l-.057.07a.5.5 0 0 1-.638.057l-.07-.057l-2.5-2.5a.5.5 0 0 1-.057-.638l.057-.07l2.5-2.5a.5.5 0 0 1 .765.638l-.057.07l-1.636 1.636l.14.008L7 14h6q.143 0 .283-.01L5.56 6.267a4 4 0 0 0-1.665 6.255a.5.5 0 1 1-.801.601a5 5 0 0 1 1.707-7.616L2.147 2.855l-.057-.07a.5.5 0 0 1 .057-.638M16.5 6.671c.116 0 .223.04.308.107l.067.063l.017.02A4.98 4.98 0 0 1 18 10c0 1.608-.76 3.04-1.939 3.954l-.714-.714A4 4 0 0 0 17 10c0-.953-.334-1.829-.89-2.516a.5.5 0 0 1 .39-.812M12.284 2.59l.07.057l2.5 2.5a.5.5 0 0 1 .057.638l-.057.07l-2.5 2.5a.5.5 0 0 1-.765-.638l.057-.07l1.637-1.636l-.14-.008L13 6H8.106l-1-1H13q.153 0 .304.01l-1.658-1.656a.5.5 0 0 1-.057-.638l.057-.07a.5.5 0 0 1 .638-.057"></svg:path>`,
})
export class FluentArrowRepeatAllOff20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff24FilledIcon],svg[fluent-arrow-repeat-all-off-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m3.613 2.21l.094.083l18 18a1 1 0 0 1-1.32 1.497l-.094-.083l-3.068-3.068a7 7 0 0 1-1.893.353l-.331.008H9.405l1.304 1.303l.077.087A1 1 0 0 1 9.39 21.8l-.095-.083l-3.005-3.005l-.077-.087a1 1 0 0 1-.006-1.232l.083-.095l3.005-3.005l.088-.078a1 1 0 0 1 1.232-.006l.095.084l.077.087a1 1 0 0 1 .006 1.232l-.083.095l-1.294 1.292h5.586q.281 0 .553-.03L6.348 7.761A5 5 0 0 0 4 12.001c0 .918.248 1.779.68 2.519l.135.218a1 1 0 0 1-1.627 1.164A6.95 6.95 0 0 1 2 12a6.99 6.99 0 0 1 2.908-5.679L2.293 3.707a1 1 0 0 1 1.32-1.498M20 7.681c.32 0 .603.15.787.382l.053.075l.017.027A6.96 6.96 0 0 1 22 12.001c0 1.977-.82 3.762-2.138 5.035l-1.415-1.414A5 5 0 0 0 20 12.001c0-.926-.252-1.793-.69-2.537l-.138-.22A1 1 0 0 1 20 7.683m-5.375-5.47l.087.077l3.006 3.005a1 1 0 0 1 .077 1.327l-.078.087l-3.005 3.006a1 1 0 0 1-1.492-1.327l.078-.088l1.297-1.298H9.826L7.911 5.085q.416-.065.848-.08l.24-.004h5.598l-1.299-1.298a1 1 0 0 1-.078-1.327l.078-.087a1 1 0 0 1 1.327-.078"></svg:path>`,
})
export class FluentArrowRepeatAllOff24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRepeatAllOff24RegularIcon],svg[fluent-arrow-repeat-all-off-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReply28FilledIcon],svg[fluent-arrow-reply-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.707 5.293a1 1 0 0 1 0 1.414L6.414 11H15c5.523 0 10 4.477 10 10a1 1 0 1 1-2 0a8 8 0 0 0-8-8H6.414l4.293 4.293a1 1 0 0 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414l6-6a1 1 0 0 1 1.414 0"></svg:path>`,
})
export class FluentArrowReply28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReply32LightIcon],svg[fluent-arrow-reply-32-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.854 6.854a.5.5 0 0 0-.708-.708l-7 7a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708L4.707 14H16.5C22.851 14 28 19.149 28 25.5a.5.5 0 0 0 1 0C29 18.596 23.404 13 16.5 13H4.707z"></svg:path>`,
})
export class FluentArrowReply32LightIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyAll20FilledIcon],svg[fluent-arrow-reply-all-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.78 4.78a.75.75 0 0 0-1.06-1.06l-4.5 4.5a.75.75 0 0 0 0 1.06l4.5 4.5a.75.75 0 0 0 1.06-1.06L3.81 8.75zm3.5 0a.75.75 0 0 0-1.06-1.06l-4.5 4.5a.75.75 0 0 0 0 1.06l4.5 4.5a.75.75 0 1 0 1.06-1.06L8.06 9.5h2.69a5.75 5.75 0 0 1 5.75 5.75a.75.75 0 0 0 1.5 0A7.25 7.25 0 0 0 10.75 8H8.06z"></svg:path>`,
})
export class FluentArrowReplyAll20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyAll32LightIcon],svg[fluent-arrow-reply-all-32-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.854 6.146a.5.5 0 0 1 0 .708L4.207 13.5l6.647 6.646a.5.5 0 0 1-.708.708l-7-7a.5.5 0 0 1 0-.708l7-7a.5.5 0 0 1 .708 0m6 0a.5.5 0 0 1 0 .708L10.707 13H16.5C23.404 13 29 18.596 29 25.5a.5.5 0 0 1-1 0C28 19.149 22.851 14 16.5 14h-5.793l6.147 6.146a.5.5 0 0 1-.708.708l-7-7a.5.5 0 0 1 0-.708l7-7a.5.5 0 0 1 .708 0"></svg:path>`,
})
export class FluentArrowReplyAll32LightIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyAll32RegularIcon],svg[fluent-arrow-reply-all-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.707 6.293a1 1 0 0 1 0 1.414L5.414 14l6.293 6.293a1 1 0 0 1-1.414 1.414l-7-7a1 1 0 0 1 0-1.414l7-7a1 1 0 0 1 1.414 0m6 0a1 1 0 0 1 0 1.414L12.414 13H17c6.627 0 12 5.373 12 12a1 1 0 1 1-2 0c0-5.523-4.477-10-10-10h-4.586l5.293 5.293a1 1 0 0 1-1.414 1.414l-7-7a1 1 0 0 1 0-1.414l7-7a1 1 0 0 1 1.414 0"></svg:path>`,
})
export class FluentArrowReplyAll32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyAll48RegularIcon],svg[fluent-arrow-reply-all-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.134 8.366a1.25 1.25 0 0 1 0 1.768L7.018 20.25l10.116 10.116a1.25 1.25 0 0 1-1.768 1.768l-11-11a1.25 1.25 0 0 1 0-1.768l11-11a1.25 1.25 0 0 1 1.768 0m8 0a1.25 1.25 0 0 1 0 1.768L16.268 19h8.982C35.605 19 44 27.395 44 37.75a1.25 1.25 0 1 1-2.5 0c0-8.975-7.275-16.25-16.25-16.25h-8.982l8.866 8.866a1.25 1.25 0 0 1-1.768 1.768l-11-11a1.25 1.25 0 0 1 0-1.768l11-11a1.25 1.25 0 0 1 1.768 0"></svg:path>`,
})
export class FluentArrowReplyAll48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyDown20FilledIcon],svg[fluent-arrow-reply-down-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.25 4a.75.75 0 0 1 .75.75A7.25 7.25 0 0 1 10.75 12H4.56l3.22 3.22a.75.75 0 1 1-1.06 1.06l-4.5-4.5a.75.75 0 0 1 0-1.06l4.5-4.5a.75.75 0 0 1 1.06 1.06L4.56 10.5h6.19a5.75 5.75 0 0 0 5.75-5.75a.75.75 0 0 1 .75-.75"></svg:path>`,
})
export class FluentArrowReplyDown20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReplyDown20RegularIcon],svg[fluent-arrow-reply-down-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.5 4a.5.5 0 0 1 .5.5a7.5 7.5 0 0 1-7.5 7.5H3.707l3.647 3.646a.5.5 0 0 1-.708.708l-4.5-4.5a.5.5 0 0 1 0-.708l4.5-4.5a.5.5 0 1 1 .708.708L3.707 11H10.5A6.5 6.5 0 0 0 17 4.5a.5.5 0 0 1 .5-.5"></svg:path>`,
})
export class FluentArrowReplyDown20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReset32FilledIcon],svg[fluent-arrow-reset-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.884 3.116a1.25 1.25 0 0 1 0 1.768L6.018 7.75H17.5c5.937 0 10.75 4.813 10.75 10.75S23.437 29.25 17.5 29.25S6.75 24.437 6.75 18.5a1.25 1.25 0 1 1 2.5 0a8.25 8.25 0 1 0 8.25-8.25H6.018l2.866 2.866a1.25 1.25 0 0 1-1.768 1.768l-5-5a1.25 1.25 0 0 1 0-1.768l5-5a1.25 1.25 0 0 1 1.768 0"></svg:path>`,
})
export class FluentArrowReset32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowReset32RegularIcon],svg[fluent-arrow-reset-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.707 3.293a1 1 0 0 1 0 1.414L5.414 8H17.5C23.299 8 28 12.701 28 18.5S23.299 29 17.5 29S7 24.299 7 18.5a1 1 0 1 1 2 0a8.5 8.5 0 1 0 8.5-8.5H5.414l3.293 3.293a1 1 0 1 1-1.414 1.414l-5-5a1 1 0 0 1 0-1.414l5-5a1 1 0 0 1 1.414 0"></svg:path>`,
})
export class FluentArrowReset32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRightCircle24FilledIcon],svg[fluent-arrow-right-circle-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path d="M12 2c5.524 0 10 4.478 10 10c0 5.524-4.476 10-10 10c-5.522 0-10-4.476-10-10C2 6.479 6.479 2 12 2zm.781 5.47l-.084-.073a.75.75 0 0 0-.883-.007l-.094.08l-.072.084a.75.75 0 0 0-.007.882l.08.094l2.719 2.72H7.75l-.102.007a.75.75 0 0 0-.641.641L7 12l.007.102a.75.75 0 0 0 .641.641l.102.007h6.69l-2.72 2.72l-.073.084a.75.75 0 0 0 1.05 1.05l.083-.073l4.002-4l.072-.084a.75.75 0 0 0 .008-.883l-.08-.094l-4.001-4l-.084-.073l.084.073z" fill="currentColor" fill-rule="nonzero"></svg:path>`,
})
export class FluentArrowRightCircle24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRightCircle24RegularIcon],svg[fluent-arrow-right-circle-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path d="M12 2c5.524 0 10 4.478 10 10c0 5.524-4.476 10-10 10c-5.522 0-10-4.476-10-10C2 6.479 6.479 2 12 2zm0 1.5a8.5 8.5 0 1 0 0 17a8.5 8.5 0 0 0 0-17zm-.352 4.054l.072-.084a.75.75 0 0 1 .977-.073l.084.073l4 4a.75.75 0 0 1 .073.977l-.072.084l-4.002 4a.75.75 0 0 1-1.133-.977l.073-.084l2.722-2.72H7.75a.75.75 0 0 1-.743-.648L7 12a.75.75 0 0 1 .648-.743l.102-.007h6.69l-2.72-2.72a.75.75 0 0 1-.072-.976l.072-.084l-.072.084z" fill="currentColor" fill-rule="nonzero"></svg:path>`,
})
export class FluentArrowRightCircle24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRotateClockwise16RegularIcon],svg[fluent-arrow-rotate-clockwise-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 3a5 5 0 0 0-5 5a.5.5 0 0 1-1 0a6 6 0 1 1 9.969 4.5H13a.5.5 0 0 1 0 1h-2.5a.5.5 0 0 1-.5-.5v-2.5a.5.5 0 0 1 1 0V12a5 5 0 0 0-3-9M6 8a2 2 0 1 1 4 0a2 2 0 0 1-4 0m2-1a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class FluentArrowRotateClockwise16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRotateClockwise24FilledIcon],svg[fluent-arrow-rotate-clockwise-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3a9 9 0 0 1 9 9a9 9 0 0 1-4.873 8.001L18 20a1 1 0 0 1 .117 1.993L18 22h-4a1 1 0 0 1-.993-.883L13 21v-4a1 1 0 0 1 1.993-.117L15 17l.001 1.327A7.01 7.01 0 0 0 19 12a7 7 0 1 0-14 0a1 1 0 1 1-2 0a9 9 0 0 1 9-9m0 6a3 3 0 1 1 0 6a3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class FluentArrowRotateClockwise24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRotateClockwise24RegularIcon],svg[fluent-arrow-rotate-clockwise-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3a9 9 0 0 1 4.977 16.5h1.773a.75.75 0 0 1 .102 1.493L18.75 21h-4a.75.75 0 0 1-.743-.648L14 20.25v-4a.75.75 0 0 1 1.493-.102l.007.102l.001 2.385A7.501 7.501 0 0 0 12 4.5A7.5 7.5 0 0 0 4.5 12A.75.75 0 0 1 3 12a9 9 0 0 1 9-9m0 6.25a2.75 2.75 0 1 1 0 5.5a2.75 2.75 0 0 1 0-5.5m0 1.5a1.25 1.25 0 1 0 0 2.5a1.25 1.25 0 0 0 0-2.5"></svg:path>`,
})
export class FluentArrowRotateClockwise24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRouting20FilledIcon],svg[fluent-arrow-routing-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRouting20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRouting20RegularIcon],svg[fluent-arrow-routing-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRouting20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRouting24RegularIcon],svg[fluent-arrow-routing-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRouting24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRoutingRectangleMultiple20FilledIcon],svg[fluent-arrow-routing-rectangle-multiple-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRoutingRectangleMultiple20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowRoutingRectangleMultiple24RegularIcon],svg[fluent-arrow-routing-rectangle-multiple-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowRoutingRectangleMultiple24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle16FilledIcon],svg[fluent-arrow-shuffle-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle16RegularIcon],svg[fluent-arrow-shuffle-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle20FilledIcon],svg[fluent-arrow-shuffle-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle20RegularIcon],svg[fluent-arrow-shuffle-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle24RegularIcon],svg[fluent-arrow-shuffle-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle28FilledIcon],svg[fluent-arrow-shuffle-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle28RegularIcon],svg[fluent-arrow-shuffle-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle32FilledIcon],svg[fluent-arrow-shuffle-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M25.134 5.616a1.25 1.25 0 0 0-1.768 1.768l1.402 1.402c-4.94.369-7.931 3.49-10.576 6.25l-.095.1c-2.911 3.038-5.444 5.614-9.847 5.614a1.25 1.25 0 0 0 0 2.5c5.535 0 8.743-3.348 11.558-6.286l.095-.1c2.667-2.782 5.016-5.178 8.776-5.56l-1.313 1.312a1.25 1.25 0 1 0 1.768 1.768l3.5-3.5a1.25 1.25 0 0 0 0-1.768zM4.25 8.75c4.356 0 7.27 2.073 9.686 4.389q-.382.393-.744.773l-.178.185q-.417.436-.815.845C9.975 12.814 7.68 11.25 4.25 11.25a1.25 1.25 0 1 1 0-2.5m20.518 14.464c-3.82-.285-6.474-2.216-8.704-4.353q.382-.393.744-.773l.177-.185q.418-.437.816-.845c1.984 1.899 4.025 3.348 6.878 3.639l-1.313-1.313a1.25 1.25 0 0 1 1.768-1.768l3.5 3.5a1.25 1.25 0 0 1 0 1.768l-3.5 3.5a1.25 1.25 0 0 1-1.768-1.768z"></svg:path>`,
})
export class FluentArrowShuffle32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle32RegularIcon],svg[fluent-arrow-shuffle-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle48FilledIcon],svg[fluent-arrow-shuffle-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffle48RegularIcon],svg[fluent-arrow-shuffle-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M38.134 8.866a1.25 1.25 0 0 0-1.768 1.768L39.732 14h-.982c-8.388 0-13.151 4.696-17.546 9.03l-.082.08C16.665 27.505 12.56 31.5 5.25 31.5a1.25 1.25 0 1 0 0 2.5c8.388 0 13.151-4.696 17.546-9.03l.082-.08c4.457-4.395 8.562-8.39 15.872-8.39h.982l-3.366 3.366a1.25 1.25 0 0 0 1.768 1.768l5.5-5.5a1.25 1.25 0 0 0 0-1.768zM5.25 14c6.993 0 11.466 3.264 15.307 6.86q-.33.323-.65.64l-.189.186l-.947.93C15.113 19.207 11.267 16.5 5.25 16.5a1.25 1.25 0 1 1 0-2.5m33.5 20c-6.992 0-11.466-3.264-15.307-6.86l.652-.641l.187-.185l.947-.93c3.659 3.409 7.504 6.116 13.521 6.116h.982l-3.366-3.366a1.25 1.25 0 0 1 1.768-1.768l5.5 5.5a1.25 1.25 0 0 1 0 1.768l-5.5 5.5a1.25 1.25 0 0 1-1.768-1.768L39.732 34z"></svg:path>`,
})
export class FluentArrowShuffle48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff16FilledIcon],svg[fluent-arrow-shuffle-off-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff16RegularIcon],svg[fluent-arrow-shuffle-off-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m11.647 12.354l2.5 2.5a.5.5 0 0 0 .707-.708l-13-13a.5.5 0 1 0-.708.708l3.569 3.568A5.9 5.9 0 0 0 2.5 5a.5.5 0 0 0 0 1c1.45 0 2.5.564 3.484 1.345q.17-.149.345-.308l.709.708C5.7 8.957 4.472 10 2.5 10a.5.5 0 0 0 0 1c2.411 0 3.906-1.33 5.245-2.547l.708.707l-.19.174a9 9 0 0 0 1.213.85l2.17 2.169zm.46-2.368l1.307 1.307l.44-.44a.5.5 0 0 0 0-.707l-1.5-1.5a.5.5 0 0 0-.708 0a.5.5 0 0 0 0 .708l.643.642zM8.556 6.435l.715.714c.863-.64 1.796-1.098 3.018-1.145l-.643.642a.5.5 0 0 0 .708.708l1.5-1.5a.5.5 0 0 0 0-.708l-1.5-1.5a.5.5 0 0 0-.708.708l.65.65c-1.567.049-2.74.667-3.74 1.43"></svg:path>`,
})
export class FluentArrowShuffleOff16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff20FilledIcon],svg[fluent-arrow-shuffle-off-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff20RegularIcon],svg[fluent-arrow-shuffle-off-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.854 2.146a.5.5 0 1 0-.708.708L6.094 6.8C5.078 6.312 3.91 6 2.5 6a.5.5 0 1 0 0 1c2.418 0 4.017 1.023 5.52 2.327l.311-.288l.708.707C7.202 11.458 5.469 13 2.5 13a.5.5 0 0 0 0 1c3.409 0 5.405-1.828 7.247-3.546l.707.707l-.21.197c.537.471 1.104.925 1.726 1.32l5.176 5.176a.5.5 0 0 0 .708-.708zM14.972 12.85l1.141 1.142l.182.005l-.088.089l.707.707l.94-.94a.5.5 0 0 0 0-.707l-2-2a.5.5 0 0 0-.708.707l1.144 1.144a7.5 7.5 0 0 1-1.318-.147m-4.45-4.449l.711.71c1.387-1.162 2.888-2.055 5.057-2.109l-1.144 1.144a.5.5 0 0 0 .708.707l2-2a.5.5 0 0 0 0-.707l-2-2a.5.5 0 0 0-.708.707l1.15 1.149c-2.538.055-4.28 1.135-5.773 2.4"></svg:path>`,
})
export class FluentArrowShuffleOff20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff24FilledIcon],svg[fluent-arrow-shuffle-off-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff24RegularIcon],svg[fluent-arrow-shuffle-off-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff28FilledIcon],svg[fluent-arrow-shuffle-off-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff28RegularIcon],svg[fluent-arrow-shuffle-off-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowShuffleOff28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff32FilledIcon],svg[fluent-arrow-shuffle-off-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m25.048 26.462l3.245 3.245a1 1 0 0 0 1.414-1.414l-26-26a1 1 0 0 0-1.414 1.414l5.57 5.57A12.2 12.2 0 0 0 4.25 8.75a1.25 1.25 0 0 0 0 2.5c3.43 0 5.726 1.563 7.95 3.691q.32-.328.652-.675l1.061 1.061C11.078 18.281 8.56 20.75 4.25 20.75a1.25 1.25 0 0 0 0 2.5c5.452 0 8.647-3.249 11.432-6.154l1.06 1.06q-.33.346-.678.705c1.366 1.31 2.892 2.541 4.748 3.365l2.476 2.476a1.25 1.25 0 0 0 1.76 1.76m-.882-5.831l3.36 3.36l1.108-1.107a1.25 1.25 0 0 0 0-1.768l-3.5-3.5a1.25 1.25 0 1 0-1.768 1.768l1.313 1.312a10 10 0 0 1-.513-.066m-7.788-7.789l1.771 1.772c1.877-1.736 3.843-3.038 6.53-3.311l-1.313 1.313a1.25 1.25 0 1 0 1.768 1.768l3.5-3.5a1.25 1.25 0 0 0 0-1.768l-3.5-3.5a1.25 1.25 0 0 0-1.768 1.768l1.403 1.402c-3.643.271-6.226 2.04-8.391 4.056"></svg:path>`,
})
export class FluentArrowShuffleOff32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff32RegularIcon],svg[fluent-arrow-shuffle-off-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff48FilledIcon],svg[fluent-arrow-shuffle-off-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowShuffleOff48RegularIcon],svg[fluent-arrow-shuffle-off-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSort16RegularIcon],svg[fluent-arrow-sort-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.854 2.146a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L4 3.707V13.5a.5.5 0 0 0 1 0V3.707l2.146 2.147a.5.5 0 1 0 .708-.708zm6.299 11.714a.5.5 0 0 0 .694 0l3-2.9a.5.5 0 1 0-.694-.72L12 12.321v-9.82a.5.5 0 0 0-1 0v9.82l-2.152-2.08a.5.5 0 1 0-.696.718z"></svg:path>`,
})
export class FluentArrowSort16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSort24FilledIcon],svg[fluent-arrow-sort-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSort24RegularIcon],svg[fluent-arrow-sort-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSort28FilledIcon],svg[fluent-arrow-sort-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSort28RegularIcon],svg[fluent-arrow-sort-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSortDown24FilledIcon],svg[fluent-arrow-sort-down-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.883 4.01L12 4.005a1 1 0 0 1 .993.883l.007.117v11.584l2.293-2.294a1 1 0 0 1 1.32-.084l.094.083a1 1 0 0 1 .084 1.32l-.084.095l-3.996 4a1 1 0 0 1-1.32.083l-.094-.083l-4.004-4a1 1 0 0 1 1.32-1.498l.094.083L11 16.583V5.004a1 1 0 0 1 .883-.992L12 4.004z"></svg:path>`,
})
export class FluentArrowSortDown24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSortDownLines16FilledIcon],svg[fluent-arrow-sort-down-lines-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 1.75a.75.75 0 0 0-1.5 0v10.69l-.72-.72a.75.75 0 1 0-1.06 1.06l2 2a.75.75 0 0 0 1.06 0l2-2a.75.75 0 1 0-1.06-1.06l-.72.72zM2.75 2.5a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5zm2 3a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5zM6 9.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5A.75.75 0 0 1 6 9.25"></svg:path>`,
})
export class FluentArrowSortDownLines16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSortDownLines16RegularIcon],svg[fluent-arrow-sort-down-lines-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 1.5a.5.5 0 0 0-1 0v11.793l-1.146-1.147a.5.5 0 0 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L13 13.293zM2.5 3a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM6 9.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5"></svg:path>`,
})
export class FluentArrowSortDownLines16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSortUpLines16RegularIcon],svg[fluent-arrow-sort-up-lines-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 14.5a.5.5 0 0 1-1 0V2.707l-1.146 1.147a.5.5 0 0 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L13 2.707zM2.5 13a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1zm2-3a.5.5 0 0 1 0-1h5a.5.5 0 0 1 0 1zM6 6.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentArrowSortUpLines16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSplit24FilledIcon],svg[fluent-arrow-split-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3a1 1 0 0 1 1 1v5h2.25A2.75 2.75 0 0 1 18 11.75v5.836l1.293-1.293a1 1 0 0 1 1.414 1.414l-3 3a1 1 0 0 1-1.414 0l-3-3a1 1 0 0 1 1.414-1.414L16 17.586V11.75a.75.75 0 0 0-.75-.75h-6.5a.75.75 0 0 0-.75.75v5.836l1.293-1.293a1 1 0 0 1 1.414 1.414l-3 3a1 1 0 0 1-1.414 0l-3-3a1 1 0 1 1 1.414-1.414L6 17.586V11.75A2.75 2.75 0 0 1 8.75 9H11V4a1 1 0 0 1 1-1"></svg:path>`,
})
export class FluentArrowSplit24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSplit24RegularIcon],svg[fluent-arrow-split-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSplit24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSquare32RegularIcon],svg[fluent-arrow-square-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSquare32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSquareDown24FilledIcon],svg[fluent-arrow-square-down-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.5 3A2.5 2.5 0 0 0 3 5.5v13A2.5 2.5 0 0 0 5.5 21h13a2.5 2.5 0 0 0 2.5-2.5v-13A2.5 2.5 0 0 0 18.5 3zm11.03 8.72a.75.75 0 0 1 .073.977l-.073.084l-4 4a.75.75 0 0 1-.977.073l-.084-.072l-4-4.002a.75.75 0 0 1 .976-1.133l.085.073l2.72 2.722V7.75a.75.75 0 0 1 .648-.743L12 7a.75.75 0 0 1 .743.648l.007.102v6.69l2.72-2.72a.75.75 0 0 1 .976-.072z"></svg:path>`,
})
export class FluentArrowSquareDown24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSquareDown24RegularIcon],svg[fluent-arrow-square-down-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSquareDown32FilledIcon],svg[fluent-arrow-square-down-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSquareDown32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSquareUpRight24RegularIcon],svg[fluent-arrow-square-up-right-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSquareUpRight24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepBack16FilledIcon],svg[fluent-arrow-step-back-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepBack16RegularIcon],svg[fluent-arrow-step-back-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.854 2.146a.5.5 0 0 1 0 .708L3.707 5h2.336c1.468 0 2.905 0 4.226.396c1.365.41 2.585 1.234 3.647 2.827a.5.5 0 0 1-.832.554c-.938-1.407-1.968-2.083-3.103-2.423C8.815 6.004 7.517 6 6 6H3.707l2.147 2.146a.5.5 0 1 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 0 1 .708 0M8 14a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0-1a1 1 0 1 1 0-2a1 1 0 0 1 0 2"></svg:path>`,
})
export class FluentArrowStepBack16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepBack20FilledIcon],svg[fluent-arrow-step-back-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.851 3.146a.5.5 0 0 1 0 .707L4.706 7H10c2.932 0 5.593 1.64 6.936 4.043a.5.5 0 1 1-.872.488C14.894 9.439 12.564 8 10 8H4.707l3.144 3.145a.5.5 0 0 1-.707.707L3.161 7.867a.5.5 0 0 1-.014-.721l3.997-4a.5.5 0 0 1 .707 0M12 15a2 2 0 1 1-4 0a2 2 0 0 1 4 0"></svg:path>`,
})
export class FluentArrowStepBack20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepBack20RegularIcon],svg[fluent-arrow-step-back-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.851 3.146a.5.5 0 0 1 0 .707L4.706 7H10c2.932 0 5.593 1.64 6.936 4.043a.5.5 0 1 1-.872.488C14.894 9.439 12.564 8 10 8H4.707l3.144 3.145a.5.5 0 0 1-.707.707L3.161 7.867a.5.5 0 0 1-.014-.721l3.997-4a.5.5 0 0 1 .707 0M8 15a2 2 0 1 1 4 0a2 2 0 0 1-4 0m2-1a1 1 0 1 0 0 2a1 1 0 0 0 0-2"></svg:path>`,
})
export class FluentArrowStepBack20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepIn16RegularIcon],svg[fluent-arrow-step-in-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.5 8.293V1.5a.5.5 0 0 1 1 0v6.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708zM8 15a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0-1a1 1 0 1 1 0-2a1 1 0 0 1 0 2"></svg:path>`,
})
export class FluentArrowStepIn16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepIn28RegularIcon],svg[fluent-arrow-step-in-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 2a.75.75 0 0 1 .75.75v11.128l3.957-4.146a.75.75 0 1 1 1.085 1.036l-5.25 5.5a.75.75 0 0 1-1.085 0l-5.25-5.5a.75.75 0 0 1 1.086-1.036l3.957 4.146V2.75A.75.75 0 0 1 14 2m4 20a4 4 0 1 1-8 0a4 4 0 0 1 8 0m-1.5 0a2.5 2.5 0 1 0-5 0a2.5 2.5 0 0 0 5 0"></svg:path>`,
})
export class FluentArrowStepIn28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInLeft12FilledIcon],svg[fluent-arrow-step-in-left-12-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 6a.5.5 0 0 0-.5-.5H6.707l1.147-1.146a.5.5 0 1 0-.708-.708l-2 2a.5.5 0 0 0 0 .708l2 2a.5.5 0 1 0 .708-.708L6.707 6.5H10.5A.5.5 0 0 0 11 6M1 6a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0"></svg:path>`,
})
export class FluentArrowStepInLeft12FilledIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInLeft12RegularIcon],svg[fluent-arrow-step-in-left-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 6a.5.5 0 0 0-.5-.5H6.707l1.147-1.146a.5.5 0 1 0-.708-.708l-2 2a.5.5 0 0 0 0 .708l2 2a.5.5 0 1 0 .708-.708L6.707 6.5H10.5A.5.5 0 0 0 11 6M2.5 4.5a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3m0 1a.5.5 0 1 1 0 1a.5.5 0 0 1 0-1"></svg:path>`,
})
export class FluentArrowStepInLeft12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInLeft16RegularIcon],svg[fluent-arrow-step-in-left-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.707 8.5H14.5a.5.5 0 0 0 0-1H7.707l2.147-2.146a.5.5 0 0 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708zM1 8a2 2 0 1 1 4 0a2 2 0 0 1-4 0m1 0a1 1 0 1 0 2 0a1 1 0 0 0-2 0"></svg:path>`,
})
export class FluentArrowStepInLeft16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInLeft24FilledIcon],svg[fluent-arrow-step-in-left-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.295 16.234a.75.75 0 0 1-1.09 1.032l-4.5-4.75a.75.75 0 0 1 0-1.032l4.5-4.75a.75.75 0 0 1 1.09 1.032l-3.301 3.484h9.256a.75.75 0 0 1 0 1.5h-9.256zM2 12a3 3 0 1 1 6 0a3 3 0 0 1-6 0"></svg:path>`,
})
export class FluentArrowStepInLeft24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInLeft28RegularIcon],svg[fluent-arrow-step-in-left-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.293 19.768a.75.75 0 0 0-.025-1.06l-4.146-3.958H25.25a.75.75 0 0 0 0-1.5H14.122l4.146-3.957a.75.75 0 0 0-1.036-1.086l-5.5 5.25a.75.75 0 0 0 0 1.085l5.5 5.25a.75.75 0 0 0 1.06-.024M6 10a4 4 0 1 0 0 8a4 4 0 0 0 0-8m0 1.5a2.5 2.5 0 1 1 0 5a2.5 2.5 0 0 1 0-5"></svg:path>`,
})
export class FluentArrowStepInLeft28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInRight12RegularIcon],svg[fluent-arrow-step-in-right-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1 6a.5.5 0 0 1 .5-.5h3.793L4.146 4.354a.5.5 0 1 1 .708-.708l2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 1 1-.708-.708L5.293 6.5H1.5A.5.5 0 0 1 1 6m8.5-1.5a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3m0 1a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1"></svg:path>`,
})
export class FluentArrowStepInRight12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInRight16RegularIcon],svg[fluent-arrow-step-in-right-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.293 8.5H1.5a.5.5 0 0 1 0-1h6.793L6.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708zM15 8a2 2 0 1 0-4 0a2 2 0 0 0 4 0m-1 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0"></svg:path>`,
})
export class FluentArrowStepInRight16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInRight20RegularIcon],svg[fluent-arrow-step-in-right-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 10a1 1 0 1 0 2 0a1 1 0 0 0-2 0m1 2a2 2 0 1 1 0-4a2 2 0 0 1 0 4M2 10a.5.5 0 0 1 .5-.5h7.793L7.146 6.354a.5.5 0 1 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708l3.147-3.146H2.5A.5.5 0 0 1 2 10"></svg:path>`,
})
export class FluentArrowStepInRight20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepInRight28FilledIcon],svg[fluent-arrow-step-in-right-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.707 19.768a.75.75 0 0 1 .025-1.06l4.146-3.958H2.75a.75.75 0 0 1 0-1.5h11.128L9.732 9.293a.75.75 0 1 1 1.036-1.086l5.5 5.25a.75.75 0 0 1 0 1.085l-5.5 5.25a.75.75 0 0 1-1.06-.024M26 14a4 4 0 1 0-8 0a4 4 0 0 0 8 0"></svg:path>`,
})
export class FluentArrowStepInRight28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOut16FilledIcon],svg[fluent-arrow-step-out-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.646 4.854a.5.5 0 0 0 .708 0L7.5 2.707V9.5a.5.5 0 0 0 1 0V2.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 0 0 0 .708M8 15a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></svg:path>`,
})
export class FluentArrowStepOut16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOut24FilledIcon],svg[fluent-arrow-step-out-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.75 13.75a.75.75 0 0 1-1.5 0V4.494l-3.484 3.3a.75.75 0 1 1-1.032-1.088l4.75-4.5a.75.75 0 0 1 1.032 0l4.75 4.5a.75.75 0 0 1-1.032 1.088l-3.484-3.3zM15 19a3 3 0 1 1-6 0a3 3 0 0 1 6 0"></svg:path>`,
})
export class FluentArrowStepOut24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOver16FilledIcon],svg[fluent-arrow-step-over-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.147 2.146a.5.5 0 0 0 0 .708L12.293 5H9.957c-1.468 0-2.905 0-4.226.396c-1.365.41-2.585 1.234-3.647 2.827a.5.5 0 0 0 .832.554C3.854 7.37 4.884 6.694 6.02 6.354C7.185 6.004 8.483 6 10 6h2.293l-2.146 2.146a.5.5 0 1 0 .707.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.707 0M8 15a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></svg:path>`,
})
export class FluentArrowStepOver16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOver16RegularIcon],svg[fluent-arrow-step-over-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.147 2.146a.5.5 0 0 0 0 .708L12.293 5H9.957c-1.468 0-2.905 0-4.226.396c-1.365.41-2.585 1.234-3.647 2.827a.5.5 0 0 0 .832.554C3.854 7.37 4.884 6.694 6.02 6.354C7.185 6.004 8.483 6 10 6h2.293l-2.146 2.146a.5.5 0 1 0 .707.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.707 0M8 15a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0-1a1 1 0 1 1 0-2a1 1 0 0 1 0 2"></svg:path>`,
})
export class FluentArrowStepOver16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOver20FilledIcon],svg[fluent-arrow-step-over-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.149 3.146a.5.5 0 0 0 0 .707L15.294 7H10c-2.932 0-5.593 1.64-6.936 4.043a.5.5 0 1 0 .873.488C5.106 9.439 7.436 8 10 8h5.293l-3.144 3.145a.5.5 0 1 0 .707.707l3.984-3.985a.5.5 0 0 0 .014-.721l-3.998-4a.5.5 0 0 0-.707 0M8 15a2 2 0 1 0 4 0a2 2 0 0 0-4 0"></svg:path>`,
})
export class FluentArrowStepOver20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowStepOver20RegularIcon],svg[fluent-arrow-step-over-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.149 3.146a.5.5 0 0 0 0 .707L15.294 7H10c-2.932 0-5.593 1.64-6.936 4.043a.5.5 0 1 0 .873.488C5.106 9.439 7.436 8 10 8h5.293l-3.144 3.145a.5.5 0 1 0 .707.707l3.984-3.985a.5.5 0 0 0 .014-.721l-3.998-4a.5.5 0 0 0-.707 0M12 15a2 2 0 1 0-4 0a2 2 0 0 0 4 0m-2-1a1 1 0 1 1 0 2a1 1 0 0 1 0-2"></svg:path>`,
})
export class FluentArrowStepOver20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSwap20RegularIcon],svg[fluent-arrow-swap-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.146 3.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L14.293 7H4.5a.5.5 0 0 1 0-1h9.793l-2.147-2.146a.5.5 0 0 1 0-.708m-4.292 7a.5.5 0 0 1 0 .708L5.707 13H15.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 0 1 .708 0"></svg:path>`,
})
export class FluentArrowSwap20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSwap24FilledIcon],svg[fluent-arrow-swap-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m15.207 2.29l4 3.996a1 1 0 0 1 .084 1.32l-.083.094l-4 4.006a1 1 0 0 1-1.498-1.32l.083-.094L16.083 8H5.5a1 1 0 0 1-.993-.883L4.5 6.999a1 1 0 0 1 .883-.993l.117-.007h10.59l-2.296-2.293a1 1 0 0 1-.084-1.32l.083-.095a1 1 0 0 1 1.32-.084zl4 3.995zm4.284 14.592l.006.117a1 1 0 0 1-.883.993l-.117.007H7.914l2.294 2.293a1 1 0 0 1 .083 1.32l-.083.094a1 1 0 0 1-1.32.084l-.094-.084l-4-3.996a1 1 0 0 1-.084-1.32l.083-.094l4-4.004a1 1 0 0 1 1.498 1.32l-.083.094l-2.29 2.293h10.58a1 1 0 0 1 .993.883l.006.117z"></svg:path>`,
})
export class FluentArrowSwap24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSync20RegularIcon],svg[fluent-arrow-sync-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.414 3.635a.5.5 0 0 0 0-.707L9.293.807a.5.5 0 0 0-.707.707l.997.997a7.5 7.5 0 0 0-4.075 13.495a.5.5 0 0 0 .6-.8A6.5 6.5 0 0 1 10.066 3.5q.037 0 .073-.005L8.586 5.049a.5.5 0 0 0 .707.707zM8.586 16.363a.5.5 0 0 0 0 .707l2.121 2.121a.5.5 0 0 0 .707-.707l-.997-.997a7.5 7.5 0 0 0 4.075-13.495a.5.5 0 1 0-.6.8q.369.277.704.61A6.5 6.5 0 0 1 9.934 16.5l-.074.004l1.554-1.554a.5.5 0 1 0-.707-.707z"></svg:path>`,
})
export class FluentArrowSync20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSync24RegularIcon],svg[fluent-arrow-sync-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCheckmark20FilledIcon],svg[fluent-arrow-sync-checkmark-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.414 3.635a.5.5 0 0 0 0-.707L9.293.807a.5.5 0 0 0-.707.707l.997.997a7.5 7.5 0 0 0-4.075 13.495a.5.5 0 0 0 .6-.8a6.5 6.5 0 0 1 5.29-11.554zM8.586 16.363l.016-.016q.613.135 1.264.15l-.006.006l.074-.004a6.5 6.5 0 0 0 3.959-11.706a.5.5 0 1 1 .6-.8q.424.317.81.703a7.5 7.5 0 0 1-4.886 12.791l.997.997a.5.5 0 1 1-.707.707l-2.121-2.12a.5.5 0 0 1 0-.708M15 9.999a5 5 0 1 1-10 0a5 5 0 0 1 10 0m-2.646-1.854a.5.5 0 0 0-.708 0L9 10.792L7.854 9.645a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0 0-.708"></svg:path>`,
})
export class FluentArrowSyncCheckmark20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCheckmark20RegularIcon],svg[fluent-arrow-sync-checkmark-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.414 3.635a.5.5 0 0 0 0-.707L9.293.807a.5.5 0 0 0-.707.707l.997.997a7.5 7.5 0 0 0-4.075 13.495a.5.5 0 0 0 .6-.8a6.5 6.5 0 0 1 5.29-11.554zM8.586 16.363l.016-.016q.613.135 1.264.15l-.006.006l.074-.004a6.5 6.5 0 0 0 3.959-11.706a.5.5 0 1 1 .6-.8q.424.317.81.703a7.5 7.5 0 0 1-4.886 12.791l.997.997a.5.5 0 1 1-.707.707l-2.121-2.12a.5.5 0 0 1 0-.708m3.768-8.218a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L9 10.792l2.646-2.647a.5.5 0 0 1 .708 0M5 10a5 5 0 1 1 10 0a5 5 0 0 1-10 0m5-4a4 4 0 1 0 0 8a4 4 0 0 0 0-8"></svg:path>`,
})
export class FluentArrowSyncCheckmark20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCheckmark24FilledIcon],svg[fluent-arrow-sync-checkmark-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSyncCheckmark24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCheckmark24RegularIcon],svg[fluent-arrow-sync-checkmark-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle16FilledIcon],svg[fluent-arrow-sync-circle-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2M5.5 8H7l.09.008A.5.5 0 0 1 7 9h-.333a1.667 1.667 0 0 0 2.533.156a.5.5 0 1 1 .72.694A2.665 2.665 0 0 1 6 9.764v.237l-.008.09a.5.5 0 0 1-.992-.09V8.5l.008-.09A.5.5 0 0 1 5.5 8M8 5.334a2.66 2.66 0 0 1 2 .903v-.234l.008-.09a.5.5 0 0 1 .992.09V7.5l-.008.09A.5.5 0 0 1 10.5 8H9.004l-.09-.008A.5.5 0 0 1 9.004 7h.329a1.667 1.667 0 0 0-2.537-.152a.5.5 0 0 1-.723-.691A2.66 2.66 0 0 1 8 5.334"></svg:path>`,
})
export class FluentArrowSyncCircle16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle16RegularIcon],svg[fluent-arrow-sync-circle-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2m0 1a5 5 0 1 1 0 10A5 5 0 0 1 8 3M7 8H5.5a.5.5 0 0 0-.492.41L5 8.5v1.501a.5.5 0 0 0 .992.09l.008-.09v-.237a2.665 2.665 0 0 0 3.92.086a.5.5 0 0 0-.72-.694A1.667 1.667 0 0 1 6.666 9H7a.5.5 0 0 0 .09-.992zm1-2.666a2.66 2.66 0 0 0-1.927.823a.5.5 0 1 0 .723.691A1.667 1.667 0 0 1 9.334 7h-.33a.5.5 0 0 0-.09.992l.09.008H10.5a.5.5 0 0 0 .492-.41L11 7.5V6.003a.5.5 0 0 0-.992-.09l-.008.09v.234a2.67 2.67 0 0 0-2-.903"></svg:path>`,
})
export class FluentArrowSyncCircle16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle24FilledIcon],svg[fluent-arrow-sync-circle-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle28FilledIcon],svg[fluent-arrow-sync-circle-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSyncCircle28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle28RegularIcon],svg[fluent-arrow-sync-circle-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle32RegularIcon],svg[fluent-arrow-sync-circle-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSyncCircle32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncCircle48RegularIcon],svg[fluent-arrow-sync-circle-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.5 24c0-9.665 7.835-17.5 17.5-17.5S41.5 14.335 41.5 24S33.665 41.5 24 41.5S6.5 33.665 6.5 24M24 4C12.954 4 4 12.954 4 24s8.954 20 20 20s20-8.954 20-20S35.046 4 24 4m11 12.25a1.25 1.25 0 1 0-2.5 0v2.48A10 10 0 0 0 24 14a9.99 9.99 0 0 0-8 3.998a1.25 1.25 0 0 0 2 1.502a7.503 7.503 0 0 1 13.074 2H27.25a1.25 1.25 0 1 0 0 2.5h6.5c.69 0 1.25-.56 1.25-1.25zM14.25 33c-.69 0-1.25-.56-1.25-1.25v-6.5c0-.69.56-1.25 1.25-1.25h6.5a1.25 1.25 0 1 1 0 2.5h-3.823A7.503 7.503 0 0 0 30 28.5a1.25 1.25 0 0 1 1.998 1.502A9.99 9.99 0 0 1 24 34a9.99 9.99 0 0 1-8.499-4.73v2.48c0 .69-.56 1.25-1.25 1.25"></svg:path>`,
})
export class FluentArrowSyncCircle48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncDismiss20FilledIcon],svg[fluent-arrow-sync-dismiss-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncDismiss20RegularIcon],svg[fluent-arrow-sync-dismiss-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.414 2.928a.5.5 0 0 1 0 .707l-.016.016a6.6 6.6 0 0 0-1.332-.152a6.5 6.5 0 0 0-3.959 11.706a.5.5 0 1 1-.6.8A7.5 7.5 0 0 1 9.583 2.51l-.996-.996a.5.5 0 0 1 .707-.707zm-2.812 13.42l-.016.015a.5.5 0 0 0 0 .707l2.121 2.121a.5.5 0 0 0 .707-.707l-.997-.997a7.5 7.5 0 0 0 4.075-13.495a.5.5 0 1 0-.6.8q.369.277.704.61a6.5 6.5 0 0 1-5.994 10.945m3.252-8.203a.5.5 0 0 1 0 .708l-1.147 1.146l1.147 1.146a.5.5 0 0 1-.708.708L10 10.706l-1.146 1.147a.5.5 0 0 1-.708-.707l1.147-1.147l-1.147-1.146a.5.5 0 1 1 .708-.708L10 9.292l1.146-1.147a.5.5 0 0 1 .708 0M5 10a5 5 0 1 1 10 0a5 5 0 0 1-10 0m5-4a4 4 0 1 0 0 8a4 4 0 0 0 0-8"></svg:path>`,
})
export class FluentArrowSyncDismiss20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncDismiss24FilledIcon],svg[fluent-arrow-sync-dismiss-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowSyncDismiss24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncDismiss24RegularIcon],svg[fluent-arrow-sync-dismiss-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff12FilledIcon],svg[fluent-arrow-sync-off-12-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff12RegularIcon],svg[fluent-arrow-sync-off-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.84 3.547A4 4 0 0 0 2 6c0 .959.338 1.84.9 2.529a.5.5 0 0 0 .775-.633A3 3 0 0 1 3 6c0-.648.205-1.248.555-1.738l4.183 4.183c-.435.31-.958.507-1.523.547l.389-.388a.5.5 0 1 0-.707-.708l-1.25 1.25a.5.5 0 0 0 0 .708l1.25 1.25a.5.5 0 0 0 .707-.708l-.402-.401a4 4 0 0 0 2.25-.835l1.694 1.694a.5.5 0 0 0 .708-.708l-9-9a.5.5 0 1 0-.708.708zm6.058 3.23l.785.785C9.887 7.082 10 6.554 10 6a4 4 0 0 0-1.099-2.754a.5.5 0 0 0-.725.689a2.99 2.99 0 0 1 .722 2.842m-4.46-4.46l1.726 1.726l1.19-1.19a.5.5 0 0 0 0-.707L6.103.896a.5.5 0 0 0-.708.708l.402.401a4 4 0 0 0-1.36.312"></svg:path>`,
})
export class FluentArrowSyncOff12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff16FilledIcon],svg[fluent-arrow-sync-off-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff16RegularIcon],svg[fluent-arrow-sync-off-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff20FilledIcon],svg[fluent-arrow-sync-off-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowSyncOff20RegularIcon],svg[fluent-arrow-sync-off-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.414 3.635a.5.5 0 0 0 0-.707L9.293.807a.5.5 0 0 0-.707.707l.997.997a7.5 7.5 0 0 0-3.72 1.23l.724.724a6.5 6.5 0 0 1 3.48-.966q.037 0 .073-.004L8.586 5.049a.5.5 0 0 0 .707.707zm-7.06 1.426a7.5 7.5 0 0 0 1.154 10.945a.5.5 0 0 0 .6-.8A6.5 6.5 0 0 1 5.063 5.77l9.165 9.165A6.48 6.48 0 0 1 9.934 16.5l-.074.004l1.554-1.554a.5.5 0 1 0-.707-.707l-2.121 2.121a.5.5 0 0 0 0 .707l2.121 2.121a.5.5 0 0 0 .707-.707l-.997-.997a7.47 7.47 0 0 0 4.521-1.843l2.208 2.209a.5.5 0 0 0 .708-.708l-15-15a.5.5 0 1 0-.708.708zm10.95-.365a7.5 7.5 0 0 1 .954 9.44l-.724-.724a6.503 6.503 0 0 0-1.641-8.62a.5.5 0 1 1 .6-.8q.424.318.81.704"></svg:path>`,
})
export class FluentArrowSyncOff20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrending16FilledIcon],svg[fluent-arrow-trending-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m8.75 4l4.548.001l.108.015l.113.033l.102.048l.038.023l.049.035l.076.067l.084.101l.059.1l.041.105l.023.097l.01.125v4.504a.75.75 0 0 1-1.493.102l-.006-.102L12.5 6.56l-4.22 4.223a.75.75 0 0 1-.978.073l-.084-.073L5.75 9.31l-2.469 2.47a.75.75 0 0 1-1.133-.977l.073-.084l2.998-3a.75.75 0 0 1 .977-.073l.084.073l1.47 1.474L11.441 5.5H8.75a.75.75 0 0 1-.743-.648L8 4.75A.75.75 0 0 1 8.75 4"></svg:path>`,
})
export class FluentArrowTrending16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrending20FilledIcon],svg[fluent-arrow-trending-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.943 5.463a.8.8 0 0 0-.161-.242l-.002-.001l-.001-.002A.75.75 0 0 0 17.25 5h-5.5a.75.75 0 0 0 0 1.5h3.69l-4.94 4.94l-1.97-1.97a.75.75 0 0 0-1.06 0l-5.25 5.25a.75.75 0 1 0 1.06 1.06L8 11.06l1.97 1.97a.75.75 0 0 0 1.06 0l5.47-5.47v3.69a.75.75 0 0 0 1.5 0v-5.5a.8.8 0 0 0-.057-.287"></svg:path>`,
})
export class FluentArrowTrending20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingCheckmark20FilledIcon],svg[fluent-arrow-trending-checkmark-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingCheckmark20RegularIcon],svg[fluent-arrow-trending-checkmark-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingCheckmark24FilledIcon],svg[fluent-arrow-trending-checkmark-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingDown16FilledIcon],svg[fluent-arrow-trending-down-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingDown16RegularIcon],svg[fluent-arrow-trending-down-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m8.496 12l5.048-.002l.086-.015l.063-.02l.058-.03l.062-.042l.058-.054l.04-.05l.035-.058l.032-.078l.012-.043l.011-.086V6.5a.5.5 0 0 0-.991-.09l-.008.09L13 10.293L7.858 5.147a.5.5 0 0 0-.638-.059l-.069.058l-1.65 1.647l-2.647-2.647a.5.5 0 0 0-.765.638l.057.07l3 3a.5.5 0 0 0 .638.058l.07-.058l1.65-1.647L12.293 11H8.496a.5.5 0 0 0-.492.41l-.008.09a.5.5 0 0 0 .5.5"></svg:path>`,
})
export class FluentArrowTrendingDown16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingDown24FilledIcon],svg[fluent-arrow-trending-down-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.003 18.999H21a1 1 0 0 0 .993-.884L22 18v-7a1 1 0 0 0-1.994-.117L20 11l-.001 4.586l-7.292-7.294a1 1 0 0 0-1.32-.083l-.094.083l-2.296 2.292l-5.288-5.29a1 1 0 0 0-1.497 1.32l.083.094l5.994 5.997a1 1 0 0 0 1.32.083l.094-.083l2.296-2.292l6.585 6.586h-4.581a1 1 0 0 0-.993.884l-.007.116a1 1 0 0 0 .883.994z"></svg:path>`,
})
export class FluentArrowTrendingDown24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingLines20FilledIcon],svg[fluent-arrow-trending-lines-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingLines20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingLines20RegularIcon],svg[fluent-arrow-trending-lines-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.5 2a.5.5 0 0 0 0 1h1.793L11.5 7.793L8.854 5.146a.5.5 0 0 0-.708 0l-5 5a.5.5 0 0 0 .708.708L8.5 6.207l2.646 2.647a.5.5 0 0 0 .708 0L17 3.707V5.5a.5.5 0 0 0 1 0v-3a.5.5 0 0 0-.5-.5zm1 7a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 1 0v-8a.5.5 0 0 0-.5-.5m-8 2a.5.5 0 0 0-.5.5v6a.5.5 0 0 0 1 0v-6a.5.5 0 0 0-.5-.5m3.5 2.5a.5.5 0 0 1 1 0v4a.5.5 0 0 1-1 0zm-8 1a.5.5 0 0 1 1 0v3a.5.5 0 0 1-1 0z"></svg:path>`,
})
export class FluentArrowTrendingLines20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingLines24RegularIcon],svg[fluent-arrow-trending-lines-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSettings20FilledIcon],svg[fluent-arrow-trending-settings-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSettings20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSettings20RegularIcon],svg[fluent-arrow-trending-settings-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSettings20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSettings24FilledIcon],svg[fluent-arrow-trending-settings-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSettings24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSettings24RegularIcon],svg[fluent-arrow-trending-settings-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSettings24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSparkle20FilledIcon],svg[fluent-arrow-trending-sparkle-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSparkle20RegularIcon],svg[fluent-arrow-trending-sparkle-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSparkle20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSparkle24FilledIcon],svg[fluent-arrow-trending-sparkle-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingSparkle24RegularIcon],svg[fluent-arrow-trending-sparkle-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingSparkle24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingText20FilledIcon],svg[fluent-arrow-trending-text-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingText20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingText20RegularIcon],svg[fluent-arrow-trending-text-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 3.5a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 0 0 1h2.793L11 8.293L9.354 6.646a.5.5 0 0 0-.708 0l-5.5 5.5a.5.5 0 0 0 .708.708L9 7.707l1.646 1.647a.5.5 0 0 0 .707 0L16 4.707V7.5a.5.5 0 0 0 1 0zM10 13a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-5a2 2 0 0 1-2-2zm6.5 3h-4a.5.5 0 1 0 0 1h4a.5.5 0 1 0 0-1m-4-3a.5.5 0 1 0 0 1h4a.5.5 0 1 0 0-1z"></svg:path>`,
})
export class FluentArrowTrendingText20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingWrench20FilledIcon],svg[fluent-arrow-trending-wrench-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.75 3a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-.342.63a1.38 1.38 0 0 0-1.15-.9L16 7.979V5.561l-4.22 4.22a.75.75 0 0 1-1.06 0L9 8.06l-4.72 4.72a.75.75 0 0 1-1.06-1.061l5.25-5.25a.75.75 0 0 1 1.06 0l1.72 1.72l3.69-3.69h-2.69a.75.75 0 0 1 0-1.5zm-.648 6.712c.26-.26.155-.696-.21-.739a3.5 3.5 0 0 0-3.704 4.652L9.475 16.34a1.5 1.5 0 0 0 2.121 2.121l2.713-2.713a3.5 3.5 0 0 0 4.653-3.704c-.043-.365-.479-.47-.739-.21l-.97.97a1.5 1.5 0 1 1-2.121-2.121z"></svg:path>`,
})
export class FluentArrowTrendingWrench20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingWrench20RegularIcon],svg[fluent-arrow-trending-wrench-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingWrench20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingWrench24FilledIcon],svg[fluent-arrow-trending-wrench-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTrendingWrench24RegularIcon],svg[fluent-arrow-trending-wrench-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentArrowTrendingWrench24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnBidirectionalDownRight20RegularIcon],svg[fluent-arrow-turn-bidirectional-down-right-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.854 2.146a.5.5 0 0 0-.708.708L16.293 6H9a3 3 0 0 0-3 3v7.293l-3.146-3.147a.5.5 0 0 0-.708.708l4 4a.5.5 0 0 0 .708 0l4-4a.5.5 0 0 0-.708-.708L7 16.293V9a2 2 0 0 1 2-2h7.293l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708z"></svg:path>`,
})
export class FluentArrowTurnBidirectionalDownRight20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnDownRight48FilledIcon],svg[fluent-arrow-turn-down-right-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 7.5a1.5 1.5 0 0 0-3 0v18a7.5 7.5 0 0 0 7.5 7.5h17.379l-6.44 6.44a1.5 1.5 0 0 0 2.122 2.12l9-9a1.5 1.5 0 0 0 0-2.12l-9-9a1.5 1.5 0 0 0-2.122 2.12L34.88 30H17.5a4.5 4.5 0 0 1-4.5-4.5z"></svg:path>`,
})
export class FluentArrowTurnDownRight48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnDownUp48RegularIcon],svg[fluent-arrow-turn-down-up-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M38.378 6.71a1.25 1.25 0 0 0-1.608-.614l-12 5a1.25 1.25 0 1 0 .961 2.308l9.483-3.951L23 39.273L10.407 8.525a1.25 1.25 0 0 0-2.313.948l12.824 31.31c.763 1.864 3.401 1.864 4.164 0l12.374-30.207l4.167 8.713a1.25 1.25 0 1 0 2.255-1.08z"></svg:path>`,
})
export class FluentArrowTurnDownUp48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnLeftDown20FilledIcon],svg[fluent-arrow-turn-left-down-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.22 10.72a.75.75 0 0 0 0 1.06l4 4a.75.75 0 0 0 1.06 0l4-4a.75.75 0 1 0-1.06-1.06L8.5 13.44V7A1.5 1.5 0 0 1 10 5.5h6.25a.75.75 0 0 0 0-1.5H10a3 3 0 0 0-3 3v6.44l-2.72-2.72a.75.75 0 0 0-1.06 0"></svg:path>`,
})
export class FluentArrowTurnLeftDown20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnLeftDown48RegularIcon],svg[fluent-arrow-turn-left-down-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M40.75 12.5a1.25 1.25 0 1 0 0-2.5h-18.5A7.25 7.25 0 0 0 15 17.25v18.168l-6.854-7.04a1.25 1.25 0 0 0-1.792 1.744l9.25 9.5a1.25 1.25 0 0 0 1.792 0l9.25-9.5a1.25 1.25 0 0 0-1.792-1.744L17.5 35.931V17.25a4.75 4.75 0 0 1 4.75-4.75z"></svg:path>`,
})
export class FluentArrowTurnLeftDown48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnLeftUp48FilledIcon],svg[fluent-arrow-turn-left-up-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M40.5 35a1.5 1.5 0 0 1 0 3h-18a7.5 7.5 0 0 1-7.5-7.5V13.121l-6.44 6.44a1.5 1.5 0 0 1-2.12-2.122l9-9a1.5 1.5 0 0 1 2.12 0l9 9a1.5 1.5 0 0 1-2.12 2.122L18 13.12V30.5a4.5 4.5 0 0 0 4.5 4.5z"></svg:path>`,
})
export class FluentArrowTurnLeftUp48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnRight16RegularIcon],svg[fluent-arrow-turn-right-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.646 1.646a.5.5 0 0 1 .708 0l3.5 3.5a.5.5 0 0 1 0 .708l-3.5 3.5a.5.5 0 1 1-.708-.708L11.293 6H5.5A1.5 1.5 0 0 0 4 7.5v6a.5.5 0 0 1-1 0v-6A2.5 2.5 0 0 1 5.5 5h5.793L8.646 2.354a.5.5 0 0 1 0-.708"></svg:path>`,
})
export class FluentArrowTurnRight16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnRight20FilledIcon],svg[fluent-arrow-turn-right-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.72 3.22a.75.75 0 0 1 1.06 0l4 4a.75.75 0 0 1 0 1.06l-4 4a.75.75 0 1 1-1.06-1.06l2.72-2.72H7A1.5 1.5 0 0 0 5.5 10v6.25a.75.75 0 0 1-1.5 0V10a3 3 0 0 1 3-3h6.44l-2.72-2.72a.75.75 0 0 1 0-1.06"></svg:path>`,
})
export class FluentArrowTurnRight20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnRightLeft20RegularIcon],svg[fluent-arrow-turn-right-left-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.004 14.566a.5.5 0 0 0 .31.4l5 1.998a.5.5 0 1 0 .372-.928L5.848 14.5l11.524-4.59c.828-.329.844-1.495.025-1.847L5.697 3.04a.5.5 0 0 0-.394.919l11.7 5.023L5.534 13.55l1.912-3.826a.5.5 0 1 0-.894-.447l-2.49 4.982a.5.5 0 0 0-.059.307"></svg:path>`,
})
export class FluentArrowTurnRightLeft20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnRightUp20FilledIcon],svg[fluent-arrow-turn-right-up-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.78 9.28a.75.75 0 0 0 0-1.06l-4-4a.75.75 0 0 0-1.06 0l-4 4a.75.75 0 0 0 1.06 1.06l2.72-2.72V13a1.5 1.5 0 0 1-1.5 1.5H3.75a.75.75 0 0 0 0 1.5H10a3 3 0 0 0 3-3V6.56l2.72 2.72a.75.75 0 0 0 1.06 0"></svg:path>`,
})
export class FluentArrowTurnRightUp20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnUpDown20RegularIcon],svg[fluent-arrow-turn-up-down-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.566 16.996a.5.5 0 0 0 .4-.31l1.998-5a.5.5 0 0 0-.928-.371L15.5 15.152L10.91 3.628c-.329-.828-1.495-.843-1.847-.024l-5.023 11.7a.5.5 0 0 0 .919.394l5.023-11.7l4.567 11.468l-3.826-1.913a.5.5 0 0 0-.447.894l4.982 2.491a.5.5 0 0 0 .307.058"></svg:path>`,
})
export class FluentArrowTurnUpDown20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowTurnUpLeft48RegularIcon],svg[fluent-arrow-turn-up-left-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M35.5 40.75a1.25 1.25 0 1 0 2.5 0v-18.5A7.25 7.25 0 0 0 30.75 15H12.582l7.04-6.854a1.25 1.25 0 0 0-1.744-1.792l-9.5 9.25a1.25 1.25 0 0 0 0 1.792l9.5 9.25a1.25 1.25 0 0 0 1.744-1.792L12.069 17.5H30.75a4.75 4.75 0 0 1 4.75 4.75z"></svg:path>`,
})
export class FluentArrowTurnUpLeft48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo16FilledIcon],svg[fluent-arrow-undo-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 2.75a.75.75 0 0 1 1.5 0v3.095l2.673-2.673a4 4 0 0 1 5.657 5.656l-4.95 4.95a.75.75 0 1 1-1.06-1.06l4.95-4.95a2.5 2.5 0 0 0-3.536-3.536L5.966 6.5H8.25a.75.75 0 0 1 0 1.5h-4.4A.85.85 0 0 1 3 7.15z"></svg:path>`,
})
export class FluentArrowUndo16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo20FilledIcon],svg[fluent-arrow-undo-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.862 6.5H9.25a.75.75 0 0 1 0 1.5h-4.4A.85.85 0 0 1 4 7.15v-4.4a.75.75 0 0 1 1.5 0v2.947l3.059-2.66a5.25 5.25 0 0 1 6.888 7.925l-8.172 7.104a.75.75 0 1 1-.984-1.132l8.172-7.104a3.75 3.75 0 1 0-4.92-5.66z"></svg:path>`,
})
export class FluentArrowUndo20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo20RegularIcon],svg[fluent-arrow-undo-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 2.5a.5.5 0 0 0-1 0v4.9a.6.6 0 0 0 .6.6h4.9a.5.5 0 0 0 0-1H5.906l3.473-3.019a4 4 0 0 1 5.248 6.038l-8.172 7.104a.5.5 0 0 0 .656.754l8.172-7.103a5 5 0 0 0-6.56-7.547L5 6.463z"></svg:path>`,
})
export class FluentArrowUndo20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo24FilledIcon],svg[fluent-arrow-undo-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo24RegularIcon],svg[fluent-arrow-undo-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo32FilledIcon],svg[fluent-arrow-undo-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.953 4.256a1.25 1.25 0 0 1 2.5 0v6.181L12.05 5.64c1.221-1.294 3.252-2.326 5.48-2.543c2.28-.22 4.817.408 6.93 2.52c2.148 2.15 2.712 4.66 2.5 6.83c-.205 2.105-1.143 3.959-2.119 4.936l-.002.002L13.633 28.68a1.25 1.25 0 0 1-1.775-1.76l11.21-11.3l.004-.004c.523-.523 1.245-1.818 1.4-3.412c.149-1.528-.228-3.268-1.78-4.82c-1.526-1.525-3.298-1.957-4.92-1.8c-1.67.163-3.128.947-3.907 1.773l-.007.008l-4.94 5.155h6.438a1.25 1.25 0 0 1 0 2.5H6.202c-.69 0-1.25-.56-1.25-1.25z"></svg:path>`,
})
export class FluentArrowUndo32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo32RegularIcon],svg[fluent-arrow-undo-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23.374 7.045c-1.28-1.445-2.936-2.144-4.616-2.097c-1.678.046-3.47.842-4.999 2.562L8.384 14H17a1 1 0 0 1 0 2H6a1 1 0 0 1-1-1V4a1 1 0 1 1 2 0v8.535l5.24-6.327l.011-.012c1.85-2.09 4.15-3.183 6.451-3.248c2.303-.064 4.518.907 6.169 2.77c3.333 3.764 2.303 8.666-.011 11.194l-.007.008l-5.578 5.834l-.003.004l-5.434 5.618l-.003.004l-.31.318a1 1 0 0 1-1.432-1.398l.307-.314l.004-.003l5.426-5.611l.004-.004l5.558-5.814c1.754-1.925 2.506-5.659-.018-8.509"></svg:path>`,
})
export class FluentArrowUndo32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUndo48FilledIcon],svg[fluent-arrow-undo-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.998 5.5a1.5 1.5 0 1 1 3 0v11.485l7.901-8.062c5.572-6.3 14.95-6.161 19.93-.67c5 5.514 3.376 13.309.028 17.222l-.008.01l-2.259 2.544l-2.537 2.537l-4.247 4.16l-8.242 8.33l-.005.005l-.497.496a1.5 1.5 0 1 1-2.12-2.122l.49-.49l.006-.006l8.252-8.34l4.253-4.165l2.463-2.463l2.18-2.456c2.635-3.09 3.742-9.144.02-13.247c-3.738-4.123-11.05-4.37-15.482.667l-.026.03L12.224 19h11.274a1.5 1.5 0 1 1 0 3h-15a1.5 1.5 0 0 1-1.5-1.5z"></svg:path>`,
})
export class FluentArrowUndo48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUp20FilledIcon],svg[fluent-arrow-up-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.201 8.735a.75.75 0 1 0 1.09 1.03l4.955-5.239V17.25a.75.75 0 0 0 1.5 0V4.524l4.957 5.241a.75.75 0 1 0 1.09-1.03l-6.07-6.418a1 1 0 0 0-.566-.3a.75.75 0 0 0-.328.002a1 1 0 0 0-.558.298z"></svg:path>`,
})
export class FluentArrowUp20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUp24RegularIcon],svg[fluent-arrow-up-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.209 10.733a.75.75 0 0 0 1.086 1.034l5.954-6.251V20.25a.75.75 0 0 0 1.5 0V5.516l5.955 6.251a.75.75 0 0 0 1.087-1.034l-7.067-7.42a1 1 0 0 0-.58-.3a.8.8 0 0 0-.29.001a1 1 0 0 0-.578.3z"></svg:path>`,
})
export class FluentArrowUp24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUpCircle24FilledIcon],svg[fluent-arrow-up-circle-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path d="M22 12c0-5.522-4.476-10-10-10C6.479 2 2 6.479 2 12c0 5.524 4.478 10 10 10c5.524 0 10-4.476 10-10zm-14.53.28a.75.75 0 0 1-.073-.976l.073-.084l4-4a.75.75 0 0 1 .977-.073l.085.072l4 4.002a.75.75 0 0 1-.977 1.133l-.084-.073l-2.72-2.721v6.691a.75.75 0 0 1-.649.743l-.102.007a.75.75 0 0 1-.743-.648l-.007-.102v-6.69l-2.72 2.72a.75.75 0 0 1-.976.072l-.084-.072z" fill="currentColor"></svg:path></svg:g>`,
})
export class FluentArrowUpCircle24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUpExclamation16FilledIcon],svg[fluent-arrow-up-exclamation-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2.707V14.5a.5.5 0 0 1-1 0V2.707L9.854 3.854a.5.5 0 1 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708zM4.5 1A2.5 2.5 0 0 0 2 3.5c0 2.318.67 4.768 1.036 5.938c.203.65.806 1.062 1.464 1.062s1.261-.412 1.464-1.062C6.33 8.268 7 5.818 7 3.5A2.5 2.5 0 0 0 4.5 1M2.75 13.25a1.75 1.75 0 1 1 3.5 0a1.75 1.75 0 0 1-3.5 0"></svg:path>`,
})
export class FluentArrowUpExclamation16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentArrowUpExclamation16RegularIcon],svg[fluent-arrow-up-exclamation-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
