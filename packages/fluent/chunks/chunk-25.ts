...
@Component({
  standalone: true,
  selector: 'svg[fluentPositionToFront20RegularIcon],svg[fluent-position-to-front-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 1a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v-.5q0-.255.035-.5H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1.035A3.5 3.5 0 0 1 7.5 4H8V3a2 2 0 0 0-2-2zm9 16v-1h.5q.255 0 .5-.035V17a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-1.035q.035-.245.035-.5V12h1a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2M5 7.5A2.5 2.5 0 0 1 7.5 5h5A2.5 2.5 0 0 1 15 7.5v5a2.5 2.5 0 0 1-2.5 2.5h-5A2.5 2.5 0 0 1 5 12.5zm2.277-1.484a1.5 1.5 0 0 0-1.26 1.261zM6 10.293L10.293 6H8.708L6 8.708zM11.707 6L6 11.707v.793c0 .232.052.45.146.647l7-7A1.5 1.5 0 0 0 12.5 6zM7.5 14h.793L14 8.294V7.5c0-.232-.053-.45-.146-.647l-7 7c.195.095.414.147.646.147m2.207 0h1.586L14 11.293V9.707zm3.017-.017a1.5 1.5 0 0 0 1.26-1.26z"></svg:path>`,
})
export class FluentPositionToFront20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPositionToFront24FilledIcon],svg[fluent-position-to-front-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPositionToFront24RegularIcon],svg[fluent-position-to-front-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPower24RegularIcon],svg[fluent-power-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPower28RegularIcon],svg[fluent-power-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPredictions20FilledIcon],svg[fluent-predictions-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.5 1c.276 0 .5.222.5.497c0 .463.073 1.219.472 1.846c.375.588 1.083 1.136 2.528 1.136c.276 0 .5.222.5.497a.5.5 0 0 1-.5.497c-.369 0-1.14.223-1.82.742c-.663.505-1.18 1.241-1.18 2.24a.5.5 0 0 1-.5.496a.5.5 0 0 1-.5-.497c0-.5-.155-1.261-.606-1.884c-.432-.596-1.157-1.097-2.394-1.097a.5.5 0 0 1-.5-.497c0-.275.224-.497.5-.497c.512 0 1.255-.01 1.873-.367C13.437 3.785 14 3.1 14 1.497c0-.275.224-.497.5-.497M6.145 12.166l-.932 3.396c-.17.62.077 1.345.74 1.64c1.638.727 4.65 1.351 7.97.009c.71-.288 1.021-1.064.814-1.75l-.975-3.229A6.5 6.5 0 0 1 10 13.424a6.5 6.5 0 0 1-3.855-1.258m6.78-9.833c-.046.218-.107.38-.168.499a.97.97 0 0 1-.388.421c-.354.205-.831.232-1.369.232c-.828 0-1.5.667-1.5 1.49c0 .824.672 1.491 1.5 1.491c.911 0 1.336.344 1.583.685c.302.417.417.962.417 1.303a1.495 1.495 0 0 0 1.613 1.487A5.5 5.5 0 0 1 10 12.43c-3.038 0-5.5-2.448-5.5-5.467S6.962 1.497 10 1.497c1.075 0 2.077.306 2.924.836"></svg:path>`,
})
export class FluentPredictions20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPredictions20RegularIcon],svg[fluent-predictions-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPredictions24FilledIcon],svg[fluent-predictions-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m16.683 14.926l1.284 3.854a1.75 1.75 0 0 1-.81 2.083C15.786 21.626 14.064 22 12 22s-3.786-.374-5.157-1.137a1.75 1.75 0 0 1-.81-2.083l1.285-3.854A7.7 7.7 0 0 0 12 16.5c1.76 0 3.382-.586 4.683-1.574M12 2c1.337 0 2.582.388 3.63 1.059c-.082.313-.208.544-.367.704c-.253.252-.683.42-1.325.47l-.222.013l-.379.01c-2.169.159-2.115 3.494.163 3.494c.89 0 1.457.181 1.763.487c.252.253.42.683.47 1.325l.013.222l.01.379c.096 1.314 1.358 1.812 2.338 1.494A6.751 6.751 0 0 1 5.25 8.75A6.75 6.75 0 0 1 12 2m6.25 0c0 1.15.27 1.96.78 2.47c.471.47 1.198.737 2.21.775l.26.005c.958 0 .998 1.378.12 1.492l-.12.008c-1.15 0-1.96.27-2.47.78c-.47.472-.737 1.198-.775 2.21l-.005.26c0 1-1.5 1-1.5 0c0-1.15-.27-1.96-.78-2.47c-.472-.47-1.198-.737-2.21-.775l-.26-.005c-.958 0-.998-1.378-.12-1.492l.12-.008c1.15 0 1.96-.27 2.47-.78s.78-1.32.78-2.47c0-1 1.5-1 1.5 0"></svg:path>`,
})
export class FluentPredictions24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPredictions24RegularIcon],svg[fluent-predictions-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2c1.153 0 2.24.29 3.189.8c-.076.445-.224.76-.426.963a1.3 1.3 0 0 1-.437.28a5.25 5.25 0 1 0-4.464 9.504q1.033.401 1.906.447L12 14q.968 0 2.137-.452a5.3 5.3 0 0 0 2.242-1.9c.64.22 1.409.086 1.894-.401a6.76 6.76 0 0 1-1.927 2.668l1.621 4.865a1.75 1.75 0 0 1-.81 2.083C15.786 21.626 14.064 22 12 22s-3.786-.374-5.157-1.137a1.75 1.75 0 0 1-.81-2.083l1.621-4.865A6.75 6.75 0 0 1 12 2m3.057 12.791l-.36.149l-.018.008a6.7 6.7 0 0 1-2.352.544h-.017l-.073.004L12 15.5l-.196-.004l-.13-.005a6.7 6.7 0 0 1-2.353-.543l-.018-.008a11 11 0 0 1-.36-.149l-1.487 4.464a.25.25 0 0 0 .115.297c1.13.627 2.603.948 4.429.948s3.3-.32 4.429-.948a.25.25 0 0 0 .115-.297zm-3.367.702l.114.003l.033.002l.163.002q-.156 0-.31-.007M17.992 1.88L18 2c0 1.15.27 1.96.78 2.47c.471.47 1.198.737 2.21.775l.26.005c.958 0 .998 1.378.12 1.492l-.12.008c-1.15 0-1.96.27-2.47.78c-.47.472-.737 1.198-.775 2.21L18 10c0 1-1.5 1-1.5 0c0-1.15-.27-1.96-.78-2.47c-.472-.47-1.198-.737-2.21-.775l-.26-.005c-.958 0-.998-1.378-.12-1.492l.12-.008c1.15 0 1.96-.27 2.47-.78s.78-1.32.78-2.47c0-.958 1.378-.998 1.492-.12m-.742 3.073l-.144.203a3.6 3.6 0 0 1-.904.844a3.6 3.6 0 0 1 1.048 1.047A3.6 3.6 0 0 1 18.297 6a3.6 3.6 0 0 1-.903-.844z"></svg:path>`,
})
export class FluentPredictions24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium16FilledIcon],svg[fluent-premium-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium16RegularIcon],svg[fluent-premium-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.5 2a.5.5 0 0 0-.447.276l-2 4a.5.5 0 0 0 .059.54l6.5 8a.5.5 0 0 0 .776 0l6.5-8a.5.5 0 0 0 .06-.54l-2-4A.5.5 0 0 0 12.5 2zM2.309 6l1.5-3h2.05l-.75 3zm.241 1h2.583l1.613 5.164zm3.63 0h3.64L8 12.823zm4.688 0h2.582l-4.196 5.164zm2.823-1h-2.8l-.75-3h2.05zM9.86 6H6.14l.75-3h2.22z"></svg:path>`,
})
export class FluentPremium16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium20FilledIcon],svg[fluent-premium-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.5 2.75a.75.75 0 0 0-.657.389l-2.75 5a.75.75 0 0 0 .08.84l7.25 8.75a.75.75 0 0 0 1.155 0l7.25-8.75a.75.75 0 0 0 .08-.84l-2.75-5a.75.75 0 0 0-.658-.389zM4.156 7.5l1.787-3.25h1.5L6.305 7.5zM6.144 9l1.929 4.748L4.138 9zm3.845 5.481L7.763 9h4.386zM7.895 7.5l1.137-3.25h1.945l1.197 3.25zm5.878 0l-1.197-3.25h1.48l1.788 3.25zM13.761 9h2.1l-4.005 4.834z"></svg:path>`,
})
export class FluentPremium20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium20RegularIcon],svg[fluent-premium-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.5 3a.5.5 0 0 0-.429.243l-3 5a.5.5 0 0 0 .045.577l7.5 9a.5.5 0 0 0 .768 0l7.5-9a.5.5 0 0 0 .045-.577l-3-5A.5.5 0 0 0 14.5 3zM3.383 8l2.4-4h1.979l-1.6 4zm2.775 1l2.267 5.829L3.568 9zM10 16.12L7.231 9h5.538zM7.239 8l1.6-4h2.322l1.6 4zm6.6 0l-1.6-4h1.978l2.4 4zm.003 1h2.59l-4.857 5.829z"></svg:path>`,
})
export class FluentPremium20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium24FilledIcon],svg[fluent-premium-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18 3a1 1 0 0 1 .832.445l.062.108l3 6a1 1 0 0 1-.067 1.01l-.084.106l-8.973 9.973a.99.99 0 0 1-.886.351l-.113-.019a.98.98 0 0 1-.532-.322L2.257 10.67a1 1 0 0 1-.204-.991l.053-.125l3-6a1 1 0 0 1 .77-.545L6 3zm-3.424 8H9.423L12 17.342zm4.177 0h-2.018l-1.661 4.088zM7.264 11H5.246l3.678 4.087zm1.358-6H6.618l-2 4h2.704zm4.651 0h-2.547L9.427 9h5.145zm4.108 0h-2.004l1.3 4h2.704z"></svg:path>`,
})
export class FluentPremium24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium24RegularIcon],svg[fluent-premium-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium28FilledIcon],svg[fluent-premium-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.75 3a1 1 0 0 1 .78.375l.075.106l4.25 7a1 1 0 0 1-.015 1.063l-.077.102l-11 13a1 1 0 0 1-1.442.088l-.084-.088l-11-13a1 1 0 0 1-.15-1.052l.058-.113l4.25-7a1 1 0 0 1 .725-.473L7.25 3zm-3.235 9h-7.031l3.515 8.672zm5.329 0h-3.171l-2.917 7.195zM8.326 12H5.155l6.087 7.193zm1.348-7H7.811l-3.036 5h3.47zm6.572 0h-4.493l-1.429 5h7.351zm3.942 0h-1.863l1.429 5h3.47z"></svg:path>`,
})
export class FluentPremium28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium28RegularIcon],svg[fluent-premium-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremium32FilledIcon],svg[fluent-premium-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 4c-.48 0-.916.274-1.125.706l-3.75 7.75a1.25 1.25 0 0 0 .153 1.33l12.75 15.75a1.25 1.25 0 0 0 1.944 0l12.75-15.75a1.25 1.25 0 0 0 .153-1.33l-3.75-7.75A1.25 1.25 0 0 0 25 4zm-1.636 7.5l2.42-5h3.688l-1.563 5zm.304 2.5h4.098l2.868 8.606zm6.733 0h7.198L16 24.797zm9.833 0h4.098l-6.966 8.606zm4.402-2.5H22.09l-1.563-5h3.688zm-7.164 0h-6.944l1.563-5h3.818z"></svg:path>`,
})
export class FluentPremium32FilledIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson16FilledIcon],svg[fluent-premium-person-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.75 2a.75.75 0 0 0-.662.397l-2 3.75a.75.75 0 0 0 .071.815l4.934 6.316A3.3 3.3 0 0 1 6 12.5a2.5 2.5 0 0 1 1.451-2.27L6.598 7.5h.943A3 3 0 0 1 8.264 6H6.398l.625-2.5h1.954l.427 1.707a3 3 0 0 1 1.5-.18l-.38-1.527H11.8L13.133 6h-.397a2.99 2.99 0 0 1 .649 2.825l1.456-1.863a.75.75 0 0 0 .07-.815l-2-3.75A.75.75 0 0 0 12.25 2zm-.883 4L4.2 3.5h1.277L4.852 6zm.616 1.5h1.544l1.029 3.293zM12.5 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0m1.5 4.5c0 1.245-1 2.5-3.5 2.5S7 13.75 7 12.5A1.5 1.5 0 0 1 8.5 11h4a1.5 1.5 0 0 1 1.5 1.5"></svg:path>`,
})
export class FluentPremiumPerson16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson16RegularIcon],svg[fluent-premium-person-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.5 2a.5.5 0 0 0-.447.276l-2 4a.5.5 0 0 0 .059.54l4.907 6.039A3 3 0 0 1 6 12.5c0-.355.074-.693.208-.999L2.55 7h2.583l1.285 4.115c.209-.312.485-.575.809-.767L6.18 7h1.49a3 3 0 0 1 .594-1H6.14l.75-3h2.22l.53 2.125a3 3 0 0 1 1.001-.122L10.141 3h2.05l1.5 3h-.955c.258.289.462.627.593 1h.12l-.085.105a3 3 0 0 1 .077 1.492l1.447-1.782a.5.5 0 0 0 .06-.539l-2-4A.5.5 0 0 0 12.5 2zM2.309 6l1.5-3h2.05l-.75 3zM12.5 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0m1.5 4.5c0 1.245-1 2.5-3.5 2.5S7 13.75 7 12.5A1.5 1.5 0 0 1 8.5 11h4a1.5 1.5 0 0 1 1.5 1.5"></svg:path>`,
})
export class FluentPremiumPerson16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson20FilledIcon],svg[fluent-premium-person-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.5 2.75a.75.75 0 0 0-.657.389l-2.75 5a.75.75 0 0 0 .08.84l7.25 8.75a.75.75 0 0 0 1.155 0l.485-.587A3.3 3.3 0 0 1 11 16.5a2.5 2.5 0 0 1 2.273-2.49A3 3 0 0 1 12.5 12c0-.858.36-1.631.937-2.178L13.76 9h4.049l.018-.021a.75.75 0 0 0 .08-.84l-2.75-5a.75.75 0 0 0-.658-.389zM4.156 7.5l1.787-3.25h1.5L6.305 7.5zM6.144 9l1.929 4.748L4.138 9zm3.845 5.481L7.763 9h4.386zM7.895 7.5l1.137-3.25h1.945l1.197 3.25zm5.878 0l-1.197-3.25h1.48l1.788 3.25zM17.5 12a2 2 0 1 1-4 0a2 2 0 0 1 4 0m1.5 4.5c0 1.245-1 2.5-3.5 2.5S12 17.75 12 16.5a1.5 1.5 0 0 1 1.5-1.5h4a1.5 1.5 0 0 1 1.5 1.5"></svg:path>`,
})
export class FluentPremiumPerson20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson20RegularIcon],svg[fluent-premium-person-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.5 3a.5.5 0 0 0-.429.243l-3 5a.5.5 0 0 0 .045.577l7.494 8.993a.5.5 0 0 0 .856-.132L13.842 9h3.892l.15-.18a.5.5 0 0 0 .045-.577l-3-5A.5.5 0 0 0 14.5 3zm7.27 6L10 16.12L7.231 9zM3.382 8l2.4-4h1.979l-1.6 4zm2.775 1l2.267 5.829L3.568 9zm1.08-1l1.6-4h2.323l1.6 4zm6.6 0l-1.6-4h1.979l2.4 4zm1.662 6a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0 5c2.5 0 3.5-1.255 3.5-2.5a1.5 1.5 0 0 0-1.5-1.5h-4a1.5 1.5 0 0 0-1.5 1.5c0 1.25 1 2.5 3.5 2.5"></svg:path>`,
})
export class FluentPremiumPerson20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson24FilledIcon],svg[fluent-premium-person-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.832 3.445A1 1 0 0 0 18 3H6l-.125.008a1 1 0 0 0-.77.545l-3 6l-.052.125a1 1 0 0 0 .204.991l8.982 9.983a.98.98 0 0 0 .532.322l.112.02a1.01 1.01 0 0 0 .887-.352l.26-.29a4 4 0 0 1-.03-.477v-.103A2.77 2.77 0 0 1 15.774 17h.274l.002-.002a3.5 3.5 0 0 1 4.678-5.199l1.016-1.13l.084-.107a1 1 0 0 0 .067-1.01l-3-6zM9.423 11h5.153L12 17.342zm-4.177 0h2.018l1.66 4.087zm1.372-6h2.004l-1.3 4H4.618zm4.108 0h2.547l1.299 4H9.427zm4.651 0h2.004l2 4h-2.704zM21 14.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0m2 5.375C23 21.431 21.714 23 18.5 23S14 21.437 14 19.875v-.103c0-.98.794-1.772 1.773-1.772h5.454c.98 0 1.773.793 1.773 1.772z"></svg:path>`,
})
export class FluentPremiumPerson24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPremiumPerson24RegularIcon],svg[fluent-premium-person-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceAvailable12RegularIcon],svg[fluent-presence-available-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 0a6 6 0 1 0 0 12A6 6 0 0 0 6 0M1.5 6a4.5 4.5 0 1 1 9 0a4.5 4.5 0 0 1-9 0m7.03-1.78a.75.75 0 0 1 0 1.06L5.78 8.03a.75.75 0 0 1-1.06 0l-1-1a.75.75 0 0 1 1.06-1.06l.47.47l2.22-2.22a.75.75 0 0 1 1.06 0"></svg:path>`,
})
export class FluentPresenceAvailable12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceAvailable20RegularIcon],svg[fluent-presence-available-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.995 0C4.475 0 0 4.475 0 9.995s4.475 9.996 9.995 9.996s9.996-4.475 9.996-9.996C19.99 4.475 15.516 0 9.995 0M2 9.995a7.995 7.995 0 1 1 15.99 0a7.995 7.995 0 0 1-15.99 0m12.207-3.202a1 1 0 0 1 0 1.414l-4.5 4.5a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.793-3.793a1 1 0 0 1 1.414 0"></svg:path>`,
})
export class FluentPresenceAvailable20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceAway12RegularIcon],svg[fluent-presence-away-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.5 5.655V3.25a.75.75 0 0 0-1.5 0V6a.75.75 0 0 0 .262.57l1.75 1.5a.75.75 0 1 0 .976-1.14zM12 6A6 6 0 1 1 0 6a6 6 0 0 1 12 0m-1.5 0a4.5 4.5 0 1 0-9 0a4.5 4.5 0 0 0 9 0"></svg:path>`,
})
export class FluentPresenceAway12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceAway20FilledIcon],svg[fluent-presence-away-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10 20c5.523 0 10-4.477 10-10S15.523 0 10 0S0 4.477 0 10s4.477 10 10 10m0-13.992v3.578l2.707 2.707a1 1 0 0 1-1.414 1.415l-3-3A1 1 0 0 1 8 10V6.008a1 1 0 1 1 2 0"></svg:path>`,
})
export class FluentPresenceAway20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceAway24RegularIcon],svg[fluent-presence-away-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 11.31V6.5a1.5 1.5 0 0 0-3 0V12c0 .438.191.854.524 1.139l3.5 3a1.5 1.5 0 0 0 1.952-2.278zM0 12C0 5.373 5.373 0 12 0s12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12m12-9a9 9 0 1 0 0 18a9 9 0 0 0 0-18"></svg:path>`,
})
export class FluentPresenceAway24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceBlocked24RegularIcon],svg[fluent-presence-blocked-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12S5.373 0 12 0s12 5.373 12 12m-3 0a8.96 8.96 0 0 0-1.664-5.215L6.786 19.336A9 9 0 0 0 21 12m-3.785-7.336a9 9 0 0 0-12.55 12.55z"></svg:path>`,
})
export class FluentPresenceBlocked24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceOffline16RegularIcon],svg[fluent-presence-offline-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.707 5.293a1 1 0 0 1 0 1.414L9.414 8l1.293 1.293a1 1 0 0 1-1.414 1.414L8 9.414l-1.293 1.293a1 1 0 0 1-1.414-1.414L6.586 8L5.293 6.707a1 1 0 0 1 1.414-1.414L8 6.586l1.293-1.293a1 1 0 0 1 1.414 0M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-6a6 6 0 1 0 0 12A6 6 0 0 0 8 2"></svg:path>`,
})
export class FluentPresenceOffline16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceOffline20RegularIcon],svg[fluent-presence-offline-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.707 6.293a1 1 0 0 1 0 1.414L11.414 10l2.293 2.293a1 1 0 0 1-1.414 1.414L10 11.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L8.586 10L6.293 7.707a1 1 0 0 1 1.414-1.414L10 8.586l2.293-2.293a1 1 0 0 1 1.414 0M0 10C0 4.477 4.477 0 10 0s10 4.477 10 10s-4.477 10-10 10S0 15.523 0 10m10-8a8 8 0 1 0 0 16a8 8 0 0 0 0-16"></svg:path>`,
})
export class FluentPresenceOffline20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceOffline24RegularIcon],svg[fluent-presence-offline-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.06 7.94a1.5 1.5 0 0 1 0 2.12L14.122 12l1.94 1.94a1.5 1.5 0 0 1-2.122 2.12L12 14.122l-1.94 1.94a1.5 1.5 0 0 1-2.12-2.122L9.878 12l-1.94-1.94a1.5 1.5 0 1 1 2.122-2.12L12 9.878l1.94-1.94a1.5 1.5 0 0 1 2.12 0M0 12C0 5.373 5.373 0 12 0s12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12m12-9a9 9 0 1 0 0 18a9 9 0 0 0 0-18"></svg:path>`,
})
export class FluentPresenceOffline24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceOof24RegularIcon],svg[fluent-presence-oof-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.562 9.057a1.5 1.5 0 0 0-2.121-2.122L6.437 10.94a1.5 1.5 0 0 0 0 2.12l4.004 4.005a1.5 1.5 0 0 0 2.121-2.121L11.12 13.5h5.38a1.5 1.5 0 1 0 0-3h-5.38zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12s12-5.373 12-12S18.627 0 12 0M3 12a9 9 0 1 1 18 0a9 9 0 0 1-18 0"></svg:path>`,
})
export class FluentPresenceOof24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceTentative10RegularIcon],svg[fluent-presence-tentative-10-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10 5.065A5 5 0 0 1 5.065 10zm-.282-1.726A5 5 0 0 0 9 1.999l-7 7c.403.304.854.548 1.34.719zM.996 7.995A5 5 0 0 1 .283 6.66L6.662.283a5 5 0 0 1 1.333.713zM4.936 0A5 5 0 0 0 0 4.935z"></svg:path>`,
})
export class FluentPresenceTentative10RegularIcon {
  readonly viewBox = input("0 0 10 10")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceTentative20RegularIcon],svg[fluent-presence-tentative-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.946.055a9.96 9.96 0 0 0-6.021 2.874A9.96 9.96 0 0 0 .05 8.949zM.187 11.953L11.95.19a10 10 0 0 1 2.355.781L.968 14.308a10 10 0 0 1-.78-2.355m1.991 4.284A10 10 0 0 0 3.76 17.82L17.815 3.764a10 10 0 0 0-1.582-1.582zM19.024 5.694L5.69 19.03c.757.36 1.55.62 2.359.78L19.805 8.054a10 10 0 0 0-.78-2.359m.916 5.364l-8.886 8.886a9.96 9.96 0 0 0 6.013-2.873a9.96 9.96 0 0 0 2.873-6.013"></svg:path>`,
})
export class FluentPresenceTentative20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenceUnknown16RegularIcon],svg[fluent-presence-unknown-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPresenceUnknown16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenter20RegularIcon],svg[fluent-presenter-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.999 6a2 2 0 1 0 0-4a2 2 0 0 0 0 4m0-1a1 1 0 1 1 0-2a1 1 0 0 1 0 2m-1.5 3a.5.5 0 0 0-.5.5V9h-1v-.5a1.5 1.5 0 0 1 1.5-1.5h3a1.5 1.5 0 0 1 1.5 1.5V9h-1v-.5a.5.5 0 0 0-.5-.5zm-1.5 6.784V16.5a1.5 1.5 0 0 0 1.5 1.5h3a1.5 1.5 0 0 0 1.5-1.5v-1.716a.5.5 0 0 1 .153-.36l3.703-3.564a.5.5 0 0 0-.347-.86H3.49a.5.5 0 0 0-.346.86l3.702 3.564a.5.5 0 0 1 .154.36M8 16.5v-1.716a1.5 1.5 0 0 0-.46-1.08L4.729 11h10.539l-2.81 2.703a1.5 1.5 0 0 0-.46 1.081V16.5a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5"></svg:path>`,
})
export class FluentPresenter20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenter24RegularIcon],svg[fluent-presenter-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.245 12.997c.709 0 1.022.892.469 1.335l-4.718 3.778v1.644a2.25 2.25 0 0 1-2.25 2.25H10.25A2.25 2.25 0 0 1 8 19.754V18.11l-4.72-3.778c-.553-.443-.24-1.335.47-1.335zm-2.137 1.5H5.887l3.332 2.667a.75.75 0 0 1 .281.585v2.005c0 .414.336.75.75.75h3.496a.75.75 0 0 0 .75-.75V17.75a.75.75 0 0 1 .281-.585zM8.75 9h6.495a1.75 1.75 0 0 1 1.744 1.606l.006.143V12h-1.5v-1.25a.25.25 0 0 0-.192-.243l-.058-.007H8.75a.25.25 0 0 0-.243.193l-.007.057V12H7v-1.25a1.75 1.75 0 0 1 1.607-1.744zh6.495zM12 2a3 3 0 1 1 0 6a3 3 0 0 1 0-6m0 1.5a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3"></svg:path>`,
})
export class FluentPresenter24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenterOff20FilledIcon],svg[fluent-presenter-off-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenterOff20RegularIcon],svg[fluent-presenter-off-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenterOff24FilledIcon],svg[fluent-presenter-off-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPresenterOff24RegularIcon],svg[fluent-presenter-off-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviewLink16RegularIcon],svg[fluent-preview-link-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 4.5a.5.5 0 0 1 .5-.5h9.001a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5zM4 5v1h8.001V5zm5.5 3a.5.5 0 0 0-.5.5v3.005a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5V8.5a.5.5 0 0 0-.5-.5zm.5 3.005V9h2v2.005zM3 9a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4A.5.5 0 0 1 3 9m.5 1.5a.5.5 0 0 0 0 1h4a.5.5 0 1 0 0-1zm-2.502-6a2.5 2.5 0 0 1 2.5-2.5h9.005a2.5 2.5 0 0 1 2.5 2.5v7.002a2.5 2.5 0 0 1-2.5 2.5H3.498a2.5 2.5 0 0 1-2.5-2.5zm2.5-1.5a1.5 1.5 0 0 0-1.5 1.5v7.002a1.5 1.5 0 0 0 1.5 1.5h9.005a1.5 1.5 0 0 0 1.5-1.5V4.5a1.5 1.5 0 0 0-1.5-1.5z"></svg:path>`,
})
export class FluentPreviewLink16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviewLink20FilledIcon],svg[fluent-preview-link-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 6v1.998h10V6zm6.998 5v3h3v-3zM2 5.754a2.75 2.75 0 0 1 2.75-2.75h10.5A2.75 2.75 0 0 1 18 5.753v8.5a2.75 2.75 0 0 1-2.75 2.75H4.75A2.75 2.75 0 0 1 2 14.253zM4 5.5v2.998a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 .5-.5V5.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5m6.998 5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 0-.5.5m-6.498 0a.5.5 0 0 0 0 1h5.004a.5.5 0 0 0 0-1zM4 14a.5.5 0 0 0 .5.5h5.004a.5.5 0 0 0 0-1H4.5a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentPreviewLink20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviewLink20RegularIcon],svg[fluent-preview-link-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v2.998a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5zM5 6v1.998h10V6zm6.498 4a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5zm.5 4v-3h3v3zM4 11a.5.5 0 0 1 .5-.5h5.004a.5.5 0 0 1 0 1H4.5A.5.5 0 0 1 4 11m.5 2.5a.5.5 0 0 0 0 1h5.003a.5.5 0 0 0 0-1zM2 5.5A2.5 2.5 0 0 1 4.5 3h11A2.5 2.5 0 0 1 18 5.5v9a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 2 14.5zM4.5 4A1.5 1.5 0 0 0 3 5.5v9A1.5 1.5 0 0 0 4.5 16h11a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 15.5 4z"></svg:path>`,
})
export class FluentPreviewLink20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviewLink24FilledIcon],svg[fluent-preview-link-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.024 7v2H17.98V7zm8.956 6.479v3h3v-3zM2 5.75A2.75 2.75 0 0 1 4.75 3h14.5A2.75 2.75 0 0 1 22 5.75v12.5A2.75 2.75 0 0 1 19.25 21H4.75A2.75 2.75 0 0 1 2 18.25zm2.524.5v3.5c0 .414.336.75.75.75H18.73a.75.75 0 0 0 .75-.75v-3.5a.75.75 0 0 0-.75-.75H5.274a.75.75 0 0 0-.75.75m8.956 6.479v4.5c0 .414.335.75.75.75h4.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75h-4.5a.75.75 0 0 0-.75.75M5.274 12.5a.75.75 0 0 0 0 1.5h5.976a.75.75 0 0 0 0-1.5zm-.75 4.25c0 .414.336.75.75.75h5.976a.75.75 0 0 0 0-1.5H5.274a.75.75 0 0 0-.75.75"></svg:path>`,
})
export class FluentPreviewLink24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviewLink24RegularIcon],svg[fluent-preview-link-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrevious20RegularIcon],svg[fluent-previous-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 3.5a.5.5 0 0 1 1 0v13a.5.5 0 0 1-1 0zm14 .752c0-1-1.117-1.595-1.947-1.038l-8.5 5.707a1.25 1.25 0 0 0-.006 2.071l8.499 5.793A1.25 1.25 0 0 0 17 15.752zm-1.39-.207a.25.25 0 0 1 .39.207v11.5c0 .2-.225.32-.391.207l-8.5-5.793a.25.25 0 0 1 .002-.414z"></svg:path>`,
})
export class FluentPrevious20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrevious28RegularIcon],svg[fluent-previous-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrevious48FilledIcon],svg[fluent-previous-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.25 6c.69 0 1.25.56 1.25 1.25v33.5a1.25 1.25 0 1 1-2.5 0V7.25C6 6.56 6.56 6 7.25 6M42 9.256c0-2.615-2.93-4.16-5.088-2.68L15.408 21.318c-1.883 1.29-1.883 4.07 0 5.36l21.504 14.744C39.07 42.9 42 41.357 42 38.743z"></svg:path>`,
})
export class FluentPrevious48FilledIcon {
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrevious48RegularIcon],svg[fluent-previous-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.5 7.25a1.25 1.25 0 1 0-2.5 0v33.5a1.25 1.25 0 1 0 2.5 0zM42 9.257c0-2.615-2.931-4.159-5.088-2.68L15.408 21.32c-1.883 1.291-1.883 4.07 0 5.361l21.504 14.743C39.07 42.904 42 41.36 42 38.744zm-3.674-.618a.75.75 0 0 1 1.174.618v29.487a.75.75 0 0 1-1.174.618L16.822 24.62a.75.75 0 0 1 0-1.237z"></svg:path>`,
})
export class FluentPrevious48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviousFrame20FilledIcon],svg[fluent-previous-frame-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.5 3a.5.5 0 0 0-.5.5v13a.5.5 0 0 0 1 0v-13a.5.5 0 0 0-.5-.5m-5.447.214A1.25 1.25 0 0 1 12 4.252v11.5a1.25 1.25 0 0 1-1.954 1.033l-8.499-5.793a1.25 1.25 0 0 1 .007-2.07z"></svg:path>`,
})
export class FluentPreviousFrame20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPreviousFrame20RegularIcon],svg[fluent-previous-frame-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.5 3a.5.5 0 0 0-.5.5v13a.5.5 0 0 0 1 0v-13a.5.5 0 0 0-.5-.5m-5.447.214A1.25 1.25 0 0 1 12 4.252v11.5a1.25 1.25 0 0 1-1.954 1.033l-8.499-5.793a1.25 1.25 0 0 1 .007-2.07zM11 4.252a.25.25 0 0 0-.39-.207L2.113 9.752a.25.25 0 0 0-.002.414l8.5 5.793a.25.25 0 0 0 .39-.207z"></svg:path>`,
})
export class FluentPreviousFrame20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint16FilledIcon],svg[fluent-print-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 3.5A1.5 1.5 0 0 1 5.5 2h5A1.5 1.5 0 0 1 12 3.5V4h1a2 2 0 0 1 2 2v4.5a1.5 1.5 0 0 1-1.5 1.5H12v.5a1.5 1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 4 12.5V12H2.5A1.5 1.5 0 0 1 1 10.5V6a2 2 0 0 1 2-2h1zm7 0a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0-.5.5V4h6zm-6 7v2a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentPrint16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint24FilledIcon],svg[fluent-print-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18 17.5v1.25A2.25 2.25 0 0 1 15.75 21h-7.5A2.25 2.25 0 0 1 6 18.75v-1.251l-1.75.001A2.25 2.25 0 0 1 2 15.25V9.254a3.25 3.25 0 0 1 3.25-3.25l.749-.001L6 5.25A2.25 2.25 0 0 1 8.25 3h7.502a2.25 2.25 0 0 1 2.25 2.25v.753h.75a3.254 3.254 0 0 1 3.252 3.25l.003 5.997a2.25 2.25 0 0 1-2.248 2.25zm-2.25-4h-7.5a.75.75 0 0 0-.75.75v4.5c0 .414.336.75.75.75h7.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75m.002-9H8.25a.75.75 0 0 0-.75.75l-.001.753h9.003V5.25a.75.75 0 0 0-.75-.75"></svg:path>`,
})
export class FluentPrint24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint24RegularIcon],svg[fluent-print-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.753 3a2.25 2.25 0 0 1 2.25 2.25l-.001.753h.75a3.254 3.254 0 0 1 3.252 3.25l.003 5.997a2.25 2.25 0 0 1-2.248 2.25H18v1.25A2.25 2.25 0 0 1 15.75 21h-7.5A2.25 2.25 0 0 1 6 18.75V17.5H4.25A2.25 2.25 0 0 1 2 15.25V9.254a3.25 3.25 0 0 1 3.25-3.25l.749-.001L6 5.25A2.25 2.25 0 0 1 8.25 3zm-.003 10.5h-7.5a.75.75 0 0 0-.75.75v4.5c0 .414.336.75.75.75h7.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75m3.002-5.996H5.25a1.75 1.75 0 0 0-1.75 1.75v5.996c0 .414.336.75.75.75H6v-1.75A2.25 2.25 0 0 1 8.25 12h7.5A2.25 2.25 0 0 1 18 14.25V16h1.783a.75.75 0 0 0 .724-.749l-.003-5.997a1.754 1.754 0 0 0-1.752-1.75m-3-3.004H8.25a.75.75 0 0 0-.75.75l-.001.753h9.003V5.25a.75.75 0 0 0-.75-.75"></svg:path>`,
})
export class FluentPrint24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint28RegularIcon],svg[fluent-print-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrint28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint32FilledIcon],svg[fluent-print-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 6.5V8H7a5 5 0 0 0-5 5v7.5A3.5 3.5 0 0 0 5.5 24H7v1.5a3.5 3.5 0 0 0 3.5 3.5h11a3.5 3.5 0 0 0 3.5-3.5V24h1.5a3.5 3.5 0 0 0 3.5-3.5V13a5 5 0 0 0-5-5h-1V6.5A3.5 3.5 0 0 0 20.5 3h-9A3.5 3.5 0 0 0 8 6.5M11.5 5h9A1.5 1.5 0 0 1 22 6.5V8H10V6.5A1.5 1.5 0 0 1 11.5 5M9 19.5a1.5 1.5 0 0 1 1.5-1.5h11a1.5 1.5 0 0 1 1.5 1.5v6a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 9 25.5z"></svg:path>`,
})
export class FluentPrint32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint32LightIcon],svg[fluent-print-32-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 8h1V6.5A3.5 3.5 0 0 1 11.5 3h9A3.5 3.5 0 0 1 24 6.5V8h1a5 5 0 0 1 5 5v7.5a3.5 3.5 0 0 1-3.5 3.5H25v1.5a3.5 3.5 0 0 1-3.5 3.5h-11A3.5 3.5 0 0 1 7 25.5V24H5.5A3.5 3.5 0 0 1 2 20.5V13a5 5 0 0 1 5-5m4.5-4A2.5 2.5 0 0 0 9 6.5V8h14V6.5A2.5 2.5 0 0 0 20.5 4zM8 25.5a2.5 2.5 0 0 0 2.5 2.5h11a2.5 2.5 0 0 0 2.5-2.5v-6a2.5 2.5 0 0 0-2.5-2.5h-11A2.5 2.5 0 0 0 8 19.5zM25 23h1.5a2.5 2.5 0 0 0 2.5-2.5V13a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v7.5A2.5 2.5 0 0 0 5.5 23H7v-3.5a3.5 3.5 0 0 1 3.5-3.5h11a3.5 3.5 0 0 1 3.5 3.5z"></svg:path>`,
})
export class FluentPrint32LightIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint32RegularIcon],svg[fluent-print-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 6.5V8h1a5 5 0 0 1 5 5v7.5a3.5 3.5 0 0 1-3.5 3.5H25v1.5a3.5 3.5 0 0 1-3.5 3.5h-11A3.5 3.5 0 0 1 7 25.5V24H5.5A3.5 3.5 0 0 1 2 20.5V13a5 5 0 0 1 5-5h1V6.5A3.5 3.5 0 0 1 11.5 3h9A3.5 3.5 0 0 1 24 6.5m-14 0V8h12V6.5A1.5 1.5 0 0 0 20.5 5h-9A1.5 1.5 0 0 0 10 6.5m-1 19a1.5 1.5 0 0 0 1.5 1.5h11a1.5 1.5 0 0 0 1.5-1.5v-6a1.5 1.5 0 0 0-1.5-1.5h-11A1.5 1.5 0 0 0 9 19.5zM25 22h1.5a1.5 1.5 0 0 0 1.5-1.5V13a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v7.5A1.5 1.5 0 0 0 5.5 22H7v-2.5a3.5 3.5 0 0 1 3.5-3.5h11a3.5 3.5 0 0 1 3.5 3.5z"></svg:path>`,
})
export class FluentPrint32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint48FilledIcon],svg[fluent-print-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrint48RegularIcon],svg[fluent-print-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrintAdd20FilledIcon],svg[fluent-print-add-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 5.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 0 0-1 0V5h-1.5a.5.5 0 0 0 0 1H14v1.5a.5.5 0 0 0 1 0V6h1.5a.5.5 0 0 0 0-1H15zm-.5 7.5c1.33 0 2.55-.472 3.5-1.257V13.5a1.5 1.5 0 0 1-1.5 1.5H15v1.5a1.5 1.5 0 0 1-1.5 1.5h-7A1.5 1.5 0 0 1 5 16.5V15H3.5A1.5 1.5 0 0 1 2 13.5v-5A2.5 2.5 0 0 1 4.5 6H5v-.5A1.5 1.5 0 0 1 6.5 4h2.707a5.5 5.5 0 0 0-.185 1H6.5a.5.5 0 0 0-.5.5V6h3.022a5.5 5.5 0 0 0 5.478 5M6 12.5v4a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5h-7a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentPrintAdd20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrintAdd20RegularIcon],svg[fluent-print-add-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrintAdd24FilledIcon],svg[fluent-print-add-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrintAdd24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrintAdd24RegularIcon],svg[fluent-print-add-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrintAdd24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProduction20FilledIcon],svg[fluent-production-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 3.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zm.5 3V4h2v2zM2 12a4 4 0 0 1 4-4h8a4 4 0 0 1 0 8H6a4 4 0 0 1-4-4m5 0a1 1 0 1 0-2 0a1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0a1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2a1 1 0 0 0 0 2"></svg:path>`,
})
export class FluentProduction20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProduction20RegularIcon],svg[fluent-production-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 3.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zm.5 3V4h2v2zm-6 7a1 1 0 1 0 0-2a1 1 0 0 0 0 2m5-1a1 1 0 1 1-2 0a1 1 0 0 1 2 0m3 1a1 1 0 1 0 0-2a1 1 0 0 0 0 2M2 12a4 4 0 0 1 4-4h8a4 4 0 0 1 0 8H6a4 4 0 0 1-4-4m4-3a3 3 0 1 0 0 6h8a3 3 0 1 0 0-6z"></svg:path>`,
})
export class FluentProduction20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProduction24RegularIcon],svg[fluent-production-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.25 3.5A1.75 1.75 0 0 0 4.5 5.25v2.5c0 .966.784 1.75 1.75 1.75h2.5a1.75 1.75 0 0 0 1.75-1.75v-2.5A1.75 1.75 0 0 0 8.75 3.5zm7.25 1.75c0-.966.784-1.75 1.75-1.75h2.5c.966 0 1.75.784 1.75 1.75v2.5a1.75 1.75 0 0 1-1.75 1.75h-2.5a1.75 1.75 0 0 1-1.75-1.75zM15.25 5a.25.25 0 0 0-.25.25v2.5c0 .138.112.25.25.25h2.5a.25.25 0 0 0 .25-.25v-2.5a.25.25 0 0 0-.25-.25zM7 17.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m6.5-1.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0m3.5 1.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M2 16a4.5 4.5 0 0 1 4.5-4.5h11a4.5 4.5 0 1 1 0 9h-11A4.5 4.5 0 0 1 2 16m4.5-3a3 3 0 1 0 0 6h11a3 3 0 1 0 0-6z"></svg:path>`,
})
export class FluentProduction24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProductionCheckmark20FilledIcon],svg[fluent-production-checkmark-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 3.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zm.5 3V4h2v2zM6 8a4 4 0 1 0 0 8h3.207A5.5 5.5 0 0 1 9 14.5c0-.626.105-1.228.297-1.789a1 1 0 0 1 .937-1.684A5.49 5.49 0 0 1 14.5 9c1.035 0 2.003.286 2.83.783A4 4 0 0 0 14 8zm0 5a1 1 0 1 1 0-2a1 1 0 0 1 0 2m13 1.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-2.854-1.854L13.5 15.293l-.646-.647a.5.5 0 0 0-.708.708l1 1a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708"></svg:path>`,
})
export class FluentProductionCheckmark20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProductionCheckmark20RegularIcon],svg[fluent-production-checkmark-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 3.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zm.5 3V4h2v2zM2 12a4 4 0 0 1 4-4h8c1.39 0 2.613.708 3.33 1.783a5.47 5.47 0 0 0-3.118-.776A3 3 0 0 0 14 9H6a3 3 0 1 0 0 6h3.022q.047.516.185 1H6a4 4 0 0 1-4-4m8-1q.121 0 .235.028a5.5 5.5 0 0 0-.938 1.683A1 1 0 0 1 10 11m-4 2a1 1 0 1 0 0-2a1 1 0 0 0 0 2m13 1.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-2.854-1.854L13.5 15.293l-.646-.647a.5.5 0 0 0-.708.708l1 1a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708"></svg:path>`,
})
export class FluentProductionCheckmark20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProductionCheckmark24FilledIcon],svg[fluent-production-checkmark-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.25 3.5A1.75 1.75 0 0 0 4.5 5.25v2.5c0 .966.784 1.75 1.75 1.75h2.5a1.75 1.75 0 0 0 1.75-1.75v-2.5A1.75 1.75 0 0 0 8.75 3.5zm7.25 1.75v2.5c0 .966.784 1.75 1.75 1.75h2.5a1.75 1.75 0 0 0 1.75-1.75v-2.5a1.75 1.75 0 0 0-1.75-1.75h-2.5a1.75 1.75 0 0 0-1.75 1.75M15.25 5h2.5a.25.25 0 0 1 .25.25v2.5a.25.25 0 0 1-.25.25h-2.5a.25.25 0 0 1-.25-.25v-2.5a.25.25 0 0 1 .25-.25M6.5 11.5a4.5 4.5 0 1 0 0 9h5.232a6.47 6.47 0 0 1-.721-3.373a1.5 1.5 0 0 1 .708-2.601a6.53 6.53 0 0 1 3.277-3.026zm.5 6a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3m16 0a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0m-2.146-2.354a.5.5 0 0 0-.708 0L16.5 18.793l-1.646-1.647a.5.5 0 0 0-.708.708l2 2a.5.5 0 0 0 .708 0l4-4a.5.5 0 0 0 0-.708"></svg:path>`,
})
export class FluentProductionCheckmark24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProductionCheckmark24RegularIcon],svg[fluent-production-checkmark-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.25 3.5A1.75 1.75 0 0 0 4.5 5.25v2.5c0 .966.784 1.75 1.75 1.75h2.5a1.75 1.75 0 0 0 1.75-1.75v-2.5A1.75 1.75 0 0 0 8.75 3.5zm7.25 1.75c0-.966.784-1.75 1.75-1.75h2.5c.966 0 1.75.784 1.75 1.75v2.5a1.75 1.75 0 0 1-1.75 1.75h-2.5a1.75 1.75 0 0 1-1.75-1.75zM15.25 5a.25.25 0 0 0-.25.25v2.5c0 .138.112.25.25.25h2.5a.25.25 0 0 0 .25-.25v-2.5a.25.25 0 0 0-.25-.25zM7 17.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M6.5 13h6.31a6.5 6.5 0 0 1 2.186-1.5H6.5a4.5 4.5 0 1 0 0 9h5.232a6.5 6.5 0 0 1-.558-1.5H6.5a3 3 0 1 1 0-6m4 3c0 .45.197.852.51 1.127a6.5 6.5 0 0 1 .709-2.6A1.5 1.5 0 0 0 10.5 16M23 17.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0m-2.146-2.354a.5.5 0 0 0-.708 0L16.5 18.793l-1.646-1.647a.5.5 0 0 0-.708.708l2 2a.5.5 0 0 0 .708 0l4-4a.5.5 0 0 0 0-.708"></svg:path>`,
})
export class FluentProductionCheckmark24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibited12FilledIcon],svg[fluent-prohibited-12-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 6A5 5 0 1 1 1 6a5 5 0 0 1 10 0M9.5 6c0-.695-.203-1.342-.552-1.887L4.113 8.948A3.5 3.5 0 0 0 9.5 6M7.888 3.052a3.5 3.5 0 0 0-4.836 4.836z"></svg:path>`,
})
export class FluentProhibited12FilledIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibited24RegularIcon],svg[fluent-prohibited-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2m6.517 4.543L6.543 18.517A8.5 8.5 0 0 0 18.517 6.543M12 3.5a8.5 8.5 0 0 0-6.517 13.957L17.457 5.483A8.47 8.47 0 0 0 12 3.5"></svg:path>`,
})
export class FluentProhibited24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibited32FilledIcon],svg[fluent-prohibited-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.032 23.2A11.45 11.45 0 0 1 4.5 16C4.5 9.649 9.649 4.5 16 4.5c2.725 0 5.23.948 7.2 2.532zM8.8 24.968L24.968 8.8A11.45 11.45 0 0 1 27.5 16c0 6.351-5.149 11.5-11.5 11.5c-2.725 0-5.23-.948-7.2-2.532M2 16c0 7.732 6.268 14 14 14s14-6.268 14-14S23.732 2 16 2S2 8.268 2 16"></svg:path>`,
})
export class FluentProhibited32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibited48RegularIcon],svg[fluent-prohibited-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M35.46 10.773c-6.876-5.969-17.297-5.684-23.834.853s-6.822 16.959-.853 23.833zm1.767 1.768L12.541 37.227c6.875 5.969 17.296 5.684 23.833-.853s6.822-16.958.853-23.833M9.857 9.858c7.811-7.81 20.475-7.81 28.285 0s7.81 20.474 0 28.284s-20.474 7.81-28.284 0s-7.81-20.474 0-28.284"></svg:path>`,
})
export class FluentProhibited48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple16FilledIcon],svg[fluent-prohibited-multiple-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.818 3.818a4.5 4.5 0 0 1 5.79-.486L3.332 9.608a4.5 4.5 0 0 1 .486-5.79m.574 6.85l6.276-6.276a4.501 4.501 0 0 1-6.276 6.276m6.85-7.91a6 6 0 1 0-8.485 8.485a6 6 0 0 0 8.486-8.486M14 7a7 7 0 0 1-8.394 6.861a6 6 0 0 0 8.256-8.255Q13.997 6.283 14 7"></svg:path>`,
})
export class FluentProhibitedMultiple16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple16RegularIcon],svg[fluent-prohibited-multiple-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.464 3.464a5 5 0 0 1 6.7-.336l-7.036 7.037a5 5 0 0 1 .336-6.7m.371 7.408l7.037-7.037a5 5 0 0 1-7.037 7.037m7.408-8.115a6 6 0 1 0-8.486 8.486a6 6 0 0 0 8.486-8.486M14 7c0 1.217-.31 2.361-.857 3.358a5.02 5.02 0 0 1-2.785 2.785A7 7 0 0 1 7 14q-.553 0-1.084-.084a6 6 0 0 0 8-8Q14 6.446 14 7"></svg:path>`,
})
export class FluentProhibitedMultiple16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple20RegularIcon],svg[fluent-prohibited-multiple-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.757 4.757a6 6 0 0 1 8.118-.339l-8.457 8.457a6 6 0 0 1 .34-8.118m.368 8.825l8.457-8.457a6 6 0 0 1-8.457 8.457M13.95 4.05a7 7 0 1 0-9.9 9.9a7 7 0 0 0 9.9-9.9M17 9c0 1.37-.344 2.66-.95 3.786a6.02 6.02 0 0 1-3.264 3.263A8 8 0 0 1 9 17a8 8 0 0 1-1.382-.119a7 7 0 0 0 9.263-9.263Q17 8.292 17 9"></svg:path>`,
})
export class FluentProhibitedMultiple20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple24FilledIcon],svg[fluent-prohibited-multiple-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.05 6.05a7 7 0 0 1 9.143-.657l-9.8 9.8A7 7 0 0 1 6.05 6.05m.757 10.557l9.8-9.8a7.001 7.001 0 0 1-9.8 9.8M17.364 4.636A9 9 0 1 0 4.636 17.364A9 9 0 0 0 17.364 4.636M21 11c0 5.523-4.477 10-10 10a10 10 0 0 1-2.834-.407A9 9 0 0 0 20.593 8.166c.265.898.407 1.85.407 2.834"></svg:path>`,
})
export class FluentProhibitedMultiple24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple28FilledIcon],svg[fluent-prohibited-multiple-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.636 6.636a9 9 0 0 1 11.982-.668l-12.65 12.65a9 9 0 0 1 .668-11.982m.746 13.396l12.65-12.65a9.001 9.001 0 0 1-12.65 12.65m13.396-14.81C16.482.926 9.518.926 5.222 5.222s-4.296 11.26 0 15.556s11.26 4.296 15.556 0c4.296-4.295 4.296-11.26 0-15.556M25.001 13c0 6.627-5.373 12-12 12c-1.28 0-2.513-.2-3.669-.571A10.95 10.95 0 0 0 15.001 26c6.075 0 11-4.925 11-11c0-2.074-.574-4.013-1.572-5.669c.371 1.157.572 2.39.572 3.669"></svg:path>`,
})
export class FluentProhibitedMultiple28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProhibitedMultiple28RegularIcon],svg[fluent-prohibited-multiple-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreen16RegularIcon],svg[fluent-projection-screen-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 2a1 1 0 0 0 0 2v4.5A2.5 2.5 0 0 0 5.5 11h2v2h-2a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-2v-2h2A2.5 2.5 0 0 0 13 8.5V4a1 1 0 1 0 0-2zm1 2h8v4.5a1.5 1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 4 8.5z"></svg:path>`,
})
export class FluentProjectionScreen16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss16RegularIcon],svg[fluent-projection-screen-dismiss-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 5.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-2.646-1.146a.5.5 0 0 0-.708-.708L10.5 4.793L9.354 3.646a.5.5 0 1 0-.708.708L9.793 5.5L8.646 6.646a.5.5 0 1 0 .708.708L10.5 6.207l1.146 1.147a.5.5 0 0 0 .708-.708L11.207 5.5zM10.5 11q.552 0 1.075-.105A2.5 2.5 0 0 1 9.5 12h-2v2h2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h2v-2h-2A2.5 2.5 0 0 1 2 9.5V5a1 1 0 0 1 0-2h3.6a5.5 5.5 0 0 0-.578 2H3v4.5A1.5 1.5 0 0 0 4.5 11h5q.177 0 .341-.039q.324.039.659.039"></svg:path>`,
})
export class FluentProjectionScreenDismiss16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss20FilledIcon],svg[fluent-projection-screen-dismiss-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 5.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-2.646-1.146a.5.5 0 0 0-.708-.708L14.5 4.793l-1.146-1.147a.5.5 0 0 0-.708.708L13.793 5.5l-1.147 1.146a.5.5 0 0 0 .708.708L14.5 6.207l1.146 1.147a.5.5 0 0 0 .708-.708L15.207 5.5zM14.5 11c.9 0 1.75-.216 2.5-.6v.6a3 3 0 0 1-3 3h-3.5v2h2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h2v-2H6a3 3 0 0 1-3-3V5a1 1 0 0 1 0-2h6.6a5.5 5.5 0 0 0 4.9 8"></svg:path>`,
})
export class FluentProjectionScreenDismiss20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss20RegularIcon],svg[fluent-projection-screen-dismiss-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 5.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-2.646-1.146a.5.5 0 0 0-.708-.708L14.5 4.793l-1.146-1.147a.5.5 0 0 0-.708.708L13.793 5.5l-1.147 1.146a.5.5 0 0 0 .708.708L14.5 6.207l1.146 1.147a.5.5 0 0 0 .708-.708L15.207 5.5zM16 11v-.207q.524-.149 1-.393v.6a3 3 0 0 1-3 3h-3.5v2h2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h2v-2H6a3 3 0 0 1-3-3V5a1 1 0 0 1 0-2h6.6a5.5 5.5 0 0 0-.578 2H4v6a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2"></svg:path>`,
})
export class FluentProjectionScreenDismiss20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss24FilledIcon],svg[fluent-projection-screen-dismiss-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentProjectionScreenDismiss24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss24RegularIcon],svg[fluent-projection-screen-dismiss-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenDismiss28RegularIcon],svg[fluent-projection-screen-dismiss-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenText20FilledIcon],svg[fluent-projection-screen-text-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1 3.5A1.5 1.5 0 0 1 2.5 2h15a1.5 1.5 0 0 1 .5 2.915V12a3 3 0 0 1-3 3h-4.5v2h3a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1h3v-2H5a3 3 0 0 1-3-3V4.915A1.5 1.5 0 0 1 1 3.5M7.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM6 9.5a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7a.5.5 0 0 0-.5.5M7.5 11a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1z"></svg:path>`,
})
export class FluentProjectionScreenText20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenText20RegularIcon],svg[fluent-projection-screen-text-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM6 9.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5M7.5 11a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zm-5-9A1.5 1.5 0 0 0 2 4.915V12a3 3 0 0 0 3 3h4.5v2h-3a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-3v-2H15a3 3 0 0 0 3-3V4.915A1.5 1.5 0 0 0 17.5 2zM3 12V5h14v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2"></svg:path>`,
})
export class FluentProjectionScreenText20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenText24FilledIcon],svg[fluent-projection-screen-text-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProjectionScreenText24RegularIcon],svg[fluent-projection-screen-text-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt16FilledIcon],svg[fluent-prompt-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt16RegularIcon],svg[fluent-prompt-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrompt16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt20FilledIcon],svg[fluent-prompt-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt20RegularIcon],svg[fluent-prompt-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt24FilledIcon],svg[fluent-prompt-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt24RegularIcon],svg[fluent-prompt-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrompt24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt28FilledIcon],svg[fluent-prompt-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt28RegularIcon],svg[fluent-prompt-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPrompt28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt32FilledIcon],svg[fluent-prompt-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt32RegularIcon],svg[fluent-prompt-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M27 8a1 1 0 0 1-1-1V6h-1a1 1 0 1 1 0-2h1V3a1 1 0 1 1 2 0v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 0 1-1 1M13 23.368V25.5a2.5 2.5 0 0 0 2.5 2.5h10a2.5 2.5 0 0 0 2.5-2.5v-10a2.5 2.5 0 0 0-2.5-2.5h-2.132c.085-.312.132-.646.132-1s-.047-.688-.132-1H25.5a4.5 4.5 0 0 1 4.5 4.5v10a4.5 4.5 0 0 1-4.5 4.5h-10a4.5 4.5 0 0 1-4.5-4.5v-2.133q.47.131 1.001.133c.354 0 .687-.047.999-.132M3 26a1 1 0 1 0 0 2h1v1a1 1 0 1 0 2 0v-1h1a1 1 0 1 0 0-2H6v-1a1 1 0 1 0-2 0v1zm13-7a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1m1 3a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2zM11.632 4.391a.57.57 0 0 1 .17-.3a.3.3 0 0 1 .2-.09a.3.3 0 0 1 .2.09a.57.57 0 0 1 .17.3c.252 1.215.892 3.086 2.52 4.716c1.63 1.63 3.5 2.27 4.717 2.523a.57.57 0 0 1 .3.17a.3.3 0 0 1 .091.2a.3.3 0 0 1-.09.2a.57.57 0 0 1-.301.17c-1.216.253-3.087.893-4.716 2.524c-1.63 1.63-2.269 3.499-2.521 4.714a.57.57 0 0 1-.17.301a.3.3 0 0 1-.2.091a.3.3 0 0 1-.2-.09a.57.57 0 0 1-.17-.301c-.253-1.216-.893-3.087-2.523-4.717s-3.5-2.27-4.716-2.523a.57.57 0 0 1-.3-.169a.3.3 0 0 1-.09-.2a.3.3 0 0 1 .09-.2a.57.57 0 0 1 .3-.17c1.217-.252 3.087-.893 4.716-2.522c1.63-1.63 2.27-3.501 2.523-4.717m.37-2.39C10.775 2 9.885 2.966 9.674 3.984c-.202.972-.71 2.44-1.98 3.709C6.428 8.962 4.96 9.47 3.988 9.672c-1.02.211-1.987 1.103-1.985 2.332c.002 1.226.968 2.113 1.985 2.324c.972.202 2.44.709 3.708 1.978c1.268 1.268 1.776 2.736 1.978 3.71c.211 1.018 1.1 1.984 2.327 1.984c1.228 0 2.118-.967 2.33-1.985c.201-.973.709-2.439 1.976-3.707c1.269-1.27 2.736-1.777 3.709-1.98C21.034 14.117 22 13.228 22 12s-.967-2.117-1.985-2.328c-.973-.202-2.44-.71-3.708-1.978c-1.268-1.27-1.775-2.736-1.978-3.71C14.12 2.966 13.23 2 12.002 2"></svg:path>`,
})
export class FluentPrompt32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt48FilledIcon],svg[fluent-prompt-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPrompt48RegularIcon],svg[fluent-prompt-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProtocolHandler16RegularIcon],svg[fluent-protocol-handler-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.585 4.414L1.414 6.585a2 2 0 0 0 0 2.829l2.171 2.172a2 2 0 0 0 2.829 0l2.171-2.172a2 2 0 0 0 0-2.829L6.414 4.414a2 2 0 0 0-2.829 0M2.121 7.293L4.293 5.12a1 1 0 0 1 1.414 0l2.171 2.172a1 1 0 0 1 0 1.414l-2.171 2.171a1 1 0 0 1-1.414 0L2.12 8.707a1 1 0 0 1 0-1.414m7.464 4.292l-.878-.878l.586-.586q.06-.06.117-.125l.883.882a1 1 0 0 0 1.414 0l2.171-2.171a1 1 0 0 0 0-1.414l-2.17-2.173a1 1 0 0 0-1.414 0l-.883.882a3 3 0 0 0-.117-.125l-.586-.585l.878-.88a2 2 0 0 1 2.829 0l2.172 2.172a2 2 0 0 1 0 2.829l-2.172 2.172a2 2 0 0 1-2.829 0"></svg:path>`,
})
export class FluentProtocolHandler16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProtocolHandler20FilledIcon],svg[fluent-protocol-handler-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.585 5.414L2.414 8.585a2 2 0 0 0 0 2.829l3.171 3.172a2 2 0 0 0 2.829 0l3.172-3.172a2 2 0 0 0 0-2.829L8.414 5.414a2 2 0 0 0-2.829 0m6 9.172l-.878-.88l1.586-1.585a3 3 0 0 0 0-4.243l-1.586-1.585l.878-.88a2 2 0 0 1 2.829 0l3.172 3.172a2 2 0 0 1 0 2.829l-3.172 3.172a2 2 0 0 1-2.828 0"></svg:path>`,
})
export class FluentProtocolHandler20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentProtocolHandler20RegularIcon],svg[fluent-protocol-handler-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentProtocolHandler24RegularIcon],svg[fluent-protocol-handler-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPulse28FilledIcon],svg[fluent-pulse-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.035 3a1 1 0 0 1 .94.78l3.712 16.496l3.864-11.592a1 1 0 0 1 1.878-.055L22.177 13H25a1 1 0 1 1 0 2h-3.5a1 1 0 0 1-.928-.629l-.987-2.465l-4.136 12.41a1 1 0 0 1-1.925-.096L9.862 7.94l-1.904 6.347A1 1 0 0 1 7 15H3a1 1 0 1 1 0-2h3.256l2.786-9.287A1 1 0 0 1 10.035 3"></svg:path>`,
})
export class FluentPulse28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPulse28RegularIcon],svg[fluent-pulse-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPulseSquare20FilledIcon],svg[fluent-pulse-square-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm5.97 1.332a.5.5 0 0 0-.938-.008L6.654 10H5.5a.5.5 0 0 0 0 1H7a.5.5 0 0 0 .468-.324l1.02-2.721l2.041 5.713a.5.5 0 0 0 .918.056L12.81 11h1.69a.5.5 0 0 0 0-1h-2a.5.5 0 0 0-.447.276l-.976 1.952z"></svg:path>`,
})
export class FluentPulseSquare20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPulseSquare20RegularIcon],svg[fluent-pulse-square-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.97 6.332a.5.5 0 0 0-.938-.008L6.654 10H5.5a.5.5 0 0 0 0 1H7a.5.5 0 0 0 .468-.324l1.02-2.721l2.041 5.713a.5.5 0 0 0 .918.056L12.81 11h1.69a.5.5 0 0 0 0-1h-2a.5.5 0 0 0-.447.276l-.976 1.952zM5 3a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM4 5a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1z"></svg:path>`,
})
export class FluentPulseSquare20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPulseSquare24RegularIcon],svg[fluent-pulse-square-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentPulseSquare24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzleCube24RegularIcon],svg[fluent-puzzle-cube-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 8.5v9.25A3.25 3.25 0 0 0 6.25 21h11.5A3.25 3.25 0 0 0 21 17.75V6.25A3.25 3.25 0 0 0 17.75 3H8.5v5.5zM8.5 10v4h-4v-4zm1.5 4v-4h4v4zm5.5 0v-4h4v4zM10 15.5h4v4h-4zm5.5 0h4v2.25a1.75 1.75 0 0 1-1.75 1.75H15.5zm0-11h2.25c.966 0 1.75.784 1.75 1.75V8.5h-4zm-1.5 4h-4v-4h4zm-5.5 7v4H6.25a1.75 1.75 0 0 1-1.75-1.75V15.5z"></svg:path>`,
})
export class FluentPuzzleCube24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzleCube28FilledIcon],svg[fluent-puzzle-cube-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 11v6h6.5v-6zm0 7.5v2.75A3.75 3.75 0 0 0 6.75 25H9.5v-6.5zm8 6.5h6v-6.5h-6zm7.5 0h2.75A3.75 3.75 0 0 0 25 21.25V18.5h-6.5zm6.5-8v-6h-6.5v6zm0-7.5V6.75A3.75 3.75 0 0 0 21.25 3H18.5v6.5zM17 3h-6v6.5h6zm0 8v6h-6v-6z"></svg:path>`,
})
export class FluentPuzzleCube28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzleCubePiece20FilledIcon],svg[fluent-puzzle-cube-piece-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzleCubePiece20RegularIcon],svg[fluent-puzzle-cube-piece-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece12RegularIcon],svg[fluent-puzzle-piece-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.5 1a.5.5 0 0 0-.5.5V3H4v2H2.5a.5.5 0 0 0 0 1H4v2h2v1.5a.5.5 0 0 0 1 0V8h2V7h-.5a1.5 1.5 0 1 1 0-3H9V3H7V1.5a.5.5 0 0 0-.5-.5M5 1.5a1.5 1.5 0 1 1 3 0V2h1a1 1 0 0 1 1 1v2H8.5a.5.5 0 0 0 0 1H10v2a1 1 0 0 1-1 1H8v.5a1.5 1.5 0 0 1-3 0V9H4a1 1 0 0 1-1-1V7h-.5a1.5 1.5 0 1 1 0-3H3V3a1 1 0 0 1 1-1h1z"></svg:path>`,
})
export class FluentPuzzlePiece12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece20RegularIcon],svg[fluent-puzzle-piece-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 3c-.69 0-1.25.56-1.25 1.25V5H6.5a.5.5 0 0 0-.5.5v3.25h-.75a1.25 1.25 0 1 0 0 2.5H6v3.25a.5.5 0 0 0 .5.5h3.25v.75a1.25 1.25 0 1 0 2.5 0V15h3.25a.5.5 0 0 0 .5-.5v-2.25h-.75a2.25 2.25 0 0 1 0-4.5H16V5.5a.5.5 0 0 0-.5-.5h-3.25v-.75C12.25 3.56 11.69 3 11 3M8.764 4a2.25 2.25 0 0 1 4.472 0H15.5A1.5 1.5 0 0 1 17 5.5v3.25h-1.75a1.25 1.25 0 1 0 0 2.5H17v3.25a1.5 1.5 0 0 1-1.5 1.5h-2.264a2.25 2.25 0 0 1-4.472 0H6.5A1.5 1.5 0 0 1 5 14.5v-2.264a2.25 2.25 0 0 1 0-4.472V5.5A1.5 1.5 0 0 1 6.5 4z"></svg:path>`,
})
export class FluentPuzzlePiece20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece24RegularIcon],svg[fluent-puzzle-piece-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece28RegularIcon],svg[fluent-puzzle-piece-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 3.5a2 2 0 0 0-2 2v2H9.25a.75.75 0 0 0-.75.75V12h-2a2 2 0 1 0 0 4h2v3.75c0 .414.336.75.75.75H13v2a2 2 0 1 0 4 0v-2h3.75a.75.75 0 0 0 .75-.75V17H21a3 3 0 1 1 0-6h.5V8.25a.75.75 0 0 0-.75-.75H17v-2a2 2 0 0 0-2-2m-3.5 2a3.5 3.5 0 1 1 7 0V6h2.25A2.25 2.25 0 0 1 23 8.25v4.25h-2a1.5 1.5 0 0 0 0 3h2v4.25A2.25 2.25 0 0 1 20.75 22H18.5v.5a3.5 3.5 0 1 1-7 0V22H9.25A2.25 2.25 0 0 1 7 19.75V17.5h-.5a3.5 3.5 0 1 1 0-7H7V8.25A2.25 2.25 0 0 1 9.25 6h2.25z"></svg:path>`,
})
export class FluentPuzzlePiece28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece32RegularIcon],svg[fluent-puzzle-piece-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 4a2 2 0 0 0-2 2v2H9.75a.75.75 0 0 0-.75.75V14H7a2 2 0 1 0 0 4h2v5.25c0 .414.336.75.75.75H15v2a2 2 0 1 0 4 0v-2h5.25a.75.75 0 0 0 .75-.75V20h-1a4 4 0 0 1 0-8h1V8.75a.75.75 0 0 0-.75-.75H19V6a2 2 0 0 0-2-2m-4 2a4 4 0 0 1 8 0h3.25A2.75 2.75 0 0 1 27 8.75V14h-3a2 2 0 1 0 0 4h3v5.25A2.75 2.75 0 0 1 24.25 26H21a4 4 0 0 1-8 0H9.75A2.75 2.75 0 0 1 7 23.25V20a4 4 0 0 1 0-8V8.75A2.75 2.75 0 0 1 9.75 6z"></svg:path>`,
})
export class FluentPuzzlePiece32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePiece48RegularIcon],svg[fluent-puzzle-piece-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M25 6.5a3.5 3.5 0 0 0-3.5 3.5v2.5h-6.75c-.69 0-1.25.56-1.25 1.25v6.75H11a3.5 3.5 0 1 0 0 7h2.5v6.75c0 .69.56 1.25 1.25 1.25h6.75V38a3.5 3.5 0 1 0 7 0v-2.5h6.75c.69 0 1.25-.56 1.25-1.25V30H36a6 6 0 0 1 0-12h.5v-4.25c0-.69-.56-1.25-1.25-1.25H28.5V10A3.5 3.5 0 0 0 25 6.5M19 10a6 6 0 0 1 12 0h4.25A3.75 3.75 0 0 1 39 13.75v6.75h-3a3.5 3.5 0 1 0 0 7h3v6.75A3.75 3.75 0 0 1 35.25 38H31a6 6 0 0 1-12 0h-4.25A3.75 3.75 0 0 1 11 34.25V30a6 6 0 0 1 0-12v-4.25A3.75 3.75 0 0 1 14.75 10z"></svg:path>`,
})
export class FluentPuzzlePiece48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePieceShield20FilledIcon],svg[fluent-puzzle-piece-shield-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m5 11.904l.06.021c.287.1.594.1.882 0a6.8 6.8 0 0 0 2.263-1.343C9.139 9.735 10 8.417 10 6.517V4.194c0-.556-.296-.997-.698-1.25A1.999 1.999 0 0 1 13 4h2.5A1.5 1.5 0 0 1 17 5.5V8h-1a2 2 0 0 0 0 4h1v2.5a1.5 1.5 0 0 1-1.5 1.5H13a2 2 0 1 1-4 0H6.5A1.5 1.5 0 0 1 5 14.5zm.88-9.745c.508.533 1.484 1.38 2.684 1.553A.5.5 0 0 1 9 4.194v2.323c0 3.122-2.784 4.255-3.386 4.463a.34.34 0 0 1-.228 0C4.785 10.772 2 9.64 2 6.517V4.194a.5.5 0 0 1 .436-.482c1.2-.174 2.175-1.02 2.683-1.553a.535.535 0 0 1 .762 0"></svg:path>`,
})
export class FluentPuzzlePieceShield20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentPuzzlePieceShield20RegularIcon],svg[fluent-puzzle-piece-shield-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m5 11.904l.06.021a1.34 1.34 0 0 0 .94-.02V14.5a.5.5 0 0 0 .5.5h3.25v.75a1.25 1.25 0 1 0 2.5 0V15h3.25a.5.5 0 0 0 .5-.5v-2.25h-.75a2.25 2.25 0 0 1 0-4.5H16V5.5a.5.5 0 0 0-.5-.5h-3.25v-.75a1.25 1.25 0 0 0-2.35-.593a1.5 1.5 0 0 0-.691-.768A2.25 2.25 0 0 1 13.237 4H15.5A1.5 1.5 0 0 1 17 5.501v3.25h-1.75a1.25 1.25 0 0 0 0 2.5H17v3.25a1.5 1.5 0 0 1-1.5 1.5h-2.263a2.25 2.25 0 0 1-4.473 0H6.5A1.5 1.5 0 0 1 5 14.5zm.88-9.745c.508.533 1.484 1.38 2.684 1.553A.5.5 0 0 1 9 4.194v2.323c0 3.122-2.784 4.255-3.386 4.463a.34.34 0 0 1-.228 0C4.785 10.772 2 9.64 2 6.517V4.194a.5.5 0 0 1 .436-.482c1.2-.174 2.175-1.02 2.683-1.553a.535.535 0 0 1 .762 0"></svg:path>`,
})
export class FluentPuzzlePieceShield20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQrCode20FilledIcon],svg[fluent-qr-code-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13 11h-2v2h2v2h-2v2h2v-2h2v2h2v-2h-2v-2h2v-2h-2v2h-2zM5 5h2v2H5zm0-2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-.75 1.75a.5.5 0 0 1 .5-.5h2.5a.5.5 0 0 1 .5.5v2.5a.5.5 0 0 1-.5.5h-2.5a.5.5 0 0 1-.5-.5zM5 13h2v2H5zm0-2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2zm-.75 1.75a.5.5 0 0 1 .5-.5h2.5a.5.5 0 0 1 .5.5v2.5a.5.5 0 0 1-.5.5h-2.5a.5.5 0 0 1-.5-.5zM13 5h2v2h-2zm0-2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-.75 1.75a.5.5 0 0 1 .5-.5h2.5a.5.5 0 0 1 .5.5v2.5a.5.5 0 0 1-.5.5h-2.5a.5.5 0 0 1-.5-.5z"></svg:path>`,
})
export class FluentQrCode20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQrCode20RegularIcon],svg[fluent-qr-code-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 15h2v2h-2zm4 0h2v2h-2zm-4-4h2v2h-2zm2 2h2v2h-2zm2-2h2v2h-2zM3 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1zm0 1h2v2H5zm-2 8a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1zm0 1h2v2H5zm6-8a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1zm0 1h2v2h-2z"></svg:path>`,
})
export class FluentQrCode20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQrCode24FilledIcon],svg[fluent-qr-code-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 6H6v2h2zm-5-.5A2.5 2.5 0 0 1 5.5 3h3A2.5 2.5 0 0 1 11 5.5v3A2.5 2.5 0 0 1 8.5 11h-3A2.5 2.5 0 0 1 3 8.5zM5.5 5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zM6 16h2v2H6zm-3-.5A2.5 2.5 0 0 1 5.5 13h3a2.5 2.5 0 0 1 2.5 2.5v3A2.5 2.5 0 0 1 8.5 21h-3A2.5 2.5 0 0 1 3 18.5zm2.5-.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zM18 6h-2v2h2zm-2.5-3A2.5 2.5 0 0 0 13 5.5v3a2.5 2.5 0 0 0 2.5 2.5h3A2.5 2.5 0 0 0 21 8.5v-3A2.5 2.5 0 0 0 18.5 3zM15 5.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zM13 13h2.75v2.75H13zm5.25 2.75h-2.5v2.5H13V21h2.75v-2.75h2.5V21H21v-2.75h-2.75zm0 0V13H21v2.75z"></svg:path>`,
})
export class FluentQrCode24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQrCode24RegularIcon],svg[fluent-qr-code-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQrCode28RegularIcon],svg[fluent-qr-code-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion16FilledIcon],svg[fluent-question-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion16RegularIcon],svg[fluent-question-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentQuestion16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion20FilledIcon],svg[fluent-question-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion24FilledIcon],svg[fluent-question-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 4a5 5 0 0 0-5 5a1 1 0 0 0 2 0c0-1.658 1.342-3 3-3s3 1.342 3 3c0 .816-.199 1.294-.438 1.629c-.262.365-.625.638-1.128.985l-.116.078c-.447.306-1.023.699-1.469 1.247c-.527.648-.849 1.467-.849 2.561v.5a1 1 0 1 0 2 0v-.5c0-.656.178-1.024.4-1.299c.257-.314.603-.552 1.114-.903l.053-.037c.496-.34 1.133-.786 1.62-1.468C16.7 11.081 17 10.183 17 9a5 5 0 0 0-5-5m0 17.25a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5"></svg:path>`,
})
export class FluentQuestion24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion24RegularIcon],svg[fluent-question-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion28FilledIcon],svg[fluent-question-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 4c-3.312 0-6 2.688-6 6a1 1 0 1 0 2 0c0-2.208 1.792-4 4-4s4 1.792 4 4c0 1.063-.26 1.742-.612 2.267c-.36.537-.835.953-1.442 1.483l-.104.091c-.627.549-1.364 1.21-1.922 2.154c-.57.965-.92 2.16-.92 3.755V20a1 1 0 1 0 2 0v-.25c0-1.28.275-2.116.642-2.737c.38-.642.893-1.121 1.517-1.667l.143-.125c.566-.492 1.234-1.074 1.747-1.84c.585-.873.951-1.944.951-3.381c0-3.312-2.688-6-6-6m0 21.25a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5"></svg:path>`,
})
export class FluentQuestion28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion28RegularIcon],svg[fluent-question-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 4a6 6 0 0 0-6 6a.75.75 0 0 0 1.5 0a4.5 4.5 0 1 1 9 0c0 1.383-.3 2.233-.697 2.839c-.412.627-.964 1.055-1.633 1.564l-.033.026c-.637.485-1.38 1.052-1.944 1.91c-.587.894-.943 2.044-.943 3.661v.25a.75.75 0 0 0 1.5 0V20c0-1.383.3-2.233.697-2.838c.412-.628.964-1.056 1.633-1.565l.033-.026c.637-.485 1.38-1.052 1.944-1.91c.587-.894.943-2.044.943-3.661a6 6 0 0 0-6-6m0 21a1 1 0 1 0 0-2a1 1 0 0 0 0 2"></svg:path>`,
})
export class FluentQuestion28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion32FilledIcon],svg[fluent-question-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.499 10.803A4.505 4.505 0 0 1 16 6.5a4.5 4.5 0 0 1 4.5 4.5c0 1.276-.298 2.02-.676 2.565c-.368.53-.836.925-1.471 1.459l-.286.241c-.745.632-1.614 1.42-2.268 2.628c-.659 1.217-1.049 2.76-1.049 4.857a1.25 1.25 0 0 0 2.5 0c0-1.778.328-2.892.748-3.667c.424-.783.993-1.324 1.685-1.91l.259-.217c.616-.515 1.363-1.139 1.937-1.966C22.579 13.98 23 12.724 23 11a7 7 0 0 0-7-7a7.005 7.005 0 0 0-6.999 6.695a1.25 1.25 0 1 0 2.498.108M16 29a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3"></svg:path>`,
})
export class FluentQuestion32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion32RegularIcon],svg[fluent-question-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 11a5 5 0 0 1 10 0c0 1.456-.33 2.31-.757 2.92c-.414.592-.95 1.013-1.637 1.555l-.227.178c-.767.608-1.648 1.348-2.311 2.518C15.4 19.348 15 20.872 15 23a1 1 0 1 0 2 0c0-1.872.35-3.036.807-3.843c.462-.814 1.08-1.355 1.814-1.936l.23-.181c.66-.516 1.436-1.124 2.031-1.975c.699-1 1.118-2.27 1.118-4.065a7 7 0 1 0-14 0a1 1 0 1 0 2 0m5 17.75a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5"></svg:path>`,
})
export class FluentQuestion32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion48FilledIcon],svg[fluent-question-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestion48RegularIcon],svg[fluent-question-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 5.5c-5.52 0-10 4.48-10 10a1.25 1.25 0 1 0 2.5 0c0-4.14 3.36-7.5 7.5-7.5s7.5 3.36 7.5 7.5c0 1.875-.47 2.94-1.101 3.745c-.51.65-1.105 1.134-1.848 1.736c-.304.247-.632.514-.99.82c-1.17 1.003-2.408 2.267-3.33 4.29c-.916 2.004-1.481 4.662-1.481 8.409v.25a1.25 1.25 0 1 0 2.5 0v-.25c0-3.503.529-5.783 1.254-7.372c.718-1.57 1.667-2.557 2.685-3.429c.232-.2.485-.405.748-.618c.818-.663 1.732-1.404 2.43-2.294C33.377 19.497 34 17.875 34 15.5c0-5.52-4.48-10-10-10M24 42a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3"></svg:path>`,
})
export class FluentQuestion48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle12FilledIcon],svg[fluent-question-circle-12-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle12RegularIcon],svg[fluent-question-circle-12-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.267 4.212a.63.63 0 0 0-.267.54a.5.5 0 0 1-1 0c0-.588.272-1.046.67-1.342c.384-.286.87-.413 1.33-.413s.945.127 1.33.412c.398.296.67.754.67 1.342c0 .429-.135.755-.367 1.006c-.183.198-.418.333-.58.426l-.051.03c-.187.109-.296.184-.37.282c-.064.082-.132.22-.132.504a.5.5 0 0 1-1 0c0-.466.12-.828.338-1.113c.206-.269.472-.428.66-.537l.028-.016c.197-.115.298-.174.372-.255c.05-.053.102-.132.102-.327a.63.63 0 0 0-.267-.54C6.555 4.08 6.29 3.998 6 3.998s-.554.082-.733.215M6 9a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1M1 6a5 5 0 1 1 10 0A5 5 0 0 1 1 6m5-4a4 4 0 1 0 0 8a4 4 0 0 0 0-8"></svg:path>`,
})
export class FluentQuestionCircle12RegularIcon {
  readonly viewBox = input("0 0 12 12")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle16RegularIcon],svg[fluent-question-circle-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 2a6 6 0 1 1 0 12A6 6 0 0 1 8 2m0 1a5 5 0 1 0 0 10A5 5 0 0 0 8 3m0 7.5A.75.75 0 1 1 8 12a.75.75 0 0 1 0-1.5m0-6a2 2 0 0 1 2 2c0 .73-.212 1.14-.754 1.708l-.264.27C8.605 8.87 8.5 9.082 8.5 9.5a.5.5 0 0 1-1 0c0-.73.212-1.14.754-1.708l.264-.27C8.895 7.13 9 6.918 9 6.5a1 1 0 0 0-2 0a.5.5 0 0 1-1 0a2 2 0 0 1 2-2"></svg:path>`,
})
export class FluentQuestionCircle16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle24FilledIcon],svg[fluent-question-circle-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2c5.523 0 10 4.478 10 10s-4.477 10-10 10S2 17.522 2 12S6.477 2 12 2m0 13.5a1 1 0 1 0 0 2a1 1 0 0 0 0-2m0-8.75A2.75 2.75 0 0 0 9.25 9.5a.75.75 0 0 0 1.493.102l.007-.102a1.25 1.25 0 1 1 2.5 0c0 .539-.135.805-.645 1.332l-.135.138c-.878.878-1.22 1.447-1.22 2.53a.75.75 0 0 0 1.5 0c0-.539.135-.805.645-1.332l.135-.138c.878-.878 1.22-1.447 1.22-2.53A2.75 2.75 0 0 0 12 6.75"></svg:path>`,
})
export class FluentQuestionCircle24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle24RegularIcon],svg[fluent-question-circle-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2c5.523 0 10 4.478 10 10s-4.477 10-10 10S2 17.522 2 12S6.477 2 12 2m0 1.667c-4.595 0-8.333 3.738-8.333 8.333S7.405 20.333 12 20.333s8.333-3.738 8.333-8.333S16.595 3.667 12 3.667M12 15.5a1 1 0 1 1 0 2a1 1 0 0 1 0-2m0-8.75a2.75 2.75 0 0 1 2.75 2.75c0 1.01-.297 1.574-1.051 2.359l-.169.171c-.622.622-.78.886-.78 1.47a.75.75 0 0 1-1.5 0c0-1.01.297-1.574 1.051-2.359l.169-.171c.622-.622.78-.886.78-1.47a1.25 1.25 0 0 0-2.493-.128l-.007.128a.75.75 0 0 1-1.5 0A2.75 2.75 0 0 1 12 6.75"></svg:path>`,
})
export class FluentQuestionCircle24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle28RegularIcon],svg[fluent-question-circle-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle32FilledIcon],svg[fluent-question-circle-32-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16 2c7.732 0 14 6.268 14 14s-6.268 14-14 14S2 23.732 2 16S8.268 2 16 2m1.5 20a1.5 1.5 0 1 0-3 0a1.5 1.5 0 0 0 3 0M14 12c0-.537.18-1.041.497-1.398c.301-.339.774-.602 1.503-.602c1.308 0 2.382 1.348 2.03 2.758c-.18.722-.61 1.135-1.257 1.756l-.178.17C15.866 15.39 15 16.328 15 18a1 1 0 1 0 2 0c0-.827.353-1.267.985-1.877l.191-.182c.614-.58 1.466-1.385 1.794-2.699C20.618 10.653 18.692 8 16 8c-1.271 0-2.298.487-2.997 1.273C12.32 10.041 12 11.037 12 12a1 1 0 1 0 2 0"></svg:path>`,
})
export class FluentQuestionCircle32FilledIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle32RegularIcon],svg[fluent-question-circle-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle48FilledIcon],svg[fluent-question-circle-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 4c11.046 0 20 8.954 20 20s-8.954 20-20 20S4 35.046 4 24S12.954 4 24 4m.25 28a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3m0-19C20.886 13 18 15.885 18 19.25a1.25 1.25 0 0 0 2.475.252l.018-.124l.013-.32c.108-1.904 1.825-3.558 3.744-3.558c1.985 0 3.75 1.763 3.75 3.75c.001 1.187-.42 2.04-1.62 3.395l-.207.231l-1.027 1.098c-1.631 1.773-2.32 2.996-2.308 4.785a1.25 1.25 0 0 0 2.446.354l.03-.12l.018-.124l.006-.128l.003-.162c.036-.8.394-1.485 1.281-2.506l.185-.21l1.015-1.086c1.91-2.058 2.68-3.408 2.678-5.528c0-3.367-2.885-6.249-6.25-6.249"></svg:path>`,
})
export class FluentQuestionCircle48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuestionCircle48RegularIcon],svg[fluent-question-circle-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 4c11.046 0 20 8.954 20 20s-8.954 20-20 20S4 35.046 4 24S12.954 4 24 4m0 2.5C14.335 6.5 6.5 14.335 6.5 24S14.335 41.5 24 41.5S41.5 33.665 41.5 24S33.665 6.5 24 6.5m.25 25.5a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3m0-19c3.365 0 6.25 2.882 6.25 6.249c.002 2.12-.769 3.47-2.678 5.528l-1.015 1.087c-1.023 1.139-1.428 1.861-1.466 2.715l-.003.162l-.006.128l-.018.124a1.25 1.25 0 0 1-2.476-.234c-.013-1.789.677-3.012 2.308-4.785l1.027-1.098c1.358-1.492 1.828-2.373 1.827-3.626c0-1.987-1.765-3.75-3.75-3.75c-1.92 0-3.636 1.654-3.744 3.559l-.012.319A1.25 1.25 0 0 1 18 19.25c0-3.365 2.886-6.25 6.25-6.25"></svg:path>`,
})
export class FluentQuestionCircle48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew20FilledIcon],svg[fluent-quiz-new-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentQuizNew20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew20RegularIcon],svg[fluent-quiz-new-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentQuizNew20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew24FilledIcon],svg[fluent-quiz-new-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew24RegularIcon],svg[fluent-quiz-new-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew28FilledIcon],svg[fluent-quiz-new-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.484 11.002h-1.967l.984-2.327zM3 5.75A2.75 2.75 0 0 1 5.75 3h16.5A2.75 2.75 0 0 1 25 5.75v8.787A7.47 7.47 0 0 0 20.45 13a7.49 7.49 0 0 0-5.999 2.998H7.225a.75.75 0 0 0 0 1.5h6.35a7.5 7.5 0 0 0-.625 3.002c0 1.688.558 3.247 1.5 4.5h-8.7A2.75 2.75 0 0 1 3 22.25zm9.192.708a.75.75 0 0 0-1.381 0L8.059 12.96a.75.75 0 1 0 1.382.585l.441-1.043h3.236l.441 1.042a.75.75 0 0 0 1.382-.583zM6.475 20.75c0 .414.336.75.75.75h4.526a.75.75 0 0 0 0-1.5H7.225a.75.75 0 0 0-.75.75m12.025-14a.75.75 0 0 0-1.5 0V8h-1.248a.75.75 0 0 0 0 1.5H17v1.248a.75.75 0 0 0 1.5 0V9.5h1.25a.75.75 0 0 0 0-1.5H18.5zm8.45 13.75a6.5 6.5 0 1 1-13 0a6.5 6.5 0 0 1 13 0m-6-4a.5.5 0 0 0-1 0V20h-3.5a.5.5 0 0 0 0 1h3.5v3.5a.5.5 0 0 0 1 0V21h3.5a.5.5 0 0 0 0-1h-3.5z"></svg:path>`,
})
export class FluentQuizNew28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew28RegularIcon],svg[fluent-quiz-new-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew48FilledIcon],svg[fluent-quiz-new-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.644 19.018h3.71l-1.856-4.494zM11.25 6A5.25 5.25 0 0 0 6 11.25v25.5C6 39.65 8.35 42 11.25 42h13.269a12.94 12.94 0 0 1-2.044-7c0-1.584.283-3.101.802-4.504H11.25a1.25 1.25 0 1 1 0-2.5h13.272A12.99 12.99 0 0 1 35.475 22c2.378 0 4.607.639 6.525 1.754V11.25C42 8.35 39.65 6 36.75 6zM10 35.25c0-.69.56-1.25 1.25-1.25h8.008a1.25 1.25 0 0 1 0 2.5H11.25c-.69 0-1.25-.56-1.25-1.25m9.498-25.252c.506 0 .962.305 1.155.773l4.752 11.506a1.25 1.25 0 0 1-2.31.954l-.708-1.713h-5.775l-.707 1.713a1.25 1.25 0 1 1-2.31-.954l4.747-11.506a1.25 1.25 0 0 1 1.156-.773m12.25 0c.69 0 1.25.56 1.25 1.25V14h2.752a1.25 1.25 0 1 1 0 2.5h-2.752v2.748a1.25 1.25 0 0 1-2.5 0V16.5H27.75a1.25 1.25 0 1 1 0-2.5h2.748v-2.752c0-.69.56-1.25 1.25-1.25M46.475 35c0 6.075-4.925 11-11 11s-11-4.925-11-11s4.925-11 11-11s11 4.925 11 11m-10-7a1 1 0 1 0-2 0v6h-6a1 1 0 1 0 0 2h6v6a1 1 0 1 0 2 0v-6h6a1 1 0 1 0 0-2h-6z"></svg:path>`,
})
export class FluentQuizNew48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentQuizNew48RegularIcon],svg[fluent-quiz-new-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.25 6A5.25 5.25 0 0 0 6 11.25v25.5C6 39.65 8.35 42 11.25 42h13.269c-.5-.78-.918-1.618-1.244-2.5H11.25a2.75 2.75 0 0 1-2.75-2.75v-25.5a2.75 2.75 0 0 1 2.75-2.75h25.5a2.75 2.75 0 0 1 2.75 2.75v11.385c.878.286 1.715.662 2.5 1.119V11.25C42 8.35 39.65 6 36.75 6zm13.272 21.996c-.5.78-.92 1.617-1.245 2.5H11.25a1.25 1.25 0 1 1 0-2.5zm8.476-16.748a1.25 1.25 0 0 0-2.5 0V14H27.75a1.25 1.25 0 1 0 0 2.5h2.748v2.748a1.25 1.25 0 0 0 2.5 0V16.5h2.752a1.25 1.25 0 1 0 0-2.5h-2.752zm-12.345-.477a1.25 1.25 0 0 0-2.31 0l-4.748 11.507a1.25 1.25 0 1 0 2.31.953l.707-1.713h5.775l.708 1.714a1.25 1.25 0 1 0 2.31-.955zm.701 8.247h-3.71l1.854-4.494zM10 35.25c0-.69.56-1.25 1.25-1.25h8.008a1.25 1.25 0 0 1 0 2.5H11.25c-.69 0-1.25-.56-1.25-1.25M46.475 35c0 6.075-4.925 11-11 11s-11-4.925-11-11s4.925-11 11-11s11 4.925 11 11m-10-7a1 1 0 1 0-2 0v6h-6a1 1 0 1 0 0 2h6v6a1 1 0 1 0 2 0v-6h6a1 1 0 1 0 0-2h-6z"></svg:path>`,
})
export class FluentQuizNew48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadar20FilledIcon],svg[fluent-radar-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadar20RegularIcon],svg[fluent-radar-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m14.497 3.382l-.722.722A7 7 0 1 0 14.95 14.95a.5.5 0 0 1 .707.707a8 8 0 1 1-1.16-12.275m-2.935 2.935l.751-.751a5.002 5.002 0 0 0-5.849 7.97a5 5 0 0 0 7.072 0a.5.5 0 1 0-.708-.708a4 4 0 1 1-1.266-6.511m4.292-2.17a.5.5 0 0 1 0 .707L10.966 9.74a1.001 1.001 0 1 1-.707-.707l4.887-4.888a.5.5 0 0 1 .708 0M17 13.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0M16.5 7a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m1.5 4.25a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0m-.5-2a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m-2.5 2a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0m-.5-2a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"></svg:path>`,
})
export class FluentRadar20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadarCheckmark20FilledIcon],svg[fluent-radar-checkmark-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadarCheckmark20RegularIcon],svg[fluent-radar-checkmark-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadarRectangleMultiple20FilledIcon],svg[fluent-radar-rectangle-multiple-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.284 3.241L13.19 4.335A6.503 6.503 0 0 0 3.577 11H2.062a8.003 8.003 0 0 1 12.221-7.759M10 17v-.5a6.48 6.48 0 0 0 4.596-1.904a.75.75 0 0 1 1.06 1.06a7.98 7.98 0 0 1-5.826 2.342c.11-.312.17-.648.17-.998m0-2.5v.6c1.305 0 2.61-.498 3.606-1.494a.75.75 0 1 0-1.06-1.06a3.6 3.6 0 0 1-2.856 1.04c.194.254.31.57.31.914M6.5 11h.041a3.6 3.6 0 0 1 4.447-4.463l1.163-1.163A5.102 5.102 0 0 0 4.998 11zm9.28-6.78a.75.75 0 0 1 0 1.06l-4.33 4.331q.049.187.05.389a1.5 1.5 0 1 1-1.111-1.45l4.33-4.33a.75.75 0 0 1 1.061 0m1.47 9.03a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0M16.5 7.5a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5m1.5 3.75a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0m-.75-1.75a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5M15 11.25a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0m-.75-1.75a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5M1.5 12a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5zm7 2a.5.5 0 0 1 .5.5V17a2 2 0 0 1-2 2H3.5a.5.5 0 0 1 0-1H7a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 .5-.5"></svg:path>`,
})
export class FluentRadarRectangleMultiple20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadarRectangleMultiple20RegularIcon],svg[fluent-radar-rectangle-multiple-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadioButton20RegularIcon],svg[fluent-radio-button-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentRadioButton20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadioButtonOff16FilledIcon],svg[fluent-radio-button-off-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRadioButtonOff16RegularIcon],svg[fluent-radio-button-off-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m1.853 1.147l13 13a.5.5 0 0 1-.707.707l-2.272-2.272a6 6 0 0 1-8.456-8.456L1.146 1.854a.5.5 0 0 1 .707-.707M3 8a5 5 0 0 0 5 5h-.001a4.98 4.98 0 0 0 3.164-1.129L4.128 4.836A4.98 4.98 0 0 0 3 8m10 0a5 5 0 0 0-5-5l-.002-.002a4.94 4.94 0 0 0-2.295.583l-.747-.747A5.97 5.97 0 0 1 8 2a6 6 0 0 1 6 6c0 1.112-.308 2.15-.835 3.043l-.747-.747A4.94 4.94 0 0 0 13 8"></svg:path>`,
})
export class FluentRadioButtonOff16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRam16FilledIcon],svg[fluent-ram-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10 8h2V6h-2zM7 8h2V6H7zM4 8h2V6H4zm9-5H3c-1.103 0-2 .897-2 2v4a2 2 0 0 0 1 1.731v1.019c0 .689.561 1.25 1.25 1.25H6.5c.133 0 .26-.053.354-.146L8 11.708l1.146 1.146A.5.5 0 0 0 9.5 13h3.25c.689 0 1.25-.561 1.25-1.25v-1.019A2 2 0 0 0 15 9V5c0-1.103-.897-2-2-2m0 5.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5z"></svg:path>`,
})
export class FluentRam16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRam16RegularIcon],svg[fluent-ram-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRam20FilledIcon],svg[fluent-ram-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRam20RegularIcon],svg[fluent-ram-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRatingMature20RegularIcon],svg[fluent-rating-mature-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRatingMature24RegularIcon],svg[fluent-rating-mature-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRatioOneToOne20RegularIcon],svg[fluent-ratio-one-to-one-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRatioOneToOne24FilledIcon],svg[fluent-ratio-one-to-one-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.25 4A3.25 3.25 0 0 0 2 7.25v9.5A3.25 3.25 0 0 0 5.25 20h13.5A3.25 3.25 0 0 0 22 16.75v-9.5A3.25 3.25 0 0 0 18.75 4zM8.5 8.75v6.5a.75.75 0 0 1-1.5 0v-5.099l-.334.223a.75.75 0 1 1-.832-1.248l1.5-1A.75.75 0 0 1 8.5 8.75m9 0v6.5a.75.75 0 1 1-1.5 0v-5.099l-.334.223a.75.75 0 1 1-.832-1.248l1.5-1a.75.75 0 0 1 1.166.624M13 14a1 1 0 1 1-2 0a1 1 0 0 1 2 0m-1-3a1 1 0 1 1 0-2a1 1 0 0 1 0 2"></svg:path>`,
})
export class FluentRatioOneToOne24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRatioOneToOne24RegularIcon],svg[fluent-ratio-one-to-one-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.5 8.75a.75.75 0 0 0-1.166-.624l-1.5 1a.75.75 0 1 0 .832 1.248L7 10.151v5.099a.75.75 0 0 0 1.5 0zm9 0a.75.75 0 0 0-1.166-.624l-1.5 1a.75.75 0 1 0 .832 1.248l.334-.223v5.099a.75.75 0 1 0 1.5 0zM13 14a1 1 0 1 1-2 0a1 1 0 0 1 2 0m-1-3a1 1 0 1 0 0-2a1 1 0 0 0 0 2M5.25 4A3.25 3.25 0 0 0 2 7.25v9.5A3.25 3.25 0 0 0 5.25 20h13.5A3.25 3.25 0 0 0 22 16.75v-9.5A3.25 3.25 0 0 0 18.75 4zM3.5 7.25c0-.966.784-1.75 1.75-1.75h13.5c.966 0 1.75.784 1.75 1.75v9.5a1.75 1.75 0 0 1-1.75 1.75H5.25a1.75 1.75 0 0 1-1.75-1.75z"></svg:path>`,
})
export class FluentRatioOneToOne24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReOrder24RegularIcon],svg[fluent-re-order-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.75 13.25h18.5a.75.75 0 0 1 .102 1.493l-.102.007H2.75a.75.75 0 0 1-.102-1.493zh18.5zm0-4h18.5a.75.75 0 0 1 .102 1.493l-.102.007H2.75a.75.75 0 0 1-.102-1.493zh18.5z"></svg:path>`,
})
export class FluentReOrder24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReOrderVertical20RegularIcon],svg[fluent-re-order-vertical-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 17.5a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-1 0zm3 0a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-1 0z"></svg:path>`,
})
export class FluentReOrderVertical20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud16FilledIcon],svg[fluent-read-aloud-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud16RegularIcon],svg[fluent-read-aloud-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.032 1.325a.5.5 0 0 1 .644-.293l.003.001l.004.002l.013.005a2 2 0 0 1 .19.083c.123.059.294.147.498.27c.406.245.944.632 1.48 1.202C13.945 3.744 15 5.615 15 8.5a.5.5 0 0 1-1 0c0-2.614-.945-4.244-1.864-5.22a6 6 0 0 0-1.27-1.032a5 5 0 0 0-.539-.279h-.003l-.001-.001a.5.5 0 0 1-.291-.643m-3.068 1.99a.5.5 0 0 0-.928 0l-4 10a.5.5 0 1 0 .928.37L4.04 11h4.923l1.074 2.686a.5.5 0 1 0 .928-.372zM8.562 10H4.439L6.5 4.847zm1.662-6.447a.5.5 0 0 0-.45.893l.01.006l.048.027q.068.038.191.125c.164.115.383.293.603.54c.436.491.874 1.253.874 2.356a.5.5 0 0 0 1 0c0-1.396-.562-2.385-1.126-3.02a4.6 4.6 0 0 0-1.034-.863l-.08-.045l-.024-.012l-.007-.004l-.003-.002zs.158.09-.001-.001m-.45.893l.002.001Z"></svg:path>`,
})
export class FluentReadAloud16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud20FilledIcon],svg[fluent-read-aloud-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud20RegularIcon],svg[fluent-read-aloud-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud24FilledIcon],svg[fluent-read-aloud-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud24RegularIcon],svg[fluent-read-aloud-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud28FilledIcon],svg[fluent-read-aloud-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud28RegularIcon],svg[fluent-read-aloud-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadAloud32LightIcon],svg[fluent-read-aloud-32-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingList20FilledIcon],svg[fluent-reading-list-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingList20RegularIcon],svg[fluent-reading-list-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 6.25a1.25 1.25 0 0 1 2.29-.692a.5.5 0 1 0 .833-.555A2.25 2.25 0 1 0 4.25 8.5l.066-.004l.065.004H15.5a.5.5 0 0 0 0-1H4.381l-.065.004L4.25 7.5C3.56 7.5 3 6.94 3 6.25M8.5 5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1zm-3 5a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1zM2 13a.5.5 0 0 1 .5-.5h12a.5.5 0 0 1 0 1h-12A.5.5 0 0 1 2 13m3.5 2a.5.5 0 0 0 0 1h12.003a.5.5 0 1 0 0-1z"></svg:path>`,
})
export class FluentReadingList20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingList28FilledIcon],svg[fluent-reading-list-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 7.5a1.5 1.5 0 0 1 2.75-.83a1 1 0 0 0 1.663-1.11A3.5 3.5 0 1 0 5.483 11H21a1 1 0 1 0 0-2H5.5A1.5 1.5 0 0 1 4 7.5M12 5a1 1 0 1 0 0 2h13a1 1 0 1 0 0-2zm-5 8a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2zm-5 5a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1m5 3a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2z"></svg:path>`,
})
export class FluentReadingList28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd16FilledIcon],svg[fluent-reading-list-add-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd16RegularIcon],svg[fluent-reading-list-add-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.001 3.999a1.001 1.001 0 0 1 1.836-.555a.5.5 0 1 0 .832-.555A2 2 0 0 0 2 3.999A2 2 0 0 0 4.078 6h3.259a5.5 5.5 0 0 1 3.151-1h-6.41l-.038.001L4.003 5A1 1 0 0 1 3 3.999m.495 3.003h2.76a5.5 5.5 0 0 0-.657 1H3.496a.5.5 0 1 1 0-1M2.501 9h2.706a5.5 5.5 0 0 0-.185 1h-2.52a.5.5 0 0 1 0-1m.995 2h1.526q.048.516.185 1H3.496a.5.5 0 0 1 0-1M7.5 3a.5.5 0 0 0 0 1h6a.5.5 0 1 0 0-1zm7.5 7.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 1 0-1 0V10H8.5a.5.5 0 0 0 0 1H10v1.5a.5.5 0 0 0 1 0V11h1.5a.5.5 0 1 0 0-1H11z"></svg:path>`,
})
export class FluentReadingListAdd16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd20FilledIcon],svg[fluent-reading-list-add-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd20RegularIcon],svg[fluent-reading-list-add-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd24FilledIcon],svg[fluent-reading-list-add-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentReadingListAdd24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd28FilledIcon],svg[fluent-reading-list-add-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 7.5a1.5 1.5 0 0 1 2.75-.83a1 1 0 0 0 1.663-1.11A3.5 3.5 0 1 0 5.463 11H21a1 1 0 1 0 0-2H5.5A1.5 1.5 0 0 1 4 7.5M12 5a1 1 0 1 0 0 2h13a1 1 0 1 0 0-2zm-5 8a1 1 0 1 0 0 2h8.4a7.47 7.47 0 0 1 5.059-2zm-4 4h10.865a7.5 7.5 0 0 0-.715 2H3a1 1 0 1 1 0-2m4 4h6.016c.046.697.187 1.368.41 2H7a1 1 0 1 1 0-2m20-.5a6.5 6.5 0 1 1-13 0a6.5 6.5 0 0 1 13 0m-6-4a.5.5 0 0 0-1 0V20h-3.5a.5.5 0 0 0 0 1H20v3.5a.5.5 0 0 0 1 0V21h3.5a.5.5 0 0 0 0-1H21z"></svg:path>`,
})
export class FluentReadingListAdd28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingListAdd28RegularIcon],svg[fluent-reading-list-add-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingModeMobile20FilledIcon],svg[fluent-reading-mode-mobile-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 3.5A1.5 1.5 0 0 1 5.5 2h9A1.5 1.5 0 0 1 16 3.5v13a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 4 16.5zm2 3a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7a.5.5 0 0 0-.5.5M6.5 8a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1zM6 10.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentReadingModeMobile20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingModeMobile20RegularIcon],svg[fluent-reading-mode-mobile-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.5 6a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1zM6 8.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m.5 1.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zM4 3.5A1.5 1.5 0 0 1 5.5 2h9A1.5 1.5 0 0 1 16 3.5v13a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 4 16.5zM5.5 3a.5.5 0 0 0-.5.5v13a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-13a.5.5 0 0 0-.5-.5z"></svg:path>`,
})
export class FluentReadingModeMobile20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReadingModeMobile24RegularIcon],svg[fluent-reading-mode-mobile-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRealEstate20FilledIcon],svg[fluent-real-estate-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2 3a1 1 0 0 1 2 0h13a1 1 0 1 1 0 2H4v12.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5zm3 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v7a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 5 13.5zm3 7a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-2.55a1 1 0 0 0-.336-.748L11.332 8.13a.5.5 0 0 0-.664 0L8.336 10.2a1 1 0 0 0-.336.75z"></svg:path>`,
})
export class FluentRealEstate20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRealEstate20RegularIcon],svg[fluent-real-estate-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentRealEstate24FilledIcon],svg[fluent-real-estate-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2 21.5V3a1 1 0 0 1 2 0v.955h16.978a1.023 1.023 0 0 1 0 2.045H4v15.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5m3-14a.5.5 0 0 1 .5-.5h14a.5.5 0 0 1 .5.5v7.75A3.75 3.75 0 0 1 16.25 19h-7.5A3.75 3.75 0 0 1 5 15.25zm4.35 4.2a1 1 0 0 0-.35.76v3.04a.5.5 0 0 0 .5.5h1.75a.25.25 0 0 0 .25-.25V14.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1.25c0 .138.112.25.25.25h1.75a.5.5 0 0 0 .5-.5v-3.04a1 1 0 0 0-.35-.76l-2.825-2.42a.5.5 0 0 0-.65 0z"></svg:path>`,
})
export class FluentRealEstate24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRealEstate24RegularIcon],svg[fluent-real-estate-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.5 4.25V20.5H5v-14h14.728a.773.773 0 0 0 0-1.545H5v-.75a.705.705 0 0 0-.705-.705H4.25a.75.75 0 0 0-.75.75M22 5.728a2.27 2.27 0 0 1-1 1.883v7.639A3.75 3.75 0 0 1 17.25 19h-8.5a3.73 3.73 0 0 1-2.25-.75v2.5c0 .69-.56 1.25-1.25 1.25h-2C2.56 22 2 21.44 2 20.75V4.25A2.25 2.25 0 0 1 4.25 2h.045c.954 0 1.767.606 2.074 1.455h13.359A2.27 2.27 0 0 1 22 5.728M6.5 8v7.25a2.25 2.25 0 0 0 2.25 2.25h8.5a2.25 2.25 0 0 0 2.25-2.25V8zm3 4.46a1 1 0 0 1 .35-.76l2.825-2.42a.5.5 0 0 1 .65 0l2.826 2.42a1 1 0 0 1 .349.76v3.04a.5.5 0 0 1-.5.5h-1.75a.25.25 0 0 1-.25-.25V14.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.25a.25.25 0 0 1-.25.25H10a.5.5 0 0 1-.5-.5z"></svg:path>`,
})
export class FluentRealEstate24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt16FilledIcon],svg[fluent-receipt-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2 3.75C2 2.784 2.784 2 3.75 2h5.5c.966 0 1.75.784 1.75 1.75V10h3v1.5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 11.5zM11 13h.5a1.5 1.5 0 0 0 1.5-1.5V11h-2zM4.5 5.5A.5.5 0 0 0 5 6h3a.5.5 0 0 0 0-1H5a.5.5 0 0 0-.5.5m.5 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1zm-.5 3a.5.5 0 0 0 .5.5h1.5a.5.5 0 0 0 0-1H5a.5.5 0 0 0-.5.5"></svg:path>`,
})
export class FluentReceipt16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt16RegularIcon],svg[fluent-receipt-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.75 2A1.75 1.75 0 0 0 2 3.75v7.75A2.5 2.5 0 0 0 4.5 14h7a2.5 2.5 0 0 0 2.5-2.5V10h-3V3.75A1.75 1.75 0 0 0 9.25 2zM11 11h2v.5a1.5 1.5 0 0 1-1.5 1.5H11zM3 3.75A.75.75 0 0 1 3.75 3h5.5a.75.75 0 0 1 .75.75V13H4.5A1.5 1.5 0 0 1 3 11.5zM4.5 5.5A.5.5 0 0 1 5 5h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5m0 2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5m.5 2a.5.5 0 0 0 0 1h1.5a.5.5 0 0 0 0-1z"></svg:path>`,
})
export class FluentReceipt16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt20FilledIcon],svg[fluent-receipt-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3zm11 11a2 2 0 0 0 2-2v-1h-2zM6.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"></svg:path>`,
})
export class FluentReceipt20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt20RegularIcon],svg[fluent-receipt-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3zm11 8v3a2 2 0 0 0 2-2v-1zm-1 3V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v9a2 2 0 0 0 2 2zM6 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m0 3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m0 3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5"></svg:path>`,
})
export class FluentReceipt20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt28FilledIcon],svg[fluent-receipt-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5.75A2.75 2.75 0 0 1 5.75 3h11.5A2.75 2.75 0 0 1 20 5.75V17h5v4.25A3.75 3.75 0 0 1 21.25 25H6.75A3.75 3.75 0 0 1 3 21.25zM20 23.5h1.25a2.25 2.25 0 0 0 2.25-2.25V18.5H20zM7 8.75c0 .414.336.75.75.75h7.5a.75.75 0 0 0 0-1.5h-7.5a.75.75 0 0 0-.75.75M7.75 13a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5zM7 18.75c0 .414.336.75.75.75h3.5a.75.75 0 0 0 0-1.5h-3.5a.75.75 0 0 0-.75.75"></svg:path>`,
})
export class FluentReceipt28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt28RegularIcon],svg[fluent-receipt-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 5.75A2.75 2.75 0 0 1 5.75 3h11.5A2.75 2.75 0 0 1 20 5.75V17h5v4.25A3.75 3.75 0 0 1 21.25 25H6.75A3.75 3.75 0 0 1 3 21.25zM20 23.5h1.25a2.25 2.25 0 0 0 2.25-2.25V18.5H20zM5.75 4.5c-.69 0-1.25.56-1.25 1.25v15.5a2.25 2.25 0 0 0 2.25 2.25H18.5V5.75c0-.69-.56-1.25-1.25-1.25zm2 3.5a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5zM7 13.75a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1-.75-.75M7.75 18a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5z"></svg:path>`,
})
export class FluentReceipt28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt32RegularIcon],svg[fluent-receipt-32-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 6.25A3.25 3.25 0 0 1 6.25 3h13.5A3.25 3.25 0 0 1 23 6.25V19h6v5.5a4.5 4.5 0 0 1-4.5 4.5h-17A4.5 4.5 0 0 1 3 24.5zM23 27h1.5a2.5 2.5 0 0 0 2.5-2.5V21h-4zM6.25 5C5.56 5 5 5.56 5 6.25V24.5A2.5 2.5 0 0 0 7.5 27H21V6.25C21 5.56 20.44 5 19.75 5zM9 9a1 1 0 0 0 0 2h8a1 1 0 1 0 0-2zm-1 7a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1m1 5a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2z"></svg:path>`,
})
export class FluentReceipt32RegularIcon {
  readonly viewBox = input("0 0 32 32")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt48FilledIcon],svg[fluent-receipt-48-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.25 6A4.25 4.25 0 0 0 6 10.25v25.5A6.25 6.25 0 0 0 12.25 42h23.5A6.25 6.25 0 0 0 42 35.75V28h-8V10.25A4.25 4.25 0 0 0 29.75 6zM34 30.5h5.5v5.25a3.75 3.75 0 0 1-3.75 3.75H34zM13 15.25c0-.69.56-1.25 1.25-1.25h11.5a1.25 1.25 0 1 1 0 2.5h-11.5c-.69 0-1.25-.56-1.25-1.25M14.25 23h11.5a1.25 1.25 0 1 1 0 2.5h-11.5a1.25 1.25 0 1 1 0-2.5M13 33.25c0-.69.56-1.25 1.25-1.25h5.5a1.25 1.25 0 1 1 0 2.5h-5.5c-.69 0-1.25-.56-1.25-1.25"></svg:path>`,
})
export class FluentReceipt48FilledIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceipt48RegularIcon],svg[fluent-receipt-48-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 10.25A4.25 4.25 0 0 1 10.25 6h19.5A4.25 4.25 0 0 1 34 10.25V28h8v7.75A6.25 6.25 0 0 1 35.75 42h-23.5A6.25 6.25 0 0 1 6 35.75zM34 39.5h1.75a3.75 3.75 0 0 0 3.75-3.75V30.5H34zm-2.5-29.25a1.75 1.75 0 0 0-1.75-1.75h-19.5a1.75 1.75 0 0 0-1.75 1.75v25.5a3.75 3.75 0 0 0 3.75 3.75H31.5zM14.25 14a1.25 1.25 0 1 0 0 2.5h11.5a1.25 1.25 0 1 0 0-2.5zM13 24.25c0-.69.56-1.25 1.25-1.25h11.5a1.25 1.25 0 1 1 0 2.5h-11.5c-.69 0-1.25-.56-1.25-1.25M14.25 32a1.25 1.25 0 1 0 0 2.5h5.5a1.25 1.25 0 1 0 0-2.5z"></svg:path>`,
})
export class FluentReceipt48RegularIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptAdd20FilledIcon],svg[fluent-receipt-add-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-4.6c.384-.75.6-1.6.6-2.5c0-1.86-.923-3.505-2.337-4.5H11.5a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.42.23A5.5 5.5 0 0 0 5.5 9a5.5 5.5 0 0 0-1.5.207zm11 11a2 2 0 0 0 2-2v-1h-2zM7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2.5 8.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 0 0-1 0V14H3.5a.5.5 0 0 0 0 1H5v1.5a.5.5 0 0 0 1 0V15h1.5a.5.5 0 0 0 0-1H6z"></svg:path>`,
})
export class FluentReceiptAdd20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptAdd20RegularIcon],svg[fluent-receipt-add-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-4.6q.244-.476.393-1H14V5a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v4.022a5.5 5.5 0 0 0-1 .185zm7.5 5H8.663a5.5 5.5 0 0 0-1.584-.77A.5.5 0 0 1 7.5 9h4a.5.5 0 0 1 0 1m3.5 6a2 2 0 0 0 2-2v-1h-2zM7 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m3 8a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 0 0-1 0V14H3.5a.5.5 0 0 0 0 1H5v1.5a.5.5 0 0 0 1 0V15h1.5a.5.5 0 0 0 0-1H6z"></svg:path>`,
})
export class FluentReceiptAdd20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptAdd24FilledIcon],svg[fluent-receipt-add-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptBag20FilledIcon],svg[fluent-receipt-bag-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-5v-4.5a1.5 1.5 0 0 0-1-1.415V11c0-.35-.06-.687-.17-1h2.67a.5.5 0 0 0 0-1H8.236A2.99 2.99 0 0 0 5 8.171A3 3 0 0 0 4 8zm11 11a2 2 0 0 0 2-2v-1h-2zM7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zM4 9c.364 0 .706.097 1 .268A2 2 0 0 1 8 11v1h.5a.5.5 0 0 1 .5.5V17a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-4.5a.5.5 0 0 1 .5-.5H2v-1a2 2 0 0 1 2-2m1 3v-1a1 1 0 1 0-2 0v1zm.75-1.969c.16.287.25.618.25.969v1h1v-1a1 1 0 0 0-1.25-.969"></svg:path>`,
})
export class FluentReceiptBag20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptBag20RegularIcon],svg[fluent-receipt-bag-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-5v-1h4V5a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v3.171A3 3 0 0 0 4 8zm7.5 5H8.83a3 3 0 0 0-.594-1H11.5a.5.5 0 0 1 0 1m3.5 3v3a2 2 0 0 0 2-2v-1zM7 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5M4 9c.364 0 .706.097 1 .268A2 2 0 0 1 8 11v1h.5a.5.5 0 0 1 .5.5V17a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-4.5a.5.5 0 0 1 .5-.5H2v-1a2 2 0 0 1 2-2m1 3v-1a1 1 0 1 0-2 0v1zm.75-1.969c.16.287.25.618.25.969v1h1v-1a1 1 0 0 0-1.25-.969"></svg:path>`,
})
export class FluentReceiptBag20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptBag24FilledIcon],svg[fluent-receipt-bag-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-7.26q.01-.123.01-.25v-6c0-.698-.409-1.3-1-1.582V13q0-.255-.035-.5h3.285a.75.75 0 0 0 0-1.5H9.873A3.496 3.496 0 0 0 5.75 9.73A3.5 3.5 0 0 0 4 9.535zM18 19.5h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM7.5 7.75c0 .414.336.75.75.75h5.5a.75.75 0 0 0 0-1.5h-5.5a.75.75 0 0 0-.75.75m-6.5 7a.75.75 0 0 1 .75-.75H2v-1a2.5 2.5 0 0 1 3.75-2.165A2.5 2.5 0 0 1 9.5 13v1h.25a.75.75 0 0 1 .75.75v6A2.25 2.25 0 0 1 8.25 23h-5A2.25 2.25 0 0 1 1 20.75zM7 13v1h1v-1a1 1 0 0 0-1.2-.98c.129.3.2.632.2.98m-1.5 1v-1a1 1 0 0 0-2 0v1z"></svg:path>`,
})
export class FluentReceiptBag24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptBag24RegularIcon],svg[fluent-receipt-bag-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptCube20FilledIcon],svg[fluent-receipt-cube-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3H9.938a2 2 0 0 0 .062-.496V12.5a2 2 0 0 0-1.106-1.789L7.47 10h4.03a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.382.823l-1.224-.612a2 2 0 0 0-1.788 0L4 9.264zm11 11a2 2 0 0 0 2-2v-1h-2zM7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm.947 5.606l-3-1.5a1 1 0 0 0-.894 0l-3 1.5A1 1 0 0 0 1 12.5v4.004a1 1 0 0 0 .553.894l3 1.5a1 1 0 0 0 .894 0l3-1.5A1 1 0 0 0 9 16.504V12.5a1 1 0 0 0-.553-.894M2.04 12.732a.5.5 0 0 1 .657-.263L5 13.456l2.303-.987a.5.5 0 0 1 .394.92l-2.197.94V17a.5.5 0 1 1-1 0v-2.67l-2.197-.942a.5.5 0 0 1-.263-.656"></svg:path>`,
})
export class FluentReceiptCube20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptCube20RegularIcon],svg[fluent-receipt-cube-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3H9.938a2 2 0 0 0 .062-.496V16h4V5a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v4a2 2 0 0 0-.894.211L4 9.264zm3.5 5h-.03l-.352-.177A.5.5 0 0 1 7.5 9h4a.5.5 0 0 1 0 1zm7.5 3v3a2 2 0 0 0 2-2v-1zM7 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m1.447 5.106l-3-1.5a1 1 0 0 0-.894 0l-3 1.5A1 1 0 0 0 1 12.5v4.004a1 1 0 0 0 .553.894l3 1.5a1 1 0 0 0 .894 0l3-1.5A1 1 0 0 0 9 16.504V12.5a1 1 0 0 0-.553-.894M2.04 12.732a.5.5 0 0 1 .657-.263L5 13.456l2.303-.987a.5.5 0 0 1 .394.92l-2.197.94V17a.5.5 0 1 1-1 0v-2.67l-2.197-.942a.5.5 0 0 1-.263-.656"></svg:path>`,
})
export class FluentReceiptCube20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptCube24FilledIcon],svg[fluent-receipt-cube-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptCube24RegularIcon],svg[fluent-receipt-cube-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-7.083c.214-.372.333-.8.333-1.247V19.5h4.5V5.25a.75.75 0 0 0-.75-.75h-9.5a.75.75 0 0 0-.75.75v5.8q-.32.066-.618.214l-.882.44zm9.75 7.25H9.59l-2.04-1.02a.75.75 0 0 1 .7-.48h5.5a.75.75 0 0 1 0 1.5m4.25 7h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM8.25 7a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5zm1.92 6.908l-3.5-1.75a1.5 1.5 0 0 0-1.34 0l-3.5 1.75A1.5 1.5 0 0 0 1 15.25v4.503a1.5 1.5 0 0 0 .83 1.342l3.5 1.75a1.5 1.5 0 0 0 1.34 0l3.5-1.75a1.5 1.5 0 0 0 .83-1.342V15.25a1.5 1.5 0 0 0-.83-1.342m-7.617 1.368a.5.5 0 0 1 .67-.223L6 16.44l2.776-1.388a.5.5 0 1 1 .448.894L6.5 17.31v3.19a.5.5 0 1 1-1 0v-3.19l-2.724-1.363a.5.5 0 0 1-.223-.67"></svg:path>`,
})
export class FluentReceiptCube24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney16FilledIcon],svg[fluent-receipt-money-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3 3.75C3 2.784 3.784 2 4.75 2h5.5c.966 0 1.75.784 1.75 1.75V10h3v1.5a2.5 2.5 0 0 1-2.5 2.5h-1.55q.05-.243.05-.5v-3a2.5 2.5 0 0 0-1.538-2.308A.5.5 0 0 0 9 7.5H6a.5.5 0 0 0-.5.5H3zM12 13h.5a1.5 1.5 0 0 0 1.5-1.5V11h-2zM5.5 5.5A.5.5 0 0 0 6 6h3a.5.5 0 0 0 0-1H6a.5.5 0 0 0-.5.5m4.5 5A1.5 1.5 0 0 0 8.5 9h-6A1.5 1.5 0 0 0 1 10.5v3A1.5 1.5 0 0 0 2.5 15h6a1.5 1.5 0 0 0 1.5-1.5zm-1 2v1a.5.5 0 0 0-.5.5h-1A1.5 1.5 0 0 1 9 12.5M8.5 10a.5.5 0 0 0 .5.5v1A1.5 1.5 0 0 1 7.5 10zm-6.5.5a.5.5 0 0 0 .5-.5h1A1.5 1.5 0 0 1 2 11.5zm.5 3.5a.5.5 0 0 0-.5-.5v-1A1.5 1.5 0 0 1 3.5 14zM4 12a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0"></svg:path>`,
})
export class FluentReceiptMoney16FilledIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney16RegularIcon],svg[fluent-receipt-money-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney20FilledIcon],svg[fluent-receipt-money-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney20RegularIcon],svg[fluent-receipt-money-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentReceiptMoney20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney24FilledIcon],svg[fluent-receipt-money-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-5.8q.05-.243.05-.5v-4a2.5 2.5 0 0 0-2.5-2.5H4zM18 19.5h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM7.5 7.75c0 .414.336.75.75.75h5.5a.75.75 0 0 0 0-1.5h-5.5a.75.75 0 0 0-.75.75M8.25 11a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5zM2.5 15A1.5 1.5 0 0 0 1 16.5v4A1.5 1.5 0 0 0 2.5 22h8a1.5 1.5 0 0 0 1.5-1.5v-4a1.5 1.5 0 0 0-1.5-1.5zm7.5 1a1 1 0 0 0 1 1v1a2 2 0 0 1-2-2zm-1 5a2 2 0 0 1 2-2v1a1 1 0 0 0-1 1zm-7-4a1 1 0 0 0 1-1h1a2 2 0 0 1-2 2zm0 2a2 2 0 0 1 2 2H3a1 1 0 0 0-1-1zm4.5-2.25a1.75 1.75 0 1 1 0 3.5a1.75 1.75 0 0 1 0-3.5"></svg:path>`,
})
export class FluentReceiptMoney24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptMoney24RegularIcon],svg[fluent-receipt-money-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-5.8q.05-.243.05-.5v-1h3.5V5.25a.75.75 0 0 0-.75-.75h-9.5a.75.75 0 0 0-.75.75V14H4zM18 19.5h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM8.25 7a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5zm-.75 4.75a.75.75 0 0 1 .75-.75h5.5a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1-.75-.75M2.5 15A1.5 1.5 0 0 0 1 16.5v4A1.5 1.5 0 0 0 2.5 22h8a1.5 1.5 0 0 0 1.5-1.5v-4a1.5 1.5 0 0 0-1.5-1.5zm7.5 1a1 1 0 0 0 1 1v1a2 2 0 0 1-2-2zm-1 5a2 2 0 0 1 2-2v1a1 1 0 0 0-1 1zm-7-4a1 1 0 0 0 1-1h1a2 2 0 0 1-2 2zm0 2a2 2 0 0 1 2 2H3a1 1 0 0 0-1-1zm4.5-2.25a1.75 1.75 0 1 1 0 3.5a1.75 1.75 0 0 1 0-3.5"></svg:path>`,
})
export class FluentReceiptMoney24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptPlay20FilledIcon],svg[fluent-receipt-play-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-4.6c.384-.75.6-1.6.6-2.5c0-1.86-.923-3.505-2.337-4.5H11.5a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.42.23A5.5 5.5 0 0 0 5.5 9a5.5 5.5 0 0 0-1.5.207zm11 11a2 2 0 0 0 2-2v-1h-2zM7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2.5 8.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-6 1.495a.5.5 0 0 0 .757.429l2.5-1.497a.5.5 0 0 0 0-.858l-2.5-1.497A.5.5 0 0 0 4 13z"></svg:path>`,
})
export class FluentReceiptPlay20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptPlay20RegularIcon],svg[fluent-receipt-play-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-4.6q.244-.476.393-1H14V5a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v4.022a5.5 5.5 0 0 0-1 .185zm7.5 5H8.663a5.5 5.5 0 0 0-1.584-.77A.5.5 0 0 1 7.5 9h4a.5.5 0 0 1 0 1m3.5 6a2 2 0 0 0 2-2v-1h-2zM7 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m3 8a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-6 1.495a.5.5 0 0 0 .757.429l2.5-1.497a.5.5 0 0 0 0-.858l-2.5-1.497A.5.5 0 0 0 4 13z"></svg:path>`,
})
export class FluentReceiptPlay20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptPlay24FilledIcon],svg[fluent-receipt-play-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-6.772A6.47 6.47 0 0 0 13 17.5c0-2.01-.913-3.808-2.346-5h3.096a.75.75 0 0 0 0-1.5h-5.5c-.16 0-.307.05-.429.134A6.53 6.53 0 0 0 4 11.498zM18 19.5h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM7.5 7.75c0 .414.336.75.75.75h5.5a.75.75 0 0 0 0-1.5h-5.5a.75.75 0 0 0-.75.75M12 17.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0m-7 1.999a.5.5 0 0 0 .777.416l3.002-1.999a.5.5 0 0 0 0-.832l-3.002-2a.5.5 0 0 0-.777.417z"></svg:path>`,
})
export class FluentReceiptPlay24FilledIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptPlay24RegularIcon],svg[fluent-receipt-play-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5.25A2.25 2.25 0 0 1 6.25 3h9.5A2.25 2.25 0 0 1 18 5.25V14h4v3.75A3.25 3.25 0 0 1 18.75 21h-6.772c.297-.463.536-.966.709-1.5H16.5V5.25a.75.75 0 0 0-.75-.75h-9.5a.75.75 0 0 0-.75.75v5.826a6.5 6.5 0 0 0-1.5.422zm9.75 7.25h-3.096a6.5 6.5 0 0 0-2.833-1.366A.75.75 0 0 1 8.25 11h5.5a.75.75 0 0 1 0 1.5m4.25 7h.75a1.75 1.75 0 0 0 1.75-1.75V15.5H18zM8.25 7a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5zM12 17.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0m-7 1.999a.5.5 0 0 0 .777.416l3.002-1.999a.5.5 0 0 0 0-.832l-3.002-2a.5.5 0 0 0-.777.417z"></svg:path>`,
})
export class FluentReceiptPlay24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSearch20FilledIcon],svg[fluent-receipt-search-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3h-3.879l-1.56-1.56A4.5 4.5 0 0 0 10 13.5A4.5 4.5 0 0 0 8.329 10H11.5a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.447.275A4.5 4.5 0 0 0 5.5 9c-.526 0-1.03.09-1.5.256zm11 11a2 2 0 0 0 2-2v-1h-2zM7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm-2 11c.786 0 1.512-.26 2.096-.697l2.55 2.55a.5.5 0 1 0 .708-.707l-2.55-2.55A3.5 3.5 0 1 0 5.5 17m0-1a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5"></svg:path>`,
})
export class FluentReceiptSearch20FilledIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSearch20RegularIcon],svg[fluent-receipt-search-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 3a2 2 0 0 0-2 2v4.256q.478-.17 1-.229V5a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1v11h-3.879l1 1H15a3 3 0 0 0 3-3v-2h-3V5a2 2 0 0 0-2-2zm2.329 7H11.5a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.447.275c.466.172.897.418 1.276.725M15 16v-3h2v1a2 2 0 0 1-2 2M7.5 6a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm-2 11c.786 0 1.512-.26 2.096-.697l2.55 2.55a.5.5 0 1 0 .708-.707l-2.55-2.55A3.5 3.5 0 1 0 5.5 17m0-1a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5"></svg:path>`,
})
export class FluentReceiptSearch20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles16FilledIcon],svg[fluent-receipt-sparkles-16-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles16RegularIcon],svg[fluent-receipt-sparkles-16-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m10.878.282l.348 1.071a2.2 2.2 0 0 0 1.398 1.397l1.072.348l.021.006a.423.423 0 0 1 0 .798l-1.071.348a2.2 2.2 0 0 0-1.399 1.397l-.348 1.07a.423.423 0 0 1-.798 0l-.348-1.07a2.2 2.2 0 0 0-1.399-1.403l-1.072-.348a.423.423 0 0 1 0-.798l1.072-.348a2.2 2.2 0 0 0 1.377-1.397l.348-1.07a.423.423 0 0 1 .799 0m4.905 7.931l-.765-.248a1.58 1.58 0 0 1-1-.999l-.248-.764a.302.302 0 0 0-.57 0l-.25.764a1.58 1.58 0 0 1-.983.999l-.765.248a.303.303 0 0 0 0 .57l.765.249a1.58 1.58 0 0 1 1 1.002l.248.764a.302.302 0 0 0 .57 0l.249-.764a1.58 1.58 0 0 1 .999-.999l.765-.248a.303.303 0 0 0 0-.57zM13.502 12a1.3 1.3 0 0 1-.55-.12A1.5 1.5 0 0 1 11.5 13H11v-2h1.227l-.212-.653a.5.5 0 0 0-.14-.22a.6.6 0 0 0-.187-.127H11v-.229l-.106-.035c-.27-.1-.49-.26-.65-.48s-.24-.481-.24-.752C10.004 7.056 10 12.252 10 13H4.5A1.5 1.5 0 0 1 3 11.5V3.75A.75.75 0 0 1 3.75 3h2.338q.064-.172.172-.325c.17-.24.41-.42.69-.521L7.43 2H3.75A1.75 1.75 0 0 0 2 3.75v7.75A2.5 2.5 0 0 0 4.5 14h7a2.5 2.5 0 0 0 2.462-2.066a1.5 1.5 0 0 1-.46.066m-5.47-6.801L7.43 5H5a.5.5 0 0 0 0 1h3a.5.5 0 0 0 .5-.5v-.013a1.3 1.3 0 0 0-.468-.288M4.5 8a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5m.5 2a.5.5 0 0 0 0 1h1.5a.5.5 0 0 0 0-1z"></svg:path>`,
})
export class FluentReceiptSparkles16RegularIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles20FilledIcon],svg[fluent-receipt-sparkles-20-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles20RegularIcon],svg[fluent-receipt-sparkles-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles24FilledIcon],svg[fluent-receipt-sparkles-24-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[fluentReceiptSparkles24RegularIcon],svg[fluent-receipt-sparkles-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class FluentReceiptSparkles24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReciept20RegularIcon],svg[fluent-reciept-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path d="M3 5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v7h3v2a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V5zm11 8v3a2 2 0 0 0 2-2v-1h-2zm-1 3V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v9a2 2 0 0 0 2 2h7z" fill="currentColor"></svg:path><svg:path d="M6 6.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z" fill="currentColor"></svg:path></svg:g>`,
})
export class FluentReciept20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentReciept24RegularIcon],svg[fluent-reciept-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path d="M4 6.25A2.25 2.25 0 0 1 6.25 4h8.5A2.25 2.25 0 0 1 17 6.25V14h3.5v3.25a3.25 3.25 0 0 1-3.25 3.25h-10A3.25 3.25 0 0 1 4 17.25v-11zm13 9.25V19h.25A1.75 1.75 0 0 0 19 17.25V15.5h-2zM15.5 19V6.25a.75.75 0 0 0-.75-.75h-8.5a.75.75 0 0 0-.75.75v11c0 .966.784 1.75 1.75 1.75h8.25z" fill="currentColor"></svg:path><svg:path d="M7 8.75A.75.75 0 0 1 7.75 8h5.5a.75.75 0 0 1 0 1.5h-5.5A.75.75 0 0 1 7 8.75zm0 3.5a.75.75 0 0 1 .75-.75h5.5a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1-.75-.75zm0 3.5a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75z" fill="currentColor"></svg:path></svg:g>`,
})
export class FluentReciept24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRecord20RegularIcon],svg[fluent-record-20-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10 14.5a4.5 4.5 0 1 0 0-9a4.5 4.5 0 0 0 0 9M10 2a8 8 0 1 0 0 16a8 8 0 0 0 0-16m-7 8a7 7 0 1 1 14 0a7 7 0 0 1-14 0"></svg:path>`,
})
export class FluentRecord20RegularIcon {
  readonly viewBox = input("0 0 20 20")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRecord24RegularIcon],svg[fluent-record-24-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 18a6 6 0 1 0 0-12a6 6 0 0 0 0 12m0-16C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2M3.5 12a8.5 8.5 0 1 1 17 0a8.5 8.5 0 0 1-17 0"></svg:path>`,
})
export class FluentRecord24RegularIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRecord28FilledIcon],svg[fluent-record-28-filled-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 2C7.373 2 2 7.373 2 14s5.373 12 12 12s12-5.373 12-12S20.627 2 14 2m0 19.5a7.5 7.5 0 1 1 0-15a7.5 7.5 0 0 1 0 15"></svg:path>`,
})
export class FluentRecord28FilledIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[fluentRecord28RegularIcon],svg[fluent-record-28-regular-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 21.5a7.5 7.5 0 1 0 0-15a7.5 7.5 0 0 0 0 15M14 2C7.373 2 2 7.373 2 14s5.373 12 12 12s12-5.373 12-12S20.627 2 14 2M3.5 14C3.5 8.201 8.201 3.5 14 3.5S24.5 8.201 24.5 14S19.799 24.5 14 24.5S3.5 19.799 3.5 14"></svg:path>`,
})
export class FluentRecord28RegularIcon {
  readonly viewBox = input("0 0 28 28")
  readonly width = input("1em")
  readonly height = input("1em")
}
