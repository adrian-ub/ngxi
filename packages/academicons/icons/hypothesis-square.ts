...
@Component({
  standalone: true,
  selector: 'svg[academiconsHypothesisSquareIcon],svg[academicons-hypothesis-square-icon]',
  host: {
    role: 'img',
