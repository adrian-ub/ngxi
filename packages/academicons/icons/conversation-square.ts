...
@Component({
  standalone: true,
  selector: 'svg[academiconsConversationSquareIcon],svg[academicons-conversation-square-icon]',
  host: {
    role: 'img',
