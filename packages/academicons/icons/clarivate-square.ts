...
@Component({
  standalone: true,
  selector: 'svg[academiconsClarivateSquareIcon],svg[academicons-clarivate-square-icon]',
  host: {
    role: 'img',
