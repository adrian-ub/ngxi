...
@Component({
  standalone: true,
  selector: 'svg[academiconsOpenAccessSquareIcon],svg[academicons-open-access-square-icon]',
  host: {
    role: 'img',
