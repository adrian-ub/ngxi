...
@Component({
  standalone: true,
  selector: 'svg[academiconsClosedAccessSquareIcon],svg[academicons-closed-access-square-icon]',
  host: {
    role: 'img',
