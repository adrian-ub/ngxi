...
@Component({
  standalone: true,
  selector: 'svg[academiconsPreregisteredDeSquareIcon],svg[academicons-preregistered-de-square-icon]',
  host: {
    role: 'img',
