...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAngularGuardIcon],svg[catppuccin-angular-guard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="m8 1l6.5 2l-1 9.5L8 15l-5.5-2.5l-1-9.5z"></svg:path><svg:path stroke="#cad3f5" d="m4.5 10.5l3.5-7l3.5 7m-5.796-2h4.635"></svg:path></svg:g>`,
})
export class CatppuccinAngularGuardIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAngularDirectiveIcon],svg[catppuccin-angular-directive-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#c6a0f6" d="m8 1l6.5 2l-1 9.5L8 15l-5.5-2.5l-1-9.5z"></svg:path><svg:path stroke="#cad3f5" d="m4.5 10.5l3.5-7l3.5 7m-5.796-2h4.635"></svg:path></svg:g>`,
})
export class CatppuccinAngularDirectiveIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAngularPipeIcon],svg[catppuccin-angular-pipe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#8bd5ca" d="m8 1l6.5 2l-1 9.5L8 15l-5.5-2.5l-1-9.5z"></svg:path><svg:path stroke="#cad3f5" d="m4.5 10.5l3.5-7l3.5 7m-5.796-2h4.635"></svg:path></svg:g>`,
})
export class CatppuccinAngularPipeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAdobePsIcon],svg[catppuccin-adobe-ps-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M14.5 4.389v7.222a2.89 2.89 0 0 1-2.889 2.889H4.39a2.89 2.89 0 0 1-2.89-2.889V4.39A2.89 2.89 0 0 1 4.389 1.5h7.222A2.89 2.89 0 0 1 14.5 4.389"></svg:path><svg:path d="M4.5 11V8m0 0V5h1.4a1.4 1.5 0 0 1 1.4 1.5v0A1.4 1.5 0 0 1 5.9 8Zm7-.75c-.214-.46-.653-.75-1.133-.75H10.1a1.05 1.125 0 0 0-1.05 1.125v0A1.05 1.125 0 0 0 10.1 8.75h.35a1.05 1.125 0 0 1 1.05 1.125v0A1.05 1.125 0 0 1 10.45 11h-.267a1.266 1.357 0 0 1-1.133-.75v0"></svg:path></svg:g>`,
})
export class CatppuccinAdobePsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAppleIcon],svg[catppuccin-apple-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAstroIcon],svg[catppuccin-astro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M10.561 1.61L13.5 10.5c-.995-.517-2.395-1.298-3.5-1.493L8 3.5L6 9.007c-1.11.194-2.5.974-3.5 1.493l3.163-8.891c.121-.398.182-.597.302-.745A1 1 0 0 1 6.36.57c.176-.07.384-.07.8-.07h1.902c.416 0 .625 0 .801.071a1 1 0 0 1 .396.293c.12.148.18.347.301.746"></svg:path><svg:path stroke="#c6a0f6" d="M10.411 11.266c-.43.365-1.292.613-2.283.613c-1.217 0-2.237-.374-2.508-.879a2.8 2.8 0 0 0-.119.831s-.063 1.038.666 1.76c0-.374.307-.679.686-.679c.648 0 .648.561.647 1.016v.04c0 .691.426 1.282 1.032 1.532a1.4 1.4 0 0 1-.141-.61c0-.658.39-.903.845-1.188c.36-.227.761-.479 1.038-.985a1.84 1.84 0 0 0 .137-1.451"></svg:path></svg:g>`,
})
export class CatppuccinAstroIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinAstroConfigIcon],svg[catppuccin-astro-config-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M8.591 8.591c-.466-.204-.932-.371-1.35-.445l-1.798-4.95l-1.797 4.95C2.649 8.32 1.398 9.022.5 9.488l2.843-7.992c.109-.357.163-.536.27-.669A.9.9 0 0 1 3.97.563C4.13.5 4.315.5 4.69.5h1.709c.374 0 .561 0 .72.064a.9.9 0 0 1 .355.263c.107.133.162.312.271.67L9.729 7.5"></svg:path><svg:path stroke="#c6a0f6" d="M6.561 11.145a5 5 0 0 1-1.003.1c-1.094 0-2.01-.336-2.254-.79c-.087.26-.106.558-.106.748c0 0-.058.933.598 1.582c0-.337.276-.61.616-.61c.583 0 .582.503.582.912v.037c0 .62.383 1.152.928 1.376a1.24 1.24 0 0 1-.127-.548c0-.592.35-.812.759-1.068"></svg:path><svg:path stroke="#8087a2" d="M11.5 13.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m1.752-4l1.75 3l-1.75 3h-3.5l-1.75-3l1.75-3z"></svg:path></svg:g>`,
})
export class CatppuccinAstroConfigIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinBabelIcon],svg[catppuccin-babel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M3.42 4.02c1.1-.68 2.32-1.53 3.63-1.95c1.16-.38 2.43-.73 3.62-.5c.6.13 1.27.41 1.57.93c.3.5.3 1.18.05 1.68c-.97 1.88-5.26 3.6-5.26 3.6m1.2-5.92L2.47 14.5s6.14-2.13 8.23-4.43c.44-.48.96-1.17.75-1.78c-.18-.53-.9-.75-1.45-.85c-1.56-.26-4.67.92-4.67.92"></svg:path>`,
})
export class CatppuccinBabelIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinBatchIcon],svg[catppuccin-batch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M2 15.5c-.7 0-1.5-.8-1.5-1.5V5c0-.7.8-1.5 1.5-1.5h9c.7 0 1.5.8 1.5 1.5v9c0 .7-.8 1.5-1.5 1.5z"></svg:path><svg:path d="m1.2 3.8l3.04-2.5S5.17.5 5.7.5h8.4c.66 0 1.4.73 1.4 1.4v7.73a2.7 2.7 0 0 1-.7 1.75l-2.68 3.51M3 8.5l3 2l-3 2"></svg:path></svg:g>`,
})
export class CatppuccinBatchIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinBenchmarkIcon],svg[catppuccin-benchmark-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="M14.562 13.625c.636-1.1.938-2.387.938-3.75a7.5 7.5 0 1 0-13.997 3.75m5.56 0l3.75-4.688"></svg:path>`,
})
export class CatppuccinBenchmarkIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinBowerIcon],svg[catppuccin-bower-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#91d7e3" d="M10.77 3.5c.13-.28.27-.53.45-.75c.67-.83 1.75-1.25 3.25-1.25c-.5 2.17-1 3.5-1.5 4s-1.33.83-2.5 1c-.03-.45-.05-.79-.05-1"></svg:path><svg:path stroke="#eed49f" d="M6.47 4.5a1 1 0 0 1-1 1a1 1 0 0 1-1-1a1 1 0 0 1 1-1a1 1 0 0 1 1 1m2 5.5c.67.17 1.17.08 1.5-.25q1.005.255 1.5-.75c.83-.17 1.17-.67 1-1.5"></svg:path><svg:path stroke="#a6da95" d="m8.47 6.5l7 1c.17 1-.08 2.17-.75 2.5c0 .67-.58 1-1.75 1c-.33.33-.67.5-1 .5s-.67-.17-1-.5c-.33.33-.67.58-1 .75s-.75.08-1.25-.25"></svg:path><svg:path stroke="#eed49f" d="m8.72 11.5l.75 2c.17.5 0 .83-.5 1c-.43.14-.75-.25-1.25-.25s-.56.65-.75.75c-.67.33-1.17.17-1.5-.5l-.5-1.5c-.33.33-.75.5-1.25.5c-.55 0-2.03-1.2-2.79-3.5"></svg:path><svg:path stroke="#ee99a0" d="M.93 10a9.5 9.5 0 0 1-.46-3c0-4.25 3.5-5.5 5.5-5.5c1.33 0 2.5.67 3.5 2l2.5 1l-3.5 2M.97 10c1.33.33 2.33.17 3-.5q3.495.495 4.5-3"></svg:path></svg:g>`,
})
export class CatppuccinBowerIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCIcon],svg[catppuccin-c-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M4.056 12.952a7.05 7.05 0 0 0 9.944 0l-1.79-1.783a4.513 4.513 0 0 1-6.364 0a4.47 4.47 0 0 1 0-6.338a4.513 4.513 0 0 1 6.364 0l.895-.891l.895-.892a7.05 7.05 0 0 0-9.944 0a6.98 6.98 0 0 0 0 9.904" clip-rule="evenodd"></svg:path>`,
})
export class CatppuccinCIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCHeaderIcon],svg[catppuccin-c-header-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M4.056 12.952a7.05 7.05 0 0 0 9.944 0l-1.79-1.783a4.513 4.513 0 0 1-6.364 0a4.47 4.47 0 0 1 0-6.338a4.513 4.513 0 0 1 6.364 0l.895-.891l.895-.892a7.05 7.05 0 0 0-9.944 0a6.98 6.98 0 0 0 0 9.904" clip-rule="evenodd"></svg:path>`,
})
export class CatppuccinCHeaderIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCaddyIcon],svg[catppuccin-caddy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="M7.5 11.5h3v-4h-5v2m4-2V6a1.5 1.5 0 0 0-3 0v1.5"></svg:path><svg:path stroke="#91d7e3" d="M14.05 5.76c.9 2.5.22 5.3-1.75 7.07A6.45 6.45 0 0 1 5.5 14m-2.78-2.2A6.52 6.52 0 0 1 4 2.85a6.45 6.45 0 0 1 8.65.64M14.5 4.5a1 1 0 0 1-1 1a1 1 0 0 1-1-1a1 1 0 0 1 1-1a1 1 0 0 1 1 1m-9 8.5A1.5 1.5 0 0 1 4 14.5A1.5 1.5 0 0 1 2.5 13A1.5 1.5 0 0 1 4 11.5A1.5 1.5 0 0 1 5.5 13m0-1.5l2-2m5-4l-1 1"></svg:path></svg:g>`,
})
export class CatppuccinCaddyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCapacitorIcon],svg[catppuccin-capacitor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="m14.36 9.2l-1.52 1.5c-.08.09-.14.15-.27.03c-1.5-1.52-6.4-6.4-7.32-7.31c-.09-.1-.08-.15 0-.24l1.62-1.6c.1-.1.16-.1.25 0L9.64 4.1c.07.07.13.16.25.17l2.68-2.69c.1-.1.17-.11.27 0l1.56 1.54c.14.13.13.2 0 .33l-2.52 2.5c-.17.17-.15.25.01.4l2.47 2.47c.16.15.15.23 0 .37zM3.44 5.28c-.11-.11-.18-.11-.29 0c-.5.52-1.02 1.03-1.53 1.53c-.15.14-.13.22 0 .35L4.1 9.64c.17.16.16.25 0 .41c-.84.82-1.66 1.66-2.5 2.49c-.12.12-.15.2 0 .33c.51.5 1.02 1.02 1.52 1.54c.12.12.19.12.3 0c.58-.59 2.4-2.4 2.75-2.71c1.36 1.37 2.27 2.27 2.7 2.72c.1.09.17.1.26 0l1.6-1.61c.1-.09.1-.15 0-.23L3.45 5.29Z"></svg:path>`,
})
export class CatppuccinCapacitorIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCertificateIcon],svg[catppuccin-certificate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#eed49f" d="M8 9a2 2 0 1 0 0-4a2 2 0 0 0 0 4"></svg:path><svg:path stroke="#ed8796" d="M9.86 2.5h.89c.97 0 1.75.78 1.75 1.75v.9m0 3.72v.88c0 .97-.78 1.75-1.75 1.75m-5.5 0c-.97 0-1.75-.78-1.75-1.75v-.88m0-3.73v-.89c0-.97.78-1.75 1.75-1.75h.89"></svg:path><svg:path stroke="#ed8796" d="m12.5 5.14l.63.62c.68.69.68 1.8 0 2.48l-.64.63M10.5 11.5V15L8 13l-2.5 2v-3.5m-2-2.64l-.63-.62a1.75 1.75 0 0 1 0-2.48l.63-.62M6.13 2.5l.63-.63c.69-.68 1.8-.68 2.48 0l.62.63"></svg:path></svg:g>`,
})
export class CatppuccinCertificateIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinChangelogIcon],svg[catppuccin-changelog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" d="M2.71 10.96a6.5 6.5 0 1 0-.69-3.53M2 8l1.5-1.5M2 8L.5 6.5m8 2v-4m0 4h3"></svg:path>`,
})
export class CatppuccinChangelogIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCobolIcon],svg[catppuccin-cobol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M6.74 2.24c.32-1.32 2.2-1.32 2.52 0a1.3 1.3 0 0 0 1.93.8c1.15-.7 2.48.62 1.77 1.77a1.3 1.3 0 0 0 .8 1.93c1.32.32 1.32 2.2 0 2.52a1.3 1.3 0 0 0-.8 1.93c.7 1.15-.62 2.48-1.77 1.77a1.3 1.3 0 0 0-1.93.8c-.32 1.32-2.2 1.32-2.52 0a1.3 1.3 0 0 0-1.93-.8c-1.15.7-2.48-.62-1.77-1.77a1.3 1.3 0 0 0-.8-1.93c-1.32-.32-1.32-2.2 0-2.52a1.3 1.3 0 0 0 .8-1.93c-.7-1.15.62-2.48 1.77-1.77a1.3 1.3 0 0 0 1.93-.8M10 6.5a2.5 2.5 0 1 0 0 3"></svg:path>`,
})
export class CatppuccinCobolIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCodeOfConductIcon],svg[catppuccin-code-of-conduct-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#f5bde6" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M13.42 8.93L8.01 14.5L2.59 8.93a3.85 3.85 0 0 1-.93-3.8A3.55 3.55 0 0 1 8 4.01a3.55 3.55 0 0 1 6.34 1.14c.4 1.34.05 2.8-.92 3.79"></svg:path><svg:path d="M8 4L5.72 6.53a.77.77 0 0 0 0 1.06l.4.4c.5.52 1.21.55 1.7.02l.74-.8a2.25 2.25 0 0 1 3.25 0l1.62 1.68m-5.05 2.25l1.44 1.5m.36-3.38l1.45 1.5"></svg:path></svg:g>`,
})
export class CatppuccinCodeOfConductIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCppHeaderIcon],svg[catppuccin-cpp-header-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M2.556 12.952a7.05 7.05 0 0 0 9.944 0l-1.79-1.783a4.513 4.513 0 0 1-6.364 0a4.47 4.47 0 0 1 0-6.338a4.513 4.513 0 0 1 6.364 0l.895-.891l.895-.892a7.05 7.05 0 0 0-9.944 0a6.98 6.98 0 0 0 0 9.904" clip-rule="evenodd"></svg:path><svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M7.5 6v4M5.514 8h3.999m3.973-2v4M11.5 8h4"></svg:path>`,
})
export class CatppuccinCppHeaderIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCsharpIcon],svg[catppuccin-csharp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" d="M6.666 1.01a1 1 0 0 1 .822 1.15L7.18 3.999h2.972l.36-2.165a1 1 0 0 1 1.971.328l-.303 1.837H14a.999.999 0 1 1 0 2h-2.153l-.666 4H13a.999.999 0 1 1 0 2h-2.153l-.36 2.166a1 1 0 0 1-1.971-.328l.306-1.834H5.847l-.36 2.165a1 1 0 0 1-1.971-.328L3.819 12H2a.999.999 0 1 1 0-2h2.153l.666-4H3a.999.999 0 1 1 0-2h2.153l.36-2.166a1 1 0 0 1 1.15-.822Zm.18 4.988l-.665 4h2.972l.666-4Z"></svg:path>`,
})
export class CatppuccinCsharpIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCssIcon],svg[catppuccin-css-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M4 1.5h8A2.5 2.5 0 0 1 14.5 4v8a2.5 2.5 0 0 1-2.5 2.5H4A2.5 2.5 0 0 1 1.5 12V4A2.5 2.5 0 0 1 4 1.5"></svg:path><svg:path stroke-width=".814" d="M10.24 11.53c0 .58.438 1.038.96 1.035l.453-.004c.522-.003.949-.451.949-1.033c0-.58-.427-1.065-.95-1.065h-.451c-.523 0-.95-.486-.95-1.066s.427-1.038.95-1.038h.452c.522 0 .951.458.951 1.039M6.8 11.529c0 .58.438 1.04.96 1.036l.465-.004c.523-.003.936-.451.936-1.031s-.409-1.066-.931-1.066h-.47c-.522 0-.949-.485-.949-1.066c0-.58.427-1.037.95-1.037h.451c.523 0 .964.457.964 1.037M3.407 11.53c0 .58.438 1.052.96 1.052h.452c.522 0 .95-.457.95-1.038m.01-2.131c0-.58-.437-1.038-.96-1.038h-.451c-.523 0-.96.468-.96 1.05v2.118"></svg:path></svg:g>`,
})
export class CatppuccinCssIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCssMapIcon],svg[catppuccin-css-map-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#ed8796" d="M.5 4.06c0 .77.24 1.52.7 2.13l2.24 3.96l.04.08h0c.13.17.32.27.52.27s.36-.09.48-.23h0l.03-.03l.08-.15l2.2-3.88c.46-.61.71-1.37.71-2.15A3.63 3.63 0 0 0 3.88.5C1.95.5.5 2.1.5 4.06"></svg:path><svg:path stroke="#ed8796" d="M5.5 4A1.5 1.5 0 0 1 4 5.5A1.5 1.5 0 0 1 2.5 4A1.5 1.5 0 0 1 4 2.5A1.5 1.5 0 0 1 5.5 4"></svg:path><svg:path stroke="#8aadf4" d="M10 3.5h5.5l-1.27 9.8L10 15l-4.23-1.7L5.6 12"></svg:path><svg:path stroke="#cad3f5" d="M9.46 5.5h3.08L12 11l-2 1l-2-1l-.05-.5m.55-2h3.62"></svg:path></svg:g>`,
})
export class CatppuccinCssMapIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinCucumberIcon],svg[catppuccin-cucumber-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinCucumberIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDartIcon],svg[catppuccin-dart-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M7 14.5h4.5v-3h3V7L9.17 1.64c-.28-.29-.8-.47-1.17-.29L3.5 3.5L1.35 8c-.18.37 0 .88.3 1.17z"></svg:path><svg:path d="M3.5 11V3.5H11m-7.5 0l8 8"></svg:path></svg:g>`,
})
export class CatppuccinDartIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDatabaseIcon],svg[catppuccin-database-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M8 6.5c3.59 0 6.5-1.4 6.5-2.68S11.59 1.5 8 1.5S1.5 2.54 1.5 3.82S4.41 6.5 8 6.5M14.5 8c0 .83-1.24 1.79-3.25 2.2s-4.49.41-6.5 0S1.5 8.83 1.5 8m13 4.18c0 .83-1.24 1.6-3.25 2c-2.01.42-4.49.42-6.5 0c-2.01-.4-3.25-1.17-3.25-2m0-8.3v8.3m13-8.3v8.3"></svg:path>`,
})
export class CatppuccinDatabaseIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDjangoIcon],svg[catppuccin-django-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#a6da95" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M12.5 6.5v4.37c0 1.64-.12 2.43-.5 3.1a2.8 2.8 0 0 1-1.5 1.53l-2-1c.94-.43 1.3-.7 1.6-1.28c.3-.59.4-1.27.4-3.06V6.5zm0-2h-2v-2h2zm-4 7.71c-1.14.2-1.97.29-2.88.29c-2.7 0-4.12-1.16-4.12-3.38c0-2.14 1.72-3.53 4.04-3.53c.36 0 .63.03.96.11V2.5h2z"></svg:path><svg:path d="M3.5 9.08c0 1.12.84 1.47 1.98 1.47c.24 0 .7-.01 1.02-.05v-3c-.26-.08-.73-.1-1-.1c-1.13 0-2 .53-2 1.68"></svg:path></svg:g>`,
})
export class CatppuccinDjangoIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDockerIcon],svg[catppuccin-docker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M.5 8.5H11l.75-.5a5.35 5.35 0 0 1 0-3.5c1 .6 1 1.88 1.74 2c.77-.09 1.23.01 2 .52c0 0-.97 1.77-2.5 1.98c-1.93 3.65-4.5 5.5-6.98 5.5C0 14.5.5 8.5.5 8.5m1 0v-2m0 0h8m-6 2v-4m0 0h4m-2-2h2m-2 6v-6m2 6v-6m2 6v-2"></svg:path>`,
})
export class CatppuccinDockerIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDockerComposeIcon],svg[catppuccin-docker-compose-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" d="M.5 8.5H11l.75-.5a5.35 5.35 0 0 1 0-3.5c1 .6 1 1.88 1.74 2c.77-.09 1.23.01 2 .52c0 0-.97 1.77-2.5 1.98c-1.93 3.65-4.5 5.5-6.98 5.5C0 14.5.5 8.5.5 8.5m1 0v-2m0 0h8m-6 2v-4m0 0h4m-2-2h2m-2 6v-6m2 6v-6m2 6v-2"></svg:path>`,
})
export class CatppuccinDockerComposeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDrawioIcon],svg[catppuccin-drawio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="M2.25 10.5h3.5c.41 0 .75.34.75.75v2.5c0 .41-.34.75-.75.75h-3.5a.75.75 0 0 1-.75-.75v-2.5c0-.41.34-.75.75-.75m8 0h3.5c.41 0 .75.34.75.75v2.5c0 .41-.34.75-.75.75h-3.5a.75.75 0 0 1-.75-.75v-2.5c0-.41.34-.75.75-.75m-4-9h3.5c.41 0 .75.34.75.75v2.5c0 .41-.34.75-.75.75h-3.5a.75.75 0 0 1-.75-.75v-2.5c0-.41.34-.75.75-.75M4 10.5l3.5-5m4.5 5l-3.5-5"></svg:path>`,
})
export class CatppuccinDrawioIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinDubSelectionsIcon],svg[catppuccin-dub-selections-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" fill-rule="evenodd" stroke-miterlimit="1.5"><svg:path stroke="#ee99a0" stroke-linecap="round" stroke-linejoin="round" d="m4.121 9.737l-.754.366a1.7 1.7 0 0 1-.717.162H.495V4.09h2.946c.83 0 1.501.667 1.501 1.49v2.519a2.335 2.335 0 0 0 2.344 2.326h.002a2.335 2.335 0 0 0 2.344-2.326V4.086h2.832c.827 0 1.498.665 1.498 1.486v.055c0 .79-.646 1.43-1.442 1.43h-1.642h1.46c.448 0 .854.181 1.148.473"></svg:path><svg:ellipse cx="7.259" cy="8.092" stroke="#ee99a0" stroke-linecap="round" stroke-linejoin="round" rx="1.122" ry="1.113"></svg:ellipse><svg:path stroke="#8087a2" d="M15 11.5c.27 0 .5.22.5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3c0-.28.22-.5.5-.5zm-4 0V10a1.5 1.5 0 0 1 3 0v1.5"></svg:path></svg:g>`,
})
export class CatppuccinDubSelectionsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinEditorconfigIcon],svg[catppuccin-editorconfig-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinEleventyIcon],svg[catppuccin-eleventy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M12.5 5.5L14 13m1.5-7.5L14 13s-.215 1-1 1s-.5-.5-.5-.5M8 5.5h2.5M9 2v9s0 1 1 1h.5M.5 3L2 2v10m2-9l1.5-1v10"></svg:path>`,
})
export class CatppuccinEleventyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinEnvrcIcon],svg[catppuccin-envrc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#eed49f" d="M4.5 7.5V11m0-6.5V3m0 4.5c2 0 2-3 0-3s-2 3 0 3m5-1V3m1.406 4.45a1.5 1.5 0 0 0-.281-.481C10.375 6.688 10 6.5 9.5 6.5C8.5 6.5 8 7.25 8 8c0 .188.031.375.094.55M3 .5h8A2.5 2.5 0 0 1 13.5 3v4m-7.425 6.5H3A2.5 2.5 0 0 1 .5 11V3A2.5 2.5 0 0 1 3 .5"></svg:path><svg:path stroke="#8087a2" d="M11.5 13.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m1.752-4l1.75 3l-1.75 3h-3.5l-1.75-3l1.75-3z"></svg:path></svg:g>`,
})
export class CatppuccinEnvrcIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinErlangIcon],svg[catppuccin-erlang-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M6.5 5.5c0-1.25 1-2 2-2s2 .75 2 2z"></svg:path><svg:path d="M13.5 13c.47-.57 1.12-1.24 1.5-2l-2.25-1.25c-.74 1.36-1.76 2.75-3.25 2.75c-2.1 0-3-2.3-3-5h8c.05-1.61-.31-3.45-1-4.5M3 13c-1.08-1.3-1.5-3-1.5-5S2.1 4.24 3 3"></svg:path></svg:g>`,
})
export class CatppuccinErlangIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinEslintIcon],svg[catppuccin-eslint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#c6a0f6" d="M11.71 1.5L15.42 8l-3.71 6.5H4.29L.58 8l3.71-6.5z"></svg:path><svg:path stroke="#b7bdf8" d="m8 4.07l3.5 1.97v3.92L8 11.93L4.5 9.96V6.04z"></svg:path></svg:g>`,
})
export class CatppuccinEslintIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFileIcon],svg[catppuccin-file-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M13.5 6.5v6a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h4.01m-.01 0l5 5h-4a1 1 0 0 1-1-1z"></svg:path>`,
})
export class CatppuccinFileIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAdminIcon],svg[catppuccin-folder-admin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M15.5 9.25v-.58L12 7.5L8.5 8.67v2.62c0 2.12 1.2 3.64 3.5 4.21m2.5-3a1 1 0 1 0 0-2a1 1 0 0 0 0 2m1 3a1 1 0 1 0-2 0"></svg:path></svg:g>`,
})
export class CatppuccinFolderAdminIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAndroidIcon],svg[catppuccin-folder-android-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderAndroidIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAnimationIcon],svg[catppuccin-folder-animation-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5bde6" d="m9.5 15l2-3l-2-3l-2 3zM14 9l1.5 3l-1.5 3m-2-6l1.5 3l-1.5 3"></svg:path></svg:g>`,
})
export class CatppuccinFolderAnimationIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderApiIcon],svg[catppuccin-folder-api-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M11.5 13.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m-3-4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m6 0a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m0 6a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m-6 0a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m4-4.5L14 9.5M12.5 13l1.5 1.5m-5 0l1.5-1.5M9 9.5l1.5 1.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderApiIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderApiOpenIcon],svg[catppuccin-folder-api-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M11.5 13.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m-3-4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m6 0a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m0 6a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m-6 0a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m4-4.5L14 9.5M12.5 13l1.5 1.5m-5 0l1.5-1.5M9 9.5l1.5 1.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderApiOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAssetsIcon],svg[catppuccin-folder-assets-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linejoin="round" d="M12.923 11.904H7.5L10.212 7Z"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linejoin="round" d="M11.662 9.641a2.569 2.596 0 1 1-1.308 2.263"></svg:path>`,
})
export class CatppuccinFolderAssetsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAudioIcon],svg[catppuccin-folder-audio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g stroke="#ee99a0"><svg:path d="M10.654 14.423A1.077 1.077 0 0 1 9.577 15.5A1.077 1.077 0 0 1 8.5 14.423a1.077 1.077 0 0 1 1.077-1.077a1.077 1.077 0 0 1 1.077 1.077m4.846-1.077a1.077 1.077 0 0 1-1.077 1.077a1.077 1.077 0 0 1-1.077-1.077a1.077 1.077 0 0 1 1.077-1.077a1.077 1.077 0 0 1 1.077 1.077"></svg:path><svg:path d="M10.654 14.423v-4.038c0-.291.237-.652.727-.808L14.773 8.5c.485 0 .727.474.727.808v4.081m-4.846-1.658l4.846-1.616"></svg:path></svg:g></svg:g>`,
})
export class CatppuccinFolderAudioIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAudioOpenIcon],svg[catppuccin-folder-audio-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderAudioOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAwsIcon],svg[catppuccin-folder-aws-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderAwsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAzureDevopsIcon],svg[catppuccin-folder-azure-devops-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#b7bdf8" stroke-linecap="round" stroke-linejoin="round" d="M7.5 12.253v-1.817l6-.936L10.44 8m-.253 7L8.5 13l6 .5v-3"></svg:path>`,
})
export class CatppuccinFolderAzureDevopsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAzureDevopsOpenIcon],svg[catppuccin-folder-azure-devops-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#b7bdf8" stroke-linecap="round" stroke-linejoin="round" d="M7.5 12.253v-1.817l6-.936L10.44 8m-.253 7L8.5 13l6 .5v-3"></svg:path>`,
})
export class CatppuccinFolderAzureDevopsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderAzurePipelinesOpenIcon],svg[catppuccin-folder-azure-pipelines-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#b7bdf8" d="M8.5 14v1.5H10m1-5l1.27-2h3.23v3.23l-2 1.77v2h-2L11 15l.75-.75l-2-2L9 13l-.5-.5v-2zm2.5 0"></svg:path></svg:g>`,
})
export class CatppuccinFolderAzurePipelinesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderBenchmarkOpenIcon],svg[catppuccin-folder-benchmark-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" d="M15 14.5c.339-.587.5-1.273.5-2a4 4 0 1 0-7.465 2m2.965 0l2-2.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderBenchmarkOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCaddyIcon],svg[catppuccin-folder-caddy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="M12.27 13.774h.947v-2.306H10.32v.484m2.318-.484v-.865c0-1.153-1.739-1.153-1.739 0v.865"></svg:path><svg:path stroke="#91d7e3" d="M15.274 10.465a3.75 3.75 0 0 1-1.014 4.076a3.75 3.75 0 0 1-3.94.674c-.557-.285-1.074-.55-1.61-1.268a3.746 3.746 0 0 1 .74-5.16a3.75 3.75 0 0 1 5.013.37c.31.396.679.793.81 1.308m-5.587 3.88l1.043-.976m4.219-3.585l-.66.537"></svg:path></svg:g>`,
})
export class CatppuccinFolderCaddyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCaddyOpenIcon],svg[catppuccin-folder-caddy-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="M12.27 13.774h.947v-2.306H10.32v.484m2.318-.484v-.865c0-1.153-1.739-1.153-1.739 0v.865"></svg:path><svg:path stroke="#91d7e3" d="M15.274 10.465a3.75 3.75 0 0 1-1.014 4.076a3.75 3.75 0 0 1-3.94.674c-.557-.285-1.074-.55-1.61-1.268a3.746 3.746 0 0 1 .74-5.16a3.75 3.75 0 0 1 5.013.37c.31.396.679.793.81 1.308m-5.587 3.88l1.043-.976m4.219-3.585l-.66.537"></svg:path></svg:g>`,
})
export class CatppuccinFolderCaddyOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCargoOpenIcon],svg[catppuccin-folder-cargo-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.8 7.9l.69-2.7c.11-.44.51-.76.97-.76h11a1.003 1.003 0 0 1 .97 1.24l-.32 1.3m-9.1 6.5h-4c-.83 0-1.5-.67-1.5-1.5v-8.5c0-.55.45-1 1-1h5c.55 0 1 .45 1 1v1"></svg:path><svg:path fill="none" stroke="#f5a97f" stroke-linejoin="round" stroke-width=".57" d="M8.285 11.432v2.291L12 15.715l3.715-1.992V9.142l-2.008-.857l-3.715 1.693v.568ZM12 9.142l2.008.856v4.582m-5.723-3.088L12 13.484l3.715-1.992m-5.723-1.394L12 11.193l3.715-1.992m-5.723 1.395v3.984M12 11.193v4.283"></svg:path>`,
})
export class CatppuccinFolderCargoOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCircleCiIcon],svg[catppuccin-folder-circle-ci-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderCircleCiIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCloudIcon],svg[catppuccin-folder-cloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M7.5 12.429c0-1.142.834-2.068 1.863-2.068c.157-.813.717-1.477 1.47-1.741a2.15 2.15 0 0 1 2.177.461c.596.55.865 1.388.708 2.2h.396c.766 0 1.386.72 1.386 1.61c0 .888-.62 1.608-1.386 1.608H9.363c-1.029-.002-1.863-.928-1.863-2.07"></svg:path></svg:g>`,
})
export class CatppuccinFolderCloudIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCloudOpenIcon],svg[catppuccin-folder-cloud-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M7.5 12.429c0-1.142.834-2.068 1.863-2.068c.157-.813.717-1.477 1.47-1.741a2.15 2.15 0 0 1 2.177.461c.596.55.865 1.388.708 2.2h.396c.766 0 1.386.72 1.386 1.61c0 .888-.62 1.608-1.386 1.608H9.363c-1.029-.002-1.863-.928-1.863-2.07"></svg:path></svg:g>`,
})
export class CatppuccinFolderCloudOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCommandOpenIcon],svg[catppuccin-folder-command-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderCommandOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderComponentsIcon],svg[catppuccin-folder-components-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderComponentsOpenIcon],svg[catppuccin-folder-components-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#a6da95" d="m9.485 9.516l3.968 3.968m-3.968 0l3.968-3.968m-1.634-1.874l3.507 3.507a.496.496 0 0 1 0 .702l-3.507 3.507a.496.496 0 0 1-.701 0L7.61 11.85a.496.496 0 0 1 0-.702l3.507-3.507a.496.496 0 0 1 .701 0z"></svg:path></svg:g>`,
})
export class CatppuccinFolderComponentsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderComposablesIcon],svg[catppuccin-folder-composables-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="m12.635 15.154l-.515-.892m.513-.895l-.515.892m1.998-1.998l.276.554a1 1 0 0 1-.894 1.447H12.12m-1.502-5.004l.104-.207a1 1 0 0 1 1.788 0l.608 1.215m-1.119-.071l1.122.067m.615-.932l-.619.938m-2.996 3.994h-.387a1 1 0 0 1-.894-1.447l.776-1.553m.616.934l-.616-.934m-1.117.067l1.117-.067"></svg:path></svg:g>`,
})
export class CatppuccinFolderComposablesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderComposablesOpenIcon],svg[catppuccin-folder-composables-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="m12.635 15.154l-.515-.892m.513-.895l-.515.892m1.998-1.998l.276.554a1 1 0 0 1-.894 1.447H12.12m-1.502-5.004l.104-.207a1 1 0 0 1 1.788 0l.608 1.215m-1.119-.071l1.122.067m.615-.932l-.619.938m-2.996 3.994h-.387a1 1 0 0 1-.894-1.447l.776-1.553m.616.934l-.616-.934m-1.117.067l1.117-.067"></svg:path></svg:g>`,
})
export class CatppuccinFolderComposablesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderConfigIcon],svg[catppuccin-folder-config-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8087a2" d="M11.498 13a1 1 0 1 0 0-2a1 1 0 0 0 0 2m1.752-4L15 12l-1.75 3h-3.5L8 12l1.75-3z"></svg:path></svg:g>`,
})
export class CatppuccinFolderConfigIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderConfigOpenIcon],svg[catppuccin-folder-config-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderConfigOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderConnectionIcon],svg[catppuccin-folder-connection-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="M14.001 12.437a2 2 0 1 0-2.439-2.434M10.5 13.5l3-3m-3.497 1.062A2 2 0 1 0 12.437 14"></svg:path></svg:g>`,
})
export class CatppuccinFolderConnectionIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderConstantIcon],svg[catppuccin-folder-constant-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderConstantIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderContentIcon],svg[catppuccin-folder-content-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="M9.038 8.5h5.924a.54.54 0 0 1 .538.538v5.385a1.077 1.077 0 0 1-1.077 1.077H9.577A1.077 1.077 0 0 1 8.5 14.423V9.038a.54.54 0 0 1 .538-.538M8.5 12h7M12 13.5"></svg:path>`,
})
export class CatppuccinFolderContentIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderContentOpenIcon],svg[catppuccin-folder-content-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="M9.038 8.5h5.924a.54.54 0 0 1 .538.538v5.385a1.077 1.077 0 0 1-1.077 1.077H9.577A1.077 1.077 0 0 1 8.5 14.423V9.038a.54.54 0 0 1 .538-.538M8.5 12h7M12 13.5"></svg:path>`,
})
export class CatppuccinFolderContentOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderControllersIcon],svg[catppuccin-folder-controllers-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" d="M11.5 12.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m-1.5-4l1.503-1L13 8.5m-3 6l1.503 1l1.497-1M8.5 13l-1-1.51l1-1.49m6 3l1-1.51l-1-1.49"></svg:path></svg:g>`,
})
export class CatppuccinFolderControllersIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderControllersOpenIcon],svg[catppuccin-folder-controllers-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" d="M11.5 12.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m-1.5-4l1.503-1L13 8.5m-3 6l1.503 1l1.497-1M8.5 13l-1-1.51l1-1.49m6 3l1-1.51l-1-1.49"></svg:path></svg:g>`,
})
export class CatppuccinFolderControllersOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCoreIcon],svg[catppuccin-folder-core-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8087a2" d="M10.5 9.5h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1m0 0v-1m3 1v-1m-3 7v-1m3 1v-1m-5-4h1m-1 3h1m5-3h1m-1 3h1"></svg:path></svg:g>`,
})
export class CatppuccinFolderCoreIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCoreOpenIcon],svg[catppuccin-folder-core-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderCoreOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCoverageIcon],svg[catppuccin-folder-coverage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCoverageOpenIcon],svg[catppuccin-folder-coverage-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderCoverageOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderCypressOpenIcon],svg[catppuccin-folder-cypress-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderCypressOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDatabaseIcon],svg[catppuccin-folder-database-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M8.5 9.5q1 1 3.5 1t3.5-1m-7 2.5q1 1 3.5 1t3.5-1m-7 2.5v-5q1-1 3.5-1t3.5 1v5q-1 1-3.5 1t-3.5-1"></svg:path></svg:g>`,
})
export class CatppuccinFolderDatabaseIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDatabaseOpenIcon],svg[catppuccin-folder-database-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M8.5 9.5q1 1 3.5 1t3.5-1m-7 2.5q1 1 3.5 1t3.5-1m-7 2.5v-5q1-1 3.5-1t3.5 1v5q-1 1-3.5 1t-3.5-1"></svg:path></svg:g>`,
})
export class CatppuccinFolderDatabaseOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDebugIcon],svg[catppuccin-folder-debug-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#ed8796" d="M12.5 10.5v-1a1 1 0 1 0-2 0v1m2.667 0c.248.372.308 1.054.333 1.5v1.5c0 1.15-.85 2-2 2s-2-.85-2-2V12c.025-.446.085-1.128.333-1.5zm-5.667 2h2m4 0h2m-4 3V13M8 15.5l1.5-1m5.5 1l-1.5-1M8 9.5l1.5 1m5.5-1l-1.5 1"></svg:path></svg:g>`,
})
export class CatppuccinFolderDebugIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDebugOpenIcon],svg[catppuccin-folder-debug-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#ed8796" d="M12.5 10.5v-1a1 1 0 1 0-2 0v1m2.667 0c.248.372.308 1.054.333 1.5v1.5c0 1.15-.85 2-2 2s-2-.85-2-2V12c.025-.446.085-1.128.333-1.5zm-5.667 2h2m4 0h2m-4 3V13M8 15.5l1.5-1m5.5 1l-1.5-1M8 9.5l1.5 1m5.5-1l-1.5 1"></svg:path></svg:g>`,
})
export class CatppuccinFolderDebugOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDevcontainerOpenIcon],svg[catppuccin-folder-devcontainer-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M8.5 9.5V14l3.5 1.5l3.5-1.5V9.5L12 8Z"></svg:path><svg:path stroke="#91d7e3" d="m10.5 10.5l1.5.5l1.5-.5M12 11v2.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderDevcontainerOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDirenvOpenIcon],svg[catppuccin-folder-direnv-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#a6da95" stroke-linecap="round" stroke-linejoin="round" d="M13.5 9.876c0-.729-.72-1.32-1.6-1.32h-.8c-.88 0-1.6.591-1.6 1.32s.72 1.32 1.6 1.32h.8c.88 0 1.6.592 1.6 1.32s-.72 1.32-1.6 1.32h-.8c-.88 0-1.6-.591-1.6-1.32m2-5.016v1.056m0 5.28v1.057"></svg:path>`,
})
export class CatppuccinFolderDirenvOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDockerIcon],svg[catppuccin-folder-docker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g stroke="#8aadf4"><svg:path d="M8.5 11.5h5l.25-.5c-.151-.555-.465-.945-.25-1.5c.47.297.65.937 1 1c.357-.044 1-1 1 0c0 0 0 1.5-1 1.5c-.5 2-1.75 2.5-3.5 2.5c-2.75 0-2.5-3-2.5-3"></svg:path><svg:path d="M9.5 11.5v-2h2v2"></svg:path></svg:g></svg:g>`,
})
export class CatppuccinFolderDockerIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDocsOpenIcon],svg[catppuccin-folder-docs-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M8.5 14.5v-5a1 1 0 0 1 1-1h6v6m-6-1h6v2h-6a1 1 0 1 1 0-2"></svg:path></svg:g>`,
})
export class CatppuccinFolderDocsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDownloadOpenIcon],svg[catppuccin-folder-download-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M9.5 15.5h4m-2-7v5m-2-2l2 2l2-2"></svg:path></svg:g>`,
})
export class CatppuccinFolderDownloadOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderDrizzleOrmOpenIcon],svg[catppuccin-folder-drizzle-orm-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="M.027 11.07L1.74 7.641m-5.143 6l1.714-3.429m-3.43.857l1.715-3.429m-5.143 6l1.714-3.429" transform="matrix(.8418 0 0 .8401 14.11 4.099)"></svg:path><svg:path stroke="#cad3f5" d="m1.873 8l.702-2.74a1.002 1 0 0 1 .961-.76h10.96a1.002 1 0 0 1 .973 1.24l-.22.875M6.009 13.5H2.001A1.503 1.5 0 0 1 .498 12V3.5a1.002 1 0 0 1 1.002-1h5.01a1.002 1 0 0 1 1.002 1v1"></svg:path></svg:g>`,
})
export class CatppuccinFolderDrizzleOrmOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderExamplesIcon],svg[catppuccin-folder-examples-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M11.5 7.5c-1.682 0-3 1.259-3 2.806c0 1.165.623 1.72 1.115 2.126c.316.261.887.418.887.612v.424c-.006.248-.004.505-.004.756c0 .763.332 1.276 1.012 1.276s.992-.513.992-1.276c0-.25.001-.517-.004-.756v-.424c0-.295.596-.473.957-.763c.488-.393 1.045-.88 1.045-1.975c0-1.547-1.318-2.806-3-2.806m-.998 5.956h1.996"></svg:path></svg:g>`,
})
export class CatppuccinFolderExamplesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderExamplesOpenIcon],svg[catppuccin-folder-examples-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M11.5 7.5c-1.682 0-3 1.259-3 2.806c0 1.165.623 1.72 1.115 2.126c.316.261.887.418.887.612v.424c-.006.248-.004.505-.004.756c0 .763.332 1.276 1.012 1.276s.992-.513.992-1.276c0-.25.001-.517-.004-.756v-.424c0-.295.596-.473.957-.763c.488-.393 1.045-.88 1.045-1.975c0-1.547-1.318-2.806-3-2.806m-.998 5.956h1.996"></svg:path></svg:g>`,
})
export class CatppuccinFolderExamplesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFastlaneIcon],svg[catppuccin-folder-fastlane-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" d="M9.25 15.5L8 11.5"></svg:path><svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M13.75 15.5h-4.5"></svg:path><svg:path fill="none" stroke="#a6da95" stroke-linecap="round" stroke-linejoin="round" d="m15 11.5l-1.25 4"></svg:path><svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="m8 11.5l3.5-3l3.5 3"></svg:path><svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="m8 11.5l3.5-3"></svg:path>`,
})
export class CatppuccinFolderFastlaneIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFirebaseOpenIcon],svg[catppuccin-folder-firebase-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="m9.5 13.75l5-4.25l1 4.25l-3 1.75zm0 0l2-6.25l1.5 3"></svg:path></svg:g>`,
})
export class CatppuccinFolderFirebaseOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFontsIcon],svg[catppuccin-folder-fonts-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f0c6c6" d="M9.163 15.477L11.999 8.5l2.837 6.977M8.5 15.5h1.477m4.046 0H15.5m-5.5-2h4"></svg:path></svg:g>`,
})
export class CatppuccinFolderFontsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFontsOpenIcon],svg[catppuccin-folder-fonts-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f0c6c6" d="M9.163 15.477L11.999 8.5l2.837 6.977M8.5 15.5h1.477m4.046 0H15.5m-5.5-2h4"></svg:path></svg:g>`,
})
export class CatppuccinFolderFontsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderForgejoOpenIcon],svg[catppuccin-folder-forgejo-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#f5a97f" stroke-width=".65" d="M14.48 8.724a.677.703 0 0 1-.677.703a.677.703 0 0 1-.676-.703a.677.703 0 0 1 .676-.703a.677.703 0 0 1 .677.703m-3.834 5.546v-3.593c0-1.079.841-1.953 1.879-1.953h.601"></svg:path><svg:path stroke="#ed8796" stroke-width=".65" d="M11.33 14.97a.677.703 0 0 1-.677.703a.677.703 0 0 1-.676-.703a.677.703 0 0 1 .676-.703a.677.703 0 0 1 .677.703m3.157-3.591a.677.703 0 0 1-.677.703a.677.703 0 0 1-.676-.703a.677.703 0 0 1 .676-.703a.677.703 0 0 1 .677.703m-3.834 2.89v-.937c0-1.078.841-1.952 1.879-1.952h.601"></svg:path><svg:path stroke="#cad3f5" d="m1.873 8l.702-2.74a1.002 1 0 0 1 .961-.76h10.96a1.002 1 0 0 1 .973 1.24l-.22.875M6.009 13.5H2.001A1.503 1.5 0 0 1 .498 12V3.5a1.002 1 0 0 1 1.002-1h5.01a1.002 1 0 0 1 1.002 1v1"></svg:path></svg:g>`,
})
export class CatppuccinFolderForgejoOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFunctionsIcon],svg[catppuccin-folder-functions-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M7 14.75c0 .583.417.75 1 .75s.556-1.556.945-3.5c.388-1.945.472-3.5 1.055-3.5s1 .167 1 .75M7.778 11.5h2.333m5.389 2H15c-1.5 0-1.818-3-3-3h-.5m0 3h.5c1.5 0 1.818-3 3-3h.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderFunctionsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderFunctionsOpenIcon],svg[catppuccin-folder-functions-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M7 14.75c0 .583.417.75 1 .75s.556-1.556.945-3.5c.388-1.945.472-3.5 1.055-3.5s1 .167 1 .75M7.778 11.5h2.333m5.389 2H15c-1.5 0-1.818-3-3-3h-.5m0 3h.5c1.5 0 1.818-3 3-3h.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderFunctionsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderGithubIcon],svg[catppuccin-folder-github-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderGithubIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderGitlabOpenIcon],svg[catppuccin-folder-gitlab-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" stroke-linecap="square" d="m12 15.5l3.5-2.515l-1-4.485l-1.5 2h-2l-1.5-2l-1 4.485z"></svg:path></svg:g>`,
})
export class CatppuccinFolderGitlabOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderGradleIcon],svg[catppuccin-folder-gradle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.855"><svg:path d="m7.5 7.5l-1.97.78c-.2.15-.74.33-1.2-.2a7.3 7.3 0 0 1-1-1.63" transform="matrix(.53379 0 0 .54472 7.231 7.141)"></svg:path><svg:path d="M11.43 2.98c.54-.48 4.07-1.39 4.07 2.1c0 2.34-1.6 3.53-2.76 4.5c-.75.61-1.35 1.28-1.35 3.92H9.88c0-1.29-2.66-2.32-3.17 0H5.38c0-1.29-2.65-2.32-3.16 0H.7C.29 11.92.22 8.3 3.33 6.45c-.15-.25-.27-1.02.43-1.3c.87-.34 3.77-1.34 6.51.12s5.01 1.12 5.14.74" transform="matrix(.53379 0 0 .54472 7.231 7.141)"></svg:path></svg:g>`,
})
export class CatppuccinFolderGradleIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderGradleOpenIcon],svg[catppuccin-folder-gradle-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.855"><svg:path d="m7.5 7.5l-1.97.78c-.2.15-.74.33-1.2-.2a7.3 7.3 0 0 1-1-1.63" transform="matrix(.53379 0 0 .54472 7.231 7.141)"></svg:path><svg:path d="M11.43 2.98c.54-.48 4.07-1.39 4.07 2.1c0 2.34-1.6 3.53-2.76 4.5c-.75.61-1.35 1.28-1.35 3.92H9.88c0-1.29-2.66-2.32-3.17 0H5.38c0-1.29-2.65-2.32-3.16 0H.7C.29 11.92.22 8.3 3.33 6.45c-.15-.25-.27-1.02.43-1.3c.87-.34 3.77-1.34 6.51.12s5.01 1.12 5.14.74" transform="matrix(.53379 0 0 .54472 7.231 7.141)"></svg:path></svg:g>`,
})
export class CatppuccinFolderGradleOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderHuskyIcon],svg[catppuccin-folder-husky-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f4dbd6" d="m9.06 12.284l2.118-.774c.65-.238 1.36.163 1.474.831l.372 2.18c.12.702-.65 1.224-1.28.868a.6.6 0 0 1-.207-.19l-.11-.162A2.63 2.63 0 0 0 9.4 13.893l-.198-.011a.6.6 0 0 1-.271-.08a.834.834 0 0 1 .128-1.518"></svg:path><svg:path fill="#f4dbd6" d="M9.224 10.801c.398.23.944.036 1.22-.435c.276-.47.176-1.039-.222-1.27c-.398-.23-.944-.035-1.22.436c-.275.47-.176 1.04.222 1.27m2.62-1c.398.23.944.036 1.22-.435c.275-.47.176-1.039-.222-1.27c-.398-.23-.944-.035-1.22.436c-.275.47-.176 1.04.222 1.27m2.045 1c.398.23.944.036 1.22-.435c.276-.47.177-1.039-.221-1.27c-.398-.23-.944-.035-1.22.436c-.276.47-.177 1.04.221 1.27m.688 2.793c.398.23.945.035 1.22-.436c.276-.47.177-1.039-.22-1.269c-.399-.23-.945-.035-1.22.435c-.277.471-.178 1.04.22 1.27"></svg:path></svg:g>`,
})
export class CatppuccinFolderHuskyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderHuskyOpenIcon],svg[catppuccin-folder-husky-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f4dbd6" d="m9.06 12.285l2.118-.775c.65-.238 1.36.163 1.474.831l.372 2.18c.12.702-.65 1.224-1.28.868a.6.6 0 0 1-.207-.19l-.11-.162A2.63 2.63 0 0 0 9.4 13.893l-.198-.011a.6.6 0 0 1-.271-.08a.834.834 0 0 1 .128-1.517"></svg:path><svg:path fill="#f4dbd6" d="M9.224 10.801c.398.23.944.036 1.22-.435c.276-.47.176-1.039-.222-1.27c-.398-.23-.944-.035-1.22.436c-.275.47-.176 1.04.222 1.27m2.62-1c.398.23.944.036 1.22-.435c.275-.47.176-1.039-.222-1.27c-.398-.23-.944-.035-1.22.436c-.275.47-.176 1.04.222 1.27m2.045 1c.398.23.944.036 1.22-.435c.276-.47.177-1.039-.221-1.27c-.398-.23-.944-.035-1.22.436c-.276.47-.177 1.04.221 1.27m.688 2.793c.398.23.945.035 1.22-.436c.276-.47.177-1.039-.22-1.269c-.399-.23-.945-.035-1.22.435c-.277.471-.178 1.04.22 1.27"></svg:path></svg:g>`,
})
export class CatppuccinFolderHuskyOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderImagesIcon],svg[catppuccin-folder-images-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderImagesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderKubernetesIcon],svg[catppuccin-folder-kubernetes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderKubernetesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderLayoutsOpenIcon],svg[catppuccin-folder-layouts-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M9 8.5h6a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5H9a.5.5 0 0 1-.5-.5V9a.5.5 0 0 1 .5-.5m-.5 2h7m-5 .5v4"></svg:path></svg:g>`,
})
export class CatppuccinFolderLayoutsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderLocalesOpenIcon],svg[catppuccin-folder-locales-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="M12 14.5h3m-3.5 1l2-4l2 4m-6-4s.556 1.734 3 2m-1-3.5s.148 3.3-3 3.5H8m0-4h5M10.5 8v1.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderLocalesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderMiddlewareIcon],svg[catppuccin-folder-middleware-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderMiddlewareIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderMocksIcon],svg[catppuccin-folder-mocks-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="m10.327 15.5l4.795-4.795a1.292 1.292 0 1 0-1.827-1.827L8.5 13.673V15.5zm2.511-6.165l1.827 1.827"></svg:path></svg:g>`,
})
export class CatppuccinFolderMocksIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderMocksOpenIcon],svg[catppuccin-folder-mocks-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="m10.327 15.5l4.795-4.795a1.292 1.292 0 1 0-1.827-1.827L8.5 13.673V15.5zm2.511-6.165l1.827 1.827"></svg:path></svg:g>`,
})
export class CatppuccinFolderMocksOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderNextOpenIcon],svg[catppuccin-folder-next-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderNextOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderNixOpenIcon],svg[catppuccin-folder-nix-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#7dc4e4" d="M8 11.557h1.634m.648-.933L8.724 13.19"></svg:path><svg:path stroke="#8aadf4" d="m9.634 8.757l.7 1.167m1.633.233h-3.01"></svg:path><svg:path stroke="#7dc4e4" d="m13.367 8.757l-.7 1.4m.471 1.213l-1.404-2.613"></svg:path><svg:path stroke="#8aadf4" d="m15 12.033l-1.633-.01m-.644.934L14.3 10.39"></svg:path><svg:path stroke="#7dc4e4" d="m13.6 14.824l-1.166-1.4m-1.386.009l3.024-.01"></svg:path><svg:path stroke="#8aadf4" d="m9.634 14.824l.7-1.4m-.453-1.167l1.386 2.567"></svg:path></svg:g>`,
})
export class CatppuccinFolderNixOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderNodeIcon],svg[catppuccin-folder-node-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#a6da95" d="m12.5 8.576l3 1.714v3.42l-3 1.714l-3-1.714v-3.42z"></svg:path></svg:g>`,
})
export class CatppuccinFolderNodeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderNuxtIcon],svg[catppuccin-folder-nuxt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#a6da95" d="M12.865 14.5H15.5L13.383 11l-1.667 2.722c-.017.03-.054.106-.105.178a3 3 0 0 1-.197.259a.8.8 0 0 1-.173.159a1 1 0 0 1-.225.102a1.5 1.5 0 0 1-.246.054c-.082.012-.205.016-.246.02c-.021 0-1.09.006-1.696.006c-.468.014-.363-.257-.206-.5L11 10l1.407 2.347"></svg:path></svg:g>`,
})
export class CatppuccinFolderNuxtIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderNuxtOpenIcon],svg[catppuccin-folder-nuxt-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderNuxtOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderPackagesOpenIcon],svg[catppuccin-folder-packages-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" d="M12 15.337v-3.919L8.5 9.214m3.5 2.204l3.5-2.204M12 7.5l3.5 1.714v4.408L12 15.5l-3.5-1.878V9.214Z"></svg:path></svg:g>`,
})
export class CatppuccinFolderPackagesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderPluginsOpenIcon],svg[catppuccin-folder-plugins-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="m8.518 15.5l1.015-1.016m3.969-5.968l-2 1.99m3.998.01l-1.998 2m-2.97-2.625l3.595 3.594l-.899.898c-.57.629-1.545.914-2.477.704c-.899-.202-1.589-.928-1.82-1.82a2.54 2.54 0 0 1 .703-2.478Z"></svg:path></svg:g>`,
})
export class CatppuccinFolderPluginsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderPreCommitIcon],svg[catppuccin-folder-pre-commit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:rect width="6.034" height="6.034" x="-3.015" y="13.247" fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" rx=".635" ry=".635" transform="rotate(-45.004)"></svg:rect><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M10.62 13.118v-3.2h1.612s.662.096.662.85c0 .753-.662.9-.662.9h-1.555"></svg:path>`,
})
export class CatppuccinFolderPreCommitIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderPreCommitOpenIcon],svg[catppuccin-folder-pre-commit-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:rect width="6.034" height="6.034" x="-3.015" y="13.247" fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" rx=".635" ry=".635" transform="rotate(-45.004)"></svg:rect><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M10.62 13.118v-3.2h1.612s.662.096.662.85c0 .753-.662.9-.662.9h-1.555"></svg:path>`,
})
export class CatppuccinFolderPreCommitOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderPrismaOpenIcon],svg[catppuccin-folder-prisma-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="m15.5 14.25l-5 1.25l-2-2.25L12 8.5zM12 8.5l-1.5 7"></svg:path></svg:g>`,
})
export class CatppuccinFolderPrismaOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderQueueIcon],svg[catppuccin-folder-queue-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M11.5 7.5L8 9.5l3.5 2l3.5-2zm-3.5 4l3.5 2l3.5-2m-7 2l3.5 2l3.5-2"></svg:path></svg:g>`,
})
export class CatppuccinFolderQueueIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderQueueOpenIcon],svg[catppuccin-folder-queue-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M11.5 7.5L8 9.5l3.5 2l3.5-2zm-3.5 4l3.5 2l3.5-2m-7 2l3.5 2l3.5-2"></svg:path></svg:g>`,
})
export class CatppuccinFolderQueueOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderReduxIcon],svg[catppuccin-folder-redux-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="M13.436 10.47c-.138-1.125-.735-1.97-1.452-1.97c-.818 0-1.481 1.104-1.481 2.466c0 .806.232 1.522.592 1.972m1.695 1.905c.894.698 1.915.873 2.421.368c.579-.578.266-1.827-.698-2.79c-.571-.57-1.243-.912-1.815-.977m-3.11 1.092c-.887.76-1.384 2.137-.877 2.643c.578.578 1.83.265 2.794-.698c.57-.57.913-1.24.978-1.812"></svg:path></svg:g>`,
})
export class CatppuccinFolderReduxIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderReduxOpenIcon],svg[catppuccin-folder-redux-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="M13.436 10.47c-.138-1.125-.736-1.97-1.452-1.97c-.818 0-1.482 1.104-1.482 2.466c0 .806.233 1.522.592 1.972m1.696 1.905c.893.698 1.914.873 2.42.368c.58-.578.267-1.827-.698-2.79c-.57-.57-1.242-.912-1.815-.977m-3.11 1.092c-.886.76-1.383 2.137-.877 2.643c.58.578 1.83.266 2.795-.698c.57-.57.913-1.24.978-1.812"></svg:path></svg:g>`,
})
export class CatppuccinFolderReduxOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderRenovateIcon],svg[catppuccin-folder-renovate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2c-.83 0-1.5-.67-1.5-1.5V3.5c0-.55.45-1 1-1h5c.55 0 1 .45 1 1v1"></svg:path><svg:path stroke="#cad3f5" stroke-width=".613" d="M13.4 13.41c-.123-.184-.203-.325-.153-.52a.7.7 0 0 1 .19-.32c.786-.771 1.486-1.44 2.125-2.248c.055-.074.08-.166.104-.252c.019-.073.019-.153.019-.232a.6.6 0 0 0-.031-.215a4.237 4.228 0 0 0-.86-1.336c-.086-.061-.172-.123-.27-.165a.676.674 0 0 0-.221-.055c-.098 0-.203.006-.295.03c-.104.03-.178.08-.282.141m.19 7.445l-.823-1.385a.43.429 0 0 1-.049-.343a.448.447 0 0 1 .215-.27l.473-.263a.473.472 0 0 1 .626.165l.823 1.385"></svg:path><svg:path stroke="#8bd5ca" stroke-width=".613" d="m8.076 9.968l3.929-2.209a1.173 1.173 0 0 1 1.588.423a1.12 1.12 0 0 1-.417 1.54l-3.929 2.221a1.176 1.176 0 0 1-1.588-.43a1.12 1.12 0 0 1 .417-1.545"></svg:path></svg:g>`,
})
export class CatppuccinFolderRenovateIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderRenovateOpenIcon],svg[catppuccin-folder-renovate-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.873 8l.702-2.74a1.002 1 0 0 1 .961-.76h10.96a1.002 1 0 0 1 .973 1.24l-.22.875M6.009 13.5H2.001A1.503 1.5 0 0 1 .498 12V3.5a1.002 1 0 0 1 1.002-1h5.01a1.002 1 0 0 1 1.002 1v1"></svg:path><svg:path stroke="#cad3f5" stroke-width=".613" d="M13.41 13.42c-.122-.184-.202-.325-.153-.522a.7.7 0 0 1 .19-.319c.783-.773 1.48-1.442 2.117-2.252c.055-.073.08-.165.104-.251c.018-.074.018-.154.018-.233a.6.6 0 0 0-.03-.215a4.222 4.234 0 0 0-.857-1.338a1.5 1.5 0 0 0-.27-.166a.673.675 0 0 0-.22-.055a1.2 1.2 0 0 0-.293.03c-.104.031-.178.08-.282.142m.19 7.455l-.82-1.387a.428.43 0 0 1-.05-.344a.447.448 0 0 1 .215-.27l.471-.264a.471.473 0 0 1 .624.166l.82 1.387"></svg:path><svg:path stroke="#8bd5ca" stroke-width=".613" d="m8.076 9.968l3.929-2.209a1.173 1.173 0 0 1 1.588.423a1.12 1.12 0 0 1-.417 1.54l-3.929 2.221a1.176 1.176 0 0 1-1.588-.43a1.12 1.12 0 0 1 .417-1.545"></svg:path></svg:g>`,
})
export class CatppuccinFolderRenovateOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderRoutesIcon],svg[catppuccin-folder-routes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#a6da95" d="M11.5 11.5v4m0-7.5v1.5m-1.5 6h3m-4.5-6v2h5.75l1.25-1l-1.25-1z"></svg:path></svg:g>`,
})
export class CatppuccinFolderRoutesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderRoutesOpenIcon],svg[catppuccin-folder-routes-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderRoutesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderSassIcon],svg[catppuccin-folder-sass-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5bde6" d="M11.82 11.127c1.006.575 1.824.401 2.635-.109s1.471-1.495.707-2.231c-.383-.368-1.774-.43-3.063.1c-1.29.531-2.504 1.627-2.588 2.215c-.169 1.177 1.72 1.551 1.986 2.278s.152 1.063-.113 1.52c-.264.458-1.067.876-1.521.367s.908-1.48 1.62-1.75c.711-.27 1.698-.212 2.014.135c.317.347-.035.964-.014.964"></svg:path></svg:g>`,
})
export class CatppuccinFolderSassIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderSassOpenIcon],svg[catppuccin-folder-sass-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5bde6" d="M11.82 11.127c1.006.575 1.824.401 2.635-.109s1.471-1.495.707-2.231c-.383-.368-1.774-.43-3.063.1c-1.29.531-2.504 1.627-2.588 2.215c-.169 1.177 1.72 1.551 1.986 2.278s.152 1.063-.113 1.52c-.264.458-1.067.876-1.521.367s.908-1.48 1.62-1.75c.711-.27 1.698-.212 2.014.135c.317.347-.035.964-.014.964"></svg:path></svg:g>`,
})
export class CatppuccinFolderSassOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderScriptsIcon],svg[catppuccin-folder-scripts-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#c6a0f6" d="M8.5 13.5V9.75C8.5 9 9 8.5 9.75 8.5h3.75v5.75c0 .75-.5 1.25-1.25 1.25H8.5a1 1 0 0 1 0-2h3a1 1 0 0 0 0 2m2-5h1a1 1 0 0 0 0-2h-1"></svg:path></svg:g>`,
})
export class CatppuccinFolderScriptsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderSecurityIcon],svg[catppuccin-folder-security-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#f0c6c6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.42" d="M7.684 7.575h.01m9.5 2.964h5.122l-3.414 6.918l-3.015-4.269m2.527-5.12l-3.902 7.907l-10.135-5.14a2.848 2.886 0 0 1-1.269-3.863l1.347-2.758A2.848 2.886 0 0 1 8.279 2.93Zm-15.608 9.39h3.668A1.951 1.977 0 0 0 8.23 16.37l1.405-2.866m-6.829 5.93v-3.953" transform="matrix(-.4104 0 0 .41613 16.655 7.41)"></svg:path>`,
})
export class CatppuccinFolderSecurityIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderSecurityOpenIcon],svg[catppuccin-folder-security-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path fill="none" stroke="#f0c6c6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.42" d="M7.684 7.575h.01m9.5 2.964h5.122l-3.414 6.918l-3.015-4.269m2.527-5.12l-3.902 7.907l-10.135-5.14a2.848 2.886 0 0 1-1.269-3.863l1.347-2.758A2.848 2.886 0 0 1 8.279 2.93Zm-15.608 9.39h3.668A1.951 1.977 0 0 0 8.23 16.37l1.405-2.866m-6.829 5.93v-3.953" transform="matrix(-.4104 0 0 .41613 16.655 7.41)"></svg:path>`,
})
export class CatppuccinFolderSecurityOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderServerOpenIcon],svg[catppuccin-folder-server-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M8.5 9.5h7v2h-7zm2 0v2m-2 2h7v2h-7zm2 0v2"></svg:path></svg:g>`,
})
export class CatppuccinFolderServerOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderStorybookIcon],svg[catppuccin-folder-storybook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1M10 13c0 .55.529 1 1 1s1-.529 1-1s-1-1-1-1s-1-.529-1-1s.529-1 1-1s.902.538 1 1"></svg:path><svg:path stroke="#f5bde6" d="M12 8.253v.75M8.5 8.5V15l5 .5l.015-7.5Z"></svg:path></svg:g>`,
})
export class CatppuccinFolderStorybookIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderStorybookOpenIcon],svg[catppuccin-folder-storybook-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1M10 13c0 .55.529 1 1 1s1-.529 1-1s-1-1-1-1s-1-.529-1-1s.529-1 1-1s.902.538 1 1"></svg:path><svg:path stroke="#f5bde6" d="M12 8.253v.75M8.5 8.5V15l5 .5l.015-7.5Z"></svg:path></svg:g>`,
})
export class CatppuccinFolderStorybookOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderStylesIcon],svg[catppuccin-folder-styles-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="M8.5 15.5v-1.555a1.556 1.556 0 1 1 1.556 1.555zm7-7a6.22 6.22 0 0 0-4.978 3.967M15.5 8.5a6.22 6.22 0 0 1-3.967 4.978m-.077-2.645a3.5 3.5 0 0 1 1.71 1.711"></svg:path></svg:g>`,
})
export class CatppuccinFolderStylesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderSvgOpenIcon],svg[catppuccin-folder-svg-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" stroke-linecap="square" d="M11.5 8.5v6m0-6a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm0 7a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm2.598-2.5l-5.196-3m5.196 3a.5.5 0 1 0 .866.5a.5.5 0 0 0-.866-.5ZM8.036 9.5a.5.5 0 1 0 .866.5a.5.5 0 0 0-.866-.5Zm6.062.5l-5.196 3m5.196-3a.5.5 0 1 0 .866-.5a.5.5 0 0 0-.866.5Zm-6.062 3.5a.5.5 0 1 0 .866-.5a.5.5 0 0 0-.866.5Z"></svg:path></svg:g>`,
})
export class CatppuccinFolderSvgOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTauriOpenIcon],svg[catppuccin-folder-tauri-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#eed49f" d="M11.11 9.812a2.32 2.32 0 0 1 4.383.95a2.326 2.326 0 0 1-1.608 2.329"></svg:path><svg:path fill="#91d7e3" d="M12.5 13a.5.5 0 0 1-.5.5a.5.5 0 0 1-.5-.5a.5.5 0 0 1 .5-.5a.5.5 0 0 1 .5.5"></svg:path><svg:path stroke="#91d7e3" d="M13.881 14.243a2.32 2.32 0 0 1-4.377-.931a2.326 2.326 0 0 1 1.562-2.342"></svg:path><svg:path fill="#eed49f" d="M13.5 11a.5.5 0 0 1-.5.5a.5.5 0 0 1-.5-.5a.5.5 0 0 1 .5-.5a.5.5 0 0 1 .5.5"></svg:path></svg:g>`,
})
export class CatppuccinFolderTauriOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTempOpenIcon],svg[catppuccin-folder-temp-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="M12 15.5a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7m0-5.5v2h1"></svg:path></svg:g>`,
})
export class CatppuccinFolderTempOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTemplatesOpenIcon],svg[catppuccin-folder-templates-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#ee99a0" d="M11.5 10.5h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1m2-.333v-.834a.833.833 0 0 0-.833-.833H9.333a.833.833 0 0 0-.833.833v3.334c0 .46.373.833.833.833h.834"></svg:path></svg:g>`,
})
export class CatppuccinFolderTemplatesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTestsOpenIcon],svg[catppuccin-folder-tests-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="m13.158 9.16l-4.272 4.253c-.558.555-.45 1.31-.064 1.694c.406.404 1.077.641 1.743-.022l4.269-4.25M12.5 8.5l.5.5l1 1l1 1l.5.5m-3.478 2.006H8.96"></svg:path></svg:g>`,
})
export class CatppuccinFolderTestsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderThemesIcon],svg[catppuccin-folder-themes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4"><svg:path stroke="#f4dbd6" d="M12 21a9 9 0 0 1 0-18c4.97 0 9 3.582 9 8c0 1.06-.474 2.078-1.318 2.828S17.693 15 16.5 15H14a2 2 0 0 0-1 3.75A1.3 1.3 0 0 1 12 21" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#ed8796" d="M7.5 10.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#a6da95" d="M11.5 7.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#8aadf4" d="M15.5 10.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path></svg:g>`,
})
export class CatppuccinFolderThemesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderThemesOpenIcon],svg[catppuccin-folder-themes-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4"><svg:path stroke="#f4dbd6" d="M12 21a9 9 0 0 1 0-18c4.97 0 9 3.582 9 8c0 1.06-.474 2.078-1.318 2.828S17.693 15 16.5 15H14a2 2 0 0 0-1 3.75A1.3 1.3 0 0 1 12 21" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#ed8796" d="M7.5 10.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#a6da95" d="M11.5 7.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path><svg:path stroke="#8aadf4" d="M15.5 10.5c0 1.333 2 1.333 2 0s-2-1.333-2 0" transform="matrix(.41667 0 0 .4167 6.75 6.747)"></svg:path></svg:g>`,
})
export class CatppuccinFolderThemesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTurboOpenIcon],svg[catppuccin-folder-turbo-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m1.9 8l.7-2.7a1 1 0 0 1 1-.8h10.9a1 1 0 0 1 1 1.2L15 7m-9 6.5H2c-.8 0-1.5-.7-1.5-1.5V3.5c0-.6.4-1 1-1h5c.6 0 1 .4 1 1v1"></svg:path><svg:circle cx="11.5" cy="11.5" r="2" stroke="#cad3f5"></svg:circle><svg:path stroke="#ee99a0" stroke-linecap="round" stroke-linejoin="round" d="M14.7 14a4 4 0 0 1-2.2 1.4"></svg:path><svg:path stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M12.5 7.6a4 4 0 0 1 3 3.7"></svg:path><svg:path stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M15.5 11.5a4 4 0 0 1-.7 2.3"></svg:path><svg:path stroke="#ee99a0" stroke-linecap="round" stroke-linejoin="round" d="M10.5 15.4a4 4 0 0 1-1.4-.7m-1.3-1.6a4 4 0 0 1-.3-1.6"></svg:path></svg:g>`,
})
export class CatppuccinFolderTurboOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTypesIcon],svg[catppuccin-folder-types-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="m8.499 12.5l4.001-4h3v3l-4 4.003z"></svg:path></svg:g>`,
})
export class CatppuccinFolderTypesIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderTypesOpenIcon],svg[catppuccin-folder-types-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8bd5ca" d="m8.499 12.5l4.001-4h3v3l-4 4.003z"></svg:path></svg:g>`,
})
export class CatppuccinFolderTypesOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderUploadIcon],svg[catppuccin-folder-upload-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M9.5 15.5h4m-2-2v-5m-2 2l2-2l2 2"></svg:path></svg:g>`,
})
export class CatppuccinFolderUploadIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderUploadOpenIcon],svg[catppuccin-folder-upload-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#91d7e3" d="M9.5 15.5h4m-2-2v-5m-2 2l2-2l2 2"></svg:path></svg:g>`,
})
export class CatppuccinFolderUploadOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderUtilsIcon],svg[catppuccin-folder-utils-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderUtilsOpenIcon],svg[catppuccin-folder-utils-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderUtilsOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderVercelIcon],svg[catppuccin-folder-vercel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8087a2" d="m12 9l3.5 6.5h-7z"></svg:path></svg:g>`,
})
export class CatppuccinFolderVercelIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderVideoOpenIcon],svg[catppuccin-folder-video-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="m15.5 12l-5-3.5v7zm-7-3.5v7"></svg:path></svg:g>`,
})
export class CatppuccinFolderVideoOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderVscodeIcon],svg[catppuccin-folder-vscode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="m8 10l5.555 5.432s.179.143.342.015l1.434-.739c.195-.144.168-.321.168-.321V9.55c0-.212-.202-.286-.202-.286l-1.322-.687c-.288-.192-.477.035-.477.035l-.421.406L8 14"></svg:path></svg:g>`,
})
export class CatppuccinFolderVscodeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderVscodeOpenIcon],svg[catppuccin-folder-vscode-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.875 8l.686-2.743a1 1 0 0 1 .97-.757h10.938a1 1 0 0 1 .97 1.243l-.315 1.26M6 13.5H2.004A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#8aadf4" d="m8 10l5.555 5.432s.179.143.342.015l1.434-.739c.195-.144.168-.321.168-.321V9.55c0-.212-.202-.286-.202-.286l-1.322-.687c-.288-.192-.477.035-.477.035l-.421.406L8 14"></svg:path></svg:g>`,
})
export class CatppuccinFolderVscodeOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderWorkflowsIcon],svg[catppuccin-folder-workflows-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12A1.5 1.5 0 0 1 13.5 6v.5m-7.5 7H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:path stroke="#f5a97f" d="M9.5 8.5h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1m4 4h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1m-4-1v3h3"></svg:path></svg:g>`,
})
export class CatppuccinFolderWorkflowsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderWxtIcon],svg[catppuccin-folder-wxt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderWxtIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderWxtOpenIcon],svg[catppuccin-folder-wxt-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinFolderWxtOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderXcodeIcon],svg[catppuccin-folder-xcode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M4.5 4.5H12c.83 0 1.5.67 1.5 1.5v.5m-7.5 7H2c-.83 0-1.5-.67-1.5-1.5V3.5c0-.55.45-1 1-1h5c.55 0 1 .45 1 1v1"></svg:path><svg:path stroke="#8aadf4" stroke-width=".563" d="M14.59 11.761v2.09c0 .868-.699 1.566-1.567 1.566h-1.245m-2.532 0h-.401a1.563 1.563 0 0 1-1.567-1.567V9.671c0-.868.699-1.567 1.567-1.567h1.527m-1.407 5.908l2.532-4.501m-1.125 0l.83 1.477m1.543 2.743l.158.281m-4.218-1.407h1.675"></svg:path><svg:g stroke-width="1.884"><svg:path stroke="#cad3f5" d="M14 12L.34 25.7c-1.443 1.447-3.267-.727-1.996-2.003l13.66-13.7" transform="matrix(.28528 -.08959 .08932 .28431 8.46 8.178)"></svg:path><svg:path stroke="#8087a2" d="m21.5 11.5l-1.914-1.914A2 2 0 0 1 19 8.172V7l-2.26-2.26a6 6 0 0 0-4.202-1.756L9 2.96l.92.82A6.18 6.18 0 0 1 12 8.4V10l2 2h1.172a2 2 0 0 1 1.414.586L18.5 14.5m-.408.569l3.854-4.031" transform="matrix(.28528 -.08959 .08932 .28431 8.46 8.178)"></svg:path></svg:g></svg:g>`,
})
export class CatppuccinFolderXcodeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderXcodeOpenIcon],svg[catppuccin-folder-xcode-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#8aadf4" stroke-width=".583" d="M14.54 11.61v2.164c0 .9-.724 1.623-1.623 1.623h-1.29m-2.622 0h-.416a1.62 1.62 0 0 1-1.623-1.623V9.445c0-.9.724-1.623 1.623-1.623h1.582m-1.457 6.119l2.622-4.662m-1.165 0l.86 1.53m1.598 2.841l.164.291m-4.37-1.457h1.735" transform="matrix(.9666 0 0 .9654 .545 .551)"></svg:path><svg:g stroke-width="1.884"><svg:path stroke="#cad3f5" d="M14 12L.34 25.7c-1.443 1.447-3.267-.727-1.996-2.003l13.66-13.7" transform="matrix(.28563 -.08959 .08943 .28431 8.462 8.176)"></svg:path><svg:path stroke="#8087a2" d="m21.5 11.5l-1.914-1.914A2 2 0 0 1 19 8.172V7l-2.26-2.26a6 6 0 0 0-4.202-1.756L9 2.96l.92.82A6.18 6.18 0 0 1 12 8.4V10l2 2h1.172a2 2 0 0 1 1.414.586L18.5 14.5m-.408.569l3.854-4.031" transform="matrix(.28563 -.08959 .08943 .28431 8.462 8.176)"></svg:path></svg:g><svg:path stroke="#cad3f5" d="m1.873 8l.702-2.74a1.002 1 0 0 1 .961-.76h10.96a1.002 1 0 0 1 .973 1.24l-.22.875M6.009 13.5H2.001A1.503 1.5 0 0 1 .498 12V3.5a1.002 1 0 0 1 1.002-1h5.01a1.002 1 0 0 1 1.002 1v1" transform="scale(1.0004 1.0002)"></svg:path></svg:g>`,
})
export class CatppuccinFolderXcodeOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderYarnIcon],svg[catppuccin-folder-yarn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFolderYarnOpenIcon],svg[catppuccin-folder-yarn-open-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="m1.87 8l.7-2.74a1 1 0 0 1 .96-.76h10.94a1 1 0 0 1 .97 1.24l-.219.875M6 13.5H2A1.5 1.5 0 0 1 .5 12V3.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1"></svg:path><svg:g stroke="#c6a0f6" stroke-width="10.927"><svg:path d="M11.9 65.033s-1.241-16.91 11.549-24.936c0 0-8.286-12.228 0-19.036s12.645-9.145 18.736-8.634c0 0 7.247-20.251 14.643 0c0 0 9.061-7.776 7.844 17.247c-.323 6.646-4.717 16.289-7.844 20.326c0 0 8.881 6.323 8.881 25.924c0 0 14.526-7.698 18.663-8.162c4.136-.463 7.724-.011 8.572 2.799s1.245 4.744-1.062 6.558c-2.308 1.813-10.589 4.258-19.484 10.194c-8.894 5.936-11.77 4.105-14.208 5.576c-2.438 1.472-16.058 7.342-33.033.927c0 0-15.323 4.247-14.195-6.503c0 0-10.684-12.422.938-22.28" transform="matrix(.09189 0 0 .09115 6.896 6.683)"></svg:path><svg:path d="M27.469 94.285c-1.525-1.407.321-8.703.321-8.703s-1.252 4.723-3.116 7.525" transform="matrix(.09189 0 0 .09115 6.896 6.683)"></svg:path></svg:g></svg:g>`,
})
export class CatppuccinFolderYarnOpenIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinForgejoIcon],svg[catppuccin-forgejo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#f5a97f" d="M12.58 1.877a1.345 1.377 0 0 1-1.345 1.377A1.345 1.377 0 0 1 9.89 1.877A1.345 1.377 0 0 1 11.235.5a1.345 1.377 0 0 1 1.345 1.377m-7.619 10.87V5.709c0-2.114 1.672-3.827 3.734-3.827H9.89"></svg:path><svg:path stroke="#ed8796" d="M6.305 14.13a1.345 1.377 0 0 1-1.345 1.377a1.345 1.377 0 0 1-1.345-1.377a1.345 1.377 0 0 1 1.345-1.377a1.345 1.377 0 0 1 1.345 1.377m6.273-7.038a1.345 1.377 0 0 1-1.345 1.377a1.345 1.377 0 0 1-1.345-1.377a1.345 1.377 0 0 1 1.345-1.377a1.345 1.377 0 0 1 1.345 1.377m-7.619 5.664v-1.837c0-2.114 1.672-3.827 3.734-3.827h1.195"></svg:path></svg:g>`,
})
export class CatppuccinForgejoIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinFvmIcon],svg[catppuccin-fvm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M9.024 12.85L9 10.505h6.5v2.35zM5.4 8.005L.5 3.155l3.433.005L8 7.155c.47.476.47 1.24 0 1.7l-4 4H.5z"></svg:path>`,
})
export class CatppuccinFvmIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGcpIcon],svg[catppuccin-gcp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linejoin="round"><svg:path stroke="#ed8796" d="M5.576 5.627a3.266 3.266 0 0 1 4.451-.339h-.009h.458"></svg:path><svg:path stroke="#ed8796" d="m11.78 3.984l.064-.553a5.87 5.87 0 0 0-3.879-1.467A5.876 5.876 0 0 0 2.309 6.29"></svg:path><svg:path stroke="#8aadf4" d="M13.637 6.29a5.9 5.9 0 0 0-1.771-2.855l-1.83 1.83a3.26 3.26 0 0 1 1.195 2.581v.325c.893 0 1.628.735 1.628 1.628c0 .894-.735 1.629-1.628 1.629H7.973v2.608h3.291c2.324 0 4.236-1.913 4.236-4.237a4.24 4.24 0 0 0-1.863-3.509Z"></svg:path><svg:path stroke="#a6da95" d="m2.268 12.709l-.114.457a4.2 4.2 0 0 0 2.557.851h3.258V11.41H4.711c-.232 0-.461-.05-.672-.147"></svg:path><svg:path stroke="#eed49f" d="m3.221 12.085l.822-.822a1.63 1.63 0 0 1-.958-1.484c0-.893.735-1.629 1.629-1.629a1.63 1.63 0 0 1 1.484.958l1.89-1.889a4.24 4.24 0 0 0-3.377-1.661C2.397 5.572.5 7.48.5 9.795a4.24 4.24 0 0 0 1.654 3.358l1.067-1.068"></svg:path></svg:g>`,
})
export class CatppuccinGcpIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGitpodIcon],svg[catppuccin-gitpod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="M8.7 3.27L4.68 5.79a.38.38 0 0 0-.18.33v3.96c0 .14.07.26.18.33l3.14 2c.11.06.25.06.36 0l3.14-2a.4.4 0 0 0 .18-.33V7.5L8.7 9.4c-.33.19-.72.23-1.08.13s-.67-.36-.85-.7a1.52 1.52 0 0 1 .54-2.02l4.27-2.54c.61-.35 1.35-.35 1.96.02c.6.37.96 1.04.96 1.77v4.32c0 1.01-.51 1.95-1.35 2.45l-3.82 2.3c-.82.5-1.84.5-2.66 0l-3.82-2.3a2.85 2.85 0 0 1-1.35-2.45V5.82c0-1.01.51-1.95 1.35-2.45L7.3.7c.33-.2.71-.25 1.07-.15s.67.36.85.7c.39.7.16 1.61-.52 2.02"></svg:path>`,
})
export class CatppuccinGitpodIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGleamIcon],svg[catppuccin-gleam-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5bde6" stroke-width=".84" d="M7.986 1.42a.96.96 0 0 0-.851.51L5.704 4.577a.98.98 0 0 1-.658.498l-2.856.601c-.733.155-1.032 1.115-.526 1.69l1.972 2.238c.192.217.284.512.251.806l-.334 3.02c-.086.775.696 1.37 1.377 1.044l2.65-1.265a.94.94 0 0 1 .812 0l2.65 1.265c.68.325 1.462-.269 1.376-1.044l-.334-3.02a1.04 1.04 0 0 1 .251-.806l1.972-2.239c.506-.574.207-1.534-.526-1.689l-2.856-.6a.98.98 0 0 1-.658-.5L8.837 1.93a.96.96 0 0 0-.851-.51"></svg:path><svg:path fill="none" stroke="#f5bde6" stroke-linecap="round" stroke-linejoin="round" d="M8.685 9.262a.75.754 0 0 1-.705.496a.75.754 0 0 1-.704-.496M10.5 8"></svg:path>`,
})
export class CatppuccinGleamIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGleamConfigIcon],svg[catppuccin-gleam-config-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGoIcon],svg[catppuccin-go-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" d="m15.48 8.06l-4.85.48m4.85-.48a4.98 4.98 0 0 1-4.54 5.42a5 5 0 1 1 2.95-8.66l-1.7 1.84a2.5 2.5 0 0 0-4.18 2.06c.05.57.3 1.1.69 1.51c.25.27 1 .83 1.78.82c.8-.02 1.58-.25 2.07-.81c0 0 .8-.96.68-1.88M2.5 8.5l-2 .01m1.5 2h1.5m-2-3.99l2-.02"></svg:path>`,
})
export class CatppuccinGoIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGoModIcon],svg[catppuccin-go-mod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" d="m2.5 8.51l-2 .01m1.5 2h1.5m-2-4h1m6.73-2.19a1.5 1.5 0 1 0-2.16.58m2.16-.58l2.78-.74l.75 2.78m.57 2.16l.75 2.79l-7.73 2.07l-2.07-7.73l2.78-.75m6.28 3.63a1.5 1.5 0 1 0-.58-2.17"></svg:path>`,
})
export class CatppuccinGoModIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGoTemplateIcon],svg[catppuccin-go-template-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" d="m2.5 8.51l-2 .01m1.5 2h1.5m-2-4h1"></svg:path><svg:path fill="none" stroke="#7dc4e4" stroke-dasharray="1 1.5" stroke-linecap="round" stroke-linejoin="round" d="m14.094 5.17l1.347 5.03a1.735 1.735 0 0 1-1.227 2.126L8.349 13.9a1.735 1.735 0 0 1-2.125-1.228l-2.02-7.544A1.74 1.74 0 0 1 5.43 3l3.36-.9m-.008.002l5.312 3.068l-3.352.898a.867.868 0 0 1-1.062-.613Z"></svg:path>`,
})
export class CatppuccinGoTemplateIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGodotIcon],svg[catppuccin-godot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="m1.5 11l2.5.5l.25 1h2l.5-1h2.5l.5 1h2l.25-1l2.5-.5m-13 1.25c0 2.25 2.74 3.25 6.5 3.25c3.75 0 6.5-1 6.5-3.25v-5L15.75 6L14.5 4L13 5.25L11.5 4l.5-1.5l-2.5-1L8.75 3h-1.5L6.5 1.5L4 2.5L4.5 4L3 5.25L1.5 4L.25 6L1.5 7.25zM8 7.5v2m-3.5 0a1 1 0 1 0 0-2a1 1 0 0 0 0 2m7 0a1 1 0 1 0 0-2a1 1 0 0 0 0 2"></svg:path>`,
})
export class CatppuccinGodotIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGodotAssetsIcon],svg[catppuccin-godot-assets-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinGodotAssetsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGroovyIcon],svg[catppuccin-groovy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M11.68 5.38c.4.19.54.68 1.53 3.25c1 2.57-.92 4.07-.92 4.07s-6.73 2.47-6.73 1.63c-.18-.92-1.92-2.08-1.92-2.08s-.52-.63.06-.75c5.89-1.27 6.96-.61 7.3-2"></svg:path><svg:path d="M7.38 10.63C2.62 10.88 2.48 8.08 2.5 8C3.6 4.6 9.24.91 10.8 1.58C14.07 3.04 9.2 8.96 7 8.5c-4.02-.83 1.5-4 1.5-4"></svg:path></svg:g>`,
})
export class CatppuccinGroovyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinGulpIcon],svg[catppuccin-gulp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="m13 4l-1 7.5l-1 1l-.5 3h-5l-.5-3l-1-1l-.93-7L3 4m5 1.5c2.76 0 5-.67 5-1.5s-2.24-1.5-5-1.5S3 3.17 3 4s2.24 1.5 5 1.5M4 11c1.78.33 3.11.5 4 .5s2.22-.17 4-.5M9.5 4l1-2.5l2-1"></svg:path>`,
})
export class CatppuccinGulpIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHamlIcon],svg[catppuccin-haml-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M7.6 9.5s1.75.97 2.55 1.13c.8.17 1.5.8 2.49-.26c1.07-1.15 1.13-1.02.26-1.68c-.88-.66-2.41-1.94-2.41-2.69"></svg:path><svg:path stroke="#eed49f" d="M6.87 5.56a.83.83 0 0 0 1.23.27L12 2.5l1 1.04L9.58 6.8a6.47 6.47 0 0 0-2.36 3.56l-1.2 4.13l-1.49-.5l1-3.98a6.17 6.17 0 0 0-.47-4.24L3.5 2.04l1.37-.54Z"></svg:path><svg:path stroke="#cad3f5" d="m12 4.5l-1-1.16ZM5.41 2.62l-1.4.7Z"></svg:path></svg:g>`,
})
export class CatppuccinHamlIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHandlebarsIcon],svg[catppuccin-handlebars-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="M8 6.15a1.73 1.73 0 0 0-2.48-.22c-.97.82-1.78 2.5-3.31 2.5a.99.99 0 0 1-.83-.66a.97.97 0 0 1 .24-1.02C.45 6.75.1 8.67 1.03 9.56a4.76 4.76 0 0 0 4.7.56C6.63 9.76 7.4 9.2 8 8.45zm0 0a1.73 1.73 0 0 1 2.48-.22c.96.82 1.78 2.5 3.3 2.5a1 1 0 0 0 .84-.66a.97.97 0 0 0-.24-1.02c1.17 0 1.52 1.92.58 2.81a4.76 4.76 0 0 1-4.7.56A5.34 5.34 0 0 1 8 8.45z"></svg:path>`,
})
export class CatppuccinHandlebarsIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHaskellIcon],svg[catppuccin-haskell-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M12.5 4.5h3m-1.5 3h1.5m-10 6l2.5-5l-2.5-5H8l5.6 10h-2.53l-1.52-2.92L8 13.5zm-5 0l2.5-5l-2.5-5H3l2.5 5l-2.5 5z"></svg:path>`,
})
export class CatppuccinHaskellIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHelmIcon],svg[catppuccin-helm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M3.5 11.5C4.48 12.62 6.52 13 8 13s3.52-.38 4.5-1.5M8 13v2.5m-4-3L3 14m9-1.5l1 1.5M3.5 4.5C4.48 3.38 6.52 3 8 3s3.52.38 4.5 1.5M8 3V.5m-4 3L3 2m9 1.5L13 2m1.5 7.5v-3L13 8l-1.5-1.5v3m-3-3v3H10m-3-3H5.5v3H7M5.5 8h1m-5-1.5v3m0-1.5h2m0-1.5v3"></svg:path>`,
})
export class CatppuccinHelmIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHuffIcon],svg[catppuccin-huff-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinHuskyIcon],svg[catppuccin-husky-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaIcon],svg[catppuccin-java-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M10.73 8.41c.57 3 1.59 5.83 2.77 7.09c-6.63-3.45-9.76-1.75-10.5 0c-.66-3.4-.54-5.74.09-7.78"></svg:path><svg:path stroke="#ed8796" d="M8.5 7c.63.34 1.82 1.07 2.24 1.41c-.54-2.9-.64-5.96-.74-7.91c-2.13.58-5.73 1.98-6.9 7.22c.52-.69 1.72-1.05 2.4-1.22"></svg:path><svg:path stroke="#ed8796" d="M5.5 7A1.5 1.5 0 0 0 7 8.5A1.5 1.5 0 0 0 8.5 7A1.5 1.5 0 0 0 7 5.5A1.5 1.5 0 0 0 5.5 7"></svg:path></svg:g>`,
})
export class CatppuccinJavaIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaAlt2Icon],svg[catppuccin-java-alt-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M10.73 8.41c.57 3 1.59 5.83 2.77 7.09c-6.63-3.45-9.76-1.75-10.5 0c-.66-3.4-.54-5.74.09-7.78"></svg:path><svg:path stroke="#c6a0f6" d="M8.5 7c.63.34 1.82 1.07 2.24 1.41c-.54-2.9-.64-5.96-.74-7.91c-2.13.58-5.73 1.98-6.9 7.22c.52-.69 1.72-1.05 2.4-1.22"></svg:path><svg:path stroke="#c6a0f6" d="M5.5 7A1.5 1.5 0 0 0 7 8.5A1.5 1.5 0 0 0 8.5 7A1.5 1.5 0 0 0 7 5.5A1.5 1.5 0 0 0 5.5 7"></svg:path></svg:g>`,
})
export class CatppuccinJavaAlt2Icon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaAlt3Icon],svg[catppuccin-java-alt-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M10.73 8.41c.57 3 1.59 5.83 2.77 7.09c-6.63-3.45-9.76-1.75-10.5 0c-.66-3.4-.54-5.74.09-7.78"></svg:path><svg:path stroke="#eed49f" d="M8.5 7c.63.34 1.82 1.07 2.24 1.41c-.54-2.9-.64-5.96-.74-7.91c-2.13.58-5.73 1.98-6.9 7.22c.52-.69 1.72-1.05 2.4-1.22"></svg:path><svg:path stroke="#eed49f" d="M5.5 7A1.5 1.5 0 0 0 7 8.5A1.5 1.5 0 0 0 8.5 7A1.5 1.5 0 0 0 7 5.5A1.5 1.5 0 0 0 5.5 7"></svg:path></svg:g>`,
})
export class CatppuccinJavaAlt3Icon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaAnnotationIcon],svg[catppuccin-java-annotation-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M10.5 8v1c0 .67.4 1.21.97 1.55c.58.34 1.53.34 2.1 0c.58-.34.94-.95.93-1.62V8a6.5 6.5 0 1 0-2.79 5.33M10.5 8a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0"></svg:path>`,
})
export class CatppuccinJavaAnnotationIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaClassIcon],svg[catppuccin-java-class-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M13.825 10.605V5.393a1.282 1.287 0 0 0-.647-1.116l-4.53-2.605a1.307 1.313 0 0 0-1.295 0L2.822 4.277c-.4.23-.647.657-.647 1.117v5.212c0 .46.246.886.647 1.116l4.53 2.605a1.307 1.313 0 0 0 1.295 0l4.531-2.605c.4-.231.647-.657.647-1.117M8 14.5V8m0 0l5.65-3.276m-11.3 0L8 8"></svg:path>`,
})
export class CatppuccinJavaClassIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaClassAbstractIcon],svg[catppuccin-java-class-abstract-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" d="M13.825 10.605V5.393a1.282 1.287 0 0 0-.647-1.116l-4.53-2.605a1.307 1.313 0 0 0-1.295 0L2.822 4.277c-.4.23-.647.657-.647 1.117v5.212c0 .46.246.886.647 1.116l4.53 2.605a1.307 1.313 0 0 0 1.295 0l4.531-2.605c.4-.231.647-.657.647-1.117M8 14.5V8m0 0l5.65-3.276m-11.3 0L8 8"></svg:path>`,
})
export class CatppuccinJavaClassAbstractIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaClassFinalIcon],svg[catppuccin-java-class-final-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="M13.825 10.605V5.393a1.282 1.287 0 0 0-.647-1.116l-4.53-2.605a1.307 1.313 0 0 0-1.295 0L2.822 4.277c-.4.23-.647.657-.647 1.117v5.212c0 .46.246.886.647 1.116l4.53 2.605a1.307 1.313 0 0 0 1.295 0l4.531-2.605c.4-.231.647-.657.647-1.117M8 14.5V8m0 0l5.65-3.276m-11.3 0L8 8"></svg:path>`,
})
export class CatppuccinJavaClassFinalIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaClassSealedIcon],svg[catppuccin-java-class-sealed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#b7bdf8" stroke-linecap="round" stroke-linejoin="round" d="M13.825 10.605V5.393a1.282 1.287 0 0 0-.647-1.116l-4.53-2.605a1.307 1.313 0 0 0-1.295 0L2.822 4.277c-.4.23-.647.657-.647 1.117v5.212c0 .46.246.886.647 1.116l4.53 2.605a1.307 1.313 0 0 0 1.295 0l4.531-2.605c.4-.231.647-.657.647-1.117M8 14.5V8m0 0l5.65-3.276m-11.3 0L8 8"></svg:path>`,
})
export class CatppuccinJavaClassSealedIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavaJarIcon],svg[catppuccin-java-jar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M10.73 8.41c.57 3 1.59 5.83 2.77 7.09c-6.63-3.45-9.76-1.75-10.5 0c-.66-3.4-.54-5.74.09-7.78"></svg:path><svg:path stroke="#8087a2" d="M8.5 7c.63.34 1.82 1.07 2.24 1.41c-.54-2.9-.64-5.96-.74-7.91c-2.13.58-5.73 1.98-6.9 7.22c.52-.69 1.72-1.05 2.4-1.22"></svg:path><svg:path stroke="#8087a2" d="M5.5 7A1.5 1.5 0 0 0 7 8.5A1.5 1.5 0 0 0 8.5 7A1.5 1.5 0 0 0 7 5.5A1.5 1.5 0 0 0 5.5 7"></svg:path></svg:g>`,
})
export class CatppuccinJavaJarIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavascriptMapIcon],svg[catppuccin-javascript-map-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#ed8796" d="M.5 4.06c0 .77.24 1.52.7 2.13l2.24 3.96l.04.08h0c.13.17.32.27.52.27s.36-.09.48-.23h0l.03-.03l.08-.15l2.2-3.88c.46-.61.71-1.37.71-2.15A3.63 3.63 0 0 0 3.88.5C1.95.5.5 2.1.5 4.06"></svg:path><svg:path stroke="#ed8796" d="M5.5 4A1.5 1.5 0 0 1 4 5.5A1.5 1.5 0 0 1 2.5 4A1.5 1.5 0 0 1 4 2.5A1.5 1.5 0 0 1 5.5 4"></svg:path><svg:path stroke="#eed49f" d="M10 4.5h3.5a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2V13"></svg:path><svg:path stroke="#eed49f" d="M13.5 9c-.33-.33-.83-.5-1.5-.5c-1 0-1.5.5-1.5 1s.5 1 1.5 1s1.5.5 1.5 1s-.5 1-1.5 1c-.67 0-1.17-.17-1.5-.5m-2-3.5v3a1 1 0 1 1-2 0"></svg:path></svg:g>`,
})
export class CatppuccinJavascriptMapIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJavascriptReactIcon],svg[catppuccin-javascript-react-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M8 10.8c4.14 0 7.5-1.25 7.5-2.8S12.14 5.2 8 5.2S.5 6.45.5 8s3.36 2.8 7.5 2.8"></svg:path><svg:path d="M5.52 9.4c2.07 3.5 4.86 5.72 6.23 4.95c1.37-.78.8-4.24-1.27-7.75C8.41 3.1 5.62.88 4.25 1.65c-1.37.78-.8 4.24 1.27 7.75"></svg:path><svg:path d="M5.52 6.6c-2.07 3.5-2.64 6.97-1.27 7.75c1.37.77 4.16-1.45 6.23-4.95s2.64-6.97 1.27-7.75C10.38.88 7.59 3.1 5.52 6.6"></svg:path><svg:path d="M8.5 8a.5.5 0 0 1-.5.5a.5.5 0 0 1-.5-.5a.5.5 0 0 1 .5-.5a.5.5 0 0 1 .5.5"></svg:path></svg:g>`,
})
export class CatppuccinJavascriptReactIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJinjaIcon],svg[catppuccin-jinja-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="M1.5 1.5c3.78 1.03 8.02 1.54 13 0L13 5c-3.5.75-6.5.75-10 0zm0 6.09C6 8.75 10 8.75 14.5 7.5m-9-1.52v8.52m-3 0h4m3 0h4m-3-8.52v8.52M3.5 8v6.5m9-6.5v6.5"></svg:path>`,
})
export class CatppuccinJinjaIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinJsonSchemaIcon],svg[catppuccin-json-schema-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M4 15c-2.4-.6-1.6-2.2-1.6-3.8S2.6 8 1 8c1.6 0 1.4-1.6 1.4-3.2S1.6 1.6 4 1m8 0c2.4.6 1.6 2.2 1.6 3.8S13.4 8 15 8c-1.6 0-1.4 1.6-1.4 3.2s.8 3.2-1.6 3.8M4 5.5C5 5.6 5.8 7 5.8 7s1-3 3.2-4m-.4 6c0 .7.5 1.5.9 2m0 0a11 11 0 0 0 1.5 1.8m-1.5-1.7c.8-.8 1.6-1.5 2.5-2.1m-2.5 2L7 14"></svg:path>`,
})
export class CatppuccinJsonSchemaIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinKdlIcon],svg[catppuccin-kdl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="m6.74 4.996l-1 5.367l2.48.4s2.16.2 2.6-2.262c.44-2.464-1.58-3.184-1.58-3.184z"></svg:path><svg:path fill="none" stroke="#f4dbd6" stroke-linecap="round" stroke-linejoin="round" d="M5.54 4.916L2.04 8.06l3.86 2.483M1.5 5.076l.58 6.008"></svg:path><svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="m11.28 5.357l.32 5.206l2.9-.26"></svg:path>`,
})
export class CatppuccinKdlIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinLatexIcon],svg[catppuccin-latex-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M13 12.5h1.5m-.5-4l-3 4m0-4l3 4m-3.5 0h1m2-4l1.1.01m-4.1-.01h1.42m-4.42 4H9m-1.5-2v4m-.86 0h3.66l.2-.5m-3.75-3.5H10l.5.5M2 13.5h3m-1.5-5v5m-2-3.5l.25-1.5h3.5L5.5 10m4-3.5l2-5l2 5m-3-2h2M9 6.5h1m3 0h1m-9.5-5v5m-1-5h2m-2 5H7l.54-.99"></svg:path>`,
})
export class CatppuccinLatexIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinLernaIcon],svg[catppuccin-lerna-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinLibIcon],svg[catppuccin-lib-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M2.5 1.5h2a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-11a1 1 0 0 1 1-1m4 3h1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1m3.48.4l1.93-.52a.5.5 0 0 1 .62.35l2.33 8.7a.5.5 0 0 1-.36.6l-1.93.53a.5.5 0 0 1-.61-.36L9.63 5.5a.5.5 0 0 1 .35-.6"></svg:path>`,
})
export class CatppuccinLibIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinLintStagedIcon],svg[catppuccin-lint-staged-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#f5a97f" d="M4.28 8.2c-.01.02.13.2.38.36c.14.08.3.14.45.16m.45-2.92c-.03.02.56.77 1.42.45"></svg:path><svg:path stroke="#f5a97f" d="M3.6 10.45a2 2 0 0 1-.05-.2C3.4 9.69 3.5 9 4.4 8.45c-.67-1.23.66-2.56 1.13-2.6c.24 0-.17-2.8 2.84-2.35m.35 1.51c-.16-.14-.97-.54-.35-1.4m2.56 4.72s.1-.33 0-.74a.9.9 0 0 0-.1-.32"></svg:path><svg:path stroke="#f5a97f" d="M6.42 11.5h4.96c.6.07 2.03-1.64-.42-3.21c-.56.63-1.12 1.2-2.09 1.05"></svg:path><svg:path stroke="#ed8796" d="M14.5 8A6.5 6.5 0 0 1 8 14.5A6.5 6.5 0 0 1 1.5 8A6.5 6.5 0 0 1 8 1.5A6.5 6.5 0 0 1 14.5 8m-11 4.5l9-9"></svg:path></svg:g>`,
})
export class CatppuccinLintStagedIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinLiquidIcon],svg[catppuccin-liquid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMakefileIcon],svg[catppuccin-makefile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#f5a97f" d="m9.24 8.47l-5.28 5.58c-.56.6-1.47.6-2.04 0a1.57 1.57 0 0 1 0-2.14L7.2 6.32"></svg:path><svg:path stroke="#cad3f5" d="m13.74 8.03l-.86-.93a2.46 2.46 0 0 1-.64-1.68v-.65l-1.89-2.04A3.7 3.7 0 0 0 7.63 1.5H5.5l.64.61A4.72 4.72 0 0 1 7.5 5.57v1.16l1.46 1.5h1.71l1.57 1.42m-.74.85l3-3"></svg:path></svg:g>`,
})
export class CatppuccinMakefileIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMarkdownIcon],svg[catppuccin-markdown-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#7dc4e4" stroke-linecap="round" stroke-linejoin="round" d="m9.25 8.25l2.25 2.25l2.25-2.25M3.5 11V5.5l2.04 3l1.96-3V11m4-.5V5M1.65 2.5h12.7c.59 0 1.15.49 1.15 1v9c0 .51-.56 1-1.15 1H1.65c-.59 0-1.15-.49-1.15-1V3.58c0-.5.56-1.08 1.15-1.08"></svg:path>`,
})
export class CatppuccinMarkdownIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMarkdownMdxIcon],svg[catppuccin-markdown-mdx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="m9.25 8.25l2.25 2.25l2.25-2.25M3.5 11V5.5l2.04 3l1.96-3V11m4-.5V5M1.65 2.5h12.7c.59 0 1.15.49 1.15 1v9c0 .51-.56 1-1.15 1H1.65c-.59 0-1.15-.49-1.15-1V3.58c0-.5.56-1.08 1.15-1.08"></svg:path>`,
})
export class CatppuccinMarkdownMdxIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMatlabIcon],svg[catppuccin-matlab-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#7dc4e4" d="M4 11L.5 8.5L5 7q.78-1.77 1.89-1.89c.74-.07 1.94-1.28 3.61-3.61M5 7l1.5 1.5"></svg:path><svg:path stroke="#f5a97f" d="m15.5 12.5l-5-11C8.5 6.83 6.33 10 4 11c1.67-.33 2.67.83 3 3.5c3.5-1.5 3.5-3.5 5-4s1.5 1.5 3.5 2"></svg:path></svg:g>`,
})
export class CatppuccinMatlabIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMdbookIcon],svg[catppuccin-mdbook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m15.5 4.39l-2.794 8.978s-.399 1.464-1.596 1.464H2.33S.5 14.233.5 13.002c0-1.23 4.024-11.207 4.024-11.207s.177-.627 1.087-.627s7.095.029 7.095.029s1.597-.067 1.098 1.097c-.5 1.164-2.76 9.212-2.76 9.212s-.2 1.13-1.331 1.13s-9.02-.107-9.02-.107"></svg:path><svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m5.977 5.964l1.166-3.316l.714 2.85l2.49-2.693l-.943 3.402M5.538 7.712l-1.035 3.08s3.55.687 4.098-1.125s-3.063-1.955-3.063-1.955"></svg:path>`,
})
export class CatppuccinMdbookIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinMesonIcon],svg[catppuccin-meson-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M8 1.5C4 3.75 1.5 8 1.5 12.74C5 15 11 15 14.5 12.75C14.5 8 12 3.75 8 1.5"></svg:path><svg:path d="M10.43 8.55c-.11.74-.8 1.95-1.67 2.74c.12.18.18.39.18.6c-.55.3-1.09-.03-1.74-.62a5.77 5.77 0 0 1-1.6-2.96a.9.9 0 0 1-.6-.14c.05-.68.73-1.08 1.34-1.32a5.8 5.8 0 0 1 3.29.1c.08-.2.23-.35.4-.45c.58.4.5 1.38.4 2.05"></svg:path></svg:g>`,
})
export class CatppuccinMesonIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestIcon],svg[catppuccin-nest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestControllerIcon],svg[catppuccin-nest-controller-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestControllerIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestDecoratorIcon],svg[catppuccin-nest-decorator-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestDecoratorIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestFilterIcon],svg[catppuccin-nest-filter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestFilterIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestGuardIcon],svg[catppuccin-nest-guard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinNestGuardIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestMiddlewareIcon],svg[catppuccin-nest-middleware-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#b7bdf8" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestMiddlewareIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestPipeIcon],svg[catppuccin-nest-pipe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestPipeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNestServiceIcon],svg[catppuccin-nest-service-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="m11.5 15.5l.5-3.47C10.5 16 8.34 15.28 7.52 15.5c-.23.06 1.67-.48 2.48-2c-.9.33-1.56.5-1.98.5c1.42-1.23 1.91-2.4 1.5-3.5c-.34 2.33-4.61 4.11-5.53 2.06c-.6-1.37-.28-2.23.97-2.57c0 1.06.51 1.59 1.54 1.59V10.5l1.97.91C8.16 8.14 6 6.83 2 7.5C1 6.35.5 5.52.5 5c0-.78.25-1 1-1s1-.02 2.03-1.05C5.09 1.46 7.1 1.1 9.5 2.57Q9.17 1.625 10.55.5c1.48.73 2.13 1.73 1.94 3s-1.02 1.94-2.5 2c.49.37 1.15.37 2 0a2.41 2.41 0 0 0 1.48-2c1.35 1.67 2.02 3.33 2.02 5s-.35 3.02-1.04 4.06l-.5-2.06c-.98 3.5-1.56 4.3-2.47 5Z"></svg:path>`,
})
export class CatppuccinNestServiceIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNextflowIcon],svg[catppuccin-nextflow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNimIcon],svg[catppuccin-nim-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNixLockIcon],svg[catppuccin-nix-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#7dc4e4" d="M.5 7.5H4m1.39-2L2.05 11"></svg:path><svg:path stroke="#8aadf4" d="M4 1.5L5.5 4m3.5.5H2.55"></svg:path><svg:path stroke="#7dc4e4" d="m12 1.5l-1.5 3m1.01 2.6L8.5 1.5"></svg:path><svg:path stroke="#8aadf4" d="m12.733 7.063l.422-.688L14 5"></svg:path><svg:path stroke="#7dc4e4" d="m7.03 11.52l.81-.002"></svg:path><svg:path stroke="#8aadf4" d="m4 14.5l1.5-3M4.53 9l2.97 5.5"></svg:path></svg:g><svg:path fill="none" stroke="#8087a2" d="M15 11.5c.27 0 .5.22.5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3c0-.28.22-.5.5-.5zm-4 0V10a1.5 1.5 0 0 1 3 0v1.5"></svg:path>`,
})
export class CatppuccinNixLockIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNodemonIcon],svg[catppuccin-nodemon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinNuxtIcon],svg[catppuccin-nuxt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#a6da95" stroke-linecap="round" stroke-linejoin="round" d="M9.5 12.5h6l-5-7L7.44 11c-.67.98-1.32 1.48-1.94 1.5h-5l5-9l3 5"></svg:path>`,
})
export class CatppuccinNuxtIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinOcamlIcon],svg[catppuccin-ocaml-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M1.5 8V3c0-.83.67-1.5 1.5-1.5h10c.83 0 1.5.67 1.5 1.5v10c0 .83-.67 1.5-1.5 1.5H9"></svg:path><svg:path d="m1.5 8l1.14-2.3q.09-.21.36-.24a.8.8 0 0 1 .44.13c.18.12.23.53.28.64c.06.1.64 1.23.85 1.23c.2 0 .71-1.47.71-1.47s.37-.49.72-.49s.55.32.67.49c.12.16.24 1.76.46 2.01s1.32.87 1.67.73c.34-.13.53-.4.63-.73c.1-.34-.14-.75 0-1a1.1 1.1 0 0 1 1.02-.55c.56.03 2.05.56 2.05 1.05q0 .75-1.5.75c-.48 1.33.28 2.22-3 2.25l1 4"></svg:path><svg:path d="m4.5 14.5l1.5-4l1 4zm-2 0l1.5-4l-1.5-.5l-1 1.54V14l1 .49Z"></svg:path></svg:g>`,
})
export class CatppuccinOcamlIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinOrgIcon],svg[catppuccin-org-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M2.287 10.409C1.95 11.15.888 12.95 2 15.48M9.56 9.5s-1.911 2.816 1.085 5.55m-.372-11.662L13.5.5l-1.96 3.986"></svg:path><svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M8 7.467c.344 2.288 2.827 1.646 3.575 1.66c.094.003.346.157.425.208l.994.47c.116.073.264.124.389.069l.467-.207a.77.77 0 0 0 .603-.673l.049-.461a.77.77 0 0 0-.206-.612L11.5 4.5l-1.5-1v-2s-2.19.261-2 1.925c0 0-4.434 1.764-1.513 5.867c0 0 .79 1.51.018 3.16"></svg:path><svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M8 3s-6.4.163-4 6"></svg:path><svg:path fill="none" stroke="#8bd5ca" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M3.526 6s-3.462 2.329-.025 6c0 0 .979 1.518.499 3.497"></svg:path>`,
})
export class CatppuccinOrgIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPackageJsonIcon],svg[catppuccin-package-json-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#a6da95" stroke-linecap="round" stroke-linejoin="round" d="M11.5 6.5v-.17c0-.73-.6-1.33-1.33-1.33H9a1.5 1.5 0 1 0 0 3h1a1.5 1.5 0 0 1 0 3H9a1.5 1.5 0 0 1-1.5-1.5M5.5 5v4.5c0 1.5-.08 1.87-.71 2.5c-.5.5-1.5.5-1.5.5c-.96-.4-1.2-.66-1.79-1v-7L8 .5l6.5 4v7l-6.5 4l-2.49-1.53"></svg:path>`,
})
export class CatppuccinPackageJsonIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPandaCssIcon],svg[catppuccin-panda-css-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M7.18 1.55c-.7.08-1.36.22-2 .47a5.27 5.27 0 0 0-3.05 2.84c-.45 1-.61 2.05-.63 3.14c-.02 1.15.12 2.28.35 3.4c.2 1.02.47 2.02.86 2.98c.03.09.08.12.18.12h4.74a2 2 0 0 0 .14 0l-.02-.06l-.3-.66c-.2-.41-.4-.83-.57-1.25A13.6 13.6 0 0 1 5.8 8.5a5.1 5.1 0 0 1 .12-1.84c.2-.69.6-1.17 1.29-1.38a3.1 3.1 0 0 1 1.89.02c.55.19.92.58 1.07 1.16c.12.45.12.9.03 1.35c-.07.35-.2.66-.46.92c-.45.45-1 .56-1.61.52l-.33-.03l-.15-.02v.13c.04.1.06.21.08.32c.06.25.12.5.2.76c.15.48.32.96.52 1.43a8.74 8.74 0 0 0 4.05-1.3l.06-.04a3.87 3.87 0 0 0 1.39-1.48c.53-1.02.63-2.1.47-3.22a4.54 4.54 0 0 0-1.54-2.88a5.4 5.4 0 0 0-2.06-1.1c-1.2-.34-2.41-.39-3.65-.28Z"></svg:path>`,
})
export class CatppuccinPandaCssIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPdfIcon],svg[catppuccin-pdf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="M2.8 14.34c1.81-1.25 3.02-3.16 3.91-5.5c.9-2.33 1.86-4.33 1.44-6.63c-.06-.36-.57-.73-.83-.7c-1.02.06-.95 1.21-.85 1.9c.24 1.71 1.56 3.7 2.84 5.56c1.27 1.87 2.32 2.16 3.78 2.26c.5.03 1.25-.14 1.37-.58c.77-2.8-9.02-.54-12.28 2.08c-.4.33-.86 1-.6 1.46c.2.36.87.4 1.23.15h0Z"></svg:path>`,
})
export class CatppuccinPdfIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPerlIcon],svg[catppuccin-perl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M12.5 14.5v-3.34c-1-.66-1-1.35-1-2.66m-3 1l.02 2.53l.98 2.47m-4-5v5m9 0V9.23s.17-1.73-1-1.73c0-1.5-.5-6-2.5-6S8.75 4.25 8.75 4.25A3.67 3.67 0 0 0 6.5 7.12v-3.5c0-.63-.85-1.32-1.5-1.32c-.92 0-1.33.59-1.5 1.2H2.25c-.42.11-.75.59-.75 1c0 .5.28 1 .75 1h1.22l.02 3c.01.75.51 1 1.51 1h4.5"></svg:path>`,
})
export class CatppuccinPerlIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPhpIcon],svg[catppuccin-php-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M.5 12.5v.74c0 .76.774 1.26 1.5 1.26c.938 0 1.5-.5 1.5-1.255V6c0-1.715 1.494-3.478 3.65-3.501c2.344 0 3.85 1.558 3.85 3c.166 2.99-1.422 4.137-3.504 5v4h8.002V9c.041-.635-.56-1.844-1.367-2.5c-.937-.692-2.073-.997-3.131-1m.5 9v-3M6 6.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"></svg:path>`,
})
export class CatppuccinPhpIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPixiIcon],svg[catppuccin-pixi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m6.702 5.889l5.046 6.426"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="m3.71 3.786l-.396-2.149l2.03.843L7.39 1.5l-.275 2.149l1.772 1.667l-2.392.24l-.808 2.132L4.569 5.78l-2.288-.24Zm4.995 6.005s-.656.559-1.192.073s.145-1.474.633-1.945s1.54-1.07 2.015-.594c.696.7-.268 1.382-.268 1.382"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M10.31 11.076s-1.132 1.025-1.817.447c-.684-.578.185-1.752.81-2.312c.623-.56 1.928-1.272 2.487-.665s-.806 1.956-.806 1.956"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M11.93 13.037s-1.508 1.326-2.33.621s.221-2.136.971-2.818c.75-.683 2.318-1.55 2.991-.81s-.979 2.331-.979 2.331"></svg:path><svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="m11.785 12.358l1.682 2.142"></svg:path>`,
})
export class CatppuccinPixiIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPixiLockIcon],svg[catppuccin-pixi-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8087a2" d="M15 11.5c.27 0 .5.22.5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3c0-.28.22-.5.5-.5zm-4 0V10a1.5 1.5 0 0 1 3 0v1.5"></svg:path><svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M5.043 4.989L9.146 9.94"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="m2.39 3.123l-.35-1.907l1.799.747l1.814-.87l-.244 1.908l1.57 1.48l-2.119.213l-.716 1.892l-.991-1.694l-2.028-.213Zm4.428 5.33s-.582.495-1.057.064c-.474-.432.128-1.308.56-1.726s1.366-.95 1.787-.527c.616.62-.238 1.226-.238 1.226"></svg:path><svg:path fill="none" stroke="#eed49f" stroke-linecap="round" stroke-linejoin="round" d="M8.59 9.358s-1.354 1.145-1.96.632c-.607-.513.164-1.555.716-2.052c.553-.498 1.71-1.129 2.205-.59c.497.538-.965 2.003-.965 2.003"></svg:path>`,
})
export class CatppuccinPixiLockIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPlaywrightIcon],svg[catppuccin-playwright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#ed8796" d="M5 9.5c-1.02.35-1.5 1-1.5 1"></svg:path><svg:path stroke="#ed8796" d="m5.97 12.36l-.1.03c-2.98.8-4.55-2.64-5.03-4.43C.62 7.13.53 6.28.5 5.88c-.03-.46.29-.33.89-.23a6.5 6.5 0 0 0 2.7-.17c.52-.14 1.26-.4 1.74-.65"></svg:path><svg:path stroke="#ed8796" d="M2.5 7.5s.36.56 1.18.31C4.5 7.57 4.5 7 4.5 7"></svg:path><svg:path stroke="#a6da95" d="M15.05 7.57c-.62 2.33-2.67 6.81-6.52 5.78C4.68 12.3 5.14 7.4 5.77 5.08c.28-1.07.58-1.84.81-2.31c.27-.54.53-.18 1.14.32a8.4 8.4 0 0 0 3.14 1.56a8.4 8.4 0 0 0 3.49.22c.78-.13 1.19-.3 1.15.29c-.04.52-.16 1.33-.45 2.4Z"></svg:path><svg:path stroke="#a6da95" d="M9.5 7.5s0-.82-.72-1.08s-1.28.08-1.28.08m0 3S8 11 9.21 11.33c1.21.34 2.29-.83 2.29-.83M13 9s.18-.87-.58-1.23C11.66 7.4 11 8 11 8"></svg:path></svg:g>`,
})
export class CatppuccinPlaywrightIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPremakeIcon],svg[catppuccin-premake-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#a6da95" d="m11.05 4.4l-.72-.2l-.06-.9l-.8-.1l-.17.96l-.7.17l-.45-.93l-1.05.32l.39.96l-.37.47l-.9-.38l-.5.6l1.2 1.54m4.62-3.13s-1 1.74-1.77 2.27c-.76.53-1.42 1.14-3.9.84c-2.5-.3-3.9.04-4.2.38s-.25 1.07.58 1.51c.82.44 1.94.8 1.94.8"></svg:path><svg:path stroke="#eed49f" d="m11.86 10.7l.54-.52l.78.42l.5-.65l-.7-.65l.22-.7l1 .1l.3-1.08l-1.01-.17l-.2-.56l.8-.59l-.23-.74l-1.92.22m.17 5.67s-.92-1.8-.96-2.73c-.03-.94-.2-1.83 1.36-3.84c1.55-2 2-3.4 1.89-3.85c-.12-.44-.76-.78-1.56-.3c-.8.5-1.55 1.45-1.55 1.45"></svg:path><svg:path stroke="#8aadf4" d="m6.12 8.41l.18.74l-.75.5l.29.76l.9-.3l.49.54l-.58.84l.77.8l.64-.82l.58.12l.1 1l.74.16l.77-1.82m-4.9-2.67s1.99.08 2.8.51c.8.44 1.66.74 2.58 3.12c.93 2.37 1.89 3.47 2.32 3.6c.44.11 1.04-.3 1.03-1.25c0-.95-.35-2.1-.35-2.1"></svg:path></svg:g>`,
})
export class CatppuccinPremakeIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPrologIcon],svg[catppuccin-prolog-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="M4.5 13.5c-.33.33-.5.67-.5 1s.17.67.5 1c.17-.67.5-1 1-1s.83.33 1 1c.33-.33.5-.83.5-1.5h2c0 .67.17 1.17.5 1.5c.17-.67.5-1 1-1s.83.33 1 1c.33-.33.5-.67.5-1s-.17-.67-.5-1l1-1l1.25 1.25c0-2.75 1-2.75 1-5.75a7.1 7.1 0 0 0-2-5.25A3.64 3.64 0 0 1 13 .5c-1.17 0-2 .42-2.5 1.25A3.08 3.08 0 0 0 8 .5c-1 0-1.83.42-2.5 1.25C5 .92 4.17.5 3 .5c.5.83.58 1.58.25 2.25a7.1 7.1 0 0 0-2 5.25c0 3 1 3 1 5.75L3.5 12.5zm6-5a2 2 0 1 0 0-4a2 2 0 0 0 0 4m-5 0a2 2 0 1 0 0-4a2 2 0 0 0 0 4M7 8l1 2.5L9 8m1.5-1.5"></svg:path>`,
})
export class CatppuccinPrologIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPugIcon],svg[catppuccin-pug-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinPythonIcon],svg[catppuccin-python-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#8aadf4" d="M8.5 5.5h-3m6 0V3c0-.8-.7-1.5-1.5-1.5H7c-.8 0-1.5.7-1.5 1.5v2.5H3c-.8 0-1.5.7-1.5 1.5v2c0 .8.7 1.5 1.48 1.5"></svg:path><svg:path stroke="#eed49f" d="M10.5 10.5h-3m-3 0V13c0 .8.7 1.5 1.5 1.5h3c.8 0 1.5-.7 1.5-1.5v-2.5H13c.8 0 1.5-.7 1.5-1.5V7c0-.8-.7-1.5-1.48-1.5H11.5c0 1.5 0 2-1 2h-2"></svg:path><svg:path stroke="#8aadf4" d="M2.98 10.5H4.5c0-1.5 0-2 1-2h2m0-5"></svg:path></svg:g>`,
})
export class CatppuccinPythonIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRIcon],svg[catppuccin-r-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#8087a2" d="M13.5 9.5c.63-.7 1-1.54 1-2.43c0-2.52-2.91-4.57-6.5-4.57S1.5 4.55 1.5 7.07c0 1.9 1.65 3.53 4 4.22"></svg:path><svg:path stroke="#8aadf4" d="M10.5 9.5c.4 0 .86.34 1 .7l1 3.3m-5 0v-8h3.05c.95 0 1.95 1 1.95 2s-1 2-1.95 2H7.5Z"></svg:path></svg:g>`,
})
export class CatppuccinRIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRazorIcon],svg[catppuccin-razor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CatppuccinRazorIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRedwoodIcon],svg[catppuccin-redwood-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRemixIcon],svg[catppuccin-remix-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M10.5 14.5c0-1.67 0-3-2-3h-6v-3h6.63c.97 0 1.37-.67 1.37-1.5s-.32-1.5-1.38-1.5H2.5v-3h8c2.4 0 3 2.33 3 4s-.67 2.5-2 3.5c1.33.66 2 2.17 2 4.5m-11 0H8"></svg:path>`,
})
export class CatppuccinRemixIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRenovateIcon],svg[catppuccin-renovate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M11.28 11.04c-.2-.3-.33-.53-.25-.85c.05-.2.17-.38.31-.52C12.62 8.41 13.76 7.32 14.8 6c.09-.12.13-.27.17-.41c.03-.12.03-.25.03-.38c0-.12-.01-.24-.05-.35a6.9 6.9 0 0 0-1.4-2.18c-.14-.1-.28-.2-.44-.27a1.1 1.1 0 0 0-.36-.09c-.16 0-.33.01-.48.05c-.17.05-.29.13-.46.23m.31 12.15l-1.34-2.26a.7.7 0 0 1-.08-.56a.73.73 0 0 1 .35-.44l.77-.43a.77.77 0 0 1 1.02.27l1.34 2.26"></svg:path><svg:path stroke="#8bd5ca" d="m2.63 5.4l6.41-3.6c.91-.52 2.06-.2 2.59.69A1.83 1.83 0 0 1 10.95 5L4.54 8.62c-.9.51-2.06.2-2.59-.7a1.83 1.83 0 0 1 .68-2.52"></svg:path></svg:g>`,
})
export class CatppuccinRenovateIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRollupIcon],svg[catppuccin-rollup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#ed8796" d="M4.37 14.5h9.13l-2-5c1.36-1.08 2-2.13 2-4c0-2.4-2.25-3.97-4-4h-7v11.3"></svg:path><svg:path stroke="#eed49f" d="M11.46 6.2c-3.25 3.32-4.37 4.25-7.2 8.3c-1.03-.13-1.67-.61-1.74-1.55c-.36-.35 4.87-8.22 5.42-9.16c.6-1 2.55-2.22 3.78-1.4c-1.18-.38-2.58.56-2.41 1.5l.47 1.89c.34.58.66.8 1.18.73c.56-.16.67-.53.63-1l-.36-.99"></svg:path></svg:g>`,
})
export class CatppuccinRollupIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRubyIcon],svg[catppuccin-ruby-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="M1.5 9.06v2.5c.02.86.36 1.61.9 2.15c1.76 1.76 5.71.65 8.84-2.47c3.12-3.13 4.23-7.08 2.47-8.84a3.1 3.1 0 0 0-2.15-.9h-2.5M14.5 4l-.25 10.25L4 14.5m4.39-6.11c2.34-2.35 3.29-5.2 2.12-6.37S6.49 1.8 4.14 4.14C1.8 6.5.85 9.34 2.02 10.51s4.02.22 6.37-2.12M5.5 14.5l.25-3.75L11 11l-.25-5.25l3.75-.25"></svg:path>`,
})
export class CatppuccinRubyIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRubyGemLockIcon],svg[catppuccin-ruby-gem-lock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#ed8796" d="m6 10.5l3.5-4l-1.5-2H4l-1.5 2z"></svg:path><svg:path stroke="#ed8796" d="M7.5 12.68L6 13.5l-5.5-3v-7L6 .5l5.5 3v3"></svg:path><svg:path stroke="#8087a2" d="M15 11.5c.27 0 .5.22.5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3c0-.28.22-.5.5-.5zm-4 0V10a1.5 1.5 0 0 1 3 0v1.5"></svg:path></svg:g>`,
})
export class CatppuccinRubyGemLockIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRuffIcon],svg[catppuccin-ruff-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinRustConfigIcon],svg[catppuccin-rust-config-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8087a2" stroke-linecap="round" stroke-linejoin="round" d="M11.5 13.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m1.75-4l1.75 3l-1.75 3h-3.5L8 12.5l1.75-3z"></svg:path><svg:g fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.252"><svg:path d="M15.5 9.5Q8 13.505.5 9.5l1-1l-1-2l2-.5V4.5h2l.5-2l1.5 1l1.5-2l1.5 2l1.5-1l.5 2h2V6l2 .5l-1 2z" transform="matrix(.79989 0 0 .79796 .1 -.697)"></svg:path><svg:path d="M6.5 7.5a1 1 0 1 1-2 0a1 1 0 0 1 2 0m5 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0M4 11.02c-.67.37-1.5.98-1.5 2.23s1.22 1.22 2 1.25v-2M12 11c.168.093.345.201.517.332" transform="matrix(.79989 0 0 .79796 .1 -.697)"></svg:path></svg:g>`,
})
export class CatppuccinRustConfigIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSalesforceIcon],svg[catppuccin-salesforce-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#91d7e3" stroke-linecap="round" stroke-linejoin="round" d="M12.058 4.418c-.445 0-.833.133-1.215.26c-.445-.77-1.279-1.278-2.176-1.278c-.7 0-1.336.318-1.788.763C6.37 3.527 5.6 3.075 4.71 3.075c-1.482 0-2.755 1.216-2.755 2.698c0 .375.134.757.261 1.139A2.34 2.34 0 0 0 1 8.954c0 1.273 1.024 2.367 2.303 2.367c.191 0 .382 0 .51-.063c.254.96 1.215 1.667 2.366 1.667c1.082 0 1.979-.643 2.297-1.54c.325.134.643.26.96.26c.834 0 1.598-.464 1.98-1.15c.197.05.4.05.579.05c1.66 0 3.003-1.33 3.003-3.054a2.93 2.93 0 0 0-2.94-3.073"></svg:path>`,
})
export class CatppuccinSalesforceIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSecurityIcon],svg[catppuccin-security-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f0c6c6" stroke-linecap="round" stroke-linejoin="round" d="M4.75 5.738h.007m6.33 1.941H14.5l-2.275 4.53l-2.008-2.796"></svg:path><svg:path fill="none" stroke="#f0c6c6" stroke-linecap="round" stroke-linejoin="round" d="m11.9 6.061l-2.6 5.177l-6.753-3.365a1.898 1.89 0 0 1-.845-2.53l.897-1.805a1.898 1.89 0 0 1 2.548-.842ZM1.5 12.21h2.444a1.3 1.294 0 0 0 1.17-.712L6.05 9.62M1.5 13.503v-2.588"></svg:path>`,
})
export class CatppuccinSecurityIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSemanticReleaseIcon],svg[catppuccin-semantic-release-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M1.5 11.5v-7L8 .5l6.5 4v7l-6.5 4zm6.5-2a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M1.75 7Q2.5 8.5 4 8.5m0 4.41c1.13.07 1.93-.33 2.43-1.2m3.83 2.2c.62-.93.67-1.83.17-2.7M14.25 9Q13.5 7.5 12 7.5m0-4.41c-1.13-.07-1.93.33-2.43 1.2m-3.83-2.2c-.62.93-.67 1.83-.17 2.7"></svg:path>`,
})
export class CatppuccinSemanticReleaseIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSentryIcon],svg[catppuccin-sentry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinServerlessIcon],svg[catppuccin-serverless-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#ed8796" stroke-linecap="round" stroke-linejoin="round" d="m6.5 11.5l-1 2h9v-2zm2-4l-1 2h7v-2zm2-4l-1 2h5v-2zm-8 10l1-2h-2v2zm2-4l1-2h-4v2zm2-4l1-2h-6v2z"></svg:path>`,
})
export class CatppuccinServerlessIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinShaderIcon],svg[catppuccin-shader-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#c6a0f6" stroke-linecap="round" stroke-linejoin="round" d="M6.41 12c0 .9-.47 1.72-1.23 2.17c-.76.44-1.7.44-2.45 0A2.5 2.5 0 0 1 1.5 12c0-1.38 1.1-2.5 2.46-2.5A2.48 2.48 0 0 1 6.4 12h0Zm3.78-7.23A2.85 2.85 0 0 0 4.6 3.6a2.9 2.9 0 0 0 1.77 3.5c2.19.88 2.7 1.75 2.43 4.13a2.85 2.85 0 0 0 5.58 1.17a2.9 2.9 0 0 0-1.77-3.5c-2.19-.88-2.7-1.76-2.43-4.13h0Z"></svg:path>`,
})
export class CatppuccinShaderIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSketchIcon],svg[catppuccin-sketch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#f5a97f" stroke-linecap="round" stroke-linejoin="round" d="m.7 6.9l6.67 7.32c.34.37.91.37 1.24 0l6.67-7.32c.26-.29.3-.72.07-1.04l-2.94-4a.83.83 0 0 0-.69-.36H4.28a.83.83 0 0 0-.68.36l-2.95 4A.84.84 0 0 0 .72 6.9zm1.8-.4h11m-1.5 0L9 3M4 6.5L7 3m0 8.5l-3-5m8 0l-3 5m3-5l-.5-3M4 6.5l.5-3"></svg:path>`,
})
export class CatppuccinSketchIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSolidIcon],svg[catppuccin-solid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M1.5 11.575Q6.05 14.5 8 14.5c1.625 0 2.6-.975 2.6-2.275S9.625 9.95 8 9.95q-1.95 0-6.5 1.625"></svg:path><svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M3.45 8.975Q8 7.35 9.95 7.35c1.625 0 2.6.975 2.6 2.275c0 .48-.133.915-.382 1.274l-1.874 2.486m4.206-8.96C11.9 2.475 9.3 1.5 8 1.5c-1.326 0-1.702.301-2.222 1.004M1.5 11.575l1.95-2.6m11.05-4.55l-1.95 2.6m-6.772-4.52l-1.92 2.411"></svg:path><svg:path fill="none" stroke="#8aadf4" stroke-linecap="round" stroke-linejoin="round" d="M5.02 8.43c-.981-.31-1.57-.961-1.57-2.055c0-1.625.975-2.275 2.6-2.275c1.097 0 3.307.694 5.329 2.083a75 75 0 0 1 1.171.842l-1.496.51"></svg:path>`,
})
export class CatppuccinSolidIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSpwnIcon],svg[catppuccin-spwn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none"><svg:path stroke="#a6da95" d="M5.5 6a4.5 4.5 0 1 0 4.5 4.5"></svg:path><svg:path stroke="#f5bde6" d="M10 11a5 5 0 1 0-5-5"></svg:path><svg:path stroke="#cad3f5" d="m8.803 10.096l-.353-.353l-.354.353l-1.914 1.914a.5.5 0 0 1-.707 0L4.06 10.596a.5.5 0 0 1 0-.707l1.914-1.914l.353-.354l-.353-.353l-.914-.914a.5.5 0 0 1 .353-.854H10a.5.5 0 0 1 .5.5v4.586a.5.5 0 0 1-.854.353z"></svg:path></svg:g>`,
})
export class CatppuccinSpwnIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinStorybookIcon],svg[catppuccin-storybook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M6.5 10.1c.45 1.05 1.23 1.4 2.46 1.4h-.21c1.35 0 2.25-.68 2.25-1.7c0-.84-.62-1.26-1.61-1.64L7.91 7.6c-.86-.33-1.41-1-1.41-1.73c0-.68.78-1.26 1.67-1.33l.36-.03c1.14-.1 2.24.53 2.47 1.39"></svg:path><svg:path stroke="#f5bde6" d="M3.5 2.5L4 14l9.5.5v-13zm8-.75v1.5"></svg:path></svg:g>`,
})
export class CatppuccinStorybookIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinStorybookSvelteIcon],svg[catppuccin-storybook-svelte-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke-linecap="round" stroke-linejoin="round"><svg:path stroke="#cad3f5" d="M6.5 10.1c.45 1.05 1.23 1.4 2.46 1.4h-.21c1.35 0 2.25-.68 2.25-1.7c0-.84-.62-1.26-1.61-1.64L7.91 7.6c-.86-.33-1.41-1-1.41-1.73c0-.68.78-1.26 1.67-1.33l.36-.03c1.14-.1 2.24.53 2.47 1.39"></svg:path><svg:path stroke="#f5a97f" d="M3.5 2.5L4 14l9.5.5v-13zm8-.75v1.5"></svg:path></svg:g>`,
})
export class CatppuccinStorybookSvelteIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinStylelintIcon],svg[catppuccin-stylelint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[catppuccinSuperColliderIcon],svg[catppuccin-super-collider-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="#cad3f5" stroke-linecap="round" stroke-linejoin="round" d="M1.5 4.616v6.952l5.116 2.781V7.481L3.138 5.638V9.91l1.89.971V9.122l-.455-.217m3.85 5.595V7.698L14.5 5.822v6.785l-4.086 1.24V9.524l2.161-.57v1.76l-.574.1m2.195-6.55L8.794 1.5L2.496 3.31l4.998 2.646l4.423-1.223l-3.275-1.759l-2.28.704l1.25.754l.692-.218"></svg:path>`,
})
export class CatppuccinSuperColliderIcon {
  readonly viewBox = input("0 0 16 16")
  readonly width = input("1em")
  readonly height = input("1em")
}
