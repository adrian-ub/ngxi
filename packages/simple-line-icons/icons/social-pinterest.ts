...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsSocialPinterestIcon],svg[simple-line-icons-social-pinterest-icon]',
  host: {
    role: 'img',
