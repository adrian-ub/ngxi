...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsBasketLoadedIcon],svg[simple-line-icons-basket-loaded-icon]',
  host: {
    role: 'img',
