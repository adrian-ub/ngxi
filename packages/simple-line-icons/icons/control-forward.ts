...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsControlForwardIcon],svg[simple-line-icons-control-forward-icon]',
  host: {
    role: 'img',
