...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsLocationPinIcon],svg[simple-line-icons-location-pin-icon]',
  host: {
    role: 'img',
