...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsSymbolMaleIcon],svg[simple-line-icons-symbol-male-icon]',
  host: {
    role: 'img',
