...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsPaperPlaneIcon],svg[simple-line-icons-paper-plane-icon]',
  host: {
    role: 'img',
