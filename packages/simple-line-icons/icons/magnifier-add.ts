...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsMagnifierAddIcon],svg[simple-line-icons-magnifier-add-icon]',
  host: {
    role: 'img',
