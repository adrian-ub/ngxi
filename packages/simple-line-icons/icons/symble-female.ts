...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsSymbleFemaleIcon],svg[simple-line-icons-symble-female-icon]',
  host: {
    role: 'img',
