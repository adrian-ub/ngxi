...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsSocialInstagramIcon],svg[simple-line-icons-social-instagram-icon]',
  host: {
    role: 'img',
