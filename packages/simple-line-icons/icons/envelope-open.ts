...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsEnvelopeOpenIcon],svg[simple-line-icons-envelope-open-icon]',
  host: {
    role: 'img',
