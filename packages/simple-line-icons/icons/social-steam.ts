...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsSocialSteamIcon],svg[simple-line-icons-social-steam-icon]',
  host: {
    role: 'img',
