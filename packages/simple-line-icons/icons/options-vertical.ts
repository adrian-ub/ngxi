...
@Component({
  standalone: true,
  selector: 'svg[simpleLineIconsOptionsVerticalIcon],svg[simple-line-icons-options-vertical-icon]',
  host: {
    role: 'img',
