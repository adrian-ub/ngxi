...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRibbonIcon],svg[fluent-emoji-high-contrast-ribbon-icon]',
  host: {
    role: 'img',
