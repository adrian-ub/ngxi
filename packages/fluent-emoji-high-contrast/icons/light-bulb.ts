...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLightBulbIcon],svg[fluent-emoji-high-contrast-light-bulb-icon]',
  host: {
    role: 'img',
