...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOpenFileFolderIcon],svg[fluent-emoji-high-contrast-open-file-folder-icon]',
  host: {
    role: 'img',
