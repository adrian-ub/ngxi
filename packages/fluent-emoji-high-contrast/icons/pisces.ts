...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPiscesIcon],svg[fluent-emoji-high-contrast-pisces-icon]',
  host: {
    role: 'img',
