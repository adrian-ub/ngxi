...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPawPrintsIcon],svg[fluent-emoji-high-contrast-paw-prints-icon]',
  host: {
    role: 'img',
