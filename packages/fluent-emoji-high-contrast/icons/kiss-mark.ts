...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastKissMarkIcon],svg[fluent-emoji-high-contrast-kiss-mark-icon]',
  host: {
    role: 'img',
