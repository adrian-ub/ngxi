...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTrophyIcon],svg[fluent-emoji-high-contrast-trophy-icon]',
  host: {
    role: 'img',
