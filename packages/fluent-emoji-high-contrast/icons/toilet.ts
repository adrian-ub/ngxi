...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastToiletIcon],svg[fluent-emoji-high-contrast-toilet-icon]',
  host: {
    role: 'img',
