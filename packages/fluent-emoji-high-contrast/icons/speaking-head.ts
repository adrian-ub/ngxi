...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSpeakingHeadIcon],svg[fluent-emoji-high-contrast-speaking-head-icon]',
  host: {
    role: 'img',
