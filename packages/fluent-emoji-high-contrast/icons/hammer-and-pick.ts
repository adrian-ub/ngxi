...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHammerAndPickIcon],svg[fluent-emoji-high-contrast-hammer-and-pick-icon]',
  host: {
    role: 'img',
