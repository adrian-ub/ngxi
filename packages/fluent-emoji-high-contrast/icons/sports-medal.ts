...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSportsMedalIcon],svg[fluent-emoji-high-contrast-sports-medal-icon]',
  host: {
    role: 'img',
