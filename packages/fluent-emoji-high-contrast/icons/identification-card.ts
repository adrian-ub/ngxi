...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastIdentificationCardIcon],svg[fluent-emoji-high-contrast-identification-card-icon]',
  host: {
    role: 'img',
