...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRainbowIcon],svg[fluent-emoji-high-contrast-rainbow-icon]',
  host: {
    role: 'img',
