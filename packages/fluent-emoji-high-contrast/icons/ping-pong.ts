...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPingPongIcon],svg[fluent-emoji-high-contrast-ping-pong-icon]',
  host: {
    role: 'img',
