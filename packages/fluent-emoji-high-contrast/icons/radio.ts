...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRadioIcon],svg[fluent-emoji-high-contrast-radio-icon]',
  host: {
    role: 'img',
