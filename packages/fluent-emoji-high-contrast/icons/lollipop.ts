...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLollipopIcon],svg[fluent-emoji-high-contrast-lollipop-icon]',
  host: {
    role: 'img',
