...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastShoppingBagsIcon],svg[fluent-emoji-high-contrast-shopping-bags-icon]',
  host: {
    role: 'img',
