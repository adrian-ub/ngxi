...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWomansClothesIcon],svg[fluent-emoji-high-contrast-womans-clothes-icon]',
  host: {
    role: 'img',
