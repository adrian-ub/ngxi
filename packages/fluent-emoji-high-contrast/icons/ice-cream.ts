...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastIceCreamIcon],svg[fluent-emoji-high-contrast-ice-cream-icon]',
  host: {
    role: 'img',
