...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSmallBlueDiamondIcon],svg[fluent-emoji-high-contrast-small-blue-diamond-icon]',
  host: {
    role: 'img',
...
export class FluentEmojiHighContrastSmallBlueDiamondIcon {
