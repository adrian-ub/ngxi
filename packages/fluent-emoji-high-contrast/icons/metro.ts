...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMetroIcon],svg[fluent-emoji-high-contrast-metro-icon]',
  host: {
    role: 'img',
