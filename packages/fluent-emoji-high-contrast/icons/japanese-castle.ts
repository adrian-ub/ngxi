...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastJapaneseCastleIcon],svg[fluent-emoji-high-contrast-japanese-castle-icon]',
  host: {
    role: 'img',
