...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMantelpieceClockIcon],svg[fluent-emoji-high-contrast-mantelpiece-clock-icon]',
  host: {
    role: 'img',
