...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHeadphoneIcon],svg[fluent-emoji-high-contrast-headphone-icon]',
  host: {
    role: 'img',
