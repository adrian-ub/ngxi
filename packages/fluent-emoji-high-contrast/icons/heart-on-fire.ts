...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHeartOnFireIcon],svg[fluent-emoji-high-contrast-heart-on-fire-icon]',
  host: {
    role: 'img',
