...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastXRayIcon],svg[fluent-emoji-high-contrast-x-ray-icon]',
  host: {
    role: 'img',
