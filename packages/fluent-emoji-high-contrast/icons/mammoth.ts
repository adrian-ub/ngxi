...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMammothIcon],svg[fluent-emoji-high-contrast-mammoth-icon]',
  host: {
    role: 'img',
