...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastManualWheelchairIcon],svg[fluent-emoji-high-contrast-manual-wheelchair-icon]',
  host: {
    role: 'img',
