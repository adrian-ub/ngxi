...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPeaPodIcon],svg[fluent-emoji-high-contrast-pea-pod-icon]',
  host: {
    role: 'img',
