...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLemonIcon],svg[fluent-emoji-high-contrast-lemon-icon]',
  host: {
    role: 'img',
