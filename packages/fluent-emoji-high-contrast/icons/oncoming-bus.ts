...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOncomingBusIcon],svg[fluent-emoji-high-contrast-oncoming-bus-icon]',
  host: {
    role: 'img',
