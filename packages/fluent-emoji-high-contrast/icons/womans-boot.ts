...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWomansBootIcon],svg[fluent-emoji-high-contrast-womans-boot-icon]',
  host: {
    role: 'img',
