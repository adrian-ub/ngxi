...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastVibrationModeIcon],svg[fluent-emoji-high-contrast-vibration-mode-icon]',
  host: {
    role: 'img',
