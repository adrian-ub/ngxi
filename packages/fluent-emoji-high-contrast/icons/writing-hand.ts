...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWritingHandIcon],svg[fluent-emoji-high-contrast-writing-hand-icon]',
  host: {
    role: 'img',
