...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPersonSwimmingIcon],svg[fluent-emoji-high-contrast-person-swimming-icon]',
  host: {
    role: 'img',
