...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWaffleIcon],svg[fluent-emoji-high-contrast-waffle-icon]',
  host: {
    role: 'img',
