...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastGuitarIcon],svg[fluent-emoji-high-contrast-guitar-icon]',
  host: {
    role: 'img',
