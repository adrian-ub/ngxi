...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSynagogueIcon],svg[fluent-emoji-high-contrast-synagogue-icon]',
  host: {
    role: 'img',
