...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMicrophoneIcon],svg[fluent-emoji-high-contrast-microphone-icon]',
  host: {
    role: 'img',
