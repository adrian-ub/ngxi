...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastJoystickIcon],svg[fluent-emoji-high-contrast-joystick-icon]',
  host: {
    role: 'img',
