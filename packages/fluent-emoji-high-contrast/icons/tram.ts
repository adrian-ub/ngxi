...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTramIcon],svg[fluent-emoji-high-contrast-tram-icon]',
  host: {
    role: 'img',
