...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLedgerIcon],svg[fluent-emoji-high-contrast-ledger-icon]',
  host: {
    role: 'img',
