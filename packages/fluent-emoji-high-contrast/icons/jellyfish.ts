...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastJellyfishIcon],svg[fluent-emoji-high-contrast-jellyfish-icon]',
  host: {
    role: 'img',
