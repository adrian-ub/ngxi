...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRightwardsPushingHandIcon],svg[fluent-emoji-high-contrast-rightwards-pushing-hand-icon]',
  host: {
    role: 'img',
