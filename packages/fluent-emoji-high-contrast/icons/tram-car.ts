...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTramCarIcon],svg[fluent-emoji-high-contrast-tram-car-icon]',
  host: {
    role: 'img',
