...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPeopleHuggingIcon],svg[fluent-emoji-high-contrast-people-hugging-icon]',
  host: {
    role: 'img',
