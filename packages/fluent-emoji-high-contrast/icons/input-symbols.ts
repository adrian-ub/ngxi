...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastInputSymbolsIcon],svg[fluent-emoji-high-contrast-input-symbols-icon]',
  host: {
    role: 'img',
