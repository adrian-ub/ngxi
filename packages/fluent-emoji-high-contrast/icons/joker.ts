...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastJokerIcon],svg[fluent-emoji-high-contrast-joker-icon]',
  host: {
    role: 'img',
