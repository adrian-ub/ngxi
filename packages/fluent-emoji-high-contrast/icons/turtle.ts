...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTurtleIcon],svg[fluent-emoji-high-contrast-turtle-icon]',
  host: {
    role: 'img',
