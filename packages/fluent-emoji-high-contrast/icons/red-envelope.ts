...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRedEnvelopeIcon],svg[fluent-emoji-high-contrast-red-envelope-icon]',
  host: {
    role: 'img',
