...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastScarfIcon],svg[fluent-emoji-high-contrast-scarf-icon]',
  host: {
    role: 'img',
