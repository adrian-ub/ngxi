...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOpticalDiskIcon],svg[fluent-emoji-high-contrast-optical-disk-icon]',
  host: {
    role: 'img',
...
export class FluentEmojiHighContrastOpticalDiskIcon {
