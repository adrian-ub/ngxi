...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPalmTreeIcon],svg[fluent-emoji-high-contrast-palm-tree-icon]',
  host: {
    role: 'img',
