...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMosquitoIcon],svg[fluent-emoji-high-contrast-mosquito-icon]',
  host: {
    role: 'img',
