...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPandaIcon],svg[fluent-emoji-high-contrast-panda-icon]',
  host: {
    role: 'img',
