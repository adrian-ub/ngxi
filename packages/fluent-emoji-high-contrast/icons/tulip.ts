...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTulipIcon],svg[fluent-emoji-high-contrast-tulip-icon]',
  host: {
    role: 'img',
