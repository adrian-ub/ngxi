...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastNationalParkIcon],svg[fluent-emoji-high-contrast-national-park-icon]',
  host: {
    role: 'img',
