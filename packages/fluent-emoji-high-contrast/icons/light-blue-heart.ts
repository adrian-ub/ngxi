...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLightBlueHeartIcon],svg[fluent-emoji-high-contrast-light-blue-heart-icon]',
  host: {
    role: 'img',
