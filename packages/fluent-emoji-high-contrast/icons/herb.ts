...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHerbIcon],svg[fluent-emoji-high-contrast-herb-icon]',
  host: {
    role: 'img',
