...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSoonArrowIcon],svg[fluent-emoji-high-contrast-soon-arrow-icon]',
  host: {
    role: 'img',
