...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSewingNeedleIcon],svg[fluent-emoji-high-contrast-sewing-needle-icon]',
  host: {
    role: 'img',
