...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSkateboardIcon],svg[fluent-emoji-high-contrast-skateboard-icon]',
  host: {
    role: 'img',
