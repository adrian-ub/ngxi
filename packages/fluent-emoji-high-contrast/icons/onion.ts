...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOnionIcon],svg[fluent-emoji-high-contrast-onion-icon]',
  host: {
    role: 'img',
