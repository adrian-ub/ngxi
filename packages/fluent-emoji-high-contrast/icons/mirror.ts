...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMirrorIcon],svg[fluent-emoji-high-contrast-mirror-icon]',
  host: {
    role: 'img',
