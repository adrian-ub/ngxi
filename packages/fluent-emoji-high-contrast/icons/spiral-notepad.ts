...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSpiralNotepadIcon],svg[fluent-emoji-high-contrast-spiral-notepad-icon]',
  host: {
    role: 'img',
