...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPinchedFingersIcon],svg[fluent-emoji-high-contrast-pinched-fingers-icon]',
  host: {
    role: 'img',
