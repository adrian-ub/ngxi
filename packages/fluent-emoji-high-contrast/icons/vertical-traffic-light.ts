...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastVerticalTrafficLightIcon],svg[fluent-emoji-high-contrast-vertical-traffic-light-icon]',
  host: {
    role: 'img',
