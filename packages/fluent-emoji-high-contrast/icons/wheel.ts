...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWheelIcon],svg[fluent-emoji-high-contrast-wheel-icon]',
  host: {
    role: 'img',
