...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLeftSpeechBubbleIcon],svg[fluent-emoji-high-contrast-left-speech-bubble-icon]',
  host: {
    role: 'img',
