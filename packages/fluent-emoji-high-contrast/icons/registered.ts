...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRegisteredIcon],svg[fluent-emoji-high-contrast-registered-icon]',
  host: {
    role: 'img',
