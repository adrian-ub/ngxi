...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOncomingPoliceCarIcon],svg[fluent-emoji-high-contrast-oncoming-police-car-icon]',
  host: {
    role: 'img',
