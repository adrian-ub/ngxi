...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMicrobeIcon],svg[fluent-emoji-high-contrast-microbe-icon]',
  host: {
    role: 'img',
