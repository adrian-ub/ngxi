...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastUpButtonIcon],svg[fluent-emoji-high-contrast-up-button-icon]',
  host: {
    role: 'img',
