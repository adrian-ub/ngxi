...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLastQuarterMoonFaceIcon],svg[fluent-emoji-high-contrast-last-quarter-moon-face-icon]',
  host: {
    role: 'img',
