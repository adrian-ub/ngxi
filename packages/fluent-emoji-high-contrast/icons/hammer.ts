...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHammerIcon],svg[fluent-emoji-high-contrast-hammer-icon]',
  host: {
    role: 'img',
