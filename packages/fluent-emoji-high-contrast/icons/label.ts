...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLabelIcon],svg[fluent-emoji-high-contrast-label-icon]',
  host: {
    role: 'img',
