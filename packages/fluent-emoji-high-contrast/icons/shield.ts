...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastShieldIcon],svg[fluent-emoji-high-contrast-shield-icon]',
  host: {
    role: 'img',
