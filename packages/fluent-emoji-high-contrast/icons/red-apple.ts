...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRedAppleIcon],svg[fluent-emoji-high-contrast-red-apple-icon]',
  host: {
    role: 'img',
