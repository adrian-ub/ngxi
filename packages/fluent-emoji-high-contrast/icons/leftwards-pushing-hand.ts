...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLeftwardsPushingHandIcon],svg[fluent-emoji-high-contrast-leftwards-pushing-hand-icon]',
  host: {
    role: 'img',
