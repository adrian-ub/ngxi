...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastReminderRibbonIcon],svg[fluent-emoji-high-contrast-reminder-ribbon-icon]',
  host: {
    role: 'img',
