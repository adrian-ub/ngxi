...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastShoppingCartIcon],svg[fluent-emoji-high-contrast-shopping-cart-icon]',
  host: {
    role: 'img',
