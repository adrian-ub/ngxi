...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOwlIcon],svg[fluent-emoji-high-contrast-owl-icon]',
  host: {
    role: 'img',
