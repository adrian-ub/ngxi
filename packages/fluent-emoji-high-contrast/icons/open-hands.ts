...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOpenHandsIcon],svg[fluent-emoji-high-contrast-open-hands-icon]',
  host: {
    role: 'img',
