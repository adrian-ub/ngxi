...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSmilingCatWithHeartEyesIcon],svg[fluent-emoji-high-contrast-smiling-cat-with-heart-eyes-icon]',
  host: {
    role: 'img',
