...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastGrinningFaceWithSweatIcon],svg[fluent-emoji-high-contrast-grinning-face-with-sweat-icon]',
  host: {
    role: 'img',
