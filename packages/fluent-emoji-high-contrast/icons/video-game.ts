...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastVideoGameIcon],svg[fluent-emoji-high-contrast-video-game-icon]',
  host: {
    role: 'img',
