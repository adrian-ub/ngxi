...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWrenchIcon],svg[fluent-emoji-high-contrast-wrench-icon]',
  host: {
    role: 'img',
