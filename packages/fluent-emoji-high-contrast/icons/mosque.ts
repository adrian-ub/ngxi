...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMosqueIcon],svg[fluent-emoji-high-contrast-mosque-icon]',
  host: {
    role: 'img',
