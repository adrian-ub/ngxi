...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRestroomIcon],svg[fluent-emoji-high-contrast-restroom-icon]',
  host: {
    role: 'img',
