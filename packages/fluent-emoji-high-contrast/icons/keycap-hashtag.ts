...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastKeycapHashtagIcon],svg[fluent-emoji-high-contrast-keycap-hashtag-icon]',
  host: {
    role: 'img',
