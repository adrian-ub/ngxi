...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPool8BallIcon],svg[fluent-emoji-high-contrast-pool-8-ball-icon]',
  host: {
    role: 'img',
