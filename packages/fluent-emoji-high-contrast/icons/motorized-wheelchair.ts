...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMotorizedWheelchairIcon],svg[fluent-emoji-high-contrast-motorized-wheelchair-icon]',
  host: {
    role: 'img',
