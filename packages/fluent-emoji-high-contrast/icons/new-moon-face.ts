...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastNewMoonFaceIcon],svg[fluent-emoji-high-contrast-new-moon-face-icon]',
  host: {
    role: 'img',
