...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMechanicalLegIcon],svg[fluent-emoji-high-contrast-mechanical-leg-icon]',
  host: {
    role: 'img',
