...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastYellowCircleIcon],svg[fluent-emoji-high-contrast-yellow-circle-icon]',
  host: {
    role: 'img',
