...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLlamaIcon],svg[fluent-emoji-high-contrast-llama-icon]',
  host: {
    role: 'img',
