...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastOfficeBuildingIcon],svg[fluent-emoji-high-contrast-office-building-icon]',
  host: {
    role: 'img',
