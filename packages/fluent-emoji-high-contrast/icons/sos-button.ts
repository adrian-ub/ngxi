...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSosButtonIcon],svg[fluent-emoji-high-contrast-sos-button-icon]',
  host: {
    role: 'img',
