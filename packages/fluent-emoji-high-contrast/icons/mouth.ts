...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMouthIcon],svg[fluent-emoji-high-contrast-mouth-icon]',
  host: {
    role: 'img',
