...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMicroscopeIcon],svg[fluent-emoji-high-contrast-microscope-icon]',
  host: {
    role: 'img',
