...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastVolleyballIcon],svg[fluent-emoji-high-contrast-volleyball-icon]',
  host: {
    role: 'img',
