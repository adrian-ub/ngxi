...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastJapaneseNotFreeOfChargeButtonIcon],svg[fluent-emoji-high-contrast-japanese-not-free-of-charge-button-icon]',
  host: {
    role: 'img',
