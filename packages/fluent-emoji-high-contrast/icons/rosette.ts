...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRosetteIcon],svg[fluent-emoji-high-contrast-rosette-icon]',
  host: {
    role: 'img',
