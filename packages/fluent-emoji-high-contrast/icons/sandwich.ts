...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSandwichIcon],svg[fluent-emoji-high-contrast-sandwich-icon]',
  host: {
    role: 'img',
