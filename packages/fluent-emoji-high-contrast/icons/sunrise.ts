...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSunriseIcon],svg[fluent-emoji-high-contrast-sunrise-icon]',
  host: {
    role: 'img',
