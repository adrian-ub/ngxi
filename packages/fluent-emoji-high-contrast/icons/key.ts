...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastKeyIcon],svg[fluent-emoji-high-contrast-key-icon]',
  host: {
    role: 'img',
