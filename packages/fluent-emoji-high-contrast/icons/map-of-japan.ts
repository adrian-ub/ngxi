...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMapOfJapanIcon],svg[fluent-emoji-high-contrast-map-of-japan-icon]',
  host: {
    role: 'img',
