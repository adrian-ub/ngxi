...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWavyDashIcon],svg[fluent-emoji-high-contrast-wavy-dash-icon]',
  host: {
    role: 'img',
