...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSkullAndCrossbonesIcon],svg[fluent-emoji-high-contrast-skull-and-crossbones-icon]',
  host: {
    role: 'img',
