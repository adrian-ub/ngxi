...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPinkHeartIcon],svg[fluent-emoji-high-contrast-pink-heart-icon]',
  host: {
    role: 'img',
