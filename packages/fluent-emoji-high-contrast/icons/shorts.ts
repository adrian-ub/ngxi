...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastShortsIcon],svg[fluent-emoji-high-contrast-shorts-icon]',
  host: {
    role: 'img',
