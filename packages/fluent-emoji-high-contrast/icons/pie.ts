...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPieIcon],svg[fluent-emoji-high-contrast-pie-icon]',
  host: {
    role: 'img',
