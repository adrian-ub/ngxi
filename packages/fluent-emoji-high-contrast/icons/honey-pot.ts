...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastHoneyPotIcon],svg[fluent-emoji-high-contrast-honey-pot-icon]',
  host: {
    role: 'img',
