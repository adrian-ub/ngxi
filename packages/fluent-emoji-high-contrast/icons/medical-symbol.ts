...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMedicalSymbolIcon],svg[fluent-emoji-high-contrast-medical-symbol-icon]',
  host: {
    role: 'img',
