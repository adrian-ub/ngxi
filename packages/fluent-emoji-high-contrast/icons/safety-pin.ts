...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSafetyPinIcon],svg[fluent-emoji-high-contrast-safety-pin-icon]',
  host: {
    role: 'img',
