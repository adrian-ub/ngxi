...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSoftballIcon],svg[fluent-emoji-high-contrast-softball-icon]',
  host: {
    role: 'img',
