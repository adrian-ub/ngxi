...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTokyoTowerIcon],svg[fluent-emoji-high-contrast-tokyo-tower-icon]',
  host: {
    role: 'img',
