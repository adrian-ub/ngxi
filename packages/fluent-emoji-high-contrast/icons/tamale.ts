...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTamaleIcon],svg[fluent-emoji-high-contrast-tamale-icon]',
  host: {
    role: 'img',
