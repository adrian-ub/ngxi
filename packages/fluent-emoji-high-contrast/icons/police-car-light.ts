...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPoliceCarLightIcon],svg[fluent-emoji-high-contrast-police-car-light-icon]',
  host: {
    role: 'img',
