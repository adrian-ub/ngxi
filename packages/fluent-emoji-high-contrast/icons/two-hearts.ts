...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTwoHeartsIcon],svg[fluent-emoji-high-contrast-two-hearts-icon]',
  host: {
    role: 'img',
