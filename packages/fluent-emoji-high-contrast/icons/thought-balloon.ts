...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastThoughtBalloonIcon],svg[fluent-emoji-high-contrast-thought-balloon-icon]',
  host: {
    role: 'img',
