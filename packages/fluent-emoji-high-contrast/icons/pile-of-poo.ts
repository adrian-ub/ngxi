...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPileOfPooIcon],svg[fluent-emoji-high-contrast-pile-of-poo-icon]',
  host: {
    role: 'img',
