...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSnakeIcon],svg[fluent-emoji-high-contrast-snake-icon]',
  host: {
    role: 'img',
