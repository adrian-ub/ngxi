...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSleepingFaceIcon],svg[fluent-emoji-high-contrast-sleeping-face-icon]',
  host: {
    role: 'img',
