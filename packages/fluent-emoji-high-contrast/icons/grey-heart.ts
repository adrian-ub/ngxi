...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastGreyHeartIcon],svg[fluent-emoji-high-contrast-grey-heart-icon]',
  host: {
    role: 'img',
