...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastInfinityIcon],svg[fluent-emoji-high-contrast-infinity-icon]',
  host: {
    role: 'img',
