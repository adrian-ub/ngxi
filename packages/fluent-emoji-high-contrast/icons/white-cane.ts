...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastWhiteCaneIcon],svg[fluent-emoji-high-contrast-white-cane-icon]',
  host: {
    role: 'img',
