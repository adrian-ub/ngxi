...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSaxophoneIcon],svg[fluent-emoji-high-contrast-saxophone-icon]',
  host: {
    role: 'img',
