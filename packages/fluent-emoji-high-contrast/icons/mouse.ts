...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMouseIcon],svg[fluent-emoji-high-contrast-mouse-icon]',
  host: {
    role: 'img',
