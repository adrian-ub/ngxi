...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastUmbrellaIcon],svg[fluent-emoji-high-contrast-umbrella-icon]',
  host: {
    role: 'img',
