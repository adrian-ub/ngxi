...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLipstickIcon],svg[fluent-emoji-high-contrast-lipstick-icon]',
  host: {
    role: 'img',
