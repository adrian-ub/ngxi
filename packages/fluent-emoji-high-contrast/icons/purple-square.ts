...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastPurpleSquareIcon],svg[fluent-emoji-high-contrast-purple-square-icon]',
  host: {
    role: 'img',
