...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastToothbrushIcon],svg[fluent-emoji-high-contrast-toothbrush-icon]',
  host: {
    role: 'img',
