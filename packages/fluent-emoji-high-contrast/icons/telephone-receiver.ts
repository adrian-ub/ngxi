...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTelephoneReceiverIcon],svg[fluent-emoji-high-contrast-telephone-receiver-icon]',
  host: {
    role: 'img',
