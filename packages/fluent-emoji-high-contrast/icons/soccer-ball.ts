...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSoccerBallIcon],svg[fluent-emoji-high-contrast-soccer-ball-icon]',
  host: {
    role: 'img',
