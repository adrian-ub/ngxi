...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSpiralShellIcon],svg[fluent-emoji-high-contrast-spiral-shell-icon]',
  host: {
    role: 'img',
