...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSunriseOverMountainsIcon],svg[fluent-emoji-high-contrast-sunrise-over-mountains-icon]',
  host: {
    role: 'img',
