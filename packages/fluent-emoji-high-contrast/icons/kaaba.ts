...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastKaabaIcon],svg[fluent-emoji-high-contrast-kaaba-icon]',
  host: {
    role: 'img',
