...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastLoudlyCryingFaceIcon],svg[fluent-emoji-high-contrast-loudly-crying-face-icon]',
  host: {
    role: 'img',
