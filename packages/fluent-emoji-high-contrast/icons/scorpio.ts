...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastScorpioIcon],svg[fluent-emoji-high-contrast-scorpio-icon]',
  host: {
    role: 'img',
