...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSunglassesIcon],svg[fluent-emoji-high-contrast-sunglasses-icon]',
  host: {
    role: 'img',
