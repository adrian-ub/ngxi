...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastStarStruckIcon],svg[fluent-emoji-high-contrast-star-struck-icon]',
  host: {
    role: 'img',
