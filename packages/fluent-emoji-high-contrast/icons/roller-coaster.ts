...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRollerCoasterIcon],svg[fluent-emoji-high-contrast-roller-coaster-icon]',
  host: {
    role: 'img',
