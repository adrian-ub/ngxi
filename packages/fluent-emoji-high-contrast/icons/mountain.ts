...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMountainIcon],svg[fluent-emoji-high-contrast-mountain-icon]',
  host: {
    role: 'img',
