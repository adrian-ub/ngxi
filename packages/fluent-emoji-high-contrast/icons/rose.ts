...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRoseIcon],svg[fluent-emoji-high-contrast-rose-icon]',
  host: {
    role: 'img',
