...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRadioactiveIcon],svg[fluent-emoji-high-contrast-radioactive-icon]',
  host: {
    role: 'img',
