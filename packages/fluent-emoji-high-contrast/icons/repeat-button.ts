...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRepeatButtonIcon],svg[fluent-emoji-high-contrast-repeat-button-icon]',
  host: {
    role: 'img',
