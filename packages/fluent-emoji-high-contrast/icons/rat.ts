...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRatIcon],svg[fluent-emoji-high-contrast-rat-icon]',
  host: {
    role: 'img',
