...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastMelonIcon],svg[fluent-emoji-high-contrast-melon-icon]',
  host: {
    role: 'img',
