...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSailboatIcon],svg[fluent-emoji-high-contrast-sailboat-icon]',
  host: {
    role: 'img',
