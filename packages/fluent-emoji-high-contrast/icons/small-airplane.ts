...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastSmallAirplaneIcon],svg[fluent-emoji-high-contrast-small-airplane-icon]',
  host: {
    role: 'img',
