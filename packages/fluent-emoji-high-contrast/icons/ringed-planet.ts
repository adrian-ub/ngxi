...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastRingedPlanetIcon],svg[fluent-emoji-high-contrast-ringed-planet-icon]',
  host: {
    role: 'img',
