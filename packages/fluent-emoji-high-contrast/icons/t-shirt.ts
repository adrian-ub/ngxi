...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastTShirtIcon],svg[fluent-emoji-high-contrast-t-shirt-icon]',
  host: {
    role: 'img',
