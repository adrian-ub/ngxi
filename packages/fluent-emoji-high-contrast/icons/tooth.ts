...
@Component({
  standalone: true,
  selector: 'svg[fluentEmojiHighContrastToothIcon],svg[fluent-emoji-high-contrast-tooth-icon]',
  host: {
    role: 'img',
