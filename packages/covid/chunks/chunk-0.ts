...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19Virus4Icon],svg[covid-covid-19-virus-4-icon]',
  host: {
    role: 'img',
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusPandemic2Icon],svg[covid-covid-19-virus-pandemic-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M13.885 6.648a5.352 5.352 0 0 1 0 10.7m-.892-14.713h1.784m-.892 0v4.013m5.991-1.901l1.262 1.261m-.631-.63l-2.838 2.838m5.581 2.892v1.784m0-.892h-4.014m1.902 5.992l-1.262 1.261m.631-.631l-2.838-2.838m-2.892 5.581h-1.784m.892 0v-4.013M10.25 21.5a9.5 9.5 0 0 1 0-19z"></svg:path><svg:path d="M10.25 2.5A10.92 10.92 0 0 0 5.5 12a10.92 10.92 0 0 0 4.75 9.5m0-12.571H1.665M10 15.071H1.415"></svg:path></svg:g>`,
})
export class CovidCovid19VirusPandemic2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusPandemic3Icon],svg[covid-covid-19-virus-pandemic-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M17.851 8.875a2.94 2.94 0 1 0 0-5.88a2.94 2.94 0 0 0 0 5.88M17.361.79h.98m-.49 0v2.205m3.292-1.045l.693.693m-.347-.346L19.93 3.856m3.066 1.589v.98m0-.49h-2.205m1.045 3.292l-.693.693m.346-.347L19.93 8.014m-1.589 3.066h-.98m.49 0V8.875M14.56 9.92l-.693-.693m.346.346l1.559-1.559m-3.066-1.589v-.98m0 .49h2.205m-1.044-3.292l.693-.693m-.347.347l1.559 1.559m4.515 9.806a9.6 9.6 0 0 1-.606 3.264m-1.809 3.024a9.6 9.6 0 0 1-2.588 2.083m-3.351 1.094c-1.106.143-2.227.1-3.319-.127m-3.253-1.358a9.8 9.8 0 0 1-2.418-2.274m-1.571-3.155a9.2 9.2 0 0 1-.341-3.3m.88-3.413a9.7 9.7 0 0 1 1.9-2.726m2.901-2.002a9.8 9.8 0 0 1 3.22-.808m6.499 9.814A5.789 5.789 0 1 1 10 7.822"></svg:path><svg:path d="m8.772 8.1l.355 1.447A1.29 1.29 0 0 1 8.84 10.7l-.653.738a1.3 1.3 0 0 0-.307.65L7.671 13.4a1.285 1.285 0 0 1-1.094 1.071l-1.612.223m11.223.547l-2.073-.885a1.287 1.287 0 0 0-1.764.921l-.27 1.293c-.052.248-.029.507.066.742l.657 1.634"></svg:path></svg:g>`,
})
export class CovidCovid19VirusPandemic3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19Virus2Icon],svg[covid-covid19-virus-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M4.934 7.263L3.269 5.6A1.648 1.648 0 1 1 5.6 3.269l1.663 1.665m0 14.132L5.6 20.731A1.647 1.647 0 1 1 3.269 18.4l1.665-1.666m14.132.003l1.665 1.663a1.648 1.648 0 0 1-2.331 2.331l-1.666-1.665m.003-14.132L18.4 3.269A1.648 1.648 0 0 1 20.731 5.6l-1.665 1.663"></svg:path><svg:path d="M20.347 10.354a8.51 8.51 0 0 0-6.7-6.7m-.001 16.693a8.515 8.515 0 0 0 6.7-6.7m-16.693-.001a8.51 8.51 0 0 0 6.7 6.7m.001-16.693a8.51 8.51 0 0 0-6.7 6.7"></svg:path><svg:path d="M9.805 6.787c.351-.352.549-.828.549-1.325V2.4a1.646 1.646 0 1 1 3.292 0v3.062c.002.498.201.974.554 1.325M6.787 14.2a1.88 1.88 0 0 0-1.325-.549H2.4a1.646 1.646 0 1 1 0-3.292h3.062c.497 0 .973-.198 1.325-.549m7.413 7.403a1.88 1.88 0 0 0-.549 1.325V21.6a1.646 1.646 0 1 1-3.292 0v-3.062c0-.497-.198-.973-.549-1.325m7.403-7.408c.352.351.828.549 1.325.549H21.6a1.646 1.646 0 0 1 0 3.292h-3.062c-.497 0-.973.198-1.325.549"></svg:path></svg:g>`,
})
export class CovidCovid19Virus2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusBatIcon],svg[covid-covid19-virus-bat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M17.211 20.568a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.143m-.572 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819m3.576 1.853v1.142m0-.571H20.64m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.852 3.576H16.64m.571 0v-2.571m-3.838 1.218l-.809-.808m.404.404l1.819-1.819m-3.576-1.853v-1.142m0 .571h2.572M12.564 13.3l.809-.808m-.405.404l1.819 1.819M8.813.861v4.012L5.665 3.824A3.7 3.7 0 0 0 .789 7.339v2.719s2.485-1.043 4.076 2.619c2.038-2.038 4.075 0 4.075 2.038M14.163.861v4.012l3.147-1.049a3.705 3.705 0 0 1 4.877 3.515"></svg:path><svg:path d="M8.813 3.536A4.67 4.67 0 0 1 11.488 2.2c1.014.14 1.954.61 2.675 1.338"></svg:path></svg:g>`,
})
export class CovidCovid19VirusBatIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusHeal1Icon],svg[covid-covid19-virus-heal-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M23.25 17.25a1 1 0 0 0-1-1h-2.5v-2.5a1 1 0 0 0-1-1h-1.5a1 1 0 0 0-1 1v2.5h-2.5a1 1 0 0 0-1 1v1.5a1 1 0 0 0 1 1h2.5v2.5a1 1 0 0 0 1 1h1.5a1 1 0 0 0 1-1v-2.5h2.5a1 1 0 0 0 1-1zM4.183 12.754H2.162a1.413 1.413 0 0 1 0-2.825h2.021m5.746-5.746V2.162a1.413 1.413 0 0 1 2.825 0v2.021"></svg:path><svg:path d="M15.405 5.28a7.3 7.3 0 0 0-8.128 0M18.5 9.929a7.25 7.25 0 0 0-1.1-2.652M7.277 17.4a7.3 7.3 0 0 0 2.478 1.061M5.28 7.277a7.3 7.3 0 0 0 0 8.128"></svg:path><svg:path d="M6.848 9.511c0-.426-.17-.835-.471-1.137L4.518 6.515a1.414 1.414 0 0 1 2-2l1.856 1.862c.302.301.71.47 1.137.471m0 8.987a1.6 1.6 0 0 0-1.137.471l-1.859 1.859a1.414 1.414 0 0 1-2-2l1.859-1.86c.301-.301.47-.71.471-1.136m6.327-6.321c.426 0 .835-.17 1.136-.471l1.86-1.859a1.414 1.414 0 1 1 2 2l-1.862 1.856a1.6 1.6 0 0 0-.471 1.137"></svg:path></svg:g>`,
})
export class CovidCovid19VirusHeal1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusPatient1Icon],svg[covid-covid19-virus-patient-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusPatient2Icon],svg[covid-covid19-virus-patient-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819m3.576 1.853v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819m-3.576-1.853v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M6 6.75a3 3 0 1 0 0-6a3 3 0 0 0 0 6m4.555 4.138A5.251 5.251 0 0 0 .75 13.5v2.25H3l.75 7.5h4.5l.323-3.232"></svg:path>`,
})
export class CovidCovid19VirusPatient2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusWarning1Icon],svg[covid-covid19-virus-warning-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.017.75H8.983m1.517 0v2.6m-5.822-.817L3.606 3.606L2.533 4.678m1.073-1.072l1.838 1.838M.75 8.983v3.034m0-1.517h2.6m-.817 5.822l1.073 1.072l1.072 1.073m-1.072-1.073l1.838-1.838M18.467 4.678l-1.073-1.072l-1.072-1.073m1.072 1.073l-1.838 1.838M8.983 9.85a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M17.284 8.252a7.148 7.148 0 1 0-7.656 9.34M17.25 18v-3m5.813 5.682a1.773 1.773 0 0 1-1.587 2.568h-8.452a1.773 1.773 0 0 1-1.587-2.568l4.226-8.451a1.774 1.774 0 0 1 3.174 0z"></svg:path><svg:path d="M10.092 14.492a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75M17.25 21a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidCovid19VirusWarning1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusWarning2Icon],svg[covid-covid19-virus-warning-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M17.25 18v-3m5.813 5.682a1.773 1.773 0 0 1-1.587 2.568h-8.452a1.773 1.773 0 0 1-1.587-2.568l4.226-8.451a1.774 1.774 0 0 1 3.174 0zm-18.88-7.928H2.162a1.413 1.413 0 0 1 0-2.825h2.021m5.746-5.746V2.162a1.413 1.413 0 0 1 2.825 0v2.021"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M15.405 5.28a7.3 7.3 0 0 0-8.128 0M18.288 9.1a7.3 7.3 0 0 0-.888-1.823M7.277 17.4a7.3 7.3 0 0 0 1.959.926M5.28 7.277a7.3 7.3 0 0 0 0 8.128"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M6.848 9.511c0-.426-.17-.835-.471-1.137L4.518 6.515a1.414 1.414 0 0 1 2-2l1.856 1.862c.302.301.71.47 1.137.471m0 8.987a1.6 1.6 0 0 0-1.137.471l-1.859 1.859a1.414 1.414 0 0 1-2-2l1.859-1.86c.301-.301.47-.71.471-1.136m6.327-6.321c.426 0 .835-.17 1.136-.471l1.86-1.859a1.414 1.414 0 1 1 2 2l-1.862 1.856"></svg:path><svg:path d="M17.25 21a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidCovid19VirusWarning2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidCovid19VirusWarning3Icon],svg[covid-covid19-virus-warning-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M10 12.583V6.667m5.472 3.346L11.333 1.58a1.485 1.485 0 0 0-2.666 0L.878 17.447A1.252 1.252 0 0 0 2 19.25h7.75M18 21a3 3 0 1 0 0-6a3 3 0 0 0 0 6m-.5-8.25h1m-.5 0V15m3.359-1.066l.707.707m-.354-.353l-1.591 1.591M23.25 17.5v1m0-.5H21m1.066 3.359l-.707.707m.353-.354l-1.591-1.591M18.5 23.25h-1m.5 0V21m-3.359 1.066l-.707-.707m.354.353l1.591-1.591M12.75 18.5v-1m0 .5H15m-1.066-3.359l.707-.707m-.353.354l1.591 1.591"></svg:path><svg:path d="M10 15.983a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidCovid19VirusWarning3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidGraphDeathRateStableIcon],svg[covid-graph-death-rate-stable-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M21.787 22.5h-21v-21"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M16.162 6.375a4.876 4.876 0 1 0-7.875 3.816v.309a1.5 1.5 0 0 0 1.5 1.5h3a1.5 1.5 0 0 0 1.5-1.5v-.309a4.85 4.85 0 0 0 1.875-3.816M11.287 10.5V12m9.535 3.234l2.391 2.391l-2.391 2.391"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M.787 17.625h.5a10.6 10.6 0 0 0 4.737-1.118L8.446 15.3a6.35 6.35 0 0 1 5.683 0l2.422 1.211a10.6 10.6 0 0 0 4.736 1.118h1.926"></svg:path><svg:path d="M13.162 7.125a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75m-3.752.75a.375.375 0 1 1 0-.75m0 .75a.375.375 0 1 0 0-.75"></svg:path></svg:g>`,
})
export class CovidGraphDeathRateStableIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidGraphDocumentInfectedReportIcon],svg[covid-graph-document-infected-report-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M17.75 20.532a3.137 3.137 0 1 0 0-6.274a3.137 3.137 0 0 0 0 6.274m-.523-8.627h1.046m-.523 0v2.353m3.512-1.114l.74.739m-.37-.37l-1.664 1.664m3.272 1.695v1.046m0-.523h-2.353m1.115 3.513l-.74.739m.37-.37l-1.664-1.663m-1.695 3.271h-1.046m.523 0v-2.353m-3.512 1.115l-.74-.739m.37.369l1.664-1.663m-3.272-1.696v-1.046m0 .523h2.353m-1.115-3.512l.74-.739m-.37.369l1.664 1.664M3.76 7.115v9h4.5"></svg:path><svg:path d="m3.76 13.115l2.689-2.689a1.5 1.5 0 0 1 2.122 0l.581.58a1.5 1.5 0 0 0 2.347-.289l.357-.6"></svg:path><svg:path d="M9.01 20.615H2.26a1.5 1.5 0 0 1-1.5-1.5v-16.5a1.5 1.5 0 0 1 1.5-1.5h10.629a1.5 1.5 0 0 1 1.06.439l2.872 2.872a1.5 1.5 0 0 1 .439 1.06v2.379"></svg:path></svg:g>`,
})
export class CovidGraphDocumentInfectedReportIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidMutation1Icon],svg[covid-mutation-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.408 1.208H9.375m1.517 0v2.6M5.07 2.992L3.997 4.064L2.925 5.136m1.072-1.072l1.839 1.839M1.142 9.442v3.033m0-1.517h2.6m-.817 5.822l1.072 1.073l1.073 1.072m-1.073-1.072l1.839-1.839M18.858 5.136l-1.072-1.072l-1.072-1.072m1.072 1.072l-1.839 1.839m-6.572 4.406a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M17.3 7.791a7.15 7.15 0 1 0-8.442 10.018m10.462 3.137H14.7a1.847 1.847 0 0 1-1.842-1.846v-4.616m3.542-1.846h4.615a1.844 1.844 0 0 1 1.846 1.846V19.1"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="m17.474 19.099l1.846 1.847l-1.846 1.846m.769-8.308l-1.846-1.846l1.846-1.846"></svg:path><svg:path d="M9.367 14.6a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidMutation1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidMutation2Icon],svg[covid-mutation-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidMutationStrongerIcon],svg[covid-mutation-stronger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.408.966H9.375m1.517 0v2.6M5.07 2.749L3.997 3.822L2.925 4.894m1.072-1.072L5.836 5.66M1.142 9.2v3.033m0-1.517h2.6m-.817 5.822l1.072 1.073l1.073 1.072m-1.073-1.072l1.839-1.839M18.858 4.894l-1.072-1.072l-1.073-1.073m1.073 1.073L15.947 5.66m-6.572 4.407a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M17.748 8.683a7.15 7.15 0 1 0-8.89 8.884m3 5.467h8.458a2.533 2.533 0 0 0 2.542-2.523v-6.606a2.19 2.19 0 0 0-1.9-2.211a2.1 2.1 0 0 0-1.152 3.969a6 6 0 0 0 0 4.428a4.674 4.674 0 0 0-7.338-1.265"></svg:path><svg:path d="M11.633 13.625a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidMutationStrongerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneCleanBottleVirusIcon],svg[covid-personal-hygiene-clean-bottle-virus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CovidPersonalHygieneCleanBottleVirusIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneCleanBottleVirusBlockIcon],svg[covid-personal-hygiene-clean-bottle-virus-block-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M15.28 19.72a3.145 3.145 0 0 1-.029-4.473a3.143 3.143 0 0 1 4.474.03m.92 2.222a3.143 3.143 0 0 1-3.143 3.143m-.524-8.643h1.047m-.523 0v2.356m5.5 2.62v1.047m0-.523h-2.357m1.117 3.519l-.742.74m.37-.37l-1.666-1.668m-1.698 3.279h-1.049m.525 0v-2.357m-5.5-2.619v-1.049m0 .525h2.356m-1.115-3.519l.74-.74m-.37.37l1.667 1.667m7.722-3.278l-11 11m-3.503-2.751h-4.5a3 3 0 0 1-3-3V9.749a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v.75M1 2.252l.621-.621A3 3 0 0 1 3.742.75h7.009"></svg:path><svg:path d="M9.999 6.75h-6v-1.5a1.5 1.5 0 0 1 1.5-1.5h3a1.5 1.5 0 0 1 1.5 1.5zM7 3.752v-3M7 9.75v5.999M4 12.75h5.998"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneCleanBottleVirusBlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneCleanGelIcon],svg[covid-personal-hygiene-clean-gel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneCleanToothpasteIcon],svg[covid-personal-hygiene-clean-toothpaste-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.972 20.25h-7.5v1.5a1.5 1.5 0 0 0 1.5 1.5h4.5a1.5 1.5 0 0 0 1.5-1.5zm0 0h-7.5L1.738 2.478A1.5 1.5 0 0 1 3.221.75h10a1.5 1.5 0 0 1 1.482 1.728zm8.308 3v-11l2-3v-8m-4 1h4m-4 3h4m-4 3h4m-14-2v6m-3-3h6"></svg:path>`,
})
export class CovidPersonalHygieneCleanToothpasteIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSanitizerLiquid1Icon],svg[covid-personal-hygiene-hand-sanitizer-liquid-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="m1.121 19.788l2.905 2.324a5.2 5.2 0 0 0 3.243 1.138h5.967a1.73 1.73 0 0 0 1.731-1.731v0a1.73 1.73 0 0 0-1.731-1.731H8.765"></svg:path><svg:path d="M1.278 14.6H4.74c1.026 0 2.029.304 2.882.873L9.6 16.788a1.615 1.615 0 0 1 .513 2.281v0a1.614 1.614 0 0 1-2.066.549l-2.6-1.56m17.432-7.418a4.945 4.945 0 1 1-9.89 0c0-3.709 4.945-9.89 4.945-9.89s4.945 6.181 4.945 9.89m-6.923-.989h3.956m-1.978-1.978v3.956"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandSanitizerLiquid1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSanitizerLiquidDropIcon],svg[covid-personal-hygiene-hand-sanitizer-liquid-drop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M18.251 21.664h3a2 2 0 0 0 2-2v-10a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v6m6-8.001h-4V5.438a.775.775 0 0 1 .775-.775h2.45a.775.775 0 0 1 .775.775zm2 4.001h-8m8 6h-5M.749 18.836l2.937 2.35a5.25 5.25 0 0 0 3.279 1.15H13a1.75 1.75 0 0 0 1.75-1.75v0a1.75 1.75 0 0 0-1.75-1.75H8.478"></svg:path><svg:path d="M.908 13.586h3.5c1.037 0 2.051.308 2.914.883l2 1.333a1.633 1.633 0 0 1 .518 2.307v0a1.634 1.634 0 0 1-2.089.555l-2.627-1.578m7.127-7.922a2.5 2.5 0 0 1-5 0c0-1.875 2.5-5 2.5-5s2.5 3.125 2.5 5m7-7.5v3m-6-1l.447-.895a2 2 0 0 1 1.789-1.105h6.764"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandSanitizerLiquidDropIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSanitizerLiquidVirusBlockIcon],svg[covid-personal-hygiene-hand-sanitizer-liquid-virus-block-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M15.4 19.85a3.142 3.142 0 1 1 4.444-4.444m.924 2.219a3.144 3.144 0 0 1-3.143 3.143m-.524-8.643h1.048m-.524 0v2.357m5.5 2.619v1.048m0-.524h-2.357m1.116 3.519l-.74.74m.37-.37l-1.667-1.667m-1.698 3.278h-1.048m.524 0v-2.357m-5.5-2.619v-1.048m0 .524h2.357m-1.116-3.519l.74-.74m-.37.37l1.667 1.667m7.722-3.278l-11 11m-2.188-3.503A6.46 6.46 0 0 1 1 13.661C1 8.82 7.454.75 7.454.75a43.4 43.4 0 0 1 5.682 9.435"></svg:path><svg:path d="M7.454 17.137a3.476 3.476 0 0 1-3.476-3.476"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandSanitizerLiquidVirusBlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSanitizerSprayVirusBlockIcon],svg[covid-personal-hygiene-hand-sanitizer-spray-virus-block-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CovidPersonalHygieneHandSanitizerSprayVirusBlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSanitizerVirusBlockIcon],svg[covid-personal-hygiene-hand-sanitizer-virus-block-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M8.408 21.443H2.962a2.177 2.177 0 0 1-2.178-2.178V8.374A2.18 2.18 0 0 1 2.962 6.2h7.757A2.18 2.18 0 0 1 12.9 8.374v.956"></svg:path><svg:path d="M4.052.75H9.63a1.09 1.09 0 0 1 1.089 1.089V6.2H2.962V1.839A1.09 1.09 0 0 1 4.052.75m10.66 18.891a3.461 3.461 0 0 1 4.894-4.895m1.014 2.447a3.46 3.46 0 0 1-3.461 3.461m-.577-9.517h1.154m-.577 0v2.596m6.057 2.884v1.153m0-.577H20.62m1.23 3.875l-.816.816m.408-.408l-1.836-1.835m-1.87 3.609h-1.154m.577 0v-2.596m-6.056-2.884v-1.153m0 .576h2.595m-1.229-3.874l.815-.816m-.407.408l1.835 1.835m8.504-3.609L11.103 23.25M.784 10.552h8.58m-8.58 6.535h6.535"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandSanitizerVirusBlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandSoap1Icon],svg[covid-personal-hygiene-hand-soap-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandWipePaper2Icon],svg[covid-personal-hygiene-hand-wipe-paper-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M23.083 7.916a3.583 3.583 0 0 1-7.166 0C15.917 5.229 19.5.75 19.5.75s3.583 4.479 3.583 7.166m-5.264 6.335c.859 2.035 2.006 3.466-.084 6h-4.818m-6-10.201c-3.314 0-6-1.074-6-2.4v13.2c0 1.326 2.686 2.4 6 2.4s6-1.074 6-2.4V7.65c0 1.326-2.687 2.4-6 2.4"></svg:path><svg:path d="M6.917 10.05c3.314 0 6-1.075 6-2.4s-2.686-2.4-6-2.4s-6 1.075-6 2.4s2.686 2.4 6 2.4m-.6-2.4h1.2m-.6-2.4h6.47"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandWipePaper2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidPersonalHygieneHandWipePaper4Icon],svg[covid-personal-hygiene-hand-wipe-paper-4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="m6.5 23.25l1.5-.431a1.25 1.25 0 0 1 .567-.028l1.567.291a3.7 3.7 0 0 0 1.7-.082l9.239-2.658a1.234 1.234 0 0 0-.682-2.371l1.778-.512a1.233 1.233 0 1 0-.682-2.371l.593-.171a1.234 1.234 0 1 0-.683-2.371l-1.185.341a1.234 1.234 0 0 0-.682-2.371l-4.15 1.194a1.234 1.234 0 1 0-.683-2.372l-4.617 1.329a3.7 3.7 0 0 0-2.5 2.435l-.56 1.723a1.23 1.23 0 0 1-.835.811l-1.737.5m9.144-3.915l1.779-.511m2.55 4.401l3.557-1.023m-4.239-1.348l2.964-.853m-2.193 5.766l2.372-.682"></svg:path><svg:path d="m22.619 8.092l.335-1.34l-.5-2.5l-2.5.5l-.5-2.5l-2.5.5l-1.5-2c-1 2-2.432 3.092-6.778 3.865c-4.271.757-6.763 2.317-7.729 4.636l2.5.5l-.5 2.5l1.5.3"></svg:path></svg:g>`,
})
export class CovidPersonalHygieneHandWipePaper4Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceBedIcon],svg[covid-quarantine-place-bed-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceHospitalIcon],svg[covid-quarantine-place-hospital-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceHouse1Icon],svg[covid-quarantine-place-house-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 17.239a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714m-.476-7.857h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.336l-1.516 1.515M17 13.906v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.336l-1.516-1.516m-1.544 2.98h-.952m.476 0v-2.143m-3.199 1.015l-.673-.673m.336.337l1.516-1.516M7 14.858v-.952m0 .476h2.143m-1.015-3.199l.673-.673m-.337.337l1.516 1.515"></svg:path><svg:path d="M3.75 12.382v9a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-9m3-1.5l-9.885-9.226a2 2 0 0 0-2.73 0L.75 10.882"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceHouse1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceHouse2Icon],svg[covid-quarantine-place-house-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.017.768H8.983m1.517 0v2.6m-5.822-.817L3.606 3.623L2.533 4.696m1.073-1.073l1.838 1.839M.75 9.001v3.033m0-1.516h2.6m-.817 5.821l1.073 1.073l1.072 1.072m-1.072-1.072l1.838-1.839M18.467 4.696l-1.073-1.073l-1.072-1.072m1.072 1.072l-1.838 1.839M8.983 9.868a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M16.229 6.24a7.149 7.149 0 1 0-7.762 11.128m9.141-7.611a7 7 0 0 0-.253-1.272v0c-.24-.81-.62-1.57-1.126-2.245m-3.479 9.69v5.8a1.5 1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5v-5.8"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="m11.25 17.243l4.518-3.954a2.25 2.25 0 0 1 2.964 0l4.518 3.954m-4.5 5.989h-3v-3a1.5 1.5 0 1 1 3 0z"></svg:path><svg:path d="M9.358 13.368a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceHouse2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceHouseShieldIcon],svg[covid-quarantine-place-house-shield-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M18.344 21.148a2.804 2.804 0 1 0 0-5.608a2.804 2.804 0 0 0 0 5.608m-.468-7.711h.935m-.467 0v2.103m3.139-.996l.66.661m-.33-.33l-1.487 1.486m2.924 1.515v.935m0-.467h-2.103m.996 3.139l-.66.66m.33-.33l-1.487-1.487m-1.515 2.924h-.935m.468 0v-2.103m-3.139.996l-.661-.66m.331.33l1.486-1.487m-2.924-1.515v-.935m0 .468h2.103m-.996-3.139l.661-.661m-.33.331l1.486 1.486M19.25 9.5V3.76a1.41 1.41 0 0 0-.823-1.292A20.6 20.6 0 0 0 10 .75a20.6 20.6 0 0 0-8.427 1.718A1.41 1.41 0 0 0 .75 3.76v7.224c0 3.532 1.546 8.352 8.228 10.922a2.85 2.85 0 0 0 2.044 0m3.79-11.052V7.068"></svg:path><svg:path d="M5.062 7.068v6.286a1.625 1.625 0 0 0 1.625 1.625h3.75"></svg:path><svg:path d="m3.437 8.49l4.9-4.283a2.44 2.44 0 0 1 3.211 0l4.889 4.283m-4.875 6.489h-3.25v-3.25a1.625 1.625 0 1 1 3.25 0z"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceHouseShieldIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceSelfLockdown1Icon],svg[covid-quarantine-place-self-lockdown-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 11.25a2.25 2.25 0 1 0 0-4.5a2.25 2.25 0 0 0 0 4.5m1.5 12l.75-4.5h1.5V16.5a3.75 3.75 0 0 0-7.5 0v2.25h1.5l.75 4.5z"></svg:path><svg:path d="M22.272 23.25a.98.98 0 0 0 .978-.978V9.75a1.2 1.2 0 0 0-.377-.8L12 .75L1.127 8.949c-.224.208-.36.495-.377.8v12.523a.98.98 0 0 0 .978.978z"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceSelfLockdown1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceSelfLockdown2Icon],svg[covid-quarantine-place-self-lockdown-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 11.25a2.25 2.25 0 1 0 0-4.5a2.25 2.25 0 0 0 0 4.5m1.5 12l.75-4.5h1.5V16.5a3.75 3.75 0 0 0-7.5 0v2.25h1.5l.75 4.5z"></svg:path><svg:path d="M22.873 8.949L20.5 7.161V1.25H16v2.518L12 .75L1.127 8.949c-.224.208-.36.495-.377.8v12.522a.98.98 0 0 0 .978.979h20.544a.98.98 0 0 0 .978-.979V9.75a1.2 1.2 0 0 0-.377-.801"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceSelfLockdown2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceTimeCalendar2Icon],svg[covid-quarantine-place-time-calendar-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"><svg:path stroke-linecap="round" d="M12 18.373a2.714 2.714 0 1 0 0-5.428a2.714 2.714 0 0 0 0 5.428m-.452-7.464h.904m-.452 0v2.036m3.039-.965l.64.64m-.32-.32l-1.44 1.44m2.831 1.467v.904m0-.452h-2.036m.965 3.039l-.64.64m.32-.32l-1.44-1.44m-1.467 2.831h-.904m.452 0v-2.036m-3.039.965l-.64-.64m.32.32l1.44-1.44M7.25 16.111v-.904m0 .452h2.036m-.965-3.039l.64-.64m-.32.32l1.44 1.44"></svg:path><svg:path stroke-linecap="round" d="M21.75 2.82H2.25a1.5 1.5 0 0 0-1.5 1.5v17.375a1.5 1.5 0 0 0 1.5 1.5h19.5a1.5 1.5 0 0 0 1.5-1.5V4.32a1.5 1.5 0 0 0-1.5-1.5"></svg:path><svg:path d="M.75 8.32h22.5"></svg:path><svg:path stroke-linecap="round" d="M7.25 4.805v-4m9 4v-4"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceTimeCalendar2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidQuarantinePlaceTimeDateDayIcon],svg[covid-quarantine-place-time-date-day-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.75 14.875h2v8m8.5-3h-5.5c0-3 4-5 4-5v8"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M10.125 17.375a6.87 6.87 0 1 1 6.737-5.5m-5.279-10.75H8.667m1.458 0v2.5M4.527 2.84L3.496 3.871L2.465 4.902m1.031-1.031l1.768 1.768M.75 9.042v2.916m0-1.458h2.5m-.785 5.598l1.031 1.031l1.031 1.031m-1.031-1.031l1.768-1.768m3.403 4.514h2.916m-1.458 0v-2.5m9.375-5.417V9.042m0 1.458H17m.785-5.598l-1.031-1.031l-1.031-1.031m1.031 1.031l-1.768 1.768"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M8.042 9.875a1.458 1.458 0 1 0 0-2.916a1.458 1.458 0 0 0 0 2.916"></svg:path><svg:path d="M9.65 14.208a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidQuarantinePlaceTimeDateDayIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingCorrect3Icon],svg[covid-social-distancing-correct-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M18.5 7.538a3.375 3.375 0 1 0 0-6.75a3.375 3.375 0 0 0 0 6.75m4.75 3.75a6.027 6.027 0 0 0-9.5 0"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M21.875 4.275A6.8 6.8 0 0 1 20 4.538a6.73 6.73 0 0 1-4.568-1.78M5.5 19.288a3.375 3.375 0 1 0 0-6.75a3.375 3.375 0 0 0 0 6.75m4.749 3.75a6.026 6.026 0 0 0-9.5 0"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M8.875 16.024a6.76 6.76 0 0 1-6.443-1.516m2.839-4.546a4.5 4.5 0 1 0 0-9a4.5 4.5 0 0 0 0 9"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="m3.471 5.912l.975.974a.45.45 0 0 0 .684-.056l1.941-2.718"></svg:path><svg:path d="M12.5 19.788a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75m3-2.125a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75m3-2.125a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75"></svg:path></svg:g>`,
})
export class CovidSocialDistancingCorrect3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingCorrect6Icon],svg[covid-social-distancing-correct-6-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M4.974 19.375a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.226 3.75a4.473 4.473 0 0 0-8.449 0m18.275-3.75a2.625 2.625 0 1 0 0-5.25a2.625 2.625 0 0 0 0 5.25m4.224 3.75a4.473 4.473 0 0 0-8.449 0M.75 6.875h3.5m-1.5 2l-2-2l2-2m20.5 2h-3.5m1.5 2l2-2l-2-2m-9.25 6a5 5 0 1 0 0-10a5 5 0 0 0 0 10"></svg:path><svg:path d="m10 6.375l1.083 1.083a.5.5 0 0 0 .76-.063L14 4.375"></svg:path></svg:g>`,
})
export class CovidSocialDistancingCorrect6Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingDoNotClose1Icon],svg[covid-social-distancing-do-not-close-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M6.856 6.524a2.887 2.887 0 1 0 0-5.774a2.887 2.887 0 0 0 0 5.774M4.833 9.521a1.62 1.62 0 0 1-2.133.819l-.99-.44a1.618 1.618 0 0 1 1.318-2.956l.986.439a1.62 1.62 0 0 1 .819 2.138m2.306 12.11v-5.605m3.237-3.568v9.173a1.619 1.619 0 1 1-3.237 0"></svg:path><svg:path d="M7.139 21.631a1.619 1.619 0 1 1-3.238 0v-8.173m-2.701-.25v2.421a1.617 1.617 0 0 0 1.618 1.618H3.9M15.516 6.524a2.887 2.887 0 1 0 0-5.774a2.887 2.887 0 0 0 0 5.774"></svg:path><svg:path d="M21.084 10.968a5.4 5.4 0 0 0-5.312-4.445a12 12 0 0 0-1.835.053m-.863 5.343a5.4 5.4 0 0 0-5.4-5.4a7.5 7.5 0 0 0-2.844.3a1.74 1.74 0 0 0-.82.564m14.24 15.842a5 5 0 1 0 0-10a5 5 0 0 0 0 10m3.535-8.535l-7.07 7.07"></svg:path></svg:g>`,
})
export class CovidSocialDistancingDoNotClose1Icon {
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingDoNotClose3Icon],svg[covid-social-distancing-do-not-close-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M10.218 10.25a4.75 4.75 0 1 0 0-9.5a4.75 4.75 0 0 0 0 9.5M17.021.946a4.75 4.75 0 1 1 .642 9.251M6.471 17.724a2.125 2.125 0 0 1-3 0l-2.1-2.1a2.125 2.125 0 0 1 3.005-3l2.1 2.1a2.125 2.125 0 0 1-.005 3m-3.498 3.034v2.492"></svg:path><svg:path d="M4.251 12.508A6.24 6.24 0 0 1 9.06 10.25h3.222a6.3 6.3 0 0 1 2.815.656m2.913 12.319a5 5 0 1 0 0-10a5 5 0 0 0 0 10m3.535-8.535l-7.07 7.07"></svg:path></svg:g>`,
})
export class CovidSocialDistancingDoNotClose3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingDoNotTouchIcon],svg[covid-social-distancing-do-not-touch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="m20.847 10.46l-1.079-5.394a1.613 1.613 0 0 0-3.185.14l-.362 3.255l-7.228-7.229A1.572 1.572 0 0 0 6.77 3.456L5.658 2.345a1.572 1.572 0 1 0-2.224 2.223L4.546 5.68A1.573 1.573 0 0 0 2.322 7.9l1.112 1.116A1.573 1.573 0 0 0 1.21 11.24l2.078 2.126m5.88-7.511L6.767 3.454m-.686 3.761L4.544 5.678"></svg:path><svg:path d="M12.382 12.47C8.271 8.726 6.458 9.717 5.9 10.28l-3.715 4.392a3.75 3.75 0 0 0-.9 2.111m9.039 1.208l-1.246-.013l2.261-2.581m-6.918 6.759l.714-.892c.78.169 1.59.14 2.355-.083l3.259-.715m7.507 2.762a4.994 4.994 0 1 0 0-9.988a4.994 4.994 0 0 0 0 9.988m3.53-8.525l-7.061 7.062"></svg:path></svg:g>`,
})
export class CovidSocialDistancingDoNotTouchIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingManIcon],svg[covid-social-distancing-man-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 5.8A2.4 2.4 0 1 0 12 1a2.4 2.4 0 0 0 0 4.8m4.2 5.4a4.2 4.2 0 1 0-8.4 0V13h1.8l.6 6h3.6l.6-6h1.8zM1 6v4m4-2H1m22-2v4m-4-2h4"></svg:path><svg:path d="M5 15.914c-2.443.734-4 1.844-4 3.086c0 2.209 4.925 4 11 4s11-1.791 11-4c0-1.242-1.557-2.352-4-3.086"></svg:path></svg:g>`,
})
export class CovidSocialDistancingManIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingProtectShield1Icon],svg[covid-social-distancing-protect-shield-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingProtectShield2Icon],svg[covid-social-distancing-protect-shield-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CovidSocialDistancingProtectShield2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingVirusIcon],svg[covid-social-distancing-virus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSocialDistancingWomanIcon],svg[covid-social-distancing-woman-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 6.009a2.567 2.567 0 1 0 0-5.134a2.567 2.567 0 0 0 0 5.134m1.925 14.116l.642-6.417h1.925v-1.925a4.49 4.49 0 0 0-2.023-3.752L12 11.783L9.531 8.031a4.49 4.49 0 0 0-2.023 3.752v1.925h1.925l.642 6.417z"></svg:path><svg:path d="M9.433 3.442s0 3.208-1.925 3.208m7.059-3.208s0 3.208 1.925 3.208M1 6.125v4m4-2H1m22-2v4m-4-2h4M5 16.039c-2.443.734-4 1.844-4 3.086c0 2.209 4.925 4 11 4s11-1.791 11-4c0-1.242-1.557-2.352-4-3.086"></svg:path></svg:g>`,
})
export class CovidSocialDistancingWomanIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsColdFeverIcon],svg[covid-symptoms-cold-fever-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsFeverIcon],svg[covid-symptoms-fever-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M6.01 16.607a3.495 3.495 0 1 0 0-6.99a3.495 3.495 0 0 0 0 6.99m5.242 6.616a5.243 5.243 0 0 0-10.485 0m20.968-7.821V3.751a2.996 2.996 0 1 0-5.991 0v11.651a4.493 4.493 0 1 0 5.991 0M18.74 5.249v11.983"></svg:path><svg:path d="M18.74 20.227a1.498 1.498 0 1 0 0-2.995a1.498 1.498 0 0 0 0 2.995M2.014 7.745a2.47 2.47 0 0 1 0-3.495a2.47 2.47 0 0 0 0-3.495m3.721 6.99a2.47 2.47 0 0 1 0-3.495a2.47 2.47 0 0 0 0-3.495m3.995 6.99a2.47 2.47 0 0 1 0-3.495a2.473 2.473 0 0 0 0-3.495"></svg:path></svg:g>`,
})
export class CovidSymptomsFeverIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsNauseaIcon],svg[covid-symptoms-nausea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CovidSymptomsNauseaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusDiarrhea1Icon],svg[covid-symptoms-virus-diarrhea-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusDiarrhea2Icon],svg[covid-symptoms-virus-diarrhea-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="m14.513 6.193l2.222-2.63l.531 1.832l2.222-2.63m-2.405 6.151l3.07-1.557l-.223 1.894L23 7.695M9.12 6.001a2.623 2.623 0 1 0 0-5.246a2.623 2.623 0 0 0 0 5.246m-2.25 7.498A1.5 1.5 0 0 0 5.373 12H2.374a1.5 1.5 0 0 0-1.499 1.499v9.743m8.994-.003a4.497 4.497 0 0 0 4.496-4.497M.875 16.494H6.81"></svg:path><svg:path d="M10.01 15.744h5.854a1.5 1.5 0 0 1 1.341.83l3.336 6.671"></svg:path><svg:path d="m17.18 23.229l-2.242-4.487H8.37a1.5 1.5 0 0 1-1.493-1.635V9.313a1.913 1.913 0 0 1 3.302-1.37l5.247 5.246a1.499 1.499 0 1 1-2.12 2.12l-2.984-2.983"></svg:path></svg:g>`,
})
export class CovidSymptomsVirusDiarrhea2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusHeadache1Icon],svg[covid-symptoms-virus-headache-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusLossSmell1Icon],svg[covid-symptoms-virus-loss-smell-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M6.886 10.392a3.506 3.506 0 1 0 0-7.012a3.506 3.506 0 0 0 0 7.012M6.302.75h1.169m-.585 0v2.63m3.926-1.246l.827.827m-.414-.414l-1.859 1.86m3.657 1.895v1.169m0-.585h-2.63m1.246 3.926l-.827.827m.413-.414L9.366 9.366m-1.895 3.657H6.302m.584 0v-2.63m-3.925 1.246l-.827-.827m.413.413l1.86-1.859M.75 7.471V6.302m0 .584h2.63M2.134 2.961l.827-.827m-.414.413l1.86 1.86M22.468.75s-2.82 5.83-5.475 7.821c-3.128 2.346-1.564 5.474.782 5.474h5.475"></svg:path><svg:path d="M19.578 10.977c.767-1.022 1.534-1.022 3.068-1.022m-8.166 7.67a6.5 6.5 0 0 0 1.007-1.534m-5.114 4.091a8.4 8.4 0 0 0 2.046-.842m7.765 1.865a4 4 0 0 0 .416 2.045m1.023-6.136c-.341.681-.682 1.363-.947 2.045m-5.189 3.068c-.549.56-1.269.92-2.046 1.023m4.091-4.09a8.4 8.4 0 0 1-.758 1.533"></svg:path></svg:g>`,
})
export class CovidSymptomsVirusLossSmell1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusLungDamageIcon],svg[covid-symptoms-virus-lung-damage-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidSymptomsVirusStomachIcon],svg[covid-symptoms-virus-stomach-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M13.906 13.498a2.776 2.776 0 1 0 0-5.552a2.776 2.776 0 0 0 0 5.552m-.462-7.634h.925m-.463 0v2.082m3.108-.987l.655.655m-.328-.328l-1.472 1.473m2.895 1.5v.925m0-.462h-2.082m.987 3.108l-.655.654m.327-.327l-1.472-1.472m-1.5 2.895h-.925m.462 0v-2.082m-3.108.986l-.654-.654m.327.327l1.472-1.472m-2.895-1.501v-.925m0 .463h2.082m-.986-3.108l.654-.655m-.327.327l1.472 1.473"></svg:path><svg:path d="M8.083 23.25a11.1 11.1 0 0 1 .826-3.731c4.13.685 11.261-1.615 13.4-5.892C25.17 7.9 20.184.781 13.6 1.878a10.6 10.6 0 0 0-5.3 2.551C7.051 3.248 7 2.8 5.98.75M.867.75a20.5 20.5 0 0 0 4.356 7.8C3.827 11.48 3.6 14.7 4.7 16.828a14.34 14.34 0 0 0-1.73 6.422"></svg:path></svg:g>`,
})
export class CovidSymptomsVirusStomachIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusAirplaneFlightIcon],svg[covid-transmission-virus-airplane-flight-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusBriefcaseIcon],svg[covid-transmission-virus-briefcase-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12.369 11.107a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714m-.476-7.857h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.337L14.389 6.23m2.98 1.544v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.336l-1.516-1.516m-1.544 2.98h-.952m.476 0v-2.143M9.17 12.122l-.673-.673m.337.337l1.515-1.516m-2.98-1.544v-.952m0 .476h2.143M8.497 5.051l.673-.673m-.336.336l1.515 1.516M6.75 2.25V.75m10.5 1.5V.75m-9.75 18a1.5 1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5"></svg:path><svg:path d="M22.25 15.75H1.75a1 1 0 0 0-1 1v5.5a1 1 0 0 0 1 1h20.5a1 1 0 0 0 1-1v-5.5a1 1 0 0 0-1-1m-6.5-13.5h3.75a1.5 1.5 0 0 1 1.5 1.5v12m-18 0v-12a1.5 1.5 0 0 1 1.5-1.5h3.94"></svg:path></svg:g>`,
})
export class CovidTransmissionVirusBriefcaseIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusCoughIcon],svg[covid-transmission-virus-cough-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusCrowdIcon],svg[covid-transmission-virus-crowd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusExpandIcon],svg[covid-transmission-virus-expand-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class CovidTransmissionVirusExpandIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusFloatWindIcon],svg[covid-transmission-virus-float-wind-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.926 19.117a4.857 4.857 0 1 0 0-9.714a4.857 4.857 0 0 0 0 9.714m-.81-13.357h1.619m-.809 0v3.642m7.126-8.162l1.374.857m-.687-.428L16.811 4.76m3.618 2.851l1.145 1.145m-.572-.572l-2.576 2.576m-.917 8.938l-1.145 1.144m.572-.572l-2.576-2.576m-2.625 5.066h-1.619m.81 0v-3.643m-5.438 1.725l-1.145-1.144m.572.572l2.576-2.576m-5.065-2.625V13.45m0 .81h3.643M4.343 8.822l1.145-1.145m-.573.572l2.576 2.576"></svg:path>`,
})
export class CovidTransmissionVirusFloatWindIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusHandshakeIcon],svg[covid-transmission-virus-handshake-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M18.25 8.685a2.857 2.857 0 1 0 0-5.714a2.857 2.857 0 0 0 0 5.714M17.774.828h.952m-.476 0v2.143m3.199-1.015l.673.673m-.336-.337L20.27 3.807m2.98 1.545v.952m0-.476h-2.143m1.015 3.199l-.673.673m.337-.337L20.27 7.848m-1.544 2.98h-.952m.476 0V8.685M15.051 9.7l-.673-.673m.336.336l1.516-1.515m-2.98-1.544v-.952m0 .476h2.143m-1.015-3.199l.673-.673m-.337.336l1.516 1.515m.003 16.153l-4.269.854m.422-4.843l-2.014.851a1.27 1.27 0 0 1-1-.014a1.32 1.32 0 0 1-.7-.741a1.36 1.36 0 0 1 .63-1.693l2.014-1.006a1.75 1.75 0 0 1 1.422-.084l4.138 1.631"></svg:path><svg:path d="M4.143 20.848h1.425l2.719 2.074A.74.74 0 0 0 9.312 23l3.8-3.138a.75.75 0 0 0 .115-1.038L11.133 16.5m-2.048-1.984l-.22-.181a1.59 1.59 0 0 0-1.538-.2l-3.185 1.359"></svg:path><svg:path d="M.75 21.517h2.372a1.02 1.02 0 0 0 1.07-.956v-4.778a1.02 1.02 0 0 0-1.07-.955H.75m18.925 6.689H17.3a1.02 1.02 0 0 1-1.07-.956v-4.778a1.02 1.02 0 0 1 1.07-.955h2.372m-9.396-9h-9m3-3l-3 3l3 3"></svg:path></svg:g>`,
})
export class CovidTransmissionVirusHandshakeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusHumanInfectedIcon],svg[covid-transmission-virus-human-infected-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusHumanTransmit2Icon],svg[covid-transmission-virus-human-transmit-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusIncreaseRateIcon],svg[covid-transmission-virus-increase-rate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusMobileApplicationIcon],svg[covid-transmission-virus-mobile-application-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusTouchFingerIcon],svg[covid-transmission-virus-touch-finger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusTouchHand1Icon],svg[covid-transmission-virus-touch-hand-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M17 20.429a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858M16.429 11h1.142M17 11v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819M23 16.429v1.142M23 17h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819M17.571 23h-1.142M17 23v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819M11 17.571v-1.142M11 17h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M4 11.252V3.786c0-.396.158-.776.44-1.056a1.503 1.503 0 0 1 2.12 0c.282.28.44.66.44 1.056"></svg:path><svg:path d="M4 9.012a1.5 1.5 0 0 0-.44-1.056a1.503 1.503 0 0 0-2.12 0c-.282.28-.44.66-.44 1.056v5.815a4.46 4.46 0 0 0 2 3.727l1.828 1.214A1.5 1.5 0 0 1 5.5 21.01v2.19M7 7.52V2.292c0-.396.158-.776.44-1.056a1.503 1.503 0 0 1 2.12 0c.282.28.44.66.44 1.056V7.52m0-4.48c0-.396.158-.776.44-1.056a1.504 1.504 0 0 1 2.12 0c.282.28.44.66.44 1.056v2.24m0 2.986V5.279c0-.396.158-.775.44-1.055a1.504 1.504 0 0 1 2.12 0c.282.28.44.66.44 1.055v2.987"></svg:path></svg:g>`,
})
export class CovidTransmissionVirusTouchHand1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusTouchHand2Icon],svg[covid-transmission-virus-touch-hand-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M7.214 18.804a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.143m-.572 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.818 1.819m3.575 1.853v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.818-1.819m-1.853 3.576H6.643m.571 0v-2.571m-3.838 1.218l-.808-.808m.404.404l1.818-1.819m-3.576-1.853v-1.142m0 .571h2.572m-1.218-3.839l.808-.808m-.404.404l1.818 1.819m17.996-6.826l-2.937-2.35a5.26 5.26 0 0 0-3.28-1.15h-6.033a1.749 1.749 0 0 0-1.237 2.987a1.75 1.75 0 0 0 1.237.513h4.52"></svg:path><svg:path d="M22.626 11.375h-3.5a5.25 5.25 0 0 1-2.914-.883l-2-1.333a1.634 1.634 0 0 1-.512-2.306v0a1.633 1.633 0 0 1 2.09-.555l2.625 1.577"></svg:path></svg:g>`,
})
export class CovidTransmissionVirusTouchHand2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusTransmitIcon],svg[covid-transmission-virus-transmit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-width="1.5"><svg:path stroke-linecap="round" stroke-linejoin="round" d="M12.267 2.142H9.233m1.517 0v2.6m-5.822-.817L3.856 4.997L2.783 6.07m1.073-1.073l1.838 1.839M1 10.375v3.033m0-1.516h2.6m-.817 5.821l1.073 1.073l1.072 1.072m-1.072-1.072l1.838-1.839M18.717 6.07l-1.073-1.073l-1.072-1.072m1.072 1.072l-1.838 1.839m-6.573 4.406a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M17.606 9.858a7.15 7.15 0 1 0-8.889 8.884M12 21.858l.3-1.185a4.89 4.89 0 0 1 4.743-3.7H23"></svg:path><svg:path stroke-linecap="round" stroke-linejoin="round" d="M19.333 20.636L23 16.969l-3.667-3.666"></svg:path><svg:path d="M11.491 14.742a.375.375 0 1 1 0-.75m0 .75a.375.375 0 1 0 0-.75"></svg:path></svg:g>`,
})
export class CovidTransmissionVirusTransmitIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusTrashBinIcon],svg[covid-transmission-virus-trash-bin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidTransmissionVirusVisibleIcon],svg[covid-transmission-virus-visible-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionFaceMask1Icon],svg[covid-vaccine-protection-face-mask-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionFaceMask2Icon],svg[covid-vaccine-protection-face-mask-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12 20.582a19.2 19.2 0 0 1-7.964-1.493V10.13s5.973-3.11 7.963-3.11"></svg:path><svg:path d="M7.022 12.868A38 38 0 0 1 12 12.37m-4.978 3.982a29 29 0 0 0 4.977.497"></svg:path><svg:path d="M12 20.582c2.73.074 5.445-.435 7.963-1.493V10.13s-5.973-3.11-7.964-3.11"></svg:path><svg:path d="M16.977 12.868a38 38 0 0 0-4.978-.498m4.978 3.982a29 29 0 0 1-4.978.497M4.036 10.13l-.749-.398A4.73 4.73 0 0 1 .801 5.564a2.154 2.154 0 0 1 2.153-2.153c.386 0 .768.086 1.116.254a2.104 2.104 0 0 1 .712 3.23m-.746 12.194A6.8 6.8 0 0 1 .8 13.299a9 9 0 0 1 .127-1.61m19.036-1.559l.748-.398A4.73 4.73 0 0 0 23.2 5.569a2.154 2.154 0 0 0-2.153-2.153c-.386 0-.768.086-1.116.254a2.104 2.104 0 0 0-.713 3.23m.745 12.189a6.8 6.8 0 0 0 3.235-5.79a9 9 0 0 0-.127-1.61"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionFaceMask2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionFaceShield1Icon],svg[covid-vaccine-protection-face-shield-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M7 .81c-3.559.543-6 1.645-6 2.92c0 1.811 4.925 3.28 11 3.28s11-1.469 11-3.28c0-1.275-2.441-2.377-6-2.92"></svg:path><svg:path d="M1 3.73v3.3c0 1.812 4.925 3.281 11 3.281s11-1.465 11-3.277V3.73"></svg:path><svg:path d="m4 9.315l-.9 9.794a1.98 1.98 0 0 0 .848 1.823A14.3 14.3 0 0 0 12 23.19c2.85.068 5.655-.718 8.054-2.258a1.98 1.98 0 0 0 .848-1.823L20 9.315"></svg:path><svg:path d="M13 20.19a7.64 7.64 0 0 0 5-2"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionFaceShield1Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionInfraredThermometerGunIcon],svg[covid-vaccine-protection-infrared-thermometer-gun-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M20.394 20.75a2.34 2.34 0 0 0 2.3-2.8l-2.3-11.483a4 4 0 0 0-3.923-3.217H4.62a1.5 1.5 0 0 0-1.464 1.825L4.4 10.684a2 2 0 0 0 1.954 1.566h4.566a4 4 0 0 1 3.772 2.669l1.292 3.66a3.25 3.25 0 0 0 3.069 2.171z"></svg:path><svg:path d="M11.769 12.34a6.23 6.23 0 0 1-.569 3.56a.6.6 0 0 0 .552.854h3.588M19.594 4.75h2.156a1.5 1.5 0 0 1 1.5 1.5v1.5a1.5 1.5 0 0 1-1.5 1.5h-.8m-16.532 1.5H2.25a1.5 1.5 0 0 1-1.5-1.5v-3a1.5 1.5 0 0 1 1.5-1.5h.87m11.13 3a1.5 1.5 0 0 1-1.5 1.5h-3.5a1.5 1.5 0 0 1 0-3h3.5a1.5 1.5 0 0 1 1.5 1.5"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionInfraredThermometerGunIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionSanitizerSprayIcon],svg[covid-vaccine-protection-sanitizer-spray-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionShieldIcon],svg[covid-vaccine-protection-shield-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12.125 14.339a3.714 3.714 0 1 0 0-7.428a3.714 3.714 0 0 0 0 7.428m-.619-10.214h1.238m-.619 0v2.786m4.158-1.321l.876.877m-.438-.438l-1.97 1.97m3.874 2.007v1.238m0-.619h-2.786m1.32 4.158l-.876.876m.438-.438l-1.97-1.97m-2.007 3.874h-1.238m.619 0v-2.786m-4.158 1.32l-.876-.876m.438.438l1.97-1.97m-3.874-2.007v-1.238m0 .619h2.786m-1.32-4.158l.876-.876m-.438.438l1.97 1.97"></svg:path><svg:path d="M2.25 3.923v7.614c0 3.723 1.629 8.8 8.673 11.513a3 3 0 0 0 2.154 0c7.041-2.708 8.673-7.822 8.673-11.513V3.923a1.49 1.49 0 0 0-.868-1.362A21.7 21.7 0 0 0 12 .75a21.7 21.7 0 0 0-8.882 1.811a1.49 1.49 0 0 0-.868 1.362"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionShieldIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionSyringeIcon],svg[covid-vaccine-protection-syringe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="m17.123 9.03l-4.816-4.816L4.121 12.4a1.36 1.36 0 0 0 0 1.926L6.689 16.9a1.5 1.5 0 0 0 2.124 0v0"></svg:path><svg:path d="m4.602 14.808l-2.408 2.408l1.926 1.926l2.408-2.408zM.75 20.587l2.408-2.408M10.863 2.77l1.444 1.444m1.445 1.445l3.371-3.371m1.926 1.926l-3.371 3.371m0-6.742l4.816 4.816m2.756 9.998a7.67 7.67 0 0 1-6 7.5a7.67 7.67 0 0 1-6-7.5v-2.25a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5zm-6-.75v4.5M15 17.157h4.5"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionSyringeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionVirusIcon],svg[covid-vaccine-protection-virus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M12.267.75H9.233m1.517 0v2.6m-5.822-.817L3.856 3.606L2.783 4.678m1.073-1.072l1.838 1.838M1 8.983v3.034M1 10.5h2.6m-.817 5.822l1.073 1.072l1.072 1.073m-1.072-1.073l1.838-1.838M18.717 4.678l-1.073-1.072l-1.072-1.073m1.072 1.073l-1.838 1.838M9.233 9.85a1.517 1.517 0 1 0 0-3.034a1.517 1.517 0 0 0 0 3.034"></svg:path><svg:path d="M17.538 8.25A7.15 7.15 0 1 0 8 17.1"></svg:path><svg:path d="M23 15.75a7.67 7.67 0 0 1-6 7.5a7.67 7.67 0 0 1-6-7.5V13.5a1.5 1.5 0 0 1 1.5-1.5h9a1.5 1.5 0 0 1 1.5 1.5zM17 15v4.5m-2.25-2.25h4.5"></svg:path></svg:g>`,
})
export class CovidVaccineProtectionVirusIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVaccineProtectionWashHandsIcon],svg[covid-vaccine-protection-wash-hands-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 4.5h-3a1.5 1.5 0 0 0 0-3H8.158a4.5 4.5 0 0 0-3.744 2L3.2 5.332A1.5 1.5 0 0 1 1.947 6H.75m11-1.5H14M.75 21.75h1.9c.233 0 .463.054.671.158l1.733.867a4.5 4.5 0 0 0 2.012.475H18.75a1.5 1.5 0 1 0 0-3H21a1.5 1.5 0 1 0 0-3h.75a1.5 1.5 0 1 0 0-3h-1.5a1.5 1.5 0 1 0 0-3H15a1.5 1.5 0 1 0 0-3H9.158a4.5 4.5 0 0 0-3.744 2L4.2 12.082a1.5 1.5 0 0 1-1.248.668H.75m12-1.5H15m1.5 6H21m-4.5-3h3.75m-4.5 6h3M21.007.75a.455.455 0 0 1 .423.289c.414 1.063 1.82 4.749 1.82 5.789a2.21 2.21 0 1 1-4.421 0c0-1.062 1.465-4.878 1.845-5.851a.36.36 0 0 1 .333-.227"></svg:path>`,
})
export class CovidVaccineProtectionWashHandsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVirusLabResearchMagnifier2Icon],svg[covid-virus-lab-research-magnifier-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M10.617 13.837a3.22 3.22 0 1 0 0-6.44a3.22 3.22 0 0 0 0 6.44m-.537-8.855h1.074m-.537 0v2.415m3.605-1.144l.759.76m-.38-.38L12.894 8.34m3.358 1.74v1.074m0-.537h-2.415m1.144 3.605l-.759.759m.379-.38l-1.707-1.707m-1.74 3.358H10.08m.537 0v-2.415m-3.605 1.144l-.759-.759m.38.379l1.707-1.707m-3.358-1.74V10.08m0 .537h2.415M6.253 7.012l.759-.759m-.379.38L8.34 8.34"></svg:path><svg:path d="M10.617 20.484c5.45 0 9.867-4.418 9.867-9.867S16.066.75 10.617.75S.75 5.168.75 10.617s4.418 9.867 9.867 9.867M23.25 23.25l-5.656-5.656"></svg:path></svg:g>`,
})
export class CovidVirusLabResearchMagnifier2Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVirusLabResearchMedicinePillIcon],svg[covid-virus-lab-research-medicine-pill-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819m3.576 1.853v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819m-3.576-1.853v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M8.6 16.4a4.6 4.6 0 0 1-6.5-6.5l7.8-7.8a4.6 4.6 0 0 1 6.5 6.5M5.999 5.999l5.138 5.138"></svg:path>`,
})
export class CovidVirusLabResearchMedicinePillIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVirusLabResearchMicroscopeIcon],svg[covid-virus-lab-research-microscope-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M6.047 9.375a3 3 0 1 0 0-6a3 3 0 0 0 0 6m-.5-8.25h1m-.5 0v2.25m3.359-1.066l.707.707m-.354-.353L8.168 4.254m3.129 1.621v1m0-.5h-2.25m1.066 3.359l-.707.707m.353-.354L8.168 8.496m-1.621 3.129h-1m.5 0v-2.25m-3.359 1.066l-.707-.707m.354.353l1.591-1.591M.797 6.875v-1m0 .5h2.25M1.981 3.016l.707-.707m-.353.354l1.591 1.591M18.146 9.1a6.134 6.134 0 0 1 .315 9.07a6.4 6.4 0 0 1-8.941 0a6.2 6.2 0 0 1-1.558-2.52"></svg:path><svg:path d="M16.151 11.054a.913.913 0 0 1-1.277 0L13.6 9.8a.875.875 0 0 1 0-1.254l3.832-3.764a.915.915 0 0 1 1.277 0l1.277 1.255a.875.875 0 0 1 0 1.254z"></svg:path><svg:path d="m19.168 5.236l2.59-2.592l-1.445-1.445m2.89 2.89l-1.445-1.445M5.797 15.65h5.058m-4.27 7.225h13.728m-6.503-2.89v2.89"></svg:path></svg:g>`,
})
export class CovidVirusLabResearchMicroscopeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[covidVirusLabResearchSyringeIcon],svg[covid-virus-lab-research-syringe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[covidVirusLabResearchTestTubeIcon],svg[covid-virus-lab-research-test-tube-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><svg:path d="M17 20.679a3.429 3.429 0 1 0 0-6.858a3.429 3.429 0 0 0 0 6.858m-.571-9.429h1.142m-.571 0v2.571m3.839-1.218l.808.808m-.404-.404l-1.819 1.819M23 16.679v1.142m0-.571h-2.571m1.218 3.839l-.808.808m.404-.404l-1.819-1.819m-1.853 3.576h-1.142m.571 0v-2.571m-3.839 1.218l-.808-.808m.404.404l1.819-1.819M11 17.821v-1.142m0 .571h2.571m-1.218-3.839l.808-.808m-.404.404l1.819 1.819M9.549 22.25a3.75 3.75 0 0 1-6.3-2.75V.75h7.5v9.5M13 .75H1"></svg:path><svg:path d="M8.125 8.25a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75a.375.375 0 0 1-.375-.375m.75 0A.375.375 0 0 1 8.125 9m-2.25 3.75a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75a.375.375 0 0 1-.375-.375m.75 0a.375.375 0 0 1-.375.375m1.5 3.75a.375.375 0 0 1 .375.375m-.75 0a.375.375 0 0 1 .375-.375m0 .75A.375.375 0 0 1 7 17.625m.75 0a.375.375 0 0 1-.375.375M10.75 5.25h-7.5"></svg:path></svg:g>`,
})
export class CovidVirusLabResearchTestTubeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
