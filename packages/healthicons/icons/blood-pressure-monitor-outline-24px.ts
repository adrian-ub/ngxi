...
@Component({
  standalone: true,
  selector: 'svg[healthiconsBloodPressureMonitorOutline24pxIcon],svg[healthicons-blood-pressure-monitor-outline-24px-icon]',
  host: {
    role: 'img',
