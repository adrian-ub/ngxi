...
@Component({
  standalone: true,
  selector: 'svg[healthiconsBladderOutline24pxIcon],svg[healthicons-bladder-outline-24px-icon]',
  host: {
    role: 'img',
