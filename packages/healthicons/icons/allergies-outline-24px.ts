...
@Component({
  standalone: true,
  selector: 'svg[healthiconsAllergiesOutline24pxIcon],svg[healthicons-allergies-outline-24px-icon]',
  host: {
    role: 'img',
