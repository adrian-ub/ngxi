...
@Component({
  standalone: true,
  selector: 'svg[healthiconsCardiogramOutline24pxIcon],svg[healthicons-cardiogram-outline-24px-icon]',
  host: {
    role: 'img',
