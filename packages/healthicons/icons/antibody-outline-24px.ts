...
@Component({
  standalone: true,
  selector: 'svg[healthiconsAntibodyOutline24pxIcon],svg[healthicons-antibody-outline-24px-icon]',
  host: {
    role: 'img',
