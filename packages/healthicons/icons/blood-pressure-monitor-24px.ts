...
@Component({
  standalone: true,
  selector: 'svg[healthiconsBloodPressureMonitor24pxIcon],svg[healthicons-blood-pressure-monitor-24px-icon]',
  host: {
    role: 'img',
