...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalSketchWordmarkIcon],svg[devicon-original-sketch-wordmark-icon]',
  host: {
    role: 'img',
