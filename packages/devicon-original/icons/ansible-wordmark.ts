...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalAnsibleWordmarkIcon],svg[devicon-original-ansible-wordmark-icon]',
  host: {
    role: 'img',
