...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalViteWordmarkIcon],svg[devicon-original-vite-wordmark-icon]',
  host: {
    role: 'img',
