...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalK3osWordmarkIcon],svg[devicon-original-k3os-wordmark-icon]',
  host: {
    role: 'img',
