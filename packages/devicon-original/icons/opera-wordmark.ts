...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalOperaWordmarkIcon],svg[devicon-original-opera-wordmark-icon]',
  host: {
    role: 'img',
