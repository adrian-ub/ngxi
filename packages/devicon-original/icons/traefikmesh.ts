...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalTraefikmeshIcon],svg[devicon-original-traefikmesh-icon]',
  host: {
    role: 'img',
