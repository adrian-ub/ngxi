...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalSpringWordmarkIcon],svg[devicon-original-spring-wordmark-icon]',
  host: {
    role: 'img',
