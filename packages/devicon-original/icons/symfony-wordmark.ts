...
@Component({
  standalone: true,
  selector: 'svg[deviconOriginalSymfonyWordmarkIcon],svg[devicon-original-symfony-wordmark-icon]',
  host: {
    role: 'img',
