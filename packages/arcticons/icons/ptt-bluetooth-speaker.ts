...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPttBluetoothSpeakerIcon],svg[arcticons-ptt-bluetooth-speaker-icon]',
  host: {
    role: 'img',
