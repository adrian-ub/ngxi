...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiExtraterrestrialAlienIcon],svg[arcticons-emoji-extraterrestrial-alien-icon]',
  host: {
    role: 'img',
