...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSoloLevelingAriseIcon],svg[arcticons-solo-leveling-arise-icon]',
  host: {
    role: 'img',
