...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAdvancedTaskManagerIcon],svg[arcticons-advanced-task-manager-icon]',
  host: {
    role: 'img',
