...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNassauLibrarySystemIcon],svg[arcticons-nassau-library-system-icon]',
  host: {
    role: 'img',
