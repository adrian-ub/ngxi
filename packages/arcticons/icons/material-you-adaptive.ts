...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMaterialYouAdaptiveIcon],svg[arcticons-material-you-adaptive-icon]',
  host: {
    role: 'img',
