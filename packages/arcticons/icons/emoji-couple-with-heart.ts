...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiCoupleWithHeartIcon],svg[arcticons-emoji-couple-with-heart-icon]',
  host: {
    role: 'img',
