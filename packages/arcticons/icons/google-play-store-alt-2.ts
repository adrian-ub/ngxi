...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGooglePlayStoreAlt2Icon],svg[arcticons-google-play-store-alt-2-icon]',
  host: {
    role: 'img',
