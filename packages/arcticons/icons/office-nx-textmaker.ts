...
@Component({
  standalone: true,
  selector: 'svg[arcticonsOfficeNxTextmakerIcon],svg[arcticons-office-nx-textmaker-icon]',
  host: {
    role: 'img',
