...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMarshallBluetoothIcon],svg[arcticons-marshall-bluetooth-icon]',
  host: {
    role: 'img',
