...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarFossify12Icon],svg[arcticons-calendar-fossify-12-icon]',
  host: {
    role: 'img',
