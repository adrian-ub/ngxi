...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiAdhesiveBandageIcon],svg[arcticons-emoji-adhesive-bandage-icon]',
  host: {
    role: 'img',
