...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarFossify22Icon],svg[arcticons-calendar-fossify-22-icon]',
  host: {
    role: 'img',
