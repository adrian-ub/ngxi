...
@Component({
  standalone: true,
  selector: 'svg[arcticonsStudentloanConnectIcon],svg[arcticons-studentloan-connect-icon]',
  host: {
    role: 'img',
