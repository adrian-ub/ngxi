...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSamsungGlobalGoalsIcon],svg[arcticons-samsung-global-goals-icon]',
  host: {
    role: 'img',
