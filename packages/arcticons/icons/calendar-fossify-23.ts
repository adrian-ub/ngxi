...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarFossify23Icon],svg[arcticons-calendar-fossify-23-icon]',
  host: {
    role: 'img',
