...
@Component({
  standalone: true,
  selector: 'svg[arcticonsProductivityLauncherIcon],svg[arcticons-productivity-launcher-icon]',
  host: {
    role: 'img',
