...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiArticulatedLorryIcon],svg[arcticons-emoji-articulated-lorry-icon]',
  host: {
    role: 'img',
