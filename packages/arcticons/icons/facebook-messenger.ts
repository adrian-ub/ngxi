...
@Component({
  standalone: true,
  selector: 'svg[arcticonsFacebookMessengerIcon],svg[arcticons-facebook-messenger-icon]',
  host: {
    role: 'img',
