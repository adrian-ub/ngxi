...
@Component({
  standalone: true,
  selector: 'svg[arcticonsFridayNightFunkinIcon],svg[arcticons-friday-night-funkin-icon]',
  host: {
    role: 'img',
