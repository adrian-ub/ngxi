...
@Component({
  standalone: true,
  selector: 'svg[arcticonsYahooJapanBrowserIcon],svg[arcticons-yahoo-japan-browser-icon]',
  host: {
    role: 'img',
