...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMasterForMinecraftPeIcon],svg[arcticons-master-for-minecraft-pe-icon]',
  host: {
    role: 'img',
