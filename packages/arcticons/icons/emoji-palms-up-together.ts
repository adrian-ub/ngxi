...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiPalmsUpTogetherIcon],svg[arcticons-emoji-palms-up-together-icon]',
  host: {
    role: 'img',
