...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLuxYellowIconPackIcon],svg[arcticons-lux-yellow-icon-pack-icon]',
  host: {
    role: 'img',
