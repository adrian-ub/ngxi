...
@Component({
  standalone: true,
  selector: 'svg[arcticonsXiaohongshuRednoteIcon],svg[arcticons-xiaohongshu-rednote-icon]',
  host: {
    role: 'img',
