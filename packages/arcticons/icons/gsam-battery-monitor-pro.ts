...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGsamBatteryMonitorProIcon],svg[arcticons-gsam-battery-monitor-pro-icon]',
  host: {
    role: 'img',
