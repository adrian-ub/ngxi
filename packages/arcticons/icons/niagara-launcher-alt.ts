...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNiagaraLauncherAltIcon],svg[arcticons-niagara-launcher-alt-icon]',
  host: {
    role: 'img',
