...
@Component({
  standalone: true,
  selector: 'svg[arcticonsOfficeNxPlanmakerIcon],svg[arcticons-office-nx-planmaker-icon]',
  host: {
    role: 'img',
