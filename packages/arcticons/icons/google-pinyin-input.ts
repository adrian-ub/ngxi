...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGooglePinyinInputIcon],svg[arcticons-google-pinyin-input-icon]',
  host: {
    role: 'img',
