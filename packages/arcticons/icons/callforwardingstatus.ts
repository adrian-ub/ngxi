...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCallforwardingstatusIcon],svg[arcticons-callforwardingstatus-icon]',
  host: {
    role: 'img',
