...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCameraFileTransferIcon],svg[arcticons-camera-file-transfer-icon]',
  host: {
    role: 'img',
