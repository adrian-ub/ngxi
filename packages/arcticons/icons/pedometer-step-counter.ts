...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPedometerStepCounterIcon],svg[arcticons-pedometer-step-counter-icon]',
  host: {
    role: 'img',
