...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLuxGreenIconPackIcon],svg[arcticons-lux-green-icon-pack-icon]',
  host: {
    role: 'img',
