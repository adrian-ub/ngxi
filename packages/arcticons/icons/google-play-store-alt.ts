...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGooglePlayStoreAltIcon],svg[arcticons-google-play-store-alt-icon]',
  host: {
    role: 'img',
