...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiWindBlowingFaceIcon],svg[arcticons-emoji-wind-blowing-face-icon]',
  host: {
    role: 'img',
