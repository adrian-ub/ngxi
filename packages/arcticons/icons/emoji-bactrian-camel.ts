...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiBactrianCamelIcon],svg[arcticons-emoji-bactrian-camel-icon]',
  host: {
    role: 'img',
