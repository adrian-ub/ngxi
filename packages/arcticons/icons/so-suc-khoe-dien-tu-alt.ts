...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSoSucKhoeDienTuAltIcon],svg[arcticons-so-suc-khoe-dien-tu-alt-icon]',
  host: {
    role: 'img',
