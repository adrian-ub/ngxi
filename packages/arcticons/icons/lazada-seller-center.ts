...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLazadaSellerCenterIcon],svg[arcticons-lazada-seller-center-icon]',
  host: {
    role: 'img',
