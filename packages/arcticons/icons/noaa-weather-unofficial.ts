...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNoaaWeatherUnofficialIcon],svg[arcticons-noaa-weather-unofficial-icon]',
  host: {
    role: 'img',
