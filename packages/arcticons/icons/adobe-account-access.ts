...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAdobeAccountAccessIcon],svg[arcticons-adobe-account-access-icon]',
  host: {
    role: 'img',
