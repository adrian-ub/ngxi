...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAntutu3dbenchLiteIcon],svg[arcticons-antutu-3dbench-lite-icon]',
  host: {
    role: 'img',
