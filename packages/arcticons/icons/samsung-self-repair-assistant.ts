...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSamsungSelfRepairAssistantIcon],svg[arcticons-samsung-self-repair-assistant-icon]',
  host: {
    role: 'img',
