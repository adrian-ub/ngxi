...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGridDrawingForArtistIcon],svg[arcticons-grid-drawing-for-artist-icon]',
  host: {
    role: 'img',
