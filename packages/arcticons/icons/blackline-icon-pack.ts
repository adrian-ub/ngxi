...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBlacklineIconPackIcon],svg[arcticons-blackline-icon-pack-icon]',
  host: {
    role: 'img',
