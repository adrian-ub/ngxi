...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSmoulderingDurtlesIcon],svg[arcticons-smouldering-durtles-icon]',
  host: {
    role: 'img',
