...
@Component({
  standalone: true,
  selector: 'svg[arcticonsDistractionFreeIconPackIcon],svg[arcticons-distraction-free-icon-pack-icon]',
  host: {
    role: 'img',
