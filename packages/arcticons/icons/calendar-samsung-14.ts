...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarSamsung14Icon],svg[arcticons-calendar-samsung-14-icon]',
  host: {
    role: 'img',
