...
@Component({
  standalone: true,
  selector: 'svg[arcticonsDigitalPraveshotsavIcon],svg[arcticons-digital-praveshotsav-icon]',
  host: {
    role: 'img',
