...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiAdultCurlyHairIcon],svg[arcticons-emoji-adult-curly-hair-icon]',
  host: {
    role: 'img',
