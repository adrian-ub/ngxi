...
@Component({
  standalone: true,
  selector: 'svg[arcticonsWolframAlphaClassicIcon],svg[arcticons-wolfram-alpha-classic-icon]',
  host: {
    role: 'img',
