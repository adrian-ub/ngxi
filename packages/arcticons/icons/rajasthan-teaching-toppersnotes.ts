...
@Component({
  standalone: true,
  selector: 'svg[arcticonsRajasthanTeachingToppersnotesIcon],svg[arcticons-rajasthan-teaching-toppersnotes-icon]',
  host: {
    role: 'img',
