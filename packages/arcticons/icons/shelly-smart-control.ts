...
@Component({
  standalone: true,
  selector: 'svg[arcticonsShellySmartControlIcon],svg[arcticons-shelly-smart-control-icon]',
  host: {
    role: 'img',
