...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiSunBehindCloudIcon],svg[arcticons-emoji-sun-behind-cloud-icon]',
  host: {
    role: 'img',
