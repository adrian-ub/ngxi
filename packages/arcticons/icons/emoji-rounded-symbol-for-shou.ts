...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiRoundedSymbolForShouIcon],svg[arcticons-emoji-rounded-symbol-for-shou-icon]',
  host: {
    role: 'img',
