...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLineDictionaryCnEnIcon],svg[arcticons-line-dictionary-cn-en-icon]',
  host: {
    role: 'img',
