...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAdblockForSamsungInternetIcon],svg[arcticons-adblock-for-samsung-internet-icon]',
  host: {
    role: 'img',
