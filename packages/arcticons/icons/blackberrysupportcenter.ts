...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBlackberrysupportcenterIcon],svg[arcticons-blackberrysupportcenter-icon]',
  host: {
    role: 'img',
