...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMaterialYouLightDarkIconsIcon],svg[arcticons-material-you-light-dark-icons-icon]',
  host: {
    role: 'img',
