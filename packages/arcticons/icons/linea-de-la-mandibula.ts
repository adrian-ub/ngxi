...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLineaDeLaMandibulaIcon],svg[arcticons-linea-de-la-mandibula-icon]',
  host: {
    role: 'img',
