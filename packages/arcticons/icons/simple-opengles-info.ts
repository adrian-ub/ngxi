...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSimpleOpenglesInfoIcon],svg[arcticons-simple-opengles-info-icon]',
  host: {
    role: 'img',
