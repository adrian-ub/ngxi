...
@Component({
  standalone: true,
  selector: 'svg[arcticonsOpendocumentReaderIcon],svg[arcticons-opendocument-reader-icon]',
  host: {
    role: 'img',
