...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBuildingsForMinecraftPeIcon],svg[arcticons-buildings-for-minecraft-pe-icon]',
  host: {
    role: 'img',
