...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiClinkingBeerMugsIcon],svg[arcticons-emoji-clinking-beer-mugs-icon]',
  host: {
    role: 'img',
