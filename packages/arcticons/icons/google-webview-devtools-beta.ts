...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGoogleWebviewDevtoolsBetaIcon],svg[arcticons-google-webview-devtools-beta-icon]',
  host: {
    role: 'img',
