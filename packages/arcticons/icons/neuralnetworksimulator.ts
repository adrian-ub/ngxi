...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNeuralnetworksimulatorIcon],svg[arcticons-neuralnetworksimulator-icon]',
  host: {
    role: 'img',
