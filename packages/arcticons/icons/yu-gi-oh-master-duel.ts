...
@Component({
  standalone: true,
  selector: 'svg[arcticonsYuGiOhMasterDuelIcon],svg[arcticons-yu-gi-oh-master-duel-icon]',
  host: {
    role: 'img',
