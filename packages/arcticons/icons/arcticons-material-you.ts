...
@Component({
  standalone: true,
  selector: 'svg[arcticonsArcticonsMaterialYouIcon],svg[arcticons-arcticons-material-you-icon]',
  host: {
    role: 'img',
