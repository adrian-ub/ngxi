...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEleMeRetailMerchantIcon],svg[arcticons-ele-me-retail-merchant-icon]',
  host: {
    role: 'img',
