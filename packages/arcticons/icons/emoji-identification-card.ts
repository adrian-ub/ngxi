...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiIdentificationCardIcon],svg[arcticons-emoji-identification-card-icon]',
  host: {
    role: 'img',
