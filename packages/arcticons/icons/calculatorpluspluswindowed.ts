...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalculatorpluspluswindowedIcon],svg[arcticons-calculatorpluspluswindowed-icon]',
  host: {
    role: 'img',
