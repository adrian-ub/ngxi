...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiCloudWithRainIcon],svg[arcticons-emoji-cloud-with-rain-icon]',
  host: {
    role: 'img',
