...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMaterialPhotoWidgetIcon],svg[arcticons-material-photo-widget-icon]',
  host: {
    role: 'img',
