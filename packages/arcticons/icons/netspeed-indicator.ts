...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNetspeedIndicatorIcon],svg[arcticons-netspeed-indicator-icon]',
  host: {
    role: 'img',
