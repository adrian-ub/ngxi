...
@Component({
  standalone: true,
  selector: 'svg[arcticonsWarframeCompanionIcon],svg[arcticons-warframe-companion-icon]',
  host: {
    role: 'img',
