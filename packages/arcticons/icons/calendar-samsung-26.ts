...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarSamsung26Icon],svg[arcticons-calendar-samsung-26-icon]',
  host: {
    role: 'img',
