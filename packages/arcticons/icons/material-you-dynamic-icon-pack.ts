...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMaterialYouDynamicIconPackIcon],svg[arcticons-material-you-dynamic-icon-pack-icon]',
  host: {
    role: 'img',
