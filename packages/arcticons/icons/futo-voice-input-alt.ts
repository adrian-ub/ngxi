...
@Component({
  standalone: true,
  selector: 'svg[arcticonsFutoVoiceInputAltIcon],svg[arcticons-futo-voice-input-alt-icon]',
  host: {
    role: 'img',
