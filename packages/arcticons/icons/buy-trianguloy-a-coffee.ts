...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBuyTrianguloyACoffeeIcon],svg[arcticons-buy-trianguloy-a-coffee-icon]',
  host: {
    role: 'img',
