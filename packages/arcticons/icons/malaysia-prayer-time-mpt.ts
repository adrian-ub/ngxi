...
@Component({
  standalone: true,
  selector: 'svg[arcticonsMalaysiaPrayerTimeMptIcon],svg[arcticons-malaysia-prayer-time-mpt-icon]',
  host: {
    role: 'img',
