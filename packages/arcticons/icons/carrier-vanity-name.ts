...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCarrierVanityNameIcon],svg[arcticons-carrier-vanity-name-icon]',
  host: {
    role: 'img',
