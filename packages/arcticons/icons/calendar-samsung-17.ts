...
@Component({
  standalone: true,
  selector: 'svg[arcticonsCalendarSamsung17Icon],svg[arcticons-calendar-samsung-17-icon]',
  host: {
    role: 'img',
