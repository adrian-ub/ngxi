...
@Component({
  standalone: true,
  selector: 'svg[arcticonsLockAppSmartAppLockerIcon],svg[arcticons-lock-app-smart-app-locker-icon]',
  host: {
    role: 'img',
