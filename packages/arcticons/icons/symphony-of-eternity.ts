...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSymphonyOfEternityIcon],svg[arcticons-symphony-of-eternity-icon]',
  host: {
    role: 'img',
