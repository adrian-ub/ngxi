...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPinterestDownloaderIcon],svg[arcticons-pinterest-downloader-icon]',
  host: {
    role: 'img',
