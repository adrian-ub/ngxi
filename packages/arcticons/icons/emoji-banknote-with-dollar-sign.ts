...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiBanknoteWithDollarSignIcon],svg[arcticons-emoji-banknote-with-dollar-sign-icon]',
  host: {
    role: 'img',
