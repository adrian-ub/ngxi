...
@Component({
  standalone: true,
  selector: 'svg[arcticonsChinaZhejiangMobileIcon],svg[arcticons-china-zhejiang-mobile-icon]',
  host: {
    role: 'img',
