...
@Component({
  standalone: true,
  selector: 'svg[arcticonsDigitalPokerChipsIcon],svg[arcticons-digital-poker-chips-icon]',
  host: {
    role: 'img',
