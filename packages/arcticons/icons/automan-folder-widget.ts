...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAutomanFolderWidgetIcon],svg[arcticons-automan-folder-widget-icon]',
  host: {
    role: 'img',
