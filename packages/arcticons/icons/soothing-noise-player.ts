...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSoothingNoisePlayerIcon],svg[arcticons-soothing-noise-player-icon]',
  host: {
    role: 'img',
