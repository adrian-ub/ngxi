...
@Component({
  standalone: true,
  selector: 'svg[arcticonsShatteredpixeldungeonIcon],svg[arcticons-shatteredpixeldungeon-icon]',
  host: {
    role: 'img',
