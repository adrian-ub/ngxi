...
@Component({
  standalone: true,
  selector: 'svg[arcticonsFossifyMusicplayerIcon],svg[arcticons-fossify-musicplayer-icon]',
  host: {
    role: 'img',
