...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBusSimulatorIndonesiaIcon],svg[arcticons-bus-simulator-indonesia-icon]',
  host: {
    role: 'img',
