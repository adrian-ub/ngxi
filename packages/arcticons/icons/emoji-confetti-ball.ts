...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiConfettiBallIcon],svg[arcticons-emoji-confetti-ball-icon]',
  host: {
    role: 'img',
