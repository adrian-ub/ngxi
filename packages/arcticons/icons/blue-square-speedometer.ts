...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBlueSquareSpeedometerIcon],svg[arcticons-blue-square-speedometer-icon]',
  host: {
    role: 'img',
