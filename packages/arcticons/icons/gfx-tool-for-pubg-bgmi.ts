...
@Component({
  standalone: true,
  selector: 'svg[arcticonsGfxToolForPubgBgmiIcon],svg[arcticons-gfx-tool-for-pubg-bgmi-icon]',
  host: {
    role: 'img',
