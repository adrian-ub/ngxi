...
@Component({
  standalone: true,
  selector: 'svg[arcticonsArcticonsRaisedEyebrowIcon],svg[arcticons-arcticons-raised-eyebrow-icon]',
  host: {
    role: 'img',
