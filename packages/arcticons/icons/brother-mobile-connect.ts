...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBrotherMobileConnectIcon],svg[arcticons-brother-mobile-connect-icon]',
  host: {
    role: 'img',
