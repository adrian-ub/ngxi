...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPhototanDeutscheBankIcon],svg[arcticons-phototan-deutsche-bank-icon]',
  host: {
    role: 'img',
