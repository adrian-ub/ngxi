...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiRolledUpNewspaperIcon],svg[arcticons-emoji-rolled-up-newspaper-icon]',
  host: {
    role: 'img',
