...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSlimsocialfortwitterIcon],svg[arcticons-slimsocialfortwitter-icon]',
  host: {
    role: 'img',
