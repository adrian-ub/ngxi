...
@Component({
  standalone: true,
  selector: 'svg[arcticonsQuestionnaireStarIcon],svg[arcticons-questionnaire-star-icon]',
  host: {
    role: 'img',
