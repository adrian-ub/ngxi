...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiCloudWithTornadoIcon],svg[arcticons-emoji-cloud-with-tornado-icon]',
  host: {
    role: 'img',
