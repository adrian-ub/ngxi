...
@Component({
  standalone: true,
  selector: 'svg[arcticonsOfficeNxPresentationsIcon],svg[arcticons-office-nx-presentations-icon]',
  host: {
    role: 'img',
