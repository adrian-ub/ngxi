...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBricksBreakerBallsCrushIcon],svg[arcticons-bricks-breaker-balls-crush-icon]',
  host: {
    role: 'img',
