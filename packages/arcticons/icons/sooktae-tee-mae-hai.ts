...
@Component({
  standalone: true,
  selector: 'svg[arcticonsSooktaeTeeMaeHaiIcon],svg[arcticons-sooktae-tee-mae-hai-icon]',
  host: {
    role: 'img',
