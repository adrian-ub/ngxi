...
@Component({
  standalone: true,
  selector: 'svg[arcticonsHuaweiGameassistantIcon],svg[arcticons-huawei-gameassistant-icon]',
  host: {
    role: 'img',
