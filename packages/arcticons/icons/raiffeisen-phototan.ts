...
@Component({
  standalone: true,
  selector: 'svg[arcticonsRaiffeisenPhototanIcon],svg[arcticons-raiffeisen-phototan-icon]',
  host: {
    role: 'img',
