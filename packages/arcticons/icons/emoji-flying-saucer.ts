...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiFlyingSaucerIcon],svg[arcticons-emoji-flying-saucer-icon]',
  host: {
    role: 'img',
