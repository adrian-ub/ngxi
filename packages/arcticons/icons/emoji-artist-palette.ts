...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiArtistPaletteIcon],svg[arcticons-emoji-artist-palette-icon]',
  host: {
    role: 'img',
