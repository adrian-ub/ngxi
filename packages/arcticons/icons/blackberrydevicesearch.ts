...
@Component({
  standalone: true,
  selector: 'svg[arcticonsBlackberrydevicesearchIcon],svg[arcticons-blackberrydevicesearch-icon]',
  host: {
    role: 'img',
