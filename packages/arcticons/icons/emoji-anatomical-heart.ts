...
@Component({
  standalone: true,
  selector: 'svg[arcticonsEmojiAnatomicalHeartIcon],svg[arcticons-emoji-anatomical-heart-icon]',
  host: {
    role: 'img',
