...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPretendYoureXyzzyIcon],svg[arcticons-pretend-youre-xyzzy-icon]',
  host: {
    role: 'img',
