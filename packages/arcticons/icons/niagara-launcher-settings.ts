...
@Component({
  standalone: true,
  selector: 'svg[arcticonsNiagaraLauncherSettingsIcon],svg[arcticons-niagara-launcher-settings-icon]',
  host: {
    role: 'img',
