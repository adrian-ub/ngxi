...
@Component({
  standalone: true,
  selector: 'svg[arcticonsKrasnoyeAndBeloyeIcon],svg[arcticons-krasnoye-and-beloye-icon]',
  host: {
    role: 'img',
