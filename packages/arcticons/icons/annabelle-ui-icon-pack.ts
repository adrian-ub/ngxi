...
@Component({
  standalone: true,
  selector: 'svg[arcticonsAnnabelleUiIconPackIcon],svg[arcticons-annabelle-ui-icon-pack-icon]',
  host: {
    role: 'img',
