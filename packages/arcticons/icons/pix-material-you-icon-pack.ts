...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPixMaterialYouIconPackIcon],svg[arcticons-pix-material-you-icon-pack-icon]',
  host: {
    role: 'img',
