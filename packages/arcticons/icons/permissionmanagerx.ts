...
@Component({
  standalone: true,
  selector: 'svg[arcticonsPermissionmanagerxIcon],svg[arcticons-permissionmanagerx-icon]',
  host: {
    role: 'img',
