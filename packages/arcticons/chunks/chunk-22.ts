...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTclHomeIcon],svg[arcticons-tcl-home-icon]',
  host: {
    role: 'img',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeTunerIcon],svg[arcticons-te-tuner-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeamFightTacticsIcon],svg[arcticons-team-fight-tactics-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.14 28.588v5.13l16.831 9.717l4.058-2.343c-2.668-.316-7.46-2.787-7.46-2.787m14.576-1.321l5.658-3.266V14.282L23.971 4.565L7.14 14.282v7.074"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.431 33.623C9.711 27.844 5.047 24.296 5.047 20.19c0-2.18 2.093-3.016 2.093-3.016"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.569 41.471V21.533h-7.386l-2.611-5.829h13.399m3.402 22.335V21.533h7.387l2.61-5.829H23.971"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.803 30.784c2.439 2.712 3.438 6.458-.714 8.084c-3.69 1.446-10.964.964-25.817-5.575M3.198 22.45c2.83 2.948 10.018 7.033 10.018 7.033m27.587 1.301c2.635.798 3.395 2.427 3.395 2.427"></svg:path>`,
})
export class ArcticonsTeamFightTacticsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeamspeakIcon],svg[arcticons-teamspeak-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.794 8.822c4.688.199 7.111 9.437 7.111 10.39s-.993.835-.993 1.65s3.298 4.886 3.298 5.86s-2.324.854-2.324 1.708s.655 1.252.655 1.63s-1.033.496-1.033.814s.696.337.696.774s-.914.974-.914 1.391s1.073.914.437 2.205s-2.622 2.305-6.357 1.192C19.323 31.668 19.6 30 19.6 25.887s-2.543-7.191-4.668-8.86z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.485 17.17a4.888 4.888 0 0 0 1.902 9.39a4.887 4.887 0 0 0 2.369-9.163m0 0l.025-10.064"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.529 40.078s2.702 1.907 10.357 1.907c9.377 0 21.614-6.383 21.614-17.958S30.845 6.014 20.886 6.014c-5.934 0-10.357 2.198-10.357 2.198L8.485 17.17"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.794 8.822c6.966-1.139 21.958 1.802 21.958 13.642s-13.588 14.94-18.727 14.45"></svg:path>`,
})
export class ArcticonsTeamspeakIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeapodIcon],svg[arcticons-teapod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.457 14.136h10.617s10.07 13.174-4.464 20.58h-6.153"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.038 17.577c5.712-12.724 13.404 6.418.114 11.35M26.248 14.136H15.63S5.56 27.31 20.095 34.716h6.153"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.687 20.36a5.78 5.78 0 0 1-4.631-4.814C7.585 13.79 6.506 14 6.506 14H3.5s1.335.113 2.514 6.67a9.97 9.97 0 0 0 7.334 7.873"></svg:path>`,
})
export class ArcticonsTeapodIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTecIcon],svg[arcticons-tec-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTechloreIcon],svg[arcticons-techlore-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.99 29.64c3.54.69 6.74 2 9.36 3.75m-30.7 0c2.62-1.75 5.82-3.06 9.36-3.75"></svg:path><svg:circle cx="20.012" cy="20.075" r="2.292" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.988" cy="20.075" r="2.292" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.425 17.564c-.632-4.058-4-6.903-7.523-6.355c-1.936.302-3.512 1.57-4.435 3.322a.506.506 0 0 1-.906.001c-.927-1.751-2.506-3.018-4.446-3.32c-3.532-.55-6.908 2.294-7.54 6.352s1.72 7.793 5.251 8.343c2.884.45 5.662-1.365 6.929-4.254a.288.288 0 0 1 .526 0c1.266 2.887 4.036 4.7 6.91 4.252c3.522-.55 5.865-4.284 5.234-8.342Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 36.68c5.04-2.21 6.18-7.53 6.29-8.26c-2.43-.1-4.69-1.35-6.29-3.31c-1.6 1.96-3.86 3.21-6.29 3.31c.11.73 1.25 6.05 6.29 8.26"></svg:path><svg:circle cx="24" cy="24" r="18" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 6V2.5m12.728 8.772l2.475-2.475M11.272 36.728l-2.475 2.475M42 24h3.5"></svg:path>`,
})
export class ArcticonsTechloreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTechnicalSupportIcon],svg[arcticons-technical-support-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="32.64" r="2.057" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.966 16.731c0-1.666.675-3.175 1.767-4.267a6.034 6.034 0 0 1 10.301 4.267c0 1.667-.563 3.3-1.767 4.267c-1.249 1.002-4.289 2.643-4.289 5.196"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M41.121 21.621C41.121 12.166 33.456 4.5 24 4.5S6.879 12.166 6.879 21.621c0 7.425 4.734 13.728 11.343 16.1L24 43.5l5.778-5.778c6.609-2.373 11.343-8.676 11.343-16.1"></svg:path>`,
})
export class ArcticonsTechnicalSupportIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeckaIcon],svg[arcticons-tecka-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeknosaIcon],svg[arcticons-teknosa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeladocIcon],svg[arcticons-teladoc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelcelIcon],svg[arcticons-telcel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegraherIcon],svg[arcticons-telegraher-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegramIcon],svg[arcticons-telegram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.83 8.48c1.14 0 2 1 1.54 2.86l-5.58 26.3c-.39 1.87-1.52 2.32-3.08 1.45L20.4 29.26a.4.4 0 0 1 0-.65l15.37-13.88c.7-.62-.15-.92-1.07-.36L15.41 26.54a.46.46 0 0 1-.4.05L6.82 24C5 23.47 5 22.22 7.23 21.33L40 8.69a2.2 2.2 0 0 1 .83-.21"></svg:path>`,
})
export class ArcticonsTelegramIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegramAlt1Icon],svg[arcticons-telegram-alt-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegramAlt2Icon],svg[arcticons-telegram-alt-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.83 8.48c1.14 0 2 1 1.54 2.86l-5.58 26.3c-.39 1.87-1.52 2.32-3.08 1.45L20.4 29.26a.4.4 0 0 1 0-.65l15.37-13.88c.7-.62-.15-.92-1.07-.36L15.41 26.54a.46.46 0 0 1-.4.05L6.82 24C5 23.47 5 22.22 7.23 21.33L40 8.69a2.2 2.2 0 0 1 .83-.21m-29.223 3.66h5.832m-2.916 2.916V9.224m7.889 29.888h3.756M24.29 40.99v-3.756m-16.103-6.87h2.579m-1.289 1.29v-2.579m3.084 9.448h2.579m-1.289 1.29v-2.579M41.207 25.71h2.579M42.496 27v-2.579M27.561 9.028h2.579m-1.289 1.289V7.739"></svg:path>`,
})
export class ArcticonsTelegramAlt2Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegramAlt3Icon],svg[arcticons-telegram-alt-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelegramPlusIcon],svg[arcticons-telegram-plus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 4.5A16.36 16.36 0 0 0 7.638 20.863A23.84 23.84 0 0 0 23.999 43.5v-6.275H24A16.363 16.363 0 0 0 24 4.5m0 21.745V15.48m-5.382 5.383h10.764"></svg:path>`,
})
export class ArcticonsTelegramPlusIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelehealthIcon],svg[arcticons-telehealth-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 4.5c-9.68 0-17.529 7.848-17.529 17.529c0 5.197 2.275 9.851 5.868 13.061l.295 8.41l7.803-4.306a17.6 17.6 0 0 0 3.563.364c9.68 0 17.529-7.848 17.529-17.53S33.68 4.5 24 4.5"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m31.884 17.646l-2.683 2.801v-1.49a1.89 1.89 0 0 0-1.89-1.889H16.667a1.89 1.89 0 0 0-1.89 1.89v6.786a1.89 1.89 0 0 0 1.89 1.89h10.644a1.89 1.89 0 0 0 1.89-1.89v-1.49l2.683 2.802c.625.652 1.727.21 1.727-.694V18.34c0-.904-1.102-1.346-1.727-.694"></svg:path>`,
})
export class ArcticonsTelehealthIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelenetIcon],svg[arcticons-telenet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:ellipse cx="19.062" cy="18.783" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="3.17" ry="2.91"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.274 20.324v-2.75c2.043-.547 4.12-.398 6.183.155v2.73c-2.094-.58-4.095-.694-6.183-.135M33 26.637v1.876c-4.912 4.913-13.093 4.769-18-.138v-1.876s9.537 6.665 18 .138"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path>`,
})
export class ArcticonsTelenetIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelepizzaIcon],svg[arcticons-telepizza-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTelloIcon],svg[arcticons-tello-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.151 36.877c-4.084 0-2.266-3.552-7.331-4.928c2.87 3.643-.743 4.928-2.608 4.928h-.66A5.05 5.05 0 0 1 4.5 31.825v-15.65a5.05 5.05 0 0 1 5.052-5.052h28.896a5.05 5.05 0 0 1 5.052 5.052v15.65a5.05 5.05 0 0 1-5.052 5.052z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M35.252 27.706c-1.72 0-2.994-1.395-2.843-3.116l.177-2.025c.15-1.721 1.668-3.117 3.389-3.117h0c1.72 0 2.994 1.396 2.843 3.117l-.177 2.025c-.15 1.721-1.668 3.116-3.389 3.116M24.465 15.242l-.954 10.906c-.076.86.56 1.558 1.421 1.558h.468m3.914-12.464l-.954 10.906c-.076.86.56 1.558 1.421 1.558h.468M11.03 16.878l-.81 9.27c-.076.86.56 1.558 1.421 1.558h.468M9.17 19.448h3.272m7.785 6.686c-.62.94-1.686 1.572-2.846 1.572h0c-1.72 0-2.994-1.395-2.843-3.116l.177-2.025c.15-1.721 1.668-3.117 3.389-3.117h0c1.72 0 2.994 1.396 2.843 3.117l-.088 1.012h-6.233"></svg:path>`,
})
export class ArcticonsTelloIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTellonymIcon],svg[arcticons-tellonym-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTempMailIcon],svg[arcticons-temp-mail-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTempleRunIcon],svg[arcticons-temple-run-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="13.59" cy="11.903" r="4.799" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21.862 5.504c-.823 5.987-1.234 8.318-1.234 12.797c0 2.65 1.442 4.16 3.372 4.16M13.453 42.504V25.157c0-1.326.548-2.651 1.37-3.29c-1.873.045-3.153 1.507-3.427 3.016c0-3.108.046-4.754.365-6.125c-2.559 1.326-3.336 2.194-3.61 4.022c.046-2.468.64-3.61.64-3.61S5.5 20.998 5.5 25.385v14.489"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.63 17.89c-2.196 0-4.66 2.466-3.083 5.642"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.453 26.162c1.85-1.805 4.87-3.702 10.547-3.702m-10.547 8.362c2.696-2.222 5.54-3.837 10.547-3.837M13.453 40.392C17.337 38.289 22.1 38.228 24 38.228"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.211 27.934c0 3.347-.234 6.882 2.844 6.882S24 30.397 24 26.985"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.227 30.527c0 2.262-.478 4.502-1.53 4.502s-1.163-1.844-1.163-5.744"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.453 36.446c1.005.251 2.12-.984 2.12-4.503m4.829-9.191l-.985-.772"></svg:path><svg:circle cx="13.59" cy="11.903" r="1.493" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.504h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.731 38.485c0-1.338.47-2.313 2.024-2.313s1.798 1.42 1.798 2.058m-8.333 1.357c0-1.71.122-2.502 1.828-2.838c1.913-.376 2.453 1.736 2.453 1.736m-4.281.581c-.168-.811-1.002-1.455-1.767-1.226"></svg:path><svg:circle cx="34.41" cy="11.903" r="4.799" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.138 5.504c.823 5.987 1.234 8.318 1.234 12.797c0 2.65-1.442 4.16-3.372 4.16m10.548 20.043V25.157c0-1.325-.549-2.651-1.372-3.29c1.874.045 3.154 1.507 3.428 3.016c0-3.108-.046-4.754-.365-6.125c2.559 1.326 3.336 2.194 3.61 4.022c-.046-2.468-.64-3.61-.64-3.61s3.291 1.828 3.291 6.215v14.489"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.37 17.89c2.196 0 4.66 2.466 3.083 5.642"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.548 26.162C32.696 24.357 29.678 22.46 24 22.46m10.548 8.362C31.85 28.6 29.008 26.985 24 26.985m10.548 13.407c-3.885-2.103-8.649-2.164-10.548-2.164"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.789 27.934c0 3.347.234 6.882-2.844 6.882S24 30.397 24 26.985"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.774 30.527c0 2.262.477 4.502 1.528 4.502s1.164-1.844 1.164-5.744"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.548 36.446c-1.006.251-2.12-.984-2.12-4.503m-4.83-9.191l.985-.772"></svg:path><svg:circle cx="34.41" cy="11.903" r="1.493" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.269 38.485c0-1.338-.47-2.313-2.024-2.313s-1.798 1.42-1.798 2.058m8.333 1.357c0-1.71-.122-2.502-1.827-2.838c-1.914-.376-2.454 1.736-2.454 1.736m4.281.581c.168-.811 1.002-1.455 1.767-1.226"></svg:path>`,
})
export class ArcticonsTempleRunIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTempmonitorIcon],svg[arcticons-tempmonitor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.6 28V9.3a4.74 4.74 0 0 0-4.13-4.79a4.61 4.61 0 0 0-5.07 4.57V28a1 1 0 0 1-.4.8a8.19 8.19 0 1 0 10 0a1 1 0 0 1-.4-.8"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.4 26.18c2.17-1.16 4.37-.64 6-.42a7.9 7.9 0 0 0 3.2-.32"></svg:path>`,
})
export class ArcticonsTempmonitorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTenTenIcon],svg[arcticons-ten-ten-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTenacityIcon],svg[arcticons-tenacity-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTenantcloudProIcon],svg[arcticons-tenantcloud-pro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTencentAppStoreIcon],svg[arcticons-tencent-app-store-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.106 12.968a5.89 5.89 0 0 0 5.89 5.89c1.95 0 3.737-1.385 4.724-2.378c.986-.994 12.933-12.92 12.933-12.92a21.4 21.4 0 0 0-6.678-1.06c-5.936 0-11.337 2.38-15.212 6.338c-1.055 1.078-1.657 2.543-1.657 4.13m33.788 22.065a5.89 5.89 0 0 0-5.89-5.89c-1.95 0-3.737 1.384-4.724 2.377c-.986.994-12.933 12.92-12.933 12.92a21.4 21.4 0 0 0 6.678 1.06c5.936 0 11.337-2.38 15.212-6.338c1.055-1.078 1.657-2.543 1.657-4.13M35.033 7.106a5.89 5.89 0 0 0-5.89 5.89c0 1.95 1.384 3.737 2.377 4.724c.994.986 12.92 12.933 12.92 12.933a21.4 21.4 0 0 0 1.06-6.678c0-5.936-2.38-11.337-6.338-15.212c-1.078-1.055-2.543-1.657-4.13-1.657M12.968 40.894a5.89 5.89 0 0 0 5.89-5.89c0-1.95-1.385-3.737-2.378-4.724c-.994-.986-12.92-12.933-12.92-12.933a21.4 21.4 0 0 0-1.06 6.678c0 5.936 2.38 11.337 6.338 15.212c1.078 1.055 2.543 1.657 4.13 1.657"></svg:path>`,
})
export class ArcticonsTencentAppStoreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTenkiJpIcon],svg[arcticons-tenki-jp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeoritentamenIcon],svg[arcticons-teoritentamen-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTerminightorIcon],svg[arcticons-terminightor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTermiusIcon],svg[arcticons-termius-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.295 35.024A9.803 9.803 0 0 1 4.5 25.212a10.19 10.19 0 0 1 4.535-8.397a9.867 9.867 0 0 1 9.82-9.945a10.16 10.16 0 0 1 7.406 3.272a10.5 10.5 0 0 1 4.336-.963a9.697 9.697 0 0 1 9.733 9.748a9.751 9.751 0 0 1-7.032 16.936a11.07 11.07 0 0 1-9.14 5.267a10.02 10.02 0 0 1-9.141-6.073a5 5 0 0 0-.721-.033Zm2.98-14.3l5.87 1.86m-5.87 1.86l5.87-1.86"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.919 26.975a5.9 5.9 0 0 0 6.302 0"></svg:path>`,
})
export class ArcticonsTermiusIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTerraNilIcon],svg[arcticons-terra-nil-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.229 8.822A21.43 21.43 0 0 1 45.5 24c0 11.876-9.624 21.5-21.5 21.5S2.5 35.876 2.5 24S12.124 2.5 24 2.5a21.42 21.42 0 0 1 14.223 5.375"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.84 19.59a2.11 2.11 0 1 1 0 4.219a2.11 2.11 0 0 1 0-4.219"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.568 20.492S41.275 7.29 40.646 6.631s-10.79 7.613-11.951 9.035c-1.897 2.326-.127 4.824-.127 4.824m-3.258-.241s-15.482-9.803-16-9.055s9.622 9.046 11.248 9.897c2.659 1.392 4.752-.842 4.752-.842m1.629 3.557s4.38 17.792 5.272 17.612s-.677-13.19-1.261-14.93c-.954-2.845-4.011-2.682-4.011-2.682"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M22.891 21.504c-.83 1.555-.4 2.702 1.058 3.131"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m23.375 45.49l.573-21.686c.54-.39 1.519-.503 1.519-.503m.655.503l.817 21.497"></svg:path>`,
})
export class ArcticonsTerraNilIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTerraformingMarsIcon],svg[arcticons-terraforming-mars-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:ellipse cx="32.078" cy="6.337" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4.622" ry="2.288"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.456 6.337v4.078c0 1.264 2.07 2.289 4.622 2.289s4.621-1.025 4.621-2.289V6.337"></svg:path><svg:ellipse cx="19.558" cy="14.39" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4.622" ry="2.288"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.936 14.39v4.68c0 1.265 2.069 2.29 4.622 2.29s4.621-1.025 4.621-2.29v-4.68"></svg:path><svg:ellipse cx="16.159" cy="5.192" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4.622" ry="2.288"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M11.537 5.192v2.875c0 1.264 2.07 2.288 4.622 2.288s4.622-1.024 4.622-2.288V5.192M6.697 11.236a7.9 7.9 0 0 0-.555 2.886c0 6.418 7.995 11.622 17.858 11.622s17.858-5.204 17.858-11.622c0-.996-.192-1.963-.554-2.886"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M11.537 6.479C6.067 10.377 2.5 16.772 2.5 24c0 11.874 9.626 21.5 21.5 21.5S45.5 35.874 45.5 24c0-7.14-3.48-13.468-8.838-17.378m-4.636-2.574l-.201-.08A21.5 21.5 0 0 0 24 2.5a21.5 21.5 0 0 0-5.517.715"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.698 16.851h3.085v2.165h-3.085zm0 2.165h3.085v2.569h-3.085zm-3.242-3.708h3.085v2.165h-3.085zm0 2.165h3.085v4.111h-3.085z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.059 15.946c.908 6.539 8.546 11.732 18.126 12.32v1.666h3.989v-1.687c9.411-.695 16.87-5.842 17.767-12.299"></svg:path>`,
})
export class ArcticonsTerraformingMarsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTerrariaIcon],svg[arcticons-terraria-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTescomobileIcon],svg[arcticons-tescomobile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeslaOneIcon],svg[arcticons-tesla-one-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.531 14.485A42.9 42.9 0 0 1 24 10.951a42.9 42.9 0 0 1 16.469 3.534"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.58 18.2a9 9 0 0 1-2.468-1.586c3.564-2.05 10.16-2.753 10.16-2.753L24 41.194l3.728-27.333s6.597.703 10.16 2.753A9 9 0 0 1 35.42 18.2"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.272 13.861L24 17.146l3.728-3.285"></svg:path>`,
})
export class ArcticonsTeslaOneIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTeslaunreadIcon],svg[arcticons-teslaunread-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTesterupIcon],svg[arcticons-testerup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M22.501 31.916H11.926A6.42 6.42 0 0 1 5.5 25.475v-9.018a6.42 6.42 0 0 1 6.426-6.442h20.563a6.42 6.42 0 0 1 6.425 6.442v1.596"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.26 27.705h-5.656a1.284 1.284 0 0 1-1.286-1.288V17.49c0-.714.574-1.289 1.286-1.289h19.128c.712 0 1.285.575 1.285 1.289v6.523"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m14.95 27.705l.065-3.222l13.598 13.502L42.5 24.129v-9.7l-4.715-1.63"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.5 14.43L28.726 28.35l-3.65-3.932l-10.06.065"></svg:path>`,
})
export class ArcticonsTesterupIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTestyIcon],svg[arcticons-testy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M45.192 20.235q.087.492.151.989m-1.588-5.768q.198.459.375.927m-2.875-5.247q.3.402.58.816m-4.006-4.444q.382.32.751.66m-4.921-3.401q.447.224.884.47M28.97 3.06q.487.114.968.253m-5.925-.835q.5 0 1 .023m-5.958.547q.485-.114.978-.206M14.364 4.75q.446-.225.903-.427M10.192 7.49q.383-.321.78-.624M6.76 11.114q.3-.401.617-.787M4.25 15.43q.2-.46.421-.909M2.81 20.209q.087-.495.198-.981M2.51 25.19a22 22 0 0 1-.032-1m.878 5.919q-.14-.478-.26-.965m2.224 5.553a22 22 0 0 1-.478-.879m3.446 4.892q-.342-.365-.667-.746m4.475 3.97a22 22 0 0 1-.82-.573m5.269 2.836a21 21 0 0 1-.93-.37m5.783 1.54q-.5-.06-.99-.143m5.981.166q-.497.055-.996.087m5.858-1.213q-.47.17-.95.316m5.421-2.53q-.42.273-.85.526m4.694-3.712a21 21 0 0 1-.708.708m3.712-4.692q-.252.431-.525.85m2.532-5.42q-.146.48-.315.95m1.216-5.86q-.033.5-.089.997m-26.316-12.87h-.5a.25.25 0 0 1-.25-.25V9.73a.25.25 0 0 1 .25-.25h10.87a.25.25 0 0 1 .25.25v3.546a.25.25 0 0 1-.25.25h-.5c-.306 0-.318.554-.318.86v5.089l7.803 14.107c1.58 2.855-.327 4.958-2.606 4.958H14.194c-2.279 0-4.185-2.102-2.606-4.958l7.803-14.107v-5.09c0-.305-.012-.86-.318-.86"></svg:path><svg:path d="M26.014 14.238a1.588 1.588 0 1 1-1.588-1.588h0c.877 0 1.588.711 1.588 1.588m-.062 7.465c0 .843-.684 1.526-1.526 1.526h0a1.526 1.526 0 0 1-1.526-1.526h0c0-.843.683-1.526 1.526-1.526h0c.842 0 1.526.683 1.526 1.526m3.274 4.983l4.135 7.786c.148.28.072.917-.244.917h-18.13c-.316 0-.392-.638-.244-.917l4.135-7.786c4.163 2.367 5.554-2.546 10.348 0"></svg:path><svg:path d="M22.825 30.965a1.7 1.7 0 0 1-1.7 1.7h0a1.7 1.7 0 1 1 1.7-1.7m6.69 1.645a1.13 1.13 0 0 1-1.13 1.13h0a1.13 1.13 0 0 1-1.13-1.13h0c0-.625.506-1.13 1.13-1.13h0c.624 0 1.13.505 1.13 1.13"></svg:path></svg:g>`,
})
export class ArcticonsTestyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTetherIcon],svg[arcticons-tether-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTextToolsProIcon],svg[arcticons-text-tools-pro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.56 14.01h5.2m-2.6 8v-8m5.08 0h5.2m-2.6 8v-8m-16.9 19.9v-8h2.6a2.7 2.7 0 1 1 0 5.4h-2.6m10.92 2.6v-8h2.6a2.7 2.7 0 1 1 0 5.4h-2.6m2.81.08l2.6 2.6m7.09-.08a2.58 2.58 0 0 1-2.6-2.6v-2.7a2.67 2.67 0 0 1 2.6-2.7h0a2.69 2.69 0 0 1 2.7 2.68v2.62a2.69 2.69 0 0 1-2.68 2.7z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path>`,
})
export class ArcticonsTextToolsProIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTextnowIcon],svg[arcticons-textnow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.511 20.378h8.635c0-3.206 2.623-5.83 5.83-5.83h8.049c3.206 0 5.829 2.624 5.829 5.83H42.5"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.593 7.47H18.407C11.308 7.47 5.5 13.28 5.5 20.379c0 5.929 4.057 10.943 9.528 12.44l.381 7.711l8.318-7.244h5.866c7.099 0 12.907-5.808 12.907-12.907S36.692 7.47 29.593 7.47"></svg:path>`,
})
export class ArcticonsTextnowIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTextraIcon],svg[arcticons-textra-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTflOysterIcon],svg[arcticons-tfl-oyster-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29c-2.2 0-4 1.8-4 4v29c0 2.2 1.8 4 4 4h29c2.2 0 4-1.8 4-4v-29c0-2.2-1.8-4-4-4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m22.593 42.5l13.244-13.245a2 2 0 0 0 0-2.828L22.012 12.602a2 2 0 0 0-2.828 0L5.5 26.286"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.233 35.86c-2.059-8.166-8.487-14.595-16.653-16.654"></svg:path>`,
})
export class ArcticonsTflOysterIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTgoZeroCarbonIcon],svg[arcticons-tgo-zero-carbon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiAirwaysIcon],svg[arcticons-thai-airways-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiDictIcon],svg[arcticons-thai-dict-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiKaoKeIcon],svg[arcticons-thai-kao-ke-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiPbsIcon],svg[arcticons-thai-pbs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsThaiPbsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiSupermodelsIcon],svg[arcticons-thai-supermodels-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiTvIcon],svg[arcticons-thai-tv-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaidIcon],svg[arcticons-thaid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaisookIcon],svg[arcticons-thaisook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaiweatherIcon],svg[arcticons-thaiweather-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsThaiweatherIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThaliaIcon],svg[arcticons-thalia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThanachartConnectIcon],svg[arcticons-thanachart-connect-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThangratIcon],svg[arcticons-thangrat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThatLevelAgainIcon],svg[arcticons-that-level-again-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThatLevelAgain2Icon],svg[arcticons-that-level-again-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.96 36.884a27.2 27.2 0 0 1-8.559 1.394c-9.427 0-16.901-5.301-16.901-16.26c0-9.11 6.104-16.45 17.922-16.747c7.719-.193 17.034 4.636 17.999 15.46v.001c.37 4.173.051 7.064-.7 9.074"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.714 22.017c.09 1.378-.158 2.523-.784 3.134c-1.235 1.207-2.468 2.23-4.967 2.201c-2.578-.03-5.752-1.903-5.752-5.335c0-2.855 1.87-5.17 5.752-5.17c3.978 0 5.54 1.9 5.751 5.17m16.488.349c.012 1.25-.076 2.262-.817 2.89c-1.31 1.11-3.777 1.72-5.556 1.697c-2.774 0-4.069-1.834-4.069-4.719c0-2.363.391-3.423 1.767-4.145c.784-.41 1.935-.907 3.266-.903c2.87.01 5.379 2.114 5.409 5.18s0 0 0 0"></svg:path><svg:circle cx="36.675" cy="35.909" r="6.825" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.091 34.593a2.586 2.586 0 0 1 3.097-2.534c1.083.208 1.949 1.145 2.056 2.243c.08.817-.178 1.623-.742 2.118c-1.045.917-4.41 3.39-4.41 3.39h5.167"></svg:path>`,
})
export class ArcticonsThatLevelAgain2Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThe1Icon],svg[arcticons-the-1-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.5 19.239h8.151m-4.075 12.54v-12.54m7.135-.157v12.697m-.001-5.329c0-1.725 1.411-3.136 3.136-3.136s3.135 1.411 3.135 3.135v5.173m8.859-1.41c-.47.94-1.567 1.567-2.665 1.567a3.144 3.144 0 0 1-3.135-3.135v-2.038c0-1.724 1.411-3.135 3.135-3.135s3.135 1.41 3.135 3.135v1.097h-6.27m8.221 7.878H43.5m-9.529-23.162h4.409v19.975"></svg:path>`,
})
export class ArcticonsThe1Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheCaseOfTheGoldenIdolIcon],svg[arcticons-the-case-of-the-golden-idol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheChosenIcon],svg[arcticons-the-chosen-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheDayBeforeIcon],svg[arcticons-the-day-before-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m20.506 27.438l2.79 2.804l6.697-6.735M5.5 15.056h37"></svg:path><svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect>`,
})
export class ArcticonsTheDayBeforeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheEndOfTheWorldIcon],svg[arcticons-the-end-of-the-world-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheForestOfLoveIcon],svg[arcticons-the-forest-of-love-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.543 11.93s-4.747-4.01-9.55-5.566c-1.937-.627-4.055.41-4.642 2.359c-1.841 6.116-.81 15.915-.81 15.915"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.547 14.765C12.728 10.843 7.78 6.802 7.78 6.802m8.504 10.138c1.439-1.816 4.137-2.175 4.137-2.175M24 33.399c-2.158 0-5.468-1.817-5.846-6.404"></svg:path><svg:ellipse cx="17.935" cy="20.777" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="2.193" ry="2.865"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.709 35.056c0 .988-.306 6.762 10.291 6.762"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 11.587c11.128 0 13.796 9.588 17.939 12.614C48.078 28.686 34.864 37.2 24 37.2s-24.078-8.514-17.939-13C10.204 21.175 12.872 11.587 24 11.587"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.457 11.93s4.747-4.01 9.55-5.566c1.937-.627 4.055.41 4.642 2.359c1.841 6.116.81 15.915.81 15.915"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.453 14.765c1.819-3.922 6.767-7.963 6.767-7.963M31.716 16.94c-1.439-1.816-4.137-2.175-4.137-2.175m3.885 12.417s-.395-.187-1.618-.187c-2.483 0-3.634 1.435-5.846 1.435s-3.363-1.435-5.846-1.435c-1.223 0-1.618.187-1.618.187"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 33.399c2.158 0 5.468-1.817 5.846-6.404"></svg:path><svg:ellipse cx="30.065" cy="20.777" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="2.193" ry="2.865"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.291 35.056c0 .988.306 6.762-10.291 6.762"></svg:path><svg:ellipse cx="24" cy="24.782" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.316" ry=".953"></svg:ellipse><svg:circle cx="19.141" cy="20.777" r=".987" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="28.859" cy="20.777" r=".987" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle>`,
})
export class ArcticonsTheForestOfLoveIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheForkIcon],svg[arcticons-the-fork-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheGhostIcon],svg[arcticons-the-ghost-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheGirlInTheWindowIcon],svg[arcticons-the-girl-in-the-window-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheHelloClubIcon],svg[arcticons-the-hello-club-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheKanaQuizIcon],svg[arcticons-the-kana-quiz-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheLastCampfireIcon],svg[arcticons-the-last-campfire-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheLightIcon],svg[arcticons-the-light-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheNewDenpaManIcon],svg[arcticons-the-new-denpa-man-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheSecretElevatorRemasteredIcon],svg[arcticons-the-secret-elevator-remastered-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheSouledStoreIcon],svg[arcticons-the-souled-store-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.212 43.232c1.018-.463 1.887-2.381 3.046-2.09c.85.213 1.903 2.106 3.835 2.12c3.23.026 2.967-4.74 6.647-2.756c2.29 1.234 5.575 1.13 5.62-.934l.544-24.7C37 10.418 30.233 4.174 23.202 4.513c-6.713.324-12.044 5.702-12.088 12.675c-.124 1.45.378 2.252 1.573 2.86c.026-.025.265-1.01.531-2.187l.485-2.142l.113 25.862c.006 1.426 1.694 2.423 3.395 1.65z"></svg:path><svg:ellipse cx="23.868" cy="19.264" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="2.702" ry="3.776"></svg:ellipse><svg:ellipse cx="32.294" cy="19.264" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="2.096" ry="3.159"></svg:ellipse>`,
})
export class ArcticonsTheSouledStoreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheUndergroundBlossomIcon],svg[arcticons-the-underground-blossom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="23.587" r="8.706" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.706 42.5a8.706 8.706 0 0 0-17.412 0"></svg:path><svg:rect width="6.548" height="3.653" x="20.726" y="9.28" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.826" ry="1.826"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 14.881v-3.368m-.798 0h1.596"></svg:path><svg:circle cx="24" cy="23.587" r="1.14" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 22.447v-5.821m4.451 6.961H25.14m-2.588 8.706v1.501m2.896-1.501v1.501M30.36 42.5a6.36 6.36 0 0 0-12.72 0"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path>`,
})
export class ArcticonsTheUndergroundBlossomIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheWolfsStashIcon],svg[arcticons-the-wolfs-stash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheantsIcon],svg[arcticons-theants-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThehinduIcon],svg[arcticons-thehindu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 42.5h-29c-2.2 0-4-1.8-4-4v-29c0-2.2 1.8-4 4-4h29c2.2 0 4 1.8 4 4v29c0 2.2-1.8 4-4 4m-29.297-27h11.263m-5.631 17v-17m11.637 0v17m11.262-17v17m-11.262-8.532h11.262M13.772 32.5h2.125m9.512 0h2.125m9.138 0h2.125m-13.388-17h2.125m9.138 0h2.125m-18.331 0v1.063M9.203 15.5v1.063"></svg:path>`,
})
export class ArcticonsThehinduIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThemeStoreIcon],svg[arcticons-theme-store-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsThemeStoreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThemerForTelegramIcon],svg[arcticons-themer-for-telegram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThemesAltIcon],svg[arcticons-themes-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M32.885 8.929c-.836 0-1.536.554-1.757 1.317h-1.093c-1.014 0-1.83.817-1.83 1.831v5.026c0 1.014.816 1.83 1.83 1.83h7.958c1.014 0 1.83-.816 1.83-1.83v-5.026c0-1.014-.816-1.83-1.83-1.83H36.9a1.826 1.826 0 0 0-1.757-1.318z"></svg:path><svg:path d="M36.335 14.487a2.32 2.32 0 1 1-4.641 0a2.32 2.32 0 0 1 4.64 0"></svg:path><svg:path d="M29.19 5.445h9.649A3.653 3.653 0 0 1 42.5 9.106v9.65a3.653 3.653 0 0 1-3.661 3.66h-9.65a3.653 3.653 0 0 1-3.66-3.66v-9.65a3.653 3.653 0 0 1 3.66-3.661"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M12.279 12.68a1.836 1.836 0 0 0-1.834 1.836l.003.06h-.102a1.37 1.37 0 0 0-1.373 1.374v.128c0 .76.613 1.373 1.373 1.373h5.019a1.37 1.37 0 0 0 1.373-1.373v-.129c0-.525-.291-.98-.723-1.212a1.547 1.547 0 0 0-2.117-1.09a1.84 1.84 0 0 0-1.62-.967"></svg:path><svg:path d="M13.585 13.23a1.947 1.947 0 0 1 3.705.836h0c0 .543-.226 1.062-.625 1.43m-1.322-5.086v.675m3.656 2.982h-.675m-.396 2.585l-.477-.478m-4.216-4.215l-.477-.478m4.693.478l.477-.478"></svg:path><svg:path d="M9.161 5.445h9.65a3.653 3.653 0 0 1 3.66 3.661v9.65a3.653 3.653 0 0 1-3.66 3.66H9.16a3.653 3.653 0 0 1-3.661-3.66v-9.65A3.653 3.653 0 0 1 9.16 5.445"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M17.548 29.949h-7.123a.983.983 0 0 0-.983.982v7.123c0 .543.44.983.982.983h5.895l2.211-2.21V30.93a.983.983 0 0 0-.983-.982m-1.227.001v9.088m-4.667-6.877v6.877m6.877-2.211H9.442m9.088-4.666h-6.877"></svg:path><svg:path d="M9.161 25.583h9.65a3.653 3.653 0 0 1 3.66 3.661v9.65a3.653 3.653 0 0 1-3.66 3.66H9.16a3.653 3.653 0 0 1-3.661-3.66v-9.65a3.653 3.653 0 0 1 3.661-3.661"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.256 25.673h4.363c.917 0 1.656.738 1.656 1.656v4.363c0 .917-.739 1.656-1.656 1.656h-4.363a1.65 1.65 0 0 1-1.656-1.656v-4.363c0-.918.738-1.656 1.656-1.656m0 9.117h4.363c.917 0 1.656.739 1.656 1.656v4.363c0 .918-.739 1.656-1.656 1.656h-4.363a1.65 1.65 0 0 1-1.656-1.656v-4.363c0-.917.738-1.656 1.656-1.656m9.154-9.117h4.363c.917 0 1.655.738 1.655 1.656v4.363c0 .917-.738 1.656-1.655 1.656h-4.364a1.65 1.65 0 0 1-1.656-1.656v-4.363c0-.918.739-1.656 1.656-1.656m.001 9.117h4.363c.917 0 1.655.739 1.655 1.656v4.363c0 .918-.738 1.656-1.655 1.656h-4.364a1.65 1.65 0 0 1-1.656-1.656v-4.363c0-.917.739-1.656 1.656-1.656"></svg:path>`,
})
export class ArcticonsThemesAltIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTheotownIcon],svg[arcticons-theotown-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="m6.574 41.226l6.744-3.347l.982 1.242V42.5m0-3.38l-6.256 3.107m34.454-15.963l-4.835 2.4l2 .993l-18.106 8.989l2 .992l-5.764 2.862m13.255-21.69l7.282-3.614v-4.15l-.826-1.48l-8.045 3.995l1.59 1.097l7.28-3.612"></svg:path><svg:path d="M31.048 16.658v4.153l-1.59-.79v-4.46m-10.345 5.17l-7.282-3.614v-4.15l.827-1.48l8.045 3.994l-1.59 1.098l-7.281-3.612"></svg:path><svg:path d="M19.113 16.579v4.152l1.59-.789v-4.46M5.502 29.363l4.511-2.238M5.5 33.515l4.513-2.24v-4.15l-.826-1.48l-3.685 1.83M20.745 5.561l1.59 1.098L24.667 5.5m-2.333 5.311l6.9-3.425V5.5m-6.9 1.159v4.152l-1.59-.789v-4.46M5.5 19.808l4.17 2.07l-1.589 1.098l-2.58-1.28"></svg:path><svg:path d="m9.595 26.377l.076-.038v-4.461m-1.59 1.098v3.218M29.234 7.385l13.265 6.585M36.322 5.5l6.049 3.003m-1.43.973v2m-9.689-5.975v1.164m1.384-1.164v1.852M34.02 6.04v2m1.385-1.314v2m1.384-1.313v2M38.173 8.1v2m1.384-1.312v2m-14.255 4.656v-1.257m-4.611 5.761h8.768M19.65 14.93h11.08m-6.745 0v5.017m-3.281-3.006h8.754m-7.188 1.263v.448m3.48-.448v.448m1.919-.448v.448m-15.837-1.874l-.669.331l-5.661-2.81m5.662-2.629v5.44m5.339-8.09l-5.34 2.65m-5.61-2.785l5.61 2.786l-.308-1.776L6.96 7.962"></svg:path><svg:path d="m5.594 8.641l5.068-2.516l5.841 2.9v4.37m-1.948-5.336l-3.7 1.836m-1.042 3.427v1.06m-1.495-1.8v1.058m-1.495-1.8v1.058m13.922-2.95h-4.242M17.835 5.5v4.447m2.91-3.005H12.36m6.95 1.254v.449M42.5 21.903L5.834 40.105M5.5 16.043l17.785 8.829h3.713L42.5 17.176m-37 18.278l12.99-6.448v-1.563l-8.82-4.378m18.908 2.506l1.014-.503m.668 1.339l1.014-.503M18.17 30.772l1.014-.503m.668 1.339l1.014-.503m-2.472-5.403l1.014.503m.669-1.339l1.014.503"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.5 5.5h29c2.216 0 4 1.784 4 4v29c0 2.216-1.784 4-4 4h-29c-2.216 0-4-1.784-4-4v-29c0-2.216 1.784-4 4-4"></svg:path>`,
})
export class ArcticonsTheotownIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThereIsNoGameIcon],svg[arcticons-there-is-no-game-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsThereIsNoGameIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThermoIcon],svg[arcticons-thermo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.715 36.786a5.715 5.715 0 0 1-11.43 0m.001-25.571a5.715 5.715 0 1 1 11.43 0m7.07 7.117a5.715 5.715 0 0 1 0 11.43m-25.571-.002a5.715 5.715 0 0 1 0-11.428M24 29.76a5.715 5.715 0 0 1-5.714-5.714m18.501 5.714H24m-5.714-18.547v12.834m-7.071 5.713h7.07v7.025m11.43-.001V29.76"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.715 11.213v7.119h7.071m-25.571 0h7.07"></svg:path>`,
})
export class ArcticonsThermoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThescoreIcon],svg[arcticons-thescore-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsThescoreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThinkfreeIcon],svg[arcticons-thinkfree-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThisshopIcon],svg[arcticons-thisshop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThncaIcon],svg[arcticons-thnca-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M17.909 25.302c-5.606 4.823-10.45 11.802-6.584 16.207c1.953 2.226 7.253 2.74 12.697 1.841"></svg:path><svg:path d="M37.454 12.184C22.99 14.817 6.044 28.475 8.35 36.241c1.686 5.681 10.725 5.993 20.329 2.803"></svg:path><svg:path d="M24.922 13.351C14.835 18.461 6.014 26.311 7.38 33.526c1.192 6.294 14.542 6.416 28.243-1.287"></svg:path><svg:path d="M19.374 13.368C12.017 17.84 5.01 25.375 6.464 30.541c2.042 7.267 18.044 5.246 30.247-2.887"></svg:path><svg:path d="M28.896 6.455C17.853 9.86 6.802 18.68 6.216 26.225c-.517 6.626 11.165 6.964 20.806 2.637"></svg:path><svg:path d="M23.873 6.295C15.587 9.802 7.384 16.479 6.537 22.22c-.966 6.548 7.452 7.034 13.973 5.325"></svg:path></svg:g><svg:path fill="currentColor" d="M41.802 11.722a.75.75 0 1 1-.75-.75a.75.75 0 0 1 .75.75m-17.464 9.574a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0m-3.069 2.01a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0M31.43 10.99a.75.75 0 1 1-.75-.75a.75.75 0 0 1 .75.75m-2.975 1.118a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0m4.012-4.168a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0m-3.265 1.029a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0m-3.262 1.347a.75.75 0 1 1-.75-.75a.75.75 0 0 1 .75.75m-3.218 1.572a.75.75 0 1 1-.75-.75a.75.75 0 0 1 .75.75M37.318 4.98a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0m-2.538.257a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0m-2.644.556a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0m-4.081-.711a.75.75 0 0 1-1.5 0a.75.75 0 0 1 1.5 0"></svg:path>`,
})
export class ArcticonsThncaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThpcodIcon],svg[arcticons-thpcod-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="m41.28 23.234l1.785 5.992a3.137 3.137 0 0 1-2.105 3.911l-26.415 7.917a3.126 3.126 0 0 1-3.9-2.111L4.631 18.775a3.137 3.137 0 0 1 2.105-3.912h0l26.415-7.916a3.126 3.126 0 0 1 3.9 2.11l1.787 5.992"></svg:path><svg:path d="m34.166 16.448l6.255-1.875a.893.893 0 0 1 1.114.604l1.928 6.467a.896.896 0 0 1-.601 1.118l-6.255 1.874"></svg:path><svg:path d="M36.588 20.182c1.246 4.181-1.124 8.584-5.294 9.834s-8.561-1.127-9.808-5.308s1.124-8.584 5.294-9.834s8.561 1.127 9.808 5.308"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.955 22.355c1.161-.033 2.13.92 2.165 2.128s-.879 2.215-2.04 2.248l-3.47.1l-.25-8.752l3.47-.1c1.161-.033 2.13.92 2.165 2.128s-.879 2.215-2.04 2.248m-1.911-5.771l.333 11.654m1.676-11.726l.333 11.654m-.431-5.811l-3.47.1"></svg:path>`,
})
export class ArcticonsThpcodIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThreeIcon],svg[arcticons-three-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThreemaIcon],svg[arcticons-threema-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThreemaWorkIcon],svg[arcticons-threema-work-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 4.5c-10.08 0-18.26 6.32-18.26 14.11a12.66 12.66 0 0 0 5.06 9.73L7.34 35l10.2-3.21a22.9 22.9 0 0 0 6.46.93c10.08 0 18.26-6.31 18.26-14.1S34.08 4.5 24 4.5"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 8.65a5 5 0 0 1 5 5v4.15h.71a1 1 0 0 1 .95.95h0V26a1 1 0 0 1-.95.95h-11.4a1 1 0 0 1-.95-.95h0v-7.27a1 1 0 0 1 .95-.95H19v-4.15a5 5 0 0 1 5-4.98"></svg:path><svg:circle cx="13.63" cy="40.6" r="2.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="24" cy="40.6" r="2.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="34.37" cy="40.6" r="2.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.02 17.78h9.96m-2.41 1.965l-1.28 5.12l-1.28-5.12l-1.28 5.12l-1.28-5.12"></svg:path>`,
})
export class ArcticonsThreemaWorkIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThreeplusIcon],svg[arcticons-threeplus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThreesIcon],svg[arcticons-threes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThroneIcon],svg[arcticons-throne-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m23.836 35.274l9.062-9.502c.536-.562.66-1.401.308-2.094l-8.542-16.82a.928.928 0 0 0-1.656 0l-8.541 16.82a1.83 1.83 0 0 0 .308 2.094z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.738 39.36a32140 32140 0 0 1-20.88-21.892c-.564-.59-1.543-.037-1.328.75l5.681 20.832a3.523 3.523 0 0 0 4.423 2.447c3.32-1.01 8.376-2.3 12.104-2.138Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.835 35.273c4.765-4.992 13.233-13.535 17.307-17.805c.565-.59 1.542-.038 1.328.749l-5.283 20.072a3.52 3.52 0 0 1-4.422 2.445a64 64 0 0 0-5.306-1.384"></svg:path>`,
})
export class ArcticonsThroneIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThumbKeyIcon],svg[arcticons-thumb-key-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.15 4.5c2.44 0 3.66.81 3.66 2.44v34.12c0 1.62-.81 2.44-2.44 2.44H16.14c-1.63 0-2.44-.81-2.44-2.44V6.94c0-1.63 1.22-2.44 3.66-2.44h12.8Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.69 17.27c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.51s-.68 1.49-1.5 1.49s-1.5-.67-1.5-1.49s.68-1.51 1.5-1.51M18.69 22.5c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.51s-.68 1.49-1.5 1.49s-1.5-.67-1.5-1.49s.68-1.51 1.5-1.51m-10.24 5.23c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.5s-.68 1.5-1.5 1.5s-1.5-.68-1.5-1.5s.68-1.5 1.5-1.5m5.12 0c.82 0 1.5.68 1.5 1.51s-.68 1.49-1.5 1.49s-1.5-.67-1.5-1.49s.68-1.51 1.5-1.51M17.86 4.56c.06 1.43.91 2.15 2.53 2.15h7.31c1.45-.05 2.21-.78 2.27-2.21"></svg:path>`,
})
export class ArcticonsThumbKeyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThunderIcon],svg[arcticons-thunder-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M16.658 40.755c2.631-1.655 4.419-7.282 1.028-10.234L9.773 42.124c-.64.936-.3 1.934 1.695 1.005l7.296-3.405l12.395-5.77a3.234 3.234 0 0 0 1.502-4.32l-.006-.012l-6.84-14.775c-.82-1.689.484-4.355 2.886-6.314m2.64-1.288c-2.63 1.655-4.418 7.282-1.027 10.234l7.913-11.603c.64-.936.3-1.934-1.695-1.005l-7.296 3.405l-12.395 5.77a3.234 3.234 0 0 0-1.502 4.32l.006.012l6.84 14.775c.82 1.689-.484 4.355-2.886 6.315"></svg:path>`,
})
export class ArcticonsThunderIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsThunderbirdIcon],svg[arcticons-thunderbird-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.059 16.73c-.553-1.7-.185-4.857 3.255-6.27h.01c1.354-4.733 7.253-7.043 13.265-7.043c4.155 0 7.884 1.315 10.44 3.403a15.3 15.3 0 0 0-4.469.888c2.066.768 3.84 1.949 5.156 3.41a16 16 0 0 0-3.005-.227A21.4 21.4 0 0 1 45.5 23.083c0 11.874-9.626 21.5-21.5 21.5c-11.691 0-21.5-9.788-21.5-21.5c0-1.85.246-3.76.723-5.55c.125-.376.3-.737.531-.869c.29-.165.554.327.597.488a19.7 19.7 0 0 0 1.263 3.423c-.046-2.455 1.003-4.691 2.445-6.625c.962-1.29 1.854-2.484 2.266-5.932c.027-.232.247-.398.468-.326c3.13 1.025 4.804 6.238 4.544 10.597"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M3.677 17.018c-1.32 5.402-.3 11.751 5.694 17.08c-1.784-1.952-3.963-9.157.845-14.305c.323-.347.88-.092.898.382c.397 10.698 9.03 17.232 18.982 16.01"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.01 32.009c5.839 0 10.573-3.863 10.573-8.628s-4.734-8.627-10.574-8.627c-4.981 0-10.576 3.24-10.573 8.753c.002 8.519 9.001 13.42 16.673 12.677c-.577-.067-4.171-.258-6.6-3.006c-.22-.248-.6-.68-.428-.96c.172-.281.646-.21.928-.21z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.769 21.596s-3.647 4.25-5.044 5.65s-2.468 1.329-3.727.019s-5.029-5.663-5.029-5.663m8.571-11.175c1.26-.396 1.149-1.643 1.149-1.643s-.63-.742-1.878-.33c-1.168.384-1.349 1.216-1.349 1.216s.638 1.21 2.078.757"></svg:path>`,
})
export class ArcticonsThunderbirdIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTianyanchaIcon],svg[arcticons-tianyancha-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M45.338 21.366Q45.5 22.669 45.5 24h0c0 3.843-1.008 7.45-2.775 10.573c-7.823 2.36-14.597-3.564-15.458-6.55c1.74 6.488 18.504 2.553 18.071-6.657"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.533 37.745A21.5 21.5 0 0 1 29.39 44.82c-4.747-6.902-6.165-13.963-4.786-20.64c-1.556 4.226 3.6 16.376 15.929 13.566"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.809 45.318q-1.38.181-2.809.182c-6.638 0-12.573-3.008-16.517-7.736c2.876-8.695 10.38-17.557 19.092-21.63c-6.71 4.952-8.028 21.665.234 29.184"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.979 20.267c6.795-8.95-5.676-18.34-26.84-8.32c3.018-5.138 14.936-8.7 22.07-5.675C32.604 3.76 28.403 2.5 24 2.5C12.126 2.5 2.5 12.126 2.5 24c0 4.134 1.167 7.996 3.203 11.275c3.971-10.7 9.82-16.048 16.272-19.84c7.492-4.403 22.148-4.514 19.004 4.832"></svg:path>`,
})
export class ArcticonsTianyanchaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTic80Icon],svg[arcticons-tic-80-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M41.34 17.39c0 6.17-1.32 8.81-3.96 7.93"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.3 42.5h7.93v-2.64h7.93v2.64h7.93v-2.64h2.64v-2.64h2.64l.04-3.98l-.04-3.95V8.14h-2.64V5.5H8.3v2.64H5.66v31.71H8.3v2.64Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.48 30.61c-2.64 3.96-7.93 3.96-10.57 0m0-13.22v5.29m10.57-5.29v5.29m6.61 3.96H8.3V10.78h23.79zM8.3 39.86h7.93m7.93 0h7.93M8.3 8.14h26.43"></svg:path>`,
})
export class ArcticonsTic80Icon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiceIcon],svg[arcticons-tice-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.177 37.016c-2.126 2.74-3.605 4.852-4.581 6c-.47.609-1.503.68-2.114 0c-1.668-1.93-9.79-12.098-9.79-12.098s3.972-4.71 5.528-6.815c-4.675-5.42-.416-11.517 4.78-11.474s8.863 6.358 4.368 11.568l5.94 6.721c2.319-3.983 4.13-5.313 4.13-13.058S30.69 4.5 24 4.5S9.562 10.183 9.562 17.86c0 3.82.442 5.988 1.18 7.749"></svg:path>`,
})
export class ArcticonsTiceIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTicketnewIcon],svg[arcticons-ticketnew-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTicketrestaurantIcon],svg[arcticons-ticketrestaurant-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTicketsIcon],svg[arcticons-tickets-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.337 43.5H14.663a2 2 0 0 1-2-2v-35a2 2 0 0 1 2-2h18.674a2 2 0 0 1 2 2v35a2 2 0 0 1-2 2M21.098 6.042h3.628"></svg:path><svg:circle cx="26.553" cy="6.087" r=".75" fill="currentColor"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.304 14.924H15.5v3.804m17 0v-3.804h-3.804m0 17H32.5V28.12m-14.68-3.589v5.054h5.054v-5.054Zm0-7.287v5.054h5.054v-5.054Zm7.287 0v5.054h5.054v-5.054Zm2.537 12.36a2.66 2.66 0 0 0 1.594-.965a3.85 3.85 0 0 0 .942-2.628v-1.48h-5.054v1.48h0a3.85 3.85 0 0 0 .942 2.628a2.66 2.66 0 0 0 1.575.965M15.5 28.12v3.804h3.804M31.051 4.5h-.603a1 1 0 0 0-.864.496l-.982 1.686a2 2 0 0 1-1.728.992h-5.748a2 2 0 0 1-1.728-.992l-.982-1.686a1 1 0 0 0-.864-.496h-.603"></svg:path>`,
})
export class ArcticonsTicketsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTicketsInfosIcon],svg[arcticons-tickets-infos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21.381 25.798v-8H24c1.48 0 2.681 1.203 2.681 2.687s-1.2 2.687-2.681 2.687h-2.619m2.619 0l2.619 2.624m-9.634-3.998a2 2 0 1 1 0 4h-3.3v-8h3.3a2 2 0 1 1 0 4m0 0h-3.3m18.63 0a2 2 0 1 1 0 4h-3.3v-8h3.3a2 2 0 1 1 0 4m0 0h-3.3m-15.33 8.404h20.63"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path>`,
})
export class ArcticonsTicketsInfosIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTickmateIcon],svg[arcticons-tickmate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m13.187 12.035l3.447-.608l.608 3.447l-3.447.608zm6.883-1.228l3.447-.608l.608 3.447l-3.447.608zm7.504 2.233l3.447-.607l.608 3.447l-3.447.608zm1.21 6.906l3.447-.608l.607 3.447l-3.447.608z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m29.392 23.378l3.447-.608l.607 3.447l-3.446.608zM21.289 17.7l3.446-.607l.608 3.447l-3.447.607zm.6 3.454l3.446-.608l.608 3.447l-3.447.608zm8.721 9.117l3.447-.608l.607 3.447l-3.446.608zm.6 3.454l3.446-.608l.608 3.447l-3.447.607z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m25.95 23.986l3.447-.608l.608 3.447l-3.447.608z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m26.548 27.43l3.447-.608l.608 3.446l-3.447.608zm-2.822 4.06l3.447-.609l.608 3.447l-3.447.608zm-2.843 4.05l3.447-.607l.607 3.447l-3.447.607zm-1.818-10.336l3.447-.608l.607 3.447l-3.446.608zm-3.452.61l3.447-.608l.608 3.447l-3.447.607z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m16.223 29.255l3.447-.608l.608 3.447l-3.447.608zm-2.428-13.788l3.447-.608l.608 3.447l-3.447.608z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m17.229 14.869l3.447-.608l.607 3.447l-3.446.607z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m14.395 18.92l3.447-.608l.608 3.447l-3.447.608z"></svg:path><svg:rect width="25.1" height="35.78" x="11.45" y="6.11" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.89" transform="rotate(-10 23.99 23.982)"></svg:rect>`,
})
export class ArcticonsTickmateIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiddloidIcon],svg[arcticons-tiddloid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTidypanelIcon],svg[arcticons-tidypanel-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.678 13.032a13.24 13.24 0 0 0-3.932 9.412v11.19l-4.2 4.199h34.907l-4.199-3.89m0-3.993v-7.506A13.25 13.25 0 0 0 27.075 9.563v-.984a3.097 3.097 0 0 0-6.193 0v.995a13.2 13.2 0 0 0-4.25 1.861m2.702 26.398a4.643 4.643 0 1 0 9.287.048v-.048M6.547 5.5l34.906 32.333"></svg:path>`,
})
export class ArcticonsTidypanelIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiendamiaIcon],svg[arcticons-tiendamia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiimeIcon],svg[arcticons-tiime-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.12 32.884V15.116c0-.976-.521-1.878-1.366-2.366L25.365 3.866a2.73 2.73 0 0 0-2.732 0L7.247 12.75a2.73 2.73 0 0 0-1.366 2.366v17.768c0 .976.52 1.878 1.366 2.366l15.387 8.884a2.73 2.73 0 0 0 2.732 0l15.388-8.884a2.73 2.73 0 0 0 1.366-2.366"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M35.315 30.533V17.467L24 10.934l-11.315 6.533v13.066L24 37.066zm-4.51-23.527L24 10.934m-6.805 30.06L24 37.066m18.12-15.67l-6.805-3.929m0 13.066v7.857M5.88 26.604l6.805 3.929m0-13.066V9.61"></svg:path>`,
})
export class ArcticonsTiimeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiimeInvoiceIcon],svg[arcticons-tiime-invoice-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.12 32.884V15.116c0-.976-.521-1.878-1.366-2.366L25.365 3.866a2.73 2.73 0 0 0-2.732 0L7.247 12.75a2.73 2.73 0 0 0-1.366 2.366v17.768c0 .976.52 1.878 1.366 2.366l15.387 8.884a2.73 2.73 0 0 0 2.732 0l15.388-8.884a2.73 2.73 0 0 0 1.366-2.366"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M35.315 30.533V17.467L24 10.934l-11.315 6.533v13.066L24 37.066zm-4.51-23.527L24 10.934m-6.805 30.06L24 37.066m18.12-15.67l-6.805-3.929m0 13.066v7.857M5.88 26.604l6.805 3.929m0-13.066V9.61"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m24.166 26.294l1.808-4.536l-3.376 3.47l-3.317-.93L28.719 17L26.98 28.851zm-1.884 1.449L20.372 31m3.393-2.456l-.665 1.117m-3.384-.81l1.15-1.926"></svg:path>`,
})
export class ArcticonsTiimeInvoiceIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTikkieIcon],svg[arcticons-tikkie-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 2.5A21.52 21.52 0 0 0 5.15 34.36L2.5 45.5l11.14-2.65A21.5 21.5 0 1 0 24 2.5"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.11 31.71a7.81 7.81 0 0 1-6 2.79h0a7.83 7.83 0 0 1-7.83-7.82v-5.36a7.83 7.83 0 0 1 7.83-7.82h0a7.8 7.8 0 0 1 6 2.82m-17.56 4.84h9.88m-9.88 5.73h9.88"></svg:path>`,
})
export class ArcticonsTikkieIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiklaGelsinIcon],svg[arcticons-tikla-gelsin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m22.376 27.512l1.567 4.557m-3.244.001l1.076 11.43h4.334l1.076-11.429m-7.039-.001h7.594m-3.825-16.85c1.468-1.77 3.064-3.707 3.503-6.01c.437-2.295-1.12-4.709-3.503-4.709s-3.941 2.414-3.503 4.709c.439 2.303 2.034 4.24 3.503 6.01"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27 36.306c2.778-1.148 4.707-4.05 4.666-7.059q-7.667-.011-15.333.05c-.016 3.02 1.918 5.889 4.71 7.028m-4.966-11.719c2.598.004 5.197-.008 7.795 0c.855 1.476 2.99 2.153 4.382.998c.924-1.265 1.93-1.063 3.412-.998m-5.909-11.488c3.722 1.01 5.956 4.313 5.908 7.575q-7.667.012-15.333-.05c-.02-3.276 2.254-6.516 5.924-7.525m-9.442-1.928l7.826-1.141m6.807-.983l7.74-1.112"></svg:path><svg:circle cx="25.62" cy="18.479" r=".75" fill="currentColor"></svg:circle><svg:circle cx="27.496" cy="16.604" r=".75" fill="currentColor"></svg:circle><svg:circle cx="27.812" cy="18.8" r=".75" fill="currentColor"></svg:circle><svg:circle cx="23.89" cy="8.111" r="1.453" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle>`,
})
export class ArcticonsTiklaGelsinIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTiktokPluginIcon],svg[arcticons-tiktok-plugin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.5 27.664v-7.328h2.399c1.356 0 2.456 1.102 2.456 2.461s-1.1 2.461-2.456 2.461H8.5m6.564-4.922v7.328h3.664m1.081-7.328v4.9a2.427 2.427 0 1 0 4.855 0v-4.9m6.563 2.427a2.427 2.427 0 0 0-2.427-2.427h0a2.427 2.427 0 0 0-2.427 2.427v2.474a2.427 2.427 0 0 0 2.427 2.427h0a2.427 2.427 0 0 0 2.427-2.427H28.8m4.136-4.901v7.328m1.709 0v-7.328l4.855 7.328v-7.328"></svg:path>`,
})
export class ArcticonsTiktokPluginIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTillaIcon],svg[arcticons-tilla-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.842 43.325a17 17 0 0 0-5.01-2.195c-7.802-1.748-14.35-7.105-13.218-14.506c.383-3.692 3.626-9.352 3.626-9.352c-2.628-3.016-5.446-5.826-4.58-12.597c1.14 3.23 2.245 6.507 4.962 7.634c-1.17-1.857-.659-3.354-.668-4.962a7.81 7.81 0 0 0 4.676 5.63c8.477-5.594 14.603-3.778 20.136-.095c2.969-.833 4.71-2.622 5.249-5.344a4.76 4.76 0 0 1-.573 4.676c3.532-1.114 3.75-4.682 5.058-7.444c-.172 5.392-1.372 10.063-5.07 12.654c0 0 3.813 5.696 3.567 9.893c-.543 9.936-6.247 12.337-12.506 13.74c-2.111.472-3.951 1.67-5.65 2.268Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.526 24.763c3.307.605 10.513 1.846 10.187 4.366a6.33 6.33 0 0 1-3.793 2.696c-4.82.75-7.93-7.398-6.394-7.062"></svg:path><svg:circle cx="15.264" cy="28.139" r="1.992" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.627 24.763c-3.307.605-10.513 1.846-10.187 4.366a6.33 6.33 0 0 0 3.793 2.696c4.82.75 7.93-7.398 6.394-7.062"></svg:path><svg:circle cx="32.889" cy="28.139" r="1.992" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.386 31.95c0 1.876-1.515 7.102-3.383 7.102s-3.384-5.226-3.384-7.101a3.384 3.384 0 1 1 6.767 0M9.24 17.272a30 30 0 0 0 4.355 3.017c2.039 1.15 4.427 1.627 6.41 2.873a17.1 17.1 0 0 1 3.997 3.373a30 30 0 0 1 3.316-2.86c2.046-1.321 4.552-1.803 6.624-3.084c2.167-1.34 4.489-3.168 4.489-3.168"></svg:path>`,
})
export class ArcticonsTillaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTillaPremiumIcon],svg[arcticons-tilla-premium-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M23.848 45.5a16.4 16.4 0 0 0-4.802-2.104C11.57 41.72 5.293 36.586 6.377 29.493c.368-3.54 3.476-8.964 3.476-8.964c-2.518-2.89-5.22-5.584-4.39-12.074c1.092 3.097 2.152 6.237 4.756 7.318c-1.12-1.78-.631-3.215-.64-4.757a7.49 7.49 0 0 0 4.482 5.397c8.125-5.362 13.996-3.622 19.3-.092c2.845-.798 4.513-2.513 5.03-5.122a4.56 4.56 0 0 1-.549 4.482c3.385-1.068 3.595-4.487 4.848-7.135c-.164 5.169-1.315 9.645-4.859 12.129c0 0 3.654 5.459 3.419 9.481c-.521 9.524-5.988 11.826-11.987 13.17c-2.023.453-3.787 1.6-5.416 2.174z"></svg:path><svg:path d="M10.127 27.709c3.17.58 10.077 1.769 9.765 4.185a6.06 6.06 0 0 1-3.636 2.584c-4.62.718-7.6-7.092-6.129-6.769"></svg:path><svg:circle cx="15.627" cy="30.945" r="1.909"></svg:circle><svg:path d="M38.02 27.709c-3.17.58-10.077 1.769-9.764 4.185a6.06 6.06 0 0 0 3.635 2.584c4.62.718 7.6-7.092 6.129-6.769"></svg:path><svg:circle cx="32.52" cy="30.945" r="1.909"></svg:circle><svg:path d="M27.246 34.598c0 1.798-1.452 6.807-3.243 6.807s-3.244-5.01-3.244-6.807a3.243 3.243 0 0 1 6.487 0M9.853 20.529a29 29 0 0 0 4.174 2.892c1.955 1.102 4.244 1.559 6.144 2.753a16.4 16.4 0 0 1 3.831 3.233a29 29 0 0 1 3.178-2.74c1.96-1.267 4.364-1.729 6.349-2.957c2.078-1.285 4.302-3.036 4.302-3.036M24.138 4.457L24.1 9.249m2.415-2.378l-4.792-.037m5.913 3.448a7.7 7.7 0 0 0 .843-3.469a7.7 7.7 0 0 0-.843-3.47a7.7 7.7 0 0 0-3.47-.843a7.7 7.7 0 0 0-3.469.844a7.7 7.7 0 0 0-.844 3.47a7.7 7.7 0 0 0 .844 3.468a7.7 7.7 0 0 0 3.47.844a7.7 7.7 0 0 0 3.469-.844"></svg:path></svg:g>`,
})
export class ArcticonsTillaPremiumIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimIcon],svg[arcticons-tim-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.382 4.5h19.235a6.65 6.65 0 0 1 6.663 6.662V29.83a6.65 6.65 0 0 1-6.662 6.662h-3.39V43.5l-8.63-7.007h-7.215A6.65 6.65 0 0 1 7.72 29.83V11.162A6.65 6.65 0 0 1 14.383 4.5Zm9.546 5.875V21.28m10.335-3.473L23.929 21.28m6.487 8.368l-6.487-8.366m-6.696 8.328l6.695-8.33M13.24 17.665l10.688 3.615"></svg:path>`,
})
export class ArcticonsTimIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimHortonsIcon],svg[arcticons-tim-hortons-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimberIcon],svg[arcticons-timber-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimbreIcon],svg[arcticons-timbre-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.868 5.113A2.863 2.863 0 0 0 5 7.98v25.89a2.86 2.86 0 0 0 2.868 2.869h23.226l-6.864 6.159h15.902A2.86 2.86 0 0 0 43 40.03l-.07-25.902a2.865 2.865 0 0 0-2.869-2.868H24.83l-1.685-6.159ZM31.095 36.74l-6.266-25.48"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.908 16.824h-3.334v9.395"></svg:path><svg:circle cx="13.83" cy="26.127" r="2.742" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.033 19.208h3.795m-1.083 11.204h6.396"></svg:path><svg:circle cx="32.552" cy="19.222" r="1.622" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="38.03" cy="30.459" r="1.622" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.026 23.201a1.622 1.622 0 1 1 .733 3.154M24.23 42.899l-2.128-5.948m12.397-17.743h4.226m-8.289 5.517h8.289"></svg:path>`,
})
export class ArcticonsTimbreIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimeBuddyIcon],svg[arcticons-time-buddy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29c-2.2 0-4 1.8-4 4v29c0 2.2 1.8 4 4 4h29c2.2 0 4-1.8 4-4v-29c0-2.2-1.8-4-4-4"></svg:path><svg:circle cx="24" cy="24" r="3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 21V9.5m2.67 15.948l11.341 6.151"></svg:path>`,
})
export class ArcticonsTimeBuddyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimeCopIcon],svg[arcticons-time-cop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimecapIcon],svg[arcticons-timecap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimerMachineIcon],svg[arcticons-timer-machine-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.434 45.395c10.7-.742 19.219-9.256 19.966-19.957m-42.807 0c.747 10.7 9.265 19.215 19.967 19.957m0-42.789c-10.701.742-19.22 9.257-19.967 19.958m42.855 0c-.744-10.722-9.29-19.25-20.014-19.969m-1.437 9.285v12.57l10.951 6.632m-15.145 8.819q.734.195 1.493.323"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.799 26.672c.888 5.434 4.425 9.95 9.221 12.212"></svg:path>`,
})
export class ArcticonsTimerMachineIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimesPrimeIcon],svg[arcticons-times-prime-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimesheetIcon],svg[arcticons-timesheet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="24" cy="24" r="1.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.5 24h20m-22.557 1.057L8.798 39.202"></svg:path>`,
})
export class ArcticonsTimesheetIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimetomeIcon],svg[arcticons-timetome-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimezoneFunAppIcon],svg[arcticons-timezone-fun-app-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.684 20.58h23.978c1.182 0 1.419 1.673.283 2l-11.132 3.213c-1.136.328-.899 2.002.283 2.002h11.588M16.41 20.579v7.215"></svg:path>`,
})
export class ArcticonsTimezoneFunAppIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTimoIcon],svg[arcticons-timo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.5 21.616c12.844-1.903 14.02-1.558 15.058-2.077c2.596-5.193 3.635-15.058 10.385-12.981c2.596 1.038-2.596 8.308-2.596 12.462c4.673 0 12.98-1.039 14.02.519c1.508 4.046-10.112 4.434-16.097 6.23c-1.039 5.193-2.596 9.866-.52 15.578c-1.038 1.038-9.865 1.038-6.23-15.058c-10.385 2.596-13.5-.52-14.02-4.673"></svg:path>`,
})
export class ArcticonsTimoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinfoilforfacebookIcon],svg[arcticons-tinfoilforfacebook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linejoin="round" d="M34.2 27.052s-.527 1.102-1.238 2.286a21.7 21.7 0 0 0-2.103 4.366a10.3 10.3 0 0 0-.281 4.59c.112.485 1.318 4.721 1.43 5.206c-3.375 0-6.862-.448-10.237-.448c-.239-.758-1.755-6.007-2.384-6.297a14.6 14.6 0 0 0-2.16-.224c-.468-.098-2.78-.485-1.85-2.742c-.18-.216-.788-.469-.646-.952a1.8 1.8 0 0 0 .14-.392c-.297-.204-.756-.469-.56-.812c.3-1.063.04-1.323-.197-1.483c-.365-.021-1.327-.42-1.178-1.035a3.9 3.9 0 0 1 .814-1.26a11.5 11.5 0 0 0 1.262-2.07c.275-.637-.425-.995-.253-1.792c.467-1.52 1.009-3.728 1.009-3.728"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linejoin="round" d="m13.46 15.415l4.281.721l7.853 1.178l8.255 4.627l2.709 1.547l.19 4.75l-13.063-5.779l-12.432-3.47ZM30.424 4.5l-6.74 17.96Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linejoin="round" d="M17.74 16.136L30.425 4.5l3.425 17.44"></svg:path>`,
})
export class ArcticonsTinfoilforfacebookIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinkoffbizIcon],svg[arcticons-tinkoffbiz-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m18.74 20.4l10.85.09l.41 13.42c-.92 2.15-5.08 2.46-5.71 3.43c-.75-.92-4.37-1.73-5.46-3.43Zm12.65 5.23C39.81 20.79 26.59 15.22 35 10c2 3.43 2.94 8.24 8.14 7.47c.54 4.78-1.05 5.63-3.1 5.65c.71 2.8 1.85 3.81 3.5 4.51c-.48 1.71-1.21 3.15-3.7 2.83c-1.36 6.85-3.69 7.51-7.6 7c2.15-4.4-.08-6.69 2.15-9.95ZM21.1 6.12h6.12l.13 5.79l2.29 1.95c-1.42 1.67-2.6 3.55-5.05 4.37c-2.73-.75-4-2.57-5.38-4.37l2.09-2Zm-1.22 34.31c2.86 1.54 5.83 2.32 9.22-.06M16.61 26c-8.42-4.85 4.8-10.42-3.61-15.61c-2 3.43-2.94 8.24-8.14 7.47c-.54 4.78 1 5.62 3.1 5.65C7.29 26.3 6.15 27.32 4.5 28c.48 1.7 1.21 3.15 3.7 2.82c1.36 6.85 3.69 7.51 7.6 7c-2.15-4.4.08-6.69-2.15-10Z"></svg:path>`,
})
export class ArcticonsTinkoffbizIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinyPlanetFxProIcon],svg[arcticons-tiny-planet-fx-pro-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.726 10.216a15.41 15.41 0 0 0-18.115 3.192m26.596 10.454a15.38 15.38 0 0 0-6.472-12.434m4.273 20.483a15.3 15.3 0 0 0 1.871-4.76M28.356 38.692a15.4 15.4 0 0 0 6.79-4.297M11.587 14.61A15.399 15.399 0 0 0 23.81 39.374a15.5 15.5 0 0 0 2.316-.173"></svg:path><svg:circle cx="28.519" cy="18.663" r="1.829" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="19.502" cy="16.539" r="1.349" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="19.247" cy="26.632" r="1.624" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="24.757" cy="29.879" r="1.624" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="33.988" cy="27.656" r="1.499" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="38.806" cy="25.475" r="1.663" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.185 40.114q.005-.035.007-.07a.997.997 0 0 0-1.93-.351a1.66 1.66 0 1 0 .94 3.074a1.417 1.417 0 1 0 .984-2.653M29.529 4.993c.007-.022.018-.043.024-.065a.997.997 0 0 0-1.786-.812a1.66 1.66 0 1 0 .161 3.21a1.417 1.417 0 1 0 1.6-2.333M7.303 31.333a1.453 1.453 0 0 0-2.491-1.017a1.451 1.451 0 1 0-1.441 2.5a1.765 1.765 0 1 0 3.497-.447a1.45 1.45 0 0 0 .435-1.036M9.986 7.629a1.453 1.453 0 0 0-1.216 2.4a1.451 1.451 0 1 0 2.374 1.64a1.765 1.765 0 1 0-.162-3.523a1.45 1.45 0 0 0-.996-.517m32.367 21.786a1.22 1.22 0 0 0-1.02 2.015a1.219 1.219 0 1 0 1.993 1.376a1.482 1.482 0 1 0-.135-2.957a1.22 1.22 0 0 0-.838-.434m.663-10.845a1.565 1.565 0 1 0-1.525 1.222a1.55 1.55 0 0 0 .713-.18a.66.66 0 0 0 .449.18a.67.67 0 0 0 .671-.671a.66.66 0 0 0-.308-.55M6.146 20.87a1.565 1.565 0 1 0-1.936-.264a1.55 1.55 0 0 0 .621.393a.66.66 0 0 0 .18.449a.67.67 0 0 0 .95.023a.66.66 0 0 0 .185-.602M14.57 43.27a1.565 1.565 0 1 0-1.562-1.174a1.55 1.55 0 0 0 .35.646a.664.664 0 1 0 1.211.529"></svg:path><svg:circle cx="20.175" cy="42.767" r="1.547" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="9.972" cy="37.848" r="1.576" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="5.461" cy="25.835" r="1.357" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="7.979" cy="15.129" r="1.16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="19.339" cy="5.696" r="1.186" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="36.662" cy="10.253" r="1.102" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="39.756" cy="13.669" r="1.35" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="43.958" cy="24.293" r="1.542" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="35.956" cy="33.063" r="1.56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.252" cy="38.994" r="1.146" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.964 27.995a1.095 1.095 0 0 0-1.095-1.094c-.023 0-.044.005-.067.006a1.258 1.258 0 1 0-2.484.355a1.243 1.243 0 1 0 1.068 2.223a1.224 1.224 0 0 0 2.305-.773a1.1 1.1 0 0 0 .273-.717"></svg:path><svg:circle cx="23.152" cy="11.034" r="1.255" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="31.699" cy="10.881" r="1.175" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.507" cy="33.834" r=".642" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="29.899" cy="34.834" r=".669" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="12.687" cy="14.508" r="1.1" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m27.6 7.391l-.421 1.558m8.705 2.085l-1.734 1.534m4.578 1.973L36.796 15.7m3.222 3.055l-1.586.386m3.983 5.152l-2.491-.045m1.409 7.182l-3.298-1.551m-7.689 9.646l-.543-1.361m-9.419 3.056l.45-2.133m-5.616 1.216l1.364-2.727m-5.618-.949l1.928-1.793m-5.624-3.817l2.41-.917m-2.859-4.265l1.679-.222m-1.63-5.726l1.961.514m.17-4.725l1.37.782m1.594-5l1.254 1.344m6.285-5.933l.357 2.221"></svg:path><svg:circle cx="36.612" cy="38.172" r="1.125" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m34.147 35.388l1.809 1.872"></svg:path>`,
})
export class ArcticonsTinyPlanetFxProIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinybitAltIcon],svg[arcticons-tinybit-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 42.5h-29c-2.2 0-4-1.8-4-4v-29c0-2.2 1.8-4 4-4h29c2.2 0 4 1.8 4 4v29c0 2.2-1.8 4-4 4m-28-26.897h11.126m-5.563 16.794V15.603m-2.204 16.794h4.408M10.5 17.807v-2.204m11.126 2.204v-2.204"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.301 24a4.199 4.199 0 0 1 0 8.397h-6.927V15.603H33.3a4.199 4.199 0 0 1 0 8.397m.001 0h-6.927m-2.205-8.397h2.205m-2.205 16.794h2.205"></svg:path>`,
})
export class ArcticonsTinybitAltIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinyscannerIcon],svg[arcticons-tinyscanner-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.2 20.38c.18.1 4.88 3.56 9.16 6.67c5.24 3.82 7.81 5.77 7.88 6a18 18 0 0 1 0 2.65c-.12 2.69-.18 2.82-1.44 3.12c-.56.13-.74.24-.8.48c-.15.59-.38.67-4.09 1.42l-4 .84c-7.73 1.62-7.95 1.66-9.07 1.65a5.2 5.2 0 0 1-1.6-.21a6.6 6.6 0 0 1-1.94-1.47l-5.66-5.23c-4.17-3.83-4.88-4.55-5-5a2.36 2.36 0 0 0-.8-1.15l-.71-.68v-2.83c0-2.81 0-2.84.26-2.93m0 0a2.35 2.35 0 0 1-1.51-2.89c.09-.16 1-1.54 2.1-3.07l4.36-6.23C15 7.71 15.47 7.18 16.41 6.7c.71-.36 1.16-.44 7.24-1.22l7.11-.92a31 31 0 0 1 3.81-.35h0c.52.1 1.48.94 1.48 1.3s-.64 1.18-6.17 8.6c-2.18 2.89-4.52 6.13-4.68 6.27"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m42.24 33l-19.53 4.36a.94.94 0 0 1-.85-.23L7.19 23.88m.2-.13l17.81-3.37"></svg:path>`,
})
export class ArcticonsTinyscannerIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinytraveltrackerIcon],svg[arcticons-tinytraveltracker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTinyviewIcon],svg[arcticons-tinyview-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTipsIcon],svg[arcticons-tips-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M11.732 5.5h24.536c1.994 0 3.492 1.608 3.6 3.598l1.212 22.579c.107 1.99-1.606 3.598-3.6 3.598H10.52c-1.994 0-3.706-1.608-3.6-3.598l1.213-22.58c.107-1.99 1.605-3.597 3.6-3.597"></svg:path><svg:path d="m38.812 35.022l.082 1.542c.094 1.734-1.4 3.135-3.139 3.135h-23.51c-1.74 0-3.233-1.4-3.14-3.135l.083-1.542"></svg:path><svg:path d="m36.166 39.67l.015.27c.076 1.416-1.145 2.56-2.567 2.56H14.386c-1.422 0-2.643-1.144-2.567-2.56l.015-.27"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.702 17.014c1.108-.159 2.188-.139 3.418-.067c-.112 2.417-.326 4.527-.332 7.102c-.008 3.267.833 4.86 3.51 2.513"></svg:path><svg:path fill="currentColor" d="M25.25 13.404a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0"></svg:path>`,
})
export class ArcticonsTipsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTisseoIcon],svg[arcticons-tisseo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.34 27.42h3.56m-3.56-7.12h3.56m-1.78 0v7.12m17.1 0h3.56m-3.56-7.12h3.56m-3.56 3.56h2.32m-2.32-3.56v7.12M42 22.68a2.39 2.39 0 0 0-2.52-2.39a2.48 2.48 0 0 0-2.26 2.52V25a2.39 2.39 0 0 0 2.39 2.39h0A2.39 2.39 0 0 0 42 25zM6.04 20.29h5.38m-2.69 7.13v-7.13m24.44-1.78l1.66-.78"></svg:path><svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.62 20.3a1.78 1.78 0 0 0-1.78 1.78h0a1.78 1.78 0 0 0 1.78 1.78h.6"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21.22 23.86h.61a1.78 1.78 0 0 1 1.77 1.78h0a1.78 1.78 0 0 1-1.77 1.78m1.6-6.52a3 3 0 0 0-2.21-.6h-.6M19 26.82a3 3 0 0 0 2.21.6h.61m5.49-7.12a1.78 1.78 0 0 0-1.78 1.78h0a1.78 1.78 0 0 0 1.78 1.78h.6m0 0h.6a1.78 1.78 0 0 1 1.78 1.78h0a1.78 1.78 0 0 1-1.78 1.78m1.61-6.52a3 3 0 0 0-2.21-.6h-.6m-1.61 6.52a3 3 0 0 0 2.21.6h.6"></svg:path>`,
})
export class ArcticonsTisseoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTitanWarIcon],svg[arcticons-titan-war-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.668 8.448c-2.324 1.684-1.979 4.412.943 5.259c2.773.803 3.597-3.323 3.677-5.947c.057-1.887-1.361-3.048-3.308-2.418c-1.233.4-1.037 2.586-1.312 3.106"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M31.121 6.632c3.775-4.86 4.995 4.597-.04 3.218"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.065 9.767c1.897 2.924-.527 4.017-2.773 2.595m-2.312-7.02l-1.465-1.454c-1.241 1.04-1.17 2.419.535 2.62"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.504 9.694c-3.186-1.28-3.157-5.345.17-4.488"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.584 12.39c-2.07.278-3.925-1.34-1.27-3.412m2.219 4.334l-.509 1.319m3.874-9.297l1.306-1.48c.48.36.729.552.956 1.733m-1.388 5.586c-1.668-1.544-2.072-1.86-4.97-1.906m4.153 3.626c-1.58-1.69-2.387-2.517-4.79-1.808m3.138-3.478c.264-.519.466-.85 1.599-.491m8.638 8.519c-1.785 1.295-1.52 3.392.726 4.043c2.132.618 2.765-2.554 2.826-4.571c.044-1.451-1.046-2.343-2.542-1.859c-.948.307-.798 1.988-1.01 2.387"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M41.965 14.239c2.901-3.737 3.84 3.533-.032 2.473"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M43.458 16.65c1.459 2.247-.404 3.087-2.131 1.994m-1.777-5.397l-1.126-1.118c-.955.8-.9 1.86.41 2.014"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.647 16.593c-2.449-.984-2.427-4.109.131-3.45"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.708 18.665c-1.591.214-3.017-1.029-.976-2.622m1.706 3.331l-.391 1.014m2.978-7.147l1.004-1.138c.368.278.56.426.734 1.333m-1.067 4.294c-1.282-1.187-1.593-1.43-3.821-1.465m3.193 2.787c-1.215-1.3-1.835-1.935-3.683-1.39m2.415-2.673c.202-.399.358-.653 1.228-.378M9.459 8.877c1.786 1.295 1.52 3.392-.726 4.043c-2.131.617-2.765-2.554-2.826-4.571C5.863 6.898 6.953 6.006 8.45 6.49c.948.307.798 1.988 1.01 2.387Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M6.035 7.481c-2.901-3.736-3.84 3.534.032 2.474"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.541 9.891c-1.458 2.248.405 3.088 2.132 1.995M8.45 6.49l1.126-1.118c.954.799.9 1.86-.411 2.014"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.352 9.835c2.45-.984 2.427-4.108-.13-3.45"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.291 11.907c1.592.214 3.017-1.03.977-2.622m-1.705 3.331l.39 1.013M6.975 6.483L5.971 5.345c-.369.278-.56.426-.735 1.333m1.068 4.294c1.282-1.187 1.592-1.43 3.82-1.465m-3.192 2.787c1.215-1.3 1.835-1.935 3.682-1.39M8.201 8.23c-.203-.398-.358-.652-1.229-.377M35.82 28.776c-.418-1.65-.619-2.082-1.238-3.202c-.188-.375.366-6.932-1.726-9.988c-4.03.947-5.092 1.639-7.605 4.324c-.526-3.704-1.464-4.293-3.766-5.13c2.154-6.844-8.899-6.3-5.835-.079c-1.896 1.374-2.517 2.036-3.297 5.097m0 0c-3.478 1.617-5.727 4.832-6.817 8.333m-.558 2.378q-.12.755-.175 1.506c-.767 10.743 17.624 17.459 29.576 6.62c9.32-.668 5.998-9.956 1.442-9.86"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.652 21.561s.198-3.033.598-4.49c.261-.953.41-2.088 1.164-2.73c.272-.23.684-.29 1.04-.257c.409.038.79.27 1.12.515c.366.274.904 1.033.904 1.033m9.84 7.263c-5.371 2.142-5.353 9.119.678 10.117c9.328 1.543 5.529-12.593-.678-10.117m-13.941 1.127c-4.33 1.449-5.448 9.207.563 8.101c5.116-.94 3.863-9.581-.563-8.101m21.629-5.684l-2.032 2.236c1.257.512 1.612.774 2.468 1.852c-.068-2.233-.17-2.791-.436-4.088M11.28 34.993c-1.42 1.714 2.946 3.137 4.528.21c1.072 4.662 8.232 2.738 5.687.498"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.535 36.857c-1.674 5.855-.139 4.405 3.387 3.957c1.452.594 4.393 1.76 5.294 1.023c.755-.619.056-2.828-.497-3.94M10.7 27.083c-1.442.483-1.471 2.901.531 2.533c1.704-.313.943-3.026-.53-2.533m15.089-.294c-1.584.582-1.284 3.59.739 3.36c1.916-.219 1.703-4.257-.739-3.36m-9.983 8.415c-2.129-1.559-1.606-2.472.144-2.518c2.614-.07 2.085 1.664-.144 2.518m14.233-3.983c3.787-.093 3.651 3.7 4.686 3.047c1.523-.961 2.425-1.235 3.004-1.017c.896.337-.321 2.417-2.597 3.208c-1.083.376-2.367-1.979-4.524-2.53c-1.589-.405-8.664 3.589-8.904-2.498m8.861-1.948c2.357-.54 3.643-.718 3.495.368c-.188 1.378-2.502.69-3.668.517m-18.745 1.564s-.368.84-.711 1.118c-.645.524-1.501.89-2.332.88c-.568-.008-1.11-.322-1.579-.644c-.377-.26-.679-.625-.939-1.001c-.364-.527-.302-1.388-.846-1.727c-.273-.17-.963 0-.963 0s-.108-1 .104-1.426c.23-.462.662-.89 1.16-1.02c.43-.113 1.304.277 1.304.277"></svg:path>`,
})
export class ArcticonsTitanWarIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTixIdIcon],svg[arcticons-tix-id-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.5 19v-7a2 2 0 0 0-2-2h-33a2 2 0 0 0-2 2v7a5 5 0 0 1 0 10v7a2 2 0 0 0 2 2h33a2 2 0 0 0 2-2v-7a5 5 0 0 1 0-10m-18.453.5v9m3.269-9l5.962 9m0-9l-5.962 9m-12.594-9h5.962m-2.981 9v-9"></svg:path>`,
})
export class ArcticonsTixIdIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTkHusteblumeIcon],svg[arcticons-tk-husteblume-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.643 24.717c-1.542 9.245 1.37 12.69 6.147 17.783m-7.847-19.465h-5.974m-.019.052l-5.113 2.852m5.043-2.989l-5.026-3.002m11.751 1.539l-4.225-4.224m-.05.023l-5.633-1.598m5.681 1.452l-1.432-5.676m7.221 9.397v-5.974m-.053-.02l-2.852-5.112m2.99 5.044l3-5.027m-.912 13.313h5.974m.02-.053l5.112-2.852m-5.043 2.99l5.026 3m-11.751-1.538l4.225 4.224m.051-.023l5.632 1.598m-5.681-1.452l1.432 5.677m.358-19.248l4.224-4.225m-.023-.051L33.494 5.5m-1.452 5.68l5.676-1.431"></svg:path><svg:circle cx="40.34" cy="12.272" r=".75" fill="currentColor"></svg:circle><svg:circle cx="34.949" cy="8.135" r=".75" fill="currentColor"></svg:circle><svg:circle cx="26.938" cy="11.568" r=".75" fill="currentColor"></svg:circle><svg:circle cx="20.167" cy="10.595" r=".75" fill="currentColor"></svg:circle><svg:circle cx="11.334" cy="14.24" r=".75" fill="currentColor"></svg:circle><svg:circle cx="7.677" cy="23.052" r=".75" fill="currentColor"></svg:circle><svg:circle cx="20.14" cy="23.052" r=".75" fill="currentColor"></svg:circle><svg:circle cx="28.95" cy="31.879" r=".75" fill="currentColor"></svg:circle><svg:circle cx="32.606" cy="23.085" r=".75" fill="currentColor"></svg:circle>`,
})
export class ArcticonsTkHusteblumeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTkcompanionappIcon],svg[arcticons-tkcompanionapp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTldrIcon],svg[arcticons-tldr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 42.5h-29c-2.2 0-4-1.8-4-4v-29c0-2.2 1.8-4 4-4h29c2.2 0 4 1.8 4 4v29c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.204 30.247c.98 1.277 2.211 1.753 3.923 1.753h2.369a3.996 3.996 0 0 0 3.991-4h0c0-2.21-1.787-4-3.991-4h-2.618a3.996 3.996 0 0 1-3.991-4h0c0-2.21 1.787-4 3.991-4h2.37c1.71 0 2.941.476 3.922 1.753M17.187 34V14m8.326 20h10.6"></svg:path>`,
})
export class ArcticonsTldrIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTmobileInternetIcon],svg[arcticons-tmobile-internet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTmshappinestIcon],svg[arcticons-tmshappinest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 42.5h-29c-2.2 0-4-1.8-4-4v-29c0-2.2 1.8-4 4-4h29c2.2 0 4 1.8 4 4v29c0 2.2-1.8 4-4 4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.303 28.686v-9.383L24 28.697l4.697-9.379v9.379M10.5 19.303h6.223m-3.112 9.394v-9.394m17.852 8.364c.576.75 1.298 1.03 2.303 1.03h1.39a2.346 2.346 0 0 0 2.344-2.349h0A2.346 2.346 0 0 0 35.157 24H33.62a2.346 2.346 0 0 1-2.343-2.348h0a2.346 2.346 0 0 1 2.343-2.349h1.39c1.006 0 1.728.28 2.304 1.03"></svg:path>`,
})
export class ArcticonsTmshappinestIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTngEwalletIcon],svg[arcticons-tng-ewallet-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.792 35.074c-8.995 0-16.287-7.292-16.287-16.287c0-7.893 5.616-14.472 13.069-15.966A21.5 21.5 0 0 0 24 2.501C12.126 2.5 2.5 12.125 2.5 24S12.126 45.5 24 45.5c11.215 0 20.414-8.59 21.401-19.548c-2.652 5.398-8.189 9.122-14.61 9.122"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M45.288 26.95c-2.006 8.902-9.96 15.55-19.467 15.55c-11.021 0-19.955-8.934-19.955-19.955S14.8 2.59 25.82 2.59"></svg:path>`,
})
export class ArcticonsTngEwalletIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToastTakeoutIcon],svg[arcticons-toast-takeout-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsToastTakeoutIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTobojapaneseIcon],svg[arcticons-tobojapanese-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path><svg:circle cx="23.998" cy="35.502" r="1.316" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.258 26.991a9.25 9.25 0 1 1-.15-17.164m7.784-.032a9.25 9.25 0 1 1-.165 17.159m-7.886-8.403l4.239.032m-6.184 2.486l4.239.032m-3.92-4.781l4.239.032m-.526-1.801l4.239.032m-2.422 2.454c1.303-1.435 2.543-1.199 3.761-.35l-1.594 2.358s-1.57 2.148-3.474.797"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.912 19.045c2.471 1.297 2.663 2.567 3.06 3.379m1.689-6.63c-.761 1.045-1.8 1.377-3.155.892"></svg:path><svg:circle cx="28.335" cy="14.726" r=".75" fill="currentColor"></svg:circle><svg:circle cx="23.968" cy="18.407" r="9.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:rect width="8" height="8" x="20.039" y="31.543" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="2" ry="2"></svg:rect>`,
})
export class ArcticonsTobojapaneseIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTocaWorldIcon],svg[arcticons-toca-world-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.5 5.498h29c2.216 0 4 1.784 4 4v29c0 2.216-1.784 4-4 4h-29c-2.216 0-4-1.784-4-4v-29c0-2.216 1.784-4 4-4"></svg:path><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M16.683 32.574c2.379.878 4.866.695 6.768.056m2.151-.553c2.714-.858 4.43-3.286 4.509-5.119c.098-2.27-1.746-3.13-2.29-5.313"></svg:path><svg:path d="M21.945 28.524c1.234-.693 2.516-1.242 3.702-1.691c.27 2.022.34 3.363.127 4.696c-.193 1.206-1.517 1.653-2.069 1.293c-1.262-.825-1.345-2.454-1.76-4.298"></svg:path><svg:path d="M22.314 30.066c1.357-.999 3.043-.477 3.306 1.707m-1.014-9.586l1.292-1.343M19.29 23.74l-2.407-.482m2.899 2.96c.144.763-.223 1.472-.82 1.585c-.598.114-1.2-.413-1.344-1.175v0c-.144-.762.223-1.472.82-1.585h0c.598-.113 1.2.413 1.344 1.175m7.608-2.116c.186.753-.14 1.482-.73 1.629s-1.22-.345-1.408-1.098v0c-.187-.753.14-1.482.73-1.629s1.22.345 1.407 1.098m-4.157 1.604l.277.5m-2.235-6.836l2.772 1.745m-2.133.371l1.377-2.22"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M13.266 30.482c.947-.478.836-1.928.035-2.769c.445-.545-.038-1.449-.845-1.993c.304-.694-.454-1.348-1.114-1.411c-.133-.69-.83-1.463-1.746-.859c-.578-.231-1.596.212-1.485 1.216c-.517.33-.953 2.657.134 3.34c-.101.65.201 1.336.943 1.376c-.096.748.87 2.323 1.844 1.755c.61.572 1.992.416 2.234-.655m17.052-6.652c.713.277 1.605-.883.896-2.483c.447-.261.43-1.278.092-1.521c.36-1.757-.92-3.061-1.802-2.91"></svg:path><svg:path d="M9.507 23.403c-.358-4.551 2.55-10.037 8.138-11.61c5.995-1.686 10.994.973 12.203 4.722"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M20.996 16.721c-.838 3.999-2.68 5.977-5.775 7.475c-.12 2.883 1.486 5.457 1.675 7.143c.284 2.54-2.602 2.017-3.835-.403"></svg:path><svg:path d="M20.874 17.24c1.752 1.795 4.991 3.927 7.384 4.529m1.278 6.883c.916.792 2.76.415 2.447-1.082c-.262-1.246-1.186-2.407-1.691-3.726c-.745-1.948-.77-3.143-.618-4.549c.171-1.591-.138-2.672-.765-3.642M7.578 26.203c-2.182-4.853-2.191-7.906-1.415-9.839"></svg:path><svg:path d="M8.722 18.551c-1.705-1.123-2.78-2.103-3.222-3.422m6.4-2.165c-1.122-1.595-4.08-4.156-6.4-1.982"></svg:path><svg:path d="M11.6 12.549c1.824-1.292 6.433-.423 8.56 1.183"></svg:path><svg:path d="M14.81 11.818c4.09-2.67 9.494-1.707 11.908.843"></svg:path><svg:path d="M20.5 10.229c-.043-1.904 1.078-4.65 3.523-4.263c2.508.395 2.795 3.404 1.622 5.793M9.746 30.88c-2.034 2.68-1.093 4.9 1.38 3.771c.222 2.922 3.093 2.358 4.617.467"></svg:path><svg:path d="M15.617 34.421c.061 1.156.717 1.907 1.904 2.195m11.663-6.978c-.03 1.947-.842 3.422-2.62 4.322"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M31.467 20.063c2.726-.021 6.875.287 10.477.965m-.23 3.44c-2.765.122-6.978-.036-10.621-.594"></svg:path><svg:path d="M32.988 24.122a85 85 0 0 0-.07 4.704"></svg:path><svg:path d="M37.942 15.658c1.064.258 2.049.708 2.76 1.51c1.251 1.408 1.322 3.526 1.21 5.406c-.11 1.88-.431 3.976-1.84 5.227h0c-1.408 1.25-3.526 1.322-5.407 1.21c-.946-.056-1.947-.165-2.867-.439m-2.094-11.666q.169-.195.365-.369c.802-.712 1.834-1.042 2.921-1.173m.82.61a65 65 0 0 0-.538 4.118"></svg:path><svg:path d="M37.31 20.372q.099-2.207.081-4.427m-.984 12.943q.382-2.215.607-4.448m-.274-7.924c-.373.356-.762.471-1.277.459c-.516-.012-.898-.145-1.254-.518s-.471-.762-.459-1.277c.012-.516.145-.899.518-1.254s.762-.471 1.278-.459c.515.012.898.145 1.254.518c.355.373.47.762.458 1.277c-.012.516-.145.899-.518 1.254"></svg:path><svg:path d="M33.87 16.018c-5.616-4.079-5.106-5.414-3.802-6.07l3.285-1.652"></svg:path><svg:path d="M34.908 13.54c-1.244-2.883-2.383-5.111-1.397-5.304c.892-.174 1.61 2.706 2.152 5.24m1.397 2.637c6.1-3.054 5.815-4.444 4.645-5.301L38.74 8.637"></svg:path><svg:path d="M36.337 13.552c1.705-2.637 3.197-4.646 2.256-5c-.85-.32-2.036 2.402-2.99 4.81"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M26.522 33.951c1.034-.113 1.725-.535 3.103.295c.56-1.067 2.086-1.053 3.02-.67"></svg:path><svg:path d="M29.088 38.8c.618-.13 1.171-.37 1.867-.9c1.357.275 3.274-.036 3.717-1.113c2.847-.18 2.566-3.14 1.15-4.805l.098-.01l-.111-.924c-.38-.146-.81-.22-1.262-.209a3.9 3.9 0 0 0-2.02.643l.227.744c-.428.25-.726.625-.765 1.164m.884-2.146c-.231-.834-.145-1.628.63-2.339"></svg:path><svg:path d="m35.223 30.888l.33-.459c1.488-.082 1.971-.704 2.093-1.53M19.532 42.502c.094-.255.16-.562.2-.931c.97-.707 1.668-2.41.68-3.958c-1.616-2.535-4.251-.8-5.185 1.869c-.885.75-1.499 1.823-1.62 3.015"></svg:path><svg:path d="M16.359 40.173c.51.315 1.068.66 1.757.894m1.52-4.944c-.657-1.376.073-1.953 1.423-1.93c.96.016 1.739.101 2.355.706c.37-1.286 1.477-1.898 2.631-1.574c.47.131.669.868.499 1.272c1.532 1.015 2.11 2.616 2.07 3.55c1.046 1.29 1.29 2.39 1.474 3.475c.204.322.342.613.438.88m-7.211-7.781l1.601 7.777"></svg:path><svg:path d="M19.643 36.004c1.804.22 5.633-.491 6.971-1.45m-4.552 5.68c2.379-.295 3.85-.706 5.088-1.393"></svg:path></svg:g>`,
})
export class ArcticonsTocaWorldIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTohobankIcon],svg[arcticons-tohobank-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToiIcon],svg[arcticons-toi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTokopediaIcon],svg[arcticons-tokopedia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTokuplayIcon],svg[arcticons-tokuplay-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 5.5C13.783 5.5 5.5 13.783 5.5 24a18.5 18.5 0 0 0 7.014 14.451L5.5 42.501H24c10.217 0 18.5-8.284 18.5-18.5a18.5 18.5 0 0 0-6.98-14.47L42.5 5.5z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m34.157 24l-15.236 8.797V15.204z"></svg:path>`,
})
export class ArcticonsTokuplayIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTokyoAmeshLogIcon],svg[arcticons-tokyo-amesh-log-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.427 20.871a14.8 14.8 0 0 1 4.073-.572c0-8.173-6.626-14.798-14.799-14.799h0a14.8 14.8 0 0 0-12.155 6.355m11.327 18.362A14.8 14.8 0 0 1 27.7 35.1c0-2.1.447-4.177 1.311-6.09"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.726 24.571a14.8 14.8 0 0 1 4.073-.572C38.8 15.826 32.173 9.201 24 9.2h0a14.8 14.8 0 0 0-12.154 6.353m11.299 18.285A14.8 14.8 0 0 1 24 38.799c0-3.02.924-5.969 2.648-8.45"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.3 12.9c-8.173 0-14.8 6.625-14.8 14.799c8.174 0 14.8 6.625 14.8 14.799v.002c0-8.174 6.626-14.8 14.8-14.801c0-8.173-6.626-14.798-14.8-14.799"></svg:path>`,
})
export class ArcticonsTokyoAmeshLogIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTokyootakumodeIcon],svg[arcticons-tokyootakumode-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTolinoIcon],svg[arcticons-tolino-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTomatoIcon],svg[arcticons-tomato-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTombOfTheMaskIcon],svg[arcticons-tomb-of-the-mask-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.254 5.5H18.171v19.278h3.812v3.381h14.459v-3.381h3.812zM25.4 22.98h7.625m-20.256-6.151h5.402m-5.402-6.258h5.402m17.803 6.438v-3.524M25.4 17.009v-3.524m-7.229 17.841h18.27V42.5h-18.27zm9.135 4.624v6.55M12.434 24.778v-3.02m0 20.742v-5.812m5.737-11.91H7.746v11.91h4.688v-5.362h5.737z"></svg:path>`,
})
export class ArcticonsTombOfTheMaskIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTomorrowIcon],svg[arcticons-tomorrow-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.892 4.5v33c0 2.115-2.067 6-2.067 6h12.299s-2.066-3.885-2.066-6v-33Zm8.222 0c5.68.932 13.178 9.739 13.178 9.739L39.347 4.5Zm-8.227 0c-5.681.932-13.179 9.739-13.179 9.739L8.653 4.5Z"></svg:path>`,
})
export class ArcticonsTomorrowIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToneprintIcon],svg[arcticons-toneprint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 2.5c11.867 0 21.5 9.633 21.5 21.5c0 11.877-9.633 21.5-21.5 21.5c-11.877 0-21.5-9.623-21.5-21.5C2.5 12.133 12.123 2.5 24 2.5"></svg:path><svg:circle cx="24" cy="24" r="16.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 7.5v11.964m-8.99 18.374V10.171m17.984 27.658V10.18"></svg:path>`,
})
export class ArcticonsToneprintIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTonhubIcon],svg[arcticons-tonhub-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.1 21.4a2.95 2.95 0 0 1-2.823 2.229h-6.554a2.95 2.95 0 0 1-2.824-2.228"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.866 9.467c1.347 0 2.625.472 3.51 1.404l5.427 5.153c1.018 1.019.84 2.765 0 3.605L26.509 37.28c-.658.848-2.073 1.253-2.509 1.253s-1.851-.405-2.509-1.253L5.197 19.63c-.84-.84-1.018-2.586 0-3.605l5.426-5.153c.886-.933 2.164-1.404 3.511-1.404z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.5 17.709h10.783c1.01 0 1.472.418 1.77 1.316l6.946 19.508l6.947-19.508c.298-.899.76-1.316 1.77-1.316H43.5"></svg:path>`,
})
export class ArcticonsTonhubIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToogoodtogoIcon],svg[arcticons-toogoodtogo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 9c2.63 0 5.15 1.8 7 5a24.65 24.65 0 0 1 2.9 12.09c0 9.43-4.43 17.08-9.9 17.08s-9.9-7.65-9.9-17.08S18.52 9 24 9"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.4 42c-3.51-.86-7.21-3.76-9.91-6.87C4.32 28 2.64 19.34 6.75 15.77a6.7 6.7 0 0 1 4.42-1.52h0a13.7 13.7 0 0 1 5.1 1.12m15.46-.01a13.7 13.7 0 0 1 5.1-1.12h0a6.7 6.7 0 0 1 4.42 1.52c4.11 3.57 2.43 12.22-3.74 19.34c-2.7 3.11-6.4 6-9.91 6.87"></svg:path>`,
})
export class ArcticonsToogoodtogoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToolwizIcon],svg[arcticons-toolwiz-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsToonBlastIcon],svg[arcticons-toon-blast-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.005 41.408a7.45 7.45 0 0 0-2.953-1.878c.477-.084 2.048-.028 2.104-.814s-2.3-.786-2.3-.786s4.994-5.387 4.994-8.614c1.347.084 2.049-.955.842-2.61c1.066.196 1.179-1.993-.28-2.61c-.758-3.452-5.304-5.08-5.304-5.08s-1.207-7.1-7.016-9.26s-13.638 1.824-14.564 2.947c.056-2.301-3.732-4.658-5.865-1.516s-.757 5.81 2.133 5.95a9.45 9.45 0 0 0-2.245 3.928s-3.929 3.059-4.069 5.472c-.04.686.396.982 1.04 1.054c-1.012.63-1.713 2.538.476 3.689a6.5 6.5 0 0 0 1.571 2.245s-2.712-.016-2.61.87c.084.73 1.32.56 1.32.56A9.2 9.2 0 0 0 4.5 36.977"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.151 19.452c.526-4-2.441-7.346-4.188-7.998a2.62 2.62 0 0 0-3.347 1.179c-1.389-1.2-3.914-1.874-5.282-.064s-2.968 4.799-.442 9.408"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.795 19.452c2.625-.287 10.123.126 10.713 4.314s-5.368 7.877-8.711 8.027c-5.156.232-11.641-3.207-11.641-5.606s4.63-6.188 9.64-6.735"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.895 28.657c.253 1.15 1.98 6.159 4.645 6.481s4.98-3.334 4.98-3.334"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.68 32.826a2.9 2.9 0 0 1 3.169.067c.645-.411 2.16.237 2.42 1.346m6.615-22.837c.299-.706.886-4.238-2.785-4.768c-2.988-.431-2.622 2.544-2.622 2.544m-3.769 14.329c0 1.026 3.55 4.77 6.132 4.77s5.135-1.894 5.135-5.977c0-2.413-4.532-3.171-6.286-2.54s-4.981 1.53-4.981 3.747"></svg:path><svg:circle cx="23.273" cy="18.049" r="1.08" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.679" cy="17.88" r=".94" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.12 11.117a2.587 2.587 0 0 1 3.073-1.543m4.125-1.207a7.5 7.5 0 0 1 3.297 2.035"></svg:path>`,
})
export class ArcticonsToonBlastIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTopElevenIcon],svg[arcticons-top-eleven-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTopsIcon],svg[arcticons-tops-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.736 20.575c-.667-.476-3.054-.93-4.464-.224c-.94.47-1.495 1.847-.01 2.49c1.243.54 2.358.251 3.809.793c1.517.566.93 2.02-.01 2.49c-1.41.707-4.146.253-4.812-.223m-8.943-2.61a3.273 3.273 0 0 0 3.275 3.271h.002c1.809 0 3.276-1.464 3.276-3.27s-1.467-3.27-3.276-3.27a3.273 3.273 0 0 0-3.277 3.27q0 0 0 0v6.535m-2.867-6.535a3.273 3.273 0 0 1-3.276 3.27h0a3.273 3.273 0 0 1-3.276-3.27h0a3.273 3.273 0 0 1 3.276-3.27h0a3.273 3.273 0 0 1 3.276 3.27M12.2 18.173h4.202m-8.403 0h4.2v8.39"></svg:path><svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect>`,
})
export class ArcticonsTopsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTorguardIcon],svg[arcticons-torguard-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M31.774 30.295c-5.313 2.11-10.27 6.225-12.037 12.205m14.813-8.932c-3.42 1.541-7.668 4.888-8.253 8.932m9.338 0H13.187m16.878-15.813c-8.823 1.31-14.612 8.464-16.878 15.813m11.997-21.786c-3.414 0-6.481 2.112-7.402 7.249V16.057a6.21 6.21 0 0 1 12.42 0v4.656z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M35.635 42.5a6.765 6.765 0 0 0 1.92-13.252a4.048 4.048 0 0 0-3.004-5.685v.001v-7.506a10.559 10.559 0 0 0-21.117 0v11.265h-.246a7.589 7.589 0 0 0 0 15.177"></svg:path>`,
})
export class ArcticonsTorguardIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTornIcon],svg[arcticons-torn-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.312 28v-8h2.619c1.48 0 2.681 1.203 2.681 2.687s-1.2 2.686-2.681 2.686h-2.619m2.62.001l2.62 2.624M9.464 20h5.3m-2.65 8v-8m21.122 8v-8l5.3 8v-8m-18.502 8a2.65 2.65 0 0 1-2.65-2.65v-2.7a2.65 2.65 0 1 1 5.3 0v2.7a2.65 2.65 0 0 1-2.65 2.65"></svg:path><svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect>`,
})
export class ArcticonsTornIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTorqueIcon],svg[arcticons-torque-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTorrdroidIcon],svg[arcticons-torrdroid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTorrentsearchsettingsIcon],svg[arcticons-torrentsearchsettings-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m24 2.5l3.05 2.24l3.594-1.188l2.209 3.073l3.784-.019l1.152 3.605l3.605 1.152l-.019 3.784l3.073 2.209l-1.188 3.594L45.5 24l-2.24 3.05l1.188 3.594l-3.073 2.209l.019 3.784l-3.605 1.152l-1.152 3.605l-3.784-.019l-2.209 3.073l-3.594-1.188L24 45.5l-3.05-2.24l-3.594 1.188l-2.209-3.073l-3.784.019l-1.152-3.605l-3.605-1.152l.019-3.784l-3.073-2.209L4.74 27.05L2.5 24l2.24-3.05l-1.188-3.594l3.073-2.209l-.019-3.784l3.605-1.152l1.152-3.605l3.784.019l2.209-3.073L20.95 4.74z"></svg:path><svg:circle cx="24" cy="24" r="12.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.249 22.757L24 29.508l6.751-6.751M24 29.508V11.5"></svg:path>`,
})
export class ArcticonsTorrentsearchsettingsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTorrserveMatrixIcon],svg[arcticons-torrserve-matrix-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.814 13.158h7.739m-3.869 11.484V13.158"></svg:path><svg:circle cx="24" cy="24" r="17.921" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.785 26.918a2.84 2.84 0 0 1 2.635-1.754h1.67c1.213 0 2.085.332 2.78 1.223m-7.063 8.716c.695.891 1.567 1.223 2.78 1.223h1.68c1.562 0 2.828-1.247 2.828-2.784v-.013c0-1.537-1.266-2.784-2.829-2.784h-1.852a2.84 2.84 0 0 1-2.377-1.272"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m34.001 4.983l-8.344 13.586l6.142-1.522l-7.924 10.108l4.931-.566L13.41 42.715l7.839-12.276l-5.046.726l6.48-9.625l-4.793.856z"></svg:path>`,
})
export class ArcticonsTorrserveMatrixIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTortoiseIcon],svg[arcticons-tortoise-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTotalcmdFtpIcon],svg[arcticons-totalcmd-ftp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M7.492 33.072V21.807h13.28v11.265m-2.514 3.671h.654c.39 0 .7.314.7.7v.657a.7.7 0 0 1-.7.7h-.654a.7.7 0 0 1-.703-.696v-.662c0-.385.314-.7.703-.7"></svg:path><svg:path d="M6.899 33.284h14.478c.772 0 1.398.626 1.398 1.399v6.176a1.4 1.4 0 0 1-1.398 1.4H6.899a1.4 1.4 0 0 1-1.399-1.4v-6.176c0-.773.626-1.399 1.399-1.399m27.191-3.353l1.802 1.803h5.153c.768.006 1.387.63 1.387 1.399v7.624c0 .773-.626 1.399-1.399 1.399h-11.14a1.4 1.4 0 0 1-1.399-1.399v-9.023l1.804-1.803zm-5.592 9.59h-5.73m0-2.419h5.73m2.2-12.127v2.076l-4.128-4.159l4.128-4.158v2.075h7.674V18.73l4.128 4.16l-4.128 4.158v-2.072z"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.94 16.444V5.742h3.565c2.015 0 3.648 1.607 3.648 3.591s-1.633 3.599-3.647 3.599H30.94m-10.028-7.19h7.213m-3.607 10.702V5.742M12.652 11.09h3.539m-3.539 5.354V5.742h5.444"></svg:path>`,
})
export class ArcticonsTotalcmdFtpIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTotalcmdLanWindowsSharesIcon],svg[arcticons-totalcmd-lan-windows-shares-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.5 6.722h37v16.904h-37zm24.758 32.246v1.378a.933.933 0 0 1-.932.932H18.674a.933.933 0 0 1-.932-.932v-6.812c0-.515.417-.932.932-.932h10.652c.515 0 .932.417.932.932v1.379m-8.285-11.287h4.055v8.976h-4.055zM17.74 34.913v4.055H7.527A2.03 2.03 0 0 1 5.5 36.941h0c0-1.12.908-2.028 2.027-2.028z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.473 38.968H29.518a2.03 2.03 0 0 1-2.027-2.028h0c0-1.12.907-2.027 2.027-2.027h10.954"></svg:path><svg:circle cx="40.472" cy="36.94" r="2.027" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="8.797" cy="20.284" r="1.29" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle>`,
})
export class ArcticonsTotalcmdLanWindowsSharesIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTotalcmdSftpIcon],svg[arcticons-totalcmd-sftp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTotalcommanderIcon],svg[arcticons-totalcommander-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTotemoIcon],svg[arcticons-totemo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.379 42.071s-2.856-.454-6.917-1.596c0 0-1.736-17.27-3.859-30.004c3.744-3.314 8.744-4.35 8.744-4.35"></svg:path><svg:circle cx="16.413" cy="31.36" r="4.939" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m13.003 7.644l1.963 13.442m6.352.894c.561-2.568 2.57-5.068 2.57-5.068m4.733 25.159s2.856-.454 6.917-1.596c0 0 1.736-17.27 3.859-30.004c-3.744-3.314-8.744-4.35-8.744-4.35"></svg:path><svg:circle cx="31.587" cy="31.36" r="4.939" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.986 21.22s-1.436-5.58-2.338-8c0 0 3.487-6.077 4.388-7.814c0 0-2.771-.858-5.183-.906c0 0-1.081 2.093-1.853 4.264c-.772-2.17-1.853-4.264-1.853-4.264c-2.412.048-5.183.906-5.183.906c.9 1.737 4.388 7.815 4.388 7.815c-.901 2.419-2.338 7.999-2.338 7.999M24 34.258c2.433 2.322 4.621 7.813 4.621 7.813c-1.518 1.25-3.08 1.429-4.621 1.429c-1.54 0-3.103-.179-4.621-1.429c0 0 2.188-5.491 4.621-7.813"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.532 23.3c-2.928-2.972-8.51-3.486-13.532.6c-5.022-4.086-10.604-3.572-13.532-.6M34.997 7.644l-1.963 13.442"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.682 21.98c-.561-2.568-2.57-5.068-2.57-5.068M12.17 37.692c2.4 1.088 8.688 1.187 8.688 1.187m14.969-1.187c-2.4 1.088-8.688 1.187-8.688 1.187"></svg:path>`,
})
export class ArcticonsTotemoIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTouchProtectorIcon],svg[arcticons-touch-protector-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTouchTheNotchIcon],svg[arcticons-touch-the-notch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTouhouDanmakuKaguraIcon],svg[arcticons-touhou-danmaku-kagura-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M16.968 36.747a11.2 11.2 0 0 0 2.153 2.033a20.3 20.3 0 0 0 6.113-.557c.63-.405 6.115-5.455 6.115-5.455M13.63 43.57c2.621-1.374 4.12-2.367 3.333-6.851s-5.047-3.391-2.805-11.368"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.638 31.867c-.841-.326-3.397-.775-3.48-6.517m3.834-1.239c.563-2.177 3.346-5.8 9.754-6.05m-4.837 14.481a3.67 3.67 0 0 0 .286-2.277c-.324-.99-1.541-3.539.774-6.062a14.8 14.8 0 0 1 4.297-3.41m-3.212 9.478a13.5 13.5 0 0 0 4.148-3.216m.221 3.024c1.415-1.246 2.757-2.137 3.338-4.585m-1.463 5.832a7.5 7.5 0 0 0 2.858-3.66M13.63 43.57s3.463-3.697-.25-6.626a8.45 8.45 0 0 1-2.838-9.614M28.84 39.544s5.362-2.117 6.584-5m-6.902 3.119a38.7 38.7 0 0 0 4.88-4.18M25.9 37.682s.376 1.674 2.94 1.862"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M27.962 39.406s.507 2.792 5.256 2.524"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M31.002 41.803c1.375 2.861 1.966 2.126 5.042 1.92m-2.826-1.793s.072-3.398-2.474-3.282"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.087 40.77a2.414 2.414 0 0 1 2.957 2.953"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.027 42.532s1.09-.325 2.438 1.928c.002 0-.37.535-2.852.987a2.39 2.39 0 0 1-2.26-1.147M8.713 33.104s.11-3.834 1.829-5.774m-3.416 3.808c-.608-1.037-1.202-4.2.223-6.22M20.485 29.5a3.33 3.33 0 0 0-3.722-3.103c-.89.053-.944-.17-1.037-.978m22.206 6.479a11.3 11.3 0 0 0 .772 4.672m0 0s-3.662-1.658-3.886-4.573m3.114-.099a1.565 1.565 0 0 1-.793-1.552c.15-1.057-.723-1.899-.233-2.591s.489-.687.489-.687"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.494 27.705a23 23 0 0 1-3.717-2.408c-.496-.714-1.47-3.713-2.488-4.757c-.437-.783 1.885-.627 2.405.11s.741 2.177 1.294 2.29a25 25 0 0 0 3.507-.313"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m33.566 20.08l-1.314-1.98l-.05-2.76l2.421-2.61l5.336.007l2.222 2.75l-.144 5.296"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.495 22.627a26 26 0 0 0 2.485-1.607m1.219-12.217a34 34 0 0 0-3.58-.032c-7.583.397-21.702 10.965-21.702 10.965S9.397 25.992 2.5 25.434m0-6.403a21.9 21.9 0 0 0 6.567-.524C20.71 16.01 30.029 8.096 38.295 8.81"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.454 18.63s3.41-2.9 3.384-4.163c-.017-1.536-1.392-.364-2.52.964c-1.051-.323-.52-1.758-2.408-.865a1.3 1.3 0 0 1-1.387-.115a10.8 10.8 0 0 1-1.828-3.476A9.3 9.3 0 0 0 6.688 12.7c2.76.242 6.595-3.987 7.28-5.73c1.414-3.6 7.537-4.919 9.223-4.298a6.5 6.5 0 0 1 2.105 2.55"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M22.323 13.663s-1.806-3.178-.797-5.753m8.423 2.422s-4.756-1.034-6.741-.767c0 0-1.89.465-.878-2.418s6.162-2.678 7.619 3.185"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.137 8.808s.374-3.473-1.242-4.299s-4.1 1.372-5.32 4.63"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.847 4.738c-.459-.347-2.503-2.252-4.053 2.88m14.771 7.978c.632 4.922-1.257 7.726-1.493 8.808l.924.762l1.51-.175s1.807 1.533.549 2.832c0 0 1.157 2.818-1.639 3.12c0 0-.382 3.115-3.334 1.44a2.48 2.48 0 0 1-2.15-.485"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.838 32.432s.182 1.992 1.404 2.62m-1.107-1.409l-2.025.837M32.252 18.1c-.668-.64-4.229-5.56-9.036-2.01"></svg:path>`,
})
export class ArcticonsTouhouDanmakuKaguraIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTowerFortressIcon],svg[arcticons-tower-fortress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.815 22.533V4.866h-3.591v17.667c0 .706 3.59.706 3.59 0"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.653 23.584c0-7.85 5.893-14.325 13.466-15.28m3.705 0c7.602.913 13.465 7.39 13.465 15.279v6.761c0 2.158-.556 3.992-.556 3.992l-6.552 6.6l-3.046 1.756c-1.031.598-.885.415-3.935.415V39.62h3.744l6.341-6.341v-9.206c0-1.72-.885-.565-3.4.248s-5.271 1.05-7.936 1.05"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.274 15.753a7.306 7.306 0 0 1 7.125 6.102a7.306 7.306 0 0 1-4.747 8.089m-30.999-6.36v6.761c0 2.158.557 3.992.557 3.992l6.551 6.599l3.047 1.757c1.031.598.885.415 3.934.415v-3.486H19l-6.341-6.341v-9.206c0-1.72.885-.566 3.4.248s5.27 1.05 7.935 1.05"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.726 15.753A7.306 7.306 0 0 0 3.6 21.855a7.306 7.306 0 0 0 4.747 8.089m14.412 11.498h2.52M35.364 24.92L22.76 40.583m.38-15.185l-2.616 2.454v7.936l-1.767 3.6m16.607-10.074l1.987-1.614v-4.937c0-2.655-1.557-2.283-3.42-1.5s-3.284 1.337-3.37 1.299s-1.117-2.091-1.251-2.14c-.13-.05-3.056.487-3.486.517m-13.188 8.375L10.649 27.7v-4.937c0-2.655 1.557-2.283 3.42-1.5s3.284 1.337 3.37 1.299s1.117-2.091 1.251-2.14c.13-.05 3.056.487 3.486.517"></svg:path>`,
})
export class ArcticonsTowerFortressIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTowerWarIcon],svg[arcticons-tower-war-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M9.5 42.5h29c2.216 0 4-1.784 4-4v-29c0-2.216-1.784-4-4-4h-29c-2.216 0-4 1.784-4 4v29c0 2.216 1.784 4 4 4"></svg:path><svg:path d="M5.892 32.963c1.445.361 2.26-.975 2.46-3.495c2.294-1.011 7.273-4.004 8.533-6.53h0c.485.252.948.619 1.36 1.253c.37-.585.433-1.108.096-2.2c-1.89-6.128-7.826-8.178-12.453-6.233"></svg:path><svg:path d="M7.276 32.821c2.47 1.562 5.995.204 8.15-1.362c3.401-2.473 3.48-5.863 2.838-7.28m-6.114 4.135l1.56-.299m-.647.23l.522.643m3.777-4.628l-.63 1.133m.314-.36l.505.372m-8.409 8.252c-1.14 1.996.539 5.802 2.435 6.078c.847.123 4.522-1.105 5.168-1.484c.432-.714-.144-3.651-1.144-3.82s-1.836.313-3.012.985"></svg:path><svg:path d="M15.557 34.348c.28-.578 1.062-1.236 1.342-.362c1.546.5 2.124 2.997.095 3.778m4.216-6.845c.506 1.17 1.616 1 2.05.44c.283-.365.746-1.327.106-2.27c-1.35-1.991-2.603.794-2.156 1.83"></svg:path><svg:path d="m12.654 35.19l7.975-8.767l1.574-.14l1.283 1.022l.003.734m-5.417 6.863l.825-.907l.838-.92c.847.402 1.932-.168 2.33-1.11m-3.683 4.058l.732 2.76l-1.02 1.063l-1.261.277l-1.37-1.084m7.055-5.244c.722 1.002.818 1.67.408 2.272c2.414 1.704 3.089 3.928 2.317 6.045M13.12 40.568c.12.288.323.49.636.548l.296.996m4.773.014c.28-.995.48-2.352 1.531-1.906c.654.277.838 1.102 1.044 1.89M15.672 5.889l15.722 36.223m4.195-36.226c2.222 1.467 3.851 4.007 4.293 7.379c.378 2.886-1.354 3.35-4.27 1.966c-2.001 1.47-7.03 4.263-9.82 4.097h0c-.024.54.061 1.119.403 1.786c-.686.029-1.166-.177-1.936-1.005c-4.556-4.9-3.01-11.416 1.464-14.224"></svg:path><svg:path d="M39.022 15.965c.12 2.891-2.787 5.246-5.197 6.32c-3.803 1.698-6.752.09-7.65-1.161m6.57-3.203l-1.027 1.19m.517-.441l.294.765m-5.839.955l1.284.019m-.464.091l.069.618m9.422 4.75c-.607-.494-1.405-.309-1.23.2c-1.064.296-1.121 1.04-.801 2.039c.49 1.527 1.523 1.621 3.056 1.295c-.627-1.09-.925-2.208-1.025-3.534"></svg:path><svg:path d="M42.113 23.987a8 8 0 0 0-.19-.464c-1.054-2.389-3.09-3.713-4.69-3.487m.779 9.362c.624.25 1.645-.074 2.534-.546c.743-.393 1.258-.886 1.57-1.46m-9.598 2.014c-.218-.754-.701-1.918-1.78-2.343c-1.114-.439-2.216-.115-2.59.918c-.546 1.51 3.406 3.066 4.37 1.425m.101.254l1.443 2.428l2.217.394l1.63-.92l-.66-1.654"></svg:path><svg:path d="m35.507 25.687l-7.405-1.842c-.201-.05-.45-.086-.622.029l-1.052.7c-.113.076-.206.233-.181.368l.53 2.936l1.202.307m3.807 3.294c.186.182.413.329.68.412c-.167 1.93-.779 5.35 1.1 7.917c.415.566 3.332-.004 3.747-.641c.64-.985-.608-2.16-.257-3.583c.24-.978.624-1.859 1.396-2.578c1.46.188 2.889 2.278 3.667 4.26"></svg:path><svg:path d="M37.662 39.086c1.147 1.609-5.5 4.944-4.126 1.056"></svg:path></svg:g>`,
})
export class ArcticonsTowerWarIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTowercollectorIcon],svg[arcticons-towercollector-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9 36.43a19.34 19.34 0 0 1 0-24.86m30 0a19.37 19.37 0 0 1 0 24.86m-24.74-4.32a12.57 12.57 0 0 1 0-16.14m19.56 0a12.57 12.57 0 0 1 0 16.14M24 17.84a6.16 6.16 0 0 1 2.3 11.87l-2.3 5l-2.3-5A6.16 6.16 0 0 1 24 17.84m0 3.69A2.47 2.47 0 1 0 26.47 24A2.44 2.44 0 0 0 24 21.53"></svg:path>`,
})
export class ArcticonsTowercollectorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTowerfcuIcon],svg[arcticons-towerfcu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.46 4.5h29.08M9.46 10.398h11.526m0 6.019V4.5m6.018 5.898v31.758M9.46 16.417v13c-.01 7.041 4.584 9.66 10.151 12.137l4.374 1.946l4.384-1.946c5.567-2.468 10.17-5.086 10.17-12.147v-12.9l-5.767-.02v22.84"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.46 16.417h11.526v25.739m-5.768-25.739v22.92m11.786-28.939H38.54"></svg:path>`,
})
export class ArcticonsTowerfcuIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTowerjumperIcon],svg[arcticons-towerjumper-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.16 22.38c2.38 1.5 3.81 3.43 3.81 5.55c0 4.73-7.15 8.56-16 8.56S8 32.66 8 27.93s7.15-8.56 16-8.56a29 29 0 0 1 4 .27"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40 27.93H8v7c0 4.73 7.15 8.56 16 8.56s16-3.83 16-8.56Zm-16 8.56V19.37"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m29.81 24.82l-17.1 9.17v6.91"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.71 21.88L35.3 33.99v6.91M24 35.72v7.78"></svg:path><svg:circle cx="32.04" cy="21.12" r="4.31" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.51 14.01L21.6 7.68m-4.63-1.91l4.74 6.12m4.54 5.81l-3.29-4.28m-.68-8.92l4.11 5.31m1.59 2.21l1.37 1.77"></svg:path>`,
})
export class ArcticonsTowerjumperIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTownshipIcon],svg[arcticons-township-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M18.125 39.277c-2.94-1.364-2.416-6.377-2.614-9.01c-1.284-2.941-2.794-6.492-.996-10.095c1.829-3.666 3.952-11.183-2.56-11.021c2.251-2.855 7.582.238 8.35 4.17"></svg:path><svg:path d="M14.39 9.586c1.775 6.245-.912 9.942-1.891 11.599c-4.252 7.193-3.386 9.404-3.42 11.192c-.04 2.114.322 2.947-2.47 5.399c.753 3.156 1.64 3.918 4.88 4.72c.75-1.192 1.5-2.436 2.266-3.084c1.384.047 3.45.253 4.37-.135"></svg:path><svg:path d="M17.576 38.946c2.97.158 5.847-.068 8.602-.955c2.642-.851 3.022 1.266 3.894 2.393c.635.822 1.476.824 1.864-.422c.256-.823.66-5.13-2.057-7.568"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M17.11 17.66a8 8 0 0 0-2.202 1.656M29.984 6.537c-2.088.206-3.802 1.323-4.782 3.352c.047 2.516 2.03 4.156 3.077 5.546c.652 1.526 2.36 2.88 4.71 3.813c1.758 1.15 3.11 2.906 5.275 1.364c1.3-1.343 2.398-2.786 1.671-4.795M29.559 8.7l2.486 3.093"></svg:path><svg:path d="M29.984 6.537c-.588.67-.547 1.658-.425 2.164c-1.565-.253-3.855.539-3.98 2.98c-1.645.389-3.387 1.316-4.1 3.354c-1.783-.277-3.397.859-4.317 2.973M34.73 6.487c-.993-1.19-3.238-1.445-4.746.05h0m10.66 4.853C41.89 7.591 37.8 4.954 34.73 6.487c-.859 1.53.1 2.983 1.588 4.116c1.238.942 2.475 1.933 4.326.787"></svg:path><svg:path d="M34.74 8.893c-1.08.88-1.982 1.842-2.695 2.9c-1.542.591-3.039 1.806-3.816 3.579c-1.107.764-2.481 2.154-3.383 3.62c-1.587 1.173-3.145 2.618-4.281 4.527c-1.207.795-3.034 2.548-3.817 4.094c-.553.54-1.132 1.021-1.582 1.778"></svg:path><svg:path d="M35.344 14.616c-1.57-.555-2.606-1.643-3.299-2.823m5.905-.126c-.654 1.143-1.388 2.045-2.606 2.949m4.591 1.202c-1.704.782-3.207.566-4.591-1.202c.7 1.737-1.292 3.44-2.837 4.437c.894 1.882-2.167 4.13-3.716 4.237c.86 1.608-1.947 4.458-3.58 4.547c.154 1.974-2.686 4.307-3.9 4.351c-.425 1.285-1.354 2.243-2.208 2.927c-1.242.174-2.102.665-2.926 1.775m24.467-25.5c1.648 1.886.183 3.406-.709 4.427h0"></svg:path><svg:path d="M25.202 9.89c-.999.349-3.178 1.15-3.703 3.16l-.151 1.847c.249 1.883 2.269 3.44 3.516 4.046c-.77 2.012 3.352 4.53 4.952 4.613c2.456 1.35 3.395 2.544 5.84 1.561"></svg:path><svg:path d="M35.655 25.117c1.308-1.168 2.099-2.188 2.609-4.504M21.499 13.05c-2.014.241-4.226 2.955-4.389 4.61c.283 1.966.968 4.122 3.41 5.641c.488 2.605 2.918 3.964 5.29 4.748c1.818 1.525 4.282 2.316 6.146 1.49m0 .001c1.411-.744 3.02-2.237 3.7-4.423"></svg:path><svg:path d="M31.956 29.54c-1.086 3.129-4.273 4.356-5.774 3.818c-1.537.667-2.986-.096-4.479-1.005c-2.452-.944-4.466-3.3-5.04-4.963c-1.6-.888-2.536-2.386-2.976-3.775"></svg:path><svg:path d="M26.182 33.358c-1.425 3.214-3.776 2.944-4.92 3.032c-1.083-.353-1.941-.713-2.202-1.378c-1.285.358-2.385-.404-3.418-1.138"></svg:path><svg:path d="M16.596 37.52c1.465.355 3.111-.095 4.667-1.13"></svg:path></svg:g>`,
})
export class ArcticonsTownshipIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTpbankEtokenIcon],svg[arcticons-tpbank-etoken-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTpbankMobileIcon],svg[arcticons-tpbank-mobile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m22.35 39.61l-3.836-27.054M5.58 10.563a2.333 2.333 0 0 1 1.65-2.857M25.65 39.61a2.333 2.333 0 0 1-3.3 0q0 0 0 0M40.77 7.706a2.333 2.333 0 0 1 1.65 2.857M25.65 39.61l16.77-29.046m-1.65-2.858H7.23m-1.65 2.857L22.35 39.61M7.23 7.706L32.859 18.44m9.561-7.877L20.802 28.689"></svg:path>`,
})
export class ArcticonsTpbankMobileIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTpmifiIcon],svg[arcticons-tpmifi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.96 12.618A20.05 20.05 0 0 1 24 4.5h0a20.05 20.05 0 0 1 16.04 8.102m-26.322 4.302A12.9 12.9 0 0 1 24 11.533a12.9 12.9 0 0 1 10.306 5.387m-15.241 4.03a6.185 6.185 0 0 1 9.87 0M12.958 43.476V21.521l10.99 13.348l10.99-13.315V43.5"></svg:path>`,
})
export class ArcticonsTpmifiIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTppyTlmMobileIcon],svg[arcticons-tppy-tlm-mobile-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M20.174 35.395c-.387.229-.515.615-.515 1.052c0 1.456 1.492 2.279 4.341 2.279s4.341-.823 4.341-2.279c0-.437-.128-.824-.515-1.052m-1.48 3.108l-4.867 2.283"></svg:path><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M16.43 39.263c-1.293.42-2.074 1.269-2.074 2.466c0 2.52 4.108 2.478 9.644 2.478s9.644.043 9.644-2.478c0-1.197-.781-2.045-2.073-2.466m-4.645-7.968l-6.822 6.239"></svg:path><svg:path d="M32.107 36.68c0-2.19-1.51-3.64-5.199-5.394c3.109-1.181 5.325-4.254 5.325-7.858c0-4.626-3.65-8.376-8.233-8.376s-8.233 3.75-8.233 8.376c0 3.604 2.216 6.677 5.325 7.858c-3.69 1.755-5.2 3.204-5.2 5.393c0 4.285 3.923 4.178 8.108 4.178s8.108.107 8.108-4.178Z"></svg:path><svg:path d="M17.821 18.073c2.264-1.288 4.53-.85 6.179.42c1.649-1.27 3.915-1.708 6.179-.42m-6.677 11.432h.997m-4.119-3.769c-.067.31-.398.637-.785.637s-.718-.326-.785-.637m10.38 0c-.067.31-.398.637-.785.637s-.718-.326-.785-.637"></svg:path></svg:g><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M11.37 38.151A19.5 19.5 0 0 1 4.5 23.293c0-10.77 8.73-19.5 19.5-19.5h0c10.77 0 19.5 8.73 19.5 19.5h0a19.5 19.5 0 0 1-6.882 14.868"></svg:path>`,
})
export class ArcticonsTppyTlmMobileIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrabeepocketIcon],svg[arcticons-trabeepocket-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrackIcon],svg[arcticons-track-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.222 16.556a47.8 47.8 0 0 0-16.444 0c-3.15.545-5.589 3.064-6.178 6.206a37.2 37.2 0 0 0 0 13.82c.59 3.142 3.027 5.66 6.178 6.206q8.222 1.425 16.444 0c3.15-.546 5.589-3.064 6.178-6.207a37.2 37.2 0 0 0 0-13.819c-.59-3.142-3.027-5.66-6.178-6.206"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.052 25.93s0-3.114-1.544-5.635q-10.203-2.813-20.408 0c-1.543 2.427-1.543 5.634-1.543 5.634c6.803-1.875 16.692-1.875 23.495 0"></svg:path><svg:circle cx="15.902" cy="28.839" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="21.503" cy="28.839" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.105" cy="28.839" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="32.707" cy="28.839" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="15.902" cy="33.656" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="21.503" cy="33.656" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.105" cy="33.656" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="32.707" cy="33.656" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="15.902" cy="38.473" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="21.503" cy="38.473" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.105" cy="38.473" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="32.707" cy="38.473" r="1.638" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.076 11.33c-.017-3.216-2.27-7.782-8.66-6.655c-.197 3.525 1.695 10.043 8.153 8.968"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.205 9.415c-4.017-1.617-7.76.494-7.64 4.228c4.782 1.262 6.533-.54 7.64-4.228"></svg:path>`,
})
export class ArcticonsTrackIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrackbookIcon],svg[arcticons-trackbook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrackercontrolIcon],svg[arcticons-trackercontrol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTractorIcon],svg[arcticons-tractor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="35.319" cy="29.628" r="8.134" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="10.589" cy="32.029" r="5.338" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m5.414 26.65l-.815-3.176c-.841-3.271 3.613-4.219 15.687-4.219l.635-5.966h-.578a.64.64 0 0 1-.64-.67l.067-1.504a.64.64 0 0 1 .627-.612l13.447-.264a1.45 1.45 0 0 1 1.475 1.327l.537 6.291s3.572.198 4.475 1.585c.395.607.684 1.57.684 1.57"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.313 32.029c-.183-.771-.32-1.575-.32-2.401c0-5.703 4.623-10.327 10.327-10.327c2.104 0 4.062.63 5.695 1.711c.95.63 1.79 1.412 2.485 2.313M5.414 26.65a7.465 7.465 0 0 1 12.64 5.379m0 0h7.259m-2.125-7.791h-.272a.657.657 0 0 1-.653-.722l1.011-10.198a.657.657 0 0 1 .654-.592h7.745c.363 0 .657.294.657.657v3.189a.654.654 0 0 1-.487.627a12.93 12.93 0 0 0-8.074 6.672a.65.65 0 0 1-.582.367M4.672 21.93c2.946-.399 3.837-.26 3.837-.26c-.21.98-1.046 1.978-3.553 3.195"></svg:path><svg:circle cx="35.319" cy="29.628" r="3.305" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="10.589" cy="32.029" r="2.511" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle>`,
})
export class ArcticonsTractorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrademeIcon],svg[arcticons-trademe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24.97" cy="17.64" r="1.863" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M4.5 21.78s4.543-3.248 6.735-4.519c3.09-1.792 8.517-4.53 11.297-4.907c2.085-.283 3.26.031 4.695.697c2.061.957 4.187 3.886 4.028 6.542c-.182 3.042-.847 4.123-2.362 5.664c-1.06 1.078-2.695 2.623-3.645 3.8c-4.14 5.126-5.127 13.634-5.127 13.634"></svg:path><svg:path d="M27.984 13.535c3.558-2.506 9.886-6.601 14.023-8.083c.508-.148 1.075-.081 1.365.452c.235.434.177 1.164-.426 1.513c-11.69 6.762-12.812 8.39-12.812 8.39M18.02 10.628c3.392-3.983 7.632-2.075 8.556-1.242s1.317 2.666 1.317 2.666m0 0s.879-1.257.94-1.848c.06-.59.62-2.423-1.046-3.846s-3.301-.984-3.301-.984"></svg:path><svg:circle cx="23.701" cy="19.666" r="4.24"></svg:circle></svg:g>`,
})
export class ArcticonsTrademeIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTraderepublicIcon],svg[arcticons-traderepublic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrafficRacerIcon],svg[arcticons-traffic-racer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrainConductorWorldIcon],svg[arcticons-train-conductor-world-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:ellipse cx="9.369" cy="30.218" rx="3.755" ry="4.189"></svg:ellipse><svg:ellipse cx="17.56" cy="33.631" rx="3.755" ry="4.189"></svg:ellipse><svg:ellipse cx="23.18" cy="38.051" rx="1.934" ry="2.157"></svg:ellipse><svg:ellipse cx="28.156" cy="40.096" rx="1.934" ry="2.157"></svg:ellipse><svg:path d="m31.779 42.656l-.287-6.666l9.485-6.861l2.023 6.4c-.318 1.342-.408 2.61-1.464 4.194c-3.832 2.243-6.796 2.591-9.757 2.933m7.395-20.34c0 3.337-1.725 7.13-3.854 8.47s-3.856-.28-3.856-3.617v-.002c0-3.337 1.725-7.13 3.855-8.469q0 0 0 0c2.129-1.34 3.855.281 3.855 3.619v0m1.196 5.07c0 .934-.483 1.995-1.078 2.37s-1.079-.078-1.079-1.012v0c0-.935.483-1.995 1.079-2.37s1.079.078 1.079 1.012z"></svg:path><svg:path d="M32.835 32.445c0 1.01-.523 2.158-1.167 2.563s-1.166-.085-1.166-1.095s.522-2.157 1.166-2.563c.644-.405 1.167.085 1.167 1.095m-6.515-7.448c0-3.338 1.727-7.13 3.855-8.47c.312-.196.442-.326.731-.4m-10.668 6.304c0-3.337 1.726-7.13 3.856-8.468c.673-.424 1.307-.551 1.857-.422M7.637 19.375l2.5 1.104l.046-2.637c-.815-1.049-1.644-1.43-2.486-1.027zM5 13.665l9.132 3.941c2.953-7.794 7.538-8.494 10.076-7.979l-8.631-4.264c-2.92-.16-6.016.528-10.577 8.301M15.42 20.4l-.111 5.49l14.053 5.587"></svg:path><svg:ellipse cx="32.89" cy="12.5" rx="1.89" ry=".924"></svg:ellipse><svg:path d="m34.782 12.5l.007 4.743c-1.723 1.42-3.848.783-3.91-.07L31 12.5"></svg:path><svg:ellipse cx="27.316" cy="13.148" rx="1.349" ry=".659"></svg:ellipse><svg:path d="m28.664 13.148l.005 3.382c-1.585.849-2.632.32-2.693-.337l-.008-3.045m-4.538-1.26l4.3 1.749"></svg:path><svg:path d="M28.666 14.834s2.252.879 2.252.844m6.34 2.62l-2.47-1.055M22.789 9.498l.005 2.948M6.147 14.16v11.118m6.951-8.118v8.73m8.166-.018l6.283 2.417"></svg:path></svg:g>`,
})
export class ArcticonsTrainConductorWorldIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrainasoneIcon],svg[arcticons-trainasone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTraleIcon],svg[arcticons-trale-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransdroidIcon],svg[arcticons-transdroid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransferIcon],svg[arcticons-transfer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.51 18.47L21 8.73a1 1 0 0 0-1.32-.61l-14.5 5.27a1 1 0 0 0-.62 1.31l9.14 25.11a1 1 0 0 0 1.32.61l10.84-4m-13.01 1.06l8.88-3.24m.09-23.17L5.41 17.04"></svg:path><svg:rect width="17.46" height="28.77" x="23.84" y="8.65" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.03" transform="rotate(10 32.592 23.005)"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m22.08 32.23l17.2 3.03m3.77-21.42l-17.19-3.03"></svg:path><svg:circle cx="13.95" cy="24.27" r="2.05" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="33.25" cy="24.27" r="2.05" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="20.19" cy="24.27" r="1.54" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="27.02" cy="24.27" r="1.54" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle>`,
})
export class ArcticonsTransferIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransistorIcon],svg[arcticons-transistor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.3 18.47h13v4.64h-13Zm-2.87 8.88a1.85 1.85 0 0 1 1.85-1.86h33.44a1.85 1.85 0 0 1 1.85 1.86m-.82-20.81a2 2 0 1 0-2 2a2 2 0 0 0 2-2m-2 9.06v-7M14.4 13.43H8.3v2.15h-1a1.87 1.87 0 0 0-1.87 1.86v24.2a1.85 1.85 0 0 0 1.85 1.86h33.43a1.86 1.86 0 0 0 1.86-1.86V17.5a1.86 1.86 0 0 0-1.86-1.86H21.3v-2.21h-4.64v2.21H14.4Z"></svg:path>`,
})
export class ArcticonsTransistorIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTranslateIcon],svg[arcticons-translate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTranslatorCsFrIcon],svg[arcticons-translator-cs-fr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.584 42.5c-.24-1.255 1.58-1.74 1.97-1.997c4.854-2.5 9.516-2.423 9.196-7.309c-1.301-1.142-1.67-3.115-2.585-4.558a1.744 1.744 0 0 1-.042-2.622c.025-1.116.046-5.56.245-5.597c.53-2.172 2.839-3.3 5.16-3.3s4.631 1.128 5.161 3.3c.199.037.22 4.48.245 5.597a1.744 1.744 0 0 1-.043 2.622c-.915 1.443-1.283 3.417-2.584 4.558c-.32 4.886 4.342 4.809 9.195 7.309c.39.256 2.211.742 1.971 1.997M6.904 5.732h3.879M6.904 9.611h2.522M6.904 5.732v7.757m6.75-.036V5.695h2.52a2.618 2.618 0 0 1 0 5.236h-2.52m2.704-.007l2.435 2.529m17.262-.973a2.31 2.31 0 0 0 1.939.872h1.164a1.944 1.944 0 0 0 1.938-1.938h0a1.943 1.943 0 0 0-1.938-1.939h-1.261a1.945 1.945 0 0 1-1.939-1.94h0a1.944 1.944 0 0 1 1.939-1.94h1.164a2.08 2.08 0 0 1 1.938.873m-7.362 4.266a2.607 2.607 0 0 1-2.617 2.618h0a2.607 2.607 0 0 1-2.618-2.596V8.118A2.607 2.607 0 0 1 31.02 5.5h0a2.526 2.526 0 0 1 2.52 2.618h0"></svg:path>`,
})
export class ArcticonsTranslatorCsFrIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransmissionBtcIcon],svg[arcticons-transmission-btc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransmissionRemoteIcon],svg[arcticons-transmission-remote-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.36 19.76a6.52 6.52 0 0 1 3.7 5.89c0 2.59-1.51 4.84-3.7 5.89m4.015 7.445c4.828-2.498 8.125-7.529 8.125-13.336S39.203 14.8 34.375 12.302M19.09 17.966h5.558a3 3 0 0 1 3 3v16.148a3 3 0 0 1-3 3H8.5a3 3 0 0 1-3-3V20.966a3 3 0 0 1 3-3h5.57"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.069 14.37h5.017v12.815h-5.017z"></svg:path><svg:rect width="19.169" height="6.484" x="6.994" y="7.886" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="3.242" ry="3.242"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.086 32.579v-5.394h-5.017v5.394h-1.96l4.496 4.615l4.497-4.615z"></svg:path>`,
})
export class ArcticonsTransmissionRemoteIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransportIcon],svg[arcticons-transport-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.54 39.08h7.74v4.42H8.54zm23.18 0h7.74v4.42h-7.74zM7.29 11h1.2v7.94a2.44 2.44 0 0 1-2.4-2.47v-4.25A1.22 1.22 0 0 1 7.29 11m33.42 0h-1.2v7.94a2.44 2.44 0 0 0 2.4-2.47v-4.25a1.22 1.22 0 0 0-1.2-1.22M24 4.5c-5.51 0-15.46.86-15.46 3.1v31.48h30.92V7.6c0-2.24-10.02-3.1-15.46-3.1m0 4.23q8.19 0 12.2 1.23a1 1 0 0 1 .67.92v17a1 1 0 0 1-1 1H12.14a1 1 0 0 1-1-1v-17a1 1 0 0 1 .67-.92q4-1.23 12.19-1.23M13.59 31.5a2.5 2.5 0 0 1 0 5h0a2.47 2.47 0 0 1-2.43-2.5h0a2.47 2.47 0 0 1 2.43-2.5m20.87 0a2.5 2.5 0 0 1 0 5h0A2.47 2.47 0 0 1 32 34h0a2.47 2.47 0 0 1 2.46-2.5"></svg:path>`,
})
export class ArcticonsTransportIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTransportrIcon],svg[arcticons-transportr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTravelokaIcon],svg[arcticons-traveloka-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrawelldroidIcon],svg[arcticons-trawelldroid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrcameraIcon],svg[arcticons-trcamera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m10 22.5l-2.55 1.78s-2-2.59-1.67-3.56c1.28-3.78 9.65-5.87 9.65-5.87a9.8 9.8 0 0 0-3.72-.43c1.78-2.05 8.09-4.8 8.09-4.8c-.49-3.18 2.1-5.12 3.07-5.12s5.44 4.74 5.44 4.74a26 26 0 0 1 3.61 1.19c-2.31.05-4.42 2.64-4.42 2.64c2.48-1.13 8.31 0 8.52 0a17 17 0 0 1 1.89 2.21A7.6 7.6 0 0 0 33 16.41c2.7-.48 6.42 1.3 6.85 1.73c.63.63 7.21 13.05-4.53 21.39c-13.91 9.89-23.39-1.83-23.39-1.83s11.75 9.27 22.42.43c9.87-8.17 2.86-17.06 2.86-17.06c5 13.75-10.35 18.6-10.35 18.6c9.51-5.23 6.63-14 6.63-14c0 7.66-6.9 10.33-6.9 10.33a4.1 4.1 0 0 0 .47-1.77a3.29 3.29 0 0 0-2.3-3.23s-2.19 4.85-2.35 5s-.24.44-3.15.44A5.06 5.06 0 0 1 15 34c1.54-.28 4.41-2 4.41-4.29a3.66 3.66 0 0 0-3.68-3.59c-1.7 0-4.36 1.57-5.13 2L7.9 24"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10 27.17c.09-2.94 1.79-6.18 6.48-8.24s11.28-.48 12.49.45c0 0-3.64.08-4.37 1.41c0 0 5.38 3 5.38 7.48s-2.91 6-2.91 6"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13 28.69a2 2 0 0 1-.59-1.57m2.93 5.27a2.9 2.9 0 0 0 .85 1.18"></svg:path>`,
})
export class ArcticonsTrcameraIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTreasureOfNadiaIcon],svg[arcticons-treasure-of-nadia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrebleshotIcon],svg[arcticons-trebleshot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.12 19.53v1.18a14.93 14.93 0 0 0 11.01 14.42M32.47 8.42a14.93 14.93 0 0 0-19 1.74M30.41 34.2a14.93 14.93 0 0 0 8-17.35"></svg:path><svg:circle cx="24" cy="35.64" r="3.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="11.07" cy="13.25" r="3.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:circle cx="36.93" cy="13.25" r="3.9" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.54 39.31a6.58 6.58 0 0 0 7.84 2.46a6.3 6.3 0 0 0 1.28-.68a6.57 6.57 0 0 0-7.33-10.91m22.42-13.89A6.57 6.57 0 0 0 31.91 9a6.7 6.7 0 0 0-.81 1.21a6.57 6.57 0 0 0 2.79 8.87M10.65 6.69a6.57 6.57 0 0 0-6.07 5.53a7 7 0 0 0-.07 1.45a6.57 6.57 0 1 0 13.12-.84"></svg:path>`,
})
export class ArcticonsTrebleshotIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTreintaIcon],svg[arcticons-treinta-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.883 14.174h9.797c-.618 7.22-4.846 9.03-9.797 9.758V43.5a9.466 9.466 0 0 1-9.563-9.673V14.173A9.466 9.466 0 0 1 23.883 4.5zm9.797 25.517a3.814 3.814 0 1 1-3.814-3.809a3.81 3.81 0 0 1 3.814 3.81"></svg:path>`,
})
export class ArcticonsTreintaIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTremotesfIcon],svg[arcticons-tremotesf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrendyolIcon],svg[arcticons-trendyol-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.827 24.526v2.183c0 .893-.724 1.617-1.617 1.617h0c-.447 0-.851-.18-1.144-.474"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.827 21.857v2.669c0 .893-.724 1.617-1.617 1.617h0a1.617 1.617 0 0 1-1.618-1.617v-2.669"></svg:path><svg:rect width="3.235" height="4.286" x="34.592" y="21.857" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.617" ry="1.617"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.063 23.474c0-.893.724-1.617 1.617-1.617h0m-1.617 0v4.286M39.5 19.674v6.469m-30.15-5.62v4.811c0 .447.361.809.808.809h.242m-1.9-4.286h1.698m12.818 4.286v-2.669c0-.893-.724-1.617-1.618-1.617h0c-.893 0-1.617.724-1.617 1.617m0 2.669v-4.286m-1.921 3.47a1.62 1.62 0 0 1-1.404.816h0a1.617 1.617 0 0 1-1.618-1.617v-1.052c0-.893.724-1.617 1.618-1.617h0c.893 0 1.617.724 1.617 1.617V24h-3.235m13.098-.526c0-.893-.724-1.617-1.617-1.617h0c-.894 0-1.618.724-1.618 1.617v1.052c0 .893.724 1.617 1.617 1.617h0c.894 0 1.618-.724 1.618-1.617m0 1.617v-6.469M42.5 34h-37m37-20h-37"></svg:path>`,
})
export class ArcticonsTrendyolIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrenitIcon],svg[arcticons-trenit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:ellipse cx="38.95" cy="30.283" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.842" ry="1.408"></svg:ellipse><svg:ellipse cx="30.717" cy="30.283" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="1.842" ry="1.408"></svg:ellipse><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.708 25.625v-5.417h-9.75v5.417Z"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.417 16.417H40.25c2.262 0 3.25 3.696 3.25 5.958v8.667c0 1.615-.552 4.333-2.167 4.333h-13c-1.615 0-2.166-2.718-2.166-4.333v-8.667c0-2.262.987-5.958 3.25-5.958"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.417 16.417c-4.332-.018-8.129 14.625-17.334 14.625H4.5v4.333h23.833"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.392 33.005v-.873a14.7 14.7 0 0 0 3.51-2.77v2.575a10.7 10.7 0 0 1-3.51 1.068m4.983-1.943a17 17 0 0 0 2.084-1.724v-4.334a42 42 0 0 1-2.084 2.732Zm-6.603 2.079c-.836.053-1.624.067-2.605.067a7.7 7.7 0 0 0 2.605-.464Zm-2.605.067H11m-1.842 0H4.5m35.75-16.791l-1.083-3.792m-9.75 3.792l-1.084-3.792l-2.97 7.104m.804-7.104h15.166"></svg:path>`,
})
export class ArcticonsTrenitIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrenitaliaIcon],svg[arcticons-trenitalia-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrenordIcon],svg[arcticons-trenord-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M11.39 6.9C9.8 6.88 9.13 8.44 9 9.78l-1.4 6.45c4.61.66 9.46 1.34 13.34 4.11a21.78 21.78 0 0 1 8.86 11.41c.74 3.28-.25 7.48-3.56 9c-1.73.54 0 .35.77.38c2.7 0 5.4.07 8.1 0c1.61-.25 1.89-1.93 2.13-3.25l6.2-29.18c.4-1.61-1.38-1.92-2.55-1.77Zm9.24 17.34l-13.84.58L4.5 36.37c5 1.08 9.59 3 14.51 3.37c2.42 0 5.44.16 7-2.11c1.78-2.51.65-6.46-.82-8.69a16.2 16.2 0 0 0-4.53-4.71Z"></svg:path>`,
})
export class ArcticonsTrenordIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrexrunnerIcon],svg[arcticons-trexrunner-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.58 13.78V6.36h-1.86V4.5H25.86v1.86H24V17.5h-1.86v1.86h-1.86v1.86h-3.7v1.86h-1.86v1.84H11v-1.84H9.14v-1.86H7.28V17.5H5.42v11.14h1.86v1.86h1.86v1.86H11v1.86h1.86v1.86h1.86v7.42h3.7v-1.86h-1.84v-1.86h1.84v-1.86h1.86v-1.84h1.86v1.84H24v5.58h3.72v-1.86h-1.86v-7.42h1.86v-1.86h1.86v-3.72h1.84v-5.56h1.86v1.84h1.86v-3.7h-3.72V17.5h7.44v-1.86h-5.58v-1.86Zm-13-5.56h-1.86V6.36h1.86Z"></svg:path>`,
})
export class ArcticonsTrexrunnerIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTribalWarsIcon],svg[arcticons-tribal-wars-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.347 3.453c3.732 1.552 4.826 5.374 4.826 5.374s-.715 2.313 1.01 4.795c-.926 1.472-1.01 3.196-.506 4.92s-.21 3.407-.126 4.122s.589 1.64.631 2.705s-.154 1.907.224 3.042s1.248 3.148-.56 5.23s-2.818 3.869-6.982 3.259S25.15 34.292 24 34.124s-5.818-.358-6.848-1.24s-2.103-3.933-1.998-5.91s-.21-4.142-.21-4.142"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.22 17.449c-1.62-1.388-4.059.147-3.533 3.406s1.724 2.537 2.105 5.182c.164 1.136.909 1.42 1.554 1.28c1.135-.246 1.065-1.513 1.792-2.439M32.102 4.467c-2.607.933-6.097.764-8.242-.35s-3.533-1.304-3.533-1.304m0 12.071c.8.757 1.199-1.031 4.164-.232c1.856.5 2.208 1.45 2.208 1.45s-2.86 1.767-5.807-.986m1.03 14.924c.383-.788.592-1.362.95-1.951s3.286-2.376 5.467-2.187c1.703.147 2.586-.273 3.638.841s2.082 2.565 2.082 2.565c-.085-1.976-.526-3.574-1.599-4.857s-1.977-1.491-3.848-1.43c-5.14.168-8.102 3.924-6.69 7.02"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.473 27.55c2.595 1.106 5.392.938 6.611.98s2.944-.252 2.944-.252m-3.14-12.946c.799.785 1.023 3.14.87 4.416c0 0 .644-.59 1.373.489s.322 2.062-.715 1.726s-.832 1.049-1.92 1.049c-1.585 0-.667-1.274-2.692-.67c-.437.13-1.234.195-1.542-1.108s1.29-2.426 2.355-1.542"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.449 16.364c1.191-.864 2.937-1.36 4.009.117c-1.052 1.234-1.893 1.462-4.01-.117m-15.504 6.468c-.019 1.262 1.112.7 2.495 3.617c.726 1.53 1.514 3.56 2.425 4.205s2.958 0 3.996 1.038s1.612 1.822 2.839 1.766s2.437-.813 1.551-2.411s0-2.512 0-2.512M20.873 2.93c-3.013.808-4.33 2.294-4.667 5.911s0 4.122 0 4.122l.953.196m14.639 15.285c-1.546 1.706-1.826 4.066-1.21 5.017s1.094.754 1.515.305s1.43-4.317 1.43-4.317s.589 1.57 1.598 1.457s1.086-3.302 1.086-3.302m-15.89-15.707c1.367.168 4.9.715 6.477 1.745m3.785.211c1.514-.463 5.593-.231 5.593-.231M14.234 4.843c-3.883 2.545-3.223 5.919-4.13 8.8S8.692 23.477 8.41 25.215s-1.01 4.879-1.177 6.953s-.075 5.198-.075 5.198m29.276-4.553c.407 2.257 4.713 4.159 4.713 4.159M16.596 14.884c-1.708 1.415-3.97 2.189-3.97 2.189m4.64 15.887c1.323 2.853 4.856 3.274 7.127 7.311s2.306 5.061 2.306 5.061m7.154-9.51c.072 1.28-.825 3.324-.825 3.324"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.282 38.66c4.307.125 9.893-.047 14.375 1.945"></svg:path><svg:circle cx="23.881" cy="15.551" r=".21" fill="none" stroke="currentColor" stroke-miterlimit="10"></svg:circle><svg:circle cx="32.636" cy="16.509" r=".119" fill="none" stroke="currentColor" stroke-miterlimit="10"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.01 19.172c-.786.436-1.192 1.725-.786 2.707m3.982-4.806c.056 1.75-.15 4.665-.15 4.665m8.319-3.586c-.62.484-1.377 1.473-1.377 1.473"></svg:path>`,
})
export class ArcticonsTribalWarsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTricountIcon],svg[arcticons-tricount-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTriliumSenderIcon],svg[arcticons-trilium-sender-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.757 22.493c2.173 2.398 7.195 3.017 11.523-1.88c4.533-5.128 8.22-9.531 8.22-9.531S35.63 4.26 27.848 9.114s-5.597 11.717-4.091 13.379"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.757 22.493c1.773-3.804 5.009-8.307 12.398-11.062M21.858 22.493c1.12-2.796-.394-8.438-5.116-9.138s-9.619.962-12.242 4.853c3.28 1.224 4.94 4.986 10.843 6.4c2.667.64 5.64.069 6.515-2.115"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21.858 22.493c-2.624-2.827-6.53-5.626-10.756-5.684m12.655 6.714c2.866 0 5.036 3.427 4.44 8.69a47 47 0 0 0-.196 8.417s-9.09-1.313-9.856-7.696c-.74-6.18 1.636-9.411 5.612-9.411"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.757 23.523c-1.9 2.722-2.49 8.974.156 12.515"></svg:path>`,
})
export class ArcticonsTriliumSenderIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTriliumnotesIcon],svg[arcticons-triliumnotes-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTriodosBankIcon],svg[arcticons-triodos-bank-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrionsIcon],svg[arcticons-trions-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m29.512 38.994l-.036 2.84l-4.804-7.172l4.978-7.044l.065 2.644c7.43.627 9.097.68 12.08-1.407l-4.463 7.73c-.78 1.353-1.55 2.687-7.82 2.409"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m35.86 30.643l-4.097-7.888l7.436-4.035l2.474 4.998c.87 1.63 1.263 3.162.123 5.137M7.997 21.74l-2.442-1.451l8.614-.575l3.61 7.834l-2.32-1.267c-4.26 6.122-5.14 7.539-4.823 11.166l-4.463-7.73c-.781-1.353-1.551-2.687 1.824-7.977"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m12.055 31.414l8.88.394l-.224 8.457l-5.565-.355c-1.847-.063-3.37-.488-4.51-2.463m23.061-25.713l2.477-1.389l-3.808 7.747l-8.59-.79l2.257-1.377c-3.172-6.749-3.959-8.22-7.258-9.759H27.7c1.563 0 3.103 0 5.997 5.568"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m23.29 10.412l-4.781 7.493l-7.213-4.423l3.091-4.642c.978-1.568 2.107-2.674 4.388-2.674"></svg:path>`,
})
export class ArcticonsTrionsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTripleAIcon],svg[arcticons-triple-a-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTripsIcon],svg[arcticons-trips-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24 4.5c-5.936 0-10.748 4.84-10.748 10.81c0 8.465 8.21 16.313 10.354 18.807a.654.654 0 0 0 .993 0c2.094-2.477 10.149-10.342 10.149-18.807C34.748 9.34 29.936 4.5 24 4.5m0 14.865c-3.587.007-5.389-4.352-2.856-6.905s6.871-.75 6.871 2.858c0 2.23-1.798 4.039-4.015 4.039zM18.88 43.5v-7.637h1.241a3.83 3.83 0 0 1 3.82 3.818h0a3.83 3.83 0 0 1-3.82 3.819zm-1.765 0l-2.482-7.637l-2.578 7.637m.859-2.578h3.342m19.689 0a2.567 2.567 0 0 1-2.578 2.578h0a2.567 2.567 0 0 1-2.577-2.578v-2.577a2.567 2.567 0 0 1 2.578-2.578h0c1.431 0 2.482 1.146 2.482 2.578h0M29.816 43.5l-2.482-7.637l-2.578 7.637m.859-2.578h3.341"></svg:path>`,
})
export class ArcticonsTripsIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTripviewIcon],svg[arcticons-tripview-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.013 4.5h19.72v22.765h-19.72zm0 15.167h19.72m-9.86.006v7.592m7.182 3.702L35.207 43.5M16.956 30.967L12.793 43.5m2.937-8.84h16.548m-18.186 4.929H33.89"></svg:path>`,
})
export class ArcticonsTripviewIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTriviaCrackIcon],svg[arcticons-trivia-crack-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTriviaYouIcon],svg[arcticons-trivia-you-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrouwIcon],svg[arcticons-trouw-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.5 18.66h5.751m-4.406 8.68l1.53-8.68M38.5 21.589l-2.804 5.751l-.777-5.751l-2.804 5.751l-.776-5.751M19.518 27.34c-1.199 0-1.999-.971-1.788-2.17l.249-1.41c.211-1.199 1.354-2.17 2.553-2.17h0c1.198 0 1.999.971 1.787 2.17l-.248 1.41c-.212 1.199-1.355 2.17-2.553 2.17m5.412-5.75l-.631 3.58c-.212 1.199.588 2.17 1.787 2.17h0c1.199 0 2.341-.971 2.553-2.17l.631-3.58m-.631 3.58l-.383 2.17m-13.904-3.58c.21-1.199 1.354-2.17 2.552-2.17h0m-2.17-.001L13.72 27.34"></svg:path>`,
})
export class ArcticonsTrouwIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrtDinleIcon],svg[arcticons-trt-dinle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrtHaberIcon],svg[arcticons-trt-haber-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTruckIcon],svg[arcticons-truck-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.497 5.5h29c2.216 0 4 1.784 4 4v29c0 2.216-1.784 4-4 4h-29c-2.216 0-4-1.784-4-4v-29c0-2.216 1.784-4 4-4"></svg:path><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M33.855 28.63L24.2 27.352l-15.62-.359c.24-5.652 1.178-11.124 3.372-14.979c.56-.984 1.67-1.554 3.204-1.681l10.493-.871l6.297 2.14l1.89.078c1.154 5.391.602 11.52.018 16.948"></svg:path><svg:path d="m9.58 21.117l12.93-.29l1.735-8.726c-4.871.092-9.457.333-12.698.985m18.618 7.291s.78-.81.829-1.33l.347-3.678l-4.708-1.504c-.45-.143-1.078.06-1.212.885l-1.027 6.33l3.461-1.121zm-16.18 2.693l2.076-.03l-.482 1.174l-1.313-.065zm1.917.363l4.207-.03m-9.807.068l3.781-.026m-.326 3.681a1.3 1.3 0 0 1-.245-.767c0-.698.533-1.264 1.19-1.264s1.191.566 1.191 1.264h0c0 .295-.097.58-.275.808"></svg:path><svg:path d="M29.666 20.29c-.114 2.291-.133 3.81-.398 6.406m2.472-1.026l-2.753-.569m-4.693-2.598l-.249 3.443M34.49 15.084l8.006 3.7m-8.332 9.759l8.332 1.914m-3.914-2.56l-1.393 3.028m3.797-2.361l-1.374 2.82"></svg:path></svg:g><svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="m8.556 28.242l.034 2.513c-.516 1.422-.443 2.952-.615 4.437c5.333.043 10.485.756 15.89 1.402l2.61.515l.19-2.886"></svg:path><svg:path d="m24.743 29.075l-.31 4.263l-.013 1.297m-13.796-2.478l-.617-7.531m10.343-.09l-2.166 8.061m-6.627-1.541c2.355.359 4.005.315 5.963.248m-6.02-1.49c2.444.359 4.156.315 6.188.248M8.152 33.94l1.179.2l.897-1.072l8.205.502l1.261 1.49l3.436.17M9.309 30.492l-.67-.085m-.406 1.839l1.226.184m11.309-1.249l2.343-.138m-3.541 2.076l3.397.07m3.703.393c.047-1.99 1.643-4.276 3.071-4.237c.901.024 1.433 1.051 1.717 1.614l1.98-.27l.466-.6l-.09-1.509m-.614 4.15l6.074.383c-.104 1.37-.182 2.825-.693 4l-5.651-.164z"></svg:path><svg:path d="M34.824 32.831c.048 1.463-.045 2.94-.304 4.167m-4.939 3.174c-1.433 0-2.587-1.99-2.587-4.463s1.154-4.463 2.587-4.463"></svg:path><svg:path d="m27.427 31.105l2.154.141c1.433 0 2.587 1.99 2.587 4.463s-1.154 4.463-2.587 4.463l-2.203-.145c-1.185 0-2.178-1.36-2.487-3.229m-9.543 1.932c-1.115 0-2.03-1.436-2.165-3.304"></svg:path><svg:path d="M17.47 35.836c-.23 1.664-1.09 2.893-2.122 2.893l-1.859-.122c-.999 0-1.837-1.153-2.098-2.736m29.661 3.549c-1.025 0-1.85-1.562-1.85-3.501c0-1.94.825-3.5 1.85-3.5"></svg:path><svg:path d="M42.503 38.096c-.338.807-.861 1.323-1.45 1.323l-1.577-.113c-.784 0-1.452-.915-1.722-2.215m1.757-4.784l1.541.111c.59 0 1.113.517 1.451 1.324"></svg:path></svg:g>`,
})
export class ArcticonsTruckIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrueFarmShrimpIcon],svg[arcticons-true-farm-shrimp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><svg:path d="M10.213 19.944c-2.489.076-4.757-.596-6.699-2.47m32.344 2.23c8.078-4.283 6.086-9.29.34-8.468c-4.99.713-10.298 3.394-15.354 5.596m-6.652 10.436c1.38.845 1.728 1.59 1.787 2.31m-.464-3.16c.986.637 1.672 1.83 1.737 2.992m1.402-3.427c.558 1.172.23 2.269-.262 3.335m5.691-3.777l1.17 1.549c-.13.545-.232 1.04-.293 1.532m.93-3.342l1.694 2.71l-.077 2.004m1.135-4.754l.972 2.396c.2.49.149 1.095-.046 1.587l-.679 1.712m1.027-6.036l.828 1.776c2.802.973 2.933 1.658 3.071 4.041m-3.216-6.079c1.082.444 2.085 1.014 3.15 1.737l.28.931"></svg:path><svg:path d="m44.486 23.113l-6.545-.88c-.838.423-1.356.386-2.456.508c-.981.493-2.735.84-4.242.77c-1.9 2.566-5.77 1.092-6.733 1.898c-4.49.268-5.545-.234-5.987.487c-1.867-.102-3.076-.263-3.224.627c-1.045.45-2.129 1.3-1.887 1.871c.383.904.845 1.572 1.13 2.328c.498.115.901.515 1.76 1.136c1.024.742 2.578.055 2.971.903c.902.04 4.14-4.748 4.693-2.18c1.904-.39.327 2.094-.384 2.805c.676.466 2.048 1.362 2.57 2.132c.502.74-2.574.64-4.04.389c-2.467-.423-4.001-.385-5.151.947c-3.165-1-5.465-1.14-6.824-2.5c-5.963-4.064-3.57-11.587-.551-13.291c.893-1.064 2.72-2.26 4.73-2.71c1.349-1.426 7.935-1.535 12.148-.876c3.809.595 8.973 1.674 9.82 3.017l5.593 1.382"></svg:path><svg:path d="M19.165 32.712c-.258 1.475-1.663 1.983-1.347 3.322m-3.468-5.26c-1.525 2.535-3.597 1.925-4.06 3.6m-2.866-3.025l.708-.907c1.74.11 3.646-.843 4.426-2.246l.701.165m-6.426-2.552c2.487-.434 2.472.512 3.731.408c.926-.076 2.174-.814 3.003.022c.346.348.348.868.156 1.32m2.437-1.846c-.394-2.604-2.108-1.315-3.86-2.788c-.871-.733-1.77-1.577-3.075-1.432m4.942-2.929c1.39 1.952 3.483 1.901 4.519 3.787a6.4 6.4 0 0 1 .807 3.097m.773-8.051c.435 4.001 4.63 4.804 4.152 7.795"></svg:path></svg:g>`,
})
export class ArcticonsTrueFarmShrimpIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrueIserviceIcon],svg[arcticons-true-iservice-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrueidIcon],svg[arcticons-trueid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTruemoneyIcon],svg[arcticons-truemoney-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrustdeviceFingerprintIcon],svg[arcticons-trustdevice-fingerprint-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrustdockIcon],svg[arcticons-trustdock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class ArcticonsTrustdockIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrustifiedIcon],svg[arcticons-trustified-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="24" cy="24" r="21.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m8.477 20.746l8.166 12.974l22.88-19.44l-23.046 11.275z"></svg:path>`,
})
export class ArcticonsTrustifiedIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTrustmanagerIcon],svg[arcticons-trustmanager-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTryhackmeIcon],svg[arcticons-tryhackme-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTsukiAdventureIcon],svg[arcticons-tsuki-adventure-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M38.5 5.5h-29a4 4 0 0 0-4 4v29a4 4 0 0 0 4 4h29a4 4 0 0 0 4-4v-29a4 4 0 0 0-4-4m-20.237.005L5.505 11.73m36.99 26.379l-8.136 4.386m8.136-7.404L28.574 42.47"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M30.172 38.045c3.124.873 6.69-2.914 4.32-6.063"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M32.359 34.312c-.8 3.585-4.596 4.928-6.715 5.006"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M33.972 29.626c.656 1.503.096 5.819-3.517 4.111"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m30.775 32.193l4.325-3.736c1.492.059 2.812-1.002 1.543-1.75c1.222-2.36 3.5-3.905 5.586-5.597m.107-2.941c-.618 1.202-1.796 2.17-2.775 2.937c-3.371 2.494-6.355 6.335-9.59 9.573"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M28.794 35.227c4.918-4.158-.995-6.544-3.698-4.24m5.847-4.972c.372-.044.58-.014.883-.367m-6.894-1.426l.256 1.2m-12.475 9.702c-4.25.76-3.59-4.189-.84-3.696"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.71 39.92c-2.513-.245-8.15-2.994-6.459-13.028"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.636 34.917c-.712-.806-3.52-1.049-5.359 2.091c-1.43 2.446.533 6.58 5.129 3.507c1.17-.783 2.046-3.541.23-5.598M5.505 21.48c2.543.896 5.579 2.263 8.756.343m-1.332 4.446c-3.029 2.96-7.124 1.942-7.424 1.798"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.608 30.628c-7.924 1.889-11.63-1.764-13.11-5.255c.729-2.55 1.294-2.773 2.132-3.98m5.576-7.551c7.816-4.401 16.08 7.073 12.646 13.759c-1.515 1.488-3.191 2.256-4.93 2.498"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.792 30.184c-2.071.03-4.2-.613-6.226-1.613c-4.239-1.297-7.253-6.762-5.203-10.875m7.68-4.884c-3.096-2.942-1.586-5.735.3-6.134c3.201-.678 6.831 7.624 6.615 8.577M14.01 12.483c2.565 1.375 4.059 3.54 5.036 5.287"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.199 19.285c-.442-1.227-8.025-5.405-4.325-8.93c2.881-2.745 8.32 4.866 8.958 7.02"></svg:path>`,
})
export class ArcticonsTsukiAdventureIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTsukiAdventure2Icon],svg[arcticons-tsuki-adventure-2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTsukiOdysseyIcon],svg[arcticons-tsuki-odyssey-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="37" height="37" x="5.5" y="5.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" rx="4" ry="4"></svg:rect><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.131 40.17c-9.092-9.16-18.217-16.357-23.135-12.632l-1.657.127c-.942-1.964-1.606-3.944-1.116-5.992c.865-2.415 1.76-4.946 2.518-7.076c.587-1.65-.782-4.594-3.952-2.677c-5.3 3.206-2.174 8.817-1.721 9.18c.68.545.176 1.743.414 2.581a48 48 0 0 0 2.327 5.578c.164-.36-3.094-4.017-5.897-2.996A20.6 20.6 0 0 1 5.5 26.9m0 4.05c.114.198 2.586-.212 4.604-.99c2.383-.918 4.806.994 3.857 3.06c-2.024 4.405 2.677 9.48 2.677 9.48"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M19.591 27.15c.31 5.856-3.285 5.96-5.47 5.392m8.518-5.987a5.18 5.18 0 0 1 .118 3.373m-1.339 2.869c-1.92 2.957-4.501 4.148-7.95 3.026m16.68-6.061a8.7 8.7 0 0 1-.22 3.863M20.845 42.5a10.63 10.63 0 0 0 6.088-3.552m8.337-5.228c.062 1.711.222 3.445-.784 4.91m-1.498 2.517l-1.402 1.352m7.182-5.615c.161.7.157 1.43-.011 2.128m-9.817-2.837l-.542.892m7.777 1.531l-.319.924M13.448 23.534c-.58.24-3.867-5.508-3.631-9.287c.097-1.558-.782-3.304-2.9-1.88A7.3 7.3 0 0 0 5.5 14.12m0 7.904c1.745 1.824 4.162 2.865 5.852 4.083M5.5 24.669c1.495.325 2.93.88 4.255 1.647M33.53 15.777c-2.67-3.708-9.85-4.565-10.136.19"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.012 19.506c5.538-4.628-6.036-5.207-1.715 2.564m-2.961 5.519c-1.72-5.185 6.638-4.254 6.28-.646"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21.896 21.673a4.33 4.33 0 0 0-1.895 2.386m10.326-10.73c3.39-1.167 4.276-.248 4.637 1.109m-2.358.315c8.455-.821 6.239 4.47 2.135 4.21c.167 1.066.326 2.13-.67 3.029m-.35 6.757c.767 1.393.172 2.332-.567 3.222"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.39 24.318c3.31 2.538 1.258 3.809.51 3.761a1.27 1.27 0 0 1-1.18.67"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.279 18.103c2.944-.685 14.112 3.825 9.028 7.172"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M23.696 18.866a3.15 3.15 0 0 0 1.547 1.532c3.395.558 5.853 2.454 8.064 4.876"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M29.773 22.172c-.04 2.514-.491 7.929 2.928 5.844l1.02.733m-.414-3.474A6.9 6.9 0 0 1 34.9 28.08m1.53-11.283l-2.231-.096l.606.924m-9.668-2.958h.67"></svg:path><svg:circle cx="30.589" cy="15.417" r=".75" fill="currentColor"></svg:circle>`,
})
export class ArcticonsTsukiOdysseyIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTsumugiIcon],svg[arcticons-tsumugi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="36.078" cy="19.177" r="1.53" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.607 19.177V10.91s3.95 2.438 3.95 3.95a2.96 2.96 0 0 1-1.447 2.335M11.746 34.022s4.4.004 4.4-4.4s-1.773-7.21-3.884-7.21"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.262 22.411s.261-2.451-1.342-2.451s-1.27 2.617-1.27 2.617s-3.755.39-3.001 6.25s5.098 5.195 5.098 5.195m-.824-14.062a15.5 15.5 0 0 1 .107-2.636m-1.484-.873s-.2.872 1.485.872s2.183-.056 2.248-.602s.317-2.213-.173-2.213S14.45 10 15.766 8.649s2.46-2.433 4.349-2.46s-3.213-1.47-5.322-.1a11.34 11.34 0 0 0-3.63 4.123c-.187.453-.935 2.467-1.006 2.845s-.18 1.415-.18 1.415s-.462-.379-.431 1.98m3.135 17.455s-2.42 2.662-2.01 8.593m3.009-8.904s-.785 5.193.772 8.904m6.761 0a28.2 28.2 0 0 1-.975-6.522c0-3.963-2.632-9.715-4.588-10.047"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M17.248 24.679c-1.316-1.73-4.967-6.653-.182-13.76m3.457-4.809a20.9 20.9 0 0 1 7.518 3.32c5.183 3.394 1.697 13.965 1.515 13.995c0 0 1.9-10.76-7.27-14.665"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M22.286 8.76s4.918 2.136 2.12 15.02"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M24.407 23.78s-.953-6.111-1.957-7.212m-2.79-7.675s.968 9.831-3.746 12.322M34.666 42.5a5.5 5.5 0 0 1 .196-2.552c.445-.872-.337-8.152-.576-9.017s-.023-2.148 1.073-.917s2.07 8.34 2.07 8.34"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.666 42.5a4.75 4.75 0 0 0 1.534-1.954c.422-1.557 1.635-2.435 1.635-2.913s-.118-1.688.158-1.507c1.662 1.083 1.983 2.26.746 3.232"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M37.673 36.106s.975-1.038 1.393-.999s1.361 2.928 1.361 2.928"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M39.923 36.635a1.377 1.377 0 0 1 2.065.226m-3.82-4.173a6.66 6.66 0 0 0-1.52-5.025c-3.409-4.54-5.64-8.233-5.81-10.363m-1.282 6.126c-.31.89 2.24 1.147 1.63 5.015a27 27 0 0 1-2.23 7.068l-5.97-.372s-2.556 3.726-2.307 4.94"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.624 35.364a78 78 0 0 0 3.287 7.059m-5.598-7.203a43.3 43.3 0 0 0 1.803 7.28m2.562-16.18s.136-1.129-.11-1.129a11 11 0 0 1-1.727-.958M14.264 6.464s-6.135.051-8.529 3.995m33.004 28.899a6.5 6.5 0 0 0-.787 3.142"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M40.427 38.035s1.474 2.62-2.095 2.39"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M41.988 36.86s1.16 2.592-1.265 2.41"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M41.259 39.261s.957 2.164.056 3.239"></svg:path>`,
})
export class ArcticonsTsumugiIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTtbTouchIcon],svg[arcticons-ttb-touch-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M36.993 32.942c3.8 0 6.507-2.95 6.507-6.618s-2.708-6.496-6.507-6.496s-6.485 2.829-6.485 6.496s2.685 6.618 6.485 6.618m-6.485-17.884v4.703m-13.015 0v-4.703m13.015 4.703v6.867a6.06 6.06 0 0 1-6.045 6.071h-.899a6.06 6.06 0 0 1-6.071-6.045v-6.893h5.242m-18.235 0v-4.703m12.993 11.57a6.04 6.04 0 0 1-6.009 6.07h-.913a6.06 6.06 0 0 1-6.07-6.045V19.76h5.24"></svg:path>`,
})
export class ArcticonsTtbTouchIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[arcticonsTtlockIcon],svg[arcticons-ttlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="25.097" cy="27.363" r="3.527" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></svg:circle><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m22.603 29.857l-7.192 7.191m3.143.11l-1.626-1.626m3.929 1.041l-2.486-2.485m3.199.073l-1.636-1.635m.227-13.376V9.597a2.779 2.779 0 1 0-5.557 0v11.234"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M25.719 16.831V7.28a2.779 2.779 0 1 0-5.558 0v12.873"></svg:path><svg:path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.604 20.832v-7.943a2.779 2.779 0 1 0-5.558 0v19.263c0 6.267 5.081 11.348 11.349 11.348c3.785 0 7.137-1.853 9.199-4.702l8.808-11.646a2.779 2.779 0 1 0-4.454-3.324l-2.672 3.579V9.597a2.779 2.779 0 1 0-5.557 0v10.555"></svg:path>`,
})
export class ArcticonsTtlockIcon {
  readonly viewBox = input("0 0 48 48")
  readonly width = input("1em")
  readonly height = input("1em")
}
