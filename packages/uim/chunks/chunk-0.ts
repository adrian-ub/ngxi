...
@Component({
  standalone: true,
  selector: 'svg[uimAlignLeftIcon],svg[uim-align-left-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2m4 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2"></svg:path>`,
})
export class UimAlignLeftIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimAlignRightJustifyIcon],svg[uim-align-right-justify-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m0 4H11a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2"></svg:path>`,
})
export class UimAlignRightJustifyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimAmazonIcon],svg[uim-amazon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimAndroidIcon],svg[uim-android-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimAngleRightIcon],svg[uim-angle-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.879 17.243a1 1 0 0 1-.707-1.707L12.707 12L9.172 8.464a1 1 0 0 1 1.414-1.414l4.242 4.243a1 1 0 0 1 0 1.414l-4.242 4.243a1 1 0 0 1-.707.293"></svg:path>`,
})
export class UimAngleRightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimAppleIcon],svg[uim-apple-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimAppleAltIcon],svg[uim-apple-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.594 12.625a4.52 4.52 0 0 1 2.162-3.805a4.67 4.67 0 0 0-3.658-1.984c-1.558-.158-3.04.917-3.83.917c-.789 0-2.008-.894-3.3-.87A4.9 4.9 0 0 0 4.83 9.392c-1.763 3.06-.45 7.593 1.267 10.076c.84 1.214 1.843 2.581 3.158 2.532c1.268-.05 1.746-.82 3.277-.82c1.53 0 1.961.82 3.3.795c1.364-.025 2.229-1.239 3.062-2.457a11 11 0 0 0 1.384-2.845a4.42 4.42 0 0 1-2.684-4.047Z"></svg:path><svg:path fill="currentColor" d="M15.216 5.04A5.56 5.56 0 0 0 16.536 1a5.67 5.67 0 0 0-3.73 1.92l-.02.047a5.56 5.56 0 0 0-1.32 4.04a5.67 5.67 0 0 0 3.73-1.92Z"></svg:path>`,
})
export class UimAppleAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBatteryBoltIcon],svg[uim-battery-bolt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.988 12.059A1.023 1.023 0 0 0 13 11H9.732l1.444-2.5a1 1 0 1 0-1.733-1l-2.31 4A1.022 1.022 0 0 0 8 13h3.268l-1.444 2.5a1 1 0 0 0 1.733 1l2.31-4a1.3 1.3 0 0 0 .121-.441"></svg:path><svg:path fill="currentColor" d="M17 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h6.69a1 1 0 0 1-.866-1.5l1.444-2.5H8a1.022 1.022 0 0 1-.866-1.5l2.31-4a1 1 0 1 1 1.732 1L9.732 11H13a1.023 1.023 0 0 1 .988 1.059a1.3 1.3 0 0 1-.122.441l-2.31 4a1 1 0 0 1-.867.5H17a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2m4 7a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1" opacity=".5"></svg:path>`,
})
export class UimBatteryBoltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBehanceIcon],svg[uim-behance-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimBitcoinIcon],svg[uim-bitcoin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.358 10.575c.197-1.33-.805-2.046-2.175-2.523l.445-1.802l-1.085-.274l-.433 1.755c-.285-.072-.578-.14-.869-.207l.436-1.766l-1.085-.274l-.444 1.802a36 36 0 0 1-.693-.164l.001-.006l-1.496-.378l-.288 1.172s.804.187.788.198c.313.04.537.324.505.638l-1.217 4.938a.394.394 0 0 1-.498.26c.011.017-.788-.198-.788-.198l-.539 1.256l1.412.356c.263.066.52.136.773.201l-.449 1.824l1.084.273l.445-1.804q.443.123.864.227l-.443 1.795l1.085.274l.449-1.82c1.85.354 3.241.211 3.827-1.48a1.933 1.933 0 0 0-.997-2.662a1.74 1.74 0 0 0 1.385-1.61zm-2.479 3.516c-.335 1.362-2.603.626-3.339.44l.596-2.414c.735.185 3.094.553 2.743 1.974m.336-3.535c-.306 1.239-2.194.61-2.806.455l.54-2.19c.612.154 2.584.442 2.266 1.735" opacity=".5"></svg:path><svg:path fill="currentColor" d="m11.949 8.82l-.54 2.191c.612.154 2.5.784 2.806-.455c.318-1.293-1.654-1.581-2.266-1.736m-.813 3.297l-.596 2.415c.736.185 3.004.921 3.34-.441c.35-1.421-2.009-1.789-2.744-1.974"></svg:path><svg:path fill="currentColor" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2m4.358 8.575a1.74 1.74 0 0 1-1.385 1.611a1.933 1.933 0 0 1 .997 2.66c-.586 1.693-1.977 1.836-3.827 1.482l-.449 1.82l-1.085-.274l.443-1.795a35 35 0 0 1-.864-.227l-.445 1.804l-1.084-.273l.45-1.824c-.254-.065-.511-.135-.774-.201l-1.412-.356l.539-1.256s.8.215.788.199l.005.001a.394.394 0 0 0 .493-.262l1.217-4.938a.583.583 0 0 0-.505-.638c.016-.011-.788-.198-.788-.198l.288-1.172l1.496.378l-.001.006q.338.084.693.164l.444-1.802l1.085.274l-.436 1.766c.291.068.584.135.87.207l.432-1.755l1.085.274l-.445 1.802c1.37.477 2.372 1.193 2.175 2.523"></svg:path>`,
})
export class UimBitcoinIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBitcoinAltIcon],svg[uim-bitcoin-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.313 11.24A3.998 3.998 0 0 0 13 5V4a1 1 0 0 0-2 0v1H9V4a1 1 0 0 0-2 0v1H6a1 1 0 0 0 0 2h1v10H6a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h2v1a1 1 0 0 0 2 0v-1h2a3.99 3.99 0 0 0 1.313-7.76M15 9a2 2 0 0 1-2 2H9V7h4a2 2 0 0 1 2 2m0 8H9v-4h6a2 2 0 0 1 0 4"></svg:path>`,
})
export class UimBitcoinAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBlackberryIcon],svg[uim-blackberry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimBloggerIcon],svg[uim-blogger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="m18.333 10.922l-.11-.222l-.178-.14c-.235-.184-1.423.011-1.742-.278c-.228-.208-.263-.584-.33-1.09a3.15 3.15 0 0 0-.362-1.367a4.46 4.46 0 0 0-3.12-2.2H9.667a4.053 4.053 0 0 0-4.042 4.03v4.695a4.05 4.05 0 0 0 4.042 4.025h4.639a4.05 4.05 0 0 0 4.038-4.022l.02-2.675l.005-.579zM9.718 8.917h2.24a.77.77 0 0 1 0 1.541h-2.24a.77.77 0 0 1 0-1.541m4.55 6.125h-4.55a.75.75 0 1 1 0-1.5h4.55a.75.75 0 1 1 0 1.5" clip-rule="evenodd" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14.267 13.542H9.673a.75.75 0 0 0 .045 1.5h4.587a.75.75 0 0 0-.038-1.5m-4.549-3.084h2.24a.77.77 0 1 0 0-1.541h-2.24a.77.77 0 1 0 0 1.541"></svg:path><svg:path fill="currentColor" d="M19.5 2h-15A2.5 2.5 0 0 0 2 4.5v15A2.5 2.5 0 0 0 4.5 22h15a2.5 2.5 0 0 0 2.5-2.5v-15A2.5 2.5 0 0 0 19.5 2m-1.136 9.678l-.02 2.675a4.05 4.05 0 0 1-4.038 4.022h-4.64a4.05 4.05 0 0 1-4.041-4.025V9.656a4.053 4.053 0 0 1 4.042-4.031h2.824a4.46 4.46 0 0 1 3.12 2.2c.222.422.346.89.362 1.367c.067.506.102.882.33 1.09c.32.29 1.507.094 1.742.278l.179.14l.109.222l.036.177z"></svg:path>`,
})
export class UimBloggerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBloggerAltIcon],svg[uim-blogger-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 23H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v16a3.003 3.003 0 0 1-3 3" opacity=".5"></svg:path><svg:path fill="currentColor" d="M16.003 10.002H16V9a4.004 4.004 0 0 0-4-4h-2a5.006 5.006 0 0 0-5 5v4a5.006 5.006 0 0 0 5 5h4a5.006 5.006 0 0 0 5-5v-1a3 3 0 0 0-2.997-2.998M10 9h1a1 1 0 1 1 0 2h-1a1 1 0 1 1 0-2m4 6h-4a1 1 0 1 1 0-2h4a1 1 0 1 1 0 2"></svg:path>`,
})
export class UimBloggerAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBorderClearIcon],svg[uim-border-clear-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="12" cy="16" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="12" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="12" cy="8" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="12" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="4" cy="16" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="4" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="4" cy="8" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="4" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="8" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="16" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="8" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="16" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="8" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="16" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="20" cy="16" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="20" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="20" cy="8" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="12" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="4" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="20" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="20" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle>`,
})
export class UimBorderClearIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimBorderVerticalIcon],svg[uim-border-vertical-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 21a1 1 0 0 1-1-1V4a1 1 0 0 1 2 0v16a1 1 0 0 1-1 1"></svg:path><svg:circle cx="7" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="3" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="15" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="19" cy="12" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="7" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="3" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="15" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="19" cy="4" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="19" cy="8" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="19" cy="16" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="3" cy="8" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="3" cy="16" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="7" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="3" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="15" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle><svg:circle cx="19" cy="20" r="1" fill="currentColor" opacity=".5"></svg:circle>`,
})
export class UimBorderVerticalIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCalenderIcon],svg[uim-calender-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimCircleIcon],svg[uim-circle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimCircleLayerIcon],svg[uim-circle-layer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 2a7 7 0 0 0-6.88 5.737a6 6 0 0 1 8.143 8.143A6.997 6.997 0 0 0 15 2" opacity=".25"></svg:path><svg:circle cx="7" cy="17" r="5" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M11 7a6 6 0 0 0-5.97 5.406a4.997 4.997 0 0 1 6.564 6.564A6 6 0 0 0 11 7" opacity=".5"></svg:path>`,
})
export class UimCircleLayerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimClinicMedicalIcon],svg[uim-clinic-medical-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 12a1 1 0 0 1-.664-.252L12 4.338l-8.336 7.41a1 1 0 0 1-1.328-1.496l9-8a1 1 0 0 1 1.328 0l9 8A1 1 0 0 1 21 12" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14 13h-1v-1a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="m12 4.338l-8 7.111V21a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-9.551ZM14 15h-1v1a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2" opacity=".25"></svg:path>`,
})
export class UimClinicMedicalIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCommentAltPlusIcon],svg[uim-comment-alt-plus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 9h-2V7a1 1 0 0 0-2 0v2H9a1 1 0 0 0 0 2h2v2a1 1 0 0 0 2 0v-2h2a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="M19 2H5a3.003 3.003 0 0 0-3 3v10a3.003 3.003 0 0 0 3 3h11.586l3.707 3.707A1 1 0 0 0 22 21V5a3.003 3.003 0 0 0-3-3m-4 9h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V7a1 1 0 0 1 2 0v2h2a1 1 0 0 1 0 2" opacity=".5"></svg:path>`,
})
export class UimCommentAltPlusIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCompressIcon],svg[uim-compress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 22a1 1 0 0 1-1-1v-4H3a1 1 0 0 1 0-2h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1M8 9H3a1 1 0 0 1 0-2h4V3a1 1 0 0 1 2 0v5a1 1 0 0 1-1 1m13 0h-5a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v4h4a1 1 0 0 1 0 2m-5 13a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2h-4v4a1 1 0 0 1-1 1"></svg:path>`,
})
export class UimCompressIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCornerDownRightIcon],svg[uim-corner-down-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14.058 22a1 1 0 0 1-.707-1.707l3.92-3.921l-3.92-3.922a1 1 0 1 1 1.414-1.414l4.628 4.629a1 1 0 0 1 0 1.414l-4.628 4.628a1 1 0 0 1-.707.293"></svg:path><svg:path fill="currentColor" d="M18.686 17.372H9.314a5.006 5.006 0 0 1-5-5V3a1 1 0 0 1 2 0v9.372a3.003 3.003 0 0 0 3 3h9.372a1 1 0 0 1 0 2"></svg:path>`,
})
export class UimCornerDownRightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCornerLeftDownIcon],svg[uim-corner-left-down-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 4.314h-9.372a5.006 5.006 0 0 0-5 5v6.957l-2.921-2.92a1 1 0 0 0-1.414 1.413l4.628 4.628a1.003 1.003 0 0 0 1.415 0l4.628-4.628a1 1 0 0 0-1.414-1.414l-2.922 2.922V9.314a3.003 3.003 0 0 1 3-3H21a1 1 0 0 0 0-2"></svg:path>`,
})
export class UimCornerLeftDownIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCornerUpRightIcon],svg[uim-corner-up-right-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.608 8.01a1 1 0 0 0-.216-1.089l-4.628-4.628a1 1 0 0 0-1.414 1.414l2.921 2.921H8.314a4.005 4.005 0 0 0-4 4V21a1 1 0 0 0 2 0V10.628a2 2 0 0 1 2-2h7.958L13.35 11.55a1 1 0 1 0 1.414 1.414l4.628-4.628a1 1 0 0 0 .216-.325Z"></svg:path>`,
})
export class UimCornerUpRightIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimCss3SimpleIcon],svg[uim-css3-simple-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class UimCss3SimpleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimDiscordIcon],svg[uim-discord-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.891 2H5.11A2.114 2.114 0 0 0 3 4.119v13.906a2.114 2.114 0 0 0 2.109 2.119h11.664l-.546-1.903l1.317 1.224l1.245 1.152L21 22.571V4.12A2.114 2.114 0 0 0 18.891 2m-3.97 13.433s-.37-.442-.679-.833a3.25 3.25 0 0 0 1.862-1.224a6 6 0 0 1-1.183.607a6.8 6.8 0 0 1-1.491.442a7.2 7.2 0 0 1-2.664-.01a8.6 8.6 0 0 1-1.512-.442a6 6 0 0 1-.751-.35c-.031-.02-.062-.031-.093-.052a.1.1 0 0 1-.04-.03a4 4 0 0 1-.289-.175a3.2 3.2 0 0 0 1.8 1.213c-.308.391-.689.854-.689.854a3.73 3.73 0 0 1-3.137-1.563a13.8 13.8 0 0 1 1.481-5.997a5.1 5.1 0 0 1 2.89-1.08l.103.124a6.9 6.9 0 0 0-2.705 1.347s.226-.123.607-.298a7.7 7.7 0 0 1 2.335-.648a1 1 0 0 1 .175-.02a8.7 8.7 0 0 1 2.077-.021a8.4 8.4 0 0 1 3.096.987a6.85 6.85 0 0 0-2.56-1.306l.143-.165a5.1 5.1 0 0 1 2.89 1.08a13.8 13.8 0 0 1 1.482 5.997a3.76 3.76 0 0 1-3.148 1.563m-1.028-4.803a1.146 1.146 0 1 0 1.049 1.141a1.096 1.096 0 0 0-1.05-1.141"></svg:path><svg:path fill="currentColor" d="M14.921 15.433s-.37-.442-.679-.833a3.25 3.25 0 0 0 1.862-1.224a6 6 0 0 1-1.183.607a6.8 6.8 0 0 1-1.491.442a7.2 7.2 0 0 1-2.664-.01a8.6 8.6 0 0 1-1.512-.442a6 6 0 0 1-.751-.35c-.031-.02-.062-.031-.093-.052a.1.1 0 0 1-.04-.03a4 4 0 0 1-.289-.175a3.2 3.2 0 0 0 1.8 1.213c-.308.391-.689.854-.689.854a3.73 3.73 0 0 1-3.137-1.563a13.8 13.8 0 0 1 1.481-5.997a5.1 5.1 0 0 1 2.89-1.08l.103.124a6.9 6.9 0 0 0-2.705 1.347s.226-.123.607-.298a7.7 7.7 0 0 1 2.335-.648a1 1 0 0 1 .175-.02a8.7 8.7 0 0 1 2.077-.021a8.4 8.4 0 0 1 3.096.987a6.85 6.85 0 0 0-2.56-1.306l.143-.165a5.1 5.1 0 0 1 2.89 1.08a13.8 13.8 0 0 1 1.482 5.997a3.76 3.76 0 0 1-3.148 1.563m-1.028-4.803a1.146 1.146 0 1 0 1.049 1.141a1.096 1.096 0 0 0-1.05-1.141" opacity=".25"></svg:path>`,
})
export class UimDiscordIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimDockerIcon],svg[uim-docker-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimDribbbleIcon],svg[uim-dribbble-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="11.97" cy="11.97" r="9" fill="currentColor" opacity=".5"></svg:circle><svg:path fill="currentColor" d="M2 12a9.8 9.8 0 0 1 1.34-5.02a9.93 9.93 0 0 1 3.64-3.64A9.8 9.8 0 0 1 12 2a9.8 9.8 0 0 1 5.02 1.34a9.93 9.93 0 0 1 3.64 3.64A9.8 9.8 0 0 1 22 12a9.8 9.8 0 0 1-1.34 5.02a9.93 9.93 0 0 1-3.64 3.64A9.8 9.8 0 0 1 12 22a9.8 9.8 0 0 1-5.02-1.34a9.93 9.93 0 0 1-3.64-3.64A9.8 9.8 0 0 1 2 12m1.66 0a8.06 8.06 0 0 0 2.1 5.5c.755-1.39 1.79-2.61 3.04-3.58a9.94 9.94 0 0 1 4.06-2.14q-.3-.7-.58-1.26a24.3 24.3 0 0 1-7.44 1.1q-.78 0-1.16-.02q0 .08-.01.2c-.01.12-.01.147-.01.2m.26-2.06q.44.04 1.3.04a22 22 0 0 0 6.34-.9a20.3 20.3 0 0 0-3.34-4.5A8.1 8.1 0 0 0 5.51 6.8a8.5 8.5 0 0 0-1.59 3.14m2.98 8.64a8.17 8.17 0 0 0 8.04 1.2a29.4 29.4 0 0 0-1.56-6.62a8.5 8.5 0 0 0-3.71 2.02a11.4 11.4 0 0 0-2.77 3.4M9.96 3.94a21.3 21.3 0 0 1 3.26 4.54a9.96 9.96 0 0 0 4.1-2.9A8.1 8.1 0 0 0 12 3.66a7.7 7.7 0 0 0-2.04.28m3.98 5.96q.3.64.68 1.62q1.48-.14 3.22-.14q1.24 0 2.46.06a8.03 8.03 0 0 0-1.96-4.84a9.9 9.9 0 0 1-4.4 3.3m1.18 3.02c.68 1.97 1.142 4.01 1.38 6.08a8.35 8.35 0 0 0 2.58-2.62a8.1 8.1 0 0 0 1.2-3.46q-1.46-.1-2.66-.1q-1.1 0-2.5.1"></svg:path>`,
})
export class UimDribbbleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimDropboxIcon],svg[uim-dropbox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" fill-rule="evenodd" d="M16.53 10.091L21 12.939l-4.502 2.868L12 12.941l-4.498 2.866L3 12.939l4.47-2.848L3 7.243l4.502-2.868L12 7.241l4.498-2.866L21 7.243z" clip-rule="evenodd"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="M16.467 10.091L12 7.245l-4.467 2.846L12 12.936z" clip-rule="evenodd" opacity=".25"></svg:path><svg:path fill="currentColor" fill-rule="evenodd" d="m7.531 16.757l-.029-.95L12 12.941l4.498 2.866l.036.95l-4.502 2.868z" clip-rule="evenodd" opacity=".5"></svg:path>`,
})
export class UimDropboxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimEntryIcon],svg[uim-entry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimFacebookIcon],svg[uim-facebook-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimFacebookFIcon],svg[uim-facebook-f-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.355 22v-9.123h3.062l.459-3.555h-3.52v-2.27c0-1.03.285-1.731 1.761-1.731L17 5.32V2.14A25 25 0 0 0 14.257 2c-2.715 0-4.573 1.657-4.573 4.7v2.622h-3.07v3.555h3.07V22z"></svg:path>`,
})
export class UimFacebookFIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFacebookMessengerIcon],svg[uim-facebook-messenger-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimFacebookMessengerAltIcon],svg[uim-facebook-messenger-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2a9.65 9.65 0 0 0-10 9.7a9.5 9.5 0 0 0 3.14 7.175a.8.8 0 0 1 .27.57l.055 1.779a.8.8 0 0 0 1.122.708l1.984-.875a.8.8 0 0 1 .534-.04A11 11 0 0 0 12 21.4A9.705 9.705 0 1 0 12 2" opacity=".5"></svg:path><svg:path fill="currentColor" d="M6.499 14.772a1 1 0 0 1-.765-1.642l3.052-3.636a.996.996 0 0 1 1.29-.21l3.346 2.056l2.312-2.755a1 1 0 1 1 1.532 1.285l-2.867 3.416a1 1 0 0 1-1.289.21L9.764 11.44l-2.498 2.975a1 1 0 0 1-.767.357"></svg:path>`,
})
export class UimFacebookMessengerAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFavoriteIcon],svg[uim-favorite-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.562 21.56a1 1 0 0 1-.465-.116L12 18.764l-5.097 2.68a1 1 0 0 1-1.45-1.053l.973-5.676l-4.124-4.02a1 1 0 0 1 .554-1.705l5.699-.828l2.549-5.164a1.04 1.04 0 0 1 1.793 0l2.548 5.164l5.699.828a1 1 0 0 1 .554 1.705l-4.124 4.02l.974 5.676a1 1 0 0 1-.985 1.169Z"></svg:path>`,
})
export class UimFavoriteIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFlipHIcon],svg[uim-flip-h-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 13H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2" opacity=".25"></svg:path><svg:path fill="currentColor" d="m12 21l5-5H7z"></svg:path><svg:path fill="currentColor" d="M12 22a1 1 0 0 1-.707-.293l-5-5A1 1 0 0 1 7 15h10a1 1 0 0 1 .707 1.707l-5 5A1 1 0 0 1 12 22m-2.586-5L12 19.586L14.586 17Z"></svg:path><svg:path fill="currentColor" d="M12 4a.99.99 0 0 1-.92-1.38a1 1 0 0 1 .21-.33a1 1 0 0 1 1.09-.21a1 1 0 0 1 .33.21A1.05 1.05 0 0 1 13 3a.84.84 0 0 1-.08.38a1.2 1.2 0 0 1-.21.33A1 1 0 0 1 12 4M8.79 6.21a1.01 1.01 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.01 1.01 0 0 1 0 1.42a1.03 1.03 0 0 1-.71.29a1.03 1.03 0 0 1-.71-.29M7 9a.99.99 0 0 1-1-1a1 1 0 0 1 1.71-.71A1.05 1.05 0 0 1 8 8a.99.99 0 0 1-1 1m5.67-1a.997.997 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a.997.997 0 0 1-1-1M9.33 8a1.003 1.003 0 0 1 1-1a.997.997 0 0 1 1 1a.997.997 0 0 1-1 1a1.003 1.003 0 0 1-1-1M17 9a.99.99 0 0 1-1-1a1 1 0 1 1 2 0a.99.99 0 0 1-1 1m-3.21-2.79a1.01 1.01 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.01 1.01 0 0 1 0 1.42a1.03 1.03 0 0 1-.71.29a1.03 1.03 0 0 1-.71-.29" opacity=".5"></svg:path>`,
})
export class UimFlipHIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFlipHAltIcon],svg[uim-flip-h-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 11a1 1 0 0 1-.71-.29a1.2 1.2 0 0 1-.21-.33a.94.94 0 0 1 0-.76a1 1 0 0 1 .21-.33a1.047 1.047 0 0 1 1.42 0a1.2 1.2 0 0 1 .21.33a.94.94 0 0 1 0 .76a1.2 1.2 0 0 1-.21.33A1 1 0 0 1 20 11m-1-4.5a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1M20 4a.99.99 0 0 1-.92-1.38a1 1 0 0 1 .21-.33a1.047 1.047 0 0 1 1.42 0a1 1 0 0 1 .21.33a.99.99 0 0 1-.21 1.09a1.2 1.2 0 0 1-.33.21A1 1 0 0 1 20 4M7.03 6.24a.994.994 0 0 1 .73-1.21a.99.99 0 0 1 1.21.73a1 1 0 0 1-.73 1.21A1 1 0 0 1 8 7a.99.99 0 0 1-.97-.76m4-1a.994.994 0 0 1 .73-1.21a.99.99 0 0 1 1.21.73a1 1 0 0 1-.73 1.21A1 1 0 0 1 12 6a1 1 0 0 1-.97-.76m4-1a1 1 0 0 1 .73-1.21a1.003 1.003 0 0 1 1.21.73a1 1 0 0 1-.73 1.21A1 1 0 0 1 16 5a.99.99 0 0 1-.97-.76M4 8a.99.99 0 0 1-1-1a.8.8 0 0 1 .08-.38a1 1 0 0 1 .21-.33a1.047 1.047 0 0 1 1.42 0a1 1 0 0 1 .21.33A.99.99 0 0 1 4 8m0 3a1 1 0 0 1-.71-.29a1.2 1.2 0 0 1-.21-.33a.94.94 0 0 1 0-.76a1.2 1.2 0 0 1 .21-.33a1.047 1.047 0 0 1 1.42 0a1.2 1.2 0 0 1 .21.33a.94.94 0 0 1 0 .76a1.2 1.2 0 0 1-.21.33A1 1 0 0 1 4 11m11-1a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1m-4 0a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1m-4 0a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20 14v7L4 17v-3z"></svg:path><svg:path fill="currentColor" d="M20 22a1 1 0 0 1-.242-.03l-16-4A1 1 0 0 1 3 17v-3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1M5 16.219l14 3.5V15H5Z"></svg:path>`,
})
export class UimFlipHAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFlipVIcon],svg[uim-flip-v-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1" opacity=".25"></svg:path><svg:path fill="currentColor" d="m21 12l-5-5v10z"></svg:path><svg:path fill="currentColor" d="M16 18a1 1 0 0 1-1-1V7a1 1 0 0 1 1.707-.707l5 5a1 1 0 0 1 0 1.414l-5 5A1 1 0 0 1 16 18m1-8.586v5.172L19.586 12Z"></svg:path><svg:path fill="currentColor" d="M3 13a.99.99 0 0 1-.92-1.38a1.2 1.2 0 0 1 .21-.33a1.047 1.047 0 0 1 1.42 0a1 1 0 0 1 .21.33A.84.84 0 0 1 4 12a.99.99 0 0 1-1 1m1.79 2.21a1.01 1.01 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.01 1.01 0 0 1 0 1.42a1.03 1.03 0 0 1-.71.29a1.03 1.03 0 0 1-.71-.29M8 18a1 1 0 0 1-.71-.29a1.2 1.2 0 0 1-.21-.33A1 1 0 0 1 7 17a1.05 1.05 0 0 1 .29-.71a1.04 1.04 0 0 1 1.09-.21a1.2 1.2 0 0 1 .33.21A1.05 1.05 0 0 1 9 17a1 1 0 0 1-.08.38a1.2 1.2 0 0 1-.21.33A1 1 0 0 1 8 18m-1-4.33a.996.996 0 0 1 1-1a.996.996 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1m0-3.34a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a.997.997 0 0 1-1 1a.997.997 0 0 1-1-1M8 8a.99.99 0 0 1-.92-1.38a1 1 0 0 1 .21-.33a.985.985 0 0 1 1.63.33A.99.99 0 0 1 8 8m-3.21 2.21a1.01 1.01 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.01 1.01 0 0 1 0 1.42a1.03 1.03 0 0 1-.71.29a1.03 1.03 0 0 1-.71-.29" opacity=".5"></svg:path>`,
})
export class UimFlipVIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimFlipVAltIcon],svg[uim-flip-v-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10 21a1 1 0 0 1-.71-.29a1.2 1.2 0 0 1-.21-.33A.8.8 0 0 1 9 20a1 1 0 1 1 2 0a.99.99 0 0 1-1 1m-4.5-1a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1M3 21a1 1 0 0 1-.71-.29a1.2 1.2 0 0 1-.21-.33A1 1 0 0 1 2 20a1.05 1.05 0 0 1 .29-.71a1.047 1.047 0 0 1 1.42 0A1.05 1.05 0 0 1 4 20a1 1 0 0 1-.08.38a1.2 1.2 0 0 1-.21.33A1 1 0 0 1 3 21m.76-4.03a1 1 0 0 1-.73-1.21a.994.994 0 0 1 1.21-.73a1 1 0 0 1 .73 1.21A.99.99 0 0 1 4 17a1 1 0 0 1-.24-.03m.99-4a.99.99 0 0 1-.72-1.21a1 1 0 0 1 1.21-.73a1 1 0 0 1 .73 1.21A1 1 0 0 1 5 13a1 1 0 0 1-.25-.03m1.01-4a1 1 0 0 1-.73-1.21a.994.994 0 0 1 1.21-.73a1 1 0 0 1 .73 1.21A.99.99 0 0 1 6 9a1 1 0 0 1-.24-.03M7 5a.99.99 0 0 1-1-1a1.05 1.05 0 0 1 .29-.71a1.034 1.034 0 0 1 1.41 0A1.02 1.02 0 0 1 8 4a1.007 1.007 0 0 1-1 1m3 0a.99.99 0 0 1-1-1a1.05 1.05 0 0 1 .29-.71a1.047 1.047 0 0 1 1.42 0A1.05 1.05 0 0 1 11 4a.99.99 0 0 1-1 1M9 16a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1m0-4a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1m0-4a1.003 1.003 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a1.003 1.003 0 0 1-1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14 20h7L17 4h-3z"></svg:path><svg:path fill="currentColor" d="M21 21h-7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h3a1 1 0 0 1 .97.758l4 16A1 1 0 0 1 21 21m-6-2h4.719l-3.5-14H15Z"></svg:path>`,
})
export class UimFlipVAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGithubIcon],svg[uim-github-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.854 21.57a9.9 9.9 0 0 0 6.29.001a.493.493 0 0 1-.644-.475c0-.338.013-1.413.013-2.75a2.37 2.37 0 0 0-.675-1.85c2.225-.25 4.562-1.1 4.562-4.938a3.87 3.87 0 0 0-1.025-2.687a3.6 3.6 0 0 0-.1-2.65s-.838-.275-2.75 1.025a9.43 9.43 0 0 0-5 0C7.612 5.958 6.775 6.22 6.775 6.22a3.6 3.6 0 0 0-.1 2.65a3.9 3.9 0 0 0-1.025 2.687c0 3.825 2.325 4.688 4.55 4.938a2.1 2.1 0 0 0-.638 1.337a2.137 2.137 0 0 1-2.91-.82l-.002-.005a2 2 0 0 0-1.538-1.025c-.837.013-.337.475.013.663c.451.38.803.865 1.025 1.412c.2.563.85 1.638 3.362 1.175c0 .838.013 1.625.013 1.863c0 .259-.185.551-.67.475z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M12 2.083c-5.523 0-10 4.477-10 10c0 4.423 2.875 8.169 6.855 9.488c.485.075.67-.216.67-.475c0-.238-.012-1.025-.012-1.863c-2.513.463-3.163-.612-3.363-1.175a3.64 3.64 0 0 0-1.025-1.412c-.35-.188-.85-.65-.013-.663a2 2 0 0 1 1.538 1.025l.003.006a2.137 2.137 0 0 0 2.91.82c.043-.51.27-.984.637-1.338c-2.225-.25-4.55-1.113-4.55-4.938a3.9 3.9 0 0 1 1.025-2.687a3.6 3.6 0 0 1 .1-2.65s.837-.263 2.75 1.025a9.43 9.43 0 0 1 5 0c1.912-1.3 2.75-1.025 2.75-1.025c.37.838.406 1.786.1 2.65a3.87 3.87 0 0 1 1.025 2.687c0 3.838-2.338 4.688-4.562 4.938c.482.49.729 1.164.675 1.85c0 1.337-.013 2.412-.013 2.75a.493.493 0 0 0 .643.476C19.124 20.253 22 16.507 22 12.083c0-5.523-4.477-10-10-10"></svg:path>`,
})
export class UimGithubIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGithubAltIcon],svg[uim-github-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimGitlabIcon],svg[uim-gitlab-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimGitlabAltIcon],svg[uim-gitlab-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m12 21.42l3.684-11.333H8.32z"></svg:path><svg:path fill="currentColor" d="m3.16 10.087l-1.123 3.444a.76.76 0 0 0 .277.852l9.685 7.038z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M3.16 10.087h5.16L6.1 3.262a.383.383 0 0 0-.728 0z"></svg:path><svg:path fill="currentColor" d="m20.845 10.087l1.118 3.444a.76.76 0 0 1-.276.852l-9.688 7.038z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M20.845 10.087h-5.161L17.9 3.262a.383.383 0 0 1 .727 0l2.217 6.825Z"></svg:path><svg:path fill="currentColor" d="m11.999 21.421l3.685-11.334h5.161zm0 0l-8.84-11.334H8.32z" opacity=".5"></svg:path>`,
})
export class UimGitlabAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGoogleIcon],svg[uim-google-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.222 5.977a5.4 5.4 0 0 1 3.823 1.496l2.868-2.868A9.6 9.6 0 0 0 12.222 2a10 10 0 0 0-8.937 5.51l3.341 2.59a5.96 5.96 0 0 1 5.596-4.123" opacity=".7"></svg:path><svg:path fill="currentColor" d="M3.285 7.51a10.01 10.01 0 0 0 0 8.98l3.341-2.59a5.9 5.9 0 0 1 0-3.8z"></svg:path><svg:path fill="currentColor" d="M15.608 17.068A6.033 6.033 0 0 1 6.626 13.9l-3.34 2.59A10 10 0 0 0 12.221 22a9.55 9.55 0 0 0 6.618-2.423z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M21.64 10.182h-9.418v3.868h5.382a4.6 4.6 0 0 1-1.996 3.018l-.01.006l.01-.006l3.232 2.51a9.75 9.75 0 0 0 2.982-7.35q0-1.032-.182-2.046" opacity=".25"></svg:path>`,
})
export class UimGoogleIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGoogleHangoutsIcon],svg[uim-google-hangouts-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.818 14.313a4 4 0 0 1-.447.085a.21.21 0 0 1-.235-.152v-.968c.006-.095-.032-.197.044-.28a.27.27 0 0 1 .138-.085q.261-.048.495-.169c.273-.158.468-.423.538-.731l.035-.151l-2.041-.004a.7.7 0 0 1-.175-.018a.41.41 0 0 1-.306-.385q-.001-1.543.001-3.087a.47.47 0 0 1 .139-.436a.4.4 0 0 1 .256-.102h3.002a.416.416 0 0 1 .4.527q.022.076.016.153c0 1.122.006 2.243-.002 3.364a2.5 2.5 0 0 1-.84 1.878l-.084.08c-.277.22-.594.384-.934.481m5.536-.071l-.038.01l-.022.013q-.29.084-.589.129a.216.216 0 0 1-.27-.217l-.002-.322l.005-.578l-.002-.127c0-.147.057-.21.24-.252c.235-.04.454-.142.634-.297a1.26 1.26 0 0 0 .378-.74l-1.886-.003h-.205a.42.42 0 0 1-.433-.44q0-1.524.003-3.049l-.002-.03a.435.435 0 0 1 .204-.45a.4.4 0 0 1 .212-.06h2.982a.416.416 0 0 1 .4.528q.022.075.016.153v3.37a2.56 2.56 0 0 1-1.557 2.327q-.034.016-.068.035" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20.866 9.055a8.5 8.5 0 0 0-2.173-4.334a8.57 8.57 0 0 0-5.263-2.667A4 4 0 0 1 12.95 2h-1.135c-.013.029-.039.018-.06.02a9 9 0 0 0-.87.114a8.45 8.45 0 0 0-5.177 3.104a8.36 8.36 0 0 0-1.84 4.709a8.6 8.6 0 0 0 .185 2.529c.138.618.347 1.22.624 1.79l.074.146a8.6 8.6 0 0 0 1.783 2.396a8.53 8.53 0 0 0 5.763 2.333c.1.001.128.026.127.128c-.005.874-.003 1.747-.002 2.621q0 .049.004.11l.063-.026a18 18 0 0 0 4.49-2.966q.402-.364.77-.763l.315-.341c.163-.175.304-.37.457-.553c.178-.212.337-.437.494-.663q.526-.75.919-1.575q.2-.417.369-.847l.01-.016c.3-.786.502-1.605.601-2.44a12 12 0 0 0 .075-.877a8 8 0 0 0-.123-1.878m-9.19 2.82a2.5 2.5 0 0 1-.84 1.877l-.084.08c-.277.22-.594.384-.934.481a4 4 0 0 1-.447.085a.21.21 0 0 1-.235-.152v-.968c.006-.095-.032-.197.044-.28a.27.27 0 0 1 .138-.085q.26-.048.495-.169c.273-.158.468-.423.538-.731l.035-.151l-2.041-.003a.7.7 0 0 1-.175-.019a.41.41 0 0 1-.306-.385a870 870 0 0 1 .001-3.087a.47.47 0 0 1 .139-.436c.07-.064.161-.1.256-.102h3.002a.416.416 0 0 1 .4.527q.022.076.016.153c0 1.122.006 2.243-.002 3.364zm5.303.004a2.56 2.56 0 0 1-1.557 2.328q-.034.016-.068.035l-.038.01l-.022.013q-.29.084-.589.129a.216.216 0 0 1-.27-.217l-.002-.322l.005-.578l-.002-.127c0-.147.057-.21.24-.252c.235-.04.454-.142.634-.297a1.26 1.26 0 0 0 .378-.74l-1.886-.003h-.205a.42.42 0 0 1-.433-.44q0-1.524.003-3.049l-.002-.03a.435.435 0 0 1 .204-.45a.4.4 0 0 1 .212-.06h2.982a.416.416 0 0 1 .4.528q.022.075.016.153z"></svg:path>`,
})
export class UimGoogleHangoutsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGooglePlayIcon],svg[uim-google-play-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m14.556 12.895l2.573 2.554l3.785-2.186c.506-.253.83-.766.842-1.332a1.47 1.47 0 0 0-.837-1.275a512 512 0 0 1-4.023-2.323l-.002-.002L4.639 1.256a1.64 1.64 0 0 0-1.657-.06q-.075.051-.142.111z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20.919 10.656a505 505 0 0 1-3.791-2.188l-2.597 2.577L2.785 22.698q.073.066.153.12c.21.12.446.182.687.181c.292-.004.578-.084.83-.232c.389-.226 12.439-7.182 12.439-7.182l4.02-2.322c.506-.253.83-.766.842-1.332a1.47 1.47 0 0 0-.837-1.275" opacity=".7"></svg:path><svg:path fill="currentColor" d="M13.61 11.96L2.84 1.309a1.51 1.51 0 0 0-.597 1.252v18.985c-.013.452.197.871.543 1.15z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M20.919 10.656c-.744-.4-3.37-1.944-3.791-2.188l-2.597 2.577l-.921.914l.946.936l2.573 2.554l3.785-2.186c.506-.253.83-.766.842-1.332a1.47 1.47 0 0 0-.837-1.275"></svg:path>`,
})
export class UimGooglePlayIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGridsIcon],svg[uim-grids-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23 21V3a1 1 0 0 0-1-1h-5v20h5a1 1 0 0 0 1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M1 3v18a1 1 0 0 0 1 1h5V2H2a1 1 0 0 0-1 1"></svg:path><svg:path fill="currentColor" d="M9 2h6v20H9z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M7 2h2v20H7zm8 0h2v20h-2z" opacity=".25"></svg:path>`,
})
export class UimGridsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimGripHorizontalLineIcon],svg[uim-grip-horizontal-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 11H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2"></svg:path>`,
})
export class UimGripHorizontalLineIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHeadSideIcon],svg[uim-head-side-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.5 22h-9a1 1 0 0 1-1-1v-2h-1a2 2 0 0 1-2-2v-2h-1a1 1 0 0 1-.904-1.426L5.5 9.53V9.5a7.44 7.44 0 0 1 2.277-5.383a7.37 7.37 0 0 1 5.453-2.114a7.7 7.7 0 0 1 7.27 7.77V10a1 1 0 0 1-.033.256l-1.93 7.266l.924 3.2A1 1 0 0 1 18.5 22" opacity=".5"></svg:path>`,
})
export class UimHeadSideIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHeadSideMaskIcon],svg[uim-head-side-mask-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20.476 9.287L12.337 12H4.5a1 1 0 0 0-.938 1.348l1.448 3.895a1 1 0 0 0 .043.099A2.98 2.98 0 0 0 7.736 19H12.5a1 1 0 0 0 .32-.052l5.864-1.978l.616-2.319l-5.8 1.956v-2.886l6.634-2.211l.333-1.254A1 1 0 0 0 20.5 10v-.228c0-.163-.014-.324-.024-.485"></svg:path><svg:path fill="currentColor" d="M3.508 12.894v.03zm.17-.465A1 1 0 0 1 4.5 12h7.837l8.14-2.713a7.676 7.676 0 0 0-7.247-7.284a7.36 7.36 0 0 0-5.453 2.114A7.44 7.44 0 0 0 5.5 9.465l-1.852 3.011c-.005.009-.004.02-.01.03c.015-.026.024-.053.04-.077m9.822 1.292v2.886l5.8-1.956l1.167-4.395l-.333 1.254zm5.037 3.801l.2-.754l-.053.202l-5.865 1.978A1 1 0 0 1 12.5 19h-4v2a1 1 0 0 0 1 1h9a1 1 0 0 0 .96-1.277Z" opacity=".5"></svg:path>`,
})
export class UimHeadSideMaskIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHipchatIcon],svg[uim-hipchat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.544 19.985a.2.2 0 0 1 .048.116c0 .058-.055.098-.124.098a7.5 7.5 0 0 1-2.857-1.518a.54.54 0 0 0-.488-.08a10 10 0 0 1-2.123.227c-4.597 0-8.323-3.076-8.323-6.873c0-3.794 3.726-6.87 8.323-6.87s8.323 3.076 8.323 6.87a6.57 6.57 0 0 1-3.374 5.526a.55.55 0 0 0-.282.438a4.7 4.7 0 0 0 .877 2.066" opacity=".25"></svg:path><svg:path fill="currentColor" d="M17.462 13.869a.4.4 0 0 0-.399-.398a.4.4 0 0 0-.263.101a7.32 7.32 0 0 1-4.796 1.711h-.008a7.62 7.62 0 0 1-4.796-1.71a.5.5 0 0 0-.272-.094a.405.405 0 0 0-.39.44a.93.93 0 0 0 .228.481a6.45 6.45 0 0 0 5.212 2.408h.044a6.45 6.45 0 0 0 5.212-2.408a1.1 1.1 0 0 0 .228-.531"></svg:path><svg:path fill="currentColor" d="M17.544 19.985a.2.2 0 0 1 .048.116c0 .058-.055.098-.124.098a7.5 7.5 0 0 1-2.857-1.518a.54.54 0 0 0-.488-.08a10 10 0 0 1-2.123.227c-4.597 0-8.323-3.076-8.323-6.873c0-3.794 3.726-6.87 8.323-6.87s8.323 3.076 8.323 6.87a6.57 6.57 0 0 1-3.374 5.526a.55.55 0 0 0-.282.438a4.7 4.7 0 0 0 .877 2.066m2.676.839a3.67 3.67 0 0 1-1.684-2.015a.37.37 0 0 1 .134-.44A8.14 8.14 0 0 0 22 11.941c0-4.765-4.477-8.627-10-8.627S2 7.176 2 11.941c0 4.767 4.477 8.63 10 8.63a11.6 11.6 0 0 0 2.104-.192a.56.56 0 0 1 .412.077A10.76 10.76 0 0 0 19.71 22a.703.703 0 0 0 .798-.698a.54.54 0 0 0-.288-.478"></svg:path>`,
})
export class UimHipchatIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHistoryAltIcon],svg[uim-history-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2a10.02 10.02 0 0 0-7 2.877V3a1 1 0 0 0-2 0v4.5a1 1 0 0 0 1 1h4.5a1 1 0 0 0 0-2H6.218A7.992 7.992 0 1 1 12 20a1 1 0 0 0 0 2a10 10 0 0 0 0-20"></svg:path><svg:path fill="currentColor" d="M14 13h-2a1 1 0 0 1-1-1V9a1 1 0 0 1 2 0v2h1a1 1 0 0 1 0 2"></svg:path><svg:path fill="currentColor" d="M12 4a8 8 0 0 0-5.782 2.5H8.5a1 1 0 0 1 0 2H4a.99.99 0 0 1-.976-.88A9.977 9.977 0 0 0 12 22a1 1 0 0 1 0-2a8 8 0 0 0 0-16m2 9h-2a1 1 0 0 1-1-1V9a1 1 0 0 1 2 0v2h1a1 1 0 0 1 0 2" opacity=".5"></svg:path>`,
})
export class UimHistoryAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHospitalIcon],svg[uim-hospital-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.5 14.5h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m-5-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m10-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2" opacity=".5"></svg:path><svg:path fill="currentColor" d="M13.5 7H13v-.5a1 1 0 0 0-2 0V7h-.5a1 1 0 0 0 0 2h.5v.5a1 1 0 0 0 2 0V9h.5a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="M21.5 6.5h-3v-4a1 1 0 0 0-1-1h-11a1 1 0 0 0-1 1v4h-3a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h19a1 1 0 0 0 1-1v-14a1 1 0 0 0-1-1m-14 12h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m5 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m1-5.5H13v.5a1 1 0 0 1-2 0V9h-.5a1 1 0 0 1 0-2h.5v-.5a1 1 0 0 1 2 0V7h.5a1 1 0 0 1 0 2m4 9.5h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2m0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2" opacity=".25"></svg:path>`,
})
export class UimHospitalIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHouseUserIcon],svg[uim-house-user-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 18a3.5 3.5 0 1 1 3.5-3.5A3.504 3.504 0 0 1 12 18" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14.64 16.772a3.452 3.452 0 0 1-5.28 0A4.99 4.99 0 0 0 7 21a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1a4.99 4.99 0 0 0-2.36-4.228"></svg:path><svg:path fill="currentColor" d="M21 12a1 1 0 0 1-.664-.252L12 4.338l-8.336 7.41a1 1 0 0 1-1.328-1.496l9-8a1 1 0 0 1 1.328 0l9 8A1 1 0 0 1 21 12" opacity=".5"></svg:path><svg:path fill="currentColor" d="m12 4.338l-8 7.111V21a1 1 0 0 0 1 1h3a1 1 0 0 1-1-1a4.99 4.99 0 0 1 2.36-4.228A3.47 3.47 0 0 1 8.5 14.5a3.5 3.5 0 0 1 7 0a3.47 3.47 0 0 1-.86 2.272A4.99 4.99 0 0 1 17 21a1 1 0 0 1-1 1h3a1 1 0 0 0 1-1v-9.551Z" opacity=".25"></svg:path>`,
})
export class UimHouseUserIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHtml3Icon],svg[uim-html3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m17.476 6.123l-.534 5.994l.002.033l-.002.074v-.001l-.38 4.192l-.041.372L12 18.037v.001l-.004.003l-4.512-1.258l-.306-3.465h2.213l.157 1.762l2.453.665l-.001.001l2.461-.675l.261-2.869H9.576l-.044-.485l-.101-1.136l-.052-.611h5.538l.202-2.231H6.682l-.044-.485l-.1-1.137l-.053-.61h11.044z" opacity=".5"></svg:path><svg:path fill="currentColor" d="m3.195 2l1.602 17.994L11.989 22l7.212-2.013L20.805 2zm14.281 4.123l-.534 5.994l.002.033l-.002.074v-.001l-.38 4.192l-.041.372L12 18.037v.001l-.004.003l-4.512-1.258l-.306-3.465h2.213l.157 1.762l2.453.665l-.001.001l2.461-.675l.261-2.869H9.576l-.044-.485l-.101-1.136l-.052-.611h5.538l.202-2.231H6.682l-.044-.485l-.1-1.137l-.053-.61h11.044z"></svg:path>`,
})
export class UimHtml3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimHtml3AltIcon],svg[uim-html3-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.99 22a1 1 0 0 1-.268-.037l-6.473-1.805a1 1 0 0 1-.728-.874L3.08 3.09A1 1 0 0 1 4.075 2h15.85a1 1 0 0 1 .996 1.089l-1.443 16.188a1 1 0 0 1-.728.874l-6.491 1.812a1 1 0 0 1-.269.037" opacity=".5"></svg:path><svg:path fill="currentColor" d="M16.777 6.325A1 1 0 0 0 16.04 6H7.96a1 1 0 1 0 0 2h6.987l-.177 2H10a1 1 0 0 0 0 2h4.592l-.264 2.977l-2.328.528l-2.328-.53l-.096-1.064a1 1 0 0 0-1.992.178l.16 1.79a1 1 0 0 0 .775.887l3.26.74a1 1 0 0 0 .443 0l3.26-.74a1 1 0 0 0 .774-.887l.78-8.79a1 1 0 0 0-.259-.764"></svg:path>`,
})
export class UimHtml3AltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimImageVIcon],svg[uim-image-v-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 2H5a3.01 3.01 0 0 0-3 3v8.86l3.88-3.88a3.075 3.075 0 0 1 4.24 0l2.871 2.887l.888-.888a3.01 3.01 0 0 1 4.242 0L22 15.86V5a3.01 3.01 0 0 0-3-3" opacity=".5"></svg:path><svg:path fill="currentColor" d="M10.12 9.98a3.075 3.075 0 0 0-4.24 0L2 13.86V19a3.01 3.01 0 0 0 3 3h14a3 3 0 0 0 2.16-.92z"></svg:path><svg:path fill="currentColor" d="m22 15.858l-3.879-3.879a3.01 3.01 0 0 0-4.242 0l-.888.888l8.165 8.209c.542-.555.845-1.3.844-2.076z" opacity=".25"></svg:path>`,
})
export class UimImageVIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimInstagramIcon],svg[uim-instagram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 6.865A5.135 5.135 0 1 0 17.135 12A5.135 5.135 0 0 0 12 6.865m0 8.469A3.334 3.334 0 1 1 15.334 12A3.333 3.333 0 0 1 12 15.334"></svg:path><svg:path fill="currentColor" d="M21.94 7.877a7.3 7.3 0 0 0-.465-2.427a4.9 4.9 0 0 0-1.153-1.772a4.9 4.9 0 0 0-1.77-1.153a7.3 7.3 0 0 0-2.428-.464C15.058 2.012 14.717 2 12.001 2s-3.057.011-4.123.06a7.3 7.3 0 0 0-2.428.465a4.9 4.9 0 0 0-1.77 1.153A4.9 4.9 0 0 0 2.525 5.45a7.3 7.3 0 0 0-.464 2.427c-.05 1.066-.06 1.407-.06 4.123s.01 3.057.06 4.123a7.3 7.3 0 0 0 .464 2.427a4.9 4.9 0 0 0 1.154 1.772a4.9 4.9 0 0 0 1.771 1.153a7.3 7.3 0 0 0 2.428.464C8.944 21.988 9.285 22 12 22s3.057-.011 4.123-.06a7.3 7.3 0 0 0 2.427-.465a5.1 5.1 0 0 0 2.925-2.925a7.3 7.3 0 0 0 .465-2.427c.048-1.067.06-1.407.06-4.123s-.012-3.057-.06-4.123m-1.8 8.164a5.6 5.6 0 0 1-.343 1.857a3.3 3.3 0 0 1-1.898 1.898a5.5 5.5 0 0 1-1.857.344c-1.055.048-1.371.058-4.042.058s-2.986-.01-4.04-.058a5.5 5.5 0 0 1-1.857-.344a3.1 3.1 0 0 1-1.15-.748a3.1 3.1 0 0 1-.748-1.15a5.5 5.5 0 0 1-.344-1.857c-.048-1.054-.058-1.37-.058-4.04s.01-2.987.058-4.042a5.6 5.6 0 0 1 .344-1.857a3.1 3.1 0 0 1 .748-1.15a3.1 3.1 0 0 1 1.15-.748A5.5 5.5 0 0 1 7.96 3.86C9.014 3.81 9.331 3.8 12 3.8s2.987.011 4.042.059a5.6 5.6 0 0 1 1.857.344a3.3 3.3 0 0 1 1.898 1.898a5.5 5.5 0 0 1 .344 1.857c.048 1.055.058 1.37.058 4.041s-.01 2.986-.058 4.041M17.339 5.462"></svg:path>`,
})
export class UimInstagramIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimInstagramAltIcon],svg[uim-instagram-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimIntercomIcon],svg[uim-intercom-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimIntercomAltIcon],svg[uim-intercom-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 23H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v16a3.003 3.003 0 0 1-3 3" opacity=".5"></svg:path><svg:path fill="currentColor" d="M12 19a10.8 10.8 0 0 1-6.644-2.06a1 1 0 0 1 1.288-1.532A9 9 0 0 0 12 17a9 9 0 0 0 5.361-1.595a1 1 0 0 1 1.282 1.535A10.8 10.8 0 0 1 12 19m-6-6a1 1 0 0 1-1-1V8a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1m4 2a1 1 0 0 1-1-1V6a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1m4 0a1 1 0 0 1-1-1V6a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1m4-2a1 1 0 0 1-1-1V8a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1"></svg:path>`,
})
export class UimIntercomAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimJavaScriptIcon],svg[uim-java-script-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.181 2.213a1.68 1.68 0 0 1 1.637 0l7.479 4.225a1.54 1.54 0 0 1 .778 1.325v8.475a1.56 1.56 0 0 1-.836 1.354l-7.452 4.204a1.63 1.63 0 0 1-1.655-.046l-2.236-1.292a1.3 1.3 0 0 1-.432-.311c.095-.128.265-.144.403-.2a5 5 0 0 0 .883-.412a.21.21 0 0 1 .23.014c.636.365 1.267.741 1.907 1.103c.136.079.274-.026.39-.09q3.658-2.068 7.317-4.13a.24.24 0 0 0 .133-.238q.003-4.193.001-8.387a.26.26 0 0 0-.156-.261q-3.714-2.092-7.426-4.186a.26.26 0 0 0-.292 0Q8.141 5.452 4.43 7.547a.26.26 0 0 0-.157.26v8.387a.24.24 0 0 0 .135.235q.99.562 1.983 1.12a1.53 1.53 0 0 0 1.24.166a.94.94 0 0 0 .609-.883c.003-2.78-.002-5.56.002-8.338a.21.21 0 0 1 .228-.214q.476-.005.953.001a.22.22 0 0 1 .207.254c-.001 2.797.003 5.594-.002 8.39a2.13 2.13 0 0 1-.995 1.922a3.06 3.06 0 0 1-2.738-.075c-.727-.363-1.42-.79-2.133-1.18a1.55 1.55 0 0 1-.835-1.354V7.763a1.54 1.54 0 0 1 .804-1.342q3.726-2.103 7.451-4.208Z"></svg:path><svg:path fill="currentColor" d="M13.348 8.083a5.9 5.9 0 0 1 3.218.493a2.43 2.43 0 0 1 1.187 2.106a.23.23 0 0 1-.247.168c-.315 0-.629.004-.943-.002a.243.243 0 0 1-.228-.236a1.44 1.44 0 0 0-.687-.992a4.1 4.1 0 0 0-1.884-.27a2.56 2.56 0 0 0-1.349.336a.855.855 0 0 0-.284.955c.101.24.378.317.605.388c1.306.342 2.69.308 3.97.757a1.87 1.87 0 0 1 1.23 1.095a2.34 2.34 0 0 1-.396 2.23a3.13 3.13 0 0 1-1.678.905a8 8 0 0 1-2.533.108a4 4 0 0 1-2.228-.839a2.34 2.34 0 0 1-.753-1.844a.21.21 0 0 1 .231-.186q.475-.005.95 0a.22.22 0 0 1 .226.22a1.44 1.44 0 0 0 .536 1.01a4.06 4.06 0 0 0 2.187.398a2.97 2.97 0 0 0 1.794-.439a.99.99 0 0 0 .27-.946c-.078-.28-.37-.41-.621-.495c-1.29-.408-2.688-.26-3.965-.72a1.93 1.93 0 0 1-1.218-1.063a2.17 2.17 0 0 1 .434-2.262a3.5 3.5 0 0 1 2.176-.875"></svg:path>`,
})
export class UimJavaScriptIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimKeySkeletonIcon],svg[uim-key-skeleton-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 12a5 5 0 1 0 0 10a5 5 0 0 0 0-10m-1.415 7.413a1 1 0 1 1 0-2a1 1 0 0 1 0 2" opacity=".5"></svg:path><svg:path fill="currentColor" d="m21.001 4.413l.706-.706a1 1 0 1 0-1.414-1.414L9.754 12.832a5 5 0 0 1 1.414 1.414l5.591-5.591l2.12 2.12a1 1 0 0 0 1.414-1.414l-2.12-2.12l1.414-1.414l.706.705a1 1 0 0 0 1.414-1.414z"></svg:path>`,
})
export class UimKeySkeletonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimLineIcon],svg[uim-line-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimLinkedinIcon],svg[uim-linkedin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.086 9.711h3.002v9.031H5.086zm1.501-1.233h-.02a1.565 1.565 0 1 1 .04-3.12a1.565 1.565 0 1 1-.02 3.12m12.325 10.264H15.91v-4.83c0-1.215-.434-2.043-1.52-2.043a1.64 1.64 0 0 0-1.54 1.098a2 2 0 0 0-.1.732v5.043h-3c0-.003.04-8.184 0-9.03h3.002v1.28a2.98 2.98 0 0 1 2.705-1.493c1.975 0 3.456 1.291 3.456 4.065v5.178z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20.468 2H3.532a1.45 1.45 0 0 0-1.47 1.433v17.135c.011.8.669 1.442 1.47 1.432h16.936a1.45 1.45 0 0 0 1.47-1.432V3.433A1.45 1.45 0 0 0 20.467 2zM8.088 18.742H5.086V9.711h3.002zM6.833 8.48a2 2 0 0 1-.246-.002h-.02a1.565 1.565 0 1 1 .04-3.12a1.565 1.565 0 0 1 .226 3.122m12.079 10.262H15.91v-4.83c0-1.215-.434-2.043-1.52-2.043a1.64 1.64 0 0 0-1.54 1.098a2.1 2.1 0 0 0-.1.732v5.043h-3c0-.003.04-8.184 0-9.03h3.002v1.28a2.98 2.98 0 0 1 2.705-1.493c1.975 0 3.456 1.291 3.456 4.065v5.178z"></svg:path>`,
})
export class UimLinkedinIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimLinuxIcon],svg[uim-linux-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.6 6.5c.1.1.2.1.4.2c.1 0 .3.1.5.2h.1q.3-.45.3-.9c.1-.6-.4-1.2-1-1.2c-.6.1-1 .7-1 1.3v.1c.2 0 .5.1.7.3m4.5 8c-.3-.2-.6-.2-1-.3c-.2-.9-.5-1.7-.9-2.5c-.6-1.2-1.1-2.4-1.4-3.7q-.3.45-.9.6c-.1.1-.3.1-.4.2c-.3.2-.7.4-1.1.4h-.1c-.4 0-.7-.2-.9-.4c-.1-.1-.2-.2-.3-.2s-.1-.1-.2-.1c-.1 1.5-1 3.2-1.5 4.3c-.3.8-.5 1.6-.5 2.4c-.8-1.2-.2-2.7.1-3.3c.4-.8.4-.9.3-.8c-.7 1.1-2.1 3.5-.1 4.8c2.1 1.3 2.2 2.6 1 2.5c.1.2.3.4.4.5c1.2 1 2.9 1.1 4.2.3c0-.1.1-.3.1-.4c.1-.3.2-.7.2-1c.1-1.1.1-2.2.9-2.6c.5-.2 1.2-.1 1.6.2c.1.1.2.1.3.2c.2.1.4.1.5.1h.6c.3-.4-.1-.8-.9-1.2m-6.9-7.7l.1-.1c.2-.3.5-.4.8-.5V6c0-.6-.4-1.1-.8-1.1c-.3.1-.6.6-.6 1.2c0 .3.1.6.3.8c.1 0 .2-.1.2-.1" opacity=".25"></svg:path><svg:path fill="currentColor" d="M8.5 17.4s0 .1 0 0c-.1-.1-.1-.3-.2-.4c.1.2.1.3.2.4" opacity=".25"></svg:path><svg:path fill="currentColor" d="M15.4 22h-.2c-.6-.1-1.1-.4-1.3-1c-.2-.7-.2-1.5.2-2.2c.1-.3.2-.7.2-1c.1-1.1.1-2.2.9-2.6c.5-.2 1.2-.1 1.6.2c.1.1.2.1.3.2c.2.1.4.1.5.1c.4-.1.8 0 1.1.3s.4.6.5 1c0 .2.1.5.2.6c.5.5.7 1 .6 1.3c-.1.5-.6.7-1.1 1c-.5.2-1 .5-1.4.9c-.5.7-1.3 1.1-2.1 1.2" opacity=".5"></svg:path><svg:path fill="currentColor" d="M17.9 15.9c-.4.5-1 .8-1.6.8c-.6-.1-.8-.9-.7-1.5c.1-.7.7-.7 1.5-.4s1.1.7.8 1.1m-5.3-9.3c.1.1.3.1.4.2c.2-.2.2-.4.2-.6c0-.4-.2-.7-.4-.7s-.5.3-.5.7v.3c.1.1.2.1.3.1m-2.2.2l.3-.3v-.3c0-.3-.2-.6-.4-.5c-.2 0-.3.3-.3.6c.1.3.3.5.4.5"></svg:path><svg:path fill="currentColor" d="M17.3 10.8c-.8-1.3-2-2.1-2-3.7c0-1.9.2-5.4-3.3-5.1S9.5 6 9.4 7.3c0 1.1-.5 2.2-1.3 3.1c-.1.1-.2.3-.3.4c-.9 1.3-1.9 3-1.8 4.6c.2-.1.4-.1.5-.1c.8.1 1.2.9 1.7 1.8c.1.1.1.3.2.4l.6.9l.1.1c1.2.1 1.2-1.2-1-2.5c-2-1.3-.6-3.7.1-4.8c.1-.1.1 0-.3.8c-.3.6-.9 2.1-.1 3.2c0-.8.2-1.6.5-2.4c.5-1 1.4-2.8 1.5-4.3c-.1-.2-.3-.5-.3-.8q0-.3.3-.6c.1 0 .2-.1.3-.2c-.2-.2-.4-.5-.4-.8c0-.6.3-1.1.7-1.1s.7.4.8 1.1v.2c.2-.1.5-.1.7 0v-.1c-.1-.6.3-1.2 1-1.3c.6.1 1.1.6 1 1.2q0 .45-.3.9c.3.1.5.4.5.7c0 .2-.1.3-.2.5c.4 1.3.8 2.5 1.4 3.7c.4.8.7 1.6.9 2.5c.3 0 .7.1 1 .3s.6.3.8.5c.1.1.1.2.2.2c0 0 0 .1.1.1v.3c.1 0 .3.1.4.2c.5-2-.5-3.9-1.4-5.2"></svg:path><svg:path fill="currentColor" d="M11.4 8.5c-.5 0-1-.3-1.4-.7l-.1-.1c-.1 0-.1 0-.1-.1s.1-.1.1-.1c.1 0 .1.1.3.2q.45.6 1.2.6c.5-.1 1-.2 1.4-.5c.2-.1.4-.2.7-.3c.1 0 .1 0 .1.1s0 .1-.1.1c-.2.1-.4.1-.6.3c-.5.3-1 .5-1.5.5" opacity=".7"></svg:path><svg:path fill="currentColor" d="M13.5 6.9c-.2-.1-.3-.1-.5-.2c-.1 0-.3-.1-.4-.2c-.6-.6-1.7-.5-2.3.2l-.1.1s-.2.2-.4.3q-.3.3-.3.6c.1.4.3.7.7.9c.1.1.2.2.3.2c.2.3.6.4.9.4h.1c.4 0 .8-.1 1.1-.4c.1-.1.2-.2.4-.2c.5-.1 1-.5 1.1-1.1c0-.2-.3-.5-.6-.6m-.1.8c-.2.1-.4.1-.6.3q-.6.45-1.5.6c-.5 0-1-.3-1.4-.7l-.1-.1c-.1 0-.1 0-.1-.1s.1-.1.1-.1c.1 0 .1.1.3.2q.45.6 1.2.6c.5-.1 1-.2 1.4-.5c.2-.1.4-.2.7-.3c.1-.1.1-.1 0 .1c.1-.1.1 0 0 0m-5 14.1c-.6 0-1.2-.2-1.7-.5c-.5-.2-1-.4-1.6-.4c-.7-.1-1.2-.1-1.5-.6c-.2-.4-.2-1 0-1.4v-.7c-.1-.4-.1-.7.1-1.1c.2-.3.5-.6.9-.7c.2 0 .4-.1.5-.3c.1-.1.2-.2.2-.3c.2-.5.8-.8 1.3-.8c.9.1 1.4 1.1 1.9 2.2l.6.9c.5.7 1.1 1.3 1 2c0 .5-.3 1-.8 1.2c-.2.4-.6.5-.9.5" opacity=".5"></svg:path><svg:path fill="currentColor" d="M13.8 19.4c-1.3.7-3 .6-4.2-.4c.1.2.2.3.3.5v.1c.1.3.2.5.2.8c0 .2-.1.3-.1.5c.5 0 1.1-.2 2-.3c.5 0 1.1.1 1.8.2c-.1-.5-.1-1 0-1.4"></svg:path>`,
})
export class UimLinuxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimLockAccessIcon],svg[uim-lock-access-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 10c-.6 0-1-.4-1-1V4h-5c-.6 0-1-.4-1-1s.4-1 1-1h6c.6 0 1 .4 1 1v6c0 .6-.4 1-1 1M3 10c-.6 0-1-.4-1-1V3c0-.6.4-1 1-1h6c.6 0 1 .4 1 1s-.4 1-1 1H4v5c0 .6-.4 1-1 1m6 12H3c-.6 0-1-.4-1-1v-6c0-.6.4-1 1-1s1 .4 1 1v5h5c.6 0 1 .4 1 1s-.4 1-1 1m12 0h-6c-.6 0-1-.4-1-1s.4-1 1-1h5v-5c0-.6.4-1 1-1s1 .4 1 1v6c0 .6-.4 1-1 1"></svg:path><svg:path fill="currentColor" d="M9 10h6c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2H9c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2m2-1c0-.6.4-1 1-1s1 .4 1 1v1h2V9c0-1.7-1.3-3-3-3S9 7.3 9 9v1h2z" opacity=".5"></svg:path>`,
})
export class UimLockAccessIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimLockOpenAltIcon],svg[uim-lock-open-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 11a1 1 0 0 1-1-.999V7a5.002 5.002 0 0 1 8.532-3.542a5.1 5.1 0 0 1 1.307 2.293a1 1 0 1 1-1.937.501v-.003a3.06 3.06 0 0 0-.786-1.379A3.002 3.002 0 0 0 9 7v3a1 1 0 0 1-.999 1zm5.5 3.5a1.5 1.5 0 1 0-3 0c0 .443.195.836.5 1.11v1.392A1 1 0 0 0 12 18h.001A1 1 0 0 0 13 17v-1.39c.305-.274.5-.667.5-1.11" opacity=".5"></svg:path><svg:path fill="currentColor" d="M17 9H7a3 3 0 0 0-3 3v7a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-7a3 3 0 0 0-3-3m-4 6.61V17a1 1 0 0 1-.999 1H12a1 1 0 0 1-1-.999V15.61a1.5 1.5 0 0 1-.5-1.11a1.5 1.5 0 1 1 3 0c0 .443-.195.836-.5 1.11"></svg:path>`,
})
export class UimLockOpenAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimMicroscopeIcon],svg[uim-microscope-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.441 13.604a1 1 0 0 1-.707-.293L7.198 9.772a1 1 0 0 1 0-1.414l6.363-6.363a1 1 0 0 1 .39-.242l2.121-.707a1 1 0 0 1 1.024.242l2.122 2.121a1 1 0 0 1 .241 1.024l-.708 2.122a1 1 0 0 1-.241.39l-6.362 6.366a1 1 0 0 1-.707.293m6.362-7.366" opacity=".25"></svg:path><svg:path fill="currentColor" d="m7.198 9.772l-1.416 1.415a1 1 0 0 0 0 1.415l2.122 2.12a1 1 0 0 0 1.414 0l1.414-1.413Z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M8 18.005H4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2"></svg:path><svg:path fill="currentColor" d="M20 23.005H4a1 1 0 0 1 0-2h16a1 1 0 0 1 0 2" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14.816 21.005a3 3 0 0 0 .184-1a3 3 0 0 0-6 0a3 3 0 0 0 .184 1Z" opacity=".25"></svg:path><svg:path fill="currentColor" d="m17.873 7.583l-1.415 1.415A5.96 5.96 0 0 1 18 13.005a6.05 6.05 0 0 1-3.455 5.431a2.97 2.97 0 0 1 .455 1.57a3 3 0 0 1-.04.407A8.04 8.04 0 0 0 20 13.005a7.95 7.95 0 0 0-2.127-5.422M9.42 18.499a7 7 0 0 1-1.095-.56a1 1 0 0 1-.326.066H5.326a8.9 8.9 0 0 0 3.72 2.472A2.7 2.7 0 0 1 9 20.005a2.97 2.97 0 0 1 .42-1.506" opacity=".5"></svg:path>`,
})
export class UimMicroscopeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimMinusSquareFullIcon],svg[uim-minus-square-full-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 13H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2"></svg:path><svg:path fill="currentColor" d="M21 2H3a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1m-4 11H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2" opacity=".5"></svg:path>`,
})
export class UimMinusSquareFullIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimObjectGroupIcon],svg[uim-object-group-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11 10h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M10 11a1 1 0 0 1 1-1h3V8a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h2zM4 22a2 2 0 1 1 0-4a2 2 0 0 1 0 4M4 6a2 2 0 1 1 0-4a2 2 0 0 1 0 4m16 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0 16a2 2 0 1 1 0-4a2 2 0 0 1 0 4"></svg:path><svg:path fill="currentColor" d="M18.278 5a1.94 1.94 0 0 1 0-2H5.722a1.94 1.94 0 0 1 0 2zM20 18a2 2 0 0 1 1 .278V5.722a1.94 1.94 0 0 1-2 0v12.556A2 2 0 0 1 20 18M4 18a2 2 0 0 1 1 .278V5.722a1.94 1.94 0 0 1-2 0v12.556A2 2 0 0 1 4 18m14.278 1H5.722a1.94 1.94 0 0 1 0 2h12.556a1.94 1.94 0 0 1 0-2" opacity=".25"></svg:path>`,
})
export class UimObjectGroupIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimObjectUngroupIcon],svg[uim-object-ungroup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 16a2 2 0 1 1 0-4a2 2 0 0 1 0 4M4 6a2 2 0 1 1 0-4a2 2 0 0 1 0 4m10 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0 10a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0-2.002" opacity=".5"></svg:path><svg:path fill="currentColor" d="M10 22a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0-10a2 2 0 1 1 0-4a2 2 0 0 1 0 4m10 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0 10a2 2 0 1 1 0-4a2 2 0 0 1 0 4m0-2.002"></svg:path><svg:path fill="currentColor" d="M12.278 5a1.94 1.94 0 0 1 0-2H5.722a1.94 1.94 0 0 1 0 2zM4 12a2 2 0 0 1 1 .278V5.722a1.94 1.94 0 0 1-2 0v6.556A2 2 0 0 1 4 12" opacity=".25"></svg:path><svg:path fill="currentColor" d="M20 18a2 2 0 0 1 1 .278v-6.556a1.94 1.94 0 0 1-2 0v6.556A2 2 0 0 1 20 18m-10 0a2 2 0 0 1 1 .278v-6.556a1.94 1.94 0 0 1-2 0v6.556A2 2 0 0 1 10 18" opacity=".5"></svg:path><svg:path fill="currentColor" d="M12.278 13H11v2h1.278a1.94 1.94 0 0 1 0-2M9 15v-2H5.722a1.94 1.94 0 0 1 0 2z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M18.278 19h-6.556a1.94 1.94 0 0 1 0 2h6.556a1.94 1.94 0 0 1 0-2m0-8a1.94 1.94 0 0 1 0-2h-6.556a1.94 1.94 0 0 1 0 2z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M15 9V5.722a1.94 1.94 0 0 1-2 0V9zm-2 2v1.278a1.94 1.94 0 0 1 2 0V11z" opacity=".25"></svg:path>`,
})
export class UimObjectUngroupIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimOperaIcon],svg[uim-opera-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimOperaAltIcon],svg[uim-opera-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimPadlockIcon],svg[uim-padlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9 7c0-1.7 1.3-3 3-3s3 1.3 3 3v2h2V7c0-2.8-2.2-5-5-5S7 4.2 7 7v2h2zm4.5 7.5c0-.8-.7-1.5-1.5-1.5s-1.5.7-1.5 1.5c0 .4.2.8.5 1.1V17c0 .6.4 1 1 1s1-.4 1-1v-1.4c.3-.3.5-.7.5-1.1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M17 9H7c-1.7 0-3 1.3-3 3v7c0 1.7 1.3 3 3 3h10c1.7 0 3-1.3 3-3v-7c0-1.7-1.3-3-3-3m-4 6.6V17c0 .6-.4 1-1 1s-1-.4-1-1v-1.4c-.3-.3-.5-.7-.5-1.1c0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5c0 .4-.2.8-.5 1.1"></svg:path>`,
})
export class UimPadlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimPagelinesIcon],svg[uim-pagelines-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimPaperclipIcon],svg[uim-paperclip-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.892 21.854a6.25 6.25 0 0 1-4.42-10.67l7.955-7.955a4.5 4.5 0 0 1 6.364 6.364l-6.895 6.894a2.816 2.816 0 0 1-3.89 0a2.75 2.75 0 0 1 .002-3.888l5.126-5.127a1 1 0 1 1 1.414 1.414l-5.126 5.127a.75.75 0 0 0 0 1.06a.77.77 0 0 0 1.06 0l6.895-6.894a2.503 2.503 0 0 0 0-3.535a2.56 2.56 0 0 0-3.536 0l-7.955 7.955a4.25 4.25 0 1 0 6.01 6.01l6.188-6.187a1 1 0 1 1 1.414 1.414l-6.187 6.186a6.2 6.2 0 0 1-4.42 1.832Z"></svg:path>`,
})
export class UimPaperclipIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimPaypalIcon],svg[uim-paypal-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.882 19.94a1 1 0 0 1-.988.843H4.062a1.533 1.533 0 0 1-1.515-1.785l2.59-16.406A1.89 1.89 0 0 1 7 1h6.214c2.56 0 4.408.62 5.492 1.843a4.96 4.96 0 0 1 1.08 4.395c-.021.135-.043.27-.075.418c-.823 4.218-3.655 6.457-8.186 6.457H9.807zm-4.36-.628l-.001.006zM7.113 2.897v.002z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20.437 7.104a4 4 0 0 0-.545-.508a5 5 0 0 1-.106.642c-.021.135-.043.27-.075.418c-.823 4.218-3.655 6.457-8.186 6.457H9.807l-.925 5.827a1 1 0 0 1-.988.843H6.727l-.082.52A1.467 1.467 0 0 0 8.093 23h3.234a1.76 1.76 0 0 0 1.751-1.469l.64-4.031l.012-.055h.298c4.033 0 6.551-1.993 7.286-5.762a5.15 5.15 0 0 0-.877-4.578"></svg:path>`,
})
export class UimPaypalIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimPlusSquareIcon],svg[uim-plus-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17 11h-4V7a1 1 0 0 0-2 0v4H7a1 1 0 0 0 0 2h4v4a1 1 0 0 0 2 0v-4h4a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="M21 2H3a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1m-4 11h-4v4a1 1 0 0 1-2 0v-4H7a1 1 0 0 1 0-2h4V7a1 1 0 0 1 2 0v4h4a1 1 0 0 1 0 2" opacity=".5"></svg:path>`,
})
export class UimPlusSquareIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimProcessIcon],svg[uim-process-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.625 8.5h-4.5a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v3.5h3.5a1 1 0 0 1 0 2"></svg:path><svg:path fill="currentColor" d="M21 13a1 1 0 0 1-1-1A7.995 7.995 0 0 0 5.08 8.001a1 1 0 0 1-1.731-1.002A9.995 9.995 0 0 1 22 12a1 1 0 0 1-1 1m-1.125 9a1 1 0 0 1-1-1v-3.5h-3.5a1 1 0 0 1 0-2h4.5a1 1 0 0 1 1 1V21a1 1 0 0 1-1 1"></svg:path><svg:path fill="currentColor" d="M12 22A10.01 10.01 0 0 1 2 12a1 1 0 0 1 2 0a7.995 7.995 0 0 0 14.92 3.999a1 1 0 0 1 1.731 1.002A10.03 10.03 0 0 1 12 22"></svg:path>`,
})
export class UimProcessIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimReactIcon],svg[uim-react-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimRedditAlienAltIcon],svg[uim-reddit-alien-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.893 7a3.014 3.014 0 0 1-3-3.022a3 3 0 0 1 6-.023v.023a3.014 3.014 0 0 1-3 3.022M11.8 23c-6.168 0-11-3.075-11-7s4.832-7 11-7s11 3.075 11 7s-4.832 7-11 7" opacity=".5"></svg:path><svg:path fill="currentColor" d="M20.499 8.292a3.77 3.77 0 0 0-4.497 1.223c2.952.756 5.224 2.295 6.228 4.234c.1-.161.194-.326.269-.5a3.78 3.78 0 0 0-2-4.957M11.8 9q.585 0 1.156.037l.856-5.705l2.087.71c0-.022-.006-.042-.006-.064a2.97 2.97 0 0 1 .653-1.828l-3.224-1.096a1 1 0 0 0-1.312.798l-1.076 7.175c.287-.014.573-.027.866-.027m-4.208.516c-.088-.117-.172-.238-.273-.344a3.777 3.777 0 0 0-5.952 4.582c1.002-1.94 3.273-3.48 6.225-4.238" opacity=".25"></svg:path><svg:path fill="currentColor" d="M11.842 19.5a5.1 5.1 0 0 1-3.781-1.218a1 1 0 0 1 1.416-1.414c.68.5 1.525.726 2.365.632a3.38 3.38 0 0 0 2.368-.633a1 1 0 1 1 1.414 1.416a5.12 5.12 0 0 1-3.782 1.217M10 14.002a1 1 0 1 0-1 1c.552-.001 1-.448 1-1m6 0a1 1 0 1 0-1 1c.552-.001 1-.448 1-1"></svg:path>`,
})
export class UimRedditAlienAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimRefreshIcon],svg[uim-refresh-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimRepeatIcon],svg[uim-repeat-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.498 22a1 1 0 0 1-.707-.293l-2.5-2.5a1 1 0 0 1 0-1.414l2.5-2.5a1 1 0 0 1 1.414 1.414L10.412 18.5l1.793 1.793A1 1 0 0 1 11.498 22" opacity=".5"></svg:path><svg:path fill="currentColor" d="M21 4.5h-2a1 1 0 0 0 0 2h1v11h-8.588l-1 1l1 1H21a1 1 0 0 0 1-1v-13a1 1 0 0 0-1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M12.5 2c.265 0 .52.105.707.293l2.5 2.5a1 1 0 0 1 0 1.414l-2.5 2.5a1 1 0 0 1-1.414-1.414L13.586 5.5l-1.793-1.793A1 1 0 0 1 12.5 2"></svg:path><svg:path fill="currentColor" d="M5 17.5H4v-11h8.586l1-1l-1-1H3a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h2a1 1 0 0 0 0-2"></svg:path>`,
})
export class UimRepeatIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimRocketIcon],svg[uim-rocket-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m17.737 14.622l-2.426 2.23a11.6 11.6 0 0 1-4.299 2.37l.644 3.004a1 1 0 0 0 1.469.661l3.905-2.202a3.035 3.035 0 0 0 1.375-3.304zM7.266 8.776l2.088-2.48l-2.604-.628a2.78 2.78 0 0 0-3.387 1.357l-2.2 3.9a1 1 0 0 0 .661 1.469l3.073.659a12.9 12.9 0 0 1 2.369-4.277m9.468.04a1.5 1.5 0 1 0-1.5-1.5a1.5 1.5 0 0 0 1.5 1.5"></svg:path><svg:path fill="currentColor" d="M22.601 2.062a1 1 0 0 0-.713-.713A11.25 11.25 0 0 0 10.47 4.972L7.266 8.776a12.94 12.94 0 0 0-2.924 6.71a1 1 0 0 0 .284.837l3.1 3.1a1 1 0 0 0 .708.293l.086-.004a11.85 11.85 0 0 0 6.79-2.86l3.664-3.368A11.2 11.2 0 0 0 22.6 2.062Zm-5.867 6.754a1.5 1.5 0 1 1 1.5-1.5a1.5 1.5 0 0 1-1.5 1.5" opacity=".5"></svg:path>`,
})
export class UimRocketIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimRulerIcon],svg[uim-ruler-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSanitizerIcon],svg[uim-sanitizer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5 5a1 1 0 0 1-.707-1.707l.829-.829A4.97 4.97 0 0 1 8.657 1H17a1 1 0 0 1 0 2H8.657a3.02 3.02 0 0 0-2.121.878l-.829.829A1 1 0 0 1 5 5"></svg:path><svg:path fill="currentColor" d="M10 3v2.5l.4-.3A1 1 0 0 1 11 5h4a1 1 0 0 1 .6.2l.4.3V3Z" opacity=".5"></svg:path><svg:circle cx="13" cy="15" r="2" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M13 18a3 3 0 1 1 3-3a3.003 3.003 0 0 1-3 3"></svg:path><svg:path fill="currentColor" d="m18.8 7.6l-3.2-2.4A1 1 0 0 0 15 5h-4a1 1 0 0 0-.6.2L7.2 7.6A3.02 3.02 0 0 0 6 10v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V10a3.02 3.02 0 0 0-1.2-2.4M13 18a3 3 0 1 1 3-3a3.003 3.003 0 0 1-3 3" opacity=".25"></svg:path>`,
})
export class UimSanitizerIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSanitizerAltIcon],svg[uim-sanitizer-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 3v1h2V3h1a1 1 0 0 0 0-2h-4.764a4.59 4.59 0 0 0-4.13 2.553a1 1 0 0 0 1.789.894A2.6 2.6 0 0 1 10.235 3Z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M16 5a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v3h6zm-2 12h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2"></svg:path><svg:path fill="currentColor" d="M16 8h-6a3.003 3.003 0 0 0-3 3v9a3.003 3.003 0 0 0 3 3h6a3.003 3.003 0 0 0 3-3v-9a3.003 3.003 0 0 0-3-3m-2 9h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2" opacity=".25"></svg:path>`,
})
export class UimSanitizerAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSceneryIcon],svg[uim-scenery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.5 9a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3" opacity=".25"></svg:path><svg:path fill="currentColor" d="M19 2H5a3.01 3.01 0 0 0-3 3v8.86l3.88-3.88a3.075 3.075 0 0 1 4.24 0l2.871 2.887l.888-.888a3.01 3.01 0 0 1 4.242 0L22 15.86V5a3.01 3.01 0 0 0-3-3m-5.5 7a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3" opacity=".5"></svg:path><svg:path fill="currentColor" d="M10.12 9.98a3.075 3.075 0 0 0-4.24 0L2 13.86V19a3.01 3.01 0 0 0 3 3h14a3 3 0 0 0 2.16-.92z"></svg:path><svg:path fill="currentColor" d="m22 15.858l-3.879-3.879a3.01 3.01 0 0 0-4.242 0l-.888.888l8.165 8.209c.542-.555.845-1.3.844-2.076z" opacity=".25"></svg:path>`,
})
export class UimSceneryIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimShieldPlusIcon],svg[uim-shield-plus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M14 11h-1v-1a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="M19.63 3.65a1 1 0 0 0-.835-.203a8 8 0 0 1-6.223-1.267a1 1 0 0 0-1.144 0a7.98 7.98 0 0 1-6.223 1.267A1 1 0 0 0 4 4.427v7.456a9.02 9.02 0 0 0 3.769 7.324l3.65 2.607a1 1 0 0 0 1.162 0l3.65-2.607A9.02 9.02 0 0 0 20 11.883V4.426a1 1 0 0 0-.37-.776M14 13h-1v1a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2" opacity=".5"></svg:path>`,
})
export class UimShieldPlusIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSignInAltIcon],svg[uim-sign-in-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 12c0-.34-.02-.67-.05-1H12.5V9.5a1 1 0 0 0-1.707-.707l-2.5 2.5a1 1 0 0 0 0 1.414l2.5 2.5A1 1 0 0 0 12.5 14.5V13h8.45c.03-.33.05-.66.05-1"></svg:path><svg:path fill="currentColor" d="M12.5 13v1.5a1 1 0 0 1-1.707.707l-2.5-2.5a1 1 0 0 1 0-1.414l2.5-2.5A1 1 0 0 1 12.5 9.5V11h8.45a10 10 0 1 0 0 2Z" opacity=".5"></svg:path>`,
})
export class UimSignInAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSignalAlt3Icon],svg[uim-signal-alt-3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6 23H2a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1" opacity=".25"></svg:path><svg:path fill="currentColor" d="M14 23h-4a1 1 0 0 1-1-1V10a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M22 23h-4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v20a1 1 0 0 1-1 1"></svg:path>`,
})
export class UimSignalAlt3Icon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSigninIcon],svg[uim-signin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19 11h-5.586l1.293-1.293a1 1 0 0 0-1.414-1.414l-3 3a1 1 0 0 0 0 1.414l3 3a1 1 0 0 0 1.414-1.414L13.414 13H19a1 1 0 0 0 0-2"></svg:path><svg:path fill="currentColor" d="m13.414 13l1.293 1.293a1 1 0 1 1-1.414 1.414l-3-3a1 1 0 0 1 0-1.414l3-3a1 1 0 0 1 1.414 1.414L13.414 11H18V5a3.003 3.003 0 0 0-3-3H7a3.003 3.003 0 0 0-3 3v14a3.003 3.003 0 0 0 3 3h8a3.003 3.003 0 0 0 3-3v-6Z" opacity=".5"></svg:path>`,
})
export class UimSigninIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
...
@Component({
  standalone: true,
  selector: 'svg[uimSignoutIcon],svg[uim-signout-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSkypeIcon],svg[uim-skype-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSkypeAltIcon],svg[uim-skype-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.5 23a6.5 6.5 0 0 1-2.809-.639A10.49 10.49 0 0 1 1.64 10.31a6.499 6.499 0 0 1 8.67-8.67a10.49 10.49 0 0 1 12.05 12.05A6.5 6.5 0 0 1 16.5 23" opacity=".5"></svg:path><svg:path fill="currentColor" d="M16.136 12.865a3.2 3.2 0 0 0-.997-1.052a5 5 0 0 0-1.29-.593c-.28-.085-.59-.168-.911-.247c-.28-.078-.612-.158-1.022-.248a9.3 9.3 0 0 1-1.436-.424a1.5 1.5 0 0 1-.616-.447a.84.84 0 0 1-.16-.566a.97.97 0 0 1 .205-.597a1.6 1.6 0 0 1 .7-.475A4 4 0 0 1 12.031 8a3.8 3.8 0 0 1 1.106.146a2.1 2.1 0 0 1 .663.322a1.2 1.2 0 0 1 .325.343a1 1 0 1 0 1.761-.948a3.15 3.15 0 0 0-.837-.958a4 4 0 0 0-1.319-.669A5.8 5.8 0 0 0 12.032 6a6 6 0 0 0-2.145.35A3.55 3.55 0 0 0 8.31 7.492a2.98 2.98 0 0 0-.604 1.797a2.84 2.84 0 0 0 .58 1.792a3.5 3.5 0 0 0 1.438 1.072a11 11 0 0 0 1.307.408l1.531.378c.248.064.487.129.706.196a3 3 0 0 1 .763.344a1.1 1.1 0 0 1 .363.368a1.2 1.2 0 0 1 .118.585a1.15 1.15 0 0 1-.214.732a1.76 1.76 0 0 1-.802.585a3.8 3.8 0 0 1-1.487.252a3.7 3.7 0 0 1-1.703-.344a1.76 1.76 0 0 1-.616-.547a1 1 0 0 1-.202-.503a1 1 0 0 0-2 0a2.94 2.94 0 0 0 .556 1.64a3.8 3.8 0 0 0 1.342 1.187a5.6 5.6 0 0 0 2.623.567a5.7 5.7 0 0 0 2.254-.405a3.7 3.7 0 0 0 1.665-1.273a3.15 3.15 0 0 0 .584-1.926a3.1 3.1 0 0 0-.375-1.53Z"></svg:path>`,
})
export class UimSkypeAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSlackIcon],svg[uim-slack-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.338 2a2 2 0 0 0 .001 4h1.996V4a2 2 0 0 0-1.997-2m0 5.333H4.016a2 2 0 0 0 0 4h5.322a2 2 0 0 0 0-4"></svg:path><svg:path fill="currentColor" d="M21.98 9.333a1.996 1.996 0 1 0-3.993 0v2h1.997a2 2 0 0 0 1.996-2m-5.323 0V4a1.996 1.996 0 1 0-3.992 0v5.333a1.996 1.996 0 1 0 3.992 0" opacity=".25"></svg:path><svg:path fill="currentColor" d="M14.661 22a2 2 0 0 0 0-4h-1.996v2a2 2 0 0 0 1.996 2m0-5.334h5.323a2 2 0 0 0 0-4h-5.322a2 2 0 0 0-.001 4" opacity=".7"></svg:path><svg:path fill="currentColor" d="M2.02 14.666a1.996 1.996 0 1 0 3.993 0v-2H4.016a2 2 0 0 0-1.996 2m5.323 0V20a1.996 1.996 0 1 0 3.992 0v-5.332a1.996 1.996 0 1 0-3.992-.002" opacity=".5"></svg:path>`,
})
export class UimSlackIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSlackAltIcon],svg[uim-slack-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.34 2a2 2 0 0 0 0 4h2V4a2 2 0 0 0-2-2m0 5.33H4a2 2 0 1 0 0 4h5.34a2 2 0 0 0 0-4" opacity=".25"></svg:path><svg:path fill="currentColor" d="M22 9.33a2 2 0 1 0-4 0v2h2a2 2 0 0 0 2-2m-5.32 0V4a2 2 0 1 0-4 0v5.33a2 2 0 1 0 4 0" opacity=".5"></svg:path><svg:path fill="currentColor" d="M14.66 22a2 2 0 0 0 0-4h-2v2a2 2 0 0 0 2 2m0-5.33H20a2 2 0 0 0 0-4h-5.34a2 2 0 0 0 0 4" opacity=".7"></svg:path><svg:path fill="currentColor" d="M2 14.67a2 2 0 1 0 4 0v-2H4a2 2 0 0 0-2 2m5.32 0V20a2 2 0 1 0 4 0v-5.33a2 2 0 1 0-4 0"></svg:path>`,
})
export class UimSlackAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSnapchatAltIcon],svg[uim-snapchat-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSnapchatGhostIcon],svg[uim-snapchat-ghost-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSnapchatSquareIcon],svg[uim-snapchat-square-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.174 15.652a4.52 4.52 0 0 1-3.079-2.582l-.004-.009a.78.78 0 0 1-.074-.657c.14-.332.607-.48.916-.578c.077-.024.15-.048.207-.07c.559-.22.672-.45.67-.602a.485.485 0 0 0-.368-.398l-.004-.002a.7.7 0 0 0-.26-.05a.55.55 0 0 0-.23.046a1.9 1.9 0 0 1-.7.195a.6.6 0 0 1-.387-.13l.023-.389l.003-.047a7.4 7.4 0 0 0-.176-2.955a3.84 3.84 0 0 0-3.568-2.298l-.295.002a3.84 3.84 0 0 0-3.562 2.298a7.4 7.4 0 0 0-.177 2.951l.027.438a.62.62 0 0 1-.428.13a1.8 1.8 0 0 1-.742-.195a.4.4 0 0 0-.18-.036a.61.61 0 0 0-.593.39c-.06.315.39.544.664.652c.057.023.13.046.207.07c.309.098.775.246.916.578c.073.22.046.46-.075.658l-.004.008c-.202.44-.465.85-.782 1.217a3.82 3.82 0 0 1-2.296 1.365a.176.176 0 0 0-.147.183q.003.05.023.095c.129.301.775.55 1.869.718c.102.016.145.183.205.456c.024.11.048.223.083.34c.023.107.124.18.234.167a2 2 0 0 0 .31-.044q.406-.09.821-.093q.298 0 .592.05c.413.105.797.3 1.124.574a3.25 3.25 0 0 0 1.97.776q.036 0 .072-.003c.03.002.07.003.112.003a3.26 3.26 0 0 0 1.97-.776c.327-.273.71-.47 1.123-.574q.294-.05.592-.05q.414.002.82.087q.154.033.311.04h.017a.204.204 0 0 0 .217-.163q.049-.17.083-.337c.06-.272.103-.438.205-.454c1.094-.169 1.74-.417 1.868-.716a.3.3 0 0 0 .023-.096a.176.176 0 0 0-.146-.183" opacity=".5"></svg:path><svg:path fill="currentColor" d="M17.508 2h-11a4.5 4.5 0 0 0-4.5 4.5v11a4.5 4.5 0 0 0 4.5 4.5h11a4.5 4.5 0 0 0 4.5-4.5v-11a4.5 4.5 0 0 0-4.5-4.5m1.79 13.93c-.129.3-.775.548-1.869.717c-.102.016-.146.182-.205.454q-.035.166-.083.337a.204.204 0 0 1-.217.162h-.017a2 2 0 0 1-.31-.04a4 4 0 0 0-.821-.086q-.298 0-.592.05c-.413.105-.796.3-1.123.574a3.26 3.26 0 0 1-1.97.776q-.065 0-.112-.003l-.073.003a3.25 3.25 0 0 1-1.97-.776a2.84 2.84 0 0 0-1.123-.574a3.6 3.6 0 0 0-.592-.05q-.414.004-.82.093a2 2 0 0 1-.311.044a.214.214 0 0 1-.234-.167a5 5 0 0 1-.083-.34c-.06-.273-.103-.44-.205-.456c-1.094-.168-1.74-.417-1.869-.718a.3.3 0 0 1-.023-.095a.176.176 0 0 1 .147-.183a3.82 3.82 0 0 0 2.296-1.365c.317-.367.58-.776.783-1.217l.003-.008a.8.8 0 0 0 .075-.658c-.14-.332-.607-.48-.916-.578a3 3 0 0 1-.207-.07c-.274-.108-.724-.337-.664-.652a.61.61 0 0 1 .593-.39a.4.4 0 0 1 .18.036c.23.118.484.185.742.196a.62.62 0 0 0 .428-.131l-.027-.438a7.4 7.4 0 0 1 .177-2.951a3.84 3.84 0 0 1 3.562-2.298l.295-.002a3.84 3.84 0 0 1 3.568 2.298a7.4 7.4 0 0 1 .176 2.955l-.003.047l-.023.389c.11.087.247.133.388.13a1.9 1.9 0 0 0 .7-.195a.55.55 0 0 1 .228-.046q.136 0 .261.05l.004.002a.485.485 0 0 1 .367.398c.003.153-.11.381-.669.602c-.057.022-.13.046-.207.07c-.31.098-.776.246-.916.578a.78.78 0 0 0 .074.657l.004.009a4.52 4.52 0 0 0 3.079 2.582a.176.176 0 0 1 .146.183a.3.3 0 0 1-.023.096z"></svg:path>`,
})
export class UimSnapchatSquareIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSortingIcon],svg[uim-sorting-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15 19.5a1 1 0 0 1-.707-.293L12 16.914l-2.293 2.293a1 1 0 0 1-1.414-1.414l3-3a1 1 0 0 1 1.414 0l3 3A1 1 0 0 1 15 19.5m-3-9a1 1 0 0 1-.707-.293l-3-3a1 1 0 0 1 1.414-1.414L12 8.086l2.293-2.293a1 1 0 0 1 1.414 1.414l-3 3A1 1 0 0 1 12 10.5"></svg:path>`,
})
export class UimSortingIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSquareShapeIcon],svg[uim-square-shape-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class UimSquareShapeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSqureShapeIcon],svg[uim-squre-shape-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:rect width="20" height="20" x="2" y="2" fill="currentColor" rx="5"></svg:rect>`,
})
export class UimSqureShapeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimStethoscopeAltIcon],svg[uim-stethoscope-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 15a1 1 0 0 1-.625-.22l-3.499-2.798A4.97 4.97 0 0 1 2 8.078V3a1 1 0 0 1 1-1h2a1 1 0 0 1 0 2H4v4.078a2.99 2.99 0 0 0 1.126 2.342L8 12.72l2.875-2.3A2.99 2.99 0 0 0 12 8.078V4h-1a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v5.078a4.98 4.98 0 0 1-1.876 3.904l-3.5 2.799A1 1 0 0 1 8 15m11-1a3 3 0 1 1 3-3a3.003 3.003 0 0 1-3 3" opacity=".5"></svg:path><svg:path fill="currentColor" d="M19 14a3 3 0 0 1-1-.184V15.5a4.5 4.5 0 0 1-9 0v-1.02l-.375.3a1 1 0 0 1-1.25 0L7 14.48v1.02a6.5 6.5 0 0 0 13 0v-1.684A3 3 0 0 1 19 14"></svg:path>`,
})
export class UimStethoscopeAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimStoreSlashIcon],svg[uim-store-slash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 18.586v-7.143a3.95 3.95 0 0 1-5-.8a3.96 3.96 0 0 1-1.789 1.154Z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M22 23a1 1 0 0 1-.707-.293l-20-20a1 1 0 0 1 1.414-1.414l20 20A1 1 0 0 1 22 23"></svg:path><svg:path fill="currentColor" d="M12.586 14H10a1 1 0 0 0-1 1v7h6v-5.586Z" opacity=".7"></svg:path><svg:path fill="currentColor" d="M10 14h2.586l-2.49-2.49A3.8 3.8 0 0 1 9 10.642a4 4 0 0 1-5 .82V21a1 1 0 0 0 1 1h4v-7a1 1 0 0 1 1-1m5 2.414V22h4a.99.99 0 0 0 .93-.655z" opacity=".25"></svg:path><svg:path fill="currentColor" d="M13.211 11.797A3.96 3.96 0 0 0 15 10.643A3.998 3.998 0 0 0 22 8a1 1 0 0 0-.071-.371l-2-5A1 1 0 0 0 19 2H5a1 1 0 0 0-.929.629l-.008.02zM3.255 4.669L2.071 7.63A1 1 0 0 0 2 8a3.998 3.998 0 0 0 7 2.643a3.8 3.8 0 0 0 1.095.866z" opacity=".5"></svg:path>`,
})
export class UimStoreSlashIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimSwiggyIcon],svg[uim-swiggy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimSyncSlashIcon],svg[uim-sync-slash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2C9.4 2 6.9 3 5 4.9V3c0-.6-.4-1-1-1s-1 .4-1 1v4.5c0 .6.4 1 1 1h4.5c.6 0 1-.4 1-1s-.4-1-1-1H6.2c3-3.2 8.1-3.3 11.3-.3C19.1 7.7 20 9.8 20 12c0 .6.4 1 1 1s1-.4 1-1c0-5.5-4.5-10-10-10m8 13.5h-4.5c-.6 0-1 .4-1 1s.4 1 1 1h2.3c-3 3.2-8.1 3.3-11.3.3C4.9 16.3 4 14.2 4 12c0-.6-.4-1-1-1s-1 .4-1 1c0 5.5 4.5 10 10 10c2.6 0 5.2-1 7-2.9V21c0 .6.4 1 1 1s1-.4 1-1v-4.5c0-.6-.4-1-1-1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M3 22c-.6 0-1-.4-1-1c0-.3.1-.5.3-.7l18-18c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-18 18c-.2.2-.4.3-.7.3"></svg:path>`,
})
export class UimSyncSlashIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimTelegramIcon],svg[uim-telegram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.174 17.152a.705.705 0 0 1-1.002.352l-2.715-2.11l-1.742 1.608a.3.3 0 0 1-.285.039l.334-2.989l.01.009l.007-.059s4.885-4.448 5.084-4.637c.202-.189.135-.23.135-.23c.012-.23-.361 0-.361 0l-6.473 4.164l-2.695-.918s-.414-.148-.453-.475c-.041-.324.466-.5.466-.5l10.717-4.258s.881-.392.881.258z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M11.994 2c-5.523 0-10 4.477-10 10s4.477 10 10 10s10-4.477 10-10s-4.477-10-10-10m3.18 15.152a.705.705 0 0 1-1.002.352l-2.715-2.11l-1.742 1.608a.3.3 0 0 1-.285.039l.334-2.989l.01.009l.007-.059s4.885-4.448 5.084-4.637c.202-.189.135-.23.135-.23c.012-.23-.361 0-.361 0l-6.473 4.164l-2.695-.918s-.414-.149-.453-.475c-.041-.324.466-.5.466-.5l10.717-4.258s.881-.392.881.258z"></svg:path>`,
})
export class UimTelegramIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimTelegramAltIcon],svg[uim-telegram-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.688 21.744a2.02 2.02 0 0 1-1.242-.427l-4.03-3.122l-2.702 2.983a1 1 0 0 1-1.698-.383l-2.02-6.682l-3.626-1.26a2.042 2.042 0 0 1-.103-3.818L20.187 1.8a2.042 2.042 0 0 1 2.771 2.295L19.695 20.11a2.054 2.054 0 0 1-2.008 1.633Z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M8.973 21.506a1 1 0 0 1-.957-.71l-2.168-7.16a1 1 0 0 1 .495-1.176L16.91 6.958a1 1 0 0 1 1.17 1.594l-7.084 7.083l-1.044 5.072a1 1 0 0 1-.933.798z"></svg:path>`,
})
export class UimTelegramAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimTumblrIcon],svg[uim-tumblr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.785 17.974a4.7 4.7 0 0 1-1.614.346a1.755 1.755 0 0 1-1.925-1.972v-6.226h4.017V7.095H13.26V2h-2.93a.16.16 0 0 0-.143.15a6.12 6.12 0 0 1-3.935 5.389v2.583h2.024v6.536c0 2.236 1.65 5.415 6.007 5.34a5.34 5.34 0 0 0 3.463-1.17l-.962-2.854"></svg:path>`,
})
export class UimTumblrIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimTwitterIcon],svg[uim-twitter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimTwitterAltIcon],svg[uim-twitter-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimUnlockIcon],svg[uim-unlock-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7 9h10a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-7a3 3 0 0 1 3-3"></svg:path><svg:path fill="currentColor" d="M9 7a3.002 3.002 0 0 1 5.116-2.13c.378.383.65.858.786 1.379l.002.007a1 1 0 0 0 1.934-.505a5.1 5.1 0 0 0-1.306-2.293A5.002 5.002 0 0 0 7 7v2h2z" opacity=".5"></svg:path>`,
})
export class UimUnlockIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimUnlockAltIcon],svg[uim-unlock-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8 11a1 1 0 0 1-1-1V7a5.002 5.002 0 0 1 8.532-3.542a5.1 5.1 0 0 1 1.306 2.293a1 1 0 0 1-1.934.505l-.002-.007a3.1 3.1 0 0 0-.786-1.379A3.002 3.002 0 0 0 9 7v3a1 1 0 0 1-1 1m4 7a1 1 0 0 1-1-1v-3a1 1 0 1 1 2 0v3a1 1 0 0 1-1 1" opacity=".5"></svg:path><svg:path fill="currentColor" d="M17 9H7a3 3 0 0 0-3 3v7a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-7a3 3 0 0 0-3-3m-4 8a1 1 0 0 1-2 0v-3a1 1 0 1 1 2 0z"></svg:path>`,
})
export class UimUnlockAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimUserMdIcon],svg[uim-user-md-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.998 8.064L6.003 8.11l-.277-3.325A3 3 0 0 1 8.17 1.482l.789-.143a17 17 0 0 1 6.086 0l.786.143a3 3 0 0 1 2.443 3.302Z"></svg:path><svg:path fill="currentColor" d="M6.009 8.109a5.994 5.994 0 0 0 11.984-.045Z" opacity=".25"></svg:path><svg:path fill="currentColor" d="m17.198 13.385l-4.49 4.49a1 1 0 0 1-1.415 0l-4.491-4.49a9.95 9.95 0 0 0-4.736 7.44a1 1 0 0 0 .994 1.108h17.88a1 1 0 0 0 .994-1.108a9.95 9.95 0 0 0-4.736-7.44"></svg:path><svg:path fill="currentColor" d="M15.69 12.654a6.01 6.01 0 0 1-7.381 0a10 10 0 0 0-1.507.73l4.491 4.492a1 1 0 0 0 1.414 0l4.491-4.491a10 10 0 0 0-1.507-.731Z" opacity=".5"></svg:path>`,
})
export class UimUserMdIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVectorSquareAltIcon],svg[uim-vector-square-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4 22a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2M4 6a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2m16 0a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2m0 16a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2m0-2.002"></svg:path><svg:rect width="10" height="10" x="7" y="7" fill="currentColor" opacity=".5" rx="1"></svg:rect><svg:path fill="currentColor" d="M18.278 5a1.94 1.94 0 0 1 0-2H5.722a1.94 1.94 0 0 1 0 2zM20 18a2 2 0 0 1 1 .278V5.722a1.94 1.94 0 0 1-2 0v12.556A2 2 0 0 1 20 18M4 18a2 2 0 0 1 1 .278V5.722a1.94 1.94 0 0 1-2 0v12.556A2 2 0 0 1 4 18m14.278 1H5.722a1.94 1.94 0 0 1 0 2h12.556a1.94 1.94 0 0 1 0-2" opacity=".25"></svg:path>`,
})
export class UimVectorSquareAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVirusSlashIcon],svg[uim-virus-slash-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:circle cx="9" cy="15" r="1" fill="currentColor"></svg:circle><svg:circle cx="15" cy="9" r="1" fill="currentColor"></svg:circle><svg:path fill="currentColor" d="M12 8a1 1 0 0 1-1-1V2a1 1 0 0 1 2 0v5a1 1 0 0 1-1 1m0 15a1 1 0 0 1-1-1v-5a1 1 0 0 1 2 0v5a1 1 0 0 1-1 1m10-10h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2" opacity=".25"></svg:path><svg:path fill="currentColor" d="m4.98 17.607l-.758.757a1 1 0 1 0 1.414 1.414l.758-.757a9 9 0 0 1-1.415-1.414zM19.02 6.394l.758-.758a1 1 0 0 0-1.414-1.414l-.757.757a9 9 0 0 1 1.414 1.415z"></svg:path><svg:path fill="currentColor" d="M6 13H2a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2" opacity=".25"></svg:path><svg:path fill="currentColor" d="M22 23.002a1 1 0 0 1-.707-.293l-20-20a1 1 0 0 1 1.414-1.414l20 20A1 1 0 0 1 22 23.002"></svg:path><svg:path fill="currentColor" d="M15.746 14.334a1.5 1.5 0 0 0-2.08-2.08zM8.252 9.668a1.5 1.5 0 0 0 2.08 2.08z" opacity=".7"></svg:path><svg:path fill="currentColor" d="m17.606 19.022l-7.274-7.274a1.5 1.5 0 0 1-2.08-2.08L4.978 6.394A8.94 8.94 0 0 0 3.06 11H6a1 1 0 0 1 0 2H3.059A9.01 9.01 0 0 0 11 20.94V17a1 1 0 0 1 2 0v3.941a8.95 8.95 0 0 0 4.606-1.919M9 16a1 1 0 1 1 1-1a1 1 0 0 1-1 1M6.392 4.98l7.274 7.274a1.5 1.5 0 0 1 2.08 2.08l3.275 3.274A8.95 8.95 0 0 0 20.94 13H18a1 1 0 0 1 0-2h2.94A9.01 9.01 0 0 0 13 3.059V7a1 1 0 0 1-2 0V3.06a8.95 8.95 0 0 0-4.608 1.92M15 8a1 1 0 1 1-1 1a1 1 0 0 1 1-1" opacity=".5"></svg:path>`,
})
export class UimVirusSlashIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVisualStudioIcon],svg[uim-visual-studio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M9.133 14.242L4.2 18.087l-2.152-1.072V6.994l2.144-1.08l4.9 3.853L16.849 2l5.104 2.033v15.9L16.875 22Zm7.563 1.352V8.406l-4.645 3.598zM4.369 14.301l2.442-2.22l-2.442-2.433Z"></svg:path>`,
})
export class UimVisualStudioIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVkIcon],svg[uim-vk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.146 16.27h-1.459c-.552 0-.718-.447-1.708-1.437c-.864-.833-1.229-.937-1.448-.937c-.302 0-.385.083-.385.5v1.312c0 .355-.115.563-1.042.563a5.7 5.7 0 0 1-4.448-2.667a11.6 11.6 0 0 1-2.302-4.833c0-.219.083-.417.5-.417h1.458c.375 0 .51.167.657.552c.708 2.084 1.916 3.896 2.406 3.896c.187 0 .27-.083.27-.552v-2.146c-.062-.979-.583-1.062-.583-1.416a.36.36 0 0 1 .375-.334h2.292c.313 0 .417.156.417.531v2.896c0 .313.135.417.229.417c.187 0 .333-.104.677-.448c.739-.9 1.342-1.904 1.792-2.98a.63.63 0 0 1 .635-.416h1.458c.438 0 .532.219.438.531a18.2 18.2 0 0 1-1.958 3.365c-.157.24-.22.365 0 .646c.145.219.656.646 1 1.052c.5.499.915 1.076 1.229 1.708c.125.406-.084.615-.5.615z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M15.073 2H8.937C3.333 2 2 3.333 2 8.927v6.136C2 20.666 3.323 22 8.927 22h6.136C20.666 22 22 20.677 22 15.073V8.937C22 3.333 20.677 2 15.073 2m3.073 14.27h-1.459c-.552 0-.718-.447-1.708-1.437c-.864-.833-1.229-.937-1.448-.937c-.302 0-.385.083-.385.5v1.312c0 .355-.115.563-1.042.563a5.7 5.7 0 0 1-4.448-2.667a11.6 11.6 0 0 1-2.302-4.833c0-.219.083-.417.5-.417h1.458c.375 0 .51.167.657.552c.708 2.084 1.916 3.896 2.406 3.896c.188 0 .27-.083.27-.552v-2.146c-.062-.979-.582-1.062-.582-1.416a.36.36 0 0 1 .374-.334h2.292c.313 0 .417.156.417.531v2.896c0 .313.135.417.229.417c.188 0 .333-.104.677-.448a12 12 0 0 0 1.792-2.98a.63.63 0 0 1 .635-.416h1.459c.437 0 .53.219.437.531a18.2 18.2 0 0 1-1.958 3.365c-.157.24-.22.365 0 .646c.146.219.656.646 1 1.052c.5.499.915 1.076 1.229 1.708c.125.406-.084.615-.5.615z"></svg:path>`,
})
export class UimVkIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVkAltIcon],svg[uim-vk-alt-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M15.063 23H8.927C2.777 23 1 21.22 1 15.062V8.928C1 2.778 2.78 1 8.938 1h6.135C21.223 1 23 2.78 23 8.938v6.135C23 21.222 21.22 23 15.062 23z" opacity=".5"></svg:path><svg:path fill="currentColor" d="M11.654 17.002a1 1 0 0 1-.586-.19a13.33 13.33 0 0 1-5.4-8.643a1 1 0 0 1 1.972-.334a11.3 11.3 0 0 0 3.014 5.99V8.001a1 1 0 1 1 2 0v8a1 1 0 0 1-.999 1z"></svg:path><svg:path fill="currentColor" d="M16.655 17.002a1 1 0 0 1-.738-.324L14.27 14.88a3.55 3.55 0 0 0-1.615-1.005v2.126a1 1 0 1 1-2 0v-3.27a1 1 0 0 1 .999-1a5.56 5.56 0 0 1 4.09 1.797l1.647 1.797a1 1 0 0 1-.736 1.676z"></svg:path><svg:path fill="currentColor" d="M11.65 14.96a1 1 0 0 1-1-1V8.04a1 1 0 1 1 2 0v5.92a1 1 0 0 1-1 1"></svg:path><svg:path fill="currentColor" d="M12.57 13.83a1 1 0 0 1-.38-1.926a5.86 5.86 0 0 0 3.485-4.126a1 1 0 1 1 1.95.444a7.87 7.87 0 0 1-4.676 5.534a1 1 0 0 1-.379.074m-.916-4.828h-.003L10.997 9A1 1 0 0 1 10 7.997A1.03 1.03 0 0 1 11.003 7l.654.002a1 1 0 0 1-.003 2"></svg:path>`,
})
export class UimVkAltIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimVuejsIcon],svg[uim-vuejs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m6.976 3.433l3.646.002l1.384 1.956l1.374-1.956l3.643-.001l-5 8.406z"></svg:path><svg:path fill="currentColor" d="M14.6 2.43a1 1 0 0 0-.819.425L12 5.39l-1.791-2.537a1 1 0 0 0-.817-.423H6.38l3.55 5.92l2.1 3.5l2.07-3.5l3.52-5.92z"></svg:path><svg:path fill="currentColor" d="m22.001 2.438l-4.384-.003L14.1 8.35l-2.07 3.5l-2.1-3.5l-3.546-5.913l-4.39.024a1 1 0 0 0-.857 1.506l10.02 17.105a1 1 0 0 0 1.727-.002l9.98-17.128a1 1 0 0 0-.863-1.504" opacity=".5"></svg:path>`,
})
export class UimVuejsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimWhatsappIcon],svg[uim-whatsapp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimWordpressIcon],svg[uim-wordpress-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 2.6a9.4 9.4 0 1 0 9.4 9.4A9.4 9.4 0 0 0 12 2.6" opacity=".25"></svg:path><svg:path fill="currentColor" d="m12.146 12.729l-2.5 7.265a8.34 8.34 0 0 0 5.121-.133a1 1 0 0 1-.06-.115zm-8.48-.73a8.33 8.33 0 0 0 4.698 7.5L4.388 8.61A8.3 8.3 0 0 0 3.667 12"></svg:path><svg:path fill="currentColor" d="M17.626 11.58a4.4 4.4 0 0 0-.687-2.299a3.9 3.9 0 0 1-.819-1.954a1.443 1.443 0 0 1 1.4-1.48c.037 0 .072.005.107.007a8.33 8.33 0 0 0-12.59 1.569c.196.006.38.01.537.01c.871 0 2.22-.106 2.22-.106a.344.344 0 0 1 .054.686s-.452.053-.954.08l3.035 9.026l1.824-5.47l-1.299-3.556c-.449-.027-.874-.08-.874-.08a.344.344 0 0 1 .053-.686s1.376.106 2.195.106c.871 0 2.221-.106 2.221-.106a.344.344 0 0 1 .053.686s-.452.053-.953.08l3.011 8.957l.86-2.724a9.6 9.6 0 0 0 .606-2.747"></svg:path><svg:path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2m7.795 15.255a9.43 9.43 0 0 1-4.136 3.407a9.39 9.39 0 0 1-8.914-.867a9.43 9.43 0 0 1-3.407-4.136a9.39 9.39 0 0 1 .867-8.914a9.43 9.43 0 0 1 4.136-3.407a9.39 9.39 0 0 1 8.914.867a9.43 9.43 0 0 1 3.407 4.136a9.39 9.39 0 0 1-.867 8.914"></svg:path><svg:path fill="currentColor" d="M19.369 8.859a7.9 7.9 0 0 1-.634 2.985l-2.545 7.358a8.334 8.334 0 0 0 3.123-11.2a6 6 0 0 1 .056.857"></svg:path>`,
})
export class UimWordpressIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimWordpressSimpleIcon],svg[uim-wordpress-simple-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[uimWrapTextIcon],svg[uim-wrap-text-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M21 7.167H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2m-12 10H3a1 1 0 1 1 0-2h6a1 1 0 0 1 0 2" opacity=".5"></svg:path><svg:path fill="currentColor" d="M18.5 17.167H15a1 1 0 0 1 0-2h3.5a1.5 1.5 0 0 0 0-3H3a1 1 0 0 1 0-2h15.5a3.5 3.5 0 1 1 0 7"></svg:path><svg:path fill="currentColor" d="M14.999 18.833a1 1 0 0 1-.639-.231l-2-1.666a1 1 0 0 1 0-1.538l2-1.667a1 1 0 0 1 1.28 1.538l-1.078.898l1.078.897a1 1 0 0 1-.641 1.769"></svg:path>`,
})
export class UimWrapTextIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[uimYoutubeIcon],svg[uim-youtube-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
