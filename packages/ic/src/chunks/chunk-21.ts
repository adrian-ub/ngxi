...
@Component({
  standalone: true,
  selector: 'svg[icBaseline11mpIcon],svg[ic-baseline-11mp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
