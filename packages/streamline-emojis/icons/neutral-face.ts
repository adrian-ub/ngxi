...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisNeutralFaceIcon],svg[streamline-emojis-neutral-face-icon]',
  host: {
    role: 'img',
