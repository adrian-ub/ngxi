...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisExpressionlessFaceIcon],svg[streamline-emojis-expressionless-face-icon]',
  host: {
    role: 'img',
