...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisRelievedFace2Icon],svg[streamline-emojis-relieved-face-2-icon]',
  host: {
    role: 'img',
