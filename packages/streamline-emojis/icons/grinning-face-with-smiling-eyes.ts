...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisGrinningFaceWithSmilingEyesIcon],svg[streamline-emojis-grinning-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
