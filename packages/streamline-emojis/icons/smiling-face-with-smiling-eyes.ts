...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisSmilingFaceWithSmilingEyesIcon],svg[streamline-emojis-smiling-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
