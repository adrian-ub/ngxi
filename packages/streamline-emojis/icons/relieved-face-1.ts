...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisRelievedFace1Icon],svg[streamline-emojis-relieved-face-1-icon]',
  host: {
    role: 'img',
