...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisGrinningSquintingFaceIcon],svg[streamline-emojis-grinning-squinting-face-icon]',
  host: {
    role: 'img',
