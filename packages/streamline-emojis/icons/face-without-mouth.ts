...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisFaceWithoutMouthIcon],svg[streamline-emojis-face-without-mouth-icon]',
  host: {
    role: 'img',
