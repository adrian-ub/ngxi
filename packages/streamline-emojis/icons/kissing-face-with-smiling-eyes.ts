...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisKissingFaceWithSmilingEyesIcon],svg[streamline-emojis-kissing-face-with-smiling-eyes-icon]',
  host: {
    role: 'img',
