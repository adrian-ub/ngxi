...
@Component({
  standalone: true,
  selector: 'svg[streamlineEmojisFaceWithRollingEyesIcon],svg[streamline-emojis-face-with-rolling-eyes-icon]',
  host: {
    role: 'img',
