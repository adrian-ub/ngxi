...
@Component({
  standalone: true,
  selector: 'svg[cbiPendantDevoteThreeSolidIcon],svg[cbi-pendant-devote-three-solid-icon]',
  host: {
    role: 'img',
