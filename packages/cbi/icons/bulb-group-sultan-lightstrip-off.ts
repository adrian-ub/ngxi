...
@Component({
  standalone: true,
  selector: 'svg[cbiBulbGroupSultanLightstripOffIcon],svg[cbi-bulb-group-sultan-lightstrip-off-icon]',
  host: {
    role: 'img',
