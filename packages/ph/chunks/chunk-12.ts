...
@Component({
  standalone: true,
  selector: 'svg[phNumberZeroBoldIcon],svg[ph-number-zero-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M186.62 61.05c-13.76-21.62-34-33-58.62-33s-44.86 11.38-58.62 33C58.17 78.66 52 102.44 52 128s6.17 49.33 17.38 66.94C83.14 216.57 103.41 228 128 228s44.86-11.43 58.62-33.06C197.83 177.33 204 153.56 204 128s-6.17-49.34-17.38-66.95m-20.25 121C157.11 196.62 144.2 204 128 204s-29.11-7.38-38.37-21.94C80.84 168.25 76 149.05 76 128s4.84-40.25 13.63-54.06C98.89 59.38 111.8 52 128 52s29.11 7.38 38.37 21.94C175.16 87.75 180 107 180 128s-4.84 40.25-13.63 54.06Z"></svg:path>`,
})
export class PhNumberZeroBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phNyTimesLogoBoldIcon],svg[ph-ny-times-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phOfficeChairBoldIcon],svg[ph-office-chair-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M252 128a12 12 0 0 1-12 12h-13.4a52.09 52.09 0 0 1-50.6 40h-36v16h20a36 36 0 0 1 36 36a12 12 0 0 1-24 0a12 12 0 0 0-12-12h-20v12a12 12 0 0 1-24 0v-12H96a12 12 0 0 0-12 12a12 12 0 0 1-24 0a36 36 0 0 1 36-36h20v-16H80a52.09 52.09 0 0 1-50.6-40H16a12 12 0 0 1 0-24h24a12 12 0 0 1 12 12a28 28 0 0 0 28 28h96a28 28 0 0 0 28-28a12 12 0 0 1 12-12h24a12 12 0 0 1 12 12m-179.18 5a20 20 0 0 1-4.59-16L81.8 29a19.91 19.91 0 0 1 19.79-17h52.82a19.91 19.91 0 0 1 19.79 17l13.57 88A20 20 0 0 1 168 140H88a20 20 0 0 1-15.18-7m19.85-17h70.66L151 36h-46Z"></svg:path>`,
})
export class PhOfficeChairBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phOnigiriBoldIcon],svg[ph-onigiri-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m235 144.51l-55.87-95.86a3 3 0 0 0-.17-.29a60 60 0 0 0-101.96 0a3 3 0 0 0-.17.29L21 144.51A60 60 0 0 0 72.1 236h111.8a60 60 0 0 0 51.1-91.49M156 212h-56v-40h56Zm59.36-18.5A35.55 35.55 0 0 1 183.9 212H180v-44a20 20 0 0 0-20-20H96a20 20 0 0 0-20 20v44h-3.9a36 36 0 0 1-30.58-55l.17-.28l55.82-95.84a36 36 0 0 1 61 0l55.82 95.85l.17.28a35.58 35.58 0 0 1 .85 36.49Z"></svg:path>`,
})
export class PhOnigiriBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phOpenAiLogoBoldIcon],svg[ph-open-ai-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phOptionBoldIcon],svg[ph-option-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M236 192a12 12 0 0 1-12 12h-63.06a19.89 19.89 0 0 1-17.88-11.06L92.58 92H32a12 12 0 0 1 0-24h63.06a19.89 19.89 0 0 1 17.88 11.06L163.42 180H224a12 12 0 0 1 12 12M152 92h72a12 12 0 0 0 0-24h-72a12 12 0 0 0 0 24"></svg:path>`,
})
export class PhOptionBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phOrangeBoldIcon],svg[ph-orange-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phOrangeSliceBoldIcon],svg[ph-orange-slice-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPackageBoldIcon],svg[ph-package-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPaintBrushBoldIcon],svg[ph-paint-brush-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPaintBrushHouseholdBoldIcon],svg[ph-paint-brush-household-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPaintBucketBoldIcon],svg[ph-paint-bucket-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPaletteBoldIcon],svg[ph-palette-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M203.57 51A107.9 107.9 0 0 0 20 128c0 44.72 27.6 82.25 72 97.94A36 36 0 0 0 140 192a12 12 0 0 1 12-12h46.21a35.79 35.79 0 0 0 35.1-28a108.6 108.6 0 0 0 2.69-24.91A107.23 107.23 0 0 0 203.57 51m6.34 95.67a11.91 11.91 0 0 1-11.7 9.3H152a36 36 0 0 0-36 36a12 12 0 0 1-16 11.3c-16.65-5.88-30.65-15.76-40.48-28.56A76 76 0 0 1 44 128a84 84 0 0 1 83.13-84h.87a84.35 84.35 0 0 1 84 83.29a84.7 84.7 0 0 1-2.09 19.42ZM144 76a16 16 0 1 1-16-16a16 16 0 0 1 16 16m-44 24a16 16 0 1 1-16-16a16 16 0 0 1 16 16m0 56a16 16 0 1 1-16-16a16 16 0 0 1 16 16m88-56a16 16 0 1 1-16-16a16 16 0 0 1 16 16"></svg:path>`,
})
export class PhPaletteBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPanoramaBoldIcon],svg[ph-panorama-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPantsBoldIcon],svg[ph-pants-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPaperPlaneRightBoldIcon],svg[ph-paper-plane-right-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M233.86 110.48L65.8 14.58a20 20 0 0 0-28.65 24.06L67.33 128l-30.18 89.36A20 20 0 0 0 56 244a20.1 20.1 0 0 0 9.81-2.58l.09-.06l168-96.07a20 20 0 0 0 0-34.81ZM63.19 215.26L88.61 140H144a12 12 0 0 0 0-24H88.61L63.18 40.72l152.76 87.17Z"></svg:path>`,
})
export class PhPaperPlaneRightBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phParachuteBoldIcon],svg[ph-parachute-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phParkBoldIcon],svg[ph-park-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M232 188h-28v-16h20a12 12 0 0 0 11.64-14.91l-32-128a12 12 0 0 0-23.28 0l-32 128A12 12 0 0 0 160 172h20v16h-64v-12a12 12 0 0 0 0-24v-12a12 12 0 0 0 0-24H32a12 12 0 0 0 0 24v12a12 12 0 0 0 0 24v12h-8a12 12 0 0 0 0 24h208a12 12 0 0 0 0-24M192 81.48L208.63 148h-33.26ZM56 140h36v12H56Zm0 36h36v12H56Zm60-76a32 32 0 1 0-32-32a32 32 0 0 0 32 32m0-40a8 8 0 1 1-8 8a8 8 0 0 1 8-8"></svg:path>`,
})
export class PhParkBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPatreonLogoBoldIcon],svg[ph-patreon-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPawPrintBoldIcon],svg[ph-paw-print-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M236 108a24 24 0 1 1-24-24a24 24 0 0 1 24 24m-168 0a24 24 0 1 0-24 24a24 24 0 0 0 24-24m24-24a24 24 0 1 0-24-24a24 24 0 0 0 24 24m72 0a24 24 0 1 0-24-24a24 24 0 0 0 24 24m48 100a44 44 0 0 1-61.1 40.55a60.15 60.15 0 0 0-45.8 0A44 44 0 0 1 67 145.34a31.33 31.33 0 0 0 14.91-18.74a48 48 0 0 1 92.18 0A31.34 31.34 0 0 0 189 145.34A44 44 0 0 1 212 184m-24 0a20 20 0 0 0-10.49-17.6l-.1-.06a55.22 55.22 0 0 1-26.37-33a24 24 0 0 0-46.08 0a55.2 55.2 0 0 1-26.37 33.05l-.1.06A20 20 0 0 0 88 204a19.8 19.8 0 0 0 7.8-1.58h.13a84 84 0 0 1 64.14 0h.13A19.8 19.8 0 0 0 168 204a20 20 0 0 0 20-20"></svg:path>`,
})
export class PhPawPrintBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPaypalLogoBoldIcon],svg[ph-paypal-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPenNibBoldIcon],svg[ph-pen-nib-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M252 92.68a19.86 19.86 0 0 0-5.86-14.14L177.46 9.85a20 20 0 0 0-28.29 0l-27.82 27.82l-57.24 21.47A20 20 0 0 0 51.4 74.58L28.16 214A12 12 0 0 0 40 228a12 12 0 0 0 2-.16l139.45-23.25a20.07 20.07 0 0 0 15.44-12.7l21.46-57.25l27.82-27.82A19.85 19.85 0 0 0 252 92.68m-76.8 88.62L75 198l33-33a34 34 0 1 0-17-17l-33 33L74.7 80.8L125 61.94L194.05 131ZM112 134a10 10 0 1 1 10 10a10 10 0 0 1-10-10m96-23l-63-63l18.34-18.34l63 63Z"></svg:path>`,
})
export class PhPenNibBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPenNibStraightBoldIcon],svg[ph-pen-nib-straight-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPencilCircleBoldIcon],svg[ph-pencil-circle-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPencilSimpleSlashBoldIcon],svg[ph-pencil-simple-slash-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPencilSlashBoldIcon],svg[ph-pencil-slash-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class PhPencilSlashBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPentagonBoldIcon],svg[ph-pentagon-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m228 84.38l-87.9-68.29l-.26-.2a19.92 19.92 0 0 0-23.66 0l-.26.2L28 84.38a20 20 0 0 0-7.09 22l32 107.51l.08.26A19.93 19.93 0 0 0 72 228h112a19.93 19.93 0 0 0 19-13.87l.08-.26l32-107.51A20 20 0 0 0 228 84.38M181 204H75L44.62 101.87L128 37.09l83.38 64.78Z"></svg:path>`,
})
export class PhPentagonBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPentagramBoldIcon],svg[ph-pentagram-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M243 89.83A19.94 19.94 0 0 0 224 76h-58.15l-18.8-57.95A19.93 19.93 0 0 0 109 18L90.15 76H32a20 20 0 0 0-11.7 36.22l47.1 33.89l-18.07 55.7a20 20 0 0 0 30.74 22.39L128 189.71l47.89 34.45a20 20 0 0 0 30.78-22.35l-18.07-55.7l47.15-33.92A20 20 0 0 0 243 89.83M128 37.11L140.62 76h-25.24ZM44.42 100h37.94l-7.18 22.13Zm31.51 97.6l11.93-36.78l19.59 14.1Zm19.71-60.75l12-36.85h40.82l12 36.85L128 160.14Zm52.91 38.07l19.59-14.1l11.93 36.78Zm32.27-52.79L173.64 100h37.94Z"></svg:path>`,
})
export class PhPentagramBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPepperBoldIcon],svg[ph-pepper-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonArmsSpreadBoldIcon],svg[ph-person-arms-spread-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M235.4 86.85A23.55 23.55 0 0 0 212 68h-61.41a36 36 0 1 0-45.18 0H44a24 24 0 0 0-10 45.79l.19.09l47.63 21L61.76 211a24 24 0 0 0 12.11 30.74A23.8 23.8 0 0 0 84 244a24 24 0 0 0 21.52-13.29l22.48-38.8l22.51 38.8A24 24 0 0 0 194.24 211l-20-76.15l47.63-21l.19-.09a23.55 23.55 0 0 0 13.34-26.91M128 28a12 12 0 1 1-12 12a12 12 0 0 1 12-12m27.16 89a12 12 0 0 0-6.77 14l22.87 87a12 12 0 0 0 .73 2c-.15-.32-.32-.64-.5-.95L138.38 162a12 12 0 0 0-20.76 0l-33.11 57.05c-.18.31-.35.63-.5.95a12 12 0 0 0 .73-2l22.87-86.92a12 12 0 0 0-6.77-14L44 92h168Z"></svg:path>`,
})
export class PhPersonArmsSpreadBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPersonBoldIcon],svg[ph-person-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleBikeBoldIcon],svg[ph-person-simple-bike-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M168 84a32 32 0 1 0-32-32a32 32 0 0 0 32 32m0-40a8 8 0 1 1-8 8a8 8 0 0 1 8-8m36 96a40 40 0 1 0 40 40a40 40 0 0 0-40-40m0 56a16 16 0 1 1 16-16a16 16 0 0 1-16 16M54 136a42 42 0 1 0 42 42a42 42 0 0 0-42-42m0 60a18 18 0 1 1 18-18a18 18 0 0 1-18 18m134-68h-36a12 12 0 0 1-8.49-3.51L120 101l-15 15l31.52 31.51A12 12 0 0 1 140 156v48a12 12 0 0 1-24 0v-43l-36.49-36.51a12 12 0 0 1 0-17l32-32a12 12 0 0 1 17 0L157 104h31a12 12 0 0 1 0 24"></svg:path>`,
})
export class PhPersonSimpleBikeBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleCircleBoldIcon],svg[ph-person-simple-circle-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M128 20a108 108 0 1 0 108 108A108.12 108.12 0 0 0 128 20m0 192a84 84 0 1 1 84-84a84.09 84.09 0 0 1-84 84M108 80a20 20 0 1 1 20 20a20 20 0 0 1-20-20m76 40a12 12 0 0 1-12 12h-32v.51l26.12 41.05a12 12 0 0 1-3.68 16.56A11.83 11.83 0 0 1 156 192a12 12 0 0 1-10.13-5.56L128 158.35l-17.88 28.09a12 12 0 0 1-20.24-12.88L116 132.51V132H84a12 12 0 0 1 0-24h88a12 12 0 0 1 12 12"></svg:path>`,
})
export class PhPersonSimpleCircleBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleHikeBoldIcon],svg[ph-person-simple-hike-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleRunBoldIcon],svg[ph-person-simple-run-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M152 92a36 36 0 1 0-36-36a36 36 0 0 0 36 36m0-48a12 12 0 1 1-12 12a12 12 0 0 1 12-12m76 93.4a12 12 0 0 1-7 10.91a66 66 0 0 1-21.47 3.78c-14 0-34.25-3.82-59.77-19a177 177 0 0 1-10.27 21C153.12 162.83 188 183.8 188 232a12 12 0 0 1-24 0c0-18.69-6.95-33.06-21.26-43.94c-9.16-7-19.55-11-27.43-13.34c-.81 1-1.64 2-2.5 2.95c-20 22.87-44.82 34.76-72.25 34.76a97 97 0 0 1-9.75-.49a12 12 0 1 1 2.39-23.88c52.3 5.22 77.48-45.92 85.79-67.75c-34.19-17.85-55.25-1.53-55.48-1.31a12 12 0 0 1-15-18.72C50.08 99 88 69.44 142.75 106.62c43.1 29.31 68.1 19.92 68.5 19.76a12 12 0 0 1 16.75 11Z"></svg:path>`,
})
export class PhPersonSimpleRunBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleSkiBoldIcon],svg[ph-person-simple-ski-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleSnowboardBoldIcon],svg[ph-person-simple-snowboard-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M168 80a32 32 0 1 0-32-32a32 32 0 0 0 32 32m0-40a8 8 0 1 1-8 8a8 8 0 0 1 8-8m51.38 68.48l-136-40a12 12 0 0 0-6.77 23L112.25 102l-28.64 43L44 133.27a30.79 30.79 0 0 0-27.38 4.94A31.18 31.18 0 0 0 4 163.39a31.53 31.53 0 0 0 22.43 30.11L180 238.71a31.23 31.23 0 0 0 40-30.11a31.52 31.52 0 0 0-22.44-30.11l-39.74-11.7L170 148.68a12 12 0 0 0-6.62-18.21l-34.56-10l7.58-11.38l76.25 22.43a12 12 0 1 0 6.77-23ZM196 208.6a7.36 7.36 0 0 1-3 6a6.92 6.92 0 0 1-6.23 1.13L33.21 170.48A7.46 7.46 0 0 1 31 157.42a7 7 0 0 1 6.23-1.13l153.59 45.22a7.39 7.39 0 0 1 5.18 7.09M140.88 149l-7.2 10.73l-26-7.64l7.1-10.64Z"></svg:path>`,
})
export class PhPersonSimpleSnowboardBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleSwimBoldIcon],svg[ph-person-simple-swim-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleThrowBoldIcon],svg[ph-person-simple-throw-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPersonSimpleWalkBoldIcon],svg[ph-person-simple-walk-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class PhPersonSimpleWalkBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneBoldIcon],svg[ph-phone-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneCallBoldIcon],svg[ph-phone-call-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneDisconnectBoldIcon],svg[ph-phone-disconnect-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneIncomingBoldIcon],svg[ph-phone-incoming-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneListBoldIcon],svg[ph-phone-list-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneOutgoingBoldIcon],svg[ph-phone-outgoing-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M143.52 112.48a12 12 0 0 1 0-17L171 68h-11a12 12 0 0 1 0-24h40a12 12 0 0 1 12 12v40a12 12 0 0 1-24 0V85l-27.51 27.51a12 12 0 0 1-17 0Zm84.33 71.1A60.27 60.27 0 0 1 168 236C86.39 236 20 169.61 20 88a60.27 60.27 0 0 1 52.42-59.85A20.05 20.05 0 0 1 93.2 40l21.11 47.13a1.4 1.4 0 0 0 .08.18a20 20 0 0 1-1.66 18.83a11 11 0 0 1-.85 1.15L92.82 130c7.06 12.84 20.5 26.16 33.49 33.21l22.31-19a13 13 0 0 1 1.12-.84a19.91 19.91 0 0 1 19-1.74l.18.08L216 162.8a20.06 20.06 0 0 1 11.85 20.78m-24.31-.06l-42-18.81l-22.43 19.07a12 12 0 0 1-1.11.85a20 20 0 0 1-19.69 1.37c-19.48-9.4-38.89-28.68-48.31-48a20 20 0 0 1 1.28-19.64a11 11 0 0 1 .86-1.15L91.3 94.5l-18.82-42A36.29 36.29 0 0 0 44 88a124.15 124.15 0 0 0 124 124a36.29 36.29 0 0 0 35.54-28.48"></svg:path>`,
})
export class PhPhoneOutgoingBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPhonePauseBoldIcon],svg[ph-phone-pause-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m216 162.8l-47.09-21.1l-.18-.08a19.89 19.89 0 0 0-19 1.74a13 13 0 0 0-1.12.84l-22.31 19c-13-7.05-26.43-20.37-33.49-33.21l19.06-22.66a11 11 0 0 0 .85-1.15a20 20 0 0 0 1.66-18.83l-.08-.18L93.2 40a20.06 20.06 0 0 0-20.78-11.85A60.27 60.27 0 0 0 20 88c0 81.61 66.39 148 148 148a60.27 60.27 0 0 0 59.85-52.42A20.06 20.06 0 0 0 216 162.8M168 212A124.15 124.15 0 0 1 44 88a36.27 36.27 0 0 1 28.48-35.53l18.82 42l-19.16 22.8a11 11 0 0 0-.86 1.15A20 20 0 0 0 70 138.08c9.42 19.28 28.83 38.56 48.31 48a20 20 0 0 0 19.69-1.45a12 12 0 0 0 1.11-.85l22.43-19.07l42 18.81A36.29 36.29 0 0 1 168 212m20-108V48a12 12 0 0 1 24 0v56a12 12 0 0 1-24 0m-40 0V48a12 12 0 0 1 24 0v56a12 12 0 0 1-24 0"></svg:path>`,
})
export class PhPhonePauseBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPhonePlusBoldIcon],svg[ph-phone-plus-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m216 162.8l-47.09-21.1l-.18-.08a19.89 19.89 0 0 0-19 1.74a13 13 0 0 0-1.12.84l-22.31 19c-13-7.05-26.43-20.37-33.49-33.21l19.06-22.66a11 11 0 0 0 .85-1.15a20 20 0 0 0 1.66-18.83a1.4 1.4 0 0 1-.08-.18L93.2 40a20.05 20.05 0 0 0-20.78-11.85A60.27 60.27 0 0 0 20 88c0 81.61 66.39 148 148 148a60.27 60.27 0 0 0 59.85-52.42A20.06 20.06 0 0 0 216 162.8M168 212A124.15 124.15 0 0 1 44 88a36.27 36.27 0 0 1 28.48-35.53l18.82 42l-19.16 22.8a11 11 0 0 0-.86 1.15A20 20 0 0 0 70 138.08c9.42 19.28 28.83 38.56 48.31 48a20 20 0 0 0 19.69-1.45a12 12 0 0 0 1.11-.85l22.43-19.07l42 18.81A36.29 36.29 0 0 1 168 212M132 80a12 12 0 0 1 12-12h20V48a12 12 0 0 1 24 0v20h20a12 12 0 0 1 0 24h-20v20a12 12 0 0 1-24 0V92h-20a12 12 0 0 1-12-12"></svg:path>`,
})
export class PhPhonePlusBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneSlashBoldIcon],svg[ph-phone-slash-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneTransferBoldIcon],svg[ph-phone-transfer-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhoneXBoldIcon],svg[ph-phone-x-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPhosphorLogoBoldIcon],svg[ph-phosphor-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M228 104a76.08 76.08 0 0 0-76-76H72a12 12 0 0 0-12 12v128a84.09 84.09 0 0 0 84 84a12 12 0 0 0 12-12v-60.11A76.09 76.09 0 0 0 228 104M84 85.81L123.48 156H84Zm48 36.38L92.52 52H132ZM85.22 180H132v46.79A60.18 60.18 0 0 1 85.22 180M156 155.83V52.17a52 52 0 0 1 0 103.66"></svg:path>`,
})
export class PhPhosphorLogoBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
