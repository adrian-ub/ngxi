...
@Component({
  standalone: true,
  selector: 'svg[phTramBoldIcon],svg[ph-tram-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
