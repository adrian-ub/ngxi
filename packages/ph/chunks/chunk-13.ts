...
@Component({
  standalone: true,
  selector: 'svg[phPiggyBankBoldIcon],svg[ph-piggy-bank-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPillBoldIcon],svg[ph-pill-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M219.26 36.77a57.28 57.28 0 0 0-81 0L36.77 138.26a57.26 57.26 0 0 0 81 81l101.49-101.52a57.33 57.33 0 0 0 0-80.97M100.78 202.26a33.26 33.26 0 1 1-47-47L96 113l47 47Zm101.5-101.49L160 143l-47-47l42.27-42.26a33.26 33.26 0 0 1 47 47Zm-9.77-25.26a12 12 0 0 1 0 17l-24 24a12 12 0 1 1-17-17l24-24a12 12 0 0 1 17 0"></svg:path>`,
})
export class PhPillBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPingPongBoldIcon],svg[ph-ping-pong-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPinwheelBoldIcon],svg[ph-pinwheel-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m232.49 215.52l-44-44a64 64 0 0 0 35.59-81a12 12 0 0 0-15.38-7.17l-35.61 13a64 64 0 0 0-82.5-80.46a12 12 0 0 0-7.17 15.38l13 35.61a64 64 0 0 0-80.49 82.55a12 12 0 0 0 15.38 7.17l35.61-13a63.94 63.94 0 0 0 82.55 80.49a12 12 0 0 0 7.17-15.38l-12.95-35.59a63.5 63.5 0 0 0 15.7 3.16l56.17 56.17a12 12 0 0 0 17-17ZM129.38 39.78a40 40 0 0 1 7.43 68L110.7 36.05a39.8 39.8 0 0 1 18.68 3.73m-93.33 89.54a40 40 0 0 1 71.75-26.11Zm74.59 70.92a40 40 0 0 1-7.43-68L129.32 204a39.8 39.8 0 0 1-18.68-3.76m36.45-51.51a39.86 39.86 0 0 1-14.87-11.92L204 110.7a40 40 0 0 1-56.88 38Z"></svg:path>`,
})
export class PhPinwheelBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPipeBoldIcon],svg[ph-pipe-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPipeWrenchBoldIcon],svg[ph-pipe-wrench-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPixLogoBoldIcon],svg[ph-pix-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPizzaBoldIcon],svg[ph-pizza-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPlanetBoldIcon],svg[ph-planet-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPlantBoldIcon],svg[ph-plant-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M255.62 51.65a12 12 0 0 0-11.27-11.27c-53.27-3.13-96.2 13.36-114.84 44.14c-12.14 20-12.56 44.17-1.46 67.3a75.1 75.1 0 0 0-12.28 23l-12.66-12.66c7.19-16.77 6.43-34.11-2.4-48.69C86.73 90.36 54.89 78 15.55 80.27A12 12 0 0 0 4.28 91.55C2 130.89 14.36 162.73 37.45 176.71a49.76 49.76 0 0 0 26 7.27a57.5 57.5 0 0 0 22.7-4.87L112 205v23a12 12 0 0 0 24 0v-29.49a51.63 51.63 0 0 1 9.49-29.95a76.8 76.8 0 0 0 32.1 7.39a64.9 64.9 0 0 0 33.89-9.46c30.77-18.64 47.28-61.57 44.14-114.84M49.88 156.18c-13.19-8-21.18-27.46-21.83-52.13c24.67.65 44.14 8.64 52.13 21.83a26 26 0 0 1 3.63 17l-11.33-11.37a12 12 0 0 0-17 17l11.34 11.34a26.27 26.27 0 0 1-16.94-3.67M199.05 146c-10.66 6.45-23 7.67-35.81 3.76l37.25-37.24a12 12 0 0 0-17-17l-37.25 37.24C142.37 120 143.59 107.61 150 97c12.7-21 42.65-33 81.32-33h.68c.14 39-11.86 69.18-32.95 82"></svg:path>`,
})
export class PhPlantBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPlaylistBoldIcon],svg[ph-playlist-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M28 64a12 12 0 0 1 12-12h176a12 12 0 0 1 0 24H40a12 12 0 0 1-12-12m12 76h116a12 12 0 0 0 0-24H40a12 12 0 0 0 0 24m68 40H40a12 12 0 0 0 0 24h68a12 12 0 0 0 0-24m143.49-52.55a12 12 0 0 1-14.94 8L212 128.13V192a36 36 0 1 1-24-33.94V112a12 12 0 0 1 15.45-11.49l40 12a12 12 0 0 1 8.04 14.94M188 192a12 12 0 1 0-12 12a12 12 0 0 0 12-12"></svg:path>`,
})
export class PhPlaylistBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPlugBoldIcon],svg[ph-plug-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPlugChargingBoldIcon],svg[ph-plug-charging-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M224 48h-44V16a12 12 0 0 0-24 0v32h-56V16a12 12 0 0 0-24 0v32H32.55C24.4 48 20 54.18 20 60a12 12 0 0 0 12 12h12v92a44.05 44.05 0 0 0 44 44h28v32a12 12 0 0 0 24 0v-32h28a44.05 44.05 0 0 0 44-44V72h12a12 12 0 0 0 0-24m-36 116a20 20 0 0 1-20 20H88a20 20 0 0 1-20-20V72h120Zm-85.86-29.17a12 12 0 0 1-1.38-11l12-32a12 12 0 1 1 22.48 8.42L129.32 116H144a12 12 0 0 1 11.24 16.21l-12 32a12 12 0 0 1-22.48-8.42l5.92-15.79H112a12 12 0 0 1-9.86-5.17"></svg:path>`,
})
export class PhPlugChargingBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPlugsBoldIcon],svg[ph-plugs-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPlugsConnectedBoldIcon],svg[ph-plugs-connected-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPlusBoldIcon],svg[ph-plus-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M228 128a12 12 0 0 1-12 12h-76v76a12 12 0 0 1-24 0v-76H40a12 12 0 0 1 0-24h76V40a12 12 0 0 1 24 0v76h76a12 12 0 0 1 12 12"></svg:path>`,
})
export class PhPlusBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPokerChipBoldIcon],svg[ph-poker-chip-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M128 20a108 108 0 1 0 108 108A108.12 108.12 0 0 0 128 20m0 144a36 36 0 1 1 36-36a36 36 0 0 1-36 36m33.06-86A59.5 59.5 0 0 0 140 69.21V44.87a83.55 83.55 0 0 1 38.28 15.88ZM116 69.21A59.5 59.5 0 0 0 94.94 78L77.72 60.75A83.55 83.55 0 0 1 116 44.87ZM78 94.94A59.5 59.5 0 0 0 69.21 116H44.87a83.6 83.6 0 0 1 15.88-38.28ZM69.21 140A59.5 59.5 0 0 0 78 161.06l-17.25 17.22A83.6 83.6 0 0 1 44.87 140Zm25.73 38a59.5 59.5 0 0 0 21.06 8.79v24.34a83.55 83.55 0 0 1-38.28-15.88Zm45.06 8.79a59.5 59.5 0 0 0 21.06-8.79l17.22 17.22A83.55 83.55 0 0 1 140 211.13Zm38-25.73a59.5 59.5 0 0 0 8.79-21.06h24.34a83.6 83.6 0 0 1-15.88 38.28Zm8.79-45.06A59.5 59.5 0 0 0 178 94.94l17.22-17.22A83.6 83.6 0 0 1 211.13 116Z"></svg:path>`,
})
export class PhPokerChipBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPoliceCarBoldIcon],svg[ph-police-car-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPolygonBoldIcon],svg[ph-polygon-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPottedPlantBoldIcon],svg[ph-potted-plant-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phProjectorScreenChartBoldIcon],svg[ph-projector-screen-chart-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M104 128v8a12 12 0 0 1-24 0v-8a12 12 0 0 1 24 0m24-16a12 12 0 0 0-12 12v12a12 12 0 0 0 24 0v-12a12 12 0 0 0-12-12m36-4a12 12 0 0 0-12 12v16a12 12 0 0 0 24 0v-16a12 12 0 0 0-12-12m56-16.4V164h4a12 12 0 0 1 0 24h-84v23.22a24 24 0 1 1-24 0V188H32a12 12 0 0 1 0-24h4V91.6A20 20 0 0 1 20 72V48a20 20 0 0 1 20-20h176a20 20 0 0 1 20 20v24a20 20 0 0 1-16 19.6M44 68h168V52H44Zm152 96V92H60v72Z"></svg:path>`,
})
export class PhProjectorScreenChartBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPulseBoldIcon],svg[ph-pulse-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M244 128a12 12 0 0 1-12 12h-24.58l-36.69 73.37A12 12 0 0 1 160 220h-.6a12 12 0 0 1-10.61-7.72L95 71.15L66.92 133A12 12 0 0 1 56 140H24a12 12 0 0 1 0-24h24.27l36.81-81a12 12 0 0 1 22.13.7l54.28 142.46l27.78-55.56A12 12 0 0 1 200 116h32a12 12 0 0 1 12 12"></svg:path>`,
})
export class PhPulseBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPushPinBoldIcon],svg[ph-push-pin-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPushPinSimpleSlashBoldIcon],svg[ph-push-pin-simple-slash-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phPushPinSlashBoldIcon],svg[ph-push-pin-slash-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
export class PhPushPinSlashBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phPuzzlePieceBoldIcon],svg[ph-puzzle-piece-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phQuestionBoldIcon],svg[ph-question-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M144 180a16 16 0 1 1-16-16a16 16 0 0 1 16 16m92-52A108 108 0 1 1 128 20a108.12 108.12 0 0 1 108 108m-24 0a84 84 0 1 0-84 84a84.09 84.09 0 0 0 84-84m-84-64c-24.26 0-44 17.94-44 40v4a12 12 0 0 0 24 0v-4c0-8.82 9-16 20-16s20 7.18 20 16s-9 16-20 16a12 12 0 0 0-12 12v8a12 12 0 0 0 23.73 2.56C158.31 137.88 172 122.37 172 104c0-22.06-19.74-40-44-40"></svg:path>`,
})
export class PhQuestionBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRabbitBoldIcon],svg[ph-rabbit-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M120 160a16 16 0 1 1-16-16a16 16 0 0 1 16 16m32-16a16 16 0 1 0 16 16a16 16 0 0 0-16-16m68 44a56 56 0 0 1-92 42.89a56 56 0 0 1-75-83a75.5 75.5 0 0 1 5.59-18.74a241.5 241.5 0 0 1-19.8-58.23C35.55 54.21 33.54 31.35 42.21 17A25.89 25.89 0 0 1 65.06 4c22.63 0 40.6 27.11 53.48 80.6a75 75 0 0 1 18.92 0C150.34 31.11 168.31 4 190.94 4a25.89 25.89 0 0 1 22.85 13c8.67 14.34 6.66 37.2 3.45 53.86a241.5 241.5 0 0 1-19.8 58.23a75.6 75.6 0 0 1 5.56 18.75A55.76 55.76 0 0 1 220 188m-59.47-96.68a75.8 75.8 0 0 1 18.72 12.56c.78.71 1.53 1.43 2.28 2.17a211 211 0 0 0 12.14-39.73c3.9-20.23 2.34-32.33-.42-36.9c-.82-1.35-1.25-1.42-2.31-1.42c-6.17 0-19.43 17.4-30.41 63.32m-86.06 14.73c.74-.73 1.5-1.46 2.28-2.17a75.8 75.8 0 0 1 18.72-12.56C84.49 45.4 71.23 28 65.06 28c-1.08 0-1.49.07-2.31 1.42c-6.21 10.28-2.02 43.42 11.72 76.63M196 188a31.9 31.9 0 0 0-11.86-24.87a12 12 0 0 1-4.38-8.17a52 52 0 0 0-103.52 0a12 12 0 0 1-4.38 8.17a32 32 0 0 0 38.47 51.08l-6-5a12 12 0 0 1 15.34-18.46l8.33 6.95l8.33-6.93a12 12 0 1 1 15.34 18.46l-6 5A32 32 0 0 0 196 188"></svg:path>`,
})
export class PhRabbitBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRacquetBoldIcon],svg[ph-racquet-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRadioBoldIcon],svg[ph-radio-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRadioactiveBoldIcon],svg[ph-radioactive-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRainbowCloudBoldIcon],svg[ph-rainbow-cloud-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M204 108a52.23 52.23 0 0 0-47.23 30.23H156c-19.85 0-36 16.55-36 36.89S136.15 212 156 212h48a52 52 0 0 0 0-104m0 80h-48c-6.62 0-12-5.78-12-12.89s5.38-12.89 12-12.89a11 11 0 0 1 4.26.84a12 12 0 0 0 16.31-8.71A28 28 0 1 1 204 188m-94.78-51.16a12 12 0 0 1-2.12 16.83A8 8 0 0 0 104 160v16a12 12 0 0 1-24 0v-16a31.8 31.8 0 0 1 12.38-25.28a12 12 0 0 1 16.84 2.12m27.44-18A48 48 0 0 0 64 160v16a12 12 0 0 1-24 0v-16a72 72 0 0 1 109-61.77a12 12 0 0 1-12.35 20.58ZM24 160v16a12 12 0 0 1-24 0v-16a112 112 0 0 1 185.47-84.54a12 12 0 0 1-15.75 18.11A88 88 0 0 0 24 160"></svg:path>`,
})
export class PhRainbowCloudBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRankingBoldIcon],svg[ph-ranking-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M108.62 103.79a12 12 0 0 1 7.59-15.17l12-4A12 12 0 0 1 144 96v40a12 12 0 0 1-24 0v-24a12 12 0 0 1-11.38-8.21M252 208a12 12 0 0 1-12 12H16a12 12 0 0 1 0-24h4v-92a20 20 0 0 1 20-20h36V56a20 20 0 0 1 20-20h64a20 20 0 0 1 20 20v68h36a20 20 0 0 1 20 20v52h4a12 12 0 0 1 12 12m-72-60v48h32v-48Zm-80 48h56V60h-56Zm-56 0h32v-88H44Z"></svg:path>`,
})
export class PhRankingBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phReadCvLogoBoldIcon],svg[ph-read-cv-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phReceiptXBoldIcon],svg[ph-receipt-x-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRecycleBoldIcon],svg[ph-recycle-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M100 208a12 12 0 0 1-12 12H40a28 28 0 0 1-24.23-42l29.45-50.88l-4.76 1.27a12 12 0 1 1-6.2-23.18l32.77-8.77a12 12 0 0 1 14.69 8.48l8.79 32.77a12 12 0 1 1-23.17 6.22L66.08 139l-29.5 51a4 4 0 0 0 3.42 6h48a12 12 0 0 1 12 12m28-172a3.87 3.87 0 0 1 3.46 2l29.45 50.87l-4.75-1.27a12 12 0 1 0-6.16 23.18l32.77 8.79a12 12 0 0 0 14.69-8.48l8.74-32.79a12 12 0 1 0-23.2-6.22l-1.31 4.86L152.23 26a28 28 0 0 0-48.46 0L80.61 66a12 12 0 1 0 20.77 12l23.16-40a3.87 3.87 0 0 1 3.46-2m112.19 142l-23.14-40a12 12 0 1 0-20.77 12l23.14 40a4 4 0 0 1-3.46 6H157l3.51-3.51a12 12 0 1 0-17-17l-24 24a12 12 0 0 0 0 17l24 24a12 12 0 1 0 17-17L157 220h59a28 28 0 0 0 24.23-42Z"></svg:path>`,
})
export class PhRecycleBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRedditLogoBoldIcon],svg[ph-reddit-logo-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRepeatBoldIcon],svg[ph-repeat-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M20 128a76.08 76.08 0 0 1 76-76h99l-3.52-3.51a12 12 0 1 1 17-17l24 24a12 12 0 0 1 0 17l-24 24a12 12 0 0 1-17-17L195 76H96a52.06 52.06 0 0 0-52 52a12 12 0 0 1-24 0m204-12a12 12 0 0 0-12 12a52.06 52.06 0 0 1-52 52H61l3.52-3.51a12 12 0 1 0-17-17l-24 24a12 12 0 0 0 0 17l24 24a12 12 0 1 0 17-17L61 204h99a76.08 76.08 0 0 0 76-76a12 12 0 0 0-12-12"></svg:path>`,
})
export class PhRepeatBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRepeatOnceBoldIcon],svg[ph-repeat-once-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRewindCircleBoldIcon],svg[ph-rewind-circle-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M128 20a108 108 0 1 0 108 108A108.12 108.12 0 0 0 128 20m0 192a84 84 0 1 1 84-84a84.09 84.09 0 0 1-84 84m52-116v64a12 12 0 0 1-19.5 9.37l-36.5-29.2V160a12 12 0 0 1-19.5 9.37l-40-32a12 12 0 0 1 0-18.74l40-32A12 12 0 0 1 124 96v19.83l36.5-29.2A12 12 0 0 1 180 96"></svg:path>`,
})
export class PhRewindCircleBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRobotBoldIcon],svg[ph-robot-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M72 104a16 16 0 1 1 16 16a16 16 0 0 1-16-16m96 16a16 16 0 1 0-16-16a16 16 0 0 0 16 16m68-40v112a36 36 0 0 1-36 36H56a36 36 0 0 1-36-36V80a36 36 0 0 1 36-36h60V16a12 12 0 0 1 24 0v28h60a36 36 0 0 1 36 36m-24 0a12 12 0 0 0-12-12H56a12 12 0 0 0-12 12v112a12 12 0 0 0 12 12h144a12 12 0 0 0 12-12Zm-12 82a30 30 0 0 1-30 30H86a30 30 0 0 1 0-60h84a30 30 0 0 1 30 30m-80-6v12h16v-12Zm-34 12h10v-12H86a6 6 0 0 0 0 12m90-6a6 6 0 0 0-6-6h-10v12h10a6 6 0 0 0 6-6"></svg:path>`,
})
export class PhRobotBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRocketBoldIcon],svg[ph-rocket-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M156 228a12 12 0 0 1-12 12h-32a12 12 0 0 1 0-24h32a12 12 0 0 1 12 12m-28-112a16 16 0 1 0-16-16a16 16 0 0 0 16 16m99.53 40.7l-12.36 55.63a19.9 19.9 0 0 1-12.88 14.53a20.2 20.2 0 0 1-6.69 1.14a19.87 19.87 0 0 1-12.29-4.27L157.17 204H98.83l-26.14 19.74A19.87 19.87 0 0 1 60.4 228a20.2 20.2 0 0 1-6.69-1.15a19.9 19.9 0 0 1-12.88-14.53L28.47 156.7a20.1 20.1 0 0 1 4.16-17.14l27.83-33.4a127 127 0 0 1 8.65-36.46c13.27-33.25 37-54.1 46.64-61.52a20 20 0 0 1 24.5 0c9.6 7.42 33.37 28.27 46.64 61.52a127 127 0 0 1 8.65 36.46l27.83 33.4a20.1 20.1 0 0 1 4.16 17.14M101.79 180h52.42c19.51-35.7 23-69.78 10.39-101.4C154.4 53 136.2 35.9 128 29.12C119.8 35.9 101.6 53 91.4 78.6c-12.62 31.62-9.12 65.7 10.39 101.4m-22.55 8.72a168 168 0 0 1-16.92-47.3l-10 12l10.58 47.64Zm124.43-35.31l-10-12a168 168 0 0 1-16.92 47.3l16.33 12.33Z"></svg:path>`,
})
export class PhRocketBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[phRocketLaunchBoldIcon],svg[ph-rocket-launch-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[phRowsPlusBottomBoldIcon],svg[ph-rows-plus-bottom-bold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M208 112H48a20 20 0 0 0-20 20v24a20 20 0 0 0 20 20h160a20 20 0 0 0 20-20v-24a20 20 0 0 0-20-20m-4 40H52v-16h152Zm4-116H48a20 20 0 0 0-20 20v24a20 20 0 0 0 20 20h160a20 20 0 0 0 20-20V56a20 20 0 0 0-20-20m-4 40H52V60h152Zm-44 144a12 12 0 0 1-12 12h-8v8a12 12 0 0 1-24 0v-8h-8a12 12 0 0 1 0-24h8v-8a12 12 0 0 1 24 0v8h8a12 12 0 0 1 12 12"></svg:path>`,
})
export class PhRowsPlusBottomBoldIcon {
  readonly viewBox = input("0 0 256 256")
  readonly width = input("1em")
  readonly height = input("1em")
}
