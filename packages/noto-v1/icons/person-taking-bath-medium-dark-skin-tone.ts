...
@Component({
  standalone: true,
  selector: 'svg[notoV1PersonTakingBathMediumDarkSkinToneIcon],svg[noto-v1-person-taking-bath-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
