...
@Component({
  standalone: true,
  selector: 'svg[notoV1PersonTakingBathMediumLightSkinToneIcon],svg[noto-v1-person-taking-bath-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
