...
@Component({
  standalone: true,
  selector: 'svg[notoV1OldManMediumDarkSkinToneIcon],svg[noto-v1-old-man-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
