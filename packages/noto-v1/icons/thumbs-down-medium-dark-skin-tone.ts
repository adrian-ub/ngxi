...
@Component({
  standalone: true,
  selector: 'svg[notoV1ThumbsDownMediumDarkSkinToneIcon],svg[noto-v1-thumbs-down-medium-dark-skin-tone-icon]',
  host: {
    role: 'img',
