...
@Component({
  standalone: true,
  selector: 'svg[notoV1PersonTakingBathMediumSkinToneIcon],svg[noto-v1-person-taking-bath-medium-skin-tone-icon]',
  host: {
    role: 'img',
