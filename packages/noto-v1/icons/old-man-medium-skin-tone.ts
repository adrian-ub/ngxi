...
@Component({
  standalone: true,
  selector: 'svg[notoV1OldManMediumSkinToneIcon],svg[noto-v1-old-man-medium-skin-tone-icon]',
  host: {
    role: 'img',
