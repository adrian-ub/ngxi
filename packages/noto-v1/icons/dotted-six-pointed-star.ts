...
@Component({
  standalone: true,
  selector: 'svg[notoV1DottedSixPointedStarIcon],svg[noto-v1-dotted-six-pointed-star-icon]',
  host: {
    role: 'img',
