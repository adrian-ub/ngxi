...
@Component({
  standalone: true,
  selector: 'svg[notoV1OldManDarkSkinToneIcon],svg[noto-v1-old-man-dark-skin-tone-icon]',
  host: {
    role: 'img',
