...
@Component({
  standalone: true,
  selector: 'svg[notoV1PersonTakingBathLightSkinToneIcon],svg[noto-v1-person-taking-bath-light-skin-tone-icon]',
  host: {
    role: 'img',
