...
@Component({
  standalone: true,
  selector: 'svg[notoV1OldManMediumLightSkinToneIcon],svg[noto-v1-old-man-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
