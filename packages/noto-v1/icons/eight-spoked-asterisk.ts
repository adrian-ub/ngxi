...
@Component({
  standalone: true,
  selector: 'svg[notoV1EightSpokedAsteriskIcon],svg[noto-v1-eight-spoked-asterisk-icon]',
  host: {
    role: 'img',
