...
@Component({
  standalone: true,
  selector: 'svg[notoV1OldManLightSkinToneIcon],svg[noto-v1-old-man-light-skin-tone-icon]',
  host: {
    role: 'img',
