...
@Component({
  standalone: true,
  selector: 'svg[notoV1ThumbsDownMediumLightSkinToneIcon],svg[noto-v1-thumbs-down-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
