...
@Component({
  standalone: true,
  selector: 'svg[notoV1PersonTakingBathDarkSkinToneIcon],svg[noto-v1-person-taking-bath-dark-skin-tone-icon]',
  host: {
    role: 'img',
