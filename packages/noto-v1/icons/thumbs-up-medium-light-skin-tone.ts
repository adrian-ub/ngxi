...
@Component({
  standalone: true,
  selector: 'svg[notoV1ThumbsUpMediumLightSkinToneIcon],svg[noto-v1-thumbs-up-medium-light-skin-tone-icon]',
  host: {
    role: 'img',
