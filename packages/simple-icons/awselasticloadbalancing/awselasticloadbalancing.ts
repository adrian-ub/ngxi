...
@Component({
  standalone: true,
  selector: 'svg[siAwselasticloadbalancing],svg[si-awselasticloadbalancing]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>AWS Elastic Load Balancing</svg:title>
    <svg:path
...
export class SiAwselasticloadbalancing {
