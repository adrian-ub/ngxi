...
@Component({
  standalone: true,
  selector: 'svg[siMetrodelaciudaddemexico],svg[si-metrodelaciudaddemexico]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Metro de la Ciudad de México</svg:title>
    <svg:path
...
export class SiMetrodelaciudaddemexico {
