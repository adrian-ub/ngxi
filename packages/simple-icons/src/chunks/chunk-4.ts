...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNextdoorIcon],svg[simple-icons-nextdoor-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNexusmodsIcon],svg[simple-icons-nexusmods-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNfcIcon],svg[simple-icons-nfc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNfcoreIcon],svg[simple-icons-nfcore-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNginxproxymanagerIcon],svg[simple-icons-nginxproxymanager-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNgrokIcon],svg[simple-icons-ngrok-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.951 7.598v6.713h1.463v-1.69l1.61 1.69H24v-.08l-2.123-2.153l2.002-1.846v-.07H21.95l-1.537 1.496v-4.06zm-2.93 2.41a2.63 2.63 0 0 0-1.787.635a2.05 2.05 0 0 0-.703 1.556c-.002.75.311 1.287.7 1.643c.526.478 1.221.626 1.767.623c.666 0 1.34-.195 1.805-.62c.521-.483.713-1.029.713-1.607c0-.73-.31-1.247-.71-1.603c-.553-.475-1.202-.628-1.785-.627m-9.062.039c-1.188-.005-2.1.977-2.104 2.25c-.004 1.296.908 2.108 2.032 2.096c.664.002.983-.244 1.308-.541v1.193h-1.37l-1.03 1.158v.2H9.66v-6.24H8.195v.435c-.381-.408-.772-.542-1.236-.551m-4.805.11l-.691.786v-.771H0v4.15h1.463v-2.799c.547.002 1.023-.002 1.49-.003v2.802h1.465v-2.595c-.004-.547-.1-.819-.307-1.061a1.43 1.43 0 0 0-.914-.51zm8.114.005v4.15h1.468l.002-2.779h1.065l1.164-1.314v-.057h-1.598l-.635.715v-.715zm-2.946 1.115c.504 0 .96.444.948.948a.956.956 0 0 1-.948.945c-.523 0-.931-.403-.947-.945c-.002-.52.443-.94.947-.948m8.703.001c.525 0 .94.434.944.95c-.027.544-.42.95-.944.95s-.934-.417-.95-.95a.955.955 0 0 1 .95-.95"></svg:path>`,
})
export class SimpleIconsNgrokIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNgrxIcon],svg[simple-icons-ngrx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNhlIcon],svg[simple-icons-nhl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNianticIcon],svg[simple-icons-niantic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.492 8.626c.222-.473.381-.981.474-1.512c1.478.757 2.158 1.325 2.281 1.56c-.253.134-1.178.18-2.755-.048m-6.139-4.618a45 45 0 0 0-4.005 1.476c.067-2.196 1.552-3.952 3.377-3.952c.991 0 1.883.518 2.501 1.344q.176.238.316.501c-1.21.321-2.1.603-2.189.631m-7.594-.585c.236-.121 1.12-.189 2.762.047a6 6 0 0 0-.483 1.509c-1.422-.727-2.151-1.3-2.279-1.556m4.065 7.031c.406.385.865.715 1.364.977l.681 5.225l-.086-.039a5 5 0 0 0-.278-.11l-.004-.002l-.149-.049l-1.716-5.888c-.033-.113.103-.195.188-.114m3.071 2.78l.029.116c.026.103.118.224.326.224h1.5c.208 0 .3-.121.327-.224l.028-.116c.128-.556.44-1.173 1.171-1.552l-.607 4.661c-1.126-.752-2.147-.859-2.515-.871h-.01a.12.12 0 0 0-.115.133l.291 2.003c.001.006-.007.01-.013.006a5 5 0 0 0-.857-.654l-.042-.024l-.684-5.254c.731.379 1.043.996 1.171 1.552m5.281-2.78c.085-.081.221.001.188.114l-1.875 6.436a5 5 0 0 0-.282-.255l-.001-.001v-.001l-.078-.064l.684-5.252a6.2 6.2 0 0 0 1.364-.977m-1.966 7.133c-.316.744-1.146 1.293-2.02 1.465c-.033.006-.068-.005-.072-.037l-.413-2.841c-.005-.033.026-.059.06-.053c.662.131 1.782.719 2.404 1.348c.052.053.048.101.041.118m-1.159 3.502l-2.087.114l-.193-1.486l.243-.024l.593-.06q.006 0 .008.006l.057.392c.009.06.064.103.127.101l.007-.001l1.201-.121l.187-.019zM8.826 19.35a.04.04 0 0 1-.043-.032l-.447-2.472c-.005-.025.018-.047.044-.044c1.257.159 2.492.939 3.083 1.907a.2.2 0 0 1 .028.079l.039.267c.002.012-.007.022-.019.023zm9.233-13.224l.002-.064l-.003-.09c2.3-1.114 3.346-2.069 3.101-2.838c-.144-.452-.688-.702-1.617-.743a7 7 0 0 0-.286-.006c-.667 0-1.457.09-2.276.228A6.06 6.06 0 0 0 11.998 0a6.06 6.06 0 0 0-4.979 2.61c-2.522-.422-3.927-.247-4.172.522c-.141.443-.044 1.183 2.416 2.495c.214.114.443.229.678.344l-.002.091l.002.064q-.355.173-.678.345c-2.46 1.311-2.557 2.051-2.416 2.494c.238.748 1.572.935 3.964.557l1.976 6.78a4 4 0 0 0-.251-.046h-.005a4 4 0 0 0-.791-.042h-.001a.1.1 0 0 0-.097.1l.001.017l.64 3.546c.01.05.056.084.106.081h.007l1.387-.141l.028-.003l.416 1.429l-.112.006a.51.51 0 0 1-.407-.124c-.138-.103-.174-.195-.364-.185l-1.276.055a.11.11 0 0 0-.104.109c.001.511.259 2.166 1.311 2.222c.074.004.176.001.298 0c.343.77 1.045.679 1.246.661c.651-.058 4.03-1.139 4.362-1.386c.341-.253.69-1.118.69-1.118s1.012-.348 1.562-.506c.074-.021.055-.13-.022-.125l-3.581.195l.336-1.153l.262-.027l1.754-.176c.056-.006.091-.063.068-.112a8.7 8.7 0 0 0-1.241-2.019q-.061-.072-.122-.14l2.089-7.167c-1.61-.242-3.386-.696-4.596-1.035a2.93 2.93 0 0 1-1.655.526c-1.264 0-2.364-.844-2.944-2.092l-.641-.261q-.473.212-.938.44q.126.412.308.798c-1.635.235-2.516.166-2.751.045c.243-.486 2.656-2.118 7.876-3.78c5.219-1.662 8.132-1.726 8.612-1.47c-.123.234-.805.803-2.285 1.562a6 6 0 0 0-.18-.746c-.991.132-2.241.374-3.72.76a4.74 4.74 0 0 1-.461 2.786A50 50 0 0 1 9.45 6.452q-.68.254-1.283.5c.99.396 2.066.781 3.186 1.138c.215.068 5.13 1.622 7.903 1.622q.147 0 .286-.006c.929-.04 1.473-.29 1.617-.742c.245-.769-.8-1.724-3.1-2.838"></svg:path>`,
})
export class SimpleIconsNianticIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNikonIcon],svg[simple-icons-nikon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M8.267 8.681c-.69 0-1.054.463-1.054.873c0 .144.032.653.949.653c.762 0 1.057-.488 1.057-.854c0-.244-.2-.672-.952-.672m-6.87.215L0 15.146h1.72c.194-1 .455-2.056.711-3.138l1.206 3.136H5.27L6.681 8.9H5l-.715 3.176l-1.18-3.18Zm8.587.004L8.6 15.144h1.663l.558-2.375l.703 2.375h1.705l-.707-2.508l1.715-2.08h-1.91l-1.38 1.664l.743-3.32zm6.608 1.465c-2.582 0-2.962 2.01-3.034 2.379c-.19.93.02 2.137 1.235 2.457c.8.21 2.051.187 2.855-.47c.736-.6 1.1-1.619 1.088-2.575c-.012-.92-.79-1.791-2.144-1.791m6.193.072c-.573.038-1.156.35-1.486.807c.044-.188.088-.404.14-.658h-1.7l-.999 4.558h1.695l.563-2.586c.104-.476.488-.68.826-.591c.146.04.35.15.281.548l-.574 2.63h1.674l.767-3.51a.96.96 0 0 0-.627-1.14a1.6 1.6 0 0 0-.56-.058m-15.66.121l-1.02 4.586h1.676l1.022-4.586zm9.23 1.104c.372-.002.472.218.44.426c-.09.545-.245 1.081-.362 1.539c-.082.254-.321.4-.601.4c-.286 0-.458-.178-.432-.406c.04-.384.286-1.357.356-1.549c.12-.334.451-.408.6-.41z"></svg:path>`,
})
export class SimpleIconsNikonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNintendoIcon],svg[simple-icons-nintendo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNintendodsIcon],svg[simple-icons-nintendods-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M.286 10.773v1.142H0v-1.541h.244l1.155 1.123v-1.123h.282v1.541h-.223zm2.86 0v1.142h-.285v-1.541h.244l1.155 1.123v-1.123h.282v1.541h-.223zm5.93 0v1.142h-.285v-1.541h.243l1.156 1.123v-1.123h.282v1.541h-.223zm-6.948-.399h.286v1.541h-.286zm2.738 0h1.672v.265H5.85v1.276h-.297v-1.276h-.687zm1.996 0h1.505v.265H7.144v.346h.946v.265h-.946v.4h1.223v.265H6.862zm5.665.225a.9.9 0 0 1 .159.545a.9.9 0 0 1-.159.546a.58.58 0 0 1-.477.225h-1.143v-1.541h1.143c.2 0 .365.078.477.225m-.469 1.051c.275 0 .372-.273.372-.506s-.097-.505-.372-.505h-.876v1.011zm2.494-1.276c.18 0 .327.147.327.327v.887c0 .18-.147.327-.327.327h-1.244a.327.327 0 0 1-.326-.327v-.887c0-.18.146-.327.326-.327zm.053 1.213v-.884a.064.064 0 0 0-.064-.064h-1.222a.064.064 0 0 0-.064.064v.884c0 .034.029.063.064.063h1.222a.064.064 0 0 0 .064-.063m-.053.514c.18 0 .327.148.327.327v.888a.33.33 0 0 1-.327.326h-1.244a.327.327 0 0 1-.326-.326v-.888c0-.179.146-.327.326-.327zm.053 1.213v-.884a.064.064 0 0 0-.064-.064h-1.222a.064.064 0 0 0-.064.064v.884c0 .035.029.063.064.063h1.222a.064.064 0 0 0 .064-.063m5.128-.322c.296.117.921.212 1.408.212c.534 0 .755-.183.755-.413c0-.207-.205-.328-.795-.544c-.787-.292-1.365-.521-1.365-1.038c0-.536.695-.851 1.755-.851c.569 0 .765.036 1.126.102l.003.508c-.355-.067-.67-.183-1.159-.183c-.523 0-.747.166-.747.337c0 .25.344.369.947.583c.84.301 1.307.533 1.307 1.04c0 .521-.585.897-1.904.897c-.542 0-.916-.036-1.331-.102zm-1.123.414c-.311.14-.898.229-1.412.229h-1.962v-3.27h1.962c.514 0 1.101.09 1.413.231c.755.341 1.002.887 1.002 1.405c0 .517-.245 1.063-1.003 1.405m-1.685-2.599h-.629v2.377h.629c.963 0 1.571-.412 1.571-1.183s-.608-1.194-1.571-1.194m6.4 2.806h-.096v-.378h-.139v-.081h.374v.081h-.139zm.675 0h-.089v-.384h-.001l-.086.384h-.094l-.084-.384h-.001v.384h-.089v-.459h.139l.083.361h.001l.082-.361H24z"></svg:path>`,
})
export class SimpleIconsNintendodsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNissanIcon],svg[simple-icons-nissan-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNodedotjsIcon],svg[simple-icons-nodedotjs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNoderedIcon],svg[simple-icons-nodered-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNorwegianIcon],svg[simple-icons-norwegian-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23.696 11.055c-.433-.217-.86-.41-1.305-.63a.5.5 0 0 0 .032-.374l-.193-.213l-.275.045l-.284.15a2 2 0 0 0-.229-.115l.21-.13c.35-.244.713-.471 1.054-.739c.33-.253.67-.507.89-.857c.052-.104.132-.217.1-.348l-.064-.112l-.107-.06l-.228-.09c-.196-.036-.409-.077-.613-.07a3.8 3.8 0 0 0-.773.132c-.364.098-.777.284-1.224.521c-.475.252-.916.554-1.36.875c-.067-.096-.204-.198-.34-.182c-.232.051-.448.232-.627.382c-.09-.012-.212-.046-.303-.057c-.403-.066-.83-.11-1.226-.153a15 15 0 0 0-.915-.118c-.26-.026-.452-.07-.698-.057l-.308.17l-.219.202l.006.083c.155.077.328.085.48.15c.432.106.619.163 1.126.282c.26.061.328.087.594.161c.265.11.523.245.773.359c-.258.186-.624.436-.92.615l-.22.104l-.22-.066c-.339-.148-.598-.265-.9-.397l-.288.076l-.091.05l-.07.105l.062.13c.17.176.33.35.501.521l-.007.006a10 10 0 0 0-.42-.047a.5.5 0 0 0-.416.08l.015.143c.292.133.668.199.972.327c-5.325 2.388-10.474 3.481-12.505 3.236c-1.824-.22-1.614-3.25 1.276-5.67l-.757.001C.04 12.358-1.206 15.865 1.34 16.383c2.828.574 8.586-1.23 14.522-4.218c.15.059.288-.041.414-.069c.32.079.653.178.977.25l.186-.06l.036-.053c-.05-.159-.203-.221-.307-.348c.306-.09.606-.196.906-.298c.466-.16.863-.354 1.287-.546c.272.03.54.04.81.045c.223.01.437 0 .656.033c.179.006.321.034.503.064c.513.098 1.026.186 1.533.299c.196.05.364.084.557.13c.186-.01.331-.127.49-.206l.089-.19zm-5.937-.255c-.349.185-.735.4-1.247.626a.7.7 0 0 1-.428.066l-.213-.03c-.212-.218-.449-.434-.658-.659l.121-.067h.047c.356.156.674.331 1.033.484l.307-.086c.453-.28.801-.5 1.223-.766c.143.058.206.087.342.143c-.179.106-.356.198-.527.29m.774-1.016l-.077-.133l.02-.266l.053-.047a2.5 2.5 0 0 1 .324-.205l.015.256l.07.13c-.137.087-.266.19-.405.265m2.036-.83c-.15.096-.464.357-.473.368c-.239-.029-.463-.035-.69-.06l.047-.024c.302-.248.57-.408.907-.613c.298-.18.74-.417 1.103-.57a4.7 4.7 0 0 1 1.018-.285c.198-.029.394-.045.592.02a3 3 0 0 0-.582.183c-.204.084-.528.215-.79.343c-.388.194-.712.37-1.132.638"></svg:path>`,
})
export class SimpleIconsNorwegianIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNotepadplusplusIcon],svg[simple-icons-notepadplusplus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNotionIcon],svg[simple-icons-notion-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.354c0-.606-.233-.933-.748-.887l-15.177.887c-.56.047-.747.327-.747.933zm14.337.745c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-1.168.514-1.635.514c-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233l4.764 7.279v-6.44l-1.215-.139c-.093-.514.28-.887.747-.933zM1.936 1.035l13.31-.98c1.634-.14 2.055-.047 3.082.7l4.249 2.986c.7.513.934.653.934 1.213v16.378c0 1.026-.373 1.634-1.68 1.726l-15.458.934c-.98.047-1.448-.093-1.962-.747l-3.129-4.06c-.56-.747-.793-1.306-.793-1.96V2.667c0-.839.374-1.54 1.447-1.632"></svg:path>`,
})
export class SimpleIconsNotionIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNotistIcon],svg[simple-icons-notist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.933 3.8c-1.1.11-2.288.4-3.038.74c-1.07.5-1.26.87-.91 1.869c.36 1.04.19 2.308-1 7.505C.109 17.79-.04 18.6.01 19.32c.04.47.09.63.29.79c.22.18.33.19 1.688.13c3.408-.17 4.057-.22 4.267-.34c.24-.13.25-.2.44-1.759c.32-2.868 1.788-7.155 3.027-8.894c1.06-1.479 2.359-2.128 3.098-1.549c.78.62.76 1.559-.13 4.147c-.68 1.999-.79 2.428-.91 3.617c-.15 1.46.13 2.49.96 3.408c.85.94 2.119 1.41 3.847 1.41c1.64 0 2.968-.41 4.377-1.34c1.29-.86 2.828-2.608 3.008-3.428c.1-.41-.07-.859-.35-.969c-.41-.15-.65-.04-1.389.63c-.859.78-1.249.95-2.008.89c-1.01-.08-1.45-.66-1.45-1.92c0-.899.09-1.349.65-3.317c.79-2.728.93-3.967.58-5.027C19.434 4.03 17.026 3.26 14.358 4c-1.45.41-3.238 1.449-4.597 2.688c-.38.34-.68.59-.68.56c0-.02.07-.35.16-.72c.34-1.5.2-2.248-.48-2.598c-.39-.2-1.598-.26-2.827-.13z"></svg:path>`,
})
export class SimpleIconsNotistIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNowIcon],svg[simple-icons-now-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNrwlIcon],svg[simple-icons-nrwl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNukeIcon],svg[simple-icons-nuke-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNvmIcon],svg[simple-icons-nvm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNxIcon],svg[simple-icons-nx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsObbIcon],svg[simple-icons-obb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsObsidianIcon],svg[simple-icons-obsidian-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.355 18.538a68.967 68.959 0 0 0 1.858-2.954a.81.81 0 0 0-.062-.9c-.516-.685-1.504-2.075-2.042-3.362c-.553-1.321-.636-3.375-.64-4.377a1.7 1.7 0 0 0-.358-1.05l-3.198-4.064a4 4 0 0 1-.076.543c-.106.503-.307 1.004-.536 1.5c-.134.29-.29.6-.446.914l-.31.626c-.516 1.068-.997 2.227-1.132 3.59c-.124 1.26.046 2.73.815 4.481q.192.016.386.044a6.36 6.36 0 0 1 3.326 1.505c.916.79 1.744 1.922 2.415 3.5zM8.199 22.569q.11.019.22.02c.78.024 2.095.092 3.16.29c.87.16 2.593.64 4.01 1.055c1.083.316 2.198-.548 2.355-1.664c.114-.814.33-1.735.725-2.58l-.01.005c-.67-1.87-1.522-3.078-2.416-3.849a5.3 5.3 0 0 0-2.778-1.257c-1.54-.216-2.952.19-3.84.45c.532 2.218.368 4.829-1.425 7.531zM5.533 9.938q-.035.15-.098.29L2.82 16.059a1.6 1.6 0 0 0 .313 1.772l4.116 4.24c2.103-3.101 1.796-6.02.836-8.3c-.728-1.73-1.832-3.081-2.55-3.831zM9.32 14.01c.615-.183 1.606-.465 2.745-.534c-.683-1.725-.848-3.233-.716-4.577c.154-1.552.7-2.847 1.235-3.95q.17-.35.328-.664c.149-.297.288-.577.419-.86c.217-.47.379-.885.46-1.27c.08-.38.08-.72-.014-1.043c-.095-.325-.297-.675-.68-1.06a1.6 1.6 0 0 0-1.475.36l-4.95 4.452a1.6 1.6 0 0 0-.513.952l-.427 2.83c.672.59 2.328 2.316 3.335 4.711q.136.317.253.653"></svg:path>`,
})
export class SimpleIconsObsidianIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsObsstudioIcon],svg[simple-icons-obsstudio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsObtainiumIcon],svg[simple-icons-obtainium-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOcamlIcon],svg[simple-icons-ocaml-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOclcIcon],svg[simple-icons-oclc-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.628 7.117C18.366 2.388 13.69-.691 8.746.133C3.478 1.01-.076 5.97.8 11.214c.605 3.685 3.22 6.52 6.529 7.602a5.34 5.34 0 0 0 2.42 4.304c2.474 1.623 5.809.94 7.419-1.547c.142-.219.27-.45.386-.682a7.53 7.53 0 0 0 5.512-5.322c.915-3.35-.592-6.79-3.451-8.465zM7.393 17.863c-2.253-1.057-3.966-3.234-4.417-5.914c-.708-4.317 2.086-8.362 6.259-9.045c2.975-.49 5.847.863 7.495 3.247a7.52 7.52 0 0 0-8.14 5.463a7.46 7.46 0 0 0-.076 3.685a5.45 5.45 0 0 0-1.133 2.577zm2.1-3.518c0-.541.077-1.108.23-1.662c.916-3.324 4.264-5.321 7.484-4.42c3.22.89 5.1 4.291 4.172 7.641a6.3 6.3 0 0 1-3.503 4.11a5.37 5.37 0 0 0-2.253-5.85a5.34 5.34 0 0 0-6.143.181zm6.477 6.958c-1.287 1.958-3.85 2.538-5.743 1.301s-2.383-3.84-1.095-5.785c1.275-1.958 3.85-2.538 5.744-1.301c1.893 1.25 2.382 3.852 1.094 5.785"></svg:path>`,
})
export class SimpleIconsOclcIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOclifIcon],svg[simple-icons-oclif-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOctaveIcon],svg[simple-icons-octave-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.5.007c-2.414-.09-4.658.715-6.286 2.485C2.913 3.906 2.188 5.75 1.987 7.77h-.42C.703 7.77 0 8.473 0 9.335v4.743c0 .863.702 1.567 1.565 1.567h2.091a17 17 0 0 0 2.57 3.687c4.46 4.848 10.696 6.036 14.561 3.016h2.102c.577 0 1.05-.473 1.05-1.05V18.43a1.03 1.03 0 0 0-.257-.668c.858-3.433-.045-7.642-2.52-11.219c.002-.017.01-.032.01-.049V4.482a.82.82 0 0 0-.816-.819h-1.703C16.142 1.372 13.218.11 10.5.007m1.75 2.18c1.78-.01 3.69.62 5.425 1.85a.8.8 0 0 0-.15.445v2.013c0 .449.368.82.816.82h2.016a.8.8 0 0 0 .392-.116c2.248 3.302 2.735 7.322 1.24 10.18h-1.964c-.579 0-1.052.475-1.052 1.051v1.794c-2.991 1.3-7.005.222-9.964-2.992a12.7 12.7 0 0 1-1.55-2.098c.256-.279.416-.647.416-1.056V9.335c0-.862-.702-1.565-1.565-1.565H5.9c.238-1.364.781-2.612 1.688-3.596c1.225-1.331 2.88-1.98 4.661-1.988zm6.091 2.01h2.016c.162 0 .283.123.283.285v2.013c0 .163-.12.285-.283.285H18.34a.28.28 0 0 1-.285-.285V4.482a.28.28 0 0 1 .285-.285zM1.566 8.303h4.743c.578 0 1.033.456 1.033 1.032v4.743c0 .577-.455 1.033-1.032 1.033H1.567a1.024 1.024 0 0 1-1.034-1.032V9.335c0-.576.455-1.032 1.032-1.032zm18.459 9.61h2.865c.29 0 .52.226.52.518v2.865a.51.51 0 0 1-.52.519h-2.865a.51.51 0 0 1-.519-.519v-2.864a.51.51 0 0 1 .519-.518z"></svg:path>`,
})
export class SimpleIconsOctaveIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOdyseeIcon],svg[simple-icons-odysee-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOkcupidIcon],svg[simple-icons-okcupid-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOkxIcon],svg[simple-icons-okx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOllamaIcon],svg[simple-icons-ollama-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOmadacloudIcon],svg[simple-icons-omadacloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOnnxIcon],svg[simple-icons-onnx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOnstarIcon],svg[simple-icons-onstar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenaiIcon],svg[simple-icons-openai-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.282 9.821a6 6 0 0 0-.516-4.91a6.05 6.05 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a6 6 0 0 0-3.998 2.9a6.05 6.05 0 0 0 .743 7.097a5.98 5.98 0 0 0 .51 4.911a6.05 6.05 0 0 0 6.515 2.9A6 6 0 0 0 13.26 24a6.06 6.06 0 0 0 5.772-4.206a6 6 0 0 0 3.997-2.9a6.06 6.06 0 0 0-.747-7.073M13.26 22.43a4.48 4.48 0 0 1-2.876-1.04l.141-.081l4.779-2.758a.8.8 0 0 0 .392-.681v-6.737l2.02 1.168a.07.07 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494M3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085l4.783 2.759a.77.77 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 19.95a4.5 4.5 0 0 1-6.14-1.646M2.34 7.896a4.5 4.5 0 0 1 2.366-1.973V11.6a.77.77 0 0 0 .388.677l5.815 3.354l-2.02 1.168a.08.08 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.08.08 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667m2.01-3.023l-.141-.085l-4.774-2.782a.78.78 0 0 0-.785 0L9.409 9.23V6.897a.07.07 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l-2.02-1.164a.08.08 0 0 1-.038-.057V6.075a4.5 4.5 0 0 1 7.375-3.453l-.142.08L8.704 5.46a.8.8 0 0 0-.393.681zm1.097-2.365l2.602-1.5l2.607 1.5v2.999l-2.597 1.5l-2.607-1.5Z"></svg:path>`,
})
export class SimpleIconsOpenaiIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenaigymIcon],svg[simple-icons-openaigym-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenapiinitiativeIcon],svg[simple-icons-openapiinitiative-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenbsdIcon],svg[simple-icons-openbsd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenfaasIcon],svg[simple-icons-openfaas-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenglIcon],svg[simple-icons-opengl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenjdkIcon],svg[simple-icons-openjdk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenmediavaultIcon],svg[simple-icons-openmediavault-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M.945 1.045A.947.947 0 0 0 0 1.988v20.024c0 .534.436.943.945.943h22.11a.944.944 0 0 0 .945-.943V1.988a.94.94 0 0 0-.945-.943Zm.118 1.064h21.875v19.784H1.063ZM3.53 4.385c-.198 0-.361.149-.361.334v3.699c0 .185.162.334.361.334h16.94c.198 0 .36-.15.36-.334v-3.7c0-.184-.161-.333-.36-.333zm2.057.886a1.3 1.3 0 0 1 1.297 1.297a1.3 1.3 0 0 1-1.297 1.3a1.3 1.3 0 0 1-1.299-1.3a1.3 1.3 0 0 1 1.299-1.297m-.002.62a.68.68 0 0 0-.676.677a.68.68 0 0 0 .678.678a.68.68 0 0 0 .678-.678a.68.68 0 0 0-.678-.677ZM3.53 9.816c-.198 0-.361.15-.361.334v3.702c0 .184.162.332.361.332h16.94c.198 0 .36-.15.36-.334v-3.7c0-.184-.161-.334-.36-.334zm2.057.887A1.3 1.3 0 0 1 6.885 12a1.3 1.3 0 0 1-1.297 1.299A1.3 1.3 0 0 1 4.289 12a1.3 1.3 0 0 1 1.299-1.297m-.002.62A.68.68 0 0 0 4.91 12a.68.68 0 0 0 .678.68a.68.68 0 0 0 0-1.358ZM3.53 15.247c-.198 0-.361.15-.361.334v3.701c0 .185.162.332.361.332h16.94c.198 0 .36-.15.36-.334v-3.699c0-.184-.161-.334-.36-.334zm2.057.887a1.3 1.3 0 0 1 1.297 1.297a1.3 1.3 0 0 1-1.297 1.298a1.3 1.3 0 0 1-1.299-1.298a1.3 1.3 0 0 1 1.299-1.297m-.002.619a.68.68 0 0 0 .002 1.358a.68.68 0 0 0 0-1.358Z"></svg:path>`,
})
export class SimpleIconsOpenmediavaultIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpennebulaIcon],svg[simple-icons-opennebula-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenscadIcon],svg[simple-icons-openscad-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.065 2.418c-1.287.016-2.478.283-3.346.701c-.895.432-1.426 1.014-1.426 1.627c0 .494.375.98.975 1.397c.242-.178.493-.307.729-.422c.235-.116.556-.147.976-.15s.856.09.856.09c.008.001 1.498.644 1.498.644l.894-.418h.002s.592-.266 1.268-.258q.067 0 .136.006c.187.013.355.038.655.107c.3.07.591.239.777.39c.562-.405.897-.879.897-1.364c0-.617-.501-1.203-1.364-1.639c-.862-.436-2.068-.71-3.402-.71h-.125zm7.3.143c-.325-.02-.443.02-.695.13c-.506.275-1.024.55-1.545.825a9.87 9.87 0 0 1 4.725 8.06c.418-.213.832-.427 1.229-.636c1.157-.844 1.234-3.073.177-5.194c-.94-1.885-2.53-3.188-3.89-3.185ZM8.55 2.928a9.65 9.65 0 0 0-6.177 8.16c.425-.214.857-.424 1.294-.617l.002-.002h.002a1.7 1.7 0 0 1 .637-.133c.22-.005.445.029.672.094c.454.13.916.386 1.355.726c.88.68 1.693 1.714 2.213 2.883c.576 1.293.84 2.532.795 3.56s-.412 1.875-1.138 2.268l-.977.467a9.6 9.6 0 0 0 4.744 1.248a9.6 9.6 0 0 0 5.334-1.611c-.745.289-1.48.318-2.086-.006c-.54-.29-.915-.833-1.082-1.541c-.121-.413-.09-.715-.103-1.147c.015-.475.141-.929.207-1.248c.104-.434.377-1.154.775-1.865c.398-.71.977-1.41 1.611-2.008c.635-.598 1.253-.966 1.704-1.082c.45-.116.742-.17 1.043-.174s.608.046.921.21c.772.41 1.163 1.295 1.188 2.357c.074-.226.108-1.16.129-1.525a9.64 9.64 0 0 0-5.123-8.516c.447.385.717.84.717 1.342c0 .618-.409 1.185-.92 1.523a6.2 6.2 0 0 1-1.498.744a7.3 7.3 0 0 1-2.211.377c-.738.002-1.25.012-1.664-.06a12 12 0 0 1-.844-.166c-.35-.067-.334-.053-.608-.15c-.59-.21-.775-.29-1.377-.686c-.601-.396-1.04-.972-1.04-1.604c0-.736.602-1.367 1.505-1.818m1.498 2.9c.054.332.147.729.162 1.131q.262.061.538.107c.46-.227.863-.423 1.27-.62l-1.247-.538c-.003 0-.09-.015-.215-.033a9 9 0 0 0-.508-.047m3.291.291l-.869.405l.022.638c.844-.032 1.631-.174 2.299-.406c.02-.298.108-.59.152-.824c-.145-.037-.305-.033-.693-.036s-.91.223-.91.223zm1.85-.115c-.04.123-.082.25-.107.39c-.014.074-.02.168-.028.256q.4-.16.725-.359a1.8 1.8 0 0 0-.59-.287m-2.967.625c-.291.14-.64.306-.984.477c.338.03.675.058 1.002.066zm-7.904 3.959a1.5 1.5 0 0 0-.549.111c-.755.333-1.507.71-2.213 1.088q.16.017.3.037c.388.052.811.218 1.509.762c.28.219.592.543.898.92c.327.388.61.844.865 1.238c.173.288.326.575.45.848c.151.316.26.641.377.945c.112.306.18.617.261.91c.078.285.104.573.15.844q.048.402.04.754c-.011.449-.044.854-.168 1.215q-.06.172-.154.328a77 77 0 0 0 2.001-.941c1.25-.676 1.36-2.978.235-5.506c-.88-1.978-2.652-3.574-4.002-3.553m14.44.666c.185.347.338.904.13 1.633c-.066.172-.12.377-.215.556c-.528 1.1-1.506 1.61-1.789 1.739c0 .047-.002.112-.039.463a3.7 3.7 0 0 1-.174.86c-.11.365-.227.628-.384.88c-.077.1-.15.257-.506.65c-.436.271-1.008.453-1.313.453c.17.567.445 1.027.871 1.256c.671.358 1.554.239 2.452-.277a6.2 6.2 0 0 0 1.48-1.23c.35-.405.666-.836 1.172-1.72c.505-.882.814-2.064.79-3.044c-.022-1.004-.384-1.783-1.054-2.14a1.5 1.5 0 0 0-.721-.163c-.248 0-.493.06-.7.084m-.284.047c-.5.165-1.01.47-1.498.875c.172.192.37.356.611.537a3.7 3.7 0 0 0 .909.502l.048-.113a3 3 0 0 0 .096-.284c.137-.48.102-.865.012-1.154a1.6 1.6 0 0 0-.178-.363m-17.178.732a.8.8 0 0 0-.468.155c-.473.369-.779.918-.823 1.894c-.043.977.211 2.185.774 3.45c.503 1.13 1.298 2.135 2.138 2.784c.841.65 1.727.944 2.481.6c.62-.343.737-.999.758-1.877s-.241-2.098-.807-3.344c-.474-1.044-1.459-2.381-2.139-2.912c-.68-.53-1.04-.664-1.386-.71a3 3 0 0 0-.528-.04m15.475.323c-.582.582-1.084 1.197-1.45 1.796l1.444.793a3 3 0 0 0 .531-.312a3.5 3.5 0 0 0 1.065-1.192a4.3 4.3 0 0 1-.944-.539c-.356-.266-.509-.39-.646-.546m-1.574 2.033a7.5 7.5 0 0 0-.658 1.715l1.955-1.004c-.41-.22-.87-.468-1.297-.711m1.42.935l-2.225 1.159l-.03.146c.226.053.475.128.782.291c.427.227.627.39.781.53q.078-.101.153-.217c.342-.548.472-1.156.523-1.586c.012-.108.01-.218.016-.323"></svg:path>`,
})
export class SimpleIconsOpenscadIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenseaIcon],svg[simple-icons-opensea-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 0C5.374 0 0 5.374 0 12s5.374 12 12 12s12-5.374 12-12S18.629 0 12 0M5.92 12.403l.051-.081l3.123-4.884a.107.107 0 0 1 .187.014c.52 1.169.972 2.623.76 3.528c-.088.372-.335.876-.614 1.342a2 2 0 0 1-.117.199a.1.1 0 0 1-.09.045H6.013a.106.106 0 0 1-.091-.163zm13.914 1.68a.11.11 0 0 1-.065.101c-.243.103-1.07.485-1.414.962c-.878 1.222-1.548 2.97-3.048 2.97H9.053a4.02 4.02 0 0 1-4.013-4.028v-.072c0-.058.048-.106.108-.106h3.485c.07 0 .12.063.115.132c-.026.226.017.459.125.67c.206.42.636.682 1.099.682h1.726v-1.347H9.99a.11.11 0 0 1-.089-.173l.063-.09c.16-.231.391-.586.621-.992c.156-.274.308-.566.43-.86q.034-.08.065-.16c.033-.094.067-.182.091-.269a5 5 0 0 0 .065-.223c.057-.25.081-.514.081-.787c0-.108-.004-.221-.014-.327c-.005-.117-.02-.235-.034-.352a3 3 0 0 0-.048-.312a7 7 0 0 0-.098-.468l-.014-.06c-.03-.108-.056-.21-.09-.317a12 12 0 0 0-.328-.972a5 5 0 0 0-.142-.355c-.072-.178-.146-.339-.213-.49a4 4 0 0 1-.094-.197a5 5 0 0 0-.103-.213c-.024-.053-.053-.104-.072-.152l-.211-.388c-.029-.053.019-.118.077-.101l1.32.357h.01l.173.05l.192.054l.07.019v-.783c0-.379.302-.686.679-.686a.66.66 0 0 1 .477.202a.7.7 0 0 1 .2.484V6.65l.141.039q.016.007.031.017q.052.037.147.11q.074.059.165.137a10 10 0 0 1 .574.504c.214.199.454.432.684.691c.065.074.127.146.192.226c.062.079.132.156.19.232c.079.104.16.212.235.324c.033.053.074.108.105.161c.096.142.178.288.257.435c.034.067.067.141.096.213c.089.197.159.396.202.598a1 1 0 0 1 .029.132v.01c.014.057.019.12.024.184a2.1 2.1 0 0 1-.106.874c-.031.084-.06.17-.098.254c-.075.17-.161.343-.264.502c-.034.06-.075.122-.113.182c-.043.063-.089.123-.127.18a4 4 0 0 1-.173.221q-.078.11-.166.209q-.12.147-.245.278c-.048.058-.1.118-.156.17c-.052.06-.108.113-.156.161c-.084.084-.15.147-.208.202l-.137.122a.1.1 0 0 1-.072.03h-1.051v1.346h1.322c.295 0 .576-.104.804-.298c.077-.067.415-.36.816-.802a.1.1 0 0 1 .05-.03l3.65-1.057a.108.108 0 0 1 .138.103z"></svg:path>`,
})
export class SimpleIconsOpenseaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpensourcehardwareIcon],svg[simple-icons-opensourcehardware-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpensourceinitiativeIcon],svg[simple-icons-opensourceinitiative-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpensslIcon],svg[simple-icons-openssl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenstreetmapIcon],svg[simple-icons-openstreetmap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpensuseIcon],svg[simple-icons-opensuse-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpentextIcon],svg[simple-icons-opentext-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpentofuIcon],svg[simple-icons-opentofu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m10.184 23.25l.002-.01l-.033-.017l-8.388-4.611a1.68 1.68 0 0 1-.873-1.475V6.864c0-.614.335-1.18.873-1.476l9.424-5.18a1.69 1.69 0 0 1 1.622 0l8.31 4.568l.022.012l.006.002l-.004-.001l1.09.599c.538.296.873.862.873 1.476v10.273c0 .614-.335 1.179-.873 1.475l-8.388 4.611l-.03.016l-1.006.553a1.69 1.69 0 0 1-1.622 0l-1.003-.552zm.603-1.158l-.005-.001l.012.006a.388.388 0 0 0 .558-.338l.001-9.147a.39.39 0 0 0-.202-.34L2.763 7.661a.39.39 0 0 0-.576.341v9.135c0 .141.077.272.201.34l8.394 4.613zm-1.983-5.129l-.005.003l-1.959-1.031l-.003-.004l.001-.01c.023-.305.153-.525.346-.632c.194-.107.45-.101.72.041c.272.143.508.397.671.691s.252.628.229.935zM5.71 15.177l-.005.002l-1.96-1.031l-.002-.004l.001-.01c.022-.304.152-.524.346-.632s.449-.101.72.042s.508.396.671.69c.162.294.252.628.229.935zm14.981-8.999l-.003-.018a.38.38 0 0 0-.191-.25l-8.31-4.567a.39.39 0 0 0-.374 0L3.503 5.91a.39.39 0 0 0-.193.423l.009.007l-.009-.007c.022.1.083.194.183.253l8.32 4.572a.39.39 0 0 0 .374 0l8.321-4.573a.385.385 0 0 0 .183-.407M3.319 6.34l-.005-.006l-.004-.003zm-.467-1.56l-.003.002l.005.006zm.007.007l-.003.001h-.002z"></svg:path>`,
})
export class SimpleIconsOpentofuIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOpenzfsIcon],svg[simple-icons-openzfs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M19.357 3.404a.634.634 0 0 1-.901 0a.64.64 0 0 1 0-.905a.634.634 0 0 1 .901 0a.63.63 0 0 1 0 .905m-.14 17.858a1.115 1.115 0 0 1-1.574-1.576a1.114 1.114 0 0 1 1.574 0a1.104 1.104 0 0 1 0 1.576m-3.722-2.154a1.11 1.11 0 0 1 0-1.57a1.103 1.103 0 0 1 1.573 0a1.107 1.107 0 0 1 0 1.57c-.435.44-1.145.44-1.573 0m-.576 2.154a1.115 1.115 0 0 1-1.573-1.576a1.114 1.114 0 0 1 1.573 1.576m-3.722-2.154a1.096 1.096 0 0 1 0-1.57a1.103 1.103 0 0 1 1.574 0a1.11 1.11 0 0 1 0 1.57c-.435.44-1.145.44-1.574 0m-.575 2.154a1.115 1.115 0 0 1-1.573-1.576a1.114 1.114 0 0 1 1.573 1.576m-3.728-2.154a1.107 1.107 0 0 1 0-1.57a1.11 1.11 0 0 1 1.58 0a1.107 1.107 0 0 1 0 1.57a1.116 1.116 0 0 1-1.58 0m-.57 2.148c-.434.44-1.144.44-1.573 0a1.096 1.096 0 0 1 0-1.57a1.103 1.103 0 0 1 1.573 0a1.11 1.11 0 0 1 0 1.57M4.604 2.58a.64.64 0 0 1 .908 0a.64.64 0 0 1 0 .904a.64.64 0 0 1-.908 0a.646.646 0 0 1 0-.904m1.388 1.388a.64.64 0 0 1 .908 0a.64.64 0 0 1 0 .904a.653.653 0 0 1-.908 0a.64.64 0 0 1 0-.904M7.38 5.35a.653.653 0 0 1 .908 0a.64.64 0 1 1-.908.904a.64.64 0 0 1 0-.904m0-2.77a.64.64 0 0 1 .908 0a.64.64 0 0 1 0 .905a.647.647 0 0 1-.908 0a.64.64 0 0 1 0-.904m1.387 4.157a.647.647 0 0 1 .908 0a.64.64 0 0 1 0 .904a.64.64 0 0 1-.908 0a.64.64 0 0 1 0-.904m0-2.77a.64.64 0 0 1 .908 0a.64.64 0 0 1 0 .905a.641.641 0 0 1-.908-.904m1.388-1.388a.64.64 0 0 1 .908 0a.64.64 0 0 1 0 .904a.64.64 0 0 1-.908 0a.64.64 0 0 1 0-.904m1.388 4.157a.64.64 0 1 1 0 .904a.64.64 0 0 1 0-.904m0-2.77a.634.634 0 0 1 .901 0a.634.634 0 0 1 0 .905a.645.645 0 0 1-.901 0a.64.64 0 0 1 0-.904M12.93 2.58a.634.634 0 0 1 .901 0a.64.64 0 0 1 0 .904a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.904m.429 12.804a1.114 1.114 0 0 1 1.573 1.576a1.115 1.115 0 0 1-1.573-1.576m.473-6.393a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.904a.64.64 0 0 1 .902.006c.25.245.25.653 0 .898m0-2.77a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.903a.634.634 0 0 1 .902 0a.64.64 0 0 1 0 .904m-2.29 3.253a.645.645 0 0 1 .902 0a.64.64 0 0 1 0 .904a.634.634 0 0 1-.901 0a.64.64 0 0 1 0-.904m-.34 3.761a1.103 1.103 0 0 1 1.574 0a1.104 1.104 0 0 1 0 1.576a1.114 1.114 0 0 1-1.573-1.576m-.57 2.148a1.115 1.115 0 1 1-1.578 1.576a1.115 1.115 0 0 1 1.579-1.576m-.48-10.066a.64.64 0 0 1 .908 0a.65.65 0 0 1 0 .904a.64.64 0 0 1-.908 0a.64.64 0 0 1 0-.904m0 2.775a.64.64 0 0 1 .902-.006c.25.251.25.66 0 .91a.645.645 0 0 1-.902 0a.64.64 0 0 1 0-.904m4.163-1.388a.634.634 0 0 1 .902 0a.64.64 0 0 1 0 .905a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.905m0-2.775a.645.645 0 0 1 .902 0a.64.64 0 0 1 0 .904a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.904m1.388 1.388a.634.634 0 0 1 .902 0a.64.64 0 0 1 0 .904a.634.634 0 0 1-.902 0a.64.64 0 0 1 0-.904m0-2.77a.634.634 0 0 1 .902 0a.633.633 0 0 1 0 .898a.634.634 0 0 1-.902 0a.63.63 0 0 1 0-.898m1.388 1.382a.645.645 0 0 1 .901 0a.64.64 0 0 1 0 .904a.634.634 0 0 1-.901 0a.64.64 0 0 1 0-.904M24 1.827A1.827 1.827 0 0 0 22.171 0H1.835C.825 0 0 .816 0 1.827V8.81h2.724L0 15.19v6.976C0 23.171.819 24 1.835 24h20.336c1.01 0 1.829-.823 1.829-1.834V15.19h-2.724L24 8.81Z"></svg:path>`,
})
export class SimpleIconsOpenzfsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOperagxIcon],svg[simple-icons-operagx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 12.01c0 3.412-1.462 6.674-4.013 8.943A12 12 0 0 1 11.992 24c-.178 0-.385-.019-.563-.019C5.016 23.681 0 18.403 0 11.991C0 5.37 5.372 0 11.99 0h.038c2.944 0 5.775 1.087 7.96 3.047A12.04 12.04 0 0 1 24 12.009zm-9.14 10.443c-2.729-.056-5.279-1.397-7.041-3.684c-1.388-1.64-2.203-4.013-2.269-6.516v-.544c.047-2.521.881-4.893 2.269-6.534c1.744-2.269 4.294-3.61 7.012-3.666a10.7 10.7 0 0 0-2.784-.384h-.038c-5.99 0-10.865 4.894-10.865 10.866c0 5.812 4.528 10.584 10.34 10.847a10.1 10.1 0 0 0 3.375-.385zm7.996-10.444c0-3.065-1.303-5.99-3.59-8.053a7.7 7.7 0 0 0-4.228-1.284c-2.447 0-4.754 1.181-6.357 3.244c-1.247 1.462-1.969 3.59-2.025 5.83v.526c.056 2.25.778 4.369 2.006 5.812l.02.02c1.602 2.071 3.909 3.252 6.355 3.252a7.7 7.7 0 0 0 4.229-1.284a10.9 10.9 0 0 0 3.59-8.063m-3.75 0c0 4.05-2.184 7.341-4.912 7.585c2.128-1.388 3.61-4.257 3.61-7.585s-1.463-6.197-3.61-7.575c2.728.244 4.912 3.525 4.912 7.575"></svg:path>`,
})
export class SimpleIconsOperagxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOppoIcon],svg[simple-icons-oppo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOptimismIcon],svg[simple-icons-optimism-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOreillyIcon],svg[simple-icons-oreilly-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOrgIcon],svg[simple-icons-org-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.169 0c-.566.004-2.16 3.312-3.376 5.94a2.2 2.2 0 0 1-.408-1.267c-.03-.582-1.089.237-.936 1.275c-.068-.035-1.26.227-1.26.23c-.23-.93-.802-1.618-1.15-.563c-.701 1.663-.88 2.984.115 4.585c-.908 4.058-6.948 6.053-6.32 9.33c.175.004 1.634 3.48 6.337 2.057c5.557-1.577 8.624 2.116 8.978 2.375c.52.526-1.348-4.573-5.302-6.865c-2.339-1.276-.87-3.474-.703-4.25c0 0 1.874 1.312 3.232-.692c1.227.316 2.05-.224 3.105.158c.64.28 3.336.11 2.334-1.396c-.148.129.07.27-.075.46c-.043.056-.128.232-.408.315c-.314.149-.83.27-1.43-.37c-.434-.32-.748-.04-.992-.063c.152-.098.577-.315 1.264-.315c.388 0 .594.336.854.338c.174 0 .685-.262.787-.365c.63-.41.697-.278 1.012-.905c.17-.759-.215-.92-.332-1.129c-.032-.483-.436-.67-.919-.326c-1.106-.198-2.192-.105-2.728-.15c-1.175-.164-2.153-.786-2.153-.786c.143-.19.075-.6-.842-.628c-.315-.104-.45-.2-.745-.307c.61-1.37.674-2.007 1.418-4.004c.261-1.053 1.039-2.685.643-2.682m-4.297 8.093c.03-.086.443.138.952.176c.395.03.805.048 1.296-.025c.03-.005.172.095-.15.194c-.02.01-.062-.01-.065.196c0 .022-.01.04-.02.046c-.15.152-.708.223-1.065.1c-.436-.17-.482-.316-.517-.443c-.305-.147-.47-.123-.43-.244zM9.685 10.2C8.86 9 8.929 8.36 8.96 7.256C7.961 8.288 6.855 8.3 5.18 8.58c-1.299.234-3.657 2.447-4.025 4.742c-.043.608-.08 2.183.424 3.498c.492 1.13.828 1.727 1.844 2.335c-.882-3.169 5.296-5.33 6.263-8.955z"></svg:path>`,
})
export class SimpleIconsOrgIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOriginIcon],svg[simple-icons-origin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.588 3.11a8.8 8.8 0 0 1 3.417.919a8.8 8.8 0 0 1 2.706 2.094a9.1 9.1 0 0 1 1.715 2.963a8.65 8.65 0 0 1 .465 3.502a8.2 8.2 0 0 1-.307 1.848a9 9 0 0 1-.674 1.703a20 20 0 0 1-1.47 2.412a17.6 17.6 0 0 1-1.762 2.118a18.6 18.6 0 0 1-4.286 3.281l-.037.026a.2.2 0 0 1-.109.023a.3.3 0 0 1-.159-.097a.27.27 0 0 1-.062-.173q0-.045.012-.085a.2.2 0 0 1 .037-.062q.416-.59.686-1.235a5.4 5.4 0 0 0 .368-1.359a.12.12 0 0 0-.038-.085a.11.11 0 0 0-.085-.038a9 9 0 0 1-.795.062a5 5 0 0 1-.796-.037a8.82 8.82 0 0 1-6.123-3.013a9.1 9.1 0 0 1-1.715-2.963a8.7 8.7 0 0 1-.465-3.502a8.2 8.2 0 0 1 .306-1.848a8.6 8.6 0 0 1 .675-1.68q.66-1.296 1.469-2.436a18 18 0 0 1 1.76-2.119A18.8 18.8 0 0 1 11.609.05l.038-.025a.2.2 0 0 1 .11-.025a.3.3 0 0 1 .157.098a.26.26 0 0 1 .062.174a.2.2 0 0 1-.012.084a.2.2 0 0 1-.036.061a6.5 6.5 0 0 0-.687 1.237q-.269.649-.366 1.358q0 .05.036.086a.12.12 0 0 0 .085.037q.393-.05.795-.06q.407-.014.798.034zm-.807 12.367a3.32 3.32 0 0 0 2.521-.855a3.4 3.4 0 0 0 1.176-2.4a3.36 3.36 0 0 0-.856-2.535a3.3 3.3 0 0 0-2.4-1.162a3.36 3.36 0 0 0-2.534.855a3.3 3.3 0 0 0-1.164 2.4a3.38 3.38 0 0 0 .846 2.535q.942 1.09 2.411 1.162"></svg:path>`,
})
export class SimpleIconsOriginIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOsfIcon],svg[simple-icons-osf-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.088 0a2.984 2.984 0 0 0-2.986 2.984a3 3 0 0 0 .525 1.68a2.65 2.65 0 0 1 2.482-1.734c1.121 0 2.083.706 2.467 1.695a3 3 0 0 0 .496-1.64A2.984 2.984 0 0 0 12.088 0M5.65 2.666A2.984 2.984 0 0 0 2.666 5.65A2.984 2.984 0 0 0 5.65 8.635A2.984 2.984 0 0 0 8.635 5.65A2.984 2.984 0 0 0 5.65 2.666m12.7 0a2.984 2.984 0 0 0-2.985 2.984a2.984 2.984 0 0 0 2.985 2.985a2.984 2.984 0 0 0 2.986-2.985a2.984 2.984 0 0 0-2.986-2.984m-6.24.764a2.147 2.147 0 0 0-2.147 2.146a2.147 2.147 0 0 0 2.146 2.147a2.147 2.147 0 0 0 2.147-2.147a2.147 2.147 0 0 0-2.147-2.146zM9.112 6.04A3.5 3.5 0 0 1 6.128 9.1a2.15 2.15 0 0 0 1.363.493A2.147 2.147 0 0 0 9.64 7.447a2.15 2.15 0 0 0-.526-1.406zm5.782.047a2.15 2.15 0 0 0-.489 1.36a2.147 2.147 0 0 0 2.147 2.146a2.15 2.15 0 0 0 1.355-.489a3.494 3.494 0 0 1-3.013-3.017M2.985 9.016A2.984 2.984 0 0 0 0 12a2.984 2.984 0 0 0 2.984 2.984a3 3 0 0 0 1.659-.505A2.655 2.655 0 0 1 2.922 12c0-1.131.719-2.102 1.723-2.479a3 3 0 0 0-1.66-.505m18.03 0a3 3 0 0 0-1.673.52a2.655 2.655 0 0 1 1.71 2.474c0 1.12-.705 2.082-1.695 2.467a3 3 0 0 0 1.659.507A2.984 2.984 0 0 0 24 12a2.984 2.984 0 0 0-2.984-2.984zm-15.447.838A2.147 2.147 0 0 0 3.422 12a2.147 2.147 0 0 0 2.146 2.146A2.147 2.147 0 0 0 7.715 12a2.147 2.147 0 0 0-2.147-2.146m12.838.01a2.147 2.147 0 0 0-2.146 2.146a2.147 2.147 0 0 0 2.146 2.146a2.147 2.147 0 0 0 2.147-2.146a2.147 2.147 0 0 0-2.147-2.147zM7.492 14.376a2.15 2.15 0 0 0-1.398.518a3.496 3.496 0 0 1 3.015 3.037a2.15 2.15 0 0 0 .53-1.409a2.147 2.147 0 0 0-2.147-2.146m9.06 0a2.147 2.147 0 0 0-2.146 2.146a2.15 2.15 0 0 0 .492 1.362a3.495 3.495 0 0 1 3.047-2.996a2.15 2.15 0 0 0-1.392-.512zm-10.902.988a2.984 2.984 0 0 0-2.984 2.985a2.984 2.984 0 0 0 2.984 2.986a2.984 2.984 0 0 0 2.985-2.986a2.984 2.984 0 0 0-2.985-2.985m12.7 0a2.984 2.984 0 0 0-2.985 2.985a2.984 2.984 0 0 0 2.985 2.986a2.984 2.984 0 0 0 2.986-2.986a2.984 2.984 0 0 0-2.986-2.985m-6.35.908a2.147 2.147 0 0 0-2.146 2.147A2.147 2.147 0 0 0 12 20.566a2.147 2.147 0 0 0 2.146-2.146A2.147 2.147 0 0 0 12 16.273zm2.268 3.504A2.65 2.65 0 0 1 12 21.067a2.65 2.65 0 0 1-2.188-1.16a2.734 2.635 0 0 0-.46 1.458A2.734 2.635 0 0 0 12.086 24a2.734 2.635 0 0 0 2.734-2.635a2.734 2.635 0 0 0-.552-1.588z"></svg:path>`,
})
export class SimpleIconsOsfIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOshkoshIcon],svg[simple-icons-oshkosh-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOsuIcon],svg[simple-icons-osu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOttoIcon],svg[simple-icons-otto-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOvercastIcon],svg[simple-icons-overcast-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOwaspIcon],svg[simple-icons-owasp-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsOwncloudIcon],svg[simple-icons-owncloud-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsP5dotjsIcon],svg[simple-icons-p5dotjs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1.345 9.122v.784h.035q.105-.164.274-.333a2 2 0 0 1 .416-.305a2.56 2.56 0 0 1 1.253-.31a2.63 2.63 0 0 1 1.964.854q.363.399.561.936q.2.539.2 1.159t-.194 1.163a2.9 2.9 0 0 1-.549.948a2.6 2.6 0 0 1-.866.644q-.51.24-1.152.24q-.597 0-1.094-.246a1.86 1.86 0 0 1-.766-.668h-.024v3.558H0V9.12zm3.276 2.785q0-.328-.1-.65a1.8 1.8 0 0 0-.298-.579a1.5 1.5 0 0 0-.503-.416a1.5 1.5 0 0 0-.714-.157a1.44 1.44 0 0 0-.691.163a1.8 1.8 0 0 0-.52.421a1.8 1.8 0 0 0-.328.585a1.97 1.97 0 0 0 0 1.305a1.8 1.8 0 0 0 .328.58a1.7 1.7 0 0 0 .52.414q.305.158.691.159a1.48 1.48 0 0 0 1.217-.586q.198-.256.297-.585a2.3 2.3 0 0 0 .1-.654zm13.682-3.054v6.223q0 .503-.082.952a2 2 0 0 1-.31.785a1.6 1.6 0 0 1-.62.532q-.392.199-1.024.199a3 3 0 0 1-.35-.024a4 4 0 0 1-.281-.047l.117-1.192a1.8 1.8 0 0 0 .386.047a.75.75 0 0 0 .397-.094a.63.63 0 0 0 .234-.258q.082-.163.105-.38q.024-.216.024-.461V8.853zm4.784 1.765a1.6 1.6 0 0 0-.514-.427a1.45 1.45 0 0 0-.714-.18q-.339 0-.62.14a.48.48 0 0 0-.28.467a.47.47 0 0 0 .31.462q.309.135.906.276q.315.07.638.187q.322.115.585.31a1.5 1.5 0 0 1 .427.48q.163.286.163.695q0 .515-.192.872q-.194.356-.515.58a2.2 2.2 0 0 1-.75.32a4 4 0 0 1-.883.101a3.5 3.5 0 0 1-1.275-.24a2.7 2.7 0 0 1-1.03-.685l.925-.866a1.83 1.83 0 0 0 1.44.703q.15 0 .31-.035a1 1 0 0 0 .29-.112a.6.6 0 0 0 .218-.205a.6.6 0 0 0 .081-.316a.52.52 0 0 0-.32-.503q-.324-.15-.967-.303a5 5 0 0 1-.614-.182a2 2 0 0 1-.531-.292a1.35 1.35 0 0 1-.375-.451a1.4 1.4 0 0 1-.14-.667q0-.467.192-.806a1.66 1.66 0 0 1 .51-.556q.315-.217.713-.322a3.2 3.2 0 0 1 .819-.105q.608 0 1.187.21t.919.643zm-8.29 2.931l.837-.252l.164.505l-.833.283l.517.734l-.436.316l-.544-.721l-.53.701l-.423-.322l.517-.708l-.84-.302l.165-.506l.843.271v-.872h.564zm-2.887-2.644a2.3 2.3 0 0 0-.602-.819a2.7 2.7 0 0 0-.907-.509a3.5 3.5 0 0 0-1.13-.175q-.221 0-.497.024a2.4 2.4 0 0 0-.474.082l.082-1.79h3.382V6.453H7.05l-.14 4.527a4 4 0 0 1 .426-.175a7 7 0 0 1 .491-.147a5 5 0 0 1 .515-.099a4 4 0 0 1 .497-.035q.34 0 .668.076q.327.075.591.269q.262.193.426.509t.164.795q0 .375-.123.673a1.4 1.4 0 0 1-.333.497a1.4 1.4 0 0 1-.49.304q-.284.106-.598.106q-.562 0-.972-.299a1.63 1.63 0 0 1-.584-.79l-.015.006l-1.016.952q.307.504.797.838q.713.486 1.754.486a3.4 3.4 0 0 0 1.17-.2a2.7 2.7 0 0 0 1.609-1.491q.24-.543.24-1.233q0-.633-.216-1.118z"></svg:path>`,
})
export class SimpleIconsP5dotjsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPackagistIcon],svg[simple-icons-packagist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.214 23.975c-.098-.053-.329-.062-1.615-.062h-1.26l-.017-.088l-.096-.431a4 4 0 0 1-.07-.354c.005-.007-.012-.056-.038-.107l-.048-.094l-.547.085c-.301.046-.598.1-.659.116c-.1.03-.11.03-.103.004c.038-.14.044-.201.028-.266c-.018-.07-.017-.072.238-.645c.276-.622.266-.594.237-.634c-.018-.025-.042-.02-.307.07c-.159.05-.294.093-.301.09a17 17 0 0 1 .414-.732c.451-.773.566-.976.566-1.003c0-.01-.12-.146-.271-.304c-.15-.157-.311-.329-.357-.384a.6.6 0 0 0-.112-.11c-.05-.017-.264-.231-.738-.734a16 16 0 0 0-.525-.542c-.062-.05-.077-.074-.107-.175a7 7 0 0 0-.291-.714l-.096-.201v-.178c0-.271-.056-.542-.277-1.331l-.054-.191l-.087-.01c-.193-.017-.283-.123-.431-.504a6 6 0 0 0-.231-.472c-.1-.191-.221-.428-.271-.532l-.086-.185l-.08-.01a.7.7 0 0 0-.361.05c-.12.05-.345.063-.618.037l-.399-.038l-.199-.02l-.107-.191c-.161-.284-.161-.285-.238-.324c-.09-.046-.161-.046-.572 0l-.325.035l-.245-.035c-.645-.094-.797-.166-.797-.375c0-.042-.045-.261-.102-.489c-.13-.528-.218-1.126-.195-1.332c.034-.294.273-.996.636-1.87l.142-.341l.023-.547c.142-3.274.178-3.76.284-3.951c.035-.062.468-.431.644-.552c.335-.224 1.503-.8 2.802-1.379l.384-.171l.195-.012l.193-.01l.522.329l.521.329l.423-.2l.658-.308c.235-.108.236-.11.367-.253c.184-.201.492-.566.592-.703c.118-.161.395-.388.816-.672c.147-.098.185-.116.569-.264l.231-.09h.49c.451 0 .502.003.655.037c.358.078.652.193.686.267c.022.05.07.08.187.12c.14.048.311.168 1.224.863c.489.373.472.366 1.539.719l.298.1l.176.211c.201.241.358.404.404.419c.07.022.485-.08 1.009-.249c.266-.085.303-.093.351-.077c.03.01.175.02.321.02c.271.005.514.034 1.117.137c.153.027.281.048.283.048s.244.419.537.933c.293.512.61 1.048.705 1.192c.167.249.174.264.189.375c.026.191.08 1.008.09 1.309l.023.896c.02.843.036 1.04.09 1.154c.093.199.276.747.572 1.719l.12.401l.008.93l-.14.728l-.158.813l-.016.083l-.439.264l-.441.265l-.321-.016c-.179-.01-.335-.016-.349-.016c-.03 0-.066.113-.135.411c-.04.176-.042.178-.092.187l-.666.106c-.92.145-1.037.181-1.341.424c-.264.211-.264.208-.556 1.681a17 17 0 0 1-.185.856c-.105.317-.941 1.708-1.246 2.074l-.165.199l.064.228c.035.126.073.265.083.309c.016.07.314 1.206.421 1.609l.038.14l-.201-.084l-.328-.136a.6.6 0 0 0-.13-.046c-.003.004.033.15.08.327c.08.288.187.763.177.773c-.003 0-.15-.008-.331-.022a6 6 0 0 0-.381-.02l-.055.005l-.181.662c-.1.363-.184.664-.187.667c-.01.007-.536-.02-1.005-.05c-.54-.035-.7-.032-.836.017c-.125.045-.241.05-.306.014zm1.957-.348c0-.026.023-.181.05-.345c.027-.165.05-.337.05-.383q0-.085.04-.175c.02-.05.036-.09.033-.093c-.002-.002-.368-.03-.813-.062c-.637-.046-.86-.067-1.053-.103l-.244-.046l-.58.072c-.414.05-.588.078-.607.095c-.02.02-.201.042-.712.094c-.376.038-.717.075-.756.083l-.072.013l.004.083c.003.065.02.115.083.231c.06.113.088.191.12.331c.02.1.042.184.046.188c.003.003.973.014 2.157.023c2.034.016 2.154.018 2.191.045c.046.035.064.02.064-.05zm-4.782-1.179c.873-.123 1.226-.168 1.572-.194c.387-.028.897-.087 1.259-.143c.057-.01.248-.02.424-.026l.321-.01l.377.097l.379.098l.682.04c.377.023.687.04.69.036a3 3 0 0 0-.07-.229c-.042-.122-.11-.333-.155-.468l-.077-.244l-.231-.072l-.231-.073l-.156.066l-.156.065l-1.776.057l-1.774.058l-.118-.06l-.118-.057H9.8l-.269.597c-.148.328-.271.602-.276.609c-.008.016-.124.03 1.134-.147m6.127-1.036c0-.017-.431-1.435-.444-1.457c-.007-.012-.05.024-.115.096l-.105.115l.154.568l.153.568l.169.06c.181.064.191.067.191.05zm-6.788-.713l.191-.355l-.057-.083c-.032-.046-.063-.08-.068-.073c-.007.006-.142.238-.303.515s-.297.511-.302.517c-.004.01.072-.026.171-.075l.176-.09zm2.957-.072c.106-.306.193-.562.193-.57a1 1 0 0 0-.198-.075a4 4 0 0 1-.201-.066a.6.6 0 0 1 .063-.11l.068-.104l.405-.02c.706-.033 1.114-.155 1.51-.451c.15-.11.214-.128.296-.085c.07.04.12.128.106.191c-.01.042-.028.056-.241.197c-.201.13-.876.428-1.114.492c-.136.035-.289.12-.323.181c-.04.066-.159.92-.132.947c.006.006 1.148-.04 1.33-.056c.11-.008.117-.01.161-.067c.024-.032.13-.153.238-.267c.106-.113.301-.333.431-.488s.328-.381.437-.502c.171-.189.263-.318.619-.857c.878-1.324.937-1.441 1.003-1.969c.045-.375.067-.447.214-.697c.146-.249.294-.965.213-1.033c-.072-.06-.153-.032-.427.15c-.512.341-1.039.841-1.114 1.053c-.034.095-.223.373-.285.418l-.519.369c-.582.414-.52.349-.849.879l-.11.174l-.327.173l-.328.171l-.616.015c-1.23.028-1.288.022-1.943-.207l-.431-.153l-.344-.303c-.191-.168-.53-.47-.754-.672l-.407-.368l-.142-.321a29 29 0 0 1-.497-1.15c-.084-.226-.09-.231-.275-.428c-.341-.361-.529-.757-.757-1.612q-.067-.248-.1-.281q-.029-.025-.023-.012c.006.01 0 .046-.012.082c-.157.441-.209.768-.249 1.559c-.02.359-.02.351.096.983c.225 1.226.296 1.5.409 1.565c.04.024.165.146.291.286c.341.376.448.485.604.61c.285.231.735.71.901.961c.04.06.102.14.135.177c.15.163.462.6.899 1.259l.314.475l.13-.007c.09-.006.329.012.74.054c.336.035.635.064.665.065h.056zm-2.276.455a1 1 0 0 0-.122-.201c-.075-.107-.14-.195-.15-.191c-.01.003-.138.268-.181.374c-.01.031.341.044.453.018m2.766-2.758c.046-.033.127-.055.376-.105c.311-.06.375-.083.628-.211a.3.3 0 0 0 .092-.11a.7.7 0 0 1 .11-.138c.04-.036.055-.062.055-.098c0-.078.227-.275 1.091-.946a.9.9 0 0 0 .245-.268c.074-.11.158-.211.263-.309c.085-.08.291-.284.459-.451c.168-.171.391-.376.497-.462a3 3 0 0 0 .241-.204c.03-.032.157-.106.335-.196c.159-.08.295-.156.301-.168c.018-.03.09-.06.508-.217c.889-.331 1.479-.492 1.79-.492c.08 0 .096-.052.067-.219c-.068-.395-.296-.552-.808-.552h-.181l-.063-.067c-.06-.065-.067-.087-.124-.325c-.115-.485-.185-.532-.742-.516c-.435.013-.552.06-1.754.718c-.602.331-1.035.702-1.543 1.33a1 1 0 0 1-.11.123c-.311-.002-.303-.472.017-.949l.106-.157l-.084-.035c-.236-.107-.532-.123-.74-.04c-.291.116-1.023.525-1.117.622c-.098.103-.187.106-.187.007c0-.122.114-.285.289-.411c.04-.032.11-.088.153-.127a1.6 1.6 0 0 1 .435-.261c.147-.06.142-.052.09-.15c-.14-.255-.525-.546-.915-.689c-.05-.02-.169-.07-.263-.112c-.221-.102-.331-.124-.672-.136c-.244-.01-.283-.014-.267-.033c.074-.09.311-.133.79-.144l.384-.01l.248.11c.697.301.963.462 1.074.645c.076.128.084.133.194.112c.266-.05.518.032.765.249c.135.12.184.13.274.063a.77.77 0 0 0 .273-.502c.035-.271-.06-1.136-.153-1.385c-.07-.188-.057-.196.087-.046c.171.178.171.178.326-.11c.04-.076.103-.176.138-.221c.291-.367.281-1.047-.017-1.347c-.15-.15-.404-.291-.815-.446c-.403-.155-.47-.211-.77-.628c-.361-.506-.425-.567-.724-.708c-.617-.293-2.101-.562-2.57-.467c-.441.09-1.04.447-1.32.789c-.175.213-.63.377-1.274.462c-.84.108-1.254.828-1.041 1.806c.04.191.038.189.165.034c.405-.505 1.209-.976 1.93-1.13c.575-.12 1.475-.126 2.01-.01l.096.022h-.144c-.75.01-1.904.257-2.722.584l-.176.07l-.016.087c-.015.083-.022.093-.281.351c-.536.539-.69.796-.775 1.286c-.04.239.036.589.15.678c.027.022.047.05.042.06a3 3 0 0 0-.026.225c-.076.845.323 1.866.96 2.453l.144.133l.108-.09c.317-.259.859-.614.888-.582c.043.05.034.09-.033.155c-.085.082-.196.226-.496.642l-.259.361l.007.104c.01.13.076.337.147.451c.03.046.09.15.136.229c.167.284.321.52.424.642c.096.117.184.241.284.401q.041.068.07.06c.04-.01.09.026.279.204c.186.171.083.122.845.408c.823.309 1.131.369 1.465.286c.09-.022.097-.022.168.015c.09.047.09.047.163-.002zm-6.348-3.82c.003-.003.02-.103.037-.225c.017-.12.053-.286.08-.367l.193-.644c.177-.602.159-.55.178-.52c.025.042.015-.01-.016-.074a2 2 0 0 1-.066-.171l-.034-.108l.034-.588l.034-.589l-.055-.397a6 6 0 0 0-.064-.406c-.032-.032-.464.145-.599.245c-.175.13-.401.679-.492 1.194c-.12.694-.008 1.647.226 1.916c.07.08.226.378.357.68l.034.077l.075-.01a.4.4 0 0 0 .078-.013m14.775-1.31c.126-.088.238-.177.246-.196c.015-.037.213-1.099.281-1.507l.042-.257l-.042-.447l-.042-.446l-.125-.48c-.124-.475-.128-.484-.264-.755c-.216-.431-.194-.236-.379-3.358l-.035-.578l-.053-.055c-.07-.075-.337-.458-.963-1.388a14 14 0 0 0-.546-.781a16 16 0 0 0-.821-.146c-.395-.055-.736-.025-1.055.094c-.128.048-.14.05-.201.03c-.138-.047-.293-.003-.569.164l-.145.087l-.166-.221c-.191-.251-.194-.255-.57-.502c-.64-.416-.716-.449-1.632-.692c-.353-.094-.311-.062-.993-.742l-.535-.532l-.585.008c-.989.015-1.482.06-1.6.142c-.712.508-1.094.888-1.538 1.531l-.103.15l-.386.184c-.422.203-1.034.392-1.201.369c-.092-.012-.421-.18-.658-.341c-.438-.291-.739-.326-1.088-.124c-.284.163-.483.269-1.286.675c-.861.437-.965.496-1.246.705l-.164.123l-.143.288c-.311.626-.305.602-.321 1.415c-.03 1.52-.035 2.008-.016 2.122c.03.179.036.374.016.505c-.028.171-.387 1.387-.585 1.977c-.066.199-.135.52-.159.736c-.01.07 0 .175.036.391c.026.164.07.451.097.64c.066.464.12.562.358.64c.209.07.309.063.732-.045c.793-.203.813-.197 1.134.378c.078.137.112.184.143.193c.105.03.725.01.866-.027l.194-.05l.056-.015l-.02-.096a2.4 2.4 0 0 1-.023-.624c.024-.268.064-.506.153-.889c.004-.017-.006-.004-.022.03l-.03.06l-.035-.157a1.9 1.9 0 0 0-.291-.672a6.4 6.4 0 0 1-.421-.87l-.093-.231l.01-.161c.05-.718.224-1.186.597-1.595c.227-.248.293-.351.325-.522c.025-.13.106-.807.171-1.395l.057-.547l.241-.715c.13-.394.231-.722.225-.728a9 9 0 0 0-.693-.321c-.124-.035-.412-.023-.632.027c-.705.161-1.224.532-1.25.893c-.007.08-.362.827-.395.828c-.02 0-.074-.098-.093-.169c-.02-.074-.012-.115.073-.351c.032-.088.097-.307.145-.487c.12-.443.14-.477.405-.599l.467-.221c.675-.325 1.657-.578 1.899-.49c.143.05.359.226.552.446l.092.104l-.09.246c-.458 1.266-.575 1.617-.606 1.823c-.071.458-.066 1.465.008 1.695c.058.188.054.195-.223.377c-.477.316-.953.919-.973 1.233c-.013.211.09.634.221.888c.052.105.589.913.606.913c.006 0 .03-.04.057-.09a1.9 1.9 0 0 1 .704-.773c.316-.204.317-.204.341-.313c.161-.725.425-1.144.88-1.385l.197-.105l-.095-.035c-.145-.053-.271-.143-.428-.308c-.697-.733-.966-1.566-.688-2.127c.02-.04.052-.122.072-.184c.245-.755.931-1.164 1.842-1.101c.896.063 1.294.296 1.618.94c.311.624.294 1.191-.055 1.751l-.066.106l.06-.058c.068-.063.766-.374.946-.421c.268-.07.659-.03 1.894.193c.499.09.584.125.823.341c.05.048.09.076.09.064s-.01-.104-.025-.206c-.083-.617.034-1.401.269-1.786c.284-.466 1.375-.883 1.974-.754c.301.065.769.355 1.021.635c.032.036.06.056.06.045c0-.01-.02-.325-.04-.699a11 11 0 0 1-.03-.689c.008-.006.144-.084.306-.174l.293-.161l.052.04c.044.032.169.063.78.191l.763.164c.027.006.085.09.216.307c.097.164.271.448.388.632c.425.68.502.856.411.941c-.093.087-.108.086-.169-.007c-.03-.045-.201-.314-.379-.595a16 16 0 0 0-.351-.539c-.02-.02-.998-.346-1.487-.497c-.239-.073-.492 1.151-.434 2.099c.02.319.02.321.291.57c.169.156.858 1.126.993 1.397l.067.136l-.006.826l-.005.825l-.105.177c-.441.742-.694 1.021-.985 1.096c-.161.04-.339.175-.324.241c.005.022.013.154.02.291q.01.252.027.253c.01 0 .073-.01.14-.023c.455-.087.958-.057 1.261.073c.11.047.116.064.128.344c.017.375.042.407.353.457c.348.055.468.114.695.344l.128.13l.462.002l.462.002zM9.954 3.808a13 13 0 0 0-.833-.494c-.338-.171-.351-.201-.117-.309c.341-.157.474-.11.908.315c.168.165.369.349.448.411c.156.118.328.275.328.297c0 .027-.115.14-.14.14a9 9 0 0 1-.594-.36m3.987.19a.5.5 0 0 1-.235-.191l-.042-.07l.03-.068c.04-.095.076-.13.231-.231c.074-.05.159-.11.188-.134c.159-.14 1.179-.558 1.358-.558c.1 0 .13.02.176.125a.6.6 0 0 0 .065.12c.05.056-.06.115-.341.179c-.15.034-.502.176-.818.328l-.258.125l-.148.201c-.08.11-.15.201-.15.201L13.94 4zm2.25 8.609c.117-.103.612-.334.898-.418c.104-.03.171-.307.171-.72v-.234l-.092-.191c-.097-.201-.203-.378-.221-.371c-.006.002-.203.251-.437.556l-.427.552l.01.249l.01.444c0 .225-.006.218.09.134zm1.639-1.799l.344-.132l.112-.169c.391-.592.512-.901.529-1.379l.01-.308l-.228-.361c-.386-.607-.636-1.018-.722-1.187a.4.4 0 0 0-.062-.1c-.062-.04-.245.12-.458.401c-.15.201-.226.254-.674.478c-.592.295-.876.341-1.292.213a7 7 0 0 0-.552-.156c-.042 0 .133.206.294.347c.126.11.221.161.346.181c.191.03.547.231 1.094.612c.303.214.261.133.291.55l.027.351l.08.078c.1.098.214.251.381.51c.07.112.13.205.132.205zm-1.719-3.119c.446-.164.704-.665.527-1.023c-.194-.391-.634-.702-.998-.702c-.425 0-.979.482-.979.853c0 .008.058-.038.127-.104c.329-.311.692-.346 1.05-.105c.385.258.469.77.173 1.064c-.078.08-.067.08.1.02zm-7.704-.16a1 1 0 0 1-.026-.396c.145-.778 1.09-1.005 1.51-.364l.064.1l-.009-.129c-.069-.971-1.094-1.234-1.726-.443c-.356.447-.299 1.13.105 1.274c.103.036.107.034.08-.042zm8.86-.527c.261-.439.226-1.053-.088-1.53c-.421-.642-1.084-.841-1.806-.542c-.559.231-.776.517-.825 1.081c-.022.251-.012.281.058.176c.238-.354.644-.547 1.094-.522c.712.038 1.24.539 1.385 1.316l.034.183l.008.04l.04-.05a2 2 0 0 0 .1-.154zm-1.431.09a.13.13 0 0 0 .04-.096a.13.13 0 0 0-.04-.095a.13.13 0 0 0-.096-.04q-.058 0-.097.04a.13.13 0 0 0-.038.096c0 .123.146.185.233.098zm-8.218-.209c.138-.773.732-1.289 1.48-1.289c.485 0 .838.274 1.043.809c.054.14.06.143.087.035c.07-.274-.01-.848-.163-1.149c-.26-.518-1.032-.779-1.751-.591c-.415.106-.9.64-.997 1.097c-.1.468-.038.849.191 1.167c.077.108.077.108.11-.08zm1.928 0a.13.13 0 0 0 .04-.096q0-.058-.04-.097c-.027-.028-.056-.041-.096-.041s-.07.013-.096.04a.13.13 0 0 0-.04.097a.136.136 0 0 0 .232.097"></svg:path>`,
})
export class SimpleIconsPackagistIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPaddlepaddleIcon],svg[simple-icons-paddlepaddle-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPaddypowerIcon],svg[simple-icons-paddypower-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPanasonicIcon],svg[simple-icons-panasonic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPaperspaceIcon],svg[simple-icons-paperspace-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsParadoxinteractiveIcon],svg[simple-icons-paradoxinteractive-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23.384 12.65c-.141-.703.587-1.31.241-2.029c-.345-.718-2.012-.67-2.038-1.488c-.037-.949 1.347-.466 1.928-.446c0-1.52-.597-2.824-2.238-1.797a.89.89 0 0 1-.77-.299c-.524-.896 1.001-1.09 1.048-1.803c0-.42-.492-.686-.65-1.048a1.8 1.8 0 0 1 0-.76c0-.1-.12-.105-.199-.126c-.309-.078-.597.1-.917.032a4.4 4.4 0 0 1-.86-.524a1.15 1.15 0 0 1-.298.403c-.23.32-1.048 1.457-1.573.964a.92.92 0 0 1-.125-.791C17.21.952 16.493.737 14.742.459c-.42-.068-1.489-.32-1.976-.173c0 .335.425 2.689-.33 2.563c-.896 0-.409-2.332-1.709-2.62a1.2 1.2 0 0 0-.64.314c-.183.267.184 1.09.263 1.41a2.14 2.14 0 0 1-.058 1.263V3.3C8.814 3.3 8.977.034 6.671 1.643c0 .876 2.096 1.982 1.368 2.94a.85.85 0 0 1-.525.326c-1.116.136-1.572-2.275-2.803-2.06a.7.7 0 0 0-.451.367c-.32.555 1.048 1.389 1.263 1.955a1.7 1.7 0 0 1-.037.89c-1.048 0-2.285-1.503-3.265-.55a.64.64 0 0 0-.262.587c.1.399.812.33 1.048.708v.047c.372.844-.482 1.462-.492 2.228c0 .382.288.597.167 1.011c-.42 1.426-1.771-.162-2.416.446s.079 1.682.126 2.327a8.5 8.5 0 0 1-.23 1.147a2.9 2.9 0 0 0 .335.986c.125.456 0 .959.246 1.352c.729 1.121 1.944-1.94 2.521-.65c.445 1.048-1.808.985-1.866 1.777c-.057.791 1.29 1.493 1.814 1.986a2.74 2.74 0 0 1 .901 1.677a5.2 5.2 0 0 1-.377 1.85a2 2 0 0 0 .644.032c1.143-.34 1.814-2.165 1.625-3.297c-.173-.954-.697-1.771-.765-2.767s.89-2.62 0-3.323l-.12-.073a.34.34 0 0 1-.336.136a.74.74 0 0 1-.524-.173a.445.445 0 0 1-.157-.624c.22-.325.843-.262.917-.697c.157-.964-1.86-1.153-.64-2.343a1.17 1.17 0 0 1 .928-.356c.566.042 1.934.45 1.855 1.174c-.036.33-.314.64-.194 1.006c.12.367.682.341.834.697c.199.488-.21.85-.168 1.305a.28.28 0 0 0 .147.226a1.6 1.6 0 0 1 .602.403c.257.566-.43 1.258.483 1.573c0-.404-.09-.944.262-1.153a1.2 1.2 0 0 0 .257.325c.288.45.408.875.995 1.048a3.3 3.3 0 0 0-.46-1.604c.418 0 .68.556 1.157.43s.048-.603-.052-.807c-.288-.582.126-1.049-.047-1.573s-1.735-1.037-2.207-1.478a.67.67 0 0 1-.246-.639c.288-.891 1.336-.362 2.096-.571a1.9 1.9 0 0 0 .85-.608a1.5 1.5 0 0 0 .361-1.494a1.6 1.6 0 0 1-.293-.912c.22-1.604 2.814-1.515 3.946-.933c.577.294 1.127.975.823 1.667c-.273.608-1.006.257-1.52.482a3.4 3.4 0 0 0-1.205 1.572c-.231.65.414 1.143.456 1.777c.089 1.384-.566 2.657-.839 3.91c-.052.23.152.524.026.75c-.199.335-.613.214-.948.335a3.3 3.3 0 0 0-.603.44c-.482.299-1.048.446-1.106 1.106c.304 0 .524-.163.854-.194a.058.058 0 0 1 .068.063v.063c-.073.576-.524 1.048-.256 1.666c.408 0 .524-.953 1.184-.702c.079 0 .068 0 .09.073a4.8 4.8 0 0 0 .434 1.211a.27.27 0 0 0 .226-.267a4 4 0 0 1 .057-1.373c.2-.524.556-.451.467-1.153a2 2 0 0 0 .346-.22c.833-.289.97-.77 2.023-.74a1.75 1.75 0 0 1 .723.126c.183 0 .115-.288.047-.524c-.372-1.226-.839-2.437-.839-3.852h.2a8 8 0 0 0 .744 1.206c.157.251.665 1.415 1.116 1.163c.21-.126.336-1.572.456-1.913c.446-1.2 1.704-1.462 2.448-.304s.267 3.417-.63 4.266c-.35.33-.853.33-1.189.64c-.335.309-.037.927-.094 1.352a1.93 1.93 0 0 1-.603 1.048c-.629.634-1.483.917-2.128 1.499c-.278.246-.34.655-.681.807c-.34.152-.75-.042-1.1.063l-.771.482c-.472.247-1.237.66-1.489.74c0 1.005 2.406.47 2.899.204c.35-.19.456-.65.802-.802c.345-.152.697.215 1.095.078a5.3 5.3 0 0 0 1.048-.65a21 21 0 0 0 1.866-1.294a2.1 2.1 0 0 0 .597-.65c.152-.425-.524-1.473.671-1.3c.923.12 1.845-1.735 2.018-2.39c.105-.524.204-1.016.304-1.53l.383-.923c.22-.754-.462-.754-.572-1.278M2.462 14.594a.886.886 0 0 1-.928-1.294a1.37 1.37 0 0 1 .598-.525a1.28 1.28 0 0 1 .755.231a.891.891 0 0 1-.425 1.588m4.942-5.393a.43.43 0 0 1-.267-.058c-.938-.398-.55-1.006-.194-1.671c.713.288.875 1.509.461 1.73m1.316 2.757a1.81 1.81 0 0 1 1.137 1.536a.5.5 0 0 1-.084.22a.72.72 0 0 1-.466 0c-.702-.3-.598-1.064-.598-1.756Zm6.918 3.071a1.05 1.05 0 0 1-.372.65a.75.75 0 0 1-.75-.461a2.3 2.3 0 0 1 0-.886a11.6 11.6 0 0 1 .472-2.945c.325.712.21 1.572.367 2.363a4 4 0 0 1 .278 1.28zm4.717-4.224a6.6 6.6 0 0 1-1.31-.037c-1.646-.325-.226-2.175.126-2.914c.67.603 1.415 1.986 1.184 2.95"></svg:path>`,
})
export class SimpleIconsParadoxinteractiveIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsParamountplusIcon],svg[simple-icons-paramountplus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsParitysubstrateIcon],svg[simple-icons-paritysubstrate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsParsedotlyIcon],svg[simple-icons-parsedotly-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPastebinIcon],svg[simple-icons-pastebin-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M17.02 0a2.1 2.1 0 0 0-.722.123L2.624 5.003A2.1 2.1 0 0 0 1.35 7.69l5.324 14.915a2.1 2.1 0 0 0 2.685 1.272l7.746-2.765c.792-.307 1.345-.534 1.464-.608c.543-.314.962-.817 1.964-2.334c.904-1.362 1.859-3.323 2.097-4.28c.24-.97.239-1.48-.502-3.674l-3.146-8.82A2.1 2.1 0 0 0 17.02 0m-.083.414c.72-.031 1.4.403 1.657 1.12l3.68 10.357c.103.433-.281 1.147-.736 1.35c-.2.1-.71.293-1.142.429c-1.397.463-2.05.878-2.458 1.547c-.363.591-.315 1.18.16 2.377c.462 1.142.533 1.864.225 2.4c-.113.188-.301.322-1.354.733l-.002-.005l-7.746 2.765a1.68 1.68 0 0 1-2.157-1.022L1.74 7.55a1.68 1.68 0 0 1 1.022-2.157L16.437.513q.25-.09.5-.099M15.9 2.25l-1.203.885l.187.519l.523-.316l.803 2.235l-.696.249c.045.145.216.642.238.664l2.166-.78l-.238-.662l-.687.248zm-3.29 1.182l-1.203.885l.186.519l.524-.316l.803 2.235l-.697.25c.046.144.216.64.238.663l2.167-.778l-.238-.663l-.687.247zM9.085 4.786c-.283 0-.56.076-.8.223c-.732.448-.85 1.383-.332 2.558c.337.776.873 1.218 1.462 1.215c1.345-.007 1.86-1.4 1.085-2.95c-.307-.66-.837-1.036-1.415-1.046m-.191.672c.168-.01.357.085.539.279c.145.155.347.51.437.787c.35.998.164 1.688-.414 1.546C8.855 7.93 8.21 6 8.62 5.585a.4.4 0 0 1 .273-.127zm-3.765.75c-.283 0-.56.076-.8.223c-.732.448-.85 1.382-.332 2.557c.337.777.873 1.218 1.462 1.215c1.344-.007 1.86-1.398 1.085-2.95c-.307-.66-.838-1.036-1.415-1.045m-.192.672c.168-.01.358.085.54.278c.145.155.347.51.437.787c.35.999.164 1.689-.415 1.547c-.6-.141-1.243-2.072-.834-2.485a.4.4 0 0 1 .272-.127m13.362.655c-.283 0-.56.076-.8.223c-.732.448-.85 1.382-.332 2.558c.337.776.873 1.218 1.462 1.215c1.345-.007 1.86-1.4 1.085-2.95c-.307-.66-.837-1.036-1.415-1.046m-.191.672c.168-.01.357.085.539.278c.145.155.347.51.437.787c.35.999.164 1.689-.414 1.547c-.601-.141-1.244-2.072-.835-2.485a.4.4 0 0 1 .273-.127m-3.766.75a1.53 1.53 0 0 0-.8.222c-.73.448-.848 1.383-.331 2.558c.337.776.873 1.218 1.462 1.215c1.344-.007 1.86-1.398 1.085-2.95c-.307-.66-.838-1.036-1.416-1.045m-.19.67c.167-.008.357.086.539.28c.145.155.347.51.437.787c.35.998.164 1.688-.415 1.547c-.6-.142-1.244-2.072-.835-2.485a.4.4 0 0 1 .273-.128zm-3.746.744a1.5 1.5 0 0 0-.8.223c-.732.448-.85 1.382-.332 2.557c.337.777.873 1.218 1.462 1.215c1.345-.007 1.86-1.398 1.085-2.95c-.307-.66-.838-1.036-1.415-1.045m-.192.672c.169-.01.358.085.54.278c.145.155.347.51.437.787c.35.999.164 1.689-.414 1.547c-.601-.141-1.244-2.072-.835-2.485a.4.4 0 0 1 .272-.127m-3.515.616l-1.203.884l.187.52l.524-.316l.802 2.233l-.696.25c.045.145.216.641.238.663l2.166-.778l-.238-.663l-.687.247zm15.664 1.33c.034 0 .049.047.064.135c.023.11-.064.545-.195.957c-.47 1.435-2.052 4.223-3.08 5.396l-.407.47l.05-.667c.03-.567-.015-.812-.376-1.71c-.496-1.263-.533-1.73-.158-2.31c.34-.514 1.028-.907 2.448-1.37c.72-.238 1.175-.463 1.385-.664c.132-.145.207-.22.253-.235l.015-.003zm-6.43 1.476l-1.202.885l.187.52l.523-.317l.803 2.235l-.696.25c.045.144.216.641.238.663l2.166-.779l-.238-.662l-.687.247zm-3.578 1.33c-.283 0-.56.077-.8.223c-.731.448-.85 1.382-.332 2.558c.337.776.873 1.218 1.462 1.215c1.345-.007 1.86-1.399 1.086-2.95c-.307-.66-.838-1.036-1.416-1.046m-.191.672c.168-.009.358.085.54.28c.144.153.346.51.437.786c.35.998.164 1.688-.415 1.546c-.6-.14-1.244-2.072-.835-2.485a.4.4 0 0 1 .273-.127m-3.515.616l-1.204.885l.187.52l.524-.317l.803 2.234l-.697.25c.045.145.216.642.238.664l2.166-.779l-.238-.663l-.687.248z"></svg:path>`,
})
export class SimpleIconsPastebinIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPaytmIcon],svg[simple-icons-paytm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPcgamingwikiIcon],svg[simple-icons-pcgamingwiki-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPdqIcon],svg[simple-icons-pdq-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPearsonIcon],svg[simple-icons-pearson-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPeerlistIcon],svg[simple-icons-peerlist-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPegasusairlinesIcon],svg[simple-icons-pegasusairlines-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m10.511 12.101l-.574 1.331H8.77l-.05-.09c-.32.134-.593.185-.966.185a1.076 1.076 0 0 1-1.072-1.18a2.626 2.626 0 0 1 2.601-2.324c.648 0 1.017.12 1.56.383l-.144.342c-.027.067-.105.114-.166.084c-.064-.029-.05-.069-.08-.134c-.05-.108-.116-.142-.158-.171a.8.8 0 0 0-.496-.138c-.34 0-.647.128-.882.337a2.88 2.88 0 0 0-.963 1.798a.478.478 0 0 0 .468.549c.323 0 .5-.187.623-.463l.228-.533c.027-.068-.044-.126-.073-.13c-.049-.02-.08-.058-.08-.106c0-.066.05-.12.142-.12h1.416c.084-.004.147.088.113.166c-.016.04-.047.062-.103.069c-.1.016-.14.058-.177.145m-3.97-.693a.15.15 0 0 0-.13.075c-.05.078-.096.086-.176.092h-.716L6 10.464h.85c.05-.003.075.054.072.082c-.002.052.023.097.067.116c.06.026.134-.012.166-.085l.203-.471h-2.7c-.093 0-.148.05-.148.116c0 .048.031.089.08.108c.042.009.098.07.075.131l-1.287 2.985h2.965l.166-.381a.12.12 0 0 0-.108-.17a.16.16 0 0 0-.131.076a.23.23 0 0 1-.213.118h-1.19l.509-1.181h.785c.046.003.065.057.063.082c-.002.052.011.097.056.116c.06.026.135-.012.166-.085l.193-.443c.034-.072-.012-.171-.096-.169m-3.716.722h-.976l-.432 1.014c-.016.028.005.063.032.075c.05.018.08.059.08.107c0 .066-.064.119-.143.119H0l1.298-3.018c.019-.044-.023-.087-.049-.095c-.048-.019-.08-.06-.08-.107c0-.066.065-.12.144-.12c.513 0 1.72 0 2.22.003a.6.6 0 0 1 .555.358q.079.195.08.417c0 .233-.073.45-.194.63c-.26.385-.688.617-1.15.617m.017-1.613c-.062-.046-.205-.06-.27-.054l-.548 1.272h.214c.272-.003.49-.156.641-.4c.199-.323.182-.69-.037-.818m18.67-.129c.055-.006.086-.028.102-.068c.034-.078-.028-.17-.113-.166h-1.34l-1.165 2.704a.5.5 0 0 1-.458.3c-.04 0-.087-.013-.125-.022a.3.3 0 0 1-.221-.298c.006-.198.126-.482.189-.629l.725-1.673c.038-.087.077-.132.177-.148c.055-.006.086-.028.102-.068c.034-.078-.028-.17-.113-.166H17.81c-.079 0-.143.054-.143.12c0 .048.031.088.08.107c.026.008.068.051.049.094l-.526 1.218a2.35 2.35 0 0 0-.216.938c0 .324.186.604.456.742c.284.137.6.214.935.214a2.39 2.39 0 0 0 2.227-1.518l.662-1.532c.037-.087.079-.133.179-.149m1.196-.359c-.862.06-1.399.686-1.348 1.409c.018.257.112.492.255.685c0 0 .644.773.682.822a.5.5 0 0 1 .089.212c.016.24-.104.438-.41.46c-.357.024-.653-.129-.782-.359c-.02-.056-.016-.127-.083-.146c-.059-.02-.127.02-.152.091l-.144.414c.323.248.753.393 1.295.353c.863-.06 1.4-.685 1.348-1.408c-.017-.257-.191-.487-.335-.68c-.104-.128-.41-.494-.52-.627c-.08-.114-.159-.241-.172-.385c-.018-.25.153-.465.46-.487c.354-.025.6.123.731.35c.02.057.016.128.083.146c.06.021.127-.02.152-.09l.143-.407c-.323-.248-.75-.392-1.292-.353m-5.663.85c-.067-.018-.063-.088-.083-.145c-.131-.228-.378-.375-.732-.35c-.306.021-.477.237-.46.487c.014.143.092.27.172.385c.112.134.415.496.52.626c.144.194.318.423.336.68c.05.723-.486 1.348-1.348 1.409c-.543.039-.973-.105-1.296-.354l.06-.173H12.82c-.08 0-.142-.052-.142-.118c0-.048.03-.089.08-.107c.025-.009.065-.048.05-.092l-.23-.988h-1.049l-.607.983c-.022.045.024.086.048.094c.05.019.08.059.08.107c.001.066-.063.12-.142.12l-.622.001c-.085.005-.15-.088-.114-.166c.02-.046.06-.063.116-.07a.2.2 0 0 0 .154-.096l1.9-3.005h1.164c.079 0 .143.054.143.12c0 .048-.031.088-.08.107c-.021.01-.053.031-.052.075l.703 3.02l.08-.225c.025-.071.092-.112.151-.091c.043.015.07.055.072.105a.1.1 0 0 0 .012.04c.128.23.424.384.78.359c.307-.022.428-.22.41-.46a.46.46 0 0 0-.088-.211c-.038-.05-.681-.822-.681-.822a1.3 1.3 0 0 1-.256-.686c-.05-.723.486-1.348 1.349-1.408c.542-.04.968.104 1.291.352l-.143.407c-.024.07-.093.111-.151.09m-4.562.855l-.192-.83l-.513.83z"></svg:path>`,
})
export class SimpleIconsPegasusairlinesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPelicanIcon],svg[simple-icons-pelican-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPercyIcon],svg[simple-icons-percy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M13.235 2.4s.569 1.169.616 1.547c0 0-1.856-.646-4.458-.891c0 0 1.25.872 1.734 1.538c0 0-1.84-.093-4.586 0c0 0 1.561.634 2.252 1.215c0 0-3.26.331-5.103.862c0 0 2.076.73 2.652 1.276c0 0-2.648.754-5.316 2.294c0 0 1.482.26 2.642.766c0 0-1.478 1.033-3.668 3.852c0 0 1.62-.309 2.73-.222c0 0-1.407 1.644-2.141 4.158c0 0 .813-.518 1.602-.706c0 0 .084 2.998 1.724 3.478v-.002a.8.8 0 0 0 .225.034q.12 0 .248-.036c.52-.15.915-.663 1.37-1.256c.15-.195.303-.395.466-.59q.302-.427.706-.762c.58-.478 1.38-.84 2.358-.695c1.1.093 1.78 1.189 2.327 2.07c.283.458.659 1.27 1.289 1.27c.696 0 .94-.834 1.25-1.862c.292-.97.726-1.891 1.29-2.732c1.085-1.617 2.474-2.495 4.14-3.36c1.595-.83 3.102-1.614 3.858-2.803c.379-.594.567-1.325.558-2.169a7 7 0 0 0-.31-1.909c-.139-.455-.505-.902-.939-.72a3.4 3.4 0 0 1-1.151.256c-.858-.805-3.379-2.4-5.038-3.303c0 0 .202.592.482 1.699c0 0-1.787-1.396-3.81-2.296zm0 2.7l3.81.945l-1.233.255zM9.957 6.67l4.571.354l-1.388.46Zm6.955 1.082l-.678.514l-2.383.134zm-5.784.514l-1.088.73l-3.018-.287Zm4.505 1.206l-1.105.617l-3.002-.176zm-8.282.77l-.679 1.312l-2.982 1.313zm4.135.533l-.77 1.265l-3.853.942zm-5.845 2.354l-.118 1.313L3.6 16.2zm11.31 3.151c-1.093 1.127-2.002 2.806-2.232 4.121c.39.58.746.867 1.08.873h.012q.52-.002.68-.693c.077-.343.094-.813.114-1.36c.029-.844.067-1.894.346-2.94zm-7.904 2.512c-1.018.011-2.008.83-2.506 1.532v.001c.283.64.587.953.925.953l.082-.007c.46-.072.886-.963 1.242-1.825a20 20 0 0 0 .257-.654"></svg:path>`,
})
export class SimpleIconsPercyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPerlIcon],svg[simple-icons-perl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPersistentIcon],svg[simple-icons-persistent-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPersonioIcon],svg[simple-icons-personio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPetsathomeIcon],svg[simple-icons-petsathome-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.627 17.554c0-.7.399-1.209 1.19-1.209s1.138.574 1.138 1.203v.065c0 .068-.038.107-.107.107h-1.507c0 .282.227.57.72.57c.204 0 .356-.052.551-.12c.11-.039.198-.016.198.104c0 .23-.341.535-.928.535c-.797 0-1.255-.493-1.255-1.255M7.778 16.066v.321h.383c.068 0 .107.039.107.107v.337c0 .068-.039.107-.107.107h-.383v1.025c0 .249.094.36.237.36a.5.5 0 0 0 .175-.043c.101-.042.159.01.159.104c0 .237-.269.425-.597.425c-.505 0-.687-.318-.687-.756v-1.776q.002-.063.062-.091l.502-.211c.088-.039.149-.003.149.091m4.43 1.511c0-.756.46-1.232 1.189-1.232s1.19.476 1.19 1.232c0 .755-.46 1.232-1.19 1.232c-.729 0-1.189-.477-1.189-1.232m-7.925 0c0-.756.409-1.232 1.031-1.232a.65.65 0 0 1 .613.389v-.24c0-.068.039-.107.107-.107h.499c.068 0 .107.039.107.107v2.163c0 .068-.039.107-.107.107h-.499c-.068 0-.107-.039-.107-.107v-.237a.65.65 0 0 1-.613.389c-.622 0-1.031-.477-1.031-1.232m12.574 1.19h-.499c-.068 0-.107-.039-.107-.107v-1.453c0-.243-.072-.288-.201-.288a.52.52 0 0 0-.383.172v1.566c0 .068-.039.107-.107.107h-.499c-.068 0-.107-.039-.107-.107v-1.998q.001-.062.061-.091l.503-.21c.091-.039.149-.004.149.091v.343c.13-.318.36-.45.678-.45c.282 0 .489.132.587.428a.645.645 0 0 1 .638-.428c.38 0 .688.207.688.732v1.579c0 .068-.039.107-.107.107h-.5c-.068 0-.107-.039-.107-.107v-1.452c0-.243-.071-.289-.201-.289a.52.52 0 0 0-.382.172v1.566c.003.078-.036.117-.104.117m-6.922 0h-.532c-.068 0-.107-.039-.107-.107v-2.792c0-.068.039-.107.107-.107h.532c.068 0 .107.039.107.107v1.038h1.047v-1.038c0-.068.039-.107.107-.107h.532c.068 0 .107.039.107.107v2.792c0 .068-.039.107-.107.107h-.532c-.068 0-.107-.039-.107-.107v-1.184h-1.047v1.184c0 .068-.039.107-.107.107m3.459-.49c.302 0 .461-.236.461-.7s-.159-.7-.461-.7c-.301 0-.46.236-.46.7s.162.7.46.7m-7.921 0c.302 0 .461-.236.461-.7s-.159-.7-.461-.7c-.301 0-.46.236-.46.7s.159.7.46.7m14.805-.995c-.029-.289-.195-.448-.461-.448s-.428.159-.46.448zm1.734-6.598l-.661-.159c-.726-.172-.992-.363-.992-.714c0-.353.353-.586.895-.586c.619 0 1.076.214 1.835.726c.084.052.159.097.214.097c.107 0 .181-.042.201-.201a4 4 0 0 0 .032-.545c0-.321-.009-.535-.032-.651c-.033-.182-.097-.276-.214-.354c-.629-.395-1.333-.564-2.111-.564c-1.751 0-2.892.853-2.892 2.166c0 .982.713 1.718 1.952 2.026l.694.172c.885.214.992.415.992.727c0 .363-.308.609-.82.609c-.811 0-1.408-.298-2.069-.96c-.097-.097-.159-.158-.276-.158a.28.28 0 0 0-.256.149c-.405.671-.713.917-1.141.917c-.457 0-.778-.321-.778-.908V9.39h1.005c.133 0 .243-.11.243-.243V8.08a.245.245 0 0 0-.243-.243h-1.005V6.579c0-.276-.182-.383-.457-.266l-1.537.642a.29.29 0 0 0-.182.275v2.983c0 1.868-1.248 3.136-2.837 3.136c-.833 0-1.589-.321-1.868-1.132c.192.075.513.107.97.107c1.835 0 3.113-1.002 3.113-2.454c0-1.291-1.067-2.143-2.656-2.143c-.59 0-1.157.113-1.647.321C9.092 6.323 7.415 5.191 5.1 5.191c-1.057 0-2.017.13-2.902.396c-.246.074-.395.233-.395.479v4.212a2.96 2.96 0 0 1-1.281-.969C.447 9.212.392 9.15.276 9.15c-.172 0-.276.13-.276.298c0 .727.853 1.686 1.803 2.156v2.902c0 .133.11.244.243.244h1.903a.245.245 0 0 0 .243-.244v-2.198c.14.01.276.023.428.023c1.258 0 2.205-.198 2.896-.646c.139 1.904 1.563 3.233 3.735 3.233c1.119 0 2.442-.395 3.178-1.397c.353.852 1.183 1.397 2.198 1.397s1.621-.256 2.133-.843c.662.555 1.398.843 2.38.843c1.751 0 2.86-.875 2.86-2.25c-.003-.983-.538-1.631-1.988-1.984M10.93 9.105c.512 0 .788.308.788.736c0 .713-.639 1.193-1.589 1.193c-.331 0-.522-.023-.652-.075c.004-1.105.568-1.854 1.453-1.854m-6.734 1.514V7.325c0-.202.084-.321.275-.351c.289-.052.48-.052.639-.052c1.29 0 2.059.681 2.059 1.813c.003 1.193-.914 1.855-2.973 1.884"></svg:path>`,
})
export class SimpleIconsPetsathomeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPeugeotIcon],svg[simple-icons-peugeot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPfsenseIcon],svg[simple-icons-pfsense-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhilipshueIcon],svg[simple-icons-philipshue-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhoenixframeworkIcon],svg[simple-icons-phoenixframework-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m9.012 15.241l-.188-.036c-1.34-.248-2.186-1.06-2.588-2.334c-.25-.794.204-1.38 1.038-1.416c.682-.032 1.15.36 1.562.816c.532.588 1.02 1.216 1.542 1.814c.754.86 1.64 1.412 2.854 1.24a5.4 5.4 0 0 0 2.86-1.308c.124-.108.26-.2.392-.302l-.084-.098a6 6 0 0 1-2.12.252c-1.092-.054-2.132-.282-3.064-.882c-.848-.548-1.476-1.28-1.774-2.26c-.24-.79.252-1.344 1.072-1.23c.313.049.606.187.842.398c.2.168.39.346.594.51c.958.77 2.294.812 3.508-.022c-1.996-.01-3.354-1.108-4.548-2.5c-.466-.544-.922-1.1-1.4-1.636c-.92-1.038-1.944-1.952-3.346-2.264c-1.79-.398-3.518-.136-5.176.622A4.2 4.2 0 0 0 0 5.217h.352c.836-.022 1.464.35 1.916 1.034c.328.498.482 1.06.6 1.64c.176.86.086 1.734.188 2.598c.26 2.22 1.394 3.768 3.506 4.56c.774.292 1.568.39 2.45.19zM3.674 5.113c-.334.084-.6-.05-.874-.328c.47-.118.886-.164 1.332-.18a.56.56 0 0 1-.458.508m10.938 12.96c-.03-.212-.212-.306-.356-.42c-.634-.492-1.378-.668-2.164-.682a4.1 4.1 0 0 1-1.378-.208c-.204-.076-.43-.174-.426-.436c.006-.266.238-.34.448-.404c.174-.052.352-.084.548-.13c-.5-.32-.988-.364-1.636-.102c-1.024.41-2.032.36-3.052-.006c-.574-.208-1.086-.534-1.618-.824l-.026.02c.44.722 1.038 1.304 1.71 1.8c1.296.96 2.712 1.53 4.37 1.276a23 23 0 0 1 1.614-.19c.676-.054 1.32.136 1.966.308zm-3.124-10.37c-.036-.026-.07-.09-.144-.024a5.26 5.26 0 0 0 2.284 1.776c1.488.604 3 .708 4.544.174c1.2-.414 2.06-.01 2.508 1.156c.066-1.352-.73-2.338-1.996-2.53c-.712-.11-1.37.128-2.038.32c-1.856.54-3.584.274-5.16-.872zm9.256 5.272l.726.064c-.546-.48-1.212-.52-1.888-.48c-1.026.058-1.766.65-2.44 1.356c-.594.624-1.13 1.324-2.016 1.574l.02.04c.12.002.24.008.36.002c1.288-.058 2.5-.33 3.464-1.264c.306-.294.576-.62.87-.926c.226-.258.562-.394.904-.366m-2.992-1.596c-.96.084-1.794.48-2.58 1.006c-.602.404-1.248.594-1.972.468q-.194-.032-.384-.058l-.006.054c.046.024.092.05.14.07c.12.048.24.106.364.136c1.396.33 2.732.16 3.936-.618c.76-.49 1.546-.582 2.398-.456q.129.022.258.036c.08.008.164.088.272 0a3.45 3.45 0 0 0-2.426-.638m-3.434-3.26a2.7 2.7 0 0 0 1.534-.364c-.154.014-.22.014-.282.026a2.3 2.3 0 0 1-1.96-.472l-.646-.5c-.856-.652-1.836-.872-2.91-.852c.018.052.02.088.038.106c1.168 1.18 2.52 1.996 4.226 2.054zm8.452 6.06c-.724-.72-1.694-.81-2.59-.186c.594.028 1.04.216 1.4.592q.191.201.404.378c.548.44 1.474.46 2.016.052c-.636-.248-.636-.248-1.23-.838zm-7.198 5.486c-.634-1.18-1.7-1.448-2.936-1.368c.364.1.708.26 1.02.474c.286.2.526.448.764.702c.472.504 1.208.812 1.696.708c-.224-.14-.546-.514-.546-.514h-.012l.008.006l.004.018c.004-.02.006-.016.008-.01h.02l-.028-.012v.01l.01.004s.114.208-.008-.018"></svg:path>`,
})
export class SimpleIconsPhoenixframeworkIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhotobucketIcon],svg[simple-icons-photobucket-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhotocrowdIcon],svg[simple-icons-photocrowd-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.182 0C.977 0 0 1.058 0 2.364v19.462C0 23.026.977 24 2.182 24h19.636A2.18 2.18 0 0 0 24 21.826V2.364C24 1.058 23.023 0 21.818 0zM12 3.49a1.022 1.022 0 1 1 0 2.045a1.022 1.022 0 0 1 0-2.044zM8.326 4.498a1.022 1.022 0 1 1-.142 2.039a1.022 1.022 0 0 1 .142-2.04zm7.347 0a1.02 1.02 0 0 1 .955 1.529a1.021 1.021 0 1 1-.955-1.53zm-10.23 2.74a1.02 1.02 0 1 1 .145 2.037a1.02 1.02 0 0 1-.145-2.036zm13.113 0a1.02 1.02 0 1 1-.142 2.036a1.02 1.02 0 0 1 .142-2.035zm-7.497.116a1.021 1.021 0 1 1 .119 2.039a1.021 1.021 0 0 1-.12-2.04zm3.687.88a1.021 1.021 0 1 1 .001 2.042a1.021 1.021 0 0 1 0-2.043zm-6.308 1.864a1.02 1.02 0 1 1-.119 2.04a1.02 1.02 0 0 1 .12-2.04zm3.561.88a1.023 1.023 0 1 1-.001 2.047a1.023 1.023 0 0 1 .001-2.047m-7.488.002a1.022 1.022 0 1 1-.001 2.044a1.022 1.022 0 0 1 0-2.044zm14.977 0a1.02 1.02 0 1 1-.001 2.042a1.02 1.02 0 0 1 0-2.042zm-3.793.881a1.02 1.02 0 1 1-.119 2.038a1.02 1.02 0 0 1 .12-2.038zm-6.442 1.866a1.021 1.021 0 1 1-.001 2.042a1.021 1.021 0 0 1 0-2.042zm3.568.883a1.02 1.02 0 1 1 .12 2.038a1.02 1.02 0 0 1-.12-2.038m-7.235.116a1.02 1.02 0 0 1 .44 1.904a1.022 1.022 0 1 1-.44-1.904m12.827 0a1.022 1.022 0 1 1 .142 2.038a1.022 1.022 0 0 1-.142-2.038m-10.229 2.74a1.021 1.021 0 1 1 .142 2.038a1.021 1.021 0 0 1-.142-2.038m7.63 0a1.02 1.02 0 0 1 .44 1.904a1.022 1.022 0 1 1-.44-1.904M12 18.463a1.022 1.022 0 1 1 0 2.045a1.022 1.022 0 0 1 0-2.045"></svg:path>`,
})
export class SimpleIconsPhotocrowdIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhotonIcon],svg[simple-icons-photon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m7.454 16.915l-3.379 4.091a14 14 0 0 1-1.089-1.079l4.091-3.38c.123.116.252.246.377.368m1.045.809l-2.517 4.679a11 11 0 0 1-1.281-.856l3.364-4.138c.357.262.434.262.434.315m-1.913-1.772l-4.119 3.345a12 12 0 0 1-.856-1.277l4.682-2.518c.008.053.235.371.293.45M9.682 18.3l-1.558 5.063a12 12 0 0 1-1.419-.588l2.492-4.693c.416.192.478.177.485.217zM5.72 14.319q.089.245.198.481l-4.691 2.496a11.5 11.5 0 0 1-.589-1.423zm5.23 4.292l-.532 5.287a12 12 0 0 1-1.51-.315l1.532-5.073q.25.06.51.101m-5.56-5.56q.04.255.1.509L.402 15.09a12 12 0 0 1-.299-1.508zm-.079-1.306v.522l-5.286.513a12 12 0 0 1 0-1.539zm6.948 6.942l.51 5.29q-.77.045-1.539 0l.51-5.29q.26.01.519 0m2.832 4.912q-.745.205-1.51.315l-.532-5.287c.17-.026.343-.06.51-.1zm-9.6-13.16q-.062.254-.101.513l-5.286-.535q.1-.762.299-1.505l5.088 1.53zm9.311 7.644l2.492 4.692q-.694.338-1.423.588l-1.551-5.082q.24-.088.482-.198M5.928 9.177a5 5 0 0 0-.201.481L.651 8.085q.252-.731.595-1.423L5.928 9.18zm10.003 8.232l3.364 4.126q-.614.467-1.281.856L15.5 17.724q.22-.135.431-.29zM6.586 8.063a5 5 0 0 0-.29.431L1.617 5.976q.389-.665.856-1.277zm14.427 11.864a12 12 0 0 1-1.089 1.089l-3.379-4.101c.129-.116.245-.245.368-.368zM4.075 2.987l3.379 4.091c-.129.115-.245.245-.368.368l-4.091-3.38c.688-.778 1.163-1.135 1.08-1.079m18.313 15.029a12 12 0 0 1-.856 1.281l-4.116-3.364a6 6 0 0 0 .29-.431l4.682 2.518zM5.985 1.612l2.517 4.679a7 7 0 0 0-.434.29L4.704 2.468q.612-.472 1.281-.856M23.36 15.873q-.245.732-.588 1.423L18.08 14.8q.108-.236.199-.481zM8.137.633l1.548 5.085a6 6 0 0 0-.481.198L6.715 1.221A12 12 0 0 1 8.137.633m15.758 12.949a12 12 0 0 1-.315 1.508l-5.072-1.53q.063-.255.101-.509zM10.418.101l.532 5.287a8 8 0 0 0-.51.1L8.908.416a12 12 0 0 1 1.51-.315m13.556 11.131q.051.767 0 1.535l-5.286-.506v-.523zM12.769.022l-.51 5.29h-.519l-.51-5.29a13 13 0 0 1 1.539 0m10.827 8.89q.207.744.315 1.508l-5.286.535a6 6 0 0 0-.101-.513zM15.1.416l-1.541 5.073a9 9 0 0 0-.51-.101l.532-5.287c.709.094 1.498.273 1.519.315m2.203.824l-2.502 4.68a5 5 0 0 0-.481-.202L15.871.636c.745.255 1.413.572 1.432.604m5.466 5.47q.34.691.588 1.422l-5.078 1.573c-.06-.16-.129-.314-.202-.481zm-6.854-.133a8 8 0 0 0-.434-.289l2.517-4.683q.67.386 1.281.856zm6.46-.613L17.7 8.481a7 7 0 0 0-.29-.434l4.11-3.367c0 .03.378.464.855 1.284m-1.362-1.892l-4.091 3.383c-.113-.133-.245-.247-.368-.371l3.38-4.091c-.065-.044.476.387 1.079 1.079"></svg:path>`,
})
export class SimpleIconsPhotonIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhpIcon],svg[simple-icons-php-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.01 10.207h-.944l-.515 2.648h.838q.834 0 1.242-.314q.408-.315.55-1.049q.137-.705-.124-.995q-.262-.29-1.047-.29M12 5.688C5.373 5.688 0 8.514 0 12s5.373 6.313 12 6.313S24 15.486 24 12s-5.373-6.312-12-6.312m-3.26 7.451c-.261.25-.575.438-.917.551q-.505.163-1.285.164H5.357l-.327 1.681H3.652l1.23-6.326h2.65q1.195 0 1.744.628q.549.627.33 1.752a2.8 2.8 0 0 1-.305.847q-.215.383-.561.703m4.024.715l.543-2.799q.094-.478-.068-.651q-.16-.174-.687-.174H11.46l-.704 3.625H9.388l1.23-6.327h1.367l-.327 1.682h1.218q1.15 0 1.586.401c.436.401.378.7.263 1.299l-.572 2.944zm7.597-2.265a2.8 2.8 0 0 1-.305.847q-.214.383-.561.703a2.44 2.44 0 0 1-.917.551q-.504.163-1.286.164h-1.18l-.327 1.682h-1.378l1.23-6.326h2.649q1.195 0 1.744.628q.55.626.331 1.751m-2.595-1.382h-.943l-.516 2.648h.838q.835 0 1.242-.314q.407-.315.551-1.049q.137-.705-.125-.995c-.262-.29-.524-.29-1.047-.29"></svg:path>`,
})
export class SimpleIconsPhpIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPhpbbIcon],svg[simple-icons-phpbb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPiaggiogroupIcon],svg[simple-icons-piaggiogroup-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPicardsurgelesIcon],svg[simple-icons-picardsurgeles-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPicnicIcon],svg[simple-icons-picnic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPicrewIcon],svg[simple-icons-picrew-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.222 10.831a.037.037 0 0 1 .038-.04a.6.6 0 0 1 .44.216a1.04 1.04 0 0 1 .21.62a.035.035 0 0 1-.04.037c-.474-.062-.593-.22-.648-.833m-.147 0a.037.037 0 0 0-.04-.04a.6.6 0 0 0-.44.216a1.04 1.04 0 0 0-.207.62a.035.035 0 0 0 .041.037c.47-.062.59-.22.646-.833m-.648 1.002a.036.036 0 0 0-.039.035a1.04 1.04 0 0 0 .21.625a.6.6 0 0 0 .438.22a.037.037 0 0 0 .039-.04c-.056-.613-.175-.772-.648-.84m.795.844a.037.037 0 0 0 .038.04a.6.6 0 0 0 .44-.216a1.04 1.04 0 0 0 .21-.633a.036.036 0 0 0-.04-.039c-.474.072-.593.23-.648.843zm2.616-1.846a.037.037 0 0 0-.038-.04a.6.6 0 0 0-.44.216a1.04 1.04 0 0 0-.21.62a.035.035 0 0 0 .04.037c.473-.062.593-.22.648-.833m.795.844a.035.035 0 0 0 .04-.037a1.04 1.04 0 0 0-.209-.625a.6.6 0 0 0-.44-.216a.037.037 0 0 0-.039.04c.056.607.175.765.648.832zm-.648 1.003a.037.037 0 0 0 .039.04a.6.6 0 0 0 .44-.216a1.04 1.04 0 0 0 .21-.634a.036.036 0 0 0-.041-.039c-.473.072-.592.23-.648.843zm-.794-.844a.036.036 0 0 0-.041.039a1.04 1.04 0 0 0 .21.624a.6.6 0 0 0 .44.215a.037.037 0 0 0 .038-.04c-.055-.612-.175-.771-.647-.839Zm17.22-.964a.29.29 0 0 0-.288.289v.88a.29.29 0 1 0 .577 0v-.88a.29.29 0 0 0-.288-.294zm-2.15-.395a.29.29 0 0 0-.288.289v1.27a.29.29 0 1 0 .577 0V10.76a.29.29 0 0 0-.29-.288Zm4.3 0a.29.29 0 0 0-.287.289v1.27a.29.29 0 1 0 .577 0V10.76a.29.29 0 0 0-.29-.288Zm-5.15 1.568a.29.29 0 0 1-.29.29h-2.745v.105a.29.29 0 0 1-.578 0a2.4 2.4 0 0 1 .05-.454c.262-1.447 2.012-1.974 3.061-1.03a1.5 1.5 0 0 1 .502 1.08zm-2.885-.296h2.25a1 1 0 0 0-.26-.376a1.3 1.3 0 0 0-.891-.322a1.22 1.22 0 0 0-1.099.698m-5.262-1.276a2.05 2.05 0 0 0-1.801 1.035a1.35 1.35 0 0 0-.783-.24a1.36 1.36 0 0 0-.664.17a4.3 4.3 0 0 0-.794-1.912a.7.7 0 0 1-.097-.15c.013-.96-1.153-1.406-1.832-.724l-.052.056A1 1 0 0 1 4.11 8.7a5 5 0 0 0-.58-.029a7 7 0 0 0-.708.04c-.646-.763-1.9-.339-1.886.657a.7.7 0 0 1-.098.15a4.4 4.4 0 0 0-.836 2.249a.29.29 0 0 0 .576.05A3.8 3.8 0 0 1 1.3 9.87a.8.8 0 0 0 .209-.502a.43.43 0 0 1 .269-.431a.51.51 0 0 1 .6.136c.151.185.31.241.63.193a5 5 0 0 1 .522-.026a5 5 0 0 1 .522.026c.338.05.492-.018.643-.208a.51.51 0 0 1 .583-.12a.43.43 0 0 1 .27.431a.8.8 0 0 0 .215.502a3.8 3.8 0 0 1 .724 1.947c.02.198 0 .37.174.47a.29.29 0 0 0 .4-.12a.754.754 0 0 1 1.251.01a.29.29 0 0 0 .528-.068a1.45 1.45 0 0 1 1.424-1.06a1.48 1.48 0 0 1 1.253.656a.29.29 0 1 0 .482-.32a2.05 2.05 0 0 0-1.735-.914m13.721 2.927a1.405 1.405 0 0 1-1.273.989a1.64 1.64 0 0 1-1.3-.546c-.632.723-1.86.749-2.39-.068c-.522.372-1.326.614-2.113.614c-1.06-.035-1.58-.388-2.298-.956c-.764-.712-1.852-.145-2.355.738v1.206a.29.29 0 0 1-.577 0v-1.532a2.1 2.1 0 0 1-1.415.544a2.05 2.05 0 0 1-1.801-1.035a1.37 1.37 0 0 1-1.55.01c-.587 1.096-1.817 1.724-3.377 1.724c-1.229 0-2.25-.386-2.916-1.085v1.372a.29.29 0 0 1-.578 0v-2.3a.3.3 0 0 1 .12-.24a.29.29 0 0 1 .416.096c.458 1.025 1.528 1.577 2.953 1.583s2.704-.63 2.997-1.78a.3.3 0 0 1 .148-.166a.29.29 0 0 1 .376.12c.248.45 1.01.45 1.258 0a.29.29 0 0 1 .492-.02a.3.3 0 0 1 .04.09a1.487 1.487 0 0 0 2.846 0a.29.29 0 0 1 .562.007c.014.035.006.43.007.475c.44-.421 1.002-.7 1.5-.7c.92-.031 1.235.565 1.878.923a2.55 2.55 0 0 0 1.276.353c.857 0 1.652-.311 2.058-.749a.292.292 0 0 1 .42.162c.242.785 1.383.79 1.755-.017a.288.288 0 0 1 .523-.031a1.04 1.04 0 0 0 1.01.635a.83.83 0 0 0 .76-.587a.289.289 0 0 1 .55.176zM7.68 13.81a.29.29 0 0 0-.288.29v1.274a.29.29 0 1 0 .577 0V14.1a.29.29 0 0 0-.289-.29"></svg:path>`,
})
export class SimpleIconsPicrewIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPicxyIcon],svg[simple-icons-picxy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPiholeIcon],svg[simple-icons-pihole-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPimcoreIcon],svg[simple-icons-pimcore-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 10.579a.474.474 0 0 1-.474.474H22.19a.084.084 0 0 0-.084.084v.547H24v.158a.474.474 0 0 1-.474.474h-1.421v.547c0 .046.038.084.084.084H24v.158a.474.474 0 0 1-.474.474h-1.579a.474.474 0 0 1-.474-.474v-2.211c0-.261.212-.474.474-.474H24zm-5.589.474a.095.095 0 0 0-.095.095V12h1.421c.27 0 .487-.227.473-.5a.48.48 0 0 0-.481-.448h-1.318m2.431.46c.005.44-.246.821-.614 1.004l.614 1.063h-.547a.31.31 0 0 1-.273-.158l-.456-.789h-1.25v.474a.474.474 0 0 1-.474.474h-.158v-2.684c0-.262.212-.474.474-.474h1.549c.61-.001 1.128.48 1.135 1.09m-5.368 1.435a.95.95 0 0 0 .947-.947a.948.948 0 0 0-1.736-.523l-.348.523l.345.52c.17.257.461.427.792.427m0-2.526a1.58 1.58 0 1 1-1.316 2.451l-.2-.3l-.43.648A2.21 2.21 0 0 1 9.473 12a2.211 2.211 0 0 1 4.05-1.228l.056.084l-.379.573l-.207-.313a1.578 1.578 0 1 0 .008 1.756l1.156-1.742a1.58 1.58 0 0 1 1.317-.709m-7.393.13l-1.067 1.067a.095.095 0 0 1-.134 0l-1.065-1.065a.447.447 0 0 0-.763.316v2.711h.158a.474.474 0 0 0 .474-.474v-1.69c0-.037.045-.056.072-.03l.856.856a.474.474 0 0 0 .67 0l.856-.856a.042.042 0 0 1 .072.03v2.163h.158a.474.474 0 0 0 .474-.474v-2.242a.44.44 0 0 0-.442-.442h-.007a.44.44 0 0 0-.312.13m-4.134 3.028a.474.474 0 0 0 .474-.474v-2.684h-.158a.474.474 0 0 0-.474.474v2.684zM2.039 12a.48.48 0 0 0 .487-.45a.475.475 0 0 0-.473-.498H.726a.096.096 0 0 0-.095.095V12zm-.015-1.579c.619 0 1.146.507 1.134 1.126a1.105 1.105 0 0 1-1.105 1.084H.632v.474a.474.474 0 0 1-.474.474H0v-2.684c0-.262.212-.474.474-.474z"></svg:path>`,
})
export class SimpleIconsPimcoreIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPinterestIcon],svg[simple-icons-pinterest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPipedIcon],svg[simple-icons-piped-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPipxIcon],svg[simple-icons-pipx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPixlrIcon],svg[simple-icons-pixlr-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlatformioIcon],svg[simple-icons-platformio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlayerfmIcon],svg[simple-icons-playerfm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlaystation3Icon],svg[simple-icons-playstation3-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlaystation4Icon],svg[simple-icons-playstation4-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlaywrightIcon],svg[simple-icons-playwright-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPleskIcon],svg[simple-icons-plesk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M6.102 7.021v7.353h.736V7.02zm13.655.01v7.343h.735V7.032zm.735 4.633l2.479 2.71h1.019l-2.574-2.731L24 9.122h-.987zm-4.008-2.636q-.803 0-1.31.378q-.505.378-.505 1.07q0 .39.148.642q.15.252.38.415q.231.163.522.267q.29.106.59.19q.263.074.5.152t.418.194a.9.9 0 0 1 .286.278q.105.163.104.405q0 .315-.286.535q-.285.22-.88.221q-.913 0-1.485-.735l-.572.504q.429.472.913.678q.484.204 1.11.204q.408 0 .766-.1a1.9 1.9 0 0 0 .621-.294q.264-.194.419-.478q.153-.283.153-.64q0-.389-.153-.646a1.5 1.5 0 0 0-.402-.436a2.3 2.3 0 0 0-.545-.289a13 13 0 0 0-.594-.205q-.242-.074-.467-.152a2 2 0 0 1-.397-.184a.9.9 0 0 1-.275-.252a.6.6 0 0 1-.104-.357q0-.304.225-.504t.787-.2q.44 0 .759.163t.594.51l.011.01l.54-.494q-.408-.472-.853-.661a2.6 2.6 0 0 0-1.018-.19zm-14.688.041q-.882 0-1.796.284v7.626h.725v-2.72q.273.072.546.115a3.54 3.54 0 0 0 1.586-.11q.504-.153.898-.478q.394-.326.636-.83q.24-.504.241-1.208q0-.577-.2-1.071a2.4 2.4 0 0 0-.572-.851a2.6 2.6 0 0 0-.898-.557a3.3 3.3 0 0 0-1.166-.2m8.886 0q-.483 0-.914.163q-.431.164-.756.5a2.4 2.4 0 0 0-.515.845q-.189.51-.189 1.202q0 .525.157.998q.159.473.473.84q.315.369.788.583q.473.216 1.103.216q.683 0 1.166-.205t.85-.604l-.44-.462a1.86 1.86 0 0 1-.683.488a2.2 2.2 0 0 1-.84.153q-.831 0-1.314-.526q-.483-.525-.514-1.417h3.939q.02-1.356-.568-2.064q-.588-.71-1.743-.71m.031.62q.39 0 .683.121q.294.12.478.32q.183.2.284.484t.1.609H9.074a2.13 2.13 0 0 1 .494-1.103q.167-.19.456-.31t.688-.12zM1.86 9.7q.924 0 1.434.563q.51.561.51 1.475q0 .989-.552 1.518q-.552.53-1.486.53q-.252 0-.52-.057a5 5 0 0 1-.52-.142V9.868a3 3 0 0 1 .557-.132A5 5 0 0 1 1.86 9.7m2.377 6.588v.692H8.66v-.692z"></svg:path>`,
})
export class SimpleIconsPleskIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlexIcon],svg[simple-icons-plex-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlotlyIcon],svg[simple-icons-plotly-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M2.021 0C.967 0 .111.883.111 1.973v20.054c0 1.09.857 1.973 1.91 1.973H21.98c1.054 0 1.91-.884 1.91-1.973V1.973C23.89.883 23.034 0 21.98 0H2.02zM10.1 4.648a.7.7 0 0 1 .304.127a1.2 1.2 0 0 1 .356.373a.21.21 0 0 1 .084.163c.165.388.135.857-.149 1.203c-.19.232-.429.305-.648.263a.24.24 0 0 1-.096.04c-.41.13-.884-.218-.994-.663c-.065-.26-.087-.674.076-.908a.4.4 0 0 1 .082-.086a1 1 0 0 1 .05-.264c.077-.214.256-.214.425-.148a1 1 0 0 1 .09-.006a2 2 0 0 1 .158.008a.28.28 0 0 1 .262-.102m8.43 0c.098.012.204.06.304.127a1.2 1.2 0 0 1 .355.373a.21.21 0 0 1 .084.163c.166.388.136.857-.148 1.203c-.19.232-.43.305-.648.263a.24.24 0 0 1-.096.04c-.41.13-.885-.218-.994-.663c-.065-.26-.087-.674.076-.908a.4.4 0 0 1 .082-.086a1 1 0 0 1 .049-.264c.077-.214.256-.214.424-.148a1 1 0 0 1 .091-.006a2 2 0 0 1 .159.008a.28.28 0 0 1 .261-.102zm-13.159.16c.224-.013.461.063.649.198a1 1 0 0 1 .23.223l.059.039c.341.244.312.679.074.992l-.004.008a.91.91 0 0 1-.897.558c-.302-.008-.611-.084-.82-.271c-.2-.143-.34-.356-.332-.627a.13.13 0 0 1 .092-.127a1.04 1.04 0 0 1 .342-.6a.7.7 0 0 1 .607-.393m8.682.003c.224-.014.461.06.648.195a1 1 0 0 1 .229.224l.058.04c.342.244.315.679.076.992l-.005.006a.91.91 0 0 1-.895.558c-.302-.008-.614-.084-.822-.271a.73.73 0 0 1-.33-.627a.13.13 0 0 1 .092-.125a1.04 1.04 0 0 1 .34-.6a.7.7 0 0 1 .61-.393zm-8.282.496l.034.04l.011.005a.13.13 0 0 1 .088.076a.6.6 0 0 1 .225.125a.7.7 0 0 0-.078-.135a1.2 1.2 0 0 0-.28-.111m8.68 0l.033.04l.012.005c.039.007.07.038.088.076a.6.6 0 0 1 .225.125a.7.7 0 0 0-.079-.135a1.2 1.2 0 0 0-.279-.111m-4.553.119a2 2 0 0 0-.005.295c.075-.042.081-.17.064-.262a.3.3 0 0 0-.059-.033m8.428 0a2 2 0 0 0-.004.295c.076-.042.08-.17.063-.262l-.02-.014l-.039-.02zM5.55 5.65l-.086.028l.01.04c.057-.032.133-.028.175.028l-.003-.057a.3.3 0 0 1-.075-.023Q5.56 5.66 5.55 5.65m8.68 0l-.086.028l.011.04c.057-.032.134-.028.176.028l-.004-.057a.3.3 0 0 1-.074-.023zm-9.032.088l.01.053l.023.078q-.04-.044-.033-.13zm8.68.002a1 1 0 0 0 .033.13q-.04-.043-.033-.13m-3.18.02l-.011.017a.38.38 0 0 1-.13.237l-.001.006a.12.12 0 0 1-.04.119l-.029.064a2 2 0 0 1-.148.285a.6.6 0 0 0 .217-.205c.1-.156.147-.34.142-.523m8.43 0l-.012.017a.38.38 0 0 1-.129.237l-.002.006c.013.043-.005.088-.039.119l-.029.064a2 2 0 0 1-.148.285a.57.57 0 0 0 .216-.205c.1-.156.148-.34.143-.523m-9.961.039a1 1 0 0 0 .004.133c.017.185.078.383.219.513a1 1 0 0 0 .086.067a1 1 0 0 1-.143-.278a2.6 2.6 0 0 1-.166-.435m8.43 0a1 1 0 0 0 .004.133c.017.185.078.383.218.513a1 1 0 0 0 .086.067a1 1 0 0 1-.142-.278a2.5 2.5 0 0 1-.166-.435m-11.67.146a.4.4 0 0 1-.028.065l.036.068a.24.24 0 0 0-.008-.133m8.681 0l-.029.065l.035.068a.24.24 0 0 0-.006-.133m-9.09.41a.6.6 0 0 1-.18.038l-.013.015a.5.5 0 0 0 .229-.013zm8.68 0a.6.6 0 0 1-.18.038l-.013.015a.5.5 0 0 0 .228-.013zm-4.308 2.3a1.06 1.06 0 0 1 1.052 1.072v8.58c0 .592-.47 1.072-1.052 1.072s-1.055-.48-1.055-1.072v-8.58c0-.592.472-1.072 1.055-1.073zm8.431 0a1.06 1.06 0 0 1 1.053 1.072v8.58c0 .592-.47 1.072-1.053 1.072c-.582 0-1.054-.48-1.054-1.072v-8.58c0-.592.472-1.072 1.054-1.073zm-12.95.105c.224-.013.461.06.649.195a1 1 0 0 1 .23.225l.059.039c.341.244.312.679.074.992l-.004.006a.91.91 0 0 1-.897.558c-.302-.007-.611-.083-.82-.271c-.2-.142-.34-.354-.332-.625a.13.13 0 0 1 .092-.127a1.04 1.04 0 0 1 .342-.6a.7.7 0 0 1 .607-.393zm8.682 0c.224-.013.461.06.648.195a1 1 0 0 1 .229.225l.058.039c.342.244.315.679.076.992l-.005.006a.91.91 0 0 1-.895.558c-.302-.007-.614-.083-.822-.271a.73.73 0 0 1-.33-.625a.13.13 0 0 1 .092-.127a1.04 1.04 0 0 1 .34-.6a.7.7 0 0 1 .61-.393zm-8.282.496l.034.043l.011.002a.13.13 0 0 1 .088.076a.6.6 0 0 1 .225.125a.7.7 0 0 0-.078-.133a1.2 1.2 0 0 0-.28-.113m8.68 0l.033.043l.012.002c.039.007.07.038.088.076a.6.6 0 0 1 .225.125a.7.7 0 0 0-.079-.133a1.2 1.2 0 0 0-.279-.113M5.55 9.6l-.086.027l.01.041c.057-.032.133-.029.175.027l-.003-.054a.3.3 0 0 1-.075-.026zm8.68 0l-.086.027l.011.041c.057-.032.134-.029.176.027l-.004-.054a.3.3 0 0 1-.074-.026zm-9.032.09a.6.6 0 0 0 .032.123a.16.16 0 0 1-.032-.124zm8.68 0a.6.6 0 0 0 .031.123a.17.17 0 0 1-.031-.124zm-7.951.206a.4.4 0 0 1-.028.063l.036.07a.24.24 0 0 0-.008-.133m8.681 0a.4.4 0 0 1-.029.063l.035.07a.24.24 0 0 0-.006-.133m-9.09.409a.6.6 0 0 1-.18.037v.002l-.013.015a.55.55 0 0 0 .229-.015zm8.68 0a.6.6 0 0 1-.18.037v.002l-.013.015a.55.55 0 0 0 .228-.015zm-8.525 2.64c.582 0 1.053.48 1.053 1.073v4.289c0 .592-.47 1.072-1.053 1.072c-.582 0-1.055-.48-1.055-1.072v-4.29c0-.592.473-1.072 1.055-1.072m8.432 0c.581 0 1.054.48 1.054 1.073v4.289c0 .592-.473 1.072-1.054 1.072c-.583 0-1.053-.48-1.053-1.072v-4.29c0-.592.47-1.072 1.053-1.072"></svg:path>`,
})
export class SimpleIconsPlotlyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlumeIcon],svg[simple-icons-plume-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.528 9.532c0-.368.095-.735.284-1.063v-.001l2.94-5.093a3.78 3.78 0 0 1 3.27-1.887l6.644.002c.294 0 .526.262.476.565c-.038.238-.261.402-.502.402l-6.618-.002a2.81 2.81 0 0 0-2.433 1.404L5.65 8.95h.001a1.17 1.17 0 0 0-.002 1.16l-.001-.002l2.75 4.764a.087.087 0 0 1-.074.13h-.767a.35.35 0 0 1-.301-.173L4.81 10.592v-.001a2.1 2.1 0 0 1-.282-1.059m.819 6.926v.001a2.13 2.13 0 0 0 1.837 1.064h4.894c.124 0 .24-.065.301-.173l.384-.664a.087.087 0 0 0-.076-.13H7.186h.001a1.16 1.16 0 0 1-1.003-.583v.002l-2.94-5.092a2.81 2.81 0 0 1 0-2.81l3.312-5.73c.12-.208.089-.483-.098-.636a.483.483 0 0 0-.727.13L2.407 7.59a3.78 3.78 0 0 0 0 3.776Zm14.126-1.99c0 .368-.096.735-.284 1.063v.001l-2.941 5.093a3.78 3.78 0 0 1-3.27 1.887l-6.643-.002a.484.484 0 0 1-.477-.565c.038-.238.262-.402.502-.402l6.618.002a2.81 2.81 0 0 0 2.433-1.404l2.94-5.092a1.17 1.17 0 0 0 .001-1.16l-2.75-4.763a.087.087 0 0 1 .076-.13h.766c.124 0 .24.066.302.174l2.444 4.237l.001.002c.188.328.282.694.282 1.059m-6.937 5.525H6.655a3.78 3.78 0 0 1-3.27-1.888L.065 12.35a.483.483 0 0 1 .222-.683c.23-.104.503.005.63.224l3.306 5.73a2.81 2.81 0 0 0 2.432 1.405h5.88h-.002a1.17 1.17 0 0 0 1.006-.578v.001l2.75-4.764a.087.087 0 0 1 .151 0l.383.663a.35.35 0 0 1 0 .349l-2.447 4.236v.001a2.13 2.13 0 0 1-1.84 1.06zm11.399-8.341l-3.32-5.755a3.78 3.78 0 0 0-3.27-1.888h-5.88a2.13 2.13 0 0 0-1.84 1.059l-.001.002l-2.447 4.236a.35.35 0 0 0 0 .348l.383.663a.087.087 0 0 0 .15 0l2.751-4.764v.001a1.16 1.16 0 0 1 1.005-.578h5.88c1.003 0 1.93.535 2.431 1.405l3.306 5.73c.127.22.4.328.63.224a.483.483 0 0 0 .222-.683M18.653 7.54l2.94 5.093a3.78 3.78 0 0 1 0 3.775l-3.324 5.753a.484.484 0 0 1-.727.13c-.187-.152-.218-.427-.097-.636l3.31-5.73a2.81 2.81 0 0 0 .001-2.809l-2.94-5.09a1.17 1.17 0 0 0-1.003-.583h-5.5a.087.087 0 0 1-.076-.13l.384-.664a.35.35 0 0 1 .301-.174l4.892.001h.002a2.13 2.13 0 0 1 1.837 1.064"></svg:path>`,
})
export class SimpleIconsPlumeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlurkIcon],svg[simple-icons-plurk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPm2Icon],svg[simple-icons-pm2-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPocketbaseIcon],svg[simple-icons-pocketbase-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPodcastindexIcon],svg[simple-icons-podcastindex-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.006.006c-.237.02-.467.103-.647.236C1.727 2.254.173 4.976.292 8.29c.12 3.195 1.675 6.27 4.067 8.046c.24.118.48.236.72.236c.358 0 .716-.118.956-.473c.478-.591.359-1.301-.24-1.656c-1.913-1.302-3.11-3.786-3.11-6.153c0-2.485 1.077-4.616 3.11-6.154c.599-.355.598-1.183.24-1.656c-.225-.37-.636-.508-1.03-.473m13.753 0c-.314.03-.613.177-.792.473c-.36.473-.36 1.301.238 1.656c2.034 1.538 3.11 3.67 3.11 6.154c0 2.367-1.196 4.851-3.11 6.153c-.598.355-.717 1.065-.239 1.656c.24.355.6.473.958.473c.24 0 .478-.118.718-.236c2.512-1.775 4.067-4.851 4.067-8.046c.107-3.313-1.435-6.035-4.067-8.047a1.3 1.3 0 0 0-.883-.236m-2.265 3.552a1.2 1.2 0 0 0-.83.376a1.17 1.17 0 0 0 .06 1.669c1.532 1.408 1.663 3.798-.012 5.371a1.195 1.195 0 0 0-.036 1.681a1.2 1.2 0 0 0 1.687.047c2.716-2.556 2.488-6.52-.012-8.827a1.18 1.18 0 0 0-.856-.317m-8.993.007a1.2 1.2 0 0 0-.856.31c-2.5 2.307-2.727 6.271-.011 8.827a1.2 1.2 0 0 0 1.686-.047a1.17 1.17 0 0 0-.048-1.668C6.597 9.413 6.741 7.022 8.26 5.614a1.17 1.17 0 0 0 .06-1.668a1.15 1.15 0 0 0-.819-.381m4.5 2.15a2.57 2.57 0 0 0-2.572 2.57a2.57 2.57 0 0 0 1.193 2.17L7.714 24h2.525l2.877-13.402a2.57 2.57 0 0 0 1.456-2.312A2.57 2.57 0 0 0 12 5.714"></svg:path>`,
})
export class SimpleIconsPodcastindexIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPodmanIcon],svg[simple-icons-podman-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPoeIcon],svg[simple-icons-poe-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M24 12.513V8.36c0-.888-.717-1.608-1.603-1.615h-.013c-.498-.009-1.194-.123-1.688-.619c-.44-.439-.584-1.172-.622-1.783l-.001.003l-.003-.044l-.001-.03a1.616 1.616 0 0 0-1.607-1.45H5.54a2 2 0 0 0-.164.008l-.055.009q-.051.005-.102.015l-.069.017q-.042.01-.083.022q-.034.01-.07.024l-.08.03l-.063.029l-.08.038l-.059.034q-.038.022-.077.047l-.061.045q-.032.021-.065.05a1 1 0 0 0-.099.09q-.01.007-.018.016l-.014.016a2 2 0 0 0-.094.102l-.046.062q-.025.031-.047.063l-.045.074l-.037.062l-.036.076a.7.7 0 0 0-.058.143l-.027.075l-.02.074l-.018.078q-.008.044-.013.088q-.006.033-.01.069q-.004.033-.004.068l-.002-.002c-.036.61-.182 1.345-.62 1.784c-.496.495-1.191.61-1.69.618h-.012q-.076 0-.147.007l-.072.012q-.043.005-.084.012l-.082.02l-.072.018l-.079.027q-.036.012-.07.026q-.036.015-.072.034l-.072.033l-.068.04l-.068.041l-.072.054l-.053.04a1.6 1.6 0 0 0-.226.227l-.041.053l-.054.074q-.023.034-.041.067L.19 7.6l-.033.07l-.034.073l-.026.07q-.016.04-.027.08q-.01.035-.018.071l-.02.082l-.012.084c-.003.024-.009.048-.01.072q-.01.079-.01.16v4.152c0 .888.717 1.609 1.603 1.616h.01c.5.008 1.196.123 1.69.618c.43.43.577 1.143.618 1.746v4.13c0 .524.66.754.986.346l2.333-2.92h11.22c.861 0 1.563-.675 1.611-1.524l.001.003c.037-.61.183-1.344.622-1.783c.495-.496 1.19-.61 1.689-.619h.012q.066 0 .132-.007l.022-.001A1.613 1.613 0 0 0 24 12.513m-3.85 1.69c-.502.503-1.215.613-1.717.619H5.566c-.501-.006-1.215-.114-1.717-.618c-.408-.409-.565-1.117-.618-1.744V8.415c.052-.627.209-1.337.618-1.745c.503-.503 1.216-.613 1.717-.619h12.867c.502.006 1.216.115 1.718.619c.409.41.564 1.117.618 1.744v4.041c-.052.63-.209 1.339-.618 1.749zM8.424 7.99c-.892 0-1.615.723-1.615 1.615v1.616a1.615 1.615 0 1 0 3.23 0V9.604c0-.892-.723-1.615-1.615-1.615Zm7.154 0c-.893 0-1.616.723-1.616 1.615v1.616a1.615 1.615 0 1 0 3.231 0V9.604c0-.892-.723-1.615-1.615-1.615z"></svg:path>`,
})
export class SimpleIconsPoeIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPokemonIcon],svg[simple-icons-pokemon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPolarsIcon],svg[simple-icons-polars-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPolyIcon],svg[simple-icons-poly-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPond5Icon],svg[simple-icons-pond5-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPoposIcon],svg[simple-icons-popos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPorkbunIcon],svg[simple-icons-porkbun-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 0A11.97 11.97 0 0 0 .018 11.982C.018 18.612 5.37 24 12 24s11.982-5.353 11.982-11.982C23.982 5.388 18.63 0 12 0M5.832 5.885c1.064.248 2.092.638 3.014 1.135c-1.1.531-1.987 1.382-2.66 2.375a3.4 3.4 0 0 1-.674-2.057c0-.532.107-.992.32-1.453m12.336 0c.213.425.32.921.32 1.453c0 .78-.248 1.49-.674 2.057c-.673-.993-1.596-1.844-2.66-2.375a10 10 0 0 1 3.014-1.135m-6.072.81a6.39 6.39 0 0 1 6.32 6.457v3.829a1.18 1.18 0 0 1-1.17 1.17a1.18 1.18 0 0 1-1.17-1.17v-.958H7.852v.957a1.18 1.18 0 0 1-1.17 1.17a1.18 1.18 0 0 1-1.17-1.17v-3.65c0-3.51 2.73-6.489 6.24-6.63q.173-.007.344-.005m1.5 3.8a.94.94 0 0 0-.922.921c0 .248.07.424.213.602c.141.212.353.354.566.46c-.142.071-.319.143-.496.143c-.213 0-.39.176-.39.389s.177.39.39.39h.178a1.56 1.56 0 0 0 1.383-.851c.39-.142.709-.39.921-.744c.071-.107.034-.249-.037-.213c-.106-.036-.212-.034-.283.072a1.04 1.04 0 0 1-.426.354v-.143c0-.39-.14-.709-.353-.992a.88.88 0 0 0-.744-.389m0 .53c.212 0 .353.141.388.354v.178c0 .177-.034.354-.105.496a1.06 1.06 0 0 1-.604-.426c-.035-.071-.07-.14-.07-.211c0-.24.206-.39.39-.39"></svg:path>`,
})
export class SimpleIconsPorkbunIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPorscheIcon],svg[simple-icons-porsche-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPostcssIcon],svg[simple-icons-postcss-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.627.008q-.352.014-.706.065c-.226.024-.453.064-.672.097c-.267.033-.534.05-.801.081c-.252.033-.51.082-.762.123c-.09.016-.178.048-.268.064c-.194.04-.396.057-.59.122A16 16 0 0 0 6.79.917c-.316.13-.624.268-.923.43c-.308.17-.6.373-.892.568q-.415.277-.82.592c-.257.203-.501.43-.736.657c-.13.13-.235.284-.356.43c-.203.236-.405.462-.6.706c-.16.203-.308.414-.462.625c-.275.373-.51.77-.728 1.168c-.09.162-.17.325-.25.487c-.123.243-.252.478-.366.73c-.08.17-.146.357-.194.544a67 67 0 0 0-.332 1.2c-.098.358-.122.73-.13 1.096c-.008.324.024.64.057.965c.008.082-.04.18.056.244c-.032.09-.008.138.04.154c-.056.09.025.146-.007.227c-.008.017.025.05.04.073c0 .025-.008.057 0 .08c.01.074.04.147.04.229c0 .056.05.12.066.178c.008.024 0 .065-.017.08c-.048.058-.04.106.033.139c.04.105.024.154.016.203c.016.073-.008.097 0 .114c.065.13.09.275.097.42c0 .034.016.066.033.107c.008 0 0 .154 0 .154c.04-.024.073-.032.113-.05q.036.16.081.294c.04.065.041.097.025.105c.032.145.048.283.105.42c0-.153-.016-.307-.04-.453c.113.04.21.08.275.08c.008-.023.016-.055.025-.072c-.049-.048-.09-.12-.138-.17c.016.065 0 .09 0 .114a1 1 0 0 0-.114-.05c.033-.04.065-.08.114-.13c0-.072-.04-.137-.154-.13c.05-.015.097-.04.154-.055c.09-.048-.008-.138-.008-.25c.008-.14-.073-.277-.097-.423c-.04-.227-.033-.568-.057-.795c-.049-.04-.09.065-.097.073q.04.293.064.584c-.048-.162-.08-.34-.12-.536c-.01.057-.017.08-.017.114c-.04.04-.008.09.016.146c-.056-.025-.12-.016-.12-.016v.227c-.082-.08-.106-.146-.147-.203c-.016-.065-.025-.13-.04-.194c.015-.04 0-.065 0-.09l-.025-.195a1 1 0 0 0-.008-.13c.065.009.106.016.146.016c-.08-.104-.025-.17.008-.234c.016-.033.073-.04.09-.074c.064-.12.17-.218.17-.373c0-.073.025-.154.032-.227q.027-.207.04-.414c.017-.178 0-.357.041-.527c.065-.283.146-.568.235-.852c.065-.203.138-.397.22-.6c.12-.317.234-.633.388-.933c.22-.438.47-.86.713-1.29c.154-.268.316-.52.487-.78c.16-.25.323-.51.51-.746c.26-.332.543-.64.86-.917c.323-.292.63-.592.98-.86a10 10 0 0 1 1.44-.925c.414-.219.843-.39 1.273-.552c.275-.105.575-.154.859-.243c.324-.106.648-.154.988-.162c.219-.008.43-.033.648-.057a16 16 0 0 0 .6-.057a.4.4 0 0 0-.04.065c-.09.13-.187.26-.276.39c-.073.105-.154.218-.227.324c-.13.17-.268.34-.39.52c-.185.267-.356.543-.55.81c-.194.26-.405.504-.608.755c-.267.35-.518.706-.785 1.055c-.244.332-.502.65-.737.982c-.21.292-.398.6-.6.9c-.3.446-.6.884-.9 1.33a84 84 0 0 1-.712 1.015c-.016.024-.04.032-.065.048c-.064.105-.064.162-.09.21a4 4 0 0 1-.202.358c-.04.065-.097.122-.146.187c-.008-.098.13-.147.065-.27c-.04.067-.08.123-.12.188l-.1.194c.033.024.088.04.035.088c-.005-.02-.032-.032-.053-.048a5 5 0 0 0-.194.293c.05.04.073.024.105-.033c.03-.06.072-.104.11-.154l-.042.074a.3.3 0 0 0 .09-.08c0 .088-.05.16-.09.233c-.033.065-.114.114-.17.163c.008.008.065.032.073.04c.073-.024.097-.064.106-.04c.024-.033.048-.057.056-.08a.3.3 0 0 1 .162-.18q.046-.026.08-.064c.244-.252.495-.496.714-.764c.34-.413.648-.843.973-1.265c.137-.178.3-.357.445-.527c.024.186.008.365 0 .535c-.025.3-.04.6-.065.908c-.008.122 0 .244-.008.366c0 .032-.025.056-.025.09c0 .08.025.17.025.25c-.025.3-.057.592-.082.893c-.008.064.024.13.04.186c-.04.438.05.9-.024 1.364c.057-.09.073-.147.073-.203c.008-.05 0-.097 0-.154v-.08c.008-.147.04-.3.024-.448a1.5 1.5 0 0 1 .016-.47c.017-.065-.007-.146.033-.227v.12c-.008.463.01.926-.056 1.388c-.008.04.024.114-.065.106c-.073.146.016.252-.065.333c-.016.016.016.09.024.138c-.032.097-.032.097.016.105c.008.18.025.34.033.51c.13-.307.064-.624.122-.941c.008.13.016.26.008.398c0 .21-.01.414-.017.625q-.002.06-.016.122c-.024.113-.032.227-.072.332c-.033.08-.016.203-.016.3v.31c.032.137-.01.21.016.29c-.025.083-.033.107-.025.13l.025.123c.162-.016.09.106.153.17c-.048.065-.032.09-.032.122c0 .073-.008.138-.016.21c0 .188-.008.374-.008.553c0 .025.008.048.008.073l-.008.227c.016.024 0 .05-.025.073c-.008 0-.032-1.03-.032-1.03h-.12c-.017.486.023.924-.066 1.38c-.097.007-.13.023-.235.023q-.378-.002-.754.008c-.3 0-.59.008-.89.008c-.147 0-.3.017-.446.017c-.195 0-.397-.025-.59-.025c-.3 0-.593.024-.893.032c-.22.008-.437.008-.656.017c-.146.008-.292.015-.438.032c-.064.008-.12.032-.202.056c-.025 0-.08-.008-.13 0c-.08.017-.153.065-.235.082c-.122.024-.154.056-.138.178v.08c-.008.017.178-.024.178-.024c-.016 0-.024.05-.049.09c.065-.025.106-.04.147-.057c.121.057.226.025.323.05c.316.08.64.113.964.145c.21.016.414.025.624.032c.3.017.6.033.9.033c.25 0 .493-.025.744-.025c.348 0 .697.016 1.045.025c.073 0 .154-.008.235-.008h.592c.527-.016 1.053-.025 1.58-.04c.3-.01.608-.025.907-.033l.924-.025c.357-.008.713-.008 1.062-.015c.267 0 .526-.01.794-.017c.3-.008.607-.032.907-.048c.162-.008.324-.025.486-.04c.195-.017.398-.04.592-.05c.29-.016.59-.024.883-.04c.365-.024.73-.057 1.102-.065c.34-.016.689-.008 1.03-.016c.3-.008.599-.025.907-.033l.51-.025s.34-.008.51-.024c.293-.016.584-.05.876-.057c.186-.008.372 0 .559-.008c.3-.008.606-.024.906-.024c.113 0 .235.016.38.024c-.064.057-.105.09-.153.13c.032.008.064.025.097.04a.22.22 0 0 1-.13.04c-.016.042-.032.058-.048.139h.145c-.056 0-.105.073-.16.122c-.066-.017-.123 0-.156.09c.057.03.05.056.04.09c-.096.03-.17.063-.128.169q-.05.022-.114.056c-.04.065-.113.08-.097.17c.032.008.064.025.09.033c-.042.016-.082.04-.123.056c-.145.09-.08.13-.048.17q-.037.027-.073.04c.016.074.04.09.048.09l-.085.069l.01-.027h-.032q0 .022.005.04l-.02.016c-.024.072-.056.104-.09.153c-.03.048-.046.114-.087.162c-.17.187-.292.406-.51.552c-.081.057-.154.13-.227.203c-.146.138-.276.292-.43.422a9 9 0 0 1-.631.478c-.267.187-.534.374-.802.552c-.146.097-.308.17-.462.26s-.3.17-.454.26c-.097.064-.186.153-.291.202c-.268.114-.551.211-.827.317c-.268.114-.462.21-.664.284a5 5 0 0 1-.575.153c-.065.017-.138 0-.211.01c-.138.024-.276.057-.414.073c-.356.048-.713.08-1.07.13c-.21.024-.413.064-.623.09c-.146.007-.3-.009-.446-.009c-.105 0-.218.025-.324.01c-.17-.026-.34-.066-.51-.098c-.04-.008-.097-.025-.13-.008c-.064.032-.122-.016-.187 0c-.04.008-.08-.025-.12-.025c-.033-.008-.074.01-.115 0c-.09-.024-.17-.056-.268-.048c-.096.008-.194-.04-.298-.065l-.43-.097a.7.7 0 0 1-.162-.073c-.21 0-.348-.008-.478-.057c-.113-.04-.22-.097-.34-.08c-.032.007-.057-.009-.09-.009c-.024-.033-.048-.098-.072-.098c-.162.008-.26-.13-.397-.17c-.073-.024-.13-.105-.202-.13c-.18-.073-.324-.227-.527-.25c-.064-.01-.13-.042-.202-.066c.024.032.04.057.064.08c-.235-.113-.453-.242-.672-.364c-.032-.008-.056-.04-.08-.057l-.22-.147c-.12.024-.17-.025-.203-.04c-.218-.154-.47-.252-.68-.421c-.09-.074-.194-.122-.26-.212a1.3 1.3 0 0 0-.404-.316c-.122-.064-.235-.138-.348-.21c-.057-.041-.114-.09-.114-.18c0-.056-.024-.113-.097-.08c-.032-.05-.065-.106-.105-.122c-.097-.04-.162-.114-.235-.18c-.073-.064-.13-.153-.22-.185c-.161-.065-.26-.203-.355-.316c-.228-.268-.43-.56-.64-.844c-.017-.024-.05-.04-.074-.065c.033.09.073.162.114.243a.5.5 0 0 1-.186-.146c-.008.008.558.942.558.942c.05.073.09.146.138.219a.25.25 0 0 1-.243-.13c-.073-.13-.154-.21-.316-.194a1.4 1.4 0 0 1-.04-.18a.6.6 0 0 1-.114-.008c.114.179.21.333.316.51l-.08-.047c.145.154.25.349.436.446c.04.187.25.276.3.454l-.114-.024c-.065-.081-.138-.162-.21-.251a.4.4 0 0 0 .072.145c.098.122.187.244.3.35c.04.04.098.057.098.13c.064.032.09.04.113.04c.017.049-.008.122.09.106c.064.12.128.12.218.08c.105.105.162.114.235.05c0 .04.008.08.008.113c.032-.017.025-.04.025-.081c.04.033.064.049.08.065c.08.114.154.219.268.307c.154.13.29.268.437.39c.283.235.6.43.916.608c.39.22.762.455 1.16.665a6.2 6.2 0 0 0 1.513.545c.195.04.38.08.576.13c.17.048.34.121.51.161c.26.057.527.106.786.154l.179.025c.072.016.16-.016.177.008c.04.065.073.032.122.024c.057-.016.12-.016.186-.016c.227.008.445.056.672.04c.05 0 .122-.04.163.04c.073-.032.113-.032.146-.04c.008.073 0 .073-.016.08c-.017.01-.04.017-.073.04c.292.058.567.066.81 0a2.7 2.7 0 0 0 1.135-.136c.032.04.056.097.105.016c.016-.025.056-.033.089-.04c.073-.017.162-.05.227-.026c.073.025.097-.04.154-.04c.097 0 .186-.008.276-.024c.048-.008.097-.033.153-.05a.4.4 0 0 0-.178-.04a7 7 0 0 1 .276-.13c-.017.025-.033.057-.065.057h.113c-.025 0-.057.073-.097.122c.29-.073.558-.138.818-.204c-.09-.17.097-.113.162-.21a3 3 0 0 1-.243.064c.275-.137.559-.26.834-.38c-.04.048-.09.073-.162.114c.049.008.08.008.106.015c.129.04.097-.08.137-.154c.154 0 .219-.024.292-.05q.12-.033.243-.08c.13-.056.25-.13.38-.194c.025-.01.065 0 .098 0c.09-.057.12-.106.145-.098c.114.017.194-.024.227-.13l.023-.015c.033.07.098.08.203.007q-.1-.002-.187-.016q-.008.002-.011.006q.06-.047.11-.08c.178-.096.347-.193.526-.29c.065 0 .097 0 .113-.008a4 4 0 0 0 .3-.163c-.024-.008-.08-.04-.08-.04a1 1 0 0 0 .154-.04c.193-.23.46-.383.664-.56c.089-.008.089-.032.089-.048c.032-.041.064-.09.105-.122c.177-.163.371-.3.533-.47q.354-.355.673-.732c.194-.227.39-.454.55-.705c.228-.35.422-.706.625-1.072c.146-.26.275-.52.422-.778c.015-.025.048-.057.072-.057c.22-.025.438-.04.65-.065c.047-.008.104-.04.152-.065c-.024-.04-.04-.09-.064-.13c-.033-.05-.08-.09-.114-.138c-.032-.04-.056-.09-.08-.138c-.025-.04-.05-.072-.074-.114a3 3 0 0 1-.138-.275c-.008-.024-.025-.065-.016-.09c.146-.315.202-.656.34-.972c.138-.325.18-.69.243-1.04c.057-.331.09-.664.13-.997c.024-.235.057-.462.064-.697c.05-.373.033-.723.025-1.072c-.008-.308-.025-.624-.04-.933c-.017-.317-.025-.633-.058-.95c-.056-.43-.113-.868-.21-1.29a7 7 0 0 0-.316-1.014c-.154-.39-.308-.787-.503-1.16c-.316-.6-.73-1.136-1.11-1.696c-.252-.357-.576-.65-.82-1.014c-.135-.21-.34-.39-.541-.55a14 14 0 0 0-1.004-.723a10 10 0 0 0-.794-.504c-.22-.122-.454-.22-.68-.325c-.26-.12-.511-.268-.803-.324c-.073-.016-.138-.04-.21-.065c-.187-.065-.365-.138-.552-.195c-.283-.089-.56-.194-.85-.267a8 8 0 0 0-.87-.163c-.323-.047-.655-.064-.98-.096a8 8 0 0 0-.623-.056c-.307-.018-.623-.018-.93-.025c-.154-.008-.316-.024-.47-.016Zm.694.94q.156.027.3.041l.389.025c.292.023.583.04.875.08c.243.033.486.081.737.122a10.4 10.4 0 0 1 1.572.405c.3.098.59.228.884.35c.656.267 1.28.592 1.895.932c.194.106.308.276.454.43c.21.22.42.438.624.665c.234.268.453.544.68.82c.201.243.412.486.615.73c.065.073.114.163.17.244c.13.194.275.38.39.592c.08.154.13.333.185.503c.08.252.162.495.243.746c.056.187.104.382.145.576c.033.13.025.268.065.397c.05.17 0 .358.05.528c.007.017.015.04.023.057c.033.032.057.065.008.114c-.008.008-.008.04 0 .064c.017-.016.025-.032.04-.057c0 .017.01.025.01.033c0 .032-.01.065 0 .097c0 .016.015.04.023.057c.016-.017.032-.025.064-.05c.073.276.082.552.082.836c0 .268.048.536-.065.795c.024-.09-.033-.17-.008-.252l.003.002c-.008 0-.056-.05-.064-.057c-.01.025 0 .05-.017.08c-.008-.023-.064-.014-.064-.04c-.01.115.048.228.04.34c.024-.014.12-.023.146-.047a.1.1 0 0 0 .032.016c-.162.122-.12.244-.048.382c.016.032.064.097.016.162c-.016.016.008.065.016.106h.024v.015l-.073.025c-.016-.025-.113-.073-.113-.114v.414c.08.025.08.138.113.195a.2.2 0 0 0 .033-.064l.008.008q-.01.072-.032.146c-.016.072-.033.137-.04.21c0 .008.015.025.015.033c-.09.203-.04.43-.072.64c-.025.154 0 .317-.017.48a4 4 0 0 1-.08.42c-.009.025-.026.033-.066.05a.7.7 0 0 0-.008-.252c-.008 0-.114-.057-.122-.057c0 .114.065.268.09.398c-.025-.008-.122-.065-.13-.065c-.017.097-.017.227-.025.332c-.008.082-.08.154-.09.244c0 .05.058.08.05.162h.064c0-.162.074-.308.074-.478h.023c.01.016.033.032.025.04c-.016.09-.05.187-.04.276c0 .05.04.097.024.154a1 1 0 0 0-.033.17c-.008-.04-.016-.056-.016-.08l-.09-.008c-.007.05.058.097.05.138c-.01.008-.017.008-.033.016l-.267-.39a82 82 0 0 1-.632-.932a2 2 0 0 1-.147-.244q-.372-.645-.833-1.24c-.235-.3-.422-.626-.64-.94c-.203-.302-.405-.594-.608-.895c-.073-.097-.162-.186-.227-.292c-.21-.332-.397-.673-.607-1.006c-.178-.276-.372-.544-.56-.81q-.097-.137-.194-.286a.1.1 0 0 1-.016-.055a12 12 0 0 1-.04-.528c0-.162.016-.324.016-.495V6.96c0-.04.008-.073.008-.113c.008-.008.016-.025.024-.033c-.235 0-.478-.01-.713 0c-.154.008-.235-.057-.34-.17c-.308-.35-.535-.747-.802-1.12a50 50 0 0 0-.77-1.055c-.211-.284-.422-.56-.632-.844c-.236-.324-.462-.65-.705-.973q-.44-.585-.892-1.168c-.138-.179-.292-.35-.446-.536m-.752.426q.026.005.05.038c.218.276.437.56.655.835c.163.204.325.398.48.61c.185.26.364.52.55.778q.316.448.624.908c.308.455.6.91.907 1.363c.227.333.454.658.672.99h-.413c-.38-.008-.77-.04-1.15-.024c-.52.025-1.046.08-1.564.122a23 23 0 0 1-1.976.064c-.236 0-.47.033-.705.05c-.284.016-.56.032-.843.04c-.333.016-.656.024-.99.033c-.185.008-.38 0-.582 0V7.18c.26-.357.527-.714.786-1.08c.08-.105.145-.22.226-.324c.025-.033.058-.05.098-.082l-.008-.015c.032-.04.064-.074.08-.106c.042-.065.066-.138.099-.21a.1.1 0 0 1 .032-.033c.114.057.114-.064.154-.105a6 6 0 0 0 .21-.252c.05-.064.098-.12.139-.194c.007-.025-.017-.065-.025-.098H9.05c.024-.016.049-.04.073-.056c.008 0 .008 0 .016-.008a5 5 0 0 1 .146-.21c.097-.13.202-.26.315-.374q-.024.062-.048.113c.008 0 .008.008.016.008c.097-.13.203-.252.3-.382q-.012-.014-.025-.016c-.04.04-.072.082-.113.122q-.012-.014-.025-.016c.082-.106.163-.21.243-.333c.017.025.033.057.065.122c.033-.08.065-.138.09-.195c-.025.025-.057.05-.081.074l-.025-.025l.146-.218c.154-.22.308-.447.462-.666c.057-.08.13-.146.178-.227c.154-.308.398-.552.584-.836c.04-.056.097-.105.145-.154q.03-.035.056-.03zm-2.285 3.16c-.048.033-.09.057-.137.09c-.01.008-.017.008-.01.008c.01.04.01.073.017.13c.057-.082.097-.147.146-.21zm6.838 3.342c.073 0 .113.025.154.09q.108.182.227.365c.008.016.024.04.024.064c0 .18 0 .365.008.544c.008.187.025.365.032.552c0 .186-.016.38-.008.576c.009.276.016.56.016.843h.002v.074c-.008 0-.016.008-.032.008c-.033-.114-.065-.236-.106-.35a2.7 2.7 0 0 0-.316-.68c-.163-.228-.308-.463-.47-.698c-.04-.057-.098-.106-.146-.154c-.17-.187-.34-.382-.56-.52a6.6 6.6 0 0 0-1.012-.52a2 2 0 0 1-.284-.145h.194L15.23 7.9c.3-.008.59-.008.89-.024m-6.083.212q.088-.003.178.008c-.13.065-.26.13-.373.21c-.146.098-.283.228-.43.334a2.4 2.4 0 0 0-.396.373c-.154.186-.324.348-.487.527c-.113.13-.243.252-.34.39c-.137.178-.26.372-.39.575c.042-.77.09-1.533.058-2.312c.382-.016.746-.04 1.12-.056c.29-.017.59-.025.88-.04q.09-.008.18-.01zm2.033.415c.242.008.485.008.728.024c.105.008.203.032.3.064c.12.04.25.098.365.154q.204.11.397.244c.235.154.453.324.688.462c.227.138.405.325.55.536c.18.25.382.48.463.787l.12.535c.026.098.083.195.058.308c-.04.203-.073.415-.105.617a1 1 0 0 0-.024.244c.015.252-.082.47-.18.698c-.031.073-.08.146-.12.227a.2.2 0 0 0 .064.033l.073-.146c.009 0 .009 0 .016.008c-.04.113-.072.235-.113.35c-.097.25-.194.51-.316.753c-.065.138-.178.25-.26.382c-.08.113-.145.235-.226.34c-.073.09-.145.18-.243.244a6 6 0 0 1-.68.454c-.146.09-.316.138-.478.178h.002c-.26.064-.527.138-.794.17c-.227.033-.462.025-.697.025a8 8 0 0 1-.625-.025c-.235-.024-.47-.05-.696-.154c-.195-.09-.398-.17-.591-.268c-.196-.097-.39-.21-.536-.39c-.105-.13-.251-.234-.38-.348a.38.38 0 0 0 .17.235c-.041.05-.098.025-.18-.106c-.023.017-.047.025-.064.033c.025-.057.049-.114.073-.162c-.032-.065-.073-.138-.105-.204a7 7 0 0 1-.187-.324c-.016-.024-.016-.048-.032-.073a2 2 0 0 1-.114-.146c-.064-.097-.12-.202-.202-.3c0 .025.008.05.008.082c-.008 0-.016.008-.016.008l-.17-.414c-.008 0-.008 0-.016.008l.145.535c-.008 0-.016.01-.024.01c-.024-.034-.048-.066-.065-.106c-.016-.066-.065-.066-.105-.04c-.025.015-.041.072-.033.096q.088.207.187.414a1 1 0 0 0 .057.138c.008.016.032.032.032.056c.033.065.057.13.098.187c.073.097.154.195.227.292c.072.097.137.203.2.3c.009.016.034.016.04.025c.043.12.18.21.277.162c.025.186.227.25.308.43a4 4 0 0 1-.235-.106c-.008.008-.008.016-.016.032c.097.05.195.098.283.154c.082.05.163.098.236.155c.097.09.21.138.348.17a.1.1 0 0 0-.016-.033c.227.106.462.22.64.308c-.843.017-1.742.033-2.674.05c0-.155-.008-.3-.008-.455c0-.065.016-.122.008-.187c-.025-.372-.025-.746-.073-1.11a8 8 0 0 1-.04-1.162c.007-.21-.01-.43-.017-.64c0-.284 0-.56.009-.844c0-.04.016-.073.032-.114h.025c.008.017 0 .04.015.05c.025.024.066.064.082.056c.048-.033.12-.065.138-.114a.8.8 0 0 0 .056-.3c0-.073.033-.12.065-.17c.016-.025.025-.05.04-.08c-.031-.025-.064-.042-.104-.074c.032-.09.024-.195.146-.243c.016-.008.016-.05.024-.073c.008-.066.015-.14.024-.204c.016.025.025.033.04.05q.015-.026.017-.026c0-.032-.008-.097 0-.097c.097-.016.057-.122.105-.17c.008-.01-.008-.033-.008-.05c0-.015 0-.04.008-.04c.113-.024.097-.146.17-.203c.024-.016.032-.04.065-.08c.064.112-.05.17-.057.25c.137-.08.178-.275.097-.332a.5.5 0 0 0 .089-.09c.09-.097.186-.186.267-.283c.057-.073.09-.162.146-.235c.033-.04.098-.073.146-.098c.146-.08.284-.17.373-.307q.026-.025.064-.05c.025-.015.074-.015.082-.04c.008-.016-.016-.057-.033-.08c.032-.017.065-.05.13-.082c-.025.05-.032.08-.05.114l.04.04c.074-.057.188-.12.26-.17c0-.008-.04-.04-.04-.04c-.05.024-.121.065-.194.097c.015-.024.015-.04.025-.05c.113-.072.226-.144.348-.202c.283-.13.567-.26.85-.38c.049-.025.114-.01.17-.01c.025 0 .04 0 .065-.006c.13-.04.26-.082.39-.114a.7.7 0 0 1 .178-.024m-.316.12l-.234.106c0 .008-.041.073-.033.073c.04-.008.13-.073.178-.08c.024 0 .057.007.082.015c0-.032 0-.065.007-.114m5.858 1.38c.08.107.17.204.227.309c.187.34.43.634.656.942c.195.268.373.56.552.835c.218.333.429.665.648.998c.162.252.332.503.502.747q.233.326.477.64c.137.187.283.374.42.56q.244.344.487.674c.08.113.17.227.26.34c.05.065.121.114.17.154a.1.1 0 0 1-.032-.008q.034.05.056.073c.09.05.098.098.05.17v-.001c-.008.016-.025.033-.033.05c-.008-.017-.008-.042-.016-.075c-.05.13-.154.066-.227.066c-.437.008-.883.008-1.32.008c-.421 0-.85 0-1.271.008c-.138 0-.284.032-.422.04a37 37 0 0 1-.997.033c-.024 0-.048-.04-.09-.073l-.048.073c-.008-.016-.024-.032-.04-.056l-.025.064h-.024c-.016-.113-.048-.22-.048-.332c0-.244.024-.487.032-.73c.008-.114 0-.22 0-.325l.09.065a1 1 0 0 1 .048-.08s-.016-.008-.033-.025c.016-.008.033-.025.033-.033c.008-.024.024-.05.024-.065c0-.057-.016-.105-.024-.153q.012.002.024-.008l.048.243h.025c-.032-.056.073-.106-.016-.17c-.008-.008.008-.057.008-.082c-.025-.048-.04-.097-.065-.162c.008-.008.033-.016.057-.024q-.046-.026-.081-.04c.08-.073.08-.114.008-.195c.016-.008.032-.008.032-.015c0-.074 0-.147-.016-.22c-.016-.081.025-.178-.097-.227a.2.2 0 0 0 .032.065s-.024.008-.048.024c-.105-.097-.04-.228-.065-.373a1 1 0 0 1 .138.05c-.017-.058-.057-.123-.081-.196h-.033v-.536c0 .008.056.008.09.017c0-.008.007-.016.007-.025l-.09-.105l.017-.016c-.065-.08-.032-.194-.032-.22v-.567c.08.082-.04.187.08.235v-.08h-.008c-.008-.122-.008-.244-.016-.366h-.016c-.008.017-.008.025-.016.04h-.016zm-13.65.665c-.098.113-.187.227-.276.34c.015.008.04.065.055.082c.09-.122.21-.276.3-.39c-.008-.008-.072-.024-.08-.032m-.543.398c-.05.072-.17.202-.22.275c.009.008.098-.032.106-.023c.05-.073.098-.155.146-.228q-.022-.013-.032-.024m.17.12c-.05.034-.097.075-.146.107c.016.016.016.025.016.04c-.064-.007-.09.026-.12.114c-.01.025-.05.033-.09.065c-.01.016-.017.057-.033.097l.008.008a.1.1 0 0 1-.04.025c-.05.048-.106.09-.154.138q-.014.036-.016.073c.056-.057.153-.162.226-.227l.01.008c.03-.05.056-.098.09-.146c.006.008.006.016.014.024c-.024.065-.048.138-.073.203c-.017.008-.04.024-.04.016c-.033.025-.058.057-.09.08l-.146.098c-.08.073-.162.138-.25.21c-.058.09-.114.17-.18.277c.098-.025.122.016.114.097c.113.016.122-.073.154-.138c.008-.016.016-.05.032-.057c.073-.065.154-.12.235-.186c.017-.016.017-.05.017-.073c0-.008-.04-.008-.066-.017c.073-.08.18-.218.25-.307c.042-.025.083-.058.083-.082c-.007-.075.032-.104.082-.13c-.037.175-.144.325-.252.356c.033.016.065.033.09.025s.04-.05.056-.074l.22-.316l.072-.122l-.032-.033c-.033.058-.065.107-.098.164l-.027-.014l.002-.002c-.032-.025-.04-.05-.04-.057a.3.3 0 0 1 .04-.074c.017 0 .04-.008.04-.008c.034-.056.034-.097.066-.146c-.008-.008-.016-.008-.025-.016zm14.059.999h-.002v.006zm-.002.006a.2.2 0 0 0-.007.067q-.002-.034.007-.067m-.007.147v.008c.008.008.009.008.016 0c-.008 0-.008 0-.016-.007zm0 .016c-.024.008-.05.008-.081.017c.04.015.079.023.08.04zm0 .056v.002zm-1.192 1.422c-.016.925.09 1.833.21 2.75l-2.786.097a3.3 3.3 0 0 0 .94-.624a1 1 0 0 1 .13-.114c.34-.21.59-.503.818-.828c.259-.373.429-.795.64-1.192a1 1 0 0 1 .048-.09m1.134.073l.033.08c.04-.007.057-.007.073-.015q-.002-.012.008-.024c-.024-.01-.057-.024-.114-.04zm.024.074l-.007.006c.008 0 .016.01.016.01l-.008-.01zM1.07 14.01a.2.2 0 0 0-.073.033c.032.08.073.17.105.252a.2.2 0 0 1 .065-.033c-.033-.08-.065-.17-.097-.252m-.228.333c-.024.04-.048.08-.04.113c0 .024.04.05.065.073c0-.008.008-.016.016-.023c-.016-.057-.024-.106-.04-.163m21.657.008c0 .016.008.04 0 .057zm-21.235.18a.3.3 0 0 0-.073.03c.065.139.13.285.194.423c.01 0 .073-.032.073-.032c-.065-.14-.105-.293-.194-.422m-.162.324c0 .032-.04.024-.04.057c-.049 0-.09-.008-.13-.008c-.008.008.024.056.033.065h.17c0-.04-.008-.073-.008-.114zm7.453.316q.133.205.276.398l-.008.008c-.017-.008-.041-.017-.057-.033l-.194-.292a.1.1 0 0 1-.017-.08m9.043.438c-.008.097-.016.17-.016.243c0 .016.016.048.024.048c.016.01.049-.008.065-.015a.06.06 0 0 0 .016-.032c-.024-.017-.048-.025-.073-.042c.154-.08 0-.12-.016-.202m-14.114 4.59c.088.099.177.196.266.302c-.048-.025-.105-.04-.13-.073c-.056-.065-.104-.138-.16-.203zm.34.286c.024.04.04.089.064.138c-.113-.008-.17-.057-.137-.122c.024-.008.05-.008.073-.016m15.434 1.241c-.065.015-.114.024-.154.04c-.016.033-.033.057-.05.09q.013.001.026.015c.049-.05.105-.09.178-.145m-.414.226c-.09.057-.186.113-.276.17c.008.008.008.017.017.025a.8.8 0 0 0 .292-.146c-.008-.017-.025-.034-.033-.05m-3.97 1.542c-.371.106-.493.122-.534.065c.187-.025.357-.04.535-.065m-.551.073c.008.016.008.032.016.048c-.05 0-.081.017-.122.025c-.113.024-.235.04-.348.057c-.04.008-.09.05-.105-.025c-.017.008-.033.008-.05.017c.04.12.139.024.22.072c-.18.025-.348.04-.52.065v-.016c.05-.008.107-.016.155-.025v-.024a2 2 0 0 0-.243-.016c-.024 0-.056.033-.08.04a.4.4 0 0 1-.106.017c-.138.008-.275.008-.405.016c-.008 0-.025-.008-.033-.008v-.025c.543-.072 1.078-.145 1.62-.218zm-1.694.21v.024a4 4 0 0 1-.453.05v-.025z"></svg:path>`,
})
export class SimpleIconsPostcssIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPostgresqlIcon],svg[simple-icons-postgresql-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPostmanIcon],svg[simple-icons-postman-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPostmatesIcon],svg[simple-icons-postmates-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m2.545 14.954l.44-1.284l-1.138.692l-1.08-.88l.342 1.35l-1.109.74l1.35.143l.396 1.338l.492-1.263l1.352.087zm5.308-2.61l-1.14.692l-1.08-.88l.342 1.349l-1.108.74l1.35.144l.396 1.336l.493-1.261l1.352.087l-1.046-.924zm-1.328 4.864l-1.139.692l-1.08-.881l.342 1.35l-1.108.74l1.35.144l.396 1.338l.492-1.263l1.353.087l-1.046-.924zM15.95 6.744l.72.041a.123.122 0 0 0 .092-.032l1.78-1.67a.032.032 0 0 0-.02-.056l-.7-.04a.2.2 0 0 0-.14.05l-1.754 1.646a.035.035 0 0 0 .022.06zm7.55 3.377a3.1 3.098 0 0 0-4.976-.342l-1.108-.83c.277-.113.857-.368.896-.525c.022-.093-.273-.158-.727-.187l2.079-1.896a.05.05 0 0 0 .009-.053l-.529-.996a.04.04 0 0 0-.063-.01l-2.163 1.97c-.646 0-1.796.085-2.127-.123c-.528-.333-.59-.822-.785-.997s-.415-.197-.462-.346a.015.015 0 0 1 .011-.019c.102-.026.67-.186.8-.58c.129-.396-.135-.932-.18-1.016a.02.02 0 0 1 0-.02l.604-.527a.018.018 0 0 0-.013-.03l-.886.108a.02.02 0 0 1-.015 0c-.047-.062-.4-.484-1.121-.189c-.842.34-.687 1.068-.687 1.068c.112.753.374.902.8 1.148c.012 0 .017.02 0 .027c-.274.228-3.035 2.494-5.585 3.378a.05.05 0 0 0 0 .093c.738.32 2.952.147 3.606-.232a.016.016 0 0 1 .025.018c-.072.273-.458 1.873.147 2.37l.034.026l-.82.578a.21.21 0 0 0 .147.38l.422-.047a1.2 1.2 0 0 0 .725-.34l.148-.14l1.193.886l-.158 1.261a3.1 3.098 0 1 0 2.56 1.623l.305-.195a.748.748 0 0 0 1.218-.756l1.262-.37a.205.205 0 0 0 .147-.24l-.008-.041a.21.21 0 0 0-.203-.164h-1.071a.02.02 0 0 1-.015-.01l-.322-.727l.64-3.762l1.034.767a3.1 3.098 0 1 0 5.224 0zm-8.594-2.228l1.46-.025l.192.361c-.338.012-.69.039-1.033.082c-.247.03-.545-.287-.634-.387a.02.02 0 0 1 .015-.03zm-2.214 2.185c.122-.204.831-1.384.92-1.787a.018.018 0 0 1 .03-.007c.471.55 1.468.866 1.545.885h.008l1.28-.394l.287.213l-1.34 1.229a.9.9 0 0 0-.52-.228c-.77-.098-1.975.076-2.194.11a.016.016 0 0 1-.006-.021zm3.31 4.029a.8.8 0 0 0-.249.074l-.915-.7a.02.02 0 0 1 0-.019l.458-.948a.016.016 0 0 1 .03 0l.752 1.18zm-1.942-1.025l-.626-.468l1.2-1.1zm0-1.623l-.974.894l-.977-.727a11.265 11.258 0 0 0 1.97-.16zm-.778 1.553l.643.478l-.077.211a.286.286 0 0 0 .172.369l1.34.488l.04.03a.753.752 0 0 0-.019.473l-.295.192a3.09 3.088 0 0 0-1.919-1.217zm-.208 1.661a2.46 2.458 0 0 1 1.465.925l-1.717 1.092zm.822 4.48a2.46 2.46 0 1 1-1.235-4.53l-.309 2.456a.21.21 0 0 0 .096.203a.21.21 0 0 0 .223 0l2.089-1.328a2.462 2.46 0 0 1-.866 3.198zm1.83-8.045a.01.01 0 0 1 0-.01a1.3 1.3 0 0 0-.063-.518l1.133-1.033l-.49 2.875zm6.486 2.751a2.46 2.458 0 0 1-3.418-3.362l1.95 1.452a.21.21 0 0 0 .237.008a.2.2 0 0 0 .054-.05a.21.21 0 0 0-.043-.295l-1.953-1.45a2.4 2.4 0 0 1 .526-.443a2.46 2.46 0 1 1 2.644 4.147Z"></svg:path>`,
})
export class SimpleIconsPostmatesIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPowerfxIcon],svg[simple-icons-powerfx-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPreactIcon],svg[simple-icons-preact-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrecommitIcon],svg[simple-icons-precommit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPremierleagueIcon],svg[simple-icons-premierleague-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrestashopIcon],svg[simple-icons-prestashop-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrestoIcon],svg[simple-icons-presto-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrettierIcon],svg[simple-icons-prettier-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPreventionIcon],svg[simple-icons-prevention-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPreziIcon],svg[simple-icons-prezi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.996 0q-.315 0-.63.015l.134 2.547c.333-.02.66-.013.987 0L12.62.015A13 13 0 0 0 11.996 0m-1.89.148c-.413.067-.826.154-1.22.26l.667 2.467c.32-.086.64-.153.973-.206zm3.761 0l-.387 2.52c.334.054.66.12.974.207L15.1.408a13 13 0 0 0-1.233-.26M7.699.795c-.393.154-.773.32-1.146.514l1.166 2.273q.443-.22.894-.4zm8.608.007l-.92 2.38q.472.179.914.407l1.146-2.28c-.366-.187-.746-.36-1.14-.507M5.46 1.935a11 11 0 0 0-1.02.74l1.607 1.98c.26-.2.527-.4.807-.58zm13.062 0l-1.38 2.147q.42.27.8.58l1.62-1.973a13 13 0 0 0-1.04-.754m-6.528 1.56c-1.167 0-2.253.22-3.32.674a8.4 8.4 0 0 0-2.707 1.82A8.3 8.3 0 0 0 4.16 8.703c-.467 1.04-.674 2.14-.674 3.307c0 1.154.207 2.254.674 3.307a8.5 8.5 0 0 0 1.807 2.7a8.4 8.4 0 0 0 2.7 1.82a8.5 8.5 0 0 0 3.32.674a8.4 8.4 0 0 0 3.308-.673a8.8 8.8 0 0 0 2.714-1.82a8.5 8.5 0 0 0 1.806-2.7a8.2 8.2 0 0 0 .687-3.308a8 8 0 0 0-.68-3.307c-.413-1.04-1.04-1.934-1.807-2.714a8.6 8.6 0 0 0-2.713-1.82a8.4 8.4 0 0 0-3.308-.673zm8.495.027l-1.814 1.794c.234.24.46.487.674.753l1.98-1.62a11 11 0 0 0-.84-.927m-16.99.007q-.437.44-.826.92l1.994 1.6q.302-.378.653-.727zm8.489.667a7.6 7.6 0 0 1 3.033.606c.947.4 1.76.96 2.474 1.68c.72.72 1.28 1.548 1.68 2.474a7.7 7.7 0 0 1 .627 3.054a7.7 7.7 0 0 1-.62 3.034c-.4.927-.96 1.76-1.68 2.48a7.8 7.8 0 0 1-2.474 1.68a7.8 7.8 0 0 1-3.034.607a7.9 7.9 0 0 1-3.033-.607c-.947-.4-1.76-.96-2.494-1.68a7.8 7.8 0 0 1-1.66-2.48A7.7 7.7 0 0 1 4.2 12.01c0-1.073.193-2.08.607-3.054c.386-.926.96-1.76 1.66-2.473a7.9 7.9 0 0 1 2.487-1.68a7.6 7.6 0 0 1 3.034-.607m0 .686q-2.95.001-5.021 2.094C5.56 8.363 4.873 10.043 4.873 12.01c0 1.947.687 3.627 2.094 5c1.374 1.388 3.054 2.094 5.02 2.094c1.948 0 3.628-.706 5.021-2.093c1.394-1.374 2.074-3.054 2.074-5.001c0-1.967-.687-3.647-2.074-5.034c-1.393-1.387-3.067-2.094-5.02-2.094m10.074.587l-2.14 1.394c.187.273.347.56.494.853l2.273-1.167a11 11 0 0 0-.627-1.08m-20.136.007c-.226.353-.44.713-.633 1.093l2.274 1.16c.16-.306.326-.593.506-.873zm10.062.106c1.76 0 3.273.62 4.54 1.887c1.247 1.247 1.854 2.747 1.854 4.541c0 1.76-.607 3.274-1.854 4.52c-1.26 1.248-2.78 1.868-4.54 1.868c-1.774 0-3.294-.62-4.52-1.867c-1.261-1.247-1.888-2.767-1.888-4.521c0-1.787.627-3.294 1.887-4.54c1.234-1.26 2.747-1.888 4.52-1.888zm0 .72c-1.567 0-2.927.547-4.04 1.66c-1.121 1.121-1.661 2.461-1.661 4.041c0 1.567.54 2.907 1.66 4.028s2.474 1.68 4.04 1.68c1.58 0 2.908-.56 4.028-1.674q1.68-1.678 1.68-4.027q0-2.37-1.68-4.04c-1.12-1.12-2.44-1.667-4.027-1.667zM12 7.01q.129 0 .259.006c1.36.067 2.507.627 3.434 1.647c.927 1.013 1.36 2.213 1.28 3.587c-.047 1.387-.607 2.54-1.627 3.467c-1.04.927-2.24 1.36-3.614 1.28q-2.078-.118-3.467-1.626c-.913-1.04-1.34-2.234-1.28-3.628c.08-1.373.62-2.527 1.66-3.447c.944-.869 2.07-1.286 3.355-1.286m11.2.68l-2.386.926q.178.452.306.934l2.467-.654c-.106-.413-.24-.813-.386-1.207zM.786 7.71c-.147.386-.28.78-.387 1.186l2.467.66c.087-.32.194-.633.307-.94zm11.222.133c-.16 0-.314.013-.467.026v8.262h.007c.14.033.3.033.46.033s.32 0 .46-.033h.006V7.869c-.153-.013-.306-.026-.466-.026m-1.407.233a4 4 0 0 0-.927.467v6.907c.007.007.013.007.02.014c.28.187.593.347.907.453zm2.814.007v7.841a4 4 0 0 0 .926-.467v-6.9q-.438-.301-.926-.474m-4.668 1.32a4.03 4.03 0 0 0-.907 2.594c0 .726.16 1.393.494 1.967a4 4 0 0 0 .413.633zm6.521.013v5.174c.16-.193.294-.406.414-.613c.32-.587.473-1.254.473-1.967c0-.987-.287-1.854-.887-2.594m-15.129.707c-.06.414-.106.827-.126 1.247l2.547.133q.028-.498.106-.987zm23.71 0l-2.52.4c.047.327.087.654.107.987v.007l2.547-.134v-.006c-.02-.427-.067-.84-.134-1.254m-2.407 2.367c-.026.34-.06.674-.113 1l2.527.394c.067-.414.107-.834.133-1.26zm-18.876.013l-2.547.134c.02.42.067.827.127 1.227l2.52-.4a7 7 0 0 1-.1-.96zm18.563 1.947c-.087.32-.193.634-.307.94l2.387.914q.222-.588.394-1.207zm-18.256.014l-2.467.653q.16.609.38 1.187l2.387-.9a13 13 0 0 1-.3-.94m.7 1.827L1.3 17.458q.28.55.62 1.073l2.147-1.38q-.262-.41-.494-.86m16.843.006a8 8 0 0 1-.494.854l2.14 1.393q.342-.532.634-1.093zm-15.77 1.64l-1.98 1.614q.4.492.84.934l1.814-1.8a9 9 0 0 1-.673-.747zm14.683.014q-.302.392-.654.733l1.8 1.807q.448-.45.847-.94zm-13.276 1.4l-1.613 1.98q.49.4 1.02.74l1.4-2.133c-.28-.187-.546-.38-.807-.587m11.882 0a8 8 0 0 1-.78.574l1.38 2.146q.531-.35 1.02-.74zM7.706 20.425l-1.16 2.273c.373.187.76.36 1.153.514l.9-2.387a10 10 0 0 1-.893-.4m8.588 0c-.293.146-.594.28-.9.393l.9 2.394c.4-.154.78-.327 1.16-.514zm-6.734.706l-.667 2.467q.6.16 1.22.26l.407-2.52a9 9 0 0 1-.96-.207m4.887 0c-.32.087-.647.154-.973.207l.4 2.52a13 13 0 0 0 1.226-.26zm-2.94.307l-.147 2.547q.628.03 1.267 0l-.134-2.547q-.498.03-.986 0"></svg:path>`,
})
export class SimpleIconsPreziIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrimeIcon],svg[simple-icons-prime-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrimereactIcon],svg[simple-icons-primereact-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.01 0c-1.212 0-2.297.62-2.903 1.66l-1.52 2.608H4.303A3.29 3.29 0 0 0 1.43 5.911a3.23 3.23 0 0 0 0 3.285l1.642 2.819l-1.646 2.825a3.2 3.2 0 0 0 0 3.261a3.27 3.27 0 0 0 2.851 1.631h2.925l.865.856L9.09 22.34A3.32 3.32 0 0 0 11.991 24c1.211 0 2.296-.62 2.902-1.66l.816-1.4l1.22-1.208h2.77a3.29 3.29 0 0 0 2.87-1.643c.6-1.028.6-2.256 0-3.285l-1.642-2.82l1.646-2.824a3.2 3.2 0 0 0 0-3.261a3.27 3.27 0 0 0-2.851-1.631H16.43L14.91 1.66A3.32 3.32 0 0 0 12.01 0m0 .719c.948 0 1.798.486 2.273 1.3l1.31 2.249H8.425l1.31-2.248A2.6 2.6 0 0 1 12.01.719m.33 4.265v7.74h.962l5.904-2.174l.014-.057l.87 1.492l-1.33 2.282l.171-3.173l-1.51.543l-1.51 1.494l-1.237-.27l.962 1.357v4.212l1.452-1.296l-.708 1.216v.001l-.744.622v.654l-.412.708V14.49l-1.098-1.63l-.687.407h-2.746l-.687-.407l-1.098 1.63v6.101l-.412-.706v-.912l-1.036-.867l-.729-1.25l1.765 1.574v-4.212l.961-1.358l-1.236.271l-1.51-1.494l-1.511-.543l.188 3.455l-1.477-2.534l.942-1.617l.122-.208l.088.36l5.904 2.174h.824V4.985Zm1.512 0h.412l.96 2.17l1.935-.2l.237.406l-2.452.192zm-3.985.001h.412L9.187 7.552l-2.556-.205l.072-.124l.001.001l.163-.28l2.04.21Zm-5.565.001h2.867L5.831 7.282l-1.592-.127l.49 2.018l-1.237 2.124l-1.433-2.46a2.52 2.52 0 0 1 0-2.567a2.57 2.57 0 0 1 2.243-1.284m12.547 0h2.873c.928 0 1.759.476 2.223 1.272a2.5 2.5 0 0 1 0 2.543l-1.437 2.466l-1.042-1.789l.563-2.323l-1.833.143Zm3.659 7.718l1.433 2.46a2.52 2.52 0 0 1 0 2.566a2.57 2.57 0 0 1-2.243 1.283h-2.277V18zm-17.016.03l3.22 5.525v.754H4.277a2.55 2.55 0 0 1-2.223-1.27a2.5 2.5 0 0 1 0-2.544z"></svg:path>`,
})
export class SimpleIconsPrimereactIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrimevideoIcon],svg[simple-icons-primevideo-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPrismicIcon],svg[simple-icons-prismic-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProbotIcon],svg[simple-icons-probot-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProcesswireIcon],svg[simple-icons-processwire-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProgateIcon],svg[simple-icons-progate-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M10.056 24a17 17 0 0 1-3.457-.698c-1.244-.364-2.899-1-2.913-2.319c0-.946.54-1.755 1.675-2.477a16 16 0 0 1 1.6-.844a40 40 0 0 1 2.2-.928V4.98l-4.41-.476v12.652a.85.85 0 0 1-.895.846a.85.85 0 0 1-.904-.846V3.496a.906.906 0 0 1 .904-.903a1 1 0 0 1 .096.014l6.198.67a.9.9 0 0 1 .8.9v11.826a61 61 0 0 0 2.399-1.03c2.27-1.036 3.799-2.091 4.668-3.237c1.056-1.374 1.218-3.075 1.168-4.259a6.26 6.26 0 0 0-1.254-3.515a5.5 5.5 0 0 0-2.095-1.725a6.2 6.2 0 0 0-1.663-.486c-.6-.082-.896-.51-.864-.938s.384-.75.888-.8c.863-.071 1.503.147 2.375.536a7.76 7.76 0 0 1 2.86 2.32a8.17 8.17 0 0 1 1.6 4.522a9 9 0 0 1-.485 3.481a7.4 7.4 0 0 1-1.088 1.966c-1.584 2.065-4.39 3.34-5.31 3.764c-.868.4-2.8 1.2-3.18 1.352V23.1a.9.9 0 0 1-.31.682a.92.92 0 0 1-.567.218zm-.896-5.318c-.552.2-1.4.512-1.72.66c-.32.147-1.215.565-1.61.91c-.1.085-.417.385-.339.629s.446.374 1.904.766c.518.14 1.125.274 1.765.4z"></svg:path>`,
})
export class SimpleIconsProgateIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProteusIcon],svg[simple-icons-proteus-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProtocolsdotioIcon],svg[simple-icons-protocolsdotio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M4.55.927c-.723.046-1.266.47-1.614 1.261a5 5 0 0 0-.215.6a11 11 0 0 0-.42 3.585c.052 1.007-.187 1.888-.6 2.797C.858 11.024.27 12.967.03 15.004c-.136 1.164.169 2.15 1.13 2.871c.41.308.834.603 1.28.855c1.24.702 2.573 1.192 3.924 1.634a.8.8 0 0 1 .297.162c1.12 1.033 2.423 1.75 3.846 2.276c1.011.373 2.005.364 3.016-.01c1.057-.391 2.089-.853 2.944-1.576c.76-.642 1.612-1.011 2.527-1.334c1.307-.462 2.566-1.037 3.69-1.872c.934-.695 1.413-1.596 1.298-2.778c-.023-.238-.04-.476-.076-.712c-.3-1.942-.888-3.802-1.705-5.58c-.356-.776-.658-1.524-.441-2.403c-.075-.856-.128-1.726-.233-2.588c-.083-.687-.24-1.365-.574-1.983c-.442-.82-1.126-1.164-2.037-1c-.32.057-.642.144-.94.273c-1.61.698-2.904 1.8-3.95 3.198c-.1.137-.194.184-.368.182a190 190 0 0 0-3.329-.002c-.144 0-.24-.014-.334-.144c-.623-.877-1.389-1.615-2.256-2.247c-.735-.536-1.51-1-2.406-1.22a2.6 2.6 0 0 0-.783-.08zm.096 1.152q.13-.002.292.04a4.5 4.5 0 0 1 .996.357c1.43.747 2.596 1.793 3.443 3.174c.088.144.178.186.338.178c.904-.042 1.806-.097 2.71-.103c.62-.004 1.24.06 1.86.103c.164.012.25-.04.337-.182c.855-1.387 2.024-2.44 3.469-3.182a4.6 4.6 0 0 1 .973-.348c.43-.107.702.006.863.418c.188.484.352.99.43 1.5c.123.816.166 1.643.226 2.282c-.037.648-.07 1.108-.086 1.569a.7.7 0 0 0 .08.322a21.8 21.8 0 0 1 2.174 6.377c.073.416.077.85.064 1.273c-.013.481-.324.812-.673 1.1c-.873.72-1.888 1.188-2.926 1.602c-.714.284-1.452.51-2.174.775c-.15.055-.3.149-.418.259c-1.224 1.13-2.625 1.94-4.26 2.285c-.37.078-.805.014-1.175-.098c-1.473-.445-2.788-1.18-3.892-2.27a.7.7 0 0 0-.272-.149c-1.35-.43-2.684-.905-3.931-1.588c-.35-.19-.676-.42-1.014-.632c-.81-.51-1.026-1.267-.893-2.166c.355-2.387 1.13-4.632 2.235-6.772a.75.75 0 0 0 .07-.375c-.106-1.522-.064-3.034.293-4.525c.064-.266.162-.529.281-.775c.146-.299.32-.442.58-.449m9.222 6.72c-.354.04-.54.264-.72.72q-.048.126-.081.253c-.197.782-.122 1.563-.025 2.352c.108.89.498 1.492 1.367 1.832c1.379.54 2.11 1.645 2.442 3.047c.08.343.148.688.228 1.068c.39-.138.764-.265 1.135-.404c.998-.373 1.972-.794 2.863-1.39c.15-.1.224-.212.195-.393c-.091-.586-.142-1.18-.273-1.758c-.409-1.806-1.407-3.178-3.08-4.018c-.61-.305-1.222-.614-1.861-.845a9.6 9.6 0 0 0-1.774-.444a1.6 1.6 0 0 0-.416-.02m-4.208.01a2 2 0 0 0-.264.036c-1.57.32-2.996.965-4.298 1.892c-.489.348-.91.766-1.225 1.282c-.727 1.193-1.073 2.5-1.152 3.886c-.01.178.053.288.199.364c.722.375 1.433.777 2.172 1.117c.583.268 1.2.462 1.824.697c.083-.39.15-.737.23-1.08c.331-1.402 1.073-2.48 2.436-3.06c.05-.02.093-.052.143-.069c.723-.249 1.07-.77 1.185-1.516c.143-.919.26-1.829-.03-2.736c-.22-.7-.494-.872-1.22-.812zm2.594 7.503c-.96.045-1.653.137-2.274.505c-.426.254-.559.555-.396.98c.366.951 1 1.69 1.89 2.19c.33.184.685.193 1.02.01c.919-.498 1.555-1.252 1.929-2.22c.14-.365.044-.626-.274-.864c-.147-.11-.312-.219-.486-.266c-.544-.146-1.097-.263-1.409-.335"></svg:path>`,
})
export class SimpleIconsProtocolsdotioIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProtondbIcon],svg[simple-icons-protondb-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProtoolsIcon],svg[simple-icons-protools-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M.505 15.452Q.27 14.63.14 13.762Q.01 12.891.01 12q0-2.49.94-4.673q.94-2.184 2.572-3.804Q5.155 1.902 7.339.938Q9.523 0 12.012 0q2.465 0 4.65.94q2.183.962 3.815 2.583q1.633 1.62 2.572 3.804t.94 4.673q0 .869-.118 1.714q-.118.846-.352 1.644q.21.047.34.07l.13.024l-1.363 3.429l-.188-.012l-.54-.106Q21.1 19.937 20.02 20.9q-1.057.987-2.325 1.668t-2.724 1.056q-1.433.376-2.96.376q-1.55 0-3.005-.376q-1.433-.375-2.7-1.068q-1.269-.693-2.35-1.656q-1.08-.963-1.878-2.16q-.282.094-.434.117l-.153.024l-1.48-3.382l.118.012zM22.744 12q0-2.23-.846-4.18q-.845-1.95-2.301-3.405q-1.456-1.456-3.429-2.301q-1.949-.846-4.156-.846q-2.231 0-4.18.846q-1.973.845-3.429 2.3Q2.947 5.872 2.102 7.82Q1.256 9.77 1.256 12q0 .751.106 1.491t.317 1.444q.892-.516 2.02-1.972q1.127-1.456 1.808-2.912q.352-.728.916-1.597q.54-.869 1.338-1.632q.799-.763 1.855-1.256q1.057-.517 2.396-.517q1.315 0 2.419.587q1.103.587 1.913 1.35t1.304 1.492q.516.727.657.986q.165.282.47.94q.329.633.728 1.361q.4.728.822 1.433q.423.68.798 1.033q.259.258.564.446t.61.329q.212-.728.33-1.48q.117-.751.117-1.526M12.012 22.732q1.338 0 2.583-.305q1.268-.33 2.383-.916q1.116-.587 2.055-1.41q.94-.821 1.668-1.83q-.94-.494-2.173-1.645q-1.233-1.15-2.5-3.358q-.142-.235-.494-.94q-.352-.704-.857-1.455t-1.115-1.339t-1.268-.587q-.681 0-1.386.634q-.704.61-1.303 1.386q-.6.775-1.022 1.503q-.423.704-.54.916q-1.174 2.066-2.477 3.205q-1.304 1.139-2.29 1.656q.728 1.01 1.667 1.831q.963.846 2.079 1.433q1.115.587 2.36.892q1.268.329 2.63.329"></svg:path>`,
})
export class SimpleIconsProtoolsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsProxmoxIcon],svg[simple-icons-proxmox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPterodactylIcon],svg[simple-icons-pterodactyl-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPubgIcon],svg[simple-icons-pubg-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPublonsIcon],svg[simple-icons-publons-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M0 0v24h24V0zm10.34 5.1c.083.014.114.096.156.158c.054.354.1.71.154 1.065c.157-.162.31-.328.49-.464c.867-.666 2.05-.94 3.11-.63c.72.21 1.315.72 1.756 1.316c.187.263.348.547.45.855c.198.582.225 1.206.198 1.815c-.053 1.12-.433 2.244-1.169 3.103a4.03 4.03 0 0 1-2.616 1.41a4.4 4.4 0 0 1-2.188-.317q.029 1.514.038 3.028c.021.465-.021.938.087 1.396c.031.14.123.292.28.308c.302.036.608.013.912.02c.057 0 .13.037.126.101c.004.186.009.373-.004.56c-.046.092-.17.07-.255.072a44 44 0 0 0-4.437 0l-.07-.056c-.004-.22-.063-.467.034-.671c.3-.035.606.02.904-.032c.191-.048.268-.26.295-.434c.04-.32.027-.642.042-.963V8.348c0-.156.006-.31-.008-.465a.9.9 0 0 0-.34-.656c-.203-.158-.438-.265-.662-.388c-.082-.052-.181-.097-.229-.187a1 1 0 0 1 .008-.337c.056-.066.144-.086.219-.122c.73-.315 1.456-.636 2.185-.952c.17-.068.346-.144.533-.144zm1.99 1.146c-.053 0-.104 0-.156.013a2.12 2.12 0 0 0-1.493.86c.005 1.44 0 2.88.003 4.32c.005.327.073.676.302.924c.524.512 1.302.692 2.014.593c.577-.096 1.037-.538 1.279-1.054c.344-.736.395-1.571.335-2.371c-.053-.655-.181-1.312-.449-1.915c-.184-.407-.442-.793-.811-1.054a1.7 1.7 0 0 0-1.024-.313z"></svg:path>`,
})
export class SimpleIconsPublonsIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPugIcon],svg[simple-icons-pug-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPulumiIcon],svg[simple-icons-pulumi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPumaIcon],svg[simple-icons-puma-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPuppeteerIcon],svg[simple-icons-puppeteer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPusherIcon],svg[simple-icons-pusher-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 23.966v-6.017a.04.04 0 0 1 .018-.03l7.732-4.465a.04.04 0 0 0 .018-.031v-1.711a.036.036 0 0 0-.054-.031l-7.66 4.423a.036.036 0 0 1-.054-.031V14.36a.04.04 0 0 1 .018-.03l7.732-4.465a.04.04 0 0 0 .018-.031v-1.71a.036.036 0 0 0-.053-.031l-7.661 4.423a.036.036 0 0 1-.054-.031v-1.711a.04.04 0 0 1 .018-.031L19.75 6.28a.04.04 0 0 0 .018-.03V4.514a.08.08 0 0 0-.035-.062L12.036.01a.07.07 0 0 0-.072 0L10.5.855a.036.036 0 0 0 0 .062l7.661 4.423a.036.036 0 0 1 0 .062l-1.464.845a.08.08 0 0 1-.072 0L8.929 1.804a.08.08 0 0 0-.076 0l-1.46.844a.036.036 0 0 0 0 .062l7.66 4.424a.036.036 0 0 1 0 .062l-1.464.845a.08.08 0 0 1-.076 0L5.821 3.597a.08.08 0 0 0-.076 0l-1.513.876v15.05a.04.04 0 0 0 .018.03l1.482.856a.036.036 0 0 0 .053-.03V5.432a.036.036 0 0 1 .054-.031l1.482.856a.04.04 0 0 1 .018.03v15.029a.04.04 0 0 0 .018.03l1.482.857a.036.036 0 0 0 .054-.032V7.227a.036.036 0 0 1 .054-.031l1.481.855a.04.04 0 0 1 .019.031v15.029a.04.04 0 0 0 .017.03l1.486.856a.036.036 0 0 0 .05-.031"></svg:path>`,
})
export class SimpleIconsPusherIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPycqaIcon],svg[simple-icons-pycqa-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPygIcon],svg[simple-icons-pyg-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m15.649 8.066l-2.65 2.724a1.14 1.14 0 0 0-.531-.18l-.288-2.611a1.15 1.15 0 0 0 .804-.893l2.464.36q0 .08.013.158c.03.159.095.31.188.442m-4.413 3.465H8.67a1.14 1.14 0 0 0-.337-.58l2.806-3.148c.172.135.38.218.597.24l.286 2.616a1.15 1.15 0 0 0-.787.872Zm-6.715-.427l1.886.596q-.015.155.011.31a1.154 1.154 0 0 0 1.347.919q.093-.018.18-.053l2.46 3.033a1.14 1.14 0 0 0-.23.837l-2.73.904a1.15 1.15 0 0 0-1.143-.583l-2.168-5.542a1.14 1.14 0 0 0 .387-.42Zm3.064 7.07c0-.034-.008-.068-.008-.103l2.732-.907a1.15 1.15 0 0 0 2.067-1.002l2.589-1.664c.139.174.326.305.538.374l-.319 3.825c-.03.008-.06.002-.09.008a1.15 1.15 0 0 0-.856.708zM9.464 4.729l1.487 1.456c-.212.26-.298.6-.237.93q.037.188.135.354l-2.9 3.255a1.135 1.135 0 0 0-1.42.555l-1.872-.592a1.2 1.2 0 0 0-.008-.341a1.14 1.14 0 0 0-.258-.53l3.883-4.88a1.14 1.14 0 0 0 1.19-.206Zm7.212 3.827a.97.97 0 0 0 .54-.175l3.208 3.35a1.14 1.14 0 0 0-.206.703l-3.359.783a1.15 1.15 0 0 0-.69-.538l.504-4.123zm1.175-4.003l-.929 1.754a1.135 1.135 0 0 0-1.415.723l-2.532-.373a1.135 1.135 0 0 0-1.681-.763L9.735 4.375q.079-.159.103-.334l7.613-.134c.056.254.197.482.4.645Zm-3.058 8.815a1.14 1.14 0 0 0-.064.637c.007.033.022.067.032.103l-2.63 1.692a1.2 1.2 0 0 0-.397-.258l.597-2.633a1.14 1.14 0 0 0 .91-.41zm.858-.719a1.14 1.14 0 0 0-.62.337l-1.574-.879a1.12 1.12 0 0 0-.146-1.011l2.65-2.725q.127.084.273.131l-.505 4.143zm-7.325.001a1.15 1.15 0 0 0 .36-.676h2.548c.071.37.32.683.665.835l-.6 2.65a1 1 0 0 0-.2.018a1.1 1.1 0 0 0-.364.14zM13.9 23.927l-8.674-1.816l1.068-2.767q.18.026.357-.005a1.15 1.15 0 0 0 .863-.73l6.642 1.237c-.002.43.241.822.627 1.012l-.883 3.07Zm-9.041-2.09l-4.82-7.372l2.852-2.947c.246.16.544.22.833.168l2.151 5.52a1.144 1.144 0 0 0 0 2L4.86 21.838Zm16.61-2.668l-7.068 4.62l.804-2.804q.159.017.316-.01c.523-.1.91-.546.935-1.078zm.07-18.79L24 12.717l-1.483-.31a1.15 1.15 0 0 0-1.285-1.159l-2.104-6.58a1.15 1.15 0 0 0 .58-1.22a1.13 1.13 0 0 0-.25-.515zm2.432 12.783l-1.977 5.48l-5.604.814a1.1 1.1 0 0 0-.201-.352l4.639-5.697c.594.322 1.338.06 1.598-.565zM0 13.87L1.773 5.4l5.86-1.105c.06.15.152.287.268.4L4.046 9.54a1.14 1.14 0 0 0-.742-.115a1.154 1.154 0 0 0-.92 1.342c.03.16.095.312.189.445zm20.737-2.444l-3.212-3.35a1.135 1.135 0 0 0-.215-1.556l.93-1.755c.15.047.31.061.468.043l2.104 6.581zM21.199.1l-2.08 2.557a1.135 1.135 0 0 0-1.51.385L10.21.073L21.2.099ZM2.306 4.848L9.387.218l8.059 3.233v.014L9.822 3.6a1.15 1.15 0 0 0-2.27.26l-5.246.989Zm13.536 13.976a1.2 1.2 0 0 0-.225-.091l.32-3.808a1 1 0 0 0 .135-.012a1.15 1.15 0 0 0 .929-1.28l3.316-.768q.066.143.167.263z"></svg:path>`,
})
export class SimpleIconsPygIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPypiIcon],svg[simple-icons-pypi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPypyIcon],svg[simple-icons-pypy-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.947 0q-.15 0-.3.016a2.7 2.7 0 0 0-1.27.447c-.164.009-.324.038-.488.053c-1.78.279-3.037 1.197-3.92 2.286c-1.702 2.515-1.711 6.092-1.481 8.471a6.55 6.55 0 0 1 1.86-3.765c.069-.069.15-.136.22-.217l.034-.034q.134-.117.272-.228a9 9 0 0 1 .416-.309c.028-.014.056-.027.084-.055l.436-.273l.03-.016l.068-.035a5 5 0 0 1 .478-.225c.029-.014.07-.029.098-.043c.127-.056.268-.098.395-.14l-.008-.006l.022-.008a2 2 0 0 0-.268-.238a1.8 1.8 0 0 0-.731-.268a3.3 3.3 0 0 0-.829-.041a4.4 4.4 0 0 0-.799.115c.248-.102.497-.19.77-.242c.279-.07.573-.111.88-.112c.265 0 .55.036.82.135l.002.004c.028.014.042.015.07.03c.07.028.155.069.225.11l.026.018l.002.012c.14.084.268.196.394.323l.014.013l.01-.002a2.82 2.82 0 0 0 2.407.944l.254-.04h.041l.557-.114c1.867-.435 2.185-.507 3.135-1.036c.4-.321.562-.548.63-.762c.07-.217.055-.455.073-.797l-.002.01c-.001-.374-.282-.8-.696-1.22c-.41-.417-.932-.824-1.366-1.196c-.53-.374-.785-.718-1.031-.973a1.7 1.7 0 0 0-.63-.434A2.8 2.8 0 0 0 12.947 0m2.362.934c.12.113.231.224.405.346l.008.004l.005.006c.425.365.963.78 1.402 1.225s.795.93.797 1.465v.004l-.002.006c-.017.319.008.589-.088.885s-.311.588-.754.94l-.012.01l-.012.008a10 10 0 0 1-.584.303c1.232.485 2.467 1.071 3.808 2.118v-.002c1.21.937 2.345 2.057 3.49 3.74c-.105-5.25-3.649-9.647-8.463-11.058M8.534.98a11.6 11.6 0 0 0-2.155.897q-.105.059-.209.12a11.77 11.77 0 0 0-5.942 10.02c.033 1.843.683 3.221 1.708 4.232c1.061 1.048 2.528 1.703 4.109 2.034c1.585.333 3.247.442 4.743.362a6.2 6.2 0 0 1-1.92-.692a11 11 0 0 1-.55-.322a13 13 0 0 1-.45-.338l-.295-.252a1.7 1.7 0 0 1-.225-.225a6.8 6.8 0 0 1-1.237-1.702c-.028-.056-.056-.126-.084-.182a6.4 6.4 0 0 1-.318-.858c-.104-.294-.318-.938-.489-2.003v-.006c-.299-2.347-.525-6.536 1.464-9.467l.004-.006l.004-.006A6.9 6.9 0 0 1 8.534.98m4.776 3.853q.089-.002.182.004c.492.043.87.282.856.55c-.028.252-.434.436-.926.408c-.492-.042-.872-.282-.858-.55c.012-.233.336-.401.746-.412m2.699 1.491c-.164.061-.451.142-.657.2c1.835 1.094 3.106 3.045 3.215 5.315l.004.068q.005.114.007.233v.04c0 .037-.005.072-.006.108c.101 2.366-.31 3.562-1.291 5.62v.002c-.99 2.092-3.237 4.63-5.012 6.089c6.255-.14 11.293-5.145 11.494-11.384c-1.22-1.9-2.408-3.086-3.696-4.084c-1.43-1.117-2.725-1.7-4.058-2.207m2.104 8.256c-.045.118-.087.238-.138.352c-.029.056-.056.126-.084.182a6.5 6.5 0 0 1-1.462 1.927l-.295.252c-.14.112-.295.225-.45.338a5 5 0 0 1-.549.322c-.183.1-.375.185-.568.268v.002l-.016.006a7 7 0 0 1-.412.154c-2.013.742-5.2.867-8.166.244c-1.63-.341-3.157-1.02-4.282-2.13a6 6 0 0 1-1.164-1.625C1.703 20.009 6.232 23.859 11.694 24c1.76-1.35 4.256-4.096 5.27-6.241v-.002c.598-1.253.97-2.146 1.15-3.178z"></svg:path>`,
})
export class SimpleIconsPypyIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPyscaffoldIcon],svg[simple-icons-pyscaffold-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPythonIcon],svg[simple-icons-python-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPythonanywhereIcon],svg[simple-icons-pythonanywhere-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M11.435 20.69c-.09-.11-.219-.182-.328-.255c-.092-.055-.128-.11-.11-.238c.183-1.077.347-2.154.511-3.25c.11-.73.22-1.46.347-2.227c.165.11.329.22.475.329c.036.036.018.091.018.128c-.036.255-.073.53-.128.785l-.273 1.77l-.274 1.753c-.019.146-.037.31-.073.457c.073.018.11-.037.164-.055c1.387-.73 2.775-1.442 4.163-2.173l.11-.054c.036-.019.072-.037.109 0c.146.09.292.2.456.31c-.073.036-.11.073-.164.091c-1.607.84-3.195 1.68-4.802 2.52c-.055.018-.11.036-.128.091zm-4.874-9.858c-.037.292-.091.547-.128.803c-.128.84-.274 1.661-.402 2.501c-.073.493-.164.986-.237 1.479c-.018.091-.055.128-.128.146c-.146.036-.31.091-.456.146c-.018-.037 0-.073 0-.11c.146-.912.292-1.807.438-2.72c.146-.876.274-1.77.42-2.647c.018-.073.036-.128.128-.146c.127-.037.237-.073.365-.11c.073-.036.128-.018.2.037l.932.93c.986.987 1.99 1.973 2.976 2.94c.018.019.036.055.073.073c-.183.073-.366.11-.53.183c-.055.018-.091-.037-.11-.055c-.237-.237-.474-.475-.73-.712a376 376 0 0 1-2.702-2.684c-.036 0-.054-.018-.11-.054m4.748 2.83a8 8 0 0 1-.402-.384c-.037-.037-.018-.091 0-.128c.11-.328.219-.657.347-.986l1.205-3.45a.3.3 0 0 0 .036-.128c-.073-.018-.128.018-.182.036c-1.497.475-2.976.932-4.473 1.406c-.238.073-.165.092-.329-.073l-.274-.274c.037-.054.11-.054.165-.073c1.734-.547 3.468-1.095 5.185-1.643c.127-.036.2-.018.292.073c.054.073.146.146.219.22c.073.054.073.127.054.2c-.2.548-.383 1.096-.584 1.643c-.401 1.15-.803 2.3-1.205 3.433a.3.3 0 0 1-.054.127m-.31 1.15a5 5 0 0 0-.074.53c0 .073-.055.073-.11.091c-.401.128-.784.256-1.168.365c-1.132.366-2.282.712-3.414 1.078c-.036.018-.091.036-.146.054a.3.3 0 0 0 .146.11c1.278.876 2.556 1.77 3.834 2.647c.11.073.183.146.128.292c-.037.128-.037.256-.073.384c-.055 0-.091-.037-.128-.055C8.496 19.284 7 18.244 5.502 17.22c-.091-.073-.128-.127-.11-.255c.019-.11.055-.201.055-.31c0-.092.055-.128.128-.147c1.77-.566 3.56-1.113 5.33-1.68c.02 0 .056 0 .092-.017M6.944 3.62c-.018.183-.055.365-.073.53c0 .073-.073.073-.128.073c-.328.11-.675.2-1.004.31c-1.205.365-2.391.73-3.596 1.095c-.037.019-.092.019-.128.073c.055.037.091.073.146.11c1.278.895 2.538 1.807 3.816 2.702c.09.073.127.128.11.256a3 3 0 0 0-.074.42c-.055-.019-.091-.055-.146-.074L1.431 5.994c-.11-.074-.146-.147-.11-.256c.018-.11.037-.2.055-.31c0-.073.036-.11.128-.147l1.26-.383c1.35-.402 2.683-.821 4.034-1.223c.037-.037.091-.037.146-.055m5.477 3.725c-.146.054-.292.09-.438.146c-.091.036-.164.018-.237-.055c-.493-.511-1.004-1.004-1.516-1.516a184 184 0 0 0-1.825-1.807c-.037-.036-.055-.091-.128-.11a6 6 0 0 0-.091.566c-.146.859-.274 1.717-.42 2.556c-.092.548-.183 1.078-.256 1.625c-.018.092-.036.128-.128.146c-.146.037-.31.092-.456.146c-.018-.11.018-.2.036-.273l.548-3.396c.091-.603.201-1.205.292-1.808c.019-.073.037-.11.11-.127c.128-.037.237-.073.365-.11c.091-.037.146-.018.219.055l1.46 1.46c.786.785 1.589 1.57 2.374 2.355c.018.037.073.073.091.147m.672 7.755a3.7 3.7 0 0 1-.13-.76c-.115-.959-.014-1.885.36-2.774c.572-1.388 1.56-2.417 2.904-3.073a8 8 0 0 1 2.116-.676c.05.059.027.13.023.185l.032.332c.013.074-.026.108-.1.12c-.484.113-.97.262-1.423.469c-1.228.536-2.164 1.367-2.76 2.57a4.95 4.95 0 0 0-.526 2.544c.02.24.04.478.078.719c.013.074.009.129-.085.159a4 4 0 0 0-.489.185m2.53 1.77c.013-.183.006-.348.02-.53c.004-.073.025-.108.117-.12c.481-.076.947-.19 1.382-.397c1.606-.712 2.66-1.92 3.09-3.628c.177-.683.207-1.376.146-2.076c.002-.036-.012-.092-.01-.129c.006-.072-.06-.169-.002-.22c.04-.052.131-.045.205-.058c.13-.028.242-.057.373-.102c.057.242.075.5.077.737a7.3 7.3 0 0 1-.054 1.552a5.65 5.65 0 0 1-1.478 3.081c-.87.928-1.953 1.492-3.179 1.754a2.8 2.8 0 0 1-.687.135m5.343-10.442c.054.004.075-.032.113-.047a54 54 0 0 1 2.265-1.251c.039-.034.095-.048.147-.008c.157.102.333.206.509.31a.6.6 0 0 1-.134.082c-.95.501-1.917.983-2.867 1.483a1 1 0 0 0-.195.17c-.349.543-.718 1.103-1.067 1.646c-.062.105-.062.105-.167.043c-.106-.063-.193-.124-.299-.186s-.105-.062-.044-.15l.677-1.05c.143-.21.268-.42.41-.63a.37.37 0 0 0 .07-.197a182 182 0 0 1 .211-3.297c.142.064.263.164.405.23c.16.083.19.177.176.36a76 76 0 0 0-.16 2.038c-.01.145-.039.29-.05.454m-3.882 4.468c-.018.255-.316.6-.575.637a.46.46 0 0 1-.465-.16a.43.43 0 0 1-.077-.463a.87.87 0 0 1 .436-.482a.45.45 0 0 1 .474.033c.156.12.238.255.207.435m1.856 1.21c-.018.255-.317.6-.577.655c-.186.042-.328-.023-.464-.16a.4.4 0 0 1-.08-.445c.09-.232.23-.405.457-.5c.322-.16.688.104.664.45M.883 6.432c.164.091.292.2.456.31c.055.037.037.091.019.146l-.165 1.04c-.2 1.242-.401 2.465-.602 3.707c0 .036-.037.091 0 .146c.055-.037.11-.055.164-.091l4.108-2.246c.11-.055.182-.055.274.018c.11.092.219.165.347.256c-.037.055-.092.073-.128.091c-1.589.877-3.177 1.735-4.747 2.61c-.11.056-.183.074-.274-.017c-.073-.073-.164-.128-.255-.183c-.073-.036-.092-.091-.073-.164c.073-.438.146-.858.2-1.296c.22-1.388.457-2.776.676-4.163a.25.25 0 0 1 0-.164"></svg:path>`,
})
export class SimpleIconsPythonanywhereIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQatarairwaysIcon],svg[simple-icons-qatarairways-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M18.633 13.143q.016.425-.006.84c-2.752.11-5.362.274-5.362.462c0 .183 2.552.347 5.27.454a7 7 0 0 1-.186.924c-2.68.11-5.17.273-5.17.456c0 .174 2.326.33 4.897.44q-.175.494-.396.954c-2.21.105-4.04.247-4.04.402c0 .145 1.595.279 3.609.38a10 10 0 0 1-.354.536q-.2.277-.422.55c-1.26.094-2.123.203-2.123.32c0 .1.616.193 1.568.276a9 9 0 0 1-1.856 1.414s-.854-.733-1.557-1.592c-.63-.764-1.96-2.78-2.271-3.229c-.314-.451-.52-.585-.887-.453c-.491.173-1.063.26-1.238.26s-.271-.067.025-.184c.291-.118 1.45-.665 2.023-1.799c.64-1.274.077-3.033.077-3.033c-.216.94-.705 1.29-.705 1.29c.159-.872-.014-1.664-.446-2.22l-.24 1.107s-.15-.01-.525.304c-.37.314-.474.77-.474.77c.296.12.644-.176.644-.176c-.446 1.685-1.093 3.054-1.562 3.78c-.472.724-.856.998-1.33 1.19c-.396.159-.529-.028-.529-.028a7 7 0 0 1-.878-.902s-.021-.04.05-.036c.196.003.54-.327.616-.467c.084-.158.078-.277.033-.286c-.04-.007-.115.119-.492.353c-.37.236-.537.074-.665-.06c-.093-.1 0-.232.057-.312c.06-.074 2.025-3.736 7.222-7.588c6.822-5.045 11.171-6.405 11.42-6.505c.166-.065.434-.15.496-.088c.065.071.1.128.088.211c-.008.082-.05.123-.363.262c-2.62 1.154-5.674 3.073-7.408 4.191c-2.136 1.04-4.172 2.525-4.245 2.561c-.164.101-.046.25.058.188c3.6-2.397 7.826-4.03 12.498-5.368c.22-.062.342-.062.382-.014a.4.4 0 0 1 .064.187c.006.084-.064.13-.258.206c-5.011 1.864-8.71 3.592-11.091 5.194c0 0-.245.146-.248.318c0 .065.132.073.132.073c1.19.021 2.784.092 3.538.136c0 0-.104.384-.83.692c-.56.24-1.077.202-1.592.204c-.117 0-.21.112-.122.238c.047.06 1.14 1.816 5.104 2.217m-9.09 3.693c-.539.193-1.177.296-1.437.296c-.451 0-1.189.25-1.45.476a337 337 0 0 0 3.413-.069l-.322-.472a1.6 1.6 0 0 0-.187-.236c-.01.003-.008 0-.016.005M2.92 8.682c1.43 0 4.068-.035 6.675-.095q.445-.358.928-.718C7.633 7.796 4.52 7.75 2.92 7.75c-.676 0-1.226.21-1.226.466c0 .257.55.465 1.226.465m.407-2.247c0 .202.433.366.965.366c1.631 0 5.267-.059 7.918-.15c.198-.138.395-.279.591-.411a283 283 0 0 0-8.509-.171c-.532 0-.965.164-.965.366m11.784 5.069c.29.173.647.348 1.085.508c1.387-.07 2.28-.147 2.28-.23c0-.1-1.374-.195-3.365-.278m-13.018-.982c1.214 0 3.196-.023 5.36-.064q.466-.447.991-.906a352 352 0 0 0-6.351-.082c-.762 0-1.378.236-1.378.526s.616.526 1.378.526m13.8-2.448a31 31 0 0 0-.606.322c1.023-.055 1.67-.115 1.67-.179c0-.05-.402-.097-1.063-.143m-9.433-2.8c1.556 0 6.286-.116 6.286-.258c0-.145-4.732-.261-6.286-.261c-.301 0-.547.116-.547.26c0 .143.246.26.547.26M16.645 9.95a1 1 0 0 1-.095.218c.862-.054 1.391-.113 1.391-.173c0-.058-.479-.113-1.264-.165zm-5.878 8.619c-2.952-.077-6.2-.124-7.846-.124c-.676 0-1.226.209-1.226.466c0 .256.55.465 1.226.465c1.735 0 5.237-.053 8.314-.137q-.235-.331-.468-.67m1.402 1.905c-2.654-.09-6.254-.148-7.876-.148c-.532 0-.965.164-.965.367c0 .2.433.364.965.364c1.702 0 5.575-.062 8.245-.161a13 13 0 0 1-.37-.422m-6.253 1.638c0 .142.246.262.547.262c1.554 0 6.286-.12 6.286-.262s-4.73-.258-6.286-.258c-.301 0-.547.115-.547.258m-2.798-6.218c.028-.13.087-.274.205-.43c-.017.02-.024.039-.006.007c.106-.183.244-.41.419-.671c-.814-.009-1.53-.014-2.093-.014c-.808 0-1.465.25-1.465.558s.657.558 1.465.558c.415 0 .915-.003 1.475-.008m1.2 1.748c-.198-.193-.862-.957-.943-1.03c-.483-.003-.918-.006-1.28-.006c-.762 0-1.378.234-1.378.527c0 .288.616.525 1.378.525c.587 0 1.348-.007 2.223-.016m-.105-3.532c.243-.327.517-.692.839-1.084c-1.427-.019-2.678-.03-3.556-.03c-.827 0-1.495.254-1.495.567s.668.568 1.495.568c.698 0 1.644-.007 2.717-.02m-2.57-1.771c.97 0 2.404-.015 4.025-.039c.298-.327.607-.67.949-1.023a299 299 0 0 0-4.974-.052c-.808 0-1.465.246-1.465.556s.657.558 1.465.558"></svg:path>`,
})
export class SimpleIconsQatarairwaysIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQbittorrentIcon],svg[simple-icons-qbittorrent-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQemuIcon],svg[simple-icons-qemu-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQiitaIcon],svg[simple-icons-qiita-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M3.57 8.343a3.7 3.7 0 0 0-1.376.269a3.6 3.6 0 0 0-1.14.738a3.5 3.5 0 0 0-.773 1.102A3.3 3.3 0 0 0 0 11.814a3.3 3.3 0 0 0 .281 1.357a3.5 3.5 0 0 0 .775 1.107A3.64 3.64 0 0 0 3.6 15.29a3.7 3.7 0 0 0 .987-.13a3.7 3.7 0 0 0 .888-.374l.687.698a.58.58 0 0 0 .824 0a.58.58 0 0 0 0-.817l-.624-.624a3.5 3.5 0 0 0 .613-1.022a3.3 3.3 0 0 0 .226-1.208a3.3 3.3 0 0 0-.282-1.362a3.5 3.5 0 0 0-.775-1.102A3.6 3.6 0 0 0 5 8.612a3.7 3.7 0 0 0-1.398-.27h-.031zm11.306.185v1.484h-.765v1.063h.765v2.142q0 .628.159 1.028a1.56 1.56 0 0 0 .433.63a1.5 1.5 0 0 0 .643.317a2.7 2.7 0 0 0 .694.086h.853v-1.013h-.736a1.3 1.3 0 0 1-.352-.048a.7.7 0 0 1-.291-.169a.8.8 0 0 1-.2-.324a1.6 1.6 0 0 1-.074-.519v-2.13h1.666v-1.063h-1.66V8.528zM9.4 8.856a.69.69 0 0 0-.69.691a.69.69 0 0 0 .69.69a.69.69 0 0 0 .691-.69a.69.69 0 0 0-.69-.691zm2.771 0a.69.69 0 0 0-.69.691a.69.69 0 0 0 .69.69a.69.69 0 0 0 .691-.69a.69.69 0 0 0-.69-.691zm-8.6.538h.03a2.35 2.35 0 0 1 .93.187a2.35 2.35 0 0 1 1.264 1.28a2.5 2.5 0 0 1 .186.957a2.4 2.4 0 0 1-.186.957a2.4 2.4 0 0 1-.506.767a2.36 2.36 0 0 1-1.688.698a2.3 2.3 0 0 1-.93-.186a2.4 2.4 0 0 1-.755-.512a2.43 2.43 0 0 1-.699-1.723a2.44 2.44 0 0 1 .699-1.727a2.4 2.4 0 0 1 .756-.511a2.3 2.3 0 0 1 .898-.187zm17.648.773a2.7 2.7 0 0 0-1.02.201a2.5 2.5 0 0 0-.815.552a2.4 2.4 0 0 0-.525.814a2.7 2.7 0 0 0-.186.998a2.6 2.6 0 0 0 .186.997a2.5 2.5 0 0 0 .525.814a2.4 2.4 0 0 0 .815.546a2.7 2.7 0 0 0 1.059.2a2.4 2.4 0 0 0 .518-.056a2.5 2.5 0 0 0 .46-.146a2.4 2.4 0 0 0 .394-.213a2.4 2.4 0 0 0 .329-.263l.065.53H24v-4.829h-.976l-.068.533a2.5 2.5 0 0 0-.322-.26a2.3 2.3 0 0 0-.394-.217a2.6 2.6 0 0 0-.462-.145a2.4 2.4 0 0 0-.521-.056zm-12.375.844v4.138h1.113V11.01zm2.77 0v4.138h1.114V11.01zm9.72.145h.024a1.56 1.56 0 0 1 1.098.445a1.5 1.5 0 0 1 .334.495a1.6 1.6 0 0 1 .121.631a1.6 1.6 0 0 1-.121.64a1.6 1.6 0 0 1-.331.498a1.5 1.5 0 0 1-.49.324a1.64 1.64 0 0 1-1.207 0a1.5 1.5 0 0 1-.493-.324a1.5 1.5 0 0 1-.333-.5a1.6 1.6 0 0 1-.122-.638a1.6 1.6 0 0 1 .12-.637a1.5 1.5 0 0 1 .328-.495a1.5 1.5 0 0 1 .49-.323a1.6 1.6 0 0 1 .581-.116z"></svg:path>`,
})
export class SimpleIconsQiitaIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQiskitIcon],svg[simple-icons-qiskit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQiwiIcon],svg[simple-icons-qiwi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQmkIcon],svg[simple-icons-qmk-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQnapIcon],svg[simple-icons-qnap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M1.316 9.955Q0 9.955 0 11.018v1.95q0 1.057 1.316 1.057h2.57c0-.006.15.005.378-.029c-.215-.309-.612-.643-.983-.912l-.068-.049h-1.6v-2.113h2.131v1.793c.64.2 1.08.455 1.379.7q.075-.194.076-.446v-1.951q0-1.005-1.176-1.06v-.003zm4.965.053q-.232 0-.357.13c-.147.154-.117.347-.131.354v3.518h1.445l-.011-2.406c.006-.036.032-.088.142-.075c0 0 .043.002.06.034c.28.445 2.104 2.447 2.104 2.447h1.5v-4.002H9.57v2.328c-.022.053-.095.044-.13.006c-.259-.4-1.251-1.764-1.569-2.2c-.02-.024-.125-.134-.355-.134Zm6.584 0q-.549 0-.844.23a.77.77 0 0 0-.302.639v3.133h1.527v-1.067h2.14v1.067h1.53v-3.133q0-.407-.297-.639q-.296-.23-.846-.23zm5.918 0q-.549 0-.846.232a.77.77 0 0 0-.302.62v3.15h1.53v-1.045h2.47q1.007.001 1.008-.809v-1.283q-.002-.462-.248-.664c-.28-.222-.743-.188-.704-.201zm4.725.072a.47.47 0 0 0 .023.94a.47.47 0 0 0 .469-.47a.47.47 0 0 0-.469-.47zm.002.068h.021c.222.001.4.182.4.403a.4.4 0 0 1-.4.398a.4.4 0 0 1-.4-.398c0-.214.167-.391.379-.403m-.19.141v.533h.073v-.236q.06-.001.12.002c.033.007.065.046.07.05c.044.059.08.123.12.184h.088l-.092-.144a.4.4 0 0 0-.058-.07a.2.2 0 0 0-.043-.028a.2.2 0 0 0 .113-.049a.144.144 0 0 0 .014-.175c-.022-.036-.056-.067-.166-.067zm.073.059h.168c.15 0 .134.14.058.168c-.074.019-.151.006-.226.01zm-10.147.7h2.14v1.159h-2.14zm5.897 0h1.943v1.038h-1.943zm-16.358 1.54c.48.304 1.352.907 1.64 1.457h1.089c-.186-.331-.814-1.13-2.729-1.457"></svg:path>`,
})
export class SimpleIconsQnapIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQuantcastIcon],svg[simple-icons-quantcast-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQuantconnectIcon],svg[simple-icons-quantconnect-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M23.067 16.664a12.1 12.1 0 0 1-6.404 6.404A12 12 0 0 1 12 24v-2.797a8.6 8.6 0 0 0 3.546-.747a9.5 9.5 0 0 0 2.983-1.927a11.4 11.4 0 0 0 1.927-2.922A9.15 9.15 0 0 0 21.204 12a8.6 8.6 0 0 0-.746-3.545a8.93 8.93 0 0 0-4.911-4.912a9.53 9.53 0 0 0-7.091 0a9.48 9.48 0 0 0-4.911 4.912A9.8 9.8 0 0 0 2.798 12H0a12 12 0 0 1 .932-4.662A12.1 12.1 0 0 1 7.336.933a12.12 12.12 0 0 1 9.326 0a11.5 11.5 0 0 1 3.792 2.609a11.5 11.5 0 0 1 2.613 3.796a12.12 12.12 0 0 1 0 9.326M11.998 9.886V7.089a4.8 4.8 0 0 0-3.483 1.43A4.7 4.7 0 0 0 7.025 12a4.6 4.6 0 0 0 1.49 3.478a4.81 4.81 0 0 0 6.799.165a5 5 0 0 0 .165-.165A4.34 4.34 0 0 0 16.91 12h-2.8a2.06 2.06 0 0 1-.621 1.492a2.02 2.02 0 0 1-1.492.622A2.123 2.123 0 0 1 9.884 12a2.02 2.02 0 0 1 .622-1.492a2.06 2.06 0 0 1 1.492-.621m5.972 8.08a7.04 7.04 0 0 0 1.806-2.676a7.5 7.5 0 0 0 .684-3.296a7.7 7.7 0 0 0-.684-3.295A8.45 8.45 0 0 0 15.3 4.223a7.5 7.5 0 0 0-3.295-.683v2.797a5.3 5.3 0 0 1 3.98 1.679a5.4 5.4 0 0 1 1.677 3.979a5.658 5.658 0 0 1-11.315 0H3.548a8.4 8.4 0 0 0 .616 3.298a9.3 9.3 0 0 0 4.54 4.538a9.04 9.04 0 0 0 6.59 0a8 8 0 0 0 2.676-1.864"></svg:path>`,
})
export class SimpleIconsQuantconnectIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQuasarIcon],svg[simple-icons-quasar-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQubesosIcon],svg[simple-icons-qubesos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m21.893 20.79l-2.289-1.332l1.547-.895a2.4 2.4 0 0 0 1.2-2.08V7.098l-.003-.059a2.4 2.4 0 0 0-1.198-2.027l-3.899-2.255l-4.21-2.436a3 3 0 0 0-.237-.118L12.77.187l-.093-.036l-.052-.019l-.085-.027l-.062-.019l-.079-.02l-.072-.017l-.073-.013l-.079-.013l-.068-.008l-.087-.008l-.063-.004L11.9 0h-.03l-.082.001l-.076.002l-.093.007l-.064.006l-.11.016l-.044.009l-.154.034a2.4 2.4 0 0 0-.602.245L5.536 3.277l-3 1.736a2.41 2.41 0 0 0-1.201 2.083v9.385a2.4 2.4 0 0 0 1.2 2.08l8.108 4.693a2.4 2.4 0 0 0 2.4.002l1.804-1.044l2.302 1.339c1.03.599 2.687.599 3.716 0l1.03-.6c1.027-.597 1.027-1.562-.002-2.161m-10.71-2.695l-4.46-2.583a1.32 1.32 0 0 1-.66-1.143V9.206c0-.236.063-.464.177-.662l.002.001c.116-.2.282-.368.482-.485l4.459-2.58q.139-.079.289-.122l.034-.01q.053-.013.105-.022l.068-.013q.046-.004.093-.006l.083-.004q.054.001.11.007l.058.005q.056.009.11.022q.028.005.055.012q.059.017.115.04l.045.015q.078.033.154.076l4.46 2.58c.198.116.364.283.48.483l.002.003l-.003.002c.116.201.177.43.177.661v5.161q-.002.226-.076.433a1.32 1.32 0 0 1-.583.71l-4.46 2.582a1.31 1.31 0 0 1-1.316 0"></svg:path>`,
})
export class SimpleIconsQubesosIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQuestIcon],svg[simple-icons-quest-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsQzoneIcon],svg[simple-icons-qzone-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRIcon],svg[simple-icons-r-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRadstudioIcon],svg[simple-icons-radstudio-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="m12.147 10.534l.735 1.953h-1.471zm-7.26-1.386c-.403.004-.806 0-1.208 0c-.02 0-.038.002-.062.004v2.096l.048.004c.415 0 .829.006 1.243-.001A1.042 1.042 0 0 0 5.917 9.99a1.05 1.05 0 0 0-1.03-.842m19.097 3.36c-.026.409-.06.818-.113 1.225a11 11 0 0 1-.364 1.674a12 12 0 0 1-.892 2.194a12 12 0 0 1-2.411 3.158a11.95 11.95 0 0 1-7.716 3.235c-.05.002-.855.005-.868.004a12 12 0 0 1-1.452-.133a12 12 0 0 1-1.794-.418a12 12 0 0 1-2.283-.996a12 12 0 0 1-2.913-2.311a11.96 11.96 0 0 1-3.103-6.79a12 12 0 0 1-.073-1.526q.01-.649.087-1.292a11.9 11.9 0 0 1 1.317-4.17a12 12 0 0 1 2.033-2.769a12 12 0 0 1 1.152-1.03A12 12 0 0 1 8.027.677c.481-.17.97-.314 1.47-.411a16 16 0 0 1 1.151-.182a14 14 0 0 1 1.033-.077c.236-.011.473-.001.71.004a11.94 11.94 0 0 1 5.224 1.385A12 12 0 0 1 20.63 3.67a12 12 0 0 1 1.362 1.692a12 12 0 0 1 1.47 3.089q.336 1.083.46 2.21c.068.614.1 1.23.061 1.848M8.016 14.834l-.836-1.983a2.1 2.1 0 0 0-.298-.509c-.071-.087-.149-.17-.22-.252c.09-.104.189-.205.274-.316a2.59 2.59 0 0 0-.142-3.322c-.512-.556-1.156-.83-1.908-.84c-.672-.008-1.345-.003-2.017.002a1 1 0 0 0-.31.055c-.29.1-.482.393-.482.716l.001 6.703q0 .117.027.232a.75.75 0 0 0 .726.581a.77.77 0 0 0 .783-.774v-2.336l.057-.004h1.12a.2.2 0 0 1 .063.008c.2.06.391.139.564.256c.13.089.25.188.317.337l.096.22l.776 1.835a.76.76 0 0 0 1.013.4a.77.77 0 0 0 .396-1.009m7.38.001l-.548-1.46l-1.967-5.24a.76.76 0 0 0-.729-.502a.77.77 0 0 0-.742.502l-2.509 6.69c-.035.096-.05.2-.064.255c.009.256.075.443.222.594c.384.396 1.07.25 1.267-.269q.252-.663.5-1.327c.017-.047.038-.065.09-.065q1.236.003 2.47 0c.052 0 .073.016.091.064q.25.675.509 1.35a.76.76 0 0 0 1.199.29a.78.78 0 0 0 .21-.882m7.14-3.645c-.15-1.092-.663-1.988-1.523-2.679c-.72-.578-1.55-.867-2.468-.897c-.486-.015-.974-.004-1.46-.002a.73.73 0 0 0-.364.1a.74.74 0 0 0-.384.679q-.003 1.68-.001 3.36v3.366a.76.76 0 0 0 .782.783h1.32a4.1 4.1 0 0 0 1.308-.211a4 4 0 0 0 2.063-1.532c.626-.892.876-1.886.728-2.967m-3.224-1.894c-.463-.182-.948-.149-1.43-.144q-.002 0-.009.006v5.203l.049.004h.545a2.5 2.5 0 0 0 1.695-.657c.67-.604.972-1.37.86-2.264c-.134-1.05-.725-1.763-1.71-2.148"></svg:path>`,
})
export class SimpleIconsRadstudioIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRamIcon],svg[simple-icons-ram-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRancherIcon],svg[simple-icons-rancher-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.727 9.007a.713.713 0 0 1-.726.855h-1.542V8.798h.468a.883.883 0 0 0 .875-.875v-.388c0-.477.12-.875.269-.875c.139 0 .328.388.407.865zm-3.49-1.253c.486 0 .874.388.894.885v4.555a.883.883 0 0 1-.875.875h-2.357a.883.883 0 0 1-.875-.875v-1.79a.87.87 0 0 0-.348.696v1.502c0 .477.397.875.875.875h1.531v2.327a.535.535 0 0 1-.537.538h-2.884a.535.535 0 0 1-.537-.538v-2.168a.535.535 0 0 0-.537-.537h-7.2a.535.535 0 0 0-.538.537v2.168a.535.535 0 0 1-.537.538H2.428a.535.535 0 0 1-.537-.538V10.58L.588 11.603c-.06.04-.14.04-.189-.02l-.368-.438a.135.135 0 0 1-.01-.159l1.91-2.914a.54.54 0 0 1 .487-.318h10.165a.54.54 0 0 1 .527.627l-.21 1.243a.54.54 0 0 0 .528.626h2.039a.535.535 0 0 0 .527-.437q-.195.06-.418.06h-1.452c-.487 0-.815-.388-.736-.866l.249-1.482c.08-.477.258-.865.407-.865c.15 0 .269.398.269.875v.229c.02-.01.05-.01.08-.01h4.843zm3.65-.537c0-.388.288-.557.556-.557s.557.17.557.557c0 .378-.288.547-.557.547c-.268 0-.557-.17-.557-.547zm.984 0c0-.308-.2-.438-.418-.438c-.219 0-.428.13-.428.438c0 .298.21.438.428.438c.219-.01.418-.14.418-.438m-.607-.279h.199c.1 0 .199.03.199.17c0 .08-.06.129-.13.149l.13.228h-.12l-.119-.218h-.05v.218h-.109zm.199.25c.05 0 .09-.03.09-.08c0-.06-.05-.07-.09-.07h-.1v.15z"></svg:path>`,
})
export class SimpleIconsRancherIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRaspberrypiIcon],svg[simple-icons-raspberrypi-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRavelryIcon],svg[simple-icons-ravelry-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRayIcon],svg[simple-icons-ray-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRazerIcon],svg[simple-icons-razer-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactIcon],svg[simple-icons-react-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactbootstrapIcon],svg[simple-icons-reactbootstrap-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactivexIcon],svg[simple-icons-reactivex-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M7.402 2.343c-2.224.984-3.615 2.583-4.4 3.747c-.852 1.268-1.184 2.319-1.184 2.328c-.002.036.005-.017 0 .019c-.246.7-.473 1.798-.473 1.807c-.265 1.344-.142 2.593-.142 2.612l.029.246a10 10 0 0 1 .132-1.012c.019-.133.37-2.016 1.694-3.511c.142-.218 1.675-2.233 4.495-2.233c.606 0 1.24.094 1.874.283h.019c.038.01.87.313 1.173.464c.284.142.786.36.795.36h.02c2.715 1.325 5.062 1.75 5.081 1.76q1.008.17 1.817.17c1.079 0 1.855-.236 2.262-.69c.237-.26.307-.559.293-.814c.019-.985-.785-2.044-1.467-2.754a11 11 0 0 0-1.542-1.344c-2.044-1.514-4.23-2.28-6.52-2.28c-2.347.009-3.937.832-3.956.842m7.419 2.659c.284 0 .511.227.511.51a.51.51 0 0 1-.511.512a.51.51 0 0 1-.511-.511c0-.284.227-.511.511-.511m-6.605-1.94c.075 0 .123.019.142.019l3.227 1.003l-.123.255l-1.543-.482c-.548-.17-1.12-.351-1.656-.52c-.01 0-.028-.01-.047-.01c-.02 0-.048 0-.067.01c-.293.075-1.097.359-1.334.785a.48.48 0 0 0-.038.378c0 .01.17.54.596 1.088l2.14-.104l1.428-.066l-.142.293l-3.549.17c-.53-.643-.738-1.286-.738-1.286C6.181 3.554 8.083 3.07 8.083 3.07q.068-.003.133-.01zm11.223 15.747c2.177-.946 3.104-2.584 3.104-2.584c2.035-2.772 1.344-5.697 1.344-5.697c-1.296 2.82-2.48 3.596-2.48 3.596c3.19-4.854.02-7.788.02-7.788C22.723 9.1 21 12.468 21 12.468c-1.448 3.048-3.502 4.136-3.502 4.136c2.29.426 3.975-1.117 3.975-1.117c-3.284 3.549-6.842 3.379-6.842 3.379c1.495 1.675 3.738 1.533 3.738 1.533c-2.934.69-5.688-.284-7.95-2.167c-.425-.35-.832-.73-1.21-1.136c-.144-.15-.28-.31-.417-.464c-.047 1.751 1.779 3.379 1.779 3.379c-2.29-.947-3.34-3-3.34-3s-1.543-2.631-.426-5.631c1.107-2.962 4.419-3.626 4.504-3.645a53 53 0 0 0-.814-.367c-.293-.142-1.145-.455-1.145-.455a6.4 6.4 0 0 0-1.798-.274c-2.792 0-4.277 2.11-4.277 2.11c-1.316 1.477-1.628 3.388-1.628 3.388c-.37 1.827.028 3.748.028 3.748s.038.151.048.217c.303.72.69 1.43 1.145 2.101c2.46 3.672 6.454 4.94 6.454 4.94c5.914 2.006 9.955-.946 9.955-.946c3.72-2.555 4.467-5.508 4.467-5.508c-3.01 2.338-4.306 2.12-4.306 2.12zM1.307 14.948a12.6 12.6 0 0 1-.36-1.78c-.01-.098-.025-.207-.037-.302c0 0-.133-1.287.151-2.697c0 0 .01-.038.02-.095c.036-.203.093-.407.132-.577c.085-.37.208-.814.33-1.174c0 0 1.307-4.287 5.726-6.245c0 0 1.524-.805 3.823-.862a3.7 3.7 0 0 0-.51-.435c-1.08-.72-2.688-.956-3.663.057c-.293.303-.54.634-.814.937c-.312.34-.69.624-1.126.785c-.378.142-.757.114-1.145.18c-.397.066-.804.208-1.126.464c-.35.284-.492.662-.53 1.097c-.038.341-.028.691-.047 1.032c-.048 1.003-.37 1.287-1.089 1.845c-.303.227-.558.53-.747.852c-.568 1.003.34 2.044.388 3.057c.01.208-.01.416-.085.615c-.076.217-.228.36-.35.54c-.171.236-.285.52-.237.813s.199.568.34.823c.275.455.616.862.975 1.25c.012.016.038.04.054.052z"></svg:path>`,
})
export class SimpleIconsReactivexIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactosIcon],svg[simple-icons-reactos-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactqueryIcon],svg[simple-icons-reactquery-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReactrouterIcon],svg[simple-icons-reactrouter-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12.118 5.466a2.3 2.3 0 0 0-.623.08c-.278.067-.702.332-.953.583c-.41.423-.49.609-.662 1.469c-.08.423.41 1.43.847 1.734c.45.317 1.085.502 2.065.608c1.429.16 1.84.636 1.84 2.197c0 1.377-.385 1.747-1.96 1.906c-1.707.172-2.58.834-2.765 2.117c-.106.781.41 1.76 1.125 2.091c1.627.768 3.15-.198 3.467-2.196c.211-1.284.622-1.642 1.998-1.747c1.588-.133 2.409-.675 2.713-1.787c.278-1.02-.304-2.157-1.297-2.554c-.264-.106-.873-.238-1.35-.291c-1.495-.16-1.879-.424-2.038-1.39c-.225-1.337-.317-1.562-.794-2.09a2.17 2.17 0 0 0-1.613-.73m-4.785 4.36a2.2 2.2 0 0 0-.497.048c-1.469.318-2.17 2.051-1.35 3.295c1.178 1.774 3.944.953 3.97-1.177c.012-1.193-.98-2.143-2.123-2.166M2.089 14.19a2.2 2.2 0 0 0-.427.052c-2.158.476-2.237 3.626-.106 4.182c.53.145.582.145 1.111.013c1.191-.318 1.866-1.456 1.549-2.607c-.278-1.02-1.144-1.664-2.127-1.64m19.824.008c-.233.002-.477.058-.784.162c-1.39.477-1.866 2.092-.98 3.336c.557.794 1.96 1.058 2.82.516c1.416-.874 1.363-3.057-.093-3.746c-.38-.186-.663-.271-.963-.268"></svg:path>`,
})
export class SimpleIconsReactrouterIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReacttableIcon],svg[simple-icons-reacttable-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M16.738 1.263c.626 0 1.183.192 1.624.581c.417.369.692.88.842 1.507c.253 1.054.169 2.505-.222 4.398a1 1 0 0 1-.06.195q1.068.28 1.906.626c1.352.559 2.301 1.264 2.817 2.158c.313.542.427 1.12.31 1.696c-.11.546-.415 1.04-.882 1.482c-.784.745-2.08 1.396-3.91 2.002a1 1 0 0 1-.236.05q.302 1.093.424 2.013c.193 1.452.056 2.629-.46 3.524c-.314.543-.758.93-1.316 1.118c-.528.177-1.107.16-1.725-.023c-1.039-.308-2.253-1.106-3.696-2.39a1.1 1.1 0 0 1-.195-.228a15 15 0 0 1-1.491 1.335c-1.16.894-2.247 1.364-3.28 1.364c-.626 0-1.183-.19-1.624-.58c-.417-.37-.692-.88-.842-1.507c-.253-1.054-.169-2.506.222-4.398a1 1 0 0 1 .072-.224a15 15 0 0 1-1.844-.61C1.82 14.793.871 14.088.355 13.194c-.313-.542-.427-1.12-.31-1.697c.11-.545.415-1.039.882-1.482c.784-.744 2.08-1.396 3.91-2.002q.107-.034.215-.048a15 15 0 0 1-.403-1.936c-.193-1.452-.056-2.629.46-3.524c.314-.543.758-.93 1.316-1.118c.528-.177 1.107-.16 1.725.023c1.039.308 2.253 1.106 3.696 2.39q.076.067.137.147q.765-.772 1.475-1.32c1.16-.893 2.247-1.364 3.28-1.364M7.359 13.761a.342.342 0 0 0-.582.106q-1.926 5.154-.809 7.11q1.143 1.998 4.953-1.33l.077-.068l.053-.059a.35.35 0 0 0-.016-.427a36 36 0 0 1-2.074-2.743a34 34 0 0 1-1.502-2.425l-.06-.106zm10.46 2.534l-.067.005a36 36 0 0 1-3.363.437a33 33 0 0 1-2.808.1h-.12l-.07.006a.343.343 0 0 0-.198.554q3.43 4.204 5.647 4.203q2.268 0 1.326-4.928l-.02-.1l-.02-.066a.34.34 0 0 0-.374-.206zm-6.231-1.137H9.385l.252.44a.63.63 0 0 0 .548.318h1.403zm3.087 0h-2.203v.758h1.403a.63.63 0 0 0 .548-.317zM19 9.098a.355.355 0 0 0-.379.226a36 36 0 0 1-1.352 3.184a34 34 0 0 1-1.366 2.525l-.063.106l-.03.064a.345.345 0 0 0 .155.412a.36.36 0 0 0 .237.044q5.537-.892 6.687-2.846q1.176-1.998-3.72-3.666l-.1-.033zm-11.118-.76l-.082.003q-5.537.892-6.687 2.846q-1.176 1.998 3.72 3.666l.1.033l.069.016a.355.355 0 0 0 .379-.226a36 36 0 0 1 1.352-3.184a34 34 0 0 1 1.366-2.525l.063-.106l.03-.064a.345.345 0 0 0-.155-.412a.36.36 0 0 0-.237-.044zm3.707 5.051H8.37l.507.885h2.71v-.885zm4.102 0h-3.218v.885h2.71zm-4.102-1.768H7.862l-.073.128a.63.63 0 0 0 0 .628l.073.128h3.726zm4.61 0h-3.726v.884h3.726l.073-.128a.63.63 0 0 0 0-.628zm-4.61-1.768h-2.71l-.508.884h3.218zm3.595 0h-2.711v.884h3.218zm2.849-6.83q-1.143-1.998-4.953 1.33l-.077.068l-.053.059a.35.35 0 0 0 .016.427q1.153 1.389 2.074 2.743q.78 1.147 1.502 2.425l.06.106l.04.058a.342.342 0 0 0 .582-.106q1.926-5.154.809-7.11m-6.444 5.188h-1.403a.63.63 0 0 0-.548.317l-.253.44h2.204zm2.287 0h-1.403v.757h2.204l-.253-.44a.63.63 0 0 0-.548-.317m-6.59-5.937q-2.266 0-1.326 4.928l.02.1l.02.065c.06.146.214.235.375.207a36 36 0 0 1 3.363-.437a33 33 0 0 1 2.807-.1h.12l.07-.006a.343.343 0 0 0 .198-.554Q9.504 2.274 7.286 2.274"></svg:path>`,
})
export class SimpleIconsReacttableIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReadmeIcon],svg[simple-icons-readme-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReadthedocsIcon],svg[simple-icons-readthedocs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRealmIcon],svg[simple-icons-realm-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M12 .029a12.12 12.12 0 0 0-8.484 3.504v.003C1.291 5.76 0 8.855 0 11.998s1.285 6.244 3.516 8.465l.001.002a12.17 12.17 0 0 0 8.479 3.505H12c3.148 0 6.255-1.283 8.482-3.508l.002-.002A12.08 12.08 0 0 0 24 12.005V12a12.06 12.06 0 0 0-3.518-8.464A12.12 12.12 0 0 0 12 .03zm0 1.336c.48 0 .96.046 1.435.113c-2.03.566-3.765 1.622-5.554 1.949a7.4 7.4 0 0 1-2.225.044C7.482 2.135 9.74 1.364 12 1.364zm4.135 1.072q.26.002.521.023a10.6 10.6 0 0 1 2.883 2.022c.092.09.173.194.262.289a10.3 10.3 0 0 1-4.442 1.178c-2.43.06-4.958-.794-7.69-.823a12.7 12.7 0 0 0-4.362.744c.32-.457.672-.893 1.062-1.293c1.223.322 2.5.39 3.748.164h.002c2.264-.412 4.133-1.625 6.049-2.08a8.3 8.3 0 0 1 1.967-.225zM20.67 5.84a10.9 10.9 0 0 1 1.433 2.824a11 11 0 0 0-1.35-.644h-.001a11.3 11.3 0 0 0-6.62-.493h-.003c-1.489.345-2.841.968-4.154 1.524q-.701.297-1.399.553a11 11 0 0 0-1.445-.257h-.002a9.6 9.6 0 0 0-4.194.55a8 8 0 0 1-1.244-.536a11 11 0 0 1 .53-1.557C3.892 6.927 5.773 6.44 7.654 6.46c2.445.026 4.992.89 7.738.822h.004A11.6 11.6 0 0 0 20.67 5.84m-4.031 2.742a10 10 0 0 1 3.625.681a10 10 0 0 1 2.283 1.282q.055.378.082.758a10.7 10.7 0 0 0-2.244-.329a10.3 10.3 0 0 0-3.201.38c-.697.199-1.353.464-1.989.76c-1.087-.371-2.166-.86-3.277-1.336a35 35 0 0 0-1.324-.538c1.3-.552 2.554-1.113 3.834-1.41a10 10 0 0 1 2.21-.248zM5.873 10.644q.562-.022 1.125.032c1.475.148 2.935.704 4.393 1.33c.717.309 1.453.625 2.203.928c-1.1.604-2.156 1.225-3.237 1.7c-1.05-.393-2.131-.757-3.302-.917c-1.835-.25-3.717.06-5.387.828a10.5 10.5 0 0 1-.32-2.3c.403-.3.828-.57 1.28-.79a8.3 8.3 0 0 1 3.245-.81zm14.463 1.667c.775.029 1.547.16 2.29.379a10.7 10.7 0 0 1-.304 1.893c-.67.439-1.383.808-2.139 1.08c-1.828.658-3.85.79-5.75.374c-.78-.17-1.557-.45-2.341-.75c1.889-.973 3.598-2.12 5.457-2.646h.002a9 9 0 0 1 2.785-.33M5.504 14.976a8 8 0 0 1 1.369.065c2.354.323 4.617 1.719 7.275 2.302c.357.078.717.134 1.078.178q-.525.15-1.043.332v.002h-.001c-1.283.462-2.455 1.042-3.637 1.388c-2.151.625-4.443.54-6.543-.23a10.7 10.7 0 0 1-1.926-3.18a8.6 8.6 0 0 1 3.428-.858zm16.144 1.5c-.067.145-.133.29-.207.433c-.221-.017-.442-.04-.664-.048c.298-.112.584-.251.871-.385m-1.7 1.703a16 16 0 0 1 .696.016c-.333.464-.696.911-1.105 1.323h-.002v.002c-1.966 1.963-4.754 3.113-7.535 3.113a10.8 10.8 0 0 1-5.793-1.725c1.57.19 3.173.065 4.71-.382h.003c1.332-.39 2.526-.987 3.71-1.414a16.1 16.1 0 0 1 5.315-.934z"></svg:path>`,
})
export class SimpleIconsRealmIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedbullIcon],svg[simple-icons-redbull-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M22.381 11.374c-.389 1.244-1.019 2.33-2.142 3.082l-.33.251l-.264.236l-.091.107l-.025.041l-.011.028l-.004.016v.013l.001.009l.002.007l.002.006l.005.007l.002.002l.01.008l.012.007l.011.004a.2.2 0 0 0 .046.006h.024c.178-.007.512-.141.629-.245l-.139.137l-.164.149l-.173.146l-.18.141l-.185.136l-.197.134l-.204.13l-.206.123l-.213.118l-.223.115l-.226.108l-.225.1l-.236.097l-.045.018c-1.97.763-4.327.854-5.914-.44c.353.344.787.728 1.199.98c-.251-.043-.429-.237-.666-.311c.004.008.575.751 2.282.946l.316.032l.48.031l.464.014l.448-.009l.44-.039l.464-.084l.401-.107l.599-.181l.294-.081l.128-.033q.155-.04.333-.077l.041-.009c.073.031-.524.339-1.344.57c-.361.132-.739.2-1.119.227l-.269.012l-.216.001l-.218-.005l-.264-.015l-.315-.027l-.31-.034l-.056-.007c-.401-.049-.781-.107-1.122-.143h-.006h.006c.03.015.209.096 1.067.402c-.061.022-.346.061-1.536-.448c2.417 1.392 4.988.759 7.266-.585l.352-.215l.053-.034l.294-.191l.151-.103q.267-.182.526-.374c0 .009-.004.021-.004.031l.075.01c-.014.041-.014.041-.214.279c.435-.351.659-.896 1.12-1.225c-.236.473-.538.813-1.1 1.361q.049-.037.095-.078l.028-.026l-.028.026a7.9 7.9 0 0 1-3.682 1.965q.19-.021.373-.073c-.22.061-.227.068-.32.099c.058-.007.058-.007.358-.068c-.175.086-.377.127-.865.226c2.806-.444 5.721-2.571 5.956-5.449a.14.14 0 0 1-.152-.143c.009-.562-.147-.982-.42-1.302c-.163.58-.413 1.136-1.027 2.072c-.26.393-.72.41-1.005.771l-.021-.013l-.032-.028l-.005-.003l-.004-.002l-.001-.001h-.003l-.007.001h-.003l-.001.001a.2.2 0 0 0-.058.051l.062-.07l.067-.092l.016-.031l.005-.014l.002-.01v-.01l-.001-.009l-.001-.003l-.002-.004l-.001-.003l-.003-.003l-.005-.006l-.009-.006l-.04-.019l-.006-.004l-.004-.004l-.002-.003l-.002-.002l-.002-.006v-.006l.001-.007l.004-.011l.023-.034l.014-.016c.622-.687 1.192-1.306 1.438-2.228l.006-.021l-.027.032c-.087.103-.147.147-.24.265l.11-.39l.035-.127l.065-.26l.052-.225a1 1 0 0 0-.118-.055m-2.257 6.199a9 9 0 0 1-1.105.547c-.38.155-.768.279-1.152.354a10 10 0 0 0 2.257-.901m-6.505.203l.051.02l-.001-.012zm3.644-2.807c-.372-.201-.515-.63-.744-.945c-.6-.62-.701-1.681-.858-2.549c-.158-.843-.878-1.467-1.378-2.119c-.443-.361-1.599-1.457-2.145-1.632c-.72-.299-1.348.267-1.947.544c-.487.201-1.002.258-1.432.63c-.674.865-1.079.173-1.861.858c-1.165 1.22-1.606.146-3.207 1.575c-.429.257-.831.515-1.348.487c-.823-.039-1.103-1.145-.459-1.633c.449-.502 1.552-1.019 1.004-1.831c-.57-.508-1.24-.292-1.918-.858c-.313.49.087 1.155.601 1.318c.211.131.701-.078.802.227c-.217.434-.81.669-1.088 1.089c-.693.8-.009 2.112.973 2.173c.363.117.825-.179 1.06-.057c.028.286 0 .544.057.802c.027.282.348.584.172.858c-.285.245-.654.37-1.03.347c-.195.225-.228.48-.344.744c-.142.258-.428.372-.629.487c-.133.201-.265.424-.545.458c-.171.201-.2.458-.257.716c.716.19.87.094 1.26-.515c.143-.143.344-.029.486 0c.407-.049.711-.321 1.003-.573c1.042-.272 1.032.41 2.233-.372c.201-.086.287-.315.373-.487c.1-.192.378-.562.028-.658c-.899 1.819-2.464.338-3.665 1.715c-.184.051-.041-.235 0-.287c.862-1.256 2.823-.15 3.493-1.776c.117-.25.051-1.247.343-1.232c.029 0 .115.029.115.086c-.278 1.214-.094 1.591 1.202 1.378c.444-.128 1.716.325 1.69-.286c0-.114-.115-.171 0-.257c.028-.029.114 0 .143.028c.081.49.511.85.919 1.06c.823.56.49 1.291-.459 1.26c-.315-.172-.4-.487-.63-.745c-.267-.234-.633-.122-.944-.057c-.155.233.212.511.286.745c.143.086.344-.058.458.114c.115.171.172.344.344.458c.496.476 1.532-.36 2.061-.401c.463.051.674-.371.831-.716c.261-.477-.434-.948-.487-1.374c-.158-.044-.368-.167-.487 0c.088.213.579.993.544 1.231c-.064.173-.21.572-.429.544c.058-.2.144-.428.144-.658c-.105-.245-.565-.953-.602-1.203c.092-.242.562-.102.744-.344c.201-.315.258-.629.316-1.03a.13.13 0 0 1 .086-.087c.279.18-.005 1.042-.172 1.232c-.016.297.568.098.687 0c.221.046.67-.175.773-.029a1.55 1.55 0 0 0-.286.573c-.172.2-.458.344-.458.63c.031.18.273-.11.286.114c-.249.317-.218.394-.143.745c.261.368.761.065 1.088-.028c.552-.217 1.172.126 1.604-.459c.116.01.222.074.286.172c.319.335.769.513 1.231.487c.188-.13-.222-.233-.286-.287c-.201-.114-.459-.286-.516-.515c-.075-.32-.306-.613-.458-.916c.669.01.739 1.406 1.716 1.203c.048-.033.043-.069.029-.115zm-16.866.687c-.339.139-.159.558-.371.773c0 .028-.058.086 0 .115c.142.028.257.086.429.114c.076-.256.15-.541.2-.773c-.058-.086-.143-.2-.258-.229m17.317-.39c-.085.109-.274.115-.356.19a.12.12 0 0 0-.023.082a.24.24 0 0 1-.073.242c-.087.094-.25.136-.397.126c-.734.008-1.092-.351-1.392-.523c-.41.265-.665.37-1.201.287c-.315-.025-.596.134-.902.212c.434.372 2.193.844 1.545.524c-1.072-.607-.295-.203.645.019a7 7 0 0 0 1.625.2a8 8 0 0 0 2.427-1.279a.3.3 0 0 1-.118-.021a.2.2 0 0 1-.095-.081c-.031-.052-.048-.136.023-.251c.074-.119.286-.327.734-.651l.004-.003c1.097-.736 1.71-1.8 2.088-3.015a4 4 0 0 0-.798-.2c-.405 1.006-.503 1.716-1.458 2.285c-1.108.725-.414.539-.403.534q.13-.053.245-.132c-.429.689-1.174 1.129-2.063 1.327a.2.2 0 0 1-.057.128m-16.687.39c.2-.115.315-.315.401-.487c-.062-.096-.136-.223-.286-.172q-.206.159-.429.287c-.072.194.107.439.315.372zm8.648-.63c.114.143.114.343.258.458a.62.62 0 0 0 .486-.143c.086-.057-.028-.143-.057-.229c-.086-.115-.028-.344-.229-.344c-.217.051-.455-.012-.659.057c0 .087.172.087.201.201m5.125-.344a1.7 1.7 0 0 1-.4.057h-.029c-.169-.156.184-.468.372-.458h.086c.105.044.078.32-.029.401m7.828-3.179c-.038.169-.078.328-.12.489a.142.142 0 0 1 .133.177c-.243.936-.807 1.571-1.433 2.262l.003.005c.1-.07.207-.127.313-.184c.163-.088.326-.176.442-.351c.632-.962.872-1.515 1.032-2.115q-.165-.159-.37-.283m-.948-2.516l.117.073c1.725 1.116 2.457 3.197 1.833 4.905l.006-.005c.29-.834.408-1.718.349-2.599c-.306-2.281-1.087-4.283-3.87-5.019c1.721.416 1.85.631 2.075.779c-1.337-1.235-3.49-1.664-5.667-1.295c1.253-.404 3.303-.361 4.61.417l.031.019c-3.108-1.906-6.839-1.075-9.134 1.114c.429.083.806.366 1.157.637l.109-.059l.127-.064l.131-.062l.27-.119l.281-.11l.295-.105l.306-.096l.285-.079l.323-.079l.299-.064l.273-.05l.17-.027l.17-.025l.138-.018l.172-.019c1.705-.182 3.539.045 4.907.946l.013.008a4.45 4.45 0 0 1 1.518 1.685c-.033.021-.065.016-.094-.001l-.038-.029l-.108-.115l-.02-.015c-.014-.005-.046-.036-.061-.043l-.209-.189l-.248-.186l-.266-.162l-.044-.024c-.773-.418-1.714-.603-2.55-.779l-.051-.01l.415.146l.459.135l.494.143l.299.099l.242.094l.16.071l.143.072l.085.046zm-1.112 4.436c.186-.409.62-.629.762-1.123c-.021.073.134.103.195.103c.245-.042.251-.379.33-.449c-.061.766-.578 1.393-1.144 1.912a.26.26 0 0 0-.244-.011c-.024-.144.286-.344.101-.432m-5.023-.402c-.032.056-.081.202-.143.201s-.089.009-.086-.057c-.005-.193-.036-.429-.201-.544c-.374-.582-.468.147-.601.057c-.08-.162.046-.345.115-.487c.032-.038.044-.083.086-.114c.061-.353.383-.152.458.057c.197.245.429.521.401.802c-.029-.029-.029.028-.029.085m-.549-3.278c-.217-.28-.442-.582-.683-.803c1.207-.431 3.157-.54 4.121-.577c.228-.007.352-.022.403-.037a.2.2 0 0 0 .087-.052a.14.14 0 0 0 .037-.115a.15.15 0 0 0-.066-.11a.6.6 0 0 0-.18-.059a8 8 0 0 0-1.056-.106h-.002c-.657 0-1.409.067-2.124.192q.383-.13.779-.209a.14.14 0 0 0 .114-.146a.14.14 0 0 0-.128-.134c-.122-.013-.895.075-1.605.241c-.485.113-.938.266-1.149.438l-.013.013q-.107-.09-.213-.176c1.546-.816 4.032-1.269 6.157-.782c1.178.269 2.246.83 2.973 1.785c-.868-.665-2.087-.901-3.134-1.122a.142.142 0 0 0-.082.27c.762.303 1.566.393 2.28.798c1.572.902 2.381 2.603 2.161 4.159c.016-.994-.449-1.573-1.164-1.938c-2.191-.92-4.263.309-6 .558v-.014l-.003-.005c-.1-.215.937-.435 1.075-.518c.082-.085.222-.056.315-.132c.092-.091.23-.111.353-.135c.323-.165.679-.219 1.039-.226c.127.019.245-.052.372-.043a.35.35 0 0 1 .188-.03c.385-.029.779-.065 1.111-.299c.035-.021.153-.086.053-.099c-.629-.17-.932.26-1.506-.256c.009-.022-.181-.103-.208-.103c-.304.061-.589.197-.905.202c-.144.032-.201-.04-.345-.04c-.193.045-.46.169-.657.184c-.092-.017-.542.218-.551.056h-.01c-.048-.182 2.822-1.254 1.641-.532c.065.056.447-.105.807-.132c.404-.086.941.211 1.118-.185c-.007-.065-.162-.046-.2-.019c-.077.042-.16.014-.241.032c-.135.016-.66-.079-.779-.071c-.095-.081.528-.064.583-.073c.205-.031.452-.077.657-.115q.137-.016.274-.006c.186.044.684-.024.153-.153c-.14-.027-.581-.041-.652-.019c-.108.014-.576.153-.825.095c-.225-.068.7-.106.59-.168c-1.148-.145-2.457-.109-4.724 1q-.107-.133-.236-.284m-2.543.902c-.029.029-.058.029-.115.029c-.077-.29-.104-.592-.258-.831c-.08-.079-.184-.181-.115-.315a.14.14 0 0 1 .173-.029c.262.196.306.469.315.802c.057.057.028.229 0 .344m1.73-1.808l.213-.075l.252-.076l.266-.068l.313-.068l.36-.067l.313-.049l.37-.049l.442-.05l.467-.042l.53-.036l.414-.023l.446-.018l.194-.018l.035-.008l.013-.005l.005-.003v-.001l.003-.002v-.001l.001-.004q0-.003-.004-.007l-.004-.003l-.006-.003c-.113-.058-.879-.133-1.149-.136c-1.19 0-2.697.224-3.712.611zm2.074-1.11l.027.001a6.5 6.5 0 0 0-.867.238l-.496.169l-.452.166l-.341.132l-.285.117l-.209-.174c.434-.355 1.968-.598 2.491-.642zm3.546.188c.08.059.363.23.812.232a.14.14 0 0 0 .131-.086a.14.14 0 0 0-.028-.154c-.09-.093-.249-.173-.434-.235c-.245-.082-.537-.139-.734-.184a.14.14 0 0 0-.102.016a.14.14 0 0 0-.068.083a.14.14 0 0 0 .008.111c.01.021.039.059.094.09c.075.041.234.099.321.127m-.287-.278q-.005-.006.003-.011c.302.069.834.165 1.057.344l.04.035a1.5 1.5 0 0 1-.438-.066l-.099-.035l-.092-.042l-.065-.037a.2.2 0 0 1-.05-.036h.001l-.277-.103l-.043-.021a.1.1 0 0 1-.037-.028m.305.284l.002.001z"></svg:path>`,
})
export class SimpleIconsRedbullIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedcandlegamesIcon],svg[simple-icons-redcandlegames-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedditIcon],svg[simple-icons-reddit-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedmineIcon],svg[simple-icons-redmine-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedoxIcon],svg[simple-icons-redox-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
  ...
  template: `<svg:path fill="currentColor" d="M5.694 6.05a.286.286 0 0 0-.258.241A5.72 5.72 0 0 0 .912 8.903H.91a.284.284 0 0 0-.386.263c0 .09.042.169.107.22A5.7 5.7 0 0 0 0 12c0 .942.227 1.83.631 2.614a.283.283 0 0 0 .281.484a5.72 5.72 0 0 0 4.524 2.611v.002a.284.284 0 0 0 .56-.002a5.71 5.71 0 0 0 4.522-2.611h.002a.285.285 0 0 0 .388-.264a.3.3 0 0 0-.03-.127l-.015-.03l-.029.017a2.4 2.4 0 0 1-.459.185l-.031.01l.01.031a.3.3 0 0 0 .021.05a5.52 5.52 0 0 1-4.42 2.548v-.002a.283.283 0 0 0-.48.004a5.52 5.52 0 0 1-4.42-2.55l.001-.001a.284.284 0 0 0-.242-.418A5.5 5.5 0 0 1 .191 12a5.5 5.5 0 0 1 .623-2.55a.284.284 0 0 0 .24-.42a5.52 5.52 0 0 1 4.42-2.55a.283.283 0 0 0 .483 0a5.52 5.52 0 0 1 4.418 2.552a.3.3 0 0 0-.035.134a.285.285 0 0 0 .277.284a5.5 5.5 0 0 1 .465 1.232a2 2 0 0 1 .238.189a5.7 5.7 0 0 0-.52-1.484a.28.28 0 0 0 .108-.22a.285.285 0 0 0-.389-.265a5.71 5.71 0 0 0-4.523-2.609a.285.285 0 0 0-.281-.244zm-.006 1.417a.29.29 0 0 0-.248.22a4.314 4.314 0 0 0-4.024 4.302a4.313 4.313 0 0 0 4.018 4.3a.284.284 0 0 0 .281.244a.29.29 0 0 0 .281-.242a4.3 4.3 0 0 0 2.945-1.431a2 2 0 0 1-.187-.077a4.1 4.1 0 0 1-2.797 1.319a.28.28 0 0 0-.242-.135a.29.29 0 0 0-.24.133a4.118 4.118 0 0 1-.012-8.223v.003a.283.283 0 0 0 .506-.003a4.12 4.12 0 0 1 3.507 2.403a2 2 0 0 1 .204-.016a4.31 4.31 0 0 0-3.688-2.576v-.002a.285.285 0 0 0-.277-.219zM3.959 9.506v4.985h.496V9.957h.703q.765 0 1.147.182a.85.85 0 0 1 .389.367q.138.247.138.59q0 .825-.723 1.039q-.342.096-1.146.096l1.682 2.26h.618l-1.398-1.862q.72-.076 1.096-.465q.38-.391.379-1.06q0-.455-.185-.797a1.37 1.37 0 0 0-.532-.547q-.457-.254-1.431-.254Zm11.629 0v1.881a1.8 1.8 0 0 0-1.45-.676q-.552 0-1.004.254a1.86 1.86 0 0 0-.704.7a1.96 1.96 0 0 0-.254.99q0 .54.263.982a1.86 1.86 0 0 0 .721.692q.461.25 1.026.25q.461 0 .786-.178q.329-.178.616-.58v.67h.502V9.505Zm-5.891 1.205a1.9 1.9 0 0 0-.964.254a1.86 1.86 0 0 0-.692.695a1.9 1.9 0 0 0-.254.97q0 .4.152.763a1.9 1.9 0 0 0 .41.623a1.9 1.9 0 0 0 .624.412a2 2 0 0 0 .765.15a1.8 1.8 0 0 0 1.096-.357a1.95 1.95 0 0 0 .7-.947h-.522a1.3 1.3 0 0 1-.51.613a1.4 1.4 0 0 1-.777.23a1.42 1.42 0 0 1-.989-.378a1.3 1.3 0 0 1-.45-.928h3.339q0-.37-.05-.614a1.8 1.8 0 0 0-.17-.48a1.8 1.8 0 0 0-.702-.736a1.95 1.95 0 0 0-1.006-.27m9.008 0q-.814.018-1.35.551q-.554.547-.554 1.387q0 .547.254.988a1.83 1.83 0 0 0 .709.692q.45.25 1.007.25q.814 0 1.348-.547t.533-1.378q0-.549-.246-.994a1.77 1.77 0 0 0-.68-.695a1.9 1.9 0 0 0-.968-.254zm2.162.09l1.285 1.809l-1.285 1.88h.567l1.001-1.48l.99 1.48H24l-1.291-1.88L24 10.8h-.574l-.99 1.423l-1.002-1.422zm-11.234.37q.031-.002.064 0q.537 0 .92.317q.385.32.51.87H8.301q.101-.534.488-.86a1.34 1.34 0 0 1 .844-.328zm4.4 0q.035-.002.072 0q.634-.001 1.069.427q.435.425.435 1.037q0 .614-.421 1.049q-.423.435-1.016.434a1.453 1.453 0 0 1-1.488-1.475q0-.614.413-1.041q.39-.406.936-.432m4.611 0q.037-.002.075 0q.626-.002 1.027.42q.402.418.402 1.071q0 .636-.392 1.047q-.39.408-.998.408q-.626 0-1.037-.413q-.412-.416-.412-1.05q0-.639.402-1.06a1.32 1.32 0 0 1 .933-.423"></svg:path>`,
})
export class SimpleIconsRedoxIcon {
  readonly viewBox = input("0 0 24 24")
  readonly width = input("1em")
  readonly height = input("1em")
}
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedragonIcon],svg[simple-icons-redragon-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReduxIcon],svg[simple-icons-redux-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsReduxsagaIcon],svg[simple-icons-reduxsaga-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRedwoodjsIcon],svg[simple-icons-redwoodjs-icon]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.width]': 'width()',
