...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglemybusinessIcon],svg[simple-icons-googlemybusiness-icon]',
  host: {
    role: 'img',
