...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsHaveibeenpwnedIcon],svg[simple-icons-haveibeenpwned-icon]',
  host: {
    'role': 'img',
