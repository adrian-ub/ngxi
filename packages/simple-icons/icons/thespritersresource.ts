...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsThespritersresourceIcon],svg[simple-icons-thespritersresource-icon]',
  host: {
    'role': 'img',
