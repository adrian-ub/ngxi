...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGoogletranslateIcon],svg[simple-icons-googletranslate-icon]',
  host: {
    role: 'img',
