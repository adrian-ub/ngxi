...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglecardboardIcon],svg[simple-icons-googlecardboard-icon]',
  host: {
    role: 'img',
