...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsLibretranslateIcon],svg[simple-icons-libretranslate-icon]',
  host: {
    'role': 'img',
