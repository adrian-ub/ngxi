...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPowervirtualagentsIcon],svg[simple-icons-powervirtualagents-icon]',
  host: {
    role: 'img',
