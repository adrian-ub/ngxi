...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsHandlebarsdotjsIcon],svg[simple-icons-handlebarsdotjs-icon]',
  host: {
    role: 'img',
