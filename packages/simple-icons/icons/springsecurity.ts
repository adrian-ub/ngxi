...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsSpringsecurityIcon],svg[simple-icons-springsecurity-icon]',
  host: {
    'role': 'img',
