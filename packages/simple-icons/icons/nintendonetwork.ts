...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNintendonetworkIcon],svg[simple-icons-nintendonetwork-icon]',
  host: {
    role: 'img',
