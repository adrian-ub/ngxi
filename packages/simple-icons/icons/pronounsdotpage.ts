...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPronounsdotpageIcon],svg[simple-icons-pronounsdotpage-icon]',
  host: {
    role: 'img',
