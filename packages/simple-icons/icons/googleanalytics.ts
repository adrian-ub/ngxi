...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGoogleanalyticsIcon],svg[simple-icons-googleanalytics-icon]',
  host: {
    'role': 'img',
