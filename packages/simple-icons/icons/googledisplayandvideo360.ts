...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGoogledisplayandvideo360Icon],svg[simple-icons-googledisplayandvideo360-icon]',
  host: {
    'role': 'img',
