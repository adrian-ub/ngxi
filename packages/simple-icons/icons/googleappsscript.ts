...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGoogleappsscriptIcon],svg[simple-icons-googleappsscript-icon]',
  host: {
    'role': 'img',
