...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPlausibleanalyticsIcon],svg[simple-icons-plausibleanalytics-icon]',
  host: {
    'role': 'img',
