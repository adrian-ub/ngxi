...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsInternetarchiveIcon],svg[simple-icons-internetarchive-icon]',
  host: {
    'role': 'img',
