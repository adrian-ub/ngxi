...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGoogleclassroomIcon],svg[simple-icons-googleclassroom-icon]',
  host: {
    role: 'img',
