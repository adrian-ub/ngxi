...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsLeagueoflegendsIcon],svg[simple-icons-leagueoflegends-icon]',
  host: {
    role: 'img',
