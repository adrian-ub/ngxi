...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglemarketingplatformIcon],svg[simple-icons-googlemarketingplatform-icon]',
  host: {
    'role': 'img',
