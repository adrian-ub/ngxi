...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNintendogamecubeIcon],svg[simple-icons-nintendogamecube-icon]',
  host: {
    'role': 'img',
