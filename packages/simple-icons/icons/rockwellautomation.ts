...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsRockwellautomationIcon],svg[simple-icons-rockwellautomation-icon]',
  host: {
    role: 'img',
