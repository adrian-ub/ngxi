...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsMicrosoftvisioIcon],svg[simple-icons-microsoftvisio-icon]',
  host: {
    'role': 'img',
