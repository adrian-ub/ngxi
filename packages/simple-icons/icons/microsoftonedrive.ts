...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsMicrosoftonedriveIcon],svg[simple-icons-microsoftonedrive-icon]',
  host: {
    role: 'img',
