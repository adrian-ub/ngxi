...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsSouthwestairlinesIcon],svg[simple-icons-southwestairlines-icon]',
  host: {
    role: 'img',
