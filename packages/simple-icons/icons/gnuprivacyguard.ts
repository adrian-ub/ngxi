...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGnuprivacyguardIcon],svg[simple-icons-gnuprivacyguard-icon]',
  host: {
    role: 'img',
