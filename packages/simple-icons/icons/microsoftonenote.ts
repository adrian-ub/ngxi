...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsMicrosoftonenoteIcon],svg[simple-icons-microsoftonenote-icon]',
  host: {
    'role': 'img',
