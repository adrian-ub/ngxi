...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsSemanticscholarIcon],svg[simple-icons-semanticscholar-icon]',
  host: {
    role: 'img',
