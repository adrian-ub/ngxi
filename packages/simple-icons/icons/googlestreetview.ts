...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglestreetviewIcon],svg[simple-icons-googlestreetview-icon]',
  host: {
    'role': 'img',
