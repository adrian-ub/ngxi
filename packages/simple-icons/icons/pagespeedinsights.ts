...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsPagespeedinsightsIcon],svg[simple-icons-pagespeedinsights-icon]',
  host: {
    role: 'img',
