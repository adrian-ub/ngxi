...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsLinuxcontainersIcon],svg[simple-icons-linuxcontainers-icon]',
  host: {
    role: 'img',
