...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsFreedesktopdotorgIcon],svg[simple-icons-freedesktopdotorg-icon]',
  host: {
    'role': 'img',
