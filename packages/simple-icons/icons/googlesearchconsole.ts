...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglesearchconsoleIcon],svg[simple-icons-googlesearchconsole-icon]',
  host: {
    'role': 'img',
