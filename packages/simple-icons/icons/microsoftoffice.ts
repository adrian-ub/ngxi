...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsMicrosoftofficeIcon],svg[simple-icons-microsoftoffice-icon]',
  host: {
    role: 'img',
