...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsStmicroelectronicsIcon],svg[simple-icons-stmicroelectronics-icon]',
  host: {
    'role': 'img',
