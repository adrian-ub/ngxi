...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsThemodelsresourceIcon],svg[simple-icons-themodelsresource-icon]',
  host: {
    role: 'img',
