...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsNeteasecloudmusicIcon],svg[simple-icons-neteasecloudmusic-icon]',
  host: {
    role: 'img',
