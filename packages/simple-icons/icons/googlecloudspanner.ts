...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglecloudspannerIcon],svg[simple-icons-googlecloudspanner-icon]',
  host: {
    'role': 'img',
