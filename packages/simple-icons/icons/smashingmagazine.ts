...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsSmashingmagazineIcon],svg[simple-icons-smashingmagazine-icon]',
  host: {
    role: 'img',
