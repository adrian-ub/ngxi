...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGradleplaypublisherIcon],svg[simple-icons-gradleplaypublisher-icon]',
  host: {
    'role': 'img',
