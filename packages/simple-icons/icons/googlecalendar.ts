...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsGooglecalendarIcon],svg[simple-icons-googlecalendar-icon]',
  host: {
    'role': 'img',
