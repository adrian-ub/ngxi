...
@Component({
  standalone: true,
  selector: 'svg[simpleIconsThewashingtonpostIcon],svg[simple-icons-thewashingtonpost-icon]',
  host: {
    role: 'img',
