...
@Component({
  standalone: true,
  selector:
    'svg[siRelianceindustrieslimited],svg[si-relianceindustrieslimited]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Reliance Industries Limited</svg:title>
    <svg:path
...
export class SiRelianceindustrieslimited {
