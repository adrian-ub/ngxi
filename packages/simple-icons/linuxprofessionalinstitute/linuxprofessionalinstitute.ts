...
@Component({
  standalone: true,
  selector:
    'svg[siLinuxprofessionalinstitute],svg[si-linuxprofessionalinstitute]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Linux Professional Institute</svg:title>
    <svg:path
...
export class SiLinuxprofessionalinstitute {
