...
@Component({
  standalone: true,
  selector:
    'svg[siGooglecontaineroptimizedos],svg[si-googlecontaineroptimizedos]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Google Container Optimized OS</svg:title>
    <svg:path
...
export class SiGooglecontaineroptimizedos {
