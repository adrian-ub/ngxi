...
@Component({
  standalone: true,
  selector: 'svg[siCommonworkflowlanguage],svg[si-commonworkflowlanguage]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Common Workflow Language</svg:title>
    <svg:path
...
export class SiCommonworkflowlanguage {
