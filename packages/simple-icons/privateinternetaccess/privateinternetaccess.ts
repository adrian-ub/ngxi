...
@Component({
  standalone: true,
  selector: 'svg[siPrivateinternetaccess],svg[si-privateinternetaccess]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Private Internet Access</svg:title>
    <svg:path
...
export class SiPrivateinternetaccess {
