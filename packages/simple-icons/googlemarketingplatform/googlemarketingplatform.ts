...
@Component({
  standalone: true,
  selector: 'svg[siGooglemarketingplatform],svg[si-googlemarketingplatform]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Google Marketing Platform</svg:title>
    <svg:path
...
export class SiGooglemarketingplatform {
