...
@Component({
  standalone: true,
  selector:
    'svg[siTaketwointeractivesoftware],svg[si-taketwointeractivesoftware]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Take-Two Interactive Software</svg:title>
    <svg:path
...
export class SiTaketwointeractivesoftware {
