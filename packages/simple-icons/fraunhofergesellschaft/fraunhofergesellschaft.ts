...
@Component({
  standalone: true,
  selector: 'svg[siFraunhofergesellschaft],svg[si-fraunhofergesellschaft]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Fraunhofer-Gesellschaft</svg:title>
    <svg:path
...
export class SiFraunhofergesellschaft {
