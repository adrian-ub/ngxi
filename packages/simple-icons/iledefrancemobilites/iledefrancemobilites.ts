...
@Component({
  standalone: true,
  selector: 'svg[siIledefrancemobilites],svg[si-iledefrancemobilites]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Île-de-France Mobilités</svg:title>
    <svg:path
...
export class SiIledefrancemobilites {
