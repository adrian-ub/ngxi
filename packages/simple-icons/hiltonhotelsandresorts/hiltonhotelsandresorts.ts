...
@Component({
  standalone: true,
  selector: 'svg[siHiltonhotelsandresorts],svg[si-hiltonhotelsandresorts]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Hilton Hotels &amp; Resorts</svg:title>
    <svg:path
...
export class SiHiltonhotelsandresorts {
