...
@Component({
  standalone: true,
  selector:
    'svg[siHomeassistantcommunitystore],svg[si-homeassistantcommunitystore]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Home Assistant Community Store</svg:title>
    <svg:path
...
export class SiHomeassistantcommunitystore {
