...
@Component({
  standalone: true,
  selector: 'svg[siGoogledisplayandvideo360],svg[si-googledisplayandvideo360]',
  host: {
    role: 'img',
    '[attr.viewBox]': 'viewBox()',
    '[attr.xmlns]': 'xmlns()',
  },
  template: `<svg:title>Google Display &amp; Video 360</svg:title>
    <svg:path
...
export class SiGoogledisplayandvideo360 {
