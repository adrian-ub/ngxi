...
@Component({
  standalone: true,
  selector: 'svg[siOpencontainersinitiative],svg[si-opencontainersinitiative]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>Open Containers Initiative</svg:title>
    <svg:path
...
export class SiOpencontainersinitiative {
