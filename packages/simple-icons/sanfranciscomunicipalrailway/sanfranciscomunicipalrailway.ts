...
@Component({
  standalone: true,
  selector:
    'svg[siSanfranciscomunicipalrailway],svg[si-sanfranciscomunicipalrailway]',
  host: {
    role: 'img',
    '[attr.role]': 'role()',
  ...
  template: `<svg:title>San Francisco Municipal Railway</svg:title>
    <svg:path
...
export class SiSanfranciscomunicipalrailway {
