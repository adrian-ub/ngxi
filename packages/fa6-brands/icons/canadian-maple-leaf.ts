...
@Component({
  standalone: true,
  selector: 'svg[fa6BrandsCanadianMapleLeafIcon],svg[fa6-brands-canadian-maple-leaf-icon]',
  host: {
    role: 'img',
