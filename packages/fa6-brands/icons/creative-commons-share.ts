...
@Component({
  standalone: true,
  selector: 'svg[fa6BrandsCreativeCommonsShareIcon],svg[fa6-brands-creative-commons-share-icon]',
  host: {
    role: 'img',
