...
@Component({
  standalone: true,
  selector: 'svg[fa6BrandsWatchmanMonitoringIcon],svg[fa6-brands-watchman-monitoring-icon]',
  host: {
    role: 'img',
