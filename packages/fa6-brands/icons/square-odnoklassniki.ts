...
@Component({
  standalone: true,
  selector: 'svg[fa6BrandsSquareOdnoklassnikiIcon],svg[fa6-brands-square-odnoklassniki-icon]',
  host: {
    role: 'img',
