...
@Component({
  standalone: true,
  selector: 'svg[fa6BrandsCreativeCommonsRemixIcon],svg[fa6-brands-creative-commons-remix-icon]',
  host: {
    role: 'img',
